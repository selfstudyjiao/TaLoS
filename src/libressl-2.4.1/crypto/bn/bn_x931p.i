...
bn_x931_derive_pi(BIGNUM *pi, const BIGNUM *Xpi, BN_CTX *ctx, BN_GENCB *cb)
{
 ...
 if (!BN_copy(pi, Xpi))
  return 0;
 if (!(((pi)->top > 0) && ((pi)->d[0] & 1)) && !BN_add_word(pi, 1))
  return 0;
 for (;;) {
  i++;
    ...
    BN_GENCB *cb)
{
 ...
 BN_CTX_start(ctx);
 if (p1 == 
# 110 "bn/bn_x931p.c" 3 4
          ((void *)0)
# 110 "bn/bn_x931p.c"
              ) {
  if ((p1 = BN_CTX_get(ctx)) == 
# 111 "bn/bn_x931p.c" 3 4
                               ((void *)0)
# 111 "bn/bn_x931p.c"
                                   )
   goto err;
 ...
 if (p2 == 
# 114 "bn/bn_x931p.c" 3 4
          ((void *)0)
# 114 "bn/bn_x931p.c"
              ) {
  if ((p2 = BN_CTX_get(ctx)) == 
# 115 "bn/bn_x931p.c" 3 4
                               ((void *)0)
# 115 "bn/bn_x931p.c"
                                   )
   goto err;
 ...
 if ((t = BN_CTX_get(ctx)) == 
# 119 "bn/bn_x931p.c" 3 4
                             ((void *)0)
# 119 "bn/bn_x931p.c"
                                 )
  goto err;
 if ((p1p2 = BN_CTX_get(ctx)) == 
# 121 "bn/bn_x931p.c" 3 4
                                ((void *)0)
# 121 "bn/bn_x931p.c"
                                    )
  goto err;
 if ((pm1 = BN_CTX_get(ctx)) == 
# 123 "bn/bn_x931p.c" 3 4
                               ((void *)0)
# 123 "bn/bn_x931p.c"
                                   )
  goto err;
 ...
 for (;;) {
  ...
  if (!BN_gcd(t, pm1, e, ctx))
   goto err;
  if (((((((t))->top == 1) && (((t))->d[0] == (unsigned long)(1))) || (((1) == 0) && (((t))->top == 0))) && !(t)->neg)
    ...
    BIGNUM *Xp2, const BIGNUM *Xp, const BIGNUM *e, BN_CTX *ctx, BN_GENCB *cb)
{
 ...
 BN_CTX_start(ctx);
 if (Xp1 == 
# 257 "bn/bn_x931p.c" 3 4
           ((void *)0)
# 257 "bn/bn_x931p.c"
               ) {
  if ((Xp1 = BN_CTX_get(ctx)) == 
# 258 "bn/bn_x931p.c" 3 4
                                ((void *)0)
# 258 "bn/bn_x931p.c"
                                    )
   goto error;
 ...
 if (Xp2 == 
# 261 "bn/bn_x931p.c" 3 4
           ((void *)0)
# 261 "bn/bn_x931p.c"
               ) {
  if ((Xp2 = BN_CTX_get(ctx)) == 
# 262 "bn/bn_x931p.c" 3 4
                                ((void *)0)
# 262 "bn/bn_x931p.c"
                                    )
   goto error;
