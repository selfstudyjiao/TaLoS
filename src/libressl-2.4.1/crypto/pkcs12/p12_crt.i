...
PKCS12_create(char *pass, char *name, EVP_PKEY *pkey, X509 *cert,
    struct stack_st_X509 *ca, int nid_key, int nid_cert, int iter, int mac_iter,
    int keytype)
{
 PKCS12 *p12 = 
# 87 "pkcs12/p12_crt.c" 3 4
              ((void *)0)
# 87 "pkcs12/p12_crt.c"
                  ;
 struct stack_st_PKCS7 *safes = 
# 88 "pkcs12/p12_crt.c" 3 4
                         ((void *)0)
# 88 "pkcs12/p12_crt.c"
                             ;
 struct stack_st_PKCS12_SAFEBAG *bags = 
# 89 "pkcs12/p12_crt.c" 3 4
                                 ((void *)0)
# 89 "pkcs12/p12_crt.c"
                                     ;
 PKCS12_SAFEBAG *bag = 
# 90 "pkcs12/p12_crt.c" 3 4
                      ((void *)0)
# 90 "pkcs12/p12_crt.c"
                          ;
 int i;
 ...
 if (!pkey && !cert && !ca) {
  ERR_put_error(35,(105),(104),"pkcs12/p12_crt.c",108)
                                     ;
  return 
# 109 "pkcs12/p12_crt.c" 3 4
        ((void *)0)
# 109 "pkcs12/p12_crt.c"
            ;
 }
 ...
 if (pkey && cert) {
  if (!X509_check_private_key(cert, pkey))
   return 
# 114 "pkcs12/p12_crt.c" 3 4
         ((void *)0)
# 114 "pkcs12/p12_crt.c"
             ;
 ...
 if (cert) {
  ...
  if (name && !PKCS12_add_friendlyname_asc(bag, name, -1))
   goto err;
 ...
 for (i = 0; i < sk_num(((_STACK*) (1 ? (ca) : (struct stack_st_X509*)0))); i++) {
  if (!PKCS12_add_cert(&bags, ((X509 *)sk_value(((_STACK*) (1 ? (ca) : (struct stack_st_X509*)0)), (i)))))
   goto err;
 }
 ...
 sk_pop_free(((_STACK*) (1 ? (bags) : (struct stack_st_PKCS12_SAFEBAG*)0)), ((void (*)(void *)) ((1 ? (PKCS12_SAFEBAG_free) : (void (*)(PKCS12_SAFEBAG *))0))));
 bags = 
# 136 "pkcs12/p12_crt.c" 3 4
       ((void *)0)
# 136 "pkcs12/p12_crt.c"
           ;
 ...
 if (pkey) {
  ...
  if (!copy_bag_attr(bag, pkey, 417))
   goto err;
  if (!copy_bag_attr(bag, pkey, 856))
   goto err;
 ...
 if (bags && !PKCS12_add_safe(&safes, bags, -1, 0, 
# 155 "pkcs12/p12_crt.c" 3 4
                                                  ((void *)0)
# 155 "pkcs12/p12_crt.c"
                                                      ))
  goto err;

 sk_pop_free(((_STACK*) (1 ? (bags) : (struct stack_st_PKCS12_SAFEBAG*)0)), ((void (*)(void *)) ((1 ? (PKCS12_SAFEBAG_free) : (void (*)(PKCS12_SAFEBAG *))0))));
 bags = 
# 159 "pkcs12/p12_crt.c" 3 4
       ((void *)0)
# 159 "pkcs12/p12_crt.c"
           ;
 ...
 sk_pop_free(((_STACK*) (1 ? (safes) : (struct stack_st_PKCS7*)0)), ((void (*)(void *)) ((1 ? (PKCS7_free) : (void (*)(PKCS7 *))0))));

 safes = 
# 168 "pkcs12/p12_crt.c" 3 4
        ((void *)0)
# 168 "pkcs12/p12_crt.c"
            ;

 if ((mac_iter != -1) &&
     !PKCS12_set_mac(p12, pass, -1, 
# 171 "pkcs12/p12_crt.c" 3 4
                                   ((void *)0)
# 171 "pkcs12/p12_crt.c"
                                       , 0, mac_iter, 
# 171 "pkcs12/p12_crt.c" 3 4
                                                      ((void *)0)
# 171 "pkcs12/p12_crt.c"
...
err:
 ...
 if (bags)
  sk_pop_free(((_STACK*) (1 ? (bags) : (struct stack_st_PKCS12_SAFEBAG*)0)), ((void (*)(void *)) ((1 ? (PKCS12_SAFEBAG_free) : (void (*)(PKCS12_SAFEBAG *))0))));
 return 
# 183 "pkcs12/p12_crt.c" 3 4
       ((void *)0)
# 183 "pkcs12/p12_crt.c"
           ;
}

PKCS12_SAFEBAG *
PKCS12_add_cert(struct stack_st_PKCS12_SAFEBAG **pbags, X509 *cert)
{
 PKCS12_SAFEBAG *bag = 
# 189 "pkcs12/p12_crt.c" 3 4
                      ((void *)0)
# 189 "pkcs12/p12_crt.c"
                          ;
 char *name;
 int namelen = -1;
 unsigned char *keyid;
 ...
 if (name && !PKCS12_add_friendlyname_asc(bag, name, namelen))
  goto err;
...
err:
 ...
 return 
# 220 "pkcs12/p12_crt.c" 3 4
       ((void *)0)
# 220 "pkcs12/p12_crt.c"
           ;
}

PKCS12_SAFEBAG *
PKCS12_add_key(struct stack_st_PKCS12_SAFEBAG **pbags, EVP_PKEY *key, int key_usage,
    int iter, int nid_key, char *pass)
{
 PKCS12_SAFEBAG *bag = 
# 227 "pkcs12/p12_crt.c" 3 4
                      ((void *)0)
# 227 "pkcs12/p12_crt.c"
                          ;
 PKCS8_PRIV_KEY_INFO *p8 = 
# 228 "pkcs12/p12_crt.c" 3 4
                          ((void *)0)
# 228 "pkcs12/p12_crt.c"
                              ;
 ...
 if (key_usage && !PKCS8_add_keyusage(p8, key_usage))
  goto err;
 if (nid_key != -1) {
  bag = PKCS12_MAKE_SHKEYBAG(nid_key, pass, -1, 
# 236 "pkcs12/p12_crt.c" 3 4
                                               ((void *)0)
# 236 "pkcs12/p12_crt.c"
                                                   , 0,
      iter, p8);
  PKCS8_PRIV_KEY_INFO_free(p8);
  p8 = 
# 239 "pkcs12/p12_crt.c" 3 4
      ((void *)0)
# 239 "pkcs12/p12_crt.c"
          ;
 } else {
  bag = PKCS12_MAKE_KEYBAG(p8);
  if (bag != 
# 242 "pkcs12/p12_crt.c" 3 4
            ((void *)0)
# 242 "pkcs12/p12_crt.c"
                )
   p8 = 
# 243 "pkcs12/p12_crt.c" 3 4
       ((void *)0)
# 243 "pkcs12/p12_crt.c"
           ;
 }
...
err:
 ...
 return 
# 260 "pkcs12/p12_crt.c" 3 4
       ((void *)0)
# 260 "pkcs12/p12_crt.c"
           ;
}

int
PKCS12_add_safe(struct stack_st_PKCS7 **psafes, struct stack_st_PKCS12_SAFEBAG *bags,
    int nid_safe, int iter, char *pass)
{
 PKCS7 *p7 = 
# 267 "pkcs12/p12_crt.c" 3 4
            ((void *)0)
# 267 "pkcs12/p12_crt.c"
                ;
 int free_safes = 0;

 if (!*psafes) {
  *psafes = ((struct stack_st_PKCS7 *)sk_new_null());
  if (!*psafes)
   return 0;
  free_safes = 1;
 } else
 ...
 if (nid_safe == -1)
  ...
  p7 = PKCS12_pack_p7encdata(nid_safe, pass, -1, 
# 284 "pkcs12/p12_crt.c" 3 4
                                                ((void *)0)
# 284 "pkcs12/p12_crt.c"
                                                    , 0,
      iter, bags);
 if (!p7)
  goto err;

 if (!sk_push(((_STACK*) (1 ? (*psafes) : (struct stack_st_PKCS7*)0)), ((void*) (1 ? (p7) : (PKCS7*)0))))
  goto err;
...
err:
 if (free_safes) {
  sk_free(((_STACK*) (1 ? (*psafes) : (struct stack_st_PKCS7*)0)));
  *psafes = 
# 297 "pkcs12/p12_crt.c" 3 4
           ((void *)0)
# 297 "pkcs12/p12_crt.c"
               ;
 }
...
static int
pkcs12_add_bag(struct stack_st_PKCS12_SAFEBAG **pbags, PKCS12_SAFEBAG *bag)
{
 int free_bags;
 ...
 if (!pbags)
  return 1;
 if (!*pbags) {
  *pbags = ((struct stack_st_PKCS12_SAFEBAG *)sk_new_null());
  if (!*pbags)
   return 0;
  free_bags = 1;
 } else
 ...
 if (!sk_push(((_STACK*) (1 ? (*pbags) : (struct stack_st_PKCS12_SAFEBAG*)0)), ((void*) (1 ? (bag) : (PKCS12_SAFEBAG*)0)))) {
  if (free_bags) {
   sk_free(((_STACK*) (1 ? (*pbags) : (struct stack_st_PKCS12_SAFEBAG*)0)));
   *pbags = 
# 324 "pkcs12/p12_crt.c" 3 4
           ((void *)0)
# 324 "pkcs12/p12_crt.c"
               ;
  }
  return 0;
 }
...
PKCS12 *
PKCS12_add_safes(struct stack_st_PKCS7 *safes, int nid_p7)
{
 PKCS12 *p12;
 ...
 if (!p12)
  return 
# 342 "pkcs12/p12_crt.c" 3 4
        ((void *)0)
# 342 "pkcs12/p12_crt.c"
            ;

 if (!PKCS12_pack_authsafes(p12, safes)) {
  PKCS12_free(p12);
  return 
# 346 "pkcs12/p12_crt.c" 3 4
        ((void *)0)
# 346 "pkcs12/p12_crt.c"
            ;
 }
