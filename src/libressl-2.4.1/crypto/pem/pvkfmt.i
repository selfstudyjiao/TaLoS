...
read_lebn(const unsigned char **in, unsigned int nbyte, BIGNUM **r)
{
 ...
 for (i = 0; i < nbyte; i++)
  *q++ = *p--;
 *r = BN_bin2bn(tmpbuf, nbyte, 
# 112 "pem/pvkfmt.c" 3 4
                              ((void *)0)
# 112 "pem/pvkfmt.c"
                                  );
 free(tmpbuf);
    ...
    unsigned int *pmagic, unsigned int *pbitlen, int *pisdss, int *pispub)
{
 ...
 if (*p == 0x6) {
  if (*pispub == 0) {
   ERR_put_error(9,(134),(119),"pem/pvkfmt.c",159)
                                        ;
   return 0;
  }
  *pispub = 1;
  ...
  if (*pispub == 1) {
   ERR_put_error(9,(134),(120),"pem/pvkfmt.c",166)
                                       ;
   return 0;
  }
  *pispub = 0;
 ...
 if (*p++ != 0x2) {
  ERR_put_error(9,(134),(117),"pem/pvkfmt.c",175);
  return 0;
 }
 ...
 *pbitlen = read_ledword(&p);
 if (*pbitlen > 65536) {
  ERR_put_error(9,(134),(121),"pem/pvkfmt.c",183);
  return 0;
 }
 *pisdss = 0;
 switch (*pmagic) {
 ...
 case 0x31415352L:
  if (*pispub == 0) {
   ERR_put_error(9,(134),(119),"pem/pvkfmt.c",194)
                                        ;
   return 0;
  }
  break;
 ...
 case 0x32415352L:
  if (*pispub == 1) {
   ERR_put_error(9,(134),(120),"pem/pvkfmt.c",204)
                                       ;
   return 0;
  }
  break;
 ...
 default:
  ERR_put_error(9,(134),(116),"pem/pvkfmt.c",210);
  return -1;
 }
 *in = p;
 return 1;
...
do_b2i(const unsigned char **in, unsigned int length, int ispub)
{
 ...
 if (do_blob_header(&p, length, &magic, &bitlen, &isdss, &ispub) <= 0) {
  ERR_put_error(9,(132),(122),"pem/pvkfmt.c",257);
  return 
# 258 "pem/pvkfmt.c" 3 4
        ((void *)0)
# 258 "pem/pvkfmt.c"
            ;
 }
 ...
 if (length < blob_length(bitlen, isdss, ispub)) {
  ERR_put_error(9,(132),(123),"pem/pvkfmt.c",262);
  return 
# 263 "pem/pvkfmt.c" 3 4
        ((void *)0)
# 263 "pem/pvkfmt.c"
            ;
 }
...
{
 const unsigned char *p;
 unsigned char hdr_buf[16], *buf = 
# 275 "pem/pvkfmt.c" 3 4
                                  ((void *)0)
# 275 "pem/pvkfmt.c"
                                      ;
 ...
 int isdss;
 EVP_PKEY *ret = 
# 278 "pem/pvkfmt.c" 3 4
                ((void *)0)
# 278 "pem/pvkfmt.c"
                    ;

 if (BIO_read(in, hdr_buf, 16) != 16) {
  ERR_put_error(9,(133),(123),"pem/pvkfmt.c",281);
  return 
# 282 "pem/pvkfmt.c" 3 4
        ((void *)0)
# 282 "pem/pvkfmt.c"
            ;
 }
...
# 286 "pem/pvkfmt.c"
 ...
 buf = malloc(length);
 if (!buf) {
  ERR_put_error(9,(133),((1|64)),"pem/pvkfmt.c",291);
  goto err;
 }
 p = buf;
 if (BIO_read(in, buf, length) != (int)length) {
  ERR_put_error(9,(133),(123),"pem/pvkfmt.c",296);
  goto err;
 }
    ...
    int ispub)
{
 const unsigned char *p = *in;
 EVP_PKEY *ret = 
# 315 "pem/pvkfmt.c" 3 4
                ((void *)0)
# 315 "pem/pvkfmt.c"
                    ;
 DSA *dsa = 
# 316 "pem/pvkfmt.c" 3 4
           ((void *)0)
# 316 "pem/pvkfmt.c"
               ;
 BN_CTX *ctx = 
# 317 "pem/pvkfmt.c" 3 4
              ((void *)0)
# 317 "pem/pvkfmt.c"
                  ;
 unsigned int nbyte;
...
memerr:
 ERR_put_error(9,(127),((1|64)),"pem/pvkfmt.c",355);
 DSA_free(dsa);
 EVP_PKEY_free(ret);
 BN_CTX_free(ctx);
 return 
# 359 "pem/pvkfmt.c" 3 4
       ((void *)0)
# 359 "pem/pvkfmt.c"
           ;
}
    ...
    int ispub)
{
 const unsigned char *p = *in;
 EVP_PKEY *ret = 
# 367 "pem/pvkfmt.c" 3 4
                ((void *)0)
# 367 "pem/pvkfmt.c"
                    ;
 RSA *rsa = 
# 368 "pem/pvkfmt.c" 3 4
           ((void *)0)
# 368 "pem/pvkfmt.c"
               ;
 unsigned int nbyte, hnbyte;
...
memerr:
 ERR_put_error(9,(129),((1|64)),"pem/pvkfmt.c",405);
 RSA_free(rsa);
 EVP_PKEY_free(ret);
 return 
# 408 "pem/pvkfmt.c" 3 4
       ((void *)0)
# 408 "pem/pvkfmt.c"
           ;
}
...
do_i2b(unsigned char **out, EVP_PKEY *pk, int ispub)
{
 ...
 outlen = 16 + blob_length(bitlen,
     keyalg == 0x2200 ? 1 : 0, ispub);
 if (out == 
# 499 "pem/pvkfmt.c" 3 4
           ((void *)0)
# 499 "pem/pvkfmt.c"
               )
  return outlen;
...
badkey:
 ERR_put_error(9,(130),(126),"pem/pvkfmt.c",567);
 return 0;
}
...
check_bitlen_rsa(RSA *rsa, int ispub, unsigned int *pmagic)
{
  ...
  *pmagic = 0x32415352L;
  ...
  if (((BN_num_bits(rsa->d)+7)/8) > nbyte)
   goto badkey;
  if ((((BN_num_bits(rsa->iqmp)+7)/8) > hnbyte) ||
...
badkey:
 ERR_put_error(9,(131),(126),"pem/pvkfmt.c",601);
 return 0;
}
    ...
    unsigned int *psaltlen, unsigned int *pkeylen)
{
 ...
 if (skip_magic) {
  if (length < 20) {
   ERR_put_error(9,(136),(125),"pem/pvkfmt.c",666);
   return 0;
  }
  length -= 20;
 } else {
  if (length < 24) {
   ERR_put_error(9,(136),(125),"pem/pvkfmt.c",672);
   return 0;
  }
  length -= 24;
  pvk_magic = read_ledword(&p);
  if (pvk_magic != 0xb0b5f11eL) {
   ERR_put_error(9,(136),(116),"pem/pvkfmt.c",678);
   return 0;
  }
 }
 ...
 *pkeylen = read_ledword(&p);
 if (*psaltlen > 65536 || *pkeylen > 65536) {
  ERR_put_error(9,(136),(115),"pem/pvkfmt.c",689);
  return 0;
 }

 if (is_encrypted && !*psaltlen) {
  ERR_put_error(9,(136),(121),"pem/pvkfmt.c",694);
  return 0;
 }
    ...
    unsigned int saltlen, const unsigned char *pass, int passlen)
{
 ...
 if (!EVP_DigestInit_ex(&mctx, EVP_sha1(), 
# 710 "pem/pvkfmt.c" 3 4
                                          ((void *)0)
# 710 "pem/pvkfmt.c"
                                              ) ||
     !EVP_DigestUpdate(&mctx, salt, saltlen) ||
     !EVP_DigestUpdate(&mctx, pass, passlen) ||
     !EVP_DigestFinal_ex(&mctx, key, 
# 713 "pem/pvkfmt.c" 3 4
                                    ((void *)0)
# 713 "pem/pvkfmt.c"
                                        ))
  rv = 0;
...
# 727 "pem/pvkfmt.c"
 ...
 if (saltlen) {
  ...
  if (cb)
   inlen = cb(psbuf, 1024, 0, u);
  else
   inlen = PEM_def_callback(psbuf, 1024, 0, u);
  if (inlen <= 0) {
   ERR_put_error(9,(135),(104),"pem/pvkfmt.c",741);
   goto err;
  }
  enctmp = malloc(keylen + 8);
  if (!enctmp) {
   ERR_put_error(9,(135),((1|64)),"pem/pvkfmt.c",746);
   goto err;
  }
  ...
  p += 8;
  if (keylen < 8) {
   ERR_put_error(9,(135),(125),"pem/pvkfmt.c",758);
   goto err;
  }
  inlen = keylen - 8;
  q = enctmp + 8;
  if (!EVP_DecryptInit_ex(&cctx, EVP_rc4(), 
# 763 "pem/pvkfmt.c" 3 4
                                           ((void *)0)
# 763 "pem/pvkfmt.c"
                                               , keybuf, 
# 763 "pem/pvkfmt.c" 3 4
...
# 763 "pem/pvkfmt.c"
  ...
  if (magic != 0x32415352L && magic != 0x32535344L) {
   q = enctmp + 8;
   memset(keybuf + 5, 0, 11);
   if (!EVP_DecryptInit_ex(&cctx, EVP_rc4(), 
# 773 "pem/pvkfmt.c" 3 4
                                            ((void *)0)
# 773 "pem/pvkfmt.c"
                                                , keybuf,
       
# 774 "pem/pvkfmt.c" 3 4
      ((void *)0)
# 774 "pem/pvkfmt.c"
          ))
    goto err;
   ...
   magic = read_ledword((const unsigned char **)&q);
   if (magic != 0x32415352L && magic != 0x32535344L) {
    ERR_put_error(9,(135),(101),"pem/pvkfmt.c",784);
    goto err;
   }
  } else
   explicit_bzero(keybuf, 20);
...
{
 unsigned char pvk_hdr[24], *buf = 
# 805 "pem/pvkfmt.c" 3 4
                                  ((void *)0)
# 805 "pem/pvkfmt.c"
                                      ;
 const unsigned char *p;
...
# 808 "pem/pvkfmt.c"
 ...
 if (BIO_read(in, pvk_hdr, 24) != 24) {
  ERR_put_error(9,(128),(124),"pem/pvkfmt.c",812);
  return 
# 813 "pem/pvkfmt.c" 3 4
        ((void *)0)
# 813 "pem/pvkfmt.c"
            ;
 }
 ...
 buf = malloc(buflen);
 if (!buf) {
  ERR_put_error(9,(128),((1|64)),"pem/pvkfmt.c",822);
  return 0;
 }
 p = buf;
 if (BIO_read(in, buf, buflen) != buflen) {
  ERR_put_error(9,(128),(124),"pem/pvkfmt.c",827);
  goto err;
 }
...
# 851 "pem/pvkfmt.c"
 ...
 if (*out)
  ...
  p = malloc(outlen);
  if (!p) {
   ERR_put_error(9,(137),((1|64)),"pem/pvkfmt.c",862);
   return -1;
  }
  *out = p;
 }

 write_ledword(&p, 0xb0b5f11eL);
 write_ledword(&p, 0);
 if (pk->type == 116)
  write_ledword(&p, 0x2);
 else
 ...
 write_ledword(&p, enclevel ? 0x10 : 0);
 write_ledword(&p, pklen);
 if (enclevel) {
  arc4random_buf(p, 0x10);
  salt = p;
  p += 0x10;
 }
 do_i2b(&p, pk, 0);
 if (enclevel == 0)
  ...
  int enctmplen, inlen;
  if (cb)
   inlen = cb(psbuf, 1024, 1, u);
  else
   inlen = PEM_def_callback(psbuf, 1024, 1, u);
  if (inlen <= 0) {
   ERR_put_error(9,(137),(104),"pem/pvkfmt.c",894);
   goto error;
  }
  if (!derive_pvk_key(keybuf, salt, 0x10,
      (unsigned char *)psbuf, inlen))
   goto error;
  if (enclevel == 1)
   memset(keybuf + 5, 0, 11);
  p = salt + 0x10 + 8;
  if (!EVP_EncryptInit_ex(&cctx, EVP_rc4(), 
# 903 "pem/pvkfmt.c" 3 4
                                           ((void *)0)
# 903 "pem/pvkfmt.c"
                                               , keybuf, 
# 903 "pem/pvkfmt.c" 3 4
...
# 922 "pem/pvkfmt.c"
 ...
 free(tmp);
 if (wrlen == outlen) {
  ERR_put_error(9,(138),(118),"pem/pvkfmt.c",931);
  return outlen;
 }
 return -1;
}
