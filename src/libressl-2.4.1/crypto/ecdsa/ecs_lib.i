...
# 63 "ecdsa/ecs_lib.c" 2




static const ECDSA_METHOD *default_ECDSA_method = 
# 67 "ecdsa/ecs_lib.c" 3 4
                                                 ((void *)0)
# 67 "ecdsa/ecs_lib.c"
                                                     ;
...
ECDSA_DATA_new_method(ENGINE *engine)
{
 ...
 if (ret == 
# 115 "ecdsa/ecs_lib.c" 3 4
           ((void *)0)
# 115 "ecdsa/ecs_lib.c"
               ) {
  ERR_put_error(42,(100),((1|64)),"ecdsa/ecs_lib.c",116);
  return (
# 117 "ecdsa/ecs_lib.c" 3 4
         ((void *)0)
# 117 "ecdsa/ecs_lib.c"
             );
 }
...
# 120 "ecdsa/ecs_lib.c"
 ...
 if (ret->engine) {
  ...
  if (!ret->meth) {
   ERR_put_error(42,(100),(38),"ecdsa/ecs_lib.c",131)
                        ;
   ENGINE_finish(ret->engine);
   free(ret);
   return 
# 134 "ecdsa/ecs_lib.c" 3 4
         ((void *)0)
# 134 "ecdsa/ecs_lib.c"
             ;
  }
 ...
 CRYPTO_new_ex_data(12, ret, &ret->ex_data);
 return (ret);
}
...
ecdsa_data_new(void)
{
 return (void *)ECDSA_DATA_new_method(
# 147 "ecdsa/ecs_lib.c" 3 4
                                     ((void *)0)
# 147 "ecdsa/ecs_lib.c"
                                         );
}
...
ecdsa_data_dup(void *data)
{
 ...
 if (r == 
# 156 "ecdsa/ecs_lib.c" 3 4
         ((void *)0)
# 156 "ecdsa/ecs_lib.c"
             )
  return 
# 157 "ecdsa/ecs_lib.c" 3 4
        ((void *)0)
# 157 "ecdsa/ecs_lib.c"
            ;
...
ecdsa_data_free(void *data)
{
 ...
 CRYPTO_free_ex_data(12, r, &r->ex_data);
...
ecdsa_check(EC_KEY *key)
{
 ...
 if (data == 
# 185 "ecdsa/ecs_lib.c" 3 4
            ((void *)0)
# 185 "ecdsa/ecs_lib.c"
                ) {
  ecdsa_data = (ECDSA_DATA *)ecdsa_data_new();
  if (ecdsa_data == 
# 187 "ecdsa/ecs_lib.c" 3 4
                   ((void *)0)
# 187 "ecdsa/ecs_lib.c"
                       )
   return 
# 188 "ecdsa/ecs_lib.c" 3 4
         ((void *)0)
# 188 "ecdsa/ecs_lib.c"
             ;
...
# 215 "ecdsa/ecs_lib.c"
 ...
 if ((order = BN_new()) == 
# 218 "ecdsa/ecs_lib.c" 3 4
                          ((void *)0)
# 218 "ecdsa/ecs_lib.c"
                              )
  return 0;
 if (!EC_GROUP_get_order(group, order, 
# 220 "ecdsa/ecs_lib.c" 3 4
                                      ((void *)0)
# 220 "ecdsa/ecs_lib.c"
                                          )) {
  BN_clear_free(order);
...
ECDSA_get_ex_new_index(long argl, void *argp, CRYPTO_EX_new *new_func,
    CRYPTO_EX_dup *dup_func, CRYPTO_EX_free *free_func)
{
 return CRYPTO_get_ex_new_index(12, argl, argp,
...
ECDSA_get_ex_data(EC_KEY *d, int idx)
{
 ...
 ecdsa = ecdsa_check(d);
 if (ecdsa == 
# 261 "ecdsa/ecs_lib.c" 3 4
             ((void *)0)
# 261 "ecdsa/ecs_lib.c"
                 )
  return 
# 262 "ecdsa/ecs_lib.c" 3 4
        ((void *)0)
# 262 "ecdsa/ecs_lib.c"
            ;
