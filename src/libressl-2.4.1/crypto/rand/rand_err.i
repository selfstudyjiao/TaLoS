...
static ERR_STRING_DATA RAND_str_functs[] = {
 {(((((unsigned long)36)&0xffL)<<24L)| ((((unsigned long)101)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "RAND_get_rand_method"},
 {(((((unsigned long)36)&0xffL)<<24L)| ((((unsigned long)102)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "RAND_init_fips"},
 {(((((unsigned long)36)&0xffL)<<24L)| ((((unsigned long)100)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "SSLEAY_RAND_BYTES"},
 {0, 
# 78 "rand/rand_err.c" 3 4
    ((void *)0)
# 78 "rand/rand_err.c"
        }
};
...
static ERR_STRING_DATA RAND_str_reasons[] = {
 {(((((unsigned long)36)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)104)&0xfffL))), "dual ec drbg disabled"},
 {(((((unsigned long)36)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)102)&0xfffL))), "error initialising drbg"},
 {(((((unsigned long)36)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)103)&0xfffL))), "error instantiating drbg"},
 {(((((unsigned long)36)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)101)&0xfffL))), "no fips random method set"},
 {(((((unsigned long)36)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)100)&0xfffL))) , "PRNG not seeded"},
 {0, 
# 87 "rand/rand_err.c" 3 4
    ((void *)0)
# 87 "rand/rand_err.c"
        }
};
...
ERR_load_RAND_strings(void)
{
 ...
 if (ERR_func_error_string(RAND_str_functs[0].error) == 
# 96 "rand/rand_err.c" 3 4
                                                       ((void *)0)
# 96 "rand/rand_err.c"
                                                           ) {
