...
typedef struct b64_struct {
 ...
 char buf[(((1024 +2)/3*4)+(1024/48+1)*2+80) + 10];
 char tmp[1024];
} BIO_B64_CTX;
...
# 159 "evp/bio_b64.c"
 ...
 if (ctx->buf_len > 0) {
  (void)((ctx->buf_len >= ctx->buf_off) ? 0 : (OpenSSLDie("evp/bio_b64.c", 174, "ctx->buf_len >= ctx->buf_off"),1));
  i = ctx->buf_len - ctx->buf_off;
  if (i > outl)
   i = outl;
  (void)((ctx->buf_off + i < (int)sizeof(ctx->buf)) ? 0 : (OpenSSLDie("evp/bio_b64.c", 178, "ctx->buf_off + i < (int)sizeof(ctx->buf)"),1));
 ...
 while (outl > 0) {
  ...
  if (i <= 0) {
   ...
   if (!BIO_test_flags(b->next_bio, 0x08)) {
    ctx->cont = i;
  ...
  if (ctx->start && (BIO_test_flags(b, ~(0x0)) & 0x100)) {
...
b64_write(BIO *b, const char *in, int inl)
{
 ...
 (void)((ctx->buf_off < (int)sizeof(ctx->buf)) ? 0 : (OpenSSLDie("evp/bio_b64.c", 369, "ctx->buf_off < (int)sizeof(ctx->buf)"),1));
 (void)((ctx->buf_len <= (int)sizeof(ctx->buf)) ? 0 : (OpenSSLDie("evp/bio_b64.c", 370, "ctx->buf_len <= (int)sizeof(ctx->buf)"),1));
 (void)((ctx->buf_len >= ctx->buf_off) ? 0 : (OpenSSLDie("evp/bio_b64.c", 371, "ctx->buf_len >= ctx->buf_off"),1));
 ...
 while (n > 0) {
  ...
  (void)((i <= n) ? 0 : (OpenSSLDie("evp/bio_b64.c", 379, "i <= n"),1));
  ctx->buf_off += i;
  (void)((ctx->buf_off <= (int)sizeof(ctx->buf)) ? 0 : (OpenSSLDie("evp/bio_b64.c", 381, "ctx->buf_off <= (int)sizeof(ctx->buf)"),1));
  (void)((ctx->buf_len >= ctx->buf_off) ? 0 : (OpenSSLDie("evp/bio_b64.c", 382, "ctx->buf_len >= ctx->buf_off"),1));
  n -= i;
 }
...
# 389 "evp/bio_b64.c"
 ...
 while (inl > 0) {
  ...
  if (BIO_test_flags(b, ~(0x0)) & 0x100) {
   if (ctx->tmp_len > 0) {
    (void)((ctx->tmp_len <= 3) ? 0 : (OpenSSLDie("evp/bio_b64.c", 397, "ctx->tmp_len <= 3"),1));
    n = 3 - ctx->tmp_len;
    ...
    (void)((ctx->buf_len <= (int)sizeof(ctx->buf)) ? 0 : (OpenSSLDie(
                             "evp/bio_b64.c"
# 410 "evp/bio_b64.c"
    ,
                             411
# 410 "evp/bio_b64.c"
    , "ctx->buf_len <= (int)sizeof(ctx->buf)"),1))
                              ;
    (void)((ctx->buf_len >= ctx->buf_off) ? 0 : (OpenSSLDie("evp/bio_b64.c", 412, "ctx->buf_len >= ctx->buf_off"),1));
...
# 427 "evp/bio_b64.c"
    , "ctx->buf_len <= (int)sizeof(ctx->buf)"),1))
                              ;
    (void)((ctx->buf_len >= ctx->buf_off) ? 0 : (OpenSSLDie("evp/bio_b64.c", 429, "ctx->buf_len >= ctx->buf_off"),1));
    ret += n;
   }
  } else {
   EVP_EncodeUpdate(&(ctx->base64),
       (unsigned char *)ctx->buf, &ctx->buf_len,
       (unsigned char *)in, n);
   (void)((ctx->buf_len <= (int)sizeof(ctx->buf)) ? 0 : (OpenSSLDie("evp/bio_b64.c", 436, "ctx->buf_len <= (int)sizeof(ctx->buf)"),1));
   (void)((ctx->buf_len >= ctx->buf_off) ? 0 : (OpenSSLDie("evp/bio_b64.c", 437, "ctx->buf_len >= ctx->buf_off"),1));
   ret += n;
  }
  inl -= n;
  in += n;
  ...
  while (n > 0) {
   ...
   (void)((i <= n) ? 0 : (OpenSSLDie("evp/bio_b64.c", 451, "i <= n"),1));
   n -= i;
   ctx->buf_off += i;
   (void)((ctx->buf_off <= (int)sizeof(ctx->buf)) ? 0 : (OpenSSLDie("evp/bio_b64.c", 454, "ctx->buf_off <= (int)sizeof(ctx->buf)"),1));
   (void)((ctx->buf_len >= ctx->buf_off) ? 0 : (OpenSSLDie("evp/bio_b64.c", 455, "ctx->buf_len >= ctx->buf_off"),1));
  }
  ctx->buf_len = 0;
  ctx->buf_off = 0;
 }
...
b64_ctrl(BIO *b, int cmd, long num, void *ptr)
{
 ...
 case 2:
  ...
  break;
 case 13:
  (void)((ctx->buf_len >= ctx->buf_off) ? 0 : (OpenSSLDie("evp/bio_b64.c", 486, "ctx->buf_len >= ctx->buf_off"),1));
  ret = ctx->buf_len - ctx->buf_off;
  if ((ret == 0) && (ctx->encode != 0) &&
      (ctx->base64.num != 0))
   ret = 1;
  else if (ret <= 0)
   ret = BIO_ctrl(b->next_bio, cmd, num, ptr);
  break;
 case 10:
  (void)((ctx->buf_len >= ctx->buf_off) ? 0 : (OpenSSLDie("evp/bio_b64.c", 495, "ctx->buf_len >= ctx->buf_off"),1));
  ret = ctx->buf_len - ctx->buf_off;
  if (ret <= 0)
   ret = BIO_ctrl(b->next_bio, cmd, num, ptr);
  break;
...
# 504 "evp/bio_b64.c"
  ...
  } else if (ctx->encode != 0 && ctx->base64.num != 0) {
   ctx->buf_off = 0;
