...
# 102 "bn/bn_kron.c"
 if (BN_is_zero(B)) {
  ret = ((((A)->top == 1) && ((A)->d[0] == (unsigned long)(1))) || (((1) == 0) && ((A)->top == 0)));
  goto end;
 }



 if (!(((A)->top > 0) && ((A)->d[0] & 1)) && !(((B)->top > 0) && ((B)->d[0] & 1))) {
  ret = 0;
  goto end;
 }
 ...
 if (i & 1) {
  ...
  ret = tab[(((A)->top == 0) ? (unsigned long) 0 : (A)->d[0]) & 7];
 } else {
 ...
 while (1) {
  ...
  if (BN_is_zero(A)) {
   ret = ((((((B))->top == 1) && (((B))->d[0] == (unsigned long)(1))) || (((1) == 0) && (((B))->top == 0))) && !(B)->neg) ? ret : 0;
   goto end;
  }
  ...
  if (i & 1) {
   ...
   ret = ret * tab[(((B)->top == 0) ? (unsigned long) 0 : (B)->d[0]) & 7];
  }



  if ((A->neg ? ~(((A)->top == 0) ? (unsigned long) 0 : (A)->d[0]) : (((A)->top == 0) ? (unsigned long) 0 : (A)->d[0])) & (((B)->top == 0) ? (unsigned long) 0 : (B)->d[0]) & 2)
   ret = -ret;
