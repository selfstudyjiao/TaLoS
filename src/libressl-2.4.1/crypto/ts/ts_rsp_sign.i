...
err:
 ERR_put_error(47,(110),((1|64)),"ts/ts_rsp_sign.c",106);
 TS_RESP_CTX_set_status_info(ctx, 2,
     "Error during serial number generation.");
 return 
# 109 "ts/ts_rsp_sign.c" 3 4
       ((void *)0)
# 109 "ts/ts_rsp_sign.c"
           ;
}
...
def_time_cb(struct TS_resp_ctx *ctx, void *data, time_t *sec, long *usec)
{
 ...
 if (gettimeofday(&tv, 
# 118 "ts/ts_rsp_sign.c" 3 4
                      ((void *)0)
# 118 "ts/ts_rsp_sign.c"
                          ) != 0) {
  ERR_put_error(47,(111),(122),"ts/ts_rsp_sign.c",119);
  TS_RESP_CTX_set_status_info(ctx, 2,
...
def_extension_cb(struct TS_resp_ctx *ctx, X509_EXTENSION *ext, void *data)
{
 ...
 TS_RESP_CTX_add_failure_info(ctx, 16);
 return 0;
}
...
TS_RESP_CTX_new(void)
{
 ...
 if (!(ctx = calloc(1, sizeof(TS_RESP_CTX)))) {
  ERR_put_error(47,(127),((1|64)),"ts/ts_rsp_sign.c",150);
  return 
# 151 "ts/ts_rsp_sign.c" 3 4
        ((void *)0)
# 151 "ts/ts_rsp_sign.c"
            ;
 }
...
TS_RESP_CTX_free(TS_RESP_CTX *ctx)
{
 ...
 sk_pop_free(((_STACK*) (1 ? (ctx->certs) : (struct stack_st_X509*)0)), ((void (*)(void *)) ((1 ? (X509_free) : (void (*)(X509 *))0))));
 sk_pop_free(((_STACK*) (1 ? (ctx->policies) : (struct stack_st_ASN1_OBJECT*)0)), ((void (*)(void *)) ((1 ? (ASN1_OBJECT_free) : (void (*)(ASN1_OBJECT *))0))));
 ASN1_OBJECT_free(ctx->default_policy);
 sk_free(((_STACK*) (1 ? (ctx->mds) : (struct stack_st_EVP_MD*)0)));
...
{
 if (X509_check_purpose(signer, 9, 0) != 1) {
  ERR_put_error(47,(131),(117),"ts/ts_rsp_sign.c",185)
                                              ;
  return 0;
 }
 X509_free(ctx->signer_cert);
 ctx->signer_cert = signer;
 CRYPTO_add_lock(&ctx->signer_cert->references,+1,3,"ts/ts_rsp_sign.c",190);
 return 1;
}
...
TS_RESP_CTX_set_signer_key(TS_RESP_CTX *ctx, EVP_PKEY *key)
{
 EVP_PKEY_free(ctx->signer_key);
 ctx->signer_key = key;
 CRYPTO_add_lock(&ctx->signer_key->references,+1,10,"ts/ts_rsp_sign.c",199);
...
err:
 ERR_put_error(47,(130),((1|64)),"ts/ts_rsp_sign.c",214);
 return 0;
}

int
TS_RESP_CTX_set_certs(TS_RESP_CTX *ctx, struct stack_st_X509 *certs)
{
 int i;
 ...
 if (ctx->certs) {
  sk_pop_free(((_STACK*) (1 ? (ctx->certs) : (struct stack_st_X509*)0)), ((void (*)(void *)) ((1 ? (X509_free) : (void (*)(X509 *))0))));
  ctx->certs = 
# 225 "ts/ts_rsp_sign.c" 3 4
              ((void *)0)
# 225 "ts/ts_rsp_sign.c"
                  ;
 }
 if (!certs)
  return 1;
 if (!(ctx->certs = (struct stack_st_X509 *)sk_dup(((_STACK*) (1 ? certs : (struct stack_st_X509*)0))))) {
  ERR_put_error(47,(129),((1|64)),"ts/ts_rsp_sign.c",230);
  return 0;
 }
 for (i = 0; i < sk_num(((_STACK*) (1 ? (ctx->certs) : (struct stack_st_X509*)0))); ++i) {
  X509 *cert = ((X509 *)sk_value(((_STACK*) (1 ? (ctx->certs) : (struct stack_st_X509*)0)), (i)));
  CRYPTO_add_lock(&cert->references,+1,3,"ts/ts_rsp_sign.c",235);
 }
...
{
 ASN1_OBJECT *copy = 
# 244 "ts/ts_rsp_sign.c" 3 4
                    ((void *)0)
# 244 "ts/ts_rsp_sign.c"
                        ;


 if (!ctx->policies && !(ctx->policies = ((struct stack_st_ASN1_OBJECT *)sk_new_null())))
  goto err;
 if (!(copy = OBJ_dup(policy)))
  goto err;
 if (!sk_push(((_STACK*) (1 ? (ctx->policies) : (struct stack_st_ASN1_OBJECT*)0)), ((void*) (1 ? (copy) : (ASN1_OBJECT*)0))))
  goto err;

 return 1;

err:
 ERR_put_error(47,(126),((1|64)),"ts/ts_rsp_sign.c",257);
...
TS_RESP_CTX_add_md(TS_RESP_CTX *ctx, const EVP_MD *md)
{
 ...
 if (!ctx->mds && !(ctx->mds = ((struct stack_st_EVP_MD *)sk_new_null())))
  goto err;

 if (!sk_push(((_STACK*) (1 ? (ctx->mds) : (struct stack_st_EVP_MD*)0)), ((void*) (1 ? ((EVP_MD *)md) : (EVP_MD*)0))))
  goto err;

 return 1;

err:
 ERR_put_error(47,(125),((1|64)),"ts/ts_rsp_sign.c",275);
 return 0;
}
# 287 "ts/ts_rsp_sign.c"
int
TS_RESP_CTX_set_accuracy(TS_RESP_CTX *ctx, int secs, int millis, int micros)
{
 ASN1_INTEGER_free(ctx->seconds); ctx->seconds = 
# 290 "ts/ts_rsp_sign.c" 3 4
((void *)0)
# 290 "ts/ts_rsp_sign.c"
; ASN1_INTEGER_free(ctx->millis); ctx->millis = 
# 290 "ts/ts_rsp_sign.c" 3 4
((void *)0)
# 290 "ts/ts_rsp_sign.c"
; ASN1_INTEGER_free(ctx->micros); ctx->micros = 
# 290 "ts/ts_rsp_sign.c" 3 4
((void *)0)
# 290 "ts/ts_rsp_sign.c"
;;
...
err:
 ASN1_INTEGER_free(ctx->seconds); ctx->seconds = 
# 304 "ts/ts_rsp_sign.c" 3 4
((void *)0)
# 304 "ts/ts_rsp_sign.c"
; ASN1_INTEGER_free(ctx->millis); ctx->millis = 
# 304 "ts/ts_rsp_sign.c" 3 4
((void *)0)
# 304 "ts/ts_rsp_sign.c"
...
# 304 "ts/ts_rsp_sign.c"
;;
 ERR_put_error(47,(128),((1|64)),"ts/ts_rsp_sign.c",305);
 return 0;
}
...
{
 TS_STATUS_INFO *si = 
# 332 "ts/ts_rsp_sign.c" 3 4
                     ((void *)0)
# 332 "ts/ts_rsp_sign.c"
                         ;
 ASN1_UTF8STRING *utf8_text = 
# 333 "ts/ts_rsp_sign.c" 3 4
                             ((void *)0)
# 333 "ts/ts_rsp_sign.c"
                                 ;
 int ret = 0;
 ...
 if (text) {
  if (!(utf8_text = ASN1_UTF8STRING_new()) ||
   ...
   goto err;
  if (!si->text && !(si->text = ((struct stack_st_ASN1_UTF8STRING *)sk_new_null())))
   goto err;
  if (!sk_push(((_STACK*) (1 ? (si->text) : (struct stack_st_ASN1_UTF8STRING*)0)), ((void*) (1 ? (utf8_text) : (ASN1_UTF8STRING*)0))))
   goto err;
  utf8_text = 
# 348 "ts/ts_rsp_sign.c" 3 4
             ((void *)0)
# 348 "ts/ts_rsp_sign.c"
                 ;
 }
...
err:
 if (!ret)
  ERR_put_error(47,(132),((1|64)),"ts/ts_rsp_sign.c",356);
...
TS_RESP_CTX_set_status_info_cond(TS_RESP_CTX *ctx, int status, const char *text)
{
 ...
 if (ASN1_INTEGER_get(si->status) == 0) {
...
err:
 ERR_put_error(47,(124),((1|64)),"ts/ts_rsp_sign.c",387);
 return 0;
}
...
TS_RESP_create_response(TS_RESP_CTX *ctx, BIO *req_bio)
{
 ...
 if (!(ctx->response = TS_RESP_new())) {
  ERR_put_error(47,(122),((1|64)),"ts/ts_rsp_sign.c",424);
  goto end;
 }


 if (!(ctx->request = d2i_TS_REQ_bio(req_bio, 
# 429 "ts/ts_rsp_sign.c" 3 4
                                             ((void *)0)
# 429 "ts/ts_rsp_sign.c"
                                                 ))) {
  TS_RESP_CTX_set_status_info(ctx, 2,
      "Bad request format or "
      "system error.");
  TS_RESP_CTX_add_failure_info(ctx, 5);
  goto end;
 }


 if (!TS_RESP_CTX_set_status_info(ctx, 0, 
# 438 "ts/ts_rsp_sign.c" 3 4
                                                         ((void *)0)
# 438 "ts/ts_rsp_sign.c"
                                                             ))
  goto end;
 ...
 if (!result) {
  ERR_put_error(47,(122),(121),"ts/ts_rsp_sign.c",466);
  if (ctx->response != 
# 467 "ts/ts_rsp_sign.c" 3 4
                      ((void *)0)
# 467 "ts/ts_rsp_sign.c"
                          ) {
   if (TS_RESP_CTX_set_status_info_cond(ctx,
    ...
    ctx->response = 
# 472 "ts/ts_rsp_sign.c" 3 4
                   ((void *)0)
# 472 "ts/ts_rsp_sign.c"
                       ;
   }
  }
 }
 ...
 ctx->response = 
# 477 "ts/ts_rsp_sign.c" 3 4
                ((void *)0)
# 477 "ts/ts_rsp_sign.c"
                    ;
...
{
 ctx->request = 
# 486 "ts/ts_rsp_sign.c" 3 4
               ((void *)0)
# 486 "ts/ts_rsp_sign.c"
                   ;
 ctx->response = 
# 487 "ts/ts_rsp_sign.c" 3 4
                ((void *)0)
# 487 "ts/ts_rsp_sign.c"
                    ;
 ctx->tst_info = 
# 488 "ts/ts_rsp_sign.c" 3 4
                ((void *)0)
# 488 "ts/ts_rsp_sign.c"
                    ;
}
...
TS_RESP_CTX_cleanup(TS_RESP_CTX *ctx)
{
 ...
 ctx->request = 
# 496 "ts/ts_rsp_sign.c" 3 4
               ((void *)0)
# 496 "ts/ts_rsp_sign.c"
                   ;
 TS_RESP_free(ctx->response);
 ctx->response = 
# 498 "ts/ts_rsp_sign.c" 3 4
                ((void *)0)
# 498 "ts/ts_rsp_sign.c"
                    ;
 TS_TST_INFO_free(ctx->tst_info);
 ctx->tst_info = 
# 500 "ts/ts_rsp_sign.c" 3 4
                ((void *)0)
# 500 "ts/ts_rsp_sign.c"
                    ;
}
...
TS_RESP_check_request(TS_RESP_CTX *ctx)
{
 ...
 EVP_MD *md = 
# 512 "ts/ts_rsp_sign.c" 3 4
             ((void *)0)
# 512 "ts/ts_rsp_sign.c"
                 ;
 int i;
 ...
 if (TS_REQ_get_version(request) != 1) {
  TS_RESP_CTX_set_status_info(ctx, 2,
      "Bad request version.");
  TS_RESP_CTX_add_failure_info(ctx, 2);
  return 0;
 }
 ...
 for (i = 0; !md && i < sk_num(((_STACK*) (1 ? (ctx->mds) : (struct stack_st_EVP_MD*)0))); ++i) {
  EVP_MD *current_md = ((EVP_MD *)sk_value(((_STACK*) (1 ? (ctx->mds) : (struct stack_st_EVP_MD*)0)), (i)));
 ...
 if (!md) {
  TS_RESP_CTX_set_status_info(ctx, 2,
      ...
      "not supported.");
  TS_RESP_CTX_add_failure_info(ctx, 0);
  return 0;
 }
...
TS_RESP_get_policy(TS_RESP_CTX *ctx)
{
 ...
 ASN1_OBJECT *policy = 
# 566 "ts/ts_rsp_sign.c" 3 4
                      ((void *)0)
# 566 "ts/ts_rsp_sign.c"
                          ;
 int i;

 if (ctx->default_policy == 
# 569 "ts/ts_rsp_sign.c" 3 4
                           ((void *)0)
# 569 "ts/ts_rsp_sign.c"
                               ) {
  ERR_put_error(47,(133),(102),"ts/ts_rsp_sign.c",570);
  return 
# 571 "ts/ts_rsp_sign.c" 3 4
        ((void *)0)
# 571 "ts/ts_rsp_sign.c"
            ;
 }
 ...
 for (i = 0; !policy && i < sk_num(((_STACK*) (1 ? (ctx->policies) : (struct stack_st_ASN1_OBJECT*)0))); ++i) {
  ASN1_OBJECT *current = ((ASN1_OBJECT *)sk_value(((_STACK*) (1 ? (ctx->policies) : (struct stack_st_ASN1_OBJECT*)0)), (i)));
  if (!OBJ_cmp(requested, current))
   policy = current;
 }
 if (!policy) {
  ERR_put_error(47,(133),(125),"ts/ts_rsp_sign.c",585);
  TS_RESP_CTX_set_status_info(ctx, 2,
      "Requested policy is not "
      "supported.");
  TS_RESP_CTX_add_failure_info(ctx, 15);
 }
 return policy;
}
...
TS_RESP_create_tst_info(TS_RESP_CTX *ctx, ASN1_OBJECT *policy)
{
 int result = 0;
 TS_TST_INFO *tst_info = 
# 599 "ts/ts_rsp_sign.c" 3 4
                        ((void *)0)
# 599 "ts/ts_rsp_sign.c"
                            ;
 ASN1_INTEGER *serial = 
# 600 "ts/ts_rsp_sign.c" 3 4
                       ((void *)0)
# 600 "ts/ts_rsp_sign.c"
                           ;
 ASN1_GENERALIZEDTIME *asn1_time = 
# 601 "ts/ts_rsp_sign.c" 3 4
                                  ((void *)0)
# 601 "ts/ts_rsp_sign.c"
                                      ;
 time_t sec;
 long usec;
 TS_ACCURACY *accuracy = 
# 604 "ts/ts_rsp_sign.c" 3 4
                        ((void *)0)
# 604 "ts/ts_rsp_sign.c"
                            ;
 const ASN1_INTEGER *nonce;
 GENERAL_NAME *tsa_name = 
# 606 "ts/ts_rsp_sign.c" 3 4
                         ((void *)0)
# 606 "ts/ts_rsp_sign.c"
                             ;
...
# 620 "ts/ts_rsp_sign.c" 3 4
                                                     ((void *)0)
# 620 "ts/ts_rsp_sign.c"
                                                         , sec, usec,
 ...
 if ((nonce = TS_REQ_get_nonce(ctx->request)) != 
# 645 "ts/ts_rsp_sign.c" 3 4
                                                ((void *)0) 
# 645 "ts/ts_rsp_sign.c"
                                                     &&
 ...
 if (!result) {
  ...
  tst_info = 
# 667 "ts/ts_rsp_sign.c" 3 4
            ((void *)0)
# 667 "ts/ts_rsp_sign.c"
                ;
  ERR_put_error(47,(123),(123),"ts/ts_rsp_sign.c",668);
  TS_RESP_CTX_set_status_info_cond(ctx, 2,
...
{
 struct stack_st_X509_EXTENSION *exts = TS_REQ_get_exts(ctx->request);
 int i;
 int ok = 1;

 for (i = 0; ok && i < sk_num(((_STACK*) (1 ? (exts) : (struct stack_st_X509_EXTENSION*)0))); ++i) {
  ...
  ok = (*ctx->extension_cb)(ctx, ext, 
# 698 "ts/ts_rsp_sign.c" 3 4
                                     ((void *)0)
# 698 "ts/ts_rsp_sign.c"
                                         );
 }
...
TS_RESP_sign(TS_RESP_CTX *ctx)
{
 int ret = 0;
 PKCS7 *p7 = 
# 709 "ts/ts_rsp_sign.c" 3 4
            ((void *)0)
# 709 "ts/ts_rsp_sign.c"
                ;
 PKCS7_SIGNER_INFO *si;
 struct stack_st_X509 *certs;
 ESS_SIGNING_CERT *sc = 
# 712 "ts/ts_rsp_sign.c" 3 4
                       ((void *)0)
# 712 "ts/ts_rsp_sign.c"
                           ;
 ASN1_OBJECT *oid;
 BIO *p7bio = 
# 714 "ts/ts_rsp_sign.c" 3 4
             ((void *)0)
# 714 "ts/ts_rsp_sign.c"
                 ;
 int i;


 if (!X509_check_private_key(ctx->signer_cert, ctx->signer_key)) {
  ERR_put_error(47,(136),(120),"ts/ts_rsp_sign.c",720)
                                                  ;
  goto err;
 }
 ...
 if (!(p7 = PKCS7_new())) {
  ERR_put_error(47,(136),((1|64)),"ts/ts_rsp_sign.c",726);
  goto err;
 }
 if (!PKCS7_set_type(p7, 22))
  goto err;
 ...
 if (!(si = PKCS7_add_signature(p7, ctx->signer_cert,
  ...
  ERR_put_error(47,(136),(118),"ts/ts_rsp_sign.c",750);
  goto err;
 }


 oid = OBJ_nid2obj(207);
 if (!PKCS7_add_signed_attribute(si, 50,
     6, oid)) {
  ERR_put_error(47,(136),(119),"ts/ts_rsp_sign.c",758);
  goto err;
 }



 certs = ctx->flags & 0x04 ? ctx->certs : 
# 764 "ts/ts_rsp_sign.c" 3 4
                                                         ((void *)0)
# 764 "ts/ts_rsp_sign.c"
                                                             ;
 ...
 if (!ESS_add_signing_cert(si, sc)) {
  ERR_put_error(47,(136),(116),"ts/ts_rsp_sign.c",770);
  goto err;
 }
...
# 779 "ts/ts_rsp_sign.c" 3 4
                                 ((void *)0)
# 779 "ts/ts_rsp_sign.c"
                                     ))) {
  ERR_put_error(47,(136),((1|64)),"ts/ts_rsp_sign.c",780);
  goto err;
 }


 if (!i2d_TS_TST_INFO_bio(p7bio, ctx->tst_info)) {
  ERR_put_error(47,(136),(124),"ts/ts_rsp_sign.c",786);
  goto err;
 }


 if (!PKCS7_dataFinal(p7, p7bio)) {
  ERR_put_error(47,(136),(124),"ts/ts_rsp_sign.c",792);
  goto err;
 }
 ...
 p7 = 
# 798 "ts/ts_rsp_sign.c" 3 4
     ((void *)0)
# 798 "ts/ts_rsp_sign.c"
         ;
 ctx->tst_info = 
# 799 "ts/ts_rsp_sign.c" 3 4
                ((void *)0)
# 799 "ts/ts_rsp_sign.c"
                    ;
...
ESS_SIGNING_CERT_new_init(X509 *signcert, struct stack_st_X509 *certs)
{
 ESS_CERT_ID *cid;
 ESS_SIGNING_CERT *sc = 
# 818 "ts/ts_rsp_sign.c" 3 4
                       ((void *)0)
# 818 "ts/ts_rsp_sign.c"
                           ;
 int i;
 ...
 if (!(sc = ESS_SIGNING_CERT_new()))
  goto err;
 if (!sc->cert_ids && !(sc->cert_ids = ((struct stack_st_ESS_CERT_ID *)sk_new_null())))
  goto err;


 if (!(cid = ESS_CERT_ID_new_init(signcert, 0)) ||
     !sk_push(((_STACK*) (1 ? (sc->cert_ids) : (struct stack_st_ESS_CERT_ID*)0)), ((void*) (1 ? (cid) : (ESS_CERT_ID*)0))))
  goto err;

 for (i = 0; i < sk_num(((_STACK*) (1 ? (certs) : (struct stack_st_X509*)0))); ++i) {
  X509 *cert = ((X509 *)sk_value(((_STACK*) (1 ? (certs) : (struct stack_st_X509*)0)), (i)));
...
err:
 ESS_SIGNING_CERT_free(sc);
 ERR_put_error(47,(114),((1|64)),"ts/ts_rsp_sign.c",843);
 return 
# 844 "ts/ts_rsp_sign.c" 3 4
       ((void *)0)
# 844 "ts/ts_rsp_sign.c"
           ;
}
...
{
 ESS_CERT_ID *cid = 
# 850 "ts/ts_rsp_sign.c" 3 4
                   ((void *)0)
# 850 "ts/ts_rsp_sign.c"
                       ;
 GENERAL_NAME *name = 
# 851 "ts/ts_rsp_sign.c" 3 4
                     ((void *)0)
# 851 "ts/ts_rsp_sign.c"
                         ;
 ...
 if (issuer_needed) {
  ...
  if (!(name->d.dirn = X509_NAME_dup(cert->cert_info->issuer)))
   goto err;
  if (!sk_push(((_STACK*) (1 ? (cid->issuer_serial->issuer) : (struct stack_st_GENERAL_NAME*)0)), ((void*) (1 ? (name) : (GENERAL_NAME*)0))))
   goto err;
  name = 
# 876 "ts/ts_rsp_sign.c" 3 4
        ((void *)0)
# 876 "ts/ts_rsp_sign.c"
            ;
...
err:
 ...
 ERR_put_error(47,(113),((1|64)),"ts/ts_rsp_sign.c",889);
 return 
# 890 "ts/ts_rsp_sign.c" 3 4
       ((void *)0)
# 890 "ts/ts_rsp_sign.c"
           ;
}
...
{
 PKCS7 *ret = 
# 896 "ts/ts_rsp_sign.c" 3 4
             ((void *)0)
# 896 "ts/ts_rsp_sign.c"
                 ;
 ASN1_OCTET_STRING *octet_string = 
# 897 "ts/ts_rsp_sign.c" 3 4
                                  ((void *)0)
# 897 "ts/ts_rsp_sign.c"
                                      ;
 ...
 if (!(ret->d.other = ASN1_TYPE_new()))
  goto err;
 ret->type = OBJ_nid2obj(207);
 if (!(octet_string = ASN1_OCTET_STRING_new()))
  goto err;
 ASN1_TYPE_set(ret->d.other, 4, octet_string);
 octet_string = 
# 908 "ts/ts_rsp_sign.c" 3 4
               ((void *)0)
# 908 "ts/ts_rsp_sign.c"
                   ;
...
{
 ASN1_STRING *seq = 
# 925 "ts/ts_rsp_sign.c" 3 4
                   ((void *)0)
# 925 "ts/ts_rsp_sign.c"
                       ;
 unsigned char *p, *pp = 
# 926 "ts/ts_rsp_sign.c" 3 4
                        ((void *)0)
# 926 "ts/ts_rsp_sign.c"
                            ;
 int len;

 len = i2d_ESS_SIGNING_CERT(sc, 
# 929 "ts/ts_rsp_sign.c" 3 4
                               ((void *)0)
# 929 "ts/ts_rsp_sign.c"
                                   );
 if (!(pp = malloc(len))) {
  ERR_put_error(47,(112),((1|64)),"ts/ts_rsp_sign.c",931);
  goto err;
 }
 p = pp;
 i2d_ESS_SIGNING_CERT(sc, &p);
 if (!(seq = ASN1_STRING_new()) || !ASN1_STRING_set(seq, pp, len)) {
  ERR_put_error(47,(112),((1|64)),"ts/ts_rsp_sign.c",937);
  goto err;
 }
 free(pp);
 pp = 
# 941 "ts/ts_rsp_sign.c" 3 4
     ((void *)0)
# 941 "ts/ts_rsp_sign.c"
         ;
...
{
 struct tm *tm = 
# 957 "ts/ts_rsp_sign.c" 3 4
                ((void *)0)
# 957 "ts/ts_rsp_sign.c"
                    ;
 char genTime_str[17 + 6];
 char usecstr[6 + 2];
 char *p;
 int rv;
 ...
 if (!(tm = gmtime(&sec)))
  goto err;
# 976 "ts/ts_rsp_sign.c"
 if (precision > 0) {
# 988 "ts/ts_rsp_sign.c"
...
err:
 ERR_put_error(47,(134),(115),"ts/ts_rsp_sign.c",1020);
 return 
# 1021 "ts/ts_rsp_sign.c" 3 4
       ((void *)0)
# 1021 "ts/ts_rsp_sign.c"
           ;
}
