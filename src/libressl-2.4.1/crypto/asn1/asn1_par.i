    ...
    int indent)
{
 ...
 else if ((xclass & 0x80) == 0x80)
  snprintf(str, sizeof str, "cont [ %d ]", tag);
 else if ((xclass & 0x40) == 0x40)
    ...
    int depth, int indent, int dump)
{
 ...
 int nl, hl, j, r;
 ASN1_OBJECT *o = 
# 124 "asn1/asn1_par.c" 3 4
                 ((void *)0)
# 124 "asn1/asn1_par.c"
                     ;
 ASN1_OCTET_STRING *os = 
# 125 "asn1/asn1_par.c" 3 4
                        ((void *)0)
# 125 "asn1/asn1_par.c"
                            ;
...
# 229 "asn1/asn1_par.c"
    ...
    opp = op;
    os = d2i_ASN1_OCTET_STRING(
# 242 "asn1/asn1_par.c" 3 4
                              ((void *)0)
# 242 "asn1/asn1_par.c"
                                  , &opp, len + hl);
    if (os != 
# 243 "asn1/asn1_par.c" 3 4
             ((void *)0) 
# 243 "asn1/asn1_par.c"
                  && os->length > 0) {
     opp = os->data;
...
# 290 "asn1/asn1_par.c"
    ...
    opp = op;
    bs = d2i_ASN1_INTEGER(
# 296 "asn1/asn1_par.c" 3 4
                         ((void *)0)
# 296 "asn1/asn1_par.c"
                             , &opp, len + hl);
    if (bs != 
# 297 "asn1/asn1_par.c" 3 4
             ((void *)0)
# 297 "asn1/asn1_par.c"
                 ) {
     if (BIO_write(bp, ":", 1) <= 0)
    ...
    opp = op;
    bs = d2i_ASN1_ENUMERATED(
# 322 "asn1/asn1_par.c" 3 4
                            ((void *)0)
# 322 "asn1/asn1_par.c"
                                , &opp, len + hl);
    if (bs != 
# 323 "asn1/asn1_par.c" 3 4
             ((void *)0)
# 323 "asn1/asn1_par.c"
                 ) {
     if (BIO_write(bp, ":", 1) <= 0)
