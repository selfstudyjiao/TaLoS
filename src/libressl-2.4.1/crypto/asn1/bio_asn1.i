...
asn1_bio_write(BIO *b, const char *in , int inl)
{
 ...
 if (!in || (inl < 0) || (b->next_bio == 
# 206 "asn1/bio_asn1.c" 3 4
                                        ((void *)0)
# 206 "asn1/bio_asn1.c"
                                            ))
  return 0;
