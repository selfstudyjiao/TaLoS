...
DH_check(const DH *dh, int *ret)
{
 int ok = 0;
 BN_CTX *ctx = 
# 78 "dh/dh_check.c" 3 4
              ((void *)0)
# 78 "dh/dh_check.c"
                  ;
 unsigned long l;
 BIGNUM *q = 
# 80 "dh/dh_check.c" 3 4
            ((void *)0)
# 80 "dh/dh_check.c"
                ;
...
# 84 "dh/dh_check.c"
 ...
 q = BN_new();
 if (q == 
# 87 "dh/dh_check.c" 3 4
         ((void *)0)
# 87 "dh/dh_check.c"
             )
  goto err;

 if (((((((dh->g))->top == 1) && (((dh->g))->d[0] == (unsigned long)((2)))) || ((((2)) == 0) && (((dh->g))->top == 0))) && (!(2) || !(dh->g)->neg))) {
  l = BN_mod_word(dh->p, 24);
  if (l != 11)
   *ret |= 0x08;
 } else if (((((((dh->g))->top == 1) && (((dh->g))->d[0] == (unsigned long)((5)))) || ((((5)) == 0) && (((dh->g))->top == 0))) && (!(5) || !(dh->g)->neg))) {
 ...
 if (!BN_is_prime_ex(dh->p, 0, ctx, 
# 101 "dh/dh_check.c" 3 4
                                                 ((void *)0)
# 101 "dh/dh_check.c"
                                                     ))
  *ret |= 0x01;
  ...
  if (!BN_rshift1(q, dh->p))
   goto err;
  if (!BN_is_prime_ex(q, 0, ctx, 
# 106 "dh/dh_check.c" 3 4
                                              ((void *)0)
# 106 "dh/dh_check.c"
                                                  ))
   *ret |= 0x02;
