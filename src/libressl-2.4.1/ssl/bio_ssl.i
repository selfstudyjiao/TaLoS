...
ssl_new(BIO *bi)
{
 ...
 if (bs == 
# 110 "../ssl/bio_ssl.c" 3 4
          ((void *)0)
# 110 "../ssl/bio_ssl.c"
              ) {
  ERR_put_error(32,(118),((1|64)),"../ssl/bio_ssl.c",111);
  return (0);
 }
 bi->init = 0;
 bi->ptr = (char *)bs;
...
# 288 "../ssl/bio_ssl.c"
 ...
 case 1:
  ...
  if (b->next_bio != 
# 301 "../ssl/bio_ssl.c" 3 4
                    ((void *)0)
# 301 "../ssl/bio_ssl.c"
                        )
   ret = BIO_ctrl(b->next_bio, cmd, num, ptr);
  else if (ssl->rbio != 
# 303 "../ssl/bio_ssl.c" 3 4
                       ((void *)0)
# 303 "../ssl/bio_ssl.c"
                           )
...
# 333 "../ssl/bio_ssl.c"
  ...
  if (bio != 
# 342 "../ssl/bio_ssl.c" 3 4
            ((void *)0)
# 342 "../ssl/bio_ssl.c"
                ) {
   if (b->next_bio != 
# 343 "../ssl/bio_ssl.c" 3 4
                     ((void *)0)
# 343 "../ssl/bio_ssl.c"
                         )
    BIO_push(bio, b->next_bio);
   b->next_bio = bio;
   CRYPTO_add_lock(&bio->references,1,21,"../ssl/bio_ssl.c",346);
  }
  b->init = 1;
  break;
 case 110:
  if (ptr != 
# 351 "../ssl/bio_ssl.c" 3 4
            ((void *)0)
# 351 "../ssl/bio_ssl.c"
                ) {
   sslp = (SSL **)ptr;
 ...
 case 10:
  ret = SSL_pending(ssl);
  if (ret == 0)
   ret = (int)BIO_ctrl(ssl->rbio,10,0,
# 369 "../ssl/bio_ssl.c" 3 4
        ((void *)0)
# 369 "../ssl/bio_ssl.c"
        );
  break;
 ...
 case 6:
  if ((b->next_bio != 
# 377 "../ssl/bio_ssl.c" 3 4
                     ((void *)0)
# 377 "../ssl/bio_ssl.c"
                         ) && (b->next_bio != ssl->rbio)) {
   SSL_set_bio(ssl, b->next_bio, b->next_bio);
   CRYPTO_add_lock(&b->next_bio->references,1,21,"../ssl/bio_ssl.c",379);
  }
  break;
 case 7:
  ...
  if (b == ptr) {
   ...
   if (b->next_bio != 
# 390 "../ssl/bio_ssl.c" 3 4
                     ((void *)0)
# 390 "../ssl/bio_ssl.c"
                         )
    CRYPTO_add_lock(&b->next_bio->references,-1,21,"../ssl/bio_ssl.c",391);
   ssl->wbio = 
# 392 "../ssl/bio_ssl.c" 3 4
              ((void *)0)
# 392 "../ssl/bio_ssl.c"
                  ;
   ssl->rbio = 
# 393 "../ssl/bio_ssl.c" 3 4
              ((void *)0)
# 393 "../ssl/bio_ssl.c"
                  ;
  }
 ...
 case 12:
  dbio = (BIO *)ptr;
  if (((BIO_SSL *)dbio->ptr)->ssl != 
# 422 "../ssl/bio_ssl.c" 3 4
                                    ((void *)0)
# 422 "../ssl/bio_ssl.c"
                                        )
  ...
  ret = (((BIO_SSL *)dbio->ptr)->ssl != 
# 433 "../ssl/bio_ssl.c" 3 4
                                       ((void *)0)
# 433 "../ssl/bio_ssl.c"
                                           );
  break;
...
# 497 "../ssl/bio_ssl.c" 3 4
                                       ((void *)0)
# 497 "../ssl/bio_ssl.c"
                                           )
  goto err;
 if ((ssl = BIO_new_ssl_connect(ctx)) == 
# 499 "../ssl/bio_ssl.c" 3 4
                                        ((void *)0)
# 499 "../ssl/bio_ssl.c"
                                            )
  goto err;
 if ((ret = BIO_push(buf, ssl)) == 
# 501 "../ssl/bio_ssl.c" 3 4
                                  ((void *)0)
# 501 "../ssl/bio_ssl.c"
                                      )
  goto err;
...
# 516 "../ssl/bio_ssl.c" 3 4
                                        ((void *)0)
# 516 "../ssl/bio_ssl.c"
                                            )
  goto err;
 if ((ssl = BIO_new_ssl(ctx, 1)) == 
# 518 "../ssl/bio_ssl.c" 3 4
                                   ((void *)0)
# 518 "../ssl/bio_ssl.c"
                                       )
  goto err;
 if ((ret = BIO_push(ssl, con)) == 
# 520 "../ssl/bio_ssl.c" 3 4
                                  ((void *)0)
# 520 "../ssl/bio_ssl.c"
                                      )
  goto err;
...
BIO_new_ssl(SSL_CTX *ctx, int client)
{
 ...
 if ((ret = BIO_new(BIO_f_ssl())) == 
# 536 "../ssl/bio_ssl.c" 3 4
                                    ((void *)0)
# 536 "../ssl/bio_ssl.c"
                                        )
  goto err;
 if ((ssl = SSL_new(ctx)) == 
# 538 "../ssl/bio_ssl.c" 3 4
                            ((void *)0)
# 538 "../ssl/bio_ssl.c"
                                )
  goto err;
 ...
 BIO_ctrl(ret,109,0x01,(char *)ssl);
 return (ret);

err:
 BIO_free(ret);
 return (
# 551 "../ssl/bio_ssl.c" 3 4
        ((void *)0)
# 551 "../ssl/bio_ssl.c"
            );
}
...
{
 t = BIO_find_type(t, (7|0x0200));
 f = BIO_find_type(f, (7|0x0200));
 if ((t == 
# 559 "../ssl/bio_ssl.c" 3 4
          ((void *)0)
# 559 "../ssl/bio_ssl.c"
              ) || (f == 
# 559 "../ssl/bio_ssl.c" 3 4
...
# 559 "../ssl/bio_ssl.c"
  ...
  return (0);
 if ((((BIO_SSL *)t->ptr)->ssl == 
# 561 "../ssl/bio_ssl.c" 3 4
                                 ((void *)0)
# 561 "../ssl/bio_ssl.c"
                                     ) ||
     (((BIO_SSL *)f->ptr)->ssl == 
# 562 "../ssl/bio_ssl.c" 3 4
                                 ((void *)0)
# 562 "../ssl/bio_ssl.c"
                                     ))
  return (0);
...
BIO_ssl_shutdown(BIO *b)
{
 ...
 while (b != 
# 573 "../ssl/bio_ssl.c" 3 4
            ((void *)0)
# 573 "../ssl/bio_ssl.c"
                ) {
  if (b->method->type == (7|0x0200)) {
   s = ((BIO_SSL *)b->ptr)->ssl;
   SSL_shutdown(s);
   break;
  }
