...
# 106 "asn1/f_enum.c"
 ...
 for (;;) {
  ...
  i -= again;
  if (i % 2 != 0) {
   ERR_put_error(13,(101),(145),"asn1/f_enum.c",154)
                                  ;
   goto err;
  }
  i /= 2;
  if (num + i > slen) {
   sp = realloc(s, num + i);
   if (sp == 
# 160 "asn1/f_enum.c" 3 4
            ((void *)0)
# 160 "asn1/f_enum.c"
                ) {
    ERR_put_error(13,(101),((1|64)),"asn1/f_enum.c",162)
                             ;
    goto err;
   }
   s = sp;
  ...
  for (j = 0; j < i; j++, k += 2) {
   for (n = 0; n < 2; n++) {
    ...
    if ((m >= '0') && (m <= '9'))
     ...
     ERR_put_error(13,(101),(141),"asn1/f_enum.c",179)
                                   ;
     goto err;
    }
    s[num + j] <<= 4;
...
err_sl:
 ERR_put_error(13,(101),(150),"asn1/f_enum.c",197);
err:
 free(s);
 return (ret);
}
