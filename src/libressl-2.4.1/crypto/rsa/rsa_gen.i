...
# 102 "rsa/rsa_gen.c" 3 4
                              ((void *)0)
# 102 "rsa/rsa_gen.c"
                                  )
  goto err;
 if ((r1 = BN_CTX_get(ctx)) == 
# 104 "rsa/rsa_gen.c" 3 4
                              ((void *)0)
# 104 "rsa/rsa_gen.c"
                                  )
  goto err;
 if ((r2 = BN_CTX_get(ctx)) == 
# 106 "rsa/rsa_gen.c" 3 4
                              ((void *)0)
# 106 "rsa/rsa_gen.c"
                                  )
  goto err;
 if ((r3 = BN_CTX_get(ctx)) == 
# 108 "rsa/rsa_gen.c" 3 4
                              ((void *)0)
# 108 "rsa/rsa_gen.c"
                                  )
  goto err;
 ...
 if (!rsa->n && ((rsa->n = BN_new()) == 
# 115 "rsa/rsa_gen.c" 3 4
                                       ((void *)0)
# 115 "rsa/rsa_gen.c"
                                           ))
  goto err;
 if (!rsa->d && ((rsa->d = BN_new()) == 
# 117 "rsa/rsa_gen.c" 3 4
                                       ((void *)0)
# 117 "rsa/rsa_gen.c"
                                           ))
  goto err;
 if (!rsa->e && ((rsa->e = BN_new()) == 
# 119 "rsa/rsa_gen.c" 3 4
                                       ((void *)0)
# 119 "rsa/rsa_gen.c"
                                           ))
  goto err;
 if (!rsa->p && ((rsa->p = BN_new()) == 
# 121 "rsa/rsa_gen.c" 3 4
                                       ((void *)0)
# 121 "rsa/rsa_gen.c"
                                           ))
  goto err;
 if (!rsa->q && ((rsa->q = BN_new()) == 
# 123 "rsa/rsa_gen.c" 3 4
                                       ((void *)0)
# 123 "rsa/rsa_gen.c"
                                           ))
  goto err;
 if (!rsa->dmp1 && ((rsa->dmp1 = BN_new()) == 
# 125 "rsa/rsa_gen.c" 3 4
                                             ((void *)0)
# 125 "rsa/rsa_gen.c"
                                                 ))
  goto err;
 if (!rsa->dmq1 && ((rsa->dmq1 = BN_new()) == 
# 127 "rsa/rsa_gen.c" 3 4
                                             ((void *)0)
# 127 "rsa/rsa_gen.c"
                                                 ))
  goto err;
 if (!rsa->iqmp && ((rsa->iqmp = BN_new()) == 
# 129 "rsa/rsa_gen.c" 3 4
                                             ((void *)0)
# 129 "rsa/rsa_gen.c"
                                                 ))
  goto err;
...
# 136 "rsa/rsa_gen.c"
  ...
  if (!BN_gcd(r1, r2, rsa->e, ctx))
   goto err;
  if (((((((r1))->top == 1) && (((r1))->d[0] == (unsigned long)(1))) || (((1) == 0) && (((r1))->top == 0))) && !(r1)->neg))
   break;
 ...
 for (;;) {
  ...
  do {
   if (!BN_generate_prime_ex(rsa->q, bitsq, 0, 
# 157 "rsa/rsa_gen.c" 3 4
                                              ((void *)0)
# 157 "rsa/rsa_gen.c"
                                                  , 
# 157 "rsa/rsa_gen.c" 3 4
...
# 157 "rsa/rsa_gen.c"
  ...
  if (degenerate == 3) {
   ok = 0;
   ERR_put_error(4,(129),(120),"rsa/rsa_gen.c",165)
                                ;
   goto err;
  }
 ...
 if (!(rsa->flags & 0x0100)) {
  pr0 = &local_r0;
  ((pr0)->d=(r0)->d, (pr0)->top=(r0)->top, (pr0)->dmax=(r0)->dmax, (pr0)->neg=(r0)->neg, (pr0)->flags=(((pr0)->flags & 0x01) | ((r0)->flags & ~0x01) | 0x02 | (0x04)));
 } else
  pr0 = r0;
...
err:
 if (ok == -1) {
  ERR_put_error(4,(129),(3),"rsa/rsa_gen.c",231);
  ok = 0;
 }
 if (ctx != 
# 234 "rsa/rsa_gen.c" 3 4
           ((void *)0)
# 234 "rsa/rsa_gen.c"
               ) {
  BN_CTX_end(ctx);
