...
BN_RECP_CTX_new(void)
{
 ...
 if ((ret = malloc(sizeof(BN_RECP_CTX))) == 
# 79 "bn/bn_recp.c" 3 4
                                           ((void *)0)
# 79 "bn/bn_recp.c"
                                               )
    ...
    BN_RECP_CTX *recp, BN_CTX *ctx)
{
 ...
 BN_CTX_start(ctx);
 if ((a = BN_CTX_get(ctx)) == 
# 119 "bn/bn_recp.c" 3 4
                             ((void *)0)
# 119 "bn/bn_recp.c"
                                 )
  goto err;
 if (y != 
# 121 "bn/bn_recp.c" 3 4
         ((void *)0)
# 121 "bn/bn_recp.c"
             ) {
  if (x == y) {
...
# 179 "bn/bn_recp.c"
 ...
 while (BN_ucmp(r, &(recp->N)) >= 0) {
  if (j++ > 2) {
   ERR_put_error(3,(130),(101),"bn/bn_recp.c",215);
   goto err;
  }
