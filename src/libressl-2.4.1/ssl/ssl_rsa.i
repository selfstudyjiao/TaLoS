...
{
 if (x == 
# 88 "../ssl/ssl_rsa.c" 3 4
         ((void *)0)
# 88 "../ssl/ssl_rsa.c"
             ) {
  ERR_put_error(20,(198),((3|64)),"../ssl/ssl_rsa.c",89);
  return (0);
 }
 if (!ssl_cert_inst(&ssl->cert)) {
  ERR_put_error(20,(198),((1|64)),"../ssl/ssl_rsa.c",93);
  return (0);
 }
...
# 105 "../ssl/ssl_rsa.c"
 ...
 if (in == 
# 108 "../ssl/ssl_rsa.c" 3 4
          ((void *)0)
# 108 "../ssl/ssl_rsa.c"
              ) {
  ERR_put_error(20,(200),(7),"../ssl/ssl_rsa.c",109);
  goto end;
 }

 if (BIO_ctrl(in,108, 0x01|0x02,(char *)file) <= 0) {
  ERR_put_error(20,(200),(2),"../ssl/ssl_rsa.c",114);
  goto end;
 }
 if (type == 2) {
  j = 13;
  x = d2i_X509_bio(in, 
# 119 "../ssl/ssl_rsa.c" 3 4
                      ((void *)0)
# 119 "../ssl/ssl_rsa.c"
                          );
 } else if (type == 1) {
...
# 122 "../ssl/ssl_rsa.c"
  ...
  ERR_put_error(20,(200),(124),"../ssl/ssl_rsa.c",126);
  goto end;
 }

 if (x == 
# 130 "../ssl/ssl_rsa.c" 3 4
         ((void *)0)
# 130 "../ssl/ssl_rsa.c"
             ) {
  ERR_put_error(20,(200),(j),"../ssl/ssl_rsa.c",131);
  goto end;
 }
...
SSL_use_certificate_ASN1(SSL *ssl, const unsigned char *d, int len)
{
 ...
 x = d2i_X509(
# 148 "../ssl/ssl_rsa.c" 3 4
             ((void *)0)
# 148 "../ssl/ssl_rsa.c"
                 , &d,(long)len);
 if (x == 
# 149 "../ssl/ssl_rsa.c" 3 4
         ((void *)0)
# 149 "../ssl/ssl_rsa.c"
             ) {
  ERR_put_error(20,(199),(13),"../ssl/ssl_rsa.c",150);
  return (0);
 }
...
SSL_use_RSAPrivateKey(SSL *ssl, RSA *rsa)
{
 ...
 if (rsa == 
# 165 "../ssl/ssl_rsa.c" 3 4
           ((void *)0)
# 165 "../ssl/ssl_rsa.c"
               ) {
  ERR_put_error(20,(204),((3|64)),"../ssl/ssl_rsa.c",166);
  return (0);
 }
 if (!ssl_cert_inst(&ssl->cert)) {
  ERR_put_error(20,(204),((1|64)),"../ssl/ssl_rsa.c",170);
  return (0);
 }
 if ((pkey = EVP_PKEY_new()) == 
# 173 "../ssl/ssl_rsa.c" 3 4
                               ((void *)0)
# 173 "../ssl/ssl_rsa.c"
                                   ) {
  ERR_put_error(20,(204),(6),"../ssl/ssl_rsa.c",174);
  return (0);
 }

 RSA_up_ref(rsa);
 EVP_PKEY_assign((pkey),6, (char *)(rsa));
...
ssl_set_pkey(CERT *c, EVP_PKEY *pkey)
{
 ...
 i = ssl_cert_type(
# 191 "../ssl/ssl_rsa.c" 3 4
                  ((void *)0)
# 191 "../ssl/ssl_rsa.c"
                      , pkey);
 if (i < 0) {
  ERR_put_error(20,(193),(247),"../ssl/ssl_rsa.c",193);
  return (0);
 }

 if (c->pkeys[i].x509 != 
# 197 "../ssl/ssl_rsa.c" 3 4
                        ((void *)0)
# 197 "../ssl/ssl_rsa.c"
                            ) {
  EVP_PKEY *pktmp;
...
# 214 "../ssl/ssl_rsa.c"
 ...
 CRYPTO_add_lock(&pkey->references,1,10,"../ssl/ssl_rsa.c",220);
...
# 233 "../ssl/ssl_rsa.c"
 ...
 in = BIO_new(BIO_s_file());
 if (in == 
# 236 "../ssl/ssl_rsa.c" 3 4
          ((void *)0)
# 236 "../ssl/ssl_rsa.c"
              ) {
  ERR_put_error(20,(206),(7),"../ssl/ssl_rsa.c",237);
  goto end;
 }

 if (BIO_ctrl(in,108, 0x01|0x02,(char *)file) <= 0) {
  ERR_put_error(20,(206),(2),"../ssl/ssl_rsa.c",242);
  goto end;
 }
 if (type == 2) {
  j = 13;
  rsa = d2i_RSAPrivateKey_bio(in, 
# 247 "../ssl/ssl_rsa.c" 3 4
                                 ((void *)0)
# 247 "../ssl/ssl_rsa.c"
                                     );
 } else if (type == 1) {
  j = 9;
  rsa = PEM_read_bio_RSAPrivateKey(in, 
# 250 "../ssl/ssl_rsa.c" 3 4
                                      ((void *)0)
# 250 "../ssl/ssl_rsa.c"
                                          ,
      ssl->ctx->default_passwd_callback,
  ...
  ERR_put_error(20,(206),(124),"../ssl/ssl_rsa.c",254);
  goto end;
 }
 if (rsa == 
# 257 "../ssl/ssl_rsa.c" 3 4
           ((void *)0)
# 257 "../ssl/ssl_rsa.c"
               ) {
  ERR_put_error(20,(206),(j),"../ssl/ssl_rsa.c",258);
  goto end;
 }
...
SSL_use_RSAPrivateKey_ASN1(SSL *ssl, unsigned char *d, long len)
{
 ...
 p = d;
 if ((rsa = d2i_RSAPrivateKey(
# 276 "../ssl/ssl_rsa.c" 3 4
                             ((void *)0)
# 276 "../ssl/ssl_rsa.c"
                                 , &p,(long)len)) == 
# 276 "../ssl/ssl_rsa.c" 3 4
...
# 276 "../ssl/ssl_rsa.c"
  ...
  ERR_put_error(20,(205),(13),"../ssl/ssl_rsa.c",277);
  return (0);
 }
...
SSL_use_PrivateKey(SSL *ssl, EVP_PKEY *pkey)
{
 ...
 if (pkey == 
# 300 "../ssl/ssl_rsa.c" 3 4
            ((void *)0)
# 300 "../ssl/ssl_rsa.c"
                ) {
  ERR_put_error(20,(201),((3|64)),"../ssl/ssl_rsa.c",301);
  return (0);
 }
 if (!ssl_cert_inst(&ssl->cert)) {
  ERR_put_error(20,(201),((1|64)),"../ssl/ssl_rsa.c",305);
  return (0);
 }
 ret = ssl_set_pkey(ssl->cert, pkey);
 return (ret);
...
# 317 "../ssl/ssl_rsa.c"
 ...
 in = BIO_new(BIO_s_file());
 if (in == 
# 320 "../ssl/ssl_rsa.c" 3 4
          ((void *)0)
# 320 "../ssl/ssl_rsa.c"
              ) {
  ERR_put_error(20,(203),(7),"../ssl/ssl_rsa.c",321);
  goto end;
 }

 if (BIO_ctrl(in,108, 0x01|0x02,(char *)file) <= 0) {
  ERR_put_error(20,(203),(2),"../ssl/ssl_rsa.c",326);
  goto end;
 }
 if (type == 1) {
  j = 9;
  pkey = PEM_read_bio_PrivateKey(in, 
# 331 "../ssl/ssl_rsa.c" 3 4
                                    ((void *)0)
# 331 "../ssl/ssl_rsa.c"
                                        ,
      ssl->ctx->default_passwd_callback,
  ...
  j = 13;
  pkey = d2i_PrivateKey_bio(in, 
# 336 "../ssl/ssl_rsa.c" 3 4
                               ((void *)0)
# 336 "../ssl/ssl_rsa.c"
                                   );
 } else {
  ERR_put_error(20,(203),(124),"../ssl/ssl_rsa.c",338);
  goto end;
 }
 if (pkey == 
# 341 "../ssl/ssl_rsa.c" 3 4
            ((void *)0)
# 341 "../ssl/ssl_rsa.c"
                ) {
  ERR_put_error(20,(203),(j),"../ssl/ssl_rsa.c",342);
  goto end;
 }
...
SSL_use_PrivateKey_ASN1(int type, SSL *ssl, const unsigned char *d, long len)
{
 ...
 p = d;
 if ((pkey = d2i_PrivateKey(type, 
# 360 "../ssl/ssl_rsa.c" 3 4
                                 ((void *)0)
# 360 "../ssl/ssl_rsa.c"
                                     , &p,(long)len)) == 
# 360 "../ssl/ssl_rsa.c" 3 4
...
# 360 "../ssl/ssl_rsa.c"
  ...
  ERR_put_error(20,(202),(13),"../ssl/ssl_rsa.c",361);
  return (0);
 }
...
{
 if (x == 
# 373 "../ssl/ssl_rsa.c" 3 4
         ((void *)0)
# 373 "../ssl/ssl_rsa.c"
             ) {
  ERR_put_error(20,(171),((3|64)),"../ssl/ssl_rsa.c",374);
  return (0);
 }
 if (!ssl_cert_inst(&ctx->cert)) {
  ERR_put_error(20,(171),((1|64)),"../ssl/ssl_rsa.c",378);
  return (0);
 }
...
ssl_set_cert(CERT *c, X509 *x)
{
 ...
 if (pkey == 
# 395 "../ssl/ssl_rsa.c" 3 4
            ((void *)0)
# 395 "../ssl/ssl_rsa.c"
                ) {
  ERR_put_error(20,(191),(268),"../ssl/ssl_rsa.c",396);
  return (0);
 }

 i = ssl_cert_type(x, pkey);
 if (i < 0) {
  ERR_put_error(20,(191),(247),"../ssl/ssl_rsa.c",402);
  EVP_PKEY_free(pkey);
  return (0);
 }

 if (c->pkeys[i].privatekey != 
# 407 "../ssl/ssl_rsa.c" 3 4
                              ((void *)0)
# 407 "../ssl/ssl_rsa.c"
                                  ) {
  ...
  if ((c->pkeys[i].privatekey->type == 6) &&
...
# 428 "../ssl/ssl_rsa.c"
 ...
 X509_free(c->pkeys[i].x509);
 CRYPTO_add_lock(&x->references,1,3,"../ssl/ssl_rsa.c",437);
 c->pkeys[i].x509 = x;
 c->key = &(c->pkeys[i]);
...
# 456 "../ssl/ssl_rsa.c"
 ...
 in = BIO_new(BIO_s_file());
 if (in == 
# 459 "../ssl/ssl_rsa.c" 3 4
          ((void *)0)
# 459 "../ssl/ssl_rsa.c"
              ) {
  ERR_put_error(20,(173),(7),"../ssl/ssl_rsa.c",460);
  goto end;
 }

 if (BIO_ctrl(in,108, 0x01|0x02,(char *)file) <= 0) {
  ERR_put_error(20,(173),(2),"../ssl/ssl_rsa.c",465);
  goto end;
 }
 if (type == 2) {
  j = 13;
  x = d2i_X509_bio(in, 
# 470 "../ssl/ssl_rsa.c" 3 4
                      ((void *)0)
# 470 "../ssl/ssl_rsa.c"
                          );
 } else if (type == 1) {
  j = 9;
  x = PEM_read_bio_X509(in, 
# 473 "../ssl/ssl_rsa.c" 3 4
                           ((void *)0)
# 473 "../ssl/ssl_rsa.c"
                               , ctx->default_passwd_callback,
      ctx->default_passwd_callback_userdata);
 } else {
  ERR_put_error(20,(173),(124),"../ssl/ssl_rsa.c",476);
  goto end;
 }

 if (x == 
# 480 "../ssl/ssl_rsa.c" 3 4
         ((void *)0)
# 480 "../ssl/ssl_rsa.c"
             ) {
  ERR_put_error(20,(173),(j),"../ssl/ssl_rsa.c",481);
  goto end;
 }
...
SSL_CTX_use_certificate_ASN1(SSL_CTX *ctx, int len, const unsigned char *d)
{
 ...
 x = d2i_X509(
# 498 "../ssl/ssl_rsa.c" 3 4
             ((void *)0)
# 498 "../ssl/ssl_rsa.c"
                 , &d,(long)len);
 if (x == 
# 499 "../ssl/ssl_rsa.c" 3 4
         ((void *)0)
# 499 "../ssl/ssl_rsa.c"
             ) {
  ERR_put_error(20,(172),(13),"../ssl/ssl_rsa.c",500);
  return (0);
 }
...
SSL_CTX_use_RSAPrivateKey(SSL_CTX *ctx, RSA *rsa)
{
 ...
 if (rsa == 
# 515 "../ssl/ssl_rsa.c" 3 4
           ((void *)0)
# 515 "../ssl/ssl_rsa.c"
               ) {
  ERR_put_error(20,(177),((3|64)),"../ssl/ssl_rsa.c",516);
  return (0);
 }
 if (!ssl_cert_inst(&ctx->cert)) {
  ERR_put_error(20,(177),((1|64)),"../ssl/ssl_rsa.c",520);
  return (0);
 }
 if ((pkey = EVP_PKEY_new()) == 
# 523 "../ssl/ssl_rsa.c" 3 4
                               ((void *)0)
# 523 "../ssl/ssl_rsa.c"
                                   ) {
  ERR_put_error(20,(177),(6),"../ssl/ssl_rsa.c",524);
  return (0);
 }
...
# 541 "../ssl/ssl_rsa.c"
 ...
 in = BIO_new(BIO_s_file());
 if (in == 
# 544 "../ssl/ssl_rsa.c" 3 4
          ((void *)0)
# 544 "../ssl/ssl_rsa.c"
              ) {
  ERR_put_error(20,(179),(7),"../ssl/ssl_rsa.c",545);
  goto end;
 }

 if (BIO_ctrl(in,108, 0x01|0x02,(char *)file) <= 0) {
  ERR_put_error(20,(179),(2),"../ssl/ssl_rsa.c",550);
  goto end;
 }
 if (type == 2) {
  j = 13;
  rsa = d2i_RSAPrivateKey_bio(in, 
# 555 "../ssl/ssl_rsa.c" 3 4
                                 ((void *)0)
# 555 "../ssl/ssl_rsa.c"
                                     );
 } else if (type == 1) {
...
# 558 "../ssl/ssl_rsa.c"
  ...
  ERR_put_error(20,(179),(124),"../ssl/ssl_rsa.c",562);
  goto end;
 }
 if (rsa == 
# 565 "../ssl/ssl_rsa.c" 3 4
           ((void *)0)
# 565 "../ssl/ssl_rsa.c"
               ) {
  ERR_put_error(20,(179),(j),"../ssl/ssl_rsa.c",566);
  goto end;
 }
...
# 584 "../ssl/ssl_rsa.c"
  ...
  ERR_put_error(20,(178),(13),"../ssl/ssl_rsa.c",585);
  return (0);
 }
...
{
 if (pkey == 
# 601 "../ssl/ssl_rsa.c" 3 4
            ((void *)0)
# 601 "../ssl/ssl_rsa.c"
                ) {
  ERR_put_error(20,(174),((3|64)),"../ssl/ssl_rsa.c",603)
                                  ;
  return (0);
 }
 if (!ssl_cert_inst(&ctx->cert)) {
  ERR_put_error(20,(174),((1|64)),"../ssl/ssl_rsa.c",607);
  return (0);
 }
...
# 623 "../ssl/ssl_rsa.c"
 ...
 in = BIO_new(BIO_s_file());
 if (in == 
# 626 "../ssl/ssl_rsa.c" 3 4
          ((void *)0)
# 626 "../ssl/ssl_rsa.c"
              ) {
  ERR_put_error(20,(176),(7),"../ssl/ssl_rsa.c",627);
  goto end;
 }

 if (BIO_ctrl(in,108, 0x01|0x02,(char *)file) <= 0) {
  ERR_put_error(20,(176),(2),"../ssl/ssl_rsa.c",632);
  goto end;
 }
 if (type == 1) {
  j = 9;
  pkey = PEM_read_bio_PrivateKey(in, 
# 637 "../ssl/ssl_rsa.c" 3 4
                                    ((void *)0)
# 637 "../ssl/ssl_rsa.c"
                                        ,
      ctx->default_passwd_callback,
  ...
  j = 13;
  pkey = d2i_PrivateKey_bio(in, 
# 642 "../ssl/ssl_rsa.c" 3 4
                               ((void *)0)
# 642 "../ssl/ssl_rsa.c"
                                   );
 } else {
  ERR_put_error(20,(176),(124),"../ssl/ssl_rsa.c",645)
                             ;
  goto end;
 }
 if (pkey == 
# 648 "../ssl/ssl_rsa.c" 3 4
            ((void *)0)
# 648 "../ssl/ssl_rsa.c"
                ) {
  ERR_put_error(20,(176),(j),"../ssl/ssl_rsa.c",649);
  goto end;
 }
...
# 668 "../ssl/ssl_rsa.c"
  ...
  ERR_put_error(20,(175),(13),"../ssl/ssl_rsa.c",669);
  return (0);
 }
...
# 688 "../ssl/ssl_rsa.c"
 ...
 x = PEM_read_bio_X509_AUX(in, 
# 692 "../ssl/ssl_rsa.c" 3 4
                              ((void *)0)
# 692 "../ssl/ssl_rsa.c"
                                  , ctx->default_passwd_callback,
     ctx->default_passwd_callback_userdata);
 if (x == 
# 694 "../ssl/ssl_rsa.c" 3 4
         ((void *)0)
# 694 "../ssl/ssl_rsa.c"
             ) {
  ERR_put_error(20,(220),(9),"../ssl/ssl_rsa.c",695);
  goto end;
 }
 ...
 if (ret) {
  ...
  if (ctx->extra_certs != 
# 713 "../ssl/ssl_rsa.c" 3 4
                         ((void *)0)
# 713 "../ssl/ssl_rsa.c"
                             ) {
   sk_pop_free(((_STACK*) (1 ? (ctx->extra_certs) : (struct stack_st_X509*)0)), ((void (*)(void *)) ((1 ? (X509_free) : (void (*)(X509 *))0))));
   ctx->extra_certs = 
# 715 "../ssl/ssl_rsa.c" 3 4
                     ((void *)0)
# 715 "../ssl/ssl_rsa.c"
                         ;
  }

  while ((ca = PEM_read_bio_X509(in, 
# 718 "../ssl/ssl_rsa.c" 3 4
                                    ((void *)0)
# 718 "../ssl/ssl_rsa.c"
                                        ,
      ctx->default_passwd_callback,
      ctx->default_passwd_callback_userdata)) != 
# 720 "../ssl/ssl_rsa.c" 3 4
                                                ((void *)0)
# 720 "../ssl/ssl_rsa.c"
                                                    ) {
   r = SSL_CTX_ctrl(ctx,14,0,(char *)ca);
   if (!r) {
    X509_free(ca);
    ret = 0;
    goto end;
...
SSL_CTX_use_certificate_chain_file(SSL_CTX *ctx, const char *file)
{
 ...
 in = BIO_new(BIO_s_file());
 if (in == 
# 760 "../ssl/ssl_rsa.c" 3 4
          ((void *)0)
# 760 "../ssl/ssl_rsa.c"
              ) {
  ERR_put_error(20,(220),(7),"../ssl/ssl_rsa.c",761);
  goto end;
 }

 if (BIO_ctrl(in,108, 0x01|0x02,(char *)file) <= 0) {
  ERR_put_error(20,(220),(2),"../ssl/ssl_rsa.c",766);
  goto end;
 }
...
SSL_CTX_use_certificate_chain_mem(SSL_CTX *ctx, void *buf, int len)
{
 ...
 if (in == 
# 784 "../ssl/ssl_rsa.c" 3 4
          ((void *)0)
# 784 "../ssl/ssl_rsa.c"
              ) {
  ERR_put_error(20,(220),(7),"../ssl/ssl_rsa.c",785);
  goto end;
 }
