...
ASN1_PCTX_new(void)
{
 ...
 if (ret == 
# 89 "asn1/tasn_prn.c" 3 4
           ((void *)0)
# 89 "asn1/tasn_prn.c"
               ) {
  ERR_put_error(13,(205),((1|64)),"asn1/tasn_prn.c",90);
  return 
# 91 "asn1/tasn_prn.c" 3 4
        ((void *)0)
# 91 "asn1/tasn_prn.c"
            ;
 }
    ...
    const char *fname, const char *sname, int nohdr, const ASN1_PCTX *pctx)
{
 ...
 if (aux && aux->asn1_cb) {
  ...
  asn1_cb = 
# 217 "asn1/tasn_prn.c" 3 4
           ((void *)0)
# 217 "asn1/tasn_prn.c"
               ;

 if (*fld == 
# 219 "asn1/tasn_prn.c" 3 4
            ((void *)0)
# 219 "asn1/tasn_prn.c"
                ) {
  if (pctx->flags & 0x001) {
    ...
    const ASN1_TEMPLATE *tt, const ASN1_PCTX *pctx)
{
 ...
 if (pctx->flags & 0x080)
  ...
  sname = 
# 344 "asn1/tasn_prn.c" 3 4
         ((void *)0)
# 344 "asn1/tasn_prn.c"
             ;
 if (pctx->flags & 0x040)
  fname = 
# 346 "asn1/tasn_prn.c" 3 4
         ((void *)0)
# 346 "asn1/tasn_prn.c"
             ;
 else
 ...
 if (flags & (0x3 << 1)) {
  char *tname;
  ASN1_VALUE *skitem;
  struct stack_st_ASN1_VALUE *stack;
  ...
  stack = (struct stack_st_ASN1_VALUE *)*fld;
  for (i = 0; i < sk_num(((_STACK*) (1 ? (stack) : (struct stack_st_ASN1_VALUE*)0))); i++) {
   if ((i > 0) && (BIO_puts(out, "\n") <= 0))
    return 0;
   skitem = ((ASN1_VALUE *)sk_value(((_STACK*) (1 ? (stack) : (struct stack_st_ASN1_VALUE*)0)), (i)));
   if (!asn1_item_print_ctx(out, &skitem, indent + 2,
       (tt->item), 
# 374 "asn1/tasn_prn.c" 3 4
                               ((void *)0)
# 374 "asn1/tasn_prn.c"
                                   , 
# 374 "asn1/tasn_prn.c" 3 4
    ...
    const ASN1_PCTX *pctx)
{
 ...
 if (pctx->flags & 0x100)
  sname = 
# 404 "asn1/tasn_prn.c" 3 4
         ((void *)0)
# 404 "asn1/tasn_prn.c"
             ;
 if (pctx->flags & 0x040)
  fname = 
# 406 "asn1/tasn_prn.c" 3 4
         ((void *)0)
# 406 "asn1/tasn_prn.c"
             ;
 if (!sname && !fname)
