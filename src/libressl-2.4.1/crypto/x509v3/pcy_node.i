...
struct stack_st_X509_POLICY_NODE *policy_node_cmp_new(void)
{
 return ((struct stack_st_X509_POLICY_NODE *)sk_new(((int (*)(const void *, const void *)) ((1 ? (node_cmp) : (int (*)(const X509_POLICY_NODE * const *, const X509_POLICY_NODE * const *))0)))));
}

X509_POLICY_NODE *
tree_find_sk(struct stack_st_X509_POLICY_NODE *nodes, const ASN1_OBJECT *id)
{
 X509_POLICY_DATA n;
 X509_POLICY_NODE l;
 int idx;
 ...
 idx = sk_find(((_STACK*) (1 ? (nodes) : (struct stack_st_X509_POLICY_NODE*)0)), ((void*) (1 ? (&l) : (X509_POLICY_NODE*)0)));
 if (idx == -1)
  return 
# 88 "x509v3/pcy_node.c" 3 4
        ((void *)0)
# 88 "x509v3/pcy_node.c"
            ;

 return ((X509_POLICY_NODE *)sk_value(((_STACK*) (1 ? (nodes) : (struct stack_st_X509_POLICY_NODE*)0)), (idx)));
}
    ...
    const ASN1_OBJECT *id)
{
 ...
 for (i = 0; i < sk_num(((_STACK*) (1 ? (level->nodes) : (struct stack_st_X509_POLICY_NODE*)0))); i++) {
  node = ((X509_POLICY_NODE *)sk_value(((_STACK*) (1 ? (level->nodes) : (struct stack_st_X509_POLICY_NODE*)0)), (i)));
 ...
 return 
# 107 "x509v3/pcy_node.c" 3 4
       ((void *)0)
# 107 "x509v3/pcy_node.c"
           ;
}
...
{
 X509_POLICY_NODE *node = 
# 115 "x509v3/pcy_node.c" 3 4
                         ((void *)0)
# 115 "x509v3/pcy_node.c"
                             ;
 ...
 if (level) {
  ...
  if (OBJ_obj2nid(data->valid_policy) == 746) {
   ...
   if (!level->nodes)
    goto node_error;
   if (!sk_push(((_STACK*) (1 ? (level->nodes) : (struct stack_st_X509_POLICY_NODE*)0)), ((void*) (1 ? (node) : (X509_POLICY_NODE*)0))))
    goto node_error;
   if (parent)
    parent->nchild++;
  }
 ...
 if (tree) {
  if (!tree->extra_data)
   tree->extra_data = ((struct stack_st_X509_POLICY_DATA *)sk_new_null());
  if (!tree->extra_data)
   goto node_error_cond;
  if (!sk_push(((_STACK*) (1 ? (tree->extra_data) : (struct stack_st_X509_POLICY_DATA*)0)), ((void*) (1 ? (data) : (X509_POLICY_DATA*)0))))
   goto node_error_cond;
 }
...
node_error_cond:
 if (level)
  node = 
# 159 "x509v3/pcy_node.c" 3 4
        ((void *)0)
# 159 "x509v3/pcy_node.c"
            ;
node_error:
 policy_node_free(node);
 node = 
# 162 "x509v3/pcy_node.c" 3 4
       ((void *)0)
# 162 "x509v3/pcy_node.c"
           ;
 if (nodep)
  *nodep = node;
 return 0;
    ...
    const ASN1_OBJECT *oid)
{
 ...
 for (i = 0; i < sk_num(((_STACK*) (1 ? (x->expected_policy_set) : (struct stack_st_ASN1_OBJECT*)0))); i++) {
  policy_oid = ((ASN1_OBJECT *)sk_value(((_STACK*) (1 ? (x->expected_policy_set) : (struct stack_st_ASN1_OBJECT*)0)), (i)));
