...
struct stack_st_EVP_PBE_CTL { _STACK stack; };
static struct stack_st_EVP_PBE_CTL *pbe_algs;
...
static const EVP_PBE_CTL builtin_pbe[] = {
 {0x0, 9, 31, 3, PKCS5_PBE_keyivgen},
 {0x0, 10, 31, 4, PKCS5_PBE_keyivgen},
 {0x0, 68, 166, 64, PKCS5_PBE_keyivgen},


 {0x0, 69, -1, -1, PKCS5_v2_PBKDF2_keyivgen},


 {0x0, 144, 5, 64, PKCS12_PBE_keyivgen},
 {0x0, 145, 97, 64, PKCS12_PBE_keyivgen},
 {0x0, 146, 44, 64, PKCS12_PBE_keyivgen},
 {0x0, 147, 43, 64, PKCS12_PBE_keyivgen},
 {0x0, 148, 37, 64, PKCS12_PBE_keyivgen},
 {0x0, 149, 98, 64, PKCS12_PBE_keyivgen},


 {0x0, 161, -1, -1, PKCS5_v2_PBE_keyivgen},

 {0x0, 168, 166, 3, PKCS5_PBE_keyivgen},
 {0x0, 169, 166, 4, PKCS5_PBE_keyivgen},
 {0x0, 170, 31, 64, PKCS5_PBE_keyivgen},
    ...
    ASN1_TYPE *param, EVP_CIPHER_CTX *ctx, int en_de)
{
 ...
 if (!EVP_PBE_find(0x0, OBJ_obj2nid(pbe_obj),
     &cipher_nid, &md_nid, &keygen)) {
  char obj_tmp[80];
  ERR_put_error(6,(116),(121),"evp/evp_pbe.c",131);
  if (!pbe_obj)
 ...
 if (cipher_nid == -1)
  cipher = 
# 146 "evp/evp_pbe.c" 3 4
          ((void *)0)
# 146 "evp/evp_pbe.c"
              ;
 else {
  cipher = EVP_get_cipherbyname(OBJ_nid2sn(cipher_nid));
  if (!cipher) {
   ERR_put_error(6,(116),(160),"evp/evp_pbe.c",150);
   return 0;
  }
 }
...
# 156 "evp/evp_pbe.c"
  ...
  if (!md) {
   ERR_put_error(6,(116),(161),"evp/evp_pbe.c",160);
   return 0;
  }
 }

 if (!keygen(ctx, pass, passlen, param, cipher, md, en_de)) {
  ERR_put_error(6,(116),(120),"evp/evp_pbe.c",166);
  return 0;
 }
 return 1;
}

static int pbe2_cmp_BSEARCH_CMP_FN(const void *, const void *); static int pbe2_cmp(EVP_PBE_CTL const *, EVP_PBE_CTL const *); static EVP_PBE_CTL * OBJ_bsearch_pbe2(EVP_PBE_CTL *key, EVP_PBE_CTL const *base, int num);
    ...
    EVP_PBE_KEYGEN *keygen)
{
 ...
 if (pbe_algs == 
# 206 "evp/evp_pbe.c" 3 4
                ((void *)0)
# 206 "evp/evp_pbe.c"
                    ) {
  pbe_algs = ((struct stack_st_EVP_PBE_CTL *)sk_new(((int (*)(const void *, const void *)) ((1 ? (pbe_cmp) : (int (*)(const EVP_PBE_CTL * const *, const EVP_PBE_CTL * const *))0)))));
  if (pbe_algs == 
# 208 "evp/evp_pbe.c" 3 4
                 ((void *)0)
# 208 "evp/evp_pbe.c"
                     ) {
   ERR_put_error(6,(160),((1|64)),"evp/evp_pbe.c",210)
                            ;
   return 0;
  }
 }
 ...
 if (pbe_tmp == 
# 215 "evp/evp_pbe.c" 3 4
               ((void *)0)
# 215 "evp/evp_pbe.c"
                   ) {
  ERR_put_error(6,(160),((1|64)),"evp/evp_pbe.c",216);
  return 0;
 }
 ...
 if (sk_push(((_STACK*) (1 ? (pbe_algs) : (struct stack_st_EVP_PBE_CTL*)0)), ((void*) (1 ? (pbe_tmp) : (EVP_PBE_CTL*)0))) == 0) {
  free(pbe_tmp);
  ERR_put_error(6,(160),((1|64)),"evp/evp_pbe.c",227);
  return 0;
 }
 return 1;
}
    ...
    EVP_PBE_KEYGEN *keygen)
{
 ...
 return EVP_PBE_alg_add_type(0x0, nid,
     cipher_nid, md_nid, keygen);
}
...
# 256 "evp/evp_pbe.c"
 ...
 if (pbe_algs) {
  i = sk_find(((_STACK*) (1 ? (pbe_algs) : (struct stack_st_EVP_PBE_CTL*)0)), ((void*) (1 ? (&pbelu) : (EVP_PBE_CTL*)0)));
  if (i != -1)
   pbetmp = ((EVP_PBE_CTL *)sk_value(((_STACK*) (1 ? (pbe_algs) : (struct stack_st_EVP_PBE_CTL*)0)), (i)));
 }
 if (pbetmp == 
# 269 "evp/evp_pbe.c" 3 4
              ((void *)0)
# 269 "evp/evp_pbe.c"
                  ) {
...
{
 sk_pop_free(((_STACK*) (1 ? (pbe_algs) : (struct stack_st_EVP_PBE_CTL*)0)), ((void (*)(void *)) ((1 ? (free_evp_pbe_ctl) : (void (*)(EVP_PBE_CTL *))0))));
 pbe_algs = 
# 294 "evp/evp_pbe.c" 3 4
           ((void *)0)
# 294 "evp/evp_pbe.c"
               ;
}
