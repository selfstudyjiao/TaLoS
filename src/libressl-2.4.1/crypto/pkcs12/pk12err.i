...
PKCS7 *PKCS12_pack_p7encdata(int pbe_nid, const char *pass, int passlen,
    unsigned char *salt, int saltlen, int iter, struct stack_st_PKCS12_SAFEBAG *bags);
...
static ERR_STRING_DATA PKCS12_str_functs[]= {
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)129)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PARSE_BAG"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)103)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PARSE_BAGS"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)100)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKCS12_ADD_FRIENDLYNAME"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)127)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKCS12_add_friendlyname_asc"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)102)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKCS12_add_friendlyname_uni"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)104)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKCS12_add_localkeyid"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)105)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKCS12_create"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)107)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKCS12_gen_mac"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)109)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKCS12_init"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)106)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKCS12_item_decrypt_d2i"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)108)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKCS12_item_i2d_encrypt"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)117)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKCS12_item_pack_safebag"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)110)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKCS12_key_gen_asc"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)111)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKCS12_key_gen_uni"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)112)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKCS12_MAKE_KEYBAG"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)113)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKCS12_MAKE_SHKEYBAG"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)128)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKCS12_newpass"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)114)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKCS12_pack_p7data"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)115)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKCS12_pack_p7encdata"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)118)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKCS12_parse"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)119)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKCS12_pbe_crypt"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)120)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKCS12_PBE_keyivgen"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)122)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKCS12_setup_mac"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)123)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKCS12_set_mac"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)130)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKCS12_unpack_authsafes"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)131)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKCS12_unpack_p7data"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)126)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKCS12_verify_mac"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)124)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKCS8_add_keyusage"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)125)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKCS8_encrypt"},
 {0, 
# 104 "pkcs12/pk12err.c" 3 4
    ((void *)0)
# 104 "pkcs12/pk12err.c"
        }
};

static ERR_STRING_DATA PKCS12_str_reasons[]= {
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)100)&0xfffL))), "cant pack structure"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)121)&0xfffL))), "content type not data"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)101)&0xfffL))) , "decode error"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)102)&0xfffL))) , "encode error"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)103)&0xfffL))) , "encrypt error"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)120)&0xfffL))), "error setting encrypted data type"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)104)&0xfffL))), "invalid null argument"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)105)&0xfffL))), "invalid null pkcs12 pointer"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)106)&0xfffL))) , "iv gen error"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)107)&0xfffL))) , "key gen error"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)108)&0xfffL))) , "mac absent"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)109)&0xfffL))), "mac generation error"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)110)&0xfffL))) , "mac setup error"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)111)&0xfffL))), "mac string set error"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)112)&0xfffL))) , "mac verify error"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)113)&0xfffL))) , "mac verify failure"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)114)&0xfffL))) , "parse error"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)115)&0xfffL))), "pkcs12 algor cipherinit error"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)116)&0xfffL))), "pkcs12 cipherfinal error"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)117)&0xfffL))), "pkcs12 pbe crypt error"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)118)&0xfffL))), "unknown digest algorithm"},
 {(((((unsigned long)35)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)119)&0xfffL))), "unsupported pkcs12 mode"},
 {0, 
# 130 "pkcs12/pk12err.c" 3 4
    ((void *)0)
# 130 "pkcs12/pk12err.c"
        }
};
...
ERR_load_PKCS12_strings(void)
{
 ...
 if (ERR_func_error_string(PKCS12_str_functs[0].error) == 
# 139 "pkcs12/pk12err.c" 3 4
                                                         ((void *)0)
# 139 "pkcs12/pk12err.c"
                                                             ) {
