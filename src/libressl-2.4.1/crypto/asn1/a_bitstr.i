...
# 142 "asn1/a_bitstr.c"
  ...
  if ((ret = ASN1_BIT_STRING_new()) == 
# 143 "asn1/a_bitstr.c" 3 4
                                      ((void *)0)
# 143 "asn1/a_bitstr.c"
                                          )
   return (
# 144 "asn1/a_bitstr.c" 3 4
          ((void *)0)
# 144 "asn1/a_bitstr.c"
              );
 } else
 ...
 ret->flags&= ~(0x08|0x07);
 ret->flags|=(0x08|(i&0x07));

 if (len-- > 1)
 {
  s = malloc(len);
  if (s == 
# 159 "asn1/a_bitstr.c" 3 4
          ((void *)0)
# 159 "asn1/a_bitstr.c"
              ) {
   i = (1|64);
...
err:
 ERR_put_error(13,(189),(i),"asn1/a_bitstr.c",179);
 if ((ret != 
# 180 "asn1/a_bitstr.c" 3 4
            ((void *)0)
# 180 "asn1/a_bitstr.c"
                ) && ((a == 
# 180 "asn1/a_bitstr.c" 3 4
...
# 199 "asn1/a_bitstr.c"
 ...
 if ((a->length < (w + 1)) || (a->data == 
# 204 "asn1/a_bitstr.c" 3 4
                                         ((void *)0)
# 204 "asn1/a_bitstr.c"
                                             )) {
  if (!value)
   return(1);
  c = CRYPTO_realloc_clean(a->data,a->length,w + 1,"asn1/a_bitstr.c",207);
  if (c == 
# 208 "asn1/a_bitstr.c" 3 4
          ((void *)0)
# 208 "asn1/a_bitstr.c"
              ) {
   ERR_put_error(13,(183),((1|64)),"asn1/a_bitstr.c",209);
   return 0;
  }
  if (w + 1 - a->length > 0)
