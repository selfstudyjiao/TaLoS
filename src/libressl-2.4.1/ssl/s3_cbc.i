...
constant_time_eq_8(unsigned a, unsigned b)
{
 unsigned c = a ^ b;
 c--;
 return ((unsigned char)(((unsigned)((int)(c) >> (sizeof(int) * 8 - 1)))));
}
# 115 "../ssl/s3_cbc.c"
int
    ...
    unsigned mac_size)
{
 ...
 if (EVP_CIPHER_flags(s->enc_read_ctx->cipher) & 0x200000) {
...
# 154 "../ssl/s3_cbc.c"
 ...
 good = ((unsigned)((int)(good) >> (sizeof(int) * 8 - 1)));
    ...
    unsigned md_size, unsigned orig_len)
{
 ...
 unsigned char rotated_mac_buf[64 + 64];
 ...
 (void)((orig_len >= md_size) ? 0 : (OpenSSLDie("../ssl/s3_cbc.c", 223, "orig_len >= md_size"),1));
 (void)((md_size <= 64) ? 0 : (OpenSSLDie("../ssl/s3_cbc.c", 224, "md_size <= EVP_MAX_MD_SIZE"),1));
...
{
 MD5_CTX *md5 = ctx;
 (*((md_out)++)=(unsigned char)(md5->A), *((md_out)++)=(unsigned char)(md5->A>>8), *((md_out)++)=(unsigned char)(md5->A>>16), *((md_out)++)=(unsigned char)(md5->A>>24));
 (*((md_out)++)=(unsigned char)(md5->B), *((md_out)++)=(unsigned char)(md5->B>>8), *((md_out)++)=(unsigned char)(md5->B>>16), *((md_out)++)=(unsigned char)(md5->B>>24));
 (*((md_out)++)=(unsigned char)(md5->C), *((md_out)++)=(unsigned char)(md5->C>>8), *((md_out)++)=(unsigned char)(md5->C>>16), *((md_out)++)=(unsigned char)(md5->C>>24));
 (*((md_out)++)=(unsigned char)(md5->D), *((md_out)++)=(unsigned char)(md5->D>>8), *((md_out)++)=(unsigned char)(md5->D>>16), *((md_out)++)=(unsigned char)(md5->D>>24));
}
...
{
 SHA_CTX *sha1 = ctx;
 (*((md_out)++)=(unsigned char)(((sha1->h0)>>24)&0xff), *((md_out)++)=(unsigned char)(((sha1->h0)>>16)&0xff), *((md_out)++)=(unsigned char)(((sha1->h0)>> 8)&0xff), *((md_out)++)=(unsigned char)(((sha1->h0) )&0xff));
 (*((md_out)++)=(unsigned char)(((sha1->h1)>>24)&0xff), *((md_out)++)=(unsigned char)(((sha1->h1)>>16)&0xff), *((md_out)++)=(unsigned char)(((sha1->h1)>> 8)&0xff), *((md_out)++)=(unsigned char)(((sha1->h1) )&0xff));
 (*((md_out)++)=(unsigned char)(((sha1->h2)>>24)&0xff), *((md_out)++)=(unsigned char)(((sha1->h2)>>16)&0xff), *((md_out)++)=(unsigned char)(((sha1->h2)>> 8)&0xff), *((md_out)++)=(unsigned char)(((sha1->h2) )&0xff));
 (*((md_out)++)=(unsigned char)(((sha1->h3)>>24)&0xff), *((md_out)++)=(unsigned char)(((sha1->h3)>>16)&0xff), *((md_out)++)=(unsigned char)(((sha1->h3)>> 8)&0xff), *((md_out)++)=(unsigned char)(((sha1->h3) )&0xff));
 (*((md_out)++)=(unsigned char)(((sha1->h4)>>24)&0xff), *((md_out)++)=(unsigned char)(((sha1->h4)>>16)&0xff), *((md_out)++)=(unsigned char)(((sha1->h4)>> 8)&0xff), *((md_out)++)=(unsigned char)(((sha1->h4) )&0xff));
}
...
tls1_sha256_final_raw(void* ctx, unsigned char *md_out)
{
 ...
 for (i = 0; i < 8; i++) {
  (*((md_out)++)=(unsigned char)(((sha256->h[i])>>24)&0xff), *((md_out)++)=(unsigned char)(((sha256->h[i])>>16)&0xff), *((md_out)++)=(unsigned char)(((sha256->h[i])>> 8)&0xff), *((md_out)++)=(unsigned char)(((sha256->h[i]) )&0xff));
 }
}
...
tls1_sha512_final_raw(void* ctx, unsigned char *md_out)
{
 ...
 for (i = 0; i < 8; i++) {
  (*((md_out)++)=(unsigned char)(((sha512->h[i])>>56)&0xff), *((md_out)++)=(unsigned char)(((sha512->h[i])>>48)&0xff), *((md_out)++)=(unsigned char)(((sha512->h[i])>>40)&0xff), *((md_out)++)=(unsigned char)(((sha512->h[i])>>32)&0xff), *((md_out)++)=(unsigned char)(((sha512->h[i])>>24)&0xff), *((md_out)++)=(unsigned char)(((sha512->h[i])>>16)&0xff), *((md_out)++)=(unsigned char)(((sha512->h[i])>> 8)&0xff), *((md_out)++)=(unsigned char)(((sha512->h[i]) )&0xff));
 }
}
...
{
 switch (EVP_MD_type(EVP_MD_CTX_md(ctx))) {
 case 4:
 case 64:
 case 675:
 case 672:
...
{
 union { double align;
  unsigned char c[sizeof(SHA512_CTX)];
 } md_state;
 ...
 unsigned char first_block[128];
 unsigned char mac_out[64];
 ...
 (void)((data_plus_mac_plus_padding_size < 1024*1024) ? 0 : (OpenSSLDie("../ssl/s3_cbc.c", 402, "data_plus_mac_plus_padding_size < 1024*1024"),1));
 ...
 default:
  ...
  (void)((0) ? 0 : (OpenSSLDie("../ssl/s3_cbc.c", 451, "0"),1));
  if (md_out_size)
   *md_out_size = 0;
  return 0;
 }

 (void)((md_length_size <= 16) ? 0 : (OpenSSLDie("../ssl/s3_cbc.c", 457, "md_length_size <= MAX_HASH_BIT_COUNT_BYTES"),1));
 (void)((md_block_size <= 128) ? 0 : (OpenSSLDie("../ssl/s3_cbc.c", 458, "md_block_size <= MAX_HASH_BLOCK_SIZE"),1));
 (void)((md_size <= 64) ? 0 : (OpenSSLDie("../ssl/s3_cbc.c", 459, "md_size <= EVP_MAX_MD_SIZE"),1));
...
# 485 "../ssl/s3_cbc.c"
 ...
 if (!is_sslv3) {
  ...
  (void)((mac_secret_length <= sizeof(hmac_pad)) ? 0 : (OpenSSLDie("../ssl/s3_cbc.c", 535, "mac_secret_length <= sizeof(hmac_pad)"),1));
 ...
 if (!EVP_DigestInit_ex(&md_ctx, ctx->digest, 
# 631 "../ssl/s3_cbc.c" 3 4
                                             ((void *)0) 
# 631 "../ssl/s3_cbc.c"
                                                              )) {
