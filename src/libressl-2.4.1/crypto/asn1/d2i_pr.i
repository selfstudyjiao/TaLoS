...
# 81 "asn1/d2i_pr.c"
  ...
  if ((ret = EVP_PKEY_new()) == 
# 82 "asn1/d2i_pr.c" 3 4
                               ((void *)0)
# 82 "asn1/d2i_pr.c"
                                   ) {
   ERR_put_error(13,(154),(6),"asn1/d2i_pr.c",83);
   return (
# 84 "asn1/d2i_pr.c" 3 4
          ((void *)0)
# 84 "asn1/d2i_pr.c"
              );
  }
...
# 91 "asn1/d2i_pr.c"
 ...
 if (!EVP_PKEY_set_type(ret, type)) {
  ERR_put_error(13,(154),(163),"asn1/d2i_pr.c",97);
  goto err;
 }
 ...
 if (!ret->ameth->old_priv_decode ||
  ...
  if (ret->ameth->priv_decode) {
   PKCS8_PRIV_KEY_INFO *p8 = 
# 104 "asn1/d2i_pr.c" 3 4
                            ((void *)0)
# 104 "asn1/d2i_pr.c"
                                ;
   p8 = d2i_PKCS8_PRIV_KEY_INFO(
# 105 "asn1/d2i_pr.c" 3 4
                               ((void *)0)
# 105 "asn1/d2i_pr.c"
                                   , pp, length);
   if (!p8)
   ...
   ERR_put_error(13,(154),(13),"asn1/d2i_pr.c",112);
   goto err;
  }
 }
 if (a != 
# 116 "asn1/d2i_pr.c" 3 4
         ((void *)0)
# 116 "asn1/d2i_pr.c"
             )
  (*a) = ret;
...
err:
 if (a == 
# 121 "asn1/d2i_pr.c" 3 4
         ((void *)0) 
# 121 "asn1/d2i_pr.c"
              || *a != ret)
  EVP_PKEY_free(ret);
 return (
# 123 "asn1/d2i_pr.c" 3 4
        ((void *)0)
# 123 "asn1/d2i_pr.c"
            );
}
...
{
 struct stack_st_ASN1_TYPE *inkey;
 const unsigned char *p;
 int keytype;
 ...
 inkey = d2i_ASN1_SEQUENCE_ANY(
# 140 "asn1/d2i_pr.c" 3 4
                              ((void *)0)
# 140 "asn1/d2i_pr.c"
                                  , &p, length);
 ...
 if (sk_num(((_STACK*) (1 ? (inkey) : (struct stack_st_ASN1_TYPE*)0))) == 6)
  keytype = 116;
 else if (sk_num(((_STACK*) (1 ? (inkey) : (struct stack_st_ASN1_TYPE*)0))) == 4)
  keytype = 408;
 else if (sk_num(((_STACK*) (1 ? (inkey) : (struct stack_st_ASN1_TYPE*)0))) == 3) {

  PKCS8_PRIV_KEY_INFO *p8 = d2i_PKCS8_PRIV_KEY_INFO(
      
# 151 "asn1/d2i_pr.c" 3 4
     ((void *)0)
# 151 "asn1/d2i_pr.c"
         , pp, length);
  EVP_PKEY *ret;

  sk_pop_free(((_STACK*) (1 ? (inkey) : (struct stack_st_ASN1_TYPE*)0)), ((void (*)(void *)) ((1 ? (ASN1_TYPE_free) : (void (*)(ASN1_TYPE *))0))));
  if (!p8) {
   ERR_put_error(13,(207),(167),"asn1/d2i_pr.c",157)
                                          ;
   return 
# 158 "asn1/d2i_pr.c" 3 4
         ((void *)0)
# 158 "asn1/d2i_pr.c"
             ;
  }
