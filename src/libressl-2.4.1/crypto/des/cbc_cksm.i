...
unsigned int DES_cbc_cksum(const unsigned char *in, DES_cblock *output,
         long length, DES_key_schedule *schedule,
         const_DES_cblock *ivec)
 {
 unsigned int tout0,tout1,tin0,tin1;
 long l=length;
 unsigned int tin[2];
 ...
 for (; l>0; l-=8)
  ...
  if (l >= 8)
   ...
   { in+=l; tin0=tin1=0; switch (l) { case 8: tin1 =((unsigned int)(*(--(in))))<<24L; case 7: tin1|=((unsigned int)(*(--(in))))<<16L; case 6: tin1|=((unsigned int)(*(--(in))))<< 8L; case 5: tin1|=((unsigned int)(*(--(in)))); case 4: tin0 =((unsigned int)(*(--(in))))<<24L; case 3: tin0|=((unsigned int)(*(--(in))))<<16L; case 2: tin0|=((unsigned int)(*(--(in))))<< 8L; case 1: tin0|=((unsigned int)(*(--(in)))); } };

  tin0^=tout0; tin[0]=tin0;
  tin1^=tout1; tin[1]=tin1;
  DES_encrypt1((unsigned int *)tin,schedule,1);

  tout0=tin[0];
  tout1=tin[1];
  }
 if (out != 
# 90 "des/cbc_cksm.c" 3 4
           ((void *)0)
# 90 "des/cbc_cksm.c"
               )
  {
