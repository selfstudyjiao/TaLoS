 ...
 *pclass = xclass;
 ...
 if (*plength > (omax - (p - *pp))) {
  ERR_put_error(13,(114),(155),"asn1/asn1_lib.c",151);
...
err:
 ERR_put_error(13,(114),(123),"asn1/asn1_lib.c",160);
 return (0x80);
}
...
# 387 "asn1/asn1_lib.c"
 ...
 if ((str->length < len) || (str->data == 
# 392 "asn1/asn1_lib.c" 3 4
                                         ((void *)0)
# 392 "asn1/asn1_lib.c"
                                             )) {
  unsigned char *tmp;
  ...
  if (tmp == 
# 404 "asn1/asn1_lib.c" 3 4
            ((void *)0)
# 404 "asn1/asn1_lib.c"
                ) {
   ERR_put_error(13,(186),((1|64)),"asn1/asn1_lib.c",405);
   return (0);
  }
  str->data = tmp;
 }
...
ASN1_STRING_type_new(int type)
{
 ...
 if (ret == 
# 440 "asn1/asn1_lib.c" 3 4
           ((void *)0)
# 440 "asn1/asn1_lib.c"
               ) {
  ERR_put_error(13,(130),((1|64)),"asn1/asn1_lib.c",441);
  return (
# 442 "asn1/asn1_lib.c" 3 4
         ((void *)0)
# 442 "asn1/asn1_lib.c"
             );
 }
...
{
 if (a == 
# 454 "asn1/asn1_lib.c" 3 4
         ((void *)0)
# 454 "asn1/asn1_lib.c"
             )
  return;
 if (a->data != 
# 456 "asn1/asn1_lib.c" 3 4
               ((void *)0) 
# 456 "asn1/asn1_lib.c"
                    && !(a->flags & 0x010)) {
