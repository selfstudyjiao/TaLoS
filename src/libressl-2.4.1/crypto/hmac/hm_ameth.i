...
# 115 "hmac/hm_ameth.c"
 ...
 if (ASN1_OCTET_STRING_set(os, *pder, derlen) == 0)
  goto err;
 if (EVP_PKEY_assign(pkey, 855, os) == 0)
  goto err;
 return 1;
