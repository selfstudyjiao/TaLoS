...
static ERR_STRING_DATA ECDH_str_functs[]= {
 {(((((unsigned long)43)&0xffL)<<24L)| ((((unsigned long)102)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "ECDH_CHECK"},
 {(((((unsigned long)43)&0xffL)<<24L)| ((((unsigned long)100)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "ECDH_compute_key"},
 {(((((unsigned long)43)&0xffL)<<24L)| ((((unsigned long)101)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "ECDH_DATA_new_method"},
 {0, 
# 78 "ecdh/ech_err.c" 3 4
    ((void *)0)
# 78 "ecdh/ech_err.c"
        }
};
...
static ERR_STRING_DATA ECDH_str_reasons[]= {
 {(((((unsigned long)43)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)102)&0xfffL))) , "KDF failed"},
 {(((((unsigned long)43)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)104)&0xfffL))), "key would be truncated"},
 {(((((unsigned long)43)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)103)&0xfffL))) , "non fips method"},
 {(((((unsigned long)43)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)100)&0xfffL))) , "no private value"},
 {(((((unsigned long)43)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)101)&0xfffL))), "point arithmetic failure"},
 {0, 
# 87 "ecdh/ech_err.c" 3 4
    ((void *)0)
# 87 "ecdh/ech_err.c"
        }
};
...
ERR_load_ECDH_strings(void)
{
 ...
 if (ERR_func_error_string(ECDH_str_functs[0].error) == 
# 96 "ecdh/ech_err.c" 3 4
                                                       ((void *)0)
# 96 "ecdh/ech_err.c"
                                                           ) {
