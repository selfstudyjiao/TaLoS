...
ec_GFp_mont_group_init(EC_GROUP * group)
{
 ...
 group->field_data1 = 
# 122 "ec/ecp_mont.c" 3 4
                     ((void *)0)
# 122 "ec/ecp_mont.c"
                         ;
 group->field_data2 = 
# 123 "ec/ecp_mont.c" 3 4
                     ((void *)0)
# 123 "ec/ecp_mont.c"
                         ;
 return ok;
...
ec_GFp_mont_group_finish(EC_GROUP * group)
{
 ...
 group->field_data1 = 
# 132 "ec/ecp_mont.c" 3 4
                     ((void *)0)
# 132 "ec/ecp_mont.c"
                         ;
 BN_free(group->field_data2);
 group->field_data2 = 
# 134 "ec/ecp_mont.c" 3 4
                     ((void *)0)
# 134 "ec/ecp_mont.c"
                         ;
...
ec_GFp_mont_group_clear_finish(EC_GROUP * group)
{
 BN_MONT_CTX_free(group->field_data1);
 group->field_data1 = 
# 143 "ec/ecp_mont.c" 3 4
                     ((void *)0)
# 143 "ec/ecp_mont.c"
                         ;
 BN_clear_free(group->field_data2);
 group->field_data2 = 
# 145 "ec/ecp_mont.c" 3 4
                     ((void *)0)
# 145 "ec/ecp_mont.c"
                         ;
...
ec_GFp_mont_group_copy(EC_GROUP * dest, const EC_GROUP * src)
{
 ...
 dest->field_data1 = 
# 154 "ec/ecp_mont.c" 3 4
                    ((void *)0)
# 154 "ec/ecp_mont.c"
                        ;
 BN_clear_free(dest->field_data2);
 dest->field_data2 = 
# 156 "ec/ecp_mont.c" 3 4
                    ((void *)0)
# 156 "ec/ecp_mont.c"
                        ;
 ...
 if (src->field_data1 != 
# 161 "ec/ecp_mont.c" 3 4
                        ((void *)0)
# 161 "ec/ecp_mont.c"
                            ) {
  dest->field_data1 = BN_MONT_CTX_new();
  if (dest->field_data1 == 
# 163 "ec/ecp_mont.c" 3 4
                          ((void *)0)
# 163 "ec/ecp_mont.c"
                              )
   return 0;
 ...
 if (src->field_data2 != 
# 168 "ec/ecp_mont.c" 3 4
                        ((void *)0)
# 168 "ec/ecp_mont.c"
                            ) {
  dest->field_data2 = BN_dup(src->field_data2);
  if (dest->field_data2 == 
# 170 "ec/ecp_mont.c" 3 4
                          ((void *)0)
# 170 "ec/ecp_mont.c"
                              )
   goto err;
...
err:
 if (dest->field_data1 != 
# 176 "ec/ecp_mont.c" 3 4
                         ((void *)0)
# 176 "ec/ecp_mont.c"
                             ) {
  BN_MONT_CTX_free(dest->field_data1);
  dest->field_data1 = 
# 178 "ec/ecp_mont.c" 3 4
                     ((void *)0)
# 178 "ec/ecp_mont.c"
                         ;
 }
...
{
 BN_CTX *new_ctx = 
# 188 "ec/ecp_mont.c" 3 4
                  ((void *)0)
# 188 "ec/ecp_mont.c"
                      ;
 BN_MONT_CTX *mont = 
# 189 "ec/ecp_mont.c" 3 4
                    ((void *)0)
# 189 "ec/ecp_mont.c"
                        ;
 BIGNUM *one = 
# 190 "ec/ecp_mont.c" 3 4
              ((void *)0)
# 190 "ec/ecp_mont.c"
                  ;
 int ret = 0;
 ...
 BN_MONT_CTX_free(group->field_data1);
 group->field_data1 = 
# 194 "ec/ecp_mont.c" 3 4
                     ((void *)0)
# 194 "ec/ecp_mont.c"
                         ;
 BN_free(group->field_data2);
 group->field_data2 = 
# 196 "ec/ecp_mont.c" 3 4
                     ((void *)0)
# 196 "ec/ecp_mont.c"
                         ;
 if (ctx == 
# 197 "ec/ecp_mont.c" 3 4
           ((void *)0)
# 197 "ec/ecp_mont.c"
               ) {
  ctx = new_ctx = BN_CTX_new();
  if (ctx == 
# 199 "ec/ecp_mont.c" 3 4
            ((void *)0)
# 199 "ec/ecp_mont.c"
                )
   return 0;
 ...
 if (mont == 
# 203 "ec/ecp_mont.c" 3 4
            ((void *)0)
# 203 "ec/ecp_mont.c"
                )
  goto err;
 if (!BN_MONT_CTX_set(mont, p, ctx)) {
  ERR_put_error(16,(189),(3),"ec/ecp_mont.c",206);
  goto err;
 }
 one = BN_new();
 if (one == 
# 210 "ec/ecp_mont.c" 3 4
           ((void *)0)
# 210 "ec/ecp_mont.c"
               )
  goto err;
 if (!BN_mod_mul_montgomery( (one),(BN_value_one()),&((mont)->RR),(mont),(ctx)))
  goto err;

 group->field_data1 = mont;
 mont = 
# 216 "ec/ecp_mont.c" 3 4
       ((void *)0)
# 216 "ec/ecp_mont.c"
           ;
 group->field_data2 = one;
 one = 
# 218 "ec/ecp_mont.c" 3 4
      ((void *)0)
# 218 "ec/ecp_mont.c"
          ;
 ...
 if (!ret) {
  BN_MONT_CTX_free(group->field_data1);
  group->field_data1 = 
# 224 "ec/ecp_mont.c" 3 4
                      ((void *)0)
# 224 "ec/ecp_mont.c"
                          ;
  BN_free(group->field_data2);
  group->field_data2 = 
# 226 "ec/ecp_mont.c" 3 4
                      ((void *)0)
# 226 "ec/ecp_mont.c"
                          ;
 }
...
# 240 "ec/ecp_mont.c" 3 4
                          ((void *)0)
# 240 "ec/ecp_mont.c"
                              ) {
  ERR_put_error(16,(131),(111),"ec/ecp_mont.c",241);
  return 0;
 }
...
{
 if (group->field_data1 == 
# 252 "ec/ecp_mont.c" 3 4
                          ((void *)0)
# 252 "ec/ecp_mont.c"
                              ) {
  ERR_put_error(16,(132),(111),"ec/ecp_mont.c",253);
  return 0;
 }
...
{
 if (group->field_data1 == 
# 264 "ec/ecp_mont.c" 3 4
                          ((void *)0)
# 264 "ec/ecp_mont.c"
                              ) {
  ERR_put_error(16,(134),(111),"ec/ecp_mont.c",265);
  return 0;
 }
 return BN_mod_mul_montgomery( (r),(a),&(((BN_MONT_CTX *) group->field_data1)->RR),((BN_MONT_CTX *) group->field_data1),(ctx));
}
...
{
 if (group->field_data1 == 
# 276 "ec/ecp_mont.c" 3 4
                          ((void *)0)
# 276 "ec/ecp_mont.c"
                              ) {
  ERR_put_error(16,(133),(111),"ec/ecp_mont.c",277);
  return 0;
 }
...
# 287 "ec/ecp_mont.c" 3 4
                          ((void *)0)
# 287 "ec/ecp_mont.c"
                              ) {
  ERR_put_error(16,(209),(111),"ec/ecp_mont.c",288);
  return 0;
 }
