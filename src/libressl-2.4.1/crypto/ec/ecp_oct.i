...
# 94 "ec/ecp_oct.c"
 ...
 if (!BN_mod_sqrt(y, tmp1, &group->field, ctx)) {
  ...
  if ((int)((((unsigned long)err)>>24L)&0xffL) == 3 && (int)((err)&0xfffL) == 111) {
   ERR_clear_error();
   ERR_put_error(16,(169),(110),"ec/ecp_oct.c",158);
  } else
   ERR_put_error(16,(169),(3),"ec/ecp_oct.c",160);
  goto err;
 }
 if (y_bit != (((y)->top > 0) && ((y)->d[0] & 1))) {
  if (BN_is_zero(y)) {
   int kron;
   ...
   if (kron == 1)
    ERR_put_error(16,(169),(109),"ec/ecp_oct.c",172);
   else




    ERR_put_error(16,(169),(110),"ec/ecp_oct.c",178);
   goto err;
  }
 ...
 if (y_bit != (((y)->top > 0) && ((y)->d[0] & 1))) {
  ERR_put_error(16,(169),((4|64)),"ec/ecp_oct.c",185);
  goto err;
 }
...
# 205 "ec/ecp_oct.c"
 ...
 if ((form != POINT_CONVERSION_COMPRESSED)
  ...
  ERR_put_error(16,(104),(104),"ec/ecp_oct.c",213);
  goto err;
 }
 if (EC_POINT_is_at_infinity(group, point) > 0) {

  if (buf != 
# 218 "ec/ecp_oct.c" 3 4
            ((void *)0)
# 218 "ec/ecp_oct.c"
                ) {
   if (len < 1) {
    ERR_put_error(16,(104),(100),"ec/ecp_oct.c",220);
    return 0;
   }
   buf[0] = 0;
  }
 ...
 field_len = ((BN_num_bits(&group->field)+7)/8);
 ret = (form == POINT_CONVERSION_COMPRESSED) ? 1 + field_len : 1 + 2 * field_len;


 if (buf != 
# 232 "ec/ecp_oct.c" 3 4
           ((void *)0)
# 232 "ec/ecp_oct.c"
               ) {
  if (len < ret) {
   ERR_put_error(16,(104),(100),"ec/ecp_oct.c",234);
   goto err;
  }
  if (ctx == 
# 237 "ec/ecp_oct.c" 3 4
            ((void *)0)
# 237 "ec/ecp_oct.c"
                ) {
   ctx = new_ctx = BN_CTX_new();
   if (ctx == 
# 239 "ec/ecp_oct.c" 3 4
             ((void *)0)
# 239 "ec/ecp_oct.c"
                 )
    return 0;
  ...
  used_ctx = 1;
  if ((x = BN_CTX_get(ctx)) == 
# 244 "ec/ecp_oct.c" 3 4
                              ((void *)0)
# 244 "ec/ecp_oct.c"
                                  )
   goto err;
  if ((y = BN_CTX_get(ctx)) == 
# 246 "ec/ecp_oct.c" 3 4
                              ((void *)0)
# 246 "ec/ecp_oct.c"
                                  )
   goto err;
  ...
  if ((form == POINT_CONVERSION_COMPRESSED || form == POINT_CONVERSION_HYBRID) && (((y)->top > 0) && ((y)->d[0] & 1)))
   buf[0] = form + 1;
  else
   buf[0] = form;
  ...
  skip = field_len - ((BN_num_bits(x)+7)/8);
  if (skip > field_len) {
   ERR_put_error(16,(104),((4|64)),"ec/ecp_oct.c",261);
   goto err;
  }
  while (skip > 0) {
   buf[i++] = 0;
  ...
  i += skip;
  if (i != 1 + field_len) {
   ERR_put_error(16,(104),((4|64)),"ec/ecp_oct.c",271);
   goto err;
  }
  if (form == POINT_CONVERSION_UNCOMPRESSED || form == POINT_CONVERSION_HYBRID) {
   skip = field_len - ((BN_num_bits(y)+7)/8);
   if (skip > field_len) {
    ERR_put_error(16,(104),((4|64)),"ec/ecp_oct.c",277);
    goto err;
   }
   while (skip > 0) {
    buf[i++] = 0;
  ...
  if (i != ret) {
   ERR_put_error(16,(104),((4|64)),"ec/ecp_oct.c",288);
   goto err;
  }
 }
 if (used_ctx)
...
# 311 "ec/ecp_oct.c"
 ...
 if (len == 0) {
  ERR_put_error(16,(103),(100),"ec/ecp_oct.c",317);
  return 0;
 }
 form = buf[0];
 y_bit = form & 1;
 ...
 if ((form != 0) && (form != POINT_CONVERSION_COMPRESSED)
     && (form != POINT_CONVERSION_UNCOMPRESSED)
     && (form != POINT_CONVERSION_HYBRID)) {
  ERR_put_error(16,(103),(102),"ec/ecp_oct.c",326);
  return 0;
 }
 if ((form == 0 || form == POINT_CONVERSION_UNCOMPRESSED) && y_bit) {
  ERR_put_error(16,(103),(102),"ec/ecp_oct.c",330);
  return 0;
 }
 if (form == 0) {
  if (len != 1) {
   ERR_put_error(16,(103),(102),"ec/ecp_oct.c",335);
   return 0;
  }
 ...
 if (len != enc_len) {
  ERR_put_error(16,(103),(102),"ec/ecp_oct.c",344);
  return 0;
 }
 if (ctx == 
# 347 "ec/ecp_oct.c" 3 4
           ((void *)0)
# 347 "ec/ecp_oct.c"
               ) {
  ctx = new_ctx = BN_CTX_new();
  if (ctx == 
# 349 "ec/ecp_oct.c" 3 4
            ((void *)0)
# 349 "ec/ecp_oct.c"
                )
   return 0;
 ...
 BN_CTX_start(ctx);
 if ((x = BN_CTX_get(ctx)) == 
# 353 "ec/ecp_oct.c" 3 4
                             ((void *)0)
# 353 "ec/ecp_oct.c"
                                 )
  goto err;
 if ((y = BN_CTX_get(ctx)) == 
# 355 "ec/ecp_oct.c" 3 4
                             ((void *)0)
# 355 "ec/ecp_oct.c"
                                 )
  goto err;
 ...
 if (BN_ucmp(x, &group->field) >= 0) {
  ERR_put_error(16,(103),(102),"ec/ecp_oct.c",361);
  goto err;
 }
 if (form == POINT_CONVERSION_COMPRESSED) {
  ...
  if (BN_ucmp(y, &group->field) >= 0) {
   ERR_put_error(16,(103),(102),"ec/ecp_oct.c",371);
   goto err;
  }
  if (form == POINT_CONVERSION_HYBRID) {
   if (y_bit != (((y)->top > 0) && ((y)->d[0] & 1))) {
    ERR_put_error(16,(103),(102),"ec/ecp_oct.c",376);
    goto err;
   }
  }
  if (!EC_POINT_set_affine_coordinates_GFp(group, point, x, y, ctx))
 ...
 if (EC_POINT_is_on_curve(group, point, ctx) <= 0) {
  ERR_put_error(16,(103),(107),"ec/ecp_oct.c",386);
  goto err;
 }
 ret = 1;
