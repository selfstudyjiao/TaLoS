...
PKCS12_init(int mode)
{
 ...
 if (!(pkcs12 = PKCS12_new())) {
  ERR_put_error(35,(109),((1|64)),"pkcs12/p12_init.c",72);
  return 
# 73 "pkcs12/p12_init.c" 3 4
        ((void *)0)
# 73 "pkcs12/p12_init.c"
            ;
 }
 ...
 case 21:
  if (!(pkcs12->authsafes->d.data =
   ...
   ERR_put_error(35,(109),((1|64)),"pkcs12/p12_init.c",81);
   goto err;
  }
  break;
 default:
  ERR_put_error(35,(109),(119),"pkcs12/p12_init.c",87)
                                       ;
  goto err;
 }
...
err:
 if (pkcs12 != 
# 94 "pkcs12/p12_init.c" 3 4
              ((void *)0)
# 94 "pkcs12/p12_init.c"
                  )
  PKCS12_free(pkcs12);
 return 
# 96 "pkcs12/p12_init.c" 3 4
       ((void *)0)
# 96 "pkcs12/p12_init.c"
           ;
}
