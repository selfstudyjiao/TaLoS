...
{
 if (ctx->pctx == 
# 72 "evp/m_sigver.c" 3 4
                 ((void *)0)
# 72 "evp/m_sigver.c"
                     )
  ctx->pctx = EVP_PKEY_CTX_new(pkey, e);
 if (ctx->pctx == 
# 74 "evp/m_sigver.c" 3 4
                 ((void *)0)
# 74 "evp/m_sigver.c"
                     )
  return 0;
 ...
 if (type == 
# 77 "evp/m_sigver.c" 3 4
            ((void *)0)
# 77 "evp/m_sigver.c"
                ) {
  int def_nid;
  if (EVP_PKEY_get_default_digest_nid(pkey, &def_nid) > 0)
   type = EVP_get_digestbyname(OBJ_nid2sn(def_nid));
 }

 if (type == 
# 83 "evp/m_sigver.c" 3 4
            ((void *)0)
# 83 "evp/m_sigver.c"
                ) {
  ERR_put_error(6,(161),(158),"evp/m_sigver.c",84);
  return 0;
 }
 ...
 if (ver) {
  ...
  if (ctx->pctx->pmeth->signctx_init) {
   if (ctx->pctx->pmeth->signctx_init(ctx->pctx, ctx) <= 0)
    return 0;
   ctx->pctx->operation = (1<<6);
  } else if (EVP_PKEY_sign_init(ctx->pctx) <= 0)
   return 0;
 }
 if (EVP_PKEY_CTX_ctrl(ctx->pctx, -1, ((1<<3) | (1<<4) | (1<<5) | (1<<6) | (1<<7)), 1, 0, (void *)type) <= 0)
  return 0;
 if (pctx)
  *pctx = ctx->pctx;
