...
{
 return ((TS_MSG_IMPRINT*)ASN1_d2i_bio( ((void *(*)(void)) (1 ? TS_MSG_IMPRINT_new : ((TS_MSG_IMPRINT *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_TS_MSG_IMPRINT : ((TS_MSG_IMPRINT *(*)(TS_MSG_IMPRINT **,const unsigned char **,long))0))), bp, ((void**) (1 ? a : (TS_MSG_IMPRINT**)0))))
                               ;
}
...
{
 return (ASN1_i2d_bio(((i2d_of_void*) (1 ? i2d_TS_MSG_IMPRINT : ((int (*)(const TS_MSG_IMPRINT *,unsigned char **))0))), bp, ((void*) (1 ? a : (const TS_MSG_IMPRINT*)0))));
}
...
{
 return ((TS_MSG_IMPRINT*)ASN1_d2i_fp(((void *(*)(void)) (1 ? TS_MSG_IMPRINT_new : ((TS_MSG_IMPRINT *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_TS_MSG_IMPRINT : ((TS_MSG_IMPRINT *(*)(TS_MSG_IMPRINT **,const unsigned char **,long))0))), fp, ((void**) (1 ? a : (TS_MSG_IMPRINT**)0))))
                               ;
}
...
{
 return (ASN1_i2d_fp(((i2d_of_void*) (1 ? i2d_TS_MSG_IMPRINT : ((int (*)(const TS_MSG_IMPRINT *,unsigned char **))0))), fp, ((void*) (1 ? a : (const TS_MSG_IMPRINT*)0))));
}
...
{
 return ((TS_REQ*)ASN1_d2i_bio( ((void *(*)(void)) (1 ? TS_REQ_new : ((TS_REQ *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_TS_REQ : ((TS_REQ *(*)(TS_REQ **,const unsigned char **,long))0))), bp, ((void**) (1 ? a : (TS_REQ**)0))));
}

int
i2d_TS_REQ_bio(BIO *bp, TS_REQ *a)
{
 return (ASN1_i2d_bio(((i2d_of_void*) (1 ? i2d_TS_REQ : ((int (*)(const TS_REQ *,unsigned char **))0))), bp, ((void*) (1 ? a : (const TS_REQ*)0))));
}
...
{
 return ((TS_REQ*)ASN1_d2i_fp(((void *(*)(void)) (1 ? TS_REQ_new : ((TS_REQ *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_TS_REQ : ((TS_REQ *(*)(TS_REQ **,const unsigned char **,long))0))), fp, ((void**) (1 ? a : (TS_REQ**)0))));
}

int
i2d_TS_REQ_fp(FILE *fp, TS_REQ *a)
{
 return (ASN1_i2d_fp(((i2d_of_void*) (1 ? i2d_TS_REQ : ((int (*)(const TS_REQ *,unsigned char **))0))), fp, ((void*) (1 ? a : (const TS_REQ*)0))));
}
...
{
 return ((TS_TST_INFO*)ASN1_d2i_bio( ((void *(*)(void)) (1 ? TS_TST_INFO_new : ((TS_TST_INFO *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_TS_TST_INFO : ((TS_TST_INFO *(*)(TS_TST_INFO **,const unsigned char **,long))0))), bp, ((void**) (1 ? a : (TS_TST_INFO**)0))))
           ;
}
...
{
 return (ASN1_i2d_bio(((i2d_of_void*) (1 ? i2d_TS_TST_INFO : ((int (*)(const TS_TST_INFO *,unsigned char **))0))), bp, ((void*) (1 ? a : (const TS_TST_INFO*)0))));
}
...
{
 return ((TS_TST_INFO*)ASN1_d2i_fp(((void *(*)(void)) (1 ? TS_TST_INFO_new : ((TS_TST_INFO *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_TS_TST_INFO : ((TS_TST_INFO *(*)(TS_TST_INFO **,const unsigned char **,long))0))), fp, ((void**) (1 ? a : (TS_TST_INFO**)0))))
           ;
}
...
{
 return (ASN1_i2d_fp(((i2d_of_void*) (1 ? i2d_TS_TST_INFO : ((int (*)(const TS_TST_INFO *,unsigned char **))0))), fp, ((void*) (1 ? a : (const TS_TST_INFO*)0))));
}
...
ts_resp_set_tst_info(TS_RESP *a)
{
 ...
 if (a->token) {
  if (status != 0 && status != 1) {
   ERR_put_error(47,(150),(131),"ts/ts_asn1.c",548);
   return 0;
  }
  if (a->tst_info != 
# 551 "ts/ts_asn1.c" 3 4
                    ((void *)0)
# 551 "ts/ts_asn1.c"
                        )
  ...
  if (!a->tst_info) {
   ERR_put_error(47,(150),(129),"ts/ts_asn1.c",556)
                                        ;
   return 0;
  }
 } else if (status == 0 || status == 1) {
  ERR_put_error(47,(150),(130),"ts/ts_asn1.c",560);
  return 0;
 }
...
ts_resp_cb(int op, ASN1_VALUE **pval, const ASN1_ITEM *it, void *exarg)
{
 ...
 if (op == 1) {
  ts_resp->tst_info = 
# 573 "ts/ts_asn1.c" 3 4
                     ((void *)0)
# 573 "ts/ts_asn1.c"
                         ;
 } else if (op == 3) {
  if (ts_resp->tst_info != 
# 575 "ts/ts_asn1.c" 3 4
                          ((void *)0)
# 575 "ts/ts_asn1.c"
                              )
...
{
 return ((TS_RESP*)ASN1_d2i_bio( ((void *(*)(void)) (1 ? TS_RESP_new : ((TS_RESP *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_TS_RESP : ((TS_RESP *(*)(TS_RESP **,const unsigned char **,long))0))), bp, ((void**) (1 ? a : (TS_RESP**)0))));
}

int
i2d_TS_RESP_bio(BIO *bp, TS_RESP *a)
{
 return (ASN1_i2d_bio(((i2d_of_void*) (1 ? i2d_TS_RESP : ((int (*)(const TS_RESP *,unsigned char **))0))), bp, ((void*) (1 ? a : (const TS_RESP*)0))));
}
...
{
 return ((TS_RESP*)ASN1_d2i_fp(((void *(*)(void)) (1 ? TS_RESP_new : ((TS_RESP *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_TS_RESP : ((TS_RESP *(*)(TS_RESP **,const unsigned char **,long))0))), fp, ((void**) (1 ? a : (TS_RESP**)0))));
}

int
i2d_TS_RESP_fp(FILE *fp, TS_RESP *a)
{
 return (ASN1_i2d_fp(((i2d_of_void*) (1 ? i2d_TS_RESP : ((int (*)(const TS_RESP *,unsigned char **))0))), fp, ((void*) (1 ? a : (const TS_RESP*)0))));
}
...
PKCS7_to_TS_TST_INFO(PKCS7 *token)
{
 ...
 if (!(OBJ_obj2nid((token)->type) == 22)) {
  ERR_put_error(47,(148),(132),"ts/ts_asn1.c",865);
  return 
# 866 "ts/ts_asn1.c" 3 4
        ((void *)0)
# 866 "ts/ts_asn1.c"
            ;
 }
...
# 870 "ts/ts_asn1.c" 3 4
    ((void *)0)
# 870 "ts/ts_asn1.c"
    )) {
  ERR_put_error(47,(148),(134),"ts/ts_asn1.c",871);
  return 
# 872 "ts/ts_asn1.c" 3 4
        ((void *)0)
# 872 "ts/ts_asn1.c"
            ;
 }
 ...
 if (OBJ_obj2nid(enveloped->type) != 207) {
  ERR_put_error(47,(148),(132),"ts/ts_asn1.c",879);
  return 
# 880 "ts/ts_asn1.c" 3 4
        ((void *)0)
# 880 "ts/ts_asn1.c"
            ;
 }
 ...
 if (tst_info_wrapper->type != 4) {
  ERR_put_error(47,(148),(133),"ts/ts_asn1.c",886);
  return 
# 887 "ts/ts_asn1.c" 3 4
        ((void *)0)
# 887 "ts/ts_asn1.c"
            ;
 }
 ...
 p = tst_info_der->data;
 return d2i_TS_TST_INFO(
# 894 "ts/ts_asn1.c" 3 4
                       ((void *)0)
# 894 "ts/ts_asn1.c"
                           , &p, tst_info_der->length);
}
