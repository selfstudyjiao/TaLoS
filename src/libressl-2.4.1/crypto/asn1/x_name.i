...
struct stack_st_STACK_OF_X509_NAME_ENTRY { _STACK stack; };
...
static int i2d_name_canon(struct stack_st_STACK_OF_X509_NAME_ENTRY *intname,
    unsigned char **in);
...
# 248 "asn1/x_name.c"
 ...
 if (!ret)
  goto memerr;
 if ((ret->entries = ((struct stack_st_X509_NAME_ENTRY *)sk_new_null())) == 
# 253 "asn1/x_name.c" 3 4
                                                      ((void *)0)
# 253 "asn1/x_name.c"
                                                          )
  goto memerr;
 if ((ret->bytes = BUF_MEM_new()) == 
# 255 "asn1/x_name.c" 3 4
                                    ((void *)0)
# 255 "asn1/x_name.c"
                                        )
  goto memerr;
 ret->canon_enc = 
# 257 "asn1/x_name.c" 3 4
                 ((void *)0)
# 257 "asn1/x_name.c"
                     ;
 ret->canon_enclen = 0;
...
memerr:
 ERR_put_error(13,(171),((1|64)),"asn1/x_name.c",264);
 if (ret) {
  if (ret->entries)
   sk_free(((_STACK*) (1 ? (ret->entries) : (struct stack_st_X509_NAME_ENTRY*)0)));
  free(ret);
 }
 return 0;
}
...
x509_name_ex_free(ASN1_VALUE **pval, const ASN1_ITEM *it)
{
 ...
 sk_pop_free(((_STACK*) (1 ? (a->entries) : (struct stack_st_X509_NAME_ENTRY*)0)), ((void (*)(void *)) ((1 ? (X509_NAME_ENTRY_free) : (void (*)(X509_NAME_ENTRY *))0))));
 free(a->canon_enc);
 free(a);
 *pval = 
# 286 "asn1/x_name.c" 3 4
        ((void *)0)
# 286 "asn1/x_name.c"
            ;
}
...
# 315 "asn1/x_name.c" 3 4
                        ((void *)0)
# 315 "asn1/x_name.c"
                            );
 if (!x509_name_ex_new(&nm.a, 
# 316 "asn1/x_name.c" 3 4
                             ((void *)0)
# 316 "asn1/x_name.c"
                                 ))
  goto err;
 ...
 for (i = 0; i < sk_num(((_STACK*) (1 ? (intname.s) : (struct stack_st_STACK_OF_X509_NAME_ENTRY*)0))); i++) {
  entries = ((STACK_OF_X509_NAME_ENTRY *)sk_value(((_STACK*) (1 ? (intname.s) : (struct stack_st_STACK_OF_X509_NAME_ENTRY*)0)), (i)));
  for (j = 0; j < sk_num(((_STACK*) (1 ? (entries) : (struct stack_st_X509_NAME_ENTRY*)0))); j++) {
   entry = ((X509_NAME_ENTRY *)sk_value(((_STACK*) (1 ? (entries) : (struct stack_st_X509_NAME_ENTRY*)0)), (j)));
   entry->set = i;
   if (!sk_push(((_STACK*) (1 ? (nm.x->entries) : (struct stack_st_X509_NAME_ENTRY*)0)), ((void*) (1 ? (entry) : (X509_NAME_ENTRY*)0))))
    goto err;
  }
  sk_free(((_STACK*) (1 ? (entries) : (struct stack_st_X509_NAME_ENTRY*)0)));
 }
 sk_free(((_STACK*) (1 ? (intname.s) : (struct stack_st_STACK_OF_X509_NAME_ENTRY*)0)));
...
err:
 if (nm.x != 
# 344 "asn1/x_name.c" 3 4
            ((void *)0)
# 344 "asn1/x_name.c"
                )
  X509_NAME_free(nm.x);
 ERR_put_error(13,(158),(58),"asn1/x_name.c",346);
 return 0;
}
...
static void
local_sk_X509_NAME_ENTRY_free(struct stack_st_X509_NAME_ENTRY *ne)
{
 sk_free(((_STACK*) (1 ? (ne) : (struct stack_st_X509_NAME_ENTRY*)0)));
}

static void
local_sk_X509_NAME_ENTRY_pop_free(struct stack_st_X509_NAME_ENTRY *ne)
{
 sk_pop_free(((_STACK*) (1 ? (ne) : (struct stack_st_X509_NAME_ENTRY*)0)), ((void (*)(void *)) ((1 ? (X509_NAME_ENTRY_free) : (void (*)(X509_NAME_ENTRY *))0))));
}
...
# 394 "asn1/x_name.c"
 ...
 intname.s = ((struct stack_st_STACK_OF_X509_NAME_ENTRY *)sk_new_null());
 if (!intname.s)
  goto memerr;
 for (i = 0; i < sk_num(((_STACK*) (1 ? (a->entries) : (struct stack_st_X509_NAME_ENTRY*)0))); i++) {
  entry = ((X509_NAME_ENTRY *)sk_value(((_STACK*) (1 ? (a->entries) : (struct stack_st_X509_NAME_ENTRY*)0)), (i)));
  if (entry->set != set) {
   entries = ((struct stack_st_X509_NAME_ENTRY *)sk_new_null());
   if (!entries)
    goto memerr;
   if (!sk_push(((_STACK*) (1 ? (intname.s) : (struct stack_st_STACK_OF_X509_NAME_ENTRY*)0)), ((void*) (1 ? (entries) : (STACK_OF_X509_NAME_ENTRY*)0)))
               )
    goto memerr;
   set = entry->set;
  }
  if (entries == 
# 412 "asn1/x_name.c" 3 4
                ((void *)0) 
# 412 "asn1/x_name.c"
                                                       ||
      !sk_push(((_STACK*) (1 ? (entries) : (struct stack_st_X509_NAME_ENTRY*)0)), ((void*) (1 ? (entry) : (X509_NAME_ENTRY*)0))))
   goto memerr;
 }
 len = ASN1_item_ex_i2d(&intname.a, 
# 416 "asn1/x_name.c" 3 4
                                   ((void *)0)
# 416 "asn1/x_name.c"
                                       ,
 ...
 ASN1_item_ex_i2d(&intname.a, &p, (&(X509_NAME_INTERNAL_it)),
     -1, -1);
 sk_pop_free(((_STACK*) (1 ? (intname.s) : (struct stack_st_STACK_OF_X509_NAME_ENTRY*)0)), ((void (*)(void *)) ((1 ? (local_sk_X509_NAME_ENTRY_free) : (void (*)(STACK_OF_X509_NAME_ENTRY *))0))))
                                   ;
 a->modified = 0;
 return len;
...
memerr:
 sk_pop_free(((_STACK*) (1 ? (intname.s) : (struct stack_st_STACK_OF_X509_NAME_ENTRY*)0)), ((void (*)(void *)) ((1 ? (local_sk_X509_NAME_ENTRY_free) : (void (*)(STACK_OF_X509_NAME_ENTRY *))0))))
                                   ;
 ERR_put_error(13,(203),((1|64)),"asn1/x_name.c",431);
 return -1;
}
...
{
 unsigned char *p;
 struct stack_st_STACK_OF_X509_NAME_ENTRY *intname = 
# 462 "asn1/x_name.c" 3 4
                                              ((void *)0)
# 462 "asn1/x_name.c"
                                                  ;
 struct stack_st_X509_NAME_ENTRY *entries = 
# 463 "asn1/x_name.c" 3 4
                                     ((void *)0)
# 463 "asn1/x_name.c"
                                         ;
 X509_NAME_ENTRY *entry, *tmpentry = 
# 464 "asn1/x_name.c" 3 4
                                    ((void *)0)
# 464 "asn1/x_name.c"
                                        ;
 ...
 if (a->canon_enc) {
  free(a->canon_enc);
  a->canon_enc = 
# 469 "asn1/x_name.c" 3 4
                ((void *)0)
# 469 "asn1/x_name.c"
                    ;
 }

 if (sk_num(((_STACK*) (1 ? (a->entries) : (struct stack_st_X509_NAME_ENTRY*)0))) == 0) {
  a->canon_enclen = 0;
  return 1;
 }
 intname = ((struct stack_st_STACK_OF_X509_NAME_ENTRY *)sk_new_null());
 if (!intname)
  goto err;
 for (i = 0; i < sk_num(((_STACK*) (1 ? (a->entries) : (struct stack_st_X509_NAME_ENTRY*)0))); i++) {
  entry = ((X509_NAME_ENTRY *)sk_value(((_STACK*) (1 ? (a->entries) : (struct stack_st_X509_NAME_ENTRY*)0)), (i)));
  if (entry->set != set) {
   ...
   if (!entries)
    goto err;
   if (sk_push(((_STACK*) (1 ? (intname) : (struct stack_st_STACK_OF_X509_NAME_ENTRY*)0)), ((void*) (1 ? (entries) : (STACK_OF_X509_NAME_ENTRY*)0)))
                == 0) {
    sk_free(((_STACK*) (1 ? (entries) : (struct stack_st_X509_NAME_ENTRY*)0)));
    goto err;
   }
...
# 496 "asn1/x_name.c"
  ...
  if (!asn1_string_canon(tmpentry->value, entry->value))
   goto err;
  if (entries == 
# 500 "asn1/x_name.c" 3 4
                ((void *)0) 
# 500 "asn1/x_name.c"
                                                       ||
      !sk_push(((_STACK*) (1 ? (entries) : (struct stack_st_X509_NAME_ENTRY*)0)), ((void*) (1 ? (tmpentry) : (X509_NAME_ENTRY*)0))))
   goto err;
  tmpentry = 
# 503 "asn1/x_name.c" 3 4
            ((void *)0)
# 503 "asn1/x_name.c"
                ;
 }
 ...
 len = i2d_name_canon(intname, 
# 507 "asn1/x_name.c" 3 4
                              ((void *)0)
# 507 "asn1/x_name.c"
                                  );
 if (len < 0)
...
err:
 ...
 if (intname)
  sk_pop_free(((_STACK*) (1 ? (intname) : (struct stack_st_STACK_OF_X509_NAME_ENTRY*)0)), ((void (*)(void *)) ((1 ? (local_sk_X509_NAME_ENTRY_pop_free) : (void (*)(STACK_OF_X509_NAME_ENTRY *))0))))
                                        ;
 return ret;
}
# 535 "asn1/x_name.c"
...
asn1_string_canon(ASN1_STRING *out, ASN1_STRING *in)
{
 ...
 if (!(ASN1_tag2bit(in->type) & (0x2000 | 0x0800 | 0x0100 | 0x0002 | 0x0004 | 0x0010 | 0x0040))) {
...
static int
i2d_name_canon(struct stack_st_STACK_OF_X509_NAME_ENTRY *_intname, unsigned char **in)
{
 int i, len, ltmp;
 ASN1_VALUE *v;
 struct stack_st_ASN1_VALUE *intname = (struct stack_st_ASN1_VALUE *)_intname;

 len = 0;
 for (i = 0; i < sk_num(((_STACK*) (1 ? (intname) : (struct stack_st_ASN1_VALUE*)0))); i++) {
  v = ((ASN1_VALUE *)sk_value(((_STACK*) (1 ? (intname) : (struct stack_st_ASN1_VALUE*)0)), (i)));
