...
# 105 "asn1/a_mbstr.c"
 ...
 if (!mask)
  mask = (0x0002|0x0004|0x0800|0x2000);


 switch (inform) {
 case (0x1000|2):
  if (len & 1) {
   ERR_put_error(13,(122),(129),"asn1/a_mbstr.c",117)
                                       ;
   return -1;
  }
  nchar = len >> 1;
 ...
 case (0x1000|4):
  if (len & 3) {
   ERR_put_error(13,(122),(133),"asn1/a_mbstr.c",126)
                                             ;
   return -1;
  }
  nchar = len >> 2;
 ...
 case (0x1000):
  ...
  ret = traverse_string(in, len, (0x1000), in_utf8, &nchar);
  if (ret < 0) {
   ERR_put_error(13,(122),(134),"asn1/a_mbstr.c",138)
                                 ;
   return -1;
  }
  break;
 ...
 default:
  ERR_put_error(13,(122),(160),"asn1/a_mbstr.c",148);
  return -1;
 }

 if ((minsize > 0) && (nchar < minsize)) {
  ERR_put_error(13,(122),(152),"asn1/a_mbstr.c",153);
  ERR_asprintf_error_data("minsize=%ld", minsize);
  return -1;
 }

 if ((maxsize > 0) && (nchar > maxsize)) {
  ERR_put_error(13,(122),(151),"asn1/a_mbstr.c",159);
 ...
 if (traverse_string(in, len, inform, type_str, &mask) < 0) {
  ERR_put_error(13,(122),(124),"asn1/a_mbstr.c",166);
  return -1;
 }
...
# 197 "asn1/a_mbstr.c"
  ...
  if (!dest) {
   ERR_put_error(13,(122),((1|64)),"asn1/a_mbstr.c",205)
                            ;
   return -1;
  }
  *out = dest;
 ...
 if (inform == outform) {
  if (!ASN1_STRING_set(dest, in, len)) {
   ERR_put_error(13,(122),((1|64)),"asn1/a_mbstr.c",214)
                            ;
   goto err;
  }
  return str_type;
 ...
 case (0x1000):
  ...
  if (traverse_string(in, len, inform, out_utf8, &outlen) < 0) {
   ERR_put_error(13,(122),(124),"asn1/a_mbstr.c",241)
                                 ;
   goto err;
  }
  cpyfunc = cpy_utf8;
 ...
 if (!(p = malloc(outlen + 1))) {
  ERR_put_error(13,(122),((1|64)),"asn1/a_mbstr.c",248);
  goto err;
 }
 dest->length = outlen;
 dest->data = p;
    ...
    int (*rfunc)(unsigned long value, void *in), void *arg)
{
 ...
 while (len) {
  ...
  case (0x1000|2):
   ...
   if (((value) >= 0x00D800 && (value) <= 0x00DFFF))
    return -1;
   len -= 2;
   break;
  case (0x1000|4):
   ...
   value |= *p++ << 8;
   value |= *p++;
   if (value > 0x10FFFF || ((value) >= 0x00D800 && (value) <= 0x00DFFF))
    return -1;
   len -= 4;
   break;
  default:
...
type_str(unsigned long value, void *arg)
{
 ...
 if ((types & 0x0002) && !is_printable(value))
  types &= ~0x0002;
 if ((types & 0x0010) && (value > 127))
  types &= ~0x0010;
 if ((types & 0x0004) && (value > 0xff))
  types &= ~0x0004;
 if ((types & 0x0800) && (value > 0xffff))
  types &= ~0x0800;
 if (!types)
  return -1;
