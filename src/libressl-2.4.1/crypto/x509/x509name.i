...
{
 if (name == 
# 108 "x509/x509name.c" 3 4
            ((void *)0)
# 108 "x509/x509name.c"
                )
  return (0);
 return (sk_num(((_STACK*) (1 ? (name->entries) : (struct stack_st_X509_NAME_ENTRY*)0))));
}
...
X509_NAME_get_index_by_OBJ(X509_NAME *name, ASN1_OBJECT *obj, int lastpos)
{
 int n;
 X509_NAME_ENTRY *ne;
 struct stack_st_X509_NAME_ENTRY *sk;

 if (name == 
# 136 "x509/x509name.c" 3 4
            ((void *)0)
# 136 "x509/x509name.c"
                )
  return (-1);
 if (lastpos < 0)
  lastpos = -1;
 sk = name->entries;
 n = sk_num(((_STACK*) (1 ? (sk) : (struct stack_st_X509_NAME_ENTRY*)0)));
 for (lastpos++; lastpos < n; lastpos++) {
  ne = ((X509_NAME_ENTRY *)sk_value(((_STACK*) (1 ? (sk) : (struct stack_st_X509_NAME_ENTRY*)0)), (lastpos)));
...
{
 if (name == 
# 157 "x509/x509name.c" 3 4
            ((void *)0) 
# 157 "x509/x509name.c"
                 || sk_num(((_STACK*) (1 ? (name->entries) : (struct stack_st_X509_NAME_ENTRY*)0))) <= loc ||
     loc < 0)
  return (
# 159 "x509/x509name.c" 3 4
         ((void *)0)
# 159 "x509/x509name.c"
             );
 else
  return (((X509_NAME_ENTRY *)sk_value(((_STACK*) (1 ? (name->entries) : (struct stack_st_X509_NAME_ENTRY*)0)), (loc))));
}
...
X509_NAME_delete_entry(X509_NAME *name, int loc)
{
 ...
 if (name == 
# 175 "x509/x509name.c" 3 4
            ((void *)0) 
# 175 "x509/x509name.c"
                 || sk_num(((_STACK*) (1 ? (name->entries) : (struct stack_st_X509_NAME_ENTRY*)0))) <= loc ||
     loc < 0)
  return (
# 177 "x509/x509name.c" 3 4
         ((void *)0)
# 177 "x509/x509name.c"
             );
 sk = name->entries;
 ret = (X509_NAME_ENTRY *)sk_delete(((_STACK*) (1 ? (sk) : (struct stack_st_X509_NAME_ENTRY*)0)), (loc));
 n = sk_num(((_STACK*) (1 ? (sk) : (struct stack_st_X509_NAME_ENTRY*)0)));
 name->modified = 1;
 if (loc == n)
  return (ret);
 ...
 if (loc != 0)
  set_prev = (((X509_NAME_ENTRY *)sk_value(((_STACK*) (1 ? (sk) : (struct stack_st_X509_NAME_ENTRY*)0)), (loc - 1))))->set;
 else
  set_prev = ret->set - 1;
 set_next = ((X509_NAME_ENTRY *)sk_value(((_STACK*) (1 ? (sk) : (struct stack_st_X509_NAME_ENTRY*)0)), (loc)))->set;
# 200 "x509/x509name.c"
 if (set_prev + 1 < set_next)
  for (i = loc; i < n; i++)
   ((X509_NAME_ENTRY *)sk_value(((_STACK*) (1 ? (sk) : (struct stack_st_X509_NAME_ENTRY*)0)), (i)))->set--;
 return (ret);
}
    ...
    unsigned char *bytes, int len, int loc, int set)
{
 ...
 ne = X509_NAME_ENTRY_create_by_OBJ(
# 213 "x509/x509name.c" 3 4
                                   ((void *)0)
# 213 "x509/x509name.c"
                                       , obj, type, bytes, len);
 if (!ne)
    ...
    const unsigned char *bytes, int len, int loc, int set)
{
 ...
 ne = X509_NAME_ENTRY_create_by_txt(
# 248 "x509/x509name.c" 3 4
                                   ((void *)0)
# 248 "x509/x509name.c"
                                       , field, type, bytes, len);
 if (!ne)
  return 0;
 ret = X509_NAME_add_entry(name, ne, loc, set);
 X509_NAME_ENTRY_free(ne);
...
# 265 "x509/x509name.c"
 ...
 if (set == -1) {
  if (loc == 0) {
   ...
   set = ((X509_NAME_ENTRY *)sk_value(((_STACK*) (1 ? (sk) : (struct stack_st_X509_NAME_ENTRY*)0)), (loc - 1)))->set;
   inc = 0;
  }
 } else {
  if (loc >= n) {
   if (loc != 0)
    set = ((X509_NAME_ENTRY *)sk_value(((_STACK*) (1 ? (sk) : (struct stack_st_X509_NAME_ENTRY*)0)), (loc - 1)))->set + 1;
   else
    set = 0;
  } else
   set = ((X509_NAME_ENTRY *)sk_value(((_STACK*) (1 ? (sk) : (struct stack_st_X509_NAME_ENTRY*)0)), (loc)))->set;
  inc = (set == 0) ? 1 : 0;
 }

 if ((new_name = X509_NAME_ENTRY_dup(ne)) == 
# 295 "x509/x509name.c" 3 4
                                            ((void *)0)
# 295 "x509/x509name.c"
                                                )
  goto err;
 new_name->set = set;
 if (!sk_insert(((_STACK*) (1 ? (sk) : (struct stack_st_X509_NAME_ENTRY*)0)), ((void*) (1 ? (new_name) : (X509_NAME_ENTRY*)0)), (loc))) {
  ERR_put_error(11,(113),((1|64)),"x509/x509name.c",299);
  goto err;
 }
 if (inc) {
  n = sk_num(((_STACK*) (1 ? (sk) : (struct stack_st_X509_NAME_ENTRY*)0)));
  for (i = loc + 1; i < n; i++)
   ((X509_NAME_ENTRY *)sk_value(((_STACK*) (1 ? (sk) : (struct stack_st_X509_NAME_ENTRY*)0)), (i - 1)))->set += 1;
 }
 return (1);

err:
 if (new_name != 
# 310 "x509/x509name.c" 3 4
                ((void *)0)
# 310 "x509/x509name.c"
                    )
    ...
    const char *field, int type, const unsigned char *bytes, int len)
{
 ...
 if (obj == 
# 323 "x509/x509name.c" 3 4
           ((void *)0)
# 323 "x509/x509name.c"
               ) {
  ERR_put_error(11,(131),(119),"x509/x509name.c",325)
                                ;
  ERR_asprintf_error_data("name=%s", field);
  return (
# 327 "x509/x509name.c" 3 4
         ((void *)0)
# 327 "x509/x509name.c"
             );
 }
    ...
    unsigned char *bytes, int len)
{
 ...
 obj = OBJ_nid2obj(nid);
 if (obj == 
# 342 "x509/x509name.c" 3 4
           ((void *)0)
# 342 "x509/x509name.c"
               ) {
  ERR_put_error(11,(114),(109),"x509/x509name.c",344)
                         ;
  return (
# 345 "x509/x509name.c" 3 4
         ((void *)0)
# 345 "x509/x509name.c"
             );
 }
...
# 358 "x509/x509name.c"
  ...
  if ((ret = X509_NAME_ENTRY_new()) == 
# 359 "x509/x509name.c" 3 4
                                      ((void *)0)
# 359 "x509/x509name.c"
                                          )
   return (
# 360 "x509/x509name.c" 3 4
          ((void *)0)
# 360 "x509/x509name.c"
              );
 } else
...
err:
 if ((ne == 
# 374 "x509/x509name.c" 3 4
           ((void *)0)
# 374 "x509/x509name.c"
               ) || (ret != *ne))
  X509_NAME_ENTRY_free(ret);
 return (
# 376 "x509/x509name.c" 3 4
        ((void *)0)
# 376 "x509/x509name.c"
            );
}
...
# 382 "x509/x509name.c"
  ...
  ERR_put_error(11,(115),((3|64)),"x509/x509name.c",384)
                                  ;
  return (0);
 }
...
{
 if (ne == 
# 420 "x509/x509name.c" 3 4
          ((void *)0)
# 420 "x509/x509name.c"
              )
  return (
# 421 "x509/x509name.c" 3 4
         ((void *)0)
# 421 "x509/x509name.c"
             );
 return (ne->object);
...
{
 if (ne == 
# 433 "x509/x509name.c" 3 4
          ((void *)0)
# 433 "x509/x509name.c"
              )
  return (
# 434 "x509/x509name.c" 3 4
         ((void *)0)
# 434 "x509/x509name.c"
             );
 return (ne->value);
