...
struct lhash_st_ENGINE_PILE { int dummy; };
...
static unsigned long engine_pile_LHASH_HASH(const void *arg) { const ENGINE_PILE *a = arg; return engine_pile_hash(a); }
static int engine_pile_LHASH_COMP(const void *arg1, const void *arg2) { const ENGINE_PILE *a = arg1; const ENGINE_PILE *b = arg2; return engine_pile_cmp(a,b); }
...
int_table_check(ENGINE_TABLE **t, int create)
{
 ...
 if (!create)
  return 0;
 if ((lh = ((struct lhash_st_ENGINE_PILE *)lh_new(engine_pile_LHASH_HASH, engine_pile_LHASH_COMP))) == 
# 126 "engine/eng_table.c" 3 4
                                   ((void *)0)
# 126 "engine/eng_table.c"
                                       )
  return 0;
 *t = (ENGINE_TABLE *)lh;
 return 1;
    ...
    ENGINE *e, const int *nids, int num_nids, int setdefault)
{
 ...
 CRYPTO_lock(1|8,30,"engine/eng_table.c",141);
 if (!(*table))
  added = 1;
 ...
 while (num_nids--) {
  ...
  if (!fnd) {
   ...
   fnd->funct = 
# 163 "engine/eng_table.c" 3 4
               ((void *)0)
# 163 "engine/eng_table.c"
                   ;
   (void)((ENGINE_PILE *)lh_insert(((_LHASH *)((void*) (1 ? &(*table)->piles : (struct lhash_st_ENGINE_PILE*)0))), ((void*) (1 ? fnd : (ENGINE_PILE*)0))));
  }
  ...
  if (setdefault) {
   if (!engine_unlocked_init(e)) {
    ERR_put_error(38,(184),(109),"engine/eng_table.c",176)
                             ;
    goto end;
   }
   if (fnd->funct)
 ...
 CRYPTO_lock(2|8,30,"engine/eng_table.c",188);
 return ret;
}
...
int_unregister_cb_doall_arg(ENGINE_PILE *pile, ENGINE *e)
{
 ...
 if (pile->funct == e) {
  ...
  pile->funct = 
# 204 "engine/eng_table.c" 3 4
               ((void *)0)
# 204 "engine/eng_table.c"
                   ;
 }
}
static void int_unregister_cb_LHASH_DOALL_ARG(void *arg1, void *arg2) { ENGINE_PILE *a = arg1; ENGINE *b = arg2; int_unregister_cb_doall_arg(a, b); }

void
engine_table_unregister(ENGINE_TABLE **table, ENGINE *e)
{
 CRYPTO_lock(1|8,30,"engine/eng_table.c",212);
 if (int_table_check(table, 0))
  lh_doall_arg(((_LHASH *)((void*) (1 ? &(*table)->piles : (struct lhash_st_ENGINE_PILE*)0))), int_unregister_cb_LHASH_DOALL_ARG, ((void*) (1 ? e : (ENGINE*)0)))
                                                       ;
 CRYPTO_lock(2|8,30,"engine/eng_table.c",216);
}
...
static void int_cleanup_cb_LHASH_DOALL(void *arg) { ENGINE_PILE *a = arg; int_cleanup_cb_doall(a); }

void
engine_table_cleanup(ENGINE_TABLE **table)
{
 CRYPTO_lock(1|8,30,"engine/eng_table.c",232);
 if (*table) {
  lh_doall(((_LHASH *)((void*) (1 ? &(*table)->piles : (struct lhash_st_ENGINE_PILE*)0))), int_cleanup_cb_LHASH_DOALL)
                                     ;
  lh_free(((_LHASH *)((void*) (1 ? &(*table)->piles : (struct lhash_st_ENGINE_PILE*)0))));
  *table = 
# 237 "engine/eng_table.c" 3 4
          ((void *)0)
# 237 "engine/eng_table.c"
              ;
 }
 CRYPTO_lock(2|8,30,"engine/eng_table.c",239);
}
...
{
 ENGINE *ret = 
# 251 "engine/eng_table.c" 3 4
              ((void *)0)
# 251 "engine/eng_table.c"
                  ;
 ENGINE_PILE tmplate, *fnd = 
# 252 "engine/eng_table.c" 3 4
                            ((void *)0)
# 252 "engine/eng_table.c"
                                ;
 int initres, loop = 0;
 ...
 if (!(*table)) {
  ...
  return 
# 260 "engine/eng_table.c" 3 4
        ((void *)0)
# 260 "engine/eng_table.c"
            ;
 }
 ERR_set_mark();
 CRYPTO_lock(1|8,30,"engine/eng_table.c",263);
...
trynext:
 ...
 if (fnd)
  fnd->uptodate = 1;
# 330 "engine/eng_table.c"
 CRYPTO_lock(2|8,30,"engine/eng_table.c",330);
...
static void int_cb_LHASH_DOALL_ARG(void *arg1, void *arg2) { ENGINE_PILE *a = arg1; ENGINE_PILE_DOALL *b = arg2; int_cb_doall_arg(a, b); }
...
engine_table_doall(ENGINE_TABLE *table, engine_table_doall_cb *cb, void *arg)
{
 ...
 dall.cb = cb;
 dall.arg = arg;
 lh_doall_arg(((_LHASH *)((void*) (1 ? &table->piles : (struct lhash_st_ENGINE_PILE*)0))), int_cb_LHASH_DOALL_ARG, ((void*) (1 ? &dall : (ENGINE_PILE_DOALL*)0)))
                              ;
}
