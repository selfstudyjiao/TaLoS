...
X509_issuer_and_serial_hash(X509 *a)
{
 ...
 EVP_MD_CTX_init(&ctx);
 f = X509_NAME_oneline(a->cert_info->issuer, 
# 95 "x509/x509_cmp.c" 3 4
                                            ((void *)0)
# 95 "x509/x509_cmp.c"
                                                , 0);
 if (f == 
# 96 "x509/x509_cmp.c" 3 4
         ((void *)0)
# 96 "x509/x509_cmp.c"
             )
  goto err;
 if (!EVP_DigestInit_ex(&ctx, EVP_md5(), 
# 98 "x509/x509_cmp.c" 3 4
                                        ((void *)0)
# 98 "x509/x509_cmp.c"
                                            ))
  goto err;
...
X509_NAME_cmp(const X509_NAME *a, const X509_NAME *b)
{
 ...
 if (!a->canon_enc || a->modified) {
  ret = i2d_X509_NAME((X509_NAME *)a, 
# 236 "x509/x509_cmp.c" 3 4
                                     ((void *)0)
# 236 "x509/x509_cmp.c"
                                         );
  if (ret < 0)
 ...
 if (!b->canon_enc || b->modified) {
  ret = i2d_X509_NAME((X509_NAME *)b, 
# 241 "x509/x509_cmp.c" 3 4
                                     ((void *)0)
# 241 "x509/x509_cmp.c"
                                         );
  if (ret < 0)
...
X509_NAME_hash(X509_NAME *x)
{
 ...
 i2d_X509_NAME(x, 
# 258 "x509/x509_cmp.c" 3 4
                 ((void *)0)
# 258 "x509/x509_cmp.c"
                     );
 if (!EVP_Digest(x->canon_enc, x->canon_enclen, md, 
# 259 "x509/x509_cmp.c" 3 4
                                                   ((void *)0)
# 259 "x509/x509_cmp.c"
                                                       , EVP_sha1(),
     
# 260 "x509/x509_cmp.c" 3 4
    ((void *)0)
# 260 "x509/x509_cmp.c"
        ))
  return 0;
...
X509_NAME_hash_old(X509_NAME *x)
{
 ...
 i2d_X509_NAME(x, 
# 282 "x509/x509_cmp.c" 3 4
                 ((void *)0)
# 282 "x509/x509_cmp.c"
                     );
 EVP_MD_CTX_init(&md_ctx);
 if (EVP_DigestInit_ex(&md_ctx, EVP_md5(), 
# 284 "x509/x509_cmp.c" 3 4
                                          ((void *)0)
# 284 "x509/x509_cmp.c"
                                              ) &&
     EVP_DigestUpdate(&md_ctx, x->bytes->data, x->bytes->length) &&
     EVP_DigestFinal_ex(&md_ctx, md, 
# 286 "x509/x509_cmp.c" 3 4
                                    ((void *)0)
# 286 "x509/x509_cmp.c"
                                        ))
...
X509 *
X509_find_by_issuer_and_serial(struct stack_st_X509 *sk, X509_NAME *name,
    ASN1_INTEGER *serial)
{
 int i;
 X509_CINF cinf;
 X509 x, *x509 = 
# 305 "x509/x509_cmp.c" 3 4
                ((void *)0)
# 305 "x509/x509_cmp.c"
                    ;
...
# 308 "x509/x509_cmp.c"
 ...
 for (i = 0; i < sk_num(((_STACK*) (1 ? (sk) : (struct stack_st_X509*)0))); i++) {
  x509 = ((X509 *)sk_value(((_STACK*) (1 ? (sk) : (struct stack_st_X509*)0)), (i)));
  if (X509_issuer_and_serial_cmp(x509, &x) == 0)
   return (x509);
 }
 return (
# 319 "x509/x509_cmp.c" 3 4
        ((void *)0)
# 319 "x509/x509_cmp.c"
            );
}
...
X509 *
X509_find_by_subject(struct stack_st_X509 *sk, X509_NAME *name)
{
 X509 *x509;
 int i;
...
X509_check_private_key(X509 *x, EVP_PKEY *k)
{
 ...
 case 1:
  break;
 case 0:
  ERR_put_error(11,(128),(116),"x509/x509_cmp.c",374)
                                 ;
  break;
 case -1:
  ERR_put_error(11,(128),(115),"x509/x509_cmp.c",378)
                               ;
  break;
 case -2:
  ERR_put_error(11,(128),(117),"x509/x509_cmp.c",382)
                              ;
 }
 EVP_PKEY_free(xk);
 if (ret > 0)
