...
# 68 "x509/x509_r2x.c" 2

X509 *
X509_REQ_to_X509(X509_REQ *r, int days, EVP_PKEY *pkey)
{
 X509 *ret = 
# 72 "x509/x509_r2x.c" 3 4
            ((void *)0)
# 72 "x509/x509_r2x.c"
                ;
 X509_CINF *xi = 
# 73 "x509/x509_r2x.c" 3 4
                ((void *)0)
# 73 "x509/x509_r2x.c"
                    ;
 X509_NAME *xn;
 ...
 if ((ret = X509_new()) == 
# 76 "x509/x509_r2x.c" 3 4
                          ((void *)0)
# 76 "x509/x509_r2x.c"
                              ) {
  ERR_put_error(11,(123),((1|64)),"x509/x509_r2x.c",77);
  goto err;
 }
 ...
 if (sk_num(((_STACK*) (1 ? (r->req_info->attributes) : (struct stack_st_X509_ATTRIBUTE*)0))) != 0) {
  if ((xi->version = ASN1_INTEGER_new()) == 
# 85 "x509/x509_r2x.c" 3 4
                                           ((void *)0)
# 85 "x509/x509_r2x.c"
                                               )
   goto err;
