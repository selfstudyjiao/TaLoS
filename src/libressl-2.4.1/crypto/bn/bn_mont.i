    ...
    BN_MONT_CTX *mont, BN_CTX *ctx)
{
 ...
 if (num > 1 && a->top == num && b->top == num) {
  if ((((num) <= (r)->dmax)?(r):bn_expand2((r),(num))) == 
# 140 "bn/bn_mont.c" 3 4
                           ((void *)0)
# 140 "bn/bn_mont.c"
                               )
   return (0);
...
{
 BIGNUM *n;
 unsigned long *ap, *np, *rp, n0, v, carry;
 int nl, max, i;
 ...
 max = (2 * nl);
 if ((((max) <= (r)->dmax)?(r):bn_expand2((r),(max))) == 
# 194 "bn/bn_mont.c" 3 4
                          ((void *)0)
# 194 "bn/bn_mont.c"
                              )
  return (0);
 ...
 for (carry = 0, i = 0; i < nl; i++, rp++) {
  v = bn_mul_add_words(rp, np, nl, (rp[0] * n0) & (0xffffffffffffffffL));
  v = (v + carry + rp[nl]) & (0xffffffffffffffffL);
  carry |= (v != rp[nl]);
  carry &= (v <= rp[nl]);
  rp[nl] = v;
 }

 if ((((nl) <= (ret)->dmax)?(ret):bn_expand2((ret),(nl))) == 
# 223 "bn/bn_mont.c" 3 4
                           ((void *)0)
# 223 "bn/bn_mont.c"
                               )
  return (0);
...

 {
  ...
  m = (0 - (size_t)v);
  nrp = (unsigned long *)(((uintptr_t)rp & ~m)|((uintptr_t)ap & m));
...
BN_MONT_CTX_new(void)
{
 ...
 if ((ret = malloc(sizeof(BN_MONT_CTX))) == 
# 328 "bn/bn_mont.c" 3 4
                                           ((void *)0)
# 328 "bn/bn_mont.c"
                                               )
  return (
# 329 "bn/bn_mont.c" 3 4
         ((void *)0)
# 329 "bn/bn_mont.c"
             );
...
BN_MONT_CTX_set(BN_MONT_CTX *mont, const BIGNUM *mod, BN_CTX *ctx)
{
 ...
 BN_CTX_start(ctx);
 if ((Ri = BN_CTX_get(ctx)) == 
# 367 "bn/bn_mont.c" 3 4
                              ((void *)0)
# 367 "bn/bn_mont.c"
                                  )
  goto err;
...
# 428 "bn/bn_mont.c"
  ...
  if ((BN_mod_inverse(Ri, R, &tmod, ctx)) == 
# 436 "bn/bn_mont.c" 3 4
                                            ((void *)0)
# 436 "bn/bn_mont.c"
                                                )
   goto err;
  if (!BN_lshift(Ri, Ri, 64))
   goto err;
  if (!BN_is_zero(Ri)) {
   if (!BN_sub_word(Ri, 1))
    goto err;
  ...
  {
   if (!BN_set_word(Ri, (0xffffffffffffffffL)))
    goto err;
  }
  if (!BN_div(Ri, 
# 449 "bn/bn_mont.c" 3 4
                 ((void *)0)
# 449 "bn/bn_mont.c"
                     , Ri, &tmod, ctx))
   goto err;
...
# 477 "bn/bn_mont.c"
 ...
 if (!BN_set_bit(&(mont->RR), mont->ri*2))
  goto err;
 if (!BN_div(
# 480 "bn/bn_mont.c" 3 4
     ((void *)0)
# 480 "bn/bn_mont.c"
     ,(&(mont->RR)),(&(mont->RR)),(&(mont->N)),(ctx)))
  goto err;
...
BN_MONT_CTX_copy(BN_MONT_CTX *to, BN_MONT_CTX *from)
{
 ...
 if (!BN_copy(&(to->RR), &(from->RR)))
  return 
# 497 "bn/bn_mont.c" 3 4
        ((void *)0)
# 497 "bn/bn_mont.c"
            ;
 if (!BN_copy(&(to->N), &(from->N)))
  return 
# 499 "bn/bn_mont.c" 3 4
        ((void *)0)
# 499 "bn/bn_mont.c"
            ;
 if (!BN_copy(&(to->Ni), &(from->Ni)))
  return 
# 501 "bn/bn_mont.c" 3 4
        ((void *)0)
# 501 "bn/bn_mont.c"
            ;
 to->ri = from->ri;
    ...
    BN_CTX *ctx)
{
 ...
 CRYPTO_lock(1|4,lock,"bn/bn_mont.c",515);
 if (!*pmont) {
  CRYPTO_lock(2|4,lock,"bn/bn_mont.c",517);
  CRYPTO_lock(1|8,lock,"bn/bn_mont.c",518);
  got_write_lock = 1;
 ...
 if (got_write_lock)
  CRYPTO_lock(2|8,lock,"bn/bn_mont.c",533);
 else
  CRYPTO_lock(2|4,lock,"bn/bn_mont.c",535);
