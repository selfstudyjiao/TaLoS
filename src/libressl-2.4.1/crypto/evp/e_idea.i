...
static int idea_cbc_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { while(inl>=((size_t)1<<(sizeof(long)*8-2))) { idea_cbc_encrypt(in, out, (long)((size_t)1<<(sizeof(long)*8-2)), &((EVP_IDEA_KEY *)ctx->cipher_data)->ks, ctx->iv, ctx->encrypt); inl-=((size_t)1<<(sizeof(long)*8-2)); in +=((size_t)1<<(sizeof(long)*8-2)); out+=((size_t)1<<(sizeof(long)*8-2)); } if (inl) idea_cbc_encrypt(in, out, (long)inl, &((EVP_IDEA_KEY *)ctx->cipher_data)->ks, ctx->iv, ctx->encrypt); return 1;}
static int idea_ofb_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { while(inl>=((size_t)1<<(sizeof(long)*8-2))) { idea_ofb64_encrypt(in, out, (long)((size_t)1<<(sizeof(long)*8-2)), &((EVP_IDEA_KEY *)ctx->cipher_data)->ks, ctx->iv, &ctx->num); inl-=((size_t)1<<(sizeof(long)*8-2)); in +=((size_t)1<<(sizeof(long)*8-2)); out+=((size_t)1<<(sizeof(long)*8-2)); } if (inl) idea_ofb64_encrypt(in, out, (long)inl, &((EVP_IDEA_KEY *)ctx->cipher_data)->ks, ctx->iv, &ctx->num); return 1;}
static int idea_cfb64_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { size_t chunk=((size_t)1<<(sizeof(long)*8-2)); if (64==1) chunk>>=3; if (inl<chunk) chunk=inl; while(inl && inl>=chunk) { idea_cfb64_encrypt(in, out, (long)((64==1) && !(ctx->flags & 0x2000) ?inl*8:inl), &((EVP_IDEA_KEY *)ctx->cipher_data)->ks, ctx->iv, &ctx->num, ctx->encrypt); inl-=chunk; in +=chunk; out+=chunk; if(inl<chunk) chunk=inl; } return 1;}

static const EVP_CIPHER idea_cbc = { 34, 8, 16, 8, 0 | 0x2, idea_init_key, idea_cbc_cipher, 
# 98 "evp/e_idea.c" 3 4
((void *)0)
# 98 "evp/e_idea.c"
, sizeof(IDEA_KEY_SCHEDULE), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, 
# 98 "evp/e_idea.c" 3 4
((void *)0)
# 98 "evp/e_idea.c"
, 
...
((void *)0) 
# 98 "evp/e_idea.c"
}; const EVP_CIPHER *EVP_idea_cbc(void) { return &idea_cbc; } static const EVP_CIPHER idea_cfb64 = { 35, 1, 16, 8, 0 | 0x3, idea_init_key, idea_cfb64_cipher, 
# 98 "evp/e_idea.c" 3 4
((void *)0)
# 98 "evp/e_idea.c"
, sizeof(IDEA_KEY_SCHEDULE), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, 
...
((void *)0) 
# 98 "evp/e_idea.c"
}; const EVP_CIPHER *EVP_idea_cfb64(void) { return &idea_cfb64; } static const EVP_CIPHER idea_ofb = { 46, 1, 16, 8, 0 | 0x4, idea_init_key, idea_ofb_cipher, 
# 98 "evp/e_idea.c" 3 4
((void *)0)
# 98 "evp/e_idea.c"
, sizeof(IDEA_KEY_SCHEDULE), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, 
...
((void *)0) 
# 98 "evp/e_idea.c"
}; const EVP_CIPHER *EVP_idea_ofb(void) { return &idea_ofb; } static const EVP_CIPHER idea_ecb = { 36, 8, 16, 0, 0 | 0x1, idea_init_key, idea_ecb_cipher, 
# 98 "evp/e_idea.c" 3 4
((void *)0)
# 98 "evp/e_idea.c"
, sizeof(IDEA_KEY_SCHEDULE), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, 
...
((void *)0) 
# 98 "evp/e_idea.c"
}; const EVP_CIPHER *EVP_idea_ecb(void) { return &idea_ecb; }
...
{
 if (!enc) {
  if ((EVP_CIPHER_CTX_flags(ctx) & 0xF0007) == 0x4)
   enc = 1;
  else if ((EVP_CIPHER_CTX_flags(ctx) & 0xF0007) == 0x3)
   enc = 1;
 }
 if (enc)
