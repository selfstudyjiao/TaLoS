...
OBJ_dup(const ASN1_OBJECT *o)
{
 ASN1_OBJECT *r;
 char *ln = 
# 77 "objects/obj_lib.c" 3 4
           ((void *)0)
# 77 "objects/obj_lib.c"
               , *sn = 
# 77 "objects/obj_lib.c" 3 4
                       ((void *)0)
# 77 "objects/obj_lib.c"
                           ;
 unsigned char *data = 
# 78 "objects/obj_lib.c" 3 4
                      ((void *)0)
# 78 "objects/obj_lib.c"
                          ;

 if (o == 
# 80 "objects/obj_lib.c" 3 4
         ((void *)0)
# 80 "objects/obj_lib.c"
             )
  return (
# 81 "objects/obj_lib.c" 3 4
         ((void *)0)
# 81 "objects/obj_lib.c"
             );
 if (!(o->flags & 0x01))
 ...
 r = ASN1_OBJECT_new();
 if (r == 
# 87 "objects/obj_lib.c" 3 4
         ((void *)0)
# 87 "objects/obj_lib.c"
             ) {
  ERR_put_error(8,(101),(13),"objects/obj_lib.c",88);
  return (
# 89 "objects/obj_lib.c" 3 4
         ((void *)0)
# 89 "objects/obj_lib.c"
             );
 }
 data = malloc(o->length);
 if (data == 
# 92 "objects/obj_lib.c" 3 4
            ((void *)0)
# 92 "objects/obj_lib.c"
                )
  goto err;
 if (o->data != 
# 94 "objects/obj_lib.c" 3 4
               ((void *)0)
# 94 "objects/obj_lib.c"
                   )
 ...
 r->nid = o->nid;
 r->ln = r->sn = 
# 100 "objects/obj_lib.c" 3 4
                ((void *)0)
# 100 "objects/obj_lib.c"
                    ;
 if (o->ln != 
# 101 "objects/obj_lib.c" 3 4
             ((void *)0)
# 101 "objects/obj_lib.c"
                 ) {
  ln = my_strdup(o->ln);
  if (ln == 
# 103 "objects/obj_lib.c" 3 4
           ((void *)0)
# 103 "objects/obj_lib.c"
               )
   goto err;
  r->ln = ln;
 }
 ...
 if (o->sn != 
# 108 "objects/obj_lib.c" 3 4
             ((void *)0)
# 108 "objects/obj_lib.c"
                 ) {
  sn = my_strdup(o->sn);
  if (sn == 
# 110 "objects/obj_lib.c" 3 4
           ((void *)0)
# 110 "objects/obj_lib.c"
               )
   goto err;
  r->sn = sn;
 }
 r->flags = o->flags | (0x01 |
     0x04 | 0x08);
 return (r);

err:
 ERR_put_error(8,(101),((1|64)),"objects/obj_lib.c",119);
 free(ln);
 free(sn);
 free(data);
 free(r);
 return (
# 124 "objects/obj_lib.c" 3 4
        ((void *)0)
# 124 "objects/obj_lib.c"
            );
}
