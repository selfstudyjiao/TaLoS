...
{
 return X509v3_add_ext(&(x->singleRequestExtensions), ex, loc) != 
# 193 "ocsp/ocsp_ext.c" 3 4
                                                                 ((void *)0)
# 193 "ocsp/ocsp_ext.c"
                                                                     ;
}
...
{
 return X509v3_add_ext(&(x->singleExtensions), ex, loc) != 
# 314 "ocsp/ocsp_ext.c" 3 4
                                                          ((void *)0)
# 314 "ocsp/ocsp_ext.c"
                                                              ;
}
# 369 "ocsp/ocsp_ext.c"
static int
ocsp_add1_nonce(struct stack_st_X509_EXTENSION **exts, unsigned char *val, int len)
{
 ...
 os.length = ASN1_object_size(0, len, 4);
 os.data = malloc(os.length);
 if (os.data == 
# 385 "ocsp/ocsp_ext.c" 3 4
               ((void *)0)
# 385 "ocsp/ocsp_ext.c"
                   )
  goto err;
 tmpval = os.data;
 ASN1_put_object(&tmpval, 0, len, 4, 0x00);
 if (val)
  memcpy(tmpval, val, len);
 else
  arc4random_buf(tmpval, len);
 if (!X509V3_add1_i2d(exts, 366, &os, 0,
     2L))
  goto err;
 ret = 1;
...
OCSP_check_nonce(OCSP_REQUEST *req, OCSP_BASICRESP *bs)
{
 ...
 req_idx = OCSP_REQUEST_get_ext_by_NID(req, 366, -1);
...
{
 X509_EXTENSION *x = 
# 484 "ocsp/ocsp_ext.c" 3 4
                    ((void *)0)
# 484 "ocsp/ocsp_ext.c"
                        ;
 OCSP_CRLID *cid = 
# 485 "ocsp/ocsp_ext.c" 3 4
                  ((void *)0)
# 485 "ocsp/ocsp_ext.c"
                      ;
...
{
 int nid;
 struct stack_st_ASN1_OBJECT *sk = 
# 520 "ocsp/ocsp_ext.c" 3 4
                            ((void *)0)
# 520 "ocsp/ocsp_ext.c"
                                ;
 ASN1_OBJECT *o = 
# 521 "ocsp/ocsp_ext.c" 3 4
                 ((void *)0)
# 521 "ocsp/ocsp_ext.c"
                     ;
 X509_EXTENSION *x = 
# 522 "ocsp/ocsp_ext.c" 3 4
                    ((void *)0)
# 522 "ocsp/ocsp_ext.c"
                        ;

 if (!(sk = ((struct stack_st_ASN1_OBJECT *)sk_new_null())))
  return 
# 525 "ocsp/ocsp_ext.c" 3 4
        ((void *)0)
# 525 "ocsp/ocsp_ext.c"
            ;
 while (oids && *oids) {
  if ((nid = OBJ_txt2nid(*oids)) != 0 &&
      (o = OBJ_nid2obj(nid)))
   if (sk_push(((_STACK*) (1 ? (sk) : (struct stack_st_ASN1_OBJECT*)0)), ((void*) (1 ? (o) : (ASN1_OBJECT*)0))) == 0) {
    sk_pop_free(((_STACK*) (1 ? (sk) : (struct stack_st_ASN1_OBJECT*)0)), ((void (*)(void *)) ((1 ? (ASN1_OBJECT_free) : (void (*)(ASN1_OBJECT *))0))));
    return 
# 531 "ocsp/ocsp_ext.c" 3 4
          ((void *)0)
# 531 "ocsp/ocsp_ext.c"
              ;
   }
...
{
 X509_EXTENSION *x = 
# 544 "ocsp/ocsp_ext.c" 3 4
                    ((void *)0)
# 544 "ocsp/ocsp_ext.c"
                        ;
 ASN1_GENERALIZEDTIME *gt = 
# 545 "ocsp/ocsp_ext.c" 3 4
                           ((void *)0)
# 545 "ocsp/ocsp_ext.c"
                               ;
 ...
 if (!(gt = ASN1_GENERALIZEDTIME_new()))
  return 
# 548 "ocsp/ocsp_ext.c" 3 4
        ((void *)0)
# 548 "ocsp/ocsp_ext.c"
            ;
 if (!(ASN1_GENERALIZEDTIME_set_string(gt, tim)))
  goto err;
 x = X509V3_EXT_i2d(370, 0, gt);
...
{
 X509_EXTENSION *x = 
# 566 "ocsp/ocsp_ext.c" 3 4
                    ((void *)0)
# 566 "ocsp/ocsp_ext.c"
                        ;
 ASN1_IA5STRING *ia5 = 
# 567 "ocsp/ocsp_ext.c" 3 4
                      ((void *)0)
# 567 "ocsp/ocsp_ext.c"
                          ;
 OCSP_SERVICELOC *sloc = 
# 568 "ocsp/ocsp_ext.c" 3 4
                        ((void *)0)
# 568 "ocsp/ocsp_ext.c"
                            ;
 ACCESS_DESCRIPTION *ad = 
# 569 "ocsp/ocsp_ext.c" 3 4
                         ((void *)0)
# 569 "ocsp/ocsp_ext.c"
                             ;
 ...
 if (!(sloc->issuer = X509_NAME_dup(issuer)))
  goto err;
 if (urls && *urls &&
     !(sloc->locator = ((struct stack_st_ACCESS_DESCRIPTION *)sk_new_null())))
  goto err;
 while (urls && *urls) {
  if (!(ad = ACCESS_DESCRIPTION_new()))
   goto err;
  if (!(ad->method = OBJ_nid2obj(178)))
   goto err;
  ...
  ia5 = 
# 591 "ocsp/ocsp_ext.c" 3 4
       ((void *)0)
# 591 "ocsp/ocsp_ext.c"
           ;
  if (!sk_push(((_STACK*) (1 ? (sloc->locator) : (struct stack_st_ACCESS_DESCRIPTION*)0)), ((void*) (1 ? (ad) : (ACCESS_DESCRIPTION*)0))))
   goto err;
  ad = 
# 594 "ocsp/ocsp_ext.c" 3 4
      ((void *)0)
# 594 "ocsp/ocsp_ext.c"
          ;
  urls++;
 }
 x = X509V3_EXT_i2d(371, 0, sloc);
