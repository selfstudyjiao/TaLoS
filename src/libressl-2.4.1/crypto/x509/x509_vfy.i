...
# 69 "x509/x509_vfy.c" 2
# 1 "../include/openssl/crypto.h" 1
# 119 "../include/openssl/crypto.h"
# 1 "../include/compat/stdlib.h" 1
# 120 "../include/openssl/crypto.h" 2
# 70 "x509/x509_vfy.c" 2
...
static void get_delta_sk(X509_STORE_CTX *ctx, X509_CRL **dcrl, int *pcrl_score,
    X509_CRL *base, struct stack_st_X509_CRL *crls);
static void crl_akid_check(X509_STORE_CTX *ctx, X509_CRL *crl, X509 **pissuer,
    int *pcrl_score);
static int crl_crldp_check(X509 *x, X509_CRL *crl, int crl_score,
    unsigned int *preasons);
static int check_crl_path(X509_STORE_CTX *ctx, X509 *x);
static int check_crl_chain(X509_STORE_CTX *ctx, struct stack_st_X509 *cert_path,
    struct stack_st_X509 *crl_path);
...
{
 X509 *x, *xtmp, *chain_ss = 
# 159 "x509/x509_vfy.c" 3 4
                            ((void *)0)
# 159 "x509/x509_vfy.c"
                                ;
 int bad_chain = 0;
 ...
 struct stack_st_X509 *sktmp = 
# 165 "x509/x509_vfy.c" 3 4
                        ((void *)0)
# 165 "x509/x509_vfy.c"
                            ;

 if (ctx->cert == 
# 167 "x509/x509_vfy.c" 3 4
                 ((void *)0)
# 167 "x509/x509_vfy.c"
                     ) {
  ERR_put_error(11,(127),(105),"x509/x509_vfy.c",169)
                                          ;
  return -1;
 }
 ...
 if (ctx->chain == 
# 177 "x509/x509_vfy.c" 3 4
                  ((void *)0)
# 177 "x509/x509_vfy.c"
                      ) {
  if (((ctx->chain = ((struct stack_st_X509 *)sk_new_null())) == 
# 178 "x509/x509_vfy.c" 3 4
                                           ((void *)0)
# 178 "x509/x509_vfy.c"
                                               ) ||
      (!sk_push(((_STACK*) (1 ? (ctx->chain) : (struct stack_st_X509*)0)), ((void*) (1 ? (ctx->cert) : (X509*)0))))) {
   ERR_put_error(11,(127),((1|64)),"x509/x509_vfy.c",180);
   goto end;
  }
  CRYPTO_add_lock(&ctx->cert->references,1,3,"x509/x509_vfy.c",183);
  ctx->last_untrusted = 1;
 }


 if (ctx->untrusted != 
# 188 "x509/x509_vfy.c" 3 4
                      ((void *)0) 
# 188 "x509/x509_vfy.c"
                           &&
     (sktmp = (struct stack_st_X509 *)sk_dup(((_STACK*) (1 ? ctx->untrusted : (struct stack_st_X509*)0)))) == 
# 189 "x509/x509_vfy.c" 3 4
                                             ((void *)0)
# 189 "x509/x509_vfy.c"
                                                 ) {
  ERR_put_error(11,(127),((1|64)),"x509/x509_vfy.c",190);
  goto end;
 }

 num = sk_num(((_STACK*) (1 ? (ctx->chain) : (struct stack_st_X509*)0)));
 x = ((X509 *)sk_value(((_STACK*) (1 ? (ctx->chain) : (struct stack_st_X509*)0)), (num - 1)));
 depth = param->depth;
 ...
 for (;;) {
  ...
  if (ctx->untrusted != 
# 212 "x509/x509_vfy.c" 3 4
                       ((void *)0)
# 212 "x509/x509_vfy.c"
                           ) {
   xtmp = find_issuer(ctx, sktmp, x);
   if (xtmp != 
# 214 "x509/x509_vfy.c" 3 4
              ((void *)0)
# 214 "x509/x509_vfy.c"
                  ) {
    if (!sk_push(((_STACK*) (1 ? (ctx->chain) : (struct stack_st_X509*)0)), ((void*) (1 ? (xtmp) : (X509*)0)))) {
     ERR_put_error(11,(127),((1|64)),"x509/x509_vfy.c",217)
                              ;
     goto end;
    }
    CRYPTO_add_lock(&xtmp->references,1,3,
                        "x509/x509_vfy.c"
# 220 "x509/x509_vfy.c"
    ,
                        221
# 220 "x509/x509_vfy.c"
                         ...
                         ;
    (void)(X509 *)sk_delete_ptr(((_STACK*) (1 ? (sktmp) : (struct stack_st_X509*)0)), ((void*) (1 ? (xtmp) : (X509*)0)));
    ctx->last_untrusted++;
    x = xtmp;
    num++;
 ...
 sk_free(((_STACK*) (1 ? (sktmp) : (struct stack_st_X509*)0)));
 sktmp = 
# 234 "x509/x509_vfy.c" 3 4
        ((void *)0)
# 234 "x509/x509_vfy.c"
            ;
# 244 "x509/x509_vfy.c"
 i = sk_num(((_STACK*) (1 ? (ctx->chain) : (struct stack_st_X509*)0)));
 x = ((X509 *)sk_value(((_STACK*) (1 ? (ctx->chain) : (struct stack_st_X509*)0)), (i - 1)));
 if (ctx->check_issued(ctx, x, x)) {

  if (sk_num(((_STACK*) (1 ? (ctx->chain) : (struct stack_st_X509*)0))) == 1) {
   ...
   if ((ok <= 0) || X509_cmp(x, xtmp)) {
    ...
    X509_free(x);
    x = xtmp;
    (void)sk_set(((_STACK*) (1 ? (ctx->chain) : (struct stack_st_X509*)0)), (i - 1), ((void*) (1 ? (x) : (X509*)0)));
    ctx->last_untrusted = 0;
   }
  } else {

   chain_ss = (X509 *)sk_pop(((_STACK*) (1 ? (ctx->chain) : (struct stack_st_X509*)0)));
   ctx->last_untrusted--;
   num--;
   x = ((X509 *)sk_value(((_STACK*) (1 ? (ctx->chain) : (struct stack_st_X509*)0)), (num - 1)));
  }
 ...
 for (;;) {
  ...
  x = xtmp;
  if (!sk_push(((_STACK*) (1 ? (ctx->chain) : (struct stack_st_X509*)0)), ((void*) (1 ? (x) : (X509*)0)))) {
   X509_free(xtmp);
   ERR_put_error(11,(127),((1|64)),"x509/x509_vfy.c",302);
   return 0;
  }
  num++;
 }
...
# 312 "x509/x509_vfy.c"
   ...
   if (!sk_push(((_STACK*) (1 ? (ctx->chain) : (struct stack_st_X509*)0)), ((void*) (1 ? (chain_ss) : (X509*)0)))) {
    X509_free(chain_ss);
    ERR_put_error(11,(127),((1|64)),"x509/x509_vfy.c",323);
    return 0;
   }
   num++;
...
# 373 "x509/x509_vfy.c"
 ...
 if (!bad_chain && (ctx->param->flags & 0x80))
 ...
 if (0) {
  ...
  X509_get_pubkey_parameters(
# 387 "x509/x509_vfy.c" 3 4
                            ((void *)0)
# 387 "x509/x509_vfy.c"
                                , ctx->chain);
 }
 if (sktmp != 
# 389 "x509/x509_vfy.c" 3 4
             ((void *)0)
# 389 "x509/x509_vfy.c"
                 )
  sk_free(((_STACK*) (1 ? (sktmp) : (struct stack_st_X509*)0)));
...
static X509 *
find_issuer(X509_STORE_CTX *ctx, struct stack_st_X509 *sk, X509 *x)
{
 int i;
 X509 *issuer, *rv = 
# 403 "x509/x509_vfy.c" 3 4
                    ((void *)0)
# 403 "x509/x509_vfy.c"
                        ;

 for (i = 0; i < sk_num(((_STACK*) (1 ? (sk) : (struct stack_st_X509*)0))); i++) {
  issuer = ((X509 *)sk_value(((_STACK*) (1 ? (sk) : (struct stack_st_X509*)0)), (i)));
 ...
 *issuer = find_issuer(ctx, ctx->other_ctx, x);
 if (*issuer) {
  CRYPTO_add_lock(&(*issuer)->references,1,3,"x509/x509_vfy.c",443);
  return 1;
 } else
  return 0;
}
...
# 476 "x509/x509_vfy.c"
 ...
 for (i = 0; i < ctx->last_untrusted; i++) {
  int ret;
  x = ((X509 *)sk_value(((_STACK*) (1 ? (ctx->chain) : (struct stack_st_X509*)0)), (i)));
  if (!(ctx->param->flags & 0x10) &&
      (x->ex_flags & 0x200)) {
   ctx->error = 34;
   ctx->error_depth = i;
   ctx->current_cert = x;
  ...
  if (!allow_proxy_certs && (x->ex_flags & 0x400)) {
   ctx->error = 40;
   ctx->error_depth = i;
   ctx->current_cert = x;
   ok = cb(0, ctx);
...
check_name_constraints(X509_STORE_CTX *ctx)
{
 ...
 for (i = sk_num(((_STACK*) (1 ? (ctx->chain) : (struct stack_st_X509*)0))) - 1; i >= 0; i--) {
  x = ((X509 *)sk_value(((_STACK*) (1 ? (ctx->chain) : (struct stack_st_X509*)0)), (i)));

  if (i && (x->ex_flags & 0x20))
   continue;
  ...
  for (j = sk_num(((_STACK*) (1 ? (ctx->chain) : (struct stack_st_X509*)0))) - 1; j > i; j--) {
   NAME_CONSTRAINTS *nc = ((X509 *)sk_value(((_STACK*) (1 ? (ctx->chain) : (struct stack_st_X509*)0)), (j)))->nc;
   if (nc) {
...
check_trust(X509_STORE_CTX *ctx)
{
 ...
 i = sk_num(((_STACK*) (1 ? (ctx->chain) : (struct stack_st_X509*)0))) - 1;
 x = ((X509 *)sk_value(((_STACK*) (1 ? (ctx->chain) : (struct stack_st_X509*)0)), (i)));
...
check_revocation(X509_STORE_CTX *ctx)
{
 ...
 if (!(ctx->param->flags & 0x4))
  return 1;
 if (ctx->param->flags & 0x8)
  last = sk_num(((_STACK*) (1 ? (ctx->chain) : (struct stack_st_X509*)0))) - 1;
 else {
...
# 685 "x509/x509_vfy.c"
 ...
 x = ((X509 *)sk_value(((_STACK*) (1 ? (ctx->chain) : (struct stack_st_X509*)0)), (cnum)));
 ctx->current_cert = x;
 ctx->current_issuer = 
# 693 "x509/x509_vfy.c" 3 4
                      ((void *)0)
# 693 "x509/x509_vfy.c"
                          ;
 ctx->current_crl_score = 0;
 ctx->current_reasons = 0;
 while (ctx->current_reasons != 0x807f) {
...
# 733 "x509/x509_vfy.c"
  ...
  X509_CRL_free(dcrl);
  crl = 
# 736 "x509/x509_vfy.c" 3 4
       ((void *)0)
# 736 "x509/x509_vfy.c"
           ;
  dcrl = 
# 737 "x509/x509_vfy.c" 3 4
        ((void *)0)
# 737 "x509/x509_vfy.c"
            ;
...
{
 time_t *ptime = 
# 760 "x509/x509_vfy.c" 3 4
                ((void *)0)
# 760 "x509/x509_vfy.c"
                    ;
 int i;

 if (ctx->param->flags & 0x200000)
  return (1);

 if (ctx->param->flags & 0x2)
  ptime = &ctx->param->check_time;

 if (notify)
  ctx->current_crl = crl;

 i = X509_cmp_time(((crl)->crl->lastUpdate), ptime);
 if (i == 0) {
  if (!notify)
   return 0;
  ctx->error = 15;
 ...
 if (((crl)->crl->nextUpdate)) {
  i = X509_cmp_time(((crl)->crl->nextUpdate), ptime);
    ...
    struct stack_st_X509_CRL *crls)
{
 ...
 X509_CRL *crl, *best_crl = 
# 824 "x509/x509_vfy.c" 3 4
                           ((void *)0)
# 824 "x509/x509_vfy.c"
                               ;
 X509 *crl_issuer = 
# 825 "x509/x509_vfy.c" 3 4
                   ((void *)0)
# 825 "x509/x509_vfy.c"
                       , *best_crl_issuer = 
# 825 "x509/x509_vfy.c" 3 4
...
# 825 "x509/x509_vfy.c"
 ...
 for (i = 0; i < sk_num(((_STACK*) (1 ? (crls) : (struct stack_st_X509_CRL*)0))); i++) {
  crl = ((X509_CRL *)sk_value(((_STACK*) (1 ? (crls) : (struct stack_st_X509_CRL*)0)), (i)));
  reasons = *preasons;
  ...
  *preasons = best_reasons;
  CRYPTO_add_lock(&best_crl->references,1,6,"x509/x509_vfy.c",847);
  if (*pdcrl) {
   X509_CRL_free(*pdcrl);
   *pdcrl = 
# 850 "x509/x509_vfy.c" 3 4
           ((void *)0)
# 850 "x509/x509_vfy.c"
               ;
  }
 ...
 if (best_score >= (0x100|0x040|0x080))
  return 1;
...
check_delta_base(X509_CRL *delta, X509_CRL *base)
{
 ...
 if (X509_NAME_cmp(((base)->crl->issuer),
     ((delta)->crl->issuer)))
  return 0;

 if (!crl_extension_match(delta, base, 90))
  return 0;
 if (!crl_extension_match(delta, base, 770))
  return 0;
    ...
    struct stack_st_X509_CRL *crls)
{
 ...
 if (!(ctx->param->flags & 0x2000))
  return;
 if (!((ctx->current_cert->ex_flags | base->flags) & 0x1000))
  return;
 for (i = 0; i < sk_num(((_STACK*) (1 ? (crls) : (struct stack_st_X509_CRL*)0))); i++) {
  delta = ((X509_CRL *)sk_value(((_STACK*) (1 ? (crls) : (struct stack_st_X509_CRL*)0)), (i)));
  if (check_delta_base(delta, base)) {
   if (check_crl_time(ctx, delta, 0))
    *pscore |= 0x002;
   CRYPTO_add_lock(&delta->references,1,6,"x509/x509_vfy.c",950);
   *dcrl = delta;
   return;
  }
 }
 *dcrl = 
# 955 "x509/x509_vfy.c" 3 4
        ((void *)0)
# 955 "x509/x509_vfy.c"
            ;
}
    ...
    X509_CRL *crl, X509 *x)
{
 ...
 if (crl->idp_flags & 0x2)
  return 0;

 if (!(ctx->param->flags & 0x1000)) {
  if (crl->idp_flags & (0x20 | 0x40))
   return 0;
 ...
 if (X509_NAME_cmp(X509_get_issuer_name(x), ((crl)->crl->issuer))) {
  if (!(crl->idp_flags & 0x20))
   return 0;
 } else
  crl_score |= 0x020;
...
{
 X509 *crl_issuer = 
# 1030 "x509/x509_vfy.c" 3 4
                   ((void *)0)
# 1030 "x509/x509_vfy.c"
                       ;
 X509_NAME *cnm = ((crl)->crl->issuer);
 int cidx = ctx->error_depth;
 int i;

 if (cidx != sk_num(((_STACK*) (1 ? (ctx->chain) : (struct stack_st_X509*)0))) - 1)
  cidx++;

 crl_issuer = ((X509 *)sk_value(((_STACK*) (1 ? (ctx->chain) : (struct stack_st_X509*)0)), (cidx)));

 if (X509_check_akid(crl_issuer, crl->akid) == 0) {
  if (*pcrl_score & 0x020) {
   *pcrl_score |= 0x004|0x018;
   *pissuer = crl_issuer;
   return;
  }
 }

 for (cidx++; cidx < sk_num(((_STACK*) (1 ? (ctx->chain) : (struct stack_st_X509*)0))); cidx++) {
  crl_issuer = ((X509 *)sk_value(((_STACK*) (1 ? (ctx->chain) : (struct stack_st_X509*)0)), (cidx)));
  if (X509_NAME_cmp(X509_get_subject_name(crl_issuer), cnm))
   continue;
  if (X509_check_akid(crl_issuer, crl->akid) == 0) {
   *pcrl_score |= 0x004|0x008;
   *pissuer = crl_issuer;
   return;
  }
 }
 ...
 for (i = 0; i < sk_num(((_STACK*) (1 ? (ctx->untrusted) : (struct stack_st_X509*)0))); i++) {
  crl_issuer = ((X509 *)sk_value(((_STACK*) (1 ? (ctx->untrusted) : (struct stack_st_X509*)0)), (i)));
  if (X509_NAME_cmp(X509_get_subject_name(crl_issuer), cnm))
   continue;
  if (X509_check_akid(crl_issuer, crl->akid) == 0) {
   *pissuer = crl_issuer;
...
# 1129 "x509/x509_vfy.c"
static int
check_crl_chain(X509_STORE_CTX *ctx, struct stack_st_X509 *cert_path,
    struct stack_st_X509 *crl_path)
{
 X509 *cert_ta, *crl_ta;

 cert_ta = ((X509 *)sk_value(((_STACK*) (1 ? (cert_path) : (struct stack_st_X509*)0)), (sk_num(((_STACK*) (1 ? (cert_path) : (struct stack_st_X509*)0))) - 1)));
 crl_ta = ((X509 *)sk_value(((_STACK*) (1 ? (crl_path) : (struct stack_st_X509*)0)), (sk_num(((_STACK*) (1 ? (crl_path) : (struct stack_st_X509*)0))) - 1)));
 if (!X509_cmp(cert_ta, crl_ta))
  return 1;
 return 0;
}
# 1149 "x509/x509_vfy.c"
static int
idp_check_dp(DIST_POINT_NAME *a, DIST_POINT_NAME *b)
{
 X509_NAME *nm = 
# 1152 "x509/x509_vfy.c" 3 4
                ((void *)0)
# 1152 "x509/x509_vfy.c"
                    ;
 GENERAL_NAMES *gens = 
# 1153 "x509/x509_vfy.c" 3 4
                      ((void *)0)
# 1153 "x509/x509_vfy.c"
                          ;
 ...
 if (nm) {
  for (i = 0; i < sk_num(((_STACK*) (1 ? (gens) : (struct stack_st_GENERAL_NAME*)0))); i++) {
   gena = ((GENERAL_NAME *)sk_value(((_STACK*) (1 ? (gens) : (struct stack_st_GENERAL_NAME*)0)), (i)));
   if (gena->type != 4)
    continue;
 ...
 for (i = 0; i < sk_num(((_STACK*) (1 ? (a->name.fullname) : (struct stack_st_GENERAL_NAME*)0))); i++) {
  gena = ((GENERAL_NAME *)sk_value(((_STACK*) (1 ? (a->name.fullname) : (struct stack_st_GENERAL_NAME*)0)), (i)));
  for (j = 0; j < sk_num(((_STACK*) (1 ? (b->name.fullname) : (struct stack_st_GENERAL_NAME*)0))); j++) {
   genb = ((GENERAL_NAME *)sk_value(((_STACK*) (1 ? (b->name.fullname) : (struct stack_st_GENERAL_NAME*)0)), (j)));
...
{
 int i;
 X509_NAME *nm = ((crl)->crl->issuer);


 if (!dp->CRLissuer)
  return !!(crl_score & 0x020);
 for (i = 0; i < sk_num(((_STACK*) (1 ? (dp->CRLissuer) : (struct stack_st_GENERAL_NAME*)0))); i++) {
  GENERAL_NAME *gen = ((GENERAL_NAME *)sk_value(((_STACK*) (1 ? (dp->CRLissuer) : (struct stack_st_GENERAL_NAME*)0)), (i)));
  if (gen->type != 4)
   continue;
...
crl_crldp_check(X509 *x, X509_CRL *crl, int crl_score, unsigned int *preasons)
{
 ...
 if (crl->idp_flags & 0x10)
  return 0;
 if (x->ex_flags & 0x10) {
  if (crl->idp_flags & 0x4)
   return 0;
 } else {
  if (crl->idp_flags & 0x8)
   return 0;
 }
 *preasons = crl->idp_reasons;
 for (i = 0; i < sk_num(((_STACK*) (1 ? (x->crldp) : (struct stack_st_DIST_POINT*)0))); i++) {
  DIST_POINT *dp = ((DIST_POINT *)sk_value(((_STACK*) (1 ? (x->crldp) : (struct stack_st_DIST_POINT*)0)), (i)));
...
get_crl_delta(X509_STORE_CTX *ctx, X509_CRL **pcrl, X509_CRL **pdcrl, X509 *x)
{
 int ok;
 X509 *issuer = 
# 1268 "x509/x509_vfy.c" 3 4
               ((void *)0)
# 1268 "x509/x509_vfy.c"
                   ;
 int crl_score = 0;
 unsigned int reasons;
 X509_CRL *crl = 
# 1271 "x509/x509_vfy.c" 3 4
                ((void *)0)
# 1271 "x509/x509_vfy.c"
                    , *dcrl = 
# 1271 "x509/x509_vfy.c" 3 4
                              ((void *)0)
# 1271 "x509/x509_vfy.c"
                                  ;
 struct stack_st_X509_CRL *skcrl;
 ...
 sk_pop_free(((_STACK*) (1 ? (skcrl) : (struct stack_st_X509_CRL*)0)), ((void (*)(void *)) ((1 ? (X509_CRL_free) : (void (*)(X509_CRL *))0))));
...
{
 X509 *issuer = 
# 1311 "x509/x509_vfy.c" 3 4
               ((void *)0)
# 1311 "x509/x509_vfy.c"
                   ;
 EVP_PKEY *ikey = 
# 1312 "x509/x509_vfy.c" 3 4
                 ((void *)0)
# 1312 "x509/x509_vfy.c"
                     ;
 int ok = 0, chnum, cnum;

 cnum = ctx->error_depth;
 chnum = sk_num(((_STACK*) (1 ? (ctx->chain) : (struct stack_st_X509*)0))) - 1;
 ...
 if (ctx->current_issuer) {
  ...
  issuer = ((X509 *)sk_value(((_STACK*) (1 ? (ctx->chain) : (struct stack_st_X509*)0)), (cnum + 1)));
 } else {
  issuer = ((X509 *)sk_value(((_STACK*) (1 ? (ctx->chain) : (struct stack_st_X509*)0)), (chnum)));
 ...
 if (issuer) {
  ...
  if (!crl->base_crl_number) {
   ...
   if ((issuer->ex_flags & 0x2) &&
       !(issuer->ex_kusage & 0x0002)) {
    ctx->error = 35;
    ok = ctx->verify_cb(0, ctx);
    if (!ok)
     goto err;
   ...
   if (!(ctx->current_crl_score & 0x080)) {
    ctx->error = 44;
    ok = ctx->verify_cb(0, ctx);
    if (!ok)
     goto err;
   ...
   if (!(ctx->current_crl_score & 0x008)) {
  ...
  if (!(ctx->current_crl_score & 0x040)) {
...
check_policy(X509_STORE_CTX *ctx)
{
 ...
 if (ret == 0) {
  ERR_put_error(11,(145),((1|64)),"x509/x509_vfy.c",1453);
  return 0;
 }
 ...
 if (ret == -1) {
  ...
  X509 *x;
  int i;
  for (i = 1; i < sk_num(((_STACK*) (1 ? (ctx->chain) : (struct stack_st_X509*)0))); i++) {
   x = ((X509 *)sk_value(((_STACK*) (1 ? (ctx->chain) : (struct stack_st_X509*)0)), (i)));
   if (!(x->ex_flags & 0x800))
    continue;
   ctx->current_cert = x;
 ...
 if (ret == -2) {
  ctx->current_cert = 
# 1475 "x509/x509_vfy.c" 3 4
                     ((void *)0)
# 1475 "x509/x509_vfy.c"
                         ;
  ctx->error = 43;
  return ctx->verify_cb(0, ctx);
 }

 if (ctx->param->flags & 0x800) {
  ctx->current_cert = 
# 1481 "x509/x509_vfy.c" 3 4
                     ((void *)0)
# 1481 "x509/x509_vfy.c"
                         ;
  ctx->error = 0;
...
{
 time_t *ptime = 
# 1493 "x509/x509_vfy.c" 3 4
                ((void *)0)
# 1493 "x509/x509_vfy.c"
                    ;
 int i;
...
internal_verify(X509_STORE_CTX *ctx)
{
 ...
 X509 *xs, *xi;
 EVP_PKEY *pkey = 
# 1548 "x509/x509_vfy.c" 3 4
                 ((void *)0)
# 1548 "x509/x509_vfy.c"
                     ;
 int (*cb)(int xok, X509_STORE_CTX *xctx);

 cb = ctx->verify_cb;

 n = sk_num(((_STACK*) (1 ? (ctx->chain) : (struct stack_st_X509*)0)));
 ctx->error_depth = n - 1;
 n--;
 xi = ((X509 *)sk_value(((_STACK*) (1 ? (ctx->chain) : (struct stack_st_X509*)0)), (n)));
 ...
 if (ctx->check_issued(ctx, xi, xi))
  ...
  if (n <= 0) {
   ...
   n--;
   ctx->error_depth = n;
   xs = ((X509 *)sk_value(((_STACK*) (1 ? (ctx->chain) : (struct stack_st_X509*)0)), (n)));
  }
 }
 ...
 while (n >= 0) {
  ...
  if (!xs->valid && (xs != xi ||
   ...
   if ((pkey = X509_get_pubkey(xi)) == 
# 1583 "x509/x509_vfy.c" 3 4
                                      ((void *)0)
# 1583 "x509/x509_vfy.c"
                                          ) {
    ctx->error = 6;
    ctx->current_cert = xi;
    ok = (*cb)(0, ctx);
   ...
   EVP_PKEY_free(pkey);
   pkey = 
# 1599 "x509/x509_vfy.c" 3 4
         ((void *)0)
# 1599 "x509/x509_vfy.c"
             ;
  }
...
{
 return X509_cmp_time(ctm, 
# 1644 "x509/x509_vfy.c" 3 4
                          ((void *)0)
# 1644 "x509/x509_vfy.c"
                              );
}
# 1660 "x509/x509_vfy.c"
int
X509_cmp_time(const ASN1_TIME *ctm, time_t *cmp_time)
{
 ...
 if (cmp_time == 
# 1668 "x509/x509_vfy.c" 3 4
                ((void *)0)
# 1668 "x509/x509_vfy.c"
                    )
  time2 = time(
# 1669 "x509/x509_vfy.c" 3 4
              ((void *)0)
# 1669 "x509/x509_vfy.c"
                  );
 else
  time2 = *cmp_time;
 ...
 if (tm1.tm_year < 150 && type != 23)
  goto out;
 if (tm1.tm_year >= 150 && type != 24)
  goto out;
 ...
 if (gmtime_r(&time2, &tm2) == 
# 1692 "x509/x509_vfy.c" 3 4
                              ((void *)0)
# 1692 "x509/x509_vfy.c"
                                  )
  goto out;
...
{
 return X509_time_adj(s, adj, 
# 1705 "x509/x509_vfy.c" 3 4
                             ((void *)0)
# 1705 "x509/x509_vfy.c"
                                 );
}
...
X509_time_adj_ex(ASN1_TIME *s, int offset_day, long offset_sec, time_t *in_time)
{
 time_t t;
 if (in_time == 
# 1718 "x509/x509_vfy.c" 3 4
               ((void *)0)
# 1718 "x509/x509_vfy.c"
                   )
  t = time(
# 1719 "x509/x509_vfy.c" 3 4
          ((void *)0)
# 1719 "x509/x509_vfy.c"
              );
 else
  t = *in_time;
...
int
X509_get_pubkey_parameters(EVP_PKEY *pkey, struct stack_st_X509 *chain)
{
 EVP_PKEY *ktmp = 
# 1729 "x509/x509_vfy.c" 3 4
                 ((void *)0)
# 1729 "x509/x509_vfy.c"
                     , *ktmp2;
 int i, j;

 if ((pkey != 
# 1732 "x509/x509_vfy.c" 3 4
             ((void *)0)
# 1732 "x509/x509_vfy.c"
                 ) && !EVP_PKEY_missing_parameters(pkey))
  return 1;

 for (i = 0; i < sk_num(((_STACK*) (1 ? (chain) : (struct stack_st_X509*)0))); i++) {
  ktmp = X509_get_pubkey(((X509 *)sk_value(((_STACK*) (1 ? (chain) : (struct stack_st_X509*)0)), (i))));
  if (ktmp == 
# 1737 "x509/x509_vfy.c" 3 4
             ((void *)0)
# 1737 "x509/x509_vfy.c"
                 ) {
   ERR_put_error(11,(110),(108),"x509/x509_vfy.c",1739)
                                             ;
   return 0;
  }
  if (!EVP_PKEY_missing_parameters(ktmp))
   ...
   EVP_PKEY_free(ktmp);
   ktmp = 
# 1746 "x509/x509_vfy.c" 3 4
         ((void *)0)
# 1746 "x509/x509_vfy.c"
             ;
  }
 }
 if (ktmp == 
# 1749 "x509/x509_vfy.c" 3 4
            ((void *)0)
# 1749 "x509/x509_vfy.c"
                ) {
  ERR_put_error(11,(110),(107),"x509/x509_vfy.c",1751)
                                                ;
  return 0;
 }
 ...
 for (j = i - 1; j >= 0; j--) {
  ktmp2 = X509_get_pubkey(((X509 *)sk_value(((_STACK*) (1 ? (chain) : (struct stack_st_X509*)0)), (j))));
  EVP_PKEY_copy_parameters(ktmp2, ktmp);
  EVP_PKEY_free(ktmp2);
 }

 if (pkey != 
# 1762 "x509/x509_vfy.c" 3 4
            ((void *)0)
# 1762 "x509/x509_vfy.c"
                )
    ...
    CRYPTO_EX_dup *dup_func, CRYPTO_EX_free *free_func)
{
 ...
 return CRYPTO_get_ex_new_index(5,
...
struct stack_st_X509 *X509_STORE_CTX_get1_chain(X509_STORE_CTX *ctx)
{
 ...
 if (!ctx->chain || !(chain = (struct stack_st_X509 *)sk_dup(((_STACK*) (1 ? ctx->chain : (struct stack_st_X509*)0)))))
  return 
# 1826 "x509/x509_vfy.c" 3 4
        ((void *)0)
# 1826 "x509/x509_vfy.c"
            ;
 for (i = 0; i < sk_num(((_STACK*) (1 ? (chain) : (struct stack_st_X509*)0))); i++) {
  x = ((X509 *)sk_value(((_STACK*) (1 ? (chain) : (struct stack_st_X509*)0)), (i)));
  CRYPTO_add_lock(&x->references,1,3,"x509/x509_vfy.c",1829);
 }
 return chain;
}
...
void
X509_STORE_CTX_set_chain(X509_STORE_CTX *ctx, struct stack_st_X509 *sk)
{
 ctx->untrusted = sk;
}

void
X509_STORE_CTX_set0_crls(X509_STORE_CTX *ctx, struct stack_st_X509_CRL *sk)
{
 ctx->crls = sk;
}
    ...
    int purpose, int trust)
{
 ...
 if (purpose) {
  ...
  if (idx == -1) {
   ERR_put_error(11,(134),(121),"x509/x509_vfy.c",1907)
                                 ;
   return 0;
  }
  ...
  if (ptmp->trust == -1) {
   ...
   if (idx == -1) {
    ERR_put_error(11,(134),(121),"x509/x509_vfy.c",1915)
                                  ;
    return 0;
   }
   ptmp = X509_PURPOSE_get0(idx);
 ...
 if (trust) {
  ...
  if (idx == -1) {
   ERR_put_error(11,(134),(120),"x509/x509_vfy.c",1928)
                               ;
   return 0;
  }
 }
...
X509_STORE_CTX_new(void)
{
 ...
 if (!ctx) {
  ERR_put_error(11,(142),((1|64)),"x509/x509_vfy.c",1947);
  return 
# 1948 "x509/x509_vfy.c" 3 4
        ((void *)0)
# 1948 "x509/x509_vfy.c"
            ;
 }
 return ctx;
}
...
{
 if (ctx == 
# 1956 "x509/x509_vfy.c" 3 4
           ((void *)0)
# 1956 "x509/x509_vfy.c"
               )
  return;
...
# 1978 "x509/x509_vfy.c"
 ...
 if (store && store->get_crl)
  ...
  ctx->get_crl = 
# 2018 "x509/x509_vfy.c" 3 4
                ((void *)0)
# 2018 "x509/x509_vfy.c"
                    ;
 ...
 if (store && store->cleanup)
  ...
  ctx->cleanup = 
# 2045 "x509/x509_vfy.c" 3 4
                ((void *)0)
# 2045 "x509/x509_vfy.c"
                    ;

 ctx->param = X509_VERIFY_PARAM_new();
 if (!ctx->param) {
  ERR_put_error(11,(143),((1|64)),"x509/x509_vfy.c",2049);
  return 0;
 }
 ...
 if (param_ret == 0) {
  ERR_put_error(11,(143),((1|64)),"x509/x509_vfy.c",2066);
  return 0;
 }

 if (CRYPTO_new_ex_data(5, ctx,
     &(ctx->ex_data)) == 0) {
  ERR_put_error(11,(143),((1|64)),"x509/x509_vfy.c",2072);
  return 0;
 }
 return 1;
}
...
void
X509_STORE_CTX_trusted_stack(X509_STORE_CTX *ctx, struct stack_st_X509 *sk)
{
 ctx->other_ctx = sk;
...
X509_STORE_CTX_cleanup(X509_STORE_CTX *ctx)
{
 if (ctx->cleanup)
  ctx->cleanup(ctx);
 if (ctx->param != 
# 2094 "x509/x509_vfy.c" 3 4
                  ((void *)0)
# 2094 "x509/x509_vfy.c"
                      ) {
  if (ctx->parent == 
# 2095 "x509/x509_vfy.c" 3 4
                    ((void *)0)
# 2095 "x509/x509_vfy.c"
                        )
   X509_VERIFY_PARAM_free(ctx->param);
  ctx->param = 
# 2097 "x509/x509_vfy.c" 3 4
              ((void *)0)
# 2097 "x509/x509_vfy.c"
                  ;
 }
 if (ctx->tree != 
# 2099 "x509/x509_vfy.c" 3 4
                 ((void *)0)
# 2099 "x509/x509_vfy.c"
                     ) {
  X509_policy_tree_free(ctx->tree);
  ctx->tree = 
# 2101 "x509/x509_vfy.c" 3 4
             ((void *)0)
# 2101 "x509/x509_vfy.c"
                 ;
 }
 if (ctx->chain != 
# 2103 "x509/x509_vfy.c" 3 4
                  ((void *)0)
# 2103 "x509/x509_vfy.c"
                      ) {
  sk_pop_free(((_STACK*) (1 ? (ctx->chain) : (struct stack_st_X509*)0)), ((void (*)(void *)) ((1 ? (X509_free) : (void (*)(X509 *))0))));
  ctx->chain = 
# 2105 "x509/x509_vfy.c" 3 4
              ((void *)0)
# 2105 "x509/x509_vfy.c"
                  ;
 }
 CRYPTO_free_ex_data(5,
     ctx, &(ctx->ex_data));
