...
static const UI_METHOD *default_UI_meth = 
# 77 "ui/ui_lib.c" 3 4
                                         ((void *)0)
# 77 "ui/ui_lib.c"
                                             ;
...
# 92 "ui/ui_lib.c"
  ...
  ERR_put_error(40,(104),((1|64)),"ui/ui_lib.c",93);
  return 
# 94 "ui/ui_lib.c" 3 4
        ((void *)0)
# 94 "ui/ui_lib.c"
...
# 102 "ui/ui_lib.c"
                     ;
 ret->flags = 0;
 CRYPTO_new_ex_data(11, ret, &ret->ex_data);
 return ret;
}
...
# 129 "ui/ui_lib.c"
  ...
  return;
 sk_pop_free(((_STACK*) (1 ? (ui->strings) : (struct stack_st_UI_STRING*)0)), ((void (*)(void *)) ((1 ? (free_string) : (void (*)(UI_STRING *))0))));
 CRYPTO_free_ex_data(11, ui, &ui->ex_data);
 free(ui);
}
...
# 139 "ui/ui_lib.c"
  ...
  ui->strings = ((struct stack_st_UI_STRING *)sk_new_null());
  if (ui->strings == 
# 141 "ui/ui_lib.c" 3 4
                    ((void *)0)
# 141 "ui/ui_lib.c"
...
# 154 "ui/ui_lib.c"
  ...
  ERR_put_error(40,(109),((3|64)),"ui/ui_lib.c",156)
                                  ;
 } else if ((type == UIT_PROMPT || type == UIT_VERIFY ||
     type == UIT_BOOLEAN) && result_buf == 
# 158 "ui/ui_lib.c" 3 4
                                          ((void *)0)
# 158 "ui/ui_lib.c"
                                              ) {
  ERR_put_error(40,(109),(105),"ui/ui_lib.c",159);
 } else if ((ret = malloc(sizeof(UI_STRING)))) {
  ret->out_string = prompt;
  ret->flags = prompt_freeable ? 0x01 : 0;
    ...
    int maxsize, const char *test_buf)
{
 ...
 if (s) {
  if (allocate_string_stack(ui) >= 0) {
   ...
   ret = sk_push(((_STACK*) (1 ? (ui->strings) : (struct stack_st_UI_STRING*)0)), ((void*) (1 ? (s) : (UI_STRING*)0)));
...
# 203 "ui/ui_lib.c"
  ...
  ERR_put_error(40,(108),((3|64)),"ui/ui_lib.c",205)
                                  ;
...
# 206 "ui/ui_lib.c"
  ...
  ERR_put_error(40,(108),((3|64)),"ui/ui_lib.c",208)
                                  ;
 } else {
  for (p = ok_chars; *p; p++) {
   if (
...
# 211 "ui/ui_lib.c"
    ...
    ERR_put_error(40,(108),(104),"ui/ui_lib.c",213)
                                             ;
   }
  }
...
# 258 "ui/ui_lib.c"
   ...
   ERR_put_error(40,(103),((1|64)),"ui/ui_lib.c",259);
   return 0;
  }
 }
...
# 283 "ui/ui_lib.c"
   ...
   ERR_put_error(40,(106),((1|64)),"ui/ui_lib.c",284);
   return -1;
  }
 }
...
# 311 "ui/ui_lib.c"
   ...
   ERR_put_error(40,(110),((1|64)),"ui/ui_lib.c",312);
   goto err;
  }
 }
 if (action_desc) {
...
# 318 "ui/ui_lib.c"
   ...
   ERR_put_error(40,(110),((1|64)),"ui/ui_lib.c",319);
   goto err;
  }
 }
 if (ok_chars) {
...
# 325 "ui/ui_lib.c"
   ...
   ERR_put_error(40,(110),((1|64)),"ui/ui_lib.c",326);
   goto err;
  }
 }
 if (cancel_chars) {
...
# 332 "ui/ui_lib.c"
   ...
   ERR_put_error(40,(110),((1|64)),"ui/ui_lib.c",333);
   goto err;
  }
 }
...
{
 return general_allocate_string(ui, text, 0, UIT_INFO, 0, 
# 352 "ui/ui_lib.c" 3 4
                                                         ((void *)0)
# 352 "ui/ui_lib.c"
                                                             , 0, 0,
...
# 363 "ui/ui_lib.c"
   ...
   ERR_put_error(40,(102),((1|64)),"ui/ui_lib.c",364);
   return -1;
  }
 }
 return general_allocate_string(ui, text_copy, 1, UIT_INFO, 0, 
# 368 "ui/ui_lib.c" 3 4
                                                              ((void *)0)
# 368 "ui/ui_lib.c"
                                                                  ,
...
{
 return general_allocate_string(ui, text, 0, UIT_ERROR, 0, 
# 375 "ui/ui_lib.c" 3 4
                                                          ((void *)0)
# 375 "ui/ui_lib.c"
                                                              , 0, 0,
...
# 386 "ui/ui_lib.c"
   ...
   ERR_put_error(40,(101),((1|64)),"ui/ui_lib.c",387);
   return -1;
  }
 }
 return general_allocate_string(ui, text_copy, 1, UIT_ERROR, 0, 
# 391 "ui/ui_lib.c" 3 4
                                                               ((void *)0)
# 391 "ui/ui_lib.c"
                                                                   ,
...
{
 if (i < 0) {
  ERR_put_error(40,(107),(103),"ui/ui_lib.c",438);
  return 
# 439 "ui/ui_lib.c" 3 4
        ((void *)0)
# 439 "ui/ui_lib.c"
 ...
 if (i >= sk_num(((_STACK*) (1 ? (ui->strings) : (struct stack_st_UI_STRING*)0)))) {
  ERR_put_error(40,(107),(102),"ui/ui_lib.c",442);
  return 
# 443 "ui/ui_lib.c" 3 4
        ((void *)0)
# 443 "ui/ui_lib.c"
 ...
 return UI_get0_result_string(((UI_STRING *)sk_value(((_STACK*) (1 ? (ui->strings) : (struct stack_st_UI_STRING*)0)), (i))));
}
...
UI_process(UI *ui)
{
 ...
 for (i = 0; i < sk_num(((_STACK*) (1 ? (ui->strings) : (struct stack_st_UI_STRING*)0))); i++) {
  if (ui->meth->ui_write_string &&
      !ui->meth->ui_write_string(ui,
   ((UI_STRING *)sk_value(((_STACK*) (1 ? (ui->strings) : (struct stack_st_UI_STRING*)0)), (i))))) {
   ok = -1;
   goto err;
  }
 }
...
# 525 "ui/ui_lib.c"
  ...
  ERR_put_error(40,(111),((3|64)),"ui/ui_lib.c",526);
  return -1;
 }
 switch (cmd) {
 case 1:
  {
   int save_flag = !!(ui->flags & 0x0100);
   if (i)
    ui->flags |= 0x0100;
   else
    ui->flags &= ~0x0100;
 ...
 case 2:
  return !!(ui->flags & 0x0001);
 default:
  break;
 }
 ERR_put_error(40,(111),(106),"ui/ui_lib.c",544);
 return -1;
}
...
UI_get_ex_new_index(long argl, void *argp, CRYPTO_EX_new *new_func,
    CRYPTO_EX_dup *dup_func, CRYPTO_EX_free *free_func)
{
 return CRYPTO_get_ex_new_index(11, argl, argp,
...
UI_set_result(UI *ui, UI_STRING *uis, const char *result)
{
 ...
 case UIT_VERIFY:
  if (l < uis->_.string_data.result_minsize) {
   ui->flags |= 0x0001;
   ERR_put_error(40,(105),(101),"ui/ui_lib.c",844)
                             ;
  ...
  if (l > uis->_.string_data.result_maxsize) {
   ui->flags |= 0x0001;
   ERR_put_error(40,(105),(100),"ui/ui_lib.c",854)
                             ;
   ERR_asprintf_error_data
       ("You must type in %d to %d characters",
    uis->_.string_data.result_minsize,
  ...
  if (!uis->result_buf) {
   ERR_put_error(40,(105),(105),"ui/ui_lib.c",862);
   return -1;
  }
 ...
 case UIT_BOOLEAN:
  {
   ...
   if (!uis->result_buf) {
    ERR_put_error(40,(105),(105),"ui/ui_lib.c",873);
    return -1;
   }
   uis->result_buf[0] = '\0';
   for (p = result; *p; p++) {
...
# 883 "ui/ui_lib.c"
       uis->_.boolean_data.cancel_chars
# 883 "ui/ui_lib.c" 3 4
       ) && (
# 883 "ui/ui_lib.c"
       *p
