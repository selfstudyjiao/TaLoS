...
# 152 "../ssl/s3_pkt.c"
 ...
 if (n > (int)(rb->len - rb->offset)) {
  ...
  ERR_put_error(20,(149),((4|64)),"../ssl/s3_pkt.c",218);
  return -1;
 }
...
# 237 "../ssl/s3_pkt.c" 3 4
 (*__errno_location ()) 
# 237 "../ssl/s3_pkt.c"
       = 0;
  if (s->rbio != 
# 238 "../ssl/s3_pkt.c" 3 4
                ((void *)0)
# 238 "../ssl/s3_pkt.c"
                    ) {
   s->rwstate = 3;
   ...
   ERR_put_error(20,(149),(211),"../ssl/s3_pkt.c",242);
   i = -1;
  }

  if (i <= 0) {
   rb->left = left;
   if (s->mode & 0x00000010L &&
       !(s->method->ssl3_enc->enc_flags & (1 << 3))) {
    if (len + left == 0)
...
again:
 ...
 if ((s->rstate != 0xF1) ||
  ...
  n = ssl3_read_n(s, 5, s->s3->rbuf.len, 0);
  if (n <= 0)
   return(n);
  s->rstate = 0xF1;
  ...
  if (!CBS_get_u8(&header, &type) ||
   ...
   ERR_put_error(20,(143),(115),"../ssl/s3_pkt.c",318)
                               ;
   goto err;
  }
  ...
  if (!s->first_packet && ssl_version != s->version) {
   ERR_put_error(20,(143),(267),"../ssl/s3_pkt.c",328)
                                  ;
  ...
  if ((ssl_version >> 8) != 0x03) {
   ERR_put_error(20,(143),(267),"../ssl/s3_pkt.c",339)
                                  ;
   goto err;
  }

  if (rr->length > s->s3->rbuf.len - 5) {
   al = 22;
   ERR_put_error(20,(143),(198),"../ssl/s3_pkt.c",346)
                                    ;
   goto f_err;
  }
 ...
 if (rr->length > s->packet_length - 5) {
 ...
 rr->input = &(s->packet[5]);
# 383 "../ssl/s3_pkt.c"
 if (rr->length > ((256 + 64)+16384)) {
  al = 22;
  ERR_put_error(20,(143),(150),"../ssl/s3_pkt.c",385);
  goto f_err;
 }
 ...
 if (enc_err == 0) {
  al = 21;
  ERR_put_error(20,(143),(129),"../ssl/s3_pkt.c",399);
  goto f_err;
 }
...
# 406 "../ssl/s3_pkt.c" 3 4
                                    ((void *)0)
# 406 "../ssl/s3_pkt.c"
                                        )) {

  unsigned char *mac = 
# 408 "../ssl/s3_pkt.c" 3 4
                      ((void *)0)
# 408 "../ssl/s3_pkt.c"
                          ;
  unsigned char mac_tmp[64];

  mac_size = EVP_MD_size(EVP_MD_CTX_md(s->read_hash));
  (void)((mac_size <= 64) ? 0 : (OpenSSLDie("../ssl/s3_pkt.c", 412, "mac_size <= EVP_MAX_MD_SIZE"),1));
  ...
  if (orig_len < mac_size ||
      ...
      orig_len < mac_size + 1)) {
   al = 50;
   ERR_put_error(20,(143),(160),"../ssl/s3_pkt.c",427);
   goto f_err;
  }

  if ((EVP_CIPHER_CTX_flags(s->enc_read_ctx) & 0xF0007) == 0x2) {
...
# 466 "../ssl/s3_pkt.c"
  al = 20;
  ERR_put_error(20,(143),(281),"../ssl/s3_pkt.c",468)
                                                ;
  goto f_err;
 }
 ...
 if (rr->length > 16384) {
  al = 22;
  ERR_put_error(20,(143),(146),"../ssl/s3_pkt.c",474);
  goto f_err;
 }
...
ssl3_write_bytes(SSL *s, int type, const void *buf_, int len)
{
 ...
 if (len < 0) {
  ERR_put_error(20,(158),((4|64)),"../ssl/s3_pkt.c",515);
  return -1;
 }
 ...
 if ((SSL_state(s)&(0x1000|0x2000)) && !s->in_handshake) {
  i = s->handshake_func(s);
  if (i < 0)
   return (i);
  if (i == 0) {
   ERR_put_error(20,(158),(229),"../ssl/s3_pkt.c",529)
                                   ;
   return -1;
  }
 }
 ...
 if (!clear && !create_empty_fragment && !s->s3->empty_fragment_done) {
  ...
  if (s->s3->need_empty_fragments &&
   ...
   if (prefix_len >
    ...
    ERR_put_error(20,(104),((4|64)),"../ssl/s3_pkt.c",639)
                             ;
    goto err;
   }
  }
 ...
 *(p++) = (s->version >> 8);
 ...
 if (s->state == (0x111|0x1000) && !s->renegotiate &&
     ((s->version >> 8) == 0x03 ? s->version : 0) > 0x0301)
  *(p++) = 0x1;
 else
  *(p++) = s->version&0xff;
 ...
 if (s->enc_write_ctx && (s->method->ssl3_enc->enc_flags & (1 << 0))) {
  int mode = (EVP_CIPHER_CTX_flags(s->enc_write_ctx) & 0xF0007);
  if (mode == 0x2) {
   ...
   eivlen = 0;
 } else if (s->aead_write_ctx != 
# 699 "../ssl/s3_pkt.c" 3 4
                                ((void *)0) 
# 699 "../ssl/s3_pkt.c"
                                     &&
 ...
 ((plen[0]=(unsigned char)(((wr->length)>> 8)&0xff), plen[1]=(unsigned char)(((wr->length) )&0xff)),plen+=2);
...
ssl3_write_pending(SSL *s, int type, const unsigned char *buf, unsigned int len)
{
 ...
 if ((s->s3->wpend_tot > (int)len) || ((s->s3->wpend_buf != buf) &&
     !(s->mode & 0x00000002L)) ||
     (s->s3->wpend_type != type)) {
  ERR_put_error(20,(159),(127),"../ssl/s3_pkt.c",795);
  return (-1);
 }

 for (;;) {
  
# 800 "../ssl/s3_pkt.c" 3 4
 (*__errno_location ()) 
# 800 "../ssl/s3_pkt.c"
       = 0;
  if (s->wbio != 
# 801 "../ssl/s3_pkt.c" 3 4
                ((void *)0)
# 801 "../ssl/s3_pkt.c"
                    ) {
   s->rwstate = 2;
   ...
   ERR_put_error(20,(159),(128),"../ssl/s3_pkt.c",807);
   i = -1;
  }
  if (i == wb->left) {
   wb->left = 0;
...
ssl3_read_bytes(SSL *s, int type, unsigned char *buf, int len, int peek)
{
 ...
 unsigned int n;
 SSL3_RECORD *rr;
 void (*cb)(const SSL *ssl, int type2, int val) = 
# 865 "../ssl/s3_pkt.c" 3 4
                                                 ((void *)0)
# 865 "../ssl/s3_pkt.c"
                                                     ;

 if (s->s3->rbuf.buf == 
# 867 "../ssl/s3_pkt.c" 3 4
                       ((void *)0)
# 867 "../ssl/s3_pkt.c"
                           )
  if (!ssl3_setup_read_buffer(s))
 ...
 if (len < 0) {
  ERR_put_error(20,(148),((4|64)),"../ssl/s3_pkt.c",872);
  return -1;
 }
 ...
 if ((type && type != 23 &&
     type != 22) ||
     (peek && (type != 23))) {
  ERR_put_error(20,(148),((4|64)),"../ssl/s3_pkt.c",879);
  return -1;
 }
 ...
 if (!s->in_handshake && (SSL_state(s)&(0x1000|0x2000))) {

  i = s->handshake_func(s);
  if (i < 0)
   return (i);
  if (i == 0) {
   ERR_put_error(20,(148),(229),"../ssl/s3_pkt.c",915)
                                   ;
   return (-1);
  }
 }
start:
 ...
 if (s->s3->change_cipher_spec
     ...
     && (rr->type != 22)) {
  al = 10;
  ERR_put_error(20,(148),(145),"../ssl/s3_pkt.c",944)
                                          ;
  goto f_err;
 }
 ...
 if (type == rr->type) {
  ...
  if ((SSL_state(s)&(0x1000|0x2000)) && (type == 23) &&
   (s->enc_read_ctx == 
# 962 "../ssl/s3_pkt.c" 3 4
                      ((void *)0)
# 962 "../ssl/s3_pkt.c"
                          )) {
   al = 10;
   ERR_put_error(20,(148),(100),"../ssl/s3_pkt.c",965)
                                   ;
   goto f_err;
  }
...

 {
  ...
  unsigned char *dest = 
# 1015 "../ssl/s3_pkt.c" 3 4
                       ((void *)0)
# 1015 "../ssl/s3_pkt.c"
                           ;
  unsigned int *dest_len = 
# 1016 "../ssl/s3_pkt.c" 3 4
                          ((void *)0)
# 1016 "../ssl/s3_pkt.c"
                              ;
 ...
 if ((!s->server) && (s->s3->handshake_fragment_len >= 4) &&
     (s->s3->handshake_fragment[0] == 0) &&
     (s->session != 
# 1051 "../ssl/s3_pkt.c" 3 4
                   ((void *)0)
# 1051 "../ssl/s3_pkt.c"
                       ) && (s->session->cipher != 
# 1051 "../ssl/s3_pkt.c" 3 4
...
# 1051 "../ssl/s3_pkt.c"
  ...
  if ((s->s3->handshake_fragment[1] != 0) ||
   ...
   al = 50;
   ERR_put_error(20,(148),(105),"../ssl/s3_pkt.c",1058);
   goto f_err;
  }

  if (s->msg_callback)
   s->msg_callback(0, s->version, 22,
  ...
  if ((SSL_state(s) == 0x03) &&
   ...
   if (ssl3_renegotiate_check(s)) {
    ...
    if (i < 0)
     return (i);
    if (i == 0) {
     ERR_put_error(20,(148),(229),"../ssl/s3_pkt.c",1077)
                                     ;
     return (-1);
    }

    if (!(s->mode & 0x00000004L)) {
     if (s->s3->rbuf.left == 0) {
...
# 1111 "../ssl/s3_pkt.c"
 ...
 if (s->s3->alert_fragment_len >= 2) {
  ...
  if (s->info_callback != 
# 1127 "../ssl/s3_pkt.c" 3 4
                         ((void *)0)
# 1127 "../ssl/s3_pkt.c"
                             )
   cb = s->info_callback;
  else if (s->ctx->info_callback != 
# 1129 "../ssl/s3_pkt.c" 3 4
                                   ((void *)0)
# 1129 "../ssl/s3_pkt.c"
                                       )
...
# 1153 "../ssl/s3_pkt.c"
   else if (alert_descr == 100) {
    al = 40;
    ERR_put_error(20,(148),(339),"../ssl/s3_pkt.c",1156)
                               ;
    goto f_err;
   }
   ...
   ERR_put_error(20,(148),(1000 + alert_descr),"../ssl/s3_pkt.c",1164)
                                          ;
   ...
   al = 47;
   ERR_put_error(20,(148),(246),"../ssl/s3_pkt.c",1172);
   goto f_err;
  }
 ...
 if (rr->type == 20) {
  ...
  if ((rr->length != 1) || (rr->off != 0) ||
   (rr->data[0] != 1)) {
   al = 47;
   ERR_put_error(20,(148),(103),"../ssl/s3_pkt.c",1193)
                                    ;
   goto f_err;
  }
...
# 1198 "../ssl/s3_pkt.c" 3 4
                              ((void *)0)
# 1198 "../ssl/s3_pkt.c"
                                  ) {
   al = 10;
   ERR_put_error(20,(148),(133),"../ssl/s3_pkt.c",1201)
                                ;
   goto f_err;
  }


  if (!(s->s3->flags & 0x0080)) {
   al = 10;
   ERR_put_error(20,(148),(133),"../ssl/s3_pkt.c",1209)
                                ;
   goto f_err;
  }
  s->s3->flags &= ~0x0080;
 ...
 if ((s->s3->handshake_fragment_len >= 4) && !s->in_handshake) {
  if (((s->state&0x0FFF) == 0x03) &&
      !(s->s3->flags & 0x0001)) {
   s->state = s->server ? 0x2000 : 0x1000;
   s->renegotiate = 1;
   s->new_session = 1;
  }
  i = s->handshake_func(s);
  if (i < 0)
   return (i);
  if (i == 0) {
   ERR_put_error(20,(148),(229),"../ssl/s3_pkt.c",1242)
                                   ;
   return (-1);
  }
 ...
 default:
  ...
  al = 10;
  ERR_put_error(20,(148),(245),"../ssl/s3_pkt.c",1275);
  goto f_err;
 case 20:
 case 21:
 case 22:
  ...
  al = 10;
  ERR_put_error(20,(148),((4|64)),"../ssl/s3_pkt.c",1284);
  goto f_err;
 case 23:
  ...
  if (s->s3->in_read_app_data &&
   ...
   al = 10;
   ERR_put_error(20,(148),(245),"../ssl/s3_pkt.c",1306);
   goto f_err;
  }
 }
...
# 1330 "../ssl/s3_pkt.c" 3 4
                            ((void *)0)
# 1330 "../ssl/s3_pkt.c"
                                ) {
  if (s->session == 
# 1331 "../ssl/s3_pkt.c" 3 4
                   ((void *)0) 
# 1331 "../ssl/s3_pkt.c"
                        || s->session->master_key_length == 0) {

   ERR_put_error(20,(292),(133),"../ssl/s3_pkt.c",1334)
                                ;
   return (0);
  }
 ...
 if (i == 0) {
  ERR_put_error(20,(292),((4|64)),"../ssl/s3_pkt.c",1360);
  return 0;
 }
...
ssl3_send_alert(SSL *s, int level, int desc)
{
 ...
 if ((level == 2) && (s->session != 
# 1376 "../ssl/s3_pkt.c" 3 4
                                   ((void *)0)
# 1376 "../ssl/s3_pkt.c"
                                       ))
  SSL_CTX_remove_session(s->ctx, s->session);
...
ssl3_dispatch_alert(SSL *s)
{
 int i, j;
 void (*cb)(const SSL *ssl, int type, int val) = 
# 1394 "../ssl/s3_pkt.c" 3 4
                                                ((void *)0)
# 1394 "../ssl/s3_pkt.c"
                                                    ;

 s->s3->alert_dispatch = 0;
 i = do_ssl3_write(s, 21, &s->s3->send_alert[0], 2, 0);
 if (i <= 0) {
  s->s3->alert_dispatch = 1;
 } else {
...
# 1405 "../ssl/s3_pkt.c"
  ...
  if (s->info_callback != 
# 1411 "../ssl/s3_pkt.c" 3 4
                         ((void *)0)
# 1411 "../ssl/s3_pkt.c"
                             )
   cb = s->info_callback;
  else if (s->ctx->info_callback != 
# 1413 "../ssl/s3_pkt.c" 3 4
                                   ((void *)0)
# 1413 "../ssl/s3_pkt.c"
                                       )
   cb = s->ctx->info_callback;
