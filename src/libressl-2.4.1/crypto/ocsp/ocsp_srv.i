...
{
 return sk_num(((_STACK*) (1 ? (req->tbsRequest->requestList) : (struct stack_st_OCSP_ONEREQ*)0)));
}

OCSP_ONEREQ *
OCSP_request_onereq_get0(OCSP_REQUEST *req, int i)
{
 return ((OCSP_ONEREQ *)sk_value(((_STACK*) (1 ? (req->tbsRequest->requestList) : (struct stack_st_OCSP_ONEREQ*)0)), (i)));
}
...
# 119 "ocsp/ocsp_srv.c"
 ...
 if (!(rsp->responseBytes = OCSP_RESPBYTES_new()))
  goto err;
 rsp->responseBytes->responseType = OBJ_nid2obj(365);
...
# 145 "ocsp/ocsp_srv.c"
 ...
 if (!rsp->tbsResponseData->responses &&
     !(rsp->tbsResponseData->responses = ((struct stack_st_OCSP_SINGLERESP *)sk_new_null())))
  goto err;
 ...
 case 1:
  if (!revtime) {
   ERR_put_error(39,(103),(109),"ocsp/ocsp_srv.c",172)
                              ;
   goto err;
  }
 ...
 if (!(sk_push(((_STACK*) (1 ? (rsp->tbsResponseData->responses) : (struct stack_st_OCSP_SINGLERESP*)0)), ((void*) (1 ? (single) : (OCSP_SINGLERESP*)0)))))
  goto err;
 return single;
...
{
 if (!resp->certs && !(resp->certs = ((struct stack_st_X509 *)sk_new_null())))
  return 0;

 if (!sk_push(((_STACK*) (1 ? (resp->certs) : (struct stack_st_X509*)0)), ((void*) (1 ? (cert) : (X509*)0))))
  return 0;
 CRYPTO_add_lock(&cert->references,1,3,"ocsp/ocsp_srv.c",217);
 return 1;
}
    ...
    const EVP_MD *dgst, struct stack_st_X509 *certs, unsigned long flags)
{
 ...
 if (!X509_check_private_key(signer, key)) {
  ERR_put_error(39,(104),(110),"ocsp/ocsp_srv.c",230)
                                                    ;
  goto err;
 }
 ...
 if (!(flags & 0x1)) {
  ...
  for (i = 0; i < sk_num(((_STACK*) (1 ? (certs) : (struct stack_st_X509*)0))); i++) {
   X509 *tmpcert = ((X509 *)sk_value(((_STACK*) (1 ? (certs) : (struct stack_st_X509*)0)), (i)));
 ...
 if (flags & 0x400) {
  ...
  X509_pubkey_digest(signer, EVP_sha1(), md, 
# 248 "ocsp/ocsp_srv.c" 3 4
                                            ((void *)0)
# 248 "ocsp/ocsp_srv.c"
                                                );
 ...
 if (!ASN1_item_sign((&(OCSP_RESPDATA_it)),brsp->signatureAlgorithm,
# 269 "ocsp/ocsp_srv.c" 3 4
     ((void *)0)
# 269 "ocsp/ocsp_srv.c"
     , brsp->signature,brsp->tbsResponseData,key,dgst))
  goto err;
