...
conn_state(BIO *b, BIO_CONNECT *c)
{
 ...
 unsigned long l;
 char *p, *q;
 int (*cb)(const BIO *, int, int) = 
# 136 "bio/bss_conn.c" 3 4
                                   ((void *)0)
# 136 "bio/bss_conn.c"
                                       ;

 if (c->info_callback != 
# 138 "bio/bss_conn.c" 3 4
                        ((void *)0)
# 138 "bio/bss_conn.c"
                            )
  cb = c->info_callback;
 ...
 for (;;) {
  ...
  case 1:
   p = c->param_hostname;
   if (p == 
# 145 "bio/bss_conn.c" 3 4
           ((void *)0)
# 145 "bio/bss_conn.c"
               ) {
    ERR_put_error(32,(115),(112),"bio/bss_conn.c",146);
    goto exit_loop;
   }
   for (; *p != '\0'; p++) {
    if ((*p == ':') || (*p == '/'))
   ...
   if (c->param_port == 
# 168 "bio/bss_conn.c" 3 4
                       ((void *)0)
# 168 "bio/bss_conn.c"
                           ) {
    ERR_put_error(32,(115),(114),"bio/bss_conn.c",169);
...
# 184 "bio/bss_conn.c"
  ...
  case 4:
   ...
   c->them.sin_family = 
# 195 "bio/bss_conn.c" 3 4
                       2
# 195 "bio/bss_conn.c"
                              ;
   c->them.sin_port = 
# 196 "bio/bss_conn.c" 3 4
                     (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (
# 196 "bio/bss_conn.c"
                     (unsigned short)c->port
# 196 "bio/bss_conn.c" 3 4
...
# 196 "bio/bss_conn.c"
   ...
   c->them.sin_addr.s_addr = 
# 202 "bio/bss_conn.c" 3 4
                            __bswap_32 (
# 202 "bio/bss_conn.c"
                            l
# 202 "bio/bss_conn.c" 3 4
...
# 205 "bio/bss_conn.c"
   ...
   if (ret == -1) {
    ERR_put_error(2,(4),(
# 207 "bio/bss_conn.c" 3 4
   (*__errno_location ())
# 207 "bio/bss_conn.c"
   ),"bio/bss_conn.c",207);
    ERR_asprintf_error_data("host=%s:%s",
        c->param_hostname, c->param_port);
    ERR_put_error(32,(115),(118),"bio/bss_conn.c",211)
                                      ;
    goto exit_loop;
   }
   b->num = ret;
  ...
  case 8:
   if (c->nbio) {
    if (!BIO_socket_nbio(b->num, 1)) {
     ERR_put_error(32,(115),(104),"bio/bss_conn.c",222)
                                  ;
     ERR_asprintf_error_data("host=%s:%s",
         c->param_hostname, c->param_port);
     goto exit_loop;
...
# 232 "bio/bss_conn.c"
   ...
   if (i < 0) {
    ERR_put_error(2,(4),(
# 234 "bio/bss_conn.c" 3 4
   (*__errno_location ())
# 234 "bio/bss_conn.c"
   ),"bio/bss_conn.c",234);
    ERR_asprintf_error_data("host=%s:%s",
        c->param_hostname, c->param_port);
    ERR_put_error(32,(115),(109),"bio/bss_conn.c",237);
    goto exit_loop;
   }
  ...
  case 5:
   ...
   if (ret < 0) {
    if (BIO_sock_should_retry(ret)) {
     BIO_set_flags(b, (0x04|0x08));
     c->state = 7;
     b->retry_reason = 0x02;
    } else {
     ERR_put_error(2,(2),(
# 255 "bio/bss_conn.c" 3 4
    (*__errno_location ())
# 255 "bio/bss_conn.c"
    ),"bio/bss_conn.c",255);
     ERR_asprintf_error_data("host=%s:%s",
         c->param_hostname, c->param_port);
     ERR_put_error(32,(115),(103),"bio/bss_conn.c",259)
                             ;
    }
    goto exit_loop;
   } else
  ...
  case 7:
   ...
   if (i) {
    BIO_clear_flags(b, ((0x01|0x02|0x04)|0x08));
    ERR_put_error(2,(2),(i),"bio/bss_conn.c",270);
    ERR_asprintf_error_data("host=%s:%s",
        c->param_hostname, c->param_port);
    ERR_put_error(32,(115),(110),"bio/bss_conn.c",274)
                                 ;
    ret = 0;
    goto exit_loop;
   } else
...
BIO_CONNECT_new(void)
{
 ...
 if ((ret = malloc(sizeof(BIO_CONNECT))) == 
# 308 "bio/bss_conn.c" 3 4
                                           ((void *)0)
# 308 "bio/bss_conn.c"
                                               )
  return (
# 309 "bio/bss_conn.c" 3 4
         ((void *)0)
# 309 "bio/bss_conn.c"
             );
 ret->state = 1;
 ret->param_hostname = 
# 311 "bio/bss_conn.c" 3 4
                      ((void *)0)
# 311 "bio/bss_conn.c"
                          ;
 ret->param_port = 
# 312 "bio/bss_conn.c" 3 4
                  ((void *)0)
# 312 "bio/bss_conn.c"
                      ;
 ret->info_callback = 
# 313 "bio/bss_conn.c" 3 4
                     ((void *)0)
# 313 "bio/bss_conn.c"
                         ;
 ret->nbio = 0;
...
conn_new(BIO *bi)
{
 ...
 bi->num = -1;
 bi->flags = 0;
 if ((bi->ptr = (char *)BIO_CONNECT_new()) == 
# 347 "bio/bss_conn.c" 3 4
                                             ((void *)0)
# 347 "bio/bss_conn.c"
                                                 )
  return (0);
...
conn_read(BIO *b, char *out, int outl)
{
 ...
 if (out != 
# 400 "bio/bss_conn.c" 3 4
           ((void *)0)
# 400 "bio/bss_conn.c"
               ) {
  
# 401 "bio/bss_conn.c" 3 4
 (*__errno_location ()) 
# 401 "bio/bss_conn.c"
       = 0;
 ...
 case 12:
  {
   dbio = (BIO *)ptr;
   if (data->param_port)
    BIO_ctrl(dbio,100,1,(char *)data->param_port);
   if (data->param_hostname)
    BIO_ctrl(dbio,100,0,(char *)data->param_hostname)
                             ;
   BIO_ctrl(dbio,102,(data->nbio),
# 536 "bio/bss_conn.c" 3 4
  ((void *)0)
# 536 "bio/bss_conn.c"
  );

   (void)(int)BIO_callback_ctrl(dbio,14,(bio_info_cb *)data->info_callback)
                                          ;
  }
  break;
 case 14:
...
BIO_new_connect(char *str)
{
 ...
 if (ret == 
# 604 "bio/bss_conn.c" 3 4
           ((void *)0)
# 604 "bio/bss_conn.c"
               )
  return (
# 605 "bio/bss_conn.c" 3 4
         ((void *)0)
# 605 "bio/bss_conn.c"
             );
 if (BIO_ctrl(ret,100,0,(char *)str))
  return (ret);
 else {
  BIO_free(ret);
  return (
# 610 "bio/bss_conn.c" 3 4
         ((void *)0)
# 610 "bio/bss_conn.c"
             );
 }
