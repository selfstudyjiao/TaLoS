...
static const CRYPTO_EX_DATA_IMPL *impl = 
# 170 "ex_data.c" 3 4
                                        ((void *)0)
# 170 "ex_data.c"
                                            ;
...
impl_check(void)
{
 CRYPTO_lock(1|8,2,"ex_data.c",204);
 if (!impl)
  impl = &impl_default;
 CRYPTO_lock(2|8,2,"ex_data.c",207);
}
...
{
 int toret = 0;
 CRYPTO_lock(1|8,2,"ex_data.c",225);
 if (!impl) {
  impl = i;
  toret = 1;
 }
 CRYPTO_lock(2|8,2,"ex_data.c",230);
 return toret;
}
# 241 "ex_data.c"
...
struct lhash_st_EX_CLASS_ITEM { int dummy; };
static struct lhash_st_EX_CLASS_ITEM *ex_data = 
# 252 "ex_data.c" 3 4
                                         ((void *)0)
# 252 "ex_data.c"
                                             ;
...
static unsigned long ex_class_item_LHASH_HASH(const void *arg) { const EX_CLASS_ITEM *a = arg; return ex_class_item_hash(a); }
...
static int ex_class_item_LHASH_COMP(const void *arg1, const void *arg2) { const EX_CLASS_ITEM *a = arg1; const EX_CLASS_ITEM *b = arg2; return ex_class_item_cmp(a,b); }
...
{
 int toret = 1;
 CRYPTO_lock(1|8,2,"ex_data.c",278);
 if (!ex_data &&
     (ex_data = ((struct lhash_st_EX_CLASS_ITEM *)lh_new(ex_class_item_LHASH_HASH, ex_class_item_LHASH_COMP))) == 
# 280 "ex_data.c" 3 4
                                          ((void *)0)
# 280 "ex_data.c"
                                              )
  toret = 0;
 CRYPTO_lock(2|8,2,"ex_data.c",282);
 return toret;
}
...
def_cleanup_cb(void *a_void)
{
 ...
 sk_pop_free(((_STACK*) (1 ? (item->meth) : (struct stack_st_CRYPTO_EX_DATA_FUNCS*)0)), ((void (*)(void *)) ((1 ? (def_cleanup_util_cb) : (void (*)(CRYPTO_EX_DATA_FUNCS *))0))));
 free(item);
}
...
def_get_class(int class_index)
{
 ...
 if(!ex_data && !ex_data_check()) {return 
# 313 "ex_data.c" 3 4
((void *)0)
# 313 "ex_data.c"
;}
 d.class_index = class_index;
 CRYPTO_lock(1|8,2,"ex_data.c",315);
 p = ((EX_CLASS_ITEM *)lh_retrieve(((_LHASH *)((void*) (1 ? ex_data : (struct lhash_st_EX_CLASS_ITEM*)0))), ((void*) (1 ? &d : (EX_CLASS_ITEM*)0))));
 if (!p) {
  gen = malloc(sizeof(EX_CLASS_ITEM));
  if (gen) {
   gen->class_index = class_index;
   gen->meth_num = 0;
   gen->meth = ((struct stack_st_CRYPTO_EX_DATA_FUNCS *)sk_new_null());
   if (!gen->meth)
    free(gen);
   else {


    (void)((EX_CLASS_ITEM *)lh_insert(((_LHASH *)((void*) (1 ? ex_data : (struct lhash_st_EX_CLASS_ITEM*)0))), ((void*) (1 ? gen : (EX_CLASS_ITEM*)0))));
    p = gen;
   }
  }
 }
 CRYPTO_lock(2|8,2,"ex_data.c",333);
 if (!p)
  ERR_put_error(15,(105),((1|64)),"ex_data.c",335);
 return p;
}
    ...
    CRYPTO_EX_new *new_func, CRYPTO_EX_dup *dup_func, CRYPTO_EX_free *free_func)
{
 ...
 if (!a) {
  ERR_put_error(15,(104),((1|64)),"ex_data.c",349);
  return -1;
 }
 a->argl = argl;
 a->argp = argp;
 ...
 CRYPTO_lock(1|8,2,"ex_data.c",357);
 while (sk_num(((_STACK*) (1 ? (item->meth) : (struct stack_st_CRYPTO_EX_DATA_FUNCS*)0))) <= item->meth_num) {
  if (!sk_push(((_STACK*) (1 ? (item->meth) : (struct stack_st_CRYPTO_EX_DATA_FUNCS*)0)), ((void*) (1 ? (
# 359 "ex_data.c" 3 4
      ((void *)0)
# 359 "ex_data.c"
      ) : (CRYPTO_EX_DATA_FUNCS*)0)))) {
   ERR_put_error(15,(104),((1|64)),"ex_data.c",360);
   free(a);
   goto err;
  }
 }
 toret = item->meth_num++;
 (void)sk_set(((_STACK*) (1 ? (item->meth) : (struct stack_st_CRYPTO_EX_DATA_FUNCS*)0)), (toret), ((void*) (1 ? (a) : (CRYPTO_EX_DATA_FUNCS*)0)));
err:
 CRYPTO_lock(2|8,2,"ex_data.c",368);
 return toret;
}
...
int_new_class(void)
{
 ...
 CRYPTO_lock(1|8,2,"ex_data.c",380);
 toret = ex_class++;
 CRYPTO_lock(2|8,2,"ex_data.c",382);
 return toret;
}
...
{
 if(!ex_data && !ex_data_check()) {return;}
 lh_doall(((_LHASH *)((void*) (1 ? ex_data : (struct lhash_st_EX_CLASS_ITEM*)0))), def_cleanup_cb);
 lh_free(((_LHASH *)((void*) (1 ? ex_data : (struct lhash_st_EX_CLASS_ITEM*)0))));
 ex_data = 
# 392 "ex_data.c" 3 4
          ((void *)0)
# 392 "ex_data.c"
...
# 423 "ex_data.c"
             ;
 CRYPTO_lock(1|4,2,"ex_data.c",424);
 mx = sk_num(((_STACK*) (1 ? (item->meth) : (struct stack_st_CRYPTO_EX_DATA_FUNCS*)0)));
 if (mx > 0) {
  storage = reallocarray(
# 427 "ex_data.c" 3 4
                        ((void *)0)
# 427 "ex_data.c"
  ...
  if (!storage)
   goto skip;
  for (i = 0; i < mx; i++)
   storage[i] = ((CRYPTO_EX_DATA_FUNCS *)sk_value(((_STACK*) (1 ? (item->meth) : (struct stack_st_CRYPTO_EX_DATA_FUNCS*)0)), (i)))
                     ;
 }
skip:
 CRYPTO_lock(2|4,2,"ex_data.c",435);
 if ((mx > 0) && !storage) {
  ERR_put_error(15,(108),((1|64)),"ex_data.c",437);
  return 0;
 }
 for (i = 0; i < mx; i++) {
...
# 457 "ex_data.c"
 ...
 if (!from->sk)
  ...
  return 1;
 if ((item = def_get_class(class_index)) == 
# 463 "ex_data.c" 3 4
                                           ((void *)0)
# 463 "ex_data.c"
                                               )
  return 0;
 CRYPTO_lock(1|4,2,"ex_data.c",465);
 mx = sk_num(((_STACK*) (1 ? (item->meth) : (struct stack_st_CRYPTO_EX_DATA_FUNCS*)0)));
 j = sk_num(((_STACK*) (1 ? (from->sk) : (struct stack_st_void*)0)));
 if (j < mx)
  mx = j;
 if (mx > 0) {
  storage = reallocarray(
...
skip:
 CRYPTO_lock(2|4,2,"ex_data.c",479);
 if ((mx > 0) && !storage) {
  ERR_put_error(15,(106),((1|64)),"ex_data.c",481);
  return 0;
 }
 for (i = 0; i < mx; i++) {
...
# 503 "ex_data.c"
  ...
  return;
 CRYPTO_lock(1|4,2,"ex_data.c",505);
 mx = sk_num(((_STACK*) (1 ? (item->meth) : (struct stack_st_CRYPTO_EX_DATA_FUNCS*)0)));
 if (mx > 0) {
  storage = reallocarray(
# 508 "ex_data.c" 3 4
...
skip:
 CRYPTO_lock(2|4,2,"ex_data.c",516);
 if ((mx > 0) && !storage) {
  ERR_put_error(15,(107),((1|64)),"ex_data.c",518);
  return;
 }
 for (i = 0; i < mx; i++) {
 ...
 free(storage);
 if (ad->sk) {
  sk_free(((_STACK*) (1 ? (ad->sk) : (struct stack_st_void*)0)));
  ad->sk = 
# 531 "ex_data.c" 3 4
          ((void *)0)
# 531 "ex_data.c"
    ...
    CRYPTO_EX_new *new_func, CRYPTO_EX_dup *dup_func, CRYPTO_EX_free *free_func)
{
 ...
 if(!impl) impl_check();
 ret = impl->cb_get_new_index(class_index,
...
{
 if(!impl) impl_check();
 return impl->cb_new_ex_data(class_index, obj, ad);
}
...
{
 if(!impl) impl_check();
 return impl->cb_dup_ex_data(class_index, to, from);
}
...
# 606 "ex_data.c"
  ...
  if ((ad->sk = ((struct stack_st_void *)sk_new_null())) == 
# 607 "ex_data.c" 3 4
                                      ((void *)0)
# 607 "ex_data.c"
                                          ) {
   ERR_put_error(15,(102),((1|64)),"ex_data.c",609)
                            ;
   return (0);
  }
 }
 i = sk_num(((_STACK*) (1 ? (ad->sk) : (struct stack_st_void*)0)));

 while (i <= idx) {
  if (!sk_push(((_STACK*) (1 ? (ad->sk) : (struct stack_st_void*)0)), ((void*) (1 ? (
# 616 "ex_data.c" 3 4
      ((void *)0)
# 616 "ex_data.c"
      ) : (void*)0)))) {
   ERR_put_error(15,(102),((1|64)),"ex_data.c",618)
                            ;
   return (0);
  }
  i++;
 }
 sk_set(((_STACK*) (1 ? (ad->sk) : (struct stack_st_void*)0)), (idx), ((void*) (1 ? (val) : (void*)0)));
 return (1);
}
...
# 632 "ex_data.c"
  ...
  return (0);
 else if (idx >= sk_num(((_STACK*) (1 ? (ad->sk) : (struct stack_st_void*)0))))
  return (0);
 else
  return (((void *)sk_value(((_STACK*) (1 ? (ad->sk) : (struct stack_st_void*)0)), (idx))));
}
