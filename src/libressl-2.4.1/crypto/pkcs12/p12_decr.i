    ...
    unsigned char *in, int inlen, unsigned char **data, int *datalen, int en_de)
{
 ...
 if (!EVP_PBE_CipherInit(algor->algorithm, pass, passlen,
  ...
  out = 
# 81 "pkcs12/p12_decr.c" 3 4
       ((void *)0)
# 81 "pkcs12/p12_decr.c"
           ;
  ERR_put_error(35,(119),(115),"pkcs12/p12_decr.c",83)
                                             ;
  goto err;
 }

 if (!(out = malloc(inlen + EVP_CIPHER_CTX_block_size(&ctx)))) {
  ERR_put_error(35,(119),((1|64)),"pkcs12/p12_decr.c",88);
  goto err;
 }
 ...
 if (!EVP_CipherUpdate(&ctx, out, &i, in, inlen)) {
  free(out);
  out = 
# 94 "pkcs12/p12_decr.c" 3 4
       ((void *)0)
# 94 "pkcs12/p12_decr.c"
           ;
  ERR_put_error(35,(119),(6),"pkcs12/p12_decr.c",95);
  goto err;
 }
 ...
 if (!EVP_CipherFinal_ex(&ctx, out + i, &i)) {
  free(out);
  out = 
# 102 "pkcs12/p12_decr.c" 3 4
       ((void *)0)
# 102 "pkcs12/p12_decr.c"
           ;
  ERR_put_error(35,(119),(116),"pkcs12/p12_decr.c",104)
                                        ;
  goto err;
 }
 outlen += i;
    ...
    const char *pass, int passlen, ASN1_OCTET_STRING *oct, int zbuf)
{
 ...
 if (!PKCS12_pbe_crypt(algor, pass, passlen, oct->data, oct->length,
     &out, &outlen, 0)) {
  ERR_put_error(35,(106),(117),"pkcs12/p12_decr.c",135)
                                      ;
  return 
# 136 "pkcs12/p12_decr.c" 3 4
        ((void *)0)
# 136 "pkcs12/p12_decr.c"
            ;
 }
 p = out;
 ret = ASN1_item_d2i(
# 139 "pkcs12/p12_decr.c" 3 4
                    ((void *)0)
# 139 "pkcs12/p12_decr.c"
                        , &p, outlen, it);
 if (zbuf)
  explicit_bzero(out, outlen);
 if (!ret)
  ERR_put_error(35,(106),(101),"pkcs12/p12_decr.c",144)
                            ;
 free(out);
 return ret;
}
    ...
    void *obj, int zbuf)
{
 ASN1_OCTET_STRING *oct;
 unsigned char *in = 
# 159 "pkcs12/p12_decr.c" 3 4
                    ((void *)0)
# 159 "pkcs12/p12_decr.c"
                        ;
 int inlen;

 if (!(oct = ASN1_OCTET_STRING_new ())) {
  ERR_put_error(35,(108),((1|64)),"pkcs12/p12_decr.c",164)
                           ;
  return 
# 165 "pkcs12/p12_decr.c" 3 4
        ((void *)0)
# 165 "pkcs12/p12_decr.c"
            ;
 }
 inlen = ASN1_item_i2d(obj, &in, it);
 if (!in) {
  ERR_put_error(35,(108),(102),"pkcs12/p12_decr.c",170)
                            ;
  goto err;
 }
 if (!PKCS12_pbe_crypt(algor, pass, passlen, in, inlen, &oct->data,
     &oct->length, 1)) {
  ERR_put_error(35,(108),(103),"pkcs12/p12_decr.c",176)
                             ;
  goto err;
 }
 if (zbuf)
...
err:
 ...
 return 
# 187 "pkcs12/p12_decr.c" 3 4
       ((void *)0)
# 187 "pkcs12/p12_decr.c"
           ;
}
