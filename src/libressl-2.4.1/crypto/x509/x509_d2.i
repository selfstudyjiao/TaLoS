...
X509_STORE_set_default_paths(X509_STORE *ctx)
{
 ...
 if (lookup == 
# 72 "x509/x509_d2.c" 3 4
              ((void *)0)
# 72 "x509/x509_d2.c"
                  )
  return (0);
 X509_LOOKUP_ctrl((lookup),1,(
# 74 "x509/x509_d2.c" 3 4
((void *)0)
# 74 "x509/x509_d2.c"
),(long)(3),
# 74 "x509/x509_d2.c" 3 4
...
# 74 "x509/x509_d2.c"
 ...
 if (lookup == 
# 77 "x509/x509_d2.c" 3 4
              ((void *)0)
# 77 "x509/x509_d2.c"
                  )
  return (0);
 X509_LOOKUP_ctrl((lookup),2,(
# 79 "x509/x509_d2.c" 3 4
((void *)0)
# 79 "x509/x509_d2.c"
),(long)(3),
# 79 "x509/x509_d2.c" 3 4
...
X509_STORE_load_locations(X509_STORE *ctx, const char *file, const char *path)
{
 ...
 if (file != 
# 92 "x509/x509_d2.c" 3 4
            ((void *)0)
# 92 "x509/x509_d2.c"
                ) {
  lookup = X509_STORE_add_lookup(ctx, X509_LOOKUP_file());
  if (lookup == 
# 94 "x509/x509_d2.c" 3 4
               ((void *)0)
# 94 "x509/x509_d2.c"
                   )
   return (0);
  if (X509_LOOKUP_ctrl((lookup),1,(file),(long)(1),
# 96 "x509/x509_d2.c" 3 4
     ((void *)0)
# 96 "x509/x509_d2.c"
     ) != 1)
   return (0);
 ...
 if (path != 
# 99 "x509/x509_d2.c" 3 4
            ((void *)0)
# 99 "x509/x509_d2.c"
                ) {
  lookup = X509_STORE_add_lookup(ctx, X509_LOOKUP_hash_dir());
  if (lookup == 
# 101 "x509/x509_d2.c" 3 4
               ((void *)0)
# 101 "x509/x509_d2.c"
                   )
   return (0);
  if (X509_LOOKUP_ctrl((lookup),2,(path),(long)(1),
# 103 "x509/x509_d2.c" 3 4
     ((void *)0)
# 103 "x509/x509_d2.c"
     ) != 1)
   return (0);
...
# 118 "x509/x509_d2.c"
 ...
 if (X509_LOOKUP_ctrl((lookup),3,(const char *)(&iov), (long)(1),
# 124 "x509/x509_d2.c" 3 4
    ((void *)0)
# 124 "x509/x509_d2.c"
    ) != 1)
  return (0);
