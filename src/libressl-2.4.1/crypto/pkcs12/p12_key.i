    ...
    const EVP_MD *md_type)
{
 ...
 if (!pass) {
  unipass = 
# 81 "pkcs12/p12_key.c" 3 4
           ((void *)0)
# 81 "pkcs12/p12_key.c"
               ;
  uniplen = 0;
 } else if (!OPENSSL_asc2uni(pass, passlen, &unipass, &uniplen)) {
  ERR_put_error(35,(110),((1|64)),"pkcs12/p12_key.c",84);
  return 0;
 }
    ...
    const EVP_MD *md_type)
{
  ...
  *p++ = pass[i % passlen];
 for (;;) {
  if (!EVP_DigestInit_ex(&ctx, md_type, 
# 137 "pkcs12/p12_key.c" 3 4
                                       ((void *)0)
# 137 "pkcs12/p12_key.c"
                                           ) ||
      !EVP_DigestUpdate(&ctx, D, v) ||
      !EVP_DigestUpdate(&ctx, I, Ilen) ||
      !EVP_DigestFinal_ex(&ctx, Ai, 
# 140 "pkcs12/p12_key.c" 3 4
                                   ((void *)0)
# 140 "pkcs12/p12_key.c"
                                       ))
   goto err;
  for (j = 1; j < iter; j++) {
   if (!EVP_DigestInit_ex(&ctx, md_type, 
# 143 "pkcs12/p12_key.c" 3 4
                                        ((void *)0)
# 143 "pkcs12/p12_key.c"
                                            ) ||
       !EVP_DigestUpdate(&ctx, Ai, u) ||
       !EVP_DigestFinal_ex(&ctx, Ai, 
# 145 "pkcs12/p12_key.c" 3 4
                                    ((void *)0)
# 145 "pkcs12/p12_key.c"
                                        ))
    goto err;
  }
...
err:
 ERR_put_error(35,(111),((1|64)),"pkcs12/p12_key.c",188);
