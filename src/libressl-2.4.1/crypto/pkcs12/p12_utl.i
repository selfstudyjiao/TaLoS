...
OPENSSL_uni2asc(unsigned char *uni, int unilen)
{
 ...
 if (!(asctmp = malloc(asclen)))
  return 
# 103 "pkcs12/p12_utl.c" 3 4
        ((void *)0)
# 103 "pkcs12/p12_utl.c"
            ;
...
{
 if (OBJ_obj2nid((bag)->type) != 152)
  return 
# 152 "pkcs12/p12_utl.c" 3 4
        ((void *)0)
# 152 "pkcs12/p12_utl.c"
            ;
 if (OBJ_obj2nid((bag)->value.bag->type) != 158)
  return 
# 154 "pkcs12/p12_utl.c" 3 4
        ((void *)0)
# 154 "pkcs12/p12_utl.c"
            ;
...
{
 if (OBJ_obj2nid((bag)->type) != 153)
  return 
# 163 "pkcs12/p12_utl.c" 3 4
        ((void *)0)
# 163 "pkcs12/p12_utl.c"
            ;
 if (OBJ_obj2nid((bag)->value.bag->type) != 160)
  return 
# 165 "pkcs12/p12_utl.c" 3 4
        ((void *)0)
# 165 "pkcs12/p12_utl.c"
            ;
 return ASN1_item_unpack(bag->value.bag->value.octet,
     (&(X509_CRL_it)));
}
