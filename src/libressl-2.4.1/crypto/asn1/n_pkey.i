    ...
    int (*cb)(char *buf, int len, const char *prompt, int verify), int sgckey)
{
 ...
 NETSCAPE_PKEY *pkey = 
# 219 "asn1/n_pkey.c" 3 4
                      ((void *)0)
# 219 "asn1/n_pkey.c"
                          ;
 NETSCAPE_ENCRYPTED_PKEY *enckey = 
# 220 "asn1/n_pkey.c" 3 4
                                  ((void *)0)
# 220 "asn1/n_pkey.c"
                                      ;
...
# 229 "asn1/n_pkey.c" 3 4
                                    ((void *)0)
# 229 "asn1/n_pkey.c"
                                        )
  goto err;
 if ((enckey = NETSCAPE_ENCRYPTED_PKEY_new()) == 
# 231 "asn1/n_pkey.c" 3 4
                                                ((void *)0)
# 231 "asn1/n_pkey.c"
                                                    )
  goto err;
 ...
 pkey->algor->algorithm = OBJ_nid2obj(6);
 if ((pkey->algor->parameter = ASN1_TYPE_new()) == 
# 236 "asn1/n_pkey.c" 3 4
                                                  ((void *)0)
# 236 "asn1/n_pkey.c"
                                                      )
  goto err;
 pkey->algor->parameter->type = 5;

 rsalen = i2d_RSAPrivateKey(a, 
# 240 "asn1/n_pkey.c" 3 4
                              ((void *)0)
# 240 "asn1/n_pkey.c"
                                  );
 ...
 pkeylen = i2d_NETSCAPE_PKEY(pkey, 
# 246 "asn1/n_pkey.c" 3 4
                                  ((void *)0)
# 246 "asn1/n_pkey.c"
                                      );
 enckey->enckey->digest->length = pkeylen;
 enckey->os->length = 11;
 enckey->enckey->algor->algorithm = OBJ_nid2obj(5);
 if ((enckey->enckey->algor->parameter = ASN1_TYPE_new()) == 
# 250 "asn1/n_pkey.c" 3 4
                                                            ((void *)0)
# 250 "asn1/n_pkey.c"
                                                                )
  goto err;
 enckey->enckey->algor->parameter->type = 5;

 if (pp == 
# 254 "asn1/n_pkey.c" 3 4
          ((void *)0)
# 254 "asn1/n_pkey.c"
              ) {
  olen = i2d_NETSCAPE_ENCRYPTED_PKEY(enckey, 
# 255 "asn1/n_pkey.c" 3 4
                                            ((void *)0)
# 255 "asn1/n_pkey.c"
                                                );
 ...
 if ((zz = malloc(rsalen)) == 
# 262 "asn1/n_pkey.c" 3 4
                             ((void *)0)
# 262 "asn1/n_pkey.c"
                                 ) {
  ERR_put_error(13,(162),((1|64)),"asn1/n_pkey.c",263);
  goto err;
 }
 ...
 if ((zz = malloc(pkeylen)) == 
# 271 "asn1/n_pkey.c" 3 4
                              ((void *)0)
# 271 "asn1/n_pkey.c"
                                  ) {
  ERR_put_error(13,(162),((1|64)),"asn1/n_pkey.c",272);
  goto err;
 }

 if (!ASN1_STRING_set(enckey->os, "private-key", -1)) {
  ERR_put_error(13,(162),((1|64)),"asn1/n_pkey.c",277);
  goto err;
 }
...
# 286 "asn1/n_pkey.c"
 ...
 if (i != 0) {
  ERR_put_error(13,(162),(103),"asn1/n_pkey.c",290);
  goto err;
 }
 i = strlen((char *)buf);

 if (sgckey) {
  if (!EVP_Digest(buf, i, buf, 
# 296 "asn1/n_pkey.c" 3 4
                              ((void *)0)
# 296 "asn1/n_pkey.c"
                                  , EVP_md5(), 
# 296 "asn1/n_pkey.c" 3 4
...
# 296 "asn1/n_pkey.c"
 ...
 if (!EVP_BytesToKey(EVP_rc4(), EVP_md5(), 
# 302 "asn1/n_pkey.c" 3 4
                                          ((void *)0)
# 302 "asn1/n_pkey.c"
                                              , buf, i,1, key, 
# 302 "asn1/n_pkey.c" 3 4
...
# 302 "asn1/n_pkey.c"
 ...
 if (!EVP_EncryptInit_ex(&ctx, EVP_rc4(), 
# 308 "asn1/n_pkey.c" 3 4
                                         ((void *)0)
# 308 "asn1/n_pkey.c"
                                             , key, 
# 308 "asn1/n_pkey.c" 3 4
...
{
 RSA *ret = 
# 335 "asn1/n_pkey.c" 3 4
           ((void *)0)
# 335 "asn1/n_pkey.c"
               ;
 const unsigned char *p;
 NETSCAPE_ENCRYPTED_PKEY *enckey = 
# 337 "asn1/n_pkey.c" 3 4
                                  ((void *)0)
# 337 "asn1/n_pkey.c"
                                      ;
...
# 341 "asn1/n_pkey.c" 3 4
                                     ((void *)0)
# 341 "asn1/n_pkey.c"
                                         , &p, length);
 if (!enckey) {
  ERR_put_error(13,(200),(111),"asn1/n_pkey.c",343);
  return 
# 344 "asn1/n_pkey.c" 3 4
        ((void *)0)
# 344 "asn1/n_pkey.c"
            ;
 }
 ...
 if (enckey->os->length != 11 ||
  ...
  ERR_put_error(13,(200),(146),"asn1/n_pkey.c",350);
  goto err;
 }
 if (OBJ_obj2nid(enckey->enckey->algor->algorithm) != 5) {
  ERR_put_error(13,(200),(166),"asn1/n_pkey.c",355)
                                              ;
  goto err;
 }
 if (cb == 
# 358 "asn1/n_pkey.c" 3 4
          ((void *)0)
# 358 "asn1/n_pkey.c"
              )
  cb = EVP_read_pw_string;
...
{
 NETSCAPE_PKEY *pkey = 
# 376 "asn1/n_pkey.c" 3 4
                      ((void *)0)
# 376 "asn1/n_pkey.c"
                          ;
 RSA *ret = 
# 377 "asn1/n_pkey.c" 3 4
           ((void *)0)
# 377 "asn1/n_pkey.c"
               ;
 int i, j;
 ...
 if (i != 0) {
  ERR_put_error(13,(201),(103),"asn1/n_pkey.c",387);
  goto err;
 }
...
# 399 "asn1/n_pkey.c"
 ...
 if (!EVP_DecryptInit_ex(&ctx, EVP_rc4(), 
# 403 "asn1/n_pkey.c" 3 4
                                         ((void *)0)
# 403 "asn1/n_pkey.c"
                                             , key, 
# 403 "asn1/n_pkey.c" 3 4
...
# 403 "asn1/n_pkey.c"
 ...
 if ((pkey = d2i_NETSCAPE_PKEY(
# 413 "asn1/n_pkey.c" 3 4
                              ((void *)0)
# 413 "asn1/n_pkey.c"
                                  , &zz, os->length)) == 
# 413 "asn1/n_pkey.c" 3 4
...
# 413 "asn1/n_pkey.c"
  ...
  ERR_put_error(13,(201),(158),"asn1/n_pkey.c",415)
                                              ;
  goto err;
 }
...
# 421 "asn1/n_pkey.c" 3 4
                                   ((void *)0)
# 421 "asn1/n_pkey.c"
                                       ) {
  ERR_put_error(13,(201),(157),"asn1/n_pkey.c",422);
  goto err;
 }
