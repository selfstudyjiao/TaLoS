...
ocsp_certid_print(BIO *bp, OCSP_CERTID* a, int indent)
{
 ...
 i2a_ASN1_STRING(bp, a->issuerNameHash, 4);
 BIO_printf(bp, "\n%*sIssuer Key Hash: ", indent, "");
 i2a_ASN1_STRING(bp, a->issuerKeyHash, 4);
...
OCSP_REQUEST_print(BIO *bp, OCSP_REQUEST* o, unsigned long flags)
{
 ...
 long l;
 OCSP_CERTID* cid = 
# 148 "ocsp/ocsp_prn.c" 3 4
                   ((void *)0)
# 148 "ocsp/ocsp_prn.c"
                       ;
 OCSP_ONEREQ *one = 
# 149 "ocsp/ocsp_prn.c" 3 4
                   ((void *)0)
# 149 "ocsp/ocsp_prn.c"
                       ;
...
# 158 "ocsp/ocsp_prn.c"
 ...
 if (BIO_write(bp, "\n    Requestor List:\n", 21) <= 0)
  goto err;
 for (i = 0; i < sk_num(((_STACK*) (1 ? (inf->requestList) : (struct stack_st_OCSP_ONEREQ*)0))); i++) {
  one = ((OCSP_ONEREQ *)sk_value(((_STACK*) (1 ? (inf->requestList) : (struct stack_st_OCSP_ONEREQ*)0)), (i)));
  cid = one->reqCert;
 ...
 if (sig) {
  if (X509_signature_print(bp, sig->signatureAlgorithm,
      sig->signature) == 0)
   goto err;
  for (i = 0; i < sk_num(((_STACK*) (1 ? (sig->certs) : (struct stack_st_X509*)0))); i++) {
   if (X509_print(bp, ((X509 *)sk_value(((_STACK*) (1 ? (sig->certs) : (struct stack_st_X509*)0)), (i)))) == 0)
    goto err;
   if (PEM_write_bio_X509(bp,
       ((X509 *)sk_value(((_STACK*) (1 ? (sig->certs) : (struct stack_st_X509*)0)), (i)))) == 0)
    goto err;
  }
 }
 return 1;
...
OCSP_RESPONSE_print(BIO *bp, OCSP_RESPONSE* o, unsigned long flags)
{
 ...
 long l;
 OCSP_CERTID *cid = 
# 199 "ocsp/ocsp_prn.c" 3 4
                   ((void *)0)
# 199 "ocsp/ocsp_prn.c"
                       ;
 OCSP_BASICRESP *br = 
# 200 "ocsp/ocsp_prn.c" 3 4
                     ((void *)0)
# 200 "ocsp/ocsp_prn.c"
                         ;
 OCSP_RESPID *rid = 
# 201 "ocsp/ocsp_prn.c" 3 4
                   ((void *)0)
# 201 "ocsp/ocsp_prn.c"
                       ;
 OCSP_RESPDATA *rd = 
# 202 "ocsp/ocsp_prn.c" 3 4
                     ((void *)0)
# 202 "ocsp/ocsp_prn.c"
                         ;
 OCSP_CERTSTATUS *cst = 
# 203 "ocsp/ocsp_prn.c" 3 4
                       ((void *)0)
# 203 "ocsp/ocsp_prn.c"
                           ;
 OCSP_REVOKEDINFO *rev = 
# 204 "ocsp/ocsp_prn.c" 3 4
                        ((void *)0)
# 204 "ocsp/ocsp_prn.c"
                            ;
 OCSP_SINGLERESP *single = 
# 205 "ocsp/ocsp_prn.c" 3 4
                          ((void *)0)
# 205 "ocsp/ocsp_prn.c"
                              ;
...
# 214 "ocsp/ocsp_prn.c"
 ...
 switch (rid->type) {
 case 0:
  X509_NAME_print_ex(bp, rid->value.byName, 0, ((1 | 2 | 4 | 0x10 | 0x100 | 0x200) | 8 | (2 << 16) | (1 << 23) | 0));
  break;
 case 1:
  i2a_ASN1_STRING(bp, rid->value.byKey, 4);
  break;
 }
 ...
 if (BIO_printf(bp, "\n    Responses:\n") <= 0)
  goto err;
 for (i = 0; i < sk_num(((_STACK*) (1 ? (rd->responses) : (struct stack_st_OCSP_SINGLERESP*)0))); i++) {
  if (! ((OCSP_SINGLERESP *)sk_value(((_STACK*) (1 ? (rd->responses) : (struct stack_st_OCSP_SINGLERESP*)0)), (i))))
   continue;
  single = ((OCSP_SINGLERESP *)sk_value(((_STACK*) (1 ? (rd->responses) : (struct stack_st_OCSP_SINGLERESP*)0)), (i)));
  cid = single->certId;
 ...
 for (i = 0; i < sk_num(((_STACK*) (1 ? (br->certs) : (struct stack_st_X509*)0))); i++) {
  X509_print(bp, ((X509 *)sk_value(((_STACK*) (1 ? (br->certs) : (struct stack_st_X509*)0)), (i))));
  PEM_write_bio_X509(bp, ((X509 *)sk_value(((_STACK*) (1 ? (br->certs) : (struct stack_st_X509*)0)), (i))));
 }
