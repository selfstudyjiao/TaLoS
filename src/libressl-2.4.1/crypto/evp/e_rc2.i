...
static int rc2_cbc_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { while(inl>=((size_t)1<<(sizeof(long)*8-2))) { RC2_cbc_encrypt(in, out, (long)((size_t)1<<(sizeof(long)*8-2)), &((EVP_RC2_KEY *)ctx->cipher_data)->ks, ctx->iv, ctx->encrypt); inl-=((size_t)1<<(sizeof(long)*8-2)); in +=((size_t)1<<(sizeof(long)*8-2)); out+=((size_t)1<<(sizeof(long)*8-2)); } if (inl) RC2_cbc_encrypt(in, out, (long)inl, &((EVP_RC2_KEY *)ctx->cipher_data)->ks, ctx->iv, ctx->encrypt); return 1;} static int rc2_cfb64_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { size_t chunk=((size_t)1<<(sizeof(long)*8-2)); if (64==1) chunk>>=3; if (inl<chunk) chunk=inl; while(inl && inl>=chunk) { RC2_cfb64_encrypt(in, out, (long)((64==1) && !(ctx->flags & 0x2000) ?inl*8:inl), &((EVP_RC2_KEY *)ctx->cipher_data)->ks, ctx->iv, &ctx->num, ctx->encrypt); inl-=chunk; in +=chunk; out+=chunk; if(inl<chunk) chunk=inl; } return 1;} static int rc2_ecb_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { size_t i, bl; bl = ctx->cipher->block_size; if(inl < bl) return 1; inl -= bl; for(i=0; i <= inl; i+=bl) RC2_ecb_encrypt(in + i, out + i, &((EVP_RC2_KEY *)ctx->cipher_data)->ks, ctx->encrypt); return 1;} static int rc2_ofb_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { while(inl>=((size_t)1<<(sizeof(long)*8-2))) { RC2_ofb64_encrypt(in, out, (long)((size_t)1<<(sizeof(long)*8-2)), &((EVP_RC2_KEY *)ctx->cipher_data)->ks, ctx->iv, &ctx->num); inl-=((size_t)1<<(sizeof(long)*8-2)); in +=((size_t)1<<(sizeof(long)*8-2)); out+=((size_t)1<<(sizeof(long)*8-2)); } if (inl) RC2_ofb64_encrypt(in, out, (long)inl, &((EVP_RC2_KEY *)ctx->cipher_data)->ks, ctx->iv, &ctx->num); return 1;} static const EVP_CIPHER rc2_cbc = { 37, 8, 16, 8, 0x8 | 0x40 | 0x2, rc2_init_key, rc2_cbc_cipher, 
# 87 "evp/e_rc2.c" 3 4
((void *)0)
# 87 "evp/e_rc2.c"
, sizeof(EVP_RC2_KEY), rc2_set_asn1_type_and_iv, rc2_get_asn1_type_and_iv, rc2_ctrl, 
# 87 "evp/e_rc2.c" 3 4
((void *)0) 
# 87 "evp/e_rc2.c"
}; const EVP_CIPHER *EVP_rc2_cbc(void) { return &rc2_cbc; } static const EVP_CIPHER rc2_cfb64 = { 39, 1, 16, 8, 0x8 | 0x40 | 0x3, rc2_init_key, rc2_cfb64_cipher, 
# 87 "evp/e_rc2.c" 3 4
((void *)0)
# 87 "evp/e_rc2.c"
, sizeof(EVP_RC2_KEY), rc2_set_asn1_type_and_iv, rc2_get_asn1_type_and_iv, rc2_ctrl, 
...
((void *)0) 
# 87 "evp/e_rc2.c"
}; const EVP_CIPHER *EVP_rc2_cfb64(void) { return &rc2_cfb64; } static const EVP_CIPHER rc2_ofb = { 40, 1, 16, 8, 0x8 | 0x40 | 0x4, rc2_init_key, rc2_ofb_cipher, 
# 87 "evp/e_rc2.c" 3 4
((void *)0)
# 87 "evp/e_rc2.c"
, sizeof(EVP_RC2_KEY), rc2_set_asn1_type_and_iv, rc2_get_asn1_type_and_iv, rc2_ctrl, 
...
((void *)0) 
# 87 "evp/e_rc2.c"
}; const EVP_CIPHER *EVP_rc2_ofb(void) { return &rc2_ofb; } static const EVP_CIPHER rc2_ecb = { 38, 8, 16, 0, 0x8 | 0x40 | 0x1, rc2_init_key, rc2_ecb_cipher, 
# 87 "evp/e_rc2.c" 3 4
((void *)0)
# 87 "evp/e_rc2.c"
, sizeof(EVP_RC2_KEY), rc2_set_asn1_type_and_iv, rc2_get_asn1_type_and_iv, rc2_ctrl, 
...
((void *)0) 
# 87 "evp/e_rc2.c"
}; const EVP_CIPHER *EVP_rc2_ecb(void) { return &rc2_ecb; }
# 99 "evp/e_rc2.c"
...
rc2_init_key(EVP_CIPHER_CTX *ctx, const unsigned char *key,
    const unsigned char *iv, int enc)
{
 RC2_set_key(&((EVP_RC2_KEY *)(ctx)->cipher_data)->ks, EVP_CIPHER_CTX_key_length(ctx),
     key, ((EVP_RC2_KEY *)(ctx)->cipher_data)->key_bits);
 return 1;
}
...
rc2_magic_to_meth(int i)
{
 if (i == 0x3a)
  ...
  ERR_put_error(6,(109),(108),"evp/e_rc2.c",174);
  return (0);
 }
}
...
# 188 "evp/e_rc2.c"
  ...
  if (l > sizeof(iv)) {
   ERR_put_error(6,(197),(102),"evp/e_rc2.c",192)
                          ;
   return -1;
  }
...
rc2_ctrl(EVP_CIPHER_CTX *c, int type, int arg, void *ptr)
{
 switch (type) {
 case 0x0:
  ((EVP_RC2_KEY *)(c)->cipher_data)->key_bits = EVP_CIPHER_CTX_key_length(c) * 8;
  return 1;

 case 0x2:
  *(int *)ptr = ((EVP_RC2_KEY *)(c)->cipher_data)->key_bits;
  return 1;

 case 0x3:
  if (arg > 0) {
   ((EVP_RC2_KEY *)(c)->cipher_data)->key_bits = arg;
   return 1;
  }
  return 0;
