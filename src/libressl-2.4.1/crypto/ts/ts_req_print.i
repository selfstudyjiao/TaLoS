...
TS_REQ_print_bio(BIO *bio, TS_REQ *a)
{
 ...
 if (a == 
# 75 "ts/ts_req_print.c" 3 4
         ((void *)0)
# 75 "ts/ts_req_print.c"
             )
  return 0;
 ...
 if (policy_id == 
# 85 "ts/ts_req_print.c" 3 4
                 ((void *)0)
# 85 "ts/ts_req_print.c"
                     )
 ...
 if (nonce == 
# 92 "ts/ts_req_print.c" 3 4
             ((void *)0)
# 92 "ts/ts_req_print.c"
                 )
  BIO_printf(bio, "unspecified");
 else
