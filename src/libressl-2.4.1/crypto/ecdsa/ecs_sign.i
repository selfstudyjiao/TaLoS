...
# 61 "ecdsa/ecs_sign.c" 2


ECDSA_SIG *
ECDSA_do_sign(const unsigned char *dgst, int dlen, EC_KEY *eckey)
{
 return ECDSA_do_sign_ex(dgst, dlen, 
# 66 "ecdsa/ecs_sign.c" 3 4
                                    ((void *)0)
# 66 "ecdsa/ecs_sign.c"
                                        , 
# 66 "ecdsa/ecs_sign.c" 3 4
    ...
    const BIGNUM *rp, EC_KEY *eckey)
{
 ...
 if (ecdsa == 
# 75 "ecdsa/ecs_sign.c" 3 4
             ((void *)0)
# 75 "ecdsa/ecs_sign.c"
                 )
  return 
# 76 "ecdsa/ecs_sign.c" 3 4
        ((void *)0)
# 76 "ecdsa/ecs_sign.c"
            ;
...
{
 return ECDSA_sign_ex(type, dgst, dlen, sig, siglen, 
# 84 "ecdsa/ecs_sign.c" 3 4
                                                    ((void *)0)
# 84 "ecdsa/ecs_sign.c"
                                                        , 
# 84 "ecdsa/ecs_sign.c" 3 4
...
ECDSA_sign_setup(EC_KEY *eckey, BN_CTX *ctx_in, BIGNUM **kinvp, BIGNUM **rp)
{
 ...
 if (ecdsa == 
# 108 "ecdsa/ecs_sign.c" 3 4
             ((void *)0)
# 108 "ecdsa/ecs_sign.c"
                 )
  return 0;
