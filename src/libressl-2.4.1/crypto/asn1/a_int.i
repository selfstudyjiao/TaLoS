...
# 199 "asn1/a_int.c" 3 4
                                   ((void *)0)
# 199 "asn1/a_int.c"
                                       )
   return (
# 200 "asn1/a_int.c" 3 4
          ((void *)0)
# 200 "asn1/a_int.c"
              );
 } else
...
err:
 ERR_put_error(13,(194),(i),"asn1/a_int.c",269);
 if (a == 
# 270 "asn1/a_int.c" 3 4
         ((void *)0) 
# 270 "asn1/a_int.c"
              || *a != ret)
  ASN1_INTEGER_free(ret);
 return (
# 272 "asn1/a_int.c" 3 4
        ((void *)0)
# 272 "asn1/a_int.c"
            );
}
...
# 291 "asn1/a_int.c"
  ...
  if ((ret = ASN1_INTEGER_new()) == 
# 292 "asn1/a_int.c" 3 4
                                   ((void *)0)
# 292 "asn1/a_int.c"
                                       )
   return (
# 293 "asn1/a_int.c" 3 4
          ((void *)0)
# 293 "asn1/a_int.c"
              );
 } else
...
err:
 ERR_put_error(13,(150),(i),"asn1/a_int.c",335);
 if (a == 
# 336 "asn1/a_int.c" 3 4
         ((void *)0) 
# 336 "asn1/a_int.c"
              || *a != ret)
  ASN1_INTEGER_free(ret);
 return (
# 338 "asn1/a_int.c" 3 4
        ((void *)0)
# 338 "asn1/a_int.c"
            );
}
...
ASN1_INTEGER_set(ASN1_INTEGER *a, long v)
{
 ...
 if (a->data == 
# 355 "asn1/a_int.c" 3 4
               ((void *)0)
# 355 "asn1/a_int.c"
                   ) {
  ERR_put_error(13,(118),((1|64)),"asn1/a_int.c",356);
  return (0);
 }
 d = v;
 if (d < 0) {
...
# 418 "asn1/a_int.c"
  ...
  ret = ai;
 if (ret == 
# 422 "asn1/a_int.c" 3 4
           ((void *)0)
# 422 "asn1/a_int.c"
               ) {
  ERR_put_error(13,(139),(58),"asn1/a_int.c",423);
  goto err;
 }
 if (((bn)->neg != 0))
  ret->type = (2 | 0x100);
 ...
 if (ret->length < len + 4) {
  ...
  if (!new_data) {
   ERR_put_error(13,(139),((1|64)),"asn1/a_int.c",435);
   goto err;
  }
  ret->data = new_data;
 }
...
# 464 "asn1/a_int.c" 3 4
                                                   ((void *)0)
# 464 "asn1/a_int.c"
                                                       )
  ERR_put_error(13,(119),(105),"asn1/a_int.c",465);
 else if (ai->type == (2 | 0x100))
