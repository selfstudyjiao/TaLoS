...
gf2m_Mdouble(const EC_GROUP *group, BIGNUM *x, BIGNUM *z, BN_CTX *ctx)
{
 ...
 BN_CTX_start(ctx);
 if ((t1 = BN_CTX_get(ctx)) == 
# 94 "ec/ec2_mult.c" 3 4
                              ((void *)0)
# 94 "ec/ec2_mult.c"
                                  )
  goto err;
    ...
    const BIGNUM *x2, const BIGNUM *z2, BN_CTX *ctx)
{
 ...
 BN_CTX_start(ctx);
 if ((t1 = BN_CTX_get(ctx)) == 
# 134 "ec/ec2_mult.c" 3 4
                              ((void *)0)
# 134 "ec/ec2_mult.c"
                                  )
  goto err;
 if ((t2 = BN_CTX_get(ctx)) == 
# 136 "ec/ec2_mult.c" 3 4
                              ((void *)0)
# 136 "ec/ec2_mult.c"
                                  )
  goto err;
    ...
    BIGNUM *z1, BIGNUM *x2, BIGNUM *z2, BN_CTX *ctx)
{
 ...
 BN_CTX_start(ctx);
 if ((t3 = BN_CTX_get(ctx)) == 
# 193 "ec/ec2_mult.c" 3 4
                              ((void *)0)
# 193 "ec/ec2_mult.c"
                                  )
  goto err;
 if ((t4 = BN_CTX_get(ctx)) == 
# 195 "ec/ec2_mult.c" 3 4
                              ((void *)0)
# 195 "ec/ec2_mult.c"
                                  )
  goto err;
 if ((t5 = BN_CTX_get(ctx)) == 
# 197 "ec/ec2_mult.c" 3 4
                              ((void *)0)
# 197 "ec/ec2_mult.c"
                                  )
  goto err;
    ...
    const BIGNUM *scalar, const EC_POINT *point, BN_CTX *ctx)
{
 ...
 if (r == point) {
  ERR_put_error(16,(208),(112),"ec/ec2_mult.c",270);
  return 0;
 }

 if ((scalar == 
# 274 "ec/ec2_mult.c" 3 4
               ((void *)0)
# 274 "ec/ec2_mult.c"
                   ) || BN_is_zero(scalar) || (point == 
# 274 "ec/ec2_mult.c" 3 4
                                                        ((void *)0)
# 274 "ec/ec2_mult.c"
                                                            ) ||
...
# 284 "ec/ec2_mult.c" 3 4
                              ((void *)0)
# 284 "ec/ec2_mult.c"
                                  )
  goto err;
 if ((z1 = BN_CTX_get(ctx)) == 
# 286 "ec/ec2_mult.c" 3 4
                              ((void *)0)
# 286 "ec/ec2_mult.c"
                                  )
  goto err;
 ...
 if (!(((group->field.top) <= (x1)->dmax)?(x1):bn_expand2((x1),(group->field.top))))
                goto err;
 if (!(((group->field.top) <= (z1)->dmax)?(z1):bn_expand2((z1),(group->field.top))))
                goto err;
 if (!(((group->field.top) <= (x2)->dmax)?(x2):bn_expand2((x2),(group->field.top))))
                goto err;
 if (!(((group->field.top) <= (z2)->dmax)?(z2):bn_expand2((z2),(group->field.top))))
                goto err;
...
# 373 "ec/ec2_mult.c"
 ...
 size_t i;
 EC_POINT *p = 
# 376 "ec/ec2_mult.c" 3 4
              ((void *)0)
# 376 "ec/ec2_mult.c"
                  ;
 EC_POINT *acc = 
# 377 "ec/ec2_mult.c" 3 4
                ((void *)0)
# 377 "ec/ec2_mult.c"
                    ;

 if (ctx == 
# 379 "ec/ec2_mult.c" 3 4
           ((void *)0)
# 379 "ec/ec2_mult.c"
               ) {
  ctx = new_ctx = BN_CTX_new();
  if (ctx == 
# 381 "ec/ec2_mult.c" 3 4
            ((void *)0)
# 381 "ec/ec2_mult.c"
                )
   return 0;
...
# 395 "ec/ec2_mult.c" 3 4
                                 ((void *)0)
# 395 "ec/ec2_mult.c"
                                     )
  goto err;
 if ((acc = EC_POINT_new(group)) == 
# 397 "ec/ec2_mult.c" 3 4
                                   ((void *)0)
# 397 "ec/ec2_mult.c"
                                       )
  goto err;
