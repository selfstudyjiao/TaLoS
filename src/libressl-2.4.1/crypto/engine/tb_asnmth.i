...
# 62 "engine/tb_asnmth.c" 2
# 70 "engine/tb_asnmth.c"
static ENGINE_TABLE *pkey_asn1_meth_table = 
# 70 "engine/tb_asnmth.c" 3 4
                                           ((void *)0)
# 70 "engine/tb_asnmth.c"
                                               ;
...
ENGINE_register_pkey_asn1_meths(ENGINE *e)
{
 if (e->pkey_asn1_meths) {
  const int *nids;
  int num_nids = e->pkey_asn1_meths(e, 
# 89 "engine/tb_asnmth.c" 3 4
                                      ((void *)0)
# 89 "engine/tb_asnmth.c"
                                          , &nids, 0);
  if (num_nids > 0)
...
ENGINE_set_default_pkey_asn1_meths(ENGINE *e)
{
 if (e->pkey_asn1_meths) {
  const int *nids;
  int num_nids = e->pkey_asn1_meths(e, 
# 112 "engine/tb_asnmth.c" 3 4
                                      ((void *)0)
# 112 "engine/tb_asnmth.c"
                                          , &nids, 0);
  if (num_nids > 0)
   return engine_table_register(&pkey_asn1_meth_table,
       engine_unregister_all_pkey_asn1_meths, e, nids,
...
ENGINE_get_pkey_asn1_meth(ENGINE *e, int nid)
{
 ...
 if (!fn || !fn(e, &ret, 
# 137 "engine/tb_asnmth.c" 3 4
                        ((void *)0)
# 137 "engine/tb_asnmth.c"
                            , nid)) {
  ERR_put_error(38,(193),(101),"engine/tb_asnmth.c",139)
                                               ;
  return 
# 140 "engine/tb_asnmth.c" 3 4
        ((void *)0)
# 140 "engine/tb_asnmth.c"
            ;
 }
 return ret;
}
...
engine_pkey_asn1_meths_free(ENGINE *e)
{
 ...
 if (e->pkey_asn1_meths) {
  const int *pknids;
  int npknids;
  npknids = e->pkey_asn1_meths(e, 
# 173 "engine/tb_asnmth.c" 3 4
                                 ((void *)0)
# 173 "engine/tb_asnmth.c"
                                     , &pknids, 0);
  for (i = 0; i < npknids; i++) {
   if (e->pkey_asn1_meths(e, &pkm, 
# 175 "engine/tb_asnmth.c" 3 4
                                  ((void *)0)
# 175 "engine/tb_asnmth.c"
                                      , pknids[i])) {
...
ENGINE_get_pkey_asn1_meth_str(ENGINE *e, const char *str, int len)
{
 ...
 if (!e->pkey_asn1_meths)
  return 
# 196 "engine/tb_asnmth.c" 3 4
        ((void *)0)
# 196 "engine/tb_asnmth.c"
            ;
 if (len == -1)
  len = strlen(str);
 nidcount = e->pkey_asn1_meths(e, 
# 199 "engine/tb_asnmth.c" 3 4
                                 ((void *)0)
# 199 "engine/tb_asnmth.c"
                                     , &nids, 0);
 for (i = 0; i < nidcount; i++) {
  e->pkey_asn1_meths(e, &ameth, 
# 201 "engine/tb_asnmth.c" 3 4
                               ((void *)0)
# 201 "engine/tb_asnmth.c"
                                   , nids[i]);
 ...
 return 
# 206 "engine/tb_asnmth.c" 3 4
       ((void *)0)
# 206 "engine/tb_asnmth.c"
           ;
}
...
static void
look_str_cb(int nid, struct stack_st_ENGINE *sk, ENGINE *def, void *arg)
{
 ...
 if (lk->ameth)
  return;
 for (i = 0; i < sk_num(((_STACK*) (1 ? (sk) : (struct stack_st_ENGINE*)0))); i++) {
  ENGINE *e = ((ENGINE *)sk_value(((_STACK*) (1 ? (sk) : (struct stack_st_ENGINE*)0)), (i)));
  EVP_PKEY_ASN1_METHOD *ameth;
  e->pkey_asn1_meths(e, &ameth, 
# 227 "engine/tb_asnmth.c" 3 4
                               ((void *)0)
# 227 "engine/tb_asnmth.c"
                                   , nid);
...
ENGINE_pkey_asn1_find_str(ENGINE **pe, const char *str, int len)
{
 ...
 fstr.e = 
# 242 "engine/tb_asnmth.c" 3 4
         ((void *)0)
# 242 "engine/tb_asnmth.c"
             ;
 fstr.ameth = 
# 243 "engine/tb_asnmth.c" 3 4
             ((void *)0)
# 243 "engine/tb_asnmth.c"
                 ;
 fstr.str = str;
 fstr.len = len;
 CRYPTO_lock(1|8,30,"engine/tb_asnmth.c",246);
 ...
 *pe = fstr.e;
 CRYPTO_lock(2|8,30,"engine/tb_asnmth.c",254);
 return fstr.ameth;
}
