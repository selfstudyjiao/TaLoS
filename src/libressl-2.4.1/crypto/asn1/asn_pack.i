...
{
 struct stack_st_OPENSSL_BLOCK *sk;
 const unsigned char *pbuf;

 pbuf = buf;
 if (!(sk = d2i_ASN1_SET(
# 78 "asn1/asn_pack.c" 3 4
                        ((void *)0)
# 78 "asn1/asn_pack.c"
                            , &pbuf, len, d2i, free_func,
     16, 0x00)))
  ERR_put_error(13,(127),(110),"asn1/asn_pack.c",80);
 return sk;
}
...
unsigned char *
ASN1_seq_pack(struct stack_st_OPENSSL_BLOCK *safes, i2d_of_void *i2d,
    unsigned char **buf, int *len)
{
 int safelen;
 unsigned char *safe, *p;

 if (!(safelen = i2d_ASN1_SET(safes, 
# 95 "asn1/asn_pack.c" 3 4
                                    ((void *)0)
# 95 "asn1/asn_pack.c"
                                        , i2d, 16,
           0x00, 0))) {
  ERR_put_error(13,(126),(112),"asn1/asn_pack.c",97);
  return 
# 98 "asn1/asn_pack.c" 3 4
        ((void *)0)
# 98 "asn1/asn_pack.c"
            ;
 }
 if (!(safe = malloc(safelen))) {
  ERR_put_error(13,(126),((1|64)),"asn1/asn_pack.c",101);
  return 
# 102 "asn1/asn_pack.c" 3 4
        ((void *)0)
# 102 "asn1/asn_pack.c"
            ;
 }
 p = safe;
 i2d_ASN1_SET(safes, &p, i2d, 16, 0x00,
         0);
 if (len)
  *len = safelen;
 if (buf)
...
ASN1_unpack_string(ASN1_STRING *oct, d2i_of_void *d2i)
{
 ...
 p = oct->data;
 if (!(ret = d2i(
# 123 "asn1/asn_pack.c" 3 4
                ((void *)0)
# 123 "asn1/asn_pack.c"
                    , &p, oct->length)))
  ERR_put_error(13,(136),(110),"asn1/asn_pack.c",124);
 return ret;
}
...
ASN1_pack_string(void *obj, i2d_of_void *i2d, ASN1_STRING **oct)
{
 ...
 if (!oct || !*oct) {
  if (!(octmp = ASN1_STRING_new())) {
   ERR_put_error(13,(124),((1|64)),"asn1/asn_pack.c",138);
   return 
# 139 "asn1/asn_pack.c" 3 4
         ((void *)0)
# 139 "asn1/asn_pack.c"
             ;
  }
 ...
 if (!(octmp->length = i2d(obj, 
# 144 "asn1/asn_pack.c" 3 4
                               ((void *)0)
# 144 "asn1/asn_pack.c"
                                   ))) {
  ERR_put_error(13,(124),(112),"asn1/asn_pack.c",145);
  goto err;
 }
 if (!(p = malloc (octmp->length))) {
  ERR_put_error(13,(124),((1|64)),"asn1/asn_pack.c",149);
  goto err;
 }
 octmp->data = p;
 i2d (obj, &p);
...
err:
 if (!oct || octmp != *oct) {
  ...
  if (oct)
   *oct = 
# 161 "asn1/asn_pack.c" 3 4
         ((void *)0)
# 161 "asn1/asn_pack.c"
             ;
 }
 return 
# 163 "asn1/asn_pack.c" 3 4
       ((void *)0)
# 163 "asn1/asn_pack.c"
           ;
}
...
ASN1_item_pack(void *obj, const ASN1_ITEM *it, ASN1_STRING **oct)
{
 ...
 if (!oct || !*oct) {
  if (!(octmp = ASN1_STRING_new ())) {
   ERR_put_error(13,(198),((1|64)),"asn1/asn_pack.c",177);
   return 
# 178 "asn1/asn_pack.c" 3 4
         ((void *)0)
# 178 "asn1/asn_pack.c"
             ;
  }
 ...
 free(octmp->data);
 octmp->data = 
# 184 "asn1/asn_pack.c" 3 4
              ((void *)0)
# 184 "asn1/asn_pack.c"
                  ;

 if (!(octmp->length = ASN1_item_i2d(obj, &octmp->data, it))) {
  ERR_put_error(13,(198),(112),"asn1/asn_pack.c",187);
  goto err;
 }
 if (!octmp->data) {
  ERR_put_error(13,(198),((1|64)),"asn1/asn_pack.c",191);
  goto err;
 }
 if (oct)
  *oct = octmp;
...
ASN1_item_unpack(ASN1_STRING *oct, const ASN1_ITEM *it)
{
 ...
 p = oct->data;
 if (!(ret = ASN1_item_d2i(
# 212 "asn1/asn_pack.c" 3 4
                          ((void *)0)
# 212 "asn1/asn_pack.c"
                              , &p, oct->length, it)))
  ERR_put_error(13,(199),(110),"asn1/asn_pack.c",213);
 return ret;
}
