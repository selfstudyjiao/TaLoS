...
# 68 "x509/x509_att.c" 2

int
X509at_get_attr_count(const struct stack_st_X509_ATTRIBUTE *x)
{
 return sk_num(((_STACK*) (1 ? (x) : (struct stack_st_X509_ATTRIBUTE*)0)));
}

int
X509at_get_attr_by_NID(const struct stack_st_X509_ATTRIBUTE *x, int nid, int lastpos)
{
 ASN1_OBJECT *obj;

 obj = OBJ_nid2obj(nid);
 if (obj == 
# 81 "x509/x509_att.c" 3 4
           ((void *)0)
# 81 "x509/x509_att.c"
               )
  return (-2);
...
int
X509at_get_attr_by_OBJ(const struct stack_st_X509_ATTRIBUTE *sk, ASN1_OBJECT *obj,
    int lastpos)
{
 int n;
 X509_ATTRIBUTE *ex;
...
# 93 "x509/x509_att.c"
 ...
 if (lastpos < 0)
  lastpos = 0;
 n = sk_num(((_STACK*) (1 ? (sk) : (struct stack_st_X509_ATTRIBUTE*)0)));
 for (; lastpos < n; lastpos++) {
  ex = ((X509_ATTRIBUTE *)sk_value(((_STACK*) (1 ? (sk) : (struct stack_st_X509_ATTRIBUTE*)0)), (lastpos)));
...
X509_ATTRIBUTE *
X509at_get_attr(const struct stack_st_X509_ATTRIBUTE *x, int loc)
{
 if (x == 
# 110 "x509/x509_att.c" 3 4
         ((void *)0) 
# 110 "x509/x509_att.c"
              || sk_num(((_STACK*) (1 ? (x) : (struct stack_st_X509_ATTRIBUTE*)0))) <= loc || loc < 0)
  return 
# 111 "x509/x509_att.c" 3 4
        ((void *)0)
# 111 "x509/x509_att.c"
            ;
 else
  return ((X509_ATTRIBUTE *)sk_value(((_STACK*) (1 ? (x) : (struct stack_st_X509_ATTRIBUTE*)0)), (loc)));
}

X509_ATTRIBUTE *
X509at_delete_attr(struct stack_st_X509_ATTRIBUTE *x, int loc)
{
 X509_ATTRIBUTE *ret;

 if (x == 
# 121 "x509/x509_att.c" 3 4
         ((void *)0) 
# 121 "x509/x509_att.c"
              || sk_num(((_STACK*) (1 ? (x) : (struct stack_st_X509_ATTRIBUTE*)0))) <= loc || loc < 0)
  return (
# 122 "x509/x509_att.c" 3 4
         ((void *)0)
# 122 "x509/x509_att.c"
             );
 ret = (X509_ATTRIBUTE *)sk_delete(((_STACK*) (1 ? (x) : (struct stack_st_X509_ATTRIBUTE*)0)), (loc));
 return (ret);
}

struct stack_st_X509_ATTRIBUTE *
X509at_add1_attr(struct stack_st_X509_ATTRIBUTE **x, X509_ATTRIBUTE *attr)
{
 X509_ATTRIBUTE *new_attr = 
# 130 "x509/x509_att.c" 3 4
                           ((void *)0)
# 130 "x509/x509_att.c"
                               ;
 struct stack_st_X509_ATTRIBUTE *sk = 
# 131 "x509/x509_att.c" 3 4
                               ((void *)0)
# 131 "x509/x509_att.c"
                                   ;

 if (x == 
# 133 "x509/x509_att.c" 3 4
         ((void *)0)
# 133 "x509/x509_att.c"
             ) {
  ERR_put_error(11,(135),((3|64)),"x509/x509_att.c",134);
  return (
# 135 "x509/x509_att.c" 3 4
         ((void *)0)
# 135 "x509/x509_att.c"
             );
 }
 ...
 if (*x == 
# 138 "x509/x509_att.c" 3 4
          ((void *)0)
# 138 "x509/x509_att.c"
              ) {
  if ((sk = ((struct stack_st_X509_ATTRIBUTE *)sk_new_null())) == 
# 139 "x509/x509_att.c" 3 4
                                            ((void *)0)
# 139 "x509/x509_att.c"
                                                )
   goto err;
 ...
 if ((new_attr = X509_ATTRIBUTE_dup(attr)) == 
# 144 "x509/x509_att.c" 3 4
                                             ((void *)0)
# 144 "x509/x509_att.c"
                                                 )
  goto err2;
 if (!sk_push(((_STACK*) (1 ? (sk) : (struct stack_st_X509_ATTRIBUTE*)0)), ((void*) (1 ? (new_attr) : (X509_ATTRIBUTE*)0))))
  goto err;
 if (*x == 
# 148 "x509/x509_att.c" 3 4
          ((void *)0)
# 148 "x509/x509_att.c"
              )
  *x = sk;
...
err:
 ERR_put_error(11,(135),((1|64)),"x509/x509_att.c",153);
err2:
 if (new_attr != 
# 155 "x509/x509_att.c" 3 4
                ((void *)0)
# 155 "x509/x509_att.c"
                    )
  X509_ATTRIBUTE_free(new_attr);
 if (sk != 
# 157 "x509/x509_att.c" 3 4
          ((void *)0) 
# 157 "x509/x509_att.c"
               && sk != *x)
  sk_free(((_STACK*) (1 ? (sk) : (struct stack_st_X509_ATTRIBUTE*)0)));
 return (
# 159 "x509/x509_att.c" 3 4
        ((void *)0)
# 159 "x509/x509_att.c"
            );
}
...
struct stack_st_X509_ATTRIBUTE *
X509at_add1_attr_by_OBJ(struct stack_st_X509_ATTRIBUTE **x, const ASN1_OBJECT *obj,
    int type, const unsigned char *bytes, int len)
{
 X509_ATTRIBUTE *attr;
 struct stack_st_X509_ATTRIBUTE *ret;

 attr = X509_ATTRIBUTE_create_by_OBJ(
# 169 "x509/x509_att.c" 3 4
                                    ((void *)0)
# 169 "x509/x509_att.c"
                                        , obj, type, bytes, len);
 if (!attr)
...
struct stack_st_X509_ATTRIBUTE *
X509at_add1_attr_by_NID(struct stack_st_X509_ATTRIBUTE **x, int nid, int type,
    const unsigned char *bytes, int len)
{
 X509_ATTRIBUTE *attr;
 struct stack_st_X509_ATTRIBUTE *ret;

 attr = X509_ATTRIBUTE_create_by_NID(
# 184 "x509/x509_att.c" 3 4
                                    ((void *)0)
# 184 "x509/x509_att.c"
                                        , nid, type, bytes, len);
 if (!attr)
...
struct stack_st_X509_ATTRIBUTE *
X509at_add1_attr_by_txt(struct stack_st_X509_ATTRIBUTE **x, const char *attrname,
    int type, const unsigned char *bytes, int len)
{
 X509_ATTRIBUTE *attr;
 struct stack_st_X509_ATTRIBUTE *ret;

 attr = X509_ATTRIBUTE_create_by_txt(
# 199 "x509/x509_att.c" 3 4
                                    ((void *)0)
# 199 "x509/x509_att.c"
                                        , attrname, type, bytes, len);
 if (!attr)
  return 0;
 ret = X509at_add1_attr(x, attr);
 X509_ATTRIBUTE_free(attr);
...
void *
X509at_get0_data_by_OBJ(struct stack_st_X509_ATTRIBUTE *x, ASN1_OBJECT *obj,
    int lastpos, int type)
{
 ...
 if (i == -1)
  return 
# 216 "x509/x509_att.c" 3 4
        ((void *)0)
# 216 "x509/x509_att.c"
            ;
 if ((lastpos <= -2) && (X509at_get_attr_by_OBJ(x, obj, i) != -1))
  return 
# 218 "x509/x509_att.c" 3 4
        ((void *)0)
# 218 "x509/x509_att.c"
            ;
 ...
 if (lastpos <= -3 && (X509_ATTRIBUTE_count(at) != 1))
  return 
# 221 "x509/x509_att.c" 3 4
        ((void *)0)
# 221 "x509/x509_att.c"
            ;
 return X509_ATTRIBUTE_get0_data(at, 0, type, 
# 222 "x509/x509_att.c" 3 4
                                             ((void *)0)
# 222 "x509/x509_att.c"
                                                 );
}
    ...
    const void *data, int len)
{
 ...
 obj = OBJ_nid2obj(nid);
 if (obj == 
# 233 "x509/x509_att.c" 3 4
           ((void *)0)
# 233 "x509/x509_att.c"
               ) {
  ERR_put_error(11,(136),(109),"x509/x509_att.c",235)
                         ;
  return (
# 236 "x509/x509_att.c" 3 4
         ((void *)0)
# 236 "x509/x509_att.c"
             );
 }
...
# 250 "x509/x509_att.c"
  ...
  if ((ret = X509_ATTRIBUTE_new()) == 
# 251 "x509/x509_att.c" 3 4
                                     ((void *)0)
# 251 "x509/x509_att.c"
                                         ) {
   ERR_put_error(11,(137),((1|64)),"x509/x509_att.c",253)
                            ;
   return (
# 254 "x509/x509_att.c" 3 4
          ((void *)0)
# 254 "x509/x509_att.c"
              );
  }
...
err:
 if ((attr == 
# 269 "x509/x509_att.c" 3 4
             ((void *)0)
# 269 "x509/x509_att.c"
                 ) || (ret != *attr))
  X509_ATTRIBUTE_free(ret);
 return (
# 271 "x509/x509_att.c" 3 4
        ((void *)0)
# 271 "x509/x509_att.c"
            );
}
    ...
    int type, const unsigned char *bytes, int len)
{
 ...
 if (obj == 
# 282 "x509/x509_att.c" 3 4
           ((void *)0)
# 282 "x509/x509_att.c"
               ) {
  ERR_put_error(11,(140),(119),"x509/x509_att.c",284)
                                ;
  ERR_asprintf_error_data("name=%s", atrname);
  return (
# 286 "x509/x509_att.c" 3 4
         ((void *)0)
# 286 "x509/x509_att.c"
             );
 }
...
{
 ASN1_TYPE *ttmp = 
# 307 "x509/x509_att.c" 3 4
                  ((void *)0)
# 307 "x509/x509_att.c"
                      ;
 ASN1_STRING *stmp = 
# 308 "x509/x509_att.c" 3 4
                    ((void *)0)
# 308 "x509/x509_att.c"
                        ;
 int atype = 0;
 ...
 if (!attr)
  return 0;
 if (attrtype & 0x1000) {
  stmp = ASN1_STRING_set_by_NID(
# 314 "x509/x509_att.c" 3 4
                               ((void *)0)
# 314 "x509/x509_att.c"
                                   , data, len, attrtype,
      OBJ_obj2nid(attr->object));
  if (!stmp) {
   ERR_put_error(11,(138),(13),"x509/x509_att.c",318)
                      ;
   return 0;
  }
  atype = stmp->type;
 ...
 if (!(attr->value.set = ((struct stack_st_ASN1_TYPE *)sk_new_null())))
  goto err;
 attr->single = 0;
 ...
 if (!(ttmp = ASN1_TYPE_new()))
  goto err;
 if ((len == -1) && !(attrtype & 0x1000)) {
  if (!ASN1_TYPE_set1(ttmp, attrtype, data))
   goto err;
 } else
  ASN1_TYPE_set(ttmp, atype, stmp);
 if (!sk_push(((_STACK*) (1 ? (attr->value.set) : (struct stack_st_ASN1_TYPE*)0)), ((void*) (1 ? (ttmp) : (ASN1_TYPE*)0))))
  goto err;
 return 1;
...
err:
 ASN1_TYPE_free(ttmp);
 ASN1_STRING_free(stmp);
 ERR_put_error(11,(138),((1|64)),"x509/x509_att.c",355);
 return 0;
}
...
{
 if (!attr->single)
  return sk_num(((_STACK*) (1 ? (attr->value.set) : (struct stack_st_ASN1_TYPE*)0)));
...
{
 if (attr == 
# 372 "x509/x509_att.c" 3 4
            ((void *)0)
# 372 "x509/x509_att.c"
                )
  return (
# 373 "x509/x509_att.c" 3 4
         ((void *)0)
# 373 "x509/x509_att.c"
             );
 return (attr->object);
...
X509_ATTRIBUTE_get0_data(X509_ATTRIBUTE *attr, int idx, int atrtype, void *data)
{
 ...
 if (!ttmp)
  return 
# 384 "x509/x509_att.c" 3 4
        ((void *)0)
# 384 "x509/x509_att.c"
            ;
 if (atrtype != ASN1_TYPE_get(ttmp)){
  ERR_put_error(11,(139),(122),"x509/x509_att.c",386);
  return 
# 387 "x509/x509_att.c" 3 4
        ((void *)0)
# 387 "x509/x509_att.c"
            ;
 }
...
{
 if (attr == 
# 395 "x509/x509_att.c" 3 4
            ((void *)0)
# 395 "x509/x509_att.c"
                )
  return (
# 396 "x509/x509_att.c" 3 4
         ((void *)0)
# 396 "x509/x509_att.c"
             );
 if (idx >= X509_ATTRIBUTE_count(attr))
  return 
# 398 "x509/x509_att.c" 3 4
        ((void *)0)
# 398 "x509/x509_att.c"
            ;
 if (!attr->single)
  return ((ASN1_TYPE *)sk_value(((_STACK*) (1 ? (attr->value.set) : (struct stack_st_ASN1_TYPE*)0)), (idx)));
 else
