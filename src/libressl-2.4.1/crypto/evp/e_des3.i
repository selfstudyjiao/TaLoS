...
des_ede_ecb_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out,
    const unsigned char *in, size_t inl)
{
 size_t i, bl; bl = ctx->cipher->block_size; if(inl < bl) return 1; inl -= bl; for(i=0; i <= inl; i+=bl)
 DES_ecb3_encrypt((const_DES_cblock *)(in + i), (DES_cblock *)(out + i),
     &((DES_EDE_KEY *)(ctx)->cipher_data)->ks1, &((DES_EDE_KEY *)(ctx)->cipher_data)->ks2, &((DES_EDE_KEY *)(ctx)->cipher_data)->ks3, ctx->encrypt);
 return 1;
}
    ...
    const unsigned char *in, size_t inl)
{
 while (inl >= ((size_t)1<<(sizeof(long)*8-2))) {
  DES_ede3_ofb64_encrypt(in, out, (long)((size_t)1<<(sizeof(long)*8-2)),
      &((DES_EDE_KEY *)(ctx)->cipher_data)->ks1, &((DES_EDE_KEY *)(ctx)->cipher_data)->ks2, &((DES_EDE_KEY *)(ctx)->cipher_data)->ks3,
...
{
 while (inl >= ((size_t)1<<(sizeof(long)*8-2))) {
  DES_ede3_cbc_encrypt(in, out, (long)((size_t)1<<(sizeof(long)*8-2)),
      &((DES_EDE_KEY *)(ctx)->cipher_data)->ks1, &((DES_EDE_KEY *)(ctx)->cipher_data)->ks2, &((DES_EDE_KEY *)(ctx)->cipher_data)->ks3,
...
{
 while (inl >= ((size_t)1<<(sizeof(long)*8-2))) {
  DES_ede3_cfb64_encrypt(in, out, (long)((size_t)1<<(sizeof(long)*8-2)),
      &((DES_EDE_KEY *)(ctx)->cipher_data)->ks1, &((DES_EDE_KEY *)(ctx)->cipher_data)->ks2, &((DES_EDE_KEY *)(ctx)->cipher_data)->ks3,
...
{
 while (inl >= ((size_t)1<<(sizeof(long)*8-2))) {
  DES_ede3_cfb_encrypt(in, out, 8, (long)((size_t)1<<(sizeof(long)*8-2)),
      &((DES_EDE_KEY *)(ctx)->cipher_data)->ks1, &((DES_EDE_KEY *)(ctx)->cipher_data)->ks2, &((DES_EDE_KEY *)(ctx)->cipher_data)->ks3,
      (DES_cblock *)ctx->iv, ctx->encrypt);
  inl -= ((size_t)1<<(sizeof(long)*8-2));
  in += ((size_t)1<<(sizeof(long)*8-2));
...
static const EVP_CIPHER des_ede_cbc = { 43, 8, 16, 8, 0x200 | 0x2, des_ede_init_key, des_ede_cbc_cipher, 
# 198 "evp/e_des3.c" 3 4
((void *)0)
# 198 "evp/e_des3.c"
, sizeof(DES_EDE_KEY), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, des3_ctrl, 
# 198 "evp/e_des3.c" 3 4
((void *)0) 
# 198 "evp/e_des3.c"
}; const EVP_CIPHER *EVP_des_ede_cbc(void) { return &des_ede_cbc; } static const EVP_CIPHER des_ede_cfb64 = { 60, 1, 16, 8, 0x200 | 0x3, des_ede_init_key, des_ede_cfb64_cipher, 
# 198 "evp/e_des3.c" 3 4
((void *)0)
# 198 "evp/e_des3.c"
, sizeof(DES_EDE_KEY), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, des3_ctrl, 
...
((void *)0) 
# 198 "evp/e_des3.c"
}; const EVP_CIPHER *EVP_des_ede_cfb64(void) { return &des_ede_cfb64; } static const EVP_CIPHER des_ede_ofb = { 62, 1, 16, 8, 0x200 | 0x4, des_ede_init_key, des_ede_ofb_cipher, 
# 198 "evp/e_des3.c" 3 4
((void *)0)
# 198 "evp/e_des3.c"
, sizeof(DES_EDE_KEY), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, des3_ctrl, 
...
((void *)0) 
# 198 "evp/e_des3.c"
}; const EVP_CIPHER *EVP_des_ede_ofb(void) { return &des_ede_ofb; } static const EVP_CIPHER des_ede_ecb = { 32, 8, 16, 0, 0x200 | 0x1, des_ede_init_key, des_ede_ecb_cipher, 
# 198 "evp/e_des3.c" 3 4
((void *)0)
# 198 "evp/e_des3.c"
, sizeof(DES_EDE_KEY), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, des3_ctrl, 
...
((void *)0) 
# 198 "evp/e_des3.c"
}; const EVP_CIPHER *EVP_des_ede_ecb(void) { return &des_ede_ecb; }
# 209 "evp/e_des3.c"
static const EVP_CIPHER des_ede3_cbc = { 44, 8, 24, 8, 0x200 | 0x2, des_ede3_init_key, des_ede_cbc_cipher, 
# 209 "evp/e_des3.c" 3 4
((void *)0)
# 209 "evp/e_des3.c"
, sizeof(DES_EDE_KEY), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, des3_ctrl, 
# 209 "evp/e_des3.c" 3 4
((void *)0) 
# 209 "evp/e_des3.c"
}; const EVP_CIPHER *EVP_des_ede3_cbc(void) { return &des_ede3_cbc; } static const EVP_CIPHER des_ede3_cfb64 = { 61, 1, 24, 8, 0x200 | 0x3, des_ede3_init_key, des_ede_cfb64_cipher, 
# 209 "evp/e_des3.c" 3 4
((void *)0)
# 209 "evp/e_des3.c"
, sizeof(DES_EDE_KEY), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, des3_ctrl, 
...
((void *)0) 
# 209 "evp/e_des3.c"
}; const EVP_CIPHER *EVP_des_ede3_cfb64(void) { return &des_ede3_cfb64; } static const EVP_CIPHER des_ede3_ofb = { 63, 1, 24, 8, 0x200 | 0x4, des_ede3_init_key, des_ede_ofb_cipher, 
# 209 "evp/e_des3.c" 3 4
((void *)0)
# 209 "evp/e_des3.c"
, sizeof(DES_EDE_KEY), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, des3_ctrl, 
...
((void *)0) 
# 209 "evp/e_des3.c"
}; const EVP_CIPHER *EVP_des_ede3_ofb(void) { return &des_ede3_ofb; } static const EVP_CIPHER des_ede3_ecb = { 33, 8, 24, 0, 0x200 | 0x1, des_ede3_init_key, des_ede_ecb_cipher, 
# 209 "evp/e_des3.c" 3 4
((void *)0)
# 209 "evp/e_des3.c"
, sizeof(DES_EDE_KEY), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, des3_ctrl, 
...
((void *)0) 
# 209 "evp/e_des3.c"
}; const EVP_CIPHER *EVP_des_ede3_ecb(void) { return &des_ede3_ecb; }





static const EVP_CIPHER des_ede3_cfb1 = { 658, 1, 24, 8, 0x200 | 0x3, des_ede3_init_key, des_ede3_cfb1_cipher, 
# 215 "evp/e_des3.c" 3 4
((void *)0)
# 215 "evp/e_des3.c"
, sizeof(DES_EDE_KEY), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, des3_ctrl, 
# 215 "evp/e_des3.c" 3 4
((void *)0) 
# 215 "evp/e_des3.c"
}; const EVP_CIPHER *EVP_des_ede3_cfb1(void) { return &des_ede3_cfb1; }





static const EVP_CIPHER des_ede3_cfb8 = { 659, 1, 24, 8, 0x200 | 0x3, des_ede3_init_key, des_ede3_cfb8_cipher, 
# 221 "evp/e_des3.c" 3 4
((void *)0)
# 221 "evp/e_des3.c"
, sizeof(DES_EDE_KEY), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, des3_ctrl, 
# 221 "evp/e_des3.c" 3 4
((void *)0) 
# 221 "evp/e_des3.c"
}; const EVP_CIPHER *EVP_des_ede3_cfb8(void) { return &des_ede3_cfb8; }
    ...
    const unsigned char *iv, int enc)
{
 ...
 DES_set_key_unchecked(&deskey[0], &((DES_EDE_KEY *)(ctx)->cipher_data)->ks1);
 DES_set_key_unchecked(&deskey[1], &((DES_EDE_KEY *)(ctx)->cipher_data)->ks2);
 memcpy(&((DES_EDE_KEY *)(ctx)->cipher_data)->ks3, &((DES_EDE_KEY *)(ctx)->cipher_data)->ks1,
     sizeof(((DES_EDE_KEY *)(ctx)->cipher_data)->ks1));
 return 1;
}
    ...
    const unsigned char *iv, int enc)
{
 ...
 DES_set_key_unchecked(&deskey[0], &((DES_EDE_KEY *)(ctx)->cipher_data)->ks1);
 DES_set_key_unchecked(&deskey[1], &((DES_EDE_KEY *)(ctx)->cipher_data)->ks2);
 DES_set_key_unchecked(&deskey[2], &((DES_EDE_KEY *)(ctx)->cipher_data)->ks3);
 return 1;
}
