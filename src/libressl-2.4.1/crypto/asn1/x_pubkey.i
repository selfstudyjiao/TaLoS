...
{
 X509_PUBKEY *pk = 
# 142 "asn1/x_pubkey.c" 3 4
                  ((void *)0)
# 142 "asn1/x_pubkey.c"
                      ;

 if (x == 
# 144 "asn1/x_pubkey.c" 3 4
         ((void *)0)
# 144 "asn1/x_pubkey.c"
             )
  return (0);
 if ((pk = X509_PUBKEY_new()) == 
# 146 "asn1/x_pubkey.c" 3 4
                                ((void *)0)
# 146 "asn1/x_pubkey.c"
                                    )
  goto error;
 ...
 if (pkey->ameth) {
  if (pkey->ameth->pub_encode) {
   if (!pkey->ameth->pub_encode(pk, pkey)) {
    ERR_put_error(11,(120),(126),"asn1/x_pubkey.c",153)
                                       ;
    goto error;
   }
  } else {
   ERR_put_error(11,(120),(124),"asn1/x_pubkey.c",158)
                                   ;
   goto error;
  }
 } else {
  ERR_put_error(11,(120),(111),"asn1/x_pubkey.c",162);
  goto error;
 }

 if (*x != 
# 166 "asn1/x_pubkey.c" 3 4
          ((void *)0)
# 166 "asn1/x_pubkey.c"
              )
  X509_PUBKEY_free(*x);
...
{
 EVP_PKEY *ret = 
# 182 "asn1/x_pubkey.c" 3 4
                ((void *)0)
# 182 "asn1/x_pubkey.c"
                    ;

 if (key == 
# 184 "asn1/x_pubkey.c" 3 4
           ((void *)0)
# 184 "asn1/x_pubkey.c"
               )
  goto error;
 ...
 if (key->pkey != 
# 187 "asn1/x_pubkey.c" 3 4
                 ((void *)0)
# 187 "asn1/x_pubkey.c"
                     ) {
  CRYPTO_add_lock(&key->pkey->references,1,10,"asn1/x_pubkey.c",188);
  return key->pkey;
 }

 if (key->public_key == 
# 192 "asn1/x_pubkey.c" 3 4
                       ((void *)0)
# 192 "asn1/x_pubkey.c"
                           )
  goto error;
 ...
 if ((ret = EVP_PKEY_new()) == 
# 195 "asn1/x_pubkey.c" 3 4
                              ((void *)0)
# 195 "asn1/x_pubkey.c"
                                  ) {
  ERR_put_error(11,(119),((1|64)),"asn1/x_pubkey.c",196);
  goto error;
 }

 if (!EVP_PKEY_set_type(ret, OBJ_obj2nid(key->algor->algorithm))) {
  ERR_put_error(11,(119),(111),"asn1/x_pubkey.c",201);
  goto error;
 }

 if (ret->ameth->pub_decode) {
  if (!ret->ameth->pub_decode(ret, key)) {
   ERR_put_error(11,(119),(125),"asn1/x_pubkey.c",208)
                                      ;
   goto error;
  }
 } else {
  ERR_put_error(11,(119),(124),"asn1/x_pubkey.c",212);
  goto error;
 }


 CRYPTO_lock(1|8,10,"asn1/x_pubkey.c",217);
 if (key->pkey) {
  CRYPTO_lock(2|8,10,"asn1/x_pubkey.c",219);
  EVP_PKEY_free(ret);
  ret = key->pkey;
 } else {
  key->pkey = ret;
  CRYPTO_lock(2|8,10,"asn1/x_pubkey.c",224);
 }
 CRYPTO_add_lock(&ret->references,1,10,"asn1/x_pubkey.c",226);
...
d2i_PUBKEY(EVP_PKEY **a, const unsigned char **pp, long length)
{
 ...
 EVP_PKEY *pktmp;
 xpk = d2i_X509_PUBKEY(
# 244 "asn1/x_pubkey.c" 3 4
                      ((void *)0)
# 244 "asn1/x_pubkey.c"
                          , pp, length);
 if (!xpk)
  return 
# 246 "asn1/x_pubkey.c" 3 4
        ((void *)0)
# 246 "asn1/x_pubkey.c"
            ;
...
d2i_RSA_PUBKEY(RSA **a, const unsigned char **pp, long length)
{
 ...
 q = *pp;
 pkey = d2i_PUBKEY(
# 283 "asn1/x_pubkey.c" 3 4
                  ((void *)0)
# 283 "asn1/x_pubkey.c"
                      , &q, length);
 if (!pkey)
  return 
# 285 "asn1/x_pubkey.c" 3 4
        ((void *)0)
# 285 "asn1/x_pubkey.c"
            ;
...
i2d_RSA_PUBKEY(RSA *a, unsigned char **pp)
{
 ...
 pktmp = EVP_PKEY_new();
 if (!pktmp) {
  ERR_put_error(13,(165),((1|64)),"asn1/x_pubkey.c",307);
  return 0;
 }
...
d2i_DSA_PUBKEY(DSA **a, const unsigned char **pp, long length)
{
 ...
 q = *pp;
 pkey = d2i_PUBKEY(
# 325 "asn1/x_pubkey.c" 3 4
                  ((void *)0)
# 325 "asn1/x_pubkey.c"
                      , &q, length);
 if (!pkey)
  return 
# 327 "asn1/x_pubkey.c" 3 4
        ((void *)0)
# 327 "asn1/x_pubkey.c"
            ;
...
i2d_DSA_PUBKEY(DSA *a, unsigned char **pp)
{
 ...
 pktmp = EVP_PKEY_new();
 if (!pktmp) {
  ERR_put_error(13,(161),((1|64)),"asn1/x_pubkey.c",349);
  return 0;
 }
...
d2i_EC_PUBKEY(EC_KEY **a, const unsigned char **pp, long length)
{
 ...
 q = *pp;
 pkey = d2i_PUBKEY(
# 367 "asn1/x_pubkey.c" 3 4
                  ((void *)0)
# 367 "asn1/x_pubkey.c"
                      , &q, length);
 if (!pkey)
  return (
# 369 "asn1/x_pubkey.c" 3 4
         ((void *)0)
# 369 "asn1/x_pubkey.c"
             );
...
i2d_EC_PUBKEY(EC_KEY *a, unsigned char **pp)
{
 ...
 if (!a)
  return (0);
 if ((pktmp = EVP_PKEY_new()) == 
# 389 "asn1/x_pubkey.c" 3 4
                                ((void *)0)
# 389 "asn1/x_pubkey.c"
                                    ) {
  ERR_put_error(13,(181),((1|64)),"asn1/x_pubkey.c",390);
  return (0);
 }
    ...
    void *pval, unsigned char *penc, int penclen)
{
 ...
 if (penc) {
  ...
  pub->public_key->flags&= ~(0x08|0x07);
  pub->public_key->flags |= 0x08;
 }
 return 1;
}
