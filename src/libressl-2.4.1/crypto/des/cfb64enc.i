...
void DES_cfb64_encrypt(const unsigned char *in, unsigned char *out,
 ...
 if (enc)
  ...
  while (l--)
   ...
   if (n == 0)
    {
    (v0 =((unsigned int)(*((iv)++))) , v0|=((unsigned int)(*((iv)++)))<< 8L, v0|=((unsigned int)(*((iv)++)))<<16L, v0|=((unsigned int)(*((iv)++)))<<24L); ti[0]=v0;
    (v1 =((unsigned int)(*((iv)++))) , v1|=((unsigned int)(*((iv)++)))<< 8L, v1|=((unsigned int)(*((iv)++)))<<16L, v1|=((unsigned int)(*((iv)++)))<<24L); ti[1]=v1;
    DES_encrypt1(ti,schedule,1);
    iv = &(*ivec)[0];
    v0=ti[0]; (*((iv)++)=(unsigned char)(((v0) )&0xff), *((iv)++)=(unsigned char)(((v0)>> 8L)&0xff), *((iv)++)=(unsigned char)(((v0)>>16L)&0xff), *((iv)++)=(unsigned char)(((v0)>>24L)&0xff));
    v0=ti[1]; (*((iv)++)=(unsigned char)(((v0) )&0xff), *((iv)++)=(unsigned char)(((v0)>> 8L)&0xff), *((iv)++)=(unsigned char)(((v0)>>16L)&0xff), *((iv)++)=(unsigned char)(((v0)>>24L)&0xff));
    iv = &(*ivec)[0];
    }
   c= *(in++)^iv[n];
   *(out++)=c;
