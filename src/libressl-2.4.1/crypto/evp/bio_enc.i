...
# 156 "evp/bio_enc.c"
 ...
 while (outl > 0) {
  ...
  i = BIO_read(b->next_bio, &(ctx->buf[(32*2)]), (1024*4));
...
# 414 "evp/bio_enc.c"
 ...
 if ((b->callback != 
# 417 "evp/bio_enc.c" 3 4
                    ((void *)0)
# 417 "evp/bio_enc.c"
                        ) &&
     (b->callback(b, 0x06, (const char *)c, 4, e, 0L) <= 0))
  return;

 b->init = 1;
 ctx = (BIO_ENC_CTX *)b->ptr;
 EVP_CipherInit_ex(&(ctx->cipher), c, 
# 423 "evp/bio_enc.c" 3 4
                                     ((void *)0)
# 423 "evp/bio_enc.c"
                                         , k, i, e);

 if (b->callback != 
# 425 "evp/bio_enc.c" 3 4
                   ((void *)0)
# 425 "evp/bio_enc.c"
                       )
  b->callback(b, 0x06, (const char *)c, 4, e, 1L);
}
