...
# 187 "../ssl/d1_clnt.c" 3 4
(*__errno_location ()) 
# 187 "../ssl/d1_clnt.c"
      = 0;

 if (s->info_callback != 
# 189 "../ssl/d1_clnt.c" 3 4
                        ((void *)0)
# 189 "../ssl/d1_clnt.c"
                            )
  cb = s->info_callback;
 else if (s->ctx->info_callback != 
# 191 "../ssl/d1_clnt.c" 3 4
                                  ((void *)0)
# 191 "../ssl/d1_clnt.c"
                                      )
 ...
 for (;;) {
  ...
  case 0x03|0x1000:
   ...
   s->server = 0;
   if (cb != 
# 214 "../ssl/d1_clnt.c" 3 4
            ((void *)0)
# 214 "../ssl/d1_clnt.c"
                )
    cb(s, 0x10, 1);

   if ((s->version & 0xff00 ) != (0xFEFF & 0xff00)) {
    ERR_put_error(20,(249),((4|64)),"../ssl/d1_clnt.c",219)
                             ;
    ret = -1;
    goto end;
   }
  ...
  case (0x111|0x1000):
   ...
   if (s->d1->send_cookie) {
    ...
    s->s3->tmp.next_state = (0x120|0x1000);
   } else
  ...
  case (0x161|0x1000):
   ...
   if (s->s3->tmp.cert_req)
    s->s3->tmp.next_state = (0x170|0x1000);
   else
    s->s3->tmp.next_state = (0x180|0x1000);
   s->init_num = 0;
  ...
  case (0x1A1|0x1000):
   ...
   dtls1_reset_seq_numbers(s, 0x02);
   break;
...
# 526 "../ssl/d1_clnt.c" 3 4
      ((void *)0)
# 526 "../ssl/d1_clnt.c"
      ) <= 0) {

    if (!BIO_test_flags(s->wbio, 0x08)) {
     s->rwstate = 1;
     s->state = s->s3->tmp.next_state;
    }
...
# 563 "../ssl/d1_clnt.c"
  ...
  default:
   ERR_put_error(20,(249),(255),"../ssl/d1_clnt.c",573);
   ret = -1;
   goto end;
...
dtls1_get_hello_verify(SSL *s)
{
 ...
 n = s->method->ssl_get_message(s, (0x126|0x1000),
     (0x127|0x1000), -1, s->max_cert_list, &ok);
 ...
 if (ssl_version != s->version) {
  ERR_put_error(20,(251),(266),"../ssl/d1_clnt.c",634);
...
{
 X509 *x509 = 
# 664 "../ssl/d1_clnt.c" 3 4
             ((void *)0)
# 664 "../ssl/d1_clnt.c"
                 ;
 EVP_PKEY *pkey = 
# 665 "../ssl/d1_clnt.c" 3 4
                 ((void *)0)
# 665 "../ssl/d1_clnt.c"
                     ;
 int i;
...
# 689 "../ssl/d1_clnt.c"
   ...
   i = 0;
   ERR_put_error(20,(261),(106),"../ssl/d1_clnt.c",697)
                                           ;
  }
