...
struct stack_st_EVP_PKEY_ASN1_METHOD { _STACK stack; };
static struct stack_st_EVP_PKEY_ASN1_METHOD *app_methods = 
# 115 "asn1/ameth_lib.c" 3 4
                                                    ((void *)0)
# 115 "asn1/ameth_lib.c"
                                                        ;

static int ameth_cmp_BSEARCH_CMP_FN(const void *, const void *); static int ameth_cmp(const EVP_PKEY_ASN1_METHOD * const *, const EVP_PKEY_ASN1_METHOD * const *); static const EVP_PKEY_ASN1_METHOD * * OBJ_bsearch_ameth(const EVP_PKEY_ASN1_METHOD * *key, const EVP_PKEY_ASN1_METHOD * const *base, int num)
                                        ;
...
static int ameth_cmp_BSEARCH_CMP_FN(const void *a_, const void *b_) { const EVP_PKEY_ASN1_METHOD * const *a = a_; const EVP_PKEY_ASN1_METHOD * const *b = b_; return ameth_cmp(a,b); } static const EVP_PKEY_ASN1_METHOD * *OBJ_bsearch_ameth(const EVP_PKEY_ASN1_METHOD * *key, const EVP_PKEY_ASN1_METHOD * const *base, int num) { return (const EVP_PKEY_ASN1_METHOD * *)OBJ_bsearch_(key, base, num, sizeof(const EVP_PKEY_ASN1_METHOD *), ameth_cmp_BSEARCH_CMP_FN); } extern void dummy_prototype(void)
                                        ;
...
EVP_PKEY_asn1_get_count(void)
{
 ...
 if (app_methods)
  num += sk_num(((_STACK*) (1 ? (app_methods) : (struct stack_st_EVP_PKEY_ASN1_METHOD*)0)));
 return num;
}
...
EVP_PKEY_asn1_get0(int idx)
{
 ...
 if (idx < 0)
  return 
# 150 "asn1/ameth_lib.c" 3 4
        ((void *)0)
# 150 "asn1/ameth_lib.c"
            ;
 if (idx < num)
  return standard_methods[idx];
 idx -= num;
 return ((EVP_PKEY_ASN1_METHOD *)sk_value(((_STACK*) (1 ? (app_methods) : (struct stack_st_EVP_PKEY_ASN1_METHOD*)0)), (idx)));
}
...
pkey_asn1_find(int type)
{
 ...
 if (app_methods) {
  int idx;
  idx = sk_find(((_STACK*) (1 ? (app_methods) : (struct stack_st_EVP_PKEY_ASN1_METHOD*)0)), ((void*) (1 ? (&tmp) : (EVP_PKEY_ASN1_METHOD*)0)));
  if (idx >= 0)
   return ((EVP_PKEY_ASN1_METHOD *)sk_value(((_STACK*) (1 ? (app_methods) : (struct stack_st_EVP_PKEY_ASN1_METHOD*)0)), (idx)));
 }
 ...
 if (!ret || !*ret)
  return 
# 172 "asn1/ameth_lib.c" 3 4
        ((void *)0)
# 172 "asn1/ameth_lib.c"
            ;
 return *ret;
}
...
EVP_PKEY_asn1_find(ENGINE **pe, int type)
{
  ...
  *pe = 
# 203 "asn1/ameth_lib.c" 3 4
       ((void *)0)
# 203 "asn1/ameth_lib.c"
           ;
 }
 return t;
}
...
EVP_PKEY_asn1_find_str(ENGINE **pe, const char *str, int len)
{
 ...
 if (pe) {
  ...
  if (ameth) {
   ...
   if (!ENGINE_init(e))
    ameth = 
# 224 "asn1/ameth_lib.c" 3 4
           ((void *)0)
# 224 "asn1/ameth_lib.c"
               ;
   ENGINE_free(e);
   *pe = e;
   return ameth;
  ...
  *pe = 
# 230 "asn1/ameth_lib.c" 3 4
       ((void *)0)
# 230 "asn1/ameth_lib.c"
           ;
 }
 ...
 return 
# 240 "asn1/ameth_lib.c" 3 4
       ((void *)0)
# 240 "asn1/ameth_lib.c"
           ;
}
...
{
 if (app_methods == 
# 246 "asn1/ameth_lib.c" 3 4
                   ((void *)0)
# 246 "asn1/ameth_lib.c"
                       ) {
  app_methods = ((struct stack_st_EVP_PKEY_ASN1_METHOD *)sk_new(((int (*)(const void *, const void *)) ((1 ? (ameth_cmp) : (int (*)(const EVP_PKEY_ASN1_METHOD * const *, const EVP_PKEY_ASN1_METHOD * const *))0)))));
  if (!app_methods)
   return 0;
 }
 if (!sk_push(((_STACK*) (1 ? (app_methods) : (struct stack_st_EVP_PKEY_ASN1_METHOD*)0)), ((void*) (1 ? (ameth) : (EVP_PKEY_ASN1_METHOD*)0))))
  return 0;
 sk_sort(((_STACK*) (1 ? (app_methods) : (struct stack_st_EVP_PKEY_ASN1_METHOD*)0)));
 return 1;
}
...
EVP_PKEY_asn1_add_alias(int to, int from)
{
 ...
 ameth = EVP_PKEY_asn1_new(from, 0x1, 
# 262 "asn1/ameth_lib.c" 3 4
                                                 ((void *)0)
# 262 "asn1/ameth_lib.c"
                                                     , 
# 262 "asn1/ameth_lib.c" 3 4
                                                       ((void *)0)
# 262 "asn1/ameth_lib.c"
...
EVP_PKEY_asn1_new(int id, int flags, const char *pem_str, const char *info)
{
 ...
 if (!ameth)
  return 
# 306 "asn1/ameth_lib.c" 3 4
        ((void *)0)
# 306 "asn1/ameth_lib.c"
            ;

 ameth->pkey_id = id;
 ameth->pkey_base_id = id;
 ameth->pkey_flags = flags | 0x2;
 ...
 if (info) {
  ...
  ameth->info = 
# 317 "asn1/ameth_lib.c" 3 4
               ((void *)0)
# 317 "asn1/ameth_lib.c"
                   ;
 ...
 if (pem_str) {
  ...
  ameth->pem_str = 
# 324 "asn1/ameth_lib.c" 3 4
                  ((void *)0)
# 324 "asn1/ameth_lib.c"
                      ;
...
err:
 EVP_PKEY_asn1_free(ameth);
 return 
# 358 "asn1/ameth_lib.c" 3 4
       ((void *)0)
# 358 "asn1/ameth_lib.c"
           ;
}
