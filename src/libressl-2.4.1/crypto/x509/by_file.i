...
static X509_LOOKUP_METHOD x509_file_lookup = {
 ...
 .new_item = 
# 75 "x509/by_file.c" 3 4
            ((void *)0)
# 75 "x509/by_file.c"
                ,
 .free = 
# 76 "x509/by_file.c" 3 4
        ((void *)0)
# 76 "x509/by_file.c"
            ,
 .init = 
# 77 "x509/by_file.c" 3 4
        ((void *)0)
# 77 "x509/by_file.c"
            ,
 .shutdown = 
# 78 "x509/by_file.c" 3 4
            ((void *)0)
# 78 "x509/by_file.c"
                ,
 .ctrl = by_file_ctrl,
 .get_by_subject = 
# 80 "x509/by_file.c" 3 4
                  ((void *)0)
# 80 "x509/by_file.c"
                      ,
 .get_by_issuer_serial = 
# 81 "x509/by_file.c" 3 4
                        ((void *)0)
# 81 "x509/by_file.c"
                            ,
 .get_by_fingerprint = 
# 82 "x509/by_file.c" 3 4
                      ((void *)0)
# 82 "x509/by_file.c"
                          ,
 .get_by_alias = 
# 83 "x509/by_file.c" 3 4
                ((void *)0)
# 83 "x509/by_file.c"
                    ,
};
 ...
 case 1:
  if (argl == 3) {
   ok = (X509_load_cert_crl_file(ctx,
       ...
       1) != 0);
   if (!ok) {
    ERR_put_error(11,(101),(104),"x509/by_file.c",106)
                                ;
   }
  } else {
   if (argl == 1)
...
X509_load_cert_file(X509_LOOKUP *ctx, const char *file, int type)
{
 int ret = 0;
 BIO *in = 
# 125 "x509/by_file.c" 3 4
          ((void *)0)
# 125 "x509/by_file.c"
              ;
 int i, count = 0;
 X509 *x = 
# 127 "x509/by_file.c" 3 4
          ((void *)0)
# 127 "x509/by_file.c"
              ;

 if (file == 
# 129 "x509/by_file.c" 3 4
            ((void *)0)
# 129 "x509/by_file.c"
                )
  return (1);
 ...
 if ((in == 
# 133 "x509/by_file.c" 3 4
           ((void *)0)
# 133 "x509/by_file.c"
               ) || (BIO_ctrl(in,108, 0x01|0x02,(char *)file) <= 0)) {
  ERR_put_error(11,(111),(2),"x509/by_file.c",134);
  goto err;
 }
...
# 140 "x509/by_file.c"
   ...
   if (x == 
# 141 "x509/by_file.c" 3 4
           ((void *)0)
# 141 "x509/by_file.c"
               ) {
    if (((int)((ERR_peek_last_error())&0xfffL) ==
        108) && (count > 0)) {
     ERR_clear_error();
     break;
    } else {
     ERR_put_error(11,(111),(9),"x509/by_file.c",148)
                       ;
     goto err;
    }
   }
...
# 157 "x509/by_file.c"
  ...
  x = d2i_X509_bio(in, 
# 161 "x509/by_file.c" 3 4
                      ((void *)0)
# 161 "x509/by_file.c"
                          );
  if (x == 
# 162 "x509/by_file.c" 3 4
          ((void *)0)
# 162 "x509/by_file.c"
              ) {
   ERR_put_error(11,(111),(13),"x509/by_file.c",163);
   goto err;
  }
  i = X509_STORE_add_cert(ctx->store_ctx, x);
  if (!i)
  ...
  ERR_put_error(11,(111),(100),"x509/by_file.c",171);
  goto err;
 }
err:
 X509_free(x);
...
X509_load_crl_file(X509_LOOKUP *ctx, const char *file, int type)
{
 int ret = 0;
 BIO *in = 
# 184 "x509/by_file.c" 3 4
          ((void *)0)
# 184 "x509/by_file.c"
              ;
 int i, count = 0;
 X509_CRL *x = 
# 186 "x509/by_file.c" 3 4
              ((void *)0)
# 186 "x509/by_file.c"
                  ;

 if (file == 
# 188 "x509/by_file.c" 3 4
            ((void *)0)
# 188 "x509/by_file.c"
                )
  return (1);
 ...
 if ((in == 
# 192 "x509/by_file.c" 3 4
           ((void *)0)
# 192 "x509/by_file.c"
               ) || (BIO_ctrl(in,108, 0x01|0x02,(char *)file) <= 0)) {
  ERR_put_error(11,(112),(2),"x509/by_file.c",193);
  goto err;
 }

 if (type == 1) {
  for (;;) {
   x = PEM_read_bio_X509_CRL(in, 
# 199 "x509/by_file.c" 3 4
                                ((void *)0)
# 199 "x509/by_file.c"
                                    , 
# 199 "x509/by_file.c" 3 4
...
# 200 "x509/by_file.c"
    ...
    if (((int)((ERR_peek_last_error())&0xfffL) ==
     ...
     ERR_put_error(11,(112),(9),"x509/by_file.c",207)
                       ;
     goto err;
    }
   }
...
# 216 "x509/by_file.c"
  ...
  x = d2i_X509_CRL_bio(in, 
# 220 "x509/by_file.c" 3 4
                          ((void *)0)
# 220 "x509/by_file.c"
                              );
  if (x == 
# 221 "x509/by_file.c" 3 4
          ((void *)0)
# 221 "x509/by_file.c"
              ) {
   ERR_put_error(11,(112),(13),"x509/by_file.c",222);
   goto err;
  }
  i = X509_STORE_add_crl(ctx->store_ctx, x);
  if (!i)
  ...
  ERR_put_error(11,(112),(100),"x509/by_file.c",230);
  goto err;
 }
err:
 if (x != 
# 234 "x509/by_file.c" 3 4
         ((void *)0)
# 234 "x509/by_file.c"
             )
  X509_CRL_free(x);
...
X509_load_cert_crl_file(X509_LOOKUP *ctx, const char *file, int type)
{
 ...
 if (!in) {
  ERR_put_error(11,(132),(2),"x509/by_file.c",251);
  return 0;
 }
 inf = PEM_X509_INFO_read_bio(in, 
# 254 "x509/by_file.c" 3 4
                                 ((void *)0)
# 254 "x509/by_file.c"
                                     , 
# 254 "x509/by_file.c" 3 4
...
# 254 "x509/by_file.c"
 ...
 BIO_free(in);
 if (!inf) {
  ERR_put_error(11,(132),(9),"x509/by_file.c",257);
  return 0;
 }
 for (i = 0; i < sk_num(((_STACK*) (1 ? (inf) : (struct stack_st_X509_INFO*)0))); i++) {
  itmp = ((X509_INFO *)sk_value(((_STACK*) (1 ? (inf) : (struct stack_st_X509_INFO*)0)), (i)));
  if (itmp->x509) {
 ...
 sk_pop_free(((_STACK*) (1 ? (inf) : (struct stack_st_X509_INFO*)0)), ((void (*)(void *)) ((1 ? (X509_INFO_free) : (void (*)(X509_INFO *))0))));
 return count;
}
