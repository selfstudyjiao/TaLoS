...
sig_cb(int operation, ASN1_VALUE **pval, const ASN1_ITEM *it, void *exarg)
{
 if (operation == 0) {
  ...
  if (!sig) {
   ERR_put_error(10,(114),((1|64)),"dsa/dsa_asn1.c",76);
   return 0;
  }
  sig->r = 
# 79 "dsa/dsa_asn1.c" 3 4
          ((void *)0)
# 79 "dsa/dsa_asn1.c"
              ;
  sig->s = 
# 80 "dsa/dsa_asn1.c" 3 4
          ((void *)0)
# 80 "dsa/dsa_asn1.c"
              ;
  *pval = (ASN1_VALUE *)sig;
...
# 417 "dsa/dsa_asn1.c"
 ...
 s = DSA_SIG_new();
 if (s == 
# 423 "dsa/dsa_asn1.c" 3 4
         ((void *)0)
# 423 "dsa/dsa_asn1.c"
             )
  return ret;
 if (d2i_DSA_SIG(&s, &p, siglen) == 
# 425 "dsa/dsa_asn1.c" 3 4
                                   ((void *)0)
# 425 "dsa/dsa_asn1.c"
                                       )
  goto err;
