...
EVP_PKEY_copy_parameters(EVP_PKEY *to, const EVP_PKEY *from)
{
 if (to->type != from->type) {
  ERR_put_error(6,(103),(101),"evp/p_lib.c",136)
                                ;
  goto err;
 }

 if (EVP_PKEY_missing_parameters(from)) {
  ERR_put_error(6,(103),(103),"evp/p_lib.c",142)
                               ;
  goto err;
 }
...
# 198 "evp/p_lib.c"
  ...
  ERR_put_error(6,(106),((1|64)),"evp/p_lib.c",199);
  return (
# 200 "evp/p_lib.c" 3 4
         ((void *)0)
# 200 "evp/p_lib.c"
...
# 234 "evp/p_lib.c"
 ...
 if (!ameth) {
  ERR_put_error(6,(158),(156),"evp/p_lib.c",247);
  return 0;
 }
 if (pkey) {
  pkey->ameth = ameth;
...
{
 return pkey_set_type(pkey, type, 
# 263 "evp/p_lib.c" 3 4
                                 ((void *)0)
# 263 "evp/p_lib.c"
                                     , -1);
...
{
 return pkey_set_type(pkey, 0, str, len);
}
...
{
 int ret = EVP_PKEY_assign((pkey),6, (char *)(key));
 if (ret)
  RSA_up_ref(key);
 return ret;
}
...
{
 if (pkey->type != 6) {
  ERR_put_error(6,(121),(127),"evp/p_lib.c",301);
  return 
# 302 "evp/p_lib.c" 3 4
        ((void *)0)
# 302 "evp/p_lib.c"
...
{
 int ret = EVP_PKEY_assign((pkey),116, (char *)(key));
 if (ret)
  DSA_up_ref(key);
 return ret;
}
...
{
 if (pkey->type != 116) {
  ERR_put_error(6,(120),(129),"evp/p_lib.c",323);
  return 
# 324 "evp/p_lib.c" 3 4
        ((void *)0)
# 324 "evp/p_lib.c"
...
{
 int ret = EVP_PKEY_assign((pkey),408, (char *)(key));
 if (ret)
  EC_KEY_up_ref(key);
 return ret;
}
...
{
 if (pkey->type != 408) {
  ERR_put_error(6,(131),(142),"evp/p_lib.c",346);
  return 
# 347 "evp/p_lib.c" 3 4
        ((void *)0)
# 347 "evp/p_lib.c"
...
{
 int ret = EVP_PKEY_assign((pkey),28, (char *)(key));
 if (ret)
  DH_up_ref(key);
 return ret;
}
...
{
 if (pkey->type != 28) {
  ERR_put_error(6,(119),(128),"evp/p_lib.c",370);
  return 
# 371 "evp/p_lib.c" 3 4
        ((void *)0)
# 371 "evp/p_lib.c"
...
# 423 "evp/p_lib.c"
 ...
 i = CRYPTO_add_lock(&x->references,-1,10,"evp/p_lib.c",426);
 if (i > 0)
  return;

 EVP_PKEY_free_it(x);
 if (x->attributes)
  sk_pop_free(((_STACK*) (1 ? (x->attributes) : (struct stack_st_X509_ATTRIBUTE*)0)), ((void (*)(void *)) ((1 ? (X509_ATTRIBUTE_free) : (void (*)(X509_ATTRIBUTE *))0))));
 free(x);
}
...
EVP_PKEY_get_default_digest_nid(EVP_PKEY *pkey, int *pnid)
{
 if (!pkey->ameth || !pkey->ameth->pkey_ctrl)
  return -2;
 return pkey->ameth->pkey_ctrl(pkey, 0x3,
     0, pnid);
}
