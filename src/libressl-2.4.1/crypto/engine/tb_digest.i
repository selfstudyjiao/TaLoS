...
static ENGINE_TABLE *digest_table = 
# 65 "engine/tb_digest.c" 3 4
                                   ((void *)0)
# 65 "engine/tb_digest.c"
                                       ;
...
ENGINE_register_digests(ENGINE *e)
{
 if (e->digests) {
  const int *nids;
  int num_nids = e->digests(e, 
# 84 "engine/tb_digest.c" 3 4
                              ((void *)0)
# 84 "engine/tb_digest.c"
                                  , &nids, 0);
  if (num_nids > 0)
...
ENGINE_set_default_digests(ENGINE *e)
{
 if (e->digests) {
  const int *nids;
  int num_nids = e->digests(e, 
# 107 "engine/tb_digest.c" 3 4
                              ((void *)0)
# 107 "engine/tb_digest.c"
                                  , &nids, 0);
  if (num_nids > 0)
   return engine_table_register(&digest_table,
       engine_unregister_all_digests, e, nids,
...
ENGINE_get_digest(ENGINE *e, int nid)
{
 ...
 if (!fn || !fn(e, &ret, 
# 132 "engine/tb_digest.c" 3 4
                        ((void *)0)
# 132 "engine/tb_digest.c"
                            , nid)) {
  ERR_put_error(38,(186),(147),"engine/tb_digest.c",134)
                                    ;
  return 
# 135 "engine/tb_digest.c" 3 4
        ((void *)0)
# 135 "engine/tb_digest.c"
            ;
 }
 return ret;
}
