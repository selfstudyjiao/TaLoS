...
pqueue_find(pqueue_s *pq, unsigned char *prio64be)
{
 ...
 for (next = pq->items; next != 
# 161 "../ssl/pqueue.c" 3 4
                               ((void *)0)
# 161 "../ssl/pqueue.c"
                                   ; next = next->next)
