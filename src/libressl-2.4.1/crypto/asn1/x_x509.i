...
# 181 "asn1/x_x509.c"
  ...
  ret->ex_pathlen = -1;
  ret->skid = 
# 184 "asn1/x_x509.c" 3 4
             ((void *)0)
# 184 "asn1/x_x509.c"
                 ;
  ret->akid = 
# 185 "asn1/x_x509.c" 3 4
             ((void *)0)
# 185 "asn1/x_x509.c"
                 ;
  ret->aux = 
# 186 "asn1/x_x509.c" 3 4
            ((void *)0)
# 186 "asn1/x_x509.c"
                ;
  ret->crldp = 
# 187 "asn1/x_x509.c" 3 4
              ((void *)0)
# 187 "asn1/x_x509.c"
                  ;
  CRYPTO_new_ex_data(10, ret, &ret->ex_data);
  break;

 case 5:
  free(ret->name);
  ret->name = X509_NAME_oneline(ret->cert_info->subject, 
# 193 "asn1/x_x509.c" 3 4
                                                        ((void *)0)
# 193 "asn1/x_x509.c"
                                                            , 0);
  break;
 ...
 case 3:
  CRYPTO_free_ex_data(10, ret, &ret->ex_data);
...
static const ASN1_AUX X509_aux = {
 .app_data = 
# 214 "asn1/x_x509.c" 3 4
            ((void *)0)
# 214 "asn1/x_x509.c"
                ,
 .flags = 1,
 .ref_offset = 
# 216 "asn1/x_x509.c" 3 4
              __builtin_offsetof (
# 216 "asn1/x_x509.c"
              X509
# 216 "asn1/x_x509.c" 3 4
...
X509_get_ex_new_index(long argl, void *argp, CRYPTO_EX_new *new_func,
    CRYPTO_EX_dup *dup_func, CRYPTO_EX_free *free_func)
{
 return CRYPTO_get_ex_new_index(10, argl, argp,
