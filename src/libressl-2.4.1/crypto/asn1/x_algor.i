...
X509_ALGOR_set0(X509_ALGOR *alg, ASN1_OBJECT *aobj, int ptype, void *pval)
{
 ...
 if (ptype != -1) {
  if (alg->parameter == 
# 156 "asn1/x_algor.c" 3 4
                       ((void *)0)
# 156 "asn1/x_algor.c"
                           )
   alg->parameter = ASN1_TYPE_new();
  if (alg->parameter == 
# 158 "asn1/x_algor.c" 3 4
                       ((void *)0)
# 158 "asn1/x_algor.c"
                           )
   return 0;
...
X509_ALGOR_set_md(X509_ALGOR *alg, const EVP_MD *md)
{
 ...
 X509_ALGOR_set0(alg, OBJ_nid2obj(EVP_MD_type(md)), param_type, 
# 207 "asn1/x_algor.c" 3 4
                                                               ((void *)0)
# 207 "asn1/x_algor.c"
                                                                   );
}
