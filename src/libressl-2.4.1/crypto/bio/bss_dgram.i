...
BIO_new_dgram(int fd, int close_flag)
{
 ...
 if (ret == 
# 126 "bio/bss_dgram.c" 3 4
           ((void *)0)
# 126 "bio/bss_dgram.c"
               )
  return (
# 127 "bio/bss_dgram.c" 3 4
         ((void *)0)
# 127 "bio/bss_dgram.c"
             );
...
dgram_read(BIO *b, char *out, int outl)
{
 ...
 if (out != 
# 264 "bio/bss_dgram.c" 3 4
           ((void *)0)
# 264 "bio/bss_dgram.c"
               ) {
  
# 265 "bio/bss_dgram.c" 3 4
 (*__errno_location ()) 
# 265 "bio/bss_dgram.c"
       = 0;
...
# 291 "bio/bss_dgram.c"
 ...
 if (data->connected)
  ...
  if (data->peer.sa.sa_family == 
# 298 "bio/bss_dgram.c" 3 4
                                2
# 298 "bio/bss_dgram.c"
                                       )
   peerlen = sizeof(data->peer.sa_in);
  else if (data->peer.sa.sa_family == 
# 300 "bio/bss_dgram.c" 3 4
                                     10
# 300 "bio/bss_dgram.c"
                                             )
...
dgram_ctrl(BIO *b, int cmd, long num, void *ptr)
{
 ...
 int *ip;
 struct sockaddr *to = 
# 324 "bio/bss_dgram.c" 3 4
                      ((void *)0)
# 324 "bio/bss_dgram.c"
                          ;
 bio_dgram_data *data = 
# 325 "bio/bss_dgram.c" 3 4
                       ((void *)0)
# 325 "bio/bss_dgram.c"
                           ;
...
# 385 "bio/bss_dgram.c"
 ...
 case 39:
  ...
  case 
# 403 "bio/bss_dgram.c" 3 4
      2
# 403 "bio/bss_dgram.c"
             :
   sockopt_val = 
# 404 "bio/bss_dgram.c" 3 4
                2
# 404 "bio/bss_dgram.c"
                              ;
   ret = setsockopt(b->num, 
# 405 "bio/bss_dgram.c" 3 4
                           IPPROTO_IP
# 405 "bio/bss_dgram.c"
                                     , 
# 405 "bio/bss_dgram.c" 3 4
...
# 405 "bio/bss_dgram.c"
  ...
  case 
# 411 "bio/bss_dgram.c" 3 4
      10
# 411 "bio/bss_dgram.c"
              :
   sockopt_val = 
# 412 "bio/bss_dgram.c" 3 4
                2
# 412 "bio/bss_dgram.c"
                                ;
   ret = setsockopt(b->num, 
# 413 "bio/bss_dgram.c" 3 4
                           IPPROTO_IPV6
# 413 "bio/bss_dgram.c"
                                       ,
       
# 414 "bio/bss_dgram.c" 3 4
      23
# 414 "bio/bss_dgram.c"
                       , &sockopt_val,
       sizeof(sockopt_val));
 ...
 case 40:
  ...
  switch (addr.sa.sa_family) {
  case 
# 438 "bio/bss_dgram.c" 3 4
      2
# 438 "bio/bss_dgram.c"
             :
   ret = getsockopt(b->num, 
# 439 "bio/bss_dgram.c" 3 4
                           IPPROTO_IP
# 439 "bio/bss_dgram.c"
                                     , 
# 439 "bio/bss_dgram.c" 3 4
...
# 439 "bio/bss_dgram.c"
  ...
  case 
# 452 "bio/bss_dgram.c" 3 4
      10
# 452 "bio/bss_dgram.c"
              :
   ret = getsockopt(b->num, 
# 453 "bio/bss_dgram.c" 3 4
                           IPPROTO_IPV6
# 453 "bio/bss_dgram.c"
                                       , 
# 453 "bio/bss_dgram.c" 3 4
...
# 476 "bio/bss_dgram.c"
   ...
   break;
  case 
# 479 "bio/bss_dgram.c" 3 4
      10
# 479 "bio/bss_dgram.c"
              :

   if (
# 481 "bio/bss_dgram.c" 3 4
      (__extension__ ({ const struct in6_addr *__a = (const struct in6_addr *) (
# 481 "bio/bss_dgram.c"
      &data->peer.sa_in6.sin6_addr
# 481 "bio/bss_dgram.c" 3 4
      ); __a->__in6_u.__u6_addr32[0] == 0 && __a->__in6_u.__u6_addr32[1] == 0 && __a->__in6_u.__u6_addr32[2] == __bswap_32 (0xffff); }))
# 481 "bio/bss_dgram.c"
                                                        )
    ret = 576 - 20 - 8;
   else
...
BIO_dgram_non_fatal_error(int err)
{
 switch (err) {
 case 
# 645 "bio/bss_dgram.c" 3 4
     4
# 645 "bio/bss_dgram.c"
          :
 case 
# 646 "bio/bss_dgram.c" 3 4
     11
# 646 "bio/bss_dgram.c"
           :
 case 
# 647 "bio/bss_dgram.c" 3 4
     115
# 647 "bio/bss_dgram.c"
                :
 case 
# 648 "bio/bss_dgram.c" 3 4
     114
# 648 "bio/bss_dgram.c"
             :
  return (1);
