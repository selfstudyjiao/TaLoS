...
int SHA384_Init(SHA512_CTX *c)
 {
 c->h[0]=0xcbbb9d5dc1059ed8UL;
 c->h[1]=0x629a292a367cd507UL;
 c->h[2]=0x9159015a3070dd17UL;
 c->h[3]=0x152fecd8f70e5939UL;
 c->h[4]=0x67332667ffc00b31UL;
 c->h[5]=0x8eb44a8768581511UL;
 c->h[6]=0xdb0c2e0d64f98fa7UL;
 c->h[7]=0x47b5481dbefa4fa4UL;
...
int SHA512_Init(SHA512_CTX *c)
 {
 c->h[0]=0x6a09e667f3bcc908UL;
 c->h[1]=0xbb67ae8584caa73bUL;
 c->h[2]=0x3c6ef372fe94f82bUL;
 c->h[3]=0xa54ff53a5f1d36f1UL;
 c->h[4]=0x510e527fade682d1UL;
 c->h[5]=0x9b05688c2b3e6c1fUL;
 c->h[6]=0x1f83d9abfb41bd6bUL;
 c->h[7]=0x5be0cd19137e2179UL;
...
int SHA512_Update (SHA512_CTX *c, const void *_data, size_t len)
 ...
 l = (c->Nl+(((unsigned long)len)<<3))&0xffffffffffffffffUL;
 if (l < c->Nl) c->Nh++;
 if (sizeof(len)>=8) c->Nh+=(((unsigned long)len)>>61);
 c->Nl=l;
