...
{
 return memchr(cbs->data, 0, cbs->len) != 
# 129 "../ssl/bs_cbs.c" 3 4
                                         ((void *)0)
# 129 "../ssl/bs_cbs.c"
                                             ;
}
...
# 357 "../ssl/bs_cbs.c"
 "0"
# 357 "../ssl/bs_cbs.c" 3 4
 , "../ssl/bs_cbs.c", 357, __PRETTY_FUNCTION__))
# 357 "../ssl/bs_cbs.c"
          ;
  return 0;
 }
...
{
 return cbs_get_asn1(cbs, out, tag_value, 0 );
}
...
CBS_get_asn1_uint64(CBS *cbs, uint64_t *out)
{
 ...
 if (!CBS_get_asn1(cbs, &bytes, (0x00 | 0x00 | 0x2)))
  return 0;
    ...
    unsigned int tag)
{
 ...
 if (present) {
  if (!CBS_get_asn1(&child, out, (0x00 | 0x00 | 0x4)) ||
      CBS_len(&child) != 0)
   return 0;
 } else {
  CBS_init(out, 
# 460 "../ssl/bs_cbs.c" 3 4
               ((void *)0)
# 460 "../ssl/bs_cbs.c"
                   , 0);
 }
    ...
    int default_value)
{
 ...
 if (present) {
  ...
  if (!CBS_get_asn1(&child, &child2, (0x00 | 0x00 | 0x1)) ||
