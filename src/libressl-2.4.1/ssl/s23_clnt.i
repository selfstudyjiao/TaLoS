...
# 131 "../ssl/s23_clnt.c" 3 4
(*__errno_location ()) 
# 131 "../ssl/s23_clnt.c"
      = 0;

 if (s->info_callback != 
# 133 "../ssl/s23_clnt.c" 3 4
                        ((void *)0)
# 133 "../ssl/s23_clnt.c"
                            )
  cb = s->info_callback;
 else if (s->ctx->info_callback != 
# 135 "../ssl/s23_clnt.c" 3 4
                                  ((void *)0)
# 135 "../ssl/s23_clnt.c"
                                      )
 ...
 for (;;) {
  ...
  case 0x03|0x1000:
   ...
   if (s->session != 
# 151 "../ssl/s23_clnt.c" 3 4
                    ((void *)0)
# 151 "../ssl/s23_clnt.c"
                        ) {
    ERR_put_error(20,(117),(221),"../ssl/s23_clnt.c",152);
    ret = -1;
    goto end;
   }
   s->server = 0;
   if (cb != 
# 157 "../ssl/s23_clnt.c" 3 4
            ((void *)0)
# 157 "../ssl/s23_clnt.c"
                )
    cb(s, 0x10, 1);
...
# 197 "../ssl/s23_clnt.c"
  ...
  default:
   ERR_put_error(20,(117),(255),"../ssl/s23_clnt.c",202);
   ret = -1;
   goto end;
...
# 247 "../ssl/s23_clnt.c"
 mask = 0x10000000L|0x04000000L;
 version = 0x0303;

 if ((options & 0x08000000L) && (options & mask) != mask)
  version = 0x0302;
 mask &= ~0x10000000L;
 if ((options & 0x10000000L) && (options & mask) != mask)
  version = 0x0301;
 mask &= ~0x04000000L;
 ...
 if (s->state == (0x210|0x1000)) {
  ...
  if (version == 0x0303) {
   ...
   ERR_put_error(20,(116),(191),"../ssl/s23_clnt.c",272)
                                    ;
   return (-1);
  }
  ...
  *(p++) = 0;
  ...
  if (i == 0) {
   ERR_put_error(20,(116),(181),"../ssl/s23_clnt.c",300)
                                  ;
   return -1;
  }
  ...
  *(p++) = 0;
  ...
  if ((p = ssl_add_clienthello_tlsext(s, p,
      buf + 16384)) == 
# 313 "../ssl/s23_clnt.c" 3 4
                                         ((void *)0)
# 313 "../ssl/s23_clnt.c"
                                             ) {
   ERR_put_error(20,(116),((4|64)),"../ssl/s23_clnt.c",314);
   return -1;
  }
  ...
  d = &(buf[5]);
  *(d++) = 1;
  ((d[0]=(unsigned char)(((l)>>16)&0xff), d[1]=(unsigned char)(((l)>> 8)&0xff), d[2]=(unsigned char)(((l) )&0xff)),d+=3);

  l += 4;

  if (l > 16384) {
   ERR_put_error(20,(116),((4|64)),"../ssl/s23_clnt.c",328);
   return -1;
  }
  ...
  *(d++) = version_major;
  ...
  if (((s->client_version >> 8) == 0x03 ? s->client_version : 0) > 0x0301)
   *(d++) = 1;
  else
   *(d++) = version_minor;
  ((d[0]=(unsigned char)((((int)l)>> 8)&0xff), d[1]=(unsigned char)((((int)l) )&0xff)),d+=2);


  s->init_num = p - buf;
  s->init_off = 0;

  tls1_finish_mac(s, &(buf[5]),
      s->init_num - 5);

  s->state = (0x211|0x1000);
  s->init_off = 0;
 }
...
ssl23_get_server_hello(SSL *s)
{
 ...
 if ((p[0] & 0x80) && (p[2] == 4) &&
     (p[5] == 0x00) && (p[6] == 0x02)) {
  ERR_put_error(20,(119),(258),"../ssl/s23_clnt.c",391)
                                 ;
  goto err;
 }
 ...
 if (p[1] == 0x03 &&
  ...
  if ((p[2] == 0x01) &&
      !(s->options & 0x04000000L)) {
   s->version = 0x0301;
   s->method = TLSv1_client_method();
  } else if ((p[2] == 0x02) &&
      !(s->options & 0x10000000L)) {
   s->version = 0x0302;
   s->method = TLSv1_1_client_method();
  } else if ((p[2] == 0x03) &&
      !(s->options & 0x08000000L)) {
   s->version = 0x0303;
   s->method = TLSv1_2_client_method();
  } else {
   ERR_put_error(20,(119),(258),"../ssl/s23_clnt.c",415)
                                  ;
   goto err;
  }
...
# 421 "../ssl/s23_clnt.c"
   ...
   if (s->info_callback != 
# 424 "../ssl/s23_clnt.c" 3 4
                          ((void *)0)
# 424 "../ssl/s23_clnt.c"
                              )
    cb = s->info_callback;
   else if (s->ctx->info_callback != 
# 426 "../ssl/s23_clnt.c" 3 4
                                    ((void *)0)
# 426 "../ssl/s23_clnt.c"
                                        )
    cb = s->ctx->info_callback;
...
# 430 "../ssl/s23_clnt.c"
   ...
   s->rwstate = 1;
   ERR_put_error(20,(119),(1000 + p[6]),"../ssl/s23_clnt.c",441)
                                   ;
   goto err;
  }
...
# 455 "../ssl/s23_clnt.c"
  ...
  ERR_put_error(20,(119),(252),"../ssl/s23_clnt.c",465);
  goto err;
 }
 s->init_num = 0;
