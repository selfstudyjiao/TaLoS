...
# 84 "dsa/dsa_ameth.c" 3 4
                           ((void *)0)
# 84 "dsa/dsa_ameth.c"
                               ;

 DSA *dsa = 
# 86 "dsa/dsa_ameth.c" 3 4
           ((void *)0)
# 86 "dsa/dsa_ameth.c"
               ;

 if (!X509_PUBKEY_get0_param(
# 88 "dsa/dsa_ameth.c" 3 4
                            ((void *)0)
# 88 "dsa/dsa_ameth.c"
                                , &p, &pklen, &palg, pubkey))
  return 0;
 X509_ALGOR_get0(
# 90 "dsa/dsa_ameth.c" 3 4
                ((void *)0)
# 90 "dsa/dsa_ameth.c"
                    , &ptype, &pval, palg);
 ...
 if (ptype == 16) {
  ...
  if (!(dsa = d2i_DSAparams(
# 97 "dsa/dsa_ameth.c" 3 4
                           ((void *)0)
# 97 "dsa/dsa_ameth.c"
                               , &pm, pmlen))) {
   ERR_put_error(10,(117),(104),"dsa/dsa_ameth.c",98);
   goto err;
  }
 } else if (ptype == 5 || ptype == -1) {
  if (!(dsa = DSA_new())) {
   ERR_put_error(10,(117),((1|64)),"dsa/dsa_ameth.c",103);
   goto err;
   }
 } else {
  ERR_put_error(10,(117),(105),"dsa/dsa_ameth.c",107);
  goto err;
 }

 if (!(public_key=d2i_ASN1_INTEGER(
# 111 "dsa/dsa_ameth.c" 3 4
                                  ((void *)0)
# 111 "dsa/dsa_ameth.c"
                                      , &p, pklen))) {
  ERR_put_error(10,(117),(104),"dsa/dsa_ameth.c",112);
  goto err;
 }

 if (!(dsa->pub_key = ASN1_INTEGER_to_BN(public_key, 
# 116 "dsa/dsa_ameth.c" 3 4
                                                    ((void *)0)
# 116 "dsa/dsa_ameth.c"
                                                        ))) {
  ERR_put_error(10,(117),(108),"dsa/dsa_ameth.c",117);
  goto err;
 }

 ASN1_INTEGER_free(public_key);
 EVP_PKEY_assign((pkey),116, (char *)(dsa));
 return 1;
...
dsa_pub_encode(X509_PUBKEY *pk, const EVP_PKEY *pkey)
{
 DSA *dsa;
 void *pval = 
# 136 "dsa/dsa_ameth.c" 3 4
             ((void *)0)
# 136 "dsa/dsa_ameth.c"
                 ;
 int ptype;
 unsigned char *penc = 
# 138 "dsa/dsa_ameth.c" 3 4
                      ((void *)0)
# 138 "dsa/dsa_ameth.c"
                          ;
 int penclen;
 ...
 if (pkey->save_parameters && dsa->p && dsa->q && dsa->g) {
  ...
  str = ASN1_STRING_new();
  if (str == 
# 146 "dsa/dsa_ameth.c" 3 4
            ((void *)0)
# 146 "dsa/dsa_ameth.c"
                ) {
   ERR_put_error(10,(118),((1|64)),"dsa/dsa_ameth.c",147);
   goto err;
  }
  str->length = i2d_DSAparams(dsa, &str->data);
  if (str->length <= 0) {
   ERR_put_error(10,(118),((1|64)),"dsa/dsa_ameth.c",152);
 ...
 if (penclen <= 0) {
  ERR_put_error(10,(118),((1|64)),"dsa/dsa_ameth.c",166);
  goto err;
 }

 if (X509_PUBKEY_set0_param(pk, OBJ_nid2obj(116), ptype, pval,
     penc, penclen))
  return 1;
...
# 193 "dsa/dsa_ameth.c" 3 4
                        ((void *)0)
# 193 "dsa/dsa_ameth.c"
                            ;
 BN_CTX *ctx = 
# 194 "dsa/dsa_ameth.c" 3 4
              ((void *)0)
# 194 "dsa/dsa_ameth.c"
                  ;
 DSA *dsa = 
# 195 "dsa/dsa_ameth.c" 3 4
           ((void *)0)
# 195 "dsa/dsa_ameth.c"
               ;
 ...
 if (!PKCS8_pkey_get0(
# 199 "dsa/dsa_ameth.c" 3 4
                     ((void *)0)
# 199 "dsa/dsa_ameth.c"
                         , &p, &pklen, &palg, p8))
  return 0;
 X509_ALGOR_get0(
# 201 "dsa/dsa_ameth.c" 3 4
                ((void *)0)
# 201 "dsa/dsa_ameth.c"
                    , &ptype, &pval, palg);
 if (ptype != 16)
 ...
 if ((privkey = d2i_ASN1_INTEGER(
# 205 "dsa/dsa_ameth.c" 3 4
                                ((void *)0)
# 205 "dsa/dsa_ameth.c"
                                    , &p, pklen)) == 
# 205 "dsa/dsa_ameth.c" 3 4
...
# 205 "dsa/dsa_ameth.c"
 ...
 pmlen = pstr->length;
 if (!(dsa = d2i_DSAparams(
# 213 "dsa/dsa_ameth.c" 3 4
                          ((void *)0)
# 213 "dsa/dsa_ameth.c"
                              , &pm, pmlen)))
  goto decerr;

 if (!(dsa->priv_key = ASN1_INTEGER_to_BN(privkey, 
# 216 "dsa/dsa_ameth.c" 3 4
                                                  ((void *)0)
# 216 "dsa/dsa_ameth.c"
                                                      ))) {
  ERR_put_error(10,(115),(109),"dsa/dsa_ameth.c",217);
  goto dsaerr;
 }

 if (!(dsa->pub_key = BN_new())) {
  ERR_put_error(10,(115),((1|64)),"dsa/dsa_ameth.c",222);
  goto dsaerr;
 }
 if (!(ctx = BN_CTX_new())) {
  ERR_put_error(10,(115),((1|64)),"dsa/dsa_ameth.c",226);
  goto dsaerr;
 }

 if (!BN_mod_exp(dsa->pub_key, dsa->g, dsa->priv_key, dsa->p, ctx)) {
  ERR_put_error(10,(115),(109),"dsa/dsa_ameth.c",231);
  goto dsaerr;
 }

 if (!EVP_PKEY_assign((pkey),116, (char *)(dsa)))
  goto decerr;
...
decerr:
 ERR_put_error(10,(115),(104),"dsa/dsa_ameth.c",242);
dsaerr:
 DSA_free(dsa);
done:
 BN_CTX_free(ctx);
...
{
 ASN1_STRING *params = 
# 254 "dsa/dsa_ameth.c" 3 4
                      ((void *)0)
# 254 "dsa/dsa_ameth.c"
                          ;
 ASN1_INTEGER *prkey = 
# 255 "dsa/dsa_ameth.c" 3 4
                      ((void *)0)
# 255 "dsa/dsa_ameth.c"
                          ;
 unsigned char *dp = 
# 256 "dsa/dsa_ameth.c" 3 4
                    ((void *)0)
# 256 "dsa/dsa_ameth.c"
                        ;
 int dplen;
 ...
 if (!params) {
  ERR_put_error(10,(116),((1|64)),"dsa/dsa_ameth.c",261);
  goto err;
 }

 params->length = i2d_DSAparams(pkey->pkey.dsa, &params->data);
 if (params->length <= 0) {
  ERR_put_error(10,(116),((1|64)),"dsa/dsa_ameth.c",267);
  goto err;
 }
 params->type = 16;


 prkey = BN_to_ASN1_INTEGER(pkey->pkey.dsa->priv_key, 
# 273 "dsa/dsa_ameth.c" 3 4
                                                     ((void *)0)
# 273 "dsa/dsa_ameth.c"
                                                         );
 if (!prkey) {
  ERR_put_error(10,(116),(109),"dsa/dsa_ameth.c",275);
  goto err;
 }
 ...
 prkey = 
# 282 "dsa/dsa_ameth.c" 3 4
        ((void *)0)
# 282 "dsa/dsa_ameth.c"
            ;

 if (!PKCS8_pkey_set0(p8, OBJ_nid2obj(116), 0, 16,
     params, dp, dplen))
  goto err;
...
dsa_copy_parameters(EVP_PKEY *to, const EVP_PKEY *from)
{
 ...
 if ((a = BN_dup(from->pkey.dsa->p)) == 
# 325 "dsa/dsa_ameth.c" 3 4
                                       ((void *)0)
# 325 "dsa/dsa_ameth.c"
                                           )
  return 0;
 ...
 if ((a = BN_dup(from->pkey.dsa->q)) == 
# 330 "dsa/dsa_ameth.c" 3 4
                                       ((void *)0)
# 330 "dsa/dsa_ameth.c"
                                           )
  return 0;
 ...
 if ((a = BN_dup(from->pkey.dsa->g)) == 
# 335 "dsa/dsa_ameth.c" 3 4
                                       ((void *)0)
# 335 "dsa/dsa_ameth.c"
                                           )
  return 0;
...
update_buflen(const BIGNUM *b, size_t *pbuflen)
{
 ...
 if (!b)
  return;
 if (*pbuflen < (i = (size_t)((BN_num_bits(b)+7)/8)))
  *pbuflen = i;
}
...
# 396 "dsa/dsa_ameth.c"
 ...
 m = malloc(buf_len + 10);
 if (m == 
# 412 "dsa/dsa_ameth.c" 3 4
         ((void *)0)
# 412 "dsa/dsa_ameth.c"
             ) {
  ERR_put_error(10,(104),((1|64)),"dsa/dsa_ameth.c",413);
  goto err;
 }
...
dsa_param_decode(EVP_PKEY *pkey, const unsigned char **pder, int derlen)
{
 ...
 if (!(dsa = d2i_DSAparams(
# 446 "dsa/dsa_ameth.c" 3 4
                          ((void *)0)
# 446 "dsa/dsa_ameth.c"
                              , pder, derlen))) {
  ERR_put_error(10,(119),(10),"dsa/dsa_ameth.c",447);
  return 0;
 }
 EVP_PKEY_assign((pkey),116, (char *)(dsa));
 return 1;
...
old_dsa_priv_decode(EVP_PKEY *pkey, const unsigned char **pder, int derlen)
{
 DSA *dsa;
 BN_CTX *ctx = 
# 482 "dsa/dsa_ameth.c" 3 4
              ((void *)0)
# 482 "dsa/dsa_ameth.c"
                  ;
 BIGNUM *j, *p1, *newp1;

 if (!(dsa = d2i_DSAPrivateKey(
# 485 "dsa/dsa_ameth.c" 3 4
                              ((void *)0)
# 485 "dsa/dsa_ameth.c"
                                  , pder, derlen))) {
  ERR_put_error(10,(122),(10),"dsa/dsa_ameth.c",486);
  return 0;
 }

 ctx = BN_CTX_new();
 if (ctx == 
# 491 "dsa/dsa_ameth.c" 3 4
           ((void *)0)
# 491 "dsa/dsa_ameth.c"
               )
  goto err;
...
# 507 "dsa/dsa_ameth.c"
 ...
 if (BN_cmp(newp1, p1) != 0) {
  ERR_put_error(10,(119),(102),"dsa/dsa_ameth.c",513);
  goto err;
 }
 ...
 if (BN_is_prime_ex(dsa->q, 0, ctx, 
# 521 "dsa/dsa_ameth.c" 3 4
                                                 ((void *)0)
# 521 "dsa/dsa_ameth.c"
                                                     ) == 0) {
  ERR_put_error(10,(119),(102),"dsa/dsa_ameth.c",522);
  goto err;
 }
...
# 561 "dsa/dsa_ameth.c"
  ...
  m = malloc(buf_len + 10);
  if (m == 
# 566 "dsa/dsa_ameth.c" 3 4
          ((void *)0)
# 566 "dsa/dsa_ameth.c"
              ) {
   ERR_put_error(10,(125),((1|64)),"dsa/dsa_ameth.c",567);
   goto err;
  }
...
# 596 "dsa/dsa_ameth.c" 3 4
                                    ((void *)0)
# 596 "dsa/dsa_ameth.c"
                                        , &alg1, &alg2);
   if (alg1 == 
# 597 "dsa/dsa_ameth.c" 3 4
              ((void *)0) 
# 597 "dsa/dsa_ameth.c"
                   || alg1->algorithm == 
# 597 "dsa/dsa_ameth.c" 3 4
...
# 597 "dsa/dsa_ameth.c"
   ...
   if (!OBJ_find_sigid_by_algs(&snid, hnid,
       EVP_PKEY_id(pkey)))
    return -1;
   X509_ALGOR_set0(alg2, OBJ_nid2obj(snid), -1,
       0);
  }
  return 1;
# 630 "dsa/dsa_ameth.c"
