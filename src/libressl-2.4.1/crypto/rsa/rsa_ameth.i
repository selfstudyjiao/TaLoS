...
# 78 "rsa/rsa_ameth.c"
 ...
 if (penclen <= 0)
  return 0;
 if (X509_PUBKEY_set0_param(pk, OBJ_nid2obj(6),
     5, 
# 85 "rsa/rsa_ameth.c" 3 4
                 ((void *)0)
# 85 "rsa/rsa_ameth.c"
                     , penc, penclen))
  return 1;
...
rsa_pub_decode(EVP_PKEY *pkey, X509_PUBKEY *pubkey)
{
 ...
 int pklen;
 RSA *rsa = 
# 97 "rsa/rsa_ameth.c" 3 4
           ((void *)0)
# 97 "rsa/rsa_ameth.c"
               ;

 if (!X509_PUBKEY_get0_param(
# 99 "rsa/rsa_ameth.c" 3 4
                            ((void *)0)
# 99 "rsa/rsa_ameth.c"
                                , &p, &pklen, 
# 99 "rsa/rsa_ameth.c" 3 4
...
# 99 "rsa/rsa_ameth.c"
                                                  , pubkey))
  return 0;
 if (!(rsa = d2i_RSAPublicKey(
# 101 "rsa/rsa_ameth.c" 3 4
                             ((void *)0)
# 101 "rsa/rsa_ameth.c"
                                 , &p, pklen))) {
  ERR_put_error(4,(139),(4),"rsa/rsa_ameth.c",102);
  return 0;
 }
...
# 123 "rsa/rsa_ameth.c" 3 4
                               ((void *)0)
# 123 "rsa/rsa_ameth.c"
                                   , pder, derlen))) {
  ERR_put_error(4,(147),(4),"rsa/rsa_ameth.c",124);
  return 0;
 }
 EVP_PKEY_assign((pkey),6, (char *)(rsa));
 return 1;
...
# 140 "rsa/rsa_ameth.c"
 ...
 if (rklen <= 0) {
  ERR_put_error(4,(138),((1|64)),"rsa/rsa_ameth.c",146);
  return 0;
 }

 if (!PKCS8_pkey_set0(p8, OBJ_nid2obj(6), 0,
     5, 
# 151 "rsa/rsa_ameth.c" 3 4
                 ((void *)0)
# 151 "rsa/rsa_ameth.c"
                     , rk, rklen)) {
  ERR_put_error(4,(138),((1|64)),"rsa/rsa_ameth.c",152);
  return 0;
 }
...
# 204 "rsa/rsa_ameth.c"
 ...
 m = malloc(buf_len + 10);
 if (m == 
# 221 "rsa/rsa_ameth.c" 3 4
         ((void *)0)
# 221 "rsa/rsa_ameth.c"
             ) {
  ERR_put_error(4,(146),((1|64)),"rsa/rsa_ameth.c",222);
  goto err;
 }

 if (x->n != 
# 226 "rsa/rsa_ameth.c" 3 4
            ((void *)0)
# 226 "rsa/rsa_ameth.c"
                )
 ...
 *pmaskHash = 
# 286 "rsa/rsa_ameth.c" 3 4
             ((void *)0)
# 286 "rsa/rsa_ameth.c"
                 ;

 if (!alg->parameter || alg->parameter->type != 16)
  return 
# 289 "rsa/rsa_ameth.c" 3 4
        ((void *)0)
# 289 "rsa/rsa_ameth.c"
            ;
 ...
 pss = d2i_RSA_PSS_PARAMS(
# 293 "rsa/rsa_ameth.c" 3 4
                         ((void *)0)
# 293 "rsa/rsa_ameth.c"
                             , &p, plen);
...
# 296 "rsa/rsa_ameth.c"
 ...
 if (pss->maskGenAlgorithm) {
  ...
  if (OBJ_obj2nid(pss->maskGenAlgorithm->algorithm) == 911 &&
      param && param->type == 16) {
   p = param->value.sequence->data;
   plen = param->value.sequence->length;
   *pmaskHash = d2i_X509_ALGOR(
# 304 "rsa/rsa_ameth.c" 3 4
                              ((void *)0)
# 304 "rsa/rsa_ameth.c"
                                  , &p, plen);
  }
...
# 435 "rsa/rsa_ameth.c"
 ...
 if (alg)
  X509_ALGOR_set0(alg, OBJ_nid2obj(6),
      5, 0);
...
# 460 "rsa/rsa_ameth.c"
 ...
 if (OBJ_obj2nid(sigalg->algorithm) != 912) {
  ERR_put_error(4,(156),(155),"rsa/rsa_ameth.c",467);
  return -1;
 }
 ...
 if (pss == 
# 474 "rsa/rsa_ameth.c" 3 4
           ((void *)0)
# 474 "rsa/rsa_ameth.c"
               ) {
  ERR_put_error(4,(156),(149),"rsa/rsa_ameth.c",475);
  goto err;
 }

 if (pss->maskGenAlgorithm) {
  if (OBJ_obj2nid(pss->maskGenAlgorithm->algorithm) != 911) {
   ERR_put_error(4,(156),(153),"rsa/rsa_ameth.c",482)
                                        ;
   goto err;
  }
  if (!maskHash) {
   ERR_put_error(4,(156),(154),"rsa/rsa_ameth.c",487)
                                        ;
   goto err;
  }
  mgf1md = EVP_get_digestbyname(OBJ_nid2sn(OBJ_obj2nid(maskHash->algorithm)));
  if (mgf1md == 
# 491 "rsa/rsa_ameth.c" 3 4
               ((void *)0)
# 491 "rsa/rsa_ameth.c"
                   ) {
   ERR_put_error(4,(156),(151),"rsa/rsa_ameth.c",493)
                                 ;
   goto err;
  }
 } else
 ...
 if (pss->hashAlgorithm) {
  md = EVP_get_digestbyname(OBJ_nid2sn(OBJ_obj2nid(pss->hashAlgorithm->algorithm)));
  if (md == 
# 501 "rsa/rsa_ameth.c" 3 4
           ((void *)0)
# 501 "rsa/rsa_ameth.c"
               ) {
   ERR_put_error(4,(156),(152),"rsa/rsa_ameth.c",502);
   goto err;
  }
 } else
  md = EVP_sha1();
 ...
 if (pss->saltLength) {
  ...
  if (saltlen < 0) {
   ERR_put_error(4,(156),(150),"rsa/rsa_ameth.c",516)
                                 ;
   goto err;
  }
 } else
 ...
 if (pss->trailerField && ASN1_INTEGER_get(pss->trailerField) != 1) {
  ERR_put_error(4,(156),(139),"rsa/rsa_ameth.c",526);
  goto err;
 }



 if (!EVP_DigestVerifyInit(ctx, &pkctx, md, 
# 532 "rsa/rsa_ameth.c" 3 4
                                           ((void *)0)
# 532 "rsa/rsa_ameth.c"
                                               , pkey))
  goto err;

 if (EVP_PKEY_CTX_ctrl(pkctx, 6, -1, (0x1000 + 1), 6, 
# 535 "rsa/rsa_ameth.c" 3 4
    ((void *)0)
# 535 "rsa/rsa_ameth.c"
    ) <= 0)
  goto err;

 if (EVP_PKEY_CTX_ctrl(pkctx, 6, ((1<<3)|(1<<4)), (0x1000 + 2), saltlen, 
# 538 "rsa/rsa_ameth.c" 3 4
    ((void *)0)
# 538 "rsa/rsa_ameth.c"
    ) <= 0)
  goto err;

 if (EVP_PKEY_CTX_ctrl(pkctx, 6, ((1<<3) | (1<<4) | (1<<5) | (1<<6) | (1<<7)), (0x1000 + 5), 0, (void *)mgf1md) <= 0)
  goto err;
    ...
    X509_ALGOR *alg1, X509_ALGOR *alg2, ASN1_BIT_STRING *sig)
{
 ...
 if (EVP_PKEY_CTX_ctrl(pkctx, 6, -1, (0x1000 + 6), 0, &pad_mode) <= 0)
  return 0;
 if (pad_mode == 1)
  return 2;
 if (pad_mode == 6) {
  ...
  RSA_PSS_PARAMS *pss = 
# 566 "rsa/rsa_ameth.c" 3 4
                       ((void *)0)
# 566 "rsa/rsa_ameth.c"
                           ;
  X509_ALGOR *mgf1alg = 
# 567 "rsa/rsa_ameth.c" 3 4
                       ((void *)0)
# 567 "rsa/rsa_ameth.c"
                           ;
  ASN1_STRING *os1 = 
# 568 "rsa/rsa_ameth.c" 3 4
                    ((void *)0)
# 568 "rsa/rsa_ameth.c"
                        , *os2 = 
# 568 "rsa/rsa_ameth.c" 3 4
...
# 568 "rsa/rsa_ameth.c"
  ...
  if (EVP_PKEY_CTX_ctrl(pkctx, 6, ((1<<3) | (1<<4) | (1<<5) | (1<<6) | (1<<7)), (0x1000 + 8), 0, (void *)&mgf1md) <= 0)
   goto err;
  if (!EVP_PKEY_CTX_ctrl(pkctx, 6, ((1<<3)|(1<<4)), (0x1000 + 7), 0, &saltlen))
   goto err;
  if (saltlen == -1)
  ...
  if (EVP_MD_type(sigmd) != 64) {
   pss->hashAlgorithm = X509_ALGOR_new();
   if (!pss->hashAlgorithm)
    goto err;
   X509_ALGOR_set_md(pss->hashAlgorithm, sigmd);
  }
  if (EVP_MD_type(mgf1md) != 64) {
   ASN1_STRING *stmp = 
# 601 "rsa/rsa_ameth.c" 3 4
                      ((void *)0)
# 601 "rsa/rsa_ameth.c"
                          ;
  ...
  if (alg2) {
   ...
   if (!os2)
    goto err;
   X509_ALGOR_set0(alg2, OBJ_nid2obj(912),
       16, os2);
  }
  X509_ALGOR_set0(alg1, OBJ_nid2obj(912),
      16, os1);
  os1 = os2 = 
# 626 "rsa/rsa_ameth.c" 3 4
             ((void *)0)
# 626 "rsa/rsa_ameth.c"
                 ;
  rv = 3;
