...
BN_value_one(void)
{
 static const unsigned long data_one = 1L;
 static const BIGNUM const_one = {
  (unsigned long *)&data_one, 1, 1, 0, 0x02
 };
...
BN_num_bits(const BIGNUM *a)
{
 ...
 if (BN_is_zero(a))
  return 0;
 return ((i * 64) + BN_num_bits_word(a->d[i]));
}
...
BN_new(void)
{
 ...
 if ((ret = malloc(sizeof(BIGNUM))) == 
# 269 "bn/bn_lib.c" 3 4
                                      ((void *)0)
# 269 "bn/bn_lib.c"
                                          ) {
  ERR_put_error(3,(113),((1|64)),"bn/bn_lib.c",270);
  return (
# 271 "bn/bn_lib.c" 3 4
         ((void *)0)
# 271 "bn/bn_lib.c"
...
# 287 "bn/bn_lib.c"
 ...
 if (words > (0x7fffffff/(4*64))) {
  ERR_put_error(3,(120),(114),"bn/bn_lib.c",294);
  return 
# 295 "bn/bn_lib.c" 3 4
        ((void *)0)
# 295 "bn/bn_lib.c"
 ...
 if (((b)->flags&(0x02))) {
  ERR_put_error(3,(120),(105),"bn/bn_lib.c",299)
                                        ;
  return (
# 300 "bn/bn_lib.c" 3 4
         ((void *)0)
...
# 303 "bn/bn_lib.c"
  ...
  ERR_put_error(3,(120),((1|64)),"bn/bn_lib.c",304);
  return (
# 305 "bn/bn_lib.c" 3 4
         ((void *)0)
# 305 "bn/bn_lib.c"
...
# 364 "bn/bn_lib.c"
 ...
 if (words > b->dmax) {
  unsigned long *a = bn_expand_internal(b, words);
...
BN_copy(BIGNUM *a, const BIGNUM *b)
{
 ...
 if (a == b)
  return (a);
 if ((((b->top) <= (a)->dmax)?(a):bn_expand2((a),(b->top))) == 
# 483 "bn/bn_lib.c" 3 4
                             ((void *)0)
# 483 "bn/bn_lib.c"
                                 )
...
BN_swap(BIGNUM *a, BIGNUM *b)
{
 ...
 a->flags = (flags_old_a & 0x01) |
     (flags_old_b & 0x02);
 b->flags = (flags_old_b & 0x01) |
     (flags_old_a & 0x02);
 ;
 ;
}
...
# 579 "bn/bn_lib.c"
 ...
 if (((bits + 64 - 1) / 64) <= a->dmax)
  return (a);

 return bn_expand2(a, (bits + 64 - 1) / 64);
}

int
ecall_BN_set_word(BIGNUM *a, unsigned long w) {
...
{
 ;
 if (bn_expand(a, (int)sizeof(unsigned long) * 8) == 
# 595 "bn/bn_lib.c" 3 4
                                               ((void *)0)
# 595 "bn/bn_lib.c"
                                                   )
...
# 619 "bn/bn_lib.c"
 ...
 i = ((n - 1) / 8) + 1;
 m = ((n - 1) % (8));
 if (((((int)i) <= (ret)->dmax)?(ret):bn_expand2((ret),((int)i))) == 
# 629 "bn/bn_lib.c" 3 4
                               ((void *)0)
# 629 "bn/bn_lib.c"
                                   ) {
...
# 631 "bn/bn_lib.c"
 ...
 { unsigned long *ftl; int tmp_top = (ret)->top; if (tmp_top > 0) { for (ftl= &((ret)->d[tmp_top-1]); tmp_top > 0; tmp_top--) if (*(ftl--)) break; (ret)->top = tmp_top; } ; };
 return (ret);
}
...
BN_set_bit(BIGNUM *a, int n)
{
 ...
 j = n % 64;
 if (a->top <= i) {
  if ((((i + 1) <= (a)->dmax)?(a):bn_expand2((a),(i + 1))) == 
# 747 "bn/bn_lib.c" 3 4
                             ((void *)0)
# 747 "bn/bn_lib.c"
                                 )
...
BN_clear_bit(BIGNUM *a, int n)
{
 ...
 a->d[i] &= (~(((unsigned long)1) << j));
 { unsigned long *ftl; int tmp_top = (a)->top; if (tmp_top > 0) { for (ftl= &((a)->d[tmp_top-1]); tmp_top > 0; tmp_top--) if (*(ftl--)) break; (a)->top = tmp_top; } ; };
 return (1);
}
...
BN_is_bit_set(const BIGNUM *a, int n)
{
 ...
 if (a->top <= i)
  return 0;
 return (int)(((a->d[i]) >> j) & ((unsigned long)1));
}
...
int
bn_cmp_words(const unsigned long *a, const unsigned long *b, int n)
{
 int i;
 unsigned long aa, bb;
...
# 860 "bn/bn_lib.c"
int
bn_cmp_part_words(const unsigned long *a, const unsigned long *b, int cl, int dl)
{
 int n, i;
...
# 889 "bn/bn_lib.c"
void
BN_consttime_swap(unsigned long condition, BIGNUM *a, BIGNUM *b, int nwords)
{
 unsigned long t;
 int i;
...
# 916 "bn/bn_lib.c"
 ...
 default:
  for (i = 10; i < nwords; i++)
   do { t = (a->d[i] ^ b->d[i]) & condition; a->d[i] ^= t; b->d[i] ^= t; } while (0);

 case 10: do { t = (a->d[9] ^ b->d[9]) & condition; a->d[9] ^= t; b->d[9] ^= t; } while (0);
 case 9: do { t = (a->d[8] ^ b->d[8]) & condition; a->d[8] ^= t; b->d[8] ^= t; } while (0);
 case 8: do { t = (a->d[7] ^ b->d[7]) & condition; a->d[7] ^= t; b->d[7] ^= t; } while (0);
 case 7: do { t = (a->d[6] ^ b->d[6]) & condition; a->d[6] ^= t; b->d[6] ^= t; } while (0);
 case 6: do { t = (a->d[5] ^ b->d[5]) & condition; a->d[5] ^= t; b->d[5] ^= t; } while (0);
 case 5: do { t = (a->d[4] ^ b->d[4]) & condition; a->d[4] ^= t; b->d[4] ^= t; } while (0);
 case 4: do { t = (a->d[3] ^ b->d[3]) & condition; a->d[3] ^= t; b->d[3] ^= t; } while (0);
 case 3: do { t = (a->d[2] ^ b->d[2]) & condition; a->d[2] ^= t; b->d[2] ^= t; } while (0);
 case 2: do { t = (a->d[1] ^ b->d[1]) & condition; a->d[1] ^= t; b->d[1] ^= t; } while (0);
 case 1:
  do { t = (a->d[0] ^ b->d[0]) & condition; a->d[0] ^= t; b->d[0] ^= t; } while (0);
 }
