...
{
 if (s->s3->tmp.key_block != 
# 149 "../ssl/t1_enc.c" 3 4
                            ((void *)0)
# 149 "../ssl/t1_enc.c"
                                ) {
...
# 165 "../ssl/t1_enc.c" 3 4
                               ((void *)0)
# 165 "../ssl/t1_enc.c"
                                   )
  return (0);

 (void)(int)BIO_ctrl(s->s3->handshake_buffer,9,(0x01),
# 168 "../ssl/t1_enc.c" 3 4
      ((void *)0)
# 168 "../ssl/t1_enc.c"
      );
...
tls1_digest_cached_records(SSL *s)
{
 ...
 s->s3->handshake_dgst = calloc(8, sizeof(EVP_MD_CTX *));
 if (s->s3->handshake_dgst == 
# 218 "../ssl/t1_enc.c" 3 4
                             ((void *)0)
# 218 "../ssl/t1_enc.c"
                                 ) {
  ERR_put_error(20,(293),((1|64)),"../ssl/t1_enc.c",219);
  return 0;
 }
 hdatalen = BIO_ctrl(s->s3->handshake_buffer,3,0,(char *)&hdata);
 if (hdatalen <= 0) {
  ERR_put_error(20,(293),(332),"../ssl/t1_enc.c",225)
                                 ;
  return 0;
 }
 ...
 for (i = 0; ssl_get_handshake_digest(i, &mask, &md); i++) {
  if ((mask & ssl_get_algorithm2(s)) && md) {
   ...
   if (s->s3->handshake_dgst[i] == 
# 233 "../ssl/t1_enc.c" 3 4
                                  ((void *)0)
# 233 "../ssl/t1_enc.c"
                                      ) {
    ERR_put_error(20,(293),((1|64)),"../ssl/t1_enc.c",235)
                             ;
    return 0;
   }
   if (!EVP_DigestInit_ex(s->s3->handshake_dgst[i],
       md, 
# 239 "../ssl/t1_enc.c" 3 4
          ((void *)0)
# 239 "../ssl/t1_enc.c"
              )) {
    EVP_MD_CTX_destroy(s->s3->handshake_dgst[i]);
 ...
 if (!(s->s3->flags & 0x0020)) {
  BIO_free(s->s3->handshake_buffer);
  s->s3->handshake_buffer = 
# 251 "../ssl/t1_enc.c" 3 4
                           ((void *)0)
# 251 "../ssl/t1_enc.c"
                               ;
 }
    ...
    const void *seed5, int seed5_len, unsigned char *out, int olen)
{
 ...
 (void)((chunk >= 0) ? 0 : (OpenSSLDie("../ssl/t1_enc.c", 284, "chunk >= 0"),1));

 EVP_MD_CTX_init(&ctx);
 EVP_MD_CTX_init(&ctx_tmp);
 mac_key = EVP_PKEY_new_mac_key(855, 
# 288 "../ssl/t1_enc.c" 3 4
                                              ((void *)0)
# 288 "../ssl/t1_enc.c"
                                                  , sec, sec_len);
 if (!mac_key)
...
# 291 "../ssl/t1_enc.c"
                                            , mac_key))
  goto err;
 if (!EVP_DigestSignInit(&ctx_tmp, 
# 293 "../ssl/t1_enc.c" 3 4
                                  ((void *)0)
# 293 "../ssl/t1_enc.c"
                                      , md, 
# 293 "../ssl/t1_enc.c" 3 4
...
# 293 "../ssl/t1_enc.c"
                                                , mac_key))
  goto err;
 if (seed1 && !EVP_DigestUpdate(&ctx,seed1,seed1_len))
  goto err;
 if (seed2 && !EVP_DigestUpdate(&ctx,seed2,seed2_len))
  goto err;
 if (seed3 && !EVP_DigestUpdate(&ctx,seed3,seed3_len))
  goto err;
 if (seed4 && !EVP_DigestUpdate(&ctx,seed4,seed4_len))
  goto err;
 if (seed5 && !EVP_DigestUpdate(&ctx,seed5,seed5_len))
  goto err;
...
# 312 "../ssl/t1_enc.c"
                                                 , mac_key))
   goto err;
  if (!EVP_DigestUpdate(&ctx,A1,A1_len))
   goto err;
  if (!EVP_DigestUpdate(&ctx_tmp,A1,A1_len))
   goto err;
  if (seed1 && !EVP_DigestUpdate(&ctx,seed1,seed1_len))
   goto err;
  if (seed2 && !EVP_DigestUpdate(&ctx,seed2,seed2_len))
    ...
    int slen, unsigned char *out1, unsigned char *out2, int olen)
{
 ...
 if (count == 0) {
  ERR_put_error(20,(284),(229),"../ssl/t1_enc.c",376)
                                  ;
  goto err;
 }
 len = slen / count;
 ...
 for (idx = 0; ssl_get_handshake_digest(idx, &m, &md); idx++) {
  if ((m << 10) & digest_mask) {
   if (!md) {
    ERR_put_error(20,(284),(326),"../ssl/t1_enc.c",388)
                                      ;
    goto err;
   }
...
tls1_generate_key_block(SSL *s, unsigned char *km, unsigned char *tmp, int num)
{
 ...
 ret = tls1_PRF(ssl_get_algorithm2(s),
     "key expansion", 13,
     s->s3->server_random, 32,
     s->s3->client_random, 32,
     
# 416 "../ssl/t1_enc.c" 3 4
    ((void *)0)
# 416 "../ssl/t1_enc.c"
        , 0, 
# 416 "../ssl/t1_enc.c" 3 4
 ...
 *aead_ctx = malloc(sizeof(SSL_AEAD_CTX));
 if (*aead_ctx == 
# 435 "../ssl/t1_enc.c" 3 4
                 ((void *)0)
# 435 "../ssl/t1_enc.c"
                     ) {
  ERR_put_error(20,(339),((1|64)),"../ssl/t1_enc.c",436);
  return (0);
 }
    ...
    unsigned key_len, const unsigned char *iv, unsigned iv_len)
{
 ...
 if (!EVP_AEAD_CTX_init(&aead_ctx->ctx, aead, key, key_len,
     0, 
# 461 "../ssl/t1_enc.c" 3 4
                                 ((void *)0)
# 461 "../ssl/t1_enc.c"
                                     ))
  return (0);
 if (iv_len > sizeof(aead_ctx->fixed_nonce)) {
  ERR_put_error(20,(340),((4|64)),"../ssl/t1_enc.c",465)
                           ;
  return (0);
 }
 ...
 aead_ctx->xor_fixed_nonce =
     s->s3->tmp.new_cipher->algorithm_enc == 0x00001000L;
 ...
 if (aead_ctx->xor_fixed_nonce) {
  if (aead_ctx->fixed_nonce_len != EVP_AEAD_nonce_length(aead) ||
   ...
   ERR_put_error(20,(340),((4|64)),"../ssl/t1_enc.c",482)
                            ;
   return (0);
  }
 } else {
  if (aead_ctx->variable_nonce_len + aead_ctx->fixed_nonce_len !=
   ...
   ERR_put_error(20,(340),((4|64)),"../ssl/t1_enc.c",489)
                            ;
   return (0);
  }
 }
    ...
    unsigned int iv_len)
{
 ...
 if (is_read) {
  if (s->s3->tmp.new_cipher->algorithm2 & 0x04)
   s->mac_flags |= 1;
  else
   s->mac_flags &= ~1;
  ...
  s->enc_read_ctx = 
# 527 "../ssl/t1_enc.c" 3 4
                   ((void *)0)
# 527 "../ssl/t1_enc.c"
                       ;
  EVP_MD_CTX_destroy(s->read_hash);
  s->read_hash = 
# 529 "../ssl/t1_enc.c" 3 4
                ((void *)0)
# 529 "../ssl/t1_enc.c"
                    ;

  if ((cipher_ctx = EVP_CIPHER_CTX_new()) == 
# 531 "../ssl/t1_enc.c" 3 4
                                            ((void *)0)
# 531 "../ssl/t1_enc.c"
                                                )
   goto err;
  s->enc_read_ctx = cipher_ctx;
  if ((mac_ctx = EVP_MD_CTX_create()) == 
# 534 "../ssl/t1_enc.c" 3 4
                                        ((void *)0)
# 534 "../ssl/t1_enc.c"
                                            )
   goto err;
...
# 550 "../ssl/t1_enc.c"
  if (!(s->method->ssl3_enc->enc_flags & (1 << 3))) {
   ...
   s->enc_write_ctx = 
# 552 "../ssl/t1_enc.c" 3 4
                     ((void *)0)
# 552 "../ssl/t1_enc.c"
                         ;
   EVP_MD_CTX_destroy(s->write_hash);
   s->write_hash = 
# 554 "../ssl/t1_enc.c" 3 4
                  ((void *)0)
# 554 "../ssl/t1_enc.c"
                      ;
  }
  if ((cipher_ctx = EVP_CIPHER_CTX_new()) == 
# 556 "../ssl/t1_enc.c" 3 4
                                            ((void *)0)
# 556 "../ssl/t1_enc.c"
                                                )
   goto err;
...
# 559 "../ssl/t1_enc.c"
 ...
 if ((EVP_CIPHER_flags(cipher) & 0xF0007) == 0x6) {
  EVP_CipherInit_ex(cipher_ctx, cipher, 
# 565 "../ssl/t1_enc.c" 3 4
                                       ((void *)0)
# 565 "../ssl/t1_enc.c"
                                           , key, 
# 565 "../ssl/t1_enc.c" 3 4
...
# 565 "../ssl/t1_enc.c"
                                                      ,
      !is_read);
  EVP_CIPHER_CTX_ctrl(cipher_ctx, 0x12,
      iv_len, (unsigned char *)iv);
 } else
  EVP_CipherInit_ex(cipher_ctx, cipher, 
# 570 "../ssl/t1_enc.c" 3 4
                                       ((void *)0)
# 570 "../ssl/t1_enc.c"
                                           , key, iv, !is_read);

 if (!(EVP_CIPHER_flags(cipher) & 0x200000)) {
  EVP_PKEY *mac_key = EVP_PKEY_new_mac_key(mac_type, 
# 573 "../ssl/t1_enc.c" 3 4
                                                    ((void *)0)
# 573 "../ssl/t1_enc.c"
                                                        ,
      mac_secret, mac_secret_size);
  if (mac_key == 
# 575 "../ssl/t1_enc.c" 3 4
                ((void *)0)
# 575 "../ssl/t1_enc.c"
                    )
   goto err;
  EVP_DigestSignInit(mac_ctx, 
# 577 "../ssl/t1_enc.c" 3 4
                             ((void *)0)
# 577 "../ssl/t1_enc.c"
                                 , mac, 
# 577 "../ssl/t1_enc.c" 3 4
...
# 577 "../ssl/t1_enc.c"
  ...
  EVP_CIPHER_CTX_ctrl(cipher_ctx, 0x17,
      mac_secret_size, (unsigned char *)mac_secret);
 }

 if (s->s3->tmp.new_cipher->algorithm_enc == 0x00000200L) {
  int nid;
  if (s->s3->tmp.new_cipher->algorithm2 & 0x40)
   nid = 824;
  else
   nid = 945;

  EVP_CIPHER_CTX_ctrl(cipher_ctx, 0x19, nid, 0);
  if (s->s3->tmp.new_cipher->algorithm_mac == 0x00000008L)
   EVP_MD_CTX_ctrl(mac_ctx, 0x4, nid, 0);
 }

 return (1);

err:
 ERR_put_error(20,(338),((1|64)),"../ssl/t1_enc.c",600);
 return (0);
}
...
tls1_change_cipher_state(SSL *s, int which)
{
 ...
 use_client_keys = ((which == (0x10|0x02)) ||
     (which == (0x20|0x01)));
 ...
 if (aead != 
# 646 "../ssl/t1_enc.c" 3 4
            ((void *)0)
# 646 "../ssl/t1_enc.c"
                ) {
  key_len = EVP_AEAD_key_length(aead);
  iv_len = (((s->s3->tmp.new_cipher->algorithm2 >> 24) & 0xf) * 2);
 } else {
 ...
 if (key_block - s->s3->tmp.key_block != s->s3->tmp.key_block_length) {
  ERR_put_error(20,(209),((4|64)),"../ssl/t1_enc.c",685);
  goto err2;
 }
...
{
 unsigned char *key_block, *tmp_block = 
# 712 "../ssl/t1_enc.c" 3 4
                                       ((void *)0)
# 712 "../ssl/t1_enc.c"
                                           ;
 int mac_type = 0, mac_secret_size = 0;
 int key_block_len, key_len, iv_len;
 const EVP_CIPHER *cipher = 
# 715 "../ssl/t1_enc.c" 3 4
                           ((void *)0)
# 715 "../ssl/t1_enc.c"
                               ;
 const EVP_AEAD *aead = 
# 716 "../ssl/t1_enc.c" 3 4
                       ((void *)0)
# 716 "../ssl/t1_enc.c"
                           ;
 const EVP_MD *mac = 
# 717 "../ssl/t1_enc.c" 3 4
                    ((void *)0)
# 717 "../ssl/t1_enc.c"
                        ;
 int ret = 0;
 ...
 if (s->session->cipher &&
     (s->session->cipher->algorithm2 & (1 << 23))) {
  if (!ssl_cipher_get_evp_aead(s->session, &aead)) {
   ERR_put_error(20,(211),(138),"../ssl/t1_enc.c",727)
                                        ;
   return (0);
  }
  key_len = EVP_AEAD_key_length(aead);
  iv_len = (((s->session->cipher->algorithm2 >> 24) & 0xf) * 2);
 } else {
  if (!ssl_cipher_get_evp(s->session, &cipher, &mac, &mac_type,
      &mac_secret_size)) {
   ERR_put_error(20,(211),(138),"../ssl/t1_enc.c",736)
                                        ;
   return (0);
  }
  key_len = EVP_CIPHER_key_length(cipher);
 ...
 if ((key_block = reallocarray(
# 755 "../ssl/t1_enc.c" 3 4
                              ((void *)0)
# 755 "../ssl/t1_enc.c"
                                  , mac_secret_size + key_len + iv_len,
     2)) == 
# 756 "../ssl/t1_enc.c" 3 4
           ((void *)0)
# 756 "../ssl/t1_enc.c"
               ) {
  ERR_put_error(20,(211),((1|64)),"../ssl/t1_enc.c",757);
  goto err;
 }
 ...
 if ((tmp_block = malloc(key_block_len)) == 
# 765 "../ssl/t1_enc.c" 3 4
                                           ((void *)0)
# 765 "../ssl/t1_enc.c"
                                               ) {
  ERR_put_error(20,(211),((1|64)),"../ssl/t1_enc.c",766);
  goto err;
 }
 ...
 if (!(s->options & 0x00000800L) &&
     s->method->version <= 0x0301) {
  ...
  if (s->session->cipher != 
# 781 "../ssl/t1_enc.c" 3 4
                           ((void *)0)
# 781 "../ssl/t1_enc.c"
                               ) {
   if (s->session->cipher->algorithm_enc == 0x00000010L)
    s->s3->need_empty_fragments = 0;


   if (s->session->cipher->algorithm_enc == 0x00000004L)
    s->s3->need_empty_fragments = 0;
...
# 902 "../ssl/t1_enc.c"
 ...
 if (send) {
  if (EVP_MD_CTX_md(s->write_hash)) {
   int n = EVP_MD_size(EVP_MD_CTX_md(s->write_hash));
   (void)((n >= 0) ? 0 : (OpenSSLDie("../ssl/t1_enc.c", 980, "n >= 0"),1));
  }
  ds = s->enc_write_ctx;
  if (s->enc_write_ctx == 
# 983 "../ssl/t1_enc.c" 3 4
                         ((void *)0)
# 983 "../ssl/t1_enc.c"
                             )
   enc = 
# 984 "../ssl/t1_enc.c" 3 4
        ((void *)0)
# 984 "../ssl/t1_enc.c"
            ;
  else {
   ...
   if ((s->method->ssl3_enc->enc_flags & (1 << 0)) &&
...
# 1001 "../ssl/t1_enc.c"
  ...
  if (EVP_MD_CTX_md(s->read_hash)) {
   int n = EVP_MD_size(EVP_MD_CTX_md(s->read_hash));
   (void)((n >= 0) ? 0 : (OpenSSLDie("../ssl/t1_enc.c", 1008, "n >= 0"),1));
  }
  ds = s->enc_read_ctx;
  if (s->enc_read_ctx == 
# 1011 "../ssl/t1_enc.c" 3 4
                        ((void *)0)
# 1011 "../ssl/t1_enc.c"
                            )
   enc = 
# 1012 "../ssl/t1_enc.c" 3 4
        ((void *)0)
# 1012 "../ssl/t1_enc.c"
            ;
  else
...
# 1017 "../ssl/t1_enc.c"
  ...
  if (EVP_CIPHER_flags(ds->cipher) & 0x200000) {
   ...
   pad = EVP_CIPHER_CTX_ctrl(ds, 0x16, 13, buf);
   if (send) {
    l += pad;
    rec->length += pad;
   }
  ...
  if ((EVP_CIPHER_flags(ds->cipher) &
      0x100000) ? (i < 0) : (i == 0))
   return -1;
  if ((EVP_CIPHER_flags(enc) & 0xF0007) == 0x6 && !send) {
   rec->data += 8;
   rec->input += 8;
   rec->length -= 8;
  }
  ...
  ret = 1;
  if (EVP_MD_CTX_md(s->read_hash) != 
# 1075 "../ssl/t1_enc.c" 3 4
                                    ((void *)0)
# 1075 "../ssl/t1_enc.c"
                                        )
   mac_size = EVP_MD_size(EVP_MD_CTX_md(s->read_hash));
  if ((bs != 1) && !send)
...
# 1088 "../ssl/t1_enc.c"
 ...
 for (i = 0; i < 8; i++) {
  if (s->s3->handshake_dgst[i] &&
      EVP_MD_type(EVP_MD_CTX_md(s->s3->handshake_dgst[i])) == md_nid) {
   d = s->s3->handshake_dgst[i];
   break;
  }
 }
 if (d == 
# 1103 "../ssl/t1_enc.c" 3 4
         ((void *)0)
# 1103 "../ssl/t1_enc.c"
             ) {
  ERR_put_error(20,(286),(324),"../ssl/t1_enc.c",1104);
  return 0;
 }
...
tls1_mac(SSL *ssl, unsigned char *md, int send)
{
 ...
 t = EVP_MD_size(EVP_MD_CTX_md(hash));
 (void)((t >= 0) ? 0 : (OpenSSLDie("../ssl/t1_enc.c", 1193, "t >= 0"),1));
 md_size = t;
 ...
 if ((ssl->method->ssl3_enc->enc_flags & (1 << 3)))
 ...
 if (!send &&
  ...
  EVP_DigestUpdate(mac_ctx,header,sizeof(header));
  EVP_DigestUpdate(mac_ctx,rec->input,rec->length);
  t = EVP_DigestSignFinal(mac_ctx, md, &md_size);
  (void)((t > 0) ? 0 : (OpenSSLDie("../ssl/t1_enc.c", 1239, "t > 0"),1));
 }
    ...
    int len)
{
 ...
 tls1_PRF(ssl_get_algorithm2(s),
     "master secret", 13,
     s->s3->client_random, 32, 
# 1259 "../ssl/t1_enc.c" 3 4
                                            ((void *)0)
# 1259 "../ssl/t1_enc.c"
                                                , 0,
     s->s3->server_random, 32, 
# 1260 "../ssl/t1_enc.c" 3 4
                                            ((void *)0)
# 1260 "../ssl/t1_enc.c"
                                                , 0,
...
# 1291 "../ssl/t1_enc.c"
 ...
 currentvalpos += llen;
 memcpy(val + currentvalpos, s->s3->client_random, 32);
 currentvalpos += 32;
 memcpy(val + currentvalpos, s->s3->server_random, 32);
 currentvalpos += 32;
...
# 1306 "../ssl/t1_enc.c"
 ...
 if (memcmp(val, "client finished",
     15) == 0)
  goto err1;
 if (memcmp(val, "server finished",
     15) == 0)
  goto err1;
 if (memcmp(val, "master secret",
     13) == 0)
  goto err1;
 if (memcmp(val, "key expansion",
     13) == 0)
  goto err1;

 rv = tls1_PRF(ssl_get_algorithm2(s),
     val, vallen, 
# 1330 "../ssl/t1_enc.c" 3 4
                 ((void *)0)
# 1330 "../ssl/t1_enc.c"
                     , 0, 
# 1330 "../ssl/t1_enc.c" 3 4
...
# 1330 "../ssl/t1_enc.c"
 ...
 goto ret;
err1:
 ERR_put_error(20,(314),(367),"../ssl/t1_enc.c",1337)
                                      ;
 rv = 0;
 goto ret;
err2:
 ERR_put_error(20,(314),((1|64)),"../ssl/t1_enc.c",1341);
 rv = 0;
ret:
 free(buff);
 free(val);
