...
gost2814789_ctl(EVP_CIPHER_CTX *ctx, int type, int arg, void *ptr)
{
 ...
 case 0x7:
  if (ptr != 
# 73 "evp/e_gost2814789.c" 3 4
            ((void *)0)
# 73 "evp/e_gost2814789.c"
                ) {
   *((int *)ptr) = 810;
   return 1;
  } else {
...
gost2814789_set_asn1_params(EVP_CIPHER_CTX *ctx, ASN1_TYPE *params)
{
 int len = 0;
 unsigned char *buf = 
# 103 "evp/e_gost2814789.c" 3 4
                     ((void *)0)
# 103 "evp/e_gost2814789.c"
                         ;
 unsigned char *p = 
# 104 "evp/e_gost2814789.c" 3 4
                   ((void *)0)
# 104 "evp/e_gost2814789.c"
                       ;
 EVP_GOST2814789_CTX *c = ctx->cipher_data;
 ASN1_OCTET_STRING *os = 
# 106 "evp/e_gost2814789.c" 3 4
                        ((void *)0)
# 106 "evp/e_gost2814789.c"
                            ;
 GOST_CIPHER_PARAMS *gcp = GOST_CIPHER_PARAMS_new();

 if (gcp == 
# 109 "evp/e_gost2814789.c" 3 4
           ((void *)0)
# 109 "evp/e_gost2814789.c"
               ) {
  ERR_put_error(50,(103),((1|64)),"evp/e_gost2814789.c",111)
                           ;
  return 0;
 }
 if (ASN1_OCTET_STRING_set(gcp->iv, ctx->iv, ctx->cipher->iv_len) == 0) {
  GOST_CIPHER_PARAMS_free(gcp);
  ERR_put_error(50,(103),(13),"evp/e_gost2814789.c",116);
  return 0;
 }
 ASN1_OBJECT_free(gcp->enc_param_set);
 gcp->enc_param_set = OBJ_nid2obj(c->param_nid);

 len = i2d_GOST_CIPHER_PARAMS(gcp, 
# 122 "evp/e_gost2814789.c" 3 4
                                  ((void *)0)
# 122 "evp/e_gost2814789.c"
                                      );
 p = buf = malloc(len);
 if (buf == 
# 124 "evp/e_gost2814789.c" 3 4
           ((void *)0)
# 124 "evp/e_gost2814789.c"
               ) {
  GOST_CIPHER_PARAMS_free(gcp);
  ERR_put_error(50,(103),((1|64)),"evp/e_gost2814789.c",127)
                           ;
  return 0;
 }
 ...
 if (os == 
# 134 "evp/e_gost2814789.c" 3 4
          ((void *)0)
# 134 "evp/e_gost2814789.c"
              ) {
  free(buf);
  ERR_put_error(50,(103),((1|64)),"evp/e_gost2814789.c",137)
                           ;
  return 0;
 }
 if (ASN1_OCTET_STRING_set(os, buf, len) == 0) {
  ...
  free(buf);
  ERR_put_error(50,(103),(13),"evp/e_gost2814789.c",143);
  return 0;
 }
 free(buf);

 ASN1_TYPE_set(params, 16, os);
 return 1;
}
...
# 157 "evp/e_gost2814789.c" 3 4
                          ((void *)0)
# 157 "evp/e_gost2814789.c"
                              ;
 EVP_GOST2814789_CTX *c = ctx->cipher_data;
 unsigned char *p;

 if (ASN1_TYPE_get(params) != 16)
  return ret;

 p = params->value.sequence->data;

 gcp = d2i_GOST_CIPHER_PARAMS(
# 166 "evp/e_gost2814789.c" 3 4
                             ((void *)0)
# 166 "evp/e_gost2814789.c"
                                 , (const unsigned char **)&p,
 ...
 if (len != ctx->cipher->iv_len) {
  GOST_CIPHER_PARAMS_free(gcp);
  ERR_put_error(50,(102),(103),"evp/e_gost2814789.c",173)
                               ;
  return -1;
 }
...
static int gost2814789_ecb_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { size_t i, bl; bl = ctx->cipher->block_size; if(inl < bl) return 1; inl -= bl; for(i=0; i <= inl; i+=bl) Gost2814789_ecb_encrypt(in + i, out + i, &((EVP_GOST2814789_CTX *)ctx->cipher_data)->ks, ctx->encrypt); return 1;}
static int gost2814789_cfb64_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { size_t chunk=((size_t)1<<(sizeof(long)*8-2)); if (64==1) chunk>>=3; if (inl<chunk) chunk=inl; while(inl && inl>=chunk) { Gost2814789_cfb64_encrypt(in, out, (long)((64==1) && !(ctx->flags & 0x2000) ?inl*8:inl), &((EVP_GOST2814789_CTX *)ctx->cipher_data)->ks, ctx->iv, &ctx->num, ctx->encrypt); inl-=chunk; in +=chunk; out+=chunk; if(inl<chunk) chunk=inl; } return 1;}
    ...
    const unsigned char *in, size_t inl)
{
 ...
 while (inl >= ((size_t)1<<(sizeof(long)*8-2))) {
  Gost2814789_cnt_encrypt(in, out, (long)((size_t)1<<(sizeof(long)*8-2)), &c->ks,
...
static const EVP_CIPHER gost2814789_ecb = { 938, 8, 32, 0, 0x100 | 0x40 | 0x1, gost2814789_init_key, gost2814789_ecb_cipher, 
# 217 "evp/e_gost2814789.c" 3 4
((void *)0)
# 217 "evp/e_gost2814789.c"
, sizeof(EVP_GOST2814789_CTX), gost2814789_set_asn1_params, gost2814789_get_asn1_params, gost2814789_ctl, 
# 217 "evp/e_gost2814789.c" 3 4
((void *)0) 
# 217 "evp/e_gost2814789.c"
}; const EVP_CIPHER *EVP_gost2814789_ecb(void) { return &gost2814789_ecb; }



static const EVP_CIPHER gost2814789_cfb64 = { 813, 1, 32, 8, 0x100 | 0x40 | 0x3, gost2814789_init_key, gost2814789_cfb64_cipher, 
# 221 "evp/e_gost2814789.c" 3 4
((void *)0)
# 221 "evp/e_gost2814789.c"
, sizeof(EVP_GOST2814789_CTX), gost2814789_set_asn1_params, gost2814789_get_asn1_params, gost2814789_ctl, 
# 221 "evp/e_gost2814789.c" 3 4
((void *)0) 
# 221 "evp/e_gost2814789.c"
}; const EVP_CIPHER *EVP_gost2814789_cfb64(void) { return &gost2814789_cfb64; }



static const EVP_CIPHER gost2814789_cnt = { 814, 1, 32, 8, 0x100 | 0x40 | 0x4, gost2814789_init_key, gost2814789_cnt_cipher, 
# 225 "evp/e_gost2814789.c" 3 4
((void *)0)
# 225 "evp/e_gost2814789.c"
, sizeof(EVP_GOST2814789_CTX), gost2814789_set_asn1_params, gost2814789_get_asn1_params, gost2814789_ctl, 
# 225 "evp/e_gost2814789.c" 3 4
((void *)0) 
# 225 "evp/e_gost2814789.c"
}; const EVP_CIPHER *EVP_gost2814789_cnt(void) { return &gost2814789_cnt; }
