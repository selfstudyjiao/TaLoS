...
X509_policy_level_node_count(X509_POLICY_LEVEL *level)
{
 ...
 if (level->anyPolicy)
  ...
  n = 0;
 if (level->nodes)
  n += sk_num(((_STACK*) (1 ? (level->nodes) : (struct stack_st_X509_POLICY_NODE*)0)));
 return n;
}
...
X509_policy_level_get0_node(X509_POLICY_LEVEL *level, int i)
{
 if (!level)
  return 
# 124 "x509v3/pcy_lib.c" 3 4
        ((void *)0)
# 124 "x509v3/pcy_lib.c"
            ;
 if (level->anyPolicy) {
  if (i == 0)
 ...
 return ((X509_POLICY_NODE *)sk_value(((_STACK*) (1 ? (level->nodes) : (struct stack_st_X509_POLICY_NODE*)0)), (i)));
}
...
X509_policy_node_get0_policy(const X509_POLICY_NODE *node)
{
 if (!node)
  return 
# 139 "x509v3/pcy_lib.c" 3 4
        ((void *)0)
# 139 "x509v3/pcy_lib.c"
            ;
...
X509_policy_node_get0_qualifiers(const X509_POLICY_NODE *node)
{
 if (!node)
  return 
# 147 "x509v3/pcy_lib.c" 3 4
        ((void *)0)
# 147 "x509v3/pcy_lib.c"
            ;
...
X509_policy_node_get0_parent(const X509_POLICY_NODE *node)
{
 if (!node)
  return 
# 155 "x509v3/pcy_lib.c" 3 4
        ((void *)0)
# 155 "x509v3/pcy_lib.c"
            ;
 return node->parent;
}
