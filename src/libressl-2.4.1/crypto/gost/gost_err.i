...
static ERR_STRING_DATA GOST_str_functs[]=
 {
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)104)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "DECODE_GOST01_ALGOR_PARAMS"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)105)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "ENCODE_GOST01_ALGOR_PARAMS"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)106)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "GOST2001_COMPUTE_PUBLIC"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)107)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "GOST2001_DO_SIGN"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)108)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "GOST2001_DO_VERIFY"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)109)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "GOST2001_KEYGEN"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)102)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "GOST89_GET_ASN1_PARAMETERS"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)103)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "GOST89_SET_ASN1_PARAMETERS"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)124)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "GOST_KEY_check_key"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)125)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "GOST_KEY_new"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)126)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "GOST_KEY_set_public_key_affine_coordinates"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)110)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PARAM_COPY_GOST01"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)111)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PARAM_DECODE_GOST01"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)116)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKEY_GOST01_CTRL"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)112)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKEY_GOST01_DECRYPT"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)113)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKEY_GOST01_DERIVE"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)114)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKEY_GOST01_ENCRYPT"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)115)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKEY_GOST01_PARAMGEN"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)123)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKEY_GOST01_SIGN"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)100)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKEY_GOST_MAC_CTRL"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)101)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKEY_GOST_MAC_KEYGEN"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)117)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PRIV_DECODE_GOST01"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)118)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PUB_DECODE_GOST01"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)119)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PUB_ENCODE_GOST01"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)120)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PUB_PRINT_GOST01"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)121)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "UNPACK_SIGNATURE_CP"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)122)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "UNPACK_SIGNATURE_LE"},
{0,
# 100 "gost/gost_err.c" 3 4
  ((void *)0)
# 100 "gost/gost_err.c"
      }
 };
...
static ERR_STRING_DATA GOST_str_reasons[]=
 {
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)104)&0xfffL))),"bad key parameters format"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)105)&0xfffL))),"bad pkey parameters format"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)106)&0xfffL))),"cannot pack ephemeral key"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)107)&0xfffL))) ,"ctrl call failed"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)108)&0xfffL))),"error computing shared key"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)109)&0xfffL))),"error parsing key transport info"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)110)&0xfffL))),"incompatible algorithms"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)111)&0xfffL))),"incompatible peer key"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)100)&0xfffL))) ,"invalid digest type"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)103)&0xfffL))) ,"invalid iv length"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)101)&0xfffL))),"invalid mac key length"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)112)&0xfffL))),"key is not initialized"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)113)&0xfffL))),"key parameters missing"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)102)&0xfffL))) ,"mac key not set"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)115)&0xfffL))) ,"no parameters set"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)116)&0xfffL))) ,"no peer key"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)117)&0xfffL))),"no private part of non ephemeral keypair"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)118)&0xfffL))) ,"public key undefined"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)120)&0xfffL))),"random number generator failed"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)121)&0xfffL))) ,"signature mismatch"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)122)&0xfffL))),"signature parts greater than q"},
{(((((unsigned long)50)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)123)&0xfffL))) ,"ukm not set"},
{0,
# 127 "gost/gost_err.c" 3 4
  ((void *)0)
# 127 "gost/gost_err.c"
      }
 };
...
void ERR_load_GOST_strings(void)
 ...
 if (ERR_func_error_string(GOST_str_functs[0].error) == 
# 136 "gost/gost_err.c" 3 4
                                                       ((void *)0)
# 136 "gost/gost_err.c"
                                                           )
  {
