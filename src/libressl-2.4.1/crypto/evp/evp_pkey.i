...
# 72 "evp/evp_pkey.c"
 ...
 if (!PKCS8_pkey_get0(&algoid, 
# 76 "evp/evp_pkey.c" 3 4
                              ((void *)0)
# 76 "evp/evp_pkey.c"
                                  , 
# 76 "evp/evp_pkey.c" 3 4
...
# 76 "evp/evp_pkey.c"
                                              , p8))
  return 
# 77 "evp/evp_pkey.c" 3 4
        ((void *)0)
# 77 "evp/evp_pkey.c"
            ;

 if (!(pkey = EVP_PKEY_new())) {
  ERR_put_error(6,(111),((1|64)),"evp/evp_pkey.c",80);
  return 
# 81 "evp/evp_pkey.c" 3 4
        ((void *)0)
# 81 "evp/evp_pkey.c"
            ;
 }
 ...
 if (!EVP_PKEY_set_type(pkey, OBJ_obj2nid(algoid))) {
  ERR_put_error(6,(111),(118),"evp/evp_pkey.c",86)
                                              ;
 ...
 if (pkey->ameth->priv_decode) {
  if (!pkey->ameth->priv_decode(pkey, p8)) {
   ERR_put_error(6,(111),(145),"evp/evp_pkey.c",95)
                                      ;
   goto error;
  }
 } else {
  ERR_put_error(6,(111),(144),"evp/evp_pkey.c",99);
  goto error;
 }
...
{
 return EVP_PKEY2PKCS8_broken(pkey, 0);
}
...
EVP_PKEY2PKCS8_broken(EVP_PKEY *pkey, int broken)
{
 ...
 if (!(p8 = PKCS8_PRIV_KEY_INFO_new())) {
  ERR_put_error(6,(113),((1|64)),"evp/evp_pkey.c",124);
  return 
# 125 "evp/evp_pkey.c" 3 4
        ((void *)0)
# 125 "evp/evp_pkey.c"
            ;
 }
 ...
 if (pkey->ameth) {
  if (pkey->ameth->priv_encode) {
   if (!pkey->ameth->priv_encode(p8, pkey)) {
    ERR_put_error(6,(113),(146),"evp/evp_pkey.c",133)
                                       ;
    goto error;
   }
  } else {
   ERR_put_error(6,(113),(144),"evp/evp_pkey.c",138)
                                  ;
   goto error;
  }
 } else {
  ERR_put_error(6,(113),(118),"evp/evp_pkey.c",143)
                                              ;
  goto error;
 }
 return p8;
...
PKCS8_set_broken(PKCS8_PRIV_KEY_INFO *p8, int broken)
{
 ...
 default:
  ERR_put_error(6,(112),(117),"evp/evp_pkey.c",169);
  return 
# 170 "evp/evp_pkey.c" 3 4
        ((void *)0)
# 170 "evp/evp_pkey.c"
            ;
 }
