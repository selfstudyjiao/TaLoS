...
static const ECDH_METHOD *default_ECDH_method = 
# 80 "ecdh/ech_lib.c" 3 4
                                               ((void *)0)
# 80 "ecdh/ech_lib.c"
                                                   ;
...
ECDH_DATA_new_method(ENGINE *engine)
{
 ...
 if (ret == 
# 127 "ecdh/ech_lib.c" 3 4
           ((void *)0)
# 127 "ecdh/ech_lib.c"
               ) {
  ERR_put_error(43,(101),((1|64)),"ecdh/ech_lib.c",128);
  return (
# 129 "ecdh/ech_lib.c" 3 4
         ((void *)0)
# 129 "ecdh/ech_lib.c"
             );
 }
...
# 132 "ecdh/ech_lib.c"
 ...
 if (ret->engine) {
  ...
  if (!ret->meth) {
   ERR_put_error(43,(101),(38),"ecdh/ech_lib.c",142);
   ENGINE_finish(ret->engine);
   free(ret);
   return 
# 145 "ecdh/ech_lib.c" 3 4
         ((void *)0)
# 145 "ecdh/ech_lib.c"
             ;
  }
 ...
 CRYPTO_new_ex_data(13, ret, &ret->ex_data);
 return (ret);
}
...
ecdh_data_new(void)
{
 return (void *)ECDH_DATA_new_method(
# 158 "ecdh/ech_lib.c" 3 4
                                    ((void *)0)
# 158 "ecdh/ech_lib.c"
                                        );
}
...
ecdh_data_dup(void *data)
{
 ...
 if (r == 
# 167 "ecdh/ech_lib.c" 3 4
         ((void *)0)
# 167 "ecdh/ech_lib.c"
             )
  return 
# 168 "ecdh/ech_lib.c" 3 4
        ((void *)0)
# 168 "ecdh/ech_lib.c"
            ;
...
ecdh_data_free(void *data)
{
 ...
 CRYPTO_free_ex_data(13, r, &r->ex_data);
...
ecdh_check(EC_KEY *key)
{
 ...
 if (data == 
# 197 "ecdh/ech_lib.c" 3 4
            ((void *)0)
# 197 "ecdh/ech_lib.c"
                ) {
  ecdh_data = (ECDH_DATA *)ecdh_data_new();
  if (ecdh_data == 
# 199 "ecdh/ech_lib.c" 3 4
                  ((void *)0)
# 199 "ecdh/ech_lib.c"
                      )
   return 
# 200 "ecdh/ech_lib.c" 3 4
         ((void *)0)
# 200 "ecdh/ech_lib.c"
             ;
...
ECDH_get_ex_new_index(long argl, void *argp, CRYPTO_EX_new *new_func,
    CRYPTO_EX_dup *dup_func, CRYPTO_EX_free *free_func)
{
 return CRYPTO_get_ex_new_index(13, argl, argp,
...
ECDH_get_ex_data(EC_KEY *d, int idx)
{
 ...
 ecdh = ecdh_check(d);
 if (ecdh == 
# 238 "ecdh/ech_lib.c" 3 4
            ((void *)0)
# 238 "ecdh/ech_lib.c"
                )
  return 
# 239 "ecdh/ech_lib.c" 3 4
        ((void *)0)
# 239 "ecdh/ech_lib.c"
            ;
