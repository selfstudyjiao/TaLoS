...
{
 BIGNUM *ret = 
# 143 "rsa/rsa_crpt.c" 3 4
              ((void *)0)
# 143 "rsa/rsa_crpt.c"
                  , *r0, *r1, *r2;

 if (d == 
# 145 "rsa/rsa_crpt.c" 3 4
         ((void *)0) 
# 145 "rsa/rsa_crpt.c"
              || p == 
# 145 "rsa/rsa_crpt.c" 3 4
...
# 149 "rsa/rsa_crpt.c" 3 4
                              ((void *)0)
# 149 "rsa/rsa_crpt.c"
                                  )
  goto err;
 if ((r1 = BN_CTX_get(ctx)) == 
# 151 "rsa/rsa_crpt.c" 3 4
                              ((void *)0)
# 151 "rsa/rsa_crpt.c"
                                  )
  goto err;
 if ((r2 = BN_CTX_get(ctx)) == 
# 153 "rsa/rsa_crpt.c" 3 4
                              ((void *)0)
# 153 "rsa/rsa_crpt.c"
                                  )
  goto err;
...
RSA_setup_blinding(RSA *rsa, BN_CTX *in_ctx)
{
 ...
 BN_CTX *ctx;
 BN_BLINDING *ret = 
# 175 "rsa/rsa_crpt.c" 3 4
                   ((void *)0)
# 175 "rsa/rsa_crpt.c"
                       ;

 if (in_ctx == 
# 177 "rsa/rsa_crpt.c" 3 4
              ((void *)0)
# 177 "rsa/rsa_crpt.c"
                  ) {
  if ((ctx = BN_CTX_new()) == 
# 178 "rsa/rsa_crpt.c" 3 4
                             ((void *)0)
# 178 "rsa/rsa_crpt.c"
                                 )
   return 0;
 ...
 if (rsa->e == 
# 185 "rsa/rsa_crpt.c" 3 4
              ((void *)0)
# 185 "rsa/rsa_crpt.c"
                  ) {
  e = rsa_get_public_exp(rsa->d, rsa->p, rsa->q, ctx);
  if (e == 
# 187 "rsa/rsa_crpt.c" 3 4
          ((void *)0)
# 187 "rsa/rsa_crpt.c"
              ) {
   ERR_put_error(4,(136),(140),"rsa/rsa_crpt.c",189)
                                ;
   goto err;
  }
 } else
 ...
 if (!(rsa->flags & 0x0100)) {
  ...
  n = &local_n;
  ((n)->d=(rsa->n)->d, (n)->top=(rsa->n)->top, (n)->dmax=(rsa->n)->dmax, (n)->neg=(rsa->n)->neg, (n)->flags=(((n)->flags & 0x01) | ((rsa->n)->flags & ~0x01) | 0x02 | (0x04)));
 } else
  n = rsa->n;

 ret = BN_BLINDING_create_param(
# 202 "rsa/rsa_crpt.c" 3 4
                               ((void *)0)
# 202 "rsa/rsa_crpt.c"
                                   , e, n, ctx, rsa->meth->bn_mod_exp,
     rsa->_method_mod_n);
 if (ret == 
# 204 "rsa/rsa_crpt.c" 3 4
           ((void *)0)
# 204 "rsa/rsa_crpt.c"
               ) {
  ERR_put_error(4,(136),(3),"rsa/rsa_crpt.c",205);
  goto err;
 }
...
err:
 BN_CTX_end(ctx);
 if (in_ctx == 
# 211 "rsa/rsa_crpt.c" 3 4
              ((void *)0)
# 211 "rsa/rsa_crpt.c"
                  )
  BN_CTX_free(ctx);
 if (rsa->e == 
# 213 "rsa/rsa_crpt.c" 3 4
              ((void *)0)
# 213 "rsa/rsa_crpt.c"
                  )
  BN_free(e);
