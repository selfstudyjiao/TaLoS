...
# 71 "evp/evp_lib.c" 3 4
                                      ((void *)0)
# 71 "evp/evp_lib.c"
                                          )
  ret = c->cipher->set_asn1_parameters(c, type);
 else if (c->cipher->flags & 0x1000)
...
EVP_CIPHER_get_asn1_iv(EVP_CIPHER_CTX *c, ASN1_TYPE *type)
{
 ...
 if (type != 
# 100 "evp/evp_lib.c" 3 4
            ((void *)0)
# 100 "evp/evp_lib.c"
                ) {
  l = EVP_CIPHER_CTX_iv_length(c);
  if (l > sizeof(c->iv)) {
   ERR_put_error(6,(201),(102),"evp/evp_lib.c",104)
                           ;
   return 0;
  }
...
EVP_CIPHER_set_asn1_iv(EVP_CIPHER_CTX *c, ASN1_TYPE *type)
{
 ...
 if (type != 
# 122 "evp/evp_lib.c" 3 4
            ((void *)0)
# 122 "evp/evp_lib.c"
                ) {
  j = EVP_CIPHER_CTX_iv_length(c);
  if (j > sizeof(c->iv)) {
   ERR_put_error(6,(202),(102),"evp/evp_lib.c",126)
                           ;
   return 0;
  }
...
{
 if (!md) {
  ERR_put_error(6,(162),(159),"evp/evp_lib.c",300);
  return -1;
 }
 return md->md_size;
}
