    ...
    const unsigned char *in, size_t inl)
{
 while (inl >= ((size_t)1<<(sizeof(long)*8-2))) {
  DES_ofb64_encrypt(in, out, (long)((size_t)1<<(sizeof(long)*8-2)), ctx->cipher_data,
...
{
 while (inl >= ((size_t)1<<(sizeof(long)*8-2))) {
  DES_ncbc_encrypt(in, out, (long)((size_t)1<<(sizeof(long)*8-2)), ctx->cipher_data,
...
{
 while (inl >= ((size_t)1<<(sizeof(long)*8-2))) {
  DES_cfb64_encrypt(in, out, (long)((size_t)1<<(sizeof(long)*8-2)), ctx->cipher_data,
...
des_cfb1_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out,
    const unsigned char *in, size_t inl)
{
 size_t n, chunk = ((size_t)1<<(sizeof(long)*8-2))/8;
...
{
 while (inl >= ((size_t)1<<(sizeof(long)*8-2))) {
  DES_cfb_encrypt(in, out, 8, (long)((size_t)1<<(sizeof(long)*8-2)),
...
static const EVP_CIPHER des_cbc = { 31, 8, 8, 8, 0x200 | 0x2, des_init_key, des_cbc_cipher, 
# 186 "evp/e_des.c" 3 4
((void *)0)
# 186 "evp/e_des.c"
, sizeof(DES_key_schedule), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, des_ctrl, 
# 186 "evp/e_des.c" 3 4
((void *)0) 
# 186 "evp/e_des.c"
}; const EVP_CIPHER *EVP_des_cbc(void) { return &des_cbc; } static const EVP_CIPHER des_cfb64 = { 30, 1, 8, 8, 0x200 | 0x3, des_init_key, des_cfb64_cipher, 
# 186 "evp/e_des.c" 3 4
((void *)0)
# 186 "evp/e_des.c"
, sizeof(DES_key_schedule), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, des_ctrl, 
...
((void *)0) 
# 186 "evp/e_des.c"
}; const EVP_CIPHER *EVP_des_cfb64(void) { return &des_cfb64; } static const EVP_CIPHER des_ofb = { 45, 1, 8, 8, 0x200 | 0x4, des_init_key, des_ofb_cipher, 
# 186 "evp/e_des.c" 3 4
((void *)0)
# 186 "evp/e_des.c"
, sizeof(DES_key_schedule), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, des_ctrl, 
...
((void *)0) 
# 186 "evp/e_des.c"
}; const EVP_CIPHER *EVP_des_ofb(void) { return &des_ofb; } static const EVP_CIPHER des_ecb = { 29, 8, 8, 0, 0x200 | 0x1, des_init_key, des_ecb_cipher, 
# 186 "evp/e_des.c" 3 4
((void *)0)
# 186 "evp/e_des.c"
, sizeof(DES_key_schedule), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, des_ctrl, 
...
static const EVP_CIPHER des_cfb1 = { 656, 1, 8, 8, 0x200 | 0x3, des_init_key, des_cfb1_cipher, 
# 192 "evp/e_des.c" 3 4
((void *)0)
# 192 "evp/e_des.c"
, sizeof(DES_key_schedule), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, des_ctrl, 
...
static const EVP_CIPHER des_cfb8 = { 657, 1, 8, 8, 0x200 | 0x3, des_init_key, des_cfb8_cipher, 
# 197 "evp/e_des.c" 3 4
((void *)0)
# 197 "evp/e_des.c"
, sizeof(DES_key_schedule), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, des_ctrl, 
