    ...
    int flen)
{
 ...
 if (flen > tlen - 11) {
  ERR_put_error(4,(110),(110),"rsa/rsa_ssl.c",76)
                                        ;
  return 0;
 }
    ...
    int flen, int num)
{
 ...
 p = from;
 if (flen < 10) {
  ERR_put_error(4,(114),(111),"rsa/rsa_ssl.c",112);
  return -1;
 }
 if (num != flen + 1 || *(p++) != 02) {
  ERR_put_error(4,(114),(107),"rsa/rsa_ssl.c",117)
                                 ;
  return -1;
 }
 ...
 if (i == j || i < 8) {
  ERR_put_error(4,(114),(113),"rsa/rsa_ssl.c",129)
                                      ;
  return -1;
 }
 for (k = -9; k < -1; k++) {
 ...
 if (k == -1) {
  ERR_put_error(4,(114),(115),"rsa/rsa_ssl.c",138)
                                  ;
  return -1;
 }
 ...
 j -= i;
 if (j > tlen) {
  ERR_put_error(4,(114),(109),"rsa/rsa_ssl.c",145);
  return -1;
 }
 memcpy(to, p, j);
