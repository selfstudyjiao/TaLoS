...
{
 hm_fragment *frag = 
# 174 "../ssl/d1_both.c" 3 4
                    ((void *)0)
# 174 "../ssl/d1_both.c"
                        ;
 unsigned char *buf = 
# 175 "../ssl/d1_both.c" 3 4
                     ((void *)0)
# 175 "../ssl/d1_both.c"
                         ;
 unsigned char *bitmask = 
# 176 "../ssl/d1_both.c" 3 4
                         ((void *)0)
# 176 "../ssl/d1_both.c"
                             ;
 ...
 if (frag == 
# 179 "../ssl/d1_both.c" 3 4
            ((void *)0)
# 179 "../ssl/d1_both.c"
                )
  return 
# 180 "../ssl/d1_both.c" 3 4
        ((void *)0)
# 180 "../ssl/d1_both.c"
            ;
 ...
 if (frag_len) {
  buf = malloc(frag_len);
  if (buf == 
# 184 "../ssl/d1_both.c" 3 4
            ((void *)0)
# 184 "../ssl/d1_both.c"
                ) {
   free(frag);
   return 
# 186 "../ssl/d1_both.c" 3 4
         ((void *)0)
# 186 "../ssl/d1_both.c"
             ;
  }
 ...
 if (reassembly) {
  bitmask = malloc((((frag_len) + 7) / 8));
  if (bitmask == 
# 196 "../ssl/d1_both.c" 3 4
                ((void *)0)
# 196 "../ssl/d1_both.c"
                    ) {
   free(buf);
   free(frag);
   return 
# 199 "../ssl/d1_both.c" 3 4
         ((void *)0)
# 199 "../ssl/d1_both.c"
             ;
  }
  memset(bitmask, 0, (((frag_len) + 7) / 8));
 }
...
dtls1_do_write(SSL *s, int type)
{
 ...
 if (s->d1->mtu < dtls1_min_mtu() &&
     !(SSL_ctrl((s),32,0,
# 236 "../ssl/d1_both.c" 3 4
      ((void *)0)
# 236 "../ssl/d1_both.c"
      ) & 0x00001000L)) {
  s->d1->mtu = BIO_ctrl(SSL_get_wbio(s),
      40, 0, 
# 238 "../ssl/d1_both.c" 3 4
                                  ((void *)0)
# 238 "../ssl/d1_both.c"
                                      );
  ...
  if (s->d1->mtu < dtls1_min_mtu()) {
   ...
   BIO_ctrl(SSL_get_wbio(s), 42,
       s->d1->mtu, 
# 249 "../ssl/d1_both.c" 3 4
                  ((void *)0)
# 249 "../ssl/d1_both.c"
                      );
  }
 ...
 (void)((s->d1->mtu >= dtls1_min_mtu()) ? 0 : (OpenSSLDie("../ssl/d1_both.c", 253, "s->d1->mtu >= dtls1_min_mtu()"),1));


 if (s->init_off == 0 && type == 22)
  (void)((s->init_num == (int)s->d1->w_msg_hdr.msg_len + 12) ? 0 : (OpenSSLDie(
                                                            "../ssl/d1_both.c"
# 257 "../ssl/d1_both.c"
  ,
                                                            258
# 257 "../ssl/d1_both.c"
  , "s->init_num == (int)s->d1->w_msg_hdr.msg_len + DTLS1_HM_HEADER_LENGTH"),1))
                                                             ;

 if (s->write_hash)
  mac_size = EVP_MD_size(EVP_MD_CTX_md(s->write_hash));
 else
  mac_size = 0;

 if (s->enc_write_ctx &&
     ((EVP_CIPHER_flags(s->enc_write_ctx->cipher) & 0xF0007) & 0x2))
 ...
 frag_off = 0;
 while (s->init_num) {
  curr_mtu = s->d1->mtu - (int)BIO_ctrl(SSL_get_wbio(s),13,0,
# 273 "../ssl/d1_both.c" 3 4
                         ((void *)0)
# 273 "../ssl/d1_both.c"
                         ) -
      13 - mac_size - blocksize;

  if (curr_mtu <= 12) {

   ret = (int)BIO_ctrl(SSL_get_wbio(s),11,0,
# 278 "../ssl/d1_both.c" 3 4
        ((void *)0)
# 278 "../ssl/d1_both.c"
        );
   if (ret <= 0)
    return ret;
   curr_mtu = s->d1->mtu - 13 -
       mac_size - blocksize;
  }
  ...
  if (type == 22) {
   if (s->init_off != 0) {
    (void)((s->init_off > 12) ? 0 : (OpenSSLDie("../ssl/d1_both.c", 294, "s->init_off > DTLS1_HM_HEADER_LENGTH"),1));
    s->init_off -= 12;
    s->init_num += 12;
   ...
   (void)((len >= 12) ? 0 : (OpenSSLDie("../ssl/d1_both.c", 310, "len >= DTLS1_HM_HEADER_LENGTH"),1));
  }
  ...
  if (ret < 0) {
   ...
   if (BIO_ctrl(SSL_get_wbio(s),
       43, 0, 
# 324 "../ssl/d1_both.c" 3 4
                                      ((void *)0)
# 324 "../ssl/d1_both.c"
                                          ) > 0)
    s->d1->mtu = BIO_ctrl(SSL_get_wbio(s),
        40, 0, 
# 326 "../ssl/d1_both.c" 3 4
                                    ((void *)0)
# 326 "../ssl/d1_both.c"
                                        );
   else
   ...
   (void)((len == (unsigned int)ret) ? 0 : (OpenSSLDie("../ssl/d1_both.c", 336, "len == (unsigned int)ret"),1));
   ...
   if (type == 22 &&
     ...
     *p++ = msg_hdr->type;
     ((p[0]=(unsigned char)(((msg_hdr->msg_len)>>16)&0xff), p[1]=(unsigned char)(((msg_hdr->msg_len)>> 8)&0xff), p[2]=(unsigned char)(((msg_hdr->msg_len) )&0xff)),p+=3);
     ((p[0]=(unsigned char)(((msg_hdr->seq)>> 8)&0xff), p[1]=(unsigned char)(((msg_hdr->seq) )&0xff)),p+=2);
     ((p[0]=(unsigned char)(((0)>>16)&0xff), p[1]=(unsigned char)(((0)>> 8)&0xff), p[2]=(unsigned char)(((0) )&0xff)),p+=3);
     ((p[0]=(unsigned char)(((msg_hdr->msg_len)>>16)&0xff), p[1]=(unsigned char)(((msg_hdr->msg_len)>> 8)&0xff), p[2]=(unsigned char)(((msg_hdr->msg_len) )&0xff)),p+=3);
     p -= 12;
     xlen = ret;
    } else {
...
dtls1_get_message(SSL *s, int st1, int stn, int mt, long max, int *ok)
{
 ...
 if (s->s3->tmp.reuse_message) {
  ...
  if ((mt >= 0) && (s->s3->tmp.message_type != mt)) {
   al = 10;
   ERR_put_error(20,(252),(244),"../ssl/d1_both.c",414)
                                ;
   goto f_err;
  }
  *ok = 1;
 ...
 *(p++) = msg_hdr->type;
 ((p[0]=(unsigned char)(((msg_len)>>16)&0xff), p[1]=(unsigned char)(((msg_len)>> 8)&0xff), p[2]=(unsigned char)(((msg_len) )&0xff)),p+=3);
 ((p[0]=(unsigned char)(((msg_hdr->seq)>> 8)&0xff), p[1]=(unsigned char)(((msg_hdr->seq) )&0xff)),p+=2);
 ((p[0]=(unsigned char)(((0)>>16)&0xff), p[1]=(unsigned char)(((0)>> 8)&0xff), p[2]=(unsigned char)(((0) )&0xff)),p+=3);
 ((p[0]=(unsigned char)(((msg_len)>>16)&0xff), p[1]=(unsigned char)(((msg_len)>> 8)&0xff), p[2]=(unsigned char)(((msg_len) )&0xff)),p+=3);
 ...
 if (s->msg_callback)
  s->msg_callback(0, s->version, 22, p, msg_len,
      s, s->msg_callback_arg);
...
dtls1_preprocess_fragment(SSL *s, struct hm_header_st *msg_hdr, int max)
{
 ...
 if ((frag_off + frag_len) > msg_len) {
  ERR_put_error(20,(288),(152),"../ssl/d1_both.c",480)
                                   ;
  return 47;
 }

 if ((frag_off + frag_len) > (unsigned long)max) {
  ERR_put_error(20,(288),(152),"../ssl/d1_both.c",486)
                                   ;
  return 47;
 }
 ...
 if ( s->d1->r_msg_hdr.frag_off == 0)
 {
  ...
  if (!BUF_MEM_grow_clean(s->init_buf,
      msg_len + 12)) {
   ERR_put_error(20,(288),(7),"../ssl/d1_both.c",498);
   return 80;
  }
  ...
  ERR_put_error(20,(288),(152),"../ssl/d1_both.c",513)
                                   ;
  return 47;
 }
...
# 541 "../ssl/d1_both.c"
 ...
 if (s->d1->handshake_read_seq == frag->msg_header.seq) {
  ...
  if (al == 0)
  {
   unsigned char *p = (unsigned char *)s->init_buf->data + 12;
...
{
 hm_fragment *frag = 
# 592 "../ssl/d1_both.c" 3 4
                    ((void *)0)
# 592 "../ssl/d1_both.c"
                        ;
 pitem *item = 
# 593 "../ssl/d1_both.c" 3 4
              ((void *)0)
# 593 "../ssl/d1_both.c"
                  ;
 int i = -1, is_complete;
 ...
 if (item == 
# 613 "../ssl/d1_both.c" 3 4
            ((void *)0)
# 613 "../ssl/d1_both.c"
                ) {
  frag = dtls1_hm_fragment_new(msg_hdr->msg_len, 1);
  if (frag == 
# 615 "../ssl/d1_both.c" 3 4
             ((void *)0)
# 615 "../ssl/d1_both.c"
                 )
   goto err;
  ...
  if (frag->msg_header.msg_len != msg_hdr->msg_len) {
   item = 
# 623 "../ssl/d1_both.c" 3 4
         ((void *)0)
# 623 "../ssl/d1_both.c"
             ;
   frag = 
# 624 "../ssl/d1_both.c" 3 4
         ((void *)0)
# 624 "../ssl/d1_both.c"
             ;
   goto err;
...
# 633 "../ssl/d1_both.c"
  ...
  while (frag_len) {
   i = s->method->ssl_read_bytes(s, 22,
 ...
 { long ii; (void)((((long)msg_hdr->msg_len) > 0) ? 0 : (OpenSSLDie(
                "../ssl/d1_both.c"
# 657 "../ssl/d1_both.c"
 ,
                658
# 657 "../ssl/d1_both.c"
 , "((long)msg_hdr->msg_len) > 0"),1)); is_complete = 1; if (frag->reassembly[((((long)msg_hdr->msg_len) - 1) >> 3)] != bitmask_end_values[(((long)msg_hdr->msg_len) & 7)]) is_complete = 0; if (is_complete) for (ii = ((((long)msg_hdr->msg_len) - 1) >> 3) - 1; ii >= 0 ; ii--) if (frag->reassembly[ii] != 0xff) { is_complete = 0; break; } }
                 ;

 if (is_complete) {
  free(frag->reassembly);
  frag->reassembly = 
# 662 "../ssl/d1_both.c" 3 4
                    ((void *)0)
# 662 "../ssl/d1_both.c"
                        ;
 }
...
dtls1_process_out_of_seq_message(SSL *s, struct hm_header_st* msg_hdr, int *ok)
{
 int i = -1;
 hm_fragment *frag = 
# 693 "../ssl/d1_both.c" 3 4
                    ((void *)0)
# 693 "../ssl/d1_both.c"
                        ;
 pitem *item = 
# 694 "../ssl/d1_both.c" 3 4
              ((void *)0)
# 694 "../ssl/d1_both.c"
                  ;
 unsigned char seq64be[8];
 ...
 if (item != 
# 711 "../ssl/d1_both.c" 3 4
            ((void *)0) 
# 711 "../ssl/d1_both.c"
                 && frag_len < msg_hdr->msg_len)
  item = 
# 712 "../ssl/d1_both.c" 3 4
        ((void *)0)
# 712 "../ssl/d1_both.c"
            ;
 ...
 if (msg_hdr->seq <= s->d1->handshake_read_seq ||
     msg_hdr->seq > s->d1->handshake_read_seq + 10 || item != 
# 721 "../ssl/d1_both.c" 3 4
                                                             ((void *)0) 
# 721 "../ssl/d1_both.c"
                                                                  ||
...
again:
 ...
 i = s->method->ssl_read_bytes(s, 22, wire,
     12, 0);
 if (i <= 0)
 {
  s->rwstate = 3;
 ...
 if (i != 12 ||
  ...
  al = 10;
  ERR_put_error(20,(253),(244),"../ssl/d1_both.c",807)
                               ;
  goto f_err;
 }
 ...
 if (!s->server && s->d1->r_msg_hdr.frag_off == 0 &&
  ...
  {
   al = 10;
   ERR_put_error(20,(253),(244),"../ssl/d1_both.c",850)
                                ;
   goto f_err;
  }
 }
 ...
 if (i != (int)frag_len) {
  al = 47;
  ERR_put_error(20,(253),(47),"../ssl/d1_both.c",882)
                                ;
  goto f_err;
 }
...
dtls1_send_change_cipher_spec(SSL *s, int a, int b)
{
  ...
  *p++=1;
  ...
  dtls1_set_message_header_int(s, 1, 0,
...
dtls1_add_cert_to_buf(BUF_MEM *buf, unsigned long *l, X509 *x)
{
 ...
 n = i2d_X509(x, 
# 945 "../ssl/d1_both.c" 3 4
                ((void *)0)
# 945 "../ssl/d1_both.c"
                    );
 if (!BUF_MEM_grow_clean(buf, n + (*l) + 3)) {
  ERR_put_error(20,(295),(7),"../ssl/d1_both.c",947);
  return 0;
 }
 p = (unsigned char *)&(buf->data[*l]);
 ((p[0]=(unsigned char)(((n)>>16)&0xff), p[1]=(unsigned char)(((n)>> 8)&0xff), p[2]=(unsigned char)(((n) )&0xff)),p+=3);
 i2d_X509(x, &p);
 *l += n + 3;
...
dtls1_output_cert_chain(SSL *s, X509 *x)
{
 unsigned char *p;
 int i;
 unsigned long l = 3 + 12;
 BUF_MEM *buf;


 buf = s->init_buf;
 if (!BUF_MEM_grow_clean(buf, 10)) {
  ERR_put_error(20,(255),(7),"../ssl/d1_both.c",969);
  return (0);
 }
 if (x != 
# 972 "../ssl/d1_both.c" 3 4
         ((void *)0)
# 972 "../ssl/d1_both.c"
             ) {
  ...
  if (!X509_STORE_CTX_init(&xs_ctx, s->ctx->cert_store,
      x, 
# 976 "../ssl/d1_both.c" 3 4
        ((void *)0)
# 976 "../ssl/d1_both.c"
            )) {
   ERR_put_error(20,(255),(11),"../ssl/d1_both.c",977);
   return (0);
  }
  ...
  ERR_clear_error();
  for (i = 0; i < sk_num(((_STACK*) (1 ? (xs_ctx.chain) : (struct stack_st_X509*)0))); i++) {
   x = ((X509 *)sk_value(((_STACK*) (1 ? (xs_ctx.chain) : (struct stack_st_X509*)0)), (i)));
 ...
 for (i = 0; i < sk_num(((_STACK*) (1 ? (s->ctx->extra_certs) : (struct stack_st_X509*)0))); i++) {
  x = ((X509 *)sk_value(((_STACK*) (1 ? (s->ctx->extra_certs) : (struct stack_st_X509*)0)), (i)));
  if (!dtls1_add_cert_to_buf(buf, &l, x))
   return 0;
 }
 ...
 p = (unsigned char *)&(buf->data[12]);
 ((p[0]=(unsigned char)(((l)>>16)&0xff), p[1]=(unsigned char)(((l)>> 8)&0xff), p[2]=(unsigned char)(((l) )&0xff)),p+=3);
 l += 3;
 p = (unsigned char *)&(buf->data[0]);
 p = dtls1_set_message_header(s, p, 11, l, 0, l);
...
dtls1_read_failed(SSL *s, int code)
{
 ...
 if (!(SSL_state(s)&(0x1000|0x2000)))
 {
  BIO_set_flags(SSL_get_rbio(s), 0x01);
  return code;
 }
...
dtls1_retransmit_buffered_messages(SSL *s)
{
 ...
 for (item = pqueue_next(&iter); item != 
# 1069 "../ssl/d1_both.c" 3 4
                                        ((void *)0)
# 1069 "../ssl/d1_both.c"
                                            ;
...
dtls1_buffer_message(SSL *s, int is_ccs)
{
 ...
 (void)((s->init_off == 0) ? 0 : (OpenSSLDie("../ssl/d1_both.c", 1099, "s->init_off == 0"),1));

 frag = dtls1_hm_fragment_new(s->init_num, 0);
 if (frag == 
# 1102 "../ssl/d1_both.c" 3 4
            ((void *)0)
# 1102 "../ssl/d1_both.c"
                )
  return 0;
 ...
 if (is_ccs) {
  (void)((s->d1->w_msg_hdr.msg_len + ((s->version == 0xFEFF) ? 1 : 3) == (unsigned int)s->init_num) ? 0 : (OpenSSLDie(
...
# 1108 "../ssl/d1_both.c"
  ,
                                                               ...
                                                               1110
# 1108 "../ssl/d1_both.c"
  , "s->d1->w_msg_hdr.msg_len + ((s->version == DTLS1_VERSION) ? DTLS1_CCS_HEADER_LENGTH : 3) == (unsigned int)s->init_num"),1))

                                                                ;
 } else {
  (void)((s->d1->w_msg_hdr.msg_len + 12 == (unsigned int)s->init_num) ? 0 : (OpenSSLDie(
                                                         "../ssl/d1_both.c"
# 1112 "../ssl/d1_both.c"
  ,
                                                         1113
# 1112 "../ssl/d1_both.c"
  , "s->d1->w_msg_hdr.msg_len + DTLS1_HM_HEADER_LENGTH == (unsigned int)s->init_num"),1))
                                                          ;
 }
 ...
 *found = 1;
 ...
 (void)(int)BIO_ctrl(SSL_get_wbio(s),11,0,
# 1234 "../ssl/d1_both.c" 3 4
      ((void *)0)
# 1234 "../ssl/d1_both.c"
      );
 return ret;
...
dtls1_clear_record_buffer(SSL *s)
{
 ...
 for(item = pqueue_pop(s->d1->sent_messages); item != 
# 1244 "../ssl/d1_both.c" 3 4
                                                     ((void *)0)
# 1244 "../ssl/d1_both.c"
                                                         ;
 ...
 *p++ = msg_hdr->type;
 ...
 ((p[0]=(unsigned char)(((msg_hdr->seq)>> 8)&0xff), p[1]=(unsigned char)(((msg_hdr->seq) )&0xff)),p+=2);
 ((p[0]=(unsigned char)(((msg_hdr->frag_off)>>16)&0xff), p[1]=(unsigned char)(((msg_hdr->frag_off)>> 8)&0xff), p[2]=(unsigned char)(((msg_hdr->frag_off) )&0xff)),p+=3);
 ((p[0]=(unsigned char)(((msg_hdr->frag_len)>>16)&0xff), p[1]=(unsigned char)(((msg_hdr->frag_len)>> 8)&0xff), p[2]=(unsigned char)(((msg_hdr->frag_len) )&0xff)),p+=3);
