...
nullf_read(BIO *b, char *out, int outl)
{
 ...
 if (out == 
# 120 "bio/bf_null.c" 3 4
           ((void *)0)
# 120 "bio/bf_null.c"
               )
  return (0);
 if (b->next_bio == 
# 122 "bio/bf_null.c" 3 4
                   ((void *)0)
# 122 "bio/bf_null.c"
                       )
  return (0);
...
nullf_write(BIO *b, const char *in, int inl)
{
 ...
 if ((in == 
# 135 "bio/bf_null.c" 3 4
           ((void *)0)
# 135 "bio/bf_null.c"
               ) || (inl <= 0))
  return (0);
 if (b->next_bio == 
# 137 "bio/bf_null.c" 3 4
                   ((void *)0)
# 137 "bio/bf_null.c"
                       )
  return (0);
