...
static int cast5_cbc_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { while(inl>=((size_t)1<<(sizeof(long)*8-2))) { CAST_cbc_encrypt(in, out, (long)((size_t)1<<(sizeof(long)*8-2)), &((EVP_CAST_KEY *)ctx->cipher_data)->ks, ctx->iv, ctx->encrypt); inl-=((size_t)1<<(sizeof(long)*8-2)); in +=((size_t)1<<(sizeof(long)*8-2)); out+=((size_t)1<<(sizeof(long)*8-2)); } if (inl) CAST_cbc_encrypt(in, out, (long)inl, &((EVP_CAST_KEY *)ctx->cipher_data)->ks, ctx->iv, ctx->encrypt); return 1;} static int cast5_cfb64_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { size_t chunk=((size_t)1<<(sizeof(long)*8-2)); if (64==1) chunk>>=3; if (inl<chunk) chunk=inl; while(inl && inl>=chunk) { CAST_cfb64_encrypt(in, out, (long)((64==1) && !(ctx->flags & 0x2000) ?inl*8:inl), &((EVP_CAST_KEY *)ctx->cipher_data)->ks, ctx->iv, &ctx->num, ctx->encrypt); inl-=chunk; in +=chunk; out+=chunk; if(inl<chunk) chunk=inl; } return 1;} static int cast5_ecb_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { size_t i, bl; bl = ctx->cipher->block_size; if(inl < bl) return 1; inl -= bl; for(i=0; i <= inl; i+=bl) CAST_ecb_encrypt(in + i, out + i, &((EVP_CAST_KEY *)ctx->cipher_data)->ks, ctx->encrypt); return 1;} static int cast5_ofb_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { while(inl>=((size_t)1<<(sizeof(long)*8-2))) { CAST_ofb64_encrypt(in, out, (long)((size_t)1<<(sizeof(long)*8-2)), &((EVP_CAST_KEY *)ctx->cipher_data)->ks, ctx->iv, &ctx->num); inl-=((size_t)1<<(sizeof(long)*8-2)); in +=((size_t)1<<(sizeof(long)*8-2)); out+=((size_t)1<<(sizeof(long)*8-2)); } if (inl) CAST_ofb64_encrypt(in, out, (long)inl, &((EVP_CAST_KEY *)ctx->cipher_data)->ks, ctx->iv, &ctx->num); return 1;} static const EVP_CIPHER cast5_cbc = { 108, 8, 16, 8, 0x8 | 0x2, cast_init_key, cast5_cbc_cipher, 
# 80 "evp/e_cast.c" 3 4
((void *)0)
# 80 "evp/e_cast.c"
, sizeof(EVP_CAST_KEY), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, 
# 80 "evp/e_cast.c" 3 4
((void *)0)
# 80 "evp/e_cast.c"
, 
...
((void *)0) 
# 80 "evp/e_cast.c"
}; const EVP_CIPHER *EVP_cast5_cbc(void) { return &cast5_cbc; } static const EVP_CIPHER cast5_cfb64 = { 110, 1, 16, 8, 0x8 | 0x3, cast_init_key, cast5_cfb64_cipher, 
# 80 "evp/e_cast.c" 3 4
((void *)0)
# 80 "evp/e_cast.c"
, sizeof(EVP_CAST_KEY), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, 
...
((void *)0) 
# 80 "evp/e_cast.c"
}; const EVP_CIPHER *EVP_cast5_cfb64(void) { return &cast5_cfb64; } static const EVP_CIPHER cast5_ofb = { 111, 1, 16, 8, 0x8 | 0x4, cast_init_key, cast5_ofb_cipher, 
# 80 "evp/e_cast.c" 3 4
((void *)0)
# 80 "evp/e_cast.c"
, sizeof(EVP_CAST_KEY), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, 
...
((void *)0) 
# 80 "evp/e_cast.c"
}; const EVP_CIPHER *EVP_cast5_ofb(void) { return &cast5_ofb; } static const EVP_CIPHER cast5_ecb = { 109, 8, 16, 0, 0x8 | 0x1, cast_init_key, cast5_ecb_cipher, 
# 80 "evp/e_cast.c" 3 4
((void *)0)
# 80 "evp/e_cast.c"
, sizeof(EVP_CAST_KEY), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, 
...
cast_init_key(EVP_CIPHER_CTX *ctx, const unsigned char *key,
    const unsigned char *iv, int enc)
{
 CAST_set_key(&((EVP_CAST_KEY *)(ctx)->cipher_data)->ks, EVP_CIPHER_CTX_key_length(ctx), key);
 return 1;
}
