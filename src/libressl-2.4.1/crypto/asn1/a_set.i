...
# 1 "../include/openssl/asn1_mac.h" 1
...
# 63 "../include/openssl/asn1_mac.h" 2
# 420 "../include/openssl/asn1_mac.h"
...
int
i2d_ASN1_SET(struct stack_st_OPENSSL_BLOCK *a, unsigned char **pp, i2d_of_void *i2d,
    int ex_tag, int ex_class, int is_set)
{
 ...
 if (a == 
# 101 "asn1/a_set.c" 3 4
         ((void *)0)
# 101 "asn1/a_set.c"
             )
  return 0;
 for (i = sk_num(((_STACK*) (1 ? a : (struct stack_st_OPENSSL_BLOCK*)0))) - 1; i >= 0; i--)
  ret += i2d(((OPENSSL_BLOCK)sk_value(((_STACK*) (1 ? a : (struct stack_st_OPENSSL_BLOCK*)0)), i)), 
# 104 "asn1/a_set.c" 3 4
                                          ((void *)0)
# 104 "asn1/a_set.c"
                                              );
 r = ASN1_object_size(1, ret, ex_tag);
 if (pp == 
# 106 "asn1/a_set.c" 3 4
          ((void *)0)
# 106 "asn1/a_set.c"
              )
  return r;
 ...
 if (!is_set || (sk_num(((_STACK*) (1 ? a : (struct stack_st_OPENSSL_BLOCK*)0))) < 2)) {
  for (i = 0; i < sk_num(((_STACK*) (1 ? a : (struct stack_st_OPENSSL_BLOCK*)0))); i++)
   i2d(((OPENSSL_BLOCK)sk_value(((_STACK*) (1 ? a : (struct stack_st_OPENSSL_BLOCK*)0)), i)), &p);
 ...
 rgSetBlob = reallocarray(
# 126 "asn1/a_set.c" 3 4
                         ((void *)0)
# 126 "asn1/a_set.c"
                             , sk_num(((_STACK*) (1 ? a : (struct stack_st_OPENSSL_BLOCK*)0))), sizeof(MYBLOB));
 if (rgSetBlob == 
# 127 "asn1/a_set.c" 3 4
                 ((void *)0)
# 127 "asn1/a_set.c"
                     ) {
  ERR_put_error(13,(188),((1|64)),"asn1/a_set.c",128);
  return 0;
 }
 ...
 *pp = p;
 ...
 qsort(rgSetBlob, sk_num(((_STACK*) (1 ? a : (struct stack_st_OPENSSL_BLOCK*)0))), sizeof(MYBLOB), SetBlobCmp);
 if ((pTempMem = malloc(totSize)) == 
# 147 "asn1/a_set.c" 3 4
                                    ((void *)0)
# 147 "asn1/a_set.c"
                                        ) {
  free(rgSetBlob);
  ERR_put_error(13,(188),((1|64)),"asn1/a_set.c",149);
  return 0;
 }
...
d2i_ASN1_SET(struct stack_st_OPENSSL_BLOCK **a, const unsigned char **pp, long length,
    d2i_of_void *d2i, void (*free_func)(OPENSSL_BLOCK), int ex_tag,
    int ex_class)
{
 ASN1_const_CTX c;
 struct stack_st_OPENSSL_BLOCK *ret = 
# 174 "asn1/a_set.c" 3 4
                               ((void *)0)
# 174 "asn1/a_set.c"
                                   ;

 if (a == 
# 176 "asn1/a_set.c" 3 4
         ((void *)0) 
# 176 "asn1/a_set.c"
              || (*a) == 
# 176 "asn1/a_set.c" 3 4
...
# 176 "asn1/a_set.c"
  ...
  if ((ret = ((struct stack_st_OPENSSL_BLOCK *)sk_new_null())) == 
# 177 "asn1/a_set.c" 3 4
                                            ((void *)0)
# 177 "asn1/a_set.c"
                                                ) {
   ERR_put_error(13,(148),((1|64)),"asn1/a_set.c",178);
   goto err;
  }
 } else
  ret = *a;
 ...
 if (ex_class != c.xclass) {
  ERR_put_error(13,(148),(101),"asn1/a_set.c",191);
  goto err;
 }
 if (ex_tag != c.tag) {
  ERR_put_error(13,(148),(104),"asn1/a_set.c",195);
  goto err;
 }
 if (c.slen + c.p > c.max) {
  ERR_put_error(13,(148),(136),"asn1/a_set.c",199);
  goto err;
 }
 ...
 while (c.p < c.max) {
  ...
  if ((((c.inf&1) == 0)?(c.slen <= 0): (c.eos=ASN1_const_check_infinite_end(&c.p,c.slen))))
   break;
  if ((s = d2i(
# 213 "asn1/a_set.c" 3 4
              ((void *)0)
# 213 "asn1/a_set.c"
                  , &c.p, c.slen)) == 
# 213 "asn1/a_set.c" 3 4
...
# 213 "asn1/a_set.c"
   ...
   ERR_put_error(13,(148),(113),"asn1/a_set.c",215)
                                        ;
   asn1_add_error(*pp, (int)(c.p - *pp));
   goto err;
  }
  if (!sk_push(((_STACK*) (1 ? ret : (struct stack_st_OPENSSL_BLOCK*)0)), ((void*) (1 ? s : (void*)0))))
   goto err;
 }
 if (a != 
# 222 "asn1/a_set.c" 3 4
         ((void *)0)
# 222 "asn1/a_set.c"
             )
  *a = ret;
...
err:
 if (a == 
# 228 "asn1/a_set.c" 3 4
         ((void *)0) 
# 228 "asn1/a_set.c"
              || *a != ret) {
  if (free_func != 
# 229 "asn1/a_set.c" 3 4
                  ((void *)0)
# 229 "asn1/a_set.c"
                      )
   sk_pop_free(((_STACK*) (1 ? ret : (struct stack_st_OPENSSL_BLOCK*)0)), ((void (*)(void *)) ((1 ? free_func : (void (*)(OPENSSL_BLOCK))0))));
  else
   sk_free(((_STACK*) (1 ? ret : (struct stack_st_OPENSSL_BLOCK*)0)));
 }
 return 
# 234 "asn1/a_set.c" 3 4
       ((void *)0)
# 234 "asn1/a_set.c"
           ;
}
