...
# 89 "asn1/evp_asn1.c" 3 4
                              ((void *)0)
# 89 "asn1/evp_asn1.c"
                                  )) {
  ERR_put_error(13,(135),(109),"asn1/evp_asn1.c",90);
  return (-1);
 }
    ...
    int len)
{
 ...
 n = i2d_ASN1_INTEGER(&in, 
# 119 "asn1/evp_asn1.c" 3 4
                          ((void *)0)
# 119 "asn1/evp_asn1.c"
                              );
 n += i2d_ASN1_bytes((ASN1_STRING *)&os, 
# 120 "asn1/evp_asn1.c" 3 4
                                        ((void *)0)
# 120 "asn1/evp_asn1.c"
                                            , 4,
     0x00);

 size = ASN1_object_size(1, n, 16);

 if ((osp = ASN1_STRING_new()) == 
# 125 "asn1/evp_asn1.c" 3 4
                                 ((void *)0)
# 125 "asn1/evp_asn1.c"
                                     )
  return (0);

 if (!ASN1_STRING_set(osp, 
# 128 "asn1/evp_asn1.c" 3 4
                          ((void *)0)
# 128 "asn1/evp_asn1.c"
                              , size)) {
 ...
 ASN1_put_object(&p, 1,n, 16, 0x00);
 i2d_ASN1_INTEGER(&in, &p);
 i2d_ASN1_bytes((ASN1_STRING *)&os, &p, 4,
     0x00);

 ASN1_TYPE_set(a, 16, osp);
 return (1);
}
    ...
    int max_len)
{
 int ret = -1, n;
 ASN1_INTEGER *ai = 
# 153 "asn1/evp_asn1.c" 3 4
                   ((void *)0)
# 153 "asn1/evp_asn1.c"
                       ;
 ASN1_OCTET_STRING *os = 
# 154 "asn1/evp_asn1.c" 3 4
                        ((void *)0)
# 154 "asn1/evp_asn1.c"
                            ;
 const unsigned char *p;
 ...
 if ((a->type != 16) || (a->value.sequence == 
# 159 "asn1/evp_asn1.c" 3 4
                                                          ((void *)0)
# 159 "asn1/evp_asn1.c"
                                                              )) {
  goto err;
 ...
 if (!asn1_GetSequence(&c,&length)) { c.line=170; goto err; };
 c.q = c.p;
 if ((ai = d2i_ASN1_INTEGER(
# 172 "asn1/evp_asn1.c" 3 4
                           ((void *)0)
# 172 "asn1/evp_asn1.c"
                               , &c.p, c.slen)) == 
# 172 "asn1/evp_asn1.c" 3 4
...
# 172 "asn1/evp_asn1.c"
 ...
 c.slen -= (c.p - c.q);
 c.q = c.p;
 if ((os = d2i_ASN1_OCTET_STRING(
# 176 "asn1/evp_asn1.c" 3 4
                                ((void *)0)
# 176 "asn1/evp_asn1.c"
                                    , &c.p, c.slen)) == 
# 176 "asn1/evp_asn1.c" 3 4
...
# 191 "asn1/evp_asn1.c"
 ...
 if (0) {
err:
  ERR_put_error(13,(134),(109),"asn1/evp_asn1.c",196)
                           ;
 }
 ASN1_OCTET_STRING_free(os);
