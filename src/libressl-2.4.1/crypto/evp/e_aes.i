...
# 63 "evp/e_aes.c" 2
# 1 "../crypto/modes/modes_lcl.h" 1
# 9 "../crypto/modes/modes_lcl.h"
# 1 "../include/compat/machine/endian.h" 1
# 10 "../crypto/modes/modes_lcl.h" 2

# 1 "../include/openssl/opensslconf.h" 1
# 1 "../include/openssl/opensslfeatures.h" 1
# 2 "../include/openssl/opensslconf.h" 2
# 12 "../crypto/modes/modes_lcl.h" 2
...
# 68 "../crypto/modes/modes_lcl.h"
typedef struct { u64 hi,lo; } u128;
# 79 "../crypto/modes/modes_lcl.h"
...
# 233 "evp/e_aes.c"
 ...
 if (ret < 0) {
  ERR_put_error(6,(165),(143),"evp/e_aes.c",237);
  return 0;
 }
...
# 567 "evp/e_aes.c"
 ...
 if (ret < 0) {
  ERR_put_error(6,(133),(143),"evp/e_aes.c",575);
  return 0;
 }
    ...
    const unsigned char *in, size_t len)
{
 ...
 while (len >= ((size_t)1<<(sizeof(size_t)*8-4))) {
  CRYPTO_cfb128_1_encrypt(in, out, ((size_t)1<<(sizeof(size_t)*8-4))*8, &dat->ks,
...
static const EVP_CIPHER aesni_128_cbc = { .nid = 419, .block_size = 16, .key_len = 128 / 8, .iv_len = 16, .flags = 0x4000|0x1000 | 0x2, .init = aesni_init_key, .do_cipher = aesni_cbc_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; static const EVP_CIPHER aes_128_cbc = { .nid = 419, .block_size = 16, .key_len = 128 / 8, .iv_len = 16, .flags = 0x4000|0x1000 | 0x2, .init = aes_init_key, .do_cipher = aes_cbc_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; const EVP_CIPHER * EVP_aes_128_cbc(void) { return (OPENSSL_ia32cap_P[1]&(1<<(57-32))) ? &aesni_128_cbc : &aes_128_cbc; } static const EVP_CIPHER aesni_128_ecb = { .nid = 418, .block_size = 16, .key_len = 128 / 8, .iv_len = 0, .flags = 0x4000|0x1000 | 0x1, .init = aesni_init_key, .do_cipher = aesni_ecb_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; static const EVP_CIPHER aes_128_ecb = { .nid = 418, .block_size = 16, .key_len = 128 / 8, .iv_len = 0, .flags = 0x4000|0x1000 | 0x1, .init = aes_init_key, .do_cipher = aes_ecb_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; const EVP_CIPHER * EVP_aes_128_ecb(void) { return (OPENSSL_ia32cap_P[1]&(1<<(57-32))) ? &aesni_128_ecb : &aes_128_ecb; } static const EVP_CIPHER aesni_128_ofb = { .nid = 420, .block_size = 1, .key_len = 128 / 8, .iv_len = 16, .flags = 0x4000|0x1000 | 0x4, .init = aesni_init_key, .do_cipher = aes_ofb_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; static const EVP_CIPHER aes_128_ofb = { .nid = 420, .block_size = 1, .key_len = 128 / 8, .iv_len = 16, .flags = 0x4000|0x1000 | 0x4, .init = aes_init_key, .do_cipher = aes_ofb_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; const EVP_CIPHER * EVP_aes_128_ofb(void) { return (OPENSSL_ia32cap_P[1]&(1<<(57-32))) ? &aesni_128_ofb : &aes_128_ofb; } static const EVP_CIPHER aesni_128_cfb = { .nid = 421, .block_size = 1, .key_len = 128 / 8, .iv_len = 16, .flags = 0x4000|0x1000 | 0x3, .init = aesni_init_key, .do_cipher = aes_cfb_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; static const EVP_CIPHER aes_128_cfb = { .nid = 421, .block_size = 1, .key_len = 128 / 8, .iv_len = 16, .flags = 0x4000|0x1000 | 0x3, .init = aes_init_key, .do_cipher = aes_cfb_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; const EVP_CIPHER * EVP_aes_128_cfb128(void) { return (OPENSSL_ia32cap_P[1]&(1<<(57-32))) ? &aesni_128_cfb : &aes_128_cfb; } static const EVP_CIPHER aesni_128_cfb1 = { .nid = 650, .block_size = 1, .key_len = 128 / 8, .iv_len = 16, .flags = 0x4000 | 0x3, .init = aesni_init_key, .do_cipher = aes_cfb1_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; static const EVP_CIPHER aes_128_cfb1 = { .nid = 650, .block_size = 1, .key_len = 128 / 8, .iv_len = 16, .flags = 0x4000 | 0x3, .init = aes_init_key, .do_cipher = aes_cfb1_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; const EVP_CIPHER * EVP_aes_128_cfb1(void) { return (OPENSSL_ia32cap_P[1]&(1<<(57-32))) ? &aesni_128_cfb1 : &aes_128_cfb1; } static const EVP_CIPHER aesni_128_cfb8 = { .nid = 653, .block_size = 1, .key_len = 128 / 8, .iv_len = 16, .flags = 0x4000 | 0x3, .init = aesni_init_key, .do_cipher = aes_cfb8_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; static const EVP_CIPHER aes_128_cfb8 = { .nid = 653, .block_size = 1, .key_len = 128 / 8, .iv_len = 16, .flags = 0x4000 | 0x3, .init = aes_init_key, .do_cipher = aes_cfb8_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; const EVP_CIPHER * EVP_aes_128_cfb8(void) { return (OPENSSL_ia32cap_P[1]&(1<<(57-32))) ? &aesni_128_cfb8 : &aes_128_cfb8; } static const EVP_CIPHER aesni_128_ctr = { .nid = 904, .block_size = 1, .key_len = 128 / 8, .iv_len = 16, .flags = 0x4000 | 0x5, .init = aesni_init_key, .do_cipher = aes_ctr_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; static const EVP_CIPHER aes_128_ctr = { .nid = 904, .block_size = 1, .key_len = 128 / 8, .iv_len = 16, .flags = 0x4000 | 0x5, .init = aes_init_key, .do_cipher = aes_ctr_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; const EVP_CIPHER * EVP_aes_128_ctr(void) { return (OPENSSL_ia32cap_P[1]&(1<<(57-32))) ? &aesni_128_ctr : &aes_128_ctr; }
static const EVP_CIPHER aesni_192_cbc = { .nid = 423, .block_size = 16, .key_len = 192 / 8, .iv_len = 16, .flags = 0x4000|0x1000 | 0x2, .init = aesni_init_key, .do_cipher = aesni_cbc_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; static const EVP_CIPHER aes_192_cbc = { .nid = 423, .block_size = 16, .key_len = 192 / 8, .iv_len = 16, .flags = 0x4000|0x1000 | 0x2, .init = aes_init_key, .do_cipher = aes_cbc_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; const EVP_CIPHER * EVP_aes_192_cbc(void) { return (OPENSSL_ia32cap_P[1]&(1<<(57-32))) ? &aesni_192_cbc : &aes_192_cbc; } static const EVP_CIPHER aesni_192_ecb = { .nid = 422, .block_size = 16, .key_len = 192 / 8, .iv_len = 0, .flags = 0x4000|0x1000 | 0x1, .init = aesni_init_key, .do_cipher = aesni_ecb_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; static const EVP_CIPHER aes_192_ecb = { .nid = 422, .block_size = 16, .key_len = 192 / 8, .iv_len = 0, .flags = 0x4000|0x1000 | 0x1, .init = aes_init_key, .do_cipher = aes_ecb_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; const EVP_CIPHER * EVP_aes_192_ecb(void) { return (OPENSSL_ia32cap_P[1]&(1<<(57-32))) ? &aesni_192_ecb : &aes_192_ecb; } static const EVP_CIPHER aesni_192_ofb = { .nid = 424, .block_size = 1, .key_len = 192 / 8, .iv_len = 16, .flags = 0x4000|0x1000 | 0x4, .init = aesni_init_key, .do_cipher = aes_ofb_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; static const EVP_CIPHER aes_192_ofb = { .nid = 424, .block_size = 1, .key_len = 192 / 8, .iv_len = 16, .flags = 0x4000|0x1000 | 0x4, .init = aes_init_key, .do_cipher = aes_ofb_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; const EVP_CIPHER * EVP_aes_192_ofb(void) { return (OPENSSL_ia32cap_P[1]&(1<<(57-32))) ? &aesni_192_ofb : &aes_192_ofb; } static const EVP_CIPHER aesni_192_cfb = { .nid = 425, .block_size = 1, .key_len = 192 / 8, .iv_len = 16, .flags = 0x4000|0x1000 | 0x3, .init = aesni_init_key, .do_cipher = aes_cfb_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; static const EVP_CIPHER aes_192_cfb = { .nid = 425, .block_size = 1, .key_len = 192 / 8, .iv_len = 16, .flags = 0x4000|0x1000 | 0x3, .init = aes_init_key, .do_cipher = aes_cfb_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; const EVP_CIPHER * EVP_aes_192_cfb128(void) { return (OPENSSL_ia32cap_P[1]&(1<<(57-32))) ? &aesni_192_cfb : &aes_192_cfb; } static const EVP_CIPHER aesni_192_cfb1 = { .nid = 651, .block_size = 1, .key_len = 192 / 8, .iv_len = 16, .flags = 0x4000 | 0x3, .init = aesni_init_key, .do_cipher = aes_cfb1_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; static const EVP_CIPHER aes_192_cfb1 = { .nid = 651, .block_size = 1, .key_len = 192 / 8, .iv_len = 16, .flags = 0x4000 | 0x3, .init = aes_init_key, .do_cipher = aes_cfb1_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; const EVP_CIPHER * EVP_aes_192_cfb1(void) { return (OPENSSL_ia32cap_P[1]&(1<<(57-32))) ? &aesni_192_cfb1 : &aes_192_cfb1; } static const EVP_CIPHER aesni_192_cfb8 = { .nid = 654, .block_size = 1, .key_len = 192 / 8, .iv_len = 16, .flags = 0x4000 | 0x3, .init = aesni_init_key, .do_cipher = aes_cfb8_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; static const EVP_CIPHER aes_192_cfb8 = { .nid = 654, .block_size = 1, .key_len = 192 / 8, .iv_len = 16, .flags = 0x4000 | 0x3, .init = aes_init_key, .do_cipher = aes_cfb8_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; const EVP_CIPHER * EVP_aes_192_cfb8(void) { return (OPENSSL_ia32cap_P[1]&(1<<(57-32))) ? &aesni_192_cfb8 : &aes_192_cfb8; } static const EVP_CIPHER aesni_192_ctr = { .nid = 905, .block_size = 1, .key_len = 192 / 8, .iv_len = 16, .flags = 0x4000 | 0x5, .init = aesni_init_key, .do_cipher = aes_ctr_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; static const EVP_CIPHER aes_192_ctr = { .nid = 905, .block_size = 1, .key_len = 192 / 8, .iv_len = 16, .flags = 0x4000 | 0x5, .init = aes_init_key, .do_cipher = aes_ctr_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; const EVP_CIPHER * EVP_aes_192_ctr(void) { return (OPENSSL_ia32cap_P[1]&(1<<(57-32))) ? &aesni_192_ctr : &aes_192_ctr; }
static const EVP_CIPHER aesni_256_cbc = { .nid = 427, .block_size = 16, .key_len = 256 / 8, .iv_len = 16, .flags = 0x4000|0x1000 | 0x2, .init = aesni_init_key, .do_cipher = aesni_cbc_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; static const EVP_CIPHER aes_256_cbc = { .nid = 427, .block_size = 16, .key_len = 256 / 8, .iv_len = 16, .flags = 0x4000|0x1000 | 0x2, .init = aes_init_key, .do_cipher = aes_cbc_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; const EVP_CIPHER * EVP_aes_256_cbc(void) { return (OPENSSL_ia32cap_P[1]&(1<<(57-32))) ? &aesni_256_cbc : &aes_256_cbc; } static const EVP_CIPHER aesni_256_ecb = { .nid = 426, .block_size = 16, .key_len = 256 / 8, .iv_len = 0, .flags = 0x4000|0x1000 | 0x1, .init = aesni_init_key, .do_cipher = aesni_ecb_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; static const EVP_CIPHER aes_256_ecb = { .nid = 426, .block_size = 16, .key_len = 256 / 8, .iv_len = 0, .flags = 0x4000|0x1000 | 0x1, .init = aes_init_key, .do_cipher = aes_ecb_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; const EVP_CIPHER * EVP_aes_256_ecb(void) { return (OPENSSL_ia32cap_P[1]&(1<<(57-32))) ? &aesni_256_ecb : &aes_256_ecb; } static const EVP_CIPHER aesni_256_ofb = { .nid = 428, .block_size = 1, .key_len = 256 / 8, .iv_len = 16, .flags = 0x4000|0x1000 | 0x4, .init = aesni_init_key, .do_cipher = aes_ofb_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; static const EVP_CIPHER aes_256_ofb = { .nid = 428, .block_size = 1, .key_len = 256 / 8, .iv_len = 16, .flags = 0x4000|0x1000 | 0x4, .init = aes_init_key, .do_cipher = aes_ofb_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; const EVP_CIPHER * EVP_aes_256_ofb(void) { return (OPENSSL_ia32cap_P[1]&(1<<(57-32))) ? &aesni_256_ofb : &aes_256_ofb; } static const EVP_CIPHER aesni_256_cfb = { .nid = 429, .block_size = 1, .key_len = 256 / 8, .iv_len = 16, .flags = 0x4000|0x1000 | 0x3, .init = aesni_init_key, .do_cipher = aes_cfb_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; static const EVP_CIPHER aes_256_cfb = { .nid = 429, .block_size = 1, .key_len = 256 / 8, .iv_len = 16, .flags = 0x4000|0x1000 | 0x3, .init = aes_init_key, .do_cipher = aes_cfb_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; const EVP_CIPHER * EVP_aes_256_cfb128(void) { return (OPENSSL_ia32cap_P[1]&(1<<(57-32))) ? &aesni_256_cfb : &aes_256_cfb; } static const EVP_CIPHER aesni_256_cfb1 = { .nid = 652, .block_size = 1, .key_len = 256 / 8, .iv_len = 16, .flags = 0x4000 | 0x3, .init = aesni_init_key, .do_cipher = aes_cfb1_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; static const EVP_CIPHER aes_256_cfb1 = { .nid = 652, .block_size = 1, .key_len = 256 / 8, .iv_len = 16, .flags = 0x4000 | 0x3, .init = aes_init_key, .do_cipher = aes_cfb1_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; const EVP_CIPHER * EVP_aes_256_cfb1(void) { return (OPENSSL_ia32cap_P[1]&(1<<(57-32))) ? &aesni_256_cfb1 : &aes_256_cfb1; } static const EVP_CIPHER aesni_256_cfb8 = { .nid = 655, .block_size = 1, .key_len = 256 / 8, .iv_len = 16, .flags = 0x4000 | 0x3, .init = aesni_init_key, .do_cipher = aes_cfb8_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; static const EVP_CIPHER aes_256_cfb8 = { .nid = 655, .block_size = 1, .key_len = 256 / 8, .iv_len = 16, .flags = 0x4000 | 0x3, .init = aes_init_key, .do_cipher = aes_cfb8_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; const EVP_CIPHER * EVP_aes_256_cfb8(void) { return (OPENSSL_ia32cap_P[1]&(1<<(57-32))) ? &aesni_256_cfb8 : &aes_256_cfb8; } static const EVP_CIPHER aesni_256_ctr = { .nid = 906, .block_size = 1, .key_len = 256 / 8, .iv_len = 16, .flags = 0x4000 | 0x5, .init = aesni_init_key, .do_cipher = aes_ctr_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; static const EVP_CIPHER aes_256_ctr = { .nid = 906, .block_size = 1, .key_len = 256 / 8, .iv_len = 16, .flags = 0x4000 | 0x5, .init = aes_init_key, .do_cipher = aes_ctr_cipher, .ctx_size = sizeof(EVP_AES_KEY) }; const EVP_CIPHER * EVP_aes_256_ctr(void) { return (OPENSSL_ia32cap_P[1]&(1<<(57-32))) ? &aesni_256_ctr : &aes_256_ctr; }
...
static const EVP_CIPHER aesni_128_gcm = { .nid = 895, .block_size = 1, .key_len = (0x6 == 0x10001 ? 2 : 1) * 128 / 8, .iv_len = 12, .flags = 0x4000|0x200000|( 0x1000 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400 ) | 0x6, .init = aesni_gcm_init_key, .do_cipher = aes_gcm_cipher, .cleanup = aes_gcm_cleanup, .ctx_size = sizeof(EVP_AES_GCM_CTX), .ctrl = aes_gcm_ctrl }; static const EVP_CIPHER aes_128_gcm = { .nid = 895, .block_size = 1, .key_len = (0x6 == 0x10001 ? 2 : 1) * 128 / 8, .iv_len = 12, .flags = 0x4000|0x200000|( 0x1000 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400 ) | 0x6, .init = aes_gcm_init_key, .do_cipher = aes_gcm_cipher, .cleanup = aes_gcm_cleanup, .ctx_size = sizeof(EVP_AES_GCM_CTX), .ctrl = aes_gcm_ctrl }; const EVP_CIPHER * EVP_aes_128_gcm(void) { return (OPENSSL_ia32cap_P[1]&(1<<(57-32))) ? &aesni_128_gcm : &aes_128_gcm; }

static const EVP_CIPHER aesni_192_gcm = { .nid = 898, .block_size = 1, .key_len = (0x6 == 0x10001 ? 2 : 1) * 192 / 8, .iv_len = 12, .flags = 0x4000|0x200000|( 0x1000 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400 ) | 0x6, .init = aesni_gcm_init_key, .do_cipher = aes_gcm_cipher, .cleanup = aes_gcm_cleanup, .ctx_size = sizeof(EVP_AES_GCM_CTX), .ctrl = aes_gcm_ctrl }; static const EVP_CIPHER aes_192_gcm = { .nid = 898, .block_size = 1, .key_len = (0x6 == 0x10001 ? 2 : 1) * 192 / 8, .iv_len = 12, .flags = 0x4000|0x200000|( 0x1000 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400 ) | 0x6, .init = aes_gcm_init_key, .do_cipher = aes_gcm_cipher, .cleanup = aes_gcm_cleanup, .ctx_size = sizeof(EVP_AES_GCM_CTX), .ctrl = aes_gcm_ctrl }; const EVP_CIPHER * EVP_aes_192_gcm(void) { return (OPENSSL_ia32cap_P[1]&(1<<(57-32))) ? &aesni_192_gcm : &aes_192_gcm; }

static const EVP_CIPHER aesni_256_gcm = { .nid = 901, .block_size = 1, .key_len = (0x6 == 0x10001 ? 2 : 1) * 256 / 8, .iv_len = 12, .flags = 0x4000|0x200000|( 0x1000 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400 ) | 0x6, .init = aesni_gcm_init_key, .do_cipher = aes_gcm_cipher, .cleanup = aes_gcm_cleanup, .ctx_size = sizeof(EVP_AES_GCM_CTX), .ctrl = aes_gcm_ctrl }; static const EVP_CIPHER aes_256_gcm = { .nid = 901, .block_size = 1, .key_len = (0x6 == 0x10001 ? 2 : 1) * 256 / 8, .iv_len = 12, .flags = 0x4000|0x200000|( 0x1000 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400 ) | 0x6, .init = aes_gcm_init_key, .do_cipher = aes_gcm_cipher, .cleanup = aes_gcm_cleanup, .ctx_size = sizeof(EVP_AES_GCM_CTX), .ctrl = aes_gcm_ctrl }; const EVP_CIPHER * EVP_aes_256_gcm(void) { return (OPENSSL_ia32cap_P[1]&(1<<(57-32))) ? &aesni_256_gcm : &aes_256_gcm; }
...
aes_xts_ctrl(EVP_CIPHER_CTX *c, int type, int arg, void *ptr)
{
 ...
 case 0x0:
  ...
  xctx->xts.key1 = 
# 1081 "evp/e_aes.c" 3 4
                  ((void *)0)
# 1081 "evp/e_aes.c"
                      ;
  xctx->xts.key2 = 
# 1082 "evp/e_aes.c" 3 4
                  ((void *)0)
# 1082 "evp/e_aes.c"
                      ;
  return 1;
...
static const EVP_CIPHER aesni_128_xts = { .nid = 913, .block_size = 1, .key_len = (0x10001 == 0x10001 ? 2 : 1) * 128 / 8, .iv_len = 16, .flags = 0x4000|( 0x1000 | 0x10 | 0x20 | 0x40 | 0x400 ) | 0x10001, .init = aesni_xts_init_key, .do_cipher = aes_xts_cipher, .cleanup = 
# 1199 "evp/e_aes.c" 3 4
((void *)0)
# 1199 "evp/e_aes.c"
, .ctx_size = sizeof(EVP_AES_XTS_CTX), .ctrl = aes_xts_ctrl }; static const EVP_CIPHER aes_128_xts = { .nid = 913, .block_size = 1, .key_len = (0x10001 == 0x10001 ? 2 : 1) * 128 / 8, .iv_len = 16, .flags = 0x4000|( 0x1000 | 0x10 | 0x20 | 0x40 | 0x400 ) | 0x10001, .init = aes_xts_init_key, .do_cipher = aes_xts_cipher, .cleanup = 
# 1199 "evp/e_aes.c" 3 4
((void *)0)
# 1199 "evp/e_aes.c"
, .ctx_size = sizeof(EVP_AES_XTS_CTX), .ctrl = aes_xts_ctrl }; const EVP_CIPHER * EVP_aes_128_xts(void) { return (OPENSSL_ia32cap_P[1]&(1<<(57-32))) ? &aesni_128_xts : &aes_128_xts; }
static const EVP_CIPHER aesni_256_xts = { .nid = 914, .block_size = 1, .key_len = (0x10001 == 0x10001 ? 2 : 1) * 256 / 8, .iv_len = 16, .flags = 0x4000|( 0x1000 | 0x10 | 0x20 | 0x40 | 0x400 ) | 0x10001, .init = aesni_xts_init_key, .do_cipher = aes_xts_cipher, .cleanup = 
# 1200 "evp/e_aes.c" 3 4
((void *)0)
# 1200 "evp/e_aes.c"
, .ctx_size = sizeof(EVP_AES_XTS_CTX), .ctrl = aes_xts_ctrl }; static const EVP_CIPHER aes_256_xts = { .nid = 914, .block_size = 1, .key_len = (0x10001 == 0x10001 ? 2 : 1) * 256 / 8, .iv_len = 16, .flags = 0x4000|( 0x1000 | 0x10 | 0x20 | 0x40 | 0x400 ) | 0x10001, .init = aes_xts_init_key, .do_cipher = aes_xts_cipher, .cleanup = 
# 1200 "evp/e_aes.c" 3 4
((void *)0)
# 1200 "evp/e_aes.c"
, .ctx_size = sizeof(EVP_AES_XTS_CTX), .ctrl = aes_xts_ctrl }; const EVP_CIPHER * EVP_aes_256_xts(void) { return (OPENSSL_ia32cap_P[1]&(1<<(57-32))) ? &aesni_256_xts : &aes_256_xts; }
...
static const EVP_CIPHER aesni_128_ccm = { .nid = 896, .block_size = 1, .key_len = (0x7 == 0x10001 ? 2 : 1) * 128 / 8, .iv_len = 12, .flags = 0x4000|( 0x1000 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400 ) | 0x7, .init = aesni_ccm_init_key, .do_cipher = aes_ccm_cipher, .cleanup = 
# 1362 "evp/e_aes.c" 3 4
((void *)0)
# 1362 "evp/e_aes.c"
, .ctx_size = sizeof(EVP_AES_CCM_CTX), .ctrl = aes_ccm_ctrl }; static const EVP_CIPHER aes_128_ccm = { .nid = 896, .block_size = 1, .key_len = (0x7 == 0x10001 ? 2 : 1) * 128 / 8, .iv_len = 12, .flags = 0x4000|( 0x1000 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400 ) | 0x7, .init = aes_ccm_init_key, .do_cipher = aes_ccm_cipher, .cleanup = 
# 1362 "evp/e_aes.c" 3 4
((void *)0)
# 1362 "evp/e_aes.c"
, .ctx_size = sizeof(EVP_AES_CCM_CTX), .ctrl = aes_ccm_ctrl }; const EVP_CIPHER * EVP_aes_128_ccm(void) { return (OPENSSL_ia32cap_P[1]&(1<<(57-32))) ? &aesni_128_ccm : &aes_128_ccm; }

static const EVP_CIPHER aesni_192_ccm = { .nid = 899, .block_size = 1, .key_len = (0x7 == 0x10001 ? 2 : 1) * 192 / 8, .iv_len = 12, .flags = 0x4000|( 0x1000 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400 ) | 0x7, .init = aesni_ccm_init_key, .do_cipher = aes_ccm_cipher, .cleanup = 
# 1364 "evp/e_aes.c" 3 4
((void *)0)
# 1364 "evp/e_aes.c"
, .ctx_size = sizeof(EVP_AES_CCM_CTX), .ctrl = aes_ccm_ctrl }; static const EVP_CIPHER aes_192_ccm = { .nid = 899, .block_size = 1, .key_len = (0x7 == 0x10001 ? 2 : 1) * 192 / 8, .iv_len = 12, .flags = 0x4000|( 0x1000 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400 ) | 0x7, .init = aes_ccm_init_key, .do_cipher = aes_ccm_cipher, .cleanup = 
# 1364 "evp/e_aes.c" 3 4
((void *)0)
# 1364 "evp/e_aes.c"
, .ctx_size = sizeof(EVP_AES_CCM_CTX), .ctrl = aes_ccm_ctrl }; const EVP_CIPHER * EVP_aes_192_ccm(void) { return (OPENSSL_ia32cap_P[1]&(1<<(57-32))) ? &aesni_192_ccm : &aes_192_ccm; }

static const EVP_CIPHER aesni_256_ccm = { .nid = 902, .block_size = 1, .key_len = (0x7 == 0x10001 ? 2 : 1) * 256 / 8, .iv_len = 12, .flags = 0x4000|( 0x1000 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400 ) | 0x7, .init = aesni_ccm_init_key, .do_cipher = aes_ccm_cipher, .cleanup = 
# 1366 "evp/e_aes.c" 3 4
((void *)0)
# 1366 "evp/e_aes.c"
, .ctx_size = sizeof(EVP_AES_CCM_CTX), .ctrl = aes_ccm_ctrl }; static const EVP_CIPHER aes_256_ccm = { .nid = 902, .block_size = 1, .key_len = (0x7 == 0x10001 ? 2 : 1) * 256 / 8, .iv_len = 12, .flags = 0x4000|( 0x1000 | 0x10 | 0x100000 | 0x20 | 0x40 | 0x400 ) | 0x7, .init = aes_ccm_init_key, .do_cipher = aes_ccm_cipher, .cleanup = 
# 1366 "evp/e_aes.c" 3 4
((void *)0)
# 1366 "evp/e_aes.c"
, .ctx_size = sizeof(EVP_AES_CCM_CTX), .ctrl = aes_ccm_ctrl }; const EVP_CIPHER * EVP_aes_256_ccm(void) { return (OPENSSL_ia32cap_P[1]&(1<<(57-32))) ? &aesni_256_ccm : &aes_256_ccm; }
    ...
    size_t tag_len)
{
 ...
 if (key_bits != 128 && key_bits != 256) {
  ERR_put_error(6,(187),(137),"evp/e_aes.c",1390);
  return 0;
 }
 ...
 if (tag_len > 16) {
  ERR_put_error(6,(187),(171),"evp/e_aes.c",1398);
  return 0;
 }

 gcm_ctx = malloc(sizeof(struct aead_aes_gcm_ctx));
 if (gcm_ctx == 
# 1403 "evp/e_aes.c" 3 4
               ((void *)0)
# 1403 "evp/e_aes.c"
                   )
  return 0;
    ...
    size_t ad_len)
{
 ...
 if (max_out_len < in_len + gcm_ctx->tag_len) {
  ERR_put_error(6,(189),(155),"evp/e_aes.c",1444);
  return 0;
 }
    ...
    size_t ad_len)
{
 ...
 if (in_len < gcm_ctx->tag_len) {
  ERR_put_error(6,(188),(100),"evp/e_aes.c",1483);
  return 0;
 }
 ...
 if (max_out_len < plaintext_len) {
  ERR_put_error(6,(188),(155),"evp/e_aes.c",1490);
  return 0;
 }
 ...
 if (timingsafe_memcmp(tag, in + plaintext_len, gcm_ctx->tag_len) != 0) {
  ERR_put_error(6,(188),(100),"evp/e_aes.c",1512);
  return 0;
 }
