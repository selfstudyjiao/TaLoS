...
# 48 "../ssl/bs_cbb.c"
 ...
 if (initial_capacity > 0) {
  if ((buf = malloc(initial_capacity)) == 
# 53 "../ssl/bs_cbb.c" 3 4
                                         ((void *)0)
# 53 "../ssl/bs_cbb.c"
                                             )
...
CBB_finish(CBB *cbb, uint8_t **out_data, size_t *out_len)
{
 ...
 if (cbb->base->can_resize && (out_data == 
# 159 "../ssl/bs_cbb.c" 3 4
                                          ((void *)0) 
# 159 "../ssl/bs_cbb.c"
                                               || out_len == 
# 159 "../ssl/bs_cbb.c" 3 4
...
# 214 "../ssl/bs_cbb.c"
 "cbb->pending_len_len == 1"
# 214 "../ssl/bs_cbb.c" 3 4
 , "../ssl/bs_cbb.c", 214, __PRETTY_FUNCTION__))
# 214 "../ssl/bs_cbb.c"
                                   ;
...
# 245 "../ssl/bs_cbb.c"
 ...
 cbb->child->base = 
# 262 "../ssl/bs_cbb.c" 3 4
                   ((void *)0)
# 262 "../ssl/bs_cbb.c"
                       ;
 cbb->child = 
# 263 "../ssl/bs_cbb.c" 3 4
             ((void *)0)
# 263 "../ssl/bs_cbb.c"
                 ;
 cbb->pending_len_len = 0;
...
CBB_add_asn1_uint64(CBB *cbb, uint64_t value)
{
 ...
 if (!CBB_add_asn1(cbb, &child, (0x00 | 0x00 | 0x2)))
  return 0;
