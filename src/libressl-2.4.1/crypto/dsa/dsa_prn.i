...
# 71 "dsa/dsa_prn.c" 3 4
                                   ((void *)0)
# 71 "dsa/dsa_prn.c"
                                       ) {
  ERR_put_error(10,(105),(7),"dsa/dsa_prn.c",72);
  return 0;
 }
...
DSAparams_print_fp(FILE *fp, const DSA *x)
{
 ...
 if ((b = BIO_new(BIO_s_file())) == 
# 87 "dsa/dsa_prn.c" 3 4
                                   ((void *)0)
# 87 "dsa/dsa_prn.c"
                                       ) {
  ERR_put_error(10,(101),(7),"dsa/dsa_prn.c",88);
  return 0;
 }
 BIO_ctrl(b,106,0x00,(char *)fp);
