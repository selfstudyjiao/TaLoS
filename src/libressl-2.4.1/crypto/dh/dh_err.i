...
static ERR_STRING_DATA DH_str_functs[]=
 {
{(((((unsigned long)5)&0xffL)<<24L)| ((((unsigned long)102)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "COMPUTE_KEY"},
{(((((unsigned long)5)&0xffL)<<24L)| ((((unsigned long)101)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "DHparams_print_fp"},
{(((((unsigned long)5)&0xffL)<<24L)| ((((unsigned long)106)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "DH_BUILTIN_GENPARAMS"},
{(((((unsigned long)5)&0xffL)<<24L)| ((((unsigned long)114)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "DH_compute_key"},
{(((((unsigned long)5)&0xffL)<<24L)| ((((unsigned long)115)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "DH_generate_key"},
{(((((unsigned long)5)&0xffL)<<24L)| ((((unsigned long)116)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "DH_generate_parameters_ex"},
{(((((unsigned long)5)&0xffL)<<24L)| ((((unsigned long)105)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "DH_new_method"},
{(((((unsigned long)5)&0xffL)<<24L)| ((((unsigned long)107)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "DH_PARAM_DECODE"},
{(((((unsigned long)5)&0xffL)<<24L)| ((((unsigned long)110)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "DH_PRIV_DECODE"},
{(((((unsigned long)5)&0xffL)<<24L)| ((((unsigned long)111)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "DH_PRIV_ENCODE"},
{(((((unsigned long)5)&0xffL)<<24L)| ((((unsigned long)108)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "DH_PUB_DECODE"},
{(((((unsigned long)5)&0xffL)<<24L)| ((((unsigned long)109)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "DH_PUB_ENCODE"},
{(((((unsigned long)5)&0xffL)<<24L)| ((((unsigned long)100)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "DO_DH_PRINT"},
{(((((unsigned long)5)&0xffL)<<24L)| ((((unsigned long)103)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "GENERATE_KEY"},
{(((((unsigned long)5)&0xffL)<<24L)| ((((unsigned long)104)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "GENERATE_PARAMETERS"},
{(((((unsigned long)5)&0xffL)<<24L)| ((((unsigned long)112)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKEY_DH_DERIVE"},
{(((((unsigned long)5)&0xffL)<<24L)| ((((unsigned long)113)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKEY_DH_KEYGEN"},
{0,
# 93 "dh/dh_err.c" 3 4
  ((void *)0)
# 93 "dh/dh_err.c"
...
static ERR_STRING_DATA DH_str_reasons[]=
 {
{(((((unsigned long)5)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)101)&0xfffL))) ,"bad generator"},
{(((((unsigned long)5)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)109)&0xfffL))) ,"bn decode error"},
{(((((unsigned long)5)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)106)&0xfffL))) ,"bn error"},
{(((((unsigned long)5)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)104)&0xfffL))) ,"decode error"},
{(((((unsigned long)5)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)102)&0xfffL))) ,"invalid public key"},
{(((((unsigned long)5)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)108)&0xfffL))) ,"keys not set"},
{(((((unsigned long)5)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)110)&0xfffL))) ,"key size too small"},
{(((((unsigned long)5)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)103)&0xfffL))) ,"modulus too large"},
{(((((unsigned long)5)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)111)&0xfffL))) ,"non fips method"},
{(((((unsigned long)5)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)107)&0xfffL))) ,"no parameters set"},
{(((((unsigned long)5)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)100)&0xfffL))) ,"no private value"},
{(((((unsigned long)5)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)105)&0xfffL))),"parameter encoding error"},
{0,
# 110 "dh/dh_err.c" 3 4
  ((void *)0)
# 110 "dh/dh_err.c"
...
void ERR_load_DH_strings(void)
 ...
 if (ERR_func_error_string(DH_str_functs[0].error) == 
# 119 "dh/dh_err.c" 3 4
                                                     ((void *)0)
# 119 "dh/dh_err.c"
                                                         )
