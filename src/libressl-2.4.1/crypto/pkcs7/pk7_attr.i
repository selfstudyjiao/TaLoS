...
# 68 "pkcs7/pk7_attr.c" 2

int
PKCS7_add_attrib_smimecap(PKCS7_SIGNER_INFO *si, struct stack_st_X509_ALGOR *cap)
{
 ASN1_STRING *seq;
 if (!(seq = ASN1_STRING_new())) {
  ERR_put_error(33,(118),((1|64)),"pkcs7/pk7_attr.c",75)
                           ;
  return 0;
 }
 seq->length = ASN1_item_i2d((ASN1_VALUE *)cap, &seq->data,
     (&(X509_ALGORS_it)));
 return PKCS7_add_signed_attribute(si, 167,
     16, seq);
}
...
PKCS7_get_smimecap(PKCS7_SIGNER_INFO *si)
{
 ...
 cap = PKCS7_get_signed_attribute(si, 167);
 if (!cap || (cap->type != 16))
  return 
# 92 "pkcs7/pk7_attr.c" 3 4
        ((void *)0)
# 92 "pkcs7/pk7_attr.c"
            ;
 p = cap->value.sequence->data;
 return (struct stack_st_X509_ALGOR *)
 ASN1_item_d2i(
# 95 "pkcs7/pk7_attr.c" 3 4
              ((void *)0)
# 95 "pkcs7/pk7_attr.c"
                  , &p, cap->value.sequence->length,
     (&(X509_ALGORS_it)));
}


int
PKCS7_simple_smimecap(struct stack_st_X509_ALGOR *sk, int nid, int arg)
{
 X509_ALGOR *alg;

 if (!(alg = X509_ALGOR_new())) {
  ERR_put_error(33,(119),((1|64)),"pkcs7/pk7_attr.c",106);
  return 0;
 }
 ...
 if (arg > 0) {
  ...
  alg->parameter->type = 2;
 }
 if (sk_push(((_STACK*) (1 ? (sk) : (struct stack_st_X509_ALGOR*)0)), ((void*) (1 ? (alg) : (X509_ALGOR*)0))) == 0)
  goto err;
 return 1;

err:
 ERR_put_error(33,(119),((1|64)),"pkcs7/pk7_attr.c",130);
 X509_ALGOR_free(alg);
 return 0;
}
...
{
 if (PKCS7_get_signed_attribute(si, 50))
  return 0;
 if (!coid)
  coid = OBJ_nid2obj(21);
 return PKCS7_add_signed_attribute(si, 50,
     6, coid);
}
...
{
 if (!t && !(t = X509_gmtime_adj(
# 149 "pkcs7/pk7_attr.c" 3 4
                                ((void *)0)
# 149 "pkcs7/pk7_attr.c"
                                    , 0))) {
  ERR_put_error(33,(135),((1|64)),"pkcs7/pk7_attr.c",151)
                           ;
  return 0;
 }
 return PKCS7_add_signed_attribute(si, 52,
     23, t);
}
    ...
    int mdlen)
{
 ...
 if (!ASN1_STRING_set(os, md, mdlen) ||
     !PKCS7_add_signed_attribute(si, 51,
     4, os)) {
