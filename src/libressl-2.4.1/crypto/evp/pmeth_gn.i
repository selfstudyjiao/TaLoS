...
EVP_PKEY_paramgen_init(EVP_PKEY_CTX *ctx)
{
 ...
 if (!ctx || !ctx->pmeth || !ctx->pmeth->paramgen) {
  ERR_put_error(6,(149),(150),"evp/pmeth_gn.c",76)
                                                     ;
  return -2;
 }
 ctx->operation = (1<<1);
...
EVP_PKEY_paramgen(EVP_PKEY_CTX *ctx, EVP_PKEY **ppkey)
{
 ...
 if (!ctx || !ctx->pmeth || !ctx->pmeth->paramgen) {
  ERR_put_error(6,(148),(150),"evp/pmeth_gn.c",95)
                                                     ;
  return -2;
 }

 if (ctx->operation != (1<<1)) {
  ERR_put_error(6,(148),(151),"evp/pmeth_gn.c",100);
  return -1;
 }
...
EVP_PKEY_keygen_init(EVP_PKEY_CTX *ctx)
{
 ...
 if (!ctx || !ctx->pmeth || !ctx->pmeth->keygen) {
  ERR_put_error(6,(147),(150),"evp/pmeth_gn.c",125)
                                                     ;
  return -2;
 }
 ctx->operation = (1<<2);
...
EVP_PKEY_keygen(EVP_PKEY_CTX *ctx, EVP_PKEY **ppkey)
{
 ...
 if (!ctx || !ctx->pmeth || !ctx->pmeth->keygen) {
  ERR_put_error(6,(146),(150),"evp/pmeth_gn.c",144)
                                                     ;
  return -2;
 }
 if (ctx->operation != (1<<2)) {
  ERR_put_error(6,(146),(151),"evp/pmeth_gn.c",148);
  return -1;
 }
...
{
 { BN_GENCB *tmp_gencb = (cb); tmp_gencb->ver = 2; tmp_gencb->arg = (ctx); tmp_gencb->cb.cb_2 = (trans_cb); }
}
...
# 210 "evp/pmeth_gn.c" 3 4
                        ((void *)0)
# 210 "evp/pmeth_gn.c"
                            ;
 EVP_PKEY *mac_key = 
# 211 "evp/pmeth_gn.c" 3 4
                    ((void *)0)
# 211 "evp/pmeth_gn.c"
                        ;
 ...
 if (!mac_ctx)
  return 
# 215 "evp/pmeth_gn.c" 3 4
        ((void *)0)
# 215 "evp/pmeth_gn.c"
            ;
 if (EVP_PKEY_keygen_init(mac_ctx) <= 0)
  goto merr;
 if (EVP_PKEY_CTX_ctrl(mac_ctx, -1, (1<<2),
     6, keylen, (void *)key) <= 0)
  goto merr;
