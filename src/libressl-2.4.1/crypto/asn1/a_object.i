...
# 75 "asn1/a_object.c"
 ...
 objsize = ASN1_object_size(0, a->length, 6);
 if (pp == 
# 79 "asn1/a_object.c" 3 4
          ((void *)0)
# 79 "asn1/a_object.c"
              )
  return objsize;
 ...
 p = *pp;
 ASN1_put_object(&p, 0, a->length, 6, 0x00);
...
# 99 "asn1/a_object.c"
 ...
 if ((c >= '0') && (c <= '2')) {
  ...
  ERR_put_error(13,(100),(122),"asn1/a_object.c",112);
  goto err;
 }

 if (num <= 0) {
  ERR_put_error(13,(100),(138),"asn1/a_object.c",117);
  goto err;
 }
 c = *(p++);
 num--;
 for (;;) {
  if (num <= 0)
   break;
  if ((c != '.') && (c != ' ')) {
   ERR_put_error(13,(100),(131),"asn1/a_object.c",127)
                                ;
   goto err;
  }
  l = 0;
  ...
  for (;;) {
   ...
   if ((c == ' ') || (c == '.'))
    break;
   if ((c < '0') || (c > '9')) {
    ERR_put_error(13,(100),(130),"asn1/a_object.c",141)
                             ;
    goto err;
   }
   if (!use_bn && l >= ((
# 144 "asn1/a_object.c" 3 4
...
# 144 "asn1/a_object.c"
  ...
  if (len == 0) {
   if ((first < 2) && (l >= 40)) {
    ERR_put_error(13,(100),(147),"asn1/a_object.c",161)
                                       ;
    goto err;
   }
   if (use_bn) {
  ...
  if (out != 
# 195 "asn1/a_object.c" 3 4
            ((void *)0)
# 195 "asn1/a_object.c"
                ) {
   if (len + i > olen) {
    ERR_put_error(13,(100),(107),"asn1/a_object.c",198)
                                ;
    goto err;
   }
   while (--i > 0)
...
err:
 ERR_put_error(13,(147),(i),"asn1/a_object.c",280);
 return (
# 281 "asn1/a_object.c" 3 4
        ((void *)0)
# 281 "asn1/a_object.c"
            );
}
...
# 287 "asn1/a_object.c"
 ...
 if (len <= 0 || len > 0x7fffffff || pp == 
# 298 "asn1/a_object.c" 3 4
                                       ((void *)0) 
# 298 "asn1/a_object.c"
                                            || (p = *pp) == 
# 298 "asn1/a_object.c" 3 4
...
# 298 "asn1/a_object.c"
                                                                 ||
     p[len - 1] & 0x80) {
  ERR_put_error(13,(196),(216),"asn1/a_object.c",300);
  return (
# 301 "asn1/a_object.c" 3 4
         ((void *)0)
# 301 "asn1/a_object.c"
             );
 }
 ...
 for (i = 0; i < length; i++, p++) {
  if (*p == 0x80 && (!i || !(p[-1] & 0x80))) {
   ERR_put_error(13,(196),(216),"asn1/a_object.c",309)
                                      ;
   return 
# 310 "asn1/a_object.c" 3 4
         ((void *)0)
# 310 "asn1/a_object.c"
             ;
  }
...
# 316 "asn1/a_object.c"
     ...
     !((*a)->flags & 0x01)) {
  if ((ret = ASN1_OBJECT_new()) == 
# 318 "asn1/a_object.c" 3 4
                                  ((void *)0)
# 318 "asn1/a_object.c"
                                      )
   return (
# 319 "asn1/a_object.c" 3 4
          ((void *)0)
# 319 "asn1/a_object.c"
              );
 } else
...
# 330 "asn1/a_object.c"
 ...
 ret->length = length;
 ret->sn = 
# 339 "asn1/a_object.c" 3 4
          ((void *)0)
# 339 "asn1/a_object.c"
              ;
 ret->ln = 
# 340 "asn1/a_object.c" 3 4
          ((void *)0)
# 340 "asn1/a_object.c"
              ;
...
err:
 ERR_put_error(13,(196),(i),"asn1/a_object.c",350);
 if ((ret != 
# 351 "asn1/a_object.c" 3 4
            ((void *)0)
# 351 "asn1/a_object.c"
                ) && ((a == 
# 351 "asn1/a_object.c" 3 4
...
ASN1_OBJECT_new(void)
{
 ...
 if (ret == 
# 362 "asn1/a_object.c" 3 4
           ((void *)0)
# 362 "asn1/a_object.c"
               ) {
  ERR_put_error(13,(123),((1|64)),"asn1/a_object.c",363);
  return (
# 364 "asn1/a_object.c" 3 4
         ((void *)0)
# 364 "asn1/a_object.c"
             );
 }
 ret->length = 0;
 ret->data = 
# 367 "asn1/a_object.c" 3 4
            ((void *)0)
# 367 "asn1/a_object.c"
                ;
 ret->nid = 0;
 ret->sn = 
# 369 "asn1/a_object.c" 3 4
          ((void *)0)
# 369 "asn1/a_object.c"
              ;
 ret->ln = 
# 370 "asn1/a_object.c" 3 4
          ((void *)0)
# 370 "asn1/a_object.c"
              ;
 ret->flags = 0x01;
