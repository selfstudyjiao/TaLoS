...
CMAC_CTX_cleanup(CMAC_CTX *ctx)
{
 ...
 explicit_bzero(ctx->tbl, 32);
 explicit_bzero(ctx->k1, 32);
 explicit_bzero(ctx->k2, 32);
 explicit_bzero(ctx->last_block, 32);
 ctx->nlast_block = -1;
}
...
CMAC_Init(CMAC_CTX *ctx, const void *key, size_t keylen,
    const EVP_CIPHER *cipher, ENGINE *impl)
{
 static unsigned char zero_iv[32];
 ...
 if (!key && !cipher && !impl && keylen == 0) {
  ...
  if (ctx->nlast_block == -1)
   return 0;
  if (!EVP_EncryptInit_ex(&ctx->cctx, 
# 162 "cmac/cmac.c" 3 4
                                     ((void *)0)
# 162 "cmac/cmac.c"
                                         , 
...
# 162 "cmac/cmac.c"
 ...
 if (cipher && !EVP_EncryptInit_ex(&ctx->cctx, cipher, impl, 
# 169 "cmac/cmac.c" 3 4
                                                            ((void *)0)
# 169 "cmac/cmac.c"
                                                                , 
...
CMAC_resume(CMAC_CTX *ctx)
{
 ...
 return EVP_EncryptInit_ex(&ctx->cctx, 
# 280 "cmac/cmac.c" 3 4
                                      ((void *)0)
# 280 "cmac/cmac.c"
                                          , 
