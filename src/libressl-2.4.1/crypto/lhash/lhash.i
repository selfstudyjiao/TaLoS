...
lh_new(LHASH_HASH_FN_TYPE h, LHASH_COMP_FN_TYPE c)
{
 ...
 if ((ret = malloc(sizeof(_LHASH))) == 
# 121 "lhash/lhash.c" 3 4
                                      ((void *)0)
# 121 "lhash/lhash.c"
                                          )
  goto err0;
 if ((ret->b = reallocarray(
# 123 "lhash/lhash.c" 3 4
                           ((void *)0)
# 123 "lhash/lhash.c"
                               , 16, sizeof(LHASH_NODE *))) == 
# 123 "lhash/lhash.c" 3 4
                                                                      ((void *)0)
# 123 "lhash/lhash.c"
                                                                          )
 ...
 for (i = 0; i < 16; i++)
  ret->b[i] = 
# 126 "lhash/lhash.c" 3 4
             ((void *)0)
# 126 "lhash/lhash.c"
                 ;
 ret->comp = ((c == 
# 127 "lhash/lhash.c" 3 4
                   ((void *)0)
# 127 "lhash/lhash.c"
                       ) ? (LHASH_COMP_FN_TYPE)strcmp : c);
 ret->hash = ((h == 
# 128 "lhash/lhash.c" 3 4
                   ((void *)0)
# 128 "lhash/lhash.c"
                       ) ? (LHASH_HASH_FN_TYPE)lh_strhash : h);
 ret->num_nodes = 16 / 2;
 ret->num_alloc_nodes = 16;
 ret->p = 0;
 ret->pmax = 16 / 2;
 ret->up_load = (2*256);
 ret->down_load = (256);
...
lh_insert(_LHASH *lh, void *data)
{
 ...
 if (*rn == 
# 194 "lhash/lhash.c" 3 4
           ((void *)0)
# 194 "lhash/lhash.c"
               ) {
  if ((nn = malloc(sizeof(LHASH_NODE))) == 
# 195 "lhash/lhash.c" 3 4
                                          ((void *)0)
# 195 "lhash/lhash.c"
                                              ) {
   lh->error++;
   return (
# 197 "lhash/lhash.c" 3 4
          ((void *)0)
# 197 "lhash/lhash.c"
              );
  }
...
lh_delete(_LHASH *lh, const void *data)
{
 ...
 if (*rn == 
# 228 "lhash/lhash.c" 3 4
           ((void *)0)
# 228 "lhash/lhash.c"
               ) {
  lh->num_no_delete++;
  return (
# 230 "lhash/lhash.c" 3 4
         ((void *)0)
# 230 "lhash/lhash.c"
             );
 } else {
...
lh_retrieve(_LHASH *lh, const void *data)
{
 ...
 if (*rn == 
# 257 "lhash/lhash.c" 3 4
           ((void *)0)
# 257 "lhash/lhash.c"
               ) {
  lh->num_retrieve_miss++;
  return (
# 259 "lhash/lhash.c" 3 4
         ((void *)0)
# 259 "lhash/lhash.c"
             );
 } else {
...
{
 doall_util_fn(lh, 0, func, (LHASH_DOALL_ARG_FN_TYPE)0, 
# 299 "lhash/lhash.c" 3 4
                                                       ((void *)0)
# 299 "lhash/lhash.c"
                                                           );
}
