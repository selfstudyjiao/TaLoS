...
BN_CTX_new(void)
{
 ...
 if (!ret) {
  ERR_put_error(3,(106),((1|64)),"bn/bn_ctx.c",228);
  return 
# 229 "bn/bn_ctx.c" 3 4
        ((void *)0)
# 229 "bn/bn_ctx.c"
...
BN_CTX_start(BN_CTX *ctx)
{
 ...
 if (ctx->err_stack || ctx->too_many)
  ...
  ERR_put_error(3,(129),(109),"bn/bn_ctx.c",277);
  ctx->err_stack++;
 }
 ;
}
...
# 311 "bn/bn_ctx.c"
  ...
  ctx->too_many = 1;
  ERR_put_error(3,(116),(109),"bn/bn_ctx.c",315);
  return 
# 316 "bn/bn_ctx.c" 3 4
        ((void *)0)
# 316 "bn/bn_ctx.c"
...
BN_STACK_push(BN_STACK *st, unsigned int idx)
{
...

 {
  unsigned int newsize = (st->size ?
      (st->size * 3 / 2) : 32);
  unsigned int *newitems = reallocarray(
# 359 "bn/bn_ctx.c" 3 4
                                       ((void *)0)
# 359 "bn/bn_ctx.c"
                                           ,
...
{
 unsigned int offset = (p->used - 1) % 16;
