...
NETSCAPE_SPKI_b64_decode(const char *str, int len)
{
 ...
 if (!(spki_der = malloc(len + 1))) {
  ERR_put_error(11,(129),((1|64)),"x509/x509spki.c",94);
  return 
# 95 "x509/x509spki.c" 3 4
        ((void *)0)
# 95 "x509/x509spki.c"
            ;
 }
 ...
 if (spki_len < 0) {
  ERR_put_error(11,(129),(118),"x509/x509spki.c",100)
                                 ;
  free(spki_der);
  return 
# 102 "x509/x509spki.c" 3 4
        ((void *)0)
# 102 "x509/x509spki.c"
            ;
 }
...
NETSCAPE_SPKI_b64_encode(NETSCAPE_SPKI *spki)
{
 ...
 char *b64_str;
 int der_len;
 der_len = i2d_NETSCAPE_SPKI(spki, 
# 118 "x509/x509spki.c" 3 4
                                  ((void *)0)
# 118 "x509/x509spki.c"
                                      );
 der_spki = malloc(der_len);
 b64_str = reallocarray(
# 120 "x509/x509spki.c" 3 4
                       ((void *)0)
# 120 "x509/x509spki.c"
                           , der_len, 2);
 if (!der_spki || !b64_str) {
  ERR_put_error(11,(130),((1|64)),"x509/x509spki.c",122);
  free(der_spki);
  free(b64_str);
  return 
# 125 "x509/x509spki.c" 3 4
        ((void *)0)
# 125 "x509/x509spki.c"
            ;
 }
