...
SSL_get1_session(SSL *ssl)
{
 ...
 CRYPTO_lock(1|8,14,"../ssl/ssl_sess.c",181);
 sess = ssl->session;
 if (sess)
  sess->references++;
 CRYPTO_lock(2|8,14,"../ssl/ssl_sess.c",185);
...
SSL_SESSION_get_ex_new_index(long argl, void *argp, CRYPTO_EX_new *new_func,
    CRYPTO_EX_dup *dup_func, CRYPTO_EX_free *free_func)
{
 return CRYPTO_get_ex_new_index(3,
...
SSL_SESSION_new(void)
{
 ...
 if (ss == 
# 216 "../ssl/ssl_sess.c" 3 4
          ((void *)0)
# 216 "../ssl/ssl_sess.c"
              ) {
  ERR_put_error(20,(189),((1|64)),"../ssl/ssl_sess.c",217);
  return (0);
 }
 ...
 ss->time = 1471626829;
 ss->prev = 
# 225 "../ssl/ssl_sess.c" 3 4
           ((void *)0)
# 225 "../ssl/ssl_sess.c"
               ;
 ss->next = 
# 226 "../ssl/ssl_sess.c" 3 4
           ((void *)0)
# 226 "../ssl/ssl_sess.c"
               ;
 ss->tlsext_hostname = 
# 227 "../ssl/ssl_sess.c" 3 4
                      ((void *)0)
# 227 "../ssl/ssl_sess.c"
                          ;

 ss->tlsext_ecpointformatlist_length = 0;
 ss->tlsext_ecpointformatlist = 
# 230 "../ssl/ssl_sess.c" 3 4
                               ((void *)0)
# 230 "../ssl/ssl_sess.c"
                                   ;
 ss->tlsext_ellipticcurvelist_length = 0;
 ss->tlsext_ellipticcurvelist = 
# 232 "../ssl/ssl_sess.c" 3 4
                               ((void *)0)
# 232 "../ssl/ssl_sess.c"
                                   ;

 CRYPTO_new_ex_data(3, ss, &ss->ex_data);
...
# 299 "../ssl/ssl_sess.c"
 ...
 if ((ss = SSL_SESSION_new()) == 
# 304 "../ssl/ssl_sess.c" 3 4
                                ((void *)0)
# 304 "../ssl/ssl_sess.c"
                                    )
  return (0);
 ...
 if (s->session != 
# 313 "../ssl/ssl_sess.c" 3 4
                  ((void *)0)
# 313 "../ssl/ssl_sess.c"
                      ) {
  SSL_SESSION_free(s->session);
  s->session = 
# 315 "../ssl/ssl_sess.c" 3 4
              ((void *)0)
# 315 "../ssl/ssl_sess.c"
                  ;
 }
 ...
 if (session) {
  ...
  case 0xFEFF:
   ...
   ss->session_id_length = 32;
   break;
  default:
   ERR_put_error(20,(181),(259),"../ssl/ssl_sess.c",329)
                                     ;
   SSL_SESSION_free(ss);
   return (0);
  }
  ...
  CRYPTO_lock(1|4,12,"../ssl/ssl_sess.c",341);
  if (s->generate_session_id)
   cb = s->generate_session_id;
  else if (s->initial_ctx->generate_session_id)
   cb = s->initial_ctx->generate_session_id;
  CRYPTO_lock(2|4,12,"../ssl/ssl_sess.c",346);


  tmp = ss->session_id_length;
  if (!cb(s, ss->session_id, &tmp)) {

   ERR_put_error(20,(181),(301),"../ssl/ssl_sess.c",353)
                                        ;
   SSL_SESSION_free(ss);
   return (0);
  }
  ...
  if (!tmp || (tmp > ss->session_id_length)) {
   ...
   ERR_put_error(20,(181),(303),"../ssl/ssl_sess.c",365)
                                       ;
   SSL_SESSION_free(ss);
   return (0);
  }
  ...
  if (SSL_has_matching_session_id(s, ss->session_id,
   ...
   ERR_put_error(20,(181),(302),"../ssl/ssl_sess.c",375)
                                 ;
   SSL_SESSION_free(ss);
   return (0);
  }
...
# 383 "../ssl/ssl_sess.c" 3 4
                             ((void *)0)
# 383 "../ssl/ssl_sess.c"
                                 ) {
    ERR_put_error(20,(181),((4|64)),"../ssl/ssl_sess.c",385)
                             ;
    SSL_SESSION_free(ss);
    return 0;
   }
 ...
 if (s->sid_ctx_length > sizeof ss->sid_ctx) {
  ERR_put_error(20,(181),((4|64)),"../ssl/ssl_sess.c",395);
  SSL_SESSION_free(ss);
  return 0;
 }
...
# 434 "../ssl/ssl_sess.c"
 ...
 if (try_session_cache && ret == 
# 464 "../ssl/ssl_sess.c" 3 4
                                ((void *)0) 
# 464 "../ssl/ssl_sess.c"
                                     &&
  ...
  CRYPTO_lock(1|4,12,"../ssl/ssl_sess.c",472);
  ret = ((SSL_SESSION *)lh_retrieve(((_LHASH *)((void*) (1 ? s->initial_ctx->sessions : (struct lhash_st_SSL_SESSION*)0))), ((void*) (1 ? &data : (SSL_SESSION*)0))));
  if (ret != 
# 474 "../ssl/ssl_sess.c" 3 4
            ((void *)0)
# 474 "../ssl/ssl_sess.c"
                ) {

   CRYPTO_add_lock(&ret->references,1,14,
                              "../ssl/ssl_sess.c"
# 476 "../ssl/ssl_sess.c"
   ,
                              477
# 476 "../ssl/ssl_sess.c"
  ...
  CRYPTO_lock(2|4,12,"../ssl/ssl_sess.c",479);

  if (ret == 
# 481 "../ssl/ssl_sess.c" 3 4
            ((void *)0)
# 481 "../ssl/ssl_sess.c"
                )
 ...
 if (try_session_cache && ret == 
# 485 "../ssl/ssl_sess.c" 3 4
                                ((void *)0) 
# 485 "../ssl/ssl_sess.c"
                                     &&
     s->initial_ctx->get_session_cb != 
# 486 "../ssl/ssl_sess.c" 3 4
                                      ((void *)0)
# 486 "../ssl/ssl_sess.c"
                                          ) {
  int copy = 1;
  ...
  ret = ocall_get_session_cb_trampoline(s, session_id, len, &copy, (void*)s->initial_ctx->get_session_cb);
...
# 524 "../ssl/ssl_sess.c"
 ...
 if ((s->verify_mode & 0x01) && s->sid_ctx_length == 0) {
# 549 "../ssl/ssl_sess.c"
  ERR_put_error(20,(217),(277),"../ssl/ssl_sess.c",550)
                                             ;
  fatal = 1;
  goto err;
 }
...
SSL_CTX_add_session(SSL_CTX *ctx, SSL_SESSION *c)
{
 ...
 CRYPTO_add_lock(&c->references,1,14,"../ssl/ssl_sess.c",607);





 CRYPTO_lock(1|8,12,"../ssl/ssl_sess.c",613);
 s = ((SSL_SESSION *)lh_insert(((_LHASH *)((void*) (1 ? ctx->sessions : (struct lhash_st_SSL_SESSION*)0))), ((void*) (1 ? c : (SSL_SESSION*)0))));
...
# 639 "../ssl/ssl_sess.c"
  ...
  if (SSL_CTX_ctrl(ctx,43,0,
# 655 "../ssl/ssl_sess.c" 3 4
     ((void *)0)
# 655 "../ssl/ssl_sess.c"
     ) > 0) {
   while (SSL_CTX_ctrl(ctx,20,0,
# 656 "../ssl/ssl_sess.c" 3 4
         ((void *)0)
# 656 "../ssl/ssl_sess.c"
         ) >
       SSL_CTX_ctrl(ctx,43,0,
# 657 "../ssl/ssl_sess.c" 3 4
      ((void *)0)
# 657 "../ssl/ssl_sess.c"
      )) {
 ...
 CRYPTO_lock(2|8,12,"../ssl/ssl_sess.c",666);
 return (ret);
}
...
remove_session_lock(SSL_CTX *ctx, SSL_SESSION *c, int lck)
{
 ...
 if ((c != 
# 682 "../ssl/ssl_sess.c" 3 4
          ((void *)0)
# 682 "../ssl/ssl_sess.c"
              ) && (c->session_id_length != 0)) {
  if (lck)
   CRYPTO_lock(1|8,12,"../ssl/ssl_sess.c",684);
  if ((r = ((SSL_SESSION *)lh_retrieve(((_LHASH *)((void*) (1 ? ctx->sessions : (struct lhash_st_SSL_SESSION*)0))), ((void*) (1 ? c : (SSL_SESSION*)0))))) == c) {
   ret = 1;
   r = ((SSL_SESSION *)lh_delete(((_LHASH *)((void*) (1 ? ctx->sessions : (struct lhash_st_SSL_SESSION*)0))), ((void*) (1 ? c : (SSL_SESSION*)0))));
   SSL_SESSION_list_remove(ctx, c);
  }
  if (lck)
   CRYPTO_lock(2|8,12,"../ssl/ssl_sess.c",691);

  if (ret) {
   r->not_resumable = 1;
   if (ctx->remove_session_cb != 
# 695 "../ssl/ssl_sess.c" 3 4
                                ((void *)0)
# 695 "../ssl/ssl_sess.c"
                                    ) {
...
SSL_SESSION_free(SSL_SESSION *ss)
{
 ...
 if (ss == 
# 715 "../ssl/ssl_sess.c" 3 4
          ((void *)0)
# 715 "../ssl/ssl_sess.c"
              )
  return;

 i = CRYPTO_add_lock(&ss->references,-1,14,"../ssl/ssl_sess.c",718);
 if (i > 0)
  return;

 CRYPTO_free_ex_data(3, ss, &ss->ex_data);

 explicit_bzero(ss->master_key, sizeof ss->master_key);
 explicit_bzero(ss->session_id, sizeof ss->session_id);
 if (ss->sess_cert != 
# 726 "../ssl/ssl_sess.c" 3 4
                     ((void *)0)
# 726 "../ssl/ssl_sess.c"
                         )
 ...
 X509_free(ss->peer);
 if (ss->ciphers != 
# 729 "../ssl/ssl_sess.c" 3 4
                   ((void *)0)
# 729 "../ssl/ssl_sess.c"
                       )
  sk_free(((_STACK*) (1 ? (ss->ciphers) : (struct stack_st_SSL_CIPHER*)0)));
...
SSL_set_session(SSL *s, SSL_SESSION *session)
{
 ...
 if (session != 
# 747 "../ssl/ssl_sess.c" 3 4
               ((void *)0)
# 747 "../ssl/ssl_sess.c"
                   ) {
  meth = s->ctx->method->get_ssl_method(session->ssl_version);
  if (meth == 
# 749 "../ssl/ssl_sess.c" 3 4
             ((void *)0)
# 749 "../ssl/ssl_sess.c"
                 )
   meth = s->method->get_ssl_method(session->ssl_version);
  if (meth == 
# 751 "../ssl/ssl_sess.c" 3 4
             ((void *)0)
# 751 "../ssl/ssl_sess.c"
                 ) {
   ERR_put_error(20,(195),(240),"../ssl/ssl_sess.c",753)
                                       ;
   return (0);
  }
  ...
  CRYPTO_add_lock(&session->references,1,14,"../ssl/ssl_sess.c",764);
  if (s->session != 
# 765 "../ssl/ssl_sess.c" 3 4
                   ((void *)0)
# 765 "../ssl/ssl_sess.c"
                       )
   SSL_SESSION_free(s->session);
  ...
  if (s->session != 
# 772 "../ssl/ssl_sess.c" 3 4
                   ((void *)0)
# 772 "../ssl/ssl_sess.c"
                       ) {
   SSL_SESSION_free(s->session);
   s->session = 
# 774 "../ssl/ssl_sess.c" 3 4
               ((void *)0)
# 774 "../ssl/ssl_sess.c"
                   ;
  }
...
{
 if (sid_ctx_len > 32) {
  ERR_put_error(20,(312),(273),"../ssl/ssl_sess.c",840)
                                            ;
  return 0;
 }
...
SSL_set_session_secret_cb(SSL *s, int (*tls_session_secret_cb)(SSL *s,
    void *secret, int *secret_len, struct stack_st_SSL_CIPHER *peer_ciphers,
    SSL_CIPHER **cipher, void *arg), void *arg)
{
 if (s == 
# 883 "../ssl/ssl_sess.c" 3 4
         ((void *)0)
# 883 "../ssl/ssl_sess.c"
             )
  return (0);
...
SSL_set_session_ticket_ext(SSL *s, void *ext_data, int ext_len)
{
 if (s->version >= 0x0301) {
  ...
  if (!s->tlsext_session_ticket) {
   ERR_put_error(20,(294),((1|64)),"../ssl/ssl_sess.c",910)
                            ;
   return 0;
  }
...
timeout_doall_arg(SSL_SESSION *s, TIMEOUT_PARAM *p)
{
 if ((p->time == 0) || (p->time > (s->time + s->timeout))) {
  ...
  (void)((SSL_SESSION *)lh_delete(((_LHASH *)((void*) (1 ? p->cache : (struct lhash_st_SSL_SESSION*)0))), ((void*) (1 ? s : (SSL_SESSION*)0))));
  SSL_SESSION_list_remove(p->ctx, s);
  s->not_resumable = 1;
  if (p->ctx->remove_session_cb != 
# 947 "../ssl/ssl_sess.c" 3 4
                                  ((void *)0)
# 947 "../ssl/ssl_sess.c"
                                      ) {
...
static
void timeout_LHASH_DOALL_ARG(void *arg1, void *arg2) { SSL_SESSION *a = arg1; TIMEOUT_PARAM *b = arg2; timeout_doall_arg(a, b); }
...
SSL_CTX_flush_sessions(SSL_CTX *s, long t)
{
 ...
 tp.cache = s->sessions;
 if (tp.cache == 
# 971 "../ssl/ssl_sess.c" 3 4
                ((void *)0)
# 971 "../ssl/ssl_sess.c"
                    )
  return;
 tp.time = t;
 CRYPTO_lock(1|8,12,"../ssl/ssl_sess.c",974);
 i = ((_LHASH *)((void*) (1 ? tp.cache : (struct lhash_st_SSL_SESSION*)0)))->down_load;
 ((_LHASH *)((void*) (1 ? tp.cache : (struct lhash_st_SSL_SESSION*)0)))->down_load = 0;
 lh_doall_arg(((_LHASH *)((void*) (1 ? tp.cache : (struct lhash_st_SSL_SESSION*)0))), timeout_LHASH_DOALL_ARG, ((void*) (1 ? &tp : (TIMEOUT_PARAM*)0)))
                    ;
 ((_LHASH *)((void*) (1 ? tp.cache : (struct lhash_st_SSL_SESSION*)0)))->down_load = i;
 CRYPTO_lock(2|8,12,"../ssl/ssl_sess.c",980);
}
...
{
 if ((s->session != 
# 986 "../ssl/ssl_sess.c" 3 4
                   ((void *)0)
# 986 "../ssl/ssl_sess.c"
                       ) && !(s->shutdown & 1) &&
     !((SSL_state(s)&(0x1000|0x2000)) || (SSL_state(s)&0x4000))) {
...
# 1005 "../ssl/ssl_sess.c" 3 4
                            ((void *)0)
# 1005 "../ssl/ssl_sess.c"
                                ;
   ctx->session_cache_tail = 
# 1006 "../ssl/ssl_sess.c" 3 4
                            ((void *)0)
# 1006 "../ssl/ssl_sess.c"
                                ;
  } else {
...
{
 if (!ENGINE_init(e)) {
  ERR_put_error(20,(290),(38),"../ssl/ssl_sess.c",1151)
                       ;
  return 0;
 }
 if (!ENGINE_get_ssl_client_cert_function(e)) {
  ERR_put_error(20,(290),(331),"../ssl/ssl_sess.c",1156)
                                  ;
  ENGINE_finish(e);
  return 0;
 }
...
SSL_SESSION *PEM_read_bio_SSL_SESSION(BIO *bp, SSL_SESSION **x, pem_password_cb *cb, void *u){ return PEM_ASN1_read_bio((d2i_of_void *)d2i_SSL_SESSION, "SSL SESSION PARAMETERS",bp,(void **)x,cb,u); } SSL_SESSION *PEM_read_SSL_SESSION(FILE *fp, SSL_SESSION **x, pem_password_cb *cb, void *u){ return PEM_ASN1_read((d2i_of_void *)d2i_SSL_SESSION, "SSL SESSION PARAMETERS",fp,(void **)x,cb,u); } int PEM_write_bio_SSL_SESSION(BIO *bp, SSL_SESSION *x) { return PEM_ASN1_write_bio((i2d_of_void *)i2d_SSL_SESSION,"SSL SESSION PARAMETERS",bp,x,
# 1179 "../ssl/ssl_sess.c" 3 4
((void *)0)
# 1179 "../ssl/ssl_sess.c"
,
# 1179 "../ssl/ssl_sess.c" 3 4
...
((void *)0)
# 1179 "../ssl/ssl_sess.c"
); } int PEM_write_SSL_SESSION(FILE *fp, SSL_SESSION *x) { return PEM_ASN1_write((i2d_of_void *)i2d_SSL_SESSION,"SSL SESSION PARAMETERS",fp,x,
# 1179 "../ssl/ssl_sess.c" 3 4
((void *)0)
# 1179 "../ssl/ssl_sess.c"
,
