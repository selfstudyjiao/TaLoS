...
asn1_do_lock(ASN1_VALUE **pval, int op, const ASN1_ITEM *it)
{
 ...
 if (!aux || !(aux->flags & 1))
  return 0;
 lck = (void *)(((char *) *pval) + aux->ref_offset);
 if (op == 0) {
  *lck = 1;
  return 1;
 }
 ret = CRYPTO_add_lock(lck,op,aux->ref_lock,"asn1/tasn_utl.c",119);
 return ret;
}
...
# 129 "asn1/tasn_utl.c"
 ...
 if (!aux || !(aux->flags & 2))
  return 
# 132 "asn1/tasn_utl.c" 3 4
        ((void *)0)
# 132 "asn1/tasn_utl.c"
            ;
 return (void *)(((char *) *pval) + aux->enc_offset);
}
...
asn1_get_field_ptr(ASN1_VALUE **pval, const ASN1_TEMPLATE *tt)
{
 ...
 if (tt->flags & (0x1<<10))
  return pval;
 pvaltmp = (void *)(((char *) *pval) + tt->offset);
...
asn1_do_adb(ASN1_VALUE **pval, const ASN1_TEMPLATE *tt, int nullerr)
{
 ...
 sfld = (void *)(((char *) *pval) + adb->offset);
...
err:
 ...
 if (nullerr)
  ERR_put_error(13,(110),(164),"asn1/tasn_utl.c",279)
                                             ;
 return 
# 280 "asn1/tasn_utl.c" 3 4
       ((void *)0)
# 280 "asn1/tasn_utl.c"
           ;
}
