...
md_ctrl(BIO *b, int cmd, long num, void *ptr)
{
 ...
 case 1:
  if (b->init)
   ret = EVP_DigestInit_ex(ctx, ctx->digest, 
# 190 "evp/bio_md.c" 3 4
                                            ((void *)0)
# 190 "evp/bio_md.c"
                                                );
  else
 ...
 case 111:
  md = ptr;
  ret = EVP_DigestInit_ex(ctx, md, 
# 222 "evp/bio_md.c" 3 4
                                  ((void *)0)
# 222 "evp/bio_md.c"
                                      );
  if (ret > 0)
