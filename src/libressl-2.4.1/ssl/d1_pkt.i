...
# 236 "../ssl/d1_pkt.c"
 ...
 if (pqueue_insert(queue->q, item) == 
# 245 "../ssl/d1_pkt.c" 3 4
                                     ((void *)0)
# 245 "../ssl/d1_pkt.c"
                                         )
  goto err;
...
init_err:
 ERR_put_error(20,(247),((4|64)),"../ssl/d1_pkt.c",254);
 free(rdata);
 pitem_free(item);
 return (-1);
}
...
dtls1_process_record(SSL *s)
{
 ...
 rr->input = &(s->packet[13]);
# 351 "../ssl/d1_pkt.c"
 if (rr->length > ((256 + 64)+16384)) {
  al = 22;
  ERR_put_error(20,(257),(150),"../ssl/d1_pkt.c",353);
  goto f_err;
 }
...
# 375 "../ssl/d1_pkt.c" 3 4
                                    ((void *)0)
# 375 "../ssl/d1_pkt.c"
                                        )) {

  unsigned char *mac = 
# 377 "../ssl/d1_pkt.c" 3 4
                      ((void *)0)
# 377 "../ssl/d1_pkt.c"
                          ;
  unsigned char mac_tmp[64];
  mac_size = EVP_MD_size(EVP_MD_CTX_md(s->read_hash));
  (void)((mac_size <= 64) ? 0 : (OpenSSLDie("../ssl/d1_pkt.c", 380, "mac_size <= EVP_MAX_MD_SIZE"),1));
  ...
  if (orig_len < mac_size ||
      ...
      orig_len < mac_size + 1)) {
   al = 50;
   ERR_put_error(20,(257),(160),"../ssl/d1_pkt.c",395);
   goto f_err;
  }
  ...
  if (i < 0 || mac == 
# 417 "../ssl/d1_pkt.c" 3 4
                     ((void *)0) 
# 417 "../ssl/d1_pkt.c"
                          || timingsafe_memcmp(md, mac, (size_t)mac_size) != 0)
   enc_err = -1;
  if (rr->length > 16384 + mac_size)
   enc_err = -1;
 }
 ...
 if (rr->length > 16384) {
  al = 22;
  ERR_put_error(20,(257),(146),"../ssl/d1_pkt.c",432);
  goto f_err;
 }
...
# 470 "../ssl/d1_pkt.c"
 ...
 if (dtls1_retrieve_buffered_record((s), &((s)->d1->processed_rcds)))
  return 1;
...
again:
 ...
 if ((s->rstate != 0xF1) ||
  ...
  n = ssl3_read_n(s, 13, s->s3->rbuf.len, 0);

  if (n <= 0)
   return(n);


  if (s->packet_length != 13)
   goto again;
  ...
  if (!CBS_write_bytes(&seq_no, &(s->s3->read_sequence[2]),
      sizeof(s->s3->read_sequence) - 2, 
# 525 "../ssl/d1_pkt.c" 3 4
                                       ((void *)0)
# 525 "../ssl/d1_pkt.c"
                                           ))
   goto again;
 ...
 if (rr->length > s->packet_length - 13) {
 ...
 if (bitmap == 
# 570 "../ssl/d1_pkt.c" 3 4
              ((void *)0)
# 570 "../ssl/d1_pkt.c"
                  )
  goto again;
# 580 "../ssl/d1_pkt.c"
 if (!(s->d1->listen && rr->type == 22 &&
     p != 
# 581 "../ssl/d1_pkt.c" 3 4
         ((void *)0) 
# 581 "../ssl/d1_pkt.c"
              && *p == 1) &&
 ...
 if (is_next_epoch) {
  if (((SSL_state(s)&(0x1000|0x2000)) || s->in_handshake) && !s->d1->listen) {
...
# 647 "../ssl/d1_pkt.c" 3 4
                                                 ((void *)0)
# 647 "../ssl/d1_pkt.c"
                                                     ;

 if (s->s3->rbuf.buf == 
# 649 "../ssl/d1_pkt.c" 3 4
                       ((void *)0)
# 649 "../ssl/d1_pkt.c"
                           )
  if (!ssl3_setup_buffers(s))
 ...
 if ((type &&
      type != 23 && type != 22) ||
     (peek && (type != 23))) {
  ERR_put_error(20,(258),((4|64)),"../ssl/d1_pkt.c",656);
  return -1;
 }
 ...
 if (!s->in_handshake && (SSL_state(s)&(0x1000|0x2000)))
 {
  ...
  if (i < 0)
   return (i);
  if (i == 0) {
   ERR_put_error(20,(258),(229),"../ssl/d1_pkt.c",673);
   return (-1);
  }
 }
...
start:
 ...
 if (s->s3->change_cipher_spec
  ...
  if (dtls1_buffer_record(s, &(s->d1->buffered_app_data),
      rr->seq_num) < 0) {
   ERR_put_error(20,(258),((4|64)),"../ssl/d1_pkt.c",737);
   return (-1);
  }
  rr->length = 0;
  goto start;
 ...
 if (type == rr->type)
 {
  ...
  if ((SSL_state(s)&(0x1000|0x2000)) && (type == 23) &&
   (s->enc_read_ctx == 
# 758 "../ssl/d1_pkt.c" 3 4
                      ((void *)0)
# 758 "../ssl/d1_pkt.c"
                          )) {
   al = 10;
   ERR_put_error(20,(258),(100),"../ssl/d1_pkt.c",760);
   goto f_err;
  }
...
# 792 "../ssl/d1_pkt.c"
 {
  ...
  unsigned char *dest = 
# 794 "../ssl/d1_pkt.c" 3 4
                       ((void *)0)
# 794 "../ssl/d1_pkt.c"
                           ;
  unsigned int *dest_len = 
# 795 "../ssl/d1_pkt.c" 3 4
                          ((void *)0)
# 795 "../ssl/d1_pkt.c"
                              ;
  ...
  if (rr->type == 22) {
   ...
   al = 10;
   ERR_put_error(20,(258),(245),"../ssl/d1_pkt.c",823);
   goto f_err;
  }
...
# 839 "../ssl/d1_pkt.c"
 ...
 if ((!s->server) &&
     (s->d1->handshake_fragment_len >= 12) &&
     (s->d1->handshake_fragment[0] == 0) &&
     (s->session != 
# 861 "../ssl/d1_pkt.c" 3 4
                   ((void *)0)
# 861 "../ssl/d1_pkt.c"
                       ) && (s->session->cipher != 
# 861 "../ssl/d1_pkt.c" 3 4
...
# 861 "../ssl/d1_pkt.c"
  ...
  if ((s->d1->handshake_fragment[1] != 0) ||
   ...
   al = 50;
   ERR_put_error(20,(258),(105),"../ssl/d1_pkt.c",868);
   goto err;
  }
  ...
  if ((SSL_state(s) == 0x03) &&
   ...
   if (ssl3_renegotiate_check(s)) {
    ...
    if (i < 0)
     return (i);
    if (i == 0) {
     ERR_put_error(20,(258),(229),"../ssl/d1_pkt.c",889);
     return (-1);
    }
 ...
 if (s->d1->alert_fragment_len >= 2) {
  ...
  if (s->info_callback != 
# 925 "../ssl/d1_pkt.c" 3 4
                         ((void *)0)
# 925 "../ssl/d1_pkt.c"
                             )
   cb = s->info_callback;
  else if (s->ctx->info_callback != 
# 927 "../ssl/d1_pkt.c" 3 4
                                   ((void *)0)
# 927 "../ssl/d1_pkt.c"
                                       )
...
# 930 "../ssl/d1_pkt.c"
  ...
  } else if (alert_level == 2)
  {
   ...
   ERR_put_error(20,(258),(1000 + alert_descr),"../ssl/d1_pkt.c",946);
   ...
   al = 47;
   ERR_put_error(20,(258),(246),"../ssl/d1_pkt.c",954);
   goto f_err;
  }
 ...
 if (rr->type == 20) {
  ...
  if ((rr->length != ccs_hdr_len) ||
      (rr->off != 0) || (rr->data[0] != 1)) {
   i = 47;
   ERR_put_error(20,(258),(103),"../ssl/d1_pkt.c",980);
   goto err;
  }
  ...
  dtls1_reset_seq_numbers(s, 0x01);

  goto start;
 }


 if ((s->d1->handshake_fragment_len >= 12) &&
     !s->in_handshake) {
  struct hm_header_st msg_hdr;
  ...
  if (i < 0)
   return (i);
  if (i == 0) {
   ERR_put_error(20,(258),(229),"../ssl/d1_pkt.c",1044);
   return (-1);
  }
 ...
 default:
  ...
  al = 10;
  ERR_put_error(20,(258),(245),"../ssl/d1_pkt.c",1074);
  goto f_err;
 case 20:
 case 21:
 case 22:
  ...
  al = 10;
  ERR_put_error(20,(258),((4|64)),"../ssl/d1_pkt.c",1083);
  goto f_err;
 case 23:
  ...
  if (s->s3->in_read_app_data &&
   ...
   al = 10;
   ERR_put_error(20,(258),(245),"../ssl/d1_pkt.c",1105);
   goto f_err;
  }
 }
...
dtls1_write_app_data_bytes(SSL *s, int type, const void *buf_, int len)
{
 ...
 if ((SSL_state(s)&(0x1000|0x2000)) && !s->in_handshake)
 {
  ...
  if (i < 0)
   return (i);
  if (i == 0) {
   ERR_put_error(20,(268),(229),"../ssl/d1_pkt.c",1128);
   return -1;
  }
 }

 if (len > 16384) {
  ERR_put_error(20,(268),(334),"../ssl/d1_pkt.c",1134);
  return -1;
 }
    ...
    int len, int peek)
{
 ...
 if ((type == 22) && (s->d1->handshake_fragment_len > 0))
...
dtls1_write_bytes(SSL *s, int type, const void *buf, int len)
{
 ...
 (void)((len <= 16384) ? 0 : (OpenSSLDie("../ssl/d1_pkt.c", 1183, "len <= SSL3_RT_MAX_PLAIN_LENGTH"),1));
 s->rwstate = 1;
...
do_dtls1_write(SSL *s, int type, const unsigned char *buf, unsigned int len)
{
 ...
 if (s->s3->wbuf.left != 0) {
  (void)((0) ? 0 : (OpenSSLDie("../ssl/d1_pkt.c", 1203, "0"),1));
 ...
 *(p++) = s->version&0xff;
 ...
 ((pseq[0]=(unsigned char)(((s->d1->w_epoch)>> 8)&0xff), pseq[1]=(unsigned char)(((s->d1->w_epoch) )&0xff)),pseq+=2);
 ...
 pseq += 6;
 ((pseq[0]=(unsigned char)(((wr->length)>> 8)&0xff), pseq[1]=(unsigned char)(((wr->length) )&0xff)),pseq+=2);
...
# 1409 "../ssl/d1_pkt.c"
 i = do_dtls1_write(s, 21, &buf[0], sizeof(buf));
 if (i <= 0) {
...
# 1419 "../ssl/d1_pkt.c"
  ...
  if (s->info_callback != 
# 1425 "../ssl/d1_pkt.c" 3 4
                         ((void *)0)
# 1425 "../ssl/d1_pkt.c"
                             )
   cb = s->info_callback;
  else if (s->ctx->info_callback != 
# 1427 "../ssl/d1_pkt.c" 3 4
                                   ((void *)0)
# 1427 "../ssl/d1_pkt.c"
                                       )
   cb = s->ctx->info_callback;
 ...
 *is_next_epoch = 0;
 ...
 if (rr->epoch == s->d1->r_epoch)
  ...
  (rr->type == 22 || rr->type == 21)) {
  *is_next_epoch = 1;
  return &s->d1->next_bitmap;
 }

 return 
# 1456 "../ssl/d1_pkt.c" 3 4
       ((void *)0)
# 1456 "../ssl/d1_pkt.c"
           ;
}
