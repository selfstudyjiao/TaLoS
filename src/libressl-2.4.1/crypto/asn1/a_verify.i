...
# 79 "asn1/a_verify.c"
 ...
 if (!pkey) {
  ERR_put_error(13,(197),((3|64)),"asn1/a_verify.c",85);
  return -1;
 }

 if (signature->type == 3 && signature->flags & 0x7)
 {
  ERR_put_error(13,(137),(220),"asn1/a_verify.c",92)
                                          ;
  return -1;
 }
 ...
 if (!OBJ_find_sigid_algs(OBJ_obj2nid(a->algorithm), &mdnid, &pknid)) {
  ERR_put_error(13,(197),(199),"asn1/a_verify.c",101)
                                         ;
  goto err;
 }
 if (mdnid == 0) {
  if (!pkey->ameth || !pkey->ameth->item_verify) {
   ERR_put_error(13,(197),(199),"asn1/a_verify.c",107)
                                          ;
   goto err;
  }
  ...
  const EVP_MD *type;
  type = EVP_get_digestbyname(OBJ_nid2sn(mdnid));
  if (type == 
# 122 "asn1/a_verify.c" 3 4
             ((void *)0)
# 122 "asn1/a_verify.c"
                 ) {
   ERR_put_error(13,(197),(161),"asn1/a_verify.c",124)
                                               ;
   goto err;
  }
  ...
  if (EVP_PKEY_type(pknid) != pkey->ameth->pkey_id) {
   ERR_put_error(13,(197),(200),"asn1/a_verify.c",131)
                                    ;
   goto err;
  }

  if (!EVP_DigestVerifyInit(&ctx, 
# 135 "asn1/a_verify.c" 3 4
                                 ((void *)0)
# 135 "asn1/a_verify.c"
                                     , type, 
# 135 "asn1/a_verify.c" 3 4
...
# 135 "asn1/a_verify.c"
                                                 , pkey)) {
   ERR_put_error(13,(197),(6),"asn1/a_verify.c",136);
   ret = 0;
   goto err;
  }
 ...
 if (buf_in == 
# 145 "asn1/a_verify.c" 3 4
              ((void *)0)
# 145 "asn1/a_verify.c"
                  ) {
  ERR_put_error(13,(197),((1|64)),"asn1/a_verify.c",146);
  goto err;
 }

 if (!EVP_DigestUpdate(&ctx,buf_in,inl)) {
  ERR_put_error(13,(197),(6),"asn1/a_verify.c",151);
  ret = 0;
  goto err;
 }
 ...
 if (EVP_DigestVerifyFinal(&ctx, signature->data,
  ...
  ERR_put_error(13,(197),(6),"asn1/a_verify.c",161);
  ret = 0;
  goto err;
 }
