...
# 78 "x509v3/pcy_cache.c" 3 4
                         ((void *)0)
# 78 "x509v3/pcy_cache.c"
                             ;
 POLICYINFO *policy;

 if (sk_num(((_STACK*) (1 ? (policies) : (struct stack_st_POLICYINFO*)0))) == 0)
  goto bad_policy;
 cache->data = ((struct stack_st_X509_POLICY_DATA *)sk_new(((int (*)(const void *, const void *)) ((1 ? (policy_data_cmp) : (int (*)(const X509_POLICY_DATA * const *, const X509_POLICY_DATA * const *))0)))));
 if (!cache->data)
  goto bad_policy;
 for (i = 0; i < sk_num(((_STACK*) (1 ? (policies) : (struct stack_st_POLICYINFO*)0))); i++) {
  policy = ((POLICYINFO *)sk_value(((_STACK*) (1 ? (policies) : (struct stack_st_POLICYINFO*)0)), (i)));
  data = policy_data_new(policy, 
# 88 "x509v3/pcy_cache.c" 3 4
                                ((void *)0)
# 88 "x509v3/pcy_cache.c"
                                    , crit);
  if (!data)
   goto bad_policy;
  ...
  if (OBJ_obj2nid(data->valid_policy) == 746) {
   ...
   ret = -1;
   goto bad_policy;
  } else if (!sk_push(((_STACK*) (1 ? (cache->data) : (struct stack_st_X509_POLICY_DATA*)0)), ((void*) (1 ? (data) : (X509_POLICY_DATA*)0))))
   goto bad_policy;
  data = 
# 105 "x509v3/pcy_cache.c" 3 4
        ((void *)0)
# 105 "x509v3/pcy_cache.c"
            ;
 }
 ret = 1;
...
bad_policy:
 ...
 sk_pop_free(((_STACK*) (1 ? (policies) : (struct stack_st_POLICYINFO*)0)), ((void (*)(void *)) ((1 ? (POLICYINFO_free) : (void (*)(POLICYINFO *))0))));
 if (ret <= 0) {
  sk_pop_free(((_STACK*) (1 ? (cache->data) : (struct stack_st_X509_POLICY_DATA*)0)), ((void (*)(void *)) ((1 ? (policy_data_free) : (void (*)(X509_POLICY_DATA *))0))));
  cache->data = 
# 117 "x509v3/pcy_cache.c" 3 4
               ((void *)0)
# 117 "x509v3/pcy_cache.c"
                   ;
 }
 return ret;
}
...
policy_cache_new(X509 *x)
{
 ...
 ASN1_INTEGER *ext_any = 
# 126 "x509v3/pcy_cache.c" 3 4
                        ((void *)0)
# 126 "x509v3/pcy_cache.c"
                            ;
 POLICY_CONSTRAINTS *ext_pcons = 
# 127 "x509v3/pcy_cache.c" 3 4
                                ((void *)0)
# 127 "x509v3/pcy_cache.c"
                                    ;
 CERTIFICATEPOLICIES *ext_cpols = 
# 128 "x509v3/pcy_cache.c" 3 4
                                 ((void *)0)
# 128 "x509v3/pcy_cache.c"
                                     ;
 POLICY_MAPPINGS *ext_pmaps = 
# 129 "x509v3/pcy_cache.c" 3 4
                             ((void *)0)
# 129 "x509v3/pcy_cache.c"
                                 ;
 int i;
 ...
 if (!cache)
  return 0;
 cache->anyPolicy = 
# 135 "x509v3/pcy_cache.c" 3 4
                   ((void *)0)
# 135 "x509v3/pcy_cache.c"
                       ;
 cache->data = 
# 136 "x509v3/pcy_cache.c" 3 4
              ((void *)0)
# 136 "x509v3/pcy_cache.c"
                  ;
 cache->any_skip = -1;
 ...
 ext_pcons = X509_get_ext_d2i(x, 401, &i, 
# 146 "x509v3/pcy_cache.c" 3 4
                                                            ((void *)0)
# 146 "x509v3/pcy_cache.c"
                                                                );
 ...
 ext_cpols = X509_get_ext_d2i(x, 89, &i, 
# 165 "x509v3/pcy_cache.c" 3 4
                                                              ((void *)0)
# 165 "x509v3/pcy_cache.c"
                                                                  );
 ...
 ext_pmaps = X509_get_ext_d2i(x, 747, &i, 
# 184 "x509v3/pcy_cache.c" 3 4
                                                         ((void *)0)
# 184 "x509v3/pcy_cache.c"
                                                             );
 ...
 ext_any = X509_get_ext_d2i(x, 748, &i, 
# 196 "x509v3/pcy_cache.c" 3 4
                                                          ((void *)0)
# 196 "x509v3/pcy_cache.c"
                                                              );
...
{
 if (x->policy_cache == 
# 233 "x509v3/pcy_cache.c" 3 4
                       ((void *)0)
# 233 "x509v3/pcy_cache.c"
                           ) {
  CRYPTO_lock(1|8,3,"x509v3/pcy_cache.c",234);
  policy_cache_new(x);
  CRYPTO_lock(2|8,3,"x509v3/pcy_cache.c",236);
 }
...
policy_cache_find_data(const X509_POLICY_CACHE *cache, const ASN1_OBJECT *id)
{
 ...
 idx = sk_find(((_STACK*) (1 ? (cache->data) : (struct stack_st_X509_POLICY_DATA*)0)), ((void*) (1 ? (&tmp) : (X509_POLICY_DATA*)0)));
 if (idx == -1)
  return 
# 251 "x509v3/pcy_cache.c" 3 4
        ((void *)0)
# 251 "x509v3/pcy_cache.c"
            ;
 return ((X509_POLICY_DATA *)sk_value(((_STACK*) (1 ? (cache->data) : (struct stack_st_X509_POLICY_DATA*)0)), (idx)));
}
...
{
 if (value == 
# 265 "x509v3/pcy_cache.c" 3 4
             ((void *)0)
# 265 "x509v3/pcy_cache.c"
                 )
  return 1;
 if (value->type == (2 | 0x100))
  return 0;
