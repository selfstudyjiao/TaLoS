...
# 95 "asn1/a_time_tm.c"
 ...
 if (my_asprintf(&ret, "%02u%02u%02u%02u%02u%02uZ",
  ...
  ret = 
# 100 "asn1/a_time_tm.c" 3 4
       ((void *)0)
# 100 "asn1/a_time_tm.c"
           ;
...
{
 char *ret = 
# 109 "asn1/a_time_tm.c" 3 4
            ((void *)0)
# 109 "asn1/a_time_tm.c"
                ;
 int year;
 ...
 if (year < 1950 || year > 9999)
  return (
# 114 "asn1/a_time_tm.c" 3 4
         ((void *)0)
# 114 "asn1/a_time_tm.c"
             );
...
asn1_time_parse(const char *bytes, size_t len, struct tm *tm, int mode)
{
 ...
 if (bytes == 
# 149 "asn1/a_time_tm.c" 3 4
             ((void *)0)
# 149 "asn1/a_time_tm.c"
                 )
  return (-1);
 ...
 lt = tm;
 if (lt == 
# 157 "asn1/a_time_tm.c" 3 4
          ((void *)0)
# 157 "asn1/a_time_tm.c"
              ) {
 ...
 for (i = 0; i < len - 1; i++) {
  if (
# 168 "asn1/a_time_tm.c" 3 4
     ((*__ctype_b_loc ())[(int) ((
# 168 "asn1/a_time_tm.c"
...
# 168 "asn1/a_time_tm.c"
 ...
 case 15:
  if (mode == 23)
   return (-1);
  lt->tm_year = (((p) += 2, ((p)[-2] - '0') * 10 + ((p)[-1] - '0')) * 100) - 1900;
  type = 24;
 ...
 case 13:
  ...
  lt->tm_year += ((p) += 2, ((p)[-2] - '0') * 10 + ((p)[-1] - '0'));
  if (type == 23) {
   if (lt->tm_year < 50)
    lt->tm_year += 100;
  }
  lt->tm_mon = ((p) += 2, ((p)[-2] - '0') * 10 + ((p)[-1] - '0')) - 1;
  if (lt->tm_mon < 0 || lt->tm_mon > 11)
   return (-1);
  lt->tm_mday = ((p) += 2, ((p)[-2] - '0') * 10 + ((p)[-1] - '0'));
  if (lt->tm_mday < 1 || lt->tm_mday > 31)
   return (-1);
  lt->tm_hour = ((p) += 2, ((p)[-2] - '0') * 10 + ((p)[-1] - '0'));
  if (lt->tm_hour < 0 || lt->tm_hour > 23)
   return (-1);
  lt->tm_min = ((p) += 2, ((p)[-2] - '0') * 10 + ((p)[-1] - '0'));
  if (lt->tm_min < 0 || lt->tm_min > 59)
   return (-1);
  lt->tm_sec = ((p) += 2, ((p)[-2] - '0') * 10 + ((p)[-1] - '0'));
...
ASN1_TIME_set_string_internal(ASN1_TIME *s, const char *str, int mode)
{
 ...
 if ((type = asn1_time_parse(str, strlen(str), 
# 229 "asn1/a_time_tm.c" 3 4
                                              ((void *)0)
# 229 "asn1/a_time_tm.c"
                                                  , mode)) == -1)
  return (0);
 if (mode != 0 && mode != type)
  return (0);
 ...
 if (s == 
# 234 "asn1/a_time_tm.c" 3 4
         ((void *)0)
# 234 "asn1/a_time_tm.c"
             )
  return (1);

 if ((tmp = my_strdup(str)) == 
# 237 "asn1/a_time_tm.c" 3 4
                              ((void *)0)
# 237 "asn1/a_time_tm.c"
                                  )
  return (0);
 free(s->data);
 s->data = tmp;
    ...
    int mode)
{
 ...
 char * p;
  ...
  if (gmtime_r(&t, &tm) == 
# 256 "asn1/a_time_tm.c" 3 4
                          ((void *)0)
# 256 "asn1/a_time_tm.c"
                              )
   return (
# 257 "asn1/a_time_tm.c" 3 4
          ((void *)0)
# 257 "asn1/a_time_tm.c"
              );

 if (offset_day || offset_sec) {
  if (!OPENSSL_gmtime_adj(&tm, offset_day, offset_sec))
   return (
# 261 "asn1/a_time_tm.c" 3 4
          ((void *)0)
# 261 "asn1/a_time_tm.c"
              );
 }
 ...
 default:
  return (
# 275 "asn1/a_time_tm.c" 3 4
         ((void *)0)
# 275 "asn1/a_time_tm.c"
             );
 }
 if (p == 
# 277 "asn1/a_time_tm.c" 3 4
         ((void *)0)
# 277 "asn1/a_time_tm.c"
             ) {
  ERR_put_error(13,(216),(184),"asn1/a_time_tm.c",279)
                                ;
  return (
# 280 "asn1/a_time_tm.c" 3 4
         ((void *)0)
# 280 "asn1/a_time_tm.c"
             );
 }

 if (s == 
# 283 "asn1/a_time_tm.c" 3 4
         ((void *)0)
# 283 "asn1/a_time_tm.c"
             ) {
  if ((s = ASN1_TIME_new()) == 
# 284 "asn1/a_time_tm.c" 3 4
                              ((void *)0)
# 284 "asn1/a_time_tm.c"
                                  )
   return (
# 285 "asn1/a_time_tm.c" 3 4
          ((void *)0)
# 285 "asn1/a_time_tm.c"
              );
  allocated = 1;
 }
 ...
 default:
  ...
  free(p);
  return (
# 301 "asn1/a_time_tm.c" 3 4
         ((void *)0)
# 301 "asn1/a_time_tm.c"
             );
 }
 free(s->data);
 s->data = p;
...
{
 return (ASN1_TIME_adj_internal(s, t, offset_day, offset_sec, 0));
}

int
ASN1_TIME_check(ASN1_TIME *t)
{
 if (t->type != 24 && t->type != 23)
  return (0);
 return (t->type == asn1_time_parse(t->data, t->length, 
# 326 "asn1/a_time_tm.c" 3 4
                                                       ((void *)0)
# 326 "asn1/a_time_tm.c"
                                                           , t->type));
}
...
{
 ASN1_GENERALIZEDTIME *tmp = 
# 332 "asn1/a_time_tm.c" 3 4
                            ((void *)0)
# 332 "asn1/a_time_tm.c"
                                ;
 struct tm tm;
 char *str;
 ...
 if (t->type != 24 && t->type != 23)
  return (
# 337 "asn1/a_time_tm.c" 3 4
         ((void *)0)
# 337 "asn1/a_time_tm.c"
             );

 memset(&tm, 0, sizeof(tm));
 if (t->type != asn1_time_parse(t->data, t->length, &tm, t->type))
  return (
# 341 "asn1/a_time_tm.c" 3 4
         ((void *)0)
# 341 "asn1/a_time_tm.c"
             );
 if ((str = gentime_string_from_tm(&tm)) == 
# 342 "asn1/a_time_tm.c" 3 4
                                           ((void *)0)
# 342 "asn1/a_time_tm.c"
                                               )
  return (
# 343 "asn1/a_time_tm.c" 3 4
         ((void *)0)
# 343 "asn1/a_time_tm.c"
             );

 if (out != 
# 345 "asn1/a_time_tm.c" 3 4
           ((void *)0)
# 345 "asn1/a_time_tm.c"
               )
  tmp = *out;
 if (tmp == 
# 347 "asn1/a_time_tm.c" 3 4
           ((void *)0) 
# 347 "asn1/a_time_tm.c"
...
# 347 "asn1/a_time_tm.c"
  ...
  free(str);
  return (
# 349 "asn1/a_time_tm.c" 3 4
         ((void *)0)
# 349 "asn1/a_time_tm.c"
             );
 }
 if (out != 
# 351 "asn1/a_time_tm.c" 3 4
           ((void *)0)
# 351 "asn1/a_time_tm.c"
               )
  *out = tmp;
...
ASN1_UTCTIME_check(ASN1_UTCTIME *d)
{
 if (d->type != 23)
  return (0);
 return (d->type == asn1_time_parse(d->data, d->length, 
# 375 "asn1/a_time_tm.c" 3 4
                                                       ((void *)0)
# 375 "asn1/a_time_tm.c"
                                                           , d->type));
}
...
{
 if (s != 
# 381 "asn1/a_time_tm.c" 3 4
         ((void *)0) 
# 381 "asn1/a_time_tm.c"
              && s->type != 23)
  return (0);
...
{
 struct tm tm1, tm2;
# 413 "asn1/a_time_tm.c"
 if (asn1_time_parse(s->data, s->length, &tm1, 23) == -1)
  return (-2);

 if (gmtime_r(&t2, &tm2) == 
# 416 "asn1/a_time_tm.c" 3 4
                           ((void *)0)
# 416 "asn1/a_time_tm.c"
                               )
  return (-2);
...
ASN1_GENERALIZEDTIME_check(ASN1_GENERALIZEDTIME *d)
{
 if (d->type != 24)
  return (0);
 return (d->type == asn1_time_parse(d->data, d->length, 
# 431 "asn1/a_time_tm.c" 3 4
                                                       ((void *)0)
# 431 "asn1/a_time_tm.c"
                                                           , d->type));
}
...
{
 if (s != 
# 437 "asn1/a_time_tm.c" 3 4
         ((void *)0) 
# 437 "asn1/a_time_tm.c"
              && s->type != 24)
  return (0);
