...
# 104 "asn1/f_string.c"
 ...
 for (;;) {
  ...
  i -= again;
  if (i % 2 != 0) {
   ERR_put_error(13,(103),(145),"asn1/f_string.c",150)
                                  ;
   goto err;
  }
  i /= 2;
  if (num + i > slen) {
   sp = realloc(s, num + i);
   if (sp == 
# 156 "asn1/f_string.c" 3 4
            ((void *)0)
# 156 "asn1/f_string.c"
                ) {
    ERR_put_error(13,(103),((1|64)),"asn1/f_string.c",158)
                             ;
    goto err;
   }
   s = sp;
  ...
  for (j = 0; j < i; j++, k += 2) {
   for (n = 0; n < 2; n++) {
    ...
    if ((m >= '0') && (m <= '9'))
     ...
     ERR_put_error(13,(103),(141),"asn1/f_string.c",175)
                                   ;
     goto err;
    }
    s[num + j] <<= 4;
...
err_sl:
 ERR_put_error(13,(103),(150),"asn1/f_string.c",193);
err:
 free(s);
 return (ret);
}
