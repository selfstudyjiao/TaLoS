...
policy_data_free(X509_POLICY_DATA *data)
{
 ...
 if (!(data->flags & 0x4))
  sk_pop_free(((_STACK*) (1 ? (data->qualifier_set) : (struct stack_st_POLICYQUALINFO*)0)), ((void (*)(void *)) ((1 ? (POLICYQUALINFO_free) : (void (*)(POLICYQUALINFO *))0))))
                          ;
 sk_pop_free(((_STACK*) (1 ? (data->expected_policy_set) : (struct stack_st_ASN1_OBJECT*)0)), ((void (*)(void *)) ((1 ? (ASN1_OBJECT_free) : (void (*)(ASN1_OBJECT *))0))));
 free(data);
}
# 85 "x509v3/pcy_data.c"
X509_POLICY_DATA *
policy_data_new(POLICYINFO *policy, const ASN1_OBJECT *cid, int crit)
{
 X509_POLICY_DATA *ret = 
# 88 "x509v3/pcy_data.c" 3 4
                        ((void *)0)
# 88 "x509v3/pcy_data.c"
                            ;
 ASN1_OBJECT *id = 
# 89 "x509v3/pcy_data.c" 3 4
                  ((void *)0)
# 89 "x509v3/pcy_data.c"
                      ;

 if (policy == 
# 91 "x509v3/pcy_data.c" 3 4
              ((void *)0) 
# 91 "x509v3/pcy_data.c"
                   && cid == 
# 91 "x509v3/pcy_data.c" 3 4
                             ((void *)0)
# 91 "x509v3/pcy_data.c"
  ...
  return 
# 92 "x509v3/pcy_data.c" 3 4
        ((void *)0)
# 92 "x509v3/pcy_data.c"
            ;
 if (cid != 
# 93 "x509v3/pcy_data.c" 3 4
           ((void *)0)
# 93 "x509v3/pcy_data.c"
               ) {
  id = OBJ_dup(cid);
  if (id == 
# 95 "x509v3/pcy_data.c" 3 4
           ((void *)0)
# 95 "x509v3/pcy_data.c"
               )
   return 
# 96 "x509v3/pcy_data.c" 3 4
         ((void *)0)
# 96 "x509v3/pcy_data.c"
             ;
 }
 ret = malloc(sizeof(X509_POLICY_DATA));
 if (ret == 
# 99 "x509v3/pcy_data.c" 3 4
           ((void *)0)
# 99 "x509v3/pcy_data.c"
               )
  goto err;
 ret->expected_policy_set = ((struct stack_st_ASN1_OBJECT *)sk_new_null());
 if (ret->expected_policy_set == 
# 102 "x509v3/pcy_data.c" 3 4
                                ((void *)0)
# 102 "x509v3/pcy_data.c"
                                    )
  goto err;
 ...
 if (id != 
# 110 "x509v3/pcy_data.c" 3 4
          ((void *)0)
# 110 "x509v3/pcy_data.c"
              )
  ret->valid_policy = id;
 else {
  ret->valid_policy = policy->policyid;
  policy->policyid = 
# 114 "x509v3/pcy_data.c" 3 4
                    ((void *)0)
# 114 "x509v3/pcy_data.c"
                        ;
 }

 if (policy != 
# 117 "x509v3/pcy_data.c" 3 4
              ((void *)0)
# 117 "x509v3/pcy_data.c"
                  ) {
  ret->qualifier_set = policy->qualifiers;
  policy->qualifiers = 
# 119 "x509v3/pcy_data.c" 3 4
                      ((void *)0)
# 119 "x509v3/pcy_data.c"
                          ;
 } else
  ret->qualifier_set = 
# 121 "x509v3/pcy_data.c" 3 4
                      ((void *)0)
# 121 "x509v3/pcy_data.c"
                          ;
...
err:
 ...
 ASN1_OBJECT_free(id);
 return 
# 128 "x509v3/pcy_data.c" 3 4
       ((void *)0)
# 128 "x509v3/pcy_data.c"
           ;
}
