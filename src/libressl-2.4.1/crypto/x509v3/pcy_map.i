...
policy_cache_set_mapping(X509 *x, POLICY_MAPPINGS *maps)
{
 ...
 if (sk_num(((_STACK*) (1 ? (maps) : (struct stack_st_POLICY_MAPPING*)0))) == 0) {
  ret = -1;
  goto bad_mapping;
 }
 for (i = 0; i < sk_num(((_STACK*) (1 ? (maps) : (struct stack_st_POLICY_MAPPING*)0))); i++) {
  map = ((POLICY_MAPPING *)sk_value(((_STACK*) (1 ? (maps) : (struct stack_st_POLICY_MAPPING*)0)), (i)));

  if ((OBJ_obj2nid(map->subjectDomainPolicy) == 746) ||
...
# 98 "x509v3/pcy_map.c"
   ...
   data->flags |= 0x2;
   data->flags |= 0x4;
   if (!sk_push(((_STACK*) (1 ? (cache->data) : (struct stack_st_X509_POLICY_DATA*)0)), ((void*) (1 ? (data) : (X509_POLICY_DATA*)0)))) {
    policy_data_free(data);
    goto bad_mapping;
   }
  } else
   data->flags |= 0x1;
  if (!sk_push(((_STACK*) (1 ? (data->expected_policy_set) : (struct stack_st_ASN1_OBJECT*)0)), ((void*) (1 ? (map->subjectDomainPolicy) : (ASN1_OBJECT*)0)))
                               )
   goto bad_mapping;
  map->subjectDomainPolicy = 
# 116 "x509v3/pcy_map.c" 3 4
                            ((void *)0)
# 116 "x509v3/pcy_map.c"
                                ;
 }
...
bad_mapping:
 if (ret == -1)
  x->ex_flags |= 0x800;
 sk_pop_free(((_STACK*) (1 ? (maps) : (struct stack_st_POLICY_MAPPING*)0)), ((void (*)(void *)) ((1 ? (POLICY_MAPPING_free) : (void (*)(POLICY_MAPPING *))0))));
 return ret;
}
