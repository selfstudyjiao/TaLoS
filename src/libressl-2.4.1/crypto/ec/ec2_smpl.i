...
ec_GF2m_simple_group_copy(EC_GROUP * dest, const EC_GROUP * src)
{
 ...
 if (((((int) (dest->poly[0] + 64 - 1) / 64) <= (&dest->a)->dmax)?(&dest->a):bn_expand2((&dest->a),((int) (dest->poly[0] + 64 - 1) / 64))) == 
# 191 "ec/ec2_smpl.c" 3 4
                                                                             ((void *)0)
# 191 "ec/ec2_smpl.c"
                                                                                 )
  return 0;
 if (((((int) (dest->poly[0] + 64 - 1) / 64) <= (&dest->b)->dmax)?(&dest->b):bn_expand2((&dest->b),((int) (dest->poly[0] + 64 - 1) / 64))) == 
# 193 "ec/ec2_smpl.c" 3 4
                                                                             ((void *)0)
# 193 "ec/ec2_smpl.c"
                                                                                 )
  return 0;
    ...
    const BIGNUM * p, const BIGNUM * a, const BIGNUM * b, BN_CTX * ctx)
{
 ...
 if ((i != 5) && (i != 3)) {
  ERR_put_error(16,(195),(131),"ec/ec2_smpl.c",215);
  goto err;
 }

 if (!BN_GF2m_mod_arr(&group->a, a, group->poly))
  goto err;
 if (((((int) (group->poly[0] + 64 - 1) / 64) <= (&group->a)->dmax)?(&group->a):bn_expand2((&group->a),((int) (group->poly[0] + 64 - 1) / 64))) == 
# 221 "ec/ec2_smpl.c" 3 4
                                                                               ((void *)0)
# 221 "ec/ec2_smpl.c"
                                                                                   )
  goto err;
 ...
 if (!BN_GF2m_mod_arr(&group->b, b, group->poly))
  goto err;
 if (((((int) (group->poly[0] + 64 - 1) / 64) <= (&group->b)->dmax)?(&group->b):bn_expand2((&group->b),((int) (group->poly[0] + 64 - 1) / 64))) == 
# 229 "ec/ec2_smpl.c" 3 4
                                                                               ((void *)0)
# 229 "ec/ec2_smpl.c"
                                                                                   )
  goto err;
...
ec_GF2m_simple_group_check_discriminant(const EC_GROUP * group, BN_CTX * ctx)
{
 ...
 BIGNUM *b;
 BN_CTX *new_ctx = 
# 284 "ec/ec2_smpl.c" 3 4
                  ((void *)0)
# 284 "ec/ec2_smpl.c"
                      ;

 if (ctx == 
# 286 "ec/ec2_smpl.c" 3 4
           ((void *)0)
# 286 "ec/ec2_smpl.c"
               ) {
  ctx = new_ctx = BN_CTX_new();
  if (ctx == 
# 288 "ec/ec2_smpl.c" 3 4
            ((void *)0)
# 288 "ec/ec2_smpl.c"
                ) {
   ERR_put_error(16,(159),((1|64)),"ec/ec2_smpl.c",289);
   goto err;
  }
 }
 BN_CTX_start(ctx);
 if ((b = BN_CTX_get(ctx)) == 
# 294 "ec/ec2_smpl.c" 3 4
                             ((void *)0)
# 294 "ec/ec2_smpl.c"
                                 )
  goto err;
...
# 385 "ec/ec2_smpl.c"
  ...
  ERR_put_error(16,(163),((3|64)),"ec/ec2_smpl.c",386);
  return 0;
 }
    ...
    const EC_POINT *point, BIGNUM *x, BIGNUM *y, BN_CTX *ctx)
{
 ...
 if (EC_POINT_is_at_infinity(group, point) > 0) {
  ERR_put_error(16,(162),(106),"ec/ec2_smpl.c",416);
  return 0;
 }
 if (BN_cmp(&point->Z, BN_value_one())) {
  ERR_put_error(16,(162),((2|64)),"ec/ec2_smpl.c",420);
  return 0;
 }
 if (x != 
# 423 "ec/ec2_smpl.c" 3 4
         ((void *)0)
# 423 "ec/ec2_smpl.c"
             ) {
...
# 446 "ec/ec2_smpl.c"
 ...
 if (ctx == 
# 460 "ec/ec2_smpl.c" 3 4
           ((void *)0)
# 460 "ec/ec2_smpl.c"
               ) {
  ctx = new_ctx = BN_CTX_new();
  if (ctx == 
# 462 "ec/ec2_smpl.c" 3 4
            ((void *)0)
# 462 "ec/ec2_smpl.c"
                )
   return 0;
...
# 466 "ec/ec2_smpl.c" 3 4
                              ((void *)0)
# 466 "ec/ec2_smpl.c"
                                  )
  goto err;
 if ((y0 = BN_CTX_get(ctx)) == 
# 468 "ec/ec2_smpl.c" 3 4
                              ((void *)0)
# 468 "ec/ec2_smpl.c"
                                  )
  goto err;
 if ((x1 = BN_CTX_get(ctx)) == 
# 470 "ec/ec2_smpl.c" 3 4
                              ((void *)0)
# 470 "ec/ec2_smpl.c"
                                  )
  goto err;
 if ((y1 = BN_CTX_get(ctx)) == 
# 472 "ec/ec2_smpl.c" 3 4
                              ((void *)0)
# 472 "ec/ec2_smpl.c"
                                  )
  goto err;
 if ((x2 = BN_CTX_get(ctx)) == 
# 474 "ec/ec2_smpl.c" 3 4
                              ((void *)0)
# 474 "ec/ec2_smpl.c"
                                  )
  goto err;
 if ((y2 = BN_CTX_get(ctx)) == 
# 476 "ec/ec2_smpl.c" 3 4
                              ((void *)0)
# 476 "ec/ec2_smpl.c"
                                  )
  goto err;
 if ((s = BN_CTX_get(ctx)) == 
# 478 "ec/ec2_smpl.c" 3 4
                             ((void *)0)
# 478 "ec/ec2_smpl.c"
                                 )
  goto err;
 if ((t = BN_CTX_get(ctx)) == 
# 480 "ec/ec2_smpl.c" 3 4
                             ((void *)0)
# 480 "ec/ec2_smpl.c"
                                 )
  goto err;
 ...
 if (BN_ucmp((x0), (x1))) {
  ...
  if (BN_ucmp((y0), (y1)) || BN_is_zero(x1)) {
...
# 598 "ec/ec2_smpl.c"
 ...
 if (ctx == 
# 613 "ec/ec2_smpl.c" 3 4
           ((void *)0)
# 613 "ec/ec2_smpl.c"
               ) {
  ctx = new_ctx = BN_CTX_new();
  if (ctx == 
# 615 "ec/ec2_smpl.c" 3 4
            ((void *)0)
# 615 "ec/ec2_smpl.c"
                )
   return -1;
 ...
 BN_CTX_start(ctx);
 if ((y2 = BN_CTX_get(ctx)) == 
# 619 "ec/ec2_smpl.c" 3 4
                              ((void *)0)
# 619 "ec/ec2_smpl.c"
                                  )
  goto err;
 if ((lh = BN_CTX_get(ctx)) == 
# 621 "ec/ec2_smpl.c" 3 4
                              ((void *)0)
# 621 "ec/ec2_smpl.c"
                                  )
  goto err;
...
# 663 "ec/ec2_smpl.c"
 ...
 if (ctx == 
# 675 "ec/ec2_smpl.c" 3 4
           ((void *)0)
# 675 "ec/ec2_smpl.c"
               ) {
  ctx = new_ctx = BN_CTX_new();
  if (ctx == 
# 677 "ec/ec2_smpl.c" 3 4
            ((void *)0)
# 677 "ec/ec2_smpl.c"
                )
   return -1;
...
# 681 "ec/ec2_smpl.c" 3 4
                              ((void *)0)
# 681 "ec/ec2_smpl.c"
                                  )
  goto err;
 if ((aY = BN_CTX_get(ctx)) == 
# 683 "ec/ec2_smpl.c" 3 4
                              ((void *)0)
# 683 "ec/ec2_smpl.c"
                                  )
  goto err;
 if ((bX = BN_CTX_get(ctx)) == 
# 685 "ec/ec2_smpl.c" 3 4
                              ((void *)0)
# 685 "ec/ec2_smpl.c"
                                  )
  goto err;
 if ((bY = BN_CTX_get(ctx)) == 
# 687 "ec/ec2_smpl.c" 3 4
                              ((void *)0)
# 687 "ec/ec2_smpl.c"
                                  )
  goto err;
...
# 708 "ec/ec2_smpl.c"
 ...
 if (ctx == 
# 715 "ec/ec2_smpl.c" 3 4
           ((void *)0)
# 715 "ec/ec2_smpl.c"
               ) {
  ctx = new_ctx = BN_CTX_new();
  if (ctx == 
# 717 "ec/ec2_smpl.c" 3 4
            ((void *)0)
# 717 "ec/ec2_smpl.c"
                )
   return 0;
 ...
 BN_CTX_start(ctx);
 if ((x = BN_CTX_get(ctx)) == 
# 721 "ec/ec2_smpl.c" 3 4
                             ((void *)0)
# 721 "ec/ec2_smpl.c"
                                 )
  goto err;
 if ((y = BN_CTX_get(ctx)) == 
# 723 "ec/ec2_smpl.c" 3 4
                             ((void *)0)
# 723 "ec/ec2_smpl.c"
                                 )
  goto err;
