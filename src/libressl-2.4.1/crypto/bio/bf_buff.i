...
buffer_new(BIO *bi)
{
 ...
 if (ctx == 
# 101 "bio/bf_buff.c" 3 4
           ((void *)0)
# 101 "bio/bf_buff.c"
               )
  return (0);
 ctx->ibuf = malloc(4096);
 if (ctx->ibuf == 
# 104 "bio/bf_buff.c" 3 4
                 ((void *)0)
# 104 "bio/bf_buff.c"
                     ) {
  free(ctx);
 ...
 ctx->obuf = malloc(4096);
 if (ctx->obuf == 
# 109 "bio/bf_buff.c" 3 4
                 ((void *)0)
# 109 "bio/bf_buff.c"
                     ) {
  free(ctx->ibuf);
...
# 354 "bio/bf_buff.c"
  ...
  p1 = ctx->ibuf;
  p2 = ctx->obuf;
  if ((ibs > 4096) && (ibs != ctx->ibuf_size)) {
   p1 = malloc(num);
   if (p1 == 
# 373 "bio/bf_buff.c" 3 4
            ((void *)0)
# 373 "bio/bf_buff.c"
                )
    goto malloc_error;
  }
  if ((obs > 4096) && (obs != ctx->obuf_size)) {
   p2 = malloc(num);
   if (p2 == 
# 378 "bio/bf_buff.c" 3 4
            ((void *)0)
# 378 "bio/bf_buff.c"
                ) {
    if (p1 != ctx->ibuf)
...
# 408 "bio/bf_buff.c"
 ...
 case 12:
  dbio = (BIO *)ptr;
  if (!BIO_int_ctrl(dbio,117,ctx->ibuf_size,0) ||
      !BIO_int_ctrl(dbio,117,ctx->obuf_size,1))
   ret = 0;
  break;
 default:
  if (b->next_bio == 
# 441 "bio/bf_buff.c" 3 4
                    ((void *)0)
# 441 "bio/bf_buff.c"
                        )
   return (0);
 ...
 return (ret);
malloc_error:
 ERR_put_error(32,(114),((1|64)),"bio/bf_buff.c",448);
 return (0);
}
