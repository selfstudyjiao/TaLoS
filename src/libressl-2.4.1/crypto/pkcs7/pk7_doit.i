...
# 66 "pkcs7/pk7_doit.c" 2
# 1 "../include/openssl/x509v3.h" 1
# 61 "../include/openssl/x509v3.h"
# 1 "../include/openssl/opensslconf.h" 1
# 1 "../include/openssl/opensslfeatures.h" 1
# 2 "../include/openssl/opensslconf.h" 2
# 62 "../include/openssl/x509v3.h" 2
...
# 67 "pkcs7/pk7_doit.c" 2

static int add_attribute(struct stack_st_X509_ATTRIBUTE **sk, int nid, int atrtype,
    void *value);
static ASN1_TYPE *get_attribute(struct stack_st_X509_ATTRIBUTE *sk, int nid);
...
PKCS7_get_octet_string(PKCS7 *p7)
{
 ...
 return 
# 104 "pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 104 "pkcs7/pk7_doit.c"
           ;
}
...
PKCS7_bio_add_digest(BIO **pbio, X509_ALGOR *alg)
{
 BIO *btmp;
 const EVP_MD *md;
 if ((btmp = BIO_new(BIO_f_md())) == 
# 112 "pkcs7/pk7_doit.c" 3 4
                                    ((void *)0)
# 112 "pkcs7/pk7_doit.c"
                                        ) {
  ERR_put_error(33,(125),(32),"pkcs7/pk7_doit.c",113);
  goto err;
 }

 md = EVP_get_digestbyname(OBJ_nid2sn(OBJ_obj2nid(alg->algorithm)));
 if (md == 
# 118 "pkcs7/pk7_doit.c" 3 4
          ((void *)0)
# 118 "pkcs7/pk7_doit.c"
              ) {
  ERR_put_error(33,(125),(109),"pkcs7/pk7_doit.c",120)
                                  ;
  goto err;
 }

 BIO_ctrl(btmp,111,0,(char *)md);
 if (*pbio == 
# 125 "pkcs7/pk7_doit.c" 3 4
             ((void *)0)
# 125 "pkcs7/pk7_doit.c"
                 )
  *pbio = btmp;
 else if (!BIO_push(*pbio, btmp)) {
  ERR_put_error(33,(125),(32),"pkcs7/pk7_doit.c",128);
  goto err;
 }
 btmp = 
# 131 "pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 131 "pkcs7/pk7_doit.c"
           ;
...
{
 EVP_PKEY_CTX *pctx = 
# 144 "pkcs7/pk7_doit.c" 3 4
                     ((void *)0)
# 144 "pkcs7/pk7_doit.c"
                         ;
 EVP_PKEY *pkey = 
# 145 "pkcs7/pk7_doit.c" 3 4
                 ((void *)0)
# 145 "pkcs7/pk7_doit.c"
                     ;
 unsigned char *ek = 
# 146 "pkcs7/pk7_doit.c" 3 4
                    ((void *)0)
# 146 "pkcs7/pk7_doit.c"
                        ;
 int ret = 0;
 size_t eklen;
...
# 154 "pkcs7/pk7_doit.c" 3 4
                              ((void *)0)
# 154 "pkcs7/pk7_doit.c"
                                  );
 if (!pctx)
  return 0;
 ...
 if (EVP_PKEY_CTX_ctrl(pctx, -1, (1<<8),
     3, 0, ri) <= 0) {
  ERR_put_error(33,(132),(152),"pkcs7/pk7_doit.c",163);
  goto err;
 }

 if (EVP_PKEY_encrypt(pctx, 
# 167 "pkcs7/pk7_doit.c" 3 4
                           ((void *)0)
# 167 "pkcs7/pk7_doit.c"
                               , &eklen, key, keylen) <= 0)
  goto err;
 ...
 if (ek == 
# 172 "pkcs7/pk7_doit.c" 3 4
          ((void *)0)
# 172 "pkcs7/pk7_doit.c"
              ) {
  ERR_put_error(33,(132),((1|64)),"pkcs7/pk7_doit.c",173);
  goto err;
 }
 ...
 ek = 
# 181 "pkcs7/pk7_doit.c" 3 4
     ((void *)0)
# 181 "pkcs7/pk7_doit.c"
         ;
...
{
 EVP_PKEY_CTX *pctx = 
# 197 "pkcs7/pk7_doit.c" 3 4
                     ((void *)0)
# 197 "pkcs7/pk7_doit.c"
                         ;
 unsigned char *ek = 
# 198 "pkcs7/pk7_doit.c" 3 4
                    ((void *)0)
# 198 "pkcs7/pk7_doit.c"
                        ;
 size_t eklen;
 ...
 pctx = EVP_PKEY_CTX_new(pkey, 
# 203 "pkcs7/pk7_doit.c" 3 4
                              ((void *)0)
# 203 "pkcs7/pk7_doit.c"
                                  );
 if (!pctx)
  return -1;
 ...
 if (EVP_PKEY_CTX_ctrl(pctx, -1, (1<<9),
     4, 0, ri) <= 0) {
  ERR_put_error(33,(133),(152),"pkcs7/pk7_doit.c",212);
  goto err;
 }

 if (EVP_PKEY_decrypt(pctx, 
# 216 "pkcs7/pk7_doit.c" 3 4
                           ((void *)0)
# 216 "pkcs7/pk7_doit.c"
                               , &eklen,
 ...
 ek = malloc(eklen);
 if (ek == 
# 221 "pkcs7/pk7_doit.c" 3 4
          ((void *)0)
# 221 "pkcs7/pk7_doit.c"
              ) {
  ERR_put_error(33,(133),((1|64)),"pkcs7/pk7_doit.c",222);
  goto err;
 }
 ...
 if (EVP_PKEY_decrypt(pctx, ek, &eklen,
     ri->enc_key->data, ri->enc_key->length) <= 0) {
  ret = 0;
  ERR_put_error(33,(133),(6),"pkcs7/pk7_doit.c",229);
  goto err;
 }
...
PKCS7_dataInit(PKCS7 *p7, BIO *bio)
{
 int i;
 BIO *out = 
# 255 "pkcs7/pk7_doit.c" 3 4
           ((void *)0)
# 255 "pkcs7/pk7_doit.c"
               , *btmp = 
# 255 "pkcs7/pk7_doit.c" 3 4
                         ((void *)0)
# 255 "pkcs7/pk7_doit.c"
                             ;
 X509_ALGOR *xa = 
# 256 "pkcs7/pk7_doit.c" 3 4
                 ((void *)0)
# 256 "pkcs7/pk7_doit.c"
                     ;
 const EVP_CIPHER *evp_cipher = 
# 257 "pkcs7/pk7_doit.c" 3 4
                               ((void *)0)
# 257 "pkcs7/pk7_doit.c"
                                   ;
 struct stack_st_X509_ALGOR *md_sk = 
# 258 "pkcs7/pk7_doit.c" 3 4
                              ((void *)0)
# 258 "pkcs7/pk7_doit.c"
                                  ;
 struct stack_st_PKCS7_RECIP_INFO *rsk = 
# 259 "pkcs7/pk7_doit.c" 3 4
                                  ((void *)0)
# 259 "pkcs7/pk7_doit.c"
                                      ;
 X509_ALGOR *xalg = 
# 260 "pkcs7/pk7_doit.c" 3 4
                   ((void *)0)
# 260 "pkcs7/pk7_doit.c"
                       ;
 PKCS7_RECIP_INFO *ri = 
# 261 "pkcs7/pk7_doit.c" 3 4
                       ((void *)0)
# 261 "pkcs7/pk7_doit.c"
                           ;
 ASN1_OCTET_STRING *os = 
# 262 "pkcs7/pk7_doit.c" 3 4
                        ((void *)0)
# 262 "pkcs7/pk7_doit.c"
                            ;

 if (p7 == 
# 264 "pkcs7/pk7_doit.c" 3 4
          ((void *)0)
# 264 "pkcs7/pk7_doit.c"
              ) {
  ERR_put_error(33,(105),(143),"pkcs7/pk7_doit.c",265);
  return 
# 266 "pkcs7/pk7_doit.c" 3 4
        ((void *)0)
# 266 "pkcs7/pk7_doit.c"
            ;
 }
# 281 "pkcs7/pk7_doit.c"
 if (p7->d.ptr == 
# 281 "pkcs7/pk7_doit.c" 3 4
                 ((void *)0)
# 281 "pkcs7/pk7_doit.c"
                     ) {
  ERR_put_error(33,(105),(122),"pkcs7/pk7_doit.c",282);
  return 
# 283 "pkcs7/pk7_doit.c" 3 4
        ((void *)0)
# 283 "pkcs7/pk7_doit.c"
            ;
 }
 ...
 case 24:
  ...
  if (evp_cipher == 
# 299 "pkcs7/pk7_doit.c" 3 4
                   ((void *)0)
# 299 "pkcs7/pk7_doit.c"
                       ) {
   ERR_put_error(33,(105),(116),"pkcs7/pk7_doit.c",301)
                                      ;
   goto err;
  }
  break;
 case 23:
  ...
  if (evp_cipher == 
# 309 "pkcs7/pk7_doit.c" 3 4
                   ((void *)0)
# 309 "pkcs7/pk7_doit.c"
                       ) {
   ERR_put_error(33,(105),(116),"pkcs7/pk7_doit.c",311)
                                      ;
   goto err;
  }
  break;
 ...
 case 21:
  break;
 default:
  ERR_put_error(33,(105),(112),"pkcs7/pk7_doit.c",323)
                                       ;
  goto err;
 }

 for (i = 0; i < sk_num(((_STACK*) (1 ? (md_sk) : (struct stack_st_X509_ALGOR*)0))); i++)
  if (!PKCS7_bio_add_digest(&out, ((X509_ALGOR *)sk_value(((_STACK*) (1 ? (md_sk) : (struct stack_st_X509_ALGOR*)0)), (i)))))
   goto err;
 ...
 if (evp_cipher != 
# 334 "pkcs7/pk7_doit.c" 3 4
                  ((void *)0)
# 334 "pkcs7/pk7_doit.c"
                      ) {
  ...
  if ((btmp = BIO_new(BIO_f_cipher())) == 
# 340 "pkcs7/pk7_doit.c" 3 4
                                         ((void *)0)
# 340 "pkcs7/pk7_doit.c"
                                             ) {
   ERR_put_error(33,(105),(32),"pkcs7/pk7_doit.c",341);
   goto err;
  }
  BIO_ctrl(btmp,129,0,(char *)&ctx);
  keylen = EVP_CIPHER_key_length(evp_cipher);
  ivlen = EVP_CIPHER_iv_length(evp_cipher);
  xalg->algorithm = OBJ_nid2obj(EVP_CIPHER_type(evp_cipher));
  if (ivlen > 0)
   arc4random_buf(iv, ivlen);
  if (EVP_CipherInit_ex(ctx, evp_cipher, 
# 350 "pkcs7/pk7_doit.c" 3 4
                                        ((void *)0)
# 350 "pkcs7/pk7_doit.c"
                                            , 
# 350 "pkcs7/pk7_doit.c" 3 4
                                              ((void *)0)
# 350 "pkcs7/pk7_doit.c"
...
# 351 "pkcs7/pk7_doit.c" 3 4
     ((void *)0)
# 351 "pkcs7/pk7_doit.c"
         , 1) <= 0)
   goto err;
  if (EVP_CIPHER_CTX_rand_key(ctx, key) <= 0)
   goto err;
  if (EVP_CipherInit_ex(ctx, 
# 355 "pkcs7/pk7_doit.c" 3 4
                            ((void *)0)
# 355 "pkcs7/pk7_doit.c"
                                , 
# 355 "pkcs7/pk7_doit.c" 3 4
                                  ((void *)0)
# 355 "pkcs7/pk7_doit.c"
  ...
  if (ivlen > 0) {
   if (xalg->parameter == 
# 359 "pkcs7/pk7_doit.c" 3 4
                         ((void *)0)
# 359 "pkcs7/pk7_doit.c"
                             ) {
    xalg->parameter = ASN1_TYPE_new();
    if (xalg->parameter == 
# 361 "pkcs7/pk7_doit.c" 3 4
                          ((void *)0)
# 361 "pkcs7/pk7_doit.c"
                              )
     goto err;
   }
  ...
  for (i = 0; i < sk_num(((_STACK*) (1 ? (rsk) : (struct stack_st_PKCS7_RECIP_INFO*)0))); i++) {
   ri = ((PKCS7_RECIP_INFO *)sk_value(((_STACK*) (1 ? (rsk) : (struct stack_st_PKCS7_RECIP_INFO*)0)), (i)));
  ...
  if (out == 
# 376 "pkcs7/pk7_doit.c" 3 4
            ((void *)0)
# 376 "pkcs7/pk7_doit.c"
                )
   out = btmp;
  else
   BIO_push(out, btmp);
  btmp = 
# 380 "pkcs7/pk7_doit.c" 3 4
        ((void *)0)
# 380 "pkcs7/pk7_doit.c"
            ;
 }

 if (bio == 
# 383 "pkcs7/pk7_doit.c" 3 4
           ((void *)0)
# 383 "pkcs7/pk7_doit.c"
               ) {
  if (((OBJ_obj2nid((p7)->type) == 22) && PKCS7_ctrl(p7,2,0,
# 384 "pkcs7/pk7_doit.c" 3 4
     ((void *)0)
# 384 "pkcs7/pk7_doit.c"
     )))
   bio = BIO_new(BIO_s_null());
  else if (os && os->length > 0)
   bio = BIO_new_mem_buf(os->data, os->length);
  if (bio == 
# 388 "pkcs7/pk7_doit.c" 3 4
            ((void *)0)
# 388 "pkcs7/pk7_doit.c"
                ) {
   bio = BIO_new(BIO_s_mem());
   if (bio == 
# 390 "pkcs7/pk7_doit.c" 3 4
             ((void *)0)
# 390 "pkcs7/pk7_doit.c"
                 )
    goto err;
   BIO_ctrl(bio,130,0,
# 392 "pkcs7/pk7_doit.c" 3 4
  ((void *)0)
# 392 "pkcs7/pk7_doit.c"
  );
  }
 }
 if (out)
  ...
  out = bio;
 bio = 
# 399 "pkcs7/pk7_doit.c" 3 4
      ((void *)0)
# 399 "pkcs7/pk7_doit.c"
          ;
 if (0) {
err:
  if (out != 
# 402 "pkcs7/pk7_doit.c" 3 4
            ((void *)0)
# 402 "pkcs7/pk7_doit.c"
                )
   BIO_free_all(out);
  if (btmp != 
# 404 "pkcs7/pk7_doit.c" 3 4
             ((void *)0)
# 404 "pkcs7/pk7_doit.c"
                 )
   BIO_free_all(btmp);
  out = 
# 406 "pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 406 "pkcs7/pk7_doit.c"
           ;
 }
 return (out);
}
...
PKCS7_dataDecode(PKCS7 *p7, EVP_PKEY *pkey, BIO *in_bio, X509 *pcert)
{
 int i, j;
 BIO *out = 
# 429 "pkcs7/pk7_doit.c" 3 4
           ((void *)0)
# 429 "pkcs7/pk7_doit.c"
               , *btmp = 
# 429 "pkcs7/pk7_doit.c" 3 4
                         ((void *)0)
# 429 "pkcs7/pk7_doit.c"
...
# 431 "pkcs7/pk7_doit.c" 3 4
                               ((void *)0)
# 431 "pkcs7/pk7_doit.c"
                                   ;
 const EVP_MD *evp_md;
 const EVP_CIPHER *evp_cipher = 
# 433 "pkcs7/pk7_doit.c" 3 4
                               ((void *)0)
# 433 "pkcs7/pk7_doit.c"
                                   ;
 EVP_CIPHER_CTX *evp_ctx = 
# 434 "pkcs7/pk7_doit.c" 3 4
                          ((void *)0)
# 434 "pkcs7/pk7_doit.c"
                              ;
 X509_ALGOR *enc_alg = 
# 435 "pkcs7/pk7_doit.c" 3 4
                      ((void *)0)
# 435 "pkcs7/pk7_doit.c"
                          ;
 struct stack_st_X509_ALGOR *md_sk = 
# 436 "pkcs7/pk7_doit.c" 3 4
                              ((void *)0)
# 436 "pkcs7/pk7_doit.c"
                                  ;
 struct stack_st_PKCS7_RECIP_INFO *rsk = 
# 437 "pkcs7/pk7_doit.c" 3 4
                                  ((void *)0)
# 437 "pkcs7/pk7_doit.c"
                                      ;
 PKCS7_RECIP_INFO *ri = 
# 438 "pkcs7/pk7_doit.c" 3 4
                       ((void *)0)
# 438 "pkcs7/pk7_doit.c"
                           ;
 unsigned char *ek = 
# 439 "pkcs7/pk7_doit.c" 3 4
                    ((void *)0)
# 439 "pkcs7/pk7_doit.c"
                        , *tkey = 
# 439 "pkcs7/pk7_doit.c" 3 4
                                  ((void *)0)
# 439 "pkcs7/pk7_doit.c"
 ...
 if (p7 == 
# 442 "pkcs7/pk7_doit.c" 3 4
          ((void *)0)
# 442 "pkcs7/pk7_doit.c"
              ) {
  ERR_put_error(33,(112),(143),"pkcs7/pk7_doit.c",444)
                                   ;
  return 
# 445 "pkcs7/pk7_doit.c" 3 4
        ((void *)0)
# 445 "pkcs7/pk7_doit.c"
            ;
 }

 if (p7->d.ptr == 
# 448 "pkcs7/pk7_doit.c" 3 4
                 ((void *)0)
# 448 "pkcs7/pk7_doit.c"
                     ) {
  ERR_put_error(33,(112),(122),"pkcs7/pk7_doit.c",449);
  return 
# 450 "pkcs7/pk7_doit.c" 3 4
        ((void *)0)
# 450 "pkcs7/pk7_doit.c"
            ;
 }
 ...
 case 24:
  ...
  if (evp_cipher == 
# 467 "pkcs7/pk7_doit.c" 3 4
                   ((void *)0)
# 467 "pkcs7/pk7_doit.c"
                       ) {
   ERR_put_error(33,(112),(111),"pkcs7/pk7_doit.c",469)
                                       ;
   goto err;
  }
  break;
 case 23:
  ...
  evp_cipher = EVP_get_cipherbyname(OBJ_nid2sn(OBJ_obj2nid(enc_alg->algorithm)));
  if (evp_cipher == 
# 478 "pkcs7/pk7_doit.c" 3 4
                   ((void *)0)
# 478 "pkcs7/pk7_doit.c"
                       ) {
   ERR_put_error(33,(112),(111),"pkcs7/pk7_doit.c",480)
                                       ;
   goto err;
  }
  break;
 default:
  ERR_put_error(33,(112),(112),"pkcs7/pk7_doit.c",486)
                                       ;
  goto err;
 }
 ...
 if (md_sk != 
# 491 "pkcs7/pk7_doit.c" 3 4
             ((void *)0)
# 491 "pkcs7/pk7_doit.c"
                 ) {
  for (i = 0; i < sk_num(((_STACK*) (1 ? (md_sk) : (struct stack_st_X509_ALGOR*)0))); i++) {
   xa = ((X509_ALGOR *)sk_value(((_STACK*) (1 ? (md_sk) : (struct stack_st_X509_ALGOR*)0)), (i)));
   if ((btmp = BIO_new(BIO_f_md())) == 
# 494 "pkcs7/pk7_doit.c" 3 4
                                      ((void *)0)
# 494 "pkcs7/pk7_doit.c"
                                          ) {
    ERR_put_error(33,(112),(32),"pkcs7/pk7_doit.c",496)
                      ;
    goto err;
   }
   ...
   if (evp_md == 
# 502 "pkcs7/pk7_doit.c" 3 4
                ((void *)0)
# 502 "pkcs7/pk7_doit.c"
                    ) {
    ERR_put_error(33,(112),(109),"pkcs7/pk7_doit.c",504)
                                    ;
    goto err;
   }

   BIO_ctrl(btmp,111,0,(char *)evp_md);
   if (out == 
# 509 "pkcs7/pk7_doit.c" 3 4
             ((void *)0)
# 509 "pkcs7/pk7_doit.c"
                 )
    out = btmp;
   else
    BIO_push(out, btmp);
   btmp = 
# 513 "pkcs7/pk7_doit.c" 3 4
         ((void *)0)
# 513 "pkcs7/pk7_doit.c"
             ;
  }
 }

 if (evp_cipher != 
# 517 "pkcs7/pk7_doit.c" 3 4
                  ((void *)0)
# 517 "pkcs7/pk7_doit.c"
                      ) {
  if ((etmp = BIO_new(BIO_f_cipher())) == 
# 518 "pkcs7/pk7_doit.c" 3 4
                                         ((void *)0)
# 518 "pkcs7/pk7_doit.c"
                                             ) {
   ERR_put_error(33,(112),(32),"pkcs7/pk7_doit.c",519);
   goto err;
  }
  ...
  if (pcert) {
   for (i = 0; i < sk_num(((_STACK*) (1 ? (rsk) : (struct stack_st_PKCS7_RECIP_INFO*)0))); i++) {
    ...
    if (!pkcs7_cmp_ri(ri, pcert))
     break;
    ri = 
# 534 "pkcs7/pk7_doit.c" 3 4
        ((void *)0)
# 534 "pkcs7/pk7_doit.c"
            ;
   }
   if (ri == 
# 536 "pkcs7/pk7_doit.c" 3 4
            ((void *)0)
# 536 "pkcs7/pk7_doit.c"
                ) {
    ERR_put_error(33,(112),(115),"pkcs7/pk7_doit.c",538)
                                                 ;
    goto err;
   }
  }
  ...
  if (pcert == 
# 544 "pkcs7/pk7_doit.c" 3 4
              ((void *)0)
# 544 "pkcs7/pk7_doit.c"
                  ) {
  ...
  evp_ctx = 
# 564 "pkcs7/pk7_doit.c" 3 4
           ((void *)0)
# 564 "pkcs7/pk7_doit.c"
               ;
  BIO_ctrl(etmp,129,0,(char *)&evp_ctx);
  if (EVP_CipherInit_ex(evp_ctx, evp_cipher, 
# 566 "pkcs7/pk7_doit.c" 3 4
                                            ((void *)0)
# 566 "pkcs7/pk7_doit.c"
                                                , 
# 566 "pkcs7/pk7_doit.c" 3 4
                                                  ((void *)0)
# 566 "pkcs7/pk7_doit.c"
...
# 567 "pkcs7/pk7_doit.c" 3 4
     ((void *)0)
# 567 "pkcs7/pk7_doit.c"
         , 0) <= 0)
   goto err;
  ...
  if (EVP_CIPHER_CTX_rand_key(evp_ctx, tkey) <= 0)
   goto err;
  if (ek == 
# 578 "pkcs7/pk7_doit.c" 3 4
           ((void *)0)
# 578 "pkcs7/pk7_doit.c"
               ) {
   ek = tkey;
   eklen = tkeylen;
   tkey = 
# 581 "pkcs7/pk7_doit.c" 3 4
         ((void *)0)
# 581 "pkcs7/pk7_doit.c"
             ;
  }
  ...
  if (eklen != EVP_CIPHER_CTX_key_length(evp_ctx)) {
   ...
   if (!EVP_CIPHER_CTX_set_key_length(evp_ctx, eklen)) {
    ...
    eklen = tkeylen;
    tkey = 
# 595 "pkcs7/pk7_doit.c" 3 4
          ((void *)0)
# 595 "pkcs7/pk7_doit.c"
              ;
   }
  }

  ERR_clear_error();
  if (EVP_CipherInit_ex(evp_ctx, 
# 600 "pkcs7/pk7_doit.c" 3 4
                                ((void *)0)
# 600 "pkcs7/pk7_doit.c"
                                    , 
# 600 "pkcs7/pk7_doit.c" 3 4
                                      ((void *)0)
# 600 "pkcs7/pk7_doit.c"
...
# 600 "pkcs7/pk7_doit.c"
  ...
  if (ek) {
   ...
   free(ek);
   ek = 
# 606 "pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 606 "pkcs7/pk7_doit.c"
           ;
  }
  if (tkey) {
...
# 611 "pkcs7/pk7_doit.c"
  ...
  if (out == 
# 614 "pkcs7/pk7_doit.c" 3 4
            ((void *)0)
# 614 "pkcs7/pk7_doit.c"
                )
   out = etmp;
  else
   BIO_push(out, etmp);
  etmp = 
# 618 "pkcs7/pk7_doit.c" 3 4
        ((void *)0)
# 618 "pkcs7/pk7_doit.c"
            ;
 }

 if (((OBJ_obj2nid((p7)->type) == 22) && PKCS7_ctrl(p7,2,0,
# 621 "pkcs7/pk7_doit.c" 3 4
    ((void *)0)
# 621 "pkcs7/pk7_doit.c"
    )) || (in_bio != 
# 621 "pkcs7/pk7_doit.c" 3 4
                                        ((void *)0)
# 621 "pkcs7/pk7_doit.c"
  ...
  if (data_body != 
# 624 "pkcs7/pk7_doit.c" 3 4
                  ((void *)0) 
# 624 "pkcs7/pk7_doit.c"
                       && data_body->length > 0)
   bio = BIO_new_mem_buf(data_body->data, data_body->length);
  else {
   bio = BIO_new(BIO_s_mem());
   BIO_ctrl(bio,130,0,
# 628 "pkcs7/pk7_doit.c" 3 4
  ((void *)0)
# 628 "pkcs7/pk7_doit.c"
  );
  }
  if (bio == 
# 630 "pkcs7/pk7_doit.c" 3 4
            ((void *)0)
...
err:
  ...
  if (out != 
# 645 "pkcs7/pk7_doit.c" 3 4
            ((void *)0)
# 645 "pkcs7/pk7_doit.c"
                )
   BIO_free_all(out);
  if (btmp != 
# 647 "pkcs7/pk7_doit.c" 3 4
             ((void *)0)
# 647 "pkcs7/pk7_doit.c"
                 )
   BIO_free_all(btmp);
  if (etmp != 
# 649 "pkcs7/pk7_doit.c" 3 4
             ((void *)0)
# 649 "pkcs7/pk7_doit.c"
                 )
   BIO_free_all(etmp);
  out = 
# 651 "pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 651 "pkcs7/pk7_doit.c"
           ;
 }
 return (out);
}
...
{
 for (;;) {
  bio = BIO_find_type(bio, (8|0x0200));
  if (bio == 
# 661 "pkcs7/pk7_doit.c" 3 4
            ((void *)0)
# 661 "pkcs7/pk7_doit.c"
                ) {
   ERR_put_error(33,(127),(108),"pkcs7/pk7_doit.c",663)
                                             ;
   return 
# 664 "pkcs7/pk7_doit.c" 3 4
         ((void *)0)
# 664 "pkcs7/pk7_doit.c"
             ;
  }
  BIO_ctrl(bio,120,0,(char *)pmd);
  if (*pmd == 
# 667 "pkcs7/pk7_doit.c" 3 4
             ((void *)0)
# 667 "pkcs7/pk7_doit.c"
                 ) {
   ERR_put_error(33,(127),((4|64)),"pkcs7/pk7_doit.c",669)
                            ;
   return 
# 670 "pkcs7/pk7_doit.c" 3 4
         ((void *)0)
# 670 "pkcs7/pk7_doit.c"
             ;
  }
  if (EVP_MD_type(EVP_MD_CTX_md(*pmd)) == nid)
   return bio;
  bio = BIO_next(bio);
 }
 return 
# 676 "pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 676 "pkcs7/pk7_doit.c"
           ;
}
...
{
 unsigned char md_data[64];
 unsigned int md_len;


 if (!PKCS7_get_signed_attribute(si, 52)) {
  if (!PKCS7_add0_attrib_signing_time(si, 
# 687 "pkcs7/pk7_doit.c" 3 4
                                         ((void *)0)
# 687 "pkcs7/pk7_doit.c"
                                             )) {
   ERR_put_error(33,(136),((1|64)),"pkcs7/pk7_doit.c",689)
                            ;
   return 0;
  }
 }
 ...
 if (!EVP_DigestFinal_ex(mctx, md_data, &md_len)) {
  ERR_put_error(33,(136),(6),"pkcs7/pk7_doit.c",696);
  return 0;
 }
 if (!PKCS7_add1_attrib_digest(si, md_data, md_len)) {
  ERR_put_error(33,(136),((1|64)),"pkcs7/pk7_doit.c",700);
  return 0;
 }
...
PKCS7_dataFinal(PKCS7 *p7, BIO *bio)
{
 ...
 struct stack_st_X509_ATTRIBUTE *sk;
 struct stack_st_PKCS7_SIGNER_INFO *si_sk = 
# 721 "pkcs7/pk7_doit.c" 3 4
                                     ((void *)0)
# 721 "pkcs7/pk7_doit.c"
                                         ;
 ASN1_OCTET_STRING *os = 
# 722 "pkcs7/pk7_doit.c" 3 4
                        ((void *)0)
# 722 "pkcs7/pk7_doit.c"
                            ;

 if (p7 == 
# 724 "pkcs7/pk7_doit.c" 3 4
          ((void *)0)
# 724 "pkcs7/pk7_doit.c"
              ) {
  ERR_put_error(33,(128),(143),"pkcs7/pk7_doit.c",726)
                                   ;
  return 0;
 }

 if (p7->d.ptr == 
# 730 "pkcs7/pk7_doit.c" 3 4
                 ((void *)0)
# 730 "pkcs7/pk7_doit.c"
                     ) {
  ERR_put_error(33,(128),(122),"pkcs7/pk7_doit.c",731);
  return 0;
 }
 ...
 case 24:
  ...
  if (!os) {
   ...
   if (!os) {
    ERR_put_error(33,(128),((1|64)),"pkcs7/pk7_doit.c",751)
                             ;
    goto err;
   }
 ...
 case 23:
  ...
  if (!os) {
   os = ASN1_OCTET_STRING_new();
   if (!os) {
    ERR_put_error(33,(128),((1|64)),"pkcs7/pk7_doit.c",764)
                             ;
    goto err;
   }
 ...
 case 22:
  ...
  os = PKCS7_get_octet_string(p7->d.sign->contents);
  if (!((OBJ_obj2nid((p7)->type) == 22) && PKCS7_ctrl(p7,2,0,
# 773 "pkcs7/pk7_doit.c" 3 4
      ((void *)0)
# 773 "pkcs7/pk7_doit.c"
      )) && os == 
# 773 "pkcs7/pk7_doit.c" 3 4
                                     ((void *)0)
# 773 "pkcs7/pk7_doit.c"
                                         ) {
   ERR_put_error(33,(128),(130),"pkcs7/pk7_doit.c",774);
   goto err;
  }

  if ((OBJ_obj2nid((p7->d.sign->contents)->type) == 21) && p7->detached) {
   ASN1_OCTET_STRING_free(os);
   os = 
# 780 "pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 780 "pkcs7/pk7_doit.c"
           ;
   p7->d.sign->contents->d.data = 
# 781 "pkcs7/pk7_doit.c" 3 4
                                 ((void *)0)
# 781 "pkcs7/pk7_doit.c"
                                     ;
  }
  break;
 ...
 case 25:
  os = PKCS7_get_octet_string(p7->d.digest->contents);
  if (os == 
# 787 "pkcs7/pk7_doit.c" 3 4
           ((void *)0)
# 787 "pkcs7/pk7_doit.c"
               ) {
   ERR_put_error(33,(128),(130),"pkcs7/pk7_doit.c",788);
   goto err;
  }

  if ((OBJ_obj2nid((p7->d.digest->contents)->type) == 21) &&
      p7->detached) {
   ASN1_OCTET_STRING_free(os);
   os = 
# 795 "pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 795 "pkcs7/pk7_doit.c"
           ;
   p7->d.digest->contents->d.data = 
# 796 "pkcs7/pk7_doit.c" 3 4
                                   ((void *)0)
# 796 "pkcs7/pk7_doit.c"
                                       ;
  }
  break;

 default:
  ERR_put_error(33,(128),(112),"pkcs7/pk7_doit.c",802)
                                       ;
  goto err;
 }

 if (si_sk != 
# 806 "pkcs7/pk7_doit.c" 3 4
             ((void *)0)
# 806 "pkcs7/pk7_doit.c"
                 ) {
  for (i = 0; i < sk_num(((_STACK*) (1 ? (si_sk) : (struct stack_st_PKCS7_SIGNER_INFO*)0))); i++) {
   si = ((PKCS7_SIGNER_INFO *)sk_value(((_STACK*) (1 ? (si_sk) : (struct stack_st_PKCS7_SIGNER_INFO*)0)), (i)));
   if (si->pkey == 
# 809 "pkcs7/pk7_doit.c" 3 4
                  ((void *)0)
# 809 "pkcs7/pk7_doit.c"
                      )
    continue;
   ...
   if (btmp == 
# 818 "pkcs7/pk7_doit.c" 3 4
              ((void *)0)
# 818 "pkcs7/pk7_doit.c"
                  )
    goto err;
   ...
   if (sk_num(((_STACK*) (1 ? (sk) : (struct stack_st_X509_ATTRIBUTE*)0))) > 0) {
    if (!do_pkcs7_signed_attrib(si, &ctx_tmp))
     goto err;
   } else {
    unsigned char *abuf = 
# 834 "pkcs7/pk7_doit.c" 3 4
                         ((void *)0)
# 834 "pkcs7/pk7_doit.c"
                             ;
    ...
    if (!EVP_SignFinal(&ctx_tmp, abuf, &abuflen,
        si->pkey)) {
     ERR_put_error(33,(128),(6),"pkcs7/pk7_doit.c",844)
                       ;
     goto err;
    }
 ...
 if (!((OBJ_obj2nid((p7)->type) == 22) && PKCS7_ctrl(p7,2,0,
# 864 "pkcs7/pk7_doit.c" 3 4
     ((void *)0)
# 864 "pkcs7/pk7_doit.c"
     ))) {
  ...
  if (os == 
# 869 "pkcs7/pk7_doit.c" 3 4
           ((void *)0)
# 869 "pkcs7/pk7_doit.c"
               )
   goto err;
  if (!(os->flags & 0x010)) {
   char *cont;
   ...
   btmp = BIO_find_type(bio, (1|0x0400));
   if (btmp == 
# 876 "pkcs7/pk7_doit.c" 3 4
              ((void *)0)
# 876 "pkcs7/pk7_doit.c"
                  ) {
    ERR_put_error(33,(128),(107),"pkcs7/pk7_doit.c",878)
                                       ;
    goto err;
   }
   contlen = BIO_ctrl(btmp,3,0,(char *)&cont);




   BIO_set_flags(btmp, 0x200);
   BIO_ctrl(btmp,130,0,
# 887 "pkcs7/pk7_doit.c" 3 4
  ((void *)0)
# 887 "pkcs7/pk7_doit.c"
  );
...
PKCS7_SIGNER_INFO_sign(PKCS7_SIGNER_INFO *si)
{
 ...
 EVP_PKEY_CTX *pctx;
 unsigned char *abuf = 
# 902 "pkcs7/pk7_doit.c" 3 4
                      ((void *)0)
# 902 "pkcs7/pk7_doit.c"
                          ;
 int alen;
 size_t siglen;
 const EVP_MD *md = 
# 905 "pkcs7/pk7_doit.c" 3 4
                   ((void *)0)
# 905 "pkcs7/pk7_doit.c"
                       ;

 md = EVP_get_digestbyname(OBJ_nid2sn(OBJ_obj2nid(si->digest_alg->algorithm)));
 if (md == 
# 908 "pkcs7/pk7_doit.c" 3 4
          ((void *)0)
# 908 "pkcs7/pk7_doit.c"
              )
  return 0;

 EVP_MD_CTX_init(&mctx);
 if (EVP_DigestSignInit(&mctx, &pctx, md, 
# 912 "pkcs7/pk7_doit.c" 3 4
                                         ((void *)0)
# 912 "pkcs7/pk7_doit.c"
                                             , si->pkey) <= 0)
  goto err;

 if (EVP_PKEY_CTX_ctrl(pctx, -1, (1<<3),
     5, 0, si) <= 0) {
  ERR_put_error(33,(139),(152),"pkcs7/pk7_doit.c",917);
  goto err;
 }
 ...
 if (!abuf)
  goto err;
 if (EVP_DigestUpdate(&mctx,abuf,alen) <= 0)
  goto err;
 free(abuf);
 abuf = 
# 928 "pkcs7/pk7_doit.c" 3 4
       ((void *)0)
# 928 "pkcs7/pk7_doit.c"
           ;
 if (EVP_DigestSignFinal(&mctx, 
# 929 "pkcs7/pk7_doit.c" 3 4
                               ((void *)0)
# 929 "pkcs7/pk7_doit.c"
                                   , &siglen) <= 0)
  goto err;
 abuf = malloc(siglen);
 if (!abuf)
 ...
 if (EVP_PKEY_CTX_ctrl(pctx, -1, (1<<3),
     5, 1, si) <= 0) {
  ERR_put_error(33,(139),(152),"pkcs7/pk7_doit.c",939);
  goto err;
 }
    ...
    PKCS7 *p7, PKCS7_SIGNER_INFO *si)
{
 ...
 if (p7 == 
# 964 "pkcs7/pk7_doit.c" 3 4
          ((void *)0)
# 964 "pkcs7/pk7_doit.c"
              ) {
  ERR_put_error(33,(107),(143),"pkcs7/pk7_doit.c",966)
                                   ;
  return 0;
 }

 if (p7->d.ptr == 
# 970 "pkcs7/pk7_doit.c" 3 4
                 ((void *)0)
# 970 "pkcs7/pk7_doit.c"
                     ) {
  ERR_put_error(33,(107),(122),"pkcs7/pk7_doit.c",971);
  return 0;
 }

 if ((OBJ_obj2nid((p7)->type) == 22)) {
  cert = p7->d.sign->cert;
 } else if ((OBJ_obj2nid((p7)->type) == 24)) {
  cert = p7->d.signed_and_enveloped->cert;
 } else {
  ERR_put_error(33,(107),(114),"pkcs7/pk7_doit.c",980);
  goto err;
 }
 ...
 if (x509 == 
# 989 "pkcs7/pk7_doit.c" 3 4
            ((void *)0)
# 989 "pkcs7/pk7_doit.c"
                ) {
  ERR_put_error(33,(107),(106),"pkcs7/pk7_doit.c",991)
                                         ;
  goto err;
 }
 ...
 if (!X509_STORE_CTX_init(ctx, cert_store, x509, cert)) {
  ERR_put_error(33,(107),(11),"pkcs7/pk7_doit.c",997);
  goto err;
 }
 X509_STORE_CTX_set_purpose(ctx, 4);
 i = X509_verify_cert(ctx);
 if (i <= 0) {
  ERR_put_error(33,(107),(11),"pkcs7/pk7_doit.c",1003);
...
PKCS7_signatureVerify(BIO *bio, PKCS7 *p7, PKCS7_SIGNER_INFO *si, X509 *x509)
{
 ...
 if (!(OBJ_obj2nid((p7)->type) == 22) &&
  ...
  ERR_put_error(33,(113),(114),"pkcs7/pk7_doit.c",1031)
                               ;
  goto err;
 }
 ...
 for (;;) {
  if ((btmp == 
# 1039 "pkcs7/pk7_doit.c" 3 4
              ((void *)0)
# 1039 "pkcs7/pk7_doit.c"
                  ) ||
      ((btmp = BIO_find_type(btmp, (8|0x0200))) == 
# 1040 "pkcs7/pk7_doit.c" 3 4
                                                   ((void *)0)
# 1040 "pkcs7/pk7_doit.c"
                                                       )) {
   ERR_put_error(33,(113),(108),"pkcs7/pk7_doit.c",1042)
                                             ;
   goto err;
  }
  BIO_ctrl(btmp,120,0,(char *)&mdc);
  if (mdc == 
# 1046 "pkcs7/pk7_doit.c" 3 4
            ((void *)0)
# 1046 "pkcs7/pk7_doit.c"
                ) {
   ERR_put_error(33,(113),((4|64)),"pkcs7/pk7_doit.c",1048)
                            ;
   goto err;
  }
  if (EVP_MD_type(EVP_MD_CTX_md(mdc)) == md_type)
   break;
 ...
 sk = si->auth_attr;
 if ((sk != 
# 1067 "pkcs7/pk7_doit.c" 3 4
           ((void *)0)
# 1067 "pkcs7/pk7_doit.c"
               ) && (sk_num(((_STACK*) (1 ? (sk) : (struct stack_st_X509_ATTRIBUTE*)0))) != 0)) {
  unsigned char md_dat[64], *abuf = 
# 1068 "pkcs7/pk7_doit.c" 3 4
                                                ((void *)0)
# 1068 "pkcs7/pk7_doit.c"
                                                    ;
  unsigned int md_len;
  int alen;
  ...
  if (!message_digest) {
   ERR_put_error(33,(113),(108),"pkcs7/pk7_doit.c",1078)
                                             ;
   goto err;
  }
  if ((message_digest->length != (int)md_len) ||
      (memcmp(message_digest->data, md_dat, md_len))) {
   ERR_put_error(33,(113),(101),"pkcs7/pk7_doit.c",1084)
                              ;
   ret = -1;
   goto err;
  }

  if (!EVP_DigestInit_ex(&mdc_tmp,EVP_get_digestbyname(OBJ_nid2sn(md_type)),
# 1089 "pkcs7/pk7_doit.c" 3 4
      ((void *)0)
# 1089 "pkcs7/pk7_doit.c"
      )
           )
   goto err;
  ...
  if (alen <= 0) {
   ERR_put_error(33,(113),(13),"pkcs7/pk7_doit.c",1096);
   ret = -1;
   goto err;
  }
  if (!EVP_DigestUpdate(&mdc_tmp,abuf,alen))
   goto err;
 ...
 EVP_PKEY_free(pkey);
 if (i <= 0) {
  ERR_put_error(33,(113),(105),"pkcs7/pk7_doit.c",1117)
                                ;
  ret = -1;
  goto err;
 } else
...
PKCS7_get_issuer_and_serial(PKCS7 *p7, int idx)
{
 ...
 if (i != 24)
  return 
# 1136 "pkcs7/pk7_doit.c" 3 4
        ((void *)0)
# 1136 "pkcs7/pk7_doit.c"
            ;
 if (p7->d.signed_and_enveloped == 
# 1137 "pkcs7/pk7_doit.c" 3 4
                                  ((void *)0)
# 1137 "pkcs7/pk7_doit.c"
                                      )
  return 
# 1138 "pkcs7/pk7_doit.c" 3 4
        ((void *)0)
# 1138 "pkcs7/pk7_doit.c"
            ;
 rsk = p7->d.signed_and_enveloped->recipientinfo;
 if (rsk == 
# 1140 "pkcs7/pk7_doit.c" 3 4
           ((void *)0)
# 1140 "pkcs7/pk7_doit.c"
               )
  return 
# 1141 "pkcs7/pk7_doit.c" 3 4
        ((void *)0)
# 1141 "pkcs7/pk7_doit.c"
            ;
 ri = ((PKCS7_RECIP_INFO *)sk_value(((_STACK*) (1 ? (rsk) : (struct stack_st_PKCS7_RECIP_INFO*)0)), (0)));
 if (sk_num(((_STACK*) (1 ? (rsk) : (struct stack_st_PKCS7_RECIP_INFO*)0))) <= idx)
  return (
# 1144 "pkcs7/pk7_doit.c" 3 4
         ((void *)0)
# 1144 "pkcs7/pk7_doit.c"
             );
 ri = ((PKCS7_RECIP_INFO *)sk_value(((_STACK*) (1 ? (rsk) : (struct stack_st_PKCS7_RECIP_INFO*)0)), (idx)));
...
static ASN1_TYPE *
get_attribute(struct stack_st_X509_ATTRIBUTE *sk, int nid)
{
 int i;
 X509_ATTRIBUTE *xa;
 ASN1_OBJECT *o;
 ...
 if (!o || !sk)
  return (
# 1170 "pkcs7/pk7_doit.c" 3 4
         ((void *)0)
# 1170 "pkcs7/pk7_doit.c"
             );
 for (i = 0; i < sk_num(((_STACK*) (1 ? (sk) : (struct stack_st_X509_ATTRIBUTE*)0))); i++) {
  xa = ((X509_ATTRIBUTE *)sk_value(((_STACK*) (1 ? (sk) : (struct stack_st_X509_ATTRIBUTE*)0)), (i)));
  if (OBJ_cmp(xa->object, o) == 0) {
   if (!xa->single && sk_num(((_STACK*) (1 ? (xa->value.set) : (struct stack_st_ASN1_TYPE*)0))))
    return (((ASN1_TYPE *)sk_value(((_STACK*) (1 ? (xa->value.set) : (struct stack_st_ASN1_TYPE*)0)), (0))));
   else
    return (
# 1177 "pkcs7/pk7_doit.c" 3 4
           ((void *)0)
# 1177 "pkcs7/pk7_doit.c"
               );
  }
 }
 return (
# 1180 "pkcs7/pk7_doit.c" 3 4
        ((void *)0)
# 1180 "pkcs7/pk7_doit.c"
            );
}

ASN1_OCTET_STRING *
PKCS7_digest_from_attributes(struct stack_st_X509_ATTRIBUTE *sk)
{
 ASN1_TYPE *astype;

 if (!(astype = get_attribute(sk, 51)))
  return 
# 1189 "pkcs7/pk7_doit.c" 3 4
        ((void *)0)
# 1189 "pkcs7/pk7_doit.c"
            ;
 if (astype->type != 4)
  return 
# 1191 "pkcs7/pk7_doit.c" 3 4
        ((void *)0)
# 1191 "pkcs7/pk7_doit.c"
            ;
    ...
    struct stack_st_X509_ATTRIBUTE *sk)
{
 ...
 if (p7si->auth_attr != 
# 1201 "pkcs7/pk7_doit.c" 3 4
                       ((void *)0)
# 1201 "pkcs7/pk7_doit.c"
                           )
  sk_pop_free(((_STACK*) (1 ? (p7si->auth_attr) : (struct stack_st_X509_ATTRIBUTE*)0)), ((void (*)(void *)) ((1 ? (X509_ATTRIBUTE_free) : (void (*)(X509_ATTRIBUTE *))0))))
                          ;
 p7si->auth_attr = (struct stack_st_X509_ATTRIBUTE *)sk_dup(((_STACK*) (1 ? sk : (struct stack_st_X509_ATTRIBUTE*)0)));
 if (p7si->auth_attr == 
# 1205 "pkcs7/pk7_doit.c" 3 4
                       ((void *)0)
# 1205 "pkcs7/pk7_doit.c"
                           )
  return 0;
 for (i = 0; i < sk_num(((_STACK*) (1 ? (sk) : (struct stack_st_X509_ATTRIBUTE*)0))); i++) {
  if ((sk_set(((_STACK*) (1 ? (p7si->auth_attr) : (struct stack_st_X509_ATTRIBUTE*)0)), (i), ((void*) (1 ? (X509_ATTRIBUTE_dup(((X509_ATTRIBUTE *)sk_value(((_STACK*) (1 ? (sk) : (struct stack_st_X509_ATTRIBUTE*)0)), (i))))) : (X509_ATTRIBUTE*)0)))
                                                         )
      == 
# 1210 "pkcs7/pk7_doit.c" 3 4
        ((void *)0)
# 1210 "pkcs7/pk7_doit.c"
            )
   return (0);
 }
 return (1);
...
int
PKCS7_set_attributes(PKCS7_SIGNER_INFO *p7si, struct stack_st_X509_ATTRIBUTE *sk)
{
 int i;

 if (p7si->unauth_attr != 
# 1221 "pkcs7/pk7_doit.c" 3 4
                         ((void *)0)
# 1221 "pkcs7/pk7_doit.c"
                             )
  sk_pop_free(((_STACK*) (1 ? (p7si->unauth_attr) : (struct stack_st_X509_ATTRIBUTE*)0)), ((void (*)(void *)) ((1 ? (X509_ATTRIBUTE_free) : (void (*)(X509_ATTRIBUTE *))0))))
                          ;
 p7si->unauth_attr = (struct stack_st_X509_ATTRIBUTE *)sk_dup(((_STACK*) (1 ? sk : (struct stack_st_X509_ATTRIBUTE*)0)));
 if (p7si->unauth_attr == 
# 1225 "pkcs7/pk7_doit.c" 3 4
                         ((void *)0)
# 1225 "pkcs7/pk7_doit.c"
                             )
  return 0;
 for (i = 0; i < sk_num(((_STACK*) (1 ? (sk) : (struct stack_st_X509_ATTRIBUTE*)0))); i++) {
  if ((sk_set(((_STACK*) (1 ? (p7si->unauth_attr) : (struct stack_st_X509_ATTRIBUTE*)0)), (i), ((void*) (1 ? (X509_ATTRIBUTE_dup(((X509_ATTRIBUTE *)sk_value(((_STACK*) (1 ? (sk) : (struct stack_st_X509_ATTRIBUTE*)0)), (i))))) : (X509_ATTRIBUTE*)0)))
                                                         )
      == 
# 1230 "pkcs7/pk7_doit.c" 3 4
        ((void *)0)
# 1230 "pkcs7/pk7_doit.c"
            )
   return (0);
 }
 return (1);
...
static int
add_attribute(struct stack_st_X509_ATTRIBUTE **sk, int nid, int atrtype, void *value)
{
 X509_ATTRIBUTE *attr = 
# 1252 "pkcs7/pk7_doit.c" 3 4
                       ((void *)0)
# 1252 "pkcs7/pk7_doit.c"
                           ;

 if (*sk == 
# 1254 "pkcs7/pk7_doit.c" 3 4
           ((void *)0)
# 1254 "pkcs7/pk7_doit.c"
               ) {
  *sk = ((struct stack_st_X509_ATTRIBUTE *)sk_new_null());
  if (*sk == 
# 1256 "pkcs7/pk7_doit.c" 3 4
            ((void *)0)
# 1256 "pkcs7/pk7_doit.c"
                )
   return 0;
new_attrib:
  if (!(attr = X509_ATTRIBUTE_create(nid, atrtype, value)))
   return 0;
  if (!sk_push(((_STACK*) (1 ? (*sk) : (struct stack_st_X509_ATTRIBUTE*)0)), ((void*) (1 ? (attr) : (X509_ATTRIBUTE*)0)))) {
  ...
  for (i = 0; i < sk_num(((_STACK*) (1 ? (*sk) : (struct stack_st_X509_ATTRIBUTE*)0))); i++) {
   attr = ((X509_ATTRIBUTE *)sk_value(((_STACK*) (1 ? (*sk) : (struct stack_st_X509_ATTRIBUTE*)0)), (i)));
   if (OBJ_obj2nid(attr->object) == nid) {
    X509_ATTRIBUTE_free(attr);
    attr = X509_ATTRIBUTE_create(nid, atrtype,
        value);
    if (attr == 
# 1274 "pkcs7/pk7_doit.c" 3 4
               ((void *)0)
# 1274 "pkcs7/pk7_doit.c"
                   )
     return 0;
    if (!sk_set(((_STACK*) (1 ? (*sk) : (struct stack_st_X509_ATTRIBUTE*)0)), (i), ((void*) (1 ? (attr) : (X509_ATTRIBUTE*)0)))) {
     X509_ATTRIBUTE_free(attr);
     return 0;
    }
    goto end;
