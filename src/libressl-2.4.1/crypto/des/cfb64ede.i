...
void DES_ede3_cfb64_encrypt(const unsigned char *in, unsigned char *out,
 ...
 if (enc)
  ...
  while (l--)
   ...
   if (n == 0)
    {
    (v0 =((unsigned int)(*((iv)++))) , v0|=((unsigned int)(*((iv)++)))<< 8L, v0|=((unsigned int)(*((iv)++)))<<16L, v0|=((unsigned int)(*((iv)++)))<<24L);
    (v1 =((unsigned int)(*((iv)++))) , v1|=((unsigned int)(*((iv)++)))<< 8L, v1|=((unsigned int)(*((iv)++)))<<16L, v1|=((unsigned int)(*((iv)++)))<<24L);
...
void DES_ede3_cfb_encrypt(const unsigned char *in,unsigned char *out,
 ...
 if (enc)
  ...
  while (l >= n)
   ...
   ti[1]=v1;
   DES_encrypt3(ti,ks1,ks2,ks3);
   { in+=n; d0=d1=0; switch (n) { case 8: d1 =((unsigned int)(*(--(in))))<<24L; case 7: d1|=((unsigned int)(*(--(in))))<<16L; case 6: d1|=((unsigned int)(*(--(in))))<< 8L; case 5: d1|=((unsigned int)(*(--(in)))); case 4: d0 =((unsigned int)(*(--(in))))<<24L; case 3: d0|=((unsigned int)(*(--(in))))<<16L; case 2: d0|=((unsigned int)(*(--(in))))<< 8L; case 1: d0|=((unsigned int)(*(--(in)))); } };
   in+=n;
   d0^=ti[0];
   d1^=ti[1];
   ...
   if (num == 32)
    ...
    (*((iv)++)=(unsigned char)(((v0) )&0xff), *((iv)++)=(unsigned char)(((v0)>> 8L)&0xff), *((iv)++)=(unsigned char)(((v0)>>16L)&0xff), *((iv)++)=(unsigned char)(((v0)>>24L)&0xff));
    (*((iv)++)=(unsigned char)(((v1) )&0xff), *((iv)++)=(unsigned char)(((v1)>> 8L)&0xff), *((iv)++)=(unsigned char)(((v1)>>16L)&0xff), *((iv)++)=(unsigned char)(((v1)>>24L)&0xff));
    (*((iv)++)=(unsigned char)(((d0) )&0xff), *((iv)++)=(unsigned char)(((d0)>> 8L)&0xff), *((iv)++)=(unsigned char)(((d0)>>16L)&0xff), *((iv)++)=(unsigned char)(((d0)>>24L)&0xff));
    (*((iv)++)=(unsigned char)(((d1) )&0xff), *((iv)++)=(unsigned char)(((d1)>> 8L)&0xff), *((iv)++)=(unsigned char)(((d1)>>16L)&0xff), *((iv)++)=(unsigned char)(((d1)>>24L)&0xff));
