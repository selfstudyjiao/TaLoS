...
int DES_enc_read(int fd, void *buf, int len, DES_key_schedule *sched,
 ...
 int net_num=0;
 static unsigned char *net=
# 93 "des/enc_read.c" 3 4
                          ((void *)0)
# 93 "des/enc_read.c"
                              ;
 ...
 static unsigned char *unnet=
# 97 "des/enc_read.c" 3 4
                            ((void *)0)
# 97 "des/enc_read.c"
                                ;
...
# 100 "des/enc_read.c"
 ...
 if (tmpbuf == 
# 105 "des/enc_read.c" 3 4
              ((void *)0)
# 105 "des/enc_read.c"
                  )
  {
  tmpbuf=malloc(((1024*16)+4));
  if (tmpbuf == 
# 108 "des/enc_read.c" 3 4
               ((void *)0)
# 108 "des/enc_read.c"
                   ) return(-1);
  }
 if (net == 
# 110 "des/enc_read.c" 3 4
           ((void *)0)
# 110 "des/enc_read.c"
               )
  {
  net=malloc(((1024*16)+4));
  if (net == 
# 113 "des/enc_read.c" 3 4
            ((void *)0)
# 113 "des/enc_read.c"
                ) return(-1);
  }
 if (unnet == 
# 115 "des/enc_read.c" 3 4
             ((void *)0)
# 115 "des/enc_read.c"
                 )
  {
  unnet=malloc(((1024*16)+4));
  if (unnet == 
# 118 "des/enc_read.c" 3 4
              ((void *)0)
# 118 "des/enc_read.c"
                  ) return(-1);
  }
 ...
 while (net_num < 4)
  {
  i=read(fd,(void *)&(net[net_num]),4 -net_num);

  if ((i == -1) && (
# 153 "des/enc_read.c" 3 4
                   (*__errno_location ()) 
# 153 "des/enc_read.c"
                         == 
# 153 "des/enc_read.c" 3 4
...
# 153 "des/enc_read.c"
 ...
 (num =((unsigned int)(*((p)++)))<<24L, num|=((unsigned int)(*((p)++)))<<16L, num|=((unsigned int)(*((p)++)))<< 8L, num|=((unsigned int)(*((p)++))));



 if ((num > (1024*16)) || (num < 0))
  return(-1);
...
# 175 "des/enc_read.c"
 ...
 if (len < num)
  {
  if (DES_rw_mode & 1)
   DES_pcbc_encrypt(net,unnet,num,sched,iv,0);
  else
   DES_cbc_encrypt(net,unnet,num,sched,iv,0);
