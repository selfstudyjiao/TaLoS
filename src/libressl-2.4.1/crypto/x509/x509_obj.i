...
# 70 "x509/x509_obj.c" 2

extern sgx_status_t ocall_malloc(void** retval, size_t size);

char* X509_name_online_buffer = 
# 73 "x509/x509_obj.c" 3 4
                               ((void *)0)
# 73 "x509/x509_obj.c"
                                   ;
...
# 100 "x509/x509_obj.c"
 ...
 if (buf == 
# 105 "x509/x509_obj.c" 3 4
           ((void *)0)
# 105 "x509/x509_obj.c"
               ) {
  if ((b = BUF_MEM_new()) == 
# 106 "x509/x509_obj.c" 3 4
                            ((void *)0)
# 106 "x509/x509_obj.c"
                                )
   goto err;
...
# 113 "x509/x509_obj.c"
 ...
 for (i = 0; i < sk_num(((_STACK*) (1 ? (a->entries) : (struct stack_st_X509_NAME_ENTRY*)0))); i++) {
  ne = ((X509_NAME_ENTRY *)sk_value(((_STACK*) (1 ? (a->entries) : (struct stack_st_X509_NAME_ENTRY*)0)), (i)));
  n = OBJ_obj2nid(ne->object);
  if ((n == 0) || ((s = OBJ_nid2sn(n)) == 
# 127 "x509/x509_obj.c" 3 4
                                                 ((void *)0)
# 127 "x509/x509_obj.c"
                                                     )) {
...
err:
 ERR_put_error(11,(116),((1|64)),"x509/x509_obj.c",198);
 if (b != 
# 199 "x509/x509_obj.c" 3 4
         ((void *)0)
# 199 "x509/x509_obj.c"
             )
  BUF_MEM_free(b);
 return (
# 201 "x509/x509_obj.c" 3 4
        ((void *)0)
# 201 "x509/x509_obj.c"
            );
}
