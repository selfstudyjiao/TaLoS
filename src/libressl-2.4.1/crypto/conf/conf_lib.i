...
# 64 "conf/conf_lib.c" 2


static CONF_METHOD *default_CONF_method = 
# 66 "conf/conf_lib.c" 3 4
                                         ((void *)0)
# 66 "conf/conf_lib.c"
                                             ;
...
void
CONF_set_nconf(CONF *conf, struct lhash_st_CONF_VALUE *hash)
{
 if (default_CONF_method == 
# 73 "conf/conf_lib.c" 3 4
                           ((void *)0)
# 73 "conf/conf_lib.c"
                               )
...
# 93 "conf/conf_lib.c"
 ...
 if (in == 
# 96 "conf/conf_lib.c" 3 4
          ((void *)0)
# 96 "conf/conf_lib.c"
              ) {
  ERR_put_error(14,(100),(2),"conf/conf_lib.c",97);
  return 
# 98 "conf/conf_lib.c" 3 4
        ((void *)0)
# 98 "conf/conf_lib.c"
            ;
 }
    ...
    long *eline)
{
 ...
 if (!(btmp = BIO_new_fp(fp, 0x00))) {
  ERR_put_error(14,(103),(7),"conf/conf_lib.c",114);
  return 
# 115 "conf/conf_lib.c" 3 4
        ((void *)0)
# 115 "conf/conf_lib.c"
            ;
 }
...
{
 if (conf == 
# 139 "conf/conf_lib.c" 3 4
            ((void *)0)
# 139 "conf/conf_lib.c"
                ) {
  return 
# 140 "conf/conf_lib.c" 3 4
        ((void *)0)
# 140 "conf/conf_lib.c"
            ;
 } else {
...
char *
CONF_get_string(struct lhash_st_CONF_VALUE *conf, const char *group,
    const char *name)
{
 if (conf == 
# 152 "conf/conf_lib.c" 3 4
            ((void *)0)
# 152 "conf/conf_lib.c"
                ) {
  return NCONF_get_string(
# 153 "conf/conf_lib.c" 3 4
                         ((void *)0)
# 153 "conf/conf_lib.c"
                             , group, name);
 } else {
...
long
CONF_get_number(struct lhash_st_CONF_VALUE *conf, const char *group,
    const char *name)
{
 int status;
 long result = 0;
 ...
 if (conf == 
# 168 "conf/conf_lib.c" 3 4
            ((void *)0)
# 168 "conf/conf_lib.c"
                ) {
  status = NCONF_get_number_e(
# 169 "conf/conf_lib.c" 3 4
                             ((void *)0)
# 169 "conf/conf_lib.c"
                                 , group, name, &result);
 } else {
...
void
CONF_free(struct lhash_st_CONF_VALUE *conf)
{
 CONF ctmp;
...
int
CONF_dump_fp(struct lhash_st_CONF_VALUE *conf, FILE *out)
{
 BIO *btmp;
 int ret;

 if (!(btmp = BIO_new_fp(out, 0x00))) {
  ERR_put_error(14,(104),(7),"conf/conf_lib.c",199);
  return 0;
 }
...
int
CONF_dump_bio(struct lhash_st_CONF_VALUE *conf, BIO *out)
{
 CONF ctmp;
...
# 227 "conf/conf_lib.c"
 ...
 if (ret == 
# 231 "conf/conf_lib.c" 3 4
           ((void *)0)
# 231 "conf/conf_lib.c"
               ) {
  ERR_put_error(14,(111),((1|64)),"conf/conf_lib.c",232);
  return (
# 233 "conf/conf_lib.c" 3 4
         ((void *)0)
# 233 "conf/conf_lib.c"
             );
 }
...
{
 if (conf == 
# 258 "conf/conf_lib.c" 3 4
            ((void *)0)
# 258 "conf/conf_lib.c"
                ) {
  ERR_put_error(14,(113),(105),"conf/conf_lib.c",259);
  return 0;
 }
...
NCONF_load_fp(CONF *conf, FILE *fp, long *eline)
{
 ...
 if (!(btmp = BIO_new_fp(fp, 0x00))) {
  ERR_put_error(14,(114),(7),"conf/conf_lib.c",273);
  return 0;
 }
...
{
 if (conf == 
# 284 "conf/conf_lib.c" 3 4
            ((void *)0)
# 284 "conf/conf_lib.c"
                ) {
  ERR_put_error(14,(110),(105),"conf/conf_lib.c",285);
  return 0;
 }
...
{
 if (conf == 
# 295 "conf/conf_lib.c" 3 4
            ((void *)0)
# 295 "conf/conf_lib.c"
                ) {
  ERR_put_error(14,(108),(105),"conf/conf_lib.c",296);
  return 
# 297 "conf/conf_lib.c" 3 4
        ((void *)0)
# 297 "conf/conf_lib.c"
            ;
 }
 ...
 if (section == 
# 300 "conf/conf_lib.c" 3 4
               ((void *)0)
# 300 "conf/conf_lib.c"
                   ) {
  ERR_put_error(14,(108),(107),"conf/conf_lib.c",301);
  return 
# 302 "conf/conf_lib.c" 3 4
        ((void *)0)
# 302 "conf/conf_lib.c"
            ;
 }
...
NCONF_get_string(const CONF *conf, const char *group, const char *name)
{
 ...
 if (conf == 
# 318 "conf/conf_lib.c" 3 4
            ((void *)0)
# 318 "conf/conf_lib.c"
                ) {
  ERR_put_error(14,(109),(106),"conf/conf_lib.c",320)
                                             ;
  return 
# 321 "conf/conf_lib.c" 3 4
        ((void *)0)
# 321 "conf/conf_lib.c"
            ;
 }
 ERR_put_error(14,(109),(108),"conf/conf_lib.c",323);
 ERR_asprintf_error_data("group=%s name=%s", group, name);
 return 
# 325 "conf/conf_lib.c" 3 4
       ((void *)0)
# 325 "conf/conf_lib.c"
           ;
}
    ...
    long *result)
{
 ...
 if (result == 
# 334 "conf/conf_lib.c" 3 4
              ((void *)0)
# 334 "conf/conf_lib.c"
                  ) {
  ERR_put_error(14,(112),((3|64)),"conf/conf_lib.c",335);
  return 0;
 }
...
NCONF_dump_fp(const CONF *conf, FILE *out)
{
 ...
 int ret;
 if (!(btmp = BIO_new_fp(out, 0x00))) {
  ERR_put_error(14,(106),(7),"conf/conf_lib.c",358);
  return 0;
 }
...
{
 if (conf == 
# 369 "conf/conf_lib.c" 3 4
            ((void *)0)
# 369 "conf/conf_lib.c"
                ) {
  ERR_put_error(14,(105),(105),"conf/conf_lib.c",370);
  return 0;
 }
