...
X509_LOOKUP_new(X509_LOOKUP_METHOD *method)
{
 ...
 if (ret == 
# 73 "x509/x509_lu.c" 3 4
           ((void *)0)
# 73 "x509/x509_lu.c"
               )
  return 
# 74 "x509/x509_lu.c" 3 4
        ((void *)0)
# 74 "x509/x509_lu.c"
            ;
 ...
 ret->method = method;
 ret->method_data = 
# 79 "x509/x509_lu.c" 3 4
                   ((void *)0)
# 79 "x509/x509_lu.c"
                       ;
 ret->store_ctx = 
# 80 "x509/x509_lu.c" 3 4
                 ((void *)0)
# 80 "x509/x509_lu.c"
                     ;
 if ((method->new_item != 
# 81 "x509/x509_lu.c" 3 4
                         ((void *)0)
# 81 "x509/x509_lu.c"
                             ) && !method->new_item(ret)) {
  free(ret);
  return 
# 83 "x509/x509_lu.c" 3 4
        ((void *)0)
# 83 "x509/x509_lu.c"
            ;
 }
...
{
 if (ctx == 
# 91 "x509/x509_lu.c" 3 4
           ((void *)0)
# 91 "x509/x509_lu.c"
               )
  return;
 if ((ctx->method != 
# 93 "x509/x509_lu.c" 3 4
                    ((void *)0)
# 93 "x509/x509_lu.c"
                        ) && (ctx->method->free != 
# 93 "x509/x509_lu.c" 3 4
...
{
 if (ctx->method == 
# 101 "x509/x509_lu.c" 3 4
                   ((void *)0)
# 101 "x509/x509_lu.c"
                       )
  return 0;
 if (ctx->method->init != 
# 103 "x509/x509_lu.c" 3 4
                         ((void *)0)
# 103 "x509/x509_lu.c"
                             )
...
{
 if (ctx->method == 
# 112 "x509/x509_lu.c" 3 4
                   ((void *)0)
# 112 "x509/x509_lu.c"
                       )
  return 0;
 if (ctx->method->shutdown != 
# 114 "x509/x509_lu.c" 3 4
                             ((void *)0)
# 114 "x509/x509_lu.c"
                                 )
...
{
 if (ctx->method == 
# 124 "x509/x509_lu.c" 3 4
                   ((void *)0)
# 124 "x509/x509_lu.c"
                       )
  return -1;
 if (ctx->method->ctrl != 
# 126 "x509/x509_lu.c" 3 4
                         ((void *)0)
# 126 "x509/x509_lu.c"
                             )
...
{
 if ((ctx->method == 
# 147 "x509/x509_lu.c" 3 4
                    ((void *)0)
# 147 "x509/x509_lu.c"
                        ) ||
     (ctx->method->get_by_issuer_serial == 
# 148 "x509/x509_lu.c" 3 4
                                          ((void *)0)
# 148 "x509/x509_lu.c"
                                              ))
  return 0;
...
X509_STORE_new(void)
{
 ...
 if ((ret = malloc(sizeof(X509_STORE))) == 
# 198 "x509/x509_lu.c" 3 4
                                          ((void *)0)
# 198 "x509/x509_lu.c"
                                              )
  return 
# 199 "x509/x509_lu.c" 3 4
        ((void *)0)
# 199 "x509/x509_lu.c"
            ;
 ret->objs = ((struct stack_st_X509_OBJECT *)sk_new(((int (*)(const void *, const void *)) ((1 ? (x509_object_cmp) : (int (*)(const X509_OBJECT * const *, const X509_OBJECT * const *))0)))));
 ret->cache = 1;
 ret->get_cert_methods = ((struct stack_st_X509_LOOKUP *)sk_new_null());
 ret->verify = 0;
 ret->verify_cb = 0;

 if ((ret->param = X509_VERIFY_PARAM_new()) == 
# 206 "x509/x509_lu.c" 3 4
                                              ((void *)0)
# 206 "x509/x509_lu.c"
                                                  )
  goto err;
 ...
 if (!CRYPTO_new_ex_data(4, ret, &ret->ex_data))
  goto err;
...
err:
 ...
 sk_free(((_STACK*) (1 ? (ret->get_cert_methods) : (struct stack_st_X509_LOOKUP*)0)));
 sk_free(((_STACK*) (1 ? (ret->objs) : (struct stack_st_X509_OBJECT*)0)));
 free(ret);
 return 
# 230 "x509/x509_lu.c" 3 4
       ((void *)0)
# 230 "x509/x509_lu.c"
           ;
}
...
{
 int i;
 struct stack_st_X509_LOOKUP *sk;
 X509_LOOKUP *lu;

 if (vfy == 
# 254 "x509/x509_lu.c" 3 4
           ((void *)0)
# 254 "x509/x509_lu.c"
               )
  return;

 i = CRYPTO_add_lock(&vfy->references,-1,11,"x509/x509_lu.c",257);
 if (i > 0)
  return;

 sk = vfy->get_cert_methods;
 for (i = 0; i < sk_num(((_STACK*) (1 ? (sk) : (struct stack_st_X509_LOOKUP*)0))); i++) {
  lu = ((X509_LOOKUP *)sk_value(((_STACK*) (1 ? (sk) : (struct stack_st_X509_LOOKUP*)0)), (i)));
  X509_LOOKUP_shutdown(lu);
  X509_LOOKUP_free(lu);
 }
 sk_free(((_STACK*) (1 ? (sk) : (struct stack_st_X509_LOOKUP*)0)));
 sk_pop_free(((_STACK*) (1 ? (vfy->objs) : (struct stack_st_X509_OBJECT*)0)), ((void (*)(void *)) ((1 ? (cleanup) : (void (*)(X509_OBJECT *))0))));

 CRYPTO_free_ex_data(4, vfy, &vfy->ex_data);
...
X509_STORE_add_lookup(X509_STORE *v, X509_LOOKUP_METHOD *m)
{
 ...
 if (lu == 
# 291 "x509/x509_lu.c" 3 4
          ((void *)0)
# 291 "x509/x509_lu.c"
              )
  return 
# 292 "x509/x509_lu.c" 3 4
        ((void *)0)
# 292 "x509/x509_lu.c"
            ;
 else {
  lu->store_ctx = v;
  if (sk_push(((_STACK*) (1 ? (v->get_cert_methods) : (struct stack_st_X509_LOOKUP*)0)), ((void*) (1 ? (lu) : (X509_LOOKUP*)0))))
   return lu;
  else {
   X509_LOOKUP_free(lu);
   return 
# 299 "x509/x509_lu.c" 3 4
         ((void *)0)
# 299 "x509/x509_lu.c"
             ;
  }
    ...
    X509_OBJECT *ret)
{
 ...
 CRYPTO_lock(1|8,11,"x509/x509_lu.c",313);
 tmp = X509_OBJECT_retrieve_by_subject(ctx->objs, type, name);
 CRYPTO_lock(2|8,11,"x509/x509_lu.c",315);

 if (tmp == 
# 317 "x509/x509_lu.c" 3 4
           ((void *)0) 
# 317 "x509/x509_lu.c"
                || type == 2) {
  for (i = vs->current_method;
      i < sk_num(((_STACK*) (1 ? (ctx->get_cert_methods) : (struct stack_st_X509_LOOKUP*)0))); i++) {
   lu = ((X509_LOOKUP *)sk_value(((_STACK*) (1 ? (ctx->get_cert_methods) : (struct stack_st_X509_LOOKUP*)0)), (i)));
...
# 352 "x509/x509_lu.c"
 ...
 if (obj == 
# 355 "x509/x509_lu.c" 3 4
           ((void *)0)
# 355 "x509/x509_lu.c"
               ) {
  ERR_put_error(11,(124),((1|64)),"x509/x509_lu.c",356);
  return 0;
 }
 obj->type = 1;
 obj->data.x509 = x;

 CRYPTO_lock(1|8,11,"x509/x509_lu.c",362);
 ...
 if (X509_OBJECT_retrieve_match(ctx->objs, obj)) {
  ...
  free(obj);
  ERR_put_error(11,(124),(101),"x509/x509_lu.c",370)
                                        ;
  ret = 0;
 } else
  sk_push(((_STACK*) (1 ? (ctx->objs) : (struct stack_st_X509_OBJECT*)0)), ((void*) (1 ? (obj) : (X509_OBJECT*)0)));

 CRYPTO_lock(2|8,11,"x509/x509_lu.c",375);
...
# 386 "x509/x509_lu.c"
 ...
 obj = malloc(sizeof(X509_OBJECT));
 if (obj == 
# 389 "x509/x509_lu.c" 3 4
           ((void *)0)
# 389 "x509/x509_lu.c"
               ) {
  ERR_put_error(11,(125),((1|64)),"x509/x509_lu.c",390);
  return 0;
 }
 obj->type = 2;
 obj->data.crl = x;

 CRYPTO_lock(1|8,11,"x509/x509_lu.c",396);
 ...
 if (X509_OBJECT_retrieve_match(ctx->objs, obj)) {
  X509_OBJECT_free_contents(obj);
  free(obj);
  ERR_put_error(11,(125),(101),"x509/x509_lu.c",404)
                                        ;
  ret = 0;
 } else
  sk_push(((_STACK*) (1 ? (ctx->objs) : (struct stack_st_X509_OBJECT*)0)), ((void*) (1 ? (obj) : (X509_OBJECT*)0)));

 CRYPTO_lock(2|8,11,"x509/x509_lu.c",409);
...
X509_OBJECT_up_ref_count(X509_OBJECT *a)
{
 switch (a->type) {
 case 1:
  CRYPTO_add_lock(&a->data.x509->references,1,3,"x509/x509_lu.c",419);
  break;
 case 2:
  CRYPTO_add_lock(&a->data.crl->references,1,6,"x509/x509_lu.c",422);
  break;
 }
}
...
static int
x509_object_idx_cnt(struct stack_st_X509_OBJECT *h, int type, X509_NAME *name,
    int *pnmatch)
{
 X509_OBJECT stmp;
 X509 x509_s;
 ...
 idx = sk_find(((_STACK*) (1 ? (h) : (struct stack_st_X509_OBJECT*)0)), ((void*) (1 ? (&stmp) : (X509_OBJECT*)0)));
 if (idx >= 0 && pnmatch) {
  int tidx;
  const X509_OBJECT *tobj, *pstmp;
  *pnmatch = 1;
  pstmp = &stmp;
  for (tidx = idx + 1; tidx < sk_num(((_STACK*) (1 ? (h) : (struct stack_st_X509_OBJECT*)0))); tidx++) {
   tobj = ((X509_OBJECT *)sk_value(((_STACK*) (1 ? (h) : (struct stack_st_X509_OBJECT*)0)), (tidx)));
...
int
X509_OBJECT_idx_by_subject(struct stack_st_X509_OBJECT *h, int type, X509_NAME *name)
{
 return x509_object_idx_cnt(h, type, name, 
# 487 "x509/x509_lu.c" 3 4
                                          ((void *)0)
# 487 "x509/x509_lu.c"
                                              );
}
...
X509_OBJECT *
X509_OBJECT_retrieve_by_subject(struct stack_st_X509_OBJECT *h, int type,
    X509_NAME *name)
{
 int idx;
 ...
 if (idx == -1)
  return 
# 498 "x509/x509_lu.c" 3 4
        ((void *)0)
# 498 "x509/x509_lu.c"
            ;
 return ((X509_OBJECT *)sk_value(((_STACK*) (1 ? (h) : (struct stack_st_X509_OBJECT*)0)), (idx)));
}
...
X509_STORE_get1_certs(X509_STORE_CTX *ctx, X509_NAME *nm)
{
 ...
 if (sk == 
# 511 "x509/x509_lu.c" 3 4
          ((void *)0)
# 511 "x509/x509_lu.c"
              )
  return 
# 512 "x509/x509_lu.c" 3 4
        ((void *)0)
# 512 "x509/x509_lu.c"
            ;
 CRYPTO_lock(1|8,11,"x509/x509_lu.c",513);
 idx = x509_object_idx_cnt(ctx->ctx->objs, 1, nm, &cnt);
 if (idx < 0) {



  X509_OBJECT xobj;
  CRYPTO_lock(2|8,11,"x509/x509_lu.c",520);
  if (!X509_STORE_get_by_subject(ctx, 1, nm, &xobj)) {
   sk_free(((_STACK*) (1 ? (sk) : (struct stack_st_X509*)0)));
   return 
# 523 "x509/x509_lu.c" 3 4
         ((void *)0)
# 523 "x509/x509_lu.c"
             ;
  }
  X509_OBJECT_free_contents(&xobj);
  CRYPTO_lock(1|8,11,"x509/x509_lu.c",526);
  idx = x509_object_idx_cnt(ctx->ctx->objs,
      1, nm, &cnt);
  if (idx < 0) {
   CRYPTO_lock(2|8,11,"x509/x509_lu.c",530);
   sk_free(((_STACK*) (1 ? (sk) : (struct stack_st_X509*)0)));
   return 
# 532 "x509/x509_lu.c" 3 4
         ((void *)0)
# 532 "x509/x509_lu.c"
             ;
  }
 ...
 for (i = 0; i < cnt; i++, idx++) {
  obj = ((X509_OBJECT *)sk_value(((_STACK*) (1 ? (ctx->ctx->objs) : (struct stack_st_X509_OBJECT*)0)), (idx)));
  x = obj->data.x509;
  CRYPTO_add_lock(&x->references,1,3,"x509/x509_lu.c",538);
  if (!sk_push(((_STACK*) (1 ? (sk) : (struct stack_st_X509*)0)), ((void*) (1 ? (x) : (X509*)0)))) {
   CRYPTO_lock(2|8,11,"x509/x509_lu.c",540);
   X509_free(x);
   sk_pop_free(((_STACK*) (1 ? (sk) : (struct stack_st_X509*)0)), ((void (*)(void *)) ((1 ? (X509_free) : (void (*)(X509 *))0))));
   return 
# 543 "x509/x509_lu.c" 3 4
         ((void *)0)
# 543 "x509/x509_lu.c"
             ;
  }
 }
 CRYPTO_lock(2|8,11,"x509/x509_lu.c",546);
 return sk;
...
X509_STORE_get1_crls(X509_STORE_CTX *ctx, X509_NAME *nm)
{
 ...
 if (sk == 
# 560 "x509/x509_lu.c" 3 4
          ((void *)0)
# 560 "x509/x509_lu.c"
              )
  return 
# 561 "x509/x509_lu.c" 3 4
        ((void *)0)
# 561 "x509/x509_lu.c"
            ;
 CRYPTO_lock(1|8,11,"x509/x509_lu.c",562);

 idx = x509_object_idx_cnt(ctx->ctx->objs, 2, nm, &cnt);



 CRYPTO_lock(2|8,11,"x509/x509_lu.c",568);
 if (!X509_STORE_get_by_subject(ctx, 2, nm, &xobj)) {
  sk_free(((_STACK*) (1 ? (sk) : (struct stack_st_X509_CRL*)0)));
  return 
# 571 "x509/x509_lu.c" 3 4
        ((void *)0)
# 571 "x509/x509_lu.c"
            ;
 }
 X509_OBJECT_free_contents(&xobj);
 CRYPTO_lock(1|8,11,"x509/x509_lu.c",574);
 idx = x509_object_idx_cnt(ctx->ctx->objs, 2, nm, &cnt);
 if (idx < 0) {
  CRYPTO_lock(2|8,11,"x509/x509_lu.c",577);
  sk_free(((_STACK*) (1 ? (sk) : (struct stack_st_X509_CRL*)0)));
  return 
# 579 "x509/x509_lu.c" 3 4
        ((void *)0)
# 579 "x509/x509_lu.c"
            ;
 }
 ...
 for (i = 0; i < cnt; i++, idx++) {
  obj = ((X509_OBJECT *)sk_value(((_STACK*) (1 ? (ctx->ctx->objs) : (struct stack_st_X509_OBJECT*)0)), (idx)));
  x = obj->data.crl;
  CRYPTO_add_lock(&x->references,1,6,"x509/x509_lu.c",585);
  if (!sk_push(((_STACK*) (1 ? (sk) : (struct stack_st_X509_CRL*)0)), ((void*) (1 ? (x) : (X509_CRL*)0)))) {
   CRYPTO_lock(2|8,11,"x509/x509_lu.c",587);
   X509_CRL_free(x);
   sk_pop_free(((_STACK*) (1 ? (sk) : (struct stack_st_X509_CRL*)0)), ((void (*)(void *)) ((1 ? (X509_CRL_free) : (void (*)(X509_CRL *))0))));
   return 
# 590 "x509/x509_lu.c" 3 4
         ((void *)0)
# 590 "x509/x509_lu.c"
             ;
  }
 }
 CRYPTO_lock(2|8,11,"x509/x509_lu.c",593);
 return sk;
}

X509_OBJECT *
X509_OBJECT_retrieve_match(struct stack_st_X509_OBJECT *h, X509_OBJECT *x)
{
 int idx, i;
 X509_OBJECT *obj;

 idx = sk_find(((_STACK*) (1 ? (h) : (struct stack_st_X509_OBJECT*)0)), ((void*) (1 ? (x) : (X509_OBJECT*)0)));
 if (idx == -1)
  return 
# 605 "x509/x509_lu.c" 3 4
        ((void *)0)
# 605 "x509/x509_lu.c"
            ;
 if ((x->type != 1) && (x->type != 2))
  return ((X509_OBJECT *)sk_value(((_STACK*) (1 ? (h) : (struct stack_st_X509_OBJECT*)0)), (idx)));
 for (i = idx; i < sk_num(((_STACK*) (1 ? (h) : (struct stack_st_X509_OBJECT*)0))); i++) {
  obj = ((X509_OBJECT *)sk_value(((_STACK*) (1 ? (h) : (struct stack_st_X509_OBJECT*)0)), (i)));
  if (x509_object_cmp((const X509_OBJECT **)&obj,
      (const X509_OBJECT **)&x))
   return 
# 612 "x509/x509_lu.c" 3 4
         ((void *)0)
# 612 "x509/x509_lu.c"
             ;
  if (x->type == 1) {
 ...
 *issuer = 
# 644 "x509/x509_lu.c" 3 4
          ((void *)0)
# 644 "x509/x509_lu.c"
              ;
 xn = X509_get_issuer_name(x);
 ok = X509_STORE_get_by_subject(ctx, 1, xn, &obj);
 if (ok != 1) {
  if (ok == -1) {
   X509_OBJECT_free_contents(&obj);
   ERR_put_error(11,(146),(106),"x509/x509_lu.c",651)
                           ;
   return -1;
  } else if (ok != 0) {
   X509_OBJECT_free_contents(&obj);
 ...
 ret = 0;
 CRYPTO_lock(1|8,11,"x509/x509_lu.c",671);
 idx = X509_OBJECT_idx_by_subject(ctx->ctx->objs, 1, xn);
 if (idx != -1) {

  for (i = idx; i < sk_num(((_STACK*) (1 ? (ctx->ctx->objs) : (struct stack_st_X509_OBJECT*)0))); i++) {
   pobj = ((X509_OBJECT *)sk_value(((_STACK*) (1 ? (ctx->ctx->objs) : (struct stack_st_X509_OBJECT*)0)), (i)));
 ...
 CRYPTO_lock(2|8,11,"x509/x509_lu.c",697);
 if (*issuer)
  CRYPTO_add_lock(&(*issuer)->references,1,3,"x509/x509_lu.c",699);
 return ret;
}
