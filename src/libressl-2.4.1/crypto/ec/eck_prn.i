...
# 80 "ec/eck_prn.c"
  ...
  ERR_put_error(16,(150),(7),"ec/eck_prn.c",81);
  return (0);
 }
...
# 96 "ec/eck_prn.c"
  ...
  ERR_put_error(16,(181),(32),"ec/eck_prn.c",97);
  return (0);
 }
 BIO_ctrl(b,106,0x00,(char *)fp);
...
ECParameters_print_fp(FILE * fp, const EC_KEY * x)
{
 ...
 if ((b = BIO_new(BIO_s_file())) == 
# 112 "ec/eck_prn.c" 3 4
                                   ((void *)0)
# 112 "ec/eck_prn.c"
                                       ) {
  ERR_put_error(16,(148),(32),"ec/eck_prn.c",113);
  return (0);
 }
 BIO_ctrl(b,106,0x00,(char *)fp);
...
EC_KEY_print(BIO * bp, const EC_KEY * x, int off)
{
 ...
 if (!pk || !EVP_PKEY_set1_EC_KEY(pk, (EC_KEY *) x))
  return 0;
 ret = EVP_PKEY_print_private(bp, pk, off, 
# 130 "ec/eck_prn.c" 3 4
                                          ((void *)0)
# 130 "ec/eck_prn.c"
                                              );
 EVP_PKEY_free(pk);
...
ECParameters_print(BIO * bp, const EC_KEY * x)
{
 ...
 if (!pk || !EVP_PKEY_set1_EC_KEY(pk, (EC_KEY *) x))
  return 0;
 ret = EVP_PKEY_print_params(bp, pk, 4, 
# 143 "ec/eck_prn.c" 3 4
                                       ((void *)0)
# 143 "ec/eck_prn.c"
                                           );
 EVP_PKEY_free(pk);
...
# 155 "ec/eck_prn.c"
 ...
 int ret = 0, reason = 32;
 BN_CTX *ctx = 
# 158 "ec/eck_prn.c" 3 4
              ((void *)0)
# 158 "ec/eck_prn.c"
                  ;
 const EC_POINT *point = 
# 159 "ec/eck_prn.c" 3 4
                        ((void *)0)
# 159 "ec/eck_prn.c"
                            ;
 BIGNUM *p = 
# 160 "ec/eck_prn.c" 3 4
            ((void *)0)
# 160 "ec/eck_prn.c"
                , *a = 
# 160 "ec/eck_prn.c" 3 4
...
# 213 "ec/eck_prn.c"
  ...
  if ((point = EC_GROUP_get0_generator(x)) == 
# 232 "ec/eck_prn.c" 3 4
                                             ((void *)0)
# 232 "ec/eck_prn.c"
                                                 ) {
   reason = 16;
  ...
  if (!EC_GROUP_get_order(x, order, 
# 236 "ec/eck_prn.c" 3 4
                                   ((void *)0)
# 236 "ec/eck_prn.c"
                                       ) ||
      !EC_GROUP_get_cofactor(x, cofactor, 
# 237 "ec/eck_prn.c" 3 4
                                         ((void *)0)
# 237 "ec/eck_prn.c"
                                             )) {
   reason = 16;
...
# 244 "ec/eck_prn.c"
  ...
  buf_len = (size_t) ((BN_num_bits(p)+7)/8);
  if (buf_len < (i = (size_t) ((BN_num_bits(a)+7)/8)))
   buf_len = i;
  if (buf_len < (i = (size_t) ((BN_num_bits(b)+7)/8)))
   buf_len = i;
  if (buf_len < (i = (size_t) ((BN_num_bits(gen)+7)/8)))
   buf_len = i;
  if (buf_len < (i = (size_t) ((BN_num_bits(order)+7)/8)))
   buf_len = i;
  if (buf_len < (i = (size_t) ((BN_num_bits(cofactor)+7)/8)))
   buf_len = i;

  if ((seed = EC_GROUP_get0_seed(x)) != 
# 260 "ec/eck_prn.c" 3 4
                                       ((void *)0)
# 260 "ec/eck_prn.c"
                                           )
...
# 264 "ec/eck_prn.c"
  ...
  if (is_char_two) {
   ...
   if ((p != 
# 290 "ec/eck_prn.c" 3 4
            ((void *)0)
# 290 "ec/eck_prn.c"
                ) && !ASN1_bn_print(bp, "Polynomial:", p, buffer,
    off))
    goto err;
  } else {
   if ((p != 
# 294 "ec/eck_prn.c" 3 4
            ((void *)0)
# 294 "ec/eck_prn.c"
                ) && !ASN1_bn_print(bp, "Prime:", p, buffer, off))
    goto err;
  }
  if ((a != 
# 297 "ec/eck_prn.c" 3 4
           ((void *)0)
# 297 "ec/eck_prn.c"
               ) && !ASN1_bn_print(bp, "A:   ", a, buffer, off))
   goto err;
  if ((b != 
# 299 "ec/eck_prn.c" 3 4
           ((void *)0)
# 299 "ec/eck_prn.c"
               ) && !ASN1_bn_print(bp, "B:   ", b, buffer, off))
   goto err;
  if (form == POINT_CONVERSION_COMPRESSED) {
   if ((gen != 
# 302 "ec/eck_prn.c" 3 4
              ((void *)0)
# 302 "ec/eck_prn.c"
...
err:
 if (!ret)
  ERR_put_error(16,(149),(reason),"ec/eck_prn.c",326);
 BN_free(p);
 BN_free(a);
 BN_free(b);
 BN_free(gen);
