...
DSA_new(void)
{
 return DSA_new_method(
# 96 "dsa/dsa_lib.c" 3 4
                      ((void *)0)
# 96 "dsa/dsa_lib.c"
                          );
}
...
DSA_new_method(ENGINE *engine)
{
 ...
 if (ret == 
# 128 "dsa/dsa_lib.c" 3 4
           ((void *)0)
# 128 "dsa/dsa_lib.c"
               ) {
  ERR_put_error(10,(103),((1|64)),"dsa/dsa_lib.c",129);
  return 
# 130 "dsa/dsa_lib.c" 3 4
        ((void *)0)
# 130 "dsa/dsa_lib.c"
            ;
 }
 ...
 if (engine) {
  if (!ENGINE_init(engine)) {
   ERR_put_error(10,(103),(38),"dsa/dsa_lib.c",136);
   free(ret);
   return 
# 138 "dsa/dsa_lib.c" 3 4
         ((void *)0)
# 138 "dsa/dsa_lib.c"
             ;
  }
 ...
 if (ret->engine) {
  ...
  if (!ret->meth) {
   ERR_put_error(10,(103),(38),"dsa/dsa_lib.c",146);
   ENGINE_finish(ret->engine);
   free(ret);
   return 
# 149 "dsa/dsa_lib.c" 3 4
         ((void *)0)
# 149 "dsa/dsa_lib.c"
             ;
  }
 ...
 ret->write_params = 1;
 ret->p = 
# 157 "dsa/dsa_lib.c" 3 4
         ((void *)0)
# 157 "dsa/dsa_lib.c"
             ;
 ret->q = 
# 158 "dsa/dsa_lib.c" 3 4
         ((void *)0)
# 158 "dsa/dsa_lib.c"
             ;
 ret->g = 
# 159 "dsa/dsa_lib.c" 3 4
         ((void *)0)
# 159 "dsa/dsa_lib.c"
             ;

 ret->pub_key = 
# 161 "dsa/dsa_lib.c" 3 4
               ((void *)0)
# 161 "dsa/dsa_lib.c"
                   ;
 ret->priv_key = 
# 162 "dsa/dsa_lib.c" 3 4
                ((void *)0)
# 162 "dsa/dsa_lib.c"
                    ;

 ret->kinv = 
# 164 "dsa/dsa_lib.c" 3 4
            ((void *)0)
# 164 "dsa/dsa_lib.c"
                ;
 ret->r = 
# 165 "dsa/dsa_lib.c" 3 4
         ((void *)0)
# 165 "dsa/dsa_lib.c"
             ;
 ret->method_mont_p = 
# 166 "dsa/dsa_lib.c" 3 4
                     ((void *)0)
# 166 "dsa/dsa_lib.c"
                         ;

 ret->references = 1;
 ret->flags = ret->meth->flags & ~0x0400;
 CRYPTO_new_ex_data(7, ret, &ret->ex_data);
 if (ret->meth->init != 
# 171 "dsa/dsa_lib.c" 3 4
                       ((void *)0) 
# 171 "dsa/dsa_lib.c"
                            && !ret->meth->init(ret)) {
  ...
  CRYPTO_free_ex_data(7, ret, &ret->ex_data);
  free(ret);
  ret = 
# 178 "dsa/dsa_lib.c" 3 4
       ((void *)0)
# 178 "dsa/dsa_lib.c"
           ;
 }
...
DSA_free(DSA *r)
{
 ...
 if (r == 
# 189 "dsa/dsa_lib.c" 3 4
         ((void *)0)
# 189 "dsa/dsa_lib.c"
             )
  return;

 i = CRYPTO_add_lock(&r->references,-1,8,"dsa/dsa_lib.c",192);
 if (i > 0)
  return;
...
DSA_up_ref(DSA *r)
{
 int i = CRYPTO_add_lock(&r->references,1,8,"dsa/dsa_lib.c",218);
 return i > 1 ? 1 : 0;
}
...
DSA_size(const DSA *r)
{
 ...
 i = i2d_ASN1_INTEGER(&bs, 
# 239 "dsa/dsa_lib.c" 3 4
                          ((void *)0)
# 239 "dsa/dsa_lib.c"
                              );
 i += i;
 ret = ASN1_object_size(1, i, 16);
 return ret;
}
...
DSA_get_ex_new_index(long argl, void *argp, CRYPTO_EX_new *new_func,
    CRYPTO_EX_dup *dup_func, CRYPTO_EX_free *free_func)
{
 return CRYPTO_get_ex_new_index(7, argl, argp,
...
DSA_dup_DH(const DSA *r)
{
 ...
 DH *ret = 
# 274 "dsa/dsa_lib.c" 3 4
          ((void *)0)
# 274 "dsa/dsa_lib.c"
              ;

 if (r == 
# 276 "dsa/dsa_lib.c" 3 4
         ((void *)0)
# 276 "dsa/dsa_lib.c"
             )
  goto err;
 ret = DH_new();
 if (ret == 
# 279 "dsa/dsa_lib.c" 3 4
           ((void *)0)
# 279 "dsa/dsa_lib.c"
               )
  goto err;
 if (r->p != 
# 281 "dsa/dsa_lib.c" 3 4
            ((void *)0)
# 281 "dsa/dsa_lib.c"
                )
  if ((ret->p = BN_dup(r->p)) == 
# 282 "dsa/dsa_lib.c" 3 4
                                ((void *)0)
# 282 "dsa/dsa_lib.c"
                                    )
   goto err;
 if (r->q != 
# 284 "dsa/dsa_lib.c" 3 4
            ((void *)0)
# 284 "dsa/dsa_lib.c"
                ) {
  ret->length = BN_num_bits(r->q);
  if ((ret->q = BN_dup(r->q)) == 
# 286 "dsa/dsa_lib.c" 3 4
                                ((void *)0)
# 286 "dsa/dsa_lib.c"
                                    )
   goto err;
 ...
 if (r->g != 
# 289 "dsa/dsa_lib.c" 3 4
            ((void *)0)
# 289 "dsa/dsa_lib.c"
                )
  if ((ret->g = BN_dup(r->g)) == 
# 290 "dsa/dsa_lib.c" 3 4
                                ((void *)0)
# 290 "dsa/dsa_lib.c"
                                    )
   goto err;
 if (r->pub_key != 
# 292 "dsa/dsa_lib.c" 3 4
                  ((void *)0)
# 292 "dsa/dsa_lib.c"
                      )
  if ((ret->pub_key = BN_dup(r->pub_key)) == 
# 293 "dsa/dsa_lib.c" 3 4
                                            ((void *)0)
# 293 "dsa/dsa_lib.c"
                                                )
   goto err;
 if (r->priv_key != 
# 295 "dsa/dsa_lib.c" 3 4
                   ((void *)0)
# 295 "dsa/dsa_lib.c"
                       )
  if ((ret->priv_key = BN_dup(r->priv_key)) == 
# 296 "dsa/dsa_lib.c" 3 4
                                              ((void *)0)
# 296 "dsa/dsa_lib.c"
                                                  )
   goto err;
