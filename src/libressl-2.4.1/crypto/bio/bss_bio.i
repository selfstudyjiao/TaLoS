...
# 139 "bio/bss_bio.c"
 ...
 b->peer = 
# 142 "bio/bss_bio.c" 3 4
          ((void *)0)
# 142 "bio/bss_bio.c"
              ;
 b->size = 17 * 1024;
 b->buf = 
# 144 "bio/bss_bio.c" 3 4
         ((void *)0)
# 144 "bio/bss_bio.c"
             ;
...
# 184 "bio/bss_bio.c" 3 4
((void) (0))
# 184 "bio/bss_bio.c"
                 ;
 
# 185 "bio/bss_bio.c" 3 4
((void) (0))
# 185 "bio/bss_bio.c"
                       ;
 peer_b = b->peer->ptr;
 
# 187 "bio/bss_bio.c" 3 4
((void) (0))
# 187 "bio/bss_bio.c"
                      ;
 
# 188 "bio/bss_bio.c" 3 4
((void) (0))
# 188 "bio/bss_bio.c"
                           ;
...
# 271 "bio/bss_bio.c" 3 4
((void) (0))
# 271 "bio/bss_bio.c"
                 ;
 
# 272 "bio/bss_bio.c" 3 4
((void) (0))
# 272 "bio/bss_bio.c"
                       ;
 peer_b = b->peer->ptr;
 
# 274 "bio/bss_bio.c" 3 4
((void) (0))
# 274 "bio/bss_bio.c"
                      ;
 
# 275 "bio/bss_bio.c" 3 4
((void) (0))
# 275 "bio/bss_bio.c"
                           ;
...
# 290 "bio/bss_bio.c" 3 4
((void) (0))
# 290 "bio/bss_bio.c"
               ;

 if (buf != 
# 292 "bio/bss_bio.c" 3 4
           ((void *)0)
# 292 "bio/bss_bio.c"
               )
...
# 344 "bio/bss_bio.c" 3 4
((void) (0))
# 344 "bio/bss_bio.c"
                 ;
 
# 345 "bio/bss_bio.c" 3 4
((void) (0))
# 345 "bio/bss_bio.c"
                       ;
 
# 346 "bio/bss_bio.c" 3 4
((void) (0))
# 346 "bio/bss_bio.c"
                      ;
 ...
 if (b->closed) {
  ...
  ERR_put_error(32,(113),(124),"bio/bss_bio.c",351);
  return -1;
 }

 
# 355 "bio/bss_bio.c" 3 4
((void) (0))
# 355 "bio/bss_bio.c"
                         ;

 if (b->len == b->size) {
  BIO_set_flags(bio, (0x02|0x08));
  return -1;
 }
...
# 422 "bio/bss_bio.c" 3 4
((void) (0))
# 422 "bio/bss_bio.c"
                 ;
 
# 423 "bio/bss_bio.c" 3 4
((void) (0))
# 423 "bio/bss_bio.c"
                       ;
 
# 424 "bio/bss_bio.c" 3 4
((void) (0))
# 424 "bio/bss_bio.c"
                      ;
 ...
 b->request = 0;
 if (b->closed) {
  ERR_put_error(32,(122),(124),"bio/bss_bio.c",428);
  return -1;
 }

 
# 432 "bio/bss_bio.c" 3 4
((void) (0))
# 432 "bio/bss_bio.c"
                         ;
 ...
 if (buf != 
# 449 "bio/bss_bio.c" 3 4
           ((void *)0)
# 449 "bio/bss_bio.c"
               )
  *buf = b->buf + write_offset;
 
# 451 "bio/bss_bio.c" 3 4
((void) (0))
# 451 "bio/bss_bio.c"
                                     ;
...
# 473 "bio/bss_bio.c" 3 4
((void) (0))
# 473 "bio/bss_bio.c"
                 ;
 b->len += num;
 
# 475 "bio/bss_bio.c" 3 4
((void) (0))
# 475 "bio/bss_bio.c"
                         ;
...
# 487 "bio/bss_bio.c"
 ...
 case 136:
  if (b->peer) {
   ERR_put_error(32,(103),(123),"bio/bss_bio.c",494);
   ret = 0;
  } else if (num == 0) {
   ERR_put_error(32,(103),(125),"bio/bss_bio.c",497);
   ret = 0;
  } else {
   size_t new_size = num;
...
# 627 "bio/bss_bio.c" 3 4
  ((void) (0))
# 627 "bio/bss_bio.c"
                           ;
   other_b = other_bio->ptr;
   
# 629 "bio/bss_bio.c" 3 4
  ((void) (0))
# 629 "bio/bss_bio.c"
                         ;

   
# 631 "bio/bss_bio.c" 3 4
  ((void) (0))
# 631 "bio/bss_bio.c"
                              ;
...
# 675 "bio/bss_bio.c" 3 4
((void) (0))
# 675 "bio/bss_bio.c"
                    ;
 
# 676 "bio/bss_bio.c" 3 4
((void) (0))
# 676 "bio/bss_bio.c"
                    ;
...
# 681 "bio/bss_bio.c"
  ...
  ERR_put_error(32,(121),(123),"bio/bss_bio.c",682);
  return 0;
 }

 if (b1->buf == 
# 686 "bio/bss_bio.c" 3 4
               ((void *)0)
# 686 "bio/bss_bio.c"
                   ) {
  b1->buf = malloc(b1->size);
  if (b1->buf == 
# 688 "bio/bss_bio.c" 3 4
                ((void *)0)
# 688 "bio/bss_bio.c"
                    ) {
   ERR_put_error(32,(121),((1|64)),"bio/bss_bio.c",689);
   return 0;
  }
  b1->len = 0;
  b1->offset = 0;
 ...
 if (b2->buf == 
# 696 "bio/bss_bio.c" 3 4
               ((void *)0)
# 696 "bio/bss_bio.c"
                   ) {
  b2->buf = malloc(b2->size);
  if (b2->buf == 
# 698 "bio/bss_bio.c" 3 4
                ((void *)0)
# 698 "bio/bss_bio.c"
                    ) {
   ERR_put_error(32,(121),((1|64)),"bio/bss_bio.c",699);
   return 0;
  }
  b2->len = 0;
  b2->offset = 0;
...
# 730 "bio/bss_bio.c" 3 4
  ((void) (0))
# 730 "bio/bss_bio.c"
                        ;
   
# 731 "bio/bss_bio.c" 3 4
  ((void) (0))
# 731 "bio/bss_bio.c"
                             ;

   peer_b->peer = 
# 733 "bio/bss_bio.c" 3 4
                 ((void *)0)
# 733 "bio/bss_bio.c"
                     ;
   peer_bio->init = 0;
   
# 735 "bio/bss_bio.c" 3 4
  ((void) (0))
# 735 "bio/bss_bio.c"
                             ;
   peer_b->len = 0;
   ...
   b->peer = 
# 739 "bio/bss_bio.c" 3 4
            ((void *)0)
# 739 "bio/bss_bio.c"
                ;
   bio->init = 0;
   
# 741 "bio/bss_bio.c" 3 4
  ((void) (0))
# 741 "bio/bss_bio.c"
                        ;
   b->len = 0;
...
# 761 "bio/bss_bio.c"
 ...
 if (writebuf1) {
  r = (int)BIO_ctrl(bio1,136,writebuf1,
# 765 "bio/bss_bio.c" 3 4
     ((void *)0)
# 765 "bio/bss_bio.c"
     );
  if (!r)
 ...
 if (writebuf2) {
  r = (int)BIO_ctrl(bio2,136,writebuf2,
# 770 "bio/bss_bio.c" 3 4
     ((void *)0)
# 770 "bio/bss_bio.c"
     );
  if (!r)
 ...
 r = (int)BIO_ctrl(bio1,138,0,bio2);
 if (!r)
  goto err;
 ret = 1;
...
{
 return BIO_ctrl(bio, 140, 0, 
# 800 "bio/bss_bio.c" 3 4
                                                   ((void *)0)
# 800 "bio/bss_bio.c"
                                                       );
}
...
{
 return BIO_ctrl(bio, 141, 0, 
# 806 "bio/bss_bio.c" 3 4
                                                ((void *)0)
# 806 "bio/bss_bio.c"
                                                    );
}
...
{
 return (BIO_ctrl(bio, 147, 0, 
# 812 "bio/bss_bio.c" 3 4
                                                   ((void *)0)
# 812 "bio/bss_bio.c"
                                                       ) != 0);
}
...
BIO_nread0(BIO *bio, char **buf)
{
 ...
 if (!bio->init) {
  ERR_put_error(32,(124),(120),"bio/bss_bio.c",825);
  return -2;
 }

 ret = BIO_ctrl(bio, 143, 0, buf);
 if (ret > 0x7fffffff)
  return 0x7fffffff;
 else
  return (int) ret;
...
BIO_nread(BIO *bio, char **buf, int num)
{
 ...
 if (!bio->init) {
  ERR_put_error(32,(123),(120),"bio/bss_bio.c",842);
  return -2;
 }

 ret = (int) BIO_ctrl(bio, 144, num, buf);
 if (ret > 0)
  bio->num_read += ret;
 return ret;
}
...
BIO_nwrite0(BIO *bio, char **buf)
{
 ...
 if (!bio->init) {
  ERR_put_error(32,(122),(120),"bio/bss_bio.c",858);
  return -2;
 }

 ret = BIO_ctrl(bio, 145, 0, buf);
 if (ret > 0x7fffffff)
  return 0x7fffffff;
 else
  return (int) ret;
...
BIO_nwrite(BIO *bio, char **buf, int num)
{
 ...
 if (!bio->init) {
  ERR_put_error(32,(125),(120),"bio/bss_bio.c",875);
  return -2;
 }

 ret = BIO_ctrl(bio, 146, num, buf);
 if (ret > 0)
  bio->num_write += ret;
 return ret;
}
