...
# 137 "dh/dh_lib.c"
  ...
  ERR_put_error(5,(105),((1|64)),"dh/dh_lib.c",138);
  return 
# 139 "dh/dh_lib.c" 3 4
        ((void *)0)
# 139 "dh/dh_lib.c"
 ...
 if (engine) {
  if (!ENGINE_init(engine)) {
   ERR_put_error(5,(105),(38),"dh/dh_lib.c",146);
   free(ret);
   return 
# 148 "dh/dh_lib.c" 3 4
         ((void *)0)
# 148 "dh/dh_lib.c"
 ...
 if(ret->engine) {
  ...
  if (!ret->meth) {
   ERR_put_error(5,(105),(38),"dh/dh_lib.c",156);
...
# 176 "dh/dh_lib.c"
 ...
 CRYPTO_new_ex_data(8, ret, &ret->ex_data);
 if (ret->meth->init != 
# 180 "dh/dh_lib.c" 3 4
                       ((void *)0) 
# 180 "dh/dh_lib.c"
  ...
  CRYPTO_free_ex_data(8, ret, &ret->ex_data);
...
# 206 "dh/dh_lib.c"
  ...
  return;
 i = CRYPTO_add_lock(&r->references,-1,26,"dh/dh_lib.c",208);
 if (i > 0)
  return;
 ...
 CRYPTO_free_ex_data(8, r, &r->ex_data);
...
DH_up_ref(DH *r)
{
 int i = CRYPTO_add_lock(&r->references,1,26,"dh/dh_lib.c",239);
...
DH_get_ex_new_index(long argl, void *argp, CRYPTO_EX_new *new_func,
    CRYPTO_EX_dup *dup_func, CRYPTO_EX_free *free_func)
{
 return CRYPTO_get_ex_new_index(8, argl, argp, new_func,
     dup_func, free_func);
}
