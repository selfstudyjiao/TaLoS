...
i2d_SSL_SESSION(SSL_SESSION *in, unsigned char **pp)
{
 ...
 unsigned char buf[4], ibuf1[(sizeof(long)*2)], ibuf2[(sizeof(long)*2)];
 unsigned char ibuf3[(sizeof(long)*2)], ibuf4[(sizeof(long)*2)], ibuf5[(sizeof(long)*2)];
 unsigned char ibuf6[(sizeof(long)*2)];
 SSL_SESSION_ASN1 a;
 unsigned char *p;
 int len = 0, ret;
 long l;
...
# 113 "../ssl/ssl_asn1.c"
  ...
  return (0);
# 123 "../ssl/ssl_asn1.c"
 a.version.length = (sizeof(long)*2);
 a.version.type = 2;
 a.version.data = ibuf1;
 ASN1_INTEGER_set(&(a.version), 0x0001);
 len += i2d_ASN1_INTEGER(&(a.version), 
# 127 "../ssl/ssl_asn1.c" 3 4
                                      ((void *)0)
# 127 "../ssl/ssl_asn1.c"
                                          );

 a.ssl_version.length = (sizeof(long)*2);
 a.ssl_version.type = 2;
 a.ssl_version.data = ibuf2;
 ASN1_INTEGER_set(&(a.ssl_version), in->ssl_version);
 len += i2d_ASN1_INTEGER(&(a.ssl_version), 
# 133 "../ssl/ssl_asn1.c" 3 4
                                          ((void *)0)
# 133 "../ssl/ssl_asn1.c"
                                              );
 ...
 a.cipher.type = 4;
 l = (in->cipher == 
# 137 "../ssl/ssl_asn1.c" 3 4
                   ((void *)0)
# 137 "../ssl/ssl_asn1.c"
                       ) ? in->cipher_id : in->cipher->id;
 buf[0] = ((unsigned char)(l >> 8L)) & 0xff;
 buf[1] = ((unsigned char)(l)) & 0xff;
 a.cipher.data = buf;
 len += i2d_ASN1_OCTET_STRING(&(a.cipher), 
# 141 "../ssl/ssl_asn1.c" 3 4
                                          ((void *)0)
# 141 "../ssl/ssl_asn1.c"
                                              );
 ...
 len += i2d_ASN1_OCTET_STRING(&(a.master_key), 
# 146 "../ssl/ssl_asn1.c" 3 4
                                              ((void *)0)
# 146 "../ssl/ssl_asn1.c"
                                                  );
 ...
 len += i2d_ASN1_OCTET_STRING(&(a.session_id), 
# 151 "../ssl/ssl_asn1.c" 3 4
                                              ((void *)0)
# 151 "../ssl/ssl_asn1.c"
                                                  );

 if (in->time != 0L) {
  a.time.length = (sizeof(long)*2);
  a.time.type = 2;
  a.time.data = ibuf3;
  ASN1_INTEGER_set(&(a.time), in->time);
  v1 = i2d_ASN1_INTEGER(&(a.time), 
# 158 "../ssl/ssl_asn1.c" 3 4
                                  ((void *)0)
# 158 "../ssl/ssl_asn1.c"
                                      );
 ...
 if (in->timeout != 0L) {
  a.timeout.length = (sizeof(long)*2);
  a.timeout.type = 2;
  a.timeout.data = ibuf4;
  ASN1_INTEGER_set(&(a.timeout), in->timeout);
  v2 = i2d_ASN1_INTEGER(&(a.timeout), 
# 167 "../ssl/ssl_asn1.c" 3 4
                                     ((void *)0)
# 167 "../ssl/ssl_asn1.c"
                                         );
 ...
 if (in->peer != 
# 171 "../ssl/ssl_asn1.c" 3 4
                ((void *)0)
# 171 "../ssl/ssl_asn1.c"
                    ) {
  v3 = i2d_X509(in->peer, 
# 172 "../ssl/ssl_asn1.c" 3 4
                         ((void *)0)
# 172 "../ssl/ssl_asn1.c"
                             );
 ...
 a.session_id_context.type = 4;
 a.session_id_context.data = in->sid_ctx;
 v4 = i2d_ASN1_OCTET_STRING(&(a.session_id_context), 
# 179 "../ssl/ssl_asn1.c" 3 4
                                                    ((void *)0)
# 179 "../ssl/ssl_asn1.c"
                                                        );
 ...
 if (in->verify_result != 0) {
  a.verify_result.length = (sizeof(long)*2);
  a.verify_result.type = 2;
  a.verify_result.data = ibuf5;
  ASN1_INTEGER_set(&a.verify_result, in->verify_result);
  v5 = i2d_ASN1_INTEGER(&(a.verify_result), 
# 187 "../ssl/ssl_asn1.c" 3 4
                                           ((void *)0)
# 187 "../ssl/ssl_asn1.c"
                                               );
 ...
 if (in->tlsext_hostname) {
  ...
  a.tlsext_hostname.type = 4;
  a.tlsext_hostname.data = (unsigned char *)in->tlsext_hostname;
  v6 = i2d_ASN1_OCTET_STRING(&(a.tlsext_hostname), 
# 195 "../ssl/ssl_asn1.c" 3 4
                                                  ((void *)0)
# 195 "../ssl/ssl_asn1.c"
                                                      );
 ...
 if (in->tlsext_tick_lifetime_hint > 0) {
  a.tlsext_tick_lifetime.length = (sizeof(long)*2);
  a.tlsext_tick_lifetime.type = 2;
  a.tlsext_tick_lifetime.data = ibuf6;
  ASN1_INTEGER_set(&a.tlsext_tick_lifetime,
      in->tlsext_tick_lifetime_hint);
  v9 = i2d_ASN1_INTEGER(&(a.tlsext_tick_lifetime), 
# 208 "../ssl/ssl_asn1.c" 3 4
                                                  ((void *)0)
# 208 "../ssl/ssl_asn1.c"
                                                      );
 ...
 if (in->tlsext_tick) {
  ...
  a.tlsext_tick.type = 4;
  a.tlsext_tick.data = (unsigned char *)in->tlsext_tick;
  v10 = i2d_ASN1_OCTET_STRING(&(a.tlsext_tick), 
# 216 "../ssl/ssl_asn1.c" 3 4
                                               ((void *)0)
# 216 "../ssl/ssl_asn1.c"
                                                   );
 ...
 ret = (ASN1_object_size(1, len, 16));
 if (pp == 
# 225 "../ssl/ssl_asn1.c" 3 4
          ((void *)0)
# 225 "../ssl/ssl_asn1.c"
              )
  return (ret);
 ...
 p = *pp;
 ASN1_put_object(&p, 1, len, 16, 0x00);
 ...
 if (in->time != 0L) {
  ASN1_put_object(&p, 1, v1, 1, 0x80);
  i2d_ASN1_INTEGER(&(a.time), &p);
 }
 if (in->timeout != 0L) {
  ASN1_put_object(&p, 1, v2, 2, 0x80);
  i2d_ASN1_INTEGER(&(a.timeout), &p);
 }
 if (in->peer != 
# 244 "../ssl/ssl_asn1.c" 3 4
                ((void *)0)
# 244 "../ssl/ssl_asn1.c"
                    ) {
  ASN1_put_object(&p, 1, v3, 3, 0x80);
  i2d_X509(in->peer, &p);
 }
 ASN1_put_object(&p, 1, v4, 4, 0x80);
 i2d_ASN1_OCTET_STRING(&(a.session_id_context), &p);
 if (in->verify_result != 0) {
  ASN1_put_object(&p, 1, v5, 5, 0x80);
  i2d_ASN1_INTEGER(&(a.verify_result), &p);
 }
 if (in->tlsext_hostname) {
  ASN1_put_object(&p, 1, v6, 6, 0x80);
  i2d_ASN1_OCTET_STRING(&(a.tlsext_hostname), &p);
 }


 if (in->tlsext_tick_lifetime_hint > 0) {
  ASN1_put_object(&p, 1, v9, 9, 0x80);
  i2d_ASN1_INTEGER(&(a.tlsext_tick_lifetime), &p);
 }
 if (in->tlsext_tick) {
  ASN1_put_object(&p, 1, v10, 10, 0x80);
...
# 309 "../ssl/ssl_asn1.c"
  ...
  if ((ret = SSL_SESSION_new()) == 
# 310 "../ssl/ssl_asn1.c" 3 4
                                  ((void *)0)
# 310 "../ssl/ssl_asn1.c"
                                      ) {
   ERR_put_error(20,(103),(58),"../ssl/ssl_asn1.c",311);
   goto err;
  }
 } else
  ret = *a;
 ...
 if (!asn1_GetSequence(&c, &length)) {
  ERR_put_error(20,(103),(58),"../ssl/ssl_asn1.c",321);
  goto err;
 }

 ai.data = 
# 325 "../ssl/ssl_asn1.c" 3 4
          ((void *)0)
# 325 "../ssl/ssl_asn1.c"
              ;
 ai.length = 0;
 c.q = c.p;
 if (d2i_ASN1_INTEGER(&aip, &c.p, c.slen) == 
# 328 "../ssl/ssl_asn1.c" 3 4
                                            ((void *)0)
# 328 "../ssl/ssl_asn1.c"
                                                ) {
  ERR_put_error(20,(103),(58),"../ssl/ssl_asn1.c",329);
  goto err;
 }
 c.slen -= (c.p - c.q);

 if (ai.data != 
# 334 "../ssl/ssl_asn1.c" 3 4
               ((void *)0)
# 334 "../ssl/ssl_asn1.c"
                   ) {
  free(ai.data);
  ai.data = 
# 336 "../ssl/ssl_asn1.c" 3 4
           ((void *)0)
# 336 "../ssl/ssl_asn1.c"
               ;
  ai.length = 0;
 ...
 c.q = c.p;
 if (d2i_ASN1_INTEGER(&aip, &c.p, c.slen) == 
# 342 "../ssl/ssl_asn1.c" 3 4
                                            ((void *)0)
# 342 "../ssl/ssl_asn1.c"
                                                ) {
  ERR_put_error(20,(103),(58),"../ssl/ssl_asn1.c",343);
  goto err;
 }
 c.slen -= (c.p - c.q);
 ...
 if (ai.data != 
# 349 "../ssl/ssl_asn1.c" 3 4
               ((void *)0)
# 349 "../ssl/ssl_asn1.c"
                   ) {
  free(ai.data);
  ai.data = 
# 351 "../ssl/ssl_asn1.c" 3 4
           ((void *)0)
# 351 "../ssl/ssl_asn1.c"
               ;
  ai.length = 0;
 ...
 os.data = 
# 355 "../ssl/ssl_asn1.c" 3 4
          ((void *)0)
# 355 "../ssl/ssl_asn1.c"
              ;
 os.length = 0;
 c.q = c.p;
 if (d2i_ASN1_OCTET_STRING(&osp, &c.p, c.slen) == 
# 358 "../ssl/ssl_asn1.c" 3 4
                                                 ((void *)0)
# 358 "../ssl/ssl_asn1.c"
                                                     ) {
  ERR_put_error(20,(103),(58),"../ssl/ssl_asn1.c",359);
  goto err;
 }
 c.slen -= (c.p - c.q);
 if ((ssl_version >> 8) >= 0x03) {
  if (os.length != 2) {
   ERR_put_error(20,(103),(137),"../ssl/ssl_asn1.c",366)
                                      ;
   goto err;
  }
  ...
  ERR_put_error(20,(103),(254),"../ssl/ssl_asn1.c",372);
  goto err;
 }

 ret->cipher = 
# 376 "../ssl/ssl_asn1.c" 3 4
              ((void *)0)
# 376 "../ssl/ssl_asn1.c"
                  ;
 ret->cipher_id = id;
 ...
 c.q = c.p;
 if (d2i_ASN1_OCTET_STRING(&osp, &c.p, c.slen) == 
# 380 "../ssl/ssl_asn1.c" 3 4
                                                 ((void *)0)
# 380 "../ssl/ssl_asn1.c"
                                                     ) {
  ERR_put_error(20,(103),(58),"../ssl/ssl_asn1.c",381);
  goto err;
 }
 c.slen -= (c.p - c.q);
 ...
 (void)((os.length <= (int)sizeof(ret->session_id)) ? 0 : (OpenSSLDie("../ssl/ssl_asn1.c", 393, "os.length <= (int)sizeof(ret->session_id)"),1));
 memcpy(ret->session_id, os.data, os.length);

 c.q = c.p;
 if (d2i_ASN1_OCTET_STRING(&osp, &c.p, c.slen) == 
# 397 "../ssl/ssl_asn1.c" 3 4
                                                 ((void *)0)
# 397 "../ssl/ssl_asn1.c"
                                                     ) {
  ERR_put_error(20,(103),(58),"../ssl/ssl_asn1.c",398);
  goto err;
 }
 c.slen -= (c.p - c.q);
 if (os.length > 48)
  ret->master_key_length = 48;
 else
 ...
 if (c.slen != 0L &&
  ...
  if (Tinf & 0x80) {
   ERR_put_error(20,(103),(59),"../ssl/ssl_asn1.c",419)
                                    ;
   goto err;
  }
  if (Tinf == (0x20 + 1))
   Tlen = c.slen - (c.p - c.q) - 2;
  if (d2i_ASN1_INTEGER(&aip, &c.p, Tlen) == 
# 424 "../ssl/ssl_asn1.c" 3 4
                                           ((void *)0)
# 424 "../ssl/ssl_asn1.c"
                                               ) {
   ERR_put_error(20,(103),(58),"../ssl/ssl_asn1.c",425);
   goto err;
  }
  if (Tinf == (0x20 + 1)) {
   Tlen = c.slen - (c.p - c.q);
   if(!ASN1_const_check_infinite_end(&c.p, Tlen)) {
    ERR_put_error(20,(103),(63),"../ssl/ssl_asn1.c",432)
                               ;
    goto err;
   }
  }
...
# 444 "../ssl/ssl_asn1.c"
 ...
 if (c.slen != 0L &&
  ...
  Tinf = ASN1_get_object(&c.p, &Tlen, &Ttag, &Tclass, c.slen);
  if (Tinf & 0x80) {
   ERR_put_error(20,(103),(59),"../ssl/ssl_asn1.c",454)
                                    ;
   goto err;
  }
  if (Tinf == (0x20 + 1))
   Tlen = c.slen - (c.p - c.q) - 2;
  if (d2i_ASN1_INTEGER(&aip, &c.p, Tlen) == 
# 459 "../ssl/ssl_asn1.c" 3 4
                                           ((void *)0)
# 459 "../ssl/ssl_asn1.c"
                                               ) {
   ERR_put_error(20,(103),(58),"../ssl/ssl_asn1.c",460);
   goto err;
  }
  if (Tinf == (0x20 + 1)) {
   Tlen = c.slen - (c.p - c.q);
   if(!ASN1_const_check_infinite_end(&c.p, Tlen)) {
    ERR_put_error(20,(103),(63),"../ssl/ssl_asn1.c",467)
                               ;
    goto err;
   }
  }
...
# 483 "../ssl/ssl_asn1.c"
 ...
 if (c.slen != 0L &&
  ...
  Tinf = ASN1_get_object(&c.p, &Tlen, &Ttag, &Tclass, c.slen);
  if (Tinf & 0x80) {
   ERR_put_error(20,(103),(59),"../ssl/ssl_asn1.c",491)
                                    ;
   goto err;
  }
  if (Tinf == (0x20 + 1))
   Tlen = c.slen - (c.p - c.q) - 2;
  if (d2i_X509(&ret->peer, &c.p, Tlen) == 
# 496 "../ssl/ssl_asn1.c" 3 4
                                         ((void *)0)
# 496 "../ssl/ssl_asn1.c"
                                             ) {
   ERR_put_error(20,(103),(58),"../ssl/ssl_asn1.c",497);
   goto err;
  }
  if (Tinf == (0x20 + 1)) {
   Tlen = c.slen - (c.p - c.q);
   if(!ASN1_const_check_infinite_end(&c.p, Tlen)) {
    ERR_put_error(20,(103),(63),"../ssl/ssl_asn1.c",504)
                               ;
    goto err;
   }
  }
...
# 514 "../ssl/ssl_asn1.c"
 ...
 if (c.slen != 0L &&
  ...
  Tinf = ASN1_get_object(&c.p, &Tlen, &Ttag, &Tclass, c.slen);
  if (Tinf & 0x80) {
   ERR_put_error(20,(103),(59),"../ssl/ssl_asn1.c",521)
                                    ;
   goto err;
  }
  if (Tinf == (0x20 + 1))
   Tlen = c.slen - (c.p - c.q) - 2;
  if (d2i_ASN1_OCTET_STRING(&osp, &c.p, Tlen) == 
# 526 "../ssl/ssl_asn1.c" 3 4
                                                ((void *)0)
# 526 "../ssl/ssl_asn1.c"
                                                    ) {
   ERR_put_error(20,(103),(58),"../ssl/ssl_asn1.c",527);
   goto err;
  }
  if (Tinf == (0x20 + 1)) {
   Tlen = c.slen - (c.p - c.q);
   if(!ASN1_const_check_infinite_end(&c.p, Tlen)) {
    ERR_put_error(20,(103),(63),"../ssl/ssl_asn1.c",534)
                               ;
    goto err;
   }
  }
 ...
 if (os.data != 
# 540 "../ssl/ssl_asn1.c" 3 4
               ((void *)0)
# 540 "../ssl/ssl_asn1.c"
                   ) {
  if (os.length > 32) {
   ERR_put_error(20,(103),(271),"../ssl/ssl_asn1.c",542);
   goto err;
  } else {
...
# 549 "../ssl/ssl_asn1.c"
 ...
 if (c.slen != 0L &&
  ...
  Tinf = ASN1_get_object(&c.p, &Tlen, &Ttag, &Tclass, c.slen);
  if (Tinf & 0x80) {
   ERR_put_error(20,(103),(59),"../ssl/ssl_asn1.c",562)
                                    ;
   goto err;
  }
  if (Tinf == (0x20 + 1))
   Tlen = c.slen - (c.p - c.q) - 2;
  if (d2i_ASN1_INTEGER(&aip, &c.p, Tlen) == 
# 567 "../ssl/ssl_asn1.c" 3 4
                                           ((void *)0)
# 567 "../ssl/ssl_asn1.c"
                                               ) {
   ERR_put_error(20,(103),(58),"../ssl/ssl_asn1.c",568);
   goto err;
  }
  if (Tinf == (0x20 + 1)) {
   Tlen = c.slen - (c.p - c.q);
   if(!ASN1_const_check_infinite_end(&c.p, Tlen)) {
    ERR_put_error(20,(103),(63),"../ssl/ssl_asn1.c",575)
                               ;
    goto err;
   }
  }
...
# 591 "../ssl/ssl_asn1.c"
 ...
 if (c.slen != 0L &&
  ...
  Tinf = ASN1_get_object(&c.p, &Tlen, &Ttag, &Tclass, c.slen);
  if (Tinf & 0x80) {
   ERR_put_error(20,(103),(59),"../ssl/ssl_asn1.c",598)
                                    ;
   goto err;
  }
  if (Tinf == (0x20 + 1))
   Tlen = c.slen - (c.p - c.q) - 2;
  if (d2i_ASN1_OCTET_STRING(&osp, &c.p, Tlen) == 
# 603 "../ssl/ssl_asn1.c" 3 4
                                                ((void *)0)
# 603 "../ssl/ssl_asn1.c"
                                                    ) {
   ERR_put_error(20,(103),(58),"../ssl/ssl_asn1.c",604);
   goto err;
  }
  if (Tinf == (0x20 + 1)) {
   Tlen = c.slen - (c.p - c.q);
   if(!ASN1_const_check_infinite_end(&c.p, Tlen)) {
    ERR_put_error(20,(103),(63),"../ssl/ssl_asn1.c",611)
                               ;
    goto err;
   }
  }
...
# 623 "../ssl/ssl_asn1.c"
 ...
 if (c.slen != 0L &&
  ...
  Tinf = ASN1_get_object(&c.p, &Tlen, &Ttag, &Tclass, c.slen);
  if (Tinf & 0x80) {
   ERR_put_error(20,(103),(59),"../ssl/ssl_asn1.c",636)
                                    ;
   goto err;
  }
  if (Tinf == (0x20 + 1))
   Tlen = c.slen - (c.p - c.q) - 2;
  if (d2i_ASN1_INTEGER(&aip, &c.p, Tlen) == 
# 641 "../ssl/ssl_asn1.c" 3 4
                                           ((void *)0)
# 641 "../ssl/ssl_asn1.c"
                                               ) {
   ERR_put_error(20,(103),(58),"../ssl/ssl_asn1.c",642);
   goto err;
  }
  if (Tinf == (0x20 + 1)) {
   Tlen = c.slen - (c.p - c.q);
   if(!ASN1_const_check_infinite_end(&c.p, Tlen)) {
    ERR_put_error(20,(103),(63),"../ssl/ssl_asn1.c",649)
                               ;
    goto err;
   }
  }
...
# 665 "../ssl/ssl_asn1.c"
 ...
 if (c.slen != 0L &&
  ...
  Tinf = ASN1_get_object(&c.p, &Tlen, &Ttag, &Tclass, c.slen);
  if (Tinf & 0x80) {
   ERR_put_error(20,(103),(59),"../ssl/ssl_asn1.c",674)
                                    ;
   goto err;
  }
  if (Tinf == (0x20 + 1))
   Tlen = c.slen - (c.p - c.q) - 2;
  if (d2i_ASN1_OCTET_STRING(&osp, &c.p, Tlen) == 
# 679 "../ssl/ssl_asn1.c" 3 4
                                                ((void *)0)
# 679 "../ssl/ssl_asn1.c"
                                                    ) {
   ERR_put_error(20,(103),(58),"../ssl/ssl_asn1.c",680);
   goto err;
  }
  if (Tinf == (0x20 + 1)) {
   Tlen = c.slen - (c.p - c.q);
   if(!ASN1_const_check_infinite_end(&c.p, Tlen)) {
    ERR_put_error(20,(103),(63),"../ssl/ssl_asn1.c",687)
                               ;
    goto err;
   }
  }
...
# 699 "../ssl/ssl_asn1.c"
 ...
 if (!asn1_const_Finish(&c)) {
  ERR_put_error(20,(103),(58),"../ssl/ssl_asn1.c",705);
  goto err;
 }

 *pp = c.p;
 if (a != 
# 710 "../ssl/ssl_asn1.c" 3 4
         ((void *)0)
# 710 "../ssl/ssl_asn1.c"
             )
  *a = ret;
