...
# 63 "gost/gostr341001_ameth.c" 2





# 1 "../crypto/asn1/asn1_locl.h" 1
# 63 "../crypto/asn1/asn1_locl.h"
struct asn1_pctx_st {
 unsigned long flags;
...
# 150 "../crypto/asn1/asn1_locl.h"
int UTF8_getc(const unsigned char *str, int len, unsigned long *val);
int UTF8_putc(unsigned char *str, int len, unsigned long value);
# 69 "gost/gostr341001_ameth.c" 2
...
# 70 "gost/gostr341001_ameth.c" 2
# 1 "gost/gost_asn1.h" 1
# 57 "gost/gost_asn1.h"
typedef struct {
...
GOST_KEY_INFO *GOST_KEY_INFO_new(void); void GOST_KEY_INFO_free(GOST_KEY_INFO *a); GOST_KEY_INFO *d2i_GOST_KEY_INFO(GOST_KEY_INFO **a, const unsigned char **in, long len); int i2d_GOST_KEY_INFO(GOST_KEY_INFO *a, unsigned char **out); extern const ASN1_ITEM GOST_KEY_INFO_it;
...
GOST_KEY_AGREEMENT_INFO *GOST_KEY_AGREEMENT_INFO_new(void); void GOST_KEY_AGREEMENT_INFO_free(GOST_KEY_AGREEMENT_INFO *a); GOST_KEY_AGREEMENT_INFO *d2i_GOST_KEY_AGREEMENT_INFO(GOST_KEY_AGREEMENT_INFO **a, const unsigned char **in, long len); int i2d_GOST_KEY_AGREEMENT_INFO(GOST_KEY_AGREEMENT_INFO *a, unsigned char **out); extern const ASN1_ITEM GOST_KEY_AGREEMENT_INFO_it;
...
GOST_KEY_TRANSPORT *GOST_KEY_TRANSPORT_new(void); void GOST_KEY_TRANSPORT_free(GOST_KEY_TRANSPORT *a); GOST_KEY_TRANSPORT *d2i_GOST_KEY_TRANSPORT(GOST_KEY_TRANSPORT **a, const unsigned char **in, long len); int i2d_GOST_KEY_TRANSPORT(GOST_KEY_TRANSPORT *a, unsigned char **out); extern const ASN1_ITEM GOST_KEY_TRANSPORT_it;
...
GOST_KEY_PARAMS *GOST_KEY_PARAMS_new(void); void GOST_KEY_PARAMS_free(GOST_KEY_PARAMS *a); GOST_KEY_PARAMS *d2i_GOST_KEY_PARAMS(GOST_KEY_PARAMS **a, const unsigned char **in, long len); int i2d_GOST_KEY_PARAMS(GOST_KEY_PARAMS *a, unsigned char **out); extern const ASN1_ITEM GOST_KEY_PARAMS_it;
# 71 "gost/gostr341001_ameth.c" 2
...
{
 int param_nid = 0, digest_nid = 0;
 GOST_KEY_PARAMS *gkp = 
# 86 "gost/gostr341001_ameth.c" 3 4
                       ((void *)0)
# 86 "gost/gostr341001_ameth.c"
                           ;
 EC_GROUP *group;
 GOST_KEY *ec;

 gkp = d2i_GOST_KEY_PARAMS(
# 90 "gost/gostr341001_ameth.c" 3 4
                          ((void *)0)
# 90 "gost/gostr341001_ameth.c"
                              , p, len);
 if (gkp == 
# 91 "gost/gostr341001_ameth.c" 3 4
           ((void *)0)
# 91 "gost/gostr341001_ameth.c"
               ) {
  ERR_put_error(50,(104),(105),"gost/gostr341001_ameth.c",93)
                                     ;
  return 0;
 }
 ...
 ec = pkey->pkey.gost;
 if (ec == 
# 101 "gost/gostr341001_ameth.c" 3 4
          ((void *)0)
# 101 "gost/gostr341001_ameth.c"
              ) {
  ec = GOST_KEY_new();
  if (ec == 
# 103 "gost/gostr341001_ameth.c" 3 4
           ((void *)0)
# 103 "gost/gostr341001_ameth.c"
               )
   return 0;
  if (EVP_PKEY_assign((pkey),811, (char *)(ec)) == 0)
   return 0;
 }

 group = EC_GROUP_new_by_curve_name(param_nid);
 if (group == 
# 110 "gost/gostr341001_ameth.c" 3 4
             ((void *)0)
# 110 "gost/gostr341001_ameth.c"
                 )
  return 0;
 EC_GROUP_set_asn1_flag(group, 0x001);
...
encode_gost01_algor_params(const EVP_PKEY *key)
{
 ...
 int pkey_param_nid = 0;

 if (params == 
# 130 "gost/gostr341001_ameth.c" 3 4
              ((void *)0) 
# 130 "gost/gostr341001_ameth.c"
                   || gkp == 
# 130 "gost/gostr341001_ameth.c" 3 4
                             ((void *)0)
# 130 "gost/gostr341001_ameth.c"
                                 ) {
  ERR_put_error(50,(105),((1|64)),"gost/gostr341001_ameth.c",132)
                           ;
  ASN1_STRING_free(params);
  params = 
# 134 "gost/gostr341001_ameth.c" 3 4
          ((void *)0)
# 134 "gost/gostr341001_ameth.c"
              ;
  goto err;
 }
 ...
 if (params->length <= 0) {
  ERR_put_error(50,(105),((1|64)),"gost/gostr341001_ameth.c",146)
                           ;
  ASN1_STRING_free(params);
  params = 
# 148 "gost/gostr341001_ameth.c" 3 4
          ((void *)0)
# 148 "gost/gostr341001_ameth.c"
              ;
  goto err;
 }
 params->type = 16;
...
pub_cmp_gost01(const EVP_PKEY *a, const EVP_PKEY *b)
{
 ...
 if (ea == 
# 165 "gost/gostr341001_ameth.c" 3 4
          ((void *)0) 
# 165 "gost/gostr341001_ameth.c"
               || eb == 
# 165 "gost/gostr341001_ameth.c" 3 4
                        ((void *)0)
# 165 "gost/gostr341001_ameth.c"
 ...
 if (ka == 
# 169 "gost/gostr341001_ameth.c" 3 4
          ((void *)0) 
# 169 "gost/gostr341001_ameth.c"
               || kb == 
# 169 "gost/gostr341001_ameth.c" 3 4
                        ((void *)0)
# 169 "gost/gostr341001_ameth.c"
  ...
  return 0;
 ret = (0 == EC_POINT_cmp(GOST_KEY_get0_group(ea), ka, kb, 
# 171 "gost/gostr341001_ameth.c" 3 4
                                                          ((void *)0)
# 171 "gost/gostr341001_ameth.c"
                                                              ));
 return ret;
}
...
{
 if (GOST_KEY_get_digest(pk->pkey.gost) == 942)
  return 128;
 return 64;
}
...
{
 X509_ALGOR *palg = 
# 194 "gost/gostr341001_ameth.c" 3 4
                   ((void *)0)
# 194 "gost/gostr341001_ameth.c"
                       ;
 const unsigned char *pubkey_buf = 
# 195 "gost/gostr341001_ameth.c" 3 4
                                  ((void *)0)
# 195 "gost/gostr341001_ameth.c"
                                      ;
 const unsigned char *p;
 ASN1_OBJECT *palgobj = 
# 197 "gost/gostr341001_ameth.c" 3 4
                       ((void *)0)
# 197 "gost/gostr341001_ameth.c"
                           ;
 int pub_len;
 BIGNUM *X, *Y;
 ASN1_OCTET_STRING *octet = 
# 200 "gost/gostr341001_ameth.c" 3 4
                           ((void *)0)
# 200 "gost/gostr341001_ameth.c"
                               ;
 int len;
 int ret;
 int ptype = -1;
 ASN1_STRING *pval = 
# 204 "gost/gostr341001_ameth.c" 3 4
                    ((void *)0)
# 204 "gost/gostr341001_ameth.c"
                        ;

 if (X509_PUBKEY_get0_param(&palgobj, &pubkey_buf, &pub_len, &palg, pub)
     == 0)
  return 0;
 (void)EVP_PKEY_assign((pk),811, (char *)(
# 209 "gost/gostr341001_ameth.c" 3 4
      ((void *)0)
# 209 "gost/gostr341001_ameth.c"
      ));
 X509_ALGOR_get0(
# 210 "gost/gostr341001_ameth.c" 3 4
                ((void *)0)
# 210 "gost/gostr341001_ameth.c"
                    , &ptype, (void **)&pval, palg);
 if (ptype != 16) {
  ERR_put_error(50,(118),(104),"gost/gostr341001_ameth.c",213)
                                       ;
  return 0;
 }
 p = pval->data;
...
# 220 "gost/gostr341001_ameth.c" 3 4
                              ((void *)0)
# 220 "gost/gostr341001_ameth.c"
                                  , &pubkey_buf, pub_len);
 if (octet == 
# 221 "gost/gostr341001_ameth.c" 3 4
             ((void *)0)
# 221 "gost/gostr341001_ameth.c"
                 ) {
  ERR_put_error(50,(118),((1|64)),"gost/gostr341001_ameth.c",222);
  return 0;
 }
 len = octet->length / 2;

 X = GOST_le2bn(octet->data, len, 
# 227 "gost/gostr341001_ameth.c" 3 4
                                 ((void *)0)
# 227 "gost/gostr341001_ameth.c"
                                     );
 Y = GOST_le2bn(octet->data + len, len, 
# 228 "gost/gostr341001_ameth.c" 3 4
                                       ((void *)0)
# 228 "gost/gostr341001_ameth.c"
                                           );
 ...
 if (ret == 0)
  ERR_put_error(50,(118),(16),"gost/gostr341001_ameth.c",234);
...
{
 ASN1_OBJECT *algobj = 
# 245 "gost/gostr341001_ameth.c" 3 4
                      ((void *)0)
# 245 "gost/gostr341001_ameth.c"
                          ;
 ASN1_OCTET_STRING *octet = 
# 246 "gost/gostr341001_ameth.c" 3 4
                           ((void *)0)
# 246 "gost/gostr341001_ameth.c"
                               ;
 ASN1_STRING *params = 
# 247 "gost/gostr341001_ameth.c" 3 4
                      ((void *)0)
# 247 "gost/gostr341001_ameth.c"
                          ;
 void *pval = 
# 248 "gost/gostr341001_ameth.c" 3 4
             ((void *)0)
# 248 "gost/gostr341001_ameth.c"
                 ;
 unsigned char *buf = 
# 249 "gost/gostr341001_ameth.c" 3 4
                     ((void *)0)
# 249 "gost/gostr341001_ameth.c"
                         , *sptr;
 int key_size, ret = 0;
 const EC_POINT *pub_key;
 BIGNUM *X = 
# 252 "gost/gostr341001_ameth.c" 3 4
            ((void *)0)
# 252 "gost/gostr341001_ameth.c"
                , *Y = 
# 252 "gost/gostr341001_ameth.c" 3 4
                       ((void *)0)
# 252 "gost/gostr341001_ameth.c"
 ...
 if (pk->save_parameters) {
  ...
  if (params == 
# 259 "gost/gostr341001_ameth.c" 3 4
               ((void *)0)
# 259 "gost/gostr341001_ameth.c"
                   )
   return 0;
  pval = params;
  ptype = 16;
 ...
 if (pub_key == 
# 268 "gost/gostr341001_ameth.c" 3 4
               ((void *)0)
# 268 "gost/gostr341001_ameth.c"
                   ) {
  ERR_put_error(50,(119),(118),"gost/gostr341001_ameth.c",269);
  goto err;
 }

 octet = ASN1_OCTET_STRING_new();
 if (octet == 
# 274 "gost/gostr341001_ameth.c" 3 4
             ((void *)0)
# 274 "gost/gostr341001_ameth.c"
                 ) {
  ERR_put_error(50,(119),((1|64)),"gost/gostr341001_ameth.c",275);
  goto err;
 }

 ret = ASN1_STRING_set(octet, 
# 279 "gost/gostr341001_ameth.c" 3 4
                             ((void *)0)
# 279 "gost/gostr341001_ameth.c"
                                 , 2 * key_size);
 if (ret == 0) {
  ERR_put_error(50,(119),((4|64)),"gost/gostr341001_ameth.c",281);
  goto err;
 }
 ...
 Y = BN_new();
 if (X == 
# 289 "gost/gostr341001_ameth.c" 3 4
         ((void *)0) 
# 289 "gost/gostr341001_ameth.c"
              || Y == 
# 289 "gost/gostr341001_ameth.c" 3 4
                      ((void *)0)
# 289 "gost/gostr341001_ameth.c"
                          ) {
  ERR_put_error(50,(119),((1|64)),"gost/gostr341001_ameth.c",290);
  goto err;
 }

 if (EC_POINT_get_affine_coordinates_GFp(GOST_KEY_get0_group(ec),
     pub_key, X, Y, 
# 295 "gost/gostr341001_ameth.c" 3 4
                   ((void *)0)
# 295 "gost/gostr341001_ameth.c"
                       ) == 0) {
  ERR_put_error(50,(119),(16),"gost/gostr341001_ameth.c",296);
  goto err;
 }
...
pub_print_gost01(BIO *out, const EVP_PKEY *pkey, int indent, ASN1_PCTX *pctx)
{
 ...
 if (ctx == 
# 345 "gost/gostr341001_ameth.c" 3 4
           ((void *)0)
# 345 "gost/gostr341001_ameth.c"
               ) {
  ERR_put_error(50,(120),((1|64)),"gost/gostr341001_ameth.c",346);
  return 0;
 }
 BN_CTX_start(ctx);
 if ((X = BN_CTX_get(ctx)) == 
# 350 "gost/gostr341001_ameth.c" 3 4
                             ((void *)0)
# 350 "gost/gostr341001_ameth.c"
                                 )
  goto err;
 if ((Y = BN_CTX_get(ctx)) == 
# 352 "gost/gostr341001_ameth.c" 3 4
                             ((void *)0)
# 352 "gost/gostr341001_ameth.c"
                                 )
  goto err;
 ...
 if (EC_POINT_get_affine_coordinates_GFp(group, pubkey, X, Y,
     ctx) == 0) {
  ERR_put_error(50,(120),(16),"gost/gostr341001_ameth.c",358);
  goto err;
 }
 if (BIO_indent(out, indent, 128) == 0)
  goto err;
...
priv_print_gost01(BIO *out, const EVP_PKEY *pkey, int indent, ASN1_PCTX *pctx)
{
 ...
 if (key == 
# 394 "gost/gostr341001_ameth.c" 3 4
           ((void *)0)
# 394 "gost/gostr341001_ameth.c"
               )
...
# 406 "gost/gostr341001_ameth.c" 3 4
                                ((void *)0)
# 406 "gost/gostr341001_ameth.c"
                                    , *p = 
# 406 "gost/gostr341001_ameth.c" 3 4
                                           ((void *)0)
# 406 "gost/gostr341001_ameth.c"
 ...
 int priv_len = 0;
 BIGNUM *pk_num = 
# 408 "gost/gostr341001_ameth.c" 3 4
                 ((void *)0)
# 408 "gost/gostr341001_ameth.c"
                     ;
 int ret = 0;
 X509_ALGOR *palg = 
# 410 "gost/gostr341001_ameth.c" 3 4
                   ((void *)0)
# 410 "gost/gostr341001_ameth.c"
                       ;
 ASN1_OBJECT *palg_obj = 
# 411 "gost/gostr341001_ameth.c" 3 4
                        ((void *)0)
# 411 "gost/gostr341001_ameth.c"
                            ;
 ASN1_INTEGER *priv_key = 
# 412 "gost/gostr341001_ameth.c" 3 4
                         ((void *)0)
# 412 "gost/gostr341001_ameth.c"
                             ;
 GOST_KEY *ec;
 int ptype = -1;
 ASN1_STRING *pval = 
# 415 "gost/gostr341001_ameth.c" 3 4
                    ((void *)0)
# 415 "gost/gostr341001_ameth.c"
                        ;

 if (PKCS8_pkey_get0(&palg_obj, &pkey_buf, &priv_len, &palg, p8inf) == 0)
  return 0;
 (void)EVP_PKEY_assign((pk),811, (char *)(
# 419 "gost/gostr341001_ameth.c" 3 4
      ((void *)0)
# 419 "gost/gostr341001_ameth.c"
      ));
 X509_ALGOR_get0(
# 420 "gost/gostr341001_ameth.c" 3 4
                ((void *)0)
# 420 "gost/gostr341001_ameth.c"
                    , &ptype, (void **)&pval, palg);
 if (ptype != 16) {
  ERR_put_error(50,(118),(104),"gost/gostr341001_ameth.c",423)
                                       ;
  return 0;
 }
 p = pval->data;
...
# 435 "gost/gostr341001_ameth.c" 3 4
                           ((void *)0)
# 435 "gost/gostr341001_ameth.c"
                               , &p, priv_len);

  if (s == 
# 437 "gost/gostr341001_ameth.c" 3 4
          ((void *)0) 
# 437 "gost/gostr341001_ameth.c"
               || s->length != 32) {
   ERR_put_error(50,(117),(114),"gost/gostr341001_ameth.c",438);
   ASN1_STRING_free(s);
   return 0;
  }
  for (i = 0; i < 32; i++) {
  ...
  ASN1_STRING_free(s);
  pk_num = BN_bin2bn(rev_buf, 32, 
# 446 "gost/gostr341001_ameth.c" 3 4
                                 ((void *)0)
# 446 "gost/gostr341001_ameth.c"
                                     );
 } else {
  priv_key = d2i_ASN1_INTEGER(
# 448 "gost/gostr341001_ameth.c" 3 4
                             ((void *)0)
# 448 "gost/gostr341001_ameth.c"
                                 , &p, priv_len);
  if (priv_key == 
# 449 "gost/gostr341001_ameth.c" 3 4
                 ((void *)0)
# 449 "gost/gostr341001_ameth.c"
                     )
   return 0;
  ret = ((pk_num = ASN1_INTEGER_to_BN(priv_key, 
# 451 "gost/gostr341001_ameth.c" 3 4
                                               ((void *)0)
# 451 "gost/gostr341001_ameth.c"
                                                   )) != 
# 451 "gost/gostr341001_ameth.c" 3 4
                                                         ((void *)0)
# 451 "gost/gostr341001_ameth.c"
  ...
  if (ret == 0) {
   ERR_put_error(50,(117),(114),"gost/gostr341001_ameth.c",454);
   return 0;
  }
 }
 ...
 ec = pk->pkey.gost;
 if (ec == 
# 460 "gost/gostr341001_ameth.c" 3 4
          ((void *)0)
# 460 "gost/gostr341001_ameth.c"
              ) {
  ec = GOST_KEY_new();
  if (ec == 
# 462 "gost/gostr341001_ameth.c" 3 4
           ((void *)0)
# 462 "gost/gostr341001_ameth.c"
               ) {
   BN_free(pk_num);
   return 0;
  }
  if (EVP_PKEY_assign((pk),811, (char *)(ec)) == 0) {
   BN_free(pk_num);
   GOST_KEY_free(ec);
   return 0;
  }
...
priv_encode_gost01(PKCS8_PRIV_KEY_INFO *p8, const EVP_PKEY *pk)
{
 ...
 unsigned char *priv_buf = 
# 490 "gost/gostr341001_ameth.c" 3 4
                          ((void *)0)
# 490 "gost/gostr341001_ameth.c"
                              ;
 int priv_len;
 ASN1_INTEGER *asn1key = 
# 492 "gost/gostr341001_ameth.c" 3 4
                        ((void *)0)
# 492 "gost/gostr341001_ameth.c"
                            ;

 if (params == 
# 494 "gost/gostr341001_ameth.c" 3 4
              ((void *)0)
# 494 "gost/gostr341001_ameth.c"
                  )
  return 0;

 asn1key = BN_to_ASN1_INTEGER(GOST_KEY_get0_private_key(pk->pkey.gost),
     
# 498 "gost/gostr341001_ameth.c" 3 4
    ((void *)0)
# 498 "gost/gostr341001_ameth.c"
        );
 if (asn1key == 
# 499 "gost/gostr341001_ameth.c" 3 4
               ((void *)0)
# 499 "gost/gostr341001_ameth.c"
                   ) {
  ASN1_STRING_free(params);
  return 0;
 }
 ...
 return PKCS8_pkey_set0(p8, algobj, 0, 16, params, priv_buf,
     priv_len);
}
...
param_encode_gost01(const EVP_PKEY *pkey, unsigned char **pder)
{
 ...
 if (params == 
# 515 "gost/gostr341001_ameth.c" 3 4
              ((void *)0)
# 515 "gost/gostr341001_ameth.c"
                  )
  return 0;
 len = params->length;
 if (pder != 
# 518 "gost/gostr341001_ameth.c" 3 4
            ((void *)0)
# 518 "gost/gostr341001_ameth.c"
                )
...
{
 ASN1_OBJECT *obj = 
# 527 "gost/gostr341001_ameth.c" 3 4
                   ((void *)0)
# 527 "gost/gostr341001_ameth.c"
                       ;
 int nid;
 GOST_KEY *ec;
 EC_GROUP *group;
 ...
 if (d2i_ASN1_OBJECT(&obj, pder, derlen) == 
# 538 "gost/gostr341001_ameth.c" 3 4
                                           ((void *)0)
# 538 "gost/gostr341001_ameth.c"
                                               ) {
  ERR_put_error(50,(111),((1|64)),"gost/gostr341001_ameth.c",539);
  return 0;
 }
 nid = OBJ_obj2nid(obj);
 ...
 ec = GOST_KEY_new();
 if (ec == 
# 546 "gost/gostr341001_ameth.c" 3 4
          ((void *)0)
# 546 "gost/gostr341001_ameth.c"
              ) {
  ERR_put_error(50,(111),((1|64)),"gost/gostr341001_ameth.c",547);
  return 0;
 }
 group = EC_GROUP_new_by_curve_name(nid);
 if (group == 
# 551 "gost/gostr341001_ameth.c" 3 4
             ((void *)0)
# 551 "gost/gostr341001_ameth.c"
                 ) {
  ERR_put_error(50,(111),(119),"gost/gostr341001_ameth.c",553)
                                        ;
  GOST_KEY_free(ec);
  return 0;
 }
 ...
 EC_GROUP_set_asn1_flag(group, 0x001);
 if (GOST_KEY_set_group(ec, group) == 0) {
  ERR_put_error(50,(111),(16),"gost/gostr341001_ameth.c",560);
  EC_GROUP_free(group);
  GOST_KEY_free(ec);
  return 0;
 }
 ...
 if (GOST_KEY_set_digest(ec,
     822) == 0) {
  ERR_put_error(50,(111),(100),"gost/gostr341001_ameth.c",568);
  GOST_KEY_free(ec);
  return 0;
 }
 ret = EVP_PKEY_assign((pkey),811, (char *)(ec));
 if (ret == 0)
  GOST_KEY_free(ec);
 return ret;
}
...
param_missing_gost01(const EVP_PKEY *pk)
{
 ...
 if (ec == 
# 583 "gost/gostr341001_ameth.c" 3 4
          ((void *)0)
# 583 "gost/gostr341001_ameth.c"
              )
  return 1;
 if (GOST_KEY_get0_group(ec) == 
# 585 "gost/gostr341001_ameth.c" 3 4
                               ((void *)0)
# 585 "gost/gostr341001_ameth.c"
                                   )
  return 1;
 if (GOST_KEY_get_digest(ec) == 0)
  return 1;
 return 0;
}
...
param_copy_gost01(EVP_PKEY *to, const EVP_PKEY *from)
{
 ...
 if (EVP_PKEY_base_id(from) != EVP_PKEY_base_id(to)) {
  ERR_put_error(50,(110),(110),"gost/gostr341001_ameth.c",601)
                                     ;
  return 0;
 }
 if (efrom == 
# 604 "gost/gostr341001_ameth.c" 3 4
             ((void *)0)
# 604 "gost/gostr341001_ameth.c"
                 ) {
  ERR_put_error(50,(110),(113),"gost/gostr341001_ameth.c",606)
                                    ;
  return 0;
 }
 if (eto == 
# 609 "gost/gostr341001_ameth.c" 3 4
           ((void *)0)
# 609 "gost/gostr341001_ameth.c"
               ) {
  eto = GOST_KEY_new();
  if (eto == 
# 611 "gost/gostr341001_ameth.c" 3 4
            ((void *)0)
# 611 "gost/gostr341001_ameth.c"
                ) {
   ERR_put_error(50,(110),((1|64)),"gost/gostr341001_ameth.c",613)
                            ;
   return 0;
  }
...
# 623 "gost/gostr341001_ameth.c" 3 4
                                      ((void *)0)
# 623 "gost/gostr341001_ameth.c"
                                          )
...
{
 X509_ALGOR *alg1 = 
# 646 "gost/gostr341001_ameth.c" 3 4
                   ((void *)0)
# 646 "gost/gostr341001_ameth.c"
                       , *alg2 = 
# 646 "gost/gostr341001_ameth.c" 3 4
                                 ((void *)0)
# 646 "gost/gostr341001_ameth.c"
...
# 646 "gost/gostr341001_ameth.c"
 ...
 case 0x1:
  if (arg1 == 0)
   PKCS7_SIGNER_INFO_get0_algs(arg2, 
# 652 "gost/gostr341001_ameth.c" 3 4
                                    ((void *)0)
# 652 "gost/gostr341001_ameth.c"
                                        , &alg1, &alg2);
  break;
...
# 670 "gost/gostr341001_ameth.c"
 ...
 if (alg1)
  X509_ALGOR_set0(alg1, OBJ_nid2obj(GostR3410_get_md_digest(digest)), 5, 0);
 if (alg2)
  X509_ALGOR_set0(alg2, OBJ_nid2obj(GostR3410_get_pk_digest(digest)), 5, 0);
 if (alg3) {
  ASN1_STRING *params = encode_gost01_algor_params(pkey);
  if (params == 
# 684 "gost/gostr341001_ameth.c" 3 4
               ((void *)0)
# 684 "gost/gostr341001_ameth.c"
                   ) {
   return -1;
  }
