...
# 79 "ec/ec_ameth.c"
  ...
  ERR_put_error(16,(223),(124),"ec/ec_ameth.c",80);
  return 0;
 }
...
# 90 "ec/ec_ameth.c"
  ...
  if (pstr->length <= 0) {
   ...
   ERR_put_error(16,(223),(16),"ec/ec_ameth.c",97);
   return 0;
  }
  *ppval = pstr;
  *pptype = 16;
...
eckey_pub_encode(X509_PUBKEY * pk, const EVP_PKEY * pkey)
{
 ...
 void *pval = 
# 110 "ec/ec_ameth.c" 3 4
             ((void *)0)
# 110 "ec/ec_ameth.c"
                 ;
 int ptype;
 unsigned char *penc = 
# 112 "ec/ec_ameth.c" 3 4
                      ((void *)0)
# 112 "ec/ec_ameth.c"
                          , *p;
 int penclen;
 ...
 if (!eckey_param2type(&ptype, &pval, ec_key)) {
  ERR_put_error(16,(216),(16),"ec/ec_ameth.c",116);
  return 0;
 }
 penclen = i2o_ECPublicKey(ec_key, 
# 119 "ec/ec_ameth.c" 3 4
                                  ((void *)0)
# 119 "ec/ec_ameth.c"
                                      );
 if (penclen <= 0)
 ...
 if (penclen <= 0)
  goto err;
 if (X509_PUBKEY_set0_param(pk, OBJ_nid2obj(408),
...
# 153 "ec/ec_ameth.c" 3 4
                                ((void *)0)
# 153 "ec/ec_ameth.c"
                                    , &pm, pmlen))) {
   ERR_put_error(16,(220),(142),"ec/ec_ameth.c",154);
   goto ecerr;
  }
 } else if (ptype == 6) {
  ...
  if ((eckey = EC_KEY_new()) == 
# 165 "ec/ec_ameth.c" 3 4
                               ((void *)0)
# 165 "ec/ec_ameth.c"
                                   ) {
   ERR_put_error(16,(220),((1|64)),"ec/ec_ameth.c",166);
   goto ecerr;
  }
  group = EC_GROUP_new_by_curve_name(OBJ_obj2nid(poid));
  if (group == 
# 170 "ec/ec_ameth.c" 3 4
              ((void *)0)
# 170 "ec/ec_ameth.c"
                  )
   goto ecerr;
  ...
  ERR_put_error(16,(220),(142),"ec/ec_ameth.c",177);
  goto ecerr;
 }
...
# 198 "ec/ec_ameth.c" 3 4
                            ((void *)0)
# 198 "ec/ec_ameth.c"
                                , &p, &pklen, &palg, pubkey))
  return 0;
 X509_ALGOR_get0(
# 200 "ec/ec_ameth.c" 3 4
                ((void *)0)
# 200 "ec/ec_ameth.c"
                    , &ptype, &pval, palg);
 ...
 if (!eckey) {
  ERR_put_error(16,(215),(16),"ec/ec_ameth.c",205);
  return 0;
 }

 if (!o2i_ECPublicKey(&eckey, &p, pklen)) {
  ERR_put_error(16,(215),(142),"ec/ec_ameth.c",210);
  goto ecerr;
 }
 EVP_PKEY_assign((pkey),408, (char *)(eckey));
 return 1;
...
eckey_pub_cmp(const EVP_PKEY * a, const EVP_PKEY * b)
{
 ...
 r = EC_POINT_cmp(group, pa, pb, 
# 229 "ec/ec_ameth.c" 3 4
                                ((void *)0)
# 229 "ec/ec_ameth.c"
                                    );
 if (r == 0)
...
# 243 "ec/ec_ameth.c"
 ...
 if (!PKCS8_pkey_get0(
# 246 "ec/ec_ameth.c" 3 4
                     ((void *)0)
# 246 "ec/ec_ameth.c"
                         , &p, &pklen, &palg, p8))
  return 0;
 X509_ALGOR_get0(
# 248 "ec/ec_ameth.c" 3 4
                ((void *)0)
# 248 "ec/ec_ameth.c"
                    , &ptype, &pval, palg);
 ...
 if (!d2i_ECPrivateKey(&eckey, &p, pklen)) {
  ERR_put_error(16,(213),(142),"ec/ec_ameth.c",257);
  goto ecerr;
 }

 if (EC_KEY_get0_public_key(eckey) == 
# 261 "ec/ec_ameth.c" 3 4
                                     ((void *)0)
# 261 "ec/ec_ameth.c"
                                         ) {
  ...
  if (pub_key == 
# 271 "ec/ec_ameth.c" 3 4
                ((void *)0)
# 271 "ec/ec_ameth.c"
                    ) {
   ERR_put_error(16,(213),(16),"ec/ec_ameth.c",272);
   goto ecliberr;
  }
  if (!EC_POINT_copy(pub_key, EC_GROUP_get0_generator(group))) {
   EC_POINT_free(pub_key);
   ERR_put_error(16,(213),(16),"ec/ec_ameth.c",277);
   goto ecliberr;
  }
  priv_key = EC_KEY_get0_private_key(eckey);
  if (!EC_POINT_mul(group, pub_key, priv_key, 
# 281 "ec/ec_ameth.c" 3 4
                                             ((void *)0)
# 281 "ec/ec_ameth.c"
                                                 , 
# 281 "ec/ec_ameth.c" 3 4
...
# 281 "ec/ec_ameth.c"
   ...
   EC_POINT_free(pub_key);
   ERR_put_error(16,(213),(16),"ec/ec_ameth.c",283);
   goto ecliberr;
  }
  if (EC_KEY_set_public_key(eckey, pub_key) == 0) {
   EC_POINT_free(pub_key);
   ERR_put_error(16,(213),(16),"ec/ec_ameth.c",288);
   goto ecliberr;
  }
  EC_POINT_free(pub_key);
 }
...
ecliberr:
 ERR_put_error(16,(213),(16),"ec/ec_ameth.c",297);
ecerr:
 if (eckey)
  EC_KEY_free(eckey);
 return 0;
...
eckey_priv_encode(PKCS8_PRIV_KEY_INFO * p8, const EVP_PKEY * pkey)
{
 ...
 if (!eckey_param2type(&ptype, &pval, ec_key)) {
  ERR_put_error(16,(214),(142),"ec/ec_ameth.c",316);
  return 0;
 }
 ...
 tmp_flags = old_flags | 0x001;
 EC_KEY_set_enc_flags(ec_key, tmp_flags);
 eplen = i2d_ECPrivateKey(ec_key, 
# 328 "ec/ec_ameth.c" 3 4
                                 ((void *)0)
# 328 "ec/ec_ameth.c"
                                     );
 if (!eplen) {
  EC_KEY_set_enc_flags(ec_key, old_flags);
  ERR_put_error(16,(214),(16),"ec/ec_ameth.c",331);
  return 0;
 }
 ep = malloc(eplen);
 if (!ep) {
  EC_KEY_set_enc_flags(ec_key, old_flags);
  ERR_put_error(16,(214),((1|64)),"ec/ec_ameth.c",337);
  return 0;
 }
 p = ep;
 if (!i2d_ECPrivateKey(ec_key, &p)) {
  EC_KEY_set_enc_flags(ec_key, old_flags);
  free(ep);
  ERR_put_error(16,(214),(16),"ec/ec_ameth.c",344);
  return 0;
 }

 EC_KEY_set_enc_flags(ec_key, old_flags);

 if (!PKCS8_pkey_set0(p8, OBJ_nid2obj(408), 0,
  ptype, pval, ep, eplen))
  return 0;
...
{
 if (EC_KEY_get0_group(pkey->pkey.ec) == 
# 388 "ec/ec_ameth.c" 3 4
                                        ((void *)0)
# 388 "ec/ec_ameth.c"
                                            )
  return 1;
...
ec_cmp_parameters(const EVP_PKEY * a, const EVP_PKEY * b)
{
 ...
 if (EC_GROUP_cmp(group_a, group_b, 
# 403 "ec/ec_ameth.c" 3 4
                                   ((void *)0)
# 403 "ec/ec_ameth.c"
                                       ))
  return 0;
...
# 440 "ec/ec_ameth.c"
  ...
  if (pub_key)
   buf_len = (size_t) ((BN_num_bits(pub_key)+7)/8);
 }
 if (ktype == 2) {
  priv_key = EC_KEY_get0_private_key(x);
  if (priv_key && (i = (size_t) ((BN_num_bits(priv_key)+7)/8)) > buf_len)
   buf_len = i;
 } else
  priv_key = 
# 452 "ec/ec_ameth.c" 3 4
            ((void *)0)
# 452 "ec/ec_ameth.c"
                ;
...
# 456 "ec/ec_ameth.c"
 ...
 if (!BIO_indent(bp, off, 128))
  goto err;
 if ((order = BN_new()) == 
# 470 "ec/ec_ameth.c" 3 4
                          ((void *)0)
# 470 "ec/ec_ameth.c"
                              )
  goto err;
 if (!EC_GROUP_get_order(group, order, 
# 472 "ec/ec_ameth.c" 3 4
                                      ((void *)0)
# 472 "ec/ec_ameth.c"
                                          ))
  goto err;
...
err:
 if (!ret)
  ERR_put_error(16,(221),(reason),"ec/ec_ameth.c",489);
 BN_free(pub_key);
 BN_free(order);
 BN_CTX_free(ctx);
 free(buffer);
    ...
    const unsigned char **pder, int derlen)
{
 EC_KEY *eckey;
 if (!(eckey = d2i_ECParameters(
# 502 "ec/ec_ameth.c" 3 4
                               ((void *)0)
# 502 "ec/ec_ameth.c"
                                   , pder, derlen))) {
  ERR_put_error(16,(212),(16),"ec/ec_ameth.c",503);
  return 0;
 }
 EVP_PKEY_assign((pkey),408, (char *)(eckey));
 return 1;
...
{
 EC_KEY *ec;
 if (!(ec = d2i_ECPrivateKey(
# 543 "ec/ec_ameth.c" 3 4
                            ((void *)0)
# 543 "ec/ec_ameth.c"
                                , pder, derlen))) {
  ERR_put_error(16,(222),(142),"ec/ec_ameth.c",544);
  return 0;
 }
 EVP_PKEY_assign((pkey),408, (char *)(ec));
 return 1;
}
...
# 565 "ec/ec_ameth.c" 3 4
                                    ((void *)0)
# 565 "ec/ec_ameth.c"
                                        , &alg1, &alg2);
   if (alg1 == 
# 566 "ec/ec_ameth.c" 3 4
              ((void *)0) 
# 566 "ec/ec_ameth.c"
                   || alg1->algorithm == 
# 566 "ec/ec_ameth.c" 3 4
...
# 566 "ec/ec_ameth.c"
   ...
   if (!OBJ_find_sigid_by_algs(&snid, hnid, EVP_PKEY_id(pkey)))
    return -1;
   X509_ALGOR_set0(alg2, OBJ_nid2obj(snid), -1, 0);
  }
  return 1;
# 595 "ec/ec_ameth.c"
 case 0x3:
