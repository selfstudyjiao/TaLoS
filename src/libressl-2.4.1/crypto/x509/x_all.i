...
{
 return ((RSA*)ASN1_d2i_bio( ((void *(*)(void)) (1 ? RSA_new : ((RSA *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_RSA_PUBKEY : ((RSA *(*)(RSA **,const unsigned char **,long))0))), bp, ((void**) (1 ? rsa : (RSA**)0))));
}

int
i2d_RSA_PUBKEY_bio(BIO *bp, RSA *rsa)
{
 return (ASN1_i2d_bio(((i2d_of_void*) (1 ? i2d_RSA_PUBKEY : ((int (*)(RSA *,unsigned char **))0))), bp, ((void*) (1 ? rsa : (RSA*)0))));
}

int
i2d_RSA_PUBKEY_fp(FILE *fp, RSA *rsa)
{
 return ASN1_i2d_fp((int (*)(void *,unsigned char **))i2d_RSA_PUBKEY, fp, rsa);
}
...
d2i_RSA_PUBKEY_fp(FILE *fp, RSA **rsa)
{
 return ASN1_d2i_fp((void *(*)(void))RSA_new,
     (void *(*)(void **,const unsigned char **,long))d2i_RSA_PUBKEY, fp, (void **)rsa);
}
...
{
 return ((DSA*)ASN1_d2i_bio( ((void *(*)(void)) (1 ? DSA_new : ((DSA *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_DSA_PUBKEY : ((DSA *(*)(DSA **,const unsigned char **,long))0))), bp, ((void**) (1 ? dsa : (DSA**)0))));
}

int
i2d_DSA_PUBKEY_bio(BIO *bp, DSA *dsa)
{
 return (ASN1_i2d_bio(((i2d_of_void*) (1 ? i2d_DSA_PUBKEY : ((int (*)(DSA *,unsigned char **))0))), bp, ((void*) (1 ? dsa : (DSA*)0))));
}

DSA *
d2i_DSA_PUBKEY_fp(FILE *fp, DSA **dsa)
{
 return ((DSA*)ASN1_d2i_fp(((void *(*)(void)) (1 ? DSA_new : ((DSA *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_DSA_PUBKEY : ((DSA *(*)(DSA **,const unsigned char **,long))0))), fp, ((void**) (1 ? dsa : (DSA**)0))));
}

int
i2d_DSA_PUBKEY_fp(FILE *fp, DSA *dsa)
{
 return (ASN1_i2d_fp(((i2d_of_void*) (1 ? i2d_DSA_PUBKEY : ((int (*)(DSA *,unsigned char **))0))), fp, ((void*) (1 ? dsa : (DSA*)0))));
}
...
{
 return ((EC_KEY*)ASN1_d2i_bio( ((void *(*)(void)) (1 ? EC_KEY_new : ((EC_KEY *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_ECPrivateKey : ((EC_KEY *(*)(EC_KEY **,const unsigned char **,long))0))), bp, ((void**) (1 ? eckey : (EC_KEY**)0))));
}

int
i2d_ECPrivateKey_bio(BIO *bp, EC_KEY *eckey)
{
 return (ASN1_i2d_bio(((i2d_of_void*) (1 ? i2d_ECPrivateKey : ((int (*)(EC_KEY *,unsigned char **))0))), bp, ((void*) (1 ? eckey : (EC_KEY*)0))));
}

EC_KEY *
d2i_ECPrivateKey_fp(FILE *fp, EC_KEY **eckey)
{
 return ((EC_KEY*)ASN1_d2i_fp(((void *(*)(void)) (1 ? EC_KEY_new : ((EC_KEY *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_ECPrivateKey : ((EC_KEY *(*)(EC_KEY **,const unsigned char **,long))0))), fp, ((void**) (1 ? eckey : (EC_KEY**)0))));
}

int
i2d_ECPrivateKey_fp(FILE *fp, EC_KEY *eckey)
{
 return (ASN1_i2d_fp(((i2d_of_void*) (1 ? i2d_ECPrivateKey : ((int (*)(EC_KEY *,unsigned char **))0))), fp, ((void*) (1 ? eckey : (EC_KEY*)0))));
}

EC_KEY *
d2i_EC_PUBKEY_bio(BIO *bp, EC_KEY **eckey)
{
 return ((EC_KEY*)ASN1_d2i_bio( ((void *(*)(void)) (1 ? EC_KEY_new : ((EC_KEY *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_EC_PUBKEY : ((EC_KEY *(*)(EC_KEY **,const unsigned char **,long))0))), bp, ((void**) (1 ? eckey : (EC_KEY**)0))));
}

int
i2d_EC_PUBKEY_bio(BIO *bp, EC_KEY *ecdsa)
{
 return (ASN1_i2d_bio(((i2d_of_void*) (1 ? i2d_EC_PUBKEY : ((int (*)(EC_KEY *,unsigned char **))0))), bp, ((void*) (1 ? ecdsa : (EC_KEY*)0))));
}
EC_KEY *
d2i_EC_PUBKEY_fp(FILE *fp, EC_KEY **eckey)
{
 return ((EC_KEY*)ASN1_d2i_fp(((void *(*)(void)) (1 ? EC_KEY_new : ((EC_KEY *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_EC_PUBKEY : ((EC_KEY *(*)(EC_KEY **,const unsigned char **,long))0))), fp, ((void**) (1 ? eckey : (EC_KEY**)0))));
}

int
i2d_EC_PUBKEY_fp(FILE *fp, EC_KEY *eckey)
{
 return (ASN1_i2d_fp(((i2d_of_void*) (1 ? i2d_EC_PUBKEY : ((int (*)(EC_KEY *,unsigned char **))0))), fp, ((void*) (1 ? eckey : (EC_KEY*)0))));
}
...
{
 return ((EVP_PKEY*)ASN1_d2i_bio( ((void *(*)(void)) (1 ? EVP_PKEY_new : ((EVP_PKEY *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_AutoPrivateKey : ((EVP_PKEY *(*)(EVP_PKEY **,const unsigned char **,long))0))), bp, ((void**) (1 ? a : (EVP_PKEY**)0))))
           ;
}
...
{
 return (ASN1_i2d_bio(((i2d_of_void*) (1 ? i2d_PrivateKey : ((int (*)(EVP_PKEY *,unsigned char **))0))), bp, ((void*) (1 ? pkey : (EVP_PKEY*)0))));
}

EVP_PKEY *
d2i_PrivateKey_fp(FILE *fp, EVP_PKEY **a)
{
 return ((EVP_PKEY*)ASN1_d2i_fp(((void *(*)(void)) (1 ? EVP_PKEY_new : ((EVP_PKEY *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_AutoPrivateKey : ((EVP_PKEY *(*)(EVP_PKEY **,const unsigned char **,long))0))), fp, ((void**) (1 ? a : (EVP_PKEY**)0))))
           ;
}
...
{
 return (ASN1_i2d_fp(((i2d_of_void*) (1 ? i2d_PrivateKey : ((int (*)(EVP_PKEY *,unsigned char **))0))), fp, ((void*) (1 ? pkey : (EVP_PKEY*)0))));
}

EVP_PKEY *
d2i_PUBKEY_bio(BIO *bp, EVP_PKEY **a)
{
 return ((EVP_PKEY*)ASN1_d2i_bio( ((void *(*)(void)) (1 ? EVP_PKEY_new : ((EVP_PKEY *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_PUBKEY : ((EVP_PKEY *(*)(EVP_PKEY **,const unsigned char **,long))0))), bp, ((void**) (1 ? a : (EVP_PKEY**)0))));
}

int
i2d_PUBKEY_bio(BIO *bp, EVP_PKEY *pkey)
{
 return (ASN1_i2d_bio(((i2d_of_void*) (1 ? i2d_PUBKEY : ((int (*)(EVP_PKEY *,unsigned char **))0))), bp, ((void*) (1 ? pkey : (EVP_PKEY*)0))));
}

int
i2d_PUBKEY_fp(FILE *fp, EVP_PKEY *pkey)
{
 return (ASN1_i2d_fp(((i2d_of_void*) (1 ? i2d_PUBKEY : ((int (*)(EVP_PKEY *,unsigned char **))0))), fp, ((void*) (1 ? pkey : (EVP_PKEY*)0))));
}

EVP_PKEY *
d2i_PUBKEY_fp(FILE *fp, EVP_PKEY **a)
{
 return ((EVP_PKEY*)ASN1_d2i_fp(((void *(*)(void)) (1 ? EVP_PKEY_new : ((EVP_PKEY *(*)(void))0))), ((d2i_of_void*) (1 ? d2i_PUBKEY : ((EVP_PKEY *(*)(EVP_PKEY **,const unsigned char **,long))0))), fp, ((void**) (1 ? a : (EVP_PKEY**)0))));
}
