...
# 98 "asn1/a_bytes.c"
  ...
  if ((ret = ASN1_STRING_new()) == 
# 99 "asn1/a_bytes.c" 3 4
                                  ((void *)0)
# 99 "asn1/a_bytes.c"
                                      )
   return (
# 100 "asn1/a_bytes.c" 3 4
          ((void *)0)
# 100 "asn1/a_bytes.c"
              );
 } else
...
err:
 ERR_put_error(13,(149),(i),"asn1/a_bytes.c",126);
 if (a == 
# 127 "asn1/a_bytes.c" 3 4
         ((void *)0) 
# 127 "asn1/a_bytes.c"
              || *a != ret)
  ASN1_STRING_free(ret);
 return (
# 129 "asn1/a_bytes.c" 3 4
        ((void *)0)
# 129 "asn1/a_bytes.c"
            );
}
...
# 172 "asn1/a_bytes.c"
  ...
  if ((ret = ASN1_STRING_new()) == 
# 173 "asn1/a_bytes.c" 3 4
                                  ((void *)0)
# 173 "asn1/a_bytes.c"
                                      )
   return (
# 174 "asn1/a_bytes.c" 3 4
          ((void *)0)
# 174 "asn1/a_bytes.c"
              );
 } else
 ...
 if (inf & 0x20) {
  ...
  if (len != 0) {
   if ((ret->length < len) || (ret->data == 
# 207 "asn1/a_bytes.c" 3 4
                                           ((void *)0)
# 207 "asn1/a_bytes.c"
                                               )) {
    free(ret->data);
    ret->data = 
# 209 "asn1/a_bytes.c" 3 4
               ((void *)0)
# 209 "asn1/a_bytes.c"
                   ;
    s = malloc(len + 1);
    if (s == 
# 211 "asn1/a_bytes.c" 3 4
            ((void *)0)
# 211 "asn1/a_bytes.c"
                ) {
     i = (1|64);
...
err:
 if (a == 
# 236 "asn1/a_bytes.c" 3 4
         ((void *)0) 
# 236 "asn1/a_bytes.c"
              || *a != ret)
  ASN1_STRING_free(ret);
 ERR_put_error(13,(143),(i),"asn1/a_bytes.c",238);
 return (
# 239 "asn1/a_bytes.c" 3 4
        ((void *)0)
# 239 "asn1/a_bytes.c"
            );
}
...
# 250 "asn1/a_bytes.c"
 ...
 b.max = 0;
 b.data = 
# 256 "asn1/a_bytes.c" 3 4
         ((void *)0)
# 256 "asn1/a_bytes.c"
             ;

 if (a == 
# 258 "asn1/a_bytes.c" 3 4
         ((void *)0)
# 258 "asn1/a_bytes.c"
             ) {
  c->error = (3|64);
...
err:
 ERR_put_error(13,(105),(c->error),"asn1/a_bytes.c",302);
 ASN1_STRING_free(os);
 free(b.data);
 return (0);
}
