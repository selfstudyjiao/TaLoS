...
{
 if (m != 
# 65 "malloc-wrapper.c" 3 4
         ((void *)0)
# 65 "malloc-wrapper.c"
             )
  *m = malloc;
 if (r != 
# 67 "malloc-wrapper.c" 3 4
         ((void *)0)
# 67 "malloc-wrapper.c"
             )
  *r = realloc;
 if (f != 
# 69 "malloc-wrapper.c" 3 4
         ((void *)0)
# 69 "malloc-wrapper.c"
             )
  *f = free;
...
{
 if (m != 
# 77 "malloc-wrapper.c" 3 4
         ((void *)0)
# 77 "malloc-wrapper.c"
             )
  *m = 
# 78 "malloc-wrapper.c" 3 4
      ((void *)0)
# 78 "malloc-wrapper.c"
          ;
 if (r != 
# 79 "malloc-wrapper.c" 3 4
         ((void *)0)
# 79 "malloc-wrapper.c"
             )
  *r = 
# 80 "malloc-wrapper.c" 3 4
      ((void *)0)
# 80 "malloc-wrapper.c"
          ;
 if (f != 
# 81 "malloc-wrapper.c" 3 4
         ((void *)0)
# 81 "malloc-wrapper.c"
             )
  *f = free;
...
{
 if (m != 
# 88 "malloc-wrapper.c" 3 4
         ((void *)0)
# 88 "malloc-wrapper.c"
             )
  *m = malloc;
 if (f != 
# 90 "malloc-wrapper.c" 3 4
         ((void *)0)
# 90 "malloc-wrapper.c"
             )
  *f = free;
...
{
 if (m != 
# 98 "malloc-wrapper.c" 3 4
         ((void *)0)
# 98 "malloc-wrapper.c"
             )
  *m = 
# 99 "malloc-wrapper.c" 3 4
      ((void *)0)
# 99 "malloc-wrapper.c"
          ;
 if (f != 
# 100 "malloc-wrapper.c" 3 4
         ((void *)0)
# 100 "malloc-wrapper.c"
             )
  *f = free;
}
...
{
 if (m != 
# 109 "malloc-wrapper.c" 3 4
         ((void *)0)
# 109 "malloc-wrapper.c"
             )
  *m = 
# 110 "malloc-wrapper.c" 3 4
      ((void *)0)
# 110 "malloc-wrapper.c"
          ;
 if (r != 
# 111 "malloc-wrapper.c" 3 4
         ((void *)0)
# 111 "malloc-wrapper.c"
             )
  *r = 
# 112 "malloc-wrapper.c" 3 4
      ((void *)0)
# 112 "malloc-wrapper.c"
          ;
 if (f != 
# 113 "malloc-wrapper.c" 3 4
         ((void *)0)
# 113 "malloc-wrapper.c"
             )
  *f = 
# 114 "malloc-wrapper.c" 3 4
      ((void *)0)
# 114 "malloc-wrapper.c"
          ;
 if (so != 
# 115 "malloc-wrapper.c" 3 4
          ((void *)0)
# 115 "malloc-wrapper.c"
              )
  *so = 
# 116 "malloc-wrapper.c" 3 4
       ((void *)0)
# 116 "malloc-wrapper.c"
           ;
 if (go != 
# 117 "malloc-wrapper.c" 3 4
          ((void *)0)
# 117 "malloc-wrapper.c"
              )
  *go = 
# 118 "malloc-wrapper.c" 3 4
       ((void *)0)
# 118 "malloc-wrapper.c"
           ;
}
...
CRYPTO_malloc_locked(int num, const char *file, int line)
{
 if (num <= 0)
  return 
# 126 "malloc-wrapper.c" 3 4
        ((void *)0)
# 126 "malloc-wrapper.c"
            ;
 return malloc(num);
}
...
CRYPTO_malloc(int num, const char *file, int line)
{
 if (num <= 0)
  return 
# 140 "malloc-wrapper.c" 3 4
        ((void *)0)
# 140 "malloc-wrapper.c"
            ;
 return malloc(num);
}
...
CRYPTO_realloc(void *ptr, int num, const char *file, int line)
{
 if (num <= 0)
  return 
# 158 "malloc-wrapper.c" 3 4
        ((void *)0)
# 158 "malloc-wrapper.c"
            ;
...
{
 void *ret = 
# 167 "malloc-wrapper.c" 3 4
            ((void *)0)
# 167 "malloc-wrapper.c"
                ;

 if (num <= 0)
  return 
# 170 "malloc-wrapper.c" 3 4
        ((void *)0)
# 170 "malloc-wrapper.c"
            ;
 if (num < old_len)
  return 
# 172 "malloc-wrapper.c" 3 4
        ((void *)0)
# 172 "malloc-wrapper.c"
            ;
 ret = malloc(num);
