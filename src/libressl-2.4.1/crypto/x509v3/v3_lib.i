...
# 65 "x509v3/v3_lib.c" 2

# 1 "x509v3/ext_dat.h" 1
# 59 "x509v3/ext_dat.h"
# 1 "../include/openssl/opensslconf.h" 1
# 1 "../include/openssl/opensslfeatures.h" 1
# 2 "../include/openssl/opensslconf.h" 2
# 60 "x509v3/ext_dat.h" 2
...
# 67 "x509v3/v3_lib.c" 2

static struct stack_st_X509V3_EXT_METHOD *ext_list = 
# 68 "x509v3/v3_lib.c" 3 4
                                              ((void *)0)
# 68 "x509v3/v3_lib.c"
                                                  ;
...
{
 if (!ext_list && !(ext_list = ((struct stack_st_X509V3_EXT_METHOD *)sk_new(((int (*)(const void *, const void *)) ((1 ? (ext_cmp) : (int (*)(const X509V3_EXT_METHOD * const *, const X509V3_EXT_METHOD * const *))0))))))) {
  ERR_put_error(34,(104),((1|64)),"x509v3/v3_lib.c",78);
  return 0;
 }
 if (!sk_push(((_STACK*) (1 ? (ext_list) : (struct stack_st_X509V3_EXT_METHOD*)0)), ((void*) (1 ? (ext) : (X509V3_EXT_METHOD*)0)))) {
  ERR_put_error(34,(104),((1|64)),"x509v3/v3_lib.c",82);
  return 0;
 }
 return 1;
}
...
X509V3_EXT_get_nid(int nid)
{
 ...
 if (nid < 0)
  return 
# 107 "x509v3/v3_lib.c" 3 4
        ((void *)0)
# 107 "x509v3/v3_lib.c"
            ;
 tmp.ext_nid = nid;
 ret = OBJ_bsearch_ext(&t, standard_exts, (sizeof(standard_exts)/sizeof(X509V3_EXT_METHOD *)));
 if (ret)
  return *ret;
 if (!ext_list)
  return 
# 113 "x509v3/v3_lib.c" 3 4
        ((void *)0)
# 113 "x509v3/v3_lib.c"
            ;
 idx = sk_find(((_STACK*) (1 ? (ext_list) : (struct stack_st_X509V3_EXT_METHOD*)0)), ((void*) (1 ? (&tmp) : (X509V3_EXT_METHOD*)0)));
 if (idx == -1)
  return 
# 116 "x509v3/v3_lib.c" 3 4
        ((void *)0)
# 116 "x509v3/v3_lib.c"
            ;
 return ((X509V3_EXT_METHOD *)sk_value(((_STACK*) (1 ? (ext_list) : (struct stack_st_X509V3_EXT_METHOD*)0)), (idx)));
}
...
X509V3_EXT_get(X509_EXTENSION *ext)
{
 ...
 if ((nid = OBJ_obj2nid(ext->object)) == 0)
  return 
# 126 "x509v3/v3_lib.c" 3 4
        ((void *)0)
# 126 "x509v3/v3_lib.c"
            ;
...
X509V3_EXT_add_alias(int nid_to, int nid_from)
{
 ...
 if (!(ext = X509V3_EXT_get_nid(nid_from))) {
  ERR_put_error(34,(106),(102),"x509v3/v3_lib.c",147)
                                   ;
  return 0;
 }
 if (!(tmpext = malloc(sizeof(X509V3_EXT_METHOD)))) {
  ERR_put_error(34,(106),((1|64)),"x509v3/v3_lib.c",151);
  return 0;
 }
 *tmpext = *ext;
 tmpext->ext_nid = nid_to;
 tmpext->ext_flags |= 0x1;
...
{
 sk_pop_free(((_STACK*) (1 ? (ext_list) : (struct stack_st_X509V3_EXT_METHOD*)0)), ((void (*)(void *)) ((1 ? (ext_list_free) : (void (*)(X509V3_EXT_METHOD *))0))));
 ext_list = 
# 164 "x509v3/v3_lib.c" 3 4
           ((void *)0)
# 164 "x509v3/v3_lib.c"
               ;
}
...
# 196 "x509v3/v3_lib.c" 3 4
                      ((void *)0)
# 196 "x509v3/v3_lib.c"
                          , &p, ext->value->length,
      (method->it));
 return method->d2i(
# 198 "x509v3/v3_lib.c" 3 4
                   ((void *)0)
# 198 "x509v3/v3_lib.c"
                       , &p, ext->value->length);
}
# 216 "x509v3/v3_lib.c"
void *
X509V3_get_d2i(struct stack_st_X509_EXTENSION *x, int nid, int *crit, int *idx)
{
 int lastpos, i;
 X509_EXTENSION *ex, *found_ex = 
# 220 "x509v3/v3_lib.c" 3 4
                                ((void *)0)
# 220 "x509v3/v3_lib.c"
                                    ;
...
# 227 "x509v3/v3_lib.c"
 ...
 if (lastpos < 0)
  lastpos = 0;
 for (i = lastpos; i < sk_num(((_STACK*) (1 ? (x) : (struct stack_st_X509_EXTENSION*)0))); i++) {
  ex = ((X509_EXTENSION *)sk_value(((_STACK*) (1 ? (x) : (struct stack_st_X509_EXTENSION*)0)), (i)));
...
int
X509V3_add1_i2d(struct stack_st_X509_EXTENSION **x, int nid, void *value,
    int crit, unsigned long flags)
{
 int extidx = -1;
 int errcode;
 X509_EXTENSION *ext, *extmp;
 unsigned long ext_op = flags & 0xfL;
 ...
 if (extidx >= 0) {
  ...
  if (ext_op == 5L) {
   if (!(X509_EXTENSION *)sk_delete(((_STACK*) (1 ? (*x) : (struct stack_st_X509_EXTENSION*)0)), (extidx)))
    return -1;
   return 1;
  }
 } else {
 ...
 if (!ext) {
  ERR_put_error(34,(140),(144),"x509v3/v3_lib.c",321)
                                        ;
  return 0;
 }
 ...
 if (extidx >= 0) {
  extmp = ((X509_EXTENSION *)sk_value(((_STACK*) (1 ? (*x) : (struct stack_st_X509_EXTENSION*)0)), (extidx)));
  X509_EXTENSION_free(extmp);
  if (!sk_set(((_STACK*) (1 ? (*x) : (struct stack_st_X509_EXTENSION*)0)), (extidx), ((void*) (1 ? (ext) : (X509_EXTENSION*)0))))
   return -1;
  return 1;
 }

 if (!*x && !(*x = ((struct stack_st_X509_EXTENSION *)sk_new_null())))
  return -1;
 if (!sk_push(((_STACK*) (1 ? (*x) : (struct stack_st_X509_EXTENSION*)0)), ((void*) (1 ? (ext) : (X509_EXTENSION*)0))))
  return -1;
...
err:
 if (!(flags & 0x10))
  ERR_put_error(34,(140),(errcode),"x509v3/v3_lib.c",343);
 return 0;
}
