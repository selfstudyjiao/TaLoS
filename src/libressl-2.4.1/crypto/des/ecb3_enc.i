...
void DES_ecb3_encrypt(const_DES_cblock *input, DES_cblock *output,
 ...
 (l0 =((unsigned int)(*((in)++))) , l0|=((unsigned int)(*((in)++)))<< 8L, l0|=((unsigned int)(*((in)++)))<<16L, l0|=((unsigned int)(*((in)++)))<<24L);
 (l1 =((unsigned int)(*((in)++))) , l1|=((unsigned int)(*((in)++)))<< 8L, l1|=((unsigned int)(*((in)++)))<<16L, l1|=((unsigned int)(*((in)++)))<<24L);
 ll[0]=l0;
 ll[1]=l1;
 if (enc)
