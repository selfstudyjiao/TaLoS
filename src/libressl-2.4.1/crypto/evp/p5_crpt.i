    ...
    ASN1_TYPE *param, const EVP_CIPHER *cipher, const EVP_MD *md, int en_de)
{
 ...
 if (param == 
# 91 "evp/p5_crpt.c" 3 4
             ((void *)0) 
# 91 "evp/p5_crpt.c"
                  || param->type != 16 ||
     param->value.sequence == 
# 92 "evp/p5_crpt.c" 3 4
                             ((void *)0)
# 92 "evp/p5_crpt.c"
                                 ) {
  ERR_put_error(6,(117),(114),"evp/p5_crpt.c",93);
  return 0;
 }
 ...
 if (!(pbe = d2i_PBEPARAM(
# 102 "evp/p5_crpt.c" 3 4
                         ((void *)0)
# 102 "evp/p5_crpt.c"
                             , &pbuf, param->value.sequence->length))) {
  ERR_put_error(6,(117),(114),"evp/p5_crpt.c",103);
  return 0;
 }
 ...
 if (!EVP_DigestInit_ex(&ctx, md, 
# 121 "evp/p5_crpt.c" 3 4
                                 ((void *)0)
# 121 "evp/p5_crpt.c"
                                     ))
  goto err;
 ...
 if (!EVP_DigestUpdate(&ctx, salt, saltlen))
  goto err;
 if (!EVP_DigestFinal_ex(&ctx, md_tmp, 
# 127 "evp/p5_crpt.c" 3 4
                                      ((void *)0)
# 127 "evp/p5_crpt.c"
                                          ))
  goto err;
...
# 134 "evp/p5_crpt.c"
 ...
 if ((size_t)EVP_CIPHER_key_length(cipher) > sizeof(md_tmp)) {
  ERR_put_error(6,(117),(137),"evp/p5_crpt.c",138);
  goto err;
 }
 memcpy(key, md_tmp, EVP_CIPHER_key_length(cipher));
 if ((size_t)EVP_CIPHER_iv_length(cipher) > 16) {
  ERR_put_error(6,(117),(102),"evp/p5_crpt.c",143);
  goto err;
 }
 memcpy(iv, md_tmp + (16 - EVP_CIPHER_iv_length(cipher)),
     EVP_CIPHER_iv_length(cipher));
 if (!EVP_CipherInit_ex(cctx, cipher, 
# 148 "evp/p5_crpt.c" 3 4
                                     ((void *)0)
# 148 "evp/p5_crpt.c"
                                         , key, iv, en_de))
  goto err;
 explicit_bzero(md_tmp, 64);
