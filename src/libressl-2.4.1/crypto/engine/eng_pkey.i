    ...
    void *callback_data)
{
 ...
 if (e == 
# 110 "engine/eng_pkey.c" 3 4
         ((void *)0)
# 110 "engine/eng_pkey.c"
             ) {
  ERR_put_error(38,(150),((3|64)),"engine/eng_pkey.c",112)
                                  ;
  return 0;
 }
 CRYPTO_lock(1|8,30,"engine/eng_pkey.c",115);
 if (e->funct_ref == 0) {
  CRYPTO_lock(2|8,30,"engine/eng_pkey.c",117);
  ERR_put_error(38,(150),(117),"engine/eng_pkey.c",119)
                               ;
  return 0;
 }
 CRYPTO_lock(2|8,30,"engine/eng_pkey.c",122);
 if (!e->load_privkey) {
  ERR_put_error(38,(150),(125),"engine/eng_pkey.c",125)
                                ;
  return 0;
 }
 pkey = e->load_privkey(e, key_id, ui_method, callback_data);
 if (!pkey) {
  ERR_put_error(38,(150),(128),"engine/eng_pkey.c",131)
                                          ;
  return 0;
 }
 return pkey;
    ...
    void *callback_data)
{
 ...
 if (e == 
# 143 "engine/eng_pkey.c" 3 4
         ((void *)0)
# 143 "engine/eng_pkey.c"
             ) {
  ERR_put_error(38,(151),((3|64)),"engine/eng_pkey.c",145)
                                  ;
  return 0;
 }
 CRYPTO_lock(1|8,30,"engine/eng_pkey.c",148);
 if (e->funct_ref == 0) {
  CRYPTO_lock(2|8,30,"engine/eng_pkey.c",150);
  ERR_put_error(38,(151),(117),"engine/eng_pkey.c",152)
                               ;
  return 0;
 }
 CRYPTO_lock(2|8,30,"engine/eng_pkey.c",155);
 if (!e->load_pubkey) {
  ERR_put_error(38,(151),(125),"engine/eng_pkey.c",158)
                                ;
  return 0;
 }
 pkey = e->load_pubkey(e, key_id, ui_method, callback_data);
 if (!pkey) {
  ERR_put_error(38,(151),(129),"engine/eng_pkey.c",164)
                                         ;
  return 0;
 }
 return pkey;
...
int
ENGINE_load_ssl_client_cert(ENGINE *e, SSL *s, struct stack_st_X509_NAME *ca_dn,
    X509 **pcert, EVP_PKEY **ppkey, struct stack_st_X509 **pother,
    UI_METHOD *ui_method, void *callback_data)
{
 if (e == 
# 175 "engine/eng_pkey.c" 3 4
         ((void *)0)
# 175 "engine/eng_pkey.c"
             ) {
  ERR_put_error(38,(194),((3|64)),"engine/eng_pkey.c",177)
                                  ;
  return 0;
 }
 CRYPTO_lock(1|8,30,"engine/eng_pkey.c",180);
 if (e->funct_ref == 0) {
  CRYPTO_lock(2|8,30,"engine/eng_pkey.c",182);
  ERR_put_error(38,(194),(117),"engine/eng_pkey.c",184)
                               ;
  return 0;
 }
 CRYPTO_lock(2|8,30,"engine/eng_pkey.c",187);
 if (!e->load_ssl_client_cert) {
  ERR_put_error(38,(194),(125),"engine/eng_pkey.c",190)
                                ;
  return 0;
 }
