...
ENGINE_new(void)
{
 ...
 if (ret == 
# 80 "engine/eng_lib.c" 3 4
           ((void *)0)
# 80 "engine/eng_lib.c"
               ) {
  ERR_put_error(38,(122),((1|64)),"engine/eng_lib.c",81);
  return 
# 82 "engine/eng_lib.c" 3 4
        ((void *)0)
# 82 "engine/eng_lib.c"
            ;
 }
...
{
 e->id = 
# 97 "engine/eng_lib.c" 3 4
        ((void *)0)
# 97 "engine/eng_lib.c"
            ;
 e->name = 
# 98 "engine/eng_lib.c" 3 4
          ((void *)0)
# 98 "engine/eng_lib.c"
              ;
 e->rsa_meth = 
# 99 "engine/eng_lib.c" 3 4
              ((void *)0)
# 99 "engine/eng_lib.c"
                  ;
 e->dsa_meth = 
# 100 "engine/eng_lib.c" 3 4
              ((void *)0)
# 100 "engine/eng_lib.c"
                  ;
 e->dh_meth = 
# 101 "engine/eng_lib.c" 3 4
             ((void *)0)
# 101 "engine/eng_lib.c"
                 ;
 e->rand_meth = 
# 102 "engine/eng_lib.c" 3 4
               ((void *)0)
# 102 "engine/eng_lib.c"
                   ;
 e->store_meth = 
# 103 "engine/eng_lib.c" 3 4
                ((void *)0)
# 103 "engine/eng_lib.c"
                    ;
 e->ciphers = 
# 104 "engine/eng_lib.c" 3 4
             ((void *)0)
# 104 "engine/eng_lib.c"
                 ;
 e->digests = 
# 105 "engine/eng_lib.c" 3 4
             ((void *)0)
# 105 "engine/eng_lib.c"
                 ;
 e->destroy = 
# 106 "engine/eng_lib.c" 3 4
             ((void *)0)
# 106 "engine/eng_lib.c"
                 ;
 e->init = 
# 107 "engine/eng_lib.c" 3 4
          ((void *)0)
# 107 "engine/eng_lib.c"
              ;
 e->finish = 
# 108 "engine/eng_lib.c" 3 4
            ((void *)0)
# 108 "engine/eng_lib.c"
                ;
 e->ctrl = 
# 109 "engine/eng_lib.c" 3 4
          ((void *)0)
# 109 "engine/eng_lib.c"
              ;
 e->load_privkey = 
# 110 "engine/eng_lib.c" 3 4
                  ((void *)0)
# 110 "engine/eng_lib.c"
                      ;
 e->load_pubkey = 
# 111 "engine/eng_lib.c" 3 4
                 ((void *)0)
# 111 "engine/eng_lib.c"
                     ;
 e->cmd_defns = 
# 112 "engine/eng_lib.c" 3 4
               ((void *)0)
# 112 "engine/eng_lib.c"
                   ;
 e->flags = 0;
}
...
engine_free_util(ENGINE *e, int locked)
{
 ...
 if (e == 
# 121 "engine/eng_lib.c" 3 4
         ((void *)0)
# 121 "engine/eng_lib.c"
             ) {
  ERR_put_error(38,(108),((3|64)),"engine/eng_lib.c",123)
                                  ;
  return 0;
 }
 if (locked)
  i = CRYPTO_add_lock(&e->struct_ref,-1,30,"engine/eng_lib.c",127);
 else
  i = --e->struct_ref;
...
static struct stack_st_ENGINE_CLEANUP_ITEM *cleanup_stack = 
# 158 "engine/eng_lib.c" 3 4
                                                     ((void *)0)
# 158 "engine/eng_lib.c"
                                                         ;
static int
...
int_cleanup_item(ENGINE_CLEANUP_CB *cb)
{
 ...
 if (!item)
  return 
# 176 "engine/eng_lib.c" 3 4
        ((void *)0)
# 176 "engine/eng_lib.c"
            ;
 item->cb = cb;
 return item;
}
...
ENGINE_cleanup(void)
{
 if (int_cleanup_check(0)) {
  sk_pop_free(((_STACK*) (1 ? (cleanup_stack) : (struct stack_st_ENGINE_CLEANUP_ITEM*)0)), ((void (*)(void *)) ((1 ? (engine_cleanup_cb_free) : (void (*)(ENGINE_CLEANUP_ITEM *))0))))
                             ;
  cleanup_stack = 
# 218 "engine/eng_lib.c" 3 4
                 ((void *)0)
# 218 "engine/eng_lib.c"
                     ;
 }


 RAND_set_rand_method(
# 222 "engine/eng_lib.c" 3 4
                     ((void *)0)
# 222 "engine/eng_lib.c"
                         );
}
...
ENGINE_get_ex_new_index(long argl, void *argp, CRYPTO_EX_new *new_func,
    CRYPTO_EX_dup *dup_func, CRYPTO_EX_free *free_func)
{
 return CRYPTO_get_ex_new_index(9, argl, argp,
...
{
 if (id == 
# 253 "engine/eng_lib.c" 3 4
          ((void *)0)
# 253 "engine/eng_lib.c"
              ) {
  ERR_put_error(38,(129),((3|64)),"engine/eng_lib.c",255)
                                  ;
  return 0;
 }
 e->id = id;
...
{
 if (name == 
# 265 "engine/eng_lib.c" 3 4
            ((void *)0)
# 265 "engine/eng_lib.c"
                ) {
  ERR_put_error(38,(130),((3|64)),"engine/eng_lib.c",267)
                                  ;
  return 0;
 }
 e->name = name;
...
# 317 "engine/eng_lib.c" 3 4
                          ((void *)0)
# 317 "engine/eng_lib.c"
                              ;
static char* engine_id = 
# 318 "engine/eng_lib.c" 3 4
                        ((void *)0)
# 318 "engine/eng_lib.c"
                            ;
