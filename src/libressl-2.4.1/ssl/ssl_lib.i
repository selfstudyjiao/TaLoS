...
# 38 "/home/jiao/sgxsdk/include/sgx_trts.h" 2
...
# 1 "./lthread.h" 1
# 34 "./lthread.h"
# 1 "../include/compat/sys/socket.h" 1
...
# 1 "../include/compat/sys/uio.h" 1 3 4
...
# 8 "../include/compat/sys/uio.h" 2 3 4
...
# 8 "../include/compat/sys/socket.h" 2
# 35 "./lthread.h" 2
...
# 36 "./lthread.h" 2
# 1 "../include/compat/netinet/in.h" 1
...
# 1 "../include/compat/sys/socket.h" 1 3 4
...
# 8 "../include/compat/netinet/in.h" 2
# 37 "./lthread.h" 2

# 1 "../include/compat/poll.h" 1
# 18 "../include/compat/poll.h"
...
const char *SSL_version_str = "LibreSSL 2.4.1";
...
# 212 "../ssl/ssl_lib.c" 3 4
                         ((void *)0)
# 212 "../ssl/ssl_lib.c"
                             ,
 .client_finished_label_len = 0,
 .server_finished_label = 
# 214 "../ssl/ssl_lib.c" 3 4
                         ((void *)0)
# 214 "../ssl/ssl_lib.c"
                             ,
...
{
 if (s->method == 
# 226 "../ssl/ssl_lib.c" 3 4
                 ((void *)0)
# 226 "../ssl/ssl_lib.c"
                     ) {
  ERR_put_error(20,(164),(188),"../ssl/ssl_lib.c",227);
  return (0);
 }
...
# 233 "../ssl/ssl_lib.c"
 ...
 if (s->renegotiate) {
  ERR_put_error(20,(164),((4|64)),"../ssl/ssl_lib.c",241);
  return (0);
 }

 s->type = 0;

 s->state = 0x4000|((s->server) ? 0x2000 : 0x1000);
...
# 255 "../ssl/ssl_lib.c"
 ...
 if (!s->in_handshake && (s->session == 
# 267 "../ssl/ssl_lib.c" 3 4
                                       ((void *)0)
# 267 "../ssl/ssl_lib.c"
                                           ) &&
...
SSL_CTX_set_ssl_version(SSL_CTX *ctx, const SSL_METHOD *meth)
{
 ...
 sk = ssl_create_cipher_list(ctx->method, &(ctx->cipher_list),
     &(ctx->cipher_list_by_id), "ALL:!aNULL:!eNULL:!SSLv2");
 if ((sk == 
# 289 "../ssl/ssl_lib.c" 3 4
           ((void *)0)
# 289 "../ssl/ssl_lib.c"
               ) || (sk_num(((_STACK*) (1 ? (sk) : (struct stack_st_SSL_CIPHER*)0))) <= 0)) {
  ERR_put_error(20,(170),(230),"../ssl/ssl_lib.c",291)
                                       ;
  return (0);
 }
 return (1);
...
static hashmap* ssl_hardening_map = 
# 300 "../ssl/ssl_lib.c" 3 4
                                   ((void *)0)
# 300 "../ssl/ssl_lib.c"
                                       ;
sgx_spinlock_t ssl_hardening_map_lock = 0;

static hashmap* get_ssl_hardening() {
 int expected = 0;
 int desired = 1;
 if (__atomic_compare_exchange_n(&ssl_hardening_initialized, &expected, desired, 0, 0, 0)) {
...
void SSL_copy_fields_to_out_struct(const SSL* in, SSL* out) {
 ...
 out->session = (SSL_SESSION*)(in->session ? in->session->peer : 
# 335 "../ssl/ssl_lib.c" 3 4
                                                                ((void *)0)
# 335 "../ssl/ssl_lib.c"
                                                                    );
...
ecall_SSL_new(SSL_CTX *ctx, SSL* out_s) {
 ...
 hashmap* m = get_ssl_hardening();
 hashmapInsert(m, (const void*)out_s, (unsigned long)s);
 hashmapInsert(m, (const void*)s, (unsigned long)out_s);
...
SSL_new(SSL_CTX *ctx)
{
 ...
 if (ctx == 
# 427 "../ssl/ssl_lib.c" 3 4
           ((void *)0)
# 427 "../ssl/ssl_lib.c"
               ) {
  ERR_put_error(20,(186),(195),"../ssl/ssl_lib.c",428);
  return (
# 429 "../ssl/ssl_lib.c" 3 4
         ((void *)0)
# 429 "../ssl/ssl_lib.c"
             );
 }
 if (ctx->method == 
# 431 "../ssl/ssl_lib.c" 3 4
                   ((void *)0)
# 431 "../ssl/ssl_lib.c"
                       ) {
  ERR_put_error(20,(186),(228),"../ssl/ssl_lib.c",432);
  return (
# 433 "../ssl/ssl_lib.c" 3 4
         ((void *)0)
# 433 "../ssl/ssl_lib.c"
             );
 }
...
# 461 "../ssl/ssl_lib.c"
 ...
 (void)((s->sid_ctx_length <= sizeof s->sid_ctx) ? 0 : (OpenSSLDie("../ssl/ssl_lib.c", 468, "s->sid_ctx_length <= sizeof s->sid_ctx"),1));
 ...
 CRYPTO_add_lock(&ctx->references,1,12,"../ssl/ssl_lib.c",480);
 s->ctx = ctx;
 s->tlsext_debug_cb = 0;
 s->tlsext_debug_arg = 
# 483 "../ssl/ssl_lib.c" 3 4
                      ((void *)0)
# 483 "../ssl/ssl_lib.c"
                          ;
 ...
 s->tlsext_ocsp_ids = 
# 487 "../ssl/ssl_lib.c" 3 4
                     ((void *)0)
# 487 "../ssl/ssl_lib.c"
                         ;
 s->tlsext_ocsp_exts = 
# 488 "../ssl/ssl_lib.c" 3 4
                      ((void *)0)
# 488 "../ssl/ssl_lib.c"
                          ;
 s->tlsext_ocsp_resp = 
# 489 "../ssl/ssl_lib.c" 3 4
                      ((void *)0)
# 489 "../ssl/ssl_lib.c"
                          ;
 s->tlsext_ocsp_resplen = -1;
 CRYPTO_add_lock(&ctx->references,1,12,"../ssl/ssl_lib.c",491);
 s->initial_ctx = ctx;
 s->next_proto_negotiated = 
# 493 "../ssl/ssl_lib.c" 3 4
                           ((void *)0)
# 493 "../ssl/ssl_lib.c"
                               ;

 if (s->ctx->alpn_client_proto_list != 
# 495 "../ssl/ssl_lib.c" 3 4
                                      ((void *)0)
# 495 "../ssl/ssl_lib.c"
                                          ) {
...
# 498 "../ssl/ssl_lib.c"
 ...
 CRYPTO_new_ex_data(1, s, &s->ex_data);
...
err:
 SSL_free(s);
 ERR_put_error(20,(186),((1|64)),"../ssl/ssl_lib.c",527);
 return (
# 528 "../ssl/ssl_lib.c" 3 4
        ((void *)0)
# 528 "../ssl/ssl_lib.c"
            );
}
    ...
    unsigned int sid_ctx_len)
{
 if (sid_ctx_len > sizeof ctx->sid_ctx) {
  ERR_put_error(20,(219),(273),"../ssl/ssl_lib.c",542)
                                            ;
  return (0);
 }
...
{
 if (sid_ctx_len > 32) {
  ERR_put_error(20,(218),(273),"../ssl/ssl_lib.c",575)
                                            ;
  return (0);
 }
...
{
 CRYPTO_lock(1|8,12,"../ssl/ssl_lib.c",587);
 ctx->generate_session_id = cb;
 CRYPTO_lock(2|8,12,"../ssl/ssl_lib.c",589);
 return (1);
}
...
{
 CRYPTO_lock(1|8,16,"../ssl/ssl_lib.c",596);
 ssl->generate_session_id = cb;
 CRYPTO_lock(2|8,16,"../ssl/ssl_lib.c",598);
 return (1);
}
    ...
    unsigned int id_len)
{
 ...
 CRYPTO_lock(1|4,12,"../ssl/ssl_lib.c",622);
 p = ((SSL_SESSION *)lh_retrieve(((_LHASH *)((void*) (1 ? ssl->ctx->sessions : (struct lhash_st_SSL_SESSION*)0))), ((void*) (1 ? &r : (SSL_SESSION*)0))));
 CRYPTO_lock(2|4,12,"../ssl/ssl_lib.c",624);
 return (p != 
# 625 "../ssl/ssl_lib.c" 3 4
             ((void *)0)
# 625 "../ssl/ssl_lib.c"
                 );
}
...
# 688 "../ssl/ssl_lib.c"
 ...
 i = CRYPTO_add_lock(&s->references,-1,16,"../ssl/ssl_lib.c",692);
 if (i > 0) {
  return;
 }
 ...
 CRYPTO_free_ex_data(1, s, &s->ex_data);

 if (s->bbio != 
# 702 "../ssl/ssl_lib.c" 3 4
               ((void *)0)
# 702 "../ssl/ssl_lib.c"
                   ) {
...
# 734 "../ssl/ssl_lib.c"
 ...
 if (s->tlsext_ocsp_ids)
  sk_pop_free(((_STACK*) (1 ? (s->tlsext_ocsp_ids) : (struct stack_st_OCSP_RESPID*)0)), ((void (*)(void *)) ((1 ? (OCSP_RESPID_free) : (void (*)(OCSP_RESPID *))0))));
 free(s->tlsext_ocsp_resp);

 if (s->client_CA != 
# 749 "../ssl/ssl_lib.c" 3 4
                    ((void *)0)
# 749 "../ssl/ssl_lib.c"
                        )
  sk_pop_free(((_STACK*) (1 ? (s->client_CA) : (struct stack_st_X509_NAME*)0)), ((void (*)(void *)) ((1 ? (X509_NAME_free) : (void (*)(X509_NAME *))0))));

 if (s->method != 
# 752 "../ssl/ssl_lib.c" 3 4
                 ((void *)0)
# 752 "../ssl/ssl_lib.c"
                     )
  s->method->ssl_free(s);
 ...
 if (s->srtp_profiles)
  sk_free(((_STACK*) (1 ? (s->srtp_profiles) : (struct stack_st_SRTP_PROTECTION_PROFILE*)0)));
...
SSL_get_rfd(const SSL *s)
{
 ...
 b = SSL_get_rbio(s);
 r = BIO_find_type(b, 0x0100);
 if (r != 
# 866 "../ssl/ssl_lib.c" 3 4
         ((void *)0)
# 866 "../ssl/ssl_lib.c"
             )
  BIO_ctrl(r,105,0,(char *)&ret);
 return (ret);
}
...
# 905 "../ssl/ssl_lib.c"
 ...
 if (bio == 
# 909 "../ssl/ssl_lib.c" 3 4
           ((void *)0)
# 909 "../ssl/ssl_lib.c"
               ) {
  ERR_put_error(20,(192),(7),"../ssl/ssl_lib.c",910);
  goto err;
 }
 BIO_int_ctrl(bio,104,0x00,fd);
...
SSL_set_wfd(SSL *s, int fd)
{
 int ret = 0;
 BIO *bio = 
# 924 "../ssl/ssl_lib.c" 3 4
           ((void *)0)
# 924 "../ssl/ssl_lib.c"
               ;

 if ((s->rbio == 
# 926 "../ssl/ssl_lib.c" 3 4
                ((void *)0)
# 926 "../ssl/ssl_lib.c"
                    ) || (BIO_method_type(s->rbio) != (5|0x0400|0x0100))
     || ((int)BIO_ctrl(s->rbio,105,0,(char *)
# 927 "../ssl/ssl_lib.c" 3 4
             ((void *)0)
# 927 "../ssl/ssl_lib.c"
             ) != fd)) {
  bio = BIO_new(BIO_s_socket());
  ...
  if (bio == 
# 930 "../ssl/ssl_lib.c" 3 4
            ((void *)0)
# 930 "../ssl/ssl_lib.c"
                ) {
   ERR_put_error(20,(196),(7),"../ssl/ssl_lib.c",931);
   goto err;
  }
  BIO_int_ctrl(bio,104,0x00,fd);
...
SSL_set_rfd(SSL *s, int fd)
{
 int ret = 0;
 BIO *bio = 
# 947 "../ssl/ssl_lib.c" 3 4
           ((void *)0)
# 947 "../ssl/ssl_lib.c"
               ;

 if ((s->wbio == 
# 949 "../ssl/ssl_lib.c" 3 4
                ((void *)0)
# 949 "../ssl/ssl_lib.c"
                    ) || (BIO_method_type(s->wbio) != (5|0x0400|0x0100))
     || ((int)BIO_ctrl(s->wbio,105,0,(char *)
# 950 "../ssl/ssl_lib.c" 3 4
             ((void *)0)
# 950 "../ssl/ssl_lib.c"
             ) != fd)) {
  bio = BIO_new(BIO_s_socket());
  ...
  if (bio == 
# 953 "../ssl/ssl_lib.c" 3 4
            ((void *)0)
# 953 "../ssl/ssl_lib.c"
                ) {
   ERR_put_error(20,(194),(7),"../ssl/ssl_lib.c",954);
   goto err;
  }
  BIO_int_ctrl(bio,104,0x00,fd);
...
int (*ssl_set_verify_cb_address)(int, X509_STORE_CTX*) = 
# 1060 "../ssl/ssl_lib.c" 3 4
                                                        ((void *)0)
# 1060 "../ssl/ssl_lib.c"
                                                            ;
int ssl_set_verify_fake_cb(int ok, X509_STORE_CTX *ctx) {
 my_fprintf(0, "%s:%s:%i need to implement callback\n", "../ssl/ssl_lib.c", __func__, 1062);
...
# 1180 "../ssl/ssl_lib.c"
 ...
 if (r == 
# 1184 "../ssl/ssl_lib.c" 3 4
         ((void *)0)
# 1184 "../ssl/ssl_lib.c"
             )
  return (r);

 CRYPTO_add_lock(&r->references,1,3,"../ssl/ssl_lib.c",1187);
...
{
 struct stack_st_X509 *r;

 if ((s == 
# 1197 "../ssl/ssl_lib.c" 3 4
          ((void *)0)
# 1197 "../ssl/ssl_lib.c"
              ) || (s->session == 
# 1197 "../ssl/ssl_lib.c" 3 4
...
# 1197 "../ssl/ssl_lib.c"
     ...
     (s->session->sess_cert == 
# 1198 "../ssl/ssl_lib.c" 3 4
                              ((void *)0)
# 1198 "../ssl/ssl_lib.c"
                                  ))
  r = 
# 1199 "../ssl/ssl_lib.c" 3 4
     ((void *)0)
# 1199 "../ssl/ssl_lib.c"
         ;
 else
...
SSL_copy_session_id(SSL *t, const SSL *f)
{
 ...
 tmp = t->cert;
 if (f->cert != 
# 1234 "../ssl/ssl_lib.c" 3 4
               ((void *)0)
# 1234 "../ssl/ssl_lib.c"
                   ) {
  CRYPTO_add_lock(&f->cert->references,1,13,"../ssl/ssl_lib.c",1235);
  t->cert = f->cert;
 } else
  t->cert = 
# 1238 "../ssl/ssl_lib.c" 3 4
           ((void *)0)
# 1238 "../ssl/ssl_lib.c"
               ;
 if (tmp != 
# 1239 "../ssl/ssl_lib.c" 3 4
           ((void *)0)
# 1239 "../ssl/ssl_lib.c"
               )
  ssl_cert_free(tmp);
...
# 1252 "../ssl/ssl_lib.c"
     ...
     (ctx->cert->key->x509 == 
# 1253 "../ssl/ssl_lib.c" 3 4
                             ((void *)0)
# 1253 "../ssl/ssl_lib.c"
                                 )) {
  ERR_put_error(20,(168),(177),"../ssl/ssl_lib.c",1255)
                                    ;
  return (0);
 }
 if (ctx->cert->key->privatekey == 
# 1258 "../ssl/ssl_lib.c" 3 4
                                  ((void *)0)
# 1258 "../ssl/ssl_lib.c"
                                      ) {
  ERR_put_error(20,(168),(190),"../ssl/ssl_lib.c",1260)
                                    ;
  return (0);
 }
...
{
 if (ssl == 
# 1271 "../ssl/ssl_lib.c" 3 4
           ((void *)0)
# 1271 "../ssl/ssl_lib.c"
               ) {
  ERR_put_error(20,(163),((3|64)),"../ssl/ssl_lib.c",1273)
                                  ;
  return (0);
 }
 if (ssl->cert == 
# 1276 "../ssl/ssl_lib.c" 3 4
                 ((void *)0)
# 1276 "../ssl/ssl_lib.c"
                     ) {
  ERR_put_error(20,(163),(177),"../ssl/ssl_lib.c",1278)
                                    ;
  return (0);
 }
 if (ssl->cert->key->x509 == 
# 1281 "../ssl/ssl_lib.c" 3 4
                            ((void *)0)
# 1281 "../ssl/ssl_lib.c"
                                ) {
  ERR_put_error(20,(163),(177),"../ssl/ssl_lib.c",1283)
                                    ;
  return (0);
 }
 if (ssl->cert->key->privatekey == 
# 1286 "../ssl/ssl_lib.c" 3 4
                                  ((void *)0)
# 1286 "../ssl/ssl_lib.c"
                                      ) {
  ERR_put_error(20,(163),(190),"../ssl/ssl_lib.c",1288)
                                    ;
  return (0);
 }
...
void ecall_start_sgx_thread(void* eq, void* oq, int tid, int appthreads, int sgxthreads, int lthread_tasks, int ncycles, uint64_t* rdtsc_value) {
 ...
 for (i=0; i<lthread_tasks; i++) {
  ...
  lthread_t *lt = 
# 1397 "../ssl/ssl_lib.c" 3 4
                 ((void *)0)
# 1397 "../ssl/ssl_lib.c"
                     ;
  lthread_create(&lt, lthread_main_handler, 
# 1398 "../ssl/ssl_lib.c" 3 4
                                           ((void *)0)
# 1398 "../ssl/ssl_lib.c"
                                               , sched_ready_q);
 }
...
{
 if (s->handshake_func == 
# 1485 "../ssl/ssl_lib.c" 3 4
                         ((void *)0)
# 1485 "../ssl/ssl_lib.c"
                             ) {
  ERR_put_error(20,(223),(276),"../ssl/ssl_lib.c",1486);
  return (-1);
 }
...
{
 if (s->handshake_func == 
# 1500 "../ssl/ssl_lib.c" 3 4
                         ((void *)0)
# 1500 "../ssl/ssl_lib.c"
                             ) {
  ERR_put_error(20,(270),(276),"../ssl/ssl_lib.c",1501);
  return (-1);
 }
...
SSL_CTX_ctrl(SSL_CTX *ctx, int cmd, long larg, void *parg)
{
 ...
 case 20:
  return (lh_num_items(((_LHASH *)((void*) (1 ? ctx->sessions : (struct lhash_st_SSL_SESSION*)0)))));
 case 21:
...
ecall_SSL_get_ciphers(const SSL *s)
{
 ...
 SSL_copy_fields_to_in_struct(in_s, out_s);
 struct stack_st_SSL_CIPHER *ret = SSL_get_ciphers(in_s);
 return ret;
...
int
ssl_cipher_list_to_bytes(SSL *s, struct stack_st_SSL_CIPHER *sk, unsigned char *p)
{
 int i;
 SSL_CIPHER *c;
 unsigned char *q;
...
# 2066 "../ssl/ssl_lib.c"
 ...
 for (i = 0; i < sk_num(((_STACK*) (1 ? (sk) : (struct stack_st_SSL_CIPHER*)0))); i++) {
  ...
  if ((c->algorithm_ssl & 0x00000004L) &&
      (((s->client_version >> 8) == 0x03 ? s->client_version : 0) < 0x0303))
   continue;

  ((p[0]=(unsigned char)(((ssl3_cipher_get_value(c))>> 8)&0xff), p[1]=(unsigned char)(((ssl3_cipher_get_value(c)) )&0xff)),p+=2);
 }
 ...
 if (p != q && !s->renegotiate)
  ((p[0]=(unsigned char)(((0x030000FF & 0x0000ffff)>> 8)&0xff), p[1]=(unsigned char)(((0x030000FF & 0x0000ffff) )&0xff)),p+=2);
...
static
unsigned long ssl_session_LHASH_HASH(const void *arg) { const SSL_SESSION *a = arg; return ssl_session_hash(a); }
static
int ssl_session_LHASH_COMP(const void *arg1, const void *arg2) { const SSL_SESSION *a = arg1; const SSL_SESSION *b = arg2; return ssl_session_cmp(a,b); }
...
# 2741 "../ssl/ssl_lib.c"
 ...
 if (a->srtp_profiles)
  sk_free(((_STACK*) (1 ? (a->srtp_profiles) : (struct stack_st_SRTP_PROTECTION_PROFILE*)0)));
...
# 2894 "../ssl/ssl_lib.c"
 ...
 if (have_ecc_cert) {
  ...
  ecdh_ok = (x->ex_flags & 0x2) ?
  (x->ex_kusage & 0x0008) : 1;
  ecdsa_ok = (x->ex_flags & 0x2) ?
  (x->ex_kusage & 0x0080) : 1;
...
ssl_check_srvr_ecc_cert_and_alg(X509 *x, SSL *s)
{
 ...
 if (alg_k & 0x00000040L || alg_k & 0x00000020L) {
  ...
  if ((alg_k & 0x00000040L) && ((s->version >> 8) == 0x03 ? s->version : 0) <
      0x0303) {
  ...
  if ((alg_k & 0x00000020L) && ((s->version >> 8) == 0x03 ? s->version : 0) <
      0x0303) {
...
ssl_get_auto_dh(SSL *s)
{
 ...
 if (s->cert->dh_tmp_auto == 2) {
  keylen = 1024;
 } else if (s->s3->tmp.new_cipher->algorithm_auth & 0x00000004L) {
  keylen = 1024;
...
static int ocall_new_session_callback_wrapper(struct ssl_st *ssl) {
 ...
 sgx_status_t ret;
 ret = ocall_new_session_callback(&retval, ssl, (void*)ssl_session_outside, (void*)ssl->initial_ctx->new_session_cb);
 if (ret != SGX_SUCCESS) {
...
SSL_get_error(const SSL *s, int i)
{
 ...
 if ((l = ERR_peek_error()) != 0) {
  if ((int)((((unsigned long)l)>>24L)&0xffL) == 2)
   return (5);
  else
   return (1);
 }
...
# 3291 "../ssl/ssl_lib.c"
 ...
 if ((i < 0) && (SSL_want(s) == 2)) {
  bio = SSL_get_wbio(s);
  if (BIO_test_flags(bio, 0x02)) {
   return (3);
  } else if (BIO_test_flags(bio, 0x01)) {
...
ssl_max_server_version(SSL *s)
{
 ...
 if ((s->options & 0x08000000L) == 0 &&
     max_version >= 0x0303)
  return (0x0303);
 if ((s->options & 0x10000000L) == 0 &&
     max_version >= 0x0302)
  return (0x0302);
 if ((s->options & 0x04000000L) == 0 &&
     max_version >= 0x0301)
  return (0x0301);
...
SSL_get_ex_new_index(long argl, void *argp, CRYPTO_EX_new *new_func,
    CRYPTO_EX_dup *dup_func, CRYPTO_EX_free *free_func)
{
 return (CRYPTO_get_ex_new_index(1, argl, argp,
...
SSL_CTX_get_ex_new_index(long argl, void *argp, CRYPTO_EX_new *new_func,
    CRYPTO_EX_dup *dup_func, CRYPTO_EX_free *free_func)
{
 return (CRYPTO_get_ex_new_index(2, argl, argp,
     new_func, dup_func, free_func));
}
...
SSL_CTX_set_tmp_dh_callback(SSL_CTX *ctx, DH *(*dh)(SSL *ssl, int is_export,
    int keylength))
{
 SSL_CTX_callback_ctrl(ctx, 6,(void (*)(void))dh);
}
...
SSL_set_tmp_dh_callback(SSL *ssl, DH *(*dh)(SSL *ssl, int is_export,
    int keylength))
{
 SSL_callback_ctrl(ssl, 6,(void (*)(void))dh);
}
...
SSL_set_tmp_ecdh_callback(SSL *ssl, EC_KEY *(*ecdh)(SSL *ssl, int is_export,
    int keylength))
{
 SSL_callback_ctrl(ssl, 7,(void (*)(void))ecdh);
}
...
SSL_set_msg_callback(SSL *ssl, void (*cb)(int write_p, int version,
    int content_type, const void *buf, size_t len, SSL *ssl, void *arg))
{
 SSL_callback_ctrl(ssl, 15, (void (*)(void))cb);
}
