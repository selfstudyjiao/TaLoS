...
RSA_new(void)
{
 RSA *r = RSA_new_method(
# 78 "rsa/rsa_lib.c" 3 4
                        ((void *)0)
# 78 "rsa/rsa_lib.c"
                            );
...
RSA_new_method(ENGINE *engine)
{
 ...
 if (ret == 
# 134 "rsa/rsa_lib.c" 3 4
           ((void *)0)
# 134 "rsa/rsa_lib.c"
               ) {
  ERR_put_error(4,(106),((1|64)),"rsa/rsa_lib.c",135);
  return 
# 136 "rsa/rsa_lib.c" 3 4
        ((void *)0)
# 136 "rsa/rsa_lib.c"
            ;
 }
 ...
 if (engine) {
  if (!ENGINE_init(engine)) {
   ERR_put_error(4,(106),(38),"rsa/rsa_lib.c",143);
   free(ret);
   return 
# 145 "rsa/rsa_lib.c" 3 4
         ((void *)0)
# 145 "rsa/rsa_lib.c"
             ;
  }
 ...
 if (ret->engine) {
  ...
  if (!ret->meth) {
   ERR_put_error(4,(106),(38),"rsa/rsa_lib.c",153);
   ENGINE_finish(ret->engine);
   free(ret);
   return 
# 156 "rsa/rsa_lib.c" 3 4
         ((void *)0)
# 156 "rsa/rsa_lib.c"
             ;
  }
 ...
 ret->version = 0;
 ret->n = 
# 163 "rsa/rsa_lib.c" 3 4
         ((void *)0)
# 163 "rsa/rsa_lib.c"
             ;
 ret->e = 
# 164 "rsa/rsa_lib.c" 3 4
         ((void *)0)
# 164 "rsa/rsa_lib.c"
             ;
 ret->d = 
# 165 "rsa/rsa_lib.c" 3 4
         ((void *)0)
# 165 "rsa/rsa_lib.c"
             ;
 ret->p = 
# 166 "rsa/rsa_lib.c" 3 4
         ((void *)0)
# 166 "rsa/rsa_lib.c"
             ;
 ret->q = 
# 167 "rsa/rsa_lib.c" 3 4
         ((void *)0)
# 167 "rsa/rsa_lib.c"
             ;
 ret->dmp1 = 
# 168 "rsa/rsa_lib.c" 3 4
            ((void *)0)
# 168 "rsa/rsa_lib.c"
                ;
 ret->dmq1 = 
# 169 "rsa/rsa_lib.c" 3 4
            ((void *)0)
# 169 "rsa/rsa_lib.c"
                ;
 ret->iqmp = 
# 170 "rsa/rsa_lib.c" 3 4
            ((void *)0)
# 170 "rsa/rsa_lib.c"
                ;
 ret->references = 1;
 ret->_method_mod_n = 
# 172 "rsa/rsa_lib.c" 3 4
                     ((void *)0)
# 172 "rsa/rsa_lib.c"
                         ;
 ret->_method_mod_p = 
# 173 "rsa/rsa_lib.c" 3 4
                     ((void *)0)
# 173 "rsa/rsa_lib.c"
                         ;
 ret->_method_mod_q = 
# 174 "rsa/rsa_lib.c" 3 4
                     ((void *)0)
# 174 "rsa/rsa_lib.c"
                         ;
 ret->blinding = 
# 175 "rsa/rsa_lib.c" 3 4
                ((void *)0)
# 175 "rsa/rsa_lib.c"
                    ;
 ret->mt_blinding = 
# 176 "rsa/rsa_lib.c" 3 4
                   ((void *)0)
# 176 "rsa/rsa_lib.c"
                       ;
 ret->flags = ret->meth->flags & ~0x0400;
 if (!CRYPTO_new_ex_data(6, ret, &ret->ex_data)) {
...
# 187 "rsa/rsa_lib.c"
  ...
  CRYPTO_free_ex_data(6, ret, &ret->ex_data);
  free(ret);
  ret = 
# 194 "rsa/rsa_lib.c" 3 4
       ((void *)0)
# 194 "rsa/rsa_lib.c"
           ;
 }
...
RSA_free(RSA *r)
{
 ...
 if (r == 
# 204 "rsa/rsa_lib.c" 3 4
         ((void *)0)
# 204 "rsa/rsa_lib.c"
             )
  return;

 i = CRYPTO_add_lock(&r->references,-1,9,"rsa/rsa_lib.c",207);
 if (i > 0)
  return;
...
RSA_up_ref(RSA *r)
{
 int i = CRYPTO_add_lock(&r->references,1,9,"rsa/rsa_lib.c",236);
 return i > 1 ? 1 : 0;
}
...
RSA_get_ex_new_index(long argl, void *argp, CRYPTO_EX_new *new_func,
    CRYPTO_EX_dup *dup_func, CRYPTO_EX_free *free_func)
{
 return CRYPTO_get_ex_new_index(6, argl, argp,
