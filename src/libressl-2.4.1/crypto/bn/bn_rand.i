...
# 124 "bn/bn_rand.c"
 ...
 if (rnd == 
# 127 "bn/bn_rand.c" 3 4
           ((void *)0)
# 127 "bn/bn_rand.c"
               ) {
  ERR_put_error(3,(127),((3|64)),"bn/bn_rand.c",128);
  return (0);
 }
 ...
 buf = malloc(bytes);
 if (buf == 
# 142 "bn/bn_rand.c" 3 4
           ((void *)0)
# 142 "bn/bn_rand.c"
               ) {
  ERR_put_error(3,(127),((1|64)),"bn/bn_rand.c",143);
  goto err;
 }
...
bn_rand_range(int pseudo, BIGNUM *r, const BIGNUM *range)
{
 ...
 if (range->neg || BN_is_zero(range)) {
  ERR_put_error(3,(122),(115),"bn/bn_rand.c",227);
  return 0;
 }
 ...
 if (n == 1)
  ...
  do {
   ...
   if (!--count) {
    ERR_put_error(3,(122),(113),"bn/bn_rand.c",258)
                                 ;
    return 0;
   }
  ...
  do {
   ...
   if (!--count) {
    ERR_put_error(3,(122),(113),"bn/bn_rand.c",271)
                                 ;
    return 0;
   }
  } while (BN_cmp(r, range) >= 0);
