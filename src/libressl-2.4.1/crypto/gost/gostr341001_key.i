...
GOST_KEY_new(void)
{
 ...
 if (ret == 
# 80 "gost/gostr341001_key.c" 3 4
           ((void *)0)
# 80 "gost/gostr341001_key.c"
               ) {
  ERR_put_error(50,(125),((1|64)),"gost/gostr341001_key.c",81);
  return (
# 82 "gost/gostr341001_key.c" 3 4
         ((void *)0)
# 82 "gost/gostr341001_key.c"
             );
 }
 ret->group = 
# 84 "gost/gostr341001_key.c" 3 4
             ((void *)0)
# 84 "gost/gostr341001_key.c"
                 ;
 ret->pub_key = 
# 85 "gost/gostr341001_key.c" 3 4
               ((void *)0)
# 85 "gost/gostr341001_key.c"
                   ;
 ret->priv_key = 
# 86 "gost/gostr341001_key.c" 3 4
                ((void *)0)
# 86 "gost/gostr341001_key.c"
                    ;
 ret->references = 1;
 ret->digest_nid = 0;
 return (ret);
...
GOST_KEY_free(GOST_KEY *r)
{
 ...
 if (r == 
# 97 "gost/gostr341001_key.c" 3 4
         ((void *)0)
# 97 "gost/gostr341001_key.c"
             )
  return;

 i = CRYPTO_add_lock(&r->references,-1,33,"gost/gostr341001_key.c",100);
 if (i > 0)
  return;
...
GOST_KEY_check_key(const GOST_KEY *key)
{
 int ok = 0;
 BN_CTX *ctx = 
# 116 "gost/gostr341001_key.c" 3 4
              ((void *)0)
# 116 "gost/gostr341001_key.c"
                  ;
 BIGNUM *order = 
# 117 "gost/gostr341001_key.c" 3 4
                ((void *)0)
# 117 "gost/gostr341001_key.c"
                    ;
 EC_POINT *point = 
# 118 "gost/gostr341001_key.c" 3 4
                  ((void *)0)
# 118 "gost/gostr341001_key.c"
                      ;

 if (key == 
# 120 "gost/gostr341001_key.c" 3 4
           ((void *)0) 
# 120 "gost/gostr341001_key.c"
                || key->group == 
# 120 "gost/gostr341001_key.c" 3 4
                                 ((void *)0) 
# 120 "gost/gostr341001_key.c"
...
# 120 "gost/gostr341001_key.c"
  ...
  ERR_put_error(50,(124),((3|64)),"gost/gostr341001_key.c",121);
  return 0;
 }
 if (EC_POINT_is_at_infinity(key->group, key->pub_key) != 0) {
  ERR_put_error(50,(124),(106),"gost/gostr341001_key.c",125);
  goto err;
 }
 if ((ctx = BN_CTX_new()) == 
# 128 "gost/gostr341001_key.c" 3 4
                            ((void *)0)
# 128 "gost/gostr341001_key.c"
                                )
  goto err;
 if ((point = EC_POINT_new(key->group)) == 
# 130 "gost/gostr341001_key.c" 3 4
                                          ((void *)0)
# 130 "gost/gostr341001_key.c"
                                              )
  goto err;


 if (EC_POINT_is_on_curve(key->group, key->pub_key, ctx) == 0) {
  ERR_put_error(50,(124),(107),"gost/gostr341001_key.c",135);
  goto err;
 }

 if ((order = BN_new()) == 
# 139 "gost/gostr341001_key.c" 3 4
                          ((void *)0)
# 139 "gost/gostr341001_key.c"
                              )
  goto err;
 if (EC_GROUP_get_order(key->group, order, ctx) == 0) {
  ERR_put_error(50,(124),(122),"gost/gostr341001_key.c",142);
  goto err;
 }
 if (EC_POINT_mul(key->group, point, 
# 145 "gost/gostr341001_key.c" 3 4
                                    ((void *)0)
# 145 "gost/gostr341001_key.c"
                                        , key->pub_key, order,
     ctx) == 0) {
  ERR_put_error(50,(124),(16),"gost/gostr341001_key.c",147);
  goto err;
 }
 if (EC_POINT_is_at_infinity(key->group, point) == 0) {
  ERR_put_error(50,(124),(130),"gost/gostr341001_key.c",151);
  goto err;
 }
 ...
 if (key->priv_key != 
# 158 "gost/gostr341001_key.c" 3 4
                     ((void *)0)
# 158 "gost/gostr341001_key.c"
                         ) {
  if (BN_cmp(key->priv_key, order) >= 0) {
   ERR_put_error(50,(124),(130),"gost/gostr341001_key.c",160);
   goto err;
  }
  if (EC_POINT_mul(key->group, point, key->priv_key, 
# 163 "gost/gostr341001_key.c" 3 4
                                                    ((void *)0)
# 163 "gost/gostr341001_key.c"
                                                        , 
# 163 "gost/gostr341001_key.c" 3 4
                                                          ((void *)0)
# 163 "gost/gostr341001_key.c"
                                                              ,
      ctx) == 0) {
   ERR_put_error(50,(124),(16),"gost/gostr341001_key.c",165);
   goto err;
  }
  if (EC_POINT_cmp(key->group, point, key->pub_key, ctx) != 0) {
   ERR_put_error(50,(124),(123),"gost/gostr341001_key.c",170)
                                ;
   goto err;
  }
 }
...
{
 BN_CTX *ctx = 
# 185 "gost/gostr341001_key.c" 3 4
              ((void *)0)
# 185 "gost/gostr341001_key.c"
                  ;
 BIGNUM *tx, *ty;
 EC_POINT *point = 
# 187 "gost/gostr341001_key.c" 3 4
                  ((void *)0)
# 187 "gost/gostr341001_key.c"
                      ;
 int ok = 0;

 if (key == 
# 190 "gost/gostr341001_key.c" 3 4
           ((void *)0) 
# 190 "gost/gostr341001_key.c"
                || key->group == 
# 190 "gost/gostr341001_key.c" 3 4
                                 ((void *)0) 
# 190 "gost/gostr341001_key.c"
...
# 190 "gost/gostr341001_key.c"
  ...
  ERR_put_error(50,(126),((3|64)),"gost/gostr341001_key.c",192)
                                  ;
  return 0;
 }
 ctx = BN_CTX_new();
 if (ctx == 
# 196 "gost/gostr341001_key.c" 3 4
           ((void *)0)
# 196 "gost/gostr341001_key.c"
               )
  goto err;

 point = EC_POINT_new(key->group);
 if (point == 
# 200 "gost/gostr341001_key.c" 3 4
             ((void *)0)
# 200 "gost/gostr341001_key.c"
                 )
  goto err;

 if ((tx = BN_CTX_get(ctx)) == 
# 203 "gost/gostr341001_key.c" 3 4
                              ((void *)0)
# 203 "gost/gostr341001_key.c"
                                  )
  goto err;
 if ((ty = BN_CTX_get(ctx)) == 
# 205 "gost/gostr341001_key.c" 3 4
                              ((void *)0)
# 205 "gost/gostr341001_key.c"
                                  )
  goto err;
 ...
 if (BN_cmp(x, tx) != 0 || BN_cmp(y, ty) != 0) {
  ERR_put_error(50,(126),(146),"gost/gostr341001_key.c",219)
                                    ;
  goto err;
 }
...
GOST_KEY_set_group(GOST_KEY *key, const EC_GROUP *group)
{
 ...
 return (key->group == 
# 248 "gost/gostr341001_key.c" 3 4
                      ((void *)0)
# 248 "gost/gostr341001_key.c"
                          ) ? 0 : 1;
}
...
GOST_KEY_set_private_key(GOST_KEY *key, const BIGNUM *priv_key)
{
 ...
 return (key->priv_key == 
# 262 "gost/gostr341001_key.c" 3 4
                         ((void *)0)
# 262 "gost/gostr341001_key.c"
                             ) ? 0 : 1;
}
...
GOST_KEY_set_public_key(GOST_KEY *key, const EC_POINT *pub_key)
{
 ...
 return (key->pub_key == 
# 276 "gost/gostr341001_key.c" 3 4
                        ((void *)0)
# 276 "gost/gostr341001_key.c"
                            ) ? 0 : 1;
}
...
GOST_KEY_get_size(const GOST_KEY *r)
{
 int i;
 BIGNUM *order = 
# 301 "gost/gostr341001_key.c" 3 4
                ((void *)0)
# 301 "gost/gostr341001_key.c"
                    ;
 const EC_GROUP *group;

 if (r == 
# 304 "gost/gostr341001_key.c" 3 4
         ((void *)0)
# 304 "gost/gostr341001_key.c"
             )
  return 0;
 group = GOST_KEY_get0_group(r);
 if (group == 
# 307 "gost/gostr341001_key.c" 3 4
             ((void *)0)
# 307 "gost/gostr341001_key.c"
                 )
  return 0;

 if ((order = BN_new()) == 
# 310 "gost/gostr341001_key.c" 3 4
                          ((void *)0)
# 310 "gost/gostr341001_key.c"
                              )
  return 0;

 if (EC_GROUP_get_order(group, order, 
# 313 "gost/gostr341001_key.c" 3 4
                                     ((void *)0)
# 313 "gost/gostr341001_key.c"
                                         ) == 0) {
  BN_clear_free(order);
  return 0;
 }

 i = ((BN_num_bits(order)+7)/8);
 BN_clear_free(order);
 return (i);
}
