...
static const unsigned long tag2bit[32] = {
 ...
 0x2000,0x1000,0x1000,0x1000,
 0x10000,0,0x0001,0x0002,
 0x0004,0x0008,0x0010,
 0x4000, 0x8000,
 0x0020,0x0040,0x0080,
 0x0100,0x1000,0x0800,0x1000,
};
...
{
 const ASN1_TEMPLATE *tt, *errtt = 
# 157 "asn1/tasn_dec.c" 3 4
                                  ((void *)0)
# 157 "asn1/tasn_dec.c"
                                      ;
...
# 161 "asn1/tasn_dec.c"
 ...
 case 0x0:
  if (it->templates) {
   ...
   if ((tag != -1) || opt) {
    ERR_put_error(13,(120),(170),"asn1/tasn_dec.c",193)
                                                ;
    goto err;
   }
...
# 206 "asn1/tasn_dec.c"
      ...
      &p, len, -1, 0, 1, ctx);
  if (!ret) {
   ERR_put_error(13,(120),(58),"asn1/tasn_dec.c",210)
                               ;
   goto err;
  }
  ...
  if (oclass != 0x00) {
   ...
   if (opt)
    return -1;
   ERR_put_error(13,(120),(139),"asn1/tasn_dec.c",220)
                                    ;
   goto err;
  }
  ...
  if (!(ASN1_tag2bit(otag) & it->utype)) {
   ...
   if (opt)
    return -1;
   ERR_put_error(13,(120),(140),"asn1/tasn_dec.c",229)
                                ;
   goto err;
  }
 ...
 case 0x2:
  if (asn1_cb && !asn1_cb(4, pval, it, 
# 242 "asn1/tasn_dec.c" 3 4
                                                    ((void *)0)
# 242 "asn1/tasn_dec.c"
                                                        ))
   goto auxerr;
  ...
  if (*pval) {
   ...
   ERR_put_error(13,(120),(58),"asn1/tasn_dec.c",256)
                               ;
   goto err;
  }
  ...
  for (i = 0, tt = it->templates; i < it->tcount; i++, tt++) {
   ...
   errtt = tt;
   ERR_put_error(13,(120),(58),"asn1/tasn_dec.c",276)
                               ;
   goto err;
  }
  ...
  if (i == it->tcount) {
   ...
   ERR_put_error(13,(120),(143),"asn1/tasn_dec.c",289)
                                      ;
   goto err;
  }
  ...
  *in = p;
  if (asn1_cb && !asn1_cb(5, pval, it, 
# 295 "asn1/tasn_dec.c" 3 4
                                                     ((void *)0)
# 295 "asn1/tasn_dec.c"
                                                         ))
   goto auxerr;
 ...
 case 0x1:
  ...
  ret = asn1_check_tlen(&len, 
# 310 "asn1/tasn_dec.c" 3 4
                             ((void *)0)
# 310 "asn1/tasn_dec.c"
                                 , 
# 310 "asn1/tasn_dec.c" 3 4
...
# 310 "asn1/tasn_dec.c"
  ...
  if (!ret) {
   ERR_put_error(13,(120),(58),"asn1/tasn_dec.c",314)
                               ;
   goto err;
  } else if (ret == -1)
   return -1;
  if (aux && (aux->flags & 4)) {
   ...
   seq_nolen = seq_eoc;
  if (!cst) {
   ERR_put_error(13,(120),(149),"asn1/tasn_dec.c",327)
                                       ;
   goto err;
  }

  if (!*pval && !ASN1_item_ex_new(pval, it)) {
   ERR_put_error(13,(120),(58),"asn1/tasn_dec.c",333)
                               ;
   goto err;
  }

  if (asn1_cb && !asn1_cb(4, pval, it, 
# 337 "asn1/tasn_dec.c" 3 4
                                                    ((void *)0)
# 337 "asn1/tasn_dec.c"
                                                        ))
   goto auxerr;
  ...
  for (i = 0, tt = it->templates; i < it->tcount; i++, tt++) {
   ...
   if (asn1_check_eoc(&p, len)) {
    if (!seq_eoc) {
     ERR_put_error(13,(120),(159),"asn1/tasn_dec.c",368)
                               ;
     goto err;
    }
    len -= p - q;
  ...
  if (seq_eoc && !asn1_check_eoc(&p, len)) {
   ERR_put_error(13,(120),(137),"asn1/tasn_dec.c",407);
   goto err;
  }

  if (!seq_nolen && len) {
   ERR_put_error(13,(120),(148),"asn1/tasn_dec.c",413)
                                       ;
   goto err;
  }
  ...
  for (; i < it->tcount; tt++, i++) {
   ...
   if (seqtt->flags & (0x1)) {
    ...
    errtt = seqtt;
    ERR_put_error(13,(120),(121),"asn1/tasn_dec.c",433)
                             ;
    goto err;
   }
  }
  ...
  if (!asn1_enc_save(pval, *in, p - *in, it)) {
   ERR_put_error(13,(120),((1|64)),"asn1/tasn_dec.c",439);
   goto auxerr;
  }
  *in = p;
  if (asn1_cb && !asn1_cb(5, pval, it, 
# 443 "asn1/tasn_dec.c" 3 4
                                                     ((void *)0)
# 443 "asn1/tasn_dec.c"
                                                         ))
   goto auxerr;
...
auxerr:
 ERR_put_error(13,(120),(100),"asn1/tasn_dec.c",452);
err:
 if (combine == 0)
  ASN1_item_ex_free(pval, it);
 if (errtt)
...
# 492 "asn1/tasn_dec.c"
  ...
  q = p;
  if (!ret) {
   ERR_put_error(13,(132),(58),"asn1/tasn_dec.c",497)
                               ;
   return 0;
  } else if (ret == -1)
   return -1;
  if (!cst) {
   ERR_put_error(13,(132),(120),"asn1/tasn_dec.c",503)
                                           ;
   return 0;
  }
  ...
  if (!ret) {
   ERR_put_error(13,(132),(58),"asn1/tasn_dec.c",510)
                               ;
   return 0;
  }
  ...
  if (exp_eoc) {
   ...
   if (!asn1_check_eoc(&p, len)) {
    ERR_put_error(13,(132),(137),"asn1/tasn_dec.c",519)
                           ;
    goto err;
   }
  } else {
   ...
   if (len) {
    ERR_put_error(13,(132),(119),"asn1/tasn_dec.c",527)
                                        ;
    goto err;
   }
  }
...
# 574 "asn1/tasn_dec.c"
  ...
  if (!ret) {
   ERR_put_error(13,(131),(58),"asn1/tasn_dec.c",578)
                               ;
   return 0;
  } else if (ret == -1)
   return -1;
   ...
   *val = (ASN1_VALUE *)sk_new_null();
   ...
   struct stack_st_ASN1_VALUE *sktmp =
       (struct stack_st_ASN1_VALUE *)*val;
   ASN1_VALUE *vtmp;
   while (sk_num(((_STACK*) (1 ? (sktmp) : (struct stack_st_ASN1_VALUE*)0))) > 0) {
    vtmp = (ASN1_VALUE *)sk_pop(((_STACK*) (1 ? (sktmp) : (struct stack_st_ASN1_VALUE*)0)));
  ...
  if (!*val) {
   ERR_put_error(13,(131),((1|64)),"asn1/tasn_dec.c",598)
                            ;
   goto err;
  }
  ...
  while (len > 0) {
   ...
   if (asn1_check_eoc(&p, len)) {
    if (!sk_eoc) {
     ERR_put_error(13,(131),(159),"asn1/tasn_dec.c",610)
                               ;
     goto err;
    }
    len -= p - q;
   ...
   skfield = 
# 617 "asn1/tasn_dec.c" 3 4
            ((void *)0)
# 617 "asn1/tasn_dec.c"
                ;
   if (!ASN1_item_ex_d2i(&skfield, &p, len,
       (tt->item), -1, 0, 0, ctx)) {
    ERR_put_error(13,(131),(58),"asn1/tasn_dec.c",621)
                                ;
    goto err;
   }
   len -= p - q;
   if (!sk_push(((_STACK*) (1 ? ((struct stack_st_ASN1_VALUE *)*val) : (struct stack_st_ASN1_VALUE*)0)), ((void*) (1 ? (skfield) : (ASN1_VALUE*)0)))
               ) {
    ERR_put_error(13,(131),((1|64)),"asn1/tasn_dec.c",628)
                             ;
    goto err;
   }
  }
  if (sk_eoc) {
   ERR_put_error(13,(131),(137),"asn1/tasn_dec.c",634)
                          ;
   goto err;
  }
 } else if (flags & (0x1 << 3)) {
  ...
  if (!ret) {
   ERR_put_error(13,(131),(58),"asn1/tasn_dec.c",643)
                               ;
   goto err;
  } else if (ret == -1)
   return -1;
  ...
  ret = ASN1_item_ex_d2i(val, &p, len, (tt->item),
      -1, tt->flags & (0x1<<10), opt, ctx);
  if (!ret) {
   ERR_put_error(13,(131),(58),"asn1/tasn_dec.c",653)
                               ;
   goto err;
  } else if (ret == -1)
   return -1;
...
# 676 "asn1/tasn_dec.c"
 ...
 buf.max = 0;
 buf.data = 
# 681 "asn1/tasn_dec.c" 3 4
           ((void *)0)
# 681 "asn1/tasn_dec.c"
               ;

 if (!pval) {
  ERR_put_error(13,(108),(125),"asn1/tasn_dec.c",684);
  return 0;
 }
 ...
 if (utype == -4) {
  ...
  unsigned char oclass;
  if (tag >= 0) {
   ERR_put_error(13,(108),(127),"asn1/tasn_dec.c",699)
                                 ;
   return 0;
  }
  if (opt) {
   ERR_put_error(13,(108),(126),"asn1/tasn_dec.c",704)
                                   ;
   return 0;
  }
  p = *in;
  ret = asn1_check_tlen(
# 708 "asn1/tasn_dec.c" 3 4
                       ((void *)0)
# 708 "asn1/tasn_dec.c"
                           , &utype, &oclass, 
# 708 "asn1/tasn_dec.c" 3 4
...
# 708 "asn1/tasn_dec.c"
      ...
      &p, inlen, -1, 0, 0, ctx);
  if (!ret) {
   ERR_put_error(13,(108),(58),"asn1/tasn_dec.c",712)
                               ;
   return 0;
  }
  if (oclass != 0x00)
 ...
 ret = asn1_check_tlen(&plen, 
# 724 "asn1/tasn_dec.c" 3 4
                             ((void *)0)
# 724 "asn1/tasn_dec.c"
                                 , 
# 724 "asn1/tasn_dec.c" 3 4
...
# 724 "asn1/tasn_dec.c"
 ...
 if (!ret) {
  ERR_put_error(13,(108),(58),"asn1/tasn_dec.c",727);
  return 0;
 } else if (ret == -1)
  return -1;
 ret = 0;
 ...
 if ((utype == 16) || (utype == 17) ||
  ...
  if (utype == -3) {
   ...
   ERR_put_error(13,(108),(156),"asn1/tasn_dec.c",744)
                                   ;
   return 0;
  }
...
# 757 "asn1/tasn_dec.c"
  ...
  if (!asn1_collect(&buf, &p, plen, inf, -1, 0x00, 0)) {
   free_cont = 1;
   goto err;
  }
  len = buf.length;
  ...
  if (!BUF_MEM_grow_clean(&buf, len + 1)) {
   ERR_put_error(13,(108),((1|64)),"asn1/tasn_dec.c",774)
                            ;
   return 0;
  }
  buf.data[len] = 0;
...
{
 ASN1_VALUE **opval = 
# 805 "asn1/tasn_dec.c" 3 4
                     ((void *)0)
# 805 "asn1/tasn_dec.c"
                         ;
 ASN1_STRING *stmp;
 ASN1_TYPE *typ = 
# 807 "asn1/tasn_dec.c" 3 4
                 ((void *)0)
# 807 "asn1/tasn_dec.c"
                     ;
 int ret = 0;
...
# 820 "asn1/tasn_dec.c"
  ...
  if (utype != typ->type)
   ASN1_TYPE_set(typ, utype, 
# 827 "asn1/tasn_dec.c" 3 4
                            ((void *)0)
# 827 "asn1/tasn_dec.c"
                                );
  opval = pval;
 ...
 case 5:
  if (len) {
   ERR_put_error(13,(204),(144),"asn1/tasn_dec.c",840)
                                   ;
   goto err;
  }
  *pval = (ASN1_VALUE *)1;
 ...
 case 1:
  if (len != 1) {
   ERR_put_error(13,(204),(106),"asn1/tasn_dec.c",849)
                                      ;
   goto err;
  } else {
   ASN1_BOOLEAN *tbool;
 ...
 case 10:
  ...
  (*tint)->type = utype | ((*tint)->type & 0x100);
  break;
 ...
 default:
  if (utype == 30 && (len & 1)) {
   ERR_put_error(13,(204),(214),"asn1/tasn_dec.c",892)
                                        ;
   goto err;
  }
  if (utype == 28 && (len & 3)) {
   ERR_put_error(13,(204),(215),"asn1/tasn_dec.c",897)
                                              ;
   goto err;
  }
  ...
  if (!*pval) {
   ...
   if (!stmp) {
    ERR_put_error(13,(204),((1|64)),"asn1/tasn_dec.c",905)
                             ;
    goto err;
   }
   ...
   *free_cont = 0;
   ...
   if (!ASN1_STRING_set(stmp, cont, len)) {
    ERR_put_error(13,(204),((1|64)),"asn1/tasn_dec.c",922)
                             ;
    ASN1_STRING_free(stmp);
    *pval = 
# 924 "asn1/tasn_dec.c" 3 4
           ((void *)0)
# 924 "asn1/tasn_dec.c"
               ;
    goto err;
...
asn1_find_end(const unsigned char **in, long len, char inf)
{
 ...
 while (len > 0) {
  ...
  if (!asn1_check_tlen(&plen, 
# 980 "asn1/tasn_dec.c" 3 4
                             ((void *)0)
# 980 "asn1/tasn_dec.c"
                                 , 
# 980 "asn1/tasn_dec.c" 3 4
...
# 980 "asn1/tasn_dec.c"
                                                   , &p, len,
      -1, 0, 0, 
# 981 "asn1/tasn_dec.c" 3 4
               ((void *)0)
# 981 "asn1/tasn_dec.c"
                   )) {
   ERR_put_error(13,(190),(58),"asn1/tasn_dec.c",982);
   return 0;
  }
  if (inf)
   expected_eoc++;
 ...
 if (expected_eoc) {
  ERR_put_error(13,(190),(137),"asn1/tasn_dec.c",992);
  return 0;
 }
 *in = p;
 return 1;
}
# 1013 "asn1/tasn_dec.c"
static int
    ...
    int tag, int aclass, int depth)
{
 ...
 while (len > 0) {
  ...
  if (asn1_check_eoc(&p, len)) {
   ...
   if (!inf) {
    ERR_put_error(13,(106),(159),"asn1/tasn_dec.c",1037)
                              ;
    return 0;
   }
   inf = 0;
  ...
  if (!asn1_check_tlen(&plen, 
# 1044 "asn1/tasn_dec.c" 3 4
                             ((void *)0)
# 1044 "asn1/tasn_dec.c"
                                 , 
# 1044 "asn1/tasn_dec.c" 3 4
                                   ((void *)0)
# 1044 "asn1/tasn_dec.c"
                                       , &ininf, &cst, &p,
      len, tag, aclass, 0, 
# 1045 "asn1/tasn_dec.c" 3 4
                          ((void *)0)
# 1045 "asn1/tasn_dec.c"
                              )) {
   ERR_put_error(13,(106),(58),"asn1/tasn_dec.c",1046);
   return 0;
  }
  ...
  if (cst) {
   if (depth >= 5) {
    ERR_put_error(13,(106),(197),"asn1/tasn_dec.c",1054)
                                  ;
    return 0;
   }
 ...
 if (inf) {
  ERR_put_error(13,(106),(137),"asn1/tasn_dec.c",1065);
  return 0;
 }
 *in = p;
 return 1;
...
collect_data(BUF_MEM *buf, const unsigned char **p, long plen)
{
 ...
 if (buf) {
  ...
  if (!BUF_MEM_grow_clean(buf, len + plen)) {
   ERR_put_error(13,(140),((1|64)),"asn1/tasn_dec.c",1079);
   return 0;
  }
    ...
    char opt, ASN1_TLC *ctx)
{
 ...
 if (ctx && ctx->valid) {
  ...
  if (ctx) {
   ...
   if (!(i & 0x81) && ((plen + ctx->hdrlen) > len)) {
    ERR_put_error(13,(104),(155),"asn1/tasn_dec.c",1145)
                        ;
    if (ctx) (ctx)->valid = 0;
    return 0;
   }
 ...
 if (i & 0x80) {
  ERR_put_error(13,(104),(102),"asn1/tasn_dec.c",1153);
  if (ctx) (ctx)->valid = 0;
  return 0;
 }
 if (exptag >= 0) {
  if ((exptag != ptag) || (expclass != pclass)) {
   ...
   if (opt)
    return -1;
   if (ctx) (ctx)->valid = 0;
   ERR_put_error(13,(104),(168),"asn1/tasn_dec.c",1165);
   return 0;
  }
