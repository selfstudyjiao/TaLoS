...
# 88 "bn/bn_sqr.c"
 ...
 max = 2 * al;
 if ((((max) <= (rr)->dmax)?(rr):bn_expand2((rr),(max))) == 
# 92 "bn/bn_sqr.c" 3 4
                           ((void *)0)
# 92 "bn/bn_sqr.c"
                               )
 ...
 if (al == 4) {
  ...
  if (al < (16)) {
   ...
   k = j + j;
   if (al == j) {
    if ((((k * 2) <= (tmp)->dmax)?(tmp):bn_expand2((tmp),(k * 2))) == 
# 121 "bn/bn_sqr.c" 3 4
                                 ((void *)0)
# 121 "bn/bn_sqr.c"
                                     )
    ...
    if ((((max) <= (tmp)->dmax)?(tmp):bn_expand2((tmp),(max))) == 
# 125 "bn/bn_sqr.c" 3 4
                               ((void *)0)
# 125 "bn/bn_sqr.c"
                                   )
 ...
 if (a->d[al - 1] == (a->d[al - 1] & (0xffffffffL)))
  rr->top = max - 1;
 else
  rr->top = max;
 if (rr != r)
...
void
bn_sqr_normal(unsigned long *r, const unsigned long *a, int n, unsigned long *tmp)
{
 int i, j, max;
...
# 203 "bn/bn_sqr.c"
void
bn_sqr_recursive(unsigned long *r, const unsigned long *a, int n2, unsigned long *t)
{
 int n = n2 / 2;
 int zero, c1;
