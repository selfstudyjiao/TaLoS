...
{
 return do_pk8pkey(bp, x, 0, nid, 
# 85 "pem/pem_pk8.c" 3 4
                                 ((void *)0)
# 85 "pem/pem_pk8.c"
                                     , kstr, klen, cb, u);
}
...
i2d_PKCS8PrivateKey_nid_bio(BIO *bp, EVP_PKEY *x, int nid,
    char *kstr, int klen, pem_password_cb *cb, void *u)
{
 return do_pk8pkey(bp, x, 1, nid, 
# 106 "pem/pem_pk8.c" 3 4
                                 ((void *)0)
# 106 "pem/pem_pk8.c"
                                     , kstr, klen, cb, u);
}
    ...
    char *kstr, int klen, pem_password_cb *cb, void *u)
{
 ...
 if (!(p8inf = EVP_PKEY2PKCS8(x))) {
  ERR_put_error(9,(126),(115),"pem/pem_pk8.c",120)
                                         ;
  return 0;
 }
 if (enc || (nid != -1)) {
  if (!kstr) {
   if (!cb)
    ...
    klen = cb(buf, 1024, 1, u);
   if (klen <= 0) {
    ERR_put_error(9,(126),(111),"pem/pem_pk8.c",130);
  ...
  p8 = PKCS8_encrypt(nid, enc, kstr, klen, 
# 137 "pem/pem_pk8.c" 3 4
                                          ((void *)0)
# 137 "pem/pem_pk8.c"
                                              , 0, 0, p8inf);
  if (kstr == buf)
...
{
 PKCS8_PRIV_KEY_INFO *p8inf = 
# 160 "pem/pem_pk8.c" 3 4
                             ((void *)0)
# 160 "pem/pem_pk8.c"
                                 ;
 X509_SIG *p8 = 
# 161 "pem/pem_pk8.c" 3 4
               ((void *)0)
# 161 "pem/pem_pk8.c"
                   ;
 int klen;
 ...
 p8 = d2i_PKCS8_bio(bp, 
# 166 "pem/pem_pk8.c" 3 4
                       ((void *)0)
# 166 "pem/pem_pk8.c"
                           );
 if (!p8)
  return 
# 168 "pem/pem_pk8.c" 3 4
        ((void *)0)
# 168 "pem/pem_pk8.c"
            ;
 if (cb)
  klen = cb(psbuf, 1024, 0, u);
 else
  klen = PEM_def_callback(psbuf, 1024, 0, u);
 if (klen <= 0) {
  ERR_put_error(9,(120),(104),"pem/pem_pk8.c",174);
  X509_SIG_free(p8);
  return 
# 176 "pem/pem_pk8.c" 3 4
        ((void *)0)
# 176 "pem/pem_pk8.c"
            ;
 }
...
i2d_PKCS8PrivateKey_nid_fp(FILE *fp, EVP_PKEY *x, int nid, char *kstr,
    int klen, pem_password_cb *cb, void *u)
{
 return do_pk8pkey_fp(fp, x, 1, nid, 
# 205 "pem/pem_pk8.c" 3 4
                                    ((void *)0)
# 205 "pem/pem_pk8.c"
                                        , kstr, klen, cb, u);
}
...
PEM_write_PKCS8PrivateKey_nid(FILE *fp, EVP_PKEY *x, int nid, char *kstr,
    int klen, pem_password_cb *cb, void *u)
{
 return do_pk8pkey_fp(fp, x, 0, nid, 
# 212 "pem/pem_pk8.c" 3 4
                                    ((void *)0)
# 212 "pem/pem_pk8.c"
                                        , kstr, klen, cb, u);
}
    ...
    char *kstr, int klen, pem_password_cb *cb, void *u)
{
 ...
 if (!(bp = BIO_new_fp(fp, 0x00))) {
  ERR_put_error(9,(125),(7),"pem/pem_pk8.c",230);
  return (0);
 }
...
d2i_PKCS8PrivateKey_fp(FILE *fp, EVP_PKEY **x, pem_password_cb *cb, void *u)
{
 ...
 if (!(bp = BIO_new_fp(fp, 0x00))) {
  ERR_put_error(9,(121),(7),"pem/pem_pk8.c",245);
  return 
# 246 "pem/pem_pk8.c" 3 4
        ((void *)0)
# 246 "pem/pem_pk8.c"
            ;
 }
...
X509_SIG *PEM_read_bio_PKCS8(BIO *bp, X509_SIG **x, pem_password_cb *cb, void *u){ return PEM_ASN1_read_bio((d2i_of_void *)d2i_X509_SIG, "ENCRYPTED PRIVATE KEY",bp,(void **)x,cb,u); } X509_SIG *PEM_read_PKCS8(FILE *fp, X509_SIG **x, pem_password_cb *cb, void *u){ return PEM_ASN1_read((d2i_of_void *)d2i_X509_SIG, "ENCRYPTED PRIVATE KEY",fp,(void **)x,cb,u); } int PEM_write_bio_PKCS8(BIO *bp, X509_SIG *x) { return PEM_ASN1_write_bio((i2d_of_void *)i2d_X509_SIG,"ENCRYPTED PRIVATE KEY",bp,x,
# 254 "pem/pem_pk8.c" 3 4
((void *)0)
# 254 "pem/pem_pk8.c"
,
# 254 "pem/pem_pk8.c" 3 4
...
((void *)0)
# 254 "pem/pem_pk8.c"
); } int PEM_write_PKCS8(FILE *fp, X509_SIG *x) { return PEM_ASN1_write((i2d_of_void *)i2d_X509_SIG,"ENCRYPTED PRIVATE KEY",fp,x,
# 254 "pem/pem_pk8.c" 3 4
((void *)0)
# 254 "pem/pem_pk8.c"
,
...
PKCS8_PRIV_KEY_INFO *PEM_read_bio_PKCS8_PRIV_KEY_INFO(BIO *bp, PKCS8_PRIV_KEY_INFO **x, pem_password_cb *cb, void *u){ return PEM_ASN1_read_bio((d2i_of_void *)d2i_PKCS8_PRIV_KEY_INFO, "PRIVATE KEY",bp,(void **)x,cb,u); } PKCS8_PRIV_KEY_INFO *PEM_read_PKCS8_PRIV_KEY_INFO(FILE *fp, PKCS8_PRIV_KEY_INFO **x, pem_password_cb *cb, void *u){ return PEM_ASN1_read((d2i_of_void *)d2i_PKCS8_PRIV_KEY_INFO, "PRIVATE KEY",fp,(void **)x,cb,u); } int PEM_write_bio_PKCS8_PRIV_KEY_INFO(BIO *bp, PKCS8_PRIV_KEY_INFO *x) { return PEM_ASN1_write_bio((i2d_of_void *)i2d_PKCS8_PRIV_KEY_INFO,"PRIVATE KEY",bp,x,
# 255 "pem/pem_pk8.c" 3 4
((void *)0)
# 255 "pem/pem_pk8.c"
,
# 255 "pem/pem_pk8.c" 3 4
...
((void *)0)
# 255 "pem/pem_pk8.c"
); } int PEM_write_PKCS8_PRIV_KEY_INFO(FILE *fp, PKCS8_PRIV_KEY_INFO *x) { return PEM_ASN1_write((i2d_of_void *)i2d_PKCS8_PRIV_KEY_INFO,"PRIVATE KEY",fp,x,
# 255 "pem/pem_pk8.c" 3 4
((void *)0)
# 255 "pem/pem_pk8.c"
,
