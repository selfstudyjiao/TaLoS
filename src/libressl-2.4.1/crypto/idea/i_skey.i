...
static unsigned int inverse(unsigned int xin);
void idea_set_encrypt_key(const unsigned char *key, IDEA_KEY_SCHEDULE *ks)
 {
 int i;
 unsigned int *kt,*kf,r0,r1,r2;

 kt= &(ks->data[0][0]);
 (kt[0] =((unsigned int)(*((key)++)))<< 8L, kt[0]|=((unsigned int)(*((key)++))) ); (kt[1] =((unsigned int)(*((key)++)))<< 8L, kt[1]|=((unsigned int)(*((key)++))) ); (kt[2] =((unsigned int)(*((key)++)))<< 8L, kt[2]|=((unsigned int)(*((key)++))) ); (kt[3] =((unsigned int)(*((key)++)))<< 8L, kt[3]|=((unsigned int)(*((key)++))) );
 (kt[4] =((unsigned int)(*((key)++)))<< 8L, kt[4]|=((unsigned int)(*((key)++))) ); (kt[5] =((unsigned int)(*((key)++)))<< 8L, kt[5]|=((unsigned int)(*((key)++))) ); (kt[6] =((unsigned int)(*((key)++)))<< 8L, kt[6]|=((unsigned int)(*((key)++))) ); (kt[7] =((unsigned int)(*((key)++)))<< 8L, kt[7]|=((unsigned int)(*((key)++))) );
