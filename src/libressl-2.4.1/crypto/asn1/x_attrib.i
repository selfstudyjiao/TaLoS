...
{
 X509_ATTRIBUTE *ret = 
# 175 "asn1/x_attrib.c" 3 4
                      ((void *)0)
# 175 "asn1/x_attrib.c"
                          ;
 ASN1_TYPE *val = 
# 176 "asn1/x_attrib.c" 3 4
                 ((void *)0)
# 176 "asn1/x_attrib.c"
                     ;

 if ((ret = X509_ATTRIBUTE_new()) == 
# 178 "asn1/x_attrib.c" 3 4
                                    ((void *)0)
# 178 "asn1/x_attrib.c"
                                        )
  return (
# 179 "asn1/x_attrib.c" 3 4
         ((void *)0)
# 179 "asn1/x_attrib.c"
             );
 ret->object = OBJ_nid2obj(nid);
 ret->single = 0;
 if ((ret->value.set = ((struct stack_st_ASN1_TYPE *)sk_new_null())) == 
# 182 "asn1/x_attrib.c" 3 4
                                                  ((void *)0)
# 182 "asn1/x_attrib.c"
                                                      )
  goto err;
 if ((val = ASN1_TYPE_new()) == 
# 184 "asn1/x_attrib.c" 3 4
                               ((void *)0)
# 184 "asn1/x_attrib.c"
                                   )
  goto err;
 if (!sk_push(((_STACK*) (1 ? (ret->value.set) : (struct stack_st_ASN1_TYPE*)0)), ((void*) (1 ? (val) : (ASN1_TYPE*)0))))
  goto err;
...
err:
 if (ret != 
# 193 "asn1/x_attrib.c" 3 4
           ((void *)0)
# 193 "asn1/x_attrib.c"
               )
  X509_ATTRIBUTE_free(ret);
 if (val != 
# 195 "asn1/x_attrib.c" 3 4
           ((void *)0)
# 195 "asn1/x_attrib.c"
               )
  ASN1_TYPE_free(val);
 return (
# 197 "asn1/x_attrib.c" 3 4
        ((void *)0)
# 197 "asn1/x_attrib.c"
            );
}
