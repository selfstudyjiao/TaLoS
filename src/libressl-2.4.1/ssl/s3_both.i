...
ssl3_send_finished(SSL *s, int a, int b, const char *sender, int slen)
{
 ...
 if (s->state == a) {
  ...
  (void)((md_len <= 64) ? 0 : (OpenSSLDie("../ssl/s3_both.c", 174, "md_len <= EVP_MAX_MD_SIZE"),1));
  ...
  p = ssl3_handshake_msg_start(s, 20);
...
ssl3_get_finished(SSL *s, int a, int b)
{
 ...
 n = s->method->ssl_get_message(s, a, b, 20, 64, &ok);
 if (!ok)
  return ((int)n);
 ...
 if (!s->s3->change_cipher_spec) {
  al = 10;
  ERR_put_error(20,(140),(154),"../ssl/s3_both.c",247);
  goto f_err;
 }
 ...
 if (n < 0) {
  al = 50;
  ERR_put_error(20,(140),(111),"../ssl/s3_both.c",256);
  goto f_err;
 }
 ...
 if (s->s3->tmp.peer_finish_md_len != md_len ||
     CBS_len(&cbs) != md_len) {
  al = 50;
  ERR_put_error(20,(140),(111),"../ssl/s3_both.c",265);
  goto f_err;
 }

 if (!CBS_mem_equal(&cbs, s->s3->tmp.peer_finish_md, CBS_len(&cbs))) {
  al = 51;
  ERR_put_error(20,(140),(149),"../ssl/s3_both.c",271);
  goto f_err;
 }


 (void)((md_len <= 64) ? 0 : (OpenSSLDie("../ssl/s3_both.c", 276, "md_len <= EVP_MAX_MD_SIZE"),1));
 if (s->type == 0x2000) {
  memcpy(s->s3->previous_client_finished,
...
ssl3_add_cert_to_buf(BUF_MEM *buf, unsigned long *l, X509 *x)
{
 ...
 n = i2d_X509(x, 
# 324 "../ssl/s3_both.c" 3 4
                ((void *)0)
# 324 "../ssl/s3_both.c"
                    );
 if (!BUF_MEM_grow_clean(buf, n + (*l) + 3)) {
  ERR_put_error(20,(296),(7),"../ssl/s3_both.c",326);
  return (-1);
 }
...
ssl3_output_cert_chain(SSL *s, X509 *x)
{
 ...
 if ((s->mode & 0x00000008L) || s->ctx->extra_certs)
  no_chain = 1;
 else
  no_chain = 0;
 ...
 if (!BUF_MEM_grow_clean(buf, ssl3_handshake_msg_hdr_len(s) + 6)) {
  ERR_put_error(20,(147),(7),"../ssl/s3_both.c",355);
  return (0);
 }
 if (x != 
# 358 "../ssl/s3_both.c" 3 4
         ((void *)0)
# 358 "../ssl/s3_both.c"
             ) {
  if (no_chain) {
   ...
   if (!X509_STORE_CTX_init(&xs_ctx, s->ctx->cert_store,
       x, 
# 366 "../ssl/s3_both.c" 3 4
         ((void *)0)
# 366 "../ssl/s3_both.c"
             )) {
    ERR_put_error(20,(147),(11),"../ssl/s3_both.c",368)
                       ;
    return (0);
   }
...
ssl3_get_message(SSL *s, int st1, int stn, int mt, long max, int *ok)
{
 ...
 if (s->s3->tmp.reuse_message) {
  ...
  if ((mt >= 0) && (s->s3->tmp.message_type != mt)) {
   al = 10;
   ERR_put_error(20,(142),(244),"../ssl/s3_both.c",424)
                                ;
   goto f_err;
  }
  *ok = 1;
 ...
 if (s->state == st1) {
  ...
  if ((mt >= 0) && (*p != mt)) {
   al = 10;
   ERR_put_error(20,(142),(244),"../ssl/s3_both.c",477)
                                ;
   goto f_err;
  }
  ...
  if (!CBS_get_u8(&cbs, &u8) ||
      !CBS_get_u24(&cbs, &l)) {
   ERR_put_error(20,(142),(7),"../ssl/s3_both.c",485);
   goto err;
  }
  ...
  if (l > (unsigned long)max) {
   al = 47;
   ERR_put_error(20,(142),(152),"../ssl/s3_both.c",493)
                                    ;
   goto f_err;
  }
  if (l && !BUF_MEM_grow_clean(s->init_buf, l + 4)) {
   ERR_put_error(20,(142),(7),"../ssl/s3_both.c",497);
   goto err;
  }
...
{
 BUF_MEM *buf = 
# 638 "../ssl/s3_both.c" 3 4
               ((void *)0)
# 638 "../ssl/s3_both.c"
                   ;

 if (s->init_buf != 
# 640 "../ssl/s3_both.c" 3 4
                   ((void *)0)
# 640 "../ssl/s3_both.c"
                       )
  return (1);
 ...
 if ((buf = BUF_MEM_new()) == 
# 643 "../ssl/s3_both.c" 3 4
                             ((void *)0)
# 643 "../ssl/s3_both.c"
                                 )
  goto err;
 if (!BUF_MEM_grow(buf, 16384))
  goto err;
...
ssl3_setup_read_buffer(SSL *s)
{
 ...
 if (s->s3->rbuf.buf == 
# 669 "../ssl/s3_both.c" 3 4
                       ((void *)0)
# 669 "../ssl/s3_both.c"
                           ) {
  len = 16384 +
      (256 + 64) + headerlen + align;
  if ((p = malloc(len)) == 
# 672 "../ssl/s3_both.c" 3 4
                          ((void *)0)
# 672 "../ssl/s3_both.c"
                              )
   goto err;
...
err:
 ERR_put_error(20,(156),((1|64)),"../ssl/s3_both.c",682);
 return 0;
}
...
ssl3_setup_write_buffer(SSL *s)
{
 ...
 if (s->s3->wbuf.buf == 
# 699 "../ssl/s3_both.c" 3 4
                       ((void *)0)
# 699 "../ssl/s3_both.c"
                           ) {
  len = s->max_send_fragment +
      (16 + 64) + headerlen + align;
  if (!(s->options & 0x00000800L))
   len += headerlen + align +
       (16 + 64);

  if ((p = malloc(len)) == 
# 706 "../ssl/s3_both.c" 3 4
                          ((void *)0)
# 706 "../ssl/s3_both.c"
                              )
   goto err;
...
err:
 ERR_put_error(20,(291),((1|64)),"../ssl/s3_both.c",715);
 return 0;
}
