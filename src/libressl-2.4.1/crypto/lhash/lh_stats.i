...
# 69 "lhash/lh_stats.c" 2
# 142 "lhash/lh_stats.c"
void
lh_stats(const _LHASH *lh, FILE *fp)
{
 ...
 if (bp == 
# 148 "lhash/lh_stats.c" 3 4
          ((void *)0)
# 148 "lhash/lh_stats.c"
              )
  goto end;
 BIO_ctrl(bp,106,0x00,(char *)fp);
 lh_stats_bio(lh, bp);
 BIO_free(bp);
end:;
}
...
lh_node_stats(const _LHASH *lh, FILE *fp)
{
 ...
 bp = BIO_new(BIO_s_file());
 if (bp == 
# 162 "lhash/lh_stats.c" 3 4
          ((void *)0)
# 162 "lhash/lh_stats.c"
              )
  goto end;
 BIO_ctrl(bp,106,0x00,(char *)fp);
...
lh_node_usage_stats(const _LHASH *lh, FILE *fp)
{
 ...
 bp = BIO_new(BIO_s_file());
 if (bp == 
# 176 "lhash/lh_stats.c" 3 4
          ((void *)0)
# 176 "lhash/lh_stats.c"
              )
  goto end;
 BIO_ctrl(bp,106,0x00,(char *)fp);
...
lh_node_stats_bio(const _LHASH *lh, BIO *out)
{
 ...
 for (i = 0; i < lh->num_nodes; i++) {
  for (n = lh->b[i], num = 0; n != 
# 221 "lhash/lh_stats.c" 3 4
                                  ((void *)0)
# 221 "lhash/lh_stats.c"
                                      ; n = n->next)
   num++;
...
lh_node_usage_stats_bio(const _LHASH *lh, BIO *out)
{
 ...
 for (i = 0; i < lh->num_nodes; i++) {
  for (n = lh->b[i], num = 0; n != 
# 236 "lhash/lh_stats.c" 3 4
                                  ((void *)0)
# 236 "lhash/lh_stats.c"
                                      ; n = n->next)
   num++;
  if (num != 0) {
   n_used++;
