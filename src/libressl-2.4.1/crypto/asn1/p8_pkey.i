...
pkey_cb(int operation, ASN1_VALUE **pval, const ASN1_ITEM *it, void *exarg)
{
 ...
 if (operation == 2) {
  ...
  if (key->pkey != 
# 72 "asn1/p8_pkey.c" 3 4
                  ((void *)0) 
# 72 "asn1/p8_pkey.c"
                       &&
      key->pkey->type == 4 &&
      key->pkey->value.octet_string != 
# 74 "asn1/p8_pkey.c" 3 4
                                      ((void *)0)
# 74 "asn1/p8_pkey.c"
                                          )
