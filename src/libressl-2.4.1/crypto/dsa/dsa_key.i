...
dsa_builtin_keygen(DSA *dsa)
{
 int ok = 0;
 BN_CTX *ctx = 
# 83 "dsa/dsa_key.c" 3 4
              ((void *)0)
# 83 "dsa/dsa_key.c"
                  ;
 BIGNUM *pub_key = 
# 84 "dsa/dsa_key.c" 3 4
                  ((void *)0)
# 84 "dsa/dsa_key.c"
                      , *priv_key = 
# 84 "dsa/dsa_key.c" 3 4
...
# 86 "dsa/dsa_key.c"
 ...
 if (dsa->priv_key == 
# 89 "dsa/dsa_key.c" 3 4
                     ((void *)0)
# 89 "dsa/dsa_key.c"
                         ) {
  if ((priv_key = BN_new()) == 
# 90 "dsa/dsa_key.c" 3 4
                              ((void *)0)
# 90 "dsa/dsa_key.c"
                                  )
   goto err;
 ...
 if (dsa->pub_key == 
# 100 "dsa/dsa_key.c" 3 4
                    ((void *)0)
# 100 "dsa/dsa_key.c"
                        ) {
  if ((pub_key = BN_new()) == 
# 101 "dsa/dsa_key.c" 3 4
                             ((void *)0)
# 101 "dsa/dsa_key.c"
                                 )
   goto err;
