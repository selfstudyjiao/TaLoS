...
# 83 "asn1/t_req.c"
  ...
  ERR_put_error(11,(122),(7),"asn1/t_req.c",84);
  return (0);
 }
...
# 176 "asn1/t_req.c"
    ...
    a = ((X509_ATTRIBUTE *)sk_value(((_STACK*) (1 ? (sk) : (struct stack_st_X509_ATTRIBUTE*)0)), (i)));
    ...
    if ((j = i2a_ASN1_OBJECT(bp, a->object)) > 0) {
     if (a->single) {
      ...
      ii = 0;
      count = sk_num(((_STACK*) (1 ? (a->value.set) : (struct stack_st_ASN1_TYPE*)0)))
                       ;
get_next:
      at = ((ASN1_TYPE *)sk_value(((_STACK*) (1 ? (a->value.set) : (struct stack_st_ASN1_TYPE*)0)), (ii)))
                           ;
      type = at->type;
...
err:
 ERR_put_error(11,(121),(7),"asn1/t_req.c",259);
 return (0);
}
...
{
 return X509_REQ_print_ex(bp, x, 0, 0);
}
