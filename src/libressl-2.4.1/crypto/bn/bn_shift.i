...
BN_lshift1(BIGNUM *r, const BIGNUM *a)
{
 ...
 if (r != a) {
  r->neg = a->neg;
  if ((((a->top + 1) <= (r)->dmax)?(r):bn_expand2((r),(a->top + 1))) == 
# 75 "bn/bn_shift.c" 3 4
                                  ((void *)0)
# 75 "bn/bn_shift.c"
                                      )
   return (0);
...
# 79 "bn/bn_shift.c"
 ...
 for (i = 0; i < a->top; i++) {
  t= *(ap++);
  *(rp++) = ((t << 1) | c) & (0xffffffffffffffffL);
  c = (t & (0x8000000000000000L)) ? 1 : 0;
 }
 if (c) {
  *rp = 1;
  r->top++;
...
BN_rshift1(BIGNUM *r, const BIGNUM *a)
{
 ...
 j = i - (ap[i - 1]==1);
 if (a != r) {
  if ((((j) <= (r)->dmax)?(r):bn_expand2((r),(j))) == 
# 115 "bn/bn_shift.c" 3 4
                         ((void *)0)
# 115 "bn/bn_shift.c"
                             )
   return (0);
...
BN_lshift(BIGNUM *r, const BIGNUM *a, int n)
{
 ...
 r->neg = a->neg;
 nw = n / 64;
 if ((((a->top + nw + 1) <= (r)->dmax)?(r):bn_expand2((r),(a->top + nw + 1))) == 
# 146 "bn/bn_shift.c" 3 4
                                      ((void *)0)
# 146 "bn/bn_shift.c"
                                          )
  return (0);
...
BN_rshift(BIGNUM *r, const BIGNUM *a, int n)
{
 ...
 i = (BN_num_bits(a) - n + (64 - 1)) / 64;
 if (r != a) {
  r->neg = a->neg;
  if ((((i) <= (r)->dmax)?(r):bn_expand2((r),(i))) == 
# 191 "bn/bn_shift.c" 3 4
                         ((void *)0)
# 191 "bn/bn_shift.c"
                             )
   return (0);
 ...
 if (rb == 0) {
  ...
  for (i = j - 1; i != 0; i--) {
   ...
   l = *(f++);
   *(t++) = (tmp|(l << lb)) & (0xffffffffffffffffL);
  }
  if ((l = (l >> rb) & (0xffffffffffffffffL)))
   *(t) = l;
 }
 ;
 return (1);
