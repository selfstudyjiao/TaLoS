...
# 81 "des/fcrypt.c"
 ...
 ll=out[0]; (*((b)++)=(unsigned char)(((ll) )&0xff), *((b)++)=(unsigned char)(((ll)>> 8L)&0xff), *((b)++)=(unsigned char)(((ll)>>16L)&0xff), *((b)++)=(unsigned char)(((ll)>>24L)&0xff));
 ll=out[1]; (*((b)++)=(unsigned char)(((ll) )&0xff), *((b)++)=(unsigned char)(((ll)>> 8L)&0xff), *((b)++)=(unsigned char)(((ll)>>16L)&0xff), *((b)++)=(unsigned char)(((ll)>>24L)&0xff));
 y=0;
 u=0x80;
 bb[8]=0;
 for (i=2; i<13; i++)
