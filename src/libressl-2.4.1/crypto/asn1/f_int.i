...
# 110 "asn1/f_int.c"
 ...
 for (;;) {
  ...
  i -= again;
  if (i % 2 != 0) {
   ERR_put_error(13,(102),(145),"asn1/f_int.c",157)
                                  ;
   goto err;
  }
  i /= 2;
  if (num + i > slen) {
   sp = CRYPTO_realloc_clean(s,slen,num + i,"asn1/f_int.c",162);
   if (sp == 
# 163 "asn1/f_int.c" 3 4
            ((void *)0)
# 163 "asn1/f_int.c"
                ) {
    ERR_put_error(13,(102),((1|64)),"asn1/f_int.c",165)
                             ;
    goto err;
   }
   s = sp;
  ...
  for (j = 0; j < i; j++, k += 2) {
   for (n = 0; n < 2; n++) {
    ...
    if ((m >= '0') && (m <= '9'))
     ...
     ERR_put_error(13,(102),(141),"asn1/f_int.c",182)
                                   ;
     goto err;
    }
    s[num + j] <<= 4;
...
err_sl:
 ERR_put_error(13,(102),(150),"asn1/f_int.c",200);
err:
 free(s);
 return (ret);
}
