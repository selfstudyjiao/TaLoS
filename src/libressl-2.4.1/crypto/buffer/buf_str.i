...
{
 char *ret = 
# 42 "buffer/buf_str.c" 3 4
            ((void *)0)
# 42 "buffer/buf_str.c"
                ;

 if (str != 
# 44 "buffer/buf_str.c" 3 4
           ((void *)0)
# 44 "buffer/buf_str.c"
               ) {
  if (!(ret = my_strdup(str)))
   ERR_put_error(7,(102),((1|64)),"buffer/buf_str.c",46);
 }
 return ret;
}
...
{
 char *ret = 
# 54 "buffer/buf_str.c" 3 4
            ((void *)0)
# 54 "buffer/buf_str.c"
                ;

 if (str != 
# 56 "buffer/buf_str.c" 3 4
           ((void *)0)
# 56 "buffer/buf_str.c"
               ) {
  if (!(ret = my_strndup(str, siz)))
   ERR_put_error(7,(104),((1|64)),"buffer/buf_str.c",58);
 }
 return ret;
}
...
{
 void *ret = 
# 66 "buffer/buf_str.c" 3 4
            ((void *)0)
# 66 "buffer/buf_str.c"
                ;

 if (data != 
# 68 "buffer/buf_str.c" 3 4
            ((void *)0)
# 68 "buffer/buf_str.c"
                ) {
  if (!(ret = malloc(siz)))
   ERR_put_error(7,(103),((1|64)),"buffer/buf_str.c",70);
  else
