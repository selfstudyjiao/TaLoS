...
# 63 "x509v3/pcy_tree.c" 2
# 139 "x509v3/pcy_tree.c"
static int
tree_init(X509_POLICY_TREE **ptree, struct stack_st_X509 *certs, unsigned int flags)
{
 X509_POLICY_TREE *tree;
 X509_POLICY_LEVEL *level;
 const X509_POLICY_CACHE *cache;
 X509_POLICY_DATA *data = 
# 145 "x509v3/pcy_tree.c" 3 4
                         ((void *)0)
# 145 "x509v3/pcy_tree.c"
                             ;
 X509 *x;
 int ret = 1;
 int i, n;
 ...
 *ptree = 
# 153 "x509v3/pcy_tree.c" 3 4
         ((void *)0)
# 153 "x509v3/pcy_tree.c"
             ;
 n = sk_num(((_STACK*) (1 ? (certs) : (struct stack_st_X509*)0)));
 ...
 for (i = n - 2; i >= 0; i--) {
  x = ((X509 *)sk_value(((_STACK*) (1 ? (certs) : (struct stack_st_X509*)0)), (i)));
  X509_check_purpose(x, -1, -1);
  cache = policy_cache_set(x);

  if (cache == 
# 183 "x509v3/pcy_tree.c" 3 4
              ((void *)0)
# 183 "x509v3/pcy_tree.c"
                  )
   return 0;
 ...
 tree->nlevel = 0;
 tree->extra_data = 
# 219 "x509v3/pcy_tree.c" 3 4
                   ((void *)0)
# 219 "x509v3/pcy_tree.c"
                       ;
 tree->auth_policies = 
# 220 "x509v3/pcy_tree.c" 3 4
                      ((void *)0)
# 220 "x509v3/pcy_tree.c"
                          ;
 tree->user_policies = 
# 221 "x509v3/pcy_tree.c" 3 4
                      ((void *)0)
# 221 "x509v3/pcy_tree.c"
                          ;
...
# 234 "x509v3/pcy_tree.c" 3 4
                       ((void *)0)
# 234 "x509v3/pcy_tree.c"
                           , OBJ_nid2obj(746), 0);

 if (!data || !level_add_node(level, data, 
# 236 "x509v3/pcy_tree.c" 3 4
                                          ((void *)0)
# 236 "x509v3/pcy_tree.c"
                                              , tree, 
# 236 "x509v3/pcy_tree.c" 3 4
                                                      ((void *)0)
# 236 "x509v3/pcy_tree.c"
 ...
 for (i = n - 2; i >= 0; i--) {
  ...
  x = ((X509 *)sk_value(((_STACK*) (1 ? (certs) : (struct stack_st_X509*)0)), (i)));
  cache = policy_cache_set(x);
  CRYPTO_add_lock(&x->references,1,3,"x509v3/pcy_tree.c",243);
  level->cert = x;
...
tree_link_matching_nodes(X509_POLICY_LEVEL *curr, const X509_POLICY_DATA *data)
{
 ...
 for (i = 0; i < sk_num(((_STACK*) (1 ? (last->nodes) : (struct stack_st_X509_POLICY_NODE*)0))); i++) {
  node = ((X509_POLICY_NODE *)sk_value(((_STACK*) (1 ? (last->nodes) : (struct stack_st_X509_POLICY_NODE*)0)), (i)));
  if (policy_node_match(last, node, data->valid_policy)) {
   if (!level_add_node(curr, data, node, 
# 300 "x509v3/pcy_tree.c" 3 4
                                        ((void *)0)
# 300 "x509v3/pcy_tree.c"
                                            , 
# 300 "x509v3/pcy_tree.c" 3 4
                                              ((void *)0)
# 300 "x509v3/pcy_tree.c"
 ...
 if (!matched && last->anyPolicy) {
  if (!level_add_node(curr, data, last->anyPolicy, 
# 306 "x509v3/pcy_tree.c" 3 4
                                                  ((void *)0)
# 306 "x509v3/pcy_tree.c"
                                                      , 
# 306 "x509v3/pcy_tree.c" 3 4
                                                        ((void *)0)
# 306 "x509v3/pcy_tree.c"
...
tree_link_nodes(X509_POLICY_LEVEL *curr, const X509_POLICY_CACHE *cache)
{
 ...
 for (i = 0; i < sk_num(((_STACK*) (1 ? (cache->data) : (struct stack_st_X509_POLICY_DATA*)0))); i++) {
  data = ((X509_POLICY_DATA *)sk_value(((_STACK*) (1 ? (cache->data) : (struct stack_st_X509_POLICY_DATA*)0)), (i)));
    ...
    const ASN1_OBJECT *id, X509_POLICY_NODE *node, X509_POLICY_TREE *tree)
{
 ...
 if (id == 
# 343 "x509v3/pcy_tree.c" 3 4
          ((void *)0)
# 343 "x509v3/pcy_tree.c"
              )
 ...
 data = policy_data_new(
# 348 "x509v3/pcy_tree.c" 3 4
                       ((void *)0)
# 348 "x509v3/pcy_tree.c"
                           , id, (node->data->flags & 0x10));

 if (data == 
# 350 "x509v3/pcy_tree.c" 3 4
            ((void *)0)
# 350 "x509v3/pcy_tree.c"
                )
  return 0;
...
# 355 "x509v3/pcy_tree.c" 3 4
                                            ((void *)0)
# 355 "x509v3/pcy_tree.c"
                                                )) {
    ...
    X509_POLICY_NODE *node, X509_POLICY_TREE *tree)
{
 ...
 if ((last->flags & 0x400) ||
  ...
  if (node->nchild)
   return 1;
  if (!tree_add_unmatched(curr, cache, 
# 375 "x509v3/pcy_tree.c" 3 4
                                      ((void *)0)
# 375 "x509v3/pcy_tree.c"
                                          , node, tree))
   return 0;

 } else {

  struct stack_st_ASN1_OBJECT *expset = node->data->expected_policy_set;
  if (node->nchild == sk_num(((_STACK*) (1 ? (expset) : (struct stack_st_ASN1_OBJECT*)0))))
   return 1;

  for (i = 0; i < sk_num(((_STACK*) (1 ? (expset) : (struct stack_st_ASN1_OBJECT*)0))); i++) {
   ASN1_OBJECT *oid = ((ASN1_OBJECT *)sk_value(((_STACK*) (1 ? (expset) : (struct stack_st_ASN1_OBJECT*)0)), (i)));
    ...
    X509_POLICY_TREE *tree)
{
 ...
 if (last->anyPolicy) {
  if (!level_add_node(curr, cache->anyPolicy,
      last->anyPolicy, 
# 413 "x509v3/pcy_tree.c" 3 4
                      ((void *)0)
# 413 "x509v3/pcy_tree.c"
                          , 
# 413 "x509v3/pcy_tree.c" 3 4
                            ((void *)0)
# 413 "x509v3/pcy_tree.c"
...
tree_prune(X509_POLICY_TREE *tree, X509_POLICY_LEVEL *curr)
{
 ...
 nodes = curr->nodes;
 if (curr->flags & 0x400) {
  for (i = sk_num(((_STACK*) (1 ? (nodes) : (struct stack_st_X509_POLICY_NODE*)0))) - 1; i >= 0; i--) {
   node = ((X509_POLICY_NODE *)sk_value(((_STACK*) (1 ? (nodes) : (struct stack_st_X509_POLICY_NODE*)0)), (i)));

   if (node->data->flags & 0x3) {
    node->parent->nchild--;
    free(node);
    (void)(X509_POLICY_NODE *)sk_delete(((_STACK*) (1 ? (nodes) : (struct stack_st_X509_POLICY_NODE*)0)), (i));
   }
  }
 }
 ...
 for (;;) {
  ...
  if (curr->anyPolicy && !curr->anyPolicy->nchild) {
   ...
   free(curr->anyPolicy);
   curr->anyPolicy = 
# 459 "x509v3/pcy_tree.c" 3 4
                    ((void *)0)
# 459 "x509v3/pcy_tree.c"
                        ;
  }
  if (curr == tree->levels) {
...
static int
tree_add_auth_node(struct stack_st_X509_POLICY_NODE **pnodes, X509_POLICY_NODE *pcy)
{
 if (!*pnodes) {
 ...
 if (!sk_push(((_STACK*) (1 ? (*pnodes) : (struct stack_st_X509_POLICY_NODE*)0)), ((void*) (1 ? (pcy) : (X509_POLICY_NODE*)0))))
  return 0;

 return 1;
}
# 497 "x509v3/pcy_tree.c"
static int
tree_calculate_authority_set(X509_POLICY_TREE *tree,
    struct stack_st_X509_POLICY_NODE **pnodes)
{
 X509_POLICY_LEVEL *curr;
 X509_POLICY_NODE *node, *anyptr;
 struct stack_st_X509_POLICY_NODE **addnodes;
 int i, j;
 ...
 for (i = 1; i < tree->nlevel; i++) {
  ...
  if (!(anyptr = curr->anyPolicy))
   break;
  curr++;
  for (j = 0; j < sk_num(((_STACK*) (1 ? (curr->nodes) : (struct stack_st_X509_POLICY_NODE*)0))); j++) {
   node = ((X509_POLICY_NODE *)sk_value(((_STACK*) (1 ? (curr->nodes) : (struct stack_st_X509_POLICY_NODE*)0)), (j)));
...
tree_calculate_user_set(X509_POLICY_TREE *tree,
    struct stack_st_ASN1_OBJECT *policy_oids, struct stack_st_X509_POLICY_NODE *auth_nodes)
{
 int i;
 X509_POLICY_NODE *node;
 ASN1_OBJECT *oid;
 ...
 if (sk_num(((_STACK*) (1 ? (policy_oids) : (struct stack_st_ASN1_OBJECT*)0))) <= 0)
  return 1;

 anyPolicy = tree->levels[tree->nlevel - 1].anyPolicy;

 for (i = 0; i < sk_num(((_STACK*) (1 ? (policy_oids) : (struct stack_st_ASN1_OBJECT*)0))); i++) {
  oid = ((ASN1_OBJECT *)sk_value(((_STACK*) (1 ? (policy_oids) : (struct stack_st_ASN1_OBJECT*)0)), (i)));
  if (OBJ_obj2nid(oid) == 746) {
   tree->flags |= 0x2;
   return 1;
  }
 }
 ...
 for (i = 0; i < sk_num(((_STACK*) (1 ? (policy_oids) : (struct stack_st_ASN1_OBJECT*)0))); i++) {
  ...
  if (!node) {
   ...
   extra = policy_data_new(
# 577 "x509v3/pcy_tree.c" 3 4
                          ((void *)0)
# 577 "x509v3/pcy_tree.c"
                              , oid,
       (anyPolicy->data->flags & 0x10));
   if (!extra)
    return 0;
   ...
   extra->flags = 0x4 |
       0x8;
   (void) level_add_node(
# 584 "x509v3/pcy_tree.c" 3 4
                        ((void *)0)
# 584 "x509v3/pcy_tree.c"
                            , extra, anyPolicy->parent,
       tree, &node);
  }
  if (!tree->user_policies) {
   tree->user_policies = ((struct stack_st_X509_POLICY_NODE *)sk_new_null());
   if (!tree->user_policies)
    return 1;
  }
  if (!sk_push(((_STACK*) (1 ? (tree->user_policies) : (struct stack_st_X509_POLICY_NODE*)0)), ((void*) (1 ? (node) : (X509_POLICY_NODE*)0))))
   return 0;
 }
 return 1;
}
...
{
 if (node->data && (node->data->flags & 0x8))
  free(node);
}
...
X509_policy_tree_free(X509_POLICY_TREE *tree)
{
 ...
 sk_free(((_STACK*) (1 ? (tree->auth_policies) : (struct stack_st_X509_POLICY_NODE*)0)));
 sk_pop_free(((_STACK*) (1 ? (tree->user_policies) : (struct stack_st_X509_POLICY_NODE*)0)), ((void (*)(void *)) ((1 ? (exnode_free) : (void (*)(X509_POLICY_NODE *))0))));

 for (i = 0, curr = tree->levels; i < tree->nlevel; i++, curr++) {
  X509_free(curr->cert);
  if (curr->nodes)
   sk_pop_free(((_STACK*) (1 ? (curr->nodes) : (struct stack_st_X509_POLICY_NODE*)0)), ((void (*)(void *)) ((1 ? (policy_node_free) : (void (*)(X509_POLICY_NODE *))0))))
                       ;
  if (curr->anyPolicy)
 ...
 if (tree->extra_data)
  sk_pop_free(((_STACK*) (1 ? (tree->extra_data) : (struct stack_st_X509_POLICY_DATA*)0)), ((void (*)(void *)) ((1 ? (policy_data_free) : (void (*)(X509_POLICY_DATA *))0))))
                       ;

 free(tree->levels);
 free(tree);
}
# 666 "x509v3/pcy_tree.c"
int
X509_policy_check(X509_POLICY_TREE **ptree, int *pexplicit_policy,
    struct stack_st_X509 *certs, struct stack_st_ASN1_OBJECT *policy_oids,
    unsigned int flags)
{
 int ret, ret2;
 X509_POLICY_TREE *tree = 
# 672 "x509v3/pcy_tree.c" 3 4
                         ((void *)0)
# 672 "x509v3/pcy_tree.c"
                             ;
 struct stack_st_X509_POLICY_NODE *nodes, *auth_nodes = 
# 673 "x509v3/pcy_tree.c" 3 4
                                                 ((void *)0)
# 673 "x509v3/pcy_tree.c"
                                                     ;

 *ptree = 
# 675 "x509v3/pcy_tree.c" 3 4
         ((void *)0)
# 675 "x509v3/pcy_tree.c"
             ;
 *pexplicit_policy = 0;
...
# 716 "x509v3/pcy_tree.c"
 ...
 if (ret == 2)
  sk_free(((_STACK*) (1 ? (auth_nodes) : (struct stack_st_X509_POLICY_NODE*)0)));
 ...
 if (*pexplicit_policy) {
  ...
  if (sk_num(((_STACK*) (1 ? (nodes) : (struct stack_st_X509_POLICY_NODE*)0))) <= 0)
   return -2;
 }
