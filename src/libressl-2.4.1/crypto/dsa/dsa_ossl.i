...
# 135 "dsa/dsa_ossl.c"
 ...
 BIGNUM xr;
 BN_CTX *ctx = 
# 138 "dsa/dsa_ossl.c" 3 4
              ((void *)0)
# 138 "dsa/dsa_ossl.c"
                  ;
 int reason = 3;
 DSA_SIG *ret = 
# 140 "dsa/dsa_ossl.c" 3 4
               ((void *)0)
# 140 "dsa/dsa_ossl.c"
                   ;
 int noredo = 0;
...
# 158 "dsa/dsa_ossl.c"
  ...
  kinv = dsa->kinv;
  dsa->kinv = 
# 163 "dsa/dsa_ossl.c" 3 4
             ((void *)0)
# 163 "dsa/dsa_ossl.c"
                 ;
  r = dsa->r;
  dsa->r = 
# 165 "dsa/dsa_ossl.c" 3 4
          ((void *)0)
# 165 "dsa/dsa_ossl.c"
              ;
  noredo = 1;
 ...
 if (dlen > ((BN_num_bits(dsa->q)+7)/8))
  dlen = ((BN_num_bits(dsa->q)+7)/8);
 if (BN_bin2bn(dgst,dlen,&m) == 
# 177 "dsa/dsa_ossl.c" 3 4
                               ((void *)0)
# 177 "dsa/dsa_ossl.c"
                                   )
  goto err;
...
err:
 if (!ret) {
  ERR_put_error(10,(112),(reason),"dsa/dsa_ossl.c",210);
  BN_free(r);
  BN_free(s);
 }
 BN_CTX_free(ctx);
...
# 225 "dsa/dsa_ossl.c"
 ...
 if (!dsa->p || !dsa->q || !dsa->g) {
  ERR_put_error(10,(107),(101),"dsa/dsa_ossl.c",229);
  return 0;
 }
 ...
 if (ctx_in == 
# 236 "dsa/dsa_ossl.c" 3 4
              ((void *)0)
# 236 "dsa/dsa_ossl.c"
                  ) {
  if ((ctx = BN_CTX_new()) == 
# 237 "dsa/dsa_ossl.c" 3 4
                             ((void *)0)
# 237 "dsa/dsa_ossl.c"
                                 )
   goto err;
...
# 272 "dsa/dsa_ossl.c"
 ...
 do { int _tmp_res53; if ((dsa)->meth->bn_mod_exp) _tmp_res53 = (dsa)->meth->bn_mod_exp((dsa), (r), (dsa->g), (K), (dsa->p), (ctx), (dsa->method_mont_p)); else _tmp_res53 = BN_mod_exp_mont((r), (dsa->g), (K), (dsa->p), (ctx), (dsa->method_mont_p)); if (!_tmp_res53) goto err; } while(0)
                        ;
 if (!BN_div(
# 290 "dsa/dsa_ossl.c" 3 4
     ((void *)0)
# 290 "dsa/dsa_ossl.c"
     ,(r),(r),(dsa->q),(ctx)))
  goto err;
 ...
 if ((kinv = BN_mod_inverse(
# 294 "dsa/dsa_ossl.c" 3 4
                           ((void *)0)
# 294 "dsa/dsa_ossl.c"
                               , &k, dsa->q, ctx)) == 
# 294 "dsa/dsa_ossl.c" 3 4
...
err:
 if (!ret) {
  ERR_put_error(10,(107),(3),"dsa/dsa_ossl.c",305);
  BN_clear_free(r);
 }
 if (ctx_in == 
# 308 "dsa/dsa_ossl.c" 3 4
              ((void *)0)
# 308 "dsa/dsa_ossl.c"
                  )
  BN_CTX_free(ctx);
...
# 320 "dsa/dsa_ossl.c"
 ...
 if (!dsa->p || !dsa->q || !dsa->g) {
  ERR_put_error(10,(113),(101),"dsa/dsa_ossl.c",324);
  return -1;
 }
 ...
 if (i != 160 && i != 224 && i != 256) {
  ERR_put_error(10,(113),(102),"dsa/dsa_ossl.c",331);
  return -1;
 }

 if (BN_num_bits(dsa->p) > 10000) {
  ERR_put_error(10,(113),(103),"dsa/dsa_ossl.c",336);
  return -1;
 }
 BN_init(&u1);
 BN_init(&u2);
...
# 343 "dsa/dsa_ossl.c"
 ...
 if (BN_is_zero(sig->s) || ((sig->s)->neg != 0) ||
...
# 359 "dsa/dsa_ossl.c"
 ...
 if (dgst_len > (i >> 3))
  dgst_len = (i >> 3);
 if (BN_bin2bn(dgst, dgst_len, &u1) == 
# 370 "dsa/dsa_ossl.c" 3 4
                                      ((void *)0)
# 370 "dsa/dsa_ossl.c"
                                          )
  goto err;
 ...
 do { int _tmp_res53; if ((dsa)->meth->dsa_mod_exp) _tmp_res53 = (dsa)->meth->dsa_mod_exp((dsa), (&t1), (dsa->g), (&u1), (dsa->pub_key), (&u2), (dsa->p), (ctx), (mont)); else _tmp_res53 = BN_mod_exp2_mont((&t1), (dsa->g), (&u1), (dsa->pub_key), (&u2), (dsa->p), (ctx), (mont)); if (!_tmp_res53) goto err; } while(0)
               ;


 if (!BN_div(
# 393 "dsa/dsa_ossl.c" 3 4
     ((void *)0)
# 393 "dsa/dsa_ossl.c"
     ,(&u1),(&t1),(dsa->q),(ctx)))
  goto err;
...
err:
 if (ret < 0)
  ERR_put_error(10,(113),(3),"dsa/dsa_ossl.c",402);
 BN_CTX_free(ctx);
 BN_free(&u1);
 BN_free(&u2);
 BN_free(&t1);
