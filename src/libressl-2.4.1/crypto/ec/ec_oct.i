    ...
    const BIGNUM * x, int y_bit, BN_CTX * ctx)
{
 if (group->meth->point_set_compressed_coordinates == 0
     && !(group->meth->flags & 0x1)) {
  ERR_put_error(16,(125),((2|64)),"ec/ec_oct.c",79);
  return 0;
 }
 if (group->meth != point->meth) {
  ERR_put_error(16,(125),(101),"ec/ec_oct.c",83);
  return 0;
 }
 if (group->meth->flags & 0x1) {
  if (group->meth->field_type == 406)
    ...
    const BIGNUM * x, int y_bit, BN_CTX * ctx)
{
 if (group->meth->point_set_compressed_coordinates == 0
     && !(group->meth->flags & 0x1)) {
  ERR_put_error(16,(186),((2|64)),"ec/ec_oct.c",111);
  return 0;
 }
 if (group->meth != point->meth) {
  ERR_put_error(16,(186),(101),"ec/ec_oct.c",115);
  return 0;
 }
 if (group->meth->flags & 0x1) {
  if (group->meth->field_type == 406)
    ...
    unsigned char *buf, size_t len, BN_CTX *ctx)
{
 if (group->meth->point2oct == 0
     && !(group->meth->flags & 0x1)) {
  ERR_put_error(16,(123),((2|64)),"ec/ec_oct.c",137);
  return 0;
 }
 if (group->meth != point->meth) {
  ERR_put_error(16,(123),(101),"ec/ec_oct.c",141);
  return 0;
 }
 if (group->meth->flags & 0x1) {
  if (group->meth->field_type == 406)
    ...
    const unsigned char *buf, size_t len, BN_CTX *ctx)
{
 if (group->meth->oct2point == 0 &&
     !(group->meth->flags & 0x1)) {
  ERR_put_error(16,(122),((2|64)),"ec/ec_oct.c",169);
  return 0;
 }
 if (group->meth != point->meth) {
  ERR_put_error(16,(122),(101),"ec/ec_oct.c",173);
  return 0;
 }
 if (group->meth->flags & 0x1) {
  if (group->meth->field_type == 406)
