...
# 74 "evp/p_verify.c"
 ...
 if (ctx->digest->flags & 0x0004) {
  i = -1;
  pkctx = EVP_PKEY_CTX_new(pkey, 
# 85 "evp/p_verify.c" 3 4
                                ((void *)0)
# 85 "evp/p_verify.c"
                                    );
  if (!pkctx)
  ...
  if (EVP_PKEY_verify_init(pkctx) <= 0)
   goto err;
  if (EVP_PKEY_CTX_ctrl(pkctx, -1, ((1<<3) | (1<<4) | (1<<5) | (1<<6) | (1<<7)), 1, 0, (void *)ctx->digest) <= 0)
   goto err;
...
err:
 ...
 if (!ok) {
  ERR_put_error(6,(108),(110),"evp/p_verify.c",108);
  return (-1);
 }
 if (ctx->digest->verify == 
# 111 "evp/p_verify.c" 3 4
                           ((void *)0)
# 111 "evp/p_verify.c"
                               ) {
  ERR_put_error(6,(108),(105),"evp/p_verify.c",113)
                                          ;
  return (0);
 }
