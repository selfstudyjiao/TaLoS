    ...
    int flen)
{
 ...
 if (j < 0) {
  ERR_put_error(4,(127),(110),"rsa/rsa_x931.c",82)
                                        ;
  return -1;
 }
    ...
    int flen, int num)
{
 ...
 if (num != flen || (*p != 0x6A && *p != 0x6B)) {
  ERR_put_error(4,(128),(137),"rsa/rsa_x931.c",113);
  return -1;
 }
 ...
 if (*p++ == 0x6B) {
  ...
  for (i = 0; i < j; i++) {
   ...
   if (c == 0xBA)
    break;
   if (c != 0xBB) {
    ERR_put_error(4,(128),(138),"rsa/rsa_x931.c",125)
                              ;
    return -1;
   }
  }
  ...
  if (i == 0) {
   ERR_put_error(4,(128),(138),"rsa/rsa_x931.c",132)
                             ;
   return -1;
  }
 ...
 if (j < 0 || p[j] != 0xCC) {
  ERR_put_error(4,(128),(139),"rsa/rsa_x931.c",141);
  return -1;
 }
