...
int
X509v3_get_ext_count(const struct stack_st_X509_EXTENSION *x)
{
 if (x == 
# 72 "x509/x509_v3.c" 3 4
         ((void *)0)
# 72 "x509/x509_v3.c"
             )
  return (0);
 return (sk_num(((_STACK*) (1 ? (x) : (struct stack_st_X509_EXTENSION*)0))));
}

int
X509v3_get_ext_by_NID(const struct stack_st_X509_EXTENSION *x, int nid, int lastpos)
{
 ASN1_OBJECT *obj;

 obj = OBJ_nid2obj(nid);
 if (obj == 
# 83 "x509/x509_v3.c" 3 4
           ((void *)0)
# 83 "x509/x509_v3.c"
               )
  return (-2);
...
int
X509v3_get_ext_by_OBJ(const struct stack_st_X509_EXTENSION *sk, ASN1_OBJECT *obj,
    int lastpos)
{
 int n;
 X509_EXTENSION *ex;
...
# 95 "x509/x509_v3.c"
 ...
 if (lastpos < 0)
  lastpos = 0;
 n = sk_num(((_STACK*) (1 ? (sk) : (struct stack_st_X509_EXTENSION*)0)));
 for (; lastpos < n; lastpos++) {
  ex = ((X509_EXTENSION *)sk_value(((_STACK*) (1 ? (sk) : (struct stack_st_X509_EXTENSION*)0)), (lastpos)));
...
int
X509v3_get_ext_by_critical(const struct stack_st_X509_EXTENSION *sk, int crit,
    int lastpos)
{
 int n;
 X509_EXTENSION *ex;
...
X509_EXTENSION *
X509v3_get_ext(const struct stack_st_X509_EXTENSION *x, int loc)
{
 if (x == 
# 134 "x509/x509_v3.c" 3 4
         ((void *)0) 
# 134 "x509/x509_v3.c"
              || sk_num(((_STACK*) (1 ? (x) : (struct stack_st_X509_EXTENSION*)0))) <= loc || loc < 0)
  return 
# 135 "x509/x509_v3.c" 3 4
        ((void *)0)
# 135 "x509/x509_v3.c"
            ;
 else
  return ((X509_EXTENSION *)sk_value(((_STACK*) (1 ? (x) : (struct stack_st_X509_EXTENSION*)0)), (loc)));
}

X509_EXTENSION *
X509v3_delete_ext(struct stack_st_X509_EXTENSION *x, int loc)
{
 X509_EXTENSION *ret;

 if (x == 
# 145 "x509/x509_v3.c" 3 4
         ((void *)0) 
# 145 "x509/x509_v3.c"
              || sk_num(((_STACK*) (1 ? (x) : (struct stack_st_X509_EXTENSION*)0))) <= loc || loc < 0)
  return (
# 146 "x509/x509_v3.c" 3 4
         ((void *)0)
# 146 "x509/x509_v3.c"
             );
 ret = (X509_EXTENSION *)sk_delete(((_STACK*) (1 ? (x) : (struct stack_st_X509_EXTENSION*)0)), (loc));
 return (ret);
}

struct stack_st_X509_EXTENSION *
X509v3_add_ext(struct stack_st_X509_EXTENSION **x, X509_EXTENSION *ex, int loc)
{
 X509_EXTENSION *new_ex = 
# 154 "x509/x509_v3.c" 3 4
                         ((void *)0)
# 154 "x509/x509_v3.c"
                             ;
 int n;
 struct stack_st_X509_EXTENSION *sk = 
# 156 "x509/x509_v3.c" 3 4
                               ((void *)0)
# 156 "x509/x509_v3.c"
                                   ;

 if (x == 
# 158 "x509/x509_v3.c" 3 4
         ((void *)0)
# 158 "x509/x509_v3.c"
             ) {
  ERR_put_error(11,(104),((3|64)),"x509/x509_v3.c",159);
  goto err2;
 }

 if (*x == 
# 163 "x509/x509_v3.c" 3 4
          ((void *)0)
# 163 "x509/x509_v3.c"
              ) {
  if ((sk = ((struct stack_st_X509_EXTENSION *)sk_new_null())) == 
# 164 "x509/x509_v3.c" 3 4
                                            ((void *)0)
# 164 "x509/x509_v3.c"
                                                )
   goto err;
 ...
 if ((new_ex = X509_EXTENSION_dup(ex)) == 
# 175 "x509/x509_v3.c" 3 4
                                         ((void *)0)
# 175 "x509/x509_v3.c"
                                             )
  goto err2;
 if (!sk_insert(((_STACK*) (1 ? (sk) : (struct stack_st_X509_EXTENSION*)0)), ((void*) (1 ? (new_ex) : (X509_EXTENSION*)0)), (loc)))
  goto err;
 if (*x == 
# 179 "x509/x509_v3.c" 3 4
          ((void *)0)
# 179 "x509/x509_v3.c"
              )
  *x = sk;
...
err:
 ERR_put_error(11,(104),((1|64)),"x509/x509_v3.c",184);
err2:
 if (new_ex != 
# 186 "x509/x509_v3.c" 3 4
              ((void *)0)
# 186 "x509/x509_v3.c"
                  )
  X509_EXTENSION_free(new_ex);
 if (sk != 
# 188 "x509/x509_v3.c" 3 4
          ((void *)0) 
# 188 "x509/x509_v3.c"
               && (x != 
# 188 "x509/x509_v3.c" 3 4
...
# 188 "x509/x509_v3.c"
                             && sk != *x))
  sk_free(((_STACK*) (1 ? (sk) : (struct stack_st_X509_EXTENSION*)0)));
 return (
# 190 "x509/x509_v3.c" 3 4
        ((void *)0)
# 190 "x509/x509_v3.c"
            );
}
    ...
    ASN1_OCTET_STRING *data)
{
 ...
 obj = OBJ_nid2obj(nid);
 if (obj == 
# 201 "x509/x509_v3.c" 3 4
           ((void *)0)
# 201 "x509/x509_v3.c"
               ) {
  ERR_put_error(11,(108),(109),"x509/x509_v3.c",203)
                         ;
  return (
# 204 "x509/x509_v3.c" 3 4
         ((void *)0)
# 204 "x509/x509_v3.c"
             );
 }
...
# 218 "x509/x509_v3.c"
  ...
  if ((ret = X509_EXTENSION_new()) == 
# 219 "x509/x509_v3.c" 3 4
                                     ((void *)0)
# 219 "x509/x509_v3.c"
                                         ) {
   ERR_put_error(11,(109),((1|64)),"x509/x509_v3.c",221)
                            ;
   return (
# 222 "x509/x509_v3.c" 3 4
          ((void *)0)
# 222 "x509/x509_v3.c"
              );
  }
...
err:
 if ((ex == 
# 239 "x509/x509_v3.c" 3 4
           ((void *)0)
# 239 "x509/x509_v3.c"
               ) || (ret != *ex))
  X509_EXTENSION_free(ret);
 return (
# 241 "x509/x509_v3.c" 3 4
        ((void *)0)
# 241 "x509/x509_v3.c"
            );
}
...
{
 if (ex == 
# 279 "x509/x509_v3.c" 3 4
          ((void *)0)
# 279 "x509/x509_v3.c"
              )
  return (
# 280 "x509/x509_v3.c" 3 4
         ((void *)0)
# 280 "x509/x509_v3.c"
             );
 return (ex->object);
...
{
 if (ex == 
# 287 "x509/x509_v3.c" 3 4
          ((void *)0)
# 287 "x509/x509_v3.c"
              )
  return (
# 288 "x509/x509_v3.c" 3 4
         ((void *)0)
# 288 "x509/x509_v3.c"
             );
 return (ex->value);
