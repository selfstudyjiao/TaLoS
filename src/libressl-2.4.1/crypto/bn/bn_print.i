...
BN_bn2hex(const BIGNUM *a)
{
 ...
 buf = malloc(((a)->neg != 0) + a->top * 8 * 2 + 2);
 if (buf == 
# 82 "bn/bn_print.c" 3 4
           ((void *)0)
# 82 "bn/bn_print.c"
               ) {
  ERR_put_error(3,(105),((1|64)),"bn/bn_print.c",83);
  goto err;
 }
 p = buf;
 if (((a)->neg != 0))
...
BN_bn2dec(const BIGNUM *a)
{
 int i = 0, num, ok = 0;
 char *buf = 
# 113 "bn/bn_print.c" 3 4
            ((void *)0)
# 113 "bn/bn_print.c"
                ;
 char *p;
 BIGNUM *t = 
# 115 "bn/bn_print.c" 3 4
            ((void *)0)
# 115 "bn/bn_print.c"
                ;
 unsigned long *bn_data = 
# 116 "bn/bn_print.c" 3 4
                    ((void *)0)
# 116 "bn/bn_print.c"
                        , *lp;

 if (BN_is_zero(a)) {
  buf = malloc(((a)->neg != 0) + 2);
  if (buf == 
# 120 "bn/bn_print.c" 3 4
            ((void *)0)
# 120 "bn/bn_print.c"
                ) {
   ERR_put_error(3,(104),((1|64)),"bn/bn_print.c",121);
   goto err;
  }
  p = buf;
  if (((a)->neg != 0))
 ...
 i = BN_num_bits(a) * 3;
 num = (i / 10 + i / 1000 + 1) + 1;
 bn_data = reallocarray(
# 139 "bn/bn_print.c" 3 4
                       ((void *)0)
# 139 "bn/bn_print.c"
                           , num / 19 + 1, sizeof(unsigned long));
 buf = malloc(num + 3);
 if ((buf == 
# 141 "bn/bn_print.c" 3 4
            ((void *)0)
# 141 "bn/bn_print.c"
                ) || (bn_data == 
# 141 "bn/bn_print.c" 3 4
...
# 141 "bn/bn_print.c"
  ...
  ERR_put_error(3,(104),((1|64)),"bn/bn_print.c",142);
  goto err;
 }
 if ((t = BN_dup(a)) == 
# 145 "bn/bn_print.c" 3 4
                       ((void *)0)
# 145 "bn/bn_print.c"
                           )
  goto err;
 ...
 i = 0;
 while (!BN_is_zero(t)) {
  *lp = BN_div_word(t, (10000000000000000000UL));
  lp++;
 }
 lp--;
 ...
 snprintf(p, (num+3 - (size_t)(p - buf)), "%lu", *lp);
 while (*p)
  p++;
 while (lp != bn_data) {
  lp--;
  snprintf(p, (num+3 - (size_t)(p - buf)), "%019lu", *lp);
  while (*p)
   p++;
 }
 ok = 1;
...
# 193 "bn/bn_print.c"
 ...
 for (i = 0; i <= (0x7fffffff / 4) && 
# 201 "bn/bn_print.c" 3 4
                                  ((*__ctype_b_loc ())[(int) ((
# 201 "bn/bn_print.c"
                                  (unsigned char)a[i]
# 201 "bn/bn_print.c" 3 4
...
# 207 "bn/bn_print.c"
 ...
 if (*bn == 
# 211 "bn/bn_print.c" 3 4
           ((void *)0)
# 211 "bn/bn_print.c"
               ) {
  if ((ret = BN_new()) == 
# 212 "bn/bn_print.c" 3 4
                         ((void *)0)
# 212 "bn/bn_print.c"
                             )
   return (0);
...
# 288 "bn/bn_print.c"
 ...
 if (*bn == 
# 293 "bn/bn_print.c" 3 4
           ((void *)0)
# 293 "bn/bn_print.c"
               ) {
  if ((ret = BN_new()) == 
# 294 "bn/bn_print.c" 3 4
                         ((void *)0)
# 294 "bn/bn_print.c"
                             )
   return (0);
...
# 302 "bn/bn_print.c"
 ...
 while (*a) {
  ...
  a++;
  if (++j == 19) {
   BN_mul_word(ret, (10000000000000000000UL));
   BN_add_word(ret, l);
   l = 0;
   j = 0;
  }
...
BN_options(void)
{
 ...
 if (!init) {
  ...
  snprintf(data,sizeof data, "bn(%d,%d)",
      (int)sizeof(unsigned long) * 8, (int)sizeof(unsigned long) * 8);
