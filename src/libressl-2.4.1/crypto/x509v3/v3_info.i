...
# 67 "x509v3/v3_info.c" 2

static struct stack_st_CONF_VALUE *i2v_AUTHORITY_INFO_ACCESS(
...
static AUTHORITY_INFO_ACCESS *v2i_AUTHORITY_INFO_ACCESS(
    X509V3_EXT_METHOD *method, X509V3_CTX *ctx, struct stack_st_CONF_VALUE *nval);
...
const X509V3_EXT_METHOD v3_info = {
 ...
 .ext_new = 
# 78 "x509v3/v3_info.c" 3 4
           ((void *)0)
# 78 "x509v3/v3_info.c"
               ,
 .ext_free = 
# 79 "x509v3/v3_info.c" 3 4
            ((void *)0)
# 79 "x509v3/v3_info.c"
                ,
 .d2i = 
# 80 "x509v3/v3_info.c" 3 4
       ((void *)0)
# 80 "x509v3/v3_info.c"
           ,
 .i2d = 
# 81 "x509v3/v3_info.c" 3 4
       ((void *)0)
# 81 "x509v3/v3_info.c"
           ,
 .i2s = 
# 82 "x509v3/v3_info.c" 3 4
       ((void *)0)
# 82 "x509v3/v3_info.c"
           ,
 .s2i = 
# 83 "x509v3/v3_info.c" 3 4
       ((void *)0)
# 83 "x509v3/v3_info.c"
           ,
 ...
 .i2r = 
# 86 "x509v3/v3_info.c" 3 4
       ((void *)0)
# 86 "x509v3/v3_info.c"
           ,
 .r2i = 
# 87 "x509v3/v3_info.c" 3 4
       ((void *)0)
# 87 "x509v3/v3_info.c"
           ,
 .usr_data = 
# 88 "x509v3/v3_info.c" 3 4
            ((void *)0)
# 88 "x509v3/v3_info.c"
                ,
};
...
const X509V3_EXT_METHOD v3_sinfo = {
 ...
 .it = (&(AUTHORITY_INFO_ACCESS_it)),
 .ext_new = 
# 95 "x509v3/v3_info.c" 3 4
           ((void *)0)
# 95 "x509v3/v3_info.c"
               ,
 .ext_free = 
# 96 "x509v3/v3_info.c" 3 4
            ((void *)0)
# 96 "x509v3/v3_info.c"
                ,
 .d2i = 
# 97 "x509v3/v3_info.c" 3 4
       ((void *)0)
# 97 "x509v3/v3_info.c"
           ,
 .i2d = 
# 98 "x509v3/v3_info.c" 3 4
       ((void *)0)
# 98 "x509v3/v3_info.c"
           ,
 .i2s = 
# 99 "x509v3/v3_info.c" 3 4
       ((void *)0)
# 99 "x509v3/v3_info.c"
           ,
 .s2i = 
# 100 "x509v3/v3_info.c" 3 4
       ((void *)0)
# 100 "x509v3/v3_info.c"
           ,
 .i2v = (X509V3_EXT_I2V)i2v_AUTHORITY_INFO_ACCESS,
 .v2i = (X509V3_EXT_V2I)v2i_AUTHORITY_INFO_ACCESS,
 .i2r = 
# 103 "x509v3/v3_info.c" 3 4
       ((void *)0)
# 103 "x509v3/v3_info.c"
           ,
 .r2i = 
# 104 "x509v3/v3_info.c" 3 4
       ((void *)0)
# 104 "x509v3/v3_info.c"
           ,
 .usr_data = 
# 105 "x509v3/v3_info.c" 3 4
            ((void *)0)
# 105 "x509v3/v3_info.c"
                ,
};
...
static const ASN1_TEMPLATE ACCESS_DESCRIPTION_seq_tt[] = {
 {
  ...
  .tag = 0,
  .offset = 
# 112 "x509v3/v3_info.c" 3 4
           __builtin_offsetof (
# 112 "x509v3/v3_info.c"
           ACCESS_DESCRIPTION
# 112 "x509v3/v3_info.c" 3 4
           , 
# 112 "x509v3/v3_info.c"
...
# 112 "x509v3/v3_info.c"
 ...
 },
 {
  ...
  .tag = 0,
  .offset = 
# 119 "x509v3/v3_info.c" 3 4
           __builtin_offsetof (
# 119 "x509v3/v3_info.c"
           ACCESS_DESCRIPTION
# 119 "x509v3/v3_info.c" 3 4
           , 
# 119 "x509v3/v3_info.c"
...
const ASN1_ITEM ACCESS_DESCRIPTION_it = {
 ...
 .funcs = 
# 130 "x509v3/v3_info.c" 3 4
         ((void *)0)
# 130 "x509v3/v3_info.c"
             ,
...
const ASN1_ITEM AUTHORITY_INFO_ACCESS_it = {
 ...
 .tcount = 0,
 .funcs = 
# 174 "x509v3/v3_info.c" 3 4
         ((void *)0)
# 174 "x509v3/v3_info.c"
             ,
 .size = 0,
...
i2v_AUTHORITY_INFO_ACCESS(X509V3_EXT_METHOD *method,
    AUTHORITY_INFO_ACCESS *ainfo, struct stack_st_CONF_VALUE *ret)
{
 ...
 for (i = 0; i < sk_num(((_STACK*) (1 ? (ainfo) : (struct stack_st_ACCESS_DESCRIPTION*)0))); i++) {
  desc = ((ACCESS_DESCRIPTION *)sk_value(((_STACK*) (1 ? (ainfo) : (struct stack_st_ACCESS_DESCRIPTION*)0)), (i)));
  ret = i2v_GENERAL_NAME(method, desc->location, ret);
  if (!ret)
   break;
  vtmp = ((CONF_VALUE *)sk_value(((_STACK*) (1 ? (ret) : (struct stack_st_CONF_VALUE*)0)), (i)));
  i2t_ASN1_OBJECT(objtmp, sizeof objtmp, desc->method);
  nlen = strlen(objtmp) + strlen(vtmp->name) + 5;
  ntmp = malloc(nlen);
  if (!ntmp) {
   ERR_put_error(34,(138),((1|64)),"x509v3/v3_info.c",225)
                            ;
   return 
# 226 "x509v3/v3_info.c" 3 4
         ((void *)0)
# 226 "x509v3/v3_info.c"
             ;
  }
...
# 244 "x509v3/v3_info.c" 3 4
                               ((void *)0)
# 244 "x509v3/v3_info.c"
                                   ;
 CONF_VALUE *cnf, ctmp;
 ...
 if (!(ainfo = ((struct stack_st_ACCESS_DESCRIPTION *)sk_new_null()))) {
  ERR_put_error(34,(139),((1|64)),"x509v3/v3_info.c",252)
                           ;
  return 
# 253 "x509v3/v3_info.c" 3 4
        ((void *)0)
# 253 "x509v3/v3_info.c"
            ;
 }
...
# 257 "x509v3/v3_info.c" 3 4
                                         ((void *)0)
# 257 "x509v3/v3_info.c"
                                             ) {
   ERR_put_error(34,(139),((1|64)),"x509v3/v3_info.c",259)
                            ;
   goto err;
  }
  if (sk_push(((_STACK*) (1 ? (ainfo) : (struct stack_st_ACCESS_DESCRIPTION*)0)), ((void*) (1 ? (acc) : (ACCESS_DESCRIPTION*)0))) == 0) {
   ACCESS_DESCRIPTION_free(acc);
   ERR_put_error(34,(139),((1|64)),"x509v3/v3_info.c",265)
                            ;
   goto err;
  }
  ptmp = 
# 268 "x509v3/v3_info.c" 3 4
        (__extension__ (__builtin_constant_p (
# 268 "x509v3/v3_info.c"
        ';'
# 268 "x509v3/v3_info.c" 3 4
...
# 268 "x509v3/v3_info.c"
                              ;
  if (!ptmp) {
   ERR_put_error(34,(139),(143),"x509v3/v3_info.c",271)
                               ;
   goto err;
  }
  ...
  if (!(objtmp = malloc(objlen + 1))) {
   ERR_put_error(34,(139),((1|64)),"x509v3/v3_info.c",281)
                            ;
   goto err;
  }
  ...
  if (!acc->method) {
   ERR_put_error(34,(139),(119),"x509v3/v3_info.c",288)
                           ;
...
err:
 sk_pop_free(((_STACK*) (1 ? (ainfo) : (struct stack_st_ACCESS_DESCRIPTION*)0)), ((void (*)(void *)) ((1 ? (ACCESS_DESCRIPTION_free) : (void (*)(ACCESS_DESCRIPTION *))0))));
 return 
# 299 "x509v3/v3_info.c" 3 4
       ((void *)0)
# 299 "x509v3/v3_info.c"
           ;
}
