...
# 75 "engine/eng_openssl.c" 2
# 1 "../include/openssl/rand.h" 1
# 59 "../include/openssl/rand.h"
# 1 "../include/compat/stdlib.h" 1
# 60 "../include/openssl/rand.h" 2
...
# 76 "engine/eng_openssl.c" 2
# 117 "engine/eng_openssl.c"
...
engine_openssl(void)
{
 ...
 if (!ret)
  return 
# 181 "engine/eng_openssl.c" 3 4
        ((void *)0)
# 181 "engine/eng_openssl.c"
            ;
 if (!bind_helper(ret)) {
  ENGINE_free(ret);
  return 
# 184 "engine/eng_openssl.c" 3 4
        ((void *)0)
# 184 "engine/eng_openssl.c"
            ;
 }
 return ret;
}
...
# 230 "engine/eng_openssl.c"
# 1 "../include/openssl/rc4.h" 1
# 62 "../include/openssl/rc4.h"
# 1 "../include/openssl/opensslconf.h" 1
# 1 "../include/openssl/opensslfeatures.h" 1
# 2 "../include/openssl/opensslconf.h" 2
# 63 "../include/openssl/rc4.h" 2
...
# 231 "engine/eng_openssl.c" 2

static int test_cipher_nids[] = {5, 97};
    ...
    const unsigned char *iv, int enc)
{
 ...
 my_fprintf(
# 252 "engine/eng_openssl.c" 3 4
           stderr
# 252 "engine/eng_openssl.c"
                 , "(TEST_ENG_OPENSSL_RC4) test_init_key() called\n");

 memcpy(&((TEST_RC4_KEY *)(ctx)->cipher_data)->key[0], key, EVP_CIPHER_CTX_key_length(ctx));
 RC4_set_key(&((TEST_RC4_KEY *)(ctx)->cipher_data)->ks, EVP_CIPHER_CTX_key_length(ctx),
     ((TEST_RC4_KEY *)(ctx)->cipher_data)->key);
 return 1;
}
    ...
    const unsigned char *in, size_t inl)
{
 ...
 RC4(&((TEST_RC4_KEY *)(ctx)->cipher_data)->ks, inl, in, out);
 return 1;
}
...
# 277 "engine/eng_openssl.c" 3 4
((void *)0)
# 277 "engine/eng_openssl.c"
    ,
 sizeof(TEST_RC4_KEY),
 
# 279 "engine/eng_openssl.c" 3 4
((void *)0)
# 279 "engine/eng_openssl.c"
    ,
 
# 280 "engine/eng_openssl.c" 3 4
((void *)0)
# 280 "engine/eng_openssl.c"
    ,
 
# 281 "engine/eng_openssl.c" 3 4
((void *)0)
# 281 "engine/eng_openssl.c"
    ,
 
# 282 "engine/eng_openssl.c" 3 4
((void *)0)

# 283 "engine/eng_openssl.c"
};
...
# 291 "engine/eng_openssl.c" 3 4
((void *)0)
# 291 "engine/eng_openssl.c"
    ,
 sizeof(TEST_RC4_KEY),
 
# 293 "engine/eng_openssl.c" 3 4
((void *)0)
# 293 "engine/eng_openssl.c"
    ,
 
# 294 "engine/eng_openssl.c" 3 4
((void *)0)
# 294 "engine/eng_openssl.c"
    ,
 
# 295 "engine/eng_openssl.c" 3 4
((void *)0)
# 295 "engine/eng_openssl.c"
    ,
 
# 296 "engine/eng_openssl.c" 3 4
((void *)0)

# 297 "engine/eng_openssl.c"
};
...
openssl_ciphers(ENGINE *e, const EVP_CIPHER **cipher, const int **nids, int nid)
{
  ...
  *cipher = 
# 317 "engine/eng_openssl.c" 3 4
           ((void *)0)
# 317 "engine/eng_openssl.c"
               ;
  return 0;
 }
 return 1;
...
# 1 "/usr/lib/gcc/x86_64-linux-gnu/5/include/stddef.h" 1 3 4
# 60 "../include/openssl/sha.h" 2
# 327 "engine/eng_openssl.c" 2
static int test_digest_nids[] = {64};
...
# 365 "engine/eng_openssl.c" 3 4
((void *)0)
# 365 "engine/eng_openssl.c"
    ,
 
# 366 "engine/eng_openssl.c" 3 4
((void *)0)
# 366 "engine/eng_openssl.c"
    ,
 (evp_sign_method *)RSA_sign, (evp_verify_method *)RSA_verify, {6,19,0,0},
 (16*4),
...
openssl_digests(ENGINE *e, const EVP_MD **digest, const int **nids, int nid)
{
  ...
  *digest = 
# 388 "engine/eng_openssl.c" 3 4
           ((void *)0)
# 388 "engine/eng_openssl.c"
               ;
  return 0;
 }
 return 1;
    ...
    void *callback_data)
{
 ...
 my_fprintf(
# 403 "engine/eng_openssl.c" 3 4
           stderr
# 403 "engine/eng_openssl.c"
                 , "(TEST_ENG_OPENSSL_PKEY)Loading Private key %s\n",
     key_id);
 in = BIO_new_file(key_id, "r");
 if (!in)
  return 
# 407 "engine/eng_openssl.c" 3 4
        ((void *)0)
# 407 "engine/eng_openssl.c"
            ;
 key = PEM_read_bio_PrivateKey(in, 
# 408 "engine/eng_openssl.c" 3 4
                                  ((void *)0)
# 408 "engine/eng_openssl.c"
                                      , 0, 
# 408 "engine/eng_openssl.c" 3 4
                                           ((void *)0)
# 408 "engine/eng_openssl.c"
