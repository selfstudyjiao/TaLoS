    ...
    int count, unsigned char *key, unsigned char *iv)
{
 ...
 if ((size_t)nkey > 64) {
  ERR_put_error(6,(200),(137),"evp/evp_key.c",138);
  return 0;
 }
 if ((size_t)niv > 16) {
  ERR_put_error(6,(200),(102),"evp/evp_key.c",142);
  return 0;
 }

 if (data == 
# 146 "evp/evp_key.c" 3 4
            ((void *)0)
# 146 "evp/evp_key.c"
                )
  return (nkey);
 ...
 EVP_MD_CTX_init(&c);
 for (;;) {
  if (!EVP_DigestInit_ex(&c, md, 
# 151 "evp/evp_key.c" 3 4
                                ((void *)0)
# 151 "evp/evp_key.c"
                                    ))
   goto err;
  ...
  if (!EVP_DigestUpdate(&c, data, datal))
   goto err;
  if (salt != 
# 158 "evp/evp_key.c" 3 4
             ((void *)0)
# 158 "evp/evp_key.c"
                 )
   if (!EVP_DigestUpdate(&c, salt, 8))
    goto err;
