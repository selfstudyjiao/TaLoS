...
sk_dup(_STACK *sk)
{
 ...
 if ((ret = sk_new(sk->comp)) == 
# 89 "stack/stack.c" 3 4
                                ((void *)0)
# 89 "stack/stack.c"
                                    )
  goto err;
...
sk_new(int (*c)(const void *, const void *))
{
 ...
 if ((ret = malloc(sizeof(_STACK))) == 
# 125 "stack/stack.c" 3 4
                                      ((void *)0)
# 125 "stack/stack.c"
                                          )
  goto err;
 if ((ret->data = reallocarray(
# 127 "stack/stack.c" 3 4
                              ((void *)0)
# 127 "stack/stack.c"
                                  , 4, sizeof(char *))) == 
# 127 "stack/stack.c" 3 4
...
{
 return internal_find(st, data, 0x02);
}

int
sk_find_ex(_STACK *st, void *data)
{
 return internal_find(st, data, 0x01);
}
...
{
 if (st == 
# 248 "stack/stack.c" 3 4
          ((void *)0)
# 248 "stack/stack.c"
              )
  return (
# 249 "stack/stack.c" 3 4
         ((void *)0)
# 249 "stack/stack.c"
             );
 if (st->num <= 0)
  return (
# 251 "stack/stack.c" 3 4
         ((void *)0)
# 251 "stack/stack.c"
             );
...
{
 if (st == 
# 258 "stack/stack.c" 3 4
          ((void *)0)
# 258 "stack/stack.c"
              )
  return (
# 259 "stack/stack.c" 3 4
         ((void *)0)
# 259 "stack/stack.c"
             );
 if (st->num <= 0)
  return (
# 261 "stack/stack.c" 3 4
         ((void *)0)
# 261 "stack/stack.c"
             );
...
static void* sk_pop_free_cb_addr = 
# 279 "stack/stack.c" 3 4
                                  ((void *)0)
# 279 "stack/stack.c"
                                      ;
