    ...
    BN_MONT_CTX *in_mont)
{
 ...
 BIGNUM *val1[32], *val2[32];
 BN_MONT_CTX *mont = 
# 131 "bn/bn_exp2.c" 3 4
                    ((void *)0)
# 131 "bn/bn_exp2.c"
                        ;
 ...
 if (!(m->d[0] & 1)) {
  ERR_put_error(3,(118),(102),"bn/bn_exp2.c",140);
  return (0);
 }
 ...
 BN_CTX_start(ctx);
 if ((d = BN_CTX_get(ctx)) == 
# 153 "bn/bn_exp2.c" 3 4
                             ((void *)0)
# 153 "bn/bn_exp2.c"
                                 )
  goto err;
 if ((r = BN_CTX_get(ctx)) == 
# 155 "bn/bn_exp2.c" 3 4
                             ((void *)0)
# 155 "bn/bn_exp2.c"
                                 )
  goto err;
 if ((val1[0] = BN_CTX_get(ctx)) == 
# 157 "bn/bn_exp2.c" 3 4
                                   ((void *)0)
# 157 "bn/bn_exp2.c"
                                       )
  goto err;
 if ((val2[0] = BN_CTX_get(ctx)) == 
# 159 "bn/bn_exp2.c" 3 4
                                   ((void *)0)
# 159 "bn/bn_exp2.c"
                                       )
  goto err;
...
# 165 "bn/bn_exp2.c"
 ...
 window1 = ((bits1) > 671 ? 6 : (bits1) > 239 ? 5 : (bits1) > 79 ? 4 : (bits1) > 23 ? 3 : 1);
 window2 = ((bits2) > 671 ? 6 : (bits2) > 239 ? 5 : (bits2) > 79 ? 4 : (bits2) > 23 ? 3 : 1);
...
# 178 "bn/bn_exp2.c"
 ...
 if (!BN_mod_mul_montgomery( (val1[0]),(a_mod_m),&((mont)->RR),(mont),(ctx)))
  goto err;
 if (window1 > 1) {
  ...
  j = 1 << (window1 - 1);
  for (i = 1; i < j; i++) {
   if (((val1[i] = BN_CTX_get(ctx)) == 
# 197 "bn/bn_exp2.c" 3 4
                                      ((void *)0)
# 197 "bn/bn_exp2.c"
                                          ) ||
...
# 209 "bn/bn_exp2.c"
 ...
 if (!BN_mod_mul_montgomery( (val2[0]),(a_mod_m),&((mont)->RR),(mont),(ctx)))
  goto err;
 if (window2 > 1) {
  ...
  j = 1 << (window2 - 1);
  for (i = 1; i < j; i++) {
   if (((val2[i] = BN_CTX_get(ctx)) == 
# 227 "bn/bn_exp2.c" 3 4
                                      ((void *)0)
# 227 "bn/bn_exp2.c"
                                          ) ||
