...
{
 PBEPARAM *pbe = 
# 124 "asn1/p5_pbe.c" 3 4
                ((void *)0)
# 124 "asn1/p5_pbe.c"
                    ;
 ASN1_STRING *pbe_str = 
# 125 "asn1/p5_pbe.c" 3 4
                       ((void *)0)
# 125 "asn1/p5_pbe.c"
                           ;
 unsigned char *sstr;
 ...
 pbe = PBEPARAM_new();
 if (!pbe) {
  ERR_put_error(13,(215),((1|64)),"asn1/p5_pbe.c",130);
  goto err;
 }
 if (iter <= 0)
  iter = 2048;
 if (!ASN1_INTEGER_set(pbe->iter, iter)) {
  ERR_put_error(13,(215),((1|64)),"asn1/p5_pbe.c",136);
  goto err;
 }
 if (!saltlen)
  saltlen = 8;
 if (!ASN1_STRING_set(pbe->salt, 
# 141 "asn1/p5_pbe.c" 3 4
                                ((void *)0)
# 141 "asn1/p5_pbe.c"
                                    , saltlen)) {
  ERR_put_error(13,(215),((1|64)),"asn1/p5_pbe.c",142);
  goto err;
 }
 ...
 if (!ASN1_item_pack(pbe, (&(PBEPARAM_it)), &pbe_str)) {
  ERR_put_error(13,(215),((1|64)),"asn1/p5_pbe.c",152);
  goto err;
 }

 PBEPARAM_free(pbe);
 pbe = 
# 157 "asn1/p5_pbe.c" 3 4
      ((void *)0)
# 157 "asn1/p5_pbe.c"
          ;

 if (X509_ALGOR_set0(algor, OBJ_nid2obj(alg), 16, pbe_str))
  return 1;

err:
 if (pbe != 
# 163 "asn1/p5_pbe.c" 3 4
           ((void *)0)
# 163 "asn1/p5_pbe.c"
               )
  PBEPARAM_free(pbe);
...
PKCS5_pbe_set(int alg, int iter, const unsigned char *salt, int saltlen)
{
 ...
 ret = X509_ALGOR_new();
 if (!ret) {
  ERR_put_error(13,(202),((1|64)),"asn1/p5_pbe.c",177);
  return 
# 178 "asn1/p5_pbe.c" 3 4
        ((void *)0)
# 178 "asn1/p5_pbe.c"
            ;
 }
