...
static ERR_STRING_DATA ECDSA_str_functs[]= {
 {(((((unsigned long)42)&0xffL)<<24L)| ((((unsigned long)104)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "ECDSA_CHECK"},
 {(((((unsigned long)42)&0xffL)<<24L)| ((((unsigned long)100)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "ECDSA_DATA_NEW_METHOD"},
 {(((((unsigned long)42)&0xffL)<<24L)| ((((unsigned long)101)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "ECDSA_do_sign"},
 {(((((unsigned long)42)&0xffL)<<24L)| ((((unsigned long)102)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "ECDSA_do_verify"},
 {(((((unsigned long)42)&0xffL)<<24L)| ((((unsigned long)103)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "ECDSA_sign_setup"},
 {0, 
# 80 "ecdsa/ecs_err.c" 3 4
    ((void *)0)
# 80 "ecdsa/ecs_err.c"
        }
};
...
static ERR_STRING_DATA ECDSA_str_reasons[]= {
 {(((((unsigned long)42)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)100)&0xfffL))) , "bad signature"},
 {(((((unsigned long)42)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)101)&0xfffL))), "data too large for key size"},
 {(((((unsigned long)42)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)102)&0xfffL))) , "err ec lib"},
 {(((((unsigned long)42)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)103)&0xfffL))) , "missing parameters"},
 {(((((unsigned long)42)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)106)&0xfffL))), "need new setup values"},
 {(((((unsigned long)42)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)107)&0xfffL))) , "non fips method"},
 {(((((unsigned long)42)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)104)&0xfffL))), "random number generation failed"},
 {(((((unsigned long)42)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)105)&0xfffL))), "signature malloc failed"},
 {0, 
# 92 "ecdsa/ecs_err.c" 3 4
    ((void *)0)
# 92 "ecdsa/ecs_err.c"
        }
};
...
ERR_load_ECDSA_strings(void)
{
 ...
 if (ERR_func_error_string(ECDSA_str_functs[0].error) == 
# 101 "ecdsa/ecs_err.c" 3 4
                                                        ((void *)0)
# 101 "ecdsa/ecs_err.c"
                                                            ) {
