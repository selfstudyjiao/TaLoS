...
# 67 "ec/ec_print.c" 3 4
    ((void *)0)
# 67 "ec/ec_print.c"
        , 0, ctx);
 if (buf_len == 0)
  return 
# 69 "ec/ec_print.c" 3 4
        ((void *)0)
# 69 "ec/ec_print.c"
            ;

 if ((buf = malloc(buf_len)) == 
# 71 "ec/ec_print.c" 3 4
                               ((void *)0)
# 71 "ec/ec_print.c"
                                   )
  return 
# 72 "ec/ec_print.c" 3 4
        ((void *)0)
# 72 "ec/ec_print.c"
            ;
    ...
    const BIGNUM * bn, EC_POINT * point, BN_CTX * ctx)
{
 ...
 if ((buf_len = ((BN_num_bits(bn)+7)/8)) == 0)
  return 
# 94 "ec/ec_print.c" 3 4
        ((void *)0)
# 94 "ec/ec_print.c"
            ;
 buf = malloc(buf_len);
 if (buf == 
# 96 "ec/ec_print.c" 3 4
           ((void *)0)
# 96 "ec/ec_print.c"
               )
  return 
# 97 "ec/ec_print.c" 3 4
        ((void *)0)
# 97 "ec/ec_print.c"
            ;
 ...
 if (!BN_bn2bin(bn, buf)) {
  free(buf);
  return 
# 101 "ec/ec_print.c" 3 4
        ((void *)0)
# 101 "ec/ec_print.c"
            ;
 }
 if (point == 
# 103 "ec/ec_print.c" 3 4
             ((void *)0)
# 103 "ec/ec_print.c"
                 ) {
  if ((ret = EC_POINT_new(group)) == 
# 104 "ec/ec_print.c" 3 4
                                    ((void *)0)
# 104 "ec/ec_print.c"
                                        ) {
   free(buf);
   return 
# 106 "ec/ec_print.c" 3 4
         ((void *)0)
# 106 "ec/ec_print.c"
             ;
  }
...
# 133 "ec/ec_print.c" 3 4
    ((void *)0)
# 133 "ec/ec_print.c"
        , 0, ctx);
 if (buf_len == 0 || buf_len + 1 == 0)
  return 
# 135 "ec/ec_print.c" 3 4
        ((void *)0)
# 135 "ec/ec_print.c"
            ;

 if ((buf = malloc(buf_len)) == 
# 137 "ec/ec_print.c" 3 4
                               ((void *)0)
# 137 "ec/ec_print.c"
                                   )
  return 
# 138 "ec/ec_print.c" 3 4
        ((void *)0)
# 138 "ec/ec_print.c"
            ;
 ...
 if (!EC_POINT_point2oct(group, point, form, buf, buf_len, ctx)) {
  free(buf);
  return 
# 142 "ec/ec_print.c" 3 4
        ((void *)0)
# 142 "ec/ec_print.c"
            ;
 }
 ret = reallocarray(
# 144 "ec/ec_print.c" 3 4
                   ((void *)0)
# 144 "ec/ec_print.c"
                       , buf_len + 1, 2);
 if (ret == 
# 145 "ec/ec_print.c" 3 4
           ((void *)0)
# 145 "ec/ec_print.c"
               ) {
  free(buf);
  return 
# 147 "ec/ec_print.c" 3 4
        ((void *)0)
# 147 "ec/ec_print.c"
            ;
 }
...
{
 EC_POINT *ret = 
# 167 "ec/ec_print.c" 3 4
                ((void *)0)
# 167 "ec/ec_print.c"
                    ;
 BIGNUM *tmp_bn = 
# 168 "ec/ec_print.c" 3 4
                 ((void *)0)
# 168 "ec/ec_print.c"
                     ;
