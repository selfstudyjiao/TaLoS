...
rinf_cb(int operation, ASN1_VALUE **pval, const ASN1_ITEM *it, void *exarg)
{
 ...
 if (operation == 1) {
  rinf->attributes = ((struct stack_st_X509_ATTRIBUTE *)sk_new_null());
  if (!rinf->attributes)
   return 0;
 }
 return 1;
...
static const ASN1_AUX X509_REQ_aux = {
 .app_data = 
# 164 "asn1/x_req.c" 3 4
            ((void *)0)
# 164 "asn1/x_req.c"
                ,
 .flags = 1,
 .ref_offset = 
# 166 "asn1/x_req.c" 3 4
              __builtin_offsetof (
# 166 "asn1/x_req.c"
              X509_REQ
# 166 "asn1/x_req.c" 3 4
