...
BIO_new_fd(int fd, int close_flag)
{
 ...
 if (ret == 
# 100 "bio/bss_fd.c" 3 4
           ((void *)0)
# 100 "bio/bss_fd.c"
               )
  return (
# 101 "bio/bss_fd.c" 3 4
         ((void *)0)
# 101 "bio/bss_fd.c"
             );
...
fd_read(BIO *b, char *out, int outl)
{
 ...
 if (out != 
# 136 "bio/bss_fd.c" 3 4
           ((void *)0)
# 136 "bio/bss_fd.c"
               ) {
  
# 137 "bio/bss_fd.c" 3 4
 (*__errno_location ()) 
# 137 "bio/bss_fd.c"
       = 0;
...
BIO_fd_non_fatal_error(int err)
{
 switch (err) {
 case 
# 257 "bio/bss_fd.c" 3 4
     107
# 257 "bio/bss_fd.c"
             :
 case 
# 258 "bio/bss_fd.c" 3 4
     4
# 258 "bio/bss_fd.c"
          :
 case 
# 259 "bio/bss_fd.c" 3 4
     11
# 259 "bio/bss_fd.c"
           :
 case 
# 260 "bio/bss_fd.c" 3 4
     115
# 260 "bio/bss_fd.c"
                :
 case 
# 261 "bio/bss_fd.c" 3 4
     114
# 261 "bio/bss_fd.c"
             :
  return (1);
