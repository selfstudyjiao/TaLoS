...
# 84 "dh/dh_ameth.c" 3 4
                           ((void *)0)
# 84 "dh/dh_ameth.c"
                               ;
 DH *dh = 
# 85 "dh/dh_ameth.c" 3 4
         ((void *)0)
# 85 "dh/dh_ameth.c"
             ;

 if (!X509_PUBKEY_get0_param(
# 87 "dh/dh_ameth.c" 3 4
                            ((void *)0)
# 87 "dh/dh_ameth.c"
                                , &p, &pklen, &palg, pubkey))
  return 0;
 X509_ALGOR_get0(
# 89 "dh/dh_ameth.c" 3 4
                ((void *)0)
# 89 "dh/dh_ameth.c"
                    , &ptype, &pval, palg);

 if (ptype != 16) {
  ERR_put_error(5,(108),(105),"dh/dh_ameth.c",92);
  goto err;
 }
 ...
 if (!(dh = d2i_DHparams(
# 100 "dh/dh_ameth.c" 3 4
                        ((void *)0)
# 100 "dh/dh_ameth.c"
                            , &pm, pmlen))) {
  ERR_put_error(5,(108),(104),"dh/dh_ameth.c",101);
  goto err;
 }

 if (!(public_key=d2i_ASN1_INTEGER(
# 105 "dh/dh_ameth.c" 3 4
                                  ((void *)0)
# 105 "dh/dh_ameth.c"
                                      , &p, pklen))) {
  ERR_put_error(5,(108),(104),"dh/dh_ameth.c",106);
  goto err;
 }


 if (!(dh->pub_key = ASN1_INTEGER_to_BN(public_key, 
# 111 "dh/dh_ameth.c" 3 4
                                                   ((void *)0)
# 111 "dh/dh_ameth.c"
                                                       ))) {
  ERR_put_error(5,(108),(109),"dh/dh_ameth.c",112);
  goto err;
 }

 ASN1_INTEGER_free(public_key);
 EVP_PKEY_assign((pkey),28, (char *)(dh));
 return 1;
...
# 135 "dh/dh_ameth.c"
 ...
 str = ASN1_STRING_new();
 if (str == 
# 140 "dh/dh_ameth.c" 3 4
           ((void *)0)
# 140 "dh/dh_ameth.c"
               ) {
  ERR_put_error(5,(109),((1|64)),"dh/dh_ameth.c",141);
  goto err;
 }

 str->length = i2d_DHparams(dh, &str->data);
 if (str->length <= 0) {
  ERR_put_error(5,(109),((1|64)),"dh/dh_ameth.c",147);
  goto err;
 }
 ptype = 16;

 pub_key = BN_to_ASN1_INTEGER(dh->pub_key, 
# 152 "dh/dh_ameth.c" 3 4
                                          ((void *)0)
# 152 "dh/dh_ameth.c"
                                              );
 if (!pub_key)
 ...
 if (penclen <= 0) {
  ERR_put_error(5,(109),((1|64)),"dh/dh_ameth.c",161);
  goto err;
  }

 if (X509_PUBKEY_set0_param(pk, OBJ_nid2obj(28), ptype,
...
# 191 "dh/dh_ameth.c" 3 4
                        ((void *)0)
# 191 "dh/dh_ameth.c"
                            ;
 DH *dh = 
# 192 "dh/dh_ameth.c" 3 4
         ((void *)0)
# 192 "dh/dh_ameth.c"
             ;

 if (!PKCS8_pkey_get0(
# 194 "dh/dh_ameth.c" 3 4
                     ((void *)0)
# 194 "dh/dh_ameth.c"
                         , &p, &pklen, &palg, p8))
  return 0;
...
# 202 "dh/dh_ameth.c"
 ...
 pmlen = pstr->length;
 if (!(dh = d2i_DHparams(
# 208 "dh/dh_ameth.c" 3 4
                        ((void *)0)
# 208 "dh/dh_ameth.c"
                            , &pm, pmlen)))
  goto decerr;

 if (!(dh->priv_key = ASN1_INTEGER_to_BN(privkey, 
# 211 "dh/dh_ameth.c" 3 4
                                                 ((void *)0)
# 211 "dh/dh_ameth.c"
                                                     ))) {
  ERR_put_error(5,(110),(106),"dh/dh_ameth.c",212);
  goto dherr;
 }
...
decerr:
 ERR_put_error(5,(110),(114),"dh/dh_ameth.c",226);
dherr:
 DH_free(dh);
 return 0;
}
...
{
 ASN1_STRING *params = 
# 235 "dh/dh_ameth.c" 3 4
                      ((void *)0)
# 235 "dh/dh_ameth.c"
                          ;
 ASN1_INTEGER *prkey = 
# 236 "dh/dh_ameth.c" 3 4
                      ((void *)0)
# 236 "dh/dh_ameth.c"
                          ;
 unsigned char *dp = 
# 237 "dh/dh_ameth.c" 3 4
                    ((void *)0)
# 237 "dh/dh_ameth.c"
                        ;
 int dplen;
 ...
 if (!params) {
  ERR_put_error(5,(111),((1|64)),"dh/dh_ameth.c",243);
  goto err;
 }

 params->length = i2d_DHparams(pkey->pkey.dh, &params->data);
 if (params->length <= 0) {
  ERR_put_error(5,(111),((1|64)),"dh/dh_ameth.c",249);
  goto err;
 }
 params->type = 16;


 prkey = BN_to_ASN1_INTEGER(pkey->pkey.dh->priv_key, 
# 255 "dh/dh_ameth.c" 3 4
                                                    ((void *)0)
# 255 "dh/dh_ameth.c"
                                                        );

 if (!prkey) {
  ERR_put_error(5,(111),(106),"dh/dh_ameth.c",258);
  goto err;
 }
 ...
 prkey = 
# 265 "dh/dh_ameth.c" 3 4
        ((void *)0)
# 265 "dh/dh_ameth.c"
            ;

 if (!PKCS8_pkey_set0(p8, OBJ_nid2obj(28), 0,
     16, params, dp, dplen))
  goto err;
...
dh_param_decode(EVP_PKEY *pkey, const unsigned char **pder, int derlen)
{
 ...
 if (!(dh = d2i_DHparams(
# 296 "dh/dh_ameth.c" 3 4
                        ((void *)0)
# 296 "dh/dh_ameth.c"
                            , pder, derlen))) {
  ERR_put_error(5,(107),(5),"dh/dh_ameth.c",297);
  return 0;
 }
 EVP_PKEY_assign((pkey),28, (char *)(dh));
 return 1;
...
# 348 "dh/dh_ameth.c"
 ...
 if (0) {
err:
  ERR_put_error(5,(100),(reason),"dh/dh_ameth.c",377);
 }
 free(m);
 return(ret);
}
...
dh_copy_parameters(EVP_PKEY *to, const EVP_PKEY *from)
{
 ...
 if ((a = BN_dup(from->pkey.dh->p)) == 
# 410 "dh/dh_ameth.c" 3 4
                                      ((void *)0)
# 410 "dh/dh_ameth.c"
                                          )
  return 0;
 ...
 if ((a = BN_dup(from->pkey.dh->g)) == 
# 415 "dh/dh_ameth.c" 3 4
                                      ((void *)0)
# 415 "dh/dh_ameth.c"
                                          )
  return 0;
...
{
 return do_dh_print(bp, x, 4, 
# 463 "dh/dh_ameth.c" 3 4
                             ((void *)0)
# 463 "dh/dh_ameth.c"
                                 , 0);
}
