...
# 60 "objects/obj_xref.c" 2
# 1 "objects/obj_xref.h" 1
...
# 61 "objects/obj_xref.c" 2

struct stack_st_nid_triple { _STACK stack; };
struct stack_st_nid_triple *sig_app, *sigx_app;
...
static int sig_cmp_BSEARCH_CMP_FN(const void *, const void *); static int sig_cmp(nid_triple const *, nid_triple const *); static nid_triple * OBJ_bsearch_sig(nid_triple *key, nid_triple const *base, int num);
static int sig_cmp_BSEARCH_CMP_FN(const void *a_, const void *b_) { nid_triple const *a = a_; nid_triple const *b = b_; return sig_cmp(a,b); } static nid_triple *OBJ_bsearch_sig(nid_triple *key, nid_triple const *base, int num) { return (nid_triple *)OBJ_bsearch_(key, base, num, sizeof(nid_triple), sig_cmp_BSEARCH_CMP_FN); } extern void dummy_prototype(void);
...
static int sigx_cmp_BSEARCH_CMP_FN(const void *, const void *); static int sigx_cmp(const nid_triple * const *, const nid_triple * const *); static const nid_triple * * OBJ_bsearch_sigx(const nid_triple * *key, const nid_triple * const *base, int num);
...
static int sigx_cmp_BSEARCH_CMP_FN(const void *a_, const void *b_) { const nid_triple * const *a = a_; const nid_triple * const *b = b_; return sigx_cmp(a,b); } static const nid_triple * *OBJ_bsearch_sigx(const nid_triple * *key, const nid_triple * const *base, int num) { return (const nid_triple * *)OBJ_bsearch_(key, base, num, sizeof(const nid_triple *), sigx_cmp_BSEARCH_CMP_FN); } extern void dummy_prototype(void);
...
OBJ_find_sigid_algs(int signid, int *pdig_nid, int *ppkey_nid)
{
 nid_triple tmp;
 const nid_triple *rv = 
# 99 "objects/obj_xref.c" 3 4
                       ((void *)0)
# 99 "objects/obj_xref.c"
                           ;
 tmp.sign_id = signid;

 if (sig_app) {
  int idx = sk_find(((_STACK*) (1 ? (sig_app) : (struct stack_st_nid_triple*)0)), ((void*) (1 ? (&tmp) : (nid_triple*)0)));
  if (idx >= 0)
   rv = ((nid_triple *)sk_value(((_STACK*) (1 ? (sig_app) : (struct stack_st_nid_triple*)0)), (idx)));
 }


 if (rv == 
# 109 "objects/obj_xref.c" 3 4
          ((void *)0)
# 109 "objects/obj_xref.c"
              ) {
 ...
 if (rv == 
# 114 "objects/obj_xref.c" 3 4
          ((void *)0)
# 114 "objects/obj_xref.c"
              )
  return 0;
 if (pdig_nid)
  *pdig_nid = rv->hash_id;
...
OBJ_find_sigid_by_algs(int *psignid, int dig_nid, int pkey_nid)
{
 ...
 const nid_triple **rv = 
# 128 "objects/obj_xref.c" 3 4
                        ((void *)0)
# 128 "objects/obj_xref.c"
                            ;
 ...
 if (sigx_app) {
  int idx = sk_find(((_STACK*) (1 ? (sigx_app) : (struct stack_st_nid_triple*)0)), ((void*) (1 ? (&tmp) : (nid_triple*)0)));
  if (idx >= 0) {
   t = ((nid_triple *)sk_value(((_STACK*) (1 ? (sigx_app) : (struct stack_st_nid_triple*)0)), (idx)));
   rv = &t;
  }
 }
 ...
 if (rv == 
# 142 "objects/obj_xref.c" 3 4
          ((void *)0)
# 142 "objects/obj_xref.c"
              ) {
 ...
 if (rv == 
# 147 "objects/obj_xref.c" 3 4
          ((void *)0)
# 147 "objects/obj_xref.c"
              )
  return 0;
 if (psignid)
  *psignid = (*rv)->sign_id;
...
OBJ_add_sigid(int signid, int dig_id, int pkey_id)
{
 ...
 if (!sig_app)
  sig_app = ((struct stack_st_nid_triple *)sk_new(((int (*)(const void *, const void *)) ((1 ? (sig_sk_cmp) : (int (*)(const nid_triple * const *, const nid_triple * const *))0)))));
 if (!sig_app)
  return 0;
 if (!sigx_app)
  sigx_app = ((struct stack_st_nid_triple *)sk_new(((int (*)(const void *, const void *)) ((1 ? (sigx_cmp) : (int (*)(const nid_triple * const *, const nid_triple * const *))0)))));
 if (!sigx_app)
  return 0;
 ntr = reallocarray(
# 167 "objects/obj_xref.c" 3 4
                   ((void *)0)
# 167 "objects/obj_xref.c"
                       , 3, sizeof(int));
 if (!ntr)
  return 0;
 ntr->sign_id = signid;
 ...
 if (!sk_push(((_STACK*) (1 ? (sig_app) : (struct stack_st_nid_triple*)0)), ((void*) (1 ? (ntr) : (nid_triple*)0)))) {
  free(ntr);
  return 0;
 }

 if (!sk_push(((_STACK*) (1 ? (sigx_app) : (struct stack_st_nid_triple*)0)), ((void*) (1 ? (ntr) : (nid_triple*)0))))
  return 0;

 sk_sort(((_STACK*) (1 ? (sig_app) : (struct stack_st_nid_triple*)0)));
 sk_sort(((_STACK*) (1 ? (sigx_app) : (struct stack_st_nid_triple*)0)));
...
{
 if (sig_app) {
  sk_pop_free(((_STACK*) (1 ? (sig_app) : (struct stack_st_nid_triple*)0)), ((void (*)(void *)) ((1 ? (sid_free) : (void (*)(nid_triple *))0))));
  sig_app = 
# 199 "objects/obj_xref.c" 3 4
           ((void *)0)
# 199 "objects/obj_xref.c"
               ;
 }
 if (sigx_app) {
  sk_free(((_STACK*) (1 ? (sigx_app) : (struct stack_st_nid_triple*)0)));
  sigx_app = 
# 203 "objects/obj_xref.c" 3 4
            ((void *)0)
# 203 "objects/obj_xref.c"
                ;
 }
}
