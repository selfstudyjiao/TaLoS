...
const X509V3_EXT_METHOD v3_sxnet = {
 ...
 .it = (&(SXNET_it)),
 .ext_new = 
# 83 "x509v3/v3_sxnet.c" 3 4
           ((void *)0)
# 83 "x509v3/v3_sxnet.c"
               ,
 .ext_free = 
# 84 "x509v3/v3_sxnet.c" 3 4
            ((void *)0)
# 84 "x509v3/v3_sxnet.c"
                ,
 .d2i = 
# 85 "x509v3/v3_sxnet.c" 3 4
       ((void *)0)
# 85 "x509v3/v3_sxnet.c"
           ,
 .i2d = 
# 86 "x509v3/v3_sxnet.c" 3 4
       ((void *)0)
# 86 "x509v3/v3_sxnet.c"
           ,
 .i2s = 
# 87 "x509v3/v3_sxnet.c" 3 4
       ((void *)0)
# 87 "x509v3/v3_sxnet.c"
           ,
 .s2i = 
# 88 "x509v3/v3_sxnet.c" 3 4
       ((void *)0)
# 88 "x509v3/v3_sxnet.c"
           ,
 .i2v = 
# 89 "x509v3/v3_sxnet.c" 3 4
       ((void *)0)
# 89 "x509v3/v3_sxnet.c"
           ,
 ...
 .r2i = 
# 96 "x509v3/v3_sxnet.c" 3 4
       ((void *)0)
# 96 "x509v3/v3_sxnet.c"
           ,
 .usr_data = 
# 97 "x509v3/v3_sxnet.c" 3 4
            ((void *)0)
# 97 "x509v3/v3_sxnet.c"
                ,
};
...
static const ASN1_TEMPLATE SXNETID_seq_tt[] = {
 {
  ...
  .tag = 0,
  .offset = 
# 104 "x509v3/v3_sxnet.c" 3 4
           __builtin_offsetof (
# 104 "x509v3/v3_sxnet.c"
           SXNETID
# 104 "x509v3/v3_sxnet.c" 3 4
           , 
# 104 "x509v3/v3_sxnet.c"
...
# 104 "x509v3/v3_sxnet.c"
 ...
 },
 {
  ...
  .tag = 0,
  .offset = 
# 111 "x509v3/v3_sxnet.c" 3 4
           __builtin_offsetof (
# 111 "x509v3/v3_sxnet.c"
           SXNETID
# 111 "x509v3/v3_sxnet.c" 3 4
           , 
# 111 "x509v3/v3_sxnet.c"
...
const ASN1_ITEM SXNETID_it = {
 ...
 .funcs = 
# 122 "x509v3/v3_sxnet.c" 3 4
         ((void *)0)
# 122 "x509v3/v3_sxnet.c"
             ,
 .size = sizeof(SXNETID),
 .sname = "SXNETID",
};
...
static const ASN1_TEMPLATE SXNET_seq_tt[] = {
 {
  ...
  .tag = 0,
  .offset = 
# 157 "x509v3/v3_sxnet.c" 3 4
           __builtin_offsetof (
# 157 "x509v3/v3_sxnet.c"
           SXNET
# 157 "x509v3/v3_sxnet.c" 3 4
           , 
# 157 "x509v3/v3_sxnet.c"
...
# 157 "x509v3/v3_sxnet.c"
 ...
 },
 {
  ...
  .tag = 0,
  .offset = 
# 164 "x509v3/v3_sxnet.c" 3 4
           __builtin_offsetof (
# 164 "x509v3/v3_sxnet.c"
           SXNET
# 164 "x509v3/v3_sxnet.c" 3 4
           , 
# 164 "x509v3/v3_sxnet.c"
...
const ASN1_ITEM SXNET_it = {
 ...
 .funcs = 
# 175 "x509v3/v3_sxnet.c" 3 4
         ((void *)0)
# 175 "x509v3/v3_sxnet.c"
             ,
 .size = sizeof(SXNET),
 .sname = "SXNET",
};
...
sxnet_i2r(X509V3_EXT_METHOD *method, SXNET *sx, BIO *out, int indent)
{
 ...
 for (i = 0; i < sk_num(((_STACK*) (1 ? (sx->ids) : (struct stack_st_SXNETID*)0))); i++) {
  id = ((SXNETID *)sk_value(((_STACK*) (1 ? (sx->ids) : (struct stack_st_SXNETID*)0)), (i)));
  tmp = i2s_ASN1_INTEGER(
# 218 "x509v3/v3_sxnet.c" 3 4
                        ((void *)0)
# 218 "x509v3/v3_sxnet.c"
                            , id->zone);
    ...
    struct stack_st_CONF_VALUE *nval)
{
 CONF_VALUE *cnf;
 SXNET *sx = 
# 238 "x509v3/v3_sxnet.c" 3 4
            ((void *)0)
# 238 "x509v3/v3_sxnet.c"
                ;
 int i;
 ...
 for (i = 0; i < sk_num(((_STACK*) (1 ? (nval) : (struct stack_st_CONF_VALUE*)0))); i++) {
  ...
  if (!SXNET_add_id_asc(&sx, cnf->name, cnf->value, -1))
   return 
# 244 "x509v3/v3_sxnet.c" 3 4
         ((void *)0)
# 244 "x509v3/v3_sxnet.c"
             ;
 }
 return sx;
}
...
{
 ASN1_INTEGER *izone = 
# 258 "x509v3/v3_sxnet.c" 3 4
                      ((void *)0)
# 258 "x509v3/v3_sxnet.c"
                          ;

 if (!(izone = s2i_ASN1_INTEGER(
# 260 "x509v3/v3_sxnet.c" 3 4
                               ((void *)0)
# 260 "x509v3/v3_sxnet.c"
                                   , zone))) {
  ERR_put_error(34,(125),(131),"x509v3/v3_sxnet.c",262)
                                     ;
  return 0;
 }
...
{
 ASN1_INTEGER *izone = 
# 273 "x509v3/v3_sxnet.c" 3 4
                      ((void *)0)
# 273 "x509v3/v3_sxnet.c"
                          ;

 if (!(izone = ASN1_INTEGER_new()) ||
     !ASN1_INTEGER_set(izone, lzone)) {
  ERR_put_error(34,(127),((1|64)),"x509v3/v3_sxnet.c",277);
...
{
 SXNET *sx = 
# 292 "x509v3/v3_sxnet.c" 3 4
            ((void *)0)
# 292 "x509v3/v3_sxnet.c"
                ;
 SXNETID *id = 
# 293 "x509v3/v3_sxnet.c" 3 4
              ((void *)0)
# 293 "x509v3/v3_sxnet.c"
                  ;

 if (!psx || !zone || !user) {
  ERR_put_error(34,(126),(107),"x509v3/v3_sxnet.c",297)
                                     ;
  return 0;
 }
 if (userlen == -1)
  userlen = strlen(user);
 if (userlen > 64) {
  ERR_put_error(34,(126),(132),"x509v3/v3_sxnet.c",304)
                             ;
  return 0;
 }
 if (!*psx) {
 ...
 if (SXNET_get_id_INTEGER(sx, zone)) {
  ERR_put_error(34,(126),(133),"x509v3/v3_sxnet.c",317)
                                 ;
  return 0;
 }
 ...
 if (!ASN1_STRING_set(id->user, user, userlen))
  goto err;
 if (!sk_push(((_STACK*) (1 ? (sx->ids) : (struct stack_st_SXNETID*)0)), ((void*) (1 ? (id) : (SXNETID*)0))))
  goto err;
 id->zone = zone;
 return 1;

err:
 ERR_put_error(34,(126),((1|64)),"x509v3/v3_sxnet.c",334);
 SXNETID_free(id);
 SXNET_free(sx);
 *psx = 
# 337 "x509v3/v3_sxnet.c" 3 4
       ((void *)0)
# 337 "x509v3/v3_sxnet.c"
           ;
 return 0;
}
...
{
 ASN1_INTEGER *izone = 
# 344 "x509v3/v3_sxnet.c" 3 4
                      ((void *)0)
# 344 "x509v3/v3_sxnet.c"
                          ;
 ASN1_OCTET_STRING *oct;

 if (!(izone = s2i_ASN1_INTEGER(
# 347 "x509v3/v3_sxnet.c" 3 4
                               ((void *)0)
# 347 "x509v3/v3_sxnet.c"
                                   , zone))) {
  ERR_put_error(34,(128),(131),"x509v3/v3_sxnet.c",349)
                                     ;
  return 
# 350 "x509v3/v3_sxnet.c" 3 4
        ((void *)0)
# 350 "x509v3/v3_sxnet.c"
            ;
 }
...
{
 ASN1_INTEGER *izone = 
# 360 "x509v3/v3_sxnet.c" 3 4
                      ((void *)0)
# 360 "x509v3/v3_sxnet.c"
                          ;
 ASN1_OCTET_STRING *oct;

 if (!(izone = ASN1_INTEGER_new()) ||
     !ASN1_INTEGER_set(izone, lzone)) {
  ERR_put_error(34,(129),((1|64)),"x509v3/v3_sxnet.c",365);
  ASN1_INTEGER_free(izone);
  return 
# 367 "x509v3/v3_sxnet.c" 3 4
        ((void *)0)
# 367 "x509v3/v3_sxnet.c"
            ;
 }
 oct = SXNET_get_id_INTEGER(sx, izone);
 ASN1_INTEGER_free(izone);
...
SXNET_get_id_INTEGER(SXNET *sx, ASN1_INTEGER *zone)
{
 ...
 return 
# 385 "x509v3/v3_sxnet.c" 3 4
       ((void *)0)
# 385 "x509v3/v3_sxnet.c"
           ;
}
