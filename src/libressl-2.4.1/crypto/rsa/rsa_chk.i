...
RSA_check_key(const RSA *key)
{
 ...
 if (!key->p || !key->q || !key->n || !key->e || !key->d) {
  ERR_put_error(4,(123),(147),"rsa/rsa_chk.c",64);
  return 0;
 }
...
# 74 "rsa/rsa_chk.c"
                                                                  ||
     ctx == 
# 75 "rsa/rsa_chk.c" 3 4
           ((void *)0)
# 75 "rsa/rsa_chk.c"
               ) {
  ret = -1;
  ERR_put_error(4,(123),((1|64)),"rsa/rsa_chk.c",77);
  goto err;
 }


 r = BN_is_prime_ex(key->p, 0, 
# 82 "rsa/rsa_chk.c" 3 4
                                            ((void *)0)
# 82 "rsa/rsa_chk.c"
                                                , 
# 82 "rsa/rsa_chk.c" 3 4
...
# 82 "rsa/rsa_chk.c"
 ...
 if (r != 1) {
  ...
  if (r != 0)
   goto err;
  ERR_put_error(4,(123),(128),"rsa/rsa_chk.c",87);
 }


 r = BN_is_prime_ex(key->q, 0, 
# 91 "rsa/rsa_chk.c" 3 4
                                            ((void *)0)
# 91 "rsa/rsa_chk.c"
                                                , 
# 91 "rsa/rsa_chk.c" 3 4
...
# 91 "rsa/rsa_chk.c"
 ...
 if (r != 1) {
  ...
  if (r != 0)
   goto err;
  ERR_put_error(4,(123),(129),"rsa/rsa_chk.c",96);
 }
 ...
 if (BN_cmp(i, key->n) != 0) {
  ret = 0;
  ERR_put_error(4,(123),(127),"rsa/rsa_chk.c",108);
 }
...
# 135 "rsa/rsa_chk.c"
 ...
 if (!((((((i))->top == 1) && (((i))->d[0] == (unsigned long)(1))) || (((1) == 0) && (((i))->top == 0))) && !(i)->neg)) {
  ret = 0;
  ERR_put_error(4,(123),(123),"rsa/rsa_chk.c",149);
 }

 if (key->dmp1 != 
# 152 "rsa/rsa_chk.c" 3 4
                 ((void *)0) 
# 152 "rsa/rsa_chk.c"
                      && key->dmq1 != 
# 152 "rsa/rsa_chk.c" 3 4
...
# 160 "rsa/rsa_chk.c"
  ...
  if (BN_cmp(j, key->dmp1) != 0) {
   ret = 0;
   ERR_put_error(4,(123),(124),"rsa/rsa_chk.c",169)
                                     ;
  }
...
# 179 "rsa/rsa_chk.c"
  ...
  if (BN_cmp(j, key->dmq1) != 0) {
   ret = 0;
   ERR_put_error(4,(123),(125),"rsa/rsa_chk.c",188)
                                     ;
  }
  ...
  if (BN_cmp(i, key->iqmp) != 0) {
   ret = 0;
   ERR_put_error(4,(123),(126),"rsa/rsa_chk.c",200)
                                   ;
  }
 }
