...
# 126 "ec/ecp_nist.c"
 ...
 if (ctx == 
# 129 "ec/ecp_nist.c" 3 4
           ((void *)0)
# 129 "ec/ecp_nist.c"
               )
  if ((ctx = new_ctx = BN_CTX_new()) == 
# 130 "ec/ecp_nist.c" 3 4
                                       ((void *)0)
# 130 "ec/ecp_nist.c"
                                           )
   return 0;
 ...
 BN_CTX_start(ctx);
 if ((tmp_bn = BN_CTX_get(ctx)) == 
# 134 "ec/ecp_nist.c" 3 4
                                  ((void *)0)
# 134 "ec/ecp_nist.c"
                                      )
  goto err;
 ...
 if (BN_ucmp(BN_get0_nist_prime_192(), p) == 0)
  ...
  ERR_put_error(16,(202),(135),"ec/ecp_nist.c",148);
  goto err;
 }
    ...
    const BIGNUM *b, BN_CTX *ctx)
{
 int ret = 0;
 BN_CTX *ctx_new = 
# 166 "ec/ecp_nist.c" 3 4
                  ((void *)0)
# 166 "ec/ecp_nist.c"
                      ;

 if (!group || !r || !a || !b) {
  ERR_put_error(16,(200),((3|64)),"ec/ecp_nist.c",169);
  goto err;
 }
 if (!ctx)
  if ((ctx_new = ctx = BN_CTX_new()) == 
# 173 "ec/ecp_nist.c" 3 4
                                       ((void *)0)
# 173 "ec/ecp_nist.c"
                                           )
   goto err;
    ...
    BN_CTX * ctx)
{
 int ret = 0;
 BN_CTX *ctx_new = 
# 193 "ec/ecp_nist.c" 3 4
                  ((void *)0)
# 193 "ec/ecp_nist.c"
                      ;

 if (!group || !r || !a) {
  ERR_put_error(16,(201),(134),"ec/ecp_nist.c",196);
  goto err;
 }
 if (!ctx)
  if ((ctx_new = ctx = BN_CTX_new()) == 
# 200 "ec/ecp_nist.c" 3 4
                                       ((void *)0)
# 200 "ec/ecp_nist.c"
                                           )
   goto err;
