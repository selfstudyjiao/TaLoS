...
# 1 "../ssl/bytestring.h" 1
# 24 "../ssl/bytestring.h"
# 1 "../include/compat/sys/types.h" 1
# 25 "../ssl/bytestring.h" 2


# 1 "../include/openssl/opensslconf.h" 1
# 1 "../include/openssl/opensslfeatures.h" 1
# 2 "../include/openssl/opensslconf.h" 2
# 28 "../ssl/bytestring.h" 2
# 41 "../ssl/bytestring.h"
...
# 183 "../ssl/s3_clnt.c" 3 4
(*__errno_location ()) 
# 183 "../ssl/s3_clnt.c"
      = 0;

 if (s->info_callback != 
# 185 "../ssl/s3_clnt.c" 3 4
                        ((void *)0)
# 185 "../ssl/s3_clnt.c"
                            )
  cb = s->info_callback;
 else if (s->ctx->info_callback != 
# 187 "../ssl/s3_clnt.c" 3 4
                                  ((void *)0)
# 187 "../ssl/s3_clnt.c"
                                      )
 ...
 s->in_handshake++;
 if (!(SSL_state(s)&(0x1000|0x2000)) || (SSL_state(s)&0x4000))
  SSL_clear(s);
...
# 209 "../ssl/s3_clnt.c"
   ...
   if ((s->version & 0xff00 ) != 0x0300) {
    ERR_put_error(20,(132),((4|64)),"../ssl/s3_clnt.c",214)
                             ;
    ret = -1;
    goto end;
   }
  ...
  case (0x121|0x1000):
   ...
   if (s->hit) {
    s->state = (0x1D0|0x1000);
    if (s->tlsext_ticket_expected) {

     s->state = (0x1E0|0x1000);
    }
   } else
    s->state = (0x130|0x1000);
   s->init_num = 0;
   break;
  ...
  case (0x131|0x1000):
   ...
   if (!(s->s3->tmp.new_cipher->algorithm_auth &
    ...
    if (s->tlsext_status_expected)
     s->state = (0x1F0|0x1000);
    else
     s->state = (0x140|0x1000);
   } else {
    skip = 1;
    s->state = (0x140|0x1000);
   }
  ...
  case (0x161|0x1000):
   ...
   if (s->s3->tmp.cert_req)
    s->state = (0x170|0x1000);
   else
    s->state = (0x180|0x1000);
   s->init_num = 0;
...
# 383 "../ssl/s3_clnt.c"
   if (s->s3->tmp.cert_req == 1) {
    s->state = (0x190|0x1000);
   } else {
    s->state = (0x1A0|0x1000);
    s->s3->change_cipher_spec = 0;
   }
   if (s->s3->flags & 0x0010) {
    s->state = (0x1A0|0x1000);
    s->s3->change_cipher_spec = 0;
   }
  ...
  case (0x1A1|0x1000):
   ...
   (0x1A0|0x1000), (0x1A1|0x1000));
   if (ret <= 0)
    goto end;

   if (s->s3->next_proto_neg_seen)
    s->state = (0x200|0x1000);
   else
    s->state = (0x1B0|0x1000);
   s->init_num = 0;
  ...
  case (0x1B0|0x1000):
  case (0x1B1|0x1000):
   ret = ssl3_send_finished(s, (0x1B0|0x1000),
       (0x1B1|0x1000),
   ...
   if (ret <= 0)
    goto end;
   s->s3->flags |= 0x0080;
   s->state = (0x100|0x1000);


   s->s3->flags &= ~0x0004;
   if (s->hit) {
    s->s3->tmp.next_state = 0x03;
    if (s->s3->flags &
        0x0002) {
     s->state = 0x03;
     s->s3->flags|=0x0004;
    ...
    s->s3->tmp.next_state = (0x1D0|0x1000);
   }
   s->init_num = 0;
   break;
  ...
  case (0x1D1|0x1000):
   s->s3->flags |= 0x0080;
   ret = ssl3_get_finished(s, (0x1D0|0x1000),
       (0x1D1|0x1000));
   if (ret <= 0)
    goto end;
  ...
  case (0x100|0x1000):
   s->rwstate = 2;
   if ((int)BIO_ctrl(s->wbio,11,0,
# 510 "../ssl/s3_clnt.c" 3 4
      ((void *)0)
# 510 "../ssl/s3_clnt.c"
      ) <= 0) {
    ret = -1;
  ...
  case 0x03:
   ...
   if (s->init_buf != 
# 522 "../ssl/s3_clnt.c" 3 4
                     ((void *)0)
# 522 "../ssl/s3_clnt.c"
                         ) {
    BUF_MEM_free(s->init_buf);
    s->init_buf = 
# 524 "../ssl/s3_clnt.c" 3 4
                 ((void *)0)
# 524 "../ssl/s3_clnt.c"
                     ;
   }
...
# 548 "../ssl/s3_clnt.c"
  ...
  default:
   ERR_put_error(20,(132),(255),"../ssl/s3_clnt.c",556)
                           ;
   ret = -1;
   goto end;
  ...
  if (!s->s3->tmp.reuse_message && !skip) {
   if (s->debug) {
    if ((ret = (int)BIO_ctrl(s->wbio,11,0,
# 565 "../ssl/s3_clnt.c" 3 4
              ((void *)0)
# 565 "../ssl/s3_clnt.c"
              )) <= 0)
     goto end;
...
# 569 "../ssl/s3_clnt.c"
 ...
 s->in_handshake--;
 if (cb != 
# 581 "../ssl/s3_clnt.c" 3 4
          ((void *)0)
# 581 "../ssl/s3_clnt.c"
              )
  cb(s, (0x1000|0x02), ret);
...
ssl3_client_hello(SSL *s)
{
 ...
 if (s->state == (0x110|0x1000)) {
  SSL_SESSION *sess = s->session;

  if ((sess == 
# 596 "../ssl/s3_clnt.c" 3 4
              ((void *)0)
# 596 "../ssl/s3_clnt.c"
                  ) ||
  ...
  if (!(s->method->ssl3_enc->enc_flags & (1 << 3)) || s->d1->send_cookie == 0)
   arc4random_buf(s->s3->client_random, 32);

  d = p = ssl3_handshake_msg_start(s, 1);
# 645 "../ssl/s3_clnt.c"
  *(p++) = s->client_version >> 8;
  *(p++) = s->client_version & 0xff;


  memcpy(p, s->s3->client_random, 32);
  p += 32;
  ...
  *(p++) = i;
  if (i != 0) {
   if (i > (int)sizeof(s->session->session_id)) {
    ERR_put_error(20,(131),((4|64)),"../ssl/s3_clnt.c",661)
                             ;
    goto err;
   }
  ...
  if ((s->method->ssl3_enc->enc_flags & (1 << 3))) {
   if (s->d1->cookie_len > sizeof(s->d1->cookie)) {
    ERR_put_error(20,(248),((4|64)),"../ssl/s3_clnt.c",672)
                             ;
    goto err;
   }
   *(p++) = s->d1->cookie_len;
  ...
  if (i == 0) {
   ERR_put_error(20,(131),(181),"../ssl/s3_clnt.c",684)
                                  ;
   goto err;
  }
  ((p[0]=(unsigned char)(((i)>> 8)&0xff), p[1]=(unsigned char)(((i) )&0xff)),p+=2);
  p += i;
  ...
  *(p++) = 0;
  ...
  bufend = (unsigned char *)s->init_buf->data +
      16384;
  if ((p = ssl_add_clienthello_tlsext(s, p, bufend)) == 
# 697 "../ssl/s3_clnt.c" 3 4
                                                       ((void *)0)
# 697 "../ssl/s3_clnt.c"
                                                           ) {
   ERR_put_error(20,(131),((4|64)),"../ssl/s3_clnt.c",699)
                            ;
   goto err;
  }
...
ssl3_get_server_hello(SSL *s)
{
 ...
 n = s->method->ssl_get_message(s, (0x120|0x1000),
     (0x121|0x1000), -1, 20000, &ok);
 ...
 if ((s->method->ssl3_enc->enc_flags & (1 << 3))) {
  if (s->s3->tmp.message_type == 3) {
   if (s->d1->send_cookie == 0) {
    ...
    al = 10;
    ERR_put_error(20,(146),(114),"../ssl/s3_clnt.c",742)
                               ;
    goto f_err;
   }
  }
 ...
 if (s->s3->tmp.message_type != 2) {
  al = 10;
  ERR_put_error(20,(146),(114),"../ssl/s3_clnt.c",751)
                             ;
  goto f_err;
 }
 ...
 if ((p[0] != (s->version >> 8)) || (p[1] != (s->version & 0xff))) {
  ERR_put_error(20,(146),(266),"../ssl/s3_clnt.c",760);
 ...
 memcpy(s->s3->server_random, p, 32);
 p += 32;
 ...
 if ((j > sizeof s->session->session_id) ||
     (j > 32)) {
  al = 47;
  ERR_put_error(20,(146),(300),"../ssl/s3_clnt.c",783)
                                     ;
  goto f_err;
 }
 ...
 q = p + j;
 ((cipher_value=(((unsigned int)(q[0]))<< 8)| (((unsigned int)(q[1])) )),q+=2);
 ...
 if (s->tls_session_secret_cb) {
  SSL_CIPHER *pref_cipher = 
# 799 "../ssl/s3_clnt.c" 3 4
                           ((void *)0)
# 799 "../ssl/s3_clnt.c"
                               ;
...
# 802 "../ssl/s3_clnt.c"
 ...
 if (j != 0 && j == s->session->session_id_length &&
  ...
  if (s->sid_ctx_length != s->session->sid_ctx_length ||
   ...
   al = 47;
   ERR_put_error(20,(146),(272),"../ssl/s3_clnt.c",818)
                                                           ;
   goto f_err;
  }
  s->s3->flags |= 0x0080;
...
# 840 "../ssl/s3_clnt.c" 3 4
                                                    ((void *)0)
# 840 "../ssl/s3_clnt.c"
                                                        ) {

  al = 47;
  ERR_put_error(20,(146),(248),"../ssl/s3_clnt.c",844)
                                    ;
  goto f_err;
 }


 if ((c->algorithm_ssl & 0x00000004L) &&
     (((s->version >> 8) == 0x03 ? s->version : 0) < 0x0303)) {
  al = 47;
  ERR_put_error(20,(146),(261),"../ssl/s3_clnt.c",853)
                                  ;
  goto f_err;
 }
 p += 2;
 ...
 i = sk_find(((_STACK*) (1 ? (sk) : (struct stack_st_SSL_CIPHER*)0)), ((void*) (1 ? (c) : (SSL_CIPHER*)0)));
 if (i < 0) {

  al = 47;
  ERR_put_error(20,(146),(261),"../ssl/s3_clnt.c",864)
                                  ;
  goto f_err;
 }
 ...
 if (s->hit && (s->session->cipher_id != c->id)) {
  al = 47;
  ERR_put_error(20,(146),(197),"../ssl/s3_clnt.c",878)
                                            ;
  goto f_err;
 }
 ...
 if (!((s->method->ssl3_enc->enc_flags & (1 << 1)) || (alg_k & 0x00000200L)) &&
 ...
 if (*(p++) != 0) {
  al = 47;
  ERR_put_error(20,(146),(257),"../ssl/s3_clnt.c",899)
                                              ;
  goto f_err;
 }
 ...
 if (!ssl_parse_serverhello_tlsext(s, &p, d, n, &al)) {
  ...
  ERR_put_error(20,(146),(227),"../ssl/s3_clnt.c",906);
  goto f_err;
 }
 if (ssl_check_serverhello_tlsext(s) <= 0) {
  ERR_put_error(20,(146),(275),"../ssl/s3_clnt.c",910);
  goto err;
 }
...
truncated:
 ...
 al = 50;
 ERR_put_error(20,(146),(115),"../ssl/s3_clnt.c",922);
f_err:
...
ssl3_get_server_certificate(SSL *s)
{
 ...
 CBS cbs, cert_list;
 X509 *x = 
# 935 "../ssl/s3_clnt.c" 3 4
            ((void *)0)
# 935 "../ssl/s3_clnt.c"
                ;
 const unsigned char *q;
 struct stack_st_X509 *sk = 
# 937 "../ssl/s3_clnt.c" 3 4
                      ((void *)0)
# 937 "../ssl/s3_clnt.c"
                          ;
 SESS_CERT *sc;
 EVP_PKEY *pkey = 
# 939 "../ssl/s3_clnt.c" 3 4
                  ((void *)0)
# 939 "../ssl/s3_clnt.c"
                      ;

 n = s->method->ssl_get_message(s, (0x130|0x1000),
     (0x131|0x1000), -1, s->max_cert_list, &ok);
 ...
 if (s->s3->tmp.message_type != 11) {
  al = 10;
  ERR_put_error(20,(144),(114),"../ssl/s3_clnt.c",955)
                             ;
  goto f_err;
 }


 if ((sk = ((struct stack_st_X509 *)sk_new_null())) == 
# 960 "../ssl/s3_clnt.c" 3 4
                                 ((void *)0)
# 960 "../ssl/s3_clnt.c"
                                     ) {
  ERR_put_error(20,(144),((1|64)),"../ssl/s3_clnt.c",962)
                           ;
  goto err;
 }
 ...
 if (!CBS_get_u24_length_prefixed(&cbs, &cert_list) ||
     CBS_len(&cbs) != 0) {
  al = 50;
  ERR_put_error(20,(144),(159),"../ssl/s3_clnt.c",977)
                            ;
  goto f_err;
 }
 ...
 while (CBS_len(&cert_list) > 0) {
  ...
  if (!CBS_get_u24_length_prefixed(&cert_list, &cert)) {
   al = 50;
   ERR_put_error(20,(144),(135),"../ssl/s3_clnt.c",989)
                                  ;
   goto f_err;
  }
  ...
  q = CBS_data(&cert);
  x = d2i_X509(
# 994 "../ssl/s3_clnt.c" 3 4
              ((void *)0)
# 994 "../ssl/s3_clnt.c"
                  , &q, CBS_len(&cert));
  if (x == 
# 995 "../ssl/s3_clnt.c" 3 4
          ((void *)0)
# 995 "../ssl/s3_clnt.c"
              ) {
   al = 42;
   ERR_put_error(20,(144),(13),"../ssl/s3_clnt.c",998)
                      ;
   goto f_err;
  }
  if (q != CBS_data(&cert) + CBS_len(&cert)) {
   al = 50;
   ERR_put_error(20,(144),(135),"../ssl/s3_clnt.c",1004)
                                  ;
   goto f_err;
  }
  if (!sk_push(((_STACK*) (1 ? (sk) : (struct stack_st_X509*)0)), ((void*) (1 ? (x) : (X509*)0)))) {
   ERR_put_error(20,(144),((1|64)),"../ssl/s3_clnt.c",1009)
                            ;
   goto err;
  }
  x = 
# 1012 "../ssl/s3_clnt.c" 3 4
     ((void *)0)
# 1012 "../ssl/s3_clnt.c"
         ;
 }
 ...
 if ((s->verify_mode != 0x00) && (i <= 0)) {
  al = ssl_verify_alarm_type(s->verify_result);
  ERR_put_error(20,(144),(134),"../ssl/s3_clnt.c",1019)
                                      ;
  goto f_err;
...
# 1026 "../ssl/s3_clnt.c"
 ...
 x = ((X509 *)sk_value(((_STACK*) (1 ? (sk) : (struct stack_st_X509*)0)), (0)));
 sk = 
# 1038 "../ssl/s3_clnt.c" 3 4
     ((void *)0)
# 1038 "../ssl/s3_clnt.c"
         ;
 ...
 if (pkey == 
# 1043 "../ssl/s3_clnt.c" 3 4
            ((void *)0) 
# 1043 "../ssl/s3_clnt.c"
                 || EVP_PKEY_missing_parameters(pkey)) {
  x = 
# 1044 "../ssl/s3_clnt.c" 3 4
     ((void *)0)
# 1044 "../ssl/s3_clnt.c"
         ;
  al = 2;
  ERR_put_error(20,(144),(239),"../ssl/s3_clnt.c",1047)
                                                 ;
  goto f_err;
 }
 ...
 if (i < 0) {
  x = 
# 1053 "../ssl/s3_clnt.c" 3 4
     ((void *)0)
# 1053 "../ssl/s3_clnt.c"
         ;
  al = 2;
  ERR_put_error(20,(144),(247),"../ssl/s3_clnt.c",1056)
                                     ;
  goto f_err;
 }

 sc->peer_cert_type = i;
 CRYPTO_add_lock(&x->references,1,3,"../ssl/s3_clnt.c",1061);
 ...
 CRYPTO_add_lock(&x->references,1,3,"../ssl/s3_clnt.c",1071);
 s->session->peer = x;
 s->session->verify_result = s->verify_result;

 x = 
# 1075 "../ssl/s3_clnt.c" 3 4
    ((void *)0)
# 1075 "../ssl/s3_clnt.c"
        ;
 ret = 1;
...
truncated:
  ...
  al = 50;
  ERR_put_error(20,(144),(115),"../ssl/s3_clnt.c",1083)
                              ;
f_err:
  ssl3_send_alert(s, 2, al);
 }
err:
 EVP_PKEY_free(pkey);
 X509_free(x);
 sk_pop_free(((_STACK*) (1 ? (sk) : (struct stack_st_X509*)0)), ((void (*)(void *)) ((1 ? (X509_free) : (void (*)(X509 *))0))));
 return (ret);
}
...
{
 unsigned char *q, md_buf[64*2];
 EVP_MD_CTX md_ctx;
 unsigned char *param, *p;
 int al, i, j, param_len, ok;
 long n, alg_k, alg_a;
 EVP_PKEY *pkey = 
# 1102 "../ssl/s3_clnt.c" 3 4
                 ((void *)0)
# 1102 "../ssl/s3_clnt.c"
                     ;
 const EVP_MD *md = 
# 1103 "../ssl/s3_clnt.c" 3 4
                     ((void *)0)
# 1103 "../ssl/s3_clnt.c"
                         ;
 RSA *rsa = 
# 1104 "../ssl/s3_clnt.c" 3 4
            ((void *)0)
# 1104 "../ssl/s3_clnt.c"
                ;
 DH *dh = 
# 1105 "../ssl/s3_clnt.c" 3 4
          ((void *)0)
# 1105 "../ssl/s3_clnt.c"
              ;
 EC_KEY *ecdh = 
# 1106 "../ssl/s3_clnt.c" 3 4
                ((void *)0)
# 1106 "../ssl/s3_clnt.c"
                    ;
 BN_CTX *bn_ctx = 
# 1107 "../ssl/s3_clnt.c" 3 4
                  ((void *)0)
# 1107 "../ssl/s3_clnt.c"
                      ;
 EC_POINT *srvr_ecpoint = 
# 1108 "../ssl/s3_clnt.c" 3 4
                         ((void *)0)
# 1108 "../ssl/s3_clnt.c"
                             ;
 int curve_nid = 0;
 ...
 n = s->method->ssl_get_message(s, (0x140|0x1000),
     (0x141|0x1000), -1, s->max_cert_list, &ok);
 if (!ok)
  return ((int)n);
 ...
 if (s->s3->tmp.message_type != 12) {
  ...
  if (alg_k & (0x00000008L|0x00000080L)) {
   ERR_put_error(20,(141),(244),"../ssl/s3_clnt.c",1133)
                                ;
   al = 10;
   goto f_err;
  }
 ...
 if (s->session->sess_cert != 
# 1143 "../ssl/s3_clnt.c" 3 4
                             ((void *)0)
# 1143 "../ssl/s3_clnt.c"
                                 ) {
  DH_free(s->session->sess_cert->peer_dh_tmp);
  s->session->sess_cert->peer_dh_tmp = 
# 1145 "../ssl/s3_clnt.c" 3 4
                                      ((void *)0)
# 1145 "../ssl/s3_clnt.c"
                                          ;
...
# 1151 "../ssl/s3_clnt.c"
 ...
 if (alg_k & 0x00000008L) {
  if ((dh = DH_new()) == 
# 1159 "../ssl/s3_clnt.c" 3 4
                        ((void *)0)
# 1159 "../ssl/s3_clnt.c"
                            ) {
   ERR_put_error(20,(141),(5),"../ssl/s3_clnt.c",1161)
                    ;
   goto err;
  }
  if (2 > n)
   goto truncated;
  ((i=(((unsigned int)(p[0]))<< 8)| (((unsigned int)(p[1])) )),p+=2);
  param_len = i + 2;
  if (param_len > n) {
   al = 50;
   ERR_put_error(20,(141),(110),"../ssl/s3_clnt.c",1171)
                             ;
   goto f_err;
  }
  if (!(dh->p = BN_bin2bn(p, i, 
# 1174 "../ssl/s3_clnt.c" 3 4
                               ((void *)0)
# 1174 "../ssl/s3_clnt.c"
                                   ))) {
   ERR_put_error(20,(141),(3),"../ssl/s3_clnt.c",1176)
                    ;
   goto err;
  }
  p += i;
  ...
  if (param_len > n) {
   al = 50;
   ERR_put_error(20,(141),(108),"../ssl/s3_clnt.c",1188)
                             ;
   goto f_err;
  }
  if (!(dh->g = BN_bin2bn(p, i, 
# 1191 "../ssl/s3_clnt.c" 3 4
                               ((void *)0)
# 1191 "../ssl/s3_clnt.c"
                                   ))) {
   ERR_put_error(20,(141),(3),"../ssl/s3_clnt.c",1193)
                    ;
   goto err;
  }
  p += i;
  ...
  if (param_len > n) {
   al = 50;
   ERR_put_error(20,(141),(109),"../ssl/s3_clnt.c",1205)
                                   ;
   goto f_err;
  }
  if (!(dh->pub_key = BN_bin2bn(p, i, 
# 1208 "../ssl/s3_clnt.c" 3 4
                                     ((void *)0)
# 1208 "../ssl/s3_clnt.c"
                                         ))) {
   ERR_put_error(20,(141),(3),"../ssl/s3_clnt.c",1210)
                    ;
   goto err;
  }
  p += i;
  ...
  if (DH_size(dh) < 1024 / 8) {
   ERR_put_error(20,(141),(110),"../ssl/s3_clnt.c",1223)
                             ;
   goto err;
  }

  if (alg_a & 0x00000001L)
   pkey = X509_get_pubkey(
       s->session->sess_cert->peer_pkeys[
       0].x509);
  else if (alg_a & 0x00000002L)
   pkey = X509_get_pubkey(
       s->session->sess_cert->peer_pkeys[
       2].x509);
...
# 1238 "../ssl/s3_clnt.c"
  ...
  if ((ecdh = EC_KEY_new()) == 
# 1243 "../ssl/s3_clnt.c" 3 4
                              ((void *)0)
# 1243 "../ssl/s3_clnt.c"
                                  ) {
   ERR_put_error(20,(141),((1|64)),"../ssl/s3_clnt.c",1245)
                            ;
   goto err;
  }
# 1260 "../ssl/s3_clnt.c"
  ...
  if (param_len > n) {
   al = 50;
   ERR_put_error(20,(141),(160),"../ssl/s3_clnt.c",1264)
                              ;
   goto f_err;
  }
  ...
  if (tls1_check_curve(s, p, param_len) != 1) {
   al = 50;
   ERR_put_error(20,(141),(378),"../ssl/s3_clnt.c",1274);
   goto f_err;
  }

  if ((curve_nid = tls1_ec_curve_id2nid(*(p + 2))) == 0) {
   al = 80;
   ERR_put_error(20,(141),(314),"../ssl/s3_clnt.c",1281)
                                            ;
   goto f_err;
  }
  ...
  if (ngroup == 
# 1286 "../ssl/s3_clnt.c" 3 4
               ((void *)0)
# 1286 "../ssl/s3_clnt.c"
                   ) {
   ERR_put_error(20,(141),(16),"../ssl/s3_clnt.c",1288)
                    ;
   goto err;
  }
  if (EC_KEY_set_group(ecdh, ngroup) == 0) {
   ERR_put_error(20,(141),(16),"../ssl/s3_clnt.c",1293)
                    ;
   goto err;
  }
  ...
  if (((srvr_ecpoint = EC_POINT_new(group)) == 
# 1303 "../ssl/s3_clnt.c" 3 4
                                              ((void *)0)
# 1303 "../ssl/s3_clnt.c"
                                                  ) ||
      ((bn_ctx = BN_CTX_new()) == 
# 1304 "../ssl/s3_clnt.c" 3 4
                                 ((void *)0)
# 1304 "../ssl/s3_clnt.c"
                                     )) {
   ERR_put_error(20,(141),((1|64)),"../ssl/s3_clnt.c",1306)
                            ;
   goto err;
  }
  ...
  if ((param_len > n) || (EC_POINT_oct2point(group, srvr_ecpoint,
   ...
   al = 50;
   ERR_put_error(20,(141),(306),"../ssl/s3_clnt.c",1320)
                         ;
   goto f_err;
  }
  ...
  ecdh = 
# 1343 "../ssl/s3_clnt.c" 3 4
        ((void *)0)
# 1343 "../ssl/s3_clnt.c"
            ;
  BN_CTX_free(bn_ctx);
  bn_ctx = 
# 1345 "../ssl/s3_clnt.c" 3 4
          ((void *)0)
# 1345 "../ssl/s3_clnt.c"
              ;
  EC_POINT_free(srvr_ecpoint);
  srvr_ecpoint = 
# 1347 "../ssl/s3_clnt.c" 3 4
                ((void *)0)
# 1347 "../ssl/s3_clnt.c"
                    ;
 } else if (alg_k) {
  al = 10;
  ERR_put_error(20,(141),(244),"../ssl/s3_clnt.c",1351)
                               ;
   goto f_err;
 }
 ...
 if (pkey != 
# 1358 "../ssl/s3_clnt.c" 3 4
            ((void *)0)
# 1358 "../ssl/s3_clnt.c"
                ) {
  if ((s->method->ssl3_enc->enc_flags & (1 << 1))) {
   int sigalg = tls12_get_sigid(pkey);

   if (sigalg == -1) {
    ERR_put_error(20,(141),((4|64)),"../ssl/s3_clnt.c",1364)
                             ;
    goto err;
   }
   ...
   if (2 > n)
    goto truncated;
   if (sigalg != (int)p[1]) {
    ERR_put_error(20,(141),(370),"../ssl/s3_clnt.c",1375)
                                   ;
    al = 50;
    goto f_err;
   }
   ...
   if (md == 
# 1380 "../ssl/s3_clnt.c" 3 4
            ((void *)0)
# 1380 "../ssl/s3_clnt.c"
                ) {
    ERR_put_error(20,(141),(368),"../ssl/s3_clnt.c",1382)
                             ;
    al = 50;
    goto f_err;
   }
  ...
  if (i != n || n > j) {
   ...
   al = 50;
   ERR_put_error(20,(141),(264),"../ssl/s3_clnt.c",1401)
                                    ;
   goto f_err;
  }

  if (pkey->type == 6 && !(s->method->ssl3_enc->enc_flags & (1 << 1))) {
   int num;
...
# 1413 "../ssl/s3_clnt.c"
   ...
   i = RSA_verify(114, md_buf, j,
       p, n, pkey->pkey.rsa);
   if (i < 0) {
    al = 51;
    ERR_put_error(20,(141),(118),"../ssl/s3_clnt.c",1434)
                              ;
    goto f_err;
   }
   if (i == 0) {
    ...
    al = 51;
    ERR_put_error(20,(141),(123),"../ssl/s3_clnt.c",1441)
                            ;
    goto f_err;
   }
  } else {
   EVP_DigestInit_ex(&md_ctx,md,
# 1445 "../ssl/s3_clnt.c" 3 4
  ((void *)0)
# 1445 "../ssl/s3_clnt.c"
  );
   EVP_DigestUpdate(&md_ctx,s->s3->client_random,32)
                        ;
   EVP_DigestUpdate(&md_ctx,s->s3->server_random,32)
                        ;
   EVP_DigestUpdate(&md_ctx,param,param_len);
   if (EVP_VerifyFinal(&md_ctx, p,(int)n, pkey) <= 0) {

    al = 51;
    ERR_put_error(20,(141),(123),"../ssl/s3_clnt.c",1455)
                            ;
    goto f_err;
   }
  }
  ...
  if (!(alg_a & 0x00000004L)) {
   ERR_put_error(20,(141),((4|64)),"../ssl/s3_clnt.c",1463)
                            ;
   goto err;
  }
  ...
  if (n != 0) {
   al = 50;
   ERR_put_error(20,(141),(153),"../ssl/s3_clnt.c",1470)
                                   ;
   goto f_err;
  }
 }
...
truncated:
 ...
 al = 50;
 ERR_put_error(20,(141),(115),"../ssl/s3_clnt.c",1480);
f_err:
 ssl3_send_alert(s, 2, al);
err:
 EVP_PKEY_free(pkey);
...
ssl3_get_certificate_request(SSL *s)
{
 ...
 X509_NAME *xn = 
# 1501 "../ssl/s3_clnt.c" 3 4
                 ((void *)0)
# 1501 "../ssl/s3_clnt.c"
                     ;
 const unsigned char *q;
 struct stack_st_X509_NAME *ca_sk = 
# 1503 "../ssl/s3_clnt.c" 3 4
                             ((void *)0)
# 1503 "../ssl/s3_clnt.c"
                                 ;

 n = s->method->ssl_get_message(s, (0x150|0x1000),
     (0x151|0x1000), -1, s->max_cert_list, &ok);
 ...
 if (s->s3->tmp.message_type != 13) {
  ...
  ERR_put_error(20,(135),(262),"../ssl/s3_clnt.c",1529)
                               ;
  goto err;
 }


 if (s->s3->tmp.new_cipher->algorithm_auth & 0x00000004L) {
  ssl3_send_alert(s, 2, 10);
  ERR_put_error(20,(135),(232),"../ssl/s3_clnt.c",1537)
                                                 ;
  goto err;
 }
 ...
 if ((ca_sk = ((struct stack_st_X509_NAME *)sk_new(((int (*)(const void *, const void *)) ((1 ? (ca_dn_cmp) : (int (*)(const X509_NAME * const *, const X509_NAME * const *))0)))))) == 
# 1545 "../ssl/s3_clnt.c" 3 4
                                             ((void *)0)
# 1545 "../ssl/s3_clnt.c"
                                                 ) {
  ERR_put_error(20,(135),((1|64)),"../ssl/s3_clnt.c",1547)
                           ;
  goto err;
 }
 ...
 if (!CBS_get_bytes(&cert_request, &ctypes, ctype_num) ||
     ...
     sizeof(s->s3->tmp.ctype), 
# 1559 "../ssl/s3_clnt.c" 3 4
                              ((void *)0)
# 1559 "../ssl/s3_clnt.c"
                                  )) {
  ERR_put_error(20,(135),(146),"../ssl/s3_clnt.c",1561)
                                 ;
  goto err;
 }
 ...
 if ((s->method->ssl3_enc->enc_flags & (1 << 1))) {
  ...
  if (CBS_len(&cert_request) < 2) {
   ERR_put_error(20,(135),(146),"../ssl/s3_clnt.c",1570)
                                  ;
   goto err;
  }
  ...
  if (!CBS_get_u16_length_prefixed(&cert_request, &sigalgs)) {
   ...
   ERR_put_error(20,(135),(146),"../ssl/s3_clnt.c",1580)
                                  ;
   goto err;
  }
  if ((CBS_len(&sigalgs) & 1) ||
      ...
      CBS_len(&sigalgs))) {
   ssl3_send_alert(s, 2, 50);
   ERR_put_error(20,(135),(360),"../ssl/s3_clnt.c",1588)
                                        ;
   goto err;
  }
 }
 ...
 if (CBS_len(&cert_request) < 2) {
  ERR_put_error(20,(135),(146),"../ssl/s3_clnt.c",1596)
                                 ;
  goto err;
 }
 ...
 if (!CBS_get_u16_length_prefixed(&cert_request, &rdn_list) ||
  ...
  ssl3_send_alert(s, 2, 50);
  ERR_put_error(20,(135),(159),"../ssl/s3_clnt.c",1604)
                            ;
  goto err;
 }
 ...
 while (CBS_len(&rdn_list) > 0) {
  ...
  if (CBS_len(&rdn_list) < 2) {
   ERR_put_error(20,(135),(146),"../ssl/s3_clnt.c",1613)
                                  ;
   goto err;
  }
  ...
  if (!CBS_get_u16_length_prefixed(&rdn_list, &rdn)) {
   ssl3_send_alert(s, 2, 50);
   ERR_put_error(20,(135),(132),"../ssl/s3_clnt.c",1620)
                            ;
   goto err;
  }
...
# 1625 "../ssl/s3_clnt.c"
   ...
   ssl3_send_alert(s, 2,
       50);
   ERR_put_error(20,(135),(13),"../ssl/s3_clnt.c",1629)
                      ;
   goto err;
  }
  ...
  if (q != CBS_data(&rdn) + CBS_len(&rdn)) {
   ssl3_send_alert(s, 2, 50);
   ERR_put_error(20,(135),(131),"../ssl/s3_clnt.c",1636)
                                   ;
   goto err;
  }
  if (!sk_push(((_STACK*) (1 ? (ca_sk) : (struct stack_st_X509_NAME*)0)), ((void*) (1 ? (xn) : (X509_NAME*)0)))) {
   ERR_put_error(20,(135),((1|64)),"../ssl/s3_clnt.c",1641)
                            ;
   goto err;
  }
  xn = 
# 1644 "../ssl/s3_clnt.c" 3 4
      ((void *)0)
# 1644 "../ssl/s3_clnt.c"
          ;
 }
 ...
 if (s->s3->tmp.ca_names != 
# 1650 "../ssl/s3_clnt.c" 3 4
                           ((void *)0)
# 1650 "../ssl/s3_clnt.c"
                               )
  sk_pop_free(((_STACK*) (1 ? (s->s3->tmp.ca_names) : (struct stack_st_X509_NAME*)0)), ((void (*)(void *)) ((1 ? (X509_NAME_free) : (void (*)(X509_NAME *))0))));
 s->s3->tmp.ca_names = ca_sk;
 ca_sk = 
# 1653 "../ssl/s3_clnt.c" 3 4
        ((void *)0)
# 1653 "../ssl/s3_clnt.c"
            ;
 ...
 if (0) {
truncated:
  ERR_put_error(20,(135),(115),"../ssl/s3_clnt.c",1659)
                              ;
 }
err:
 X509_NAME_free(xn);
 if (ca_sk != 
# 1663 "../ssl/s3_clnt.c" 3 4
             ((void *)0)
# 1663 "../ssl/s3_clnt.c"
                 )
  sk_pop_free(((_STACK*) (1 ? (ca_sk) : (struct stack_st_X509_NAME*)0)), ((void (*)(void *)) ((1 ? (X509_NAME_free) : (void (*)(X509_NAME *))0))));
 return (ret);
}
...
ssl3_get_new_session_ticket(SSL *s)
{
 ...
 n = s->method->ssl_get_message(s, (0x1E0|0x1000),
     (0x1E1|0x1000), -1, 16384, &ok);
 if (!ok)
  return ((int)n);

 if (s->s3->tmp.message_type == 20) {
  s->s3->tmp.reuse_message = 1;
  return (1);
 }
 if (s->s3->tmp.message_type != 4) {
  al = 10;
  ERR_put_error(20,(283),(114),"../ssl/s3_clnt.c",1694)
                             ;
  goto f_err;
 }
 ...
 if (n < 0) {
  al = 50;
  ERR_put_error(20,(283),(159),"../ssl/s3_clnt.c",1701)
                            ;
  goto f_err;
 }
 ...
 if (!CBS_get_u32(&cbs, &lifetime_hint) ||
     ...
     CBS_len(&cbs) != 0) {
  al = 50;
  ERR_put_error(20,(283),(159),"../ssl/s3_clnt.c",1714)
                            ;
  goto f_err;
 }
 ...
 if (!CBS_stow(&session_ticket, &s->session->tlsext_tick,
  ...
  ERR_put_error(20,(283),((1|64)),"../ssl/s3_clnt.c",1722)
                           ;
  goto err;
 }
# 1742 "../ssl/s3_clnt.c"
...
ssl3_get_cert_status(SSL *s)
{
 ...
 n = s->method->ssl_get_message(s, (0x1F0|0x1000),
     (0x1F1|0x1000), 22,
     16384, &ok);
 ...
 if (n < 0) {
  ...
  al = 50;
  ERR_put_error(20,(289),(159),"../ssl/s3_clnt.c",1773)
                            ;
  goto f_err;
 }
 ...
 if (!CBS_get_u8(&cert_status, &status_type) ||
  ...
  al = 50;
  ERR_put_error(20,(289),(159),"../ssl/s3_clnt.c",1783)
                            ;
  goto f_err;
 }
 ...
 if (status_type != 1) {
  al = 50;
  ERR_put_error(20,(289),(329),"../ssl/s3_clnt.c",1790)
                                    ;
  goto f_err;
 }
 ...
 if (!CBS_get_u24_length_prefixed(&cert_status, &response) ||
  ...
  al = 50;
  ERR_put_error(20,(289),(159),"../ssl/s3_clnt.c",1798)
                            ;
  goto f_err;
 }

 if (!CBS_stow(&response, &s->tlsext_ocsp_resp,
     &stow_len) || stow_len > 0x7fffffff) {
  s->tlsext_ocsp_resplen = 0;
   al = 80;
   ERR_put_error(20,(289),((1|64)),"../ssl/s3_clnt.c",1807)
                            ;
   goto f_err;
  }
 ...
 if (s->ctx->tlsext_status_cb) {
  ...
  if (ret == 0) {
   al = 113;
   ERR_put_error(20,(289),(328),"../ssl/s3_clnt.c",1818)
                                     ;
   goto f_err;
  }
  if (ret < 0) {
   al = 80;
   ERR_put_error(20,(289),((1|64)),"../ssl/s3_clnt.c",1824)
                            ;
   goto f_err;
  }
 }
...
ssl3_get_server_done(SSL *s)
{
 ...
 n = s->method->ssl_get_message(s, (0x160|0x1000),
     (0x161|0x1000), 14,
     30, &ok);
 ...
 if (n > 0) {
  ...
  ssl3_send_alert(s, 2, 50);
  ERR_put_error(20,(145),(159),"../ssl/s3_clnt.c",1849);
  return (-1);
 }
 ret = 1;
 return (ret);
...
# 1861 "../ssl/s3_clnt.c"
 ...
 pkey = X509_get_pubkey(sess_cert->peer_pkeys[0].x509);
 if (pkey == 
# 1867 "../ssl/s3_clnt.c" 3 4
            ((void *)0) 
# 1867 "../ssl/s3_clnt.c"
                 || pkey->type != 6 ||
     pkey->pkey.rsa == 
# 1868 "../ssl/s3_clnt.c" 3 4
                      ((void *)0)
# 1868 "../ssl/s3_clnt.c"
                          ) {
  ERR_put_error(20,(152),((4|64)),"../ssl/s3_clnt.c",1870)
                           ;
  goto err;
 }
 ...
 n = RSA_public_encrypt(sizeof(tmp_buf), tmp_buf, p, pkey->pkey.rsa,
     1);
 if (n <= 0) {
  ERR_put_error(20,(152),(119),"../ssl/s3_clnt.c",1887)
                            ;
  goto err;
 }

 ((q[0]=(unsigned char)(((n)>> 8)&0xff), q[1]=(unsigned char)(((n) )&0xff)),q+=2);
 n += 2;
...
# 1913 "../ssl/s3_clnt.c"
 ...
 if (sess_cert->peer_dh_tmp == 
# 1918 "../ssl/s3_clnt.c" 3 4
                              ((void *)0)
# 1918 "../ssl/s3_clnt.c"
                                  ) {
  ssl3_send_alert(s, 2, 40);
  ERR_put_error(20,(152),(238),"../ssl/s3_clnt.c",1921)
                                         ;
  goto err;
 }
 ...
 if ((dh_clnt = DHparams_dup(dh_srvr)) == 
# 1927 "../ssl/s3_clnt.c" 3 4
                                         ((void *)0)
# 1927 "../ssl/s3_clnt.c"
                                             ) {
  ERR_put_error(20,(152),(5),"../ssl/s3_clnt.c",1928);
  goto err;
 }
 if (!DH_generate_key(dh_clnt)) {
  ERR_put_error(20,(152),(5),"../ssl/s3_clnt.c",1932);
  goto err;
 }
 key_size = DH_size(dh_clnt);
 if ((key = malloc(key_size)) == 
# 1936 "../ssl/s3_clnt.c" 3 4
                                ((void *)0)
# 1936 "../ssl/s3_clnt.c"
                                    ) {
  ERR_put_error(20,(152),((1|64)),"../ssl/s3_clnt.c",1938)
                           ;
  goto err;
 }
 n = DH_compute_key(key, dh_srvr->pub_key, dh_clnt);
 if (n <= 0) {
  ERR_put_error(20,(152),(5),"../ssl/s3_clnt.c",1943);
  goto err;
 }
 ...
 n = ((BN_num_bits(dh_clnt->pub_key)+7)/8);
 ((p[0]=(unsigned char)(((n)>> 8)&0xff), p[1]=(unsigned char)(((n) )&0xff)),p+=2);
...
ssl3_send_client_kex_ecdh(SSL *s, SESS_CERT *sess_cert, unsigned char *p,
    int *outlen)
{
 EC_KEY *tkey, *clnt_ecdh = 
# 1974 "../ssl/s3_clnt.c" 3 4
                           ((void *)0)
# 1974 "../ssl/s3_clnt.c"
                               ;
 const EC_GROUP *srvr_group = 
# 1975 "../ssl/s3_clnt.c" 3 4
                             ((void *)0)
# 1975 "../ssl/s3_clnt.c"
                                 ;
 const EC_POINT *srvr_ecpoint = 
# 1976 "../ssl/s3_clnt.c" 3 4
                               ((void *)0)
# 1976 "../ssl/s3_clnt.c"
                                   ;
 EVP_PKEY *srvr_pub_pkey = 
# 1977 "../ssl/s3_clnt.c" 3 4
                          ((void *)0)
# 1977 "../ssl/s3_clnt.c"
                              ;
 BN_CTX *bn_ctx = 
# 1978 "../ssl/s3_clnt.c" 3 4
                 ((void *)0)
# 1978 "../ssl/s3_clnt.c"
                     ;
 unsigned char *encodedPoint = 
# 1979 "../ssl/s3_clnt.c" 3 4
                              ((void *)0)
# 1979 "../ssl/s3_clnt.c"
                                  ;
 unsigned char *key = 
# 1980 "../ssl/s3_clnt.c" 3 4
                     ((void *)0)
# 1980 "../ssl/s3_clnt.c"
                         ;
 unsigned long alg_k;
 ...
 if ((alg_k & 0x00000080L) && sess_cert->peer_ecdh_tmp == 
# 1989 "../ssl/s3_clnt.c" 3 4
                                                        ((void *)0)
# 1989 "../ssl/s3_clnt.c"
                                                            ) {
  ssl3_send_alert(s, 2, 40);
  ERR_put_error(20,(152),((4|64)),"../ssl/s3_clnt.c",1992)
                           ;
  goto err;
 }
 ...
 if (alg_k & (0x00000020L|0x00000040L)) {
  ...
  srvr_pub_pkey = X509_get_pubkey(
      sess_cert->peer_pkeys[5].x509);
  if (srvr_pub_pkey != 
# 2001 "../ssl/s3_clnt.c" 3 4
                      ((void *)0) 
# 2001 "../ssl/s3_clnt.c"
                           && srvr_pub_pkey->type == 408)
   tkey = srvr_pub_pkey->pkey.ec;
 }

 if (tkey == 
# 2005 "../ssl/s3_clnt.c" 3 4
            ((void *)0)
# 2005 "../ssl/s3_clnt.c"
                ) {
  ERR_put_error(20,(152),((4|64)),"../ssl/s3_clnt.c",2007)
                           ;
  goto err;
 }
...
# 2014 "../ssl/s3_clnt.c"
  ...
  ERR_put_error(20,(152),((4|64)),"../ssl/s3_clnt.c",2016)
                           ;
  goto err;
 }

 if ((clnt_ecdh = EC_KEY_new()) == 
# 2020 "../ssl/s3_clnt.c" 3 4
                                  ((void *)0)
# 2020 "../ssl/s3_clnt.c"
                                      ) {
  ERR_put_error(20,(152),((1|64)),"../ssl/s3_clnt.c",2022)
                           ;
  goto err;
 }

 if (!EC_KEY_set_group(clnt_ecdh, srvr_group)) {
  ERR_put_error(20,(152),(16),"../ssl/s3_clnt.c",2027);
  goto err;
 }


 if (!(EC_KEY_generate_key(clnt_ecdh))) {
  ERR_put_error(20,(152),(43),"../ssl/s3_clnt.c",2033);
  goto err;
 }
 key_size = ECDH_size(clnt_ecdh);
 if (key_size <= 0) {
  ERR_put_error(20,(152),(43),"../ssl/s3_clnt.c",2038);
  goto err;
 }
 if ((key = malloc(key_size)) == 
# 2041 "../ssl/s3_clnt.c" 3 4
                                ((void *)0)
# 2041 "../ssl/s3_clnt.c"
                                    ) {
  ERR_put_error(20,(152),((1|64)),"../ssl/s3_clnt.c",2043)
                           ;
 }
 n = ECDH_compute_key(key, key_size, srvr_ecpoint, clnt_ecdh, 
# 2045 "../ssl/s3_clnt.c" 3 4
                                                             ((void *)0)
# 2045 "../ssl/s3_clnt.c"
                                                                 );
 if (n <= 0) {
  ERR_put_error(20,(152),(43),"../ssl/s3_clnt.c",2047);
  goto err;
 }
...
# 2065 "../ssl/s3_clnt.c"
  ...
  ERR_put_error(20,(152),((1|64)),"../ssl/s3_clnt.c",2067)
                           ;
  goto err;
 }
...
# 2106 "../ssl/s3_clnt.c"
 ...
 peer_cert = sess_cert->peer_pkeys[6].x509;
 if (peer_cert == 
# 2118 "../ssl/s3_clnt.c" 3 4
                 ((void *)0)
# 2118 "../ssl/s3_clnt.c"
                     ) {
  ERR_put_error(20,(152),(330),"../ssl/s3_clnt.c",2120)
                                             ;
  goto err;
 }
...
# 2125 "../ssl/s3_clnt.c"
 ...
 if (ukm_hash == 
# 2155 "../ssl/s3_clnt.c" 3 4
                ((void *)0)
# 2155 "../ssl/s3_clnt.c"
                    ) {
  ERR_put_error(20,(152),((1|64)),"../ssl/s3_clnt.c",2157)
                           ;
  goto err;
 }

 if (ssl_get_algorithm2(s) & 0x40)
  nid = 809;
 else
  nid = 941;
 if (!EVP_DigestInit(ukm_hash, EVP_get_digestbyname(OBJ_nid2sn(nid))))
  goto err;
 EVP_DigestUpdate(ukm_hash, s->s3->client_random, 32);
 EVP_DigestUpdate(ukm_hash, s->s3->server_random, 32);
 EVP_DigestFinal_ex(ukm_hash, shared_ukm, &md_len);
 EVP_MD_CTX_destroy(ukm_hash);
 if (EVP_PKEY_CTX_ctrl(pkey_ctx, -1, (1<<8),
     8, 8, shared_ukm) < 0) {
  ERR_put_error(20,(152),(274),"../ssl/s3_clnt.c",2173);
  goto err;
 }
 ...
 *(p++) = 16 | 0x20;
 ...
 if (EVP_PKEY_encrypt(pkey_ctx, tmp, &msglen, premaster_secret,
     32) < 0) {
  ERR_put_error(20,(152),(274),"../ssl/s3_clnt.c",2184);
  goto err;
 }
 if (msglen >= 0x80) {
  *(p++) = 0x81;
 ...
 if (EVP_PKEY_CTX_ctrl(pkey_ctx, -1, -1, 2, 2,
     
# 2199 "../ssl/s3_clnt.c" 3 4
    ((void *)0)
# 2199 "../ssl/s3_clnt.c"
        ) > 0) {
...
ssl3_send_client_key_exchange(SSL *s)
{
 ...
 if (s->state == (0x180|0x1000)) {
  p = ssl3_handshake_msg_start(s, 16);

  alg_k = s->s3->tmp.new_cipher->algorithm_mkey;

  if ((sess_cert = s->session->sess_cert) == 
# 2231 "../ssl/s3_clnt.c" 3 4
                                            ((void *)0)
# 2231 "../ssl/s3_clnt.c"
                                                ) {
   ssl3_send_alert(s, 2,
       10);
   ERR_put_error(20,(152),((4|64)),"../ssl/s3_clnt.c",2235)
                            ;
   goto err;
  }

  if (alg_k & 0x00000001L) {
   if (ssl3_send_client_kex_rsa(s, sess_cert, p, &n) != 1)
    goto err;
  } else if (alg_k & 0x00000008L) {
   if (ssl3_send_client_kex_dhe(s, sess_cert, p, &n) != 1)
    goto err;
  } else if (alg_k & (0x00000080L|0x00000020L|0x00000040L)) {
   ...
   ssl3_send_alert(s, 2,
       40);
   ERR_put_error(20,(152),((4|64)),"../ssl/s3_clnt.c",2255)
                            ;
   goto err;
  }
...
# 2277 "../ssl/s3_clnt.c"
 ...
 if (s->state == (0x190|0x1000)) {
  p = ssl3_handshake_msg_start(s, 15);
...
# 2293 "../ssl/s3_clnt.c" 3 4
                               ((void *)0)
# 2293 "../ssl/s3_clnt.c"
                                   );
  EVP_PKEY_sign_init(pctx);
  if (EVP_PKEY_CTX_ctrl(pctx, -1, ((1<<3) | (1<<4) | (1<<5) | (1<<6) | (1<<7)), 1, 0, (void *)EVP_sha1()) > 0) {
   if (!(s->method->ssl3_enc->enc_flags & (1 << 1)))
  ...
  if ((s->method->ssl3_enc->enc_flags & (1 << 1))) {
   ...
   hdatalen = BIO_ctrl(s->s3->handshake_buffer,3,0,(char *)&hdata)
              ;
   if (hdatalen <= 0 ||
       !tls12_get_sigandhash(p, pkey, md)) {
    ERR_put_error(20,(153),((4|64)),"../ssl/s3_clnt.c",2315)
                             ;
    goto err;
   }
   p += 2;
   if (!EVP_DigestInit_ex(&mctx,md,
# 2319 "../ssl/s3_clnt.c" 3 4
       ((void *)0)
# 2319 "../ssl/s3_clnt.c"
       ) ||
       !EVP_DigestUpdate(&mctx,hdata,hdatalen) ||
       !EVP_SignFinal(&mctx, p + 2, &u, pkey)) {
    ERR_put_error(20,(153),(6),"../ssl/s3_clnt.c",2323)
                      ;
    goto err;
   }
   ((p[0]=(unsigned char)(((u)>> 8)&0xff), p[1]=(unsigned char)(((u) )&0xff)),p+=2);
   n = u + 4;
   if (!tls1_digest_cached_records(s))
    goto err;
  } else if (pkey->type == 6) {
   s->method->ssl3_enc->cert_verify_mac(
       s, 4, &(data[0]));
   if (RSA_sign(114, data,
       16 + 20, &(p[2]),
       &u, pkey->pkey.rsa) <= 0 ) {
    ERR_put_error(20,(153),(4),"../ssl/s3_clnt.c",2337)
                      ;
    goto err;
   }
   ((p[0]=(unsigned char)(((u)>> 8)&0xff), p[1]=(unsigned char)(((u) )&0xff)),p+=2);
   n = u + 2;
  } else if (pkey->type == 116) {
   if (!DSA_sign(pkey->save_type,
       &(data[16]),
       20, &(p[2]),
       (unsigned int *)&j, pkey->pkey.dsa)) {
    ERR_put_error(20,(153),(10),"../ssl/s3_clnt.c",2348)
                      ;
    goto err;
   }
   ((p[0]=(unsigned char)(((j)>> 8)&0xff), p[1]=(unsigned char)(((j) )&0xff)),p+=2);
   n = j + 2;
   ...
   if (!ECDSA_sign(pkey->save_type,
    ...
    ERR_put_error(20,(153),(42),"../ssl/s3_clnt.c",2359)
                        ;
    goto err;
   }
   ((p[0]=(unsigned char)(((j)>> 8)&0xff), p[1]=(unsigned char)(((j) )&0xff)),p+=2);
   ...
   hdatalen = BIO_ctrl(s->s3->handshake_buffer,3,0,(char *)&hdata);
   if (hdatalen <= 0) {
    ERR_put_error(20,(153),((4|64)),"../ssl/s3_clnt.c",2377)
                             ;
    goto err;
   }
   if (!EVP_PKEY_get_default_digest_nid(pkey, &nid) ||
       !(md = EVP_get_digestbyname(OBJ_nid2sn(nid)))) {
    ERR_put_error(20,(153),(6),"../ssl/s3_clnt.c",2383)
                    ;
    goto err;
   }
   if (!EVP_DigestInit_ex(&mctx, md, 
# 2386 "../ssl/s3_clnt.c" 3 4
                                    ((void *)0)
# 2386 "../ssl/s3_clnt.c"
                                        ) ||
       !EVP_DigestUpdate(&mctx, hdata, hdatalen) ||
...
# 2393 "../ssl/s3_clnt.c" 3 4
           ((void *)0)
# 2393 "../ssl/s3_clnt.c"
               ) <= 0) ||
       (EVP_PKEY_sign(pctx, &(p[2]), &sigsize,
        signbuf, u) <= 0)) {
    ERR_put_error(20,(153),(6),"../ssl/s3_clnt.c",2397)
                      ;
    goto err;
   }
   if (!tls1_digest_cached_records(s))
   ...
   ERR_put_error(20,(153),((4|64)),"../ssl/s3_clnt.c",2408)
                            ;
   goto err;
  }

  s->state = (0x191|0x1000);
...
{
 X509 *x509 = 
# 2431 "../ssl/s3_clnt.c" 3 4
              ((void *)0)
# 2431 "../ssl/s3_clnt.c"
                  ;
 EVP_PKEY *pkey = 
# 2432 "../ssl/s3_clnt.c" 3 4
                 ((void *)0)
# 2432 "../ssl/s3_clnt.c"
                     ;
 int i;
 ...
 if (s->state == (0x170|0x1000)) {
  if ((s->cert == 
# 2437 "../ssl/s3_clnt.c" 3 4
                 ((void *)0)
# 2437 "../ssl/s3_clnt.c"
                     ) || (s->cert->key->x509 == 
# 2437 "../ssl/s3_clnt.c" 3 4
...
# 2438 "../ssl/s3_clnt.c" 3 4
                                  ((void *)0)
# 2438 "../ssl/s3_clnt.c"
                                      ))
   s->state = (0x171|0x1000);
  else
   s->state = (0x172|0x1000);
 }


 if (s->state == (0x171|0x1000)) {
...
# 2457 "../ssl/s3_clnt.c"
   ...
   i = 0;
   ERR_put_error(20,(151),(106),"../ssl/s3_clnt.c",2465)
                                           ;
  }
 ...
 if (s->state == (0x172|0x1000)) {
  s->state = (0x173|0x1000);
  l = ssl3_output_cert_chain(s,
      (s->s3->tmp.cert_req == 2) ? 
# 2480 "../ssl/s3_clnt.c" 3 4
                                  ((void *)0) 
# 2480 "../ssl/s3_clnt.c"
                                       : s->cert->key->x509);
  s->init_num = (int)l;
...
# 2495 "../ssl/s3_clnt.c"
 ...
 if (sc == 
# 2507 "../ssl/s3_clnt.c" 3 4
          ((void *)0)
# 2507 "../ssl/s3_clnt.c"
              ) {
  ERR_put_error(20,(130),((4|64)),"../ssl/s3_clnt.c",2509)
                           ;
  goto err;
 }
 ...
 if (idx == 5) {
  if (ssl_check_srvr_ecc_cert_and_alg(
   ...
   ERR_put_error(20,(130),(304),"../ssl/s3_clnt.c",2522)
                          ;
   goto f_err;
  } else {
   return (1);
 ...
 if ((alg_a & 0x00000001L) && !(((i)&(0x0001|0x0010)) == (0x0001|0x0010))) {
  ERR_put_error(20,(130),(170),"../ssl/s3_clnt.c",2535)
                                     ;
  goto f_err;
 } else if ((alg_a & 0x00000002L) &&
     !(((i)&(0x0002|0x0010)) == (0x0002|0x0010))) {
  ERR_put_error(20,(130),(165),"../ssl/s3_clnt.c",2540)
                                     ;
  goto f_err;
 }
 if ((alg_k & 0x00000001L) &&
     !(((i)&(0x0001|0x0020)) == (0x0001|0x0020))) {
  ERR_put_error(20,(130),(169),"../ssl/s3_clnt.c",2546)
                                        ;
  goto f_err;
 }
 if ((alg_k & 0x00000008L) &&
     !((((i)&(0x0004|0x0040)) == (0x0004|0x0040)) || (dh != 
# 2550 "../ssl/s3_clnt.c" 3 4
                                                    ((void *)0)
# 2550 "../ssl/s3_clnt.c"
                                                        ))) {
  ERR_put_error(20,(130),(163),"../ssl/s3_clnt.c",2552)
                           ;
  goto f_err;
 }
...
ssl3_send_next_proto(SSL *s)
{
 ...
 if (s->state == (0x200|0x1000)) {
  d = p = ssl3_handshake_msg_start(s, 67);
