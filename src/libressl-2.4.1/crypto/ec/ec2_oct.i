...
# 97 "ec/ec2_oct.c"
 ...
 if (ctx == 
# 104 "ec/ec2_oct.c" 3 4
           ((void *)0)
# 104 "ec/ec2_oct.c"
               ) {
  ctx = new_ctx = BN_CTX_new();
  if (ctx == 
# 106 "ec/ec2_oct.c" 3 4
            ((void *)0)
# 106 "ec/ec2_oct.c"
                )
   return 0;
...
# 112 "ec/ec2_oct.c" 3 4
                               ((void *)0)
# 112 "ec/ec2_oct.c"
                                   )
  goto err;
 if ((x = BN_CTX_get(ctx)) == 
# 114 "ec/ec2_oct.c" 3 4
                             ((void *)0)
# 114 "ec/ec2_oct.c"
                                 )
  goto err;
 if ((y = BN_CTX_get(ctx)) == 
# 116 "ec/ec2_oct.c" 3 4
                             ((void *)0)
# 116 "ec/ec2_oct.c"
                                 )
  goto err;
 if ((z = BN_CTX_get(ctx)) == 
# 118 "ec/ec2_oct.c" 3 4
                             ((void *)0)
# 118 "ec/ec2_oct.c"
                                 )
  goto err;
 ...
 if (BN_is_zero(x)) {
  ...
  if (!BN_GF2m_mod_solve_quad_arr(z, tmp, group->poly, ctx)) {
   ...
   if ((int)((((unsigned long)err)>>24L)&0xffL) == 3 &&
       (int)((err)&0xfffL) == 116) {
    ERR_clear_error();
    ERR_put_error(16,(164),(110),"ec/ec2_oct.c",141);
   } else
    ERR_put_error(16,(164),(3),"ec/ec2_oct.c",143);
   goto err;
  }
  z0 = ((((z)->top > 0) && ((z)->d[0] & 1))) ? 1 : 0;
...
# 177 "ec/ec2_oct.c"
 ...
 if ((form != POINT_CONVERSION_COMPRESSED)
  ...
  ERR_put_error(16,(161),(104),"ec/ec2_oct.c",185);
  goto err;
 }
 if (EC_POINT_is_at_infinity(group, point) > 0) {

  if (buf != 
# 190 "ec/ec2_oct.c" 3 4
            ((void *)0)
# 190 "ec/ec2_oct.c"
                ) {
   if (len < 1) {
    ERR_put_error(16,(161),(100),"ec/ec2_oct.c",192);
    return 0;
   }
   buf[0] = 0;
  }
 ...
 if (buf != 
# 205 "ec/ec2_oct.c" 3 4
           ((void *)0)
# 205 "ec/ec2_oct.c"
               ) {
  if (len < ret) {
   ERR_put_error(16,(161),(100),"ec/ec2_oct.c",207);
   goto err;
  }
  if (ctx == 
# 210 "ec/ec2_oct.c" 3 4
            ((void *)0)
# 210 "ec/ec2_oct.c"
                ) {
   ctx = new_ctx = BN_CTX_new();
   if (ctx == 
# 212 "ec/ec2_oct.c" 3 4
             ((void *)0)
# 212 "ec/ec2_oct.c"
                 )
    return 0;
  ...
  used_ctx = 1;
  if ((x = BN_CTX_get(ctx)) == 
# 217 "ec/ec2_oct.c" 3 4
                              ((void *)0)
# 217 "ec/ec2_oct.c"
                                  )
   goto err;
  if ((y = BN_CTX_get(ctx)) == 
# 219 "ec/ec2_oct.c" 3 4
                              ((void *)0)
# 219 "ec/ec2_oct.c"
                                  )
   goto err;
  if ((yxi = BN_CTX_get(ctx)) == 
# 221 "ec/ec2_oct.c" 3 4
                                ((void *)0)
# 221 "ec/ec2_oct.c"
                                    )
   goto err;
  ...
  if (skip > field_len) {
   ERR_put_error(16,(161),((4|64)),"ec/ec2_oct.c",238);
   goto err;
  }
  while (skip > 0) {
   buf[i++] = 0;
  ...
  i += skip;
  if (i != 1 + field_len) {
   ERR_put_error(16,(161),((4|64)),"ec/ec2_oct.c",248);
   goto err;
  }
  if (form == POINT_CONVERSION_UNCOMPRESSED ||
   ...
   if (skip > field_len) {
    ERR_put_error(16,(161),((4|64)),"ec/ec2_oct.c",255);
    goto err;
   }
   while (skip > 0) {
    buf[i++] = 0;
  ...
  if (i != ret) {
   ERR_put_error(16,(161),((4|64)),"ec/ec2_oct.c",266);
   goto err;
  }
 }
 if (used_ctx)
...
# 292 "ec/ec2_oct.c"
 ...
 if (len == 0) {
  ERR_put_error(16,(160),(100),"ec/ec2_oct.c",298);
  return 0;
 }
 form = buf[0];
 y_bit = form & 1;
 ...
 if ((form != 0) && (form != POINT_CONVERSION_COMPRESSED) &&
     (form != POINT_CONVERSION_UNCOMPRESSED) &&
     (form != POINT_CONVERSION_HYBRID)) {
  ERR_put_error(16,(160),(102),"ec/ec2_oct.c",307);
  return 0;
 }
 if ((form == 0 || form == POINT_CONVERSION_UNCOMPRESSED) && y_bit) {
  ERR_put_error(16,(160),(102),"ec/ec2_oct.c",311);
  return 0;
 }
 if (form == 0) {
  if (len != 1) {
   ERR_put_error(16,(160),(102),"ec/ec2_oct.c",316);
   return 0;
  }
 ...
 if (len != enc_len) {
  ERR_put_error(16,(160),(102),"ec/ec2_oct.c",326);
  return 0;
 }
 if (ctx == 
# 329 "ec/ec2_oct.c" 3 4
           ((void *)0)
# 329 "ec/ec2_oct.c"
               ) {
  ctx = new_ctx = BN_CTX_new();
  if (ctx == 
# 331 "ec/ec2_oct.c" 3 4
            ((void *)0)
# 331 "ec/ec2_oct.c"
                )
   return 0;
 ...
 BN_CTX_start(ctx);
 if ((x = BN_CTX_get(ctx)) == 
# 335 "ec/ec2_oct.c" 3 4
                             ((void *)0)
# 335 "ec/ec2_oct.c"
                                 )
  goto err;
 if ((y = BN_CTX_get(ctx)) == 
# 337 "ec/ec2_oct.c" 3 4
                             ((void *)0)
# 337 "ec/ec2_oct.c"
                                 )
  goto err;
 if ((yxi = BN_CTX_get(ctx)) == 
# 339 "ec/ec2_oct.c" 3 4
                               ((void *)0)
# 339 "ec/ec2_oct.c"
                                   )
  goto err;
 ...
 if (BN_ucmp(x, &group->field) >= 0) {
  ERR_put_error(16,(160),(102),"ec/ec2_oct.c",345);
  goto err;
 }
 if (form == POINT_CONVERSION_COMPRESSED) {
  ...
  if (BN_ucmp(y, &group->field) >= 0) {
   ERR_put_error(16,(160),(102),"ec/ec2_oct.c",355);
   goto err;
  }
  if (form == POINT_CONVERSION_HYBRID) {
   if (!group->meth->field_div(group, yxi, y, x, ctx))
    goto err;
   if (y_bit != (((yxi)->top > 0) && ((yxi)->d[0] & 1))) {
    ERR_put_error(16,(160),(102),"ec/ec2_oct.c",362);
    goto err;
   }
  }
  if (!EC_POINT_set_affine_coordinates_GF2m(group, point, x, y, ctx))
 ...
 if (EC_POINT_is_on_curve(group, point, ctx) <= 0) {
  ERR_put_error(16,(160),(107),"ec/ec2_oct.c",372);
  goto err;
 }
 ret = 1;
