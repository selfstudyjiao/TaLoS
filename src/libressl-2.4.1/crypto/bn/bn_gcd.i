...
# 276 "bn/bn_gcd.c"
 ...
 if ((((n)->top > 0) && ((n)->d[0] & 1)) && (BN_num_bits(n) <= (128 <= 32 ? 450 : 2048))) {
...
# 389 "bn/bn_gcd.c"
   ...
   B = M;
# 460 "bn/bn_gcd.c"
   if (((((((D))->top == 1) && (((D))->d[0] == (unsigned long)(1))) || (((1) == 0) && (((D))->top == 0))) && !(D)->neg)) {
    if (!BN_add(tmp, X, Y))
     goto err;
   } else {
    if (((((((D))->top == 1) && (((D))->d[0] == (unsigned long)((2)))) || ((((2)) == 0) && (((D))->top == 0))) && (!(2) || !(D)->neg))) {
     if (!BN_lshift1(tmp, X))
      goto err;
    } else if (((((((D))->top == 1) && (((D))->d[0] == (unsigned long)((4)))) || ((((4)) == 0) && (((D))->top == 0))) && (!(4) || !(D)->neg))) {
...
# 498 "bn/bn_gcd.c"
 ...
 if (((((((A))->top == 1) && (((A))->d[0] == (unsigned long)(1))) || (((1) == 0) && (((A))->top == 0))) && !(A)->neg)) {
  ...
  ERR_put_error(3,(110),(108),"bn/bn_gcd.c",514);
  goto err;
 }
 ret = R;
...
# 571 "bn/bn_gcd.c"
 ...
 if (B->neg || (BN_ucmp(B, A) >= 0)) {
  ...
  pB = &local_B;
  ((pB)->d=(B)->d, (pB)->top=(B)->top, (pB)->dmax=(B)->dmax, (pB)->neg=(B)->neg, (pB)->flags=(((pB)->flags & 0x01) | ((B)->flags & ~0x01) | 0x02 | (0x04)));
...
# 604 "bn/bn_gcd.c"
  pA = &local_A;
  ((pA)->d=(A)->d, (pA)->top=(A)->top, (pA)->dmax=(A)->dmax, (pA)->neg=(A)->neg, (pA)->flags=(((pA)->flags & 0x01) | ((A)->flags & ~0x01) | 0x02 | (0x04)));
...
# 661 "bn/bn_gcd.c"
 ...
 if (((((((A))->top == 1) && (((A))->d[0] == (unsigned long)(1))) || (((1) == 0) && (((A))->top == 0))) && !(A)->neg)) {
  ...
  ERR_put_error(3,(139),(108),"bn/bn_gcd.c",677);
  goto err;
 }
 ret = R;
