...
# 96 "evp/e_xcbc_d.c" 3 4
((void *)0)
# 96 "evp/e_xcbc_d.c"
    ,
 
# 97 "evp/e_xcbc_d.c" 3 4
((void *)0)
    ...
    const unsigned char *iv, int enc)
{
 ...
 DES_set_key_unchecked(deskey, &((DESX_CBC_KEY *)(ctx)->cipher_data)->ks);
 memcpy(&((DESX_CBC_KEY *)(ctx)->cipher_data)->inw[0], &key[8], 8);
 memcpy(&((DESX_CBC_KEY *)(ctx)->cipher_data)->outw[0], &key[16], 8);
    ...
    const unsigned char *in, size_t inl)
{
 while (inl >= ((size_t)1<<(sizeof(long)*8-2))) {
  DES_xcbc_encrypt(in, out, (long)((size_t)1<<(sizeof(long)*8-2)), &((DESX_CBC_KEY *)(ctx)->cipher_data)->ks,
      (DES_cblock *)&(ctx->iv[0]), &((DESX_CBC_KEY *)(ctx)->cipher_data)->inw,
      &((DESX_CBC_KEY *)(ctx)->cipher_data)->outw, ctx->encrypt);
  inl -= ((size_t)1<<(sizeof(long)*8-2));
  in += ((size_t)1<<(sizeof(long)*8-2));
  out += ((size_t)1<<(sizeof(long)*8-2));
 }
 if (inl)
  DES_xcbc_encrypt(in, out, (long)inl, &((DESX_CBC_KEY *)(ctx)->cipher_data)->ks,
      (DES_cblock *)&(ctx->iv[0]), &((DESX_CBC_KEY *)(ctx)->cipher_data)->inw,
      &((DESX_CBC_KEY *)(ctx)->cipher_data)->outw, ctx->encrypt);
 return 1;
}
