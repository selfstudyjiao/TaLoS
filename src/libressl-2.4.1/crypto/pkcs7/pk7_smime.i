...
# 66 "pkcs7/pk7_smime.c" 2

static int pkcs7_copy_existing_digest(PKCS7 *p7, PKCS7_SIGNER_INFO *si);

PKCS7 *
PKCS7_sign(X509 *signcert, EVP_PKEY *pkey, struct stack_st_X509 *certs, BIO *data,
    int flags)
{
 PKCS7 *p7;
 int i;
 ...
 if (!(p7 = PKCS7_new())) {
  ERR_put_error(33,(116),((1|64)),"pkcs7/pk7_smime.c",77);
  return 
# 78 "pkcs7/pk7_smime.c" 3 4
        ((void *)0)
# 78 "pkcs7/pk7_smime.c"
            ;
 }
 ...
 if (!PKCS7_content_new(p7, 21))
  goto err;

 if (pkey && !PKCS7_sign_add_signer(p7, signcert, pkey, 
# 87 "pkcs7/pk7_smime.c" 3 4
                                                       ((void *)0)
# 87 "pkcs7/pk7_smime.c"
                                                           , flags)) {
  ERR_put_error(33,(116),(153),"pkcs7/pk7_smime.c",88);
  goto err;
 }

 if (!(flags & 0x2)) {
  for (i = 0; i < sk_num(((_STACK*) (1 ? (certs) : (struct stack_st_X509*)0))); i++) {
   if (!PKCS7_add_certificate(p7, ((X509 *)sk_value(((_STACK*) (1 ? (certs) : (struct stack_st_X509*)0)), (i)))))
    goto err;
  }
 }
 ...
 if (flags & 0x40)
  PKCS7_ctrl(p7,1,1,
# 100 "pkcs7/pk7_smime.c" 3 4
 ((void *)0)
# 100 "pkcs7/pk7_smime.c"
 );
...
err:
 PKCS7_free(p7);
 return 
# 110 "pkcs7/pk7_smime.c" 3 4
       ((void *)0)
# 110 "pkcs7/pk7_smime.c"
           ;
}
...
# 119 "pkcs7/pk7_smime.c" 3 4
                                 ((void *)0)
# 119 "pkcs7/pk7_smime.c"
                                     ))) {
  ERR_put_error(33,(134),((1|64)),"pkcs7/pk7_smime.c",120);
  return 0;
 }

 SMIME_crlf_copy(data, p7bio, flags);

 (void)(int)BIO_ctrl(p7bio,11,0,
# 126 "pkcs7/pk7_smime.c" 3 4
      ((void *)0)
# 126 "pkcs7/pk7_smime.c"
      );

 if (!PKCS7_dataFinal(p7, p7bio)) {
  ERR_put_error(33,(134),(145),"pkcs7/pk7_smime.c",129);
  goto err;
 }
...
static int
add_cipher_smcap(struct stack_st_X509_ALGOR *sk, int nid, int arg)
{
 if (EVP_get_cipherbyname(OBJ_nid2sn(nid)))
  return PKCS7_simple_smimecap(sk, nid, arg);
 return 1;
}

static int
add_digest_smcap(struct stack_st_X509_ALGOR *sk, int nid, int arg)
{
 if (EVP_get_digestbyname(OBJ_nid2sn(nid)))
  return PKCS7_simple_smimecap(sk, nid, arg);
 return 1;
}
...
# 163 "pkcs7/pk7_smime.c" 3 4
                        ((void *)0)
# 163 "pkcs7/pk7_smime.c"
                            ;
 struct stack_st_X509_ALGOR *smcap = 
# 164 "pkcs7/pk7_smime.c" 3 4
                              ((void *)0)
# 164 "pkcs7/pk7_smime.c"
                                  ;

 if (!X509_check_private_key(signcert, pkey)) {
  ERR_put_error(33,(137),(127),"pkcs7/pk7_smime.c",168)
                                                     ;
  return 
# 169 "pkcs7/pk7_smime.c" 3 4
        ((void *)0)
# 169 "pkcs7/pk7_smime.c"
            ;
 }

 if (!(si = PKCS7_add_signature(p7, signcert, pkey, md))) {
  ERR_put_error(33,(137),(124),"pkcs7/pk7_smime.c",174)
                                        ;
  return 
# 175 "pkcs7/pk7_smime.c" 3 4
        ((void *)0)
# 175 "pkcs7/pk7_smime.c"
            ;
 }
 ...
 if (!(flags & 0x100)) {
  if (!PKCS7_add_attrib_content_type(si, 
# 184 "pkcs7/pk7_smime.c" 3 4
                                        ((void *)0)
# 184 "pkcs7/pk7_smime.c"
                                            ))
   goto err;

  if (!(flags & 0x200)) {
   if (!(smcap = ((struct stack_st_X509_ALGOR *)sk_new_null()))) {
    ERR_put_error(33,(137),((1|64)),"pkcs7/pk7_smime.c",190)
                             ;
    goto err;
   }
   if (!add_cipher_smcap(smcap, 427, -1) ||
       !add_digest_smcap(smcap, 809, -1) ||
       !add_digest_smcap(smcap, 941, -1) ||
       !add_digest_smcap(smcap, 942, -1) ||
       !add_cipher_smcap(smcap, 813, -1) ||
       !add_cipher_smcap(smcap, 423, -1) ||
       !add_cipher_smcap(smcap, 419, -1) ||
       !add_cipher_smcap(smcap, 44, -1) ||
       !add_cipher_smcap(smcap, 37, 128) ||
       !add_cipher_smcap(smcap, 37, 64) ||
       !add_cipher_smcap(smcap, 31, -1) ||
       !add_cipher_smcap(smcap, 37, 40) ||
       !PKCS7_add_attrib_smimecap(si, smcap))
    goto err;
   sk_pop_free(((_STACK*) (1 ? (smcap) : (struct stack_st_X509_ALGOR*)0)), ((void (*)(void *)) ((1 ? (X509_ALGOR_free) : (void (*)(X509_ALGOR *))0))));
   smcap = 
# 208 "pkcs7/pk7_smime.c" 3 4
          ((void *)0)
# 208 "pkcs7/pk7_smime.c"
              ;
  }
  if (flags & 0x8000) {
...
err:
 if (smcap)
  sk_pop_free(((_STACK*) (1 ? (smcap) : (struct stack_st_X509_ALGOR*)0)), ((void (*)(void *)) ((1 ? (X509_ALGOR_free) : (void (*)(X509_ALGOR *))0))));
 return 
# 223 "pkcs7/pk7_smime.c" 3 4
       ((void *)0)
# 223 "pkcs7/pk7_smime.c"
           ;
}
...
pkcs7_copy_existing_digest(PKCS7 *p7, PKCS7_SIGNER_INFO *si)
{
 ...
 ASN1_OCTET_STRING *osdig = 
# 236 "pkcs7/pk7_smime.c" 3 4
                           ((void *)0)
# 236 "pkcs7/pk7_smime.c"
                               ;

 sinfos = PKCS7_get_signer_info(p7);
 for (i = 0; i < sk_num(((_STACK*) (1 ? (sinfos) : (struct stack_st_PKCS7_SIGNER_INFO*)0))); i++) {
  sitmp = ((PKCS7_SIGNER_INFO *)sk_value(((_STACK*) (1 ? (sinfos) : (struct stack_st_PKCS7_SIGNER_INFO*)0)), (i)));
  if (si == sitmp)
   break;
  if (sk_num(((_STACK*) (1 ? (sitmp->auth_attr) : (struct stack_st_X509_ATTRIBUTE*)0))) <= 0)
   continue;
 ...
 ERR_put_error(33,(138),(154),"pkcs7/pk7_smime.c",257)
                                           ;
 return 0;
}

int
PKCS7_verify(PKCS7 *p7, struct stack_st_X509 *certs, X509_STORE *store, BIO *indata,
    BIO *out, int flags)
{
 ...
 if (!p7) {
  ERR_put_error(33,(117),(143),"pkcs7/pk7_smime.c",276);
  return 0;
 }

 if (!(OBJ_obj2nid((p7)->type) == 22)) {
  ERR_put_error(33,(117),(113),"pkcs7/pk7_smime.c",281);
  return 0;
 }


 if (PKCS7_ctrl(p7,2,0,
# 286 "pkcs7/pk7_smime.c" 3 4
    ((void *)0)
# 286 "pkcs7/pk7_smime.c"
    ) && !indata) {
  ERR_put_error(33,(117),(122),"pkcs7/pk7_smime.c",287);
  return 0;
 }
 ...
 if (!PKCS7_ctrl(p7,2,0,
# 296 "pkcs7/pk7_smime.c" 3 4
     ((void *)0)
# 296 "pkcs7/pk7_smime.c"
     ) && indata) {
  ERR_put_error(33,(117),(118),"pkcs7/pk7_smime.c",297);
  return 0;
 }

 sinfos = PKCS7_get_signer_info(p7);

 if (!sinfos || !sk_num(((_STACK*) (1 ? (sinfos) : (struct stack_st_PKCS7_SIGNER_INFO*)0)))) {
  ERR_put_error(33,(117),(123),"pkcs7/pk7_smime.c",304);
  return 0;
 }
 ...
 if (!(flags & 0x20))
  for (k = 0; k < sk_num(((_STACK*) (1 ? (signers) : (struct stack_st_X509*)0))); k++) {
   signer = ((X509 *)sk_value(((_STACK*) (1 ? (signers) : (struct stack_st_X509*)0)), (k)));
   if (!(flags & 0x8)) {
    if (!X509_STORE_CTX_init(&cert_ctx, store,
        signer, p7->d.sign->cert)) {
     ERR_put_error(33,(117),(11),"pkcs7/pk7_smime.c",323)
                        ;
    ...
    X509_STORE_CTX_set_default(&cert_ctx,
       ...
       signer, 
# 330 "pkcs7/pk7_smime.c" 3 4
              ((void *)0)
# 330 "pkcs7/pk7_smime.c"
                  )) {
    ERR_put_error(33,(117),(11),"pkcs7/pk7_smime.c",331);
    sk_free(((_STACK*) (1 ? (signers) : (struct stack_st_X509*)0)));
    return 0;
   }
   if (!(flags & 0x2000))
   ...
   if (i <= 0) {
    ERR_put_error(33,(117),(117),"pkcs7/pk7_smime.c",343)
                                         ;
...
# 359 "pkcs7/pk7_smime.c"
 if (indata && (BIO_method_type(indata) == (1|0x0400))) {
  char *ptr;
  long len;

  len = BIO_ctrl(indata,3,0,(char *)&ptr);
  tmpin = BIO_new_mem_buf(ptr, len);
  if (tmpin == 
# 365 "pkcs7/pk7_smime.c" 3 4
              ((void *)0)
# 365 "pkcs7/pk7_smime.c"
                  ) {
   ERR_put_error(33,(117),((1|64)),"pkcs7/pk7_smime.c",366);
   return 0;
  }
 } else
  tmpin = indata;
 ...
 if (flags & 0x1) {
  if (!(tmpout = BIO_new(BIO_s_mem()))) {
   ERR_put_error(33,(117),((1|64)),"pkcs7/pk7_smime.c",378);
   goto err;
  }
  BIO_ctrl(tmpout,130,0,
# 381 "pkcs7/pk7_smime.c" 3 4
 ((void *)0)
# 381 "pkcs7/pk7_smime.c"
 );
 } else
  tmpout = out;
 ...
 if (flags & 0x1) {
  if (!SMIME_text(tmpout, out)) {
   ERR_put_error(33,(117),(129),"pkcs7/pk7_smime.c",397)
                                ;
   BIO_free(tmpout);
   goto err;
  }
 ...
 if (!(flags & 0x4))
  for (i = 0; i < sk_num(((_STACK*) (1 ? (sinfos) : (struct stack_st_PKCS7_SIGNER_INFO*)0))); i++) {
   si = ((PKCS7_SIGNER_INFO *)sk_value(((_STACK*) (1 ? (sinfos) : (struct stack_st_PKCS7_SIGNER_INFO*)0)), (i)));
   signer = ((X509 *)sk_value(((_STACK*) (1 ? (signers) : (struct stack_st_X509*)0)), (i)));
   j = PKCS7_signatureVerify(p7bio, p7, si, signer);
   if (j <= 0) {
    ERR_put_error(33,(117),(105),"pkcs7/pk7_smime.c",412)
                                  ;
    goto err;
   }
  }
...
PKCS7_get0_signers(PKCS7 *p7, struct stack_st_X509 *certs, int flags)
{
 struct stack_st_X509 *signers;
 struct stack_st_PKCS7_SIGNER_INFO *sinfos;
 PKCS7_SIGNER_INFO *si;
 ...
 if (!p7) {
  ERR_put_error(33,(124),(143),"pkcs7/pk7_smime.c",442)
                                   ;
  return 
# 443 "pkcs7/pk7_smime.c" 3 4
        ((void *)0)
# 443 "pkcs7/pk7_smime.c"
            ;
 }

 if (!(OBJ_obj2nid((p7)->type) == 22)) {
  ERR_put_error(33,(124),(113),"pkcs7/pk7_smime.c",448)
                                 ;
  return 
# 449 "pkcs7/pk7_smime.c" 3 4
        ((void *)0)
# 449 "pkcs7/pk7_smime.c"
            ;
 }


 sinfos = PKCS7_get_signer_info(p7);
 if (sk_num(((_STACK*) (1 ? (sinfos) : (struct stack_st_PKCS7_SIGNER_INFO*)0))) <= 0) {
  ERR_put_error(33,(124),(142),"pkcs7/pk7_smime.c",455);
  return 0;
 }

 if (!(signers = ((struct stack_st_X509 *)sk_new_null()))) {
  ERR_put_error(33,(124),((1|64)),"pkcs7/pk7_smime.c",460);
  return 
# 461 "pkcs7/pk7_smime.c" 3 4
        ((void *)0)
# 461 "pkcs7/pk7_smime.c"
            ;
 }
 ...
 for (i = 0; i < sk_num(((_STACK*) (1 ? (sinfos) : (struct stack_st_PKCS7_SIGNER_INFO*)0))); i++) {
  ...
  signer = 
# 467 "pkcs7/pk7_smime.c" 3 4
          ((void *)0)
# 467 "pkcs7/pk7_smime.c"
              ;

  if (certs)
   signer = X509_find_by_issuer_and_serial (certs,
       ias->issuer, ias->serial);
  if (!signer && !(flags & 0x10) && p7->d.sign->cert)
   signer =
       X509_find_by_issuer_and_serial(p7->d.sign->cert,
         ias->issuer, ias->serial);
  if (!signer) {
   ERR_put_error(33,(124),(128),"pkcs7/pk7_smime.c",478)
                                            ;
   sk_free(((_STACK*) (1 ? (signers) : (struct stack_st_X509*)0)));
   return 0;
  }

  if (!sk_push(((_STACK*) (1 ? (signers) : (struct stack_st_X509*)0)), ((void*) (1 ? (signer) : (X509*)0)))) {
   sk_free(((_STACK*) (1 ? (signers) : (struct stack_st_X509*)0)));
   return 
# 485 "pkcs7/pk7_smime.c" 3 4
         ((void *)0)
# 485 "pkcs7/pk7_smime.c"
             ;
  }
 }
 return signers;
...
PKCS7 *
PKCS7_encrypt(struct stack_st_X509 *certs, BIO *in, const EVP_CIPHER *cipher,
    int flags)
{
 PKCS7 *p7;
 BIO *p7bio = 
# 498 "pkcs7/pk7_smime.c" 3 4
             ((void *)0)
# 498 "pkcs7/pk7_smime.c"
                 ;
 int i;
 X509 *x509;

 if (!(p7 = PKCS7_new())) {
  ERR_put_error(33,(115),((1|64)),"pkcs7/pk7_smime.c",503);
  return 
# 504 "pkcs7/pk7_smime.c" 3 4
        ((void *)0)
# 504 "pkcs7/pk7_smime.c"
            ;
 }

 if (!PKCS7_set_type(p7, 23))
  goto err;
 if (!PKCS7_set_cipher(p7, cipher)) {
  ERR_put_error(33,(115),(121),"pkcs7/pk7_smime.c",510);
  goto err;
 }

 for (i = 0; i < sk_num(((_STACK*) (1 ? (certs) : (struct stack_st_X509*)0))); i++) {
  x509 = ((X509 *)sk_value(((_STACK*) (1 ? (certs) : (struct stack_st_X509*)0)), (i)));
  if (!PKCS7_add_recipient(p7, x509)) {
   ERR_put_error(33,(115),(120),"pkcs7/pk7_smime.c",518)
                                      ;
   goto err;
  }
 }
...
err:
 ...
 PKCS7_free(p7);
 return 
# 532 "pkcs7/pk7_smime.c" 3 4
       ((void *)0)
# 532 "pkcs7/pk7_smime.c"
           ;
}
...
PKCS7_decrypt(PKCS7 *p7, EVP_PKEY *pkey, X509 *cert, BIO *data, int flags)
{
 ...
 if (!p7) {
  ERR_put_error(33,(114),(143),"pkcs7/pk7_smime.c",543);
  return 0;
 }

 if (!(OBJ_obj2nid((p7)->type) == 23)) {
  ERR_put_error(33,(114),(113),"pkcs7/pk7_smime.c",548);
  return 0;
 }

 if (cert && !X509_check_private_key(cert, pkey)) {
  ERR_put_error(33,(114),(127),"pkcs7/pk7_smime.c",554)
                                                     ;
  return 0;
 }

 if (!(tmpmem = PKCS7_dataDecode(p7, pkey, 
# 558 "pkcs7/pk7_smime.c" 3 4
                                          ((void *)0)
# 558 "pkcs7/pk7_smime.c"
                                              , cert))) {
  ERR_put_error(33,(114),(119),"pkcs7/pk7_smime.c",559);
  return 0;
 }
 ...
 if (flags & 0x1) {
  ...
  if (!(tmpbuf = BIO_new(BIO_f_buffer()))) {
   ERR_put_error(33,(114),((1|64)),"pkcs7/pk7_smime.c",568);
   BIO_free_all(tmpmem);
   return 0;
  }
  BIO_push(tmpbuf, tmpmem);
  ret = SMIME_text(tmpbuf, data);
  if (ret > 0 && BIO_method_type(tmpmem) == (10|0x0200)) {
   if (!BIO_ctrl(tmpmem,113,0,
# 575 "pkcs7/pk7_smime.c" 3 4
       ((void *)0)
# 575 "pkcs7/pk7_smime.c"
       ))
    ret = 0;
  }
  BIO_free_all(tmpbuf);
  ...
  for (;;) {
   ...
   if (i <= 0) {
    ...
    if (BIO_method_type(tmpmem) ==
        (10|0x0200)) {
     if (!BIO_ctrl(tmpmem,113,0,
# 587 "pkcs7/pk7_smime.c" 3 4
         ((void *)0)
# 587 "pkcs7/pk7_smime.c"
         ))
      ret = 0;
    }
    break;
