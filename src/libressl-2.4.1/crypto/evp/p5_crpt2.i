    ...
    int saltlen, int iter, const EVP_MD *digest, int keylen, unsigned char *out)
{
 ...
 if (!pass)
  ...
  passlen = strlen(pass);
 if (!HMAC_Init_ex(&hctx_tpl, pass, passlen, digest, 
# 100 "evp/p5_crpt2.c" 3 4
                                                    ((void *)0)
# 100 "evp/p5_crpt2.c"
                                                        )) {
 ...
 while (tkeylen) {
  ...
  if (!HMAC_Update(&hctx, salt, saltlen) ||
      ...
      !HMAC_Final(&hctx, digtmp, 
# 122 "evp/p5_crpt2.c" 3 4
                                ((void *)0)
# 122 "evp/p5_crpt2.c"
                                    )) {
   HMAC_CTX_cleanup(&hctx_tpl);
...
# 171 "evp/p5_crpt2.c"
 ...
 if (param == 
# 176 "evp/p5_crpt2.c" 3 4
             ((void *)0) 
# 176 "evp/p5_crpt2.c"
                  || param->type != 16 ||
     param->value.sequence == 
# 177 "evp/p5_crpt2.c" 3 4
                             ((void *)0)
# 177 "evp/p5_crpt2.c"
                                 ) {
  ERR_put_error(6,(118),(114),"evp/p5_crpt2.c",178);
  goto err;
 }

 pbuf = param->value.sequence->data;
 plen = param->value.sequence->length;
 if (!(pbe2 = d2i_PBE2PARAM(
# 184 "evp/p5_crpt2.c" 3 4
                           ((void *)0)
# 184 "evp/p5_crpt2.c"
                               , &pbuf, plen))) {
  ERR_put_error(6,(118),(114),"evp/p5_crpt2.c",185);
  goto err;
 }



 if (OBJ_obj2nid(pbe2->keyfunc->algorithm) != 69) {
  ERR_put_error(6,(118),(124),"evp/p5_crpt2.c",193)
                                                ;
  goto err;
 }
 ...
 cipher = EVP_get_cipherbyname(OBJ_nid2sn(OBJ_obj2nid(pbe2->encryption->algorithm)));

 if (!cipher) {
  ERR_put_error(6,(118),(107),"evp/p5_crpt2.c",204)
                               ;
  goto err;
 }
...
# 209 "evp/p5_crpt2.c"
 ...
 if (EVP_CIPHER_asn1_to_param(ctx, pbe2->encryption->parameter) < 0) {
  ERR_put_error(6,(118),(122),"evp/p5_crpt2.c",213)
                                   ;
  goto err;
 }
...
# 237 "evp/p5_crpt2.c" 3 4
                                  ((void *)0)
# 237 "evp/p5_crpt2.c"
                                      ) {
  ERR_put_error(6,(164),(131),"evp/p5_crpt2.c",238);
  return 0;
 }
 keylen = EVP_CIPHER_CTX_key_length(ctx);
 if (keylen > sizeof key) {
  ERR_put_error(6,(164),(137),"evp/p5_crpt2.c",243);
  return 0;
 }



 if (!param || (param->type != 16)) {
  ERR_put_error(6,(164),(114),"evp/p5_crpt2.c",250);
  return 0;
 }
 ...
 if (!(kdf = d2i_PBKDF2PARAM(
# 257 "evp/p5_crpt2.c" 3 4
                            ((void *)0)
# 257 "evp/p5_crpt2.c"
                                , &pbuf, plen)) ) {
  ERR_put_error(6,(164),(114),"evp/p5_crpt2.c",258);
  return 0;
 }
 ...
 if (kdf->keylength &&
  ...
  ERR_put_error(6,(164),(123),"evp/p5_crpt2.c",267)
                                  ;
  goto err;
 }
 ...
 if (!EVP_PBE_find(0x1, prf_nid, 
# 276 "evp/p5_crpt2.c" 3 4
                                             ((void *)0)
# 276 "evp/p5_crpt2.c"
                                                 , &hmac_md_nid, 0)) {
  ERR_put_error(6,(164),(125),"evp/p5_crpt2.c",277);
  goto err;
 }

 prfmd = EVP_get_digestbyname(OBJ_nid2sn(hmac_md_nid));
 if (prfmd == 
# 282 "evp/p5_crpt2.c" 3 4
             ((void *)0)
# 282 "evp/p5_crpt2.c"
                 ) {
  ERR_put_error(6,(164),(125),"evp/p5_crpt2.c",283);
  goto err;
 }

 if (kdf->salt->type != 4) {
  ERR_put_error(6,(164),(126),"evp/p5_crpt2.c",289)
                                  ;
  goto err;
 }
 ...
 if (!PKCS5_PBKDF2_HMAC(pass, passlen, salt, saltlen, iter, prfmd,
     keylen, key))
  goto err;
 rv = EVP_CipherInit_ex(ctx, 
# 300 "evp/p5_crpt2.c" 3 4
                            ((void *)0)
# 300 "evp/p5_crpt2.c"
                                , 
# 300 "evp/p5_crpt2.c" 3 4
