...
static const ASN1_TEMPLATE PKCS12_MAC_DATA_seq_tt[] = {
 {
  ...
  .tag = 0,
  .offset = 
# 130 "pkcs12/p12_asn.c" 3 4
           __builtin_offsetof (
# 130 "pkcs12/p12_asn.c"
           PKCS12_MAC_DATA
# 130 "pkcs12/p12_asn.c" 3 4
           , 
# 130 "pkcs12/p12_asn.c"
...
# 130 "pkcs12/p12_asn.c"
 ...
 },
 {
  ...
  .tag = 0,
  .offset = 
# 137 "pkcs12/p12_asn.c" 3 4
           __builtin_offsetof (
# 137 "pkcs12/p12_asn.c"
           PKCS12_MAC_DATA
# 137 "pkcs12/p12_asn.c" 3 4
           , 
# 137 "pkcs12/p12_asn.c"
...
# 137 "pkcs12/p12_asn.c"
 ...
 },
 {
  ...
  .tag = 0,
  .offset = 
# 144 "pkcs12/p12_asn.c" 3 4
           __builtin_offsetof (
# 144 "pkcs12/p12_asn.c"
           PKCS12_MAC_DATA
# 144 "pkcs12/p12_asn.c" 3 4
           , 
# 144 "pkcs12/p12_asn.c"
...
const ASN1_ITEM PKCS12_MAC_DATA_it = {
 ...
 .funcs = 
# 155 "pkcs12/p12_asn.c" 3 4
         ((void *)0)
# 155 "pkcs12/p12_asn.c"
             ,
...
static const ASN1_TEMPLATE bag_default_tt = {
 ...
 .tag = 0,
 .offset = 
# 189 "pkcs12/p12_asn.c" 3 4
          __builtin_offsetof (
# 189 "pkcs12/p12_asn.c"
          PKCS12_BAGS
# 189 "pkcs12/p12_asn.c" 3 4
          , 
# 189 "pkcs12/p12_asn.c"
...
static const ASN1_ADB_TABLE PKCS12_BAGS_adbtbl[] = {
 {
  ...
  .tt = {
   ...
   .tag = 0,
   .offset = 
# 200 "pkcs12/p12_asn.c" 3 4
            __builtin_offsetof (
# 200 "pkcs12/p12_asn.c"
            PKCS12_BAGS
# 200 "pkcs12/p12_asn.c" 3 4
            , 
# 200 "pkcs12/p12_asn.c"
...
# 200 "pkcs12/p12_asn.c"
 ...
 },
 {
  ...
  .tt = {
   ...
   .tag = 0,
   .offset = 
# 211 "pkcs12/p12_asn.c" 3 4
            __builtin_offsetof (
# 211 "pkcs12/p12_asn.c"
            PKCS12_BAGS
# 211 "pkcs12/p12_asn.c" 3 4
            , 
# 211 "pkcs12/p12_asn.c"
...
# 211 "pkcs12/p12_asn.c"
 ...
 },
 {
  ...
  .tt = {
   ...
   .tag = 0,
   .offset = 
# 222 "pkcs12/p12_asn.c" 3 4
            __builtin_offsetof (
# 222 "pkcs12/p12_asn.c"
            PKCS12_BAGS
# 222 "pkcs12/p12_asn.c" 3 4
            , 
# 222 "pkcs12/p12_asn.c"
...
static const ASN1_ADB PKCS12_BAGS_adb = {
 .flags = 0,
 .offset = 
# 232 "pkcs12/p12_asn.c" 3 4
          __builtin_offsetof (
# 232 "pkcs12/p12_asn.c"
          PKCS12_BAGS
# 232 "pkcs12/p12_asn.c" 3 4
          , 
# 232 "pkcs12/p12_asn.c"
...
# 232 "pkcs12/p12_asn.c"
 ...
 .null_tt = 
# 237 "pkcs12/p12_asn.c" 3 4
           ((void *)0)
# 237 "pkcs12/p12_asn.c"
               ,
};
...
static const ASN1_TEMPLATE PKCS12_BAGS_seq_tt[] = {
 {
  ...
  .tag = 0,
  .offset = 
# 244 "pkcs12/p12_asn.c" 3 4
           __builtin_offsetof (
# 244 "pkcs12/p12_asn.c"
           PKCS12_BAGS
# 244 "pkcs12/p12_asn.c" 3 4
           , 
# 244 "pkcs12/p12_asn.c"
...
const ASN1_ITEM PKCS12_BAGS_it = {
 ...
 .funcs = 
# 262 "pkcs12/p12_asn.c" 3 4
         ((void *)0)
# 262 "pkcs12/p12_asn.c"
             ,
...
static const ASN1_TEMPLATE safebag_default_tt = {
 ...
 .tag = 0,
 .offset = 
# 296 "pkcs12/p12_asn.c" 3 4
          __builtin_offsetof (
# 296 "pkcs12/p12_asn.c"
          PKCS12_SAFEBAG
# 296 "pkcs12/p12_asn.c" 3 4
          , 
# 296 "pkcs12/p12_asn.c"
...
static const ASN1_ADB_TABLE PKCS12_SAFEBAG_adbtbl[] = {
 {
  ...
  .tt = {
   ...
   .tag = 0,
   .offset = 
# 307 "pkcs12/p12_asn.c" 3 4
            __builtin_offsetof (
# 307 "pkcs12/p12_asn.c"
            PKCS12_SAFEBAG
# 307 "pkcs12/p12_asn.c" 3 4
            , 
# 307 "pkcs12/p12_asn.c"
...
# 307 "pkcs12/p12_asn.c"
 ...
 },
 {
  ...
  .tt = {
   ...
   .tag = 0,
   .offset = 
# 318 "pkcs12/p12_asn.c" 3 4
            __builtin_offsetof (
# 318 "pkcs12/p12_asn.c"
            PKCS12_SAFEBAG
# 318 "pkcs12/p12_asn.c" 3 4
            , 
# 318 "pkcs12/p12_asn.c"
...
# 318 "pkcs12/p12_asn.c"
 ...
 },
 {
  .value = 155,
  .tt = {
   .flags = (0x2 << 3)|(0x2<<6) | (0x1 << 1),
   .tag = 0,
   .offset = 
# 329 "pkcs12/p12_asn.c" 3 4
            __builtin_offsetof (
# 329 "pkcs12/p12_asn.c"
            PKCS12_SAFEBAG
# 329 "pkcs12/p12_asn.c" 3 4
            , 
# 329 "pkcs12/p12_asn.c"
...
# 329 "pkcs12/p12_asn.c"
 ...
 },
 {
  ...
  .tt = {
   ...
   .tag = 0,
   .offset = 
# 339 "pkcs12/p12_asn.c" 3 4
            __builtin_offsetof (
# 339 "pkcs12/p12_asn.c"
            PKCS12_SAFEBAG
# 339 "pkcs12/p12_asn.c" 3 4
            , 
# 339 "pkcs12/p12_asn.c"
...
# 339 "pkcs12/p12_asn.c"
 ...
 },
 {
  ...
  .tt = {
   ...
   .tag = 0,
   .offset = 
# 350 "pkcs12/p12_asn.c" 3 4
            __builtin_offsetof (
# 350 "pkcs12/p12_asn.c"
            PKCS12_SAFEBAG
# 350 "pkcs12/p12_asn.c" 3 4
            , 
# 350 "pkcs12/p12_asn.c"
...
# 350 "pkcs12/p12_asn.c"
 ...
 },
 {
  ...
  .tt = {
   ...
   .tag = 0,
   .offset = 
# 361 "pkcs12/p12_asn.c" 3 4
            __builtin_offsetof (
# 361 "pkcs12/p12_asn.c"
            PKCS12_SAFEBAG
# 361 "pkcs12/p12_asn.c" 3 4
            , 
# 361 "pkcs12/p12_asn.c"
...
static const ASN1_ADB PKCS12_SAFEBAG_adb = {
 .flags = 0,
 .offset = 
# 371 "pkcs12/p12_asn.c" 3 4
          __builtin_offsetof (
# 371 "pkcs12/p12_asn.c"
          PKCS12_SAFEBAG
# 371 "pkcs12/p12_asn.c" 3 4
          , 
# 371 "pkcs12/p12_asn.c"
...
# 371 "pkcs12/p12_asn.c"
 ...
 .null_tt = 
# 376 "pkcs12/p12_asn.c" 3 4
           ((void *)0)
# 376 "pkcs12/p12_asn.c"
               ,
};
...
static const ASN1_TEMPLATE PKCS12_SAFEBAG_seq_tt[] = {
 {
  ...
  .tag = 0,
  .offset = 
# 383 "pkcs12/p12_asn.c" 3 4
           __builtin_offsetof (
# 383 "pkcs12/p12_asn.c"
           PKCS12_SAFEBAG
# 383 "pkcs12/p12_asn.c" 3 4
           , 
# 383 "pkcs12/p12_asn.c"
...
# 383 "pkcs12/p12_asn.c"
 ...
 },
 {
  ...
  .tag = 0,
  .offset = 
# 397 "pkcs12/p12_asn.c" 3 4
           __builtin_offsetof (
# 397 "pkcs12/p12_asn.c"
           PKCS12_SAFEBAG
# 397 "pkcs12/p12_asn.c" 3 4
           , 
# 397 "pkcs12/p12_asn.c"
...
const ASN1_ITEM PKCS12_SAFEBAG_it = {
 ...
 .funcs = 
# 408 "pkcs12/p12_asn.c" 3 4
         ((void *)0)
# 408 "pkcs12/p12_asn.c"
             ,
...
const ASN1_ITEM PKCS12_SAFEBAGS_it = {
 ...
 .tcount = 0,
 .funcs = 
# 453 "pkcs12/p12_asn.c" 3 4
         ((void *)0)
# 453 "pkcs12/p12_asn.c"
             ,
 .size = 0,
...
const ASN1_ITEM PKCS12_AUTHSAFES_it = {
 ...
 .tcount = 0,
 .funcs = 
# 472 "pkcs12/p12_asn.c" 3 4
         ((void *)0)
# 472 "pkcs12/p12_asn.c"
             ,
 .size = 0,
