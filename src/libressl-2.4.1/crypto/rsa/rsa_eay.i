...
static RSA_METHOD rsa_pkcs1_eay_meth = {
 ...
 .rsa_priv_enc = RSA_eay_private_encrypt,
    ...
    RSA *rsa, int padding)
{
 ...
 int i, j, k, num = 0, r = -1;
 unsigned char *buf = 
# 157 "rsa/rsa_eay.c" 3 4
                     ((void *)0)
# 157 "rsa/rsa_eay.c"
                         ;
 BN_CTX *ctx = 
# 158 "rsa/rsa_eay.c" 3 4
              ((void *)0)
# 158 "rsa/rsa_eay.c"
                  ;

 if (BN_num_bits(rsa->n) > 16384) {
  ERR_put_error(4,(104),(105),"rsa/rsa_eay.c",161);
  return -1;
 }

 if (BN_ucmp(rsa->n, rsa->e) <= 0) {
  ERR_put_error(4,(104),(101),"rsa/rsa_eay.c",166);
  return -1;
 }


 if (BN_num_bits(rsa->n) > 3072) {
  if (BN_num_bits(rsa->e) > 64) {
   ERR_put_error(4,(104),(101),"rsa/rsa_eay.c",173);
   return -1;
  }
 }

 if ((ctx = BN_CTX_new()) == 
# 178 "rsa/rsa_eay.c" 3 4
                            ((void *)0)
# 178 "rsa/rsa_eay.c"
                                )
  goto err;
 ...
 f = BN_CTX_get(ctx);
 ret = BN_CTX_get(ctx);
 num = ((BN_num_bits(rsa->n)+7)/8);
 buf = malloc(num);
 if (f == 
# 185 "rsa/rsa_eay.c" 3 4
         ((void *)0) 
# 185 "rsa/rsa_eay.c"
              || ret == 
# 185 "rsa/rsa_eay.c" 3 4
...
# 185 "rsa/rsa_eay.c"
  ...
  ERR_put_error(4,(104),((1|64)),"rsa/rsa_eay.c",186);
  goto err;
 }
 ...
 case 4:
  i = RSA_padding_add_PKCS1_OAEP(buf, num, from, flen, 
# 196 "rsa/rsa_eay.c" 3 4
                                                      ((void *)0)
# 196 "rsa/rsa_eay.c"
                                                          , 0);
  break;
 ...
 case 3:
  ...
  break;
 default:
  ERR_put_error(4,(104),(118),"rsa/rsa_eay.c",207)
                                 ;
  goto err;
 }
 if (i <= 0)
 ...
 if (BN_bin2bn(buf, num, f) == 
# 213 "rsa/rsa_eay.c" 3 4
                              ((void *)0)
# 213 "rsa/rsa_eay.c"
                                  )
  goto err;
 ...
 if (BN_ucmp(f, rsa->n) >= 0) {
  ...
  ERR_put_error(4,(104),(132),"rsa/rsa_eay.c",219)
                                       ;
  goto err;
 }
...
rsa_get_blinding(RSA *rsa, int *local, BN_CTX *ctx)
{
 ...
 CRYPTO_lock(1|4,9,"rsa/rsa_eay.c",259);

 if (rsa->blinding == 
# 261 "rsa/rsa_eay.c" 3 4
                     ((void *)0)
# 261 "rsa/rsa_eay.c"
                         ) {
  CRYPTO_lock(2|4,9,"rsa/rsa_eay.c",262);
  CRYPTO_lock(1|8,9,"rsa/rsa_eay.c",263);
  got_write_lock = 1;

  if (rsa->blinding == 
# 266 "rsa/rsa_eay.c" 3 4
                      ((void *)0)
# 266 "rsa/rsa_eay.c"
                          )
...
# 271 "rsa/rsa_eay.c"
  ...
  *local = 0;
  ...
  if (rsa->mt_blinding == 
# 288 "rsa/rsa_eay.c" 3 4
                         ((void *)0)
# 288 "rsa/rsa_eay.c"
                             ) {
   if (!got_write_lock) {
    CRYPTO_lock(2|4,9,"rsa/rsa_eay.c",290);
    CRYPTO_lock(1|8,9,"rsa/rsa_eay.c",291);
    got_write_lock = 1;
   }

   if (rsa->mt_blinding == 
# 295 "rsa/rsa_eay.c" 3 4
                          ((void *)0)
# 295 "rsa/rsa_eay.c"
                              )
...
err:
 if (got_write_lock)
  CRYPTO_lock(2|8,9,"rsa/rsa_eay.c",303);
 else
  CRYPTO_lock(2|4,9,"rsa/rsa_eay.c",305);
 return ret;
}
...
# 312 "rsa/rsa_eay.c"
  ...
  return BN_BLINDING_convert_ex(f, 
# 317 "rsa/rsa_eay.c" 3 4
                                  ((void *)0)
# 317 "rsa/rsa_eay.c"
                                      , b, ctx);
 else {
  ...
  int ret;
  CRYPTO_lock(1|8,25,"rsa/rsa_eay.c",324);
  ret = BN_BLINDING_convert_ex(f, unblind, b, ctx);
  CRYPTO_lock(2|8,25,"rsa/rsa_eay.c",326);
  return ret;
 }
}
    ...
    RSA *rsa, int padding)
{
 ...
 int i, j, k, num = 0, r = -1;
 unsigned char *buf = 
# 352 "rsa/rsa_eay.c" 3 4
                     ((void *)0)
# 352 "rsa/rsa_eay.c"
                         ;
 BN_CTX *ctx = 
# 353 "rsa/rsa_eay.c" 3 4
              ((void *)0)
# 353 "rsa/rsa_eay.c"
                  ;
 ...
 BIGNUM *unblind = 
# 360 "rsa/rsa_eay.c" 3 4
                  ((void *)0)
# 360 "rsa/rsa_eay.c"
                      ;
 BN_BLINDING *blinding = 
# 361 "rsa/rsa_eay.c" 3 4
                        ((void *)0)
# 361 "rsa/rsa_eay.c"
                            ;

 if ((ctx = BN_CTX_new()) == 
# 363 "rsa/rsa_eay.c" 3 4
                            ((void *)0)
# 363 "rsa/rsa_eay.c"
                                )
  goto err;
...
# 370 "rsa/rsa_eay.c"
  ...
  ERR_put_error(4,(102),((1|64)),"rsa/rsa_eay.c",371);
  goto err;
 }
 ...
 case 2:
 default:
  ERR_put_error(4,(102),(118),"rsa/rsa_eay.c",388)
                                 ;
  goto err;
 }
 if (i <= 0)
...
# 394 "rsa/rsa_eay.c"
 ...
 if (BN_ucmp(f, rsa->n) >= 0) {
  ...
  ERR_put_error(4,(102),(132),"rsa/rsa_eay.c",400)
                                       ;
  goto err;
 }
 ...
 if (!(rsa->flags & 0x0080)) {
  ...
  if (blinding == 
# 406 "rsa/rsa_eay.c" 3 4
                 ((void *)0)
# 406 "rsa/rsa_eay.c"
                     ) {
   ERR_put_error(4,(102),((4|64)),"rsa/rsa_eay.c",408)
                            ;
   goto err;
  }
 }
 ...
 if (blinding != 
# 413 "rsa/rsa_eay.c" 3 4
                ((void *)0)
# 413 "rsa/rsa_eay.c"
                    ) {
  if (!local_blinding && ((unblind = BN_CTX_get(ctx)) == 
# 414 "rsa/rsa_eay.c" 3 4
                                                        ((void *)0)
# 414 "rsa/rsa_eay.c"
                                                            )) {
   ERR_put_error(4,(102),((1|64)),"rsa/rsa_eay.c",416)
                            ;
   goto err;
  }
...
# 430 "rsa/rsa_eay.c"
  ...
  if (!(rsa->flags & 0x0100)) {
   BN_init(&local_d);
   d = &local_d;
   ((d)->d=(rsa->d)->d, (d)->top=(rsa->d)->top, (d)->dmax=(rsa->d)->dmax, (d)->neg=(rsa->d)->neg, (d)->flags=(((d)->flags & 0x01) | ((rsa->d)->flags & ~0x01) | 0x02 | (0x04)));
  } else
   d = rsa->d;
    ...
    RSA *rsa, int padding)
{
 ...
 unsigned char *p;
 unsigned char *buf = 
# 489 "rsa/rsa_eay.c" 3 4
                     ((void *)0)
# 489 "rsa/rsa_eay.c"
                         ;
 BN_CTX *ctx = 
# 490 "rsa/rsa_eay.c" 3 4
              ((void *)0)
# 490 "rsa/rsa_eay.c"
                  ;
 int local_blinding = 0;
 ...
 BIGNUM *unblind = 
# 497 "rsa/rsa_eay.c" 3 4
                  ((void *)0)
# 497 "rsa/rsa_eay.c"
                      ;
 BN_BLINDING *blinding = 
# 498 "rsa/rsa_eay.c" 3 4
                        ((void *)0)
# 498 "rsa/rsa_eay.c"
                            ;

 if ((ctx = BN_CTX_new()) == 
# 500 "rsa/rsa_eay.c" 3 4
                            ((void *)0)
# 500 "rsa/rsa_eay.c"
                                )
  goto err;
 ...
 buf = malloc(num);
 if (!f || !ret || !buf) {
  ERR_put_error(4,(101),((1|64)),"rsa/rsa_eay.c",508);
  goto err;
 }
 ...
 if (flen > num) {
  ERR_put_error(4,(101),(108),"rsa/rsa_eay.c",516)
                                      ;
  goto err;
 }
...
# 521 "rsa/rsa_eay.c"
 ...
 if (BN_ucmp(f, rsa->n) >= 0) {
  ERR_put_error(4,(101),(132),"rsa/rsa_eay.c",526)
                                       ;
  goto err;
 }
 ...
 if (!(rsa->flags & 0x0080)) {
  blinding = rsa_get_blinding(rsa, &local_blinding, ctx);
  if (blinding == 
# 532 "rsa/rsa_eay.c" 3 4
                 ((void *)0)
# 532 "rsa/rsa_eay.c"
                     ) {
   ERR_put_error(4,(101),((4|64)),"rsa/rsa_eay.c",534)
                            ;
   goto err;
  }
 }
 ...
 if (blinding != 
# 539 "rsa/rsa_eay.c" 3 4
                ((void *)0)
# 539 "rsa/rsa_eay.c"
                    ) {
  if (!local_blinding && ((unblind = BN_CTX_get(ctx)) == 
# 540 "rsa/rsa_eay.c" 3 4
                                                        ((void *)0)
# 540 "rsa/rsa_eay.c"
                                                            )) {
   ERR_put_error(4,(101),((1|64)),"rsa/rsa_eay.c",542)
                            ;
   goto err;
  }
  if (!rsa_blinding_convert(blinding, f, unblind, ctx))
...
# 557 "rsa/rsa_eay.c"
 ...
 case 4:
  r = RSA_padding_check_PKCS1_OAEP(to, num, buf, j, num, 
# 587 "rsa/rsa_eay.c" 3 4
                                                        ((void *)0)
# 587 "rsa/rsa_eay.c"
                                                            , 0);
  break;
 ...
 case 3:
  ...
  break;
 default:
  ERR_put_error(4,(101),(118),"rsa/rsa_eay.c",598)
                                 ;
  goto err;
 }
 if (r < 0)
  ERR_put_error(4,(101),(114),"rsa/rsa_eay.c",603)
                                 ;

err:
 if (ctx != 
# 606 "rsa/rsa_eay.c" 3 4
           ((void *)0)
# 606 "rsa/rsa_eay.c"
               ) {
  BN_CTX_end(ctx);
    ...
    RSA *rsa, int padding)
{
 ...
 unsigned char *p;
 unsigned char *buf = 
# 625 "rsa/rsa_eay.c" 3 4
                     ((void *)0)
# 625 "rsa/rsa_eay.c"
                         ;
 BN_CTX *ctx = 
# 626 "rsa/rsa_eay.c" 3 4
              ((void *)0)
# 626 "rsa/rsa_eay.c"
                  ;

 if (BN_num_bits(rsa->n) > 16384) {
  ERR_put_error(4,(103),(105),"rsa/rsa_eay.c",629);
  return -1;
 }

 if (BN_ucmp(rsa->n, rsa->e) <= 0) {
  ERR_put_error(4,(103),(101),"rsa/rsa_eay.c",634);
  return -1;
 }
 ...
 if (BN_num_bits(rsa->n) > 3072) {
  if (BN_num_bits(rsa->e) > 64) {
   ERR_put_error(4,(103),(101),"rsa/rsa_eay.c",641);
   return -1;
  }
 }

 if ((ctx = BN_CTX_new()) == 
# 646 "rsa/rsa_eay.c" 3 4
                            ((void *)0)
# 646 "rsa/rsa_eay.c"
                                )
  goto err;
 ...
 buf = malloc(num);
 if (!f || !ret || !buf) {
  ERR_put_error(4,(103),((1|64)),"rsa/rsa_eay.c",654);
  goto err;
 }
 ...
 if (flen > num) {
  ERR_put_error(4,(103),(108),"rsa/rsa_eay.c",662)
                                      ;
  goto err;
 }

 if (BN_bin2bn(from, flen, f) == 
# 666 "rsa/rsa_eay.c" 3 4
                                ((void *)0)
# 666 "rsa/rsa_eay.c"
                                    )
  goto err;
 ...
 if (BN_ucmp(f, rsa->n) >= 0) {
  ERR_put_error(4,(103),(132),"rsa/rsa_eay.c",671)
                                       ;
  goto err;
 }
 ...
 case 3:
  ...
  break;
 default:
  ERR_put_error(4,(103),(118),"rsa/rsa_eay.c",703)
                                 ;
  goto err;
 }
 if (r < 0)
  ERR_put_error(4,(103),(114),"rsa/rsa_eay.c",708)
                                 ;

err:
 if (ctx != 
# 711 "rsa/rsa_eay.c" 3 4
           ((void *)0)
# 711 "rsa/rsa_eay.c"
               ) {
  BN_CTX_end(ctx);
...
# 734 "rsa/rsa_eay.c"
  ...
  ERR_put_error(4,(157),((1|64)),"rsa/rsa_eay.c",735);
  goto err;
 }
...
# 741 "rsa/rsa_eay.c"
  ...
  if (!(rsa->flags & 0x0100)) {
   BN_init(&local_p);
   p = &local_p;
   ((p)->d=(rsa->p)->d, (p)->top=(rsa->p)->top, (p)->dmax=(rsa->p)->dmax, (p)->neg=(rsa->p)->neg, (p)->flags=(((p)->flags & 0x01) | ((rsa->p)->flags & ~0x01) | 0x02 | (0x04)));

   BN_init(&local_q);
   q = &local_q;
   ((q)->d=(rsa->q)->d, (q)->top=(rsa->q)->top, (q)->dmax=(rsa->q)->dmax, (q)->neg=(rsa->q)->neg, (q)->flags=(((q)->flags & 0x01) | ((rsa->q)->flags & ~0x01) | 0x02 | (0x04)));
  } else {
   p = rsa->p;
   q = rsa->q;
  }
 ...
 if (!(rsa->flags & 0x0100)) {
  c = &local_c;
  ((c)->d=(I)->d, (c)->top=(I)->top, (c)->dmax=(I)->dmax, (c)->neg=(I)->neg, (c)->flags=(((c)->flags & 0x01) | ((I)->flags & ~0x01) | 0x02 | (0x04)));
  if (!BN_div(
# 779 "rsa/rsa_eay.c" 3 4
      ((void *)0)
# 779 "rsa/rsa_eay.c"
      ,(r1),(c),(rsa->q),(ctx)))
   goto err;
...
# 782 "rsa/rsa_eay.c"
 ...
 if (!(rsa->flags & 0x0100)) {
  dmq1 = &local_dmq1;
  ((dmq1)->d=(rsa->dmq1)->d, (dmq1)->top=(rsa->dmq1)->top, (dmq1)->dmax=(rsa->dmq1)->dmax, (dmq1)->neg=(rsa->dmq1)->neg, (dmq1)->flags=(((dmq1)->flags & 0x01) | ((rsa->dmq1)->flags & ~0x01) | 0x02 | (0x04)));
 } else
  dmq1 = rsa->dmq1;
...
# 803 "rsa/rsa_eay.c"
 ...
 if (!(rsa->flags & 0x0100)) {
  dmp1 = &local_dmp1;
  ((dmp1)->d=(rsa->dmp1)->d, (dmp1)->top=(rsa->dmp1)->top, (dmp1)->dmax=(rsa->dmp1)->dmax, (dmp1)->neg=(rsa->dmp1)->neg, (dmp1)->flags=(((dmp1)->flags & 0x01) | ((rsa->dmp1)->flags & ~0x01) | 0x02 | (0x04)));
 } else
  dmp1 = rsa->dmp1;
 ...
 if (!(rsa->flags & 0x0100)) {
  pr1 = &local_r1;
  ((pr1)->d=(r1)->d, (pr1)->top=(r1)->top, (pr1)->dmax=(r1)->dmax, (pr1)->neg=(r1)->neg, (pr1)->flags=(((pr1)->flags & 0x01) | ((r1)->flags & ~0x01) | 0x02 | (0x04)));
 } else
  pr1 = r1;
 if (!BN_div(
# 836 "rsa/rsa_eay.c" 3 4
     ((void *)0)
# 836 "rsa/rsa_eay.c"
     ,(r0),(pr1),(rsa->p),(ctx)))
  goto err;
