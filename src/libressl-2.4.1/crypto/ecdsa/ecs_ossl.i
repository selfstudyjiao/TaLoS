...
# 60 "ecdsa/ecs_ossl.c" 2

# 1 "ecdsa/ecs_locl.h" 1
# 62 "ecdsa/ecs_locl.h"
...
# 63 "ecdsa/ecs_ossl.c" 2
# 1 "../include/openssl/obj_mac.h" 1
# 64 "ecdsa/ecs_ossl.c" 2
...
{
 BN_CTX *ctx = 
# 89 "ecdsa/ecs_ossl.c" 3 4
                ((void *)0)
# 89 "ecdsa/ecs_ossl.c"
                    ;
 BIGNUM *k = 
# 90 "ecdsa/ecs_ossl.c" 3 4
             ((void *)0)
# 90 "ecdsa/ecs_ossl.c"
                 , *r = 
# 90 "ecdsa/ecs_ossl.c" 3 4
...
# 95 "ecdsa/ecs_ossl.c"
  ...
  ERR_put_error(42,(103),((3|64)),"ecdsa/ecs_ossl.c",96);
  return 0;
 }

 if (ctx_in == 
# 100 "ecdsa/ecs_ossl.c" 3 4
              ((void *)0)
# 100 "ecdsa/ecs_ossl.c"
                  ) {
  if ((ctx = BN_CTX_new()) == 
# 101 "ecdsa/ecs_ossl.c" 3 4
                             ((void *)0)
# 101 "ecdsa/ecs_ossl.c"
                                 ) {
   ERR_put_error(42,(103),((1|64)),"ecdsa/ecs_ossl.c",103)
                            ;
   return 0;
  }
 } else
 ...
 X = BN_new();
 if (!k || !r || !order || !X) {
  ERR_put_error(42,(103),((1|64)),"ecdsa/ecs_ossl.c",114);
  goto err;
 }
 if ((tmp_point = EC_POINT_new(group)) == 
# 117 "ecdsa/ecs_ossl.c" 3 4
                                         ((void *)0)
# 117 "ecdsa/ecs_ossl.c"
                                             ) {
  ERR_put_error(42,(103),(16),"ecdsa/ecs_ossl.c",118);
  goto err;
 }
 if (!EC_GROUP_get_order(group, order, ctx)) {
  ERR_put_error(42,(103),(16),"ecdsa/ecs_ossl.c",122);
  goto err;
 }
 ...
 do {
  ...
  do
   if (!BN_rand_range(k, order)) {
    ERR_put_error(42,(103),(104),"ecdsa/ecs_ossl.c",131)
                                                ;
    goto err;
   }
  while (BN_is_zero(k));
  ...
  if (!EC_POINT_mul(group, tmp_point, k, 
# 146 "ecdsa/ecs_ossl.c" 3 4
                                        ((void *)0)
# 146 "ecdsa/ecs_ossl.c"
                                            , 
# 146 "ecdsa/ecs_ossl.c" 3 4
                                              ((void *)0)
# 146 "ecdsa/ecs_ossl.c"
                                                  , ctx)) {
   ERR_put_error(42,(103),(16),"ecdsa/ecs_ossl.c",147);
   goto err;
  }
  if (EC_METHOD_get_field_type(EC_GROUP_method_of(group)) ==
   ...
   if (!EC_POINT_get_affine_coordinates_GFp(group,
       tmp_point, X, 
# 153 "ecdsa/ecs_ossl.c" 3 4
                    ((void *)0)
# 153 "ecdsa/ecs_ossl.c"
                        , ctx)) {
    ERR_put_error(42,(103),(16),"ecdsa/ecs_ossl.c",155)
                     ;
    goto err;
   }
  }
  ...
  else
  {
   if (!EC_POINT_get_affine_coordinates_GF2m(group,
       tmp_point, X, 
# 163 "ecdsa/ecs_ossl.c" 3 4
                    ((void *)0)
# 163 "ecdsa/ecs_ossl.c"
                        , ctx)) {
    ERR_put_error(42,(103),(16),"ecdsa/ecs_ossl.c",165)
                     ;
    goto err;
   }
  }
  ...
  if (!BN_nnmod(r, X, order, ctx)) {
   ERR_put_error(42,(103),(3),"ecdsa/ecs_ossl.c",171);
   goto err;
  }
 } while (BN_is_zero(r));
 ...
 if (!BN_mod_inverse(k, k, order, ctx)) {
  ERR_put_error(42,(103),(3),"ecdsa/ecs_ossl.c",178);
  goto err;
 }
...
err:
 ...
 if (ctx_in == 
# 194 "ecdsa/ecs_ossl.c" 3 4
              ((void *)0)
# 194 "ecdsa/ecs_ossl.c"
                  )
  BN_CTX_free(ctx);
 BN_free(order);
    ...
    const BIGNUM *in_kinv, const BIGNUM *in_r, EC_KEY *eckey)
{
 int ok = 0, i;
 BIGNUM *kinv = 
# 208 "ecdsa/ecs_ossl.c" 3 4
               ((void *)0)
# 208 "ecdsa/ecs_ossl.c"
                   , *s, *m = 
# 208 "ecdsa/ecs_ossl.c" 3 4
                              ((void *)0)
# 208 "ecdsa/ecs_ossl.c"
...
# 208 "ecdsa/ecs_ossl.c"
 ...
 const BIGNUM *ckinv;
 BN_CTX *ctx = 
# 210 "ecdsa/ecs_ossl.c" 3 4
                  ((void *)0)
# 210 "ecdsa/ecs_ossl.c"
                      ;
 const EC_GROUP *group;
 ECDSA_SIG *ret;
 ECDSA_DATA *ecdsa;
 ...
 if (group == 
# 220 "ecdsa/ecs_ossl.c" 3 4
             ((void *)0) 
# 220 "ecdsa/ecs_ossl.c"
                  || priv_key == 
# 220 "ecdsa/ecs_ossl.c" 3 4
                                 ((void *)0) 
# 220 "ecdsa/ecs_ossl.c"
...
# 220 "ecdsa/ecs_ossl.c"
  ...
  ERR_put_error(42,(101),((3|64)),"ecdsa/ecs_ossl.c",221);
  return 
# 222 "ecdsa/ecs_ossl.c" 3 4
        ((void *)0)
# 222 "ecdsa/ecs_ossl.c"
            ;
 }

 ret = ECDSA_SIG_new();
 if (!ret) {
  ERR_put_error(42,(101),((1|64)),"ecdsa/ecs_ossl.c",227);
  return 
# 228 "ecdsa/ecs_ossl.c" 3 4
        ((void *)0)
# 228 "ecdsa/ecs_ossl.c"
            ;
 }
 s = ret->s;

 if ((ctx = BN_CTX_new()) == 
# 232 "ecdsa/ecs_ossl.c" 3 4
                            ((void *)0) 
# 232 "ecdsa/ecs_ossl.c"
                                 || (order = BN_new()) == 
# 232 "ecdsa/ecs_ossl.c" 3 4
                                                          ((void *)0) 
# 232 "ecdsa/ecs_ossl.c"
                                                               ||
     (tmp = BN_new()) == 
# 233 "ecdsa/ecs_ossl.c" 3 4
                        ((void *)0) 
# 233 "ecdsa/ecs_ossl.c"
                             || (m = BN_new()) == 
# 233 "ecdsa/ecs_ossl.c" 3 4
                                                  ((void *)0)
# 233 "ecdsa/ecs_ossl.c"
                                                      ) {
  ERR_put_error(42,(101),((1|64)),"ecdsa/ecs_ossl.c",234);
  goto err;
 }

 if (!EC_GROUP_get_order(group, order, ctx)) {
  ERR_put_error(42,(101),(16),"ecdsa/ecs_ossl.c",239);
  goto err;
 }
 i = BN_num_bits(order);
 ...
 if (!BN_bin2bn(dgst, dgst_len, m)) {
  ERR_put_error(42,(101),(3),"ecdsa/ecs_ossl.c",249);
  goto err;
 }

 if ((8 * dgst_len > i) && !BN_rshift(m, m, 8 - (i & 0x7))) {
  ERR_put_error(42,(101),(3),"ecdsa/ecs_ossl.c",254);
  goto err;
 }
 do {
  if (in_kinv == 
# 258 "ecdsa/ecs_ossl.c" 3 4
                ((void *)0) 
# 258 "ecdsa/ecs_ossl.c"
                     || in_r == 
# 258 "ecdsa/ecs_ossl.c" 3 4
                                ((void *)0)
# 258 "ecdsa/ecs_ossl.c"
   ...
   if (!ECDSA_sign_setup(eckey, ctx, &kinv, &ret->r)) {
    ERR_put_error(42,(101),(42),"ecdsa/ecs_ossl.c",261)
                        ;
    goto err;
   }
   ckinv = kinv;
...
# 267 "ecdsa/ecs_ossl.c" 3 4
                               ((void *)0)
# 267 "ecdsa/ecs_ossl.c"
                                   ) {
    ERR_put_error(42,(101),((1|64)),"ecdsa/ecs_ossl.c",269)
                             ;
    goto err;
   }
  }
  ...
  if (!BN_mod_mul(tmp, priv_key, ret->r, order, ctx)) {
   ERR_put_error(42,(101),(3),"ecdsa/ecs_ossl.c",275);
   goto err;
  }
  if (!BN_mod_add_quick(s, tmp, m, order)) {
   ERR_put_error(42,(101),(3),"ecdsa/ecs_ossl.c",279);
   goto err;
  }
  if (!BN_mod_mul(s, s, ckinv, order, ctx)) {
   ERR_put_error(42,(101),(3),"ecdsa/ecs_ossl.c",283);
   goto err;
  }
  if (BN_is_zero(s)) {
   ...
   if (in_kinv != 
# 289 "ecdsa/ecs_ossl.c" 3 4
                 ((void *)0) 
# 289 "ecdsa/ecs_ossl.c"
                      && in_r != 
# 289 "ecdsa/ecs_ossl.c" 3 4
                                 ((void *)0)
# 289 "ecdsa/ecs_ossl.c"
                                     ) {
    ERR_put_error(42,(101),(106),"ecdsa/ecs_ossl.c",291)
                                      ;
    goto err;
   }
  } else
...
err:
 if (!ok) {
  ECDSA_SIG_free(ret);
  ret = 
# 304 "ecdsa/ecs_ossl.c" 3 4
       ((void *)0)
# 304 "ecdsa/ecs_ossl.c"
           ;
 }
 BN_CTX_free(ctx);
 BN_clear_free(m);
    ...
    EC_KEY *eckey)
{
 ...
 EC_POINT *point = 
# 321 "ecdsa/ecs_ossl.c" 3 4
                  ((void *)0)
# 321 "ecdsa/ecs_ossl.c"
                      ;
 const EC_GROUP *group;
 ...
 if (eckey == 
# 326 "ecdsa/ecs_ossl.c" 3 4
             ((void *)0) 
# 326 "ecdsa/ecs_ossl.c"
                  || (group = EC_KEY_get0_group(eckey)) == 
# 326 "ecdsa/ecs_ossl.c" 3 4
                                                           ((void *)0) 
# 326 "ecdsa/ecs_ossl.c"
...
# 327 "ecdsa/ecs_ossl.c" 3 4
                                                 ((void *)0) 
# 327 "ecdsa/ecs_ossl.c"
                                                      || sig == 
# 327 "ecdsa/ecs_ossl.c" 3 4
                                                                ((void *)0)
# 327 "ecdsa/ecs_ossl.c"
                                                                    ) {
  ERR_put_error(42,(102),(103),"ecdsa/ecs_ossl.c",328);
  return -1;
 }

 ctx = BN_CTX_new();
 if (!ctx) {
  ERR_put_error(42,(102),((1|64)),"ecdsa/ecs_ossl.c",334);
  return -1;
 }
 BN_CTX_start(ctx);
 ...
 X = BN_CTX_get(ctx);
 if (!X) {
  ERR_put_error(42,(102),(3),"ecdsa/ecs_ossl.c",344);
  goto err;
 }

 if (!EC_GROUP_get_order(group, order, ctx)) {
  ERR_put_error(42,(102),(16),"ecdsa/ecs_ossl.c",349);
  goto err;
 }

 if (BN_is_zero(sig->r) || ((sig->r)->neg != 0) ||
     BN_ucmp(sig->r, order) >= 0 || BN_is_zero(sig->s) ||
     ((sig->s)->neg != 0) || BN_ucmp(sig->s, order) >= 0) {
  ERR_put_error(42,(102),(100),"ecdsa/ecs_ossl.c",356);
  ret = 0;
  goto err;
 }

 if (!BN_mod_inverse(u2, sig->s, order, ctx)) {
  ERR_put_error(42,(102),(3),"ecdsa/ecs_ossl.c",362);
  goto err;
 }
 ...
 if (8 * dgst_len > i)
  dgst_len = (i + 7)/8;
 if (!BN_bin2bn(dgst, dgst_len, m)) {
  ERR_put_error(42,(102),(3),"ecdsa/ecs_ossl.c",373);
  goto err;
 }

 if ((8 * dgst_len > i) && !BN_rshift(m, m, 8 - (i & 0x7))) {
  ERR_put_error(42,(102),(3),"ecdsa/ecs_ossl.c",378);
  goto err;
 }

 if (!BN_mod_mul(u1, m, u2, order, ctx)) {
  ERR_put_error(42,(102),(3),"ecdsa/ecs_ossl.c",383);
  goto err;
 }

 if (!BN_mod_mul(u2, sig->r, u2, order, ctx)) {
  ERR_put_error(42,(102),(3),"ecdsa/ecs_ossl.c",388);
  goto err;
 }

 if ((point = EC_POINT_new(group)) == 
# 392 "ecdsa/ecs_ossl.c" 3 4
                                     ((void *)0)
# 392 "ecdsa/ecs_ossl.c"
                                         ) {
  ERR_put_error(42,(102),((1|64)),"ecdsa/ecs_ossl.c",393);
  goto err;
 }
 if (!EC_POINT_mul(group, point, u1, pub_key, u2, ctx)) {
  ERR_put_error(42,(102),(16),"ecdsa/ecs_ossl.c",397);
  goto err;
 }
 if (EC_METHOD_get_field_type(EC_GROUP_method_of(group)) ==
     406) {
  if (!EC_POINT_get_affine_coordinates_GFp(group,
      point, X, 
# 403 "ecdsa/ecs_ossl.c" 3 4
               ((void *)0)
# 403 "ecdsa/ecs_ossl.c"
                   , ctx)) {
   ERR_put_error(42,(102),(16),"ecdsa/ecs_ossl.c",404);
   goto err;
  }
 }
 ...
 else
 {
  if (!EC_POINT_get_affine_coordinates_GF2m(group,
      point, X, 
# 412 "ecdsa/ecs_ossl.c" 3 4
               ((void *)0)
# 412 "ecdsa/ecs_ossl.c"
                   , ctx)) {
   ERR_put_error(42,(102),(16),"ecdsa/ecs_ossl.c",413);
   goto err;
  }
 }

 if (!BN_nnmod(u1, X, order, ctx)) {
  ERR_put_error(42,(102),(3),"ecdsa/ecs_ossl.c",419);
  goto err;
 }
