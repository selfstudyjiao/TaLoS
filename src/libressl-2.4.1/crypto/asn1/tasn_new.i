...
# 135 "asn1/tasn_new.c"
  ...
  if (asn1_cb && !asn1_cb(1, pval, it, 
# 152 "asn1/tasn_new.c" 3 4
                                                     ((void *)0)
# 152 "asn1/tasn_new.c"
                                                         ))
   goto auxerr;
...
memerr:
 ERR_put_error(13,(121),((1|64)),"asn1/tasn_new.c",193);
...
auxerr:
 ERR_put_error(13,(121),(100),"asn1/tasn_new.c",201);
...
# 257 "asn1/tasn_new.c"
 ...
 if (tt->flags & (0x3 << 1)) {
  struct stack_st_ASN1_VALUE *skval;
  skval = ((struct stack_st_ASN1_VALUE *)sk_new_null());
  if (!skval) {
   ERR_put_error(13,(133),((1|64)),"asn1/tasn_new.c",269);
   ret = 0;
   goto done;
  }
 ...
 ret = asn1_item_ex_combine_new(pval, it, tt->flags & (0x1<<10));
done:
...
asn1_template_clear(ASN1_VALUE **pval, const ASN1_TEMPLATE *tt)
{
 ...
 if (tt->flags & ((0x3<<8)|(0x3 << 1)))
  *pval = 
# 292 "asn1/tasn_new.c" 3 4
         ((void *)0)
# 292 "asn1/tasn_new.c"
             ;
 else
...
ASN1_primitive_new(ASN1_VALUE **pval, const ASN1_ITEM *it)
{
 ...
 case -4:
  ...
  if (typ != 
# 334 "asn1/tasn_new.c" 3 4
            ((void *)0)
# 334 "asn1/tasn_new.c"
                ) {
   typ->value.ptr = 
# 335 "asn1/tasn_new.c" 3 4
                   ((void *)0)
# 335 "asn1/tasn_new.c"
                       ;
   typ->type = -1;
 ...
 default:
  ...
  if (it != 
# 343 "asn1/tasn_new.c" 3 4
           ((void *)0) 
# 343 "asn1/tasn_new.c"
                && it->itype == 0x5 &&
      str != 
# 344 "asn1/tasn_new.c" 3 4
            ((void *)0)
# 344 "asn1/tasn_new.c"
                )
   str->flags |= 0x040;
