...
TS_RESP_set_status_info(TS_RESP *a, TS_STATUS_INFO *status_info)
{
 ...
 if (new_status_info == 
# 76 "ts/ts_rsp_utils.c" 3 4
                       ((void *)0)
# 76 "ts/ts_rsp_utils.c"
                           ) {
  ERR_put_error(47,(135),((1|64)),"ts/ts_rsp_utils.c",77);
  return 0;
 }
...
TS_TST_INFO_set_policy_id(TS_TST_INFO *a, ASN1_OBJECT *policy)
{
 ...
 if (new_policy == 
# 135 "ts/ts_rsp_utils.c" 3 4
                  ((void *)0)
# 135 "ts/ts_rsp_utils.c"
                      ) {
  ERR_put_error(47,(140),((1|64)),"ts/ts_rsp_utils.c",136);
  return 0;
 }
...
TS_TST_INFO_set_msg_imprint(TS_TST_INFO *a, TS_MSG_IMPRINT *msg_imprint)
{
 ...
 if (new_msg_imprint == 
# 158 "ts/ts_rsp_utils.c" 3 4
                       ((void *)0)
# 158 "ts/ts_rsp_utils.c"
                           ) {
  ERR_put_error(47,(138),((1|64)),"ts/ts_rsp_utils.c",159);
  return 0;
 }
...
TS_TST_INFO_set_serial(TS_TST_INFO *a, const ASN1_INTEGER *serial)
{
 ...
 if (new_serial == 
# 181 "ts/ts_rsp_utils.c" 3 4
                  ((void *)0)
# 181 "ts/ts_rsp_utils.c"
                      ) {
  ERR_put_error(47,(141),((1|64)),"ts/ts_rsp_utils.c",182);
  return 0;
 }
...
TS_TST_INFO_set_time(TS_TST_INFO *a, const ASN1_GENERALIZEDTIME *gtime)
{
 ...
 if (new_time == 
# 204 "ts/ts_rsp_utils.c" 3 4
                ((void *)0)
# 204 "ts/ts_rsp_utils.c"
                    ) {
  ERR_put_error(47,(142),((1|64)),"ts/ts_rsp_utils.c",205);
  return 0;
 }
...
TS_TST_INFO_set_accuracy(TS_TST_INFO *a, TS_ACCURACY *accuracy)
{
 ...
 if (new_accuracy == 
# 227 "ts/ts_rsp_utils.c" 3 4
                    ((void *)0)
# 227 "ts/ts_rsp_utils.c"
                        ) {
  ERR_put_error(47,(137),((1|64)),"ts/ts_rsp_utils.c",228);
  return 0;
 }
...
TS_ACCURACY_set_seconds(TS_ACCURACY *a, const ASN1_INTEGER *seconds)
{
 ...
 if (new_seconds == 
# 250 "ts/ts_rsp_utils.c" 3 4
                   ((void *)0)
# 250 "ts/ts_rsp_utils.c"
                       ) {
  ERR_put_error(47,(117),((1|64)),"ts/ts_rsp_utils.c",251);
  return 0;
 }
...
{
 ASN1_INTEGER *new_millis = 
# 268 "ts/ts_rsp_utils.c" 3 4
                           ((void *)0)
# 268 "ts/ts_rsp_utils.c"
                               ;

 if (a->millis == millis)
  return 1;
 if (millis != 
# 272 "ts/ts_rsp_utils.c" 3 4
              ((void *)0)
# 272 "ts/ts_rsp_utils.c"
                  ) {
  new_millis = ASN1_INTEGER_dup(millis);
  if (new_millis == 
# 274 "ts/ts_rsp_utils.c" 3 4
                   ((void *)0)
# 274 "ts/ts_rsp_utils.c"
                       ) {
   ERR_put_error(47,(116),((1|64)),"ts/ts_rsp_utils.c",276)
                            ;
   return 0;
  }
 }
...
{
 ASN1_INTEGER *new_micros = 
# 294 "ts/ts_rsp_utils.c" 3 4
                           ((void *)0)
# 294 "ts/ts_rsp_utils.c"
                               ;

 if (a->micros == micros)
  return 1;
 if (micros != 
# 298 "ts/ts_rsp_utils.c" 3 4
              ((void *)0)
# 298 "ts/ts_rsp_utils.c"
                  ) {
  new_micros = ASN1_INTEGER_dup(micros);
  if (new_micros == 
# 300 "ts/ts_rsp_utils.c" 3 4
                   ((void *)0)
# 300 "ts/ts_rsp_utils.c"
                       ) {
   ERR_put_error(47,(115),((1|64)),"ts/ts_rsp_utils.c",302)
                            ;
   return 0;
  }
 }
...
TS_TST_INFO_set_nonce(TS_TST_INFO *a, const ASN1_INTEGER *nonce)
{
 ...
 if (new_nonce == 
# 338 "ts/ts_rsp_utils.c" 3 4
                 ((void *)0)
# 338 "ts/ts_rsp_utils.c"
                     ) {
  ERR_put_error(47,(139),((1|64)),"ts/ts_rsp_utils.c",339);
  return 0;
 }
...
TS_TST_INFO_set_tsa(TS_TST_INFO *a, GENERAL_NAME *tsa)
{
 ...
 if (new_tsa == 
# 361 "ts/ts_rsp_utils.c" 3 4
               ((void *)0)
# 361 "ts/ts_rsp_utils.c"
                   ) {
  ERR_put_error(47,(143),((1|64)),"ts/ts_rsp_utils.c",362);
  return 0;
 }
...
TS_TST_INFO_ext_free(TS_TST_INFO *a)
{
 if (!a)
  return;
 sk_pop_free(((_STACK*) (1 ? (a->extensions) : (struct stack_st_X509_EXTENSION*)0)), ((void (*)(void *)) ((1 ? (X509_EXTENSION_free) : (void (*)(X509_EXTENSION *))0))));
 a->extensions = 
# 387 "ts/ts_rsp_utils.c" 3 4
                ((void *)0)
# 387 "ts/ts_rsp_utils.c"
                    ;
}
...
{
 return X509v3_add_ext(&a->extensions, ex, loc) != 
# 429 "ts/ts_rsp_utils.c" 3 4
                                                  ((void *)0)
# 429 "ts/ts_rsp_utils.c"
                                                      ;
}
