...
crl_inf_cb(int operation, ASN1_VALUE **pval, const ASN1_ITEM *it, void *exarg)
{
 ...
 case 5:
  (void)((int (*)(const X509_REVOKED * const *,const X509_REVOKED * const *)) sk_set_cmp_func(((_STACK*) (1 ? (a->revoked) : (struct stack_st_X509_REVOKED*)0)), ((int (*)(const void *, const void *)) ((1 ? (X509_REVOKED_cmp) : (int (*)(const X509_REVOKED * const *, const X509_REVOKED * const *))0)))));
  break;
 }
 return 1;
}
...
# 171 "asn1/x_crl.c"
 ...
 {
  .flags = (0x2 << 3)|(0x2<<6) | (0x2 << 1) | (0x1),
  .offset = 
# 177 "asn1/x_crl.c" 3 4
           __builtin_offsetof (
# 177 "asn1/x_crl.c"
           X509_CRL_INFO
# 177 "asn1/x_crl.c" 3 4
...
crl_set_issuers(X509_CRL *crl)
{
 ...
 gens = 
# 206 "asn1/x_crl.c" 3 4
       ((void *)0)
# 206 "asn1/x_crl.c"
           ;
 for (i = 0; i < sk_num(((_STACK*) (1 ? (revoked) : (struct stack_st_X509_REVOKED*)0))); i++) {
  X509_REVOKED *rev = ((X509_REVOKED *)sk_value(((_STACK*) (1 ? (revoked) : (struct stack_st_X509_REVOKED*)0)), (i)));
  struct stack_st_X509_EXTENSION *exts;
  ASN1_ENUMERATED *reason;
  X509_EXTENSION *ext;
  gtmp = X509_REVOKED_get_ext_d2i(rev, 771,
      &j, 
# 213 "asn1/x_crl.c" 3 4
         ((void *)0)
# 213 "asn1/x_crl.c"
             );
  if (!gtmp && (j != -1)) {
  ...
  if (gtmp) {
   gens = gtmp;
   if (!crl->issuers) {
    crl->issuers = ((struct stack_st_GENERAL_NAMES *)sk_new_null());
    if (!crl->issuers)
     return 0;
   }
   if (!sk_push(((_STACK*) (1 ? (crl->issuers) : (struct stack_st_GENERAL_NAMES*)0)), ((void*) (1 ? (gtmp) : (GENERAL_NAMES*)0))))
    return 0;
  }
  rev->issuer = gens;

  reason = X509_REVOKED_get_ext_d2i(rev, 141,
      &j, 
# 232 "asn1/x_crl.c" 3 4
         ((void *)0)
# 232 "asn1/x_crl.c"
             );
  if (!reason && (j != -1)) {
  ...
  for (j = 0; j < sk_num(((_STACK*) (1 ? (exts) : (struct stack_st_X509_EXTENSION*)0))); j++) {
   ext = ((X509_EXTENSION *)sk_value(((_STACK*) (1 ? (exts) : (struct stack_st_X509_EXTENSION*)0)), (j)));
   if (ext->critical > 0) {
...
crl_cb(int operation, ASN1_VALUE **pval, const ASN1_ITEM *it, void *exarg)
{
 ...
 case 1:
  crl->idp = 
# 277 "asn1/x_crl.c" 3 4
            ((void *)0)
# 277 "asn1/x_crl.c"
                ;
  crl->akid = 
# 278 "asn1/x_crl.c" 3 4
             ((void *)0)
# 278 "asn1/x_crl.c"
                 ;
  crl->flags = 0;
  crl->idp_flags = 0;
  crl->idp_reasons = 0x807f;
  crl->meth = default_crl_method;
  crl->meth_data = 
# 283 "asn1/x_crl.c" 3 4
                  ((void *)0)
# 283 "asn1/x_crl.c"
                      ;
  crl->issuers = 
# 284 "asn1/x_crl.c" 3 4
                ((void *)0)
# 284 "asn1/x_crl.c"
                    ;
  crl->crl_number = 
# 285 "asn1/x_crl.c" 3 4
                   ((void *)0)
# 285 "asn1/x_crl.c"
                       ;
  crl->base_crl_number = 
# 286 "asn1/x_crl.c" 3 4
                        ((void *)0)
# 286 "asn1/x_crl.c"
                            ;
  break;
...
# 318 "asn1/x_crl.c"
  ...
  for (idx = 0; idx < sk_num(((_STACK*) (1 ? (exts) : (struct stack_st_X509_EXTENSION*)0))); idx++) {
   int nid;
   ext = ((X509_EXTENSION *)sk_value(((_STACK*) (1 ? (exts) : (struct stack_st_X509_EXTENSION*)0)), (idx)));
 ...
 case 3:
  ...
  sk_pop_free(((_STACK*) (1 ? (crl->issuers) : (struct stack_st_GENERAL_NAMES*)0)), ((void (*)(void *)) ((1 ? (GENERAL_NAMES_free) : (void (*)(GENERAL_NAMES *))0))));
  break;
 }
 return rc;
}
...
static const ASN1_AUX X509_CRL_aux = {
 .app_data = 
# 405 "asn1/x_crl.c" 3 4
            ((void *)0)
# 405 "asn1/x_crl.c"
                ,
 .flags = 1,
 .ref_offset = 
# 407 "asn1/x_crl.c" 3 4
              __builtin_offsetof (
# 407 "asn1/x_crl.c"
              X509_CRL
# 407 "asn1/x_crl.c" 3 4
...
X509_CRL_add0_revoked(X509_CRL *crl, X509_REVOKED *rev)
{
 ...
 inf = crl->crl;
 if (!inf->revoked)
  inf->revoked = ((struct stack_st_X509_REVOKED *)sk_new(((int (*)(const void *, const void *)) ((1 ? (X509_REVOKED_cmp) : (int (*)(const X509_REVOKED * const *, const X509_REVOKED * const *))0)))));
 if (!inf->revoked || !sk_push(((_STACK*) (1 ? (inf->revoked) : (struct stack_st_X509_REVOKED*)0)), ((void*) (1 ? (rev) : (X509_REVOKED*)0)))) {
  ERR_put_error(13,(169),((1|64)),"asn1/x_crl.c",538);
  return 0;
 }
 inf->enc.modified = 1;
 return 1;
...
crl_revoked_issuer_match(X509_CRL *crl, X509_NAME *nm, X509_REVOKED *rev)
{
 ...
 if (!rev->issuer) {
  if (!nm)
   return 1;
  if (!X509_NAME_cmp(nm, ((crl)->crl->issuer)))
   return 1;
  return 0;
 }
 ...
 for (i = 0; i < sk_num(((_STACK*) (1 ? (rev->issuer) : (struct stack_st_GENERAL_NAME*)0))); i++) {
  GENERAL_NAME *gen = ((GENERAL_NAME *)sk_value(((_STACK*) (1 ? (rev->issuer) : (struct stack_st_GENERAL_NAME*)0)), (i)));
  if (gen->type != 4)
   continue;
    ...
    X509_NAME *issuer)
{
 ...
 if (!sk_is_sorted(((_STACK*) (1 ? (crl->crl->revoked) : (struct stack_st_X509_REVOKED*)0)))) {
  CRYPTO_lock(1|8,6,"asn1/x_crl.c",617);
  sk_sort(((_STACK*) (1 ? (crl->crl->revoked) : (struct stack_st_X509_REVOKED*)0)));
  CRYPTO_lock(2|8,6,"asn1/x_crl.c",619);
 }
 idx = sk_find(((_STACK*) (1 ? (crl->crl->revoked) : (struct stack_st_X509_REVOKED*)0)), ((void*) (1 ? (&rtmp) : (X509_REVOKED*)0)));
 if (idx < 0)
  return 0;

 for (; idx < sk_num(((_STACK*) (1 ? (crl->crl->revoked) : (struct stack_st_X509_REVOKED*)0))); idx++) {
  rev = ((X509_REVOKED *)sk_value(((_STACK*) (1 ? (crl->crl->revoked) : (struct stack_st_X509_REVOKED*)0)), (idx)));
