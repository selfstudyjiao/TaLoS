...
BN_exp(BIGNUM *r, const BIGNUM *a, const BIGNUM *p, BN_CTX *ctx)
{
 ...
 if (((p)->flags&(0x04)) != 0) {
  ...
  ERR_put_error(3,(123),((2|64)),"bn/bn_exp.c",131);
  return -1;
 }
...
# 225 "bn/bn_exp.c"
 if ((((m)->top > 0) && ((m)->d[0] & 1))) {
  ...
  if (a->top == 1 && !a->neg &&
      (((p)->flags&(0x04)) == 0)) {
   unsigned long A = a->d[0];
   ret = BN_mod_exp_mont_word(r, A,p, m,ctx, 
# 230 "bn/bn_exp.c" 3 4
                                            ((void *)0)
# 230 "bn/bn_exp.c"
                                                );
    ...
    BN_CTX *ctx)
{
 ...
 if (((p)->flags&(0x04)) != 0) {
  ...
  ERR_put_error(3,(125),((2|64)),"bn/bn_exp.c",263);
  return -1;
 }
 ...
 BN_CTX_start(ctx);
 if ((aa = BN_CTX_get(ctx)) == 
# 275 "bn/bn_exp.c" 3 4
                              ((void *)0)
# 275 "bn/bn_exp.c"
                                  )
  goto err;
 if ((val[0] = BN_CTX_get(ctx)) == 
# 277 "bn/bn_exp.c" 3 4
                                  ((void *)0)
# 277 "bn/bn_exp.c"
                                      )
 ...
 window = ((bits) > 671 ? 6 : (bits) > 239 ? 5 : (bits) > 79 ? 4 : (bits) > 23 ? 3 : 1);
 if (window > 1) {
  if (!BN_mod_mul_reciprocal(aa, val[0], val[0], &recp, ctx))
   goto err;
  j = 1 << (window - 1);
  for (i = 1; i < j; i++) {
   if (((val[i] = BN_CTX_get(ctx)) == 
# 307 "bn/bn_exp.c" 3 4
                                     ((void *)0)
# 307 "bn/bn_exp.c"
                                         ) ||
...
# 390 "bn/bn_exp.c"
 ...
 if (!(((m)->top > 0) && ((m)->d[0] & 1))) {
  ERR_put_error(3,(109),(102),"bn/bn_exp.c",401);
  return (0);
 }
 bits = BN_num_bits(p);
 if (bits == 0) {
...
# 581 "bn/bn_exp.c"
                        ;
 int numPowers;
 unsigned char *powerbufFree = 
# 583 "bn/bn_exp.c" 3 4
                              ((void *)0)
# 583 "bn/bn_exp.c"
                                  ;
 int powerbufLen = 0;
 unsigned char *powerbuf = 
# 585 "bn/bn_exp.c" 3 4
                          ((void *)0)
# 585 "bn/bn_exp.c"
                              ;
 ...
 if (!(m->d[0] & 1)) {
  ERR_put_error(3,(124),(102),"bn/bn_exp.c",596)
                                    ;
  return (0);
 }
 bits = BN_num_bits(p);
...
# 613 "bn/bn_exp.c"
 ...
 window = ((bits) > 937 ? 6 : (bits) > 306 ? 5 : (bits) > 89 ? 4 : (bits) > 22 ? 3 : 1);
...
# 633 "bn/bn_exp.c"
 ...
 powerbuf = ((unsigned char*)(powerbufFree) + (( 64 ) - (((size_t)(powerbufFree)) & ((( 64 ) - 1)))));
 memset(powerbuf, 0, powerbufLen);


 tmp.d = (unsigned long *)(powerbuf + sizeof(m->d[0]) * top * numPowers);
 am.d = tmp.d + top;
 tmp.top = am.top = 0;
 tmp.dmax = am.dmax = top;
 tmp.neg = am.neg = 0;
 tmp.flags = am.flags = 0x02;



 if (!BN_mod_mul_montgomery( (&tmp),(BN_value_one()),&((mont)->RR),(mont),(ctx)))
  goto err;
# 659 "bn/bn_exp.c"
 if (a->neg || BN_ucmp(a, m) >= 0) {
  if (!BN_div(
...
# 660 "bn/bn_exp.c"
      ,(&am),(a),(m),(ctx)))
   goto err;
  if (!BN_mod_mul_montgomery( (&am),(&am),&((mont)->RR),(mont),(ctx)))
   goto err;
 } else if (!BN_mod_mul_montgomery( (&am),(a),&((mont)->RR),(mont),(ctx)))
  goto err;
# 674 "bn/bn_exp.c"
 if (window == 5 && top > 1) {
  void bn_mul_mont_gather5(unsigned long *rp, const unsigned long *ap,
      const void *table, const unsigned long *np,
      const unsigned long *n0, int num, int power);
  void bn_scatter5(const unsigned long *inp, size_t num,
      void *table, size_t power);
  void bn_gather5(unsigned long *out, size_t num,
      void *table, size_t power);

  unsigned long *np = mont->N.d, *n0 = mont->n0;
...
# 706 "bn/bn_exp.c"
  ...
  tmp.top = top;
  { unsigned long *ftl; int tmp_top = (&tmp)->top; if (tmp_top > 0) { for (ftl= &((&tmp)->d[tmp_top-1]); tmp_top > 0; tmp_top--) if (*(ftl--)) break; (&tmp)->top = tmp_top; } ; };
 } else
...
int
BN_mod_exp_mont_word(BIGNUM *rr, unsigned long a, const BIGNUM *p, const BIGNUM *m,
    BN_CTX *ctx, BN_MONT_CTX *in_mont)
{
 BN_MONT_CTX *mont = 
# 839 "bn/bn_exp.c" 3 4
...
# 839 "bn/bn_exp.c"
 ...
 int b, bits, ret = 0;
 int r_is_one;
 unsigned long w, next_w;
 BIGNUM *d, *r, *t;
 BIGNUM *swap_tmp;
# 861 "bn/bn_exp.c"
 if (((p)->flags&(0x04)) != 0) {

  ERR_put_error(3,(117),((2|64)),"bn/bn_exp.c",864)
                                        ;
  return -1;
 }
 ...
 if (!(((m)->top > 0) && ((m)->d[0] & 1))) {
  ERR_put_error(3,(117),(102),"bn/bn_exp.c",872);
  return (0);
 }
 if (m->top == 1)
  a %= m->d[0];
 ...
 for (b = bits - 2; b >= 0; b--) {
  ...
  if ((next_w / w) != w)
  {
   if (r_is_one) {
    ...
    if (!(BN_mul_word(r, (w)) && ( (BN_div(
# 922 "bn/bn_exp.c" 3 4
        ((void *)0)
# 922 "bn/bn_exp.c"
        ,(t),(r),(m),(ctx)) && (swap_tmp = r, r = t, t = swap_tmp, 1)))))
     goto err;
   }
   next_w = 1;
  }
    ...
    BN_CTX *ctx)
{
 ...
 if (((p)->flags&(0x04)) != 0) {
  ...
  ERR_put_error(3,(126),((2|64)),"bn/bn_exp.c",997)
                                        ;
  return -1;
 }
 ...
 BN_CTX_start(ctx);
 if ((d = BN_CTX_get(ctx)) == 
# 1009 "bn/bn_exp.c" 3 4
                             ((void *)0)
# 1009 "bn/bn_exp.c"
                                 )
  goto err;
 if ((val[0] = BN_CTX_get(ctx)) == 
# 1011 "bn/bn_exp.c" 3 4
                                  ((void *)0)
# 1011 "bn/bn_exp.c"
                                      )
  goto err;
