...
{
 X509_PKEY *ret = 
# 70 "asn1/x_pkey.c" 3 4
                 ((void *)0)
# 70 "asn1/x_pkey.c"
                     ;

 if ((ret = malloc(sizeof(X509_PKEY))) == 
# 72 "asn1/x_pkey.c" 3 4
                                         ((void *)0)
# 72 "asn1/x_pkey.c"
                                             ) {
  ERR_put_error(13,(173),((1|64)),"asn1/x_pkey.c",73);
  goto err;
 }
 ret->version = 0;
 if ((ret->enc_algor = X509_ALGOR_new()) == 
# 77 "asn1/x_pkey.c" 3 4
                                           ((void *)0)
# 77 "asn1/x_pkey.c"
                                               ) {
  ERR_put_error(13,(173),((1|64)),"asn1/x_pkey.c",78);
  goto err;
 }
 if ((ret->enc_pkey = ASN1_OCTET_STRING_new()) == 
# 81 "asn1/x_pkey.c" 3 4
                                                 ((void *)0)
# 81 "asn1/x_pkey.c"
                                                     ) {
  ERR_put_error(13,(173),((1|64)),"asn1/x_pkey.c",82);
  goto err;
 }
 ret->dec_pkey = 
# 85 "asn1/x_pkey.c" 3 4
                ((void *)0)
# 85 "asn1/x_pkey.c"
                    ;
 ret->key_length = 0;
 ret->key_data = 
# 87 "asn1/x_pkey.c" 3 4
                ((void *)0)
# 87 "asn1/x_pkey.c"
                    ;
 ret->key_free = 0;
 ret->cipher.cipher = 
# 89 "asn1/x_pkey.c" 3 4
                     ((void *)0)
# 89 "asn1/x_pkey.c"
                         ;
 memset(ret->cipher.iv, 0, 16);
 ret->references = 1;
 return (ret);
...
X509_PKEY_free(X509_PKEY *x)
{
 ...
 if (x == 
# 107 "asn1/x_pkey.c" 3 4
         ((void *)0)
# 107 "asn1/x_pkey.c"
             )
  return;

 i = CRYPTO_add_lock(&x->references,-1,5,"asn1/x_pkey.c",110);
 if (i > 0)
  return;

 if (x->enc_algor != 
# 114 "asn1/x_pkey.c" 3 4
                    ((void *)0)
# 114 "asn1/x_pkey.c"
                        )
