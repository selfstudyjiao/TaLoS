...
static ENGINE_TABLE *cipher_table = 
# 65 "engine/tb_cipher.c" 3 4
                                   ((void *)0)
# 65 "engine/tb_cipher.c"
                                       ;
...
ENGINE_register_ciphers(ENGINE *e)
{
 if (e->ciphers) {
  const int *nids;
  int num_nids = e->ciphers(e, 
# 84 "engine/tb_cipher.c" 3 4
                              ((void *)0)
# 84 "engine/tb_cipher.c"
                                  , &nids, 0);
  if (num_nids > 0)
...
ENGINE_set_default_ciphers(ENGINE *e)
{
 if (e->ciphers) {
  const int *nids;
  int num_nids = e->ciphers(e, 
# 107 "engine/tb_cipher.c" 3 4
                              ((void *)0)
# 107 "engine/tb_cipher.c"
                                  , &nids, 0);
  if (num_nids > 0)
   return engine_table_register(&cipher_table,
       engine_unregister_all_ciphers, e, nids,
...
ENGINE_get_cipher(ENGINE *e, int nid)
{
 ...
 if (!fn || !fn(e, &ret, 
# 132 "engine/tb_cipher.c" 3 4
                        ((void *)0)
# 132 "engine/tb_cipher.c"
                            , nid)) {
  ERR_put_error(38,(185),(146),"engine/tb_cipher.c",134)
                                    ;
  return 
# 135 "engine/tb_cipher.c" 3 4
        ((void *)0)
# 135 "engine/tb_cipher.c"
            ;
 }
 return ret;
}
