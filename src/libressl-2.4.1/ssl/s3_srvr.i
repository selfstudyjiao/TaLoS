...
# 20 "../include/compat/sys/types.h" 2
...
# 178 "../ssl/s3_srvr.c" 3 4
(*__errno_location ()) 
# 178 "../ssl/s3_srvr.c"
      = 0;

 if (s->info_callback != 
# 180 "../ssl/s3_srvr.c" 3 4
                        ((void *)0)
# 180 "../ssl/s3_srvr.c"
                            )
  cb = s->info_callback;
 else if (s->ctx->info_callback != 
# 182 "../ssl/s3_srvr.c" 3 4
                                  ((void *)0)
# 182 "../ssl/s3_srvr.c"
                                      )
 ...
 if (s->cert == 
# 190 "../ssl/s3_srvr.c" 3 4
               ((void *)0)
# 190 "../ssl/s3_srvr.c"
                   ) {
  ERR_put_error(20,(128),(179),"../ssl/s3_srvr.c",191);
  ret = -1;
  goto end;
 }
...
# 210 "../ssl/s3_srvr.c"
   ...
   if ((s->version >> 8) != 3) {
    ERR_put_error(20,(128),((4|64)),"../ssl/s3_srvr.c",214);
    ret = -1;
    goto end;
   }
   s->type = 0x2000;
   ...
   if (s->state != (0x04|(0x1000|0x2000))) {
    ...
    ERR_put_error(20,(128),(338),"../ssl/s3_srvr.c",256)
                                                   ;
    ssl3_send_alert(s, 2,
        40);
    ret = -1;
  ...
  case (0x121|0x2000):
   ...
   if (ret <= 0)
    goto end;
   s->s3->tmp.next_state = (0x122|0x2000);
   s->state = (0x100|0x2000);
   s->init_num = 0;
  ...
  case (0x131|0x2000):
   ...
   if (s->hit) {
    if (s->tlsext_ticket_expected)
     s->state = (0x1F0|0x2000);
    else
     s->state = (0x1D0|0x2000);
   }
   else
    s->state = (0x140|0x2000);
   s->init_num = 0;
   break;
  ...
  case (0x141|0x2000):
   ...
   if (!(s->s3->tmp.new_cipher->algorithm_auth &
    ...
    if (s->tlsext_status_expected)
     s->state = (0x200|0x2000);
    else
     s->state = (0x150|0x2000);
   } else {
    skip = 1;
    s->state = (0x150|0x2000);
   }
...
# 355 "../ssl/s3_srvr.c"
  ...
  case (0x161|0x2000):
# 385 "../ssl/s3_srvr.c"
   if (!(s->verify_mode & 0x01) ||
       ((s->session->peer != 
# 386 "../ssl/s3_srvr.c" 3 4
                            ((void *)0)
# 386 "../ssl/s3_srvr.c"
                                ) &&
        (s->verify_mode & 0x04)) ||
       ((s->s3->tmp.new_cipher->algorithm_auth &
        0x00000004L) && !(s->verify_mode &
        0x02))) {

    skip = 1;
    s->s3->tmp.cert_request = 0;
    s->state = (0x170|0x2000);
  ...
  case (0x171|0x2000):
   ...
   if (ret <= 0)
    goto end;
   s->s3->tmp.next_state = (0x180|0x2000);
   s->state = (0x100|0x2000);
   s->init_num = 0;
   break;
...
# 471 "../ssl/s3_srvr.c"
    if (s->s3->next_proto_neg_seen)
     s->state = (0x210|0x2000);
    else
     s->state = (0x1C0|0x2000);
    s->init_num = 0;
   } else if ((s->method->ssl3_enc->enc_flags & (1 << 1)) || (alg_k & 0x00000200L)) {
    s->state = (0x1A0|0x2000);
    s->init_num = 0;
    if (!s->session->peer)
     break;
    ...
    if (!s->s3->handshake_buffer) {
     ERR_put_error(20,(128),((4|64)),"../ssl/s3_srvr.c",487)
                              ;
     ret = -1;
     goto end;
    }
...
# 510 "../ssl/s3_srvr.c"
    ...
    for (dgst_num = 0; dgst_num < 8;
        dgst_num++)
     if (s->s3->handshake_dgst[dgst_num]) {
     int dgst_size;

     s->method->ssl3_enc->cert_verify_mac(s,
         EVP_MD_type(EVP_MD_CTX_md(s->s3->handshake_dgst[dgst_num]))
                                         ,
         &(s->s3->tmp.cert_verify_md[offset]));
     dgst_size = EVP_MD_size(EVP_MD_CTX_md(s->s3->handshake_dgst[dgst_num]))
                                         ;
     if (dgst_size < 0) {
      ret = -1;
      goto end;
  ...
  case (0x1C1|0x2000):
   s->s3->flags |= 0x0080;
   ret = ssl3_get_finished(s, (0x1C0|0x2000),
       (0x1C1|0x2000));
   if (ret <= 0)
    goto end;
   if (s->hit)
  ...
  case (0x1D1|0x2000):
   ...
   ret = ssl3_send_change_cipher_spec(s,
       (0x1D0|0x2000), (0x1D1|0x2000));

   if (ret <= 0)
    goto end;
   s->state = (0x1E0|0x2000);
   s->init_num = 0;
...
# 666 "../ssl/s3_srvr.c"
  ...
  default:
   ERR_put_error(20,(128),(255),"../ssl/s3_srvr.c",676)
                           ;
   ret = -1;
   goto end;
...
# 689 "../ssl/s3_srvr.c"
 ...
 s->in_handshake--;
 if (cb != 
# 702 "../ssl/s3_srvr.c" 3 4
          ((void *)0)
# 702 "../ssl/s3_srvr.c"
              )
  cb(s, (0x2000|0x02), ret);
 return (ret);
}
...
{
 if (s->state == (0x120|0x2000)) {
  ssl3_handshake_msg_start(s, 0);
  ssl3_handshake_msg_finish(s, 0);

  s->state = (0x121|0x2000);
 }
...
ssl3_get_client_hello(SSL *s)
{
 ...
 SSL_CIPHER *c;
 struct stack_st_SSL_CIPHER *ciphers = 
# 730 "../ssl/s3_srvr.c" 3 4
                                ((void *)0)
# 730 "../ssl/s3_srvr.c"
                                    ;
 unsigned long alg_k;
# 740 "../ssl/s3_srvr.c"
 if (s->state == (0x110|0x2000)) {
  s->state = (0x111|0x2000);
 }
 s->first_packet = 1;
 n = s->method->ssl_get_message(s, (0x111|0x2000),
     (0x112|0x2000), 1,
     16384, &ok);
 ...
 if ((s->version == 0xFEFF && s->client_version > s->version) ||
     (s->version != 0xFEFF && s->client_version < s->version)) {
  ERR_put_error(20,(138),(267),"../ssl/s3_srvr.c",765)
                                 ;
  if ((s->client_version >> 8) == 0x03 &&
...
# 783 "../ssl/s3_srvr.c"
  ...
  session_length = *(p + 32);
  cookie_length = *(p + 32 + session_length + 1);
...
# 821 "../ssl/s3_srvr.c"
 ...
 if ((s->method->ssl3_enc->enc_flags & (1 << 3))) {
  ...
  if (cookie_len > sizeof(s->d1->rcvd_cookie)) {
   ...
   al = 50;
   ERR_put_error(20,(138),(308),"../ssl/s3_srvr.c",855)
                             ;
   goto f_err;
  }
...
# 867 "../ssl/s3_srvr.c"
    ...
    if (s->ctx->app_verify_cookie_cb(s,
     ...
     al = 40;
     ERR_put_error(20,(138),(308),"../ssl/s3_srvr.c",872)
                               ;
     goto f_err;
    }
    ...
    al = 40;
    ERR_put_error(20,(138),(308),"../ssl/s3_srvr.c",881)
                              ;
    goto f_err;
   }
 ...
 if ((i == 0) && (j != 0)) {
  ...
  al = 47;
  ERR_put_error(20,(138),(183),"../ssl/s3_srvr.c",898)
                                 ;
  goto f_err;
 }
 if (p + i - d > n)
  goto truncated;
 if (i > 0) {
  if ((ciphers = ssl_bytes_to_cipher_list(s, p, i)) == 
# 904 "../ssl/s3_srvr.c" 3 4
                                                      ((void *)0)
# 904 "../ssl/s3_srvr.c"
                                                          )
   goto err;
 ...
 if ((s->hit) && (i > 0)) {
  ...
  for (i = 0; i < sk_num(((_STACK*) (1 ? (ciphers) : (struct stack_st_SSL_CIPHER*)0))); i++) {
   c = ((SSL_CIPHER *)sk_value(((_STACK*) (1 ? (ciphers) : (struct stack_st_SSL_CIPHER*)0)), (i)));
   if (c->id == id) {
    j = 1;
    break;
   }
  ...
  if (j == 0) {
   ...
   al = 47;
   ERR_put_error(20,(138),(215),"../ssl/s3_srvr.c",928)
                                     ;
   goto f_err;
  }
 }
 ...
 if (j >= i) {
  ...
  al = 50;
  ERR_put_error(20,(138),(187),"../ssl/s3_srvr.c",949)
                                     ;
  goto f_err;
 }
 ...
 if (!ssl_parse_clienthello_tlsext(s, &p, d, n, &al)) {
  ...
  ERR_put_error(20,(138),(227),"../ssl/s3_srvr.c",956);
  goto f_err;
 }
 if (ssl_check_clienthello_tlsext_early(s) <= 0) {
  ERR_put_error(20,(138),(226),"../ssl/s3_srvr.c",961)
                               ;
  goto err;
 }
 ...
 arc4random_buf(s->s3->server_random, 32);

 if (!s->hit && s->tls_session_secret_cb) {
  SSL_CIPHER *pref_cipher = 
# 974 "../ssl/s3_srvr.c" 3 4
                           ((void *)0)
# 974 "../ssl/s3_srvr.c"
                               ;
  ...
  if (s->tls_session_secret_cb(s, s->session->master_key,
   ...
   s->session->verify_result = 0;

   ciphers = 
# 984 "../ssl/s3_srvr.c" 3 4
            ((void *)0)
# 984 "../ssl/s3_srvr.c"
                ;
   ...
   pref_cipher = pref_cipher ? pref_cipher :
       ...
       SSL_get_ciphers(s));
   if (pref_cipher == 
# 990 "../ssl/s3_srvr.c" 3 4
                     ((void *)0)
# 990 "../ssl/s3_srvr.c"
                         ) {
    al = 40;
    ERR_put_error(20,(138),(193),"../ssl/s3_srvr.c",993)
                               ;
    goto f_err;
   }
   ...
   if (s->cipher_list)
    sk_free(((_STACK*) (1 ? (s->cipher_list) : (struct stack_st_SSL_CIPHER*)0)));

   if (s->cipher_list_by_id)
    sk_free(((_STACK*) (1 ? (s->cipher_list_by_id) : (struct stack_st_SSL_CIPHER*)0)));

   s->cipher_list = (struct stack_st_SSL_CIPHER *)sk_dup(((_STACK*) (1 ? s->session->ciphers : (struct stack_st_SSL_CIPHER*)0)));
   s->cipher_list_by_id =
       (struct stack_st_SSL_CIPHER *)sk_dup(((_STACK*) (1 ? s->session->ciphers : (struct stack_st_SSL_CIPHER*)0)));
  }
 }
...
# 1017 "../ssl/s3_srvr.c" 3 4
                            ((void *)0)
# 1017 "../ssl/s3_srvr.c"
                                )
   sk_free(((_STACK*) (1 ? (s->session->ciphers) : (struct stack_st_SSL_CIPHER*)0)));
  s->session->ciphers = ciphers;
  if (ciphers == 
# 1020 "../ssl/s3_srvr.c" 3 4
                ((void *)0)
# 1020 "../ssl/s3_srvr.c"
                    ) {
   al = 47;
   ERR_put_error(20,(138),(182),"../ssl/s3_srvr.c",1023)
                               ;
   goto f_err;
  }
  ciphers = 
# 1026 "../ssl/s3_srvr.c" 3 4
           ((void *)0)
# 1026 "../ssl/s3_srvr.c"
               ;
  ...
  if (c == 
# 1030 "../ssl/s3_srvr.c" 3 4
          ((void *)0)
# 1030 "../ssl/s3_srvr.c"
              ) {
   al = 40;
   ERR_put_error(20,(138),(193),"../ssl/s3_srvr.c",1033)
                              ;
   goto f_err;
  }
...
# 1063 "../ssl/s3_srvr.c"
 if (ssl_check_clienthello_tlsext_late(s) <= 0) {
  ERR_put_error(20,(138),(226),"../ssl/s3_srvr.c",1064);
  goto err;
 }
...
truncated:
  al = 50;
  ERR_put_error(20,(138),(115),"../ssl/s3_srvr.c",1073);
f_err:
  ssl3_send_alert(s, 2, al);
 }
err:
 if (ciphers != 
# 1078 "../ssl/s3_srvr.c" 3 4
               ((void *)0)
# 1078 "../ssl/s3_srvr.c"
                   )
  sk_free(((_STACK*) (1 ? (ciphers) : (struct stack_st_SSL_CIPHER*)0)));
 return (ret);
}
...
ssl3_send_server_hello(SSL *s)
{
 ...
 if (s->state == (0x130|0x2000)) {
  d = p = ssl3_handshake_msg_start(s, 2);

  *(p++) = s->version >> 8;
  *(p++) = s->version & 0xff;


  memcpy(p, s->s3->server_random, 32);
  p += 32;
# 1118 "../ssl/s3_srvr.c"
  if (!(s->ctx->session_cache_mode & 0x0002)
      && !s->hit)
   s->session->session_id_length = 0;

  sl = s->session->session_id_length;
  if (sl > (int)sizeof(s->session->session_id)) {
   ERR_put_error(20,(242),((4|64)),"../ssl/s3_srvr.c",1125)
                            ;
   return (-1);
  }
  *(p++) = sl;
  ...
  ((p[0]=(unsigned char)(((ssl3_cipher_get_value(s->s3->tmp.new_cipher))>> 8)&0xff), p[1]=(unsigned char)(((ssl3_cipher_get_value(s->s3->tmp.new_cipher)) )&0xff)),p+=2);
  ...
  *(p++) = 0;
  ...
  bufend = (unsigned char *)s->init_buf->data +
      16384;
  if ((p = ssl_add_serverhello_tlsext(s, p, bufend)) == 
# 1140 "../ssl/s3_srvr.c" 3 4
                                                       ((void *)0)
# 1140 "../ssl/s3_srvr.c"
                                                           ) {
   ERR_put_error(20,(242),((4|64)),"../ssl/s3_srvr.c",1142)
                            ;
   return (-1);
  }
...
{
 if (s->state == (0x170|0x2000)) {
  ssl3_handshake_msg_start(s, 14);
  ssl3_handshake_msg_finish(s, 0);

  s->state = (0x171|0x2000);
 }
...
ssl3_send_server_key_exchange(SSL *s)
{
 unsigned char *q;
 int j, num;
 unsigned char md_buf[16 + 20];
 unsigned int u;
 DH *dh = 
# 1174 "../ssl/s3_srvr.c" 3 4
         ((void *)0)
# 1174 "../ssl/s3_srvr.c"
             , *dhp;
 EC_KEY *ecdh = 
# 1175 "../ssl/s3_srvr.c" 3 4
               ((void *)0)
# 1175 "../ssl/s3_srvr.c"
                   , *ecdhp;
 unsigned char *encodedPoint = 
# 1176 "../ssl/s3_srvr.c" 3 4
                              ((void *)0)
# 1176 "../ssl/s3_srvr.c"
                                  ;
 int encodedlen = 0;
...
# 1200 "../ssl/s3_srvr.c"
  ...
  if (type & 0x00000008L) {
   if (s->cert->dh_tmp_auto != 0) {
    if ((dhp = ssl_get_auto_dh(s)) == 
# 1204 "../ssl/s3_srvr.c" 3 4
                                     ((void *)0)
# 1204 "../ssl/s3_srvr.c"
                                         ) {
     al = 80;
     ERR_put_error(20,(155),((4|64)),"../ssl/s3_srvr.c",1208)
...
# 1214 "../ssl/s3_srvr.c"
   ...
   if (dhp == 
# 1218 "../ssl/s3_srvr.c" 3 4
             ((void *)0)
# 1218 "../ssl/s3_srvr.c"
                 ) {
    al = 40;
    ERR_put_error(20,(155),(171),"../ssl/s3_srvr.c",1221)
                                 ;
    goto f_err;
   }

   if (s->s3->tmp.dh != 
# 1225 "../ssl/s3_srvr.c" 3 4
                       ((void *)0)
# 1225 "../ssl/s3_srvr.c"
                           ) {
    ERR_put_error(20,(155),((4|64)),"../ssl/s3_srvr.c",1227)
                             ;
    goto err;
   }
   ...
   if (s->cert->dh_tmp_auto != 0) {
    dh = dhp;
   } else if ((dh = DHparams_dup(dhp)) == 
# 1233 "../ssl/s3_srvr.c" 3 4
                                         ((void *)0)
# 1233 "../ssl/s3_srvr.c"
                                             ) {
    ERR_put_error(20,(155),(5),"../ssl/s3_srvr.c",1235)
                     ;
    goto err;
   }
   s->s3->tmp.dh = dh;
   if (!DH_generate_key(dh)) {
    ERR_put_error(20,(155),(5),"../ssl/s3_srvr.c",1241)
                     ;
    goto err;
   }
   r[0] = dh->p;
...
# 1255 "../ssl/s3_srvr.c" 3 4
                      ((void *)0) 
# 1255 "../ssl/s3_srvr.c"
                           &&
       s->cert->ecdh_tmp_cb != 
# 1256 "../ssl/s3_srvr.c" 3 4
                              ((void *)0)
# 1256 "../ssl/s3_srvr.c"
                                  ) {
   ...
   if (ecdhp == 
# 1260 "../ssl/s3_srvr.c" 3 4
               ((void *)0)
# 1260 "../ssl/s3_srvr.c"
                   ) {
    al = 40;
    ERR_put_error(20,(155),(311),"../ssl/s3_srvr.c",1263)
                                   ;
    goto f_err;
   }

   if (s->s3->tmp.ecdh != 
# 1267 "../ssl/s3_srvr.c" 3 4
                         ((void *)0)
# 1267 "../ssl/s3_srvr.c"
                             ) {
    ERR_put_error(20,(155),((4|64)),"../ssl/s3_srvr.c",1269)
                             ;
    goto err;
   }
   ...
   if (s->cert->ecdh_tmp_auto != 0) {
    ecdh = ecdhp;
   } else if ((ecdh = EC_KEY_dup(ecdhp)) == 
# 1276 "../ssl/s3_srvr.c" 3 4
                                           ((void *)0)
# 1276 "../ssl/s3_srvr.c"
                                               ) {
    ERR_put_error(20,(155),(43),"../ssl/s3_srvr.c",1278)
                       ;
    goto err;
   }
   s->s3->tmp.ecdh = ecdh;

   if ((EC_KEY_get0_public_key(ecdh) == 
# 1283 "../ssl/s3_srvr.c" 3 4
                                       ((void *)0)
# 1283 "../ssl/s3_srvr.c"
                                           ) ||
       (EC_KEY_get0_private_key(ecdh) == 
# 1284 "../ssl/s3_srvr.c" 3 4
                                        ((void *)0)
# 1284 "../ssl/s3_srvr.c"
                                            ) ||
       (s->options & 0x00080000L)) {
    if (!EC_KEY_generate_key(ecdh)) {
     ERR_put_error(20,(155),(43),"../ssl/s3_srvr.c",1289)
   ...
   if (((group = EC_KEY_get0_group(ecdh)) == 
# 1294 "../ssl/s3_srvr.c" 3 4
                                            ((void *)0)
# 1294 "../ssl/s3_srvr.c"
                                                ) ||
       (EC_KEY_get0_public_key(ecdh) == 
# 1295 "../ssl/s3_srvr.c" 3 4
                                        ((void *)0)
# 1295 "../ssl/s3_srvr.c"
                                            ) ||
       (EC_KEY_get0_private_key(ecdh) == 
# 1296 "../ssl/s3_srvr.c" 3 4
                                        ((void *)0)
# 1296 "../ssl/s3_srvr.c"
                                            )) {
    ERR_put_error(20,(155),(43),"../ssl/s3_srvr.c",1298)
                       ;
    goto err;
   }
   ...
   if ((curve_id = tls1_ec_nid2curve_id(
    ...
    ERR_put_error(20,(155),(315),"../ssl/s3_srvr.c",1310)
                                         ;
    goto err;
   }
...
# 1327 "../ssl/s3_srvr.c"
    ...
    ERR_put_error(20,(155),((1|64)),"../ssl/s3_srvr.c",1329)
                             ;
    goto err;
   }
   ...
   if (encodedlen == 0) {
    ERR_put_error(20,(155),(43),"../ssl/s3_srvr.c",1341)
                       ;
    goto err;
   }
...
# 1355 "../ssl/s3_srvr.c"
   ...
   r[0] = 
# 1361 "../ssl/s3_srvr.c" 3 4
         ((void *)0)
# 1361 "../ssl/s3_srvr.c"
             ;
   r[1] = 
# 1362 "../ssl/s3_srvr.c" 3 4
         ((void *)0)
# 1362 "../ssl/s3_srvr.c"
             ;
   r[2] = 
# 1363 "../ssl/s3_srvr.c" 3 4
         ((void *)0)
# 1363 "../ssl/s3_srvr.c"
             ;
   r[3] = 
# 1364 "../ssl/s3_srvr.c" 3 4
         ((void *)0)
# 1364 "../ssl/s3_srvr.c"
             ;
  } else
  {
   al = 40;
   ERR_put_error(20,(155),(250),"../ssl/s3_srvr.c",1369)
                                       ;
   goto f_err;
  }
  for (i = 0; i < 4 && r[i] != 
# 1372 "../ssl/s3_srvr.c" 3 4
                              ((void *)0)
# 1372 "../ssl/s3_srvr.c"
                                  ; i++) {
   nr[i] = ((BN_num_bits(r[i])+7)/8);
   n += 2 + nr[i];
  }

  if (!(s->s3->tmp.new_cipher->algorithm_auth & 0x00000004L)) {
   if ((pkey = ssl_get_sign_pkey(
       s, s->s3->tmp.new_cipher, &md)) == 
# 1379 "../ssl/s3_srvr.c" 3 4
                                         ((void *)0)
# 1379 "../ssl/s3_srvr.c"
                                             ) {
    al = 50;
...
# 1385 "../ssl/s3_srvr.c"
  ...
  if (!BUF_MEM_grow_clean(buf, ssl3_handshake_msg_hdr_len(s) +
      n + kn)) {
   ERR_put_error(20,(155),(7),"../ssl/s3_srvr.c",1392)
                   ;
   goto err;
  }
  ...
  for (i = 0; i < 4 && r[i] != 
# 1399 "../ssl/s3_srvr.c" 3 4
                              ((void *)0)
# 1399 "../ssl/s3_srvr.c"
                                  ; i++) {
   ((p[0]=(unsigned char)(((nr[i])>> 8)&0xff), p[1]=(unsigned char)(((nr[i]) )&0xff)),p+=2);
   BN_bn2bin(r[i], p);
   p += nr[i];
  }
...
# 1442 "../ssl/s3_srvr.c"
    ...
    if (RSA_sign(114, md_buf, j,
        &(p[2]), &u, pkey->pkey.rsa) <= 0) {
     ERR_put_error(20,(155),(4),"../ssl/s3_srvr.c",1460)
    ...
    if ((s->method->ssl3_enc->enc_flags & (1 << 1))) {
     if (!tls12_get_sigandhash(p, pkey, md)) {
      ...
      al = 80;
      ERR_put_error(20,(155),((4|64)),"../ssl/s3_srvr.c",1473)
...
# 1478 "../ssl/s3_srvr.c"
    ...
    if (!EVP_SignFinal(&md_ctx, &p[2],
     (unsigned int *)&i, pkey)) {
     ERR_put_error(20,(155),(6),"../ssl/s3_srvr.c",1490)
    ...
    al = 40;
    ERR_put_error(20,(155),(251),"../ssl/s3_srvr.c",1501)
                                ;
    goto f_err;
   }
  }
...
# 1528 "../ssl/s3_srvr.c"
 ...
 if (s->state == (0x160|0x2000)) {
  ...
  if ((s->method->ssl3_enc->enc_flags & (1 << 1))) {
   ...
   ((p[0]=(unsigned char)(((nl)>> 8)&0xff), p[1]=(unsigned char)(((nl) )&0xff)),p+=2);
   p += nl + 2;
   n += nl + 2;
  }
  ...
  nl = 0;
  if (sk != 
# 1558 "../ssl/s3_srvr.c" 3 4
           ((void *)0)
# 1558 "../ssl/s3_srvr.c"
               ) {
   for (i = 0; i < sk_num(((_STACK*) (1 ? (sk) : (struct stack_st_X509_NAME*)0))); i++) {
    name = ((X509_NAME *)sk_value(((_STACK*) (1 ? (sk) : (struct stack_st_X509_NAME*)0)), (i)));
    j = i2d_X509_NAME(name, 
# 1561 "../ssl/s3_srvr.c" 3 4
                           ((void *)0)
# 1561 "../ssl/s3_srvr.c"
                               );
    if (!BUF_MEM_grow_clean(buf,
        ...
        + 2)) {
     ERR_put_error(20,(150),(7),"../ssl/s3_srvr.c",1567)
...
ssl3_get_client_key_exchange(SSL *s)
{
 ...
 unsigned char *d, *p;
 RSA *rsa = 
# 1601 "../ssl/s3_srvr.c" 3 4
           ((void *)0)
# 1601 "../ssl/s3_srvr.c"
               ;
 EVP_PKEY *pkey = 
# 1602 "../ssl/s3_srvr.c" 3 4
                 ((void *)0)
# 1602 "../ssl/s3_srvr.c"
                     ;
 BIGNUM *pub = 
# 1603 "../ssl/s3_srvr.c" 3 4
              ((void *)0)
# 1603 "../ssl/s3_srvr.c"
                  ;
 DH *dh_srvr;
 ...
 EC_KEY *srvr_ecdh = 
# 1606 "../ssl/s3_srvr.c" 3 4
                    ((void *)0)
# 1606 "../ssl/s3_srvr.c"
                        ;
 EVP_PKEY *clnt_pub_pkey = 
# 1607 "../ssl/s3_srvr.c" 3 4
                          ((void *)0)
# 1607 "../ssl/s3_srvr.c"
                              ;
 EC_POINT *clnt_ecpoint = 
# 1608 "../ssl/s3_srvr.c" 3 4
                         ((void *)0)
# 1608 "../ssl/s3_srvr.c"
                             ;
 BN_CTX *bn_ctx = 
# 1609 "../ssl/s3_srvr.c" 3 4
                 ((void *)0)
# 1609 "../ssl/s3_srvr.c"
                     ;


 n = s->method->ssl_get_message(s, (0x190|0x2000),
     (0x191|0x2000), 16, 2048, &ok);
 if (!ok)
  return ((int)n);
 d = p = (unsigned char *)s->init_msg;
 ...
 if (alg_k & 0x00000001L) {
  ...
  if ((pkey == 
# 1628 "../ssl/s3_srvr.c" 3 4
              ((void *)0)
# 1628 "../ssl/s3_srvr.c"
                  ) || (pkey->type != 6) ||
      (pkey->pkey.rsa == 
# 1629 "../ssl/s3_srvr.c" 3 4
                        ((void *)0)
# 1629 "../ssl/s3_srvr.c"
                            )) {
   al = 40;
   ERR_put_error(20,(139),(168),"../ssl/s3_srvr.c",1632)
                                     ;
   goto f_err;
  }
  rsa = pkey->pkey.rsa;
  ...
  ((i=(((unsigned int)(p[0]))<< 8)| (((unsigned int)(p[1])) )),p+=2);
  if (n != i + 2) {
   ERR_put_error(20,(139),(234),"../ssl/s3_srvr.c",1642)
                                                     ;
   goto err;
  } else
   n = i;
...
# 1692 "../ssl/s3_srvr.c"
  ...
  ((i=(((unsigned int)(p[0]))<< 8)| (((unsigned int)(p[1])) )),p+=2);
  if (n != i + 2) {
   ERR_put_error(20,(139),(148),"../ssl/s3_srvr.c",1717)
                                             ;
   goto err;
  }
  ...
  if (n == 0L) {
   ...
   al = 40;
   ERR_put_error(20,(139),(236),"../ssl/s3_srvr.c",1725)
                                       ;
   goto f_err;
  } else {
   if (s->s3->tmp.dh == 
# 1728 "../ssl/s3_srvr.c" 3 4
                       ((void *)0)
# 1728 "../ssl/s3_srvr.c"
                           ) {
    al = 40;
    ERR_put_error(20,(139),(171),"../ssl/s3_srvr.c",1731)
                                 ;
    goto f_err;
   } else
    dh_srvr = s->s3->tmp.dh;
  ...
  pub = BN_bin2bn(p, i, 
# 1737 "../ssl/s3_srvr.c" 3 4
                       ((void *)0)
# 1737 "../ssl/s3_srvr.c"
                           );
  if (pub == 
# 1738 "../ssl/s3_srvr.c" 3 4
            ((void *)0)
# 1738 "../ssl/s3_srvr.c"
                ) {
   ERR_put_error(20,(139),(130),"../ssl/s3_srvr.c",1740)
                    ;
   goto err;
  }
  ...
  if (i <= 0) {
   ERR_put_error(20,(139),(5),"../ssl/s3_srvr.c",1748)
                    ;
   BN_clear_free(pub);
   goto err;
  }
...
# 1757 "../ssl/s3_srvr.c"
 ...
 if (alg_k & (0x00000080L|0x00000020L|0x00000040L)) {
  int ret = 1;
  int key_size;
  const EC_KEY *tkey;
  const EC_GROUP *group;
  ...
  if ((srvr_ecdh = EC_KEY_new()) == 
# 1772 "../ssl/s3_srvr.c" 3 4
                                   ((void *)0)
# 1772 "../ssl/s3_srvr.c"
                                       ) {
   ERR_put_error(20,(139),((1|64)),"../ssl/s3_srvr.c",1774)
                            ;
   goto err;
  }
  ...
  if (alg_k & (0x00000020L|0x00000040L)) {
   ...
   tkey = s->cert->pkeys[5].privatekey->pkey.ec;
  } else {
  ...
  if (!EC_KEY_set_group(srvr_ecdh, group) ||
   ...
   ERR_put_error(20,(139),(16),"../ssl/s3_srvr.c",1796)
                    ;
   goto err;
  }


  if ((clnt_ecpoint = EC_POINT_new(group)) == 
# 1801 "../ssl/s3_srvr.c" 3 4
                                             ((void *)0)
# 1801 "../ssl/s3_srvr.c"
                                                 ) {
   ERR_put_error(20,(139),((1|64)),"../ssl/s3_srvr.c",1803)
                            ;
   goto err;
  }
  ...
  if (n == 0L) {
   ...
   if (alg_k & 0x00000080L) {
    al = 40;
    ERR_put_error(20,(139),(311),"../ssl/s3_srvr.c",1813)
                                   ;
    goto f_err;
   }
   if (((clnt_pub_pkey = X509_get_pubkey(
       s->session->peer)) == 
# 1817 "../ssl/s3_srvr.c" 3 4
                            ((void *)0)
# 1817 "../ssl/s3_srvr.c"
                                ) ||
       (clnt_pub_pkey->type != 408)) {
# 1831 "../ssl/s3_srvr.c"
    al = 40;
    ERR_put_error(20,(139),(313),"../ssl/s3_srvr.c",1833)
                                          ;
    goto f_err;
   }
   ...
   if (EC_POINT_copy(clnt_ecpoint,
       ...
       == 0) {
    ERR_put_error(20,(139),(16),"../ssl/s3_srvr.c",1841)
                     ;
    goto err;
   }
   ret = 2;
...
# 1850 "../ssl/s3_srvr.c" 3 4
                                 ((void *)0)
# 1850 "../ssl/s3_srvr.c"
                                     ) {
    ERR_put_error(20,(139),((1|64)),"../ssl/s3_srvr.c",1852)
                             ;
    goto err;
   }
   ...
   p += 1;
   if (n != 1 + i) {
    ERR_put_error(20,(139),(16),"../ssl/s3_srvr.c",1862)
                     ;
    goto err;
   }
   if (EC_POINT_oct2point(group,
    clnt_ecpoint, p, i, bn_ctx) == 0) {
    ERR_put_error(20,(139),(16),"../ssl/s3_srvr.c",1868)
                     ;
    goto err;
   }
  ...
  if (key_size <= 0) {
   ERR_put_error(20,(139),(43),"../ssl/s3_srvr.c",1882)
                      ;
   goto err;
  }
  i = ECDH_compute_key(p, key_size, clnt_ecpoint, srvr_ecdh,
      
# 1886 "../ssl/s3_srvr.c" 3 4
     ((void *)0)
# 1886 "../ssl/s3_srvr.c"
         );
  if (i <= 0) {
   ERR_put_error(20,(139),(43),"../ssl/s3_srvr.c",1889)
                      ;
   goto err;
  }
...
# 1898 "../ssl/s3_srvr.c"
 ...
 if (alg_k & 0x00000200L) {
  int ret = 0;
  EVP_PKEY_CTX *pkey_ctx;
  EVP_PKEY *client_pub_pkey = 
# 1911 "../ssl/s3_srvr.c" 3 4
                             ((void *)0)
# 1911 "../ssl/s3_srvr.c"
                                 , *pk = 
# 1911 "../ssl/s3_srvr.c" 3 4
...
# 1923 "../ssl/s3_srvr.c"
  ...
  if (ASN1_get_object((const unsigned char **)&p, &Tlen, &Ttag,
      &Tclass, n) != 0x20 ||
      Ttag != 16 || Tclass != 0x00) {
   ERR_put_error(20,(139),(147),"../ssl/s3_srvr.c",1945)
                               ;
   goto gerr;
  }
  start = p;
  ...
  if (EVP_PKEY_decrypt(pkey_ctx, premaster_secret, &outlen,
      start, inlen) <=0) {
   ERR_put_error(20,(139),(147),"../ssl/s3_srvr.c",1953)
                               ;
   goto gerr;
  }
...
gerr:
  ...
  al = 40;
  ERR_put_error(20,(139),(249),"../ssl/s3_srvr.c",1976)
                                ;
  goto f_err;
 }
...
truncated:
 al = 50;
 ERR_put_error(20,(139),(115),"../ssl/s3_srvr.c",1983);
f_err:
 ssl3_send_alert(s, 2, al);
err:
 EVP_PKEY_free(clnt_pub_pkey);
...
# 2003 "../ssl/s3_srvr.c"
 ...
 n = s->method->ssl_get_message(s, (0x1A0|0x2000),
     (0x1A1|0x2000), -1, 16384, &ok);
 if (!ok)
  return ((int)n);

 if (s->session->peer != 
# 2012 "../ssl/s3_srvr.c" 3 4
                        ((void *)0)
# 2012 "../ssl/s3_srvr.c"
                            ) {
  peer = s->session->peer;
  ...
  peer = 
# 2017 "../ssl/s3_srvr.c" 3 4
        ((void *)0)
# 2017 "../ssl/s3_srvr.c"
            ;
  pkey = 
# 2018 "../ssl/s3_srvr.c" 3 4
        ((void *)0)
# 2018 "../ssl/s3_srvr.c"
            ;
 }
 ...
 if (s->s3->tmp.message_type != 15) {
  ...
  if (peer != 
# 2023 "../ssl/s3_srvr.c" 3 4
             ((void *)0)
# 2023 "../ssl/s3_srvr.c"
                 ) {
   al = 10;
   ERR_put_error(20,(136),(174),"../ssl/s3_srvr.c",2026)
                                    ;
   goto f_err;
  }
  ret = 1;
 ...
 if (peer == 
# 2033 "../ssl/s3_srvr.c" 3 4
            ((void *)0)
# 2033 "../ssl/s3_srvr.c"
                ) {
  ERR_put_error(20,(136),(186),"../ssl/s3_srvr.c",2035)
                                    ;
  al = 10;
  goto f_err;
 }
 ...
 if (!(type & 0x0010)) {
  ERR_put_error(20,(136),(220),"../ssl/s3_srvr.c",2042)
                                                  ;
  al = 47;
  goto f_err;
 }
 ...
 if (s->s3->change_cipher_spec) {
  ERR_put_error(20,(136),(133),"../ssl/s3_srvr.c",2049)
                               ;
  al = 10;
  goto f_err;
 }
 ...
 if (n == 64 && (pkey->type == 812 ||
  ...
  if ((s->method->ssl3_enc->enc_flags & (1 << 1))) {
   ...
   if (sigalg == -1) {
    ERR_put_error(20,(136),((4|64)),"../ssl/s3_srvr.c",2071)
                             ;
    al = 80;
    goto f_err;
   }
   ...
   if (sigalg != (int)p[1]) {
    ERR_put_error(20,(136),(370),"../ssl/s3_srvr.c",2080)
                                   ;
    al = 50;
    goto f_err;
   }
   ...
   if (md == 
# 2085 "../ssl/s3_srvr.c" 3 4
            ((void *)0)
# 2085 "../ssl/s3_srvr.c"
                ) {
    ERR_put_error(20,(136),(368),"../ssl/s3_srvr.c",2087)
                             ;
    al = 50;
    goto f_err;
   }
 ...
 if ((i > j) || (n > j) || (n <= 0)) {
  ERR_put_error(20,(136),(265),"../ssl/s3_srvr.c",2104)
                                 ;
  al = 50;
  goto f_err;
 }
 ...
 if ((s->method->ssl3_enc->enc_flags & (1 << 1))) {
  ...
  if (hdatalen <= 0) {
   ERR_put_error(20,(136),((4|64)),"../ssl/s3_srvr.c",2115)
                            ;
   al = 80;
   goto f_err;
  }
  if (!EVP_DigestInit_ex(&mctx,md,
# 2119 "../ssl/s3_srvr.c" 3 4
      ((void *)0)
# 2119 "../ssl/s3_srvr.c"
      ) ||
      !EVP_DigestUpdate(&mctx,hdata,hdatalen)) {
   ERR_put_error(20,(136),(6),"../ssl/s3_srvr.c",2122)
                     ;
   al = 80;
   goto f_err;
  }
  ...
  if (EVP_VerifyFinal(&mctx, p, i, pkey) <= 0) {
   al = 51;
   ERR_put_error(20,(136),(123),"../ssl/s3_srvr.c",2130)
                           ;
   goto f_err;
  }
 } else
 if (pkey->type == 6) {
  i = RSA_verify(114, s->s3->tmp.cert_verify_md,
      16 + 20, p, i,
      pkey->pkey.rsa);
  if (i < 0) {
   al = 51;
   ERR_put_error(20,(136),(118),"../ssl/s3_srvr.c",2141)
                             ;
   goto f_err;
  }
  if (i == 0) {
   al = 51;
   ERR_put_error(20,(136),(122),"../ssl/s3_srvr.c",2147)
                               ;
   goto f_err;
  }
 } else
 if (pkey->type == 116) {
  ...
  if (j <= 0) {
   ...
   al = 51;
   ERR_put_error(20,(136),(112),"../ssl/s3_srvr.c",2159)
                               ;
   goto f_err;
  }
 } else
 if (pkey->type == 408) {
  ...
  if (j <= 0) {
   ...
   al = 51;
   ERR_put_error(20,(136),(305),"../ssl/s3_srvr.c",2171)
                                 ;
   goto f_err;
  }
 } else
 ...
 if (pkey->type == 812 ||
  ...
  hdatalen = BIO_ctrl(s->s3->handshake_buffer,3,0,(char *)&hdata);
  if (hdatalen <= 0) {
   ERR_put_error(20,(136),((4|64)),"../ssl/s3_srvr.c",2188)
                            ;
   al = 80;
   goto f_err;
  }
  if (!EVP_PKEY_get_default_digest_nid(pkey, &nid) ||
   ...
   ERR_put_error(20,(136),(6),"../ssl/s3_srvr.c",2195)
                   ;
   al = 80;
   goto f_err;
  }
  pctx = EVP_PKEY_CTX_new(pkey, 
# 2199 "../ssl/s3_srvr.c" 3 4
                               ((void *)0)
# 2199 "../ssl/s3_srvr.c"
                                   );
  if (!pctx) {
   ERR_put_error(20,(136),(6),"../ssl/s3_srvr.c",2202)
                     ;
   al = 80;
   goto f_err;
  }
  if (!EVP_DigestInit_ex(&mctx, md, 
# 2206 "../ssl/s3_srvr.c" 3 4
                                   ((void *)0)
# 2206 "../ssl/s3_srvr.c"
                                       ) ||
      !EVP_DigestUpdate(&mctx, hdata, hdatalen) ||
...
# 2214 "../ssl/s3_srvr.c" 3 4
          ((void *)0)
# 2214 "../ssl/s3_srvr.c"
              ) <= 0)) {
   ERR_put_error(20,(136),(6),"../ssl/s3_srvr.c",2216)
                     ;
   al = 80;
  ...
  if (EVP_PKEY_verify(pctx, p, i, signature, siglen) <= 0) {
   al = 51;
   ERR_put_error(20,(136),(123),"../ssl/s3_srvr.c",2225)
                           ;
   EVP_PKEY_CTX_free(pctx);
   goto f_err;
  }
 ...
 {
  ERR_put_error(20,(136),((4|64)),"../ssl/s3_srvr.c",2235)
                           ;
  al = 43;
  goto f_err;
 }
...
truncated:
  al = 50;
  ERR_put_error(20,(136),(115),"../ssl/s3_srvr.c",2245);
f_err:
  ssl3_send_alert(s, 2, al);
 }
end:
...
# 2268 "../ssl/s3_srvr.c" 3 4
                     ((void *)0)
# 2268 "../ssl/s3_srvr.c"
                         ;

 n = s->method->ssl_get_message(s, (0x180|0x2000), (0x181|0x2000),
 ...
 if (s->s3->tmp.message_type == 16) {
  if ((s->verify_mode & 0x01) &&
      (s->verify_mode & 0x02)) {
       ERR_put_error(20,(137),(199),"../ssl/s3_srvr.c",2280)
                                               ;
   al = 40;
   goto f_err;
  }
  ...
  if (s->s3->tmp.cert_request) {
   ERR_put_error(20,(137),(233),"../ssl/s3_srvr.c",2291)
 ...
 if (s->s3->tmp.message_type != 11) {
  al = 10;
  ERR_put_error(20,(137),(262),"../ssl/s3_srvr.c",2302)
                               ;
  goto f_err;
 }
...
# 2311 "../ssl/s3_srvr.c" 3 4
                                 ((void *)0)
# 2311 "../ssl/s3_srvr.c"
                                     ) {
  ERR_put_error(20,(137),((1|64)),"../ssl/s3_srvr.c",2313)
                           ;
  goto err;
 }
 ...
 while (CBS_len(&client_certs) > 0) {
  ...
  if (!CBS_get_u24_length_prefixed(&client_certs, &cert)) {
   al = 50;
   ERR_put_error(20,(137),(135),"../ssl/s3_srvr.c",2327)
                                  ;
   goto f_err;
  }
  ...
  q = CBS_data(&cert);
  x = d2i_X509(
# 2332 "../ssl/s3_srvr.c" 3 4
              ((void *)0)
# 2332 "../ssl/s3_srvr.c"
                  , &q, CBS_len(&cert));
  if (x == 
# 2333 "../ssl/s3_srvr.c" 3 4
          ((void *)0)
# 2333 "../ssl/s3_srvr.c"
              ) {
   ERR_put_error(20,(137),(13),"../ssl/s3_srvr.c",2335)
                      ;
   goto err;
  }
  if (q != CBS_data(&cert) + CBS_len(&cert)) {
   al = 50;
   ERR_put_error(20,(137),(135),"../ssl/s3_srvr.c",2341)
                                  ;
   goto f_err;
  }
  if (!sk_push(((_STACK*) (1 ? (sk) : (struct stack_st_X509*)0)), ((void*) (1 ? (x) : (X509*)0)))) {
   ERR_put_error(20,(137),((1|64)),"../ssl/s3_srvr.c",2346)
                            ;
   goto err;
  }
  x = 
# 2349 "../ssl/s3_srvr.c" 3 4
     ((void *)0)
# 2349 "../ssl/s3_srvr.c"
         ;
 }

 if (sk_num(((_STACK*) (1 ? (sk) : (struct stack_st_X509*)0))) <= 0) {
  ...
  if ((s->verify_mode & 0x01) &&
      (s->verify_mode & 0x02)) {
   ERR_put_error(20,(137),(199),"../ssl/s3_srvr.c",2360)
                                               ;
   al = 40;
   goto f_err;
  }
  ...
  if (i <= 0) {
   ...
   ERR_put_error(20,(137),(178),"../ssl/s3_srvr.c",2374)
                                     ;
   goto f_err;
  }
 }
 ...
 s->session->peer = (X509 *)sk_shift(((_STACK*) (1 ? (sk) : (struct stack_st_X509*)0)));
...
# 2387 "../ssl/s3_srvr.c" 3 4
                             ((void *)0)
# 2387 "../ssl/s3_srvr.c"
                                 ) {
  s->session->sess_cert = ssl_sess_cert_new();
  if (s->session->sess_cert == 
# 2389 "../ssl/s3_srvr.c" 3 4
                              ((void *)0)
# 2389 "../ssl/s3_srvr.c"
                                  ) {
   ERR_put_error(20,(137),((1|64)),"../ssl/s3_srvr.c",2391)
                            ;
   goto err;
  }
 }
 if (s->session->sess_cert->cert_chain != 
# 2395 "../ssl/s3_srvr.c" 3 4
                                         ((void *)0)
# 2395 "../ssl/s3_srvr.c"
                                             )
  sk_pop_free(((_STACK*) (1 ? (s->session->sess_cert->cert_chain) : (struct stack_st_X509*)0)), ((void (*)(void *)) ((1 ? (X509_free) : (void (*)(X509 *))0))));
...
truncated:
  al = 50;
  ERR_put_error(20,(137),(115),"../ssl/s3_srvr.c",2411)
                              ;
f_err:
  ssl3_send_alert(s, 2, al);
 }
...
ssl3_send_server_certificate(SSL *s)
{
 ...
 if (s->state == (0x140|0x2000)) {
  x = ssl_get_server_send_cert(s);
  if (x == 
# 2430 "../ssl/s3_srvr.c" 3 4
          ((void *)0)
# 2430 "../ssl/s3_srvr.c"
              ) {
   ERR_put_error(20,(154),((4|64)),"../ssl/s3_srvr.c",2432)
                            ;
   return (0);
  }

  l = ssl3_output_cert_chain(s, x);
  s->state = (0x141|0x2000);
  s->init_num = (int)l;
  s->init_off = 0;
 }
...
ssl3_send_newsession_ticket(SSL *s)
{
 if (s->state == (0x1F0|0x2000)) {
  ...
  slen_full = i2d_SSL_SESSION(s->session, 
# 2463 "../ssl/s3_srvr.c" 3 4
                                         ((void *)0)
# 2463 "../ssl/s3_srvr.c"
                                             );
...
# 2481 "../ssl/s3_srvr.c" 3 4
                        ((void *)0)
# 2481 "../ssl/s3_srvr.c"
                            , &const_p, slen_full);
  if (sess == 
# 2482 "../ssl/s3_srvr.c" 3 4
             ((void *)0)
# 2482 "../ssl/s3_srvr.c"
                 ) {
   free(senc);
  ...
  slen = i2d_SSL_SESSION(sess, 
# 2490 "../ssl/s3_srvr.c" 3 4
                              ((void *)0)
# 2490 "../ssl/s3_srvr.c"
                                  );
  if (slen > slen_full) {
...
# 2508 "../ssl/s3_srvr.c"
  ...
  d = p = ssl3_handshake_msg_start(s, 4);
...
# 2537 "../ssl/s3_srvr.c"
  ...
  (*((p)++)=(unsigned char)(((s->hit ? 0 : s->session->timeout)>>24)&0xff), *((p)++)=(unsigned char)(((s->hit ? 0 : s->session->timeout)>>16)&0xff), *((p)++)=(unsigned char)(((s->hit ? 0 : s->session->timeout)>> 8)&0xff), *((p)++)=(unsigned char)(((s->hit ? 0 : s->session->timeout) )&0xff));
  ...
  p = d + 4;
  ((p[0]=(unsigned char)(((len - 6)>> 8)&0xff), p[1]=(unsigned char)(((len - 6) )&0xff)),p+=2);

  ssl3_handshake_msg_finish(s, len);

  s->state = (0x1F1|0x2000);
...
ssl3_send_cert_status(SSL *s)
{
 ...
 if (s->state == (0x200|0x2000)) {
  ...
  if (!BUF_MEM_grow(s->init_buf, 4 + 4 +
      s->tlsext_ocsp_resplen))
   return (-1);

  p = ssl3_handshake_msg_start(s, 22);

  *(p++) = s->tlsext_status_type;
  ((p[0]=(unsigned char)(((s->tlsext_ocsp_resplen)>>16)&0xff), p[1]=(unsigned char)(((s->tlsext_ocsp_resplen)>> 8)&0xff), p[2]=(unsigned char)(((s->tlsext_ocsp_resplen) )&0xff)),p+=3);
  memcpy(p, s->tlsext_ocsp_resp, s->tlsext_ocsp_resplen);

  ssl3_handshake_msg_finish(s, s->tlsext_ocsp_resplen + 4);

  s->state = (0x201|0x2000);
 }
...
ssl3_get_next_proto(SSL *s)
{
 ...
 if (!s->s3->next_proto_neg_seen) {
  ERR_put_error(20,(306),(356),"../ssl/s3_srvr.c",2638)
                                             ;
  return (-1);
 }


 n = s->method->ssl_get_message(s, (0x210|0x2000),
     (0x211|0x2000), 67, 514, &ok);
 if (!ok)
  return ((int)n);
 ...
 if (!s->s3->change_cipher_spec) {
  ERR_put_error(20,(306),(355),"../ssl/s3_srvr.c",2655)
                                        ;
  return (-1);
 }
...
# 2681 "../ssl/s3_srvr.c"
 ...
 if (!CBS_stow(&proto, &s->next_proto_negotiated, &len)) {
  ERR_put_error(20,(306),((1|64)),"../ssl/s3_srvr.c",2686)
                           ;
  return (0);
 }
