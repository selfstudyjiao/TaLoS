...
# 191 "asn1/p5_pbev2.c"
 ...
 if (alg_nid == 0) {
  ERR_put_error(13,(167),(108),"asn1/p5_pbev2.c",197)
                                         ;
  goto err;
 }
...
# 223 "asn1/p5_pbev2.c"
 ...
 if (EVP_CIPHER_param_to_asn1(&ctx, scheme->parameter) < 0) {
  ERR_put_error(13,(167),(114),"asn1/p5_pbev2.c",227)
                                     ;
 ...
 if ((prf_nid == -1) &&
     EVP_CIPHER_CTX_ctrl(&ctx, 0x7, 0, &prf_nid) <= 0) {
  ERR_clear_error();
  prf_nid = 163;
 }
 EVP_CIPHER_CTX_cleanup(&ctx);
 ...
 ret->algorithm = OBJ_nid2obj(161);



 if (!ASN1_item_pack(pbe2, (&(PBE2PARAM_it)),
  &ret->parameter->value.sequence)) goto merr;
 ret->parameter->type = 16;

 PBE2PARAM_free(pbe2);
 pbe2 = 
# 273 "asn1/p5_pbev2.c" 3 4
       ((void *)0)
# 273 "asn1/p5_pbev2.c"
           ;
...
merr:
 ERR_put_error(13,(167),((1|64)),"asn1/p5_pbev2.c",278);
...
PKCS5_pbe2_set(const EVP_CIPHER *cipher, int iter, unsigned char *salt,
    int saltlen)
{
 return PKCS5_pbe2_set_iv(cipher, iter, salt, saltlen, 
# 293 "asn1/p5_pbev2.c" 3 4
                                                      ((void *)0)
# 293 "asn1/p5_pbev2.c"
                                                          , -1);
}
...
{
 X509_ALGOR *keyfunc = 
# 300 "asn1/p5_pbev2.c" 3 4
                      ((void *)0)
# 300 "asn1/p5_pbev2.c"
                          ;
 PBKDF2PARAM *kdf = 
# 301 "asn1/p5_pbev2.c" 3 4
                   ((void *)0)
# 301 "asn1/p5_pbev2.c"
                       ;
 ASN1_OCTET_STRING *osalt = 
# 302 "asn1/p5_pbev2.c" 3 4
                           ((void *)0)
# 302 "asn1/p5_pbev2.c"
                               ;
 ...
 if (prf_nid > 0 && prf_nid != 163) {
  kdf->prf = X509_ALGOR_new();
  if (!kdf->prf)
   goto merr;
  X509_ALGOR_set0(kdf->prf, OBJ_nid2obj(prf_nid),
  5, 
# 345 "asn1/p5_pbev2.c" 3 4
              ((void *)0)
# 345 "asn1/p5_pbev2.c"
                  );
 }
 ...
 keyfunc->algorithm = OBJ_nid2obj(69);
 ...
 if (!ASN1_item_pack(kdf, (&(PBKDF2PARAM_it)),
  ...
  goto merr;
 keyfunc->parameter->type = 16;

 PBKDF2PARAM_free(kdf);
 return keyfunc;

merr:
 ERR_put_error(13,(219),((1|64)),"asn1/p5_pbev2.c",370);
 PBKDF2PARAM_free(kdf);
 X509_ALGOR_free(keyfunc);
 return 
# 373 "asn1/p5_pbev2.c" 3 4
       ((void *)0)
# 373 "asn1/p5_pbev2.c"
           ;
}
