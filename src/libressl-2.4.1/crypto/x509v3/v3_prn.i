...
void
X509V3_EXT_val_prn(BIO *out, struct stack_st_CONF_VALUE *val, int indent, int ml)
{
 int i;
 CONF_VALUE *nval;
 ...
 if (!val)
  return;
 if (!ml || !sk_num(((_STACK*) (1 ? (val) : (struct stack_st_CONF_VALUE*)0)))) {
  BIO_printf(out, "%*s", indent, "");
  if (!sk_num(((_STACK*) (1 ? (val) : (struct stack_st_CONF_VALUE*)0))))
   BIO_puts(out, "<EMPTY>\n");
 }
 for (i = 0; i < sk_num(((_STACK*) (1 ? (val) : (struct stack_st_CONF_VALUE*)0))); i++) {
  if (ml)
   BIO_printf(out, "%*s", indent, "");
  else if (i > 0) BIO_printf(out, ", ");
   nval = ((CONF_VALUE *)sk_value(((_STACK*) (1 ? (val) : (struct stack_st_CONF_VALUE*)0)), (i)));
  if (!nval->name)
...
{
 void *ext_str = 
# 106 "x509v3/v3_prn.c" 3 4
                ((void *)0)
# 106 "x509v3/v3_prn.c"
                    ;
 char *value = 
# 107 "x509v3/v3_prn.c" 3 4
              ((void *)0)
# 107 "x509v3/v3_prn.c"
                  ;
 const unsigned char *p;
...
int
X509V3_extensions_print(BIO *bp, char *title, struct stack_st_X509_EXTENSION *exts,
    unsigned long flag, int indent)
{
 ...
 for (i = 0; i < sk_num(((_STACK*) (1 ? (exts) : (struct stack_st_X509_EXTENSION*)0))); i++) {
  ASN1_OBJECT *obj;
  X509_EXTENSION *ex;
  ex = ((X509_EXTENSION *)sk_value(((_STACK*) (1 ? (exts) : (struct stack_st_X509_EXTENSION*)0)), (i)));
