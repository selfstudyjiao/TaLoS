...
static DSO_METHOD *default_DSO_meth = 
# 72 "dso/dso_lib.c" 3 4
                                     ((void *)0)
# 72 "dso/dso_lib.c"
                                         ;
...
DSO_new(void)
{
 return (DSO_new_method(
# 77 "dso/dso_lib.c" 3 4
                       ((void *)0)
# 77 "dso/dso_lib.c"
                           ));
}
...
# 113 "dso/dso_lib.c"
 ...
 if (ret == 
# 119 "dso/dso_lib.c" 3 4
           ((void *)0)
# 119 "dso/dso_lib.c"
               ) {
  ERR_put_error(37,(113),((1|64)),"dso/dso_lib.c",120);
  return (
# 121 "dso/dso_lib.c" 3 4
         ((void *)0)
# 121 "dso/dso_lib.c"
             );
 }
 ret->meth_data = ((struct stack_st_void *)sk_new_null());
 if (ret->meth_data == 
# 124 "dso/dso_lib.c" 3 4
                      ((void *)0)
# 124 "dso/dso_lib.c"
                          ) {

  ERR_put_error(37,(113),((1|64)),"dso/dso_lib.c",126);
  free(ret);
  return (
# 128 "dso/dso_lib.c" 3 4
         ((void *)0)
# 128 "dso/dso_lib.c"
             );
 }
 if (meth == 
# 130 "dso/dso_lib.c" 3 4
            ((void *)0)
# 130 "dso/dso_lib.c"
                )
 ...
 ret->references = 1;
 if ((ret->meth->init != 
# 135 "dso/dso_lib.c" 3 4
                        ((void *)0)
# 135 "dso/dso_lib.c"
                            ) && !ret->meth->init(ret)) {
  free(ret);
  ret = 
# 137 "dso/dso_lib.c" 3 4
       ((void *)0)
# 137 "dso/dso_lib.c"
           ;
 }
...
DSO_free(DSO *dso)
{
 ...
 if (dso == 
# 147 "dso/dso_lib.c" 3 4
           ((void *)0)
# 147 "dso/dso_lib.c"
               ) {
  ERR_put_error(37,(111),((3|64)),"dso/dso_lib.c",148);
  return (0);
 }

 i = CRYPTO_add_lock(&dso->references,-1,28,"dso/dso_lib.c",152);
 if (i > 0)
  return (1);

 if ((dso->meth->dso_unload != 
# 156 "dso/dso_lib.c" 3 4
                              ((void *)0)
# 156 "dso/dso_lib.c"
                                  ) && !dso->meth->dso_unload(dso)) {
  ERR_put_error(37,(111),(107),"dso/dso_lib.c",157);
  return (0);
 }

 if ((dso->meth->finish != 
# 161 "dso/dso_lib.c" 3 4
                          ((void *)0)
# 161 "dso/dso_lib.c"
                              ) && !dso->meth->finish(dso)) {
  ERR_put_error(37,(111),(102),"dso/dso_lib.c",162);
  return (0);
 }

 sk_free(((_STACK*) (1 ? (dso->meth_data) : (struct stack_st_void*)0)));
 free(dso->filename);
...
{
 if (dso == 
# 183 "dso/dso_lib.c" 3 4
           ((void *)0)
# 183 "dso/dso_lib.c"
               ) {
  ERR_put_error(37,(114),((3|64)),"dso/dso_lib.c",184);
  return (0);
 }

 CRYPTO_add_lock(&dso->references,1,28,"dso/dso_lib.c",188);
 return (1);
}
...
DSO_load(DSO *dso, const char *filename, DSO_METHOD *meth, int flags)
{
 ...
 if (dso == 
# 198 "dso/dso_lib.c" 3 4
           ((void *)0)
# 198 "dso/dso_lib.c"
               ) {
  ret = DSO_new_method(meth);
  if (ret == 
# 200 "dso/dso_lib.c" 3 4
            ((void *)0)
# 200 "dso/dso_lib.c"
                ) {
   ERR_put_error(37,(112),((1|64)),"dso/dso_lib.c",201);
   goto err;
  }
  allocated = 1;

  if (DSO_ctrl(ret, 2, flags, 
# 206 "dso/dso_lib.c" 3 4
                                              ((void *)0)
# 206 "dso/dso_lib.c"
                                                  ) < 0) {
   ERR_put_error(37,(112),(100),"dso/dso_lib.c",207);
   goto err;
  }
 } else
  ret = dso;
 ...
 if (ret->filename != 
# 213 "dso/dso_lib.c" 3 4
                     ((void *)0)
# 213 "dso/dso_lib.c"
                         ) {
  ERR_put_error(37,(112),(110),"dso/dso_lib.c",214);
  goto err;
 }


 if (filename != 
# 219 "dso/dso_lib.c" 3 4
                ((void *)0)
# 219 "dso/dso_lib.c"
                    )
  if (!DSO_set_filename(ret, filename)) {
  ERR_put_error(37,(112),(112),"dso/dso_lib.c",221);
  goto err;
 }
 filename = ret->filename;
 if (filename == 
# 225 "dso/dso_lib.c" 3 4
                ((void *)0)
# 225 "dso/dso_lib.c"
                    ) {
  ERR_put_error(37,(112),(111),"dso/dso_lib.c",226);
  goto err;
 }
 if (ret->meth->dso_load == 
# 229 "dso/dso_lib.c" 3 4
                           ((void *)0)
# 229 "dso/dso_lib.c"
                               ) {
  ERR_put_error(37,(112),(108),"dso/dso_lib.c",230);
  goto err;
 }
 if (!ret->meth->dso_load(ret)) {
  ERR_put_error(37,(112),(103),"dso/dso_lib.c",234);
  goto err;
 }
...
{
 void *ret = 
# 249 "dso/dso_lib.c" 3 4
            ((void *)0)
# 249 "dso/dso_lib.c"
                ;

 if ((dso == 
# 251 "dso/dso_lib.c" 3 4
            ((void *)0)
# 251 "dso/dso_lib.c"
                ) || (symname == 
# 251 "dso/dso_lib.c" 3 4
...
# 251 "dso/dso_lib.c"
  ...
  ERR_put_error(37,(109),((3|64)),"dso/dso_lib.c",252);
  return (
# 253 "dso/dso_lib.c" 3 4
         ((void *)0)
# 253 "dso/dso_lib.c"
             );
 }
 if (dso->meth->dso_bind_var == 
# 255 "dso/dso_lib.c" 3 4
                               ((void *)0)
# 255 "dso/dso_lib.c"
                                   ) {
  ERR_put_error(37,(109),(108),"dso/dso_lib.c",256);
  return (
# 257 "dso/dso_lib.c" 3 4
         ((void *)0)
# 257 "dso/dso_lib.c"
             );
 }
 if ((ret = dso->meth->dso_bind_var(dso, symname)) == 
# 259 "dso/dso_lib.c" 3 4
                                                     ((void *)0)
# 259 "dso/dso_lib.c"
                                                         ) {
  ERR_put_error(37,(109),(106),"dso/dso_lib.c",260);
  return (
# 261 "dso/dso_lib.c" 3 4
         ((void *)0)
# 261 "dso/dso_lib.c"
             );
 }
...
{
 DSO_FUNC_TYPE ret = 
# 270 "dso/dso_lib.c" 3 4
                    ((void *)0)
# 270 "dso/dso_lib.c"
                        ;

 if ((dso == 
# 272 "dso/dso_lib.c" 3 4
            ((void *)0)
# 272 "dso/dso_lib.c"
                ) || (symname == 
# 272 "dso/dso_lib.c" 3 4
...
# 272 "dso/dso_lib.c"
  ...
  ERR_put_error(37,(108),((3|64)),"dso/dso_lib.c",273);
  return (
# 274 "dso/dso_lib.c" 3 4
         ((void *)0)
# 274 "dso/dso_lib.c"
             );
 }
 if (dso->meth->dso_bind_func == 
# 276 "dso/dso_lib.c" 3 4
                                ((void *)0)
# 276 "dso/dso_lib.c"
                                    ) {
  ERR_put_error(37,(108),(108),"dso/dso_lib.c",277);
  return (
# 278 "dso/dso_lib.c" 3 4
         ((void *)0)
# 278 "dso/dso_lib.c"
             );
 }
 if ((ret = dso->meth->dso_bind_func(dso, symname)) == 
# 280 "dso/dso_lib.c" 3 4
                                                      ((void *)0)
# 280 "dso/dso_lib.c"
                                                          ) {
  ERR_put_error(37,(108),(106),"dso/dso_lib.c",281);
  return (
# 282 "dso/dso_lib.c" 3 4
         ((void *)0)
# 282 "dso/dso_lib.c"
             );
 }
...
{
 if (dso == 
# 299 "dso/dso_lib.c" 3 4
           ((void *)0)
# 299 "dso/dso_lib.c"
               ) {
  ERR_put_error(37,(110),((3|64)),"dso/dso_lib.c",300);
  return (-1);
 }
...
# 318 "dso/dso_lib.c"
  ...
  ERR_put_error(37,(110),(108),"dso/dso_lib.c",319);
  return (-1);
 }
...
{
 if (dso == 
# 329 "dso/dso_lib.c" 3 4
           ((void *)0)
# 329 "dso/dso_lib.c"
               ) {
  ERR_put_error(37,(122),((3|64)),"dso/dso_lib.c",331)
                                  ;
  return (0);
 }
 if (oldcb)
...
{
 if (dso == 
# 343 "dso/dso_lib.c" 3 4
           ((void *)0)
# 343 "dso/dso_lib.c"
               ) {
  ERR_put_error(37,(127),((3|64)),"dso/dso_lib.c",344);
  return (
# 345 "dso/dso_lib.c" 3 4
         ((void *)0)
# 345 "dso/dso_lib.c"
             );
 }
...
# 355 "dso/dso_lib.c"
  ...
  ERR_put_error(37,(129),((3|64)),"dso/dso_lib.c",356);
  return (0);
 }
 if (dso->loaded_filename) {
  ERR_put_error(37,(129),(110),"dso/dso_lib.c",360);
  return (0);
 }

 copied = my_strdup(filename);
 if (copied == 
# 365 "dso/dso_lib.c" 3 4
              ((void *)0)
# 365 "dso/dso_lib.c"
                  ) {
  ERR_put_error(37,(129),((1|64)),"dso/dso_lib.c",366);
  return (0);
 }
 free(dso->filename);
 dso->filename = copied;
...
{
 char *result = 
# 377 "dso/dso_lib.c" 3 4
               ((void *)0)
# 377 "dso/dso_lib.c"
                   ;

 if (dso == 
# 379 "dso/dso_lib.c" 3 4
           ((void *)0) 
# 379 "dso/dso_lib.c"
                || filespec1 == 
# 379 "dso/dso_lib.c" 3 4
...
# 379 "dso/dso_lib.c"
  ...
  ERR_put_error(37,(132),((3|64)),"dso/dso_lib.c",380);
  return (
# 381 "dso/dso_lib.c" 3 4
         ((void *)0)
# 381 "dso/dso_lib.c"
             );
 }
 if ((dso->flags & 0x01) == 0) {
  if (dso->merger != 
# 384 "dso/dso_lib.c" 3 4
                    ((void *)0)
# 384 "dso/dso_lib.c"
                        )
   result = dso->merger(dso, filespec1, filespec2);
  else if (dso->meth->dso_merger != 
# 386 "dso/dso_lib.c" 3 4
                                   ((void *)0)
# 386 "dso/dso_lib.c"
                                       )
...
{
 char *result = 
# 396 "dso/dso_lib.c" 3 4
               ((void *)0)
# 396 "dso/dso_lib.c"
                   ;

 if (dso == 
# 398 "dso/dso_lib.c" 3 4
           ((void *)0)
# 398 "dso/dso_lib.c"
               ) {
  ERR_put_error(37,(126),((3|64)),"dso/dso_lib.c",399);
  return (
# 400 "dso/dso_lib.c" 3 4
         ((void *)0)
# 400 "dso/dso_lib.c"
             );
 }
 if (filename == 
# 402 "dso/dso_lib.c" 3 4
                ((void *)0)
# 402 "dso/dso_lib.c"
                    )
  filename = dso->filename;
 if (filename == 
# 404 "dso/dso_lib.c" 3 4
                ((void *)0)
# 404 "dso/dso_lib.c"
                    ) {
  ERR_put_error(37,(126),(111),"dso/dso_lib.c",405);
  return (
# 406 "dso/dso_lib.c" 3 4
         ((void *)0)
# 406 "dso/dso_lib.c"
             );
 }
 if ((dso->flags & 0x01) == 0) {
  if (dso->name_converter != 
# 409 "dso/dso_lib.c" 3 4
                            ((void *)0)
# 409 "dso/dso_lib.c"
                                )
   result = dso->name_converter(dso, filename);
  else if (dso->meth->dso_name_converter != 
# 411 "dso/dso_lib.c" 3 4
                                           ((void *)0)
# 411 "dso/dso_lib.c"
                                               )
 ...
 if (result == 
# 414 "dso/dso_lib.c" 3 4
              ((void *)0)
# 414 "dso/dso_lib.c"
                  ) {
  result = my_strdup(filename);
  if (result == 
# 416 "dso/dso_lib.c" 3 4
               ((void *)0)
# 416 "dso/dso_lib.c"
                   ) {
   ERR_put_error(37,(126),((1|64)),"dso/dso_lib.c",418)
                            ;
   return (
# 419 "dso/dso_lib.c" 3 4
          ((void *)0)
# 419 "dso/dso_lib.c"
              );
  }
...
{
 if (dso == 
# 428 "dso/dso_lib.c" 3 4
           ((void *)0)
# 428 "dso/dso_lib.c"
               ) {
  ERR_put_error(37,(128),((3|64)),"dso/dso_lib.c",430)
                                  ;
  return (
# 431 "dso/dso_lib.c" 3 4
         ((void *)0)
# 431 "dso/dso_lib.c"
             );
 }
...
DSO_pathbyaddr(void *addr, char *path, int sz)
{
 ...
 if (meth == 
# 440 "dso/dso_lib.c" 3 4
            ((void *)0)
# 440 "dso/dso_lib.c"
                )
  meth = DSO_METHOD_openssl();
 if (meth->pathbyaddr == 
# 442 "dso/dso_lib.c" 3 4
                        ((void *)0)
# 442 "dso/dso_lib.c"
                            ) {
  ERR_put_error(37,(140),(108),"dso/dso_lib.c",443);
  return -1;
 }
...
DSO_global_lookup(const char *name)
{
 DSO_METHOD *meth = default_DSO_meth;
 if (meth == 
# 453 "dso/dso_lib.c" 3 4
            ((void *)0)
# 453 "dso/dso_lib.c"
                )
  meth = DSO_METHOD_openssl();
 if (meth->globallookup == 
# 455 "dso/dso_lib.c" 3 4
                          ((void *)0)
# 455 "dso/dso_lib.c"
                              ) {
  ERR_put_error(37,(139),(108),"dso/dso_lib.c",456);
  return 
# 457 "dso/dso_lib.c" 3 4
        ((void *)0)
# 457 "dso/dso_lib.c"
            ;
 }
