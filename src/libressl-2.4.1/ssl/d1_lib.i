...
dtls1_new(SSL *s)
{
 ...
 if (!ssl3_new(s))
  return (0);
 if ((d1 = calloc(1, sizeof *d1)) == 
# 108 "../ssl/d1_lib.c" 3 4
                                    ((void *)0)
# 108 "../ssl/d1_lib.c"
                                        ) {
  ssl3_free(s);
...
{
 pitem *item = 
# 146 "../ssl/d1_lib.c" 3 4
              ((void *)0)
# 146 "../ssl/d1_lib.c"
                  ;
 hm_fragment *frag = 
# 147 "../ssl/d1_lib.c" 3 4
                    ((void *)0)
# 147 "../ssl/d1_lib.c"
                        ;
 DTLS1_RECORD_DATA *rdata;

 while ((item = pqueue_pop(s->d1->unprocessed_rcds.q)) != 
# 150 "../ssl/d1_lib.c" 3 4
                                                         ((void *)0)
# 150 "../ssl/d1_lib.c"
                                                             ) {
 ...
 while ((item = pqueue_pop(s->d1->processed_rcds.q)) != 
# 157 "../ssl/d1_lib.c" 3 4
                                                       ((void *)0)
# 157 "../ssl/d1_lib.c"
                                                           ) {
  rdata = (DTLS1_RECORD_DATA *) item->data;
 ...
 while ((item = pqueue_pop(s->d1->buffered_messages)) != 
# 164 "../ssl/d1_lib.c" 3 4
                                                        ((void *)0)
# 164 "../ssl/d1_lib.c"
                                                            ) {
 ...
 while ((item = pqueue_pop(s->d1->sent_messages)) != 
# 171 "../ssl/d1_lib.c" 3 4
                                                    ((void *)0)
# 171 "../ssl/d1_lib.c"
                                                        ) {
  frag = (hm_fragment *)item->data;
 ...
 while ((item = pqueue_pop(s->d1->buffered_app_data.q)) != 
# 178 "../ssl/d1_lib.c" 3 4
                                                          ((void *)0)
# 178 "../ssl/d1_lib.c"
                                                              ) {
  rdata = (DTLS1_RECORD_DATA *) item->data;
...
dtls1_ctrl(SSL *s, int cmd, long larg, void *parg)
{
 ...
 switch (cmd) {
 case 73:
  if (dtls1_get_timeout(s, (struct timeval*) parg) != 
# 256 "../ssl/d1_lib.c" 3 4
                                                     ((void *)0)
# 256 "../ssl/d1_lib.c"
                                                         ) {
   ret = 1;
...
dtls1_get_cipher(unsigned int u)
{
 ...
 if (ciph != 
# 286 "../ssl/d1_lib.c" 3 4
            ((void *)0)
# 286 "../ssl/d1_lib.c"
                ) {
  if (ciph->algorithm_enc == 0x00000004L)
   return 
# 288 "../ssl/d1_lib.c" 3 4
         ((void *)0)
# 288 "../ssl/d1_lib.c"
             ;
 }
...
dtls1_start_timer(SSL *s)
{
 ...
 gettimeofday(&(s->d1->next_timeout), 
# 304 "../ssl/d1_lib.c" 3 4
                                     ((void *)0)
# 304 "../ssl/d1_lib.c"
                                         );
...
# 403 "../ssl/d1_lib.c"
 ...
 if (s->d1->timeout.num_alerts > 12) {

  ERR_put_error(20,(316),(312),"../ssl/d1_lib.c",409);
  return -1;
 }
...
dtls1_handle_timeout(SSL *s)
{
 ...
 if (s->d1->timeout.read_timeouts > 2) {
...
dtls1_listen(SSL *s, struct sockaddr *client)
{
 ...
 SSL_ctrl((s),32,(0x00002000L),
# 446 "../ssl/d1_lib.c" 3 4
((void *)0)
# 446 "../ssl/d1_lib.c"
);
 s->d1->listen = 1;
 ...
 (void)(int)BIO_ctrl(SSL_get_rbio(s), 46, 0, (char *)client);
 return 1;
}
...
dtls1_build_sequence_number(unsigned char *dst, unsigned char *seq,
    unsigned short epoch)
{
 unsigned char dtlsseq[8];
 unsigned char *p;

 p = dtlsseq;
 ((p[0]=(unsigned char)(((epoch)>> 8)&0xff), p[1]=(unsigned char)(((epoch) )&0xff)),p+=2);
 memcpy(p, &seq[2], 8 - 2);
 memcpy(dst, dtlsseq, 8);
}
