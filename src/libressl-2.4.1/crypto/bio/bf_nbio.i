...
nbiof_read(BIO *b, char *out, int outl)
{
 ...
 if (out == 
# 136 "bio/bf_nbio.c" 3 4
           ((void *)0)
# 136 "bio/bf_nbio.c"
               )
  return (0);
 if (b->next_bio == 
# 138 "bio/bf_nbio.c" 3 4
                   ((void *)0)
# 138 "bio/bf_nbio.c"
                       )
  return (0);
...
nbiof_write(BIO *b, const char *in, int inl)
{
 ...
 if ((in == 
# 168 "bio/bf_nbio.c" 3 4
           ((void *)0)
# 168 "bio/bf_nbio.c"
               ) || (inl <= 0))
  return (0);
 if (b->next_bio == 
# 170 "bio/bf_nbio.c" 3 4
                   ((void *)0)
# 170 "bio/bf_nbio.c"
                       )
  return (0);
