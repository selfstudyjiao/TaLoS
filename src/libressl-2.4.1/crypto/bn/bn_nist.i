...
# 64 "bn/bn_nist.c" 2
# 73 "bn/bn_nist.c"
static const unsigned long _nist_p_192[][(192+64 -1)/64] = {
 {0xFFFFFFFFFFFFFFFFULL, 0xFFFFFFFFFFFFFFFEULL, 0xFFFFFFFFFFFFFFFFULL},
 {0xFFFFFFFFFFFFFFFEULL, 0xFFFFFFFFFFFFFFFDULL, 0xFFFFFFFFFFFFFFFFULL},
 {0xFFFFFFFFFFFFFFFDULL, 0xFFFFFFFFFFFFFFFCULL, 0xFFFFFFFFFFFFFFFFULL}
};
static const unsigned long _nist_p_192_sqr[] = {
 0x0000000000000001ULL, 0x0000000000000002ULL, 0x0000000000000001ULL,
 0xFFFFFFFFFFFFFFFEULL, 0xFFFFFFFFFFFFFFFDULL, 0xFFFFFFFFFFFFFFFFULL
};
static const unsigned long _nist_p_224[][(224+64 -1)/64] = {
 {
...
static const unsigned long _nist_p_224_sqr[] = {
 0x0000000000000001ULL, 0xFFFFFFFE00000000ULL,
 0xFFFFFFFFFFFFFFFFULL, 0x0000000200000000ULL,
 0x0000000000000000ULL, 0xFFFFFFFFFFFFFFFEULL,
 0xFFFFFFFFFFFFFFFFULL
};
static const unsigned long _nist_p_256[][(256+64 -1)/64] = {
 {
  0xFFFFFFFFFFFFFFFFULL, 0x00000000FFFFFFFFULL,
...
static const unsigned long _nist_p_256_sqr[] = {
 0x0000000000000001ULL, 0xFFFFFFFE00000000ULL,
 0xFFFFFFFFFFFFFFFFULL, 0x00000001FFFFFFFEULL,
 0x00000001FFFFFFFEULL, 0x00000001FFFFFFFEULL,
 0xFFFFFFFE00000001ULL, 0xFFFFFFFE00000002ULL
};
static const unsigned long _nist_p_384[][(384+64 -1)/64] = {
 {
...
static const unsigned long _nist_p_384_sqr[] = {
 0xFFFFFFFE00000001ULL, 0x0000000200000000ULL, 0xFFFFFFFE00000000ULL,
 0x0000000200000000ULL, 0x0000000000000001ULL, 0x0000000000000000ULL,
 0x00000001FFFFFFFEULL, 0xFFFFFFFE00000000ULL, 0xFFFFFFFFFFFFFFFDULL,
 0xFFFFFFFFFFFFFFFFULL, 0xFFFFFFFFFFFFFFFFULL, 0xFFFFFFFFFFFFFFFFULL
};
static const unsigned long _nist_p_521[] = {
 0xFFFFFFFFFFFFFFFFULL, 0xFFFFFFFFFFFFFFFFULL, 0xFFFFFFFFFFFFFFFFULL,
 0xFFFFFFFFFFFFFFFFULL, 0xFFFFFFFFFFFFFFFFULL, 0xFFFFFFFFFFFFFFFFULL,
 0xFFFFFFFFFFFFFFFFULL, 0xFFFFFFFFFFFFFFFFULL, 0x00000000000001FFULL
};
static const unsigned long _nist_p_521_sqr[] = {
...
static void
nist_cp_bn_0(unsigned long *dst, const unsigned long *src, int top, int max)
{
 int i;
...
static void nist_cp_bn(unsigned long *dst, const unsigned long *src, int top)
{
 int i;
...
BN_nist_mod_192(BIGNUM *r, const BIGNUM *a, const BIGNUM *field, BN_CTX *ctx)
{
 int top = a->top, i;
 int carry;
 unsigned long *r_d, *a_d = a->d;
 union {
  unsigned long bn[(192+64 -1)/64];
  unsigned int ui[(192+64 -1)/64 *
      sizeof(unsigned long) / sizeof(unsigned int)];
 } buf;
 unsigned long c_d[(192+64 -1)/64], *res;
 uintptr_t mask;
 static const BIGNUM _bignum_nist_p_192_sqr = {
  (unsigned long *)_nist_p_192_sqr,
 ...
 if (((a)->neg != 0) || BN_ucmp(a, &_bignum_nist_p_192_sqr) >= 0)
...
# 453 "bn/bn_nist.c" 3 4
                                          ((void *)0)
# 453 "bn/bn_nist.c"
                                              );

 if (r != a) {
  if (!((((192+64 -1)/64) <= (r)->dmax)?(r):bn_expand2((r),((192+64 -1)/64))))
   return 0;
  r_d = r->d;
  nist_cp_bn(r_d, a_d, (192+64 -1)/64);
 } else
  r_d = a_d;

 nist_cp_bn_0(buf.bn, a_d + (192+64 -1)/64, top - (192+64 -1)/64,
     (192+64 -1)/64);
...
# 523 "bn/bn_nist.c"
 ...
 res = c_d;
 res = (unsigned long *)(((uintptr_t)res & ~mask) | ((uintptr_t)r_d & mask));
 nist_cp_bn(r_d, res, (192+64 -1)/64);
 r->top = (192+64 -1)/64;
 { unsigned long *ftl; int tmp_top = (r)->top; if (tmp_top > 0) { for (ftl= &((r)->d[tmp_top-1]); tmp_top > 0; tmp_top--) if (*(ftl--)) break; (r)->top = tmp_top; } ; };

 return 1;
}

typedef unsigned long (*bn_addsub_f)(unsigned long *, const unsigned long *,
...
BN_nist_mod_224(BIGNUM *r, const BIGNUM *a, const BIGNUM *field, BN_CTX *ctx)
{
 ...
 unsigned long *r_d, *a_d = a->d;
 union {
  unsigned long bn[(224+64 -1)/64];
  unsigned int ui[(224+64 -1)/64 *
      sizeof(unsigned long) / sizeof(unsigned int)];
 } buf;
 unsigned long c_d[(224+64 -1)/64], *res;
 uintptr_t mask;
 union {
  bn_addsub_f f;
  uintptr_t p;
 ...
 if (((a)->neg != 0) || BN_ucmp(a, &_bignum_nist_p_224_sqr) >= 0)
  return BN_nnmod(r, a, field, ctx);
...
# 675 "bn/bn_nist.c"
 {
  ...
  carry = (int)bn_add_words(r_d, r_d, t_d, (224+64 -1)/64);
 ...
 if (carry > 0) {
  ...
  carry = (int)(~(r_d[(224+64 -1)/64 - 1] >> 32)) & 1;
 ...
 mask = 0 - (uintptr_t)(*u.f)(c_d, r_d, _nist_p_224[0], (224+64 -1)/64);
 mask &= 0 - (uintptr_t)carry;
 res = c_d;
 res = (unsigned long *)(((uintptr_t)res & ~mask) | ((uintptr_t)r_d & mask));
 nist_cp_bn(r_d, res, (224+64 -1)/64);
 r->top = (224+64 -1)/64;
 { unsigned long *ftl; int tmp_top = (r)->top; if (tmp_top > 0) { for (ftl= &((r)->d[tmp_top-1]); tmp_top > 0; tmp_top--) if (*(ftl--)) break; (r)->top = tmp_top; } ; };
...
BN_nist_mod_256(BIGNUM *r, const BIGNUM *a, const BIGNUM *field, BN_CTX *ctx)
{
 int i, top = a->top;
 int carry = 0;
 unsigned long *a_d = a->d, *r_d;
 union {
  unsigned long bn[(256+64 -1)/64];
  unsigned int ui[(256+64 -1)/64 *
      sizeof(unsigned long) / sizeof(unsigned int)];
 } buf;
 unsigned long c_d[(256+64 -1)/64], *res;
 uintptr_t mask;
 union {
  bn_addsub_f f;
  uintptr_t p;
 ...
 if (((a)->neg != 0) || BN_ucmp(a, &_bignum_nist_p_256_sqr) >= 0)
  return BN_nnmod(r, a, field, ctx);
 ...
 if (i == 0) {
  ...
  return (r == a) ? 1 : (BN_copy(r, a) != 
# 773 "bn/bn_nist.c" 3 4
                                         ((void *)0)
# 773 "bn/bn_nist.c"
                                             );

 if (r != a) {
  if (!((((256+64 -1)/64) <= (r)->dmax)?(r):bn_expand2((r),((256+64 -1)/64))))
   return 0;
  r_d = r->d;
  nist_cp_bn(r_d, a_d, (256+64 -1)/64);
 } else
  r_d = a_d;

 nist_cp_bn_0(buf.bn, a_d + (256+64 -1)/64,
     top - (256+64 -1)/64, (256+64 -1)/64);
...
# 925 "bn/bn_nist.c"
 ...
 mask = 0 - (uintptr_t)(*u.f)(c_d, r_d, _nist_p_256[0], (256+64 -1)/64);
 mask &= 0 - (uintptr_t)carry;
 res = c_d;
 res = (unsigned long *)(((uintptr_t)res & ~mask) | ((uintptr_t)r_d & mask));
 nist_cp_bn(r_d, res, (256+64 -1)/64);
 r->top = (256+64 -1)/64;
 { unsigned long *ftl; int tmp_top = (r)->top; if (tmp_top > 0) { for (ftl= &((r)->d[tmp_top-1]); tmp_top > 0; tmp_top--) if (*(ftl--)) break; (r)->top = tmp_top; } ; };
...
BN_nist_mod_384(BIGNUM *r, const BIGNUM *a, const BIGNUM *field, BN_CTX *ctx)
{
 ...
 unsigned long *r_d, *a_d = a->d;
 union {
  unsigned long bn[(384+64 -1)/64];
  unsigned int ui[(384+64 -1)/64 *
      sizeof(unsigned long) / sizeof(unsigned int)];
 } buf;
 unsigned long c_d[(384+64 -1)/64], *res;
 uintptr_t mask;
 union {
  bn_addsub_f f;
  uintptr_t p;
 ...
 if (((a)->neg != 0) || BN_ucmp(a, &_bignum_nist_p_384_sqr) >= 0)
  return BN_nnmod(r, a, field, ctx);
 ...
 if (i == 0) {
  ...
  return (r == a) ? 1 : (BN_copy(r, a) != 
# 1000 "bn/bn_nist.c" 3 4
                                         ((void *)0)
# 1000 "bn/bn_nist.c"
                                             );

 if (r != a) {
  if (!((((384+64 -1)/64) <= (r)->dmax)?(r):bn_expand2((r),((384+64 -1)/64))))
   return 0;
  r_d = r->d;
  nist_cp_bn(r_d, a_d, (384+64 -1)/64);
 } else
  r_d = a_d;

 nist_cp_bn_0(buf.bn, a_d + (384+64 -1)/64,
     top - (384+64 -1)/64, (384+64 -1)/64);
...
# 1185 "bn/bn_nist.c"
 ...
 mask = 0 - (uintptr_t)(*u.f)(c_d, r_d, _nist_p_384[0], (384+64 -1)/64);
 mask &= 0 - (uintptr_t)carry;
 res = c_d;
 res = (unsigned long *)(((uintptr_t)res & ~mask) | ((uintptr_t)r_d & mask));
 nist_cp_bn(r_d, res, (384+64 -1)/64);
 r->top = (384+64 -1)/64;
 { unsigned long *ftl; int tmp_top = (r)->top; if (tmp_top > 0) { for (ftl= &((r)->d[tmp_top-1]); tmp_top > 0; tmp_top--) if (*(ftl--)) break; (r)->top = tmp_top; } ; };
...
{
 int top = a->top, i;
 unsigned long *r_d, *a_d = a->d, t_d[(521+64 -1)/64], val, tmp, *res;
 uintptr_t mask;
 static const BIGNUM _bignum_nist_p_521_sqr = {
  (unsigned long *)_nist_p_521_sqr,
 ...
 if (((a)->neg != 0) || BN_ucmp(a, &_bignum_nist_p_521_sqr) >= 0)
  return BN_nnmod(r, a, field, ctx);
 ...
 if (i == 0) {
  ...
  return (r == a) ? 1 : (BN_copy(r, a) != 
# 1237 "bn/bn_nist.c" 3 4
                                         ((void *)0)
# 1237 "bn/bn_nist.c"
                                             );

 if (r != a) {
  if (!((((521+64 -1)/64) <= (r)->dmax)?(r):bn_expand2((r),((521+64 -1)/64))))
   return 0;
  r_d = r->d;
  nist_cp_bn(r_d, a_d, (521+64 -1)/64);
 } else
  r_d = a_d;


 nist_cp_bn_0(t_d, a_d + ((521+64 -1)/64 - 1),
     top - ((521+64 -1)/64 - 1), (521+64 -1)/64);

 for (val = t_d[0], i = 0; i < (521+64 -1)/64 - 1; i++) {
  tmp = val >> (521%64);
  val = t_d[i + 1];
  t_d[i] = (tmp | val << (64 -(521%64))) & (0xffffffffffffffffL);
 }
 t_d[i] = val >> (521%64);

 r_d[i] &= ((unsigned long)(0xffffffffffffffffL)>>(64 -(521%64)));

 bn_add_words(r_d, r_d, t_d, (521+64 -1)/64);
 mask = 0 - (uintptr_t)bn_sub_words(t_d, r_d, _nist_p_521,
     (521+64 -1)/64);
 res = t_d;
 res = (unsigned long *)(((uintptr_t)res & ~mask) | ((uintptr_t)r_d & mask));
 nist_cp_bn(r_d, res, (521+64 -1)/64);
 r->top = (521+64 -1)/64;
 { unsigned long *ftl; int tmp_top = (r)->top; if (tmp_top > 0) { for (ftl= &((r)->d[tmp_top-1]); tmp_top > 0; tmp_top--) if (*(ftl--)) break; (r)->top = tmp_top; } ; };
