...
# 65 "x509v3/v3_extku.c" 2

static void *v2i_EXTENDED_KEY_USAGE(const X509V3_EXT_METHOD *method,
    X509V3_CTX *ctx, struct stack_st_CONF_VALUE *nval);
static struct stack_st_CONF_VALUE *i2v_EXTENDED_KEY_USAGE(
    const X509V3_EXT_METHOD *method, void *eku, struct stack_st_CONF_VALUE *extlist);
...
const X509V3_EXT_METHOD v3_ext_ku = {
 ...
 .ext_new = 
# 75 "x509v3/v3_extku.c" 3 4
           ((void *)0)
# 75 "x509v3/v3_extku.c"
               ,
 .ext_free = 
# 76 "x509v3/v3_extku.c" 3 4
            ((void *)0)
# 76 "x509v3/v3_extku.c"
                ,
 .d2i = 
# 77 "x509v3/v3_extku.c" 3 4
       ((void *)0)
# 77 "x509v3/v3_extku.c"
           ,
 .i2d = 
# 78 "x509v3/v3_extku.c" 3 4
       ((void *)0)
# 78 "x509v3/v3_extku.c"
           ,
 .i2s = 
# 79 "x509v3/v3_extku.c" 3 4
       ((void *)0)
# 79 "x509v3/v3_extku.c"
           ,
 .s2i = 
# 80 "x509v3/v3_extku.c" 3 4
       ((void *)0)
# 80 "x509v3/v3_extku.c"
           ,
 .i2v = i2v_EXTENDED_KEY_USAGE,
 .v2i = v2i_EXTENDED_KEY_USAGE,
 .i2r = 
# 83 "x509v3/v3_extku.c" 3 4
       ((void *)0)
# 83 "x509v3/v3_extku.c"
           ,
 .r2i = 
# 84 "x509v3/v3_extku.c" 3 4
       ((void *)0)
# 84 "x509v3/v3_extku.c"
           ,
 .usr_data = 
# 85 "x509v3/v3_extku.c" 3 4
            ((void *)0)
# 85 "x509v3/v3_extku.c"
                ,
};
...
const X509V3_EXT_METHOD v3_ocsp_accresp = {
 ...
 .it = (&(EXTENDED_KEY_USAGE_it)),
 .ext_new = 
# 93 "x509v3/v3_extku.c" 3 4
           ((void *)0)
# 93 "x509v3/v3_extku.c"
               ,
 .ext_free = 
# 94 "x509v3/v3_extku.c" 3 4
            ((void *)0)
# 94 "x509v3/v3_extku.c"
                ,
 .d2i = 
# 95 "x509v3/v3_extku.c" 3 4
       ((void *)0)
# 95 "x509v3/v3_extku.c"
           ,
 .i2d = 
# 96 "x509v3/v3_extku.c" 3 4
       ((void *)0)
# 96 "x509v3/v3_extku.c"
           ,
 .i2s = 
# 97 "x509v3/v3_extku.c" 3 4
       ((void *)0)
# 97 "x509v3/v3_extku.c"
           ,
 .s2i = 
# 98 "x509v3/v3_extku.c" 3 4
       ((void *)0)
# 98 "x509v3/v3_extku.c"
           ,
 .i2v = i2v_EXTENDED_KEY_USAGE,
 .v2i = v2i_EXTENDED_KEY_USAGE,
 .i2r = 
# 101 "x509v3/v3_extku.c" 3 4
       ((void *)0)
# 101 "x509v3/v3_extku.c"
           ,
 .r2i = 
# 102 "x509v3/v3_extku.c" 3 4
       ((void *)0)
# 102 "x509v3/v3_extku.c"
           ,
 .usr_data = 
# 103 "x509v3/v3_extku.c" 3 4
            ((void *)0)
# 103 "x509v3/v3_extku.c"
                ,
};
...
const ASN1_ITEM EXTENDED_KEY_USAGE_it = {
 ...
 .tcount = 0,
 .funcs = 
# 119 "x509v3/v3_extku.c" 3 4
         ((void *)0)
# 119 "x509v3/v3_extku.c"
             ,
 .size = 0,
...
i2v_EXTENDED_KEY_USAGE(const X509V3_EXT_METHOD *method, void *a,
    struct stack_st_CONF_VALUE *ext_list)
{
 ...
 for (i = 0; i < sk_num(((_STACK*) (1 ? (eku) : (struct stack_st_ASN1_OBJECT*)0))); i++) {
  obj = ((ASN1_OBJECT *)sk_value(((_STACK*) (1 ? (eku) : (struct stack_st_ASN1_OBJECT*)0)), (i)));
  i2t_ASN1_OBJECT(obj_tmp, 80, obj);
  X509V3_add_value(
# 162 "x509v3/v3_extku.c" 3 4
                  ((void *)0)
# 162 "x509v3/v3_extku.c"
                      , obj_tmp, &ext_list);
 }
 return ext_list;
}
    ...
    struct stack_st_CONF_VALUE *nval)
{
 ...
 if (!(extku = ((struct stack_st_ASN1_OBJECT *)sk_new_null()))) {
  ERR_put_error(34,(103),((1|64)),"x509v3/v3_extku.c",179)
                           ;
  return 
# 180 "x509v3/v3_extku.c" 3 4
        ((void *)0)
# 180 "x509v3/v3_extku.c"
            ;
 }
 ...
 for (i = 0; i < sk_num(((_STACK*) (1 ? (nval) : (struct stack_st_CONF_VALUE*)0))); i++) {
  ...
  if (!(objtmp = OBJ_txt2obj(extval, 0))) {
   sk_pop_free(((_STACK*) (1 ? (extku) : (struct stack_st_ASN1_OBJECT*)0)), ((void (*)(void *)) ((1 ? (ASN1_OBJECT_free) : (void (*)(ASN1_OBJECT *))0))));
   ERR_put_error(34,(103),(110),"x509v3/v3_extku.c",192)
                                          ;
   ERR_asprintf_error_data( "section:%s,name:%s,value:%s", val->section, val->name, val->value);;
   return 
# 194 "x509v3/v3_extku.c" 3 4
         ((void *)0)
# 194 "x509v3/v3_extku.c"
             ;
  }
  if (sk_push(((_STACK*) (1 ? (extku) : (struct stack_st_ASN1_OBJECT*)0)), ((void*) (1 ? (objtmp) : (ASN1_OBJECT*)0))) == 0) {
   ASN1_OBJECT_free(objtmp);
   sk_pop_free(((_STACK*) (1 ? (extku) : (struct stack_st_ASN1_OBJECT*)0)), ((void (*)(void *)) ((1 ? (ASN1_OBJECT_free) : (void (*)(ASN1_OBJECT *))0))));
   ERR_put_error(34,(103),((1|64)),"x509v3/v3_extku.c",200)
                            ;
   return 
# 201 "x509v3/v3_extku.c" 3 4
         ((void *)0)
# 201 "x509v3/v3_extku.c"
             ;
  }
 }
 return extku;
