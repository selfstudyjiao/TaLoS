...
{
 if (X509at_add1_attr_by_NID(&bag->attrib, 157,
     4, name, namelen))
  return 1;
 else
  return 0;
...
PKCS8_add_keyusage(PKCS8_PRIV_KEY_INFO *p8, int usage)
{
 ...
 if (X509at_add1_attr_by_NID(&p8->attributes, 83,
     3, &us_val, 1))
  return 1;
 else
  return 0;
...
{
 if (X509at_add1_attr_by_NID(&bag->attrib, 156,
     (0x1000|1), (unsigned char *)name, namelen))
  return 1;
 else
  return 0;
}
...
{
 if (X509at_add1_attr_by_NID(&bag->attrib, 417,
     (0x1000|1), (unsigned char *)name, namelen))
  return 1;
 else
  return 0;
...
ASN1_TYPE *
PKCS12_get_attr_gen(struct stack_st_X509_ATTRIBUTE *attrs, int attr_nid)
{
 ...
 if (!attrs)
  return 
# 131 "pkcs12/p12_attr.c" 3 4
        ((void *)0)
# 131 "pkcs12/p12_attr.c"
            ;
 for (i = 0; i < sk_num(((_STACK*) (1 ? (attrs) : (struct stack_st_X509_ATTRIBUTE*)0))); i++) {
  attrib = ((X509_ATTRIBUTE *)sk_value(((_STACK*) (1 ? (attrs) : (struct stack_st_X509_ATTRIBUTE*)0)), (i)));
  if (OBJ_obj2nid (attrib->object) == attr_nid) {
   if (sk_num(((_STACK*) (1 ? (attrib->value.set) : (struct stack_st_ASN1_TYPE*)0))))
    return ((ASN1_TYPE *)sk_value(((_STACK*) (1 ? (attrib->value.set) : (struct stack_st_ASN1_TYPE*)0)), (0)));
   else
    return 
# 138 "pkcs12/p12_attr.c" 3 4
          ((void *)0)
# 138 "pkcs12/p12_attr.c"
              ;
  }
 }
 return 
# 141 "pkcs12/p12_attr.c" 3 4
       ((void *)0)
# 141 "pkcs12/p12_attr.c"
           ;
}
...
PKCS12_get_friendlyname(PKCS12_SAFEBAG *bag)
{
 ...
 if (!(atype = PKCS12_get_attr_gen(bag->attrib, 156)))
  return 
# 150 "pkcs12/p12_attr.c" 3 4
        ((void *)0)
# 150 "pkcs12/p12_attr.c"
            ;
 if (atype->type != 30)
  return 
# 152 "pkcs12/p12_attr.c" 3 4
        ((void *)0)
# 152 "pkcs12/p12_attr.c"
            ;
