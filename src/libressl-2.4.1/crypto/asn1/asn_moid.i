...
# 65 "asn1/asn_moid.c" 2
# 1 "../include/openssl/crypto.h" 1
# 119 "../include/openssl/crypto.h"
# 1 "../include/compat/stdlib.h" 1
# 120 "../include/openssl/crypto.h" 2
# 66 "asn1/asn_moid.c" 2
...
oid_module_init(CONF_IMODULE *md, const CONF *cnf)
{
 ...
 if (!(sktmp = NCONF_get_section(cnf, oid_section))) {
  ERR_put_error(13,(174),(172),"asn1/asn_moid.c",82);
  return 0;
 }
 for (i = 0; i < sk_num(((_STACK*) (1 ? (sktmp) : (struct stack_st_CONF_VALUE*)0))); i++) {
  oval = ((CONF_VALUE *)sk_value(((_STACK*) (1 ? (sktmp) : (struct stack_st_CONF_VALUE*)0)), (i)));
  if (!do_create(oval->value, oval->name)) {
   ERR_put_error(13,(174),(171),"asn1/asn_moid.c",88);
   return 0;
  }
 }
 return 1;
