...
# 93 "ecdsa/ecs_vrf.c"
 ...
 s = ECDSA_SIG_new();
 if (s == 
# 99 "ecdsa/ecs_vrf.c" 3 4
         ((void *)0)
# 99 "ecdsa/ecs_vrf.c"
             )
  return (ret);
 if (d2i_ECDSA_SIG(&s, &p, sig_len) == 
# 101 "ecdsa/ecs_vrf.c" 3 4
                                      ((void *)0)
# 101 "ecdsa/ecs_vrf.c"
                                          )
  goto err;
