...
# 77 "ec/ec_key.c"
  ...
  ERR_put_error(16,(182),((1|64)),"ec/ec_key.c",78);
  return (
# 79 "ec/ec_key.c" 3 4
         ((void *)0)
# 79 "ec/ec_key.c"
...
# 122 "ec/ec_key.c"
 ...
 i = CRYPTO_add_lock(&r->references,-1,33,"ec/ec_key.c",125);
 if (i > 0)
  return;
...
# 145 "ec/ec_key.c"
  ...
  ERR_put_error(16,(178),((3|64)),"ec/ec_key.c",146);
  return 
# 147 "ec/ec_key.c" 3 4
        ((void *)0)
# 147 "ec/ec_key.c"
...
{
 int i = CRYPTO_add_lock(&r->references,1,33,"ec/ec_key.c",217);
 return ((i > 1) ? 1 : 0);
}
...
# 227 "ec/ec_key.c"
 ...
 if (!eckey || !eckey->group) {
  ERR_put_error(16,(179),((3|64)),"ec/ec_key.c",230);
  return 0;
 }
 if ((order = BN_new()) == 
# 233 "ec/ec_key.c" 3 4
...
# 255 "ec/ec_key.c"
 ...
 if (!EC_POINT_mul(eckey->group, pub_key, priv_key, 
# 260 "ec/ec_key.c" 3 4
                                                   ((void *)0)
# 260 "ec/ec_key.c"
                                                       , 
...
# 284 "ec/ec_key.c"
 ...
 if (!eckey || !eckey->group || !eckey->pub_key) {
  ERR_put_error(16,(177),((3|64)),"ec/ec_key.c",287);
  return 0;
 }
 if (EC_POINT_is_at_infinity(eckey->group, eckey->pub_key) > 0) {
  ERR_put_error(16,(177),(106),"ec/ec_key.c",291);
  goto err;
 }
 if ((ctx = BN_CTX_new()) == 
# 294 "ec/ec_key.c" 3 4
...
# 294 "ec/ec_key.c"
  ...
  goto err;
 if ((point = EC_POINT_new(eckey->group)) == 
# 296 "ec/ec_key.c" 3 4
                                            ((void *)0)
# 296 "ec/ec_key.c"
                                                )
 ...
 if (EC_POINT_is_on_curve(eckey->group, eckey->pub_key, ctx) <= 0) {
  ERR_put_error(16,(177),(107),"ec/ec_key.c",301);
  goto err;
 }

 order = &eckey->group->order;
 if (BN_is_zero(order)) {
  ERR_put_error(16,(177),(122),"ec/ec_key.c",307);
  goto err;
 }
 if (!EC_POINT_mul(eckey->group, point, 
# 310 "ec/ec_key.c" 3 4
                                       ((void *)0)
# 310 "ec/ec_key.c"
                                           , eckey->pub_key, order, ctx)) {
  ERR_put_error(16,(177),(16),"ec/ec_key.c",311);
  goto err;
 }
 if (EC_POINT_is_at_infinity(eckey->group, point) <= 0) {
  ERR_put_error(16,(177),(130),"ec/ec_key.c",315);
  goto err;
 }
 ...
 if (eckey->priv_key) {
  if (BN_cmp(eckey->priv_key, order) >= 0) {
   ERR_put_error(16,(177),(130),"ec/ec_key.c",324);
   goto err;
  }
...
# 328 "ec/ec_key.c"
            , ctx)) {
   ERR_put_error(16,(177),(16),"ec/ec_key.c",329);
   goto err;
  }
  if (EC_POINT_cmp(eckey->group, point, eckey->pub_key,
   ctx) != 0) {
   ERR_put_error(16,(177),(123),"ec/ec_key.c",334);
   goto err;
  }
 }
 ok = 1;
...
# 350 "ec/ec_key.c"
 ...
 if (!key || !key->group || !x || !y) {
  ERR_put_error(16,(229),((3|64)),"ec/ec_key.c",355)
                                  ;
  return 0;
 }
 ctx = BN_CTX_new();
...
# 374 "ec/ec_key.c"
 ...
 if (BN_cmp(x, tx) || BN_cmp(y, ty)) {
  ERR_put_error(16,(229),(146),"ec/ec_key.c",401)
                                    ;
  goto err;
 }
    ...
    void (*clear_free_func) (void *))
{
 ...
 CRYPTO_lock(1|4,33,"ec/ec_key.c",495);
 ret = EC_EX_DATA_get_data(key->method_data, dup_func, free_func, clear_free_func);
 CRYPTO_lock(2|4,33,"ec/ec_key.c",497);
    ...
    void (*clear_free_func) (void *))
{
 ...
 CRYPTO_lock(1|8,33,"ec/ec_key.c",510);
...
# 512 "ec/ec_key.c"
 ...
 CRYPTO_lock(2|8,33,"ec/ec_key.c",514);
