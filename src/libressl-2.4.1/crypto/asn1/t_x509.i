...
{
 return X509_print_ex_fp(fp, x, 0, 0);
}
...
# 94 "asn1/t_x509.c" 3 4
                                   ((void *)0)
# 94 "asn1/t_x509.c"
                                       ) {
  ERR_put_error(11,(118),(7),"asn1/t_x509.c",95);
  return (0);
 }
...
# 115 "asn1/t_x509.c"
 ...
 ASN1_INTEGER *bs;
 EVP_PKEY *pkey = 
# 119 "asn1/t_x509.c" 3 4
                 ((void *)0)
# 119 "asn1/t_x509.c"
                     ;
 const char *neg;

 if ((nmflags & (0xf << 16)) == (4 << 16)) {
  mlch = '\n';
  nmindent = 12;
 }
 ...
 if (!(cflag & (1L << 1))) {
  l = ASN1_INTEGER_get((x)->cert_info->version);
 ...
 if (!(cflag & (1L << 3))) {
  if (X509_signature_print(bp, x->sig_alg, 
# 173 "asn1/t_x509.c" 3 4
                                          ((void *)0)
# 173 "asn1/t_x509.c"
                                              ) <= 0)
   goto err;
...
# 221 "asn1/t_x509.c"
   ...
   EVP_PKEY_print_public(bp, pkey, 16, 
# 225 "asn1/t_x509.c" 3 4
                                      ((void *)0)
# 225 "asn1/t_x509.c"
                                          );
   EVP_PKEY_free(pkey);
...
# 251 "asn1/t_x509.c"
 ...
 int derlen;
 int i;
 unsigned char SHA1md[20];



 if (BIO_printf(bp, "        Subject OCSP hash: ") <= 0)
  goto err;
 derlen = i2d_X509_NAME(x->cert_info->subject, 
# 261 "asn1/t_x509.c" 3 4
                                              ((void *)0)
# 261 "asn1/t_x509.c"
                                                  );
 if ((der = dertmp = malloc(derlen)) == 
# 262 "asn1/t_x509.c" 3 4
                                       ((void *)0)
# 262 "asn1/t_x509.c"
                                           )
  goto err;
 ...
 if (!EVP_Digest(der, derlen, SHA1md, 
# 266 "asn1/t_x509.c" 3 4
                                     ((void *)0)
# 266 "asn1/t_x509.c"
                                         , EVP_sha1(), 
# 266 "asn1/t_x509.c" 3 4
...
X509_signature_print(BIO *bp, X509_ALGOR *sigalg, ASN1_STRING *sig)
{
 ...
 if (sig_nid != 0) {
  ...
  if (OBJ_find_sigid_algs(sig_nid, &dig_nid, &pkey_nid)) {
   ameth = EVP_PKEY_asn1_find(
# 336 "asn1/t_x509.c" 3 4
                             ((void *)0)
# 336 "asn1/t_x509.c"
                                 , pkey_nid);
...
X509_NAME_print(BIO *bp, X509_NAME *name, int obase)
{
 ...
 b = X509_NAME_oneline(name, 
# 499 "asn1/t_x509.c" 3 4
                            ((void *)0)
# 499 "asn1/t_x509.c"
                                , 0);
 if (b == 
# 500 "asn1/t_x509.c" 3 4
         ((void *)0)
# 500 "asn1/t_x509.c"
             )
  return 0;
 ...
 if (0) {
err:
  ERR_put_error(11,(117),(7),"asn1/t_x509.c",533);
 }
 free(b);
 return (ret);
}
