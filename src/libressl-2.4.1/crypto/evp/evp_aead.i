    ...
    const unsigned char *key, size_t key_len, size_t tag_len, ENGINE *impl)
{
 ...
 if (key_len != aead->key_len) {
  ERR_put_error(6,(180),(108),"evp/evp_aead.c",56);
  return 0;
 }
    ...
    size_t ad_len)
{
 ...
 if (possible_out_len < in_len) {
  ERR_put_error(6,(186),(164),"evp/evp_aead.c",99);
  goto error;
 }

 if (!check_alias(in, in_len, out)) {
  ERR_put_error(6,(186),(172),"evp/evp_aead.c",104);
  goto error;
 }
...
{
 if (!check_alias(in, in_len, out)) {
  ERR_put_error(6,(185),(172),"evp/evp_aead.c",128);
  goto error;
 }
