...
void MD4_Transform (MD4_CTX *c, const unsigned char *data)
{
...
int MD4_Final (unsigned char *md, MD4_CTX *c)
{
 ...
 do { unsigned long ll; ll=(c)->A; (*((unsigned int *)((md)))=(ll), ((md))+=4); ll=(c)->B; (*((unsigned int *)((md)))=(ll), ((md))+=4); ll=(c)->C; (*((unsigned int *)((md)))=(ll), ((md))+=4); ll=(c)->D; (*((unsigned int *)((md)))=(ll), ((md))+=4); } while (0);
...
void md4_block_data_order (MD4_CTX *c, const void *data_, size_t num)
 ...
 for (;num--;)
  {
 ((l)=*((const unsigned int *)(data)), (data)+=4); XX0=l;
 ((l)=*((const unsigned int *)(data)), (data)+=4); XX1=l;

 { A+=((XX0)+(0)+(((((C)) ^ ((D))) & ((B))) ^ ((D)))); A=ROTATE(A,3); };; ((l)=*((const unsigned int *)(data)), (data)+=4); XX2=l;
 { D+=((XX1)+(0)+(((((B)) ^ ((C))) & ((A))) ^ ((C)))); D=ROTATE(D,7); };; ((l)=*((const unsigned int *)(data)), (data)+=4); XX3=l;
 { C+=((XX2)+(0)+(((((A)) ^ ((B))) & ((D))) ^ ((B)))); C=ROTATE(C,11); };; ((l)=*((const unsigned int *)(data)), (data)+=4); XX4=l;
 { B+=((XX3)+(0)+(((((D)) ^ ((A))) & ((C))) ^ ((A)))); B=ROTATE(B,19); };; ((l)=*((const unsigned int *)(data)), (data)+=4); XX5=l;
 { A+=((XX4)+(0)+(((((C)) ^ ((D))) & ((B))) ^ ((D)))); A=ROTATE(A,3); };; ((l)=*((const unsigned int *)(data)), (data)+=4); XX6=l;
 { D+=((XX5)+(0)+(((((B)) ^ ((C))) & ((A))) ^ ((C)))); D=ROTATE(D,7); };; ((l)=*((const unsigned int *)(data)), (data)+=4); XX7=l;
 { C+=((XX6)+(0)+(((((A)) ^ ((B))) & ((D))) ^ ((B)))); C=ROTATE(C,11); };; ((l)=*((const unsigned int *)(data)), (data)+=4); XX8=l;
 { B+=((XX7)+(0)+(((((D)) ^ ((A))) & ((C))) ^ ((A)))); B=ROTATE(B,19); };; ((l)=*((const unsigned int *)(data)), (data)+=4); XX9=l;
 { A+=((XX8)+(0)+(((((C)) ^ ((D))) & ((B))) ^ ((D)))); A=ROTATE(A,3); };; ((l)=*((const unsigned int *)(data)), (data)+=4); XX10=l;
 { D+=((XX9)+(0)+(((((B)) ^ ((C))) & ((A))) ^ ((C)))); D=ROTATE(D,7); };; ((l)=*((const unsigned int *)(data)), (data)+=4); XX11=l;
 { C+=((XX10)+(0)+(((((A)) ^ ((B))) & ((D))) ^ ((B)))); C=ROTATE(C,11); };; ((l)=*((const unsigned int *)(data)), (data)+=4); XX12=l;
 { B+=((XX11)+(0)+(((((D)) ^ ((A))) & ((C))) ^ ((A)))); B=ROTATE(B,19); };; ((l)=*((const unsigned int *)(data)), (data)+=4); XX13=l;
 { A+=((XX12)+(0)+(((((C)) ^ ((D))) & ((B))) ^ ((D)))); A=ROTATE(A,3); };; ((l)=*((const unsigned int *)(data)), (data)+=4); XX14=l;
 { D+=((XX13)+(0)+(((((B)) ^ ((C))) & ((A))) ^ ((C)))); D=ROTATE(D,7); };; ((l)=*((const unsigned int *)(data)), (data)+=4); XX15=l;
 { C+=((XX14)+(0)+(((((A)) ^ ((B))) & ((D))) ^ ((B)))); C=ROTATE(C,11); };;
 { B+=((XX15)+(0)+(((((D)) ^ ((A))) & ((C))) ^ ((A)))); B=ROTATE(B,19); };;

 { A+=((XX0)+(0x5A827999L)+((((B)) & ((C))) | (((B)) & ((D))) | (((C)) & ((D))))); A=ROTATE(A,3); };;
 { D+=((XX4)+(0x5A827999L)+((((A)) & ((B))) | (((A)) & ((C))) | (((B)) & ((C))))); D=ROTATE(D,5); };;
 { C+=((XX8)+(0x5A827999L)+((((D)) & ((A))) | (((D)) & ((B))) | (((A)) & ((B))))); C=ROTATE(C,9); };;
 { B+=((XX12)+(0x5A827999L)+((((C)) & ((D))) | (((C)) & ((A))) | (((D)) & ((A))))); B=ROTATE(B,13); };;
 { A+=((XX1)+(0x5A827999L)+((((B)) & ((C))) | (((B)) & ((D))) | (((C)) & ((D))))); A=ROTATE(A,3); };;
 { D+=((XX5)+(0x5A827999L)+((((A)) & ((B))) | (((A)) & ((C))) | (((B)) & ((C))))); D=ROTATE(D,5); };;
 { C+=((XX9)+(0x5A827999L)+((((D)) & ((A))) | (((D)) & ((B))) | (((A)) & ((B))))); C=ROTATE(C,9); };;
 { B+=((XX13)+(0x5A827999L)+((((C)) & ((D))) | (((C)) & ((A))) | (((D)) & ((A))))); B=ROTATE(B,13); };;
 { A+=((XX2)+(0x5A827999L)+((((B)) & ((C))) | (((B)) & ((D))) | (((C)) & ((D))))); A=ROTATE(A,3); };;
 { D+=((XX6)+(0x5A827999L)+((((A)) & ((B))) | (((A)) & ((C))) | (((B)) & ((C))))); D=ROTATE(D,5); };;
 { C+=((XX10)+(0x5A827999L)+((((D)) & ((A))) | (((D)) & ((B))) | (((A)) & ((B))))); C=ROTATE(C,9); };;
 { B+=((XX14)+(0x5A827999L)+((((C)) & ((D))) | (((C)) & ((A))) | (((D)) & ((A))))); B=ROTATE(B,13); };;
