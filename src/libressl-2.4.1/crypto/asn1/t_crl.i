...
# 74 "asn1/t_crl.c"
  ...
  ERR_put_error(11,(147),(7),"asn1/t_crl.c",75);
  return (0);
 }
...
{
 struct stack_st_X509_REVOKED *rev;
 X509_REVOKED *r;
 long l;
 int i;
 char *p;
 ...
 l = ASN1_INTEGER_get((x)->crl->version);
 BIO_printf(out, "%8sVersion %lu (0x%lx)\n", "", l + 1, l);
 i = OBJ_obj2nid(x->sig_alg->algorithm);
 if (X509_signature_print(out, x->sig_alg, 
# 97 "asn1/t_crl.c" 3 4
                                          ((void *)0)
# 97 "asn1/t_crl.c"
                                              ) == 0)
  goto err;
 p = X509_NAME_oneline(((x)->crl->issuer), 
# 99 "asn1/t_crl.c" 3 4
                                              ((void *)0)
# 99 "asn1/t_crl.c"
                                                  , 0);
 if (p == 
# 100 "asn1/t_crl.c" 3 4
         ((void *)0)
# 100 "asn1/t_crl.c"
             )
  goto err;
 ...
 ASN1_TIME_print(out, ((x)->crl->lastUpdate));
 BIO_printf(out, "\n%8sNext Update: ", "");
 if (((x)->crl->nextUpdate))
  ASN1_TIME_print(out, ((x)->crl->nextUpdate));
 else
  BIO_printf(out, "NONE");
 BIO_printf(out, "\n");
 ...
 if (sk_num(((_STACK*) (1 ? (rev) : (struct stack_st_X509_REVOKED*)0))) > 0)
  BIO_printf(out, "Revoked Certificates:\n");
 else
  BIO_printf(out, "No Revoked Certificates.\n");

 for (i = 0; i < sk_num(((_STACK*) (1 ? (rev) : (struct stack_st_X509_REVOKED*)0))); i++) {
  r = ((X509_REVOKED *)sk_value(((_STACK*) (1 ? (rev) : (struct stack_st_X509_REVOKED*)0)), (i)));
