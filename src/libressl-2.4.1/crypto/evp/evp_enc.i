    ...
    const unsigned char *key, const unsigned char *iv, int enc)
{
 ...
 return EVP_CipherInit_ex(ctx, cipher, 
# 94 "evp/evp_enc.c" 3 4
                                      ((void *)0)
# 94 "evp/evp_enc.c"
                                          , key, iv, enc);
}
    ...
    const unsigned char *key, const unsigned char *iv, int enc)
{
 ...
 if (cipher) {
  ...
  if (impl) {
   if (!ENGINE_init(impl)) {
    ERR_put_error(6,(123),(134),"evp/evp_enc.c",132)
                                   ;
    return 0;
   }
  } else
  ...
  if (impl) {
   ...
   if (!c) {
    ERR_put_error(6,(123),(134),"evp/evp_enc.c",144)
                                   ;
    return 0;
   }
...
# 154 "evp/evp_enc.c"
  ...
  if (ctx->cipher->ctx_size) {
   ...
   if (!ctx->cipher_data) {
    ERR_put_error(6,(123),((1|64)),"evp/evp_enc.c",162)
                             ;
    return 0;
   }
  } else {
   ctx->cipher_data = 
# 166 "evp/evp_enc.c" 3 4
                     ((void *)0)
# 166 "evp/evp_enc.c"
                         ;
  }
  ...
  ctx->flags = 0;
  if (ctx->cipher->flags & 0x40) {
   if (!EVP_CIPHER_CTX_ctrl(ctx, 0x0, 0, 
# 171 "evp/evp_enc.c" 3 4
                                                  ((void *)0)
# 171 "evp/evp_enc.c"
                                                      )) {
    ERR_put_error(6,(123),(134),"evp/evp_enc.c",173)
                                   ;
    return 0;
   }
  }
 } else if (!ctx->cipher) {
  ERR_put_error(6,(123),(131),"evp/evp_enc.c",178);
  return 0;
 }
...
skip_to_init:
 ...
 if (ctx->cipher->block_size != 1 &&
  ...
  ERR_put_error(6,(123),(136),"evp/evp_enc.c",188);
  return 0;
 }

 if (!(EVP_CIPHER_CTX_flags(ctx) & 0x10)) {
  ...
  case 0x2:
   ...
   if ((size_t)EVP_CIPHER_CTX_iv_length(ctx) >
       sizeof(ctx->iv)) {
    ERR_put_error(6,(123),(102),"evp/evp_enc.c",210)
                           ;
    return 0;
   }
   if (iv)
    ...
    const unsigned char *in, int inl)
{
 ...
 if ((size_t)bl > sizeof(ctx->buf)) {
  ERR_put_error(6,(198),(136),"evp/evp_enc.c",332);
  *outl = 0;
  return 0;
 }
 if (i != 0) {
...
EVP_EncryptFinal_ex(EVP_CIPHER_CTX *ctx, unsigned char *out, int *outl)
{
 ...
 if (ctx->cipher->flags & 0x100000) {
  ret = ctx->cipher->do_cipher(ctx, out, 
# 385 "evp/evp_enc.c" 3 4
       ((void *)0)
# 385 "evp/evp_enc.c"
       , 0);
  if (ret < 0)
 ...
 if (b > sizeof ctx->buf) {
  ERR_put_error(6,(127),(136),"evp/evp_enc.c",395);
  return 0;
 }
 if (b == 1) {
  *outl = 0;
 ...
 if (ctx->flags & 0x100) {
  if (bl) {
   ERR_put_error(6,(127),(138),"evp/evp_enc.c",406)
                                               ;
   return 0;
  }
  *outl = 0;
    ...
    const unsigned char *in, int inl)
{
 ...
 if (b > sizeof ctx->final) {
  ERR_put_error(6,(199),(136),"evp/evp_enc.c",452);
  return 0;
 }
 ...
 *outl = 0;
 ...
 if (ctx->cipher->flags & 0x100000) {
  i = ctx->cipher->do_cipher(ctx, out, 
# 500 "evp/evp_enc.c" 3 4
     ((void *)0)
# 500 "evp/evp_enc.c"
     , 0);
  if (i < 0)
 ...
 if (ctx->flags & 0x100) {
  if (ctx->buf_len) {
   ERR_put_error(6,(101),(138),"evp/evp_enc.c",512)
                                               ;
   return 0;
  }
  *outl = 0;
 ...
 if (b > 1) {
  if (ctx->buf_len || !ctx->final_used) {
   ERR_put_error(6,(101),(109),"evp/evp_enc.c",521)
                                      ;
   return (0);
  }
  if (b > sizeof ctx->final) {
   ERR_put_error(6,(101),(136),"evp/evp_enc.c",526)
                              ;
   return 0;
  }
  n = ctx->final[b - 1];
  if (n == 0 || n > (int)b) {
   ERR_put_error(6,(101),(100),"evp/evp_enc.c",531);
   return (0);
  }
  for (i = 0; i < n; i++) {
   if (ctx->final[--b] != n) {
    ERR_put_error(6,(101),(100),"evp/evp_enc.c",537)
                          ;
    return (0);
   }
  }
...
{
 if (c->cipher->flags & 0x80)
  return EVP_CIPHER_CTX_ctrl(c, 0x1,
      keylen, 
# 585 "evp/evp_enc.c" 3 4
             ((void *)0)
# 585 "evp/evp_enc.c"
                 );
 if (c->key_len == keylen)
  return 1;
 if ((keylen > 0) && (c->cipher->flags & 0x8)) {
  c->key_len = keylen;
  return 1;
 }
 ERR_put_error(6,(122),(130),"evp/evp_enc.c",592);
 return 0;
}
...
EVP_CIPHER_CTX_ctrl(EVP_CIPHER_CTX *ctx, int type, int arg, void *ptr)
{
 ...
 if (!ctx->cipher) {
  ERR_put_error(6,(124),(131),"evp/evp_enc.c",612);
  return 0;
 }

 if (!ctx->cipher->ctrl) {
  ERR_put_error(6,(124),(132),"evp/evp_enc.c",617);
  return 0;
 }

 ret = ctx->cipher->ctrl(ctx, type, arg, ptr);
 if (ret == -1) {
  ERR_put_error(6,(124),(133),"evp/evp_enc.c",624)
                                           ;
  return 0;
 }
 return ret;
...
{
 if (ctx->cipher->flags & 0x200)
  return EVP_CIPHER_CTX_ctrl(ctx, 0x6, 0, key);
...
# 642 "evp/evp_enc.c"
  ...
  ERR_put_error(6,(163),(111),"evp/evp_enc.c",643);
  return 0;
 }


 if (in->engine && !ENGINE_init(in->engine)) {
  ERR_put_error(6,(163),(38),"evp/evp_enc.c",649);
  return 0;
 }
 ...
 if (in->cipher_data && in->cipher->ctx_size) {
  ...
  if (!out->cipher_data) {
   ERR_put_error(6,(163),((1|64)),"evp/evp_enc.c",660);
   return 0;
  }
  memcpy(out->cipher_data, in->cipher_data, in->cipher->ctx_size);
 }

 if (in->cipher->flags & 0x400)
