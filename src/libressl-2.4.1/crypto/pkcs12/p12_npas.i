...
# 65 "pkcs12/p12_npas.c" 2



static int newpass_p12(PKCS12 *p12, char *oldpass, char *newpass);
static int newpass_bags(struct stack_st_PKCS12_SAFEBAG *bags, char *oldpass,
    char *newpass);
...
PKCS12_newpass(PKCS12 *p12, char *oldpass, char *newpass)
{
 ...
 if (!p12) {
  ERR_put_error(35,(128),(105),"pkcs12/p12_npas.c",85)
                                           ;
  return 0;
 }
 ...
 if (!PKCS12_verify_mac(p12, oldpass, -1)) {
  ERR_put_error(35,(128),(113),"pkcs12/p12_npas.c",92);
  return 0;
 }

 if (!newpass_p12(p12, oldpass, newpass)) {
  ERR_put_error(35,(128),(114),"pkcs12/p12_npas.c",97);
  return 0;
 }
...
{
 struct stack_st_PKCS7 *asafes, *newsafes;
 struct stack_st_PKCS12_SAFEBAG *bags;
 int i, bagnid, pbe_nid = 0, pbe_iter = 0, pbe_saltlen = 0;
 PKCS7 *p7, *p7new;
 ASN1_OCTET_STRING *p12_data_tmp = 
# 113 "pkcs12/p12_npas.c" 3 4
                                  ((void *)0)
# 113 "pkcs12/p12_npas.c"
                                      , *macnew = 
# 113 "pkcs12/p12_npas.c" 3 4
                                                  ((void *)0)
# 113 "pkcs12/p12_npas.c"
 ...
 if (!(asafes = PKCS12_unpack_authsafes(p12)))
  return 0;
 if (!(newsafes = ((struct stack_st_PKCS7 *)sk_new_null())))
  return 0;
  ...
  if (bagnid == 21) {
   ...
   if (!alg_get(p7->d.encrypted->enc_data->algorithm,
    ...
    sk_pop_free(((_STACK*) (1 ? (bags) : (struct stack_st_PKCS12_SAFEBAG*)0)), ((void (*)(void *)) ((1 ? (PKCS12_SAFEBAG_free) : (void (*)(PKCS12_SAFEBAG *))0))))
                            ;
    bags = 
# 132 "pkcs12/p12_npas.c" 3 4
          ((void *)0)
# 132 "pkcs12/p12_npas.c"
              ;
   }
  } else
   continue;
  if (bags == 
# 136 "pkcs12/p12_npas.c" 3 4
             ((void *)0)
# 136 "pkcs12/p12_npas.c"
                 )
   goto err;
...
# 147 "pkcs12/p12_npas.c" 3 4
      ((void *)0)
# 147 "pkcs12/p12_npas.c"
          , pbe_saltlen, pbe_iter, bags);
  sk_pop_free(((_STACK*) (1 ? (bags) : (struct stack_st_PKCS12_SAFEBAG*)0)), ((void (*)(void *)) ((1 ? (PKCS12_SAFEBAG_free) : (void (*)(PKCS12_SAFEBAG *))0))));
  if (p7new == 
# 149 "pkcs12/p12_npas.c" 3 4
              ((void *)0)
# 149 "pkcs12/p12_npas.c"
                  )
   goto err;
  if (sk_push(((_STACK*) (1 ? (newsafes) : (struct stack_st_PKCS7*)0)), ((void*) (1 ? (p7new) : (PKCS7*)0))) == 0)
   goto err;
 }
...
err:
 sk_pop_free(((_STACK*) (1 ? (asafes) : (struct stack_st_PKCS7*)0)), ((void (*)(void *)) ((1 ? (PKCS7_free) : (void (*)(PKCS7 *))0))));
 sk_pop_free(((_STACK*) (1 ? (newsafes) : (struct stack_st_PKCS7*)0)), ((void (*)(void *)) ((1 ? (PKCS7_free) : (void (*)(PKCS7 *))0))));
 return 0;
}


static int
newpass_bags(struct stack_st_PKCS12_SAFEBAG *bags, char *oldpass, char *newpass)
{
 int i;

 for (i = 0; i < sk_num(((_STACK*) (1 ? (bags) : (struct stack_st_PKCS12_SAFEBAG*)0))); i++) {
  if (!newpass_bag(((PKCS12_SAFEBAG *)sk_value(((_STACK*) (1 ? (bags) : (struct stack_st_PKCS12_SAFEBAG*)0)), (i))),
      oldpass, newpass))
   return 0;
 }
 return 1;
...
newpass_bag(PKCS12_SAFEBAG *bag, char *oldpass, char *newpass)
{
 ...
 if (!alg_get(bag->value.shkeybag->algor, &p8_nid, &p8_iter,
     &p8_saltlen))
  return 0;
 if (!(p8new = PKCS8_encrypt(p8_nid, 
# 222 "pkcs12/p12_npas.c" 3 4
                                    ((void *)0)
# 222 "pkcs12/p12_npas.c"
                                        , newpass, -1, 
# 222 "pkcs12/p12_npas.c" 3 4
                                                       ((void *)0)
# 222 "pkcs12/p12_npas.c"
...
alg_get(X509_ALGOR *alg, int *pnid, int *piter, int *psaltlen)
{
 ...
 pbe = d2i_PBEPARAM(
# 236 "pkcs12/p12_npas.c" 3 4
                   ((void *)0)
# 236 "pkcs12/p12_npas.c"
                       , &p, alg->parameter->value.sequence->length);
 if (!pbe)
  return 0;
