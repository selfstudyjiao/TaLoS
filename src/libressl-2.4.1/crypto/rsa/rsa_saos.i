    ...
    unsigned char *sigret, unsigned int *siglen, RSA *rsa)
{
 ...
 i = i2d_ASN1_OCTET_STRING(&sig, 
# 80 "rsa/rsa_saos.c" 3 4
                                ((void *)0)
# 80 "rsa/rsa_saos.c"
                                    );
 j = RSA_size(rsa);
 if (i > (j - 11)) {
  ERR_put_error(4,(118),(112),"rsa/rsa_saos.c",84)
                                       ;
  return 0;
 }
 s = malloc(j + 1);
 if (s == 
# 88 "rsa/rsa_saos.c" 3 4
         ((void *)0)
# 88 "rsa/rsa_saos.c"
             ) {
  ERR_put_error(4,(118),((1|64)),"rsa/rsa_saos.c",89);
  return 0;
 }
 p = s;
    ...
    unsigned int m_len, unsigned char *sigbuf, unsigned int siglen, RSA *rsa)
{
 ...
 const unsigned char *p;
 ASN1_OCTET_STRING *sig = 
# 112 "rsa/rsa_saos.c" 3 4
                         ((void *)0)
# 112 "rsa/rsa_saos.c"
                             ;

 if (siglen != (unsigned int)RSA_size(rsa)) {
  ERR_put_error(4,(120),(119),"rsa/rsa_saos.c",116)
                                   ;
  return 0;
 }
 ...
 s = malloc(siglen);
 if (s == 
# 121 "rsa/rsa_saos.c" 3 4
         ((void *)0)
# 121 "rsa/rsa_saos.c"
             ) {
  ERR_put_error(4,(120),((1|64)),"rsa/rsa_saos.c",123)
                           ;
  goto err;
 }
 ...
 p = s;
 sig = d2i_ASN1_OCTET_STRING(
# 132 "rsa/rsa_saos.c" 3 4
                            ((void *)0)
# 132 "rsa/rsa_saos.c"
                                , &p, (long)i);
 if (sig == 
# 133 "rsa/rsa_saos.c" 3 4
           ((void *)0)
# 133 "rsa/rsa_saos.c"
               )
  goto err;
 ...
 if ((unsigned int)sig->length != m_len ||
  ...
  ERR_put_error(4,(120),(104),"rsa/rsa_saos.c",139)
                          ;
 } else
  ret = 1;
err:
