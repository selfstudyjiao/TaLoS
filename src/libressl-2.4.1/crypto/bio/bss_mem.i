...
BIO_new_mem_buf(void *buf, int len)
{
 ...
 if (!buf) {
  ERR_put_error(32,(126),(115),"bio/bss_mem.c",104);
  return 
# 105 "bio/bss_mem.c" 3 4
        ((void *)0)
# 105 "bio/bss_mem.c"
            ;
 }
...
# 140 "bio/bss_mem.c"
   ...
   if (a->flags & 0x200)
    b->data = 
# 144 "bio/bss_mem.c" 3 4
             ((void *)0)
# 144 "bio/bss_mem.c"
                 ;
   BUF_MEM_free(b);
   a->ptr = 
# 146 "bio/bss_mem.c" 3 4
           ((void *)0)
# 146 "bio/bss_mem.c"
               ;
  }
...
mem_write(BIO *b, const char *in, int inl)
{
 ...
 bm = (BUF_MEM *)b->ptr;
 if (in == 
# 185 "bio/bss_mem.c" 3 4
          ((void *)0)
# 185 "bio/bss_mem.c"
              ) {
  ERR_put_error(32,(117),(115),"bio/bss_mem.c",186);
  goto end;
 }

 if (b->flags & 0x200) {
  ERR_put_error(32,(117),(126),"bio/bss_mem.c",191);
  goto end;
 }
...
mem_gets(BIO *bp, char *buf, int size)
{
 ...
 BIO_clear_flags(bp, ((0x01|0x02|0x04)|0x08));
 j = bm->length;
 if ((size - 1) < j)
  j = size - 1;
 if (j <= 0) {
