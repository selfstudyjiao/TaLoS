...
PKCS12_item_pack_safebag(void *obj, const ASN1_ITEM *it, int nid1, int nid2)
{
 ...
 if (!(bag = PKCS12_BAGS_new())) {
  ERR_put_error(35,(117),((1|64)),"pkcs12/p12_add.c",74)
                           ;
  return 
# 75 "pkcs12/p12_add.c" 3 4
        ((void *)0)
# 75 "pkcs12/p12_add.c"
            ;
 }
 ...
 if (!ASN1_item_pack(obj, it, &bag->value.octet)) {
  ERR_put_error(35,(117),((1|64)),"pkcs12/p12_add.c",80)
                           ;
  PKCS12_BAGS_free(bag);
  return 
# 82 "pkcs12/p12_add.c" 3 4
        ((void *)0)
# 82 "pkcs12/p12_add.c"
            ;
 }
 if (!(safebag = PKCS12_SAFEBAG_new())) {
  ERR_put_error(35,(117),((1|64)),"pkcs12/p12_add.c",86)
                           ;
  PKCS12_BAGS_free(bag);
  return 
# 88 "pkcs12/p12_add.c" 3 4
        ((void *)0)
# 88 "pkcs12/p12_add.c"
            ;
 }
...
PKCS12_MAKE_KEYBAG(PKCS8_PRIV_KEY_INFO *p8)
{
 ...
 if (!(bag = PKCS12_SAFEBAG_new())) {
  ERR_put_error(35,(112),((1|64)),"pkcs12/p12_add.c",103);
  return 
# 104 "pkcs12/p12_add.c" 3 4
        ((void *)0)
# 104 "pkcs12/p12_add.c"
            ;
 }
 bag->type = OBJ_nid2obj(150);
 bag->value.keybag = p8;
 return bag;
}
    ...
    unsigned char *salt, int saltlen, int iter, PKCS8_PRIV_KEY_INFO *p8)
{
 ...
 if (!(bag = PKCS12_SAFEBAG_new())) {
  ERR_put_error(35,(113),((1|64)),"pkcs12/p12_add.c",122);
  return 
# 123 "pkcs12/p12_add.c" 3 4
        ((void *)0)
# 123 "pkcs12/p12_add.c"
            ;
 }

 bag->type = OBJ_nid2obj(151);

 pbe_ciph = EVP_get_cipherbyname(OBJ_nid2sn(pbe_nid));
 ...
 if (!(bag->value.shkeybag = PKCS8_encrypt(pbe_nid, pbe_ciph, pass,
  ...
  ERR_put_error(35,(113),((1|64)),"pkcs12/p12_add.c",135);
  PKCS12_SAFEBAG_free(bag);
  return 
# 137 "pkcs12/p12_add.c" 3 4
        ((void *)0)
# 137 "pkcs12/p12_add.c"
            ;
 }
...
PKCS7 *
PKCS12_pack_p7data(struct stack_st_PKCS12_SAFEBAG *sk)
{
 PKCS7 *p7;

 if (!(p7 = PKCS7_new())) {
  ERR_put_error(35,(114),((1|64)),"pkcs12/p12_add.c",150);
  return 
# 151 "pkcs12/p12_add.c" 3 4
        ((void *)0)
# 151 "pkcs12/p12_add.c"
            ;
 }
 p7->type = OBJ_nid2obj(21);
 if (!(p7->d.data = ASN1_OCTET_STRING_new())) {
  ERR_put_error(35,(114),((1|64)),"pkcs12/p12_add.c",155);
  goto err;
 }

 if (!ASN1_item_pack(sk, (&(PKCS12_SAFEBAGS_it)), &p7->d.data)) {
  ERR_put_error(35,(114),(100),"pkcs12/p12_add.c",161)
                                   ;
  goto err;
 }
 return p7;
...
err:
 PKCS7_free(p7);
 return 
# 168 "pkcs12/p12_add.c" 3 4
       ((void *)0)
# 168 "pkcs12/p12_add.c"
           ;
}
...
PKCS12_unpack_p7data(PKCS7 *p7)
{
 if (!(OBJ_obj2nid((p7)->type) == 21)) {
  ERR_put_error(35,(131),(121),"pkcs12/p12_add.c",177)
                                     ;
  return 
# 178 "pkcs12/p12_add.c" 3 4
        ((void *)0)
# 178 "pkcs12/p12_add.c"
            ;
 }
    ...
    unsigned char *salt, int saltlen, int iter, struct stack_st_PKCS12_SAFEBAG *bags)
{
 ...
 if (!(p7 = PKCS7_new())) {
  ERR_put_error(35,(115),((1|64)),"pkcs12/p12_add.c",194);
  return 
# 195 "pkcs12/p12_add.c" 3 4
        ((void *)0)
# 195 "pkcs12/p12_add.c"
            ;
 }
 if (!PKCS7_set_type(p7, 26)) {
  ERR_put_error(35,(115),(120),"pkcs12/p12_add.c",199)
                                                 ;
  goto err;
 }
 ...
 if (!pbe) {
  ERR_put_error(35,(115),((1|64)),"pkcs12/p12_add.c",211);
  goto err;
 }
 ...
 if (!(p7->d.encrypted->enc_data->enc_data = PKCS12_item_i2d_encrypt(
  ...
  ERR_put_error(35,(115),(103),"pkcs12/p12_add.c",220)
                             ;
  goto err;
 }
...
err:
 PKCS7_free(p7);
 return 
# 228 "pkcs12/p12_add.c" 3 4
       ((void *)0)
# 228 "pkcs12/p12_add.c"
           ;
}
...
{
 if (!(OBJ_obj2nid((p7)->type) == 26))
  return 
# 235 "pkcs12/p12_add.c" 3 4
        ((void *)0)
# 235 "pkcs12/p12_add.c"
            ;
...
int
PKCS12_pack_authsafes(PKCS12 *p12, struct stack_st_PKCS7 *safes)
{
...
{
 if (!(OBJ_obj2nid((p12->authsafes)->type) == 21)) {
  ERR_put_error(35,(130),(121),"pkcs12/p12_add.c",261)
                                     ;
  return 
# 262 "pkcs12/p12_add.c" 3 4
        ((void *)0)
# 262 "pkcs12/p12_add.c"
            ;
 }
