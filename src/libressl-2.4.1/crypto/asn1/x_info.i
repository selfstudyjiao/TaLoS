...
# 69 "asn1/x_info.c"
 ...
 if (ret == 
# 72 "asn1/x_info.c" 3 4
           ((void *)0)
# 72 "asn1/x_info.c"
               ) {
  ERR_put_error(13,(170),((1|64)),"asn1/x_info.c",73);
  return (
# 74 "asn1/x_info.c" 3 4
         ((void *)0)
# 74 "asn1/x_info.c"
             );
 }

 ret->enc_cipher.cipher = 
# 77 "asn1/x_info.c" 3 4
                         ((void *)0)
# 77 "asn1/x_info.c"
                             ;
 ret->enc_len = 0;
 ret->enc_data = 
# 79 "asn1/x_info.c" 3 4
                ((void *)0)
# 79 "asn1/x_info.c"
                    ;
 ...
 ret->references = 1;
 ret->x509 = 
# 82 "asn1/x_info.c" 3 4
            ((void *)0)
# 82 "asn1/x_info.c"
                ;
 ret->crl = 
# 83 "asn1/x_info.c" 3 4
           ((void *)0)
# 83 "asn1/x_info.c"
               ;
 ret->x_pkey = 
# 84 "asn1/x_info.c" 3 4
              ((void *)0)
# 84 "asn1/x_info.c"
                  ;
 return (ret);
...
X509_INFO_free(X509_INFO *x)
{
 ...
 if (x == 
# 93 "asn1/x_info.c" 3 4
         ((void *)0)
# 93 "asn1/x_info.c"
             )
  return;

 i = CRYPTO_add_lock(&x->references,-1,4,"asn1/x_info.c",96);
 if (i > 0)
  return;

 X509_free(x->x509);
 if (x->crl != 
# 101 "asn1/x_info.c" 3 4
              ((void *)0)
# 101 "asn1/x_info.c"
                  )
  X509_CRL_free(x->crl);
 if (x->x_pkey != 
# 103 "asn1/x_info.c" 3 4
                 ((void *)0)
# 103 "asn1/x_info.c"
                     )
