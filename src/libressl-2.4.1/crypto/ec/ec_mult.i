...
# 106 "ec/ec_mult.c"
 ...
 if (!ret) {
  ERR_put_error(16,(196),((1|64)),"ec/ec_mult.c",110);
  return ret;
 }
 ret->group = group;
 ret->blocksize = 8;
...
ec_pre_comp_dup(void *src_)
{
 ...
 CRYPTO_add_lock(&src->references,1,36,"ec/ec_mult.c",130);
...
ec_pre_comp_free(void *pre_)
{
 ...
 i = CRYPTO_add_lock(&pre->references,-1,36,"ec/ec_mult.c",144);
 if (i > 0)
  return;
...
ec_pre_comp_clear_free(void *pre_)
{
 ...
 i = CRYPTO_add_lock(&pre->references,-1,36,"ec/ec_mult.c",167);
 if (i > 0)
  return;
...
# 200 "ec/ec_mult.c"
 ...
 if (BN_is_zero(scalar)) {
  r = malloc(1);
  if (!r) {
   ERR_put_error(16,(143),((1|64)),"ec/ec_mult.c",208);
   goto err;
  }
  r[0] = 0;
  *ret_len = 1;
 ...
 if (w <= 0 || w > 7) {
  ...
  ERR_put_error(16,(143),((4|64)),"ec/ec_mult.c",218);
  goto err;
 }
 bit = 1 << w;
 next_bit = bit << 1;
 ...
 if (scalar->d == 
# 228 "ec/ec_mult.c" 3 4
                 ((void *)0) 
# 228 "ec/ec_mult.c"
                      || scalar->top == 0) {
  ERR_put_error(16,(143),((4|64)),"ec/ec_mult.c",229);
  goto err;
 }
 ...
 if (r == 
# 237 "ec/ec_mult.c" 3 4
         ((void *)0)
# 237 "ec/ec_mult.c"
             ) {
  ERR_put_error(16,(143),((1|64)),"ec/ec_mult.c",238);
  goto err;
 }
...
# 264 "ec/ec_mult.c"
   ...
   if (digit <= -bit || digit >= bit || !(digit & 1)) {
    ERR_put_error(16,(143),((4|64)),"ec/ec_mult.c",272);
    goto err;
   }
   window_val -= digit;
   ...
   if (window_val != 0 && window_val != next_bit && window_val != bit) {
    ERR_put_error(16,(143),((4|64)),"ec/ec_mult.c",283);
    goto err;
   }
  }
  r[j++] = sign * digit;
  ...
  if (window_val > next_bit) {
   ERR_put_error(16,(143),((4|64)),"ec/ec_mult.c",293);
   goto err;
  }
 }

 if (j > len + 1) {
  ERR_put_error(16,(143),((4|64)),"ec/ec_mult.c",299);
  goto err;
 }
 len = j;
 ok = 1;
...
{
 BN_CTX *new_ctx = 
# 339 "ec/ec_mult.c" 3 4
                  ((void *)0)
# 339 "ec/ec_mult.c"
                      ;
 const EC_POINT *generator = 
# 340 "ec/ec_mult.c" 3 4
                            ((void *)0)
# 340 "ec/ec_mult.c"
                                ;
 EC_POINT *tmp = 
# 341 "ec/ec_mult.c" 3 4
                ((void *)0)
# 341 "ec/ec_mult.c"
                    ;
 size_t totalnum;
 ...
 size_t *wsize = 
# 349 "ec/ec_mult.c" 3 4
                ((void *)0)
# 349 "ec/ec_mult.c"
                    ;
 signed char **wNAF = 
# 350 "ec/ec_mult.c" 3 4
                     ((void *)0)
# 350 "ec/ec_mult.c"
                         ;
 signed char *tmp_wNAF = 
# 351 "ec/ec_mult.c" 3 4
                        ((void *)0)
# 351 "ec/ec_mult.c"
                            ;
 size_t *wNAF_len = 
# 352 "ec/ec_mult.c" 3 4
                   ((void *)0)
# 352 "ec/ec_mult.c"
                       ;
 size_t max_len = 0;
 size_t num_val;
 EC_POINT **val = 
# 355 "ec/ec_mult.c" 3 4
                 ((void *)0)
# 355 "ec/ec_mult.c"
                     ;
 EC_POINT **v;
 EC_POINT ***val_sub = 
# 357 "ec/ec_mult.c" 3 4
                      ((void *)0)
# 357 "ec/ec_mult.c"
                          ;

 const EC_PRE_COMP *pre_comp = 
# 359 "ec/ec_mult.c" 3 4
                              ((void *)0)
# 359 "ec/ec_mult.c"
                                  ;
 int num_scalar = 0;
 ...
 if (group->meth != r->meth) {
  ERR_put_error(16,(187),(101),"ec/ec_mult.c",366);
  return 0;
 }
 if ((scalar == 
# 369 "ec/ec_mult.c" 3 4
               ((void *)0)
# 369 "ec/ec_mult.c"
                   ) && (num == 0)) {
 ...
 for (i = 0; i < num; i++) {
  if (group->meth != points[i]->meth) {
   ERR_put_error(16,(187),(101),"ec/ec_mult.c",374);
   return 0;
  }
 }

 if (ctx == 
# 379 "ec/ec_mult.c" 3 4
           ((void *)0)
# 379 "ec/ec_mult.c"
               ) {
  ctx = new_ctx = BN_CTX_new();
  if (ctx == 
# 381 "ec/ec_mult.c" 3 4
            ((void *)0)
# 381 "ec/ec_mult.c"
                )
   goto err;
 ...
 if (scalar != 
# 384 "ec/ec_mult.c" 3 4
              ((void *)0)
# 384 "ec/ec_mult.c"
                  ) {
  generator = EC_GROUP_get0_generator(group);
  if (generator == 
# 386 "ec/ec_mult.c" 3 4
                  ((void *)0)
# 386 "ec/ec_mult.c"
                      ) {
   ERR_put_error(16,(187),(113),"ec/ec_mult.c",387);
   goto err;
  }
  ...
  if (pre_comp && pre_comp->numblocks &&
   ...
   if (pre_comp->num != (pre_comp->numblocks * pre_points_per_block)) {
    ERR_put_error(16,(187),((4|64)),"ec/ec_mult.c",416);
    goto err;
   }
  } else {

   pre_comp = 
# 421 "ec/ec_mult.c" 3 4
             ((void *)0)
# 421 "ec/ec_mult.c"
                 ;
   numblocks = 1;
 ...
 wNAF = reallocarray(
# 430 "ec/ec_mult.c" 3 4
                    ((void *)0)
# 430 "ec/ec_mult.c"
                        , (totalnum + 1), sizeof wNAF[0]);
 if (wNAF == 
# 431 "ec/ec_mult.c" 3 4
            ((void *)0)
# 431 "ec/ec_mult.c"
                ) {
  ERR_put_error(16,(187),((1|64)),"ec/ec_mult.c",432);
  goto err;
 }

 wNAF[0] = 
# 436 "ec/ec_mult.c" 3 4
          ((void *)0)
# 436 "ec/ec_mult.c"
              ;

 wsize = reallocarray(
# 438 "ec/ec_mult.c" 3 4
                     ((void *)0)
# 438 "ec/ec_mult.c"
                         , totalnum, sizeof wsize[0]);
 wNAF_len = reallocarray(
# 439 "ec/ec_mult.c" 3 4
                        ((void *)0)
# 439 "ec/ec_mult.c"
                            , totalnum, sizeof wNAF_len[0]);
 val_sub = reallocarray(
# 440 "ec/ec_mult.c" 3 4
                       ((void *)0)
# 440 "ec/ec_mult.c"
                           , totalnum, sizeof val_sub[0]);

 if (wsize == 
# 442 "ec/ec_mult.c" 3 4
             ((void *)0) 
# 442 "ec/ec_mult.c"
                  || wNAF_len == 
# 442 "ec/ec_mult.c" 3 4
...
# 442 "ec/ec_mult.c"
  ...
  ERR_put_error(16,(187),((1|64)),"ec/ec_mult.c",443);
  goto err;
 }
 ...
 for (i = 0; i < num + num_scalar; i++) {
  ...
  wsize[i] = ((size_t) ((bits) >= 2000 ? 6 : (bits) >= 800 ? 5 : (bits) >= 300 ? 4 : (bits) >= 70 ? 3 : (bits) >= 20 ? 2 : 1));
  num_val += (size_t) 1 << (wsize[i] - 1);
  wNAF[i + 1] = 
# 456 "ec/ec_mult.c" 3 4
               ((void *)0)
# 456 "ec/ec_mult.c"
                   ;
  wNAF[i] = compute_wNAF((i < num ? scalars[i] : scalar), wsize[i], &wNAF_len[i]);
  if (wNAF[i] == 
# 458 "ec/ec_mult.c" 3 4
                ((void *)0)
# 458 "ec/ec_mult.c"
                    )
   goto err;
 ...
 if (numblocks) {
  ...
  if (pre_comp == 
# 467 "ec/ec_mult.c" 3 4
                 ((void *)0)
# 467 "ec/ec_mult.c"
                     ) {
   if (num_scalar != 1) {
    ERR_put_error(16,(187),((4|64)),"ec/ec_mult.c",469);
    goto err;
   }
   ...
   if (num_scalar != 0) {
    ERR_put_error(16,(187),((4|64)),"ec/ec_mult.c",477);
    goto err;
   }
...
# 486 "ec/ec_mult.c"
   ...
   if (tmp_len <= max_len) {
    ...
    wNAF[num] = tmp_wNAF;
    tmp_wNAF = 
# 500 "ec/ec_mult.c" 3 4
              ((void *)0)
# 500 "ec/ec_mult.c"
                  ;
    wNAF[num + 1] = 
# 501 "ec/ec_mult.c" 3 4
                   ((void *)0)
# 501 "ec/ec_mult.c"
                       ;
    ...
    if (tmp_len < numblocks * blocksize) {
     ...
     if (numblocks > pre_comp->numblocks) {
      ERR_put_error(16,(187),((4|64)),"ec/ec_mult.c",527);
      goto err;
     }
     totalnum = num + numblocks;
    }
    ...
    for (i = num; i < totalnum; i++) {
     if (i < totalnum - 1) {
      ...
      if (tmp_len < blocksize) {
       ERR_put_error(16,(187),((4|64)),"ec/ec_mult.c",540);
       goto err;
      }
      tmp_len -= blocksize;
     } else
     ...
     wNAF[i + 1] = 
# 553 "ec/ec_mult.c" 3 4
                  ((void *)0)
# 553 "ec/ec_mult.c"
                      ;
     wNAF[i] = malloc(wNAF_len[i]);
     if (wNAF[i] == 
# 555 "ec/ec_mult.c" 3 4
                   ((void *)0)
# 555 "ec/ec_mult.c"
                       ) {
      ERR_put_error(16,(187),((1|64)),"ec/ec_mult.c",556);
      goto err;
     }
     ...
     if (*tmp_points == 
# 563 "ec/ec_mult.c" 3 4
                       ((void *)0)
# 563 "ec/ec_mult.c"
                           ) {
      ERR_put_error(16,(187),((4|64)),"ec/ec_mult.c",564);
      goto err;
     }
 ...
 val = reallocarray(
# 580 "ec/ec_mult.c" 3 4
                   ((void *)0)
# 580 "ec/ec_mult.c"
                       , (num_val + 1), sizeof val[0]);
 if (val == 
# 581 "ec/ec_mult.c" 3 4
           ((void *)0)
# 581 "ec/ec_mult.c"
               ) {
  ERR_put_error(16,(187),((1|64)),"ec/ec_mult.c",582);
  goto err;
 }
 val[num_val] = 
# 585 "ec/ec_mult.c" 3 4
               ((void *)0)
# 585 "ec/ec_mult.c"
                   ;
...
# 593 "ec/ec_mult.c"
 ...
 if (!(v == val + num_val)) {
  ERR_put_error(16,(187),((4|64)),"ec/ec_mult.c",599);
  goto err;
 }
...
# 691 "ec/ec_mult.c"
 ...
 if (val != 
# 696 "ec/ec_mult.c" 3 4
           ((void *)0)
# 696 "ec/ec_mult.c"
               ) {
  for (v = val; *v != 
# 697 "ec/ec_mult.c" 3 4
                     ((void *)0)
# 697 "ec/ec_mult.c"
                         ; v++)
...
# 741 "ec/ec_mult.c"
 ...
 generator = EC_GROUP_get0_generator(group);
 if (generator == 
# 745 "ec/ec_mult.c" 3 4
                 ((void *)0)
# 745 "ec/ec_mult.c"
                     ) {
  ERR_put_error(16,(188),(113),"ec/ec_mult.c",746);
  goto err;
 }
 if (ctx == 
# 749 "ec/ec_mult.c" 3 4
           ((void *)0)
# 749 "ec/ec_mult.c"
               ) {
  ctx = new_ctx = BN_CTX_new();
  if (ctx == 
# 751 "ec/ec_mult.c" 3 4
            ((void *)0)
# 751 "ec/ec_mult.c"
                )
   goto err;
...
# 755 "ec/ec_mult.c"
 ...
 if (!EC_GROUP_get_order(group, order, ctx))
  goto err;
 if (BN_is_zero(order)) {
  ERR_put_error(16,(188),(114),"ec/ec_mult.c",761);
  goto err;
 }
...
# 773 "ec/ec_mult.c"
 blocksize = 8;
 w = 4;
 if (((size_t) ((bits) >= 2000 ? 6 : (bits) >= 800 ? 5 : (bits) >= 300 ? 4 : (bits) >= 70 ? 3 : (bits) >= 20 ? 2 : 1)) > w) {

  w = ((size_t) ((bits) >= 2000 ? 6 : (bits) >= 800 ? 5 : (bits) >= 300 ? 4 : (bits) >= 70 ? 3 : (bits) >= 20 ? 2 : 1));
 }
 ...
 points = reallocarray(
# 787 "ec/ec_mult.c" 3 4
                      ((void *)0)
# 787 "ec/ec_mult.c"
                          , (num + 1), sizeof(EC_POINT *));
 if (!points) {
  ERR_put_error(16,(188),((1|64)),"ec/ec_mult.c",789);
  goto err;
 }
 var = points;
 var[num] = 
# 793 "ec/ec_mult.c" 3 4
           ((void *)0)
# 793 "ec/ec_mult.c"
               ;
 for (i = 0; i < num; i++) {
  if ((var[i] = EC_POINT_new(group)) == 
# 795 "ec/ec_mult.c" 3 4
                                       ((void *)0)
# 795 "ec/ec_mult.c"
                                           ) {
   ERR_put_error(16,(188),((1|64)),"ec/ec_mult.c",796);
   goto err;
  }
 }

 if (!(tmp_point = EC_POINT_new(group)) || !(base = EC_POINT_new(group))) {
  ERR_put_error(16,(188),((1|64)),"ec/ec_mult.c",802);
  goto err;
 }
 ...
 for (i = 0; i < numblocks; i++) {
  ...
  if (i < numblocks - 1) {
   ...
   if (blocksize <= 2) {
    ERR_put_error(16,(188),((4|64)),"ec/ec_mult.c",832);
    goto err;
   }
...
{
 if (EC_EX_DATA_get_data(group->extra_data, ec_pre_comp_dup, ec_pre_comp_free, ec_pre_comp_clear_free) != 
# 882 "ec/ec_mult.c" 3 4
                                                                                                         ((void *)0)
# 882 "ec/ec_mult.c"
                                                                                                             )
  return 1;
