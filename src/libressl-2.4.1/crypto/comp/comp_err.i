...
static ERR_STRING_DATA COMP_str_functs[] = {
 {(((((unsigned long)41)&0xffL)<<24L)| ((((unsigned long)99)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "BIO_ZLIB_FLUSH"},
 {(((((unsigned long)41)&0xffL)<<24L)| ((((unsigned long)100)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "BIO_ZLIB_NEW"},
 {(((((unsigned long)41)&0xffL)<<24L)| ((((unsigned long)101)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "BIO_ZLIB_READ"},
 {(((((unsigned long)41)&0xffL)<<24L)| ((((unsigned long)102)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "BIO_ZLIB_WRITE"},
 {0, 
# 74 "comp/comp_err.c" 3 4
    ((void *)0)
# 74 "comp/comp_err.c"
        }
};
...
static ERR_STRING_DATA COMP_str_reasons[] = {
 {(((((unsigned long)41)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)99)&0xfffL))) , "zlib deflate error"},
 {(((((unsigned long)41)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)100)&0xfffL))) , "zlib inflate error"},
 {(((((unsigned long)41)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)101)&0xfffL))) , "zlib not supported"},
 {0, 
# 81 "comp/comp_err.c" 3 4
    ((void *)0)
# 81 "comp/comp_err.c"
        }
};
...
ERR_load_COMP_strings(void)
{
 ...
 if (ERR_func_error_string(COMP_str_functs[0].error) == 
# 90 "comp/comp_err.c" 3 4
                                                       ((void *)0)
# 90 "comp/comp_err.c"
                                                           ) {
