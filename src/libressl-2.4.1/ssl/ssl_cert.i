...
# 118 "../ssl/ssl_cert.c" 2

# 1 "../include/compat/dirent.h" 1
# 13 "../include/compat/dirent.h"
...
# 14 "../include/compat/dirent.h" 2
# 120 "../ssl/ssl_cert.c" 2
...
# 127 "../ssl/ssl_cert.c" 2
# 1 "../include/openssl/opensslconf.h" 1
# 1 "../include/openssl/opensslfeatures.h" 1
# 2 "../include/openssl/opensslconf.h" 2
# 128 "../ssl/ssl_cert.c" 2
...
SSL_get_ex_data_X509_STORE_CTX_idx(void)
{
 ...
 CRYPTO_lock(1|4,12,"../ssl/ssl_cert.c",145);

 if (ssl_x509_store_ctx_idx < 0) {
  CRYPTO_lock(2|4,12,"../ssl/ssl_cert.c",148);
  CRYPTO_lock(1|8,12,"../ssl/ssl_cert.c",149);
  got_write_lock = 1;

  if (ssl_x509_store_ctx_idx < 0) {
   ssl_x509_store_ctx_idx =
       X509_STORE_CTX_get_ex_new_index(
    0, "SSL for verify callback", 
# 155 "../ssl/ssl_cert.c" 3 4
                                 ((void *)0)
# 155 "../ssl/ssl_cert.c"
                                     , 
# 155 "../ssl/ssl_cert.c" 3 4
...
# 155 "../ssl/ssl_cert.c"
 ...
 if (got_write_lock)
  CRYPTO_lock(2|8,12,"../ssl/ssl_cert.c",160);
 else
  CRYPTO_lock(2|4,12,"../ssl/ssl_cert.c",162);
...
ssl_cert_set_default_md(CERT *cert)
{
 ...
 cert->pkeys[2].digest = EVP_sha1();
 cert->pkeys[1].digest = EVP_sha1();
 cert->pkeys[0].digest = EVP_sha1();
 cert->pkeys[5].digest = EVP_sha1();

 cert->pkeys[6].digest = EVP_gostr341194();
...
ssl_cert_new(void)
{
 ...
 if (ret == 
# 186 "../ssl/ssl_cert.c" 3 4
           ((void *)0)
# 186 "../ssl/ssl_cert.c"
               ) {
  ERR_put_error(20,(162),((1|64)),"../ssl/ssl_cert.c",187);
  return (
# 188 "../ssl/ssl_cert.c" 3 4
         ((void *)0)
# 188 "../ssl/ssl_cert.c"
             );
 }
...
ssl_cert_dup(CERT *cert)
{
 ...
 ret = calloc(1, sizeof(CERT));
 if (ret == 
# 203 "../ssl/ssl_cert.c" 3 4
           ((void *)0)
# 203 "../ssl/ssl_cert.c"
               ) {
  ERR_put_error(20,(221),((1|64)),"../ssl/ssl_cert.c",204);
  return (
# 205 "../ssl/ssl_cert.c" 3 4
         ((void *)0)
# 205 "../ssl/ssl_cert.c"
             );
 }
 ...
 if (cert->dh_tmp != 
# 218 "../ssl/ssl_cert.c" 3 4
                    ((void *)0)
# 218 "../ssl/ssl_cert.c"
                        ) {
  ret->dh_tmp = DHparams_dup(cert->dh_tmp);
  if (ret->dh_tmp == 
# 220 "../ssl/ssl_cert.c" 3 4
                    ((void *)0)
# 220 "../ssl/ssl_cert.c"
                        ) {
   ERR_put_error(20,(221),(5),"../ssl/ssl_cert.c",221);
   goto err;
  }
  if (cert->dh_tmp->priv_key) {
   BIGNUM *b = BN_dup(cert->dh_tmp->priv_key);
   if (!b) {
    ERR_put_error(20,(221),(3),"../ssl/ssl_cert.c",227);
    goto err;
   }
  ...
  if (cert->dh_tmp->pub_key) {
   ...
   if (!b) {
    ERR_put_error(20,(221),(3),"../ssl/ssl_cert.c",235);
    goto err;
   }
 ...
 if (cert->ecdh_tmp) {
  ...
  if (ret->ecdh_tmp == 
# 246 "../ssl/ssl_cert.c" 3 4
                      ((void *)0)
# 246 "../ssl/ssl_cert.c"
                          ) {
   ERR_put_error(20,(221),(16),"../ssl/ssl_cert.c",247);
   goto err;
  }
 }
 ...
 for (i = 0; i < 7; i++) {
  if (cert->pkeys[i].x509 != 
# 255 "../ssl/ssl_cert.c" 3 4
                            ((void *)0)
# 255 "../ssl/ssl_cert.c"
                                ) {
   ret->pkeys[i].x509 = cert->pkeys[i].x509;
   CRYPTO_add_lock(&ret->pkeys[i].x509->references,1,3,
                   "../ssl/ssl_cert.c"
# 257 "../ssl/ssl_cert.c"
   ,
                   258
# 257 "../ssl/ssl_cert.c"
  ...
  if (cert->pkeys[i].privatekey != 
# 261 "../ssl/ssl_cert.c" 3 4
                                  ((void *)0)
# 261 "../ssl/ssl_cert.c"
                                      ) {
   ret->pkeys[i].privatekey = cert->pkeys[i].privatekey;
   CRYPTO_add_lock(&ret->pkeys[i].privatekey->references,1,10,
                       "../ssl/ssl_cert.c"
# 263 "../ssl/ssl_cert.c"
   ,
                       264
# 263 "../ssl/ssl_cert.c"
   ...
   default:
    ...
    ERR_put_error(20,(221),(274),"../ssl/ssl_cert.c",293);
   }
  }
 }
...
ssl_cert_free(CERT *c)
{
 ...
 if (c == 
# 330 "../ssl/ssl_cert.c" 3 4
         ((void *)0)
# 330 "../ssl/ssl_cert.c"
             )
  return;

 i = CRYPTO_add_lock(&c->references,-1,13,"../ssl/ssl_cert.c",333);
 if (i > 0)
  return;
...
# 362 "../ssl/ssl_cert.c"
 if (o == 
# 362 "../ssl/ssl_cert.c" 3 4
         ((void *)0)
# 362 "../ssl/ssl_cert.c"
             ) {
  ERR_put_error(20,(222),((3|64)),"../ssl/ssl_cert.c",363);
  return (0);
 }
 if (*o == 
# 366 "../ssl/ssl_cert.c" 3 4
          ((void *)0)
# 366 "../ssl/ssl_cert.c"
              ) {
  if ((*o = ssl_cert_new()) == 
# 367 "../ssl/ssl_cert.c" 3 4
                              ((void *)0)
# 367 "../ssl/ssl_cert.c"
                                  ) {
   ERR_put_error(20,(222),((1|64)),"../ssl/ssl_cert.c",368);
   return (0);
  }
 }
 return (1);
...
ssl_sess_cert_new(void)
{
 ...
 if (ret == 
# 382 "../ssl/ssl_cert.c" 3 4
           ((void *)0)
# 382 "../ssl/ssl_cert.c"
               ) {
  ERR_put_error(20,(225),((1|64)),"../ssl/ssl_cert.c",383);
  return 
# 384 "../ssl/ssl_cert.c" 3 4
        ((void *)0)
# 384 "../ssl/ssl_cert.c"
            ;
 }
 ret->peer_key = &(ret->peer_pkeys[0]);
 ret->references = 1;
...
ssl_sess_cert_free(SESS_CERT *sc)
{
 ...
 if (sc == 
# 397 "../ssl/ssl_cert.c" 3 4
          ((void *)0)
# 397 "../ssl/ssl_cert.c"
              )
  return;

 i = CRYPTO_add_lock(&sc->references,-1,15,"../ssl/ssl_cert.c",400);
 if (i > 0)
  return;


 if (sc->cert_chain != 
# 405 "../ssl/ssl_cert.c" 3 4
                      ((void *)0)
# 405 "../ssl/ssl_cert.c"
                          )
  sk_pop_free(((_STACK*) (1 ? (sc->cert_chain) : (struct stack_st_X509*)0)), ((void (*)(void *)) ((1 ? (X509_free) : (void (*)(X509 *))0))));
 for (i = 0; i < 7; i++)
...
int
ssl_verify_cert_chain(SSL *s, struct stack_st_X509 *sk)
{
 X509_STORE_CTX ctx;
 X509 *x;
 int ret;
...
# 423 "../ssl/ssl_cert.c"
 ...
 if (!X509_STORE_CTX_init(&ctx, s->ctx->cert_store, x, sk)) {
  ERR_put_error(20,(207),(11),"../ssl/ssl_cert.c",428);
  return (0);
 }
...
static void
set_client_CA_list(struct stack_st_X509_NAME **ca_list,
    struct stack_st_X509_NAME *name_list)
{
 if (*ca_list != 
# 466 "../ssl/ssl_cert.c" 3 4
                ((void *)0)
# 466 "../ssl/ssl_cert.c"
                    )
...
SSL_dup_CA_list(struct stack_st_X509_NAME *sk)
{
 int i;
 struct stack_st_X509_NAME *ret;
 X509_NAME *name;

 ret = ((struct stack_st_X509_NAME *)sk_new_null());
 for (i = 0; i < sk_num(((_STACK*) (1 ? (sk) : (struct stack_st_X509_NAME*)0))); i++) {
  name = X509_NAME_dup(((X509_NAME *)sk_value(((_STACK*) (1 ? (sk) : (struct stack_st_X509_NAME*)0)), (i))));
  if ((name == 
# 482 "../ssl/ssl_cert.c" 3 4
              ((void *)0)
# 482 "../ssl/ssl_cert.c"
                  ) || !sk_push(((_STACK*) (1 ? (ret) : (struct stack_st_X509_NAME*)0)), ((void*) (1 ? (name) : (X509_NAME*)0)))) {
   sk_pop_free(((_STACK*) (1 ? (ret) : (struct stack_st_X509_NAME*)0)), ((void (*)(void *)) ((1 ? (X509_NAME_free) : (void (*)(X509_NAME *))0))));
   return (
# 484 "../ssl/ssl_cert.c" 3 4
          ((void *)0)
# 484 "../ssl/ssl_cert.c"
              );
  }
...
void
SSL_set_client_CA_list(SSL *s, struct stack_st_X509_NAME *name_list)
{
 set_client_CA_list(&(s->client_CA), name_list);
}

void
SSL_CTX_set_client_CA_list(SSL_CTX *ctx, struct stack_st_X509_NAME *name_list)
{
...
# 518 "../ssl/ssl_cert.c"
   ...
   return (
# 521 "../ssl/ssl_cert.c" 3 4
          ((void *)0)
# 521 "../ssl/ssl_cert.c"
              );
 } else {
  if (s->client_CA != 
# 523 "../ssl/ssl_cert.c" 3 4
                     ((void *)0)
# 523 "../ssl/ssl_cert.c"
                         )
   return (s->client_CA);
...
static int
add_client_CA(struct stack_st_X509_NAME **sk, X509 *x)
{
 X509_NAME *name;

 if (x == 
# 535 "../ssl/ssl_cert.c" 3 4
         ((void *)0)
# 535 "../ssl/ssl_cert.c"
             )
  return (0);
 if ((*sk == 
# 537 "../ssl/ssl_cert.c" 3 4
            ((void *)0)
# 537 "../ssl/ssl_cert.c"
...
# 537 "../ssl/ssl_cert.c"
 ...
 if ((name = X509_NAME_dup(X509_get_subject_name(x))) == 
# 540 "../ssl/ssl_cert.c" 3 4
                                                        ((void *)0)
# 540 "../ssl/ssl_cert.c"
                                                            )
  return (0);

 if (!sk_push(((_STACK*) (1 ? (*sk) : (struct stack_st_X509_NAME*)0)), ((void*) (1 ? (name) : (X509_NAME*)0)))) {
  X509_NAME_free(name);
  return (0);
 }
 return (1);
...
SSL_load_client_CA_file(const char *file)
{
 BIO *in;
 X509 *x = 
# 580 "../ssl/ssl_cert.c" 3 4
          ((void *)0)
# 580 "../ssl/ssl_cert.c"
              ;
 X509_NAME *xn = 
# 581 "../ssl/ssl_cert.c" 3 4
                ((void *)0)
# 581 "../ssl/ssl_cert.c"
                    ;
 struct stack_st_X509_NAME *ret = 
# 582 "../ssl/ssl_cert.c" 3 4
                           ((void *)0)
# 582 "../ssl/ssl_cert.c"
                               , *sk;

 sk = ((struct stack_st_X509_NAME *)sk_new(((int (*)(const void *, const void *)) ((1 ? (xname_cmp) : (int (*)(const X509_NAME * const *, const X509_NAME * const *))0)))));

 in = BIO_new(BIO_s_file());

 if ((sk == 
# 588 "../ssl/ssl_cert.c" 3 4
           ((void *)0)
# 588 "../ssl/ssl_cert.c"
               ) || (in == 
# 588 "../ssl/ssl_cert.c" 3 4
...
# 588 "../ssl/ssl_cert.c"
  ...
  ERR_put_error(20,(185),((1|64)),"../ssl/ssl_cert.c",589);
  goto err;
 }

 if (!BIO_ctrl(in,108, 0x01|0x02,(char *)file))
  goto err;

 for (;;) {
  if (PEM_read_bio_X509(in, &x, 
# 597 "../ssl/ssl_cert.c" 3 4
                               ((void *)0)
# 597 "../ssl/ssl_cert.c"
                                   , 
# 597 "../ssl/ssl_cert.c" 3 4
...
# 597 "../ssl/ssl_cert.c"
   ...
   break;
  if (ret == 
# 599 "../ssl/ssl_cert.c" 3 4
            ((void *)0)
# 599 "../ssl/ssl_cert.c"
                ) {
   ret = ((struct stack_st_X509_NAME *)sk_new_null());
   if (ret == 
# 601 "../ssl/ssl_cert.c" 3 4
             ((void *)0)
# 601 "../ssl/ssl_cert.c"
                 ) {
    ERR_put_error(20,(185),((1|64)),"../ssl/ssl_cert.c",603)
                             ;
    goto err;
   }
  }
  if ((xn = X509_get_subject_name(x)) == 
# 607 "../ssl/ssl_cert.c" 3 4
                                        ((void *)0)
# 607 "../ssl/ssl_cert.c"
                                            ) goto err;
  ...
  xn = X509_NAME_dup(xn);
  if (xn == 
# 610 "../ssl/ssl_cert.c" 3 4
           ((void *)0)
# 610 "../ssl/ssl_cert.c"
               )
   goto err;
  if (sk_find(((_STACK*) (1 ? (sk) : (struct stack_st_X509_NAME*)0)), ((void*) (1 ? (xn) : (X509_NAME*)0))) >= 0)
   X509_NAME_free(xn);
  else {
   sk_push(((_STACK*) (1 ? (sk) : (struct stack_st_X509_NAME*)0)), ((void*) (1 ? (xn) : (X509_NAME*)0)));
   sk_push(((_STACK*) (1 ? (ret) : (struct stack_st_X509_NAME*)0)), ((void*) (1 ? (xn) : (X509_NAME*)0)));
  }
 }
...
err:
  if (ret != 
# 622 "../ssl/ssl_cert.c" 3 4
            ((void *)0)
# 622 "../ssl/ssl_cert.c"
                )
   sk_pop_free(((_STACK*) (1 ? (ret) : (struct stack_st_X509_NAME*)0)), ((void (*)(void *)) ((1 ? (X509_NAME_free) : (void (*)(X509_NAME *))0))));
  ret = 
# 624 "../ssl/ssl_cert.c" 3 4
       ((void *)0)
# 624 "../ssl/ssl_cert.c"
           ;
 }
 if (sk != 
# 626 "../ssl/ssl_cert.c" 3 4
          ((void *)0)
# 626 "../ssl/ssl_cert.c"
              )
...
# 644 "../ssl/ssl_cert.c"
int
SSL_add_file_cert_subjects_to_stack(struct stack_st_X509_NAME *stack,
    const char *file)
{
 BIO *in;
 X509 *x = 
# 649 "../ssl/ssl_cert.c" 3 4
          ((void *)0)
# 649 "../ssl/ssl_cert.c"
              ;
 X509_NAME *xn = 
# 650 "../ssl/ssl_cert.c" 3 4
                ((void *)0)
# 650 "../ssl/ssl_cert.c"
                    ;
 int ret = 1;
 ...
 oldcmp = ((int (*)(const X509_NAME * const *,const X509_NAME * const *)) sk_set_cmp_func(((_STACK*) (1 ? (stack) : (struct stack_st_X509_NAME*)0)), ((int (*)(const void *, const void *)) ((1 ? (xname_cmp) : (int (*)(const X509_NAME * const *, const X509_NAME * const *))0)))));

 in = BIO_new(BIO_s_file());

 if (in == 
# 658 "../ssl/ssl_cert.c" 3 4
          ((void *)0)
# 658 "../ssl/ssl_cert.c"
              ) {
  ERR_put_error(20,(216),((1|64)),"../ssl/ssl_cert.c",660)
                           ;
  goto err;
 }
...
# 668 "../ssl/ssl_cert.c"
   ...
   break;
  if ((xn = X509_get_subject_name(x)) == 
# 670 "../ssl/ssl_cert.c" 3 4
                                        ((void *)0)
# 670 "../ssl/ssl_cert.c"
                                            ) goto err;
   xn = X509_NAME_dup(xn);
  if (xn == 
# 672 "../ssl/ssl_cert.c" 3 4
           ((void *)0)
# 672 "../ssl/ssl_cert.c"
               )
   goto err;
  if (sk_find(((_STACK*) (1 ? (stack) : (struct stack_st_X509_NAME*)0)), ((void*) (1 ? (xn) : (X509_NAME*)0))) >= 0)
   X509_NAME_free(xn);
  else
   sk_push(((_STACK*) (1 ? (stack) : (struct stack_st_X509_NAME*)0)), ((void*) (1 ? (xn) : (X509_NAME*)0)));
 }
...
err:
 ...
 (void)((int (*)(const X509_NAME * const *,const X509_NAME * const *)) sk_set_cmp_func(((_STACK*) (1 ? (stack) : (struct stack_st_X509_NAME*)0)), ((int (*)(const void *, const void *)) ((1 ? (oldcmp) : (int (*)(const X509_NAME * const *, const X509_NAME * const *))0)))));

 return ret;
}
# 705 "../ssl/ssl_cert.c"
int
SSL_add_dir_cert_subjects_to_stack(struct stack_st_X509_NAME *stack, const char *dir)
{
 DIR *dirp = 
# 708 "../ssl/ssl_cert.c" 3 4
            ((void *)0)
# 708 "../ssl/ssl_cert.c"
                ;
 char *path = 
# 709 "../ssl/ssl_cert.c" 3 4
             ((void *)0)
# 709 "../ssl/ssl_cert.c"
                 ;
 int ret = 0;
...
# 715 "../ssl/ssl_cert.c"
 ...
 if (!ret) {
   ERR_put_error(2,(10),(
# 727 "../ssl/ssl_cert.c" 3 4
  (*__errno_location ())
# 727 "../ssl/ssl_cert.c"
  ),"../ssl/ssl_cert.c",727);
  ERR_asprintf_error_data("opendir ('%s')", dir);
  ERR_put_error(20,(215),(2),"../ssl/ssl_cert.c",729);
 }
 return ret;
}
