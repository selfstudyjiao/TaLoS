...
# 80 "rsa/rsa_sign.c" 3 4
                          ((void *)0)
# 80 "rsa/rsa_sign.c"
                              ;
 const unsigned char *s = 
# 81 "rsa/rsa_sign.c" 3 4
                         ((void *)0)
# 81 "rsa/rsa_sign.c"
                             ;
 X509_ALGOR algor;
 ...
 if ((rsa->flags & 0x0040) && rsa->meth->rsa_sign)
  return rsa->meth->rsa_sign(type, m, m_len, sigret, siglen, rsa);


 if (type == 114) {
  if (m_len != 36) {
   ERR_put_error(4,(117),(131),"rsa/rsa_sign.c",91);
   return 0;
  }
  i = 36;
  s = m;
...
# 99 "rsa/rsa_sign.c" 3 4
                             ((void *)0)
# 99 "rsa/rsa_sign.c"
                                 ) {
   ERR_put_error(4,(117),(117),"rsa/rsa_sign.c",100);
   return 0;
  }
  if (sig.algor->algorithm->length == 0) {
   ERR_put_error(4,(117),(116),"rsa/rsa_sign.c",105)
                                                                 ;
   return 0;
  }
  parameter.type = 5;
  parameter.value.ptr = 
# 109 "rsa/rsa_sign.c" 3 4
                       ((void *)0)
# 109 "rsa/rsa_sign.c"
                           ;
...
# 116 "rsa/rsa_sign.c"
 ...
 j = RSA_size(rsa);
 if (i > j - 11) {
  ERR_put_error(4,(117),(112),"rsa/rsa_sign.c",120);
  return 0;
 }
 if (type != 114) {
  tmps = malloc(j + 1);
  if (tmps == 
# 125 "rsa/rsa_sign.c" 3 4
             ((void *)0)
# 125 "rsa/rsa_sign.c"
                 ) {
   ERR_put_error(4,(117),((1|64)),"rsa/rsa_sign.c",126);
   return 0;
  }
  p = tmps;
  i2d_X509_SIG(&sig, &p);
    ...
    size_t siglen, RSA *rsa)
{
 ...
 unsigned char *s;
 X509_SIG *sig = 
# 153 "rsa/rsa_sign.c" 3 4
                ((void *)0)
# 153 "rsa/rsa_sign.c"
                    ;

 if (siglen != (unsigned int)RSA_size(rsa)) {
  ERR_put_error(4,(145),(119),"rsa/rsa_sign.c",156);
  return 0;
 }
 ...
 s = malloc(siglen);
 if (s == 
# 170 "rsa/rsa_sign.c" 3 4
         ((void *)0)
# 170 "rsa/rsa_sign.c"
             ) {
  ERR_put_error(4,(145),((1|64)),"rsa/rsa_sign.c",171);
  goto err;
 }
 if (dtype == 114 && m_len != 36) {
  ERR_put_error(4,(145),(131),"rsa/rsa_sign.c",175);
  goto err;
 }
 i = RSA_public_decrypt((int)siglen, sigbuf, s, rsa, 1);
 ...
 if (dtype == 114) {
  if (i != 36 || memcmp(s, m, 36))
   ERR_put_error(4,(145),(104),"rsa/rsa_sign.c",186);
  else
   ret = 1;
 } else {
  ...
  sig = d2i_X509_SIG(
# 192 "rsa/rsa_sign.c" 3 4
                    ((void *)0)
# 192 "rsa/rsa_sign.c"
                        , &p, (long)i);

  if (sig == 
# 194 "rsa/rsa_sign.c" 3 4
            ((void *)0)
# 194 "rsa/rsa_sign.c"
                )
   goto err;
  ...
  if (p != s + i) {
   ERR_put_error(4,(145),(104),"rsa/rsa_sign.c",199);
   goto err;
  }
  ...
  if (sig->algor->parameter &&
      ASN1_TYPE_get(sig->algor->parameter) != 5) {
   ERR_put_error(4,(145),(104),"rsa/rsa_sign.c",207);
   goto err;
  }
  ...
  if (sigtype != dtype) {
   ERR_put_error(4,(145),(100),"rsa/rsa_sign.c",214);
   goto err;
  }
  if (rm) {
   const EVP_MD *md;

   md = EVP_get_digestbyname(OBJ_nid2sn(dtype));
   if (md && (EVP_MD_size(md) != sig->digest->length))
    ERR_put_error(4,(145),(143),"rsa/rsa_sign.c",223)
                                    ;
   else {
   ...
   ERR_put_error(4,(145),(104),"rsa/rsa_sign.c",232);
  } else
   ret = 1;
 }
err:
 if (sig != 
# 237 "rsa/rsa_sign.c" 3 4
           ((void *)0)
# 237 "rsa/rsa_sign.c"
               )
  X509_SIG_free(sig);
 if (s != 
# 239 "rsa/rsa_sign.c" 3 4
         ((void *)0)
# 239 "rsa/rsa_sign.c"
             ) {
...
RSA_verify(int dtype, const unsigned char *m, unsigned int m_len,
    const unsigned char *sigbuf, unsigned int siglen, RSA *rsa)
{
 if ((rsa->flags & 0x0040) && rsa->meth->rsa_verify)
  return rsa->meth->rsa_verify(dtype, m, m_len, sigbuf, siglen,
      rsa);

 return int_rsa_verify(dtype, m, m_len, 
# 254 "rsa/rsa_sign.c" 3 4
                                       ((void *)0)
# 254 "rsa/rsa_sign.c"
                                           , 
# 254 "rsa/rsa_sign.c" 3 4
