    ...
    BN_CTX *ctx)
{
 ...
 if (num->top > 0 && num->d[num->top - 1] == 0) {
  ERR_put_error(3,(107),(107),"bn/bn_div.c",134);
  return 0;
 }
 ...
 if (BN_is_zero(divisor)) {
  ERR_put_error(3,(107),(103),"bn/bn_div.c",151);
  return (0);
 }
...
# 173 "bn/bn_div.c"
 ...
 norm_shift = 64 - ((BN_num_bits(divisor)) % 64);
 ...
 if (no_branch) {
  ...
  if (snum->top <= sdiv->top + 1) {
   if ((((sdiv->top + 2) <= (snum)->dmax)?(snum):bn_expand2((snum),(sdiv->top + 2))) == 
# 192 "bn/bn_div.c" 3 4
                                         ((void *)0)
# 192 "bn/bn_div.c"
                                             )
   ...
   if ((((snum->top + 1) <= (snum)->dmax)?(snum):bn_expand2((snum),(snum->top + 1))) == 
# 198 "bn/bn_div.c" 3 4
                                         ((void *)0)
# 198 "bn/bn_div.c"
                                             )
 ...
 for (i = 0; i < loop - 1; i++, wnump--, resp--) {
  ...
  {
# 301 "bn/bn_div.c"
   unsigned long t2l, t2h;

   q = ({ asm volatile ( "divq	%4" : "=a"(q), "=d"(rem) : "a"(n1), "d"(n0), "g"(d0) : "cc"); q; });





   asm ("mulq	%3" : "=a"(t2l),"=d"(t2h) : "a"(d1),"g"(q) : "cc");;
# 324 "bn/bn_div.c"
   for (;;) {
    if ((t2h < rem) ||
        ((t2h == rem) && (t2l <= wnump[-2])))
 ...
 { unsigned long *ftl; int tmp_top = (snum)->top; if (tmp_top > 0) { for (ftl= &((snum)->d[tmp_top-1]); tmp_top > 0; tmp_top--) if (*(ftl--)) break; (snum)->top = tmp_top; } ; };
 if (rm != 
# 362 "bn/bn_div.c" 3 4
          ((void *)0)
# 362 "bn/bn_div.c"
 ...
 if (no_branch)
  { unsigned long *ftl; int tmp_top = (res)->top; if (tmp_top > 0) { for (ftl= &((res)->d[tmp_top-1]); tmp_top > 0; tmp_top--) if (*(ftl--)) break; (res)->top = tmp_top; } ; };
 BN_CTX_end(ctx);
 return (1);
