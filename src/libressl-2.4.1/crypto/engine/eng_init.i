...
engine_unlocked_finish(ENGINE *e, int unlock_for_handlers)
{
 ...
 if ((e->funct_ref == 0) && e->finish) {
  if (unlock_for_handlers)
   CRYPTO_lock(2|8,30,"engine/eng_init.c",99);
  to_return = e->finish(e);
  if (unlock_for_handlers)
   CRYPTO_lock(1|8,30,"engine/eng_init.c",102);
  if (!to_return)
   return 0;
 }
 ...
 if (!engine_free_util(e, 0)) {
  ERR_put_error(38,(191),(106),"engine/eng_init.c",110)
                             ;
  return 0;
 }
 return to_return;
...
ENGINE_init(ENGINE *e)
{
 ...
 if (e == 
# 122 "engine/eng_init.c" 3 4
         ((void *)0)
# 122 "engine/eng_init.c"
             ) {
  ERR_put_error(38,(119),((3|64)),"engine/eng_init.c",123);
  return 0;
 }
 CRYPTO_lock(1|8,30,"engine/eng_init.c",126);
 ret = engine_unlocked_init(e);
 CRYPTO_lock(2|8,30,"engine/eng_init.c",128);
 return ret;
}
...
ENGINE_finish(ENGINE *e)
{
 ...
 if (e == 
# 138 "engine/eng_init.c" 3 4
         ((void *)0)
# 138 "engine/eng_init.c"
             ) {
  ERR_put_error(38,(107),((3|64)),"engine/eng_init.c",139);
  return 0;
 }
 CRYPTO_lock(1|8,30,"engine/eng_init.c",142);
 to_return = engine_unlocked_finish(e, 1);
 CRYPTO_lock(2|8,30,"engine/eng_init.c",144);
 if (!to_return) {
  ERR_put_error(38,(107),(106),"engine/eng_init.c",146);
  return 0;
 }
 return to_return;
}
