...
BIO_new_socket(int fd, int close_flag)
{
 ...
 if (ret == 
# 99 "bio/bss_sock.c" 3 4
           ((void *)0)
# 99 "bio/bss_sock.c"
               )
  return (
# 100 "bio/bss_sock.c" 3 4
         ((void *)0)
# 100 "bio/bss_sock.c"
             );
 BIO_int_ctrl(ret,104,close_flag,fd);
 return (ret);
}
...
sock_read(BIO *b, char *out, int outl)
{
 ...
 if (out != 
# 136 "bio/bss_sock.c" 3 4
           ((void *)0)
# 136 "bio/bss_sock.c"
               ) {
  
# 137 "bio/bss_sock.c" 3 4
 (*__errno_location ()) 
# 137 "bio/bss_sock.c"
       = 0;
...
BIO_sock_non_fatal_error(int err)
{
 switch (err) {
 case 
# 228 "bio/bss_sock.c" 3 4
     107
# 228 "bio/bss_sock.c"
             :
 case 
# 229 "bio/bss_sock.c" 3 4
     4
# 229 "bio/bss_sock.c"
          :
 case 
# 230 "bio/bss_sock.c" 3 4
     11
# 230 "bio/bss_sock.c"
           :
 case 
# 231 "bio/bss_sock.c" 3 4
     115
# 231 "bio/bss_sock.c"
                :
 case 
# 232 "bio/bss_sock.c" 3 4
     114
# 232 "bio/bss_sock.c"
             :
  return (1);
