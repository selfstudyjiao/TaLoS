...
# 65 "asn1/tasn_enc.c" 2

static int asn1_i2d_ex_primitive(ASN1_VALUE **pval, unsigned char **out,
    const ASN1_ITEM *it, int tag, int aclass);
static int asn1_set_seq_out(struct stack_st_ASN1_VALUE *sk, unsigned char **out,
...
{
 return asn1_item_flags_i2d(val, out, it, (0x1<<11));
}
...
# 133 "asn1/tasn_enc.c"
 ...
 ASN1_aux_cb *asn1_cb = 
# 137 "asn1/tasn_enc.c" 3 4
                       ((void *)0)
# 137 "asn1/tasn_enc.c"
                           ;

 if ((it->itype != 0x0) && !*pval)
  return 0;
 ...
 case 0x2:
  if (asn1_cb && !asn1_cb(6, pval, it, 
# 158 "asn1/tasn_enc.c" 3 4
                                                    ((void *)0)
# 158 "asn1/tasn_enc.c"
                                                        ))
   return 0;
  ...
  if (asn1_cb && !asn1_cb(7, pval, it, 
# 170 "asn1/tasn_enc.c" 3 4
                                                     ((void *)0)
# 170 "asn1/tasn_enc.c"
                                                         ))
   return 0;
    ...
    const ASN1_TEMPLATE *tt, int tag, int iclass)
{
 ...
 if (flags & (0x3 << 1)) {
  ...
  struct stack_st_ASN1_VALUE *sk = (struct stack_st_ASN1_VALUE *)*pval;
  ...
  skcontlen = 0;
  for (i = 0; i < sk_num(((_STACK*) (1 ? (sk) : (struct stack_st_ASN1_VALUE*)0))); i++) {
   skitem = ((ASN1_VALUE *)sk_value(((_STACK*) (1 ? (sk) : (struct stack_st_ASN1_VALUE*)0)), (i)));
   skcontlen += ASN1_item_ex_i2d(&skitem, 
# 332 "asn1/tasn_enc.c" 3 4
                                         ((void *)0)
# 332 "asn1/tasn_enc.c"
                                             ,
       (tt->item), -1, iclass);
 ...
 if (flags & (0x2 << 3)) {
  ...
  i = ASN1_item_ex_i2d(pval, 
# 366 "asn1/tasn_enc.c" 3 4
                            ((void *)0)
# 366 "asn1/tasn_enc.c"
                                , (tt->item),
      -1, iclass);
...
static int
asn1_set_seq_out(struct stack_st_ASN1_VALUE *sk, unsigned char **out, int skcontlen,
    const ASN1_ITEM *item, int do_sort, int iclass)
{
 int i;
 ASN1_VALUE *skitem;
 unsigned char *tmpdat = 
# 417 "asn1/tasn_enc.c" 3 4
                        ((void *)0)
# 417 "asn1/tasn_enc.c"
                            , *p = 
# 417 "asn1/tasn_enc.c" 3 4
...
# 418 "asn1/tasn_enc.c"
 ...
 if (do_sort) {
  ...
  if (sk_num(((_STACK*) (1 ? (sk) : (struct stack_st_ASN1_VALUE*)0))) < 2)
   do_sort = 0;
  else {
   derlst = reallocarray(
# 425 "asn1/tasn_enc.c" 3 4
                        ((void *)0)
# 425 "asn1/tasn_enc.c"
                            , sk_num(((_STACK*) (1 ? (sk) : (struct stack_st_ASN1_VALUE*)0))),
       sizeof(*derlst));
 ...
 for (i = 0, tder = derlst; i < sk_num(((_STACK*) (1 ? (sk) : (struct stack_st_ASN1_VALUE*)0))); i++, tder++) {
  skitem = ((ASN1_VALUE *)sk_value(((_STACK*) (1 ? (sk) : (struct stack_st_ASN1_VALUE*)0)), (i)));
  tder->data = p;
 ...
 qsort(derlst, sk_num(((_STACK*) (1 ? (sk) : (struct stack_st_ASN1_VALUE*)0))), sizeof(*derlst), der_cmp);
    ...
    const ASN1_ITEM *it, int tag, int aclass)
{
 ...
 len = asn1_ex_i2c(pval, 
# 487 "asn1/tasn_enc.c" 3 4
                        ((void *)0)
# 487 "asn1/tasn_enc.c"
                            , &utype, it);
