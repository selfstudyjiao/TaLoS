...
PKCS7_ctrl(PKCS7 *p7, int cmd, long larg, char *parg)
{
 ...
 case 1:
  if (nid == 22) {
   ...
   if (ret && (OBJ_obj2nid((p7->d.sign->contents)->type) == 21)) {
    ASN1_OCTET_STRING *os;
    os = p7->d.sign->contents->d.data;
    ASN1_OCTET_STRING_free(os);
    p7->d.sign->contents->d.data = 
# 83 "pkcs7/pk7_lib.c" 3 4
                                  ((void *)0)
# 83 "pkcs7/pk7_lib.c"
                                      ;
   }
  } else {
   ERR_put_error(33,(104),(104),"pkcs7/pk7_lib.c",87)
                                                    ;
   ret = 0;
  }
  break;
 case 2:
  if (nid == 22) {
   ...
   ERR_put_error(33,(104),(104),"pkcs7/pk7_lib.c",101)
                                                    ;
   ret = 0;
  }
  ...
  break;
 default:
  ERR_put_error(33,(104),(110),"pkcs7/pk7_lib.c",107);
  ret = 0;
 }
 return (ret);
}
...
{
 PKCS7 *ret = 
# 116 "pkcs7/pk7_lib.c" 3 4
             ((void *)0)
# 116 "pkcs7/pk7_lib.c"
                 ;

 if ((ret = PKCS7_new()) == 
# 118 "pkcs7/pk7_lib.c" 3 4
                           ((void *)0)
# 118 "pkcs7/pk7_lib.c"
                               )
  goto err;
...
# 140 "pkcs7/pk7_lib.c"
  ...
  break;
 case 25:
  if (p7->d.digest->contents != 
# 145 "pkcs7/pk7_lib.c" 3 4
                               ((void *)0)
# 145 "pkcs7/pk7_lib.c"
                                   )
 ...
 case 26:
 default:
  ERR_put_error(33,(109),(112),"pkcs7/pk7_lib.c",155)
                                       ;
  goto err;
 }
 return (1);
...
PKCS7_set_type(PKCS7 *p7, int type)
{
 ...
 case 22:
  p7->type = obj;
  if ((p7->d.sign = PKCS7_SIGNED_new()) == 
# 174 "pkcs7/pk7_lib.c" 3 4
                                          ((void *)0)
# 174 "pkcs7/pk7_lib.c"
                                              )
   goto err;
...
# 219 "pkcs7/pk7_lib.c"
  ...
  break;
 default:
  ERR_put_error(33,(110),(112),"pkcs7/pk7_lib.c",226)
                                       ;
  goto err;
 }
 return (1);
...
PKCS7_add_signer(PKCS7 *p7, PKCS7_SIGNER_INFO *psi)
{
 int i, j, nid;
 X509_ALGOR *alg;
 struct stack_st_PKCS7_SIGNER_INFO *signer_sk;
 ...
 case 24:
  ...
  break;
 default:
  ERR_put_error(33,(103),(113),"pkcs7/pk7_lib.c",261);
  return (0);
 }
 ...
 for (i = 0; i < sk_num(((_STACK*) (1 ? (md_sk) : (struct stack_st_X509_ALGOR*)0))); i++) {
  alg = ((X509_ALGOR *)sk_value(((_STACK*) (1 ? (md_sk) : (struct stack_st_X509_ALGOR*)0)), (i)));
 ...
 if (!j)
 {
  if (!(alg = X509_ALGOR_new()) ||
   ...
   X509_ALGOR_free(alg);
   ERR_put_error(33,(103),((1|64)),"pkcs7/pk7_lib.c",282)
                            ;
   return (0);
  }
  alg->algorithm = OBJ_nid2obj(nid);
  alg->parameter->type = 5;
  if (!sk_push(((_STACK*) (1 ? (md_sk) : (struct stack_st_X509_ALGOR*)0)), ((void*) (1 ? (alg) : (X509_ALGOR*)0)))) {
   X509_ALGOR_free(alg);
   return 0;
  }
 }

 if (!sk_push(((_STACK*) (1 ? (signer_sk) : (struct stack_st_PKCS7_SIGNER_INFO*)0)), ((void*) (1 ? (psi) : (PKCS7_SIGNER_INFO*)0))))
  return 0;
 return (1);
}
...
PKCS7_add_certificate(PKCS7 *p7, X509 *x509)
{
 ...
 case 24:
  ...
  break;
 default:
  ERR_put_error(33,(100),(113),"pkcs7/pk7_lib.c",314)
                                 ;
  return (0);
 }

 if (*sk == 
# 318 "pkcs7/pk7_lib.c" 3 4
           ((void *)0)
# 318 "pkcs7/pk7_lib.c"
               )
  *sk = ((struct stack_st_X509 *)sk_new_null());
 if (*sk == 
# 320 "pkcs7/pk7_lib.c" 3 4
           ((void *)0)
# 320 "pkcs7/pk7_lib.c"
               ) {
  ERR_put_error(33,(100),((1|64)),"pkcs7/pk7_lib.c",321);
  return 0;
 }
 CRYPTO_add_lock(&x509->references,1,3,"pkcs7/pk7_lib.c",324);
 if (!sk_push(((_STACK*) (1 ? (*sk) : (struct stack_st_X509*)0)), ((void*) (1 ? (x509) : (X509*)0)))) {
  X509_free(x509);
  return 0;
 }
 return (1);
...
PKCS7_add_crl(PKCS7 *p7, X509_CRL *crl)
{
 ...
 case 24:
  ...
  break;
 default:
  ERR_put_error(33,(101),(113),"pkcs7/pk7_lib.c",347);
  return (0);
 }

 if (*sk == 
# 351 "pkcs7/pk7_lib.c" 3 4
           ((void *)0)
# 351 "pkcs7/pk7_lib.c"
               )
  *sk = ((struct stack_st_X509_CRL *)sk_new_null());
 if (*sk == 
# 353 "pkcs7/pk7_lib.c" 3 4
           ((void *)0)
# 353 "pkcs7/pk7_lib.c"
               ) {
  ERR_put_error(33,(101),((1|64)),"pkcs7/pk7_lib.c",354);
  return 0;
 }

 CRYPTO_add_lock(&crl->references,1,6,"pkcs7/pk7_lib.c",358);
 if (!sk_push(((_STACK*) (1 ? (*sk) : (struct stack_st_X509_CRL*)0)), ((void*) (1 ? (crl) : (X509_CRL*)0)))) {
  X509_CRL_free(crl);
  return 0;
 }
 return (1);
    ...
    const EVP_MD *dgst)
{
 ...
 CRYPTO_add_lock(&pkey->references,1,10,"pkcs7/pk7_lib.c",387);
 p7i->pkey = pkey;
 ...
 X509_ALGOR_set0(p7i->digest_alg, OBJ_nid2obj(EVP_MD_type(dgst)),
     5, 
# 393 "pkcs7/pk7_lib.c" 3 4
                 ((void *)0)
# 393 "pkcs7/pk7_lib.c"
                     );

 if (pkey->ameth && pkey->ameth->pkey_ctrl) {
  ret = pkey->ameth->pkey_ctrl(pkey, 0x1,
      0, p7i);
  if (ret > 0)
   return 1;
  if (ret != -2) {
   ERR_put_error(33,(129),(147),"pkcs7/pk7_lib.c",402)
                                    ;
   return 0;
  }
 }
 ERR_put_error(33,(129),(148),"pkcs7/pk7_lib.c",407)
                                                     ;
err:
 return 0;
}
...
# 415 "pkcs7/pk7_lib.c" 3 4
                        ((void *)0)
# 415 "pkcs7/pk7_lib.c"
                            ;

 if (dgst == 
# 417 "pkcs7/pk7_lib.c" 3 4
            ((void *)0)
# 417 "pkcs7/pk7_lib.c"
                ) {
  int def_nid;
  if (EVP_PKEY_get_default_digest_nid(pkey, &def_nid) <= 0)
   goto err;
  dgst = EVP_get_digestbyname(OBJ_nid2sn(def_nid));
  if (dgst == 
# 422 "pkcs7/pk7_lib.c" 3 4
             ((void *)0)
# 422 "pkcs7/pk7_lib.c"
                 ) {
   ERR_put_error(33,(131),(151),"pkcs7/pk7_lib.c",424)
                                 ;
   goto err;
  }
 }
...
PKCS7_set_digest(PKCS7 *p7, const EVP_MD *md)
{
 if ((OBJ_obj2nid((p7)->type) == 25)) {
  if (!(p7->d.digest->md->parameter = ASN1_TYPE_new())) {
   ERR_put_error(33,(126),((1|64)),"pkcs7/pk7_lib.c",448)
                            ;
   return 0;
  }
  p7->d.digest->md->parameter->type = 5;
  p7->d.digest->md->algorithm = OBJ_nid2obj(EVP_MD_type(md));
  return 1;
 }

 ERR_put_error(33,(126),(113),"pkcs7/pk7_lib.c",456);
 return 1;
}
...
{
 int i;
 struct stack_st_PKCS7_RECIP_INFO *sk;
 ...
 case 23:
  ...
  break;
 default:
  ERR_put_error(33,(102),(113),"pkcs7/pk7_lib.c",526)
                                 ;
  return (0);
 }

 if (!sk_push(((_STACK*) (1 ? (sk) : (struct stack_st_PKCS7_RECIP_INFO*)0)), ((void*) (1 ? (ri) : (PKCS7_RECIP_INFO*)0))))
  return 0;
 return (1);
}
...
# 539 "pkcs7/pk7_lib.c"
 ...
 if (!pkey || !pkey->ameth || !pkey->ameth->pkey_ctrl) {
  ERR_put_error(33,(130),(150),"pkcs7/pk7_lib.c",555)
                                                         ;
  goto err;
 }

 ret = pkey->ameth->pkey_ctrl(pkey, 0x2,
     0, p7i);
 if (ret == -2) {
  ERR_put_error(33,(130),(150),"pkcs7/pk7_lib.c",563)
                                                         ;
  goto err;
 }
 if (ret <= 0) {
  ERR_put_error(33,(130),(149),"pkcs7/pk7_lib.c",568)
                                      ;
  goto err;
 }
 ...
 CRYPTO_add_lock(&x509->references,1,3,"pkcs7/pk7_lib.c",574);
 p7i->cert = x509;
...
PKCS7_set_cipher(PKCS7 *p7, const EVP_CIPHER *cipher)
{
 ...
 case 23:
  ...
  break;
 default:
  ERR_put_error(33,(108),(113),"pkcs7/pk7_lib.c",610);
  return (0);
 }
 ...
 if (i == 0) {
  ERR_put_error(33,(108),(144),"pkcs7/pk7_lib.c",618)
                                              ;
  return (0);
 }
