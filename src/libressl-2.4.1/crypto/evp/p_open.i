...
# 76 "evp/p_open.c"
 ...
 if (type) {
  ...
  if (!EVP_DecryptInit_ex(ctx, type, 
# 81 "evp/p_open.c" 3 4
                                    ((void *)0)
# 81 "evp/p_open.c"
                                        , 
...
# 81 "evp/p_open.c"
 ...
 if (priv->type != 6) {
  ERR_put_error(6,(102),(106),"evp/p_open.c",89);
  goto err;
 }
...
# 95 "evp/p_open.c"
  ...
  ERR_put_error(6,(102),((1|64)),"evp/p_open.c",97);
  goto err;
 }
...
EVP_OpenFinal(EVP_CIPHER_CTX *ctx, unsigned char *out, int *outl)
{
 ...
 if (i)
  i = EVP_DecryptInit_ex(ctx, 
# 125 "evp/p_open.c" 3 4
                             ((void *)0)
# 125 "evp/p_open.c"
                                 , 
# 125 "evp/p_open.c" 3 4
