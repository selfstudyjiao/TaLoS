...
# 177 "ec/ecp_smpl.c"
 ...
 if (BN_num_bits(p) <= 2 || !(((p)->top > 0) && ((p)->d[0] & 1))) {
  ERR_put_error(16,(166),(103),"ec/ecp_smpl.c",182);
  return 0;
 }
 if (ctx == 
# 185 "ec/ecp_smpl.c" 3 4
           ((void *)0)
# 185 "ec/ecp_smpl.c"
               ) {
  ctx = new_ctx = BN_CTX_new();
  if (ctx == 
# 187 "ec/ecp_smpl.c" 3 4
            ((void *)0)
# 187 "ec/ecp_smpl.c"
                )
   return 0;
 ...
 BN_CTX_start(ctx);
 if ((tmp_a = BN_CTX_get(ctx)) == 
# 191 "ec/ecp_smpl.c" 3 4
                                 ((void *)0)
# 191 "ec/ecp_smpl.c"
                                     )
  goto err;
...
ec_GFp_simple_group_get_curve(const EC_GROUP * group, BIGNUM * p, BIGNUM * a, BIGNUM * b, BN_CTX * ctx)
{
 int ret = 0;
 BN_CTX *new_ctx = 
# 233 "ec/ecp_smpl.c" 3 4
                  ((void *)0)
# 233 "ec/ecp_smpl.c"
                      ;

 if (p != 
# 235 "ec/ecp_smpl.c" 3 4
         ((void *)0)
# 235 "ec/ecp_smpl.c"
             ) {
...
# 239 "ec/ecp_smpl.c"
  ...
  if (group->meth->field_decode) {
   if (ctx == 
# 241 "ec/ecp_smpl.c" 3 4
             ((void *)0)
# 241 "ec/ecp_smpl.c"
                 ) {
    ctx = new_ctx = BN_CTX_new();
    if (ctx == 
# 243 "ec/ecp_smpl.c" 3 4
              ((void *)0)
# 243 "ec/ecp_smpl.c"
                  )
     return 0;
...
ec_GFp_simple_group_check_discriminant(const EC_GROUP * group, BN_CTX * ctx)
{
 ...
 BN_CTX *new_ctx = 
# 286 "ec/ecp_smpl.c" 3 4
                  ((void *)0)
# 286 "ec/ecp_smpl.c"
                      ;

 if (ctx == 
# 288 "ec/ecp_smpl.c" 3 4
           ((void *)0)
# 288 "ec/ecp_smpl.c"
               ) {
  ctx = new_ctx = BN_CTX_new();
  if (ctx == 
# 290 "ec/ecp_smpl.c" 3 4
            ((void *)0)
# 290 "ec/ecp_smpl.c"
                ) {
   ERR_put_error(16,(165),((1|64)),"ec/ecp_smpl.c",291);
   goto err;
  }
 }
 BN_CTX_start(ctx);
 if ((a = BN_CTX_get(ctx)) == 
# 296 "ec/ecp_smpl.c" 3 4
                             ((void *)0)
# 296 "ec/ecp_smpl.c"
                                 )
  goto err;
 if ((b = BN_CTX_get(ctx)) == 
# 298 "ec/ecp_smpl.c" 3 4
                             ((void *)0)
# 298 "ec/ecp_smpl.c"
                                 )
  goto err;
 if ((tmp_1 = BN_CTX_get(ctx)) == 
# 300 "ec/ecp_smpl.c" 3 4
                                 ((void *)0)
# 300 "ec/ecp_smpl.c"
                                     )
  goto err;
 if ((tmp_2 = BN_CTX_get(ctx)) == 
# 302 "ec/ecp_smpl.c" 3 4
                                 ((void *)0)
# 302 "ec/ecp_smpl.c"
                                     )
  goto err;
 if ((order = BN_CTX_get(ctx)) == 
# 304 "ec/ecp_smpl.c" 3 4
                                 ((void *)0)
# 304 "ec/ecp_smpl.c"
                                     )
  goto err;
...
# 415 "ec/ecp_smpl.c"
 ...
 if (ctx == 
# 418 "ec/ecp_smpl.c" 3 4
           ((void *)0)
# 418 "ec/ecp_smpl.c"
               ) {
  ctx = new_ctx = BN_CTX_new();
  if (ctx == 
# 420 "ec/ecp_smpl.c" 3 4
            ((void *)0)
# 420 "ec/ecp_smpl.c"
                )
   return 0;
...
# 439 "ec/ecp_smpl.c"
  ...
  if (!BN_nnmod(&point->Z, z, &group->field, ctx))
   goto err;
  Z_is_one = ((((((&point->Z))->top == 1) && (((&point->Z))->d[0] == (unsigned long)(1))) || (((1) == 0) && (((&point->Z))->top == 0))) && !(&point->Z)->neg);
  if (group->meth->field_encode) {
...
# 468 "ec/ecp_smpl.c"
 ...
 if (group->meth->field_decode != 0) {
  if (ctx == 
# 472 "ec/ecp_smpl.c" 3 4
            ((void *)0)
# 472 "ec/ecp_smpl.c"
                ) {
   ctx = new_ctx = BN_CTX_new();
   if (ctx == 
# 474 "ec/ecp_smpl.c" 3 4
             ((void *)0)
# 474 "ec/ecp_smpl.c"
                 )
    return 0;
...
# 516 "ec/ecp_smpl.c"
  ...
  ERR_put_error(16,(168),((3|64)),"ec/ecp_smpl.c",518);
  return 0;
 }
...
# 529 "ec/ecp_smpl.c"
 ...
 if (EC_POINT_is_at_infinity(group, point) > 0) {
  ERR_put_error(16,(167),(106),"ec/ecp_smpl.c",535);
  return 0;
 }
 if (ctx == 
# 538 "ec/ecp_smpl.c" 3 4
           ((void *)0)
# 538 "ec/ecp_smpl.c"
               ) {
  ctx = new_ctx = BN_CTX_new();
  if (ctx == 
# 540 "ec/ecp_smpl.c" 3 4
            ((void *)0)
# 540 "ec/ecp_smpl.c"
                )
   return 0;
 ...
 BN_CTX_start(ctx);
 if ((Z = BN_CTX_get(ctx)) == 
# 544 "ec/ecp_smpl.c" 3 4
                             ((void *)0)
# 544 "ec/ecp_smpl.c"
                                 )
  goto err;
 if ((Z_1 = BN_CTX_get(ctx)) == 
# 546 "ec/ecp_smpl.c" 3 4
                               ((void *)0)
# 546 "ec/ecp_smpl.c"
                                   )
  goto err;
 if ((Z_2 = BN_CTX_get(ctx)) == 
# 548 "ec/ecp_smpl.c" 3 4
                               ((void *)0)
# 548 "ec/ecp_smpl.c"
                                   )
  goto err;
 if ((Z_3 = BN_CTX_get(ctx)) == 
# 550 "ec/ecp_smpl.c" 3 4
                               ((void *)0)
# 550 "ec/ecp_smpl.c"
                                   )
  goto err;
 ...
 if (((((((Z_))->top == 1) && (((Z_))->d[0] == (unsigned long)(1))) || (((1) == 0) && (((Z_))->top == 0))) && !(Z_)->neg)) {
  if (group->meth->field_decode) {
   if (x != 
# 565 "ec/ecp_smpl.c" 3 4
           ((void *)0)
# 565 "ec/ecp_smpl.c"
               ) {
    if (!group->meth->field_decode(group, x, &point->X, ctx))
...
# 578 "ec/ecp_smpl.c"
  ...
  if (!BN_mod_inverse(Z_1, Z_, &group->field, ctx)) {
   ERR_put_error(16,(167),(3),"ec/ecp_smpl.c",585);
   goto err;
  }
...
# 638 "ec/ecp_smpl.c"
 ...
 if (ctx == 
# 653 "ec/ecp_smpl.c" 3 4
           ((void *)0)
# 653 "ec/ecp_smpl.c"
               ) {
  ctx = new_ctx = BN_CTX_new();
  if (ctx == 
# 655 "ec/ecp_smpl.c" 3 4
            ((void *)0)
# 655 "ec/ecp_smpl.c"
                )
   return 0;
 ...
 BN_CTX_start(ctx);
 if ((n0 = BN_CTX_get(ctx)) == 
# 659 "ec/ecp_smpl.c" 3 4
                              ((void *)0)
# 659 "ec/ecp_smpl.c"
                                  )
  goto end;
 if ((n1 = BN_CTX_get(ctx)) == 
# 661 "ec/ecp_smpl.c" 3 4
                              ((void *)0)
# 661 "ec/ecp_smpl.c"
                                  )
  goto end;
 if ((n2 = BN_CTX_get(ctx)) == 
# 663 "ec/ecp_smpl.c" 3 4
                              ((void *)0)
# 663 "ec/ecp_smpl.c"
                                  )
  goto end;
 if ((n3 = BN_CTX_get(ctx)) == 
# 665 "ec/ecp_smpl.c" 3 4
                              ((void *)0)
# 665 "ec/ecp_smpl.c"
                                  )
  goto end;
 if ((n4 = BN_CTX_get(ctx)) == 
# 667 "ec/ecp_smpl.c" 3 4
                              ((void *)0)
# 667 "ec/ecp_smpl.c"
                                  )
  goto end;
 if ((n5 = BN_CTX_get(ctx)) == 
# 669 "ec/ecp_smpl.c" 3 4
                              ((void *)0)
# 669 "ec/ecp_smpl.c"
                                  )
  goto end;
 if ((n6 = BN_CTX_get(ctx)) == 
# 671 "ec/ecp_smpl.c" 3 4
                              ((void *)0)
# 671 "ec/ecp_smpl.c"
                                  )
  goto end;
...
# 827 "ec/ecp_smpl.c"
 ...
 if (ctx == 
# 840 "ec/ecp_smpl.c" 3 4
           ((void *)0)
# 840 "ec/ecp_smpl.c"
               ) {
  ctx = new_ctx = BN_CTX_new();
  if (ctx == 
# 842 "ec/ecp_smpl.c" 3 4
            ((void *)0)
# 842 "ec/ecp_smpl.c"
                )
   return 0;
 ...
 BN_CTX_start(ctx);
 if ((n0 = BN_CTX_get(ctx)) == 
# 846 "ec/ecp_smpl.c" 3 4
                              ((void *)0)
# 846 "ec/ecp_smpl.c"
                                  )
  goto err;
 if ((n1 = BN_CTX_get(ctx)) == 
# 848 "ec/ecp_smpl.c" 3 4
                              ((void *)0)
# 848 "ec/ecp_smpl.c"
                                  )
  goto err;
 if ((n2 = BN_CTX_get(ctx)) == 
# 850 "ec/ecp_smpl.c" 3 4
                              ((void *)0)
# 850 "ec/ecp_smpl.c"
                                  )
  goto err;
 if ((n3 = BN_CTX_get(ctx)) == 
# 852 "ec/ecp_smpl.c" 3 4
                              ((void *)0)
# 852 "ec/ecp_smpl.c"
                                  )
  goto err;
...
# 987 "ec/ecp_smpl.c"
 ...
 if (ctx == 
# 998 "ec/ecp_smpl.c" 3 4
           ((void *)0)
# 998 "ec/ecp_smpl.c"
               ) {
  ctx = new_ctx = BN_CTX_new();
  if (ctx == 
# 1000 "ec/ecp_smpl.c" 3 4
            ((void *)0)
# 1000 "ec/ecp_smpl.c"
                )
   return -1;
 ...
 BN_CTX_start(ctx);
 if ((rh = BN_CTX_get(ctx)) == 
# 1004 "ec/ecp_smpl.c" 3 4
                              ((void *)0)
# 1004 "ec/ecp_smpl.c"
                                  )
  goto err;
 if ((tmp = BN_CTX_get(ctx)) == 
# 1006 "ec/ecp_smpl.c" 3 4
                               ((void *)0)
# 1006 "ec/ecp_smpl.c"
                                   )
  goto err;
 if ((Z4 = BN_CTX_get(ctx)) == 
# 1008 "ec/ecp_smpl.c" 3 4
                              ((void *)0)
# 1008 "ec/ecp_smpl.c"
                                  )
  goto err;
 if ((Z6 = BN_CTX_get(ctx)) == 
# 1010 "ec/ecp_smpl.c" 3 4
                              ((void *)0)
# 1010 "ec/ecp_smpl.c"
                                  )
  goto err;
...
# 1094 "ec/ecp_smpl.c"
 ...
 if (ctx == 
# 1111 "ec/ecp_smpl.c" 3 4
           ((void *)0)
# 1111 "ec/ecp_smpl.c"
               ) {
  ctx = new_ctx = BN_CTX_new();
  if (ctx == 
# 1113 "ec/ecp_smpl.c" 3 4
            ((void *)0)
# 1113 "ec/ecp_smpl.c"
                )
   return -1;
 ...
 BN_CTX_start(ctx);
 if ((tmp1 = BN_CTX_get(ctx)) == 
# 1117 "ec/ecp_smpl.c" 3 4
                                ((void *)0)
# 1117 "ec/ecp_smpl.c"
                                    )
  goto end;
 if ((tmp2 = BN_CTX_get(ctx)) == 
# 1119 "ec/ecp_smpl.c" 3 4
                                ((void *)0)
# 1119 "ec/ecp_smpl.c"
                                    )
  goto end;
 if ((Za23 = BN_CTX_get(ctx)) == 
# 1121 "ec/ecp_smpl.c" 3 4
                                ((void *)0)
# 1121 "ec/ecp_smpl.c"
                                    )
  goto end;
 if ((Zb23 = BN_CTX_get(ctx)) == 
# 1123 "ec/ecp_smpl.c" 3 4
                                ((void *)0)
# 1123 "ec/ecp_smpl.c"
                                    )
  goto end;
...
# 1189 "ec/ecp_smpl.c"
 ...
 if (ctx == 
# 1196 "ec/ecp_smpl.c" 3 4
           ((void *)0)
# 1196 "ec/ecp_smpl.c"
               ) {
  ctx = new_ctx = BN_CTX_new();
  if (ctx == 
# 1198 "ec/ecp_smpl.c" 3 4
            ((void *)0)
# 1198 "ec/ecp_smpl.c"
                )
   return 0;
 ...
 BN_CTX_start(ctx);
 if ((x = BN_CTX_get(ctx)) == 
# 1202 "ec/ecp_smpl.c" 3 4
                             ((void *)0)
# 1202 "ec/ecp_smpl.c"
                                 )
  goto err;
 if ((y = BN_CTX_get(ctx)) == 
# 1204 "ec/ecp_smpl.c" 3 4
                             ((void *)0)
# 1204 "ec/ecp_smpl.c"
                                 )
  goto err;
 ...
 if (!EC_POINT_set_affine_coordinates_GFp(group, point, x, y, ctx))
  goto err;
 if (!point->Z_is_one) {
  ERR_put_error(16,(102),((4|64)),"ec/ecp_smpl.c",1212);
  goto err;
 }
 ret = 1;
...
# 1230 "ec/ecp_smpl.c"
 ...
 if (ctx == 
# 1237 "ec/ecp_smpl.c" 3 4
           ((void *)0)
# 1237 "ec/ecp_smpl.c"
               ) {
  ctx = new_ctx = BN_CTX_new();
  if (ctx == 
# 1239 "ec/ecp_smpl.c" 3 4
            ((void *)0)
# 1239 "ec/ecp_smpl.c"
                )
   return 0;
 ...
 BN_CTX_start(ctx);
 if ((tmp0 = BN_CTX_get(ctx)) == 
# 1243 "ec/ecp_smpl.c" 3 4
                                ((void *)0)
# 1243 "ec/ecp_smpl.c"
                                    )
  goto err;
 if ((tmp1 = BN_CTX_get(ctx)) == 
# 1245 "ec/ecp_smpl.c" 3 4
                                ((void *)0)
# 1245 "ec/ecp_smpl.c"
                                    )
  goto err;
# 1255 "ec/ecp_smpl.c"
 ...
 heap = reallocarray(
# 1264 "ec/ecp_smpl.c" 3 4
                    ((void *)0)
# 1264 "ec/ecp_smpl.c"
                        , pow2, sizeof heap[0]);
 if (heap == 
# 1265 "ec/ecp_smpl.c" 3 4
            ((void *)0)
# 1265 "ec/ecp_smpl.c"
                )
  goto err;
# 1281 "ec/ecp_smpl.c"
 heap[0] = 
# 1281 "ec/ecp_smpl.c" 3 4
          ((void *)0)
# 1281 "ec/ecp_smpl.c"
              ;
 for (i = pow2 / 2 - 1; i > 0; i--)
  heap[i] = 
# 1283 "ec/ecp_smpl.c" 3 4
           ((void *)0)
# 1283 "ec/ecp_smpl.c"
               ;
 for (i = 0; i < num; i++)
...
# 1292 "ec/ecp_smpl.c"
  ...
  if (heap[2 * i] != 
# 1295 "ec/ecp_smpl.c" 3 4
                    ((void *)0)
# 1295 "ec/ecp_smpl.c"
                        ) {
   if ((heap[2 * i + 1] == 
# 1296 "ec/ecp_smpl.c" 3 4
                          ((void *)0)
# 1296 "ec/ecp_smpl.c"
 ...
 if (!BN_is_zero(heap[1])) {
  if (!BN_mod_inverse(heap[1], heap[1], &group->field, ctx)) {
   ERR_put_error(16,(137),(3),"ec/ecp_smpl.c",1315);
   goto err;
  }
 }
 if (group->meth->field_encode != 0) {
