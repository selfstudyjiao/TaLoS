...
{
 return (X509v3_add_ext(&(x->crl->extensions), ex, loc) != 
# 120 "x509/x509_ext.c" 3 4
                                                          ((void *)0)
# 120 "x509/x509_ext.c"
                                                              );
}
...
{
 return (X509v3_add_ext(&(x->cert_info->extensions), ex, loc) != 
# 177 "x509/x509_ext.c" 3 4
                                                                ((void *)0)
# 177 "x509/x509_ext.c"
                                                                    );
}
...
# 182 "x509/x509_ext.c" 2

extern sgx_status_t ocall_malloc(void** retval, size_t size);

BASIC_CONSTRAINTS *out_bc = 
# 185 "x509/x509_ext.c" 3 4
                           ((void *)0)
# 185 "x509/x509_ext.c"
                               ;
BASIC_CONSTRAINTS *in_bc = 
# 186 "x509/x509_ext.c" 3 4
                          ((void *)0)
# 186 "x509/x509_ext.c"
                              ;
...
{
 return (X509v3_add_ext(&(x->extensions), ex, loc) != 
# 263 "x509/x509_ext.c" 3 4
                                                     ((void *)0)
# 263 "x509/x509_ext.c"
                                                         );
}
