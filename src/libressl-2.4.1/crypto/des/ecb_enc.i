...
void DES_ecb_encrypt(const_DES_cblock *input, DES_cblock *output,
 ...
 (l =((unsigned int)(*((in)++))) , l|=((unsigned int)(*((in)++)))<< 8L, l|=((unsigned int)(*((in)++)))<<16L, l|=((unsigned int)(*((in)++)))<<24L); ll[0]=l;
 (l =((unsigned int)(*((in)++))) , l|=((unsigned int)(*((in)++)))<< 8L, l|=((unsigned int)(*((in)++)))<<16L, l|=((unsigned int)(*((in)++)))<<24L); ll[1]=l;
 DES_encrypt1(ll,ks,enc);
 l=ll[0]; (*((out)++)=(unsigned char)(((l) )&0xff), *((out)++)=(unsigned char)(((l)>> 8L)&0xff), *((out)++)=(unsigned char)(((l)>>16L)&0xff), *((out)++)=(unsigned char)(((l)>>24L)&0xff));
 l=ll[1]; (*((out)++)=(unsigned char)(((l) )&0xff), *((out)++)=(unsigned char)(((l)>> 8L)&0xff), *((out)++)=(unsigned char)(((l)>>16L)&0xff), *((out)++)=(unsigned char)(((l)>>24L)&0xff));
 l=ll[0]=ll[1]=0;
 }
