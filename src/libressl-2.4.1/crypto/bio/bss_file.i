...
# 122 "bio/bss_file.c"
 ...
 if (file == 
# 126 "bio/bss_file.c" 3 4
            ((void *)0)
# 126 "bio/bss_file.c"
                ) {
  ERR_put_error(2,(1),(
# 127 "bio/bss_file.c" 3 4
 (*__errno_location ())
# 127 "bio/bss_file.c"
 ),"bio/bss_file.c",127);
  ERR_asprintf_error_data("fopen('%s', '%s')", filename, mode);
  if (
# 129 "bio/bss_file.c" 3 4
     (*__errno_location ()) 
# 129 "bio/bss_file.c"
           == 
# 129 "bio/bss_file.c" 3 4
...
# 129 "bio/bss_file.c"
   ...
   ERR_put_error(32,(109),(128),"bio/bss_file.c",130);
  else
   ERR_put_error(32,(109),(2),"bio/bss_file.c",132);
  return (
# 133 "bio/bss_file.c" 3 4
         ((void *)0)
# 133 "bio/bss_file.c"
             );
 }
 if ((ret = BIO_new(BIO_s_file())) == 
# 135 "bio/bss_file.c" 3 4
                                     ((void *)0)
# 135 "bio/bss_file.c"
                                         ) {
  fclose(file);
  return (
# 137 "bio/bss_file.c" 3 4
         ((void *)0)
# 137 "bio/bss_file.c"
             );
 }
...
BIO_new_fp(FILE *stream, int close_flag)
{
 ...
 if ((ret = BIO_new(BIO_s_file())) == 
# 149 "bio/bss_file.c" 3 4
                                     ((void *)0)
# 149 "bio/bss_file.c"
                                         )
  return (
# 150 "bio/bss_file.c" 3 4
         ((void *)0)
# 150 "bio/bss_file.c"
             );
...
# 179 "bio/bss_file.c"
 ...
 if (a->shutdown) {
  if ((a->init) && (a->ptr != 
# 182 "bio/bss_file.c" 3 4
                             ((void *)0)
# 182 "bio/bss_file.c"
                                 )) {
   fclose (a->ptr);
   a->ptr = 
# 184 "bio/bss_file.c" 3 4
           ((void *)0)
# 184 "bio/bss_file.c"
               ;
   a->flags = 0;
...
# 197 "bio/bss_file.c"
  ...
  if (ret == 0 && ferror((FILE *)b->ptr)) {
   ERR_put_error(2,(11),(
# 200 "bio/bss_file.c" 3 4
  (*__errno_location ())
# 200 "bio/bss_file.c"
  ),"bio/bss_file.c",200);
   ERR_put_error(32,(130),(2),"bio/bss_file.c",201);
   ret = -1;
  }
 }
 return (ret);
...
file_ctrl(BIO *b, int cmd, long num, void *ptr)
{
 ...
 case 108:
  ...
  if (num & 0x08) {
   ...
   ERR_put_error(32,(116),(101),"bio/bss_file.c",258);
   ret = 0;
   break;
  }
  fp = fopen(ptr, p);
  if (fp == 
# 263 "bio/bss_file.c" 3 4
           ((void *)0)
# 263 "bio/bss_file.c"
               ) {
   ERR_put_error(2,(1),(
# 264 "bio/bss_file.c" 3 4
  (*__errno_location ())
# 264 "bio/bss_file.c"
  ),"bio/bss_file.c",264);
   ERR_asprintf_error_data("fopen('%s', '%s')", ptr, p);
   ERR_put_error(32,(116),(2),"bio/bss_file.c",266);
   ret = 0;
   break;
  }
  b->ptr = fp;
