...
X509_to_X509_REQ(X509 *x, EVP_PKEY *pkey, const EVP_MD *md)
{
 ...
 ret = X509_REQ_new();
 if (ret == 
# 82 "x509/x509_req.c" 3 4
           ((void *)0)
# 82 "x509/x509_req.c"
               ) {
  ERR_put_error(11,(126),((1|64)),"x509/x509_req.c",83);
  goto err;
 }

 ri = ret->req_info;

 if ((ri->version = ASN1_INTEGER_new()) == 
# 89 "x509/x509_req.c" 3 4
                                          ((void *)0)
# 89 "x509/x509_req.c"
                                              )
  goto err;
 ...
 if ((pktmp = X509_get_pubkey(x)) == 
# 97 "x509/x509_req.c" 3 4
                                    ((void *)0)
# 97 "x509/x509_req.c"
                                        )
  goto err;
...
# 127 "x509/x509_req.c"
 ...
 case 1:
  ...
  break;
 case 0:
  ERR_put_error(11,(144),(116),"x509/x509_req.c",137)
                                 ;
  break;
 case -1:
  ERR_put_error(11,(144),(115),"x509/x509_req.c",141)
                               ;
  break;
 case -2:

  if (k->type == 408) {
   ERR_put_error(11,(144),(16),"x509/x509_req.c",147)
                    ;
   break;
  }
  ...
  if (k->type == 28) {
   ...
   ERR_put_error(11,(144),(114),"x509/x509_req.c",155)
                                ;
   break;
  }

  ERR_put_error(11,(144),(117),"x509/x509_req.c",160)
                              ;
 }
...
static int ext_nid_list[] = {172, 171, 0};
...
# 210 "x509/x509_req.c"
  ...
  return (
# 211 "x509/x509_req.c" 3 4
         ((void *)0)
# 211 "x509/x509_req.c"
             );
 for (pnid = ext_nids; *pnid != 0; pnid++) {
  ...
  else if (sk_num(((_STACK*) (1 ? (attr->value.set) : (struct stack_st_ASN1_TYPE*)0))))
   ext = ((ASN1_TYPE *)sk_value(((_STACK*) (1 ? (attr->value.set) : (struct stack_st_ASN1_TYPE*)0)), (0)));
  break;
 }
 if (!ext || (ext->type != 16))
  return 
# 224 "x509/x509_req.c" 3 4
        ((void *)0)
# 224 "x509/x509_req.c"
            ;
 p = ext->value.sequence->data;
 return (struct stack_st_X509_EXTENSION *)ASN1_item_d2i(
# 226 "x509/x509_req.c" 3 4
                                                 ((void *)0)
# 226 "x509/x509_req.c"
                                                     , &p,
...
int
X509_REQ_add_extensions_nid(X509_REQ *req, struct stack_st_X509_EXTENSION *exts,
    int nid)
{
 ASN1_TYPE *at = 
# 238 "x509/x509_req.c" 3 4
                ((void *)0)
# 238 "x509/x509_req.c"
                    ;
 X509_ATTRIBUTE *attr = 
# 239 "x509/x509_req.c" 3 4
                       ((void *)0)
# 239 "x509/x509_req.c"
                           ;
 ...
 if (!(attr->value.set = ((struct stack_st_ASN1_TYPE *)sk_new_null())))
  goto err;
 if (!sk_push(((_STACK*) (1 ? (attr->value.set) : (struct stack_st_ASN1_TYPE*)0)), ((void*) (1 ? (at) : (ASN1_TYPE*)0))))
  goto err;
 at = 
# 255 "x509/x509_req.c" 3 4
     ((void *)0)
# 255 "x509/x509_req.c"
         ;
 attr->single = 0;
 ...
 if (!req->req_info->attributes) {
  if (!(req->req_info->attributes = ((struct stack_st_X509_ATTRIBUTE *)sk_new_null())))
   goto err;
 }
 if (!sk_push(((_STACK*) (1 ? (req->req_info->attributes) : (struct stack_st_X509_ATTRIBUTE*)0)), ((void*) (1 ? (attr) : (X509_ATTRIBUTE*)0))))
  goto err;
 return 1;
...
int
X509_REQ_add_extensions(X509_REQ *req, struct stack_st_X509_EXTENSION *exts)
{
