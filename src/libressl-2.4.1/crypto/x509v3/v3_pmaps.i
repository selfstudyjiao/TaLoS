...
# 66 "x509v3/v3_pmaps.c" 2

static void *v2i_POLICY_MAPPINGS(const X509V3_EXT_METHOD *method,
    X509V3_CTX *ctx, struct stack_st_CONF_VALUE *nval);
static struct stack_st_CONF_VALUE *i2v_POLICY_MAPPINGS(
    const X509V3_EXT_METHOD *method, void *pmps, struct stack_st_CONF_VALUE *extlist);
...
const X509V3_EXT_METHOD v3_policy_mappings = {
 ...
 .ext_new = 
# 76 "x509v3/v3_pmaps.c" 3 4
           ((void *)0)
# 76 "x509v3/v3_pmaps.c"
               ,
 .ext_free = 
# 77 "x509v3/v3_pmaps.c" 3 4
            ((void *)0)
# 77 "x509v3/v3_pmaps.c"
                ,
 .d2i = 
# 78 "x509v3/v3_pmaps.c" 3 4
       ((void *)0)
# 78 "x509v3/v3_pmaps.c"
           ,
 .i2d = 
# 79 "x509v3/v3_pmaps.c" 3 4
       ((void *)0)
# 79 "x509v3/v3_pmaps.c"
           ,
 .i2s = 
# 80 "x509v3/v3_pmaps.c" 3 4
       ((void *)0)
# 80 "x509v3/v3_pmaps.c"
           ,
 .s2i = 
# 81 "x509v3/v3_pmaps.c" 3 4
       ((void *)0)
# 81 "x509v3/v3_pmaps.c"
           ,
 .i2v = i2v_POLICY_MAPPINGS,
 .v2i = v2i_POLICY_MAPPINGS,
 .i2r = 
# 84 "x509v3/v3_pmaps.c" 3 4
       ((void *)0)
# 84 "x509v3/v3_pmaps.c"
           ,
 .r2i = 
# 85 "x509v3/v3_pmaps.c" 3 4
       ((void *)0)
# 85 "x509v3/v3_pmaps.c"
           ,
 .usr_data = 
# 86 "x509v3/v3_pmaps.c" 3 4
            ((void *)0)
# 86 "x509v3/v3_pmaps.c"
                ,
};
...
static const ASN1_TEMPLATE POLICY_MAPPING_seq_tt[] = {
 {
  ...
  .tag = 0,
  .offset = 
# 93 "x509v3/v3_pmaps.c" 3 4
           __builtin_offsetof (
# 93 "x509v3/v3_pmaps.c"
           POLICY_MAPPING
# 93 "x509v3/v3_pmaps.c" 3 4
           , 
# 93 "x509v3/v3_pmaps.c"
...
# 93 "x509v3/v3_pmaps.c"
 ...
 },
 {
  ...
  .tag = 0,
  .offset = 
# 100 "x509v3/v3_pmaps.c" 3 4
           __builtin_offsetof (
# 100 "x509v3/v3_pmaps.c"
           POLICY_MAPPING
# 100 "x509v3/v3_pmaps.c" 3 4
           , 
# 100 "x509v3/v3_pmaps.c"
...
const ASN1_ITEM POLICY_MAPPING_it = {
 ...
 .funcs = 
# 111 "x509v3/v3_pmaps.c" 3 4
         ((void *)0)
# 111 "x509v3/v3_pmaps.c"
             ,
...
const ASN1_ITEM POLICY_MAPPINGS_it = {
 ...
 .tcount = 0,
 .funcs = 
# 129 "x509v3/v3_pmaps.c" 3 4
         ((void *)0)
# 129 "x509v3/v3_pmaps.c"
             ,
 .size = 0,
    ...
    struct stack_st_CONF_VALUE *ext_list)
{
 ...
 for (i = 0; i < sk_num(((_STACK*) (1 ? (pmaps) : (struct stack_st_POLICY_MAPPING*)0))); i++) {
  pmap = ((POLICY_MAPPING *)sk_value(((_STACK*) (1 ? (pmaps) : (struct stack_st_POLICY_MAPPING*)0)), (i)));
...
# 170 "x509v3/v3_pmaps.c" 3 4
                         ((void *)0)
# 170 "x509v3/v3_pmaps.c"
                             ;
 POLICY_MAPPING *pmap = 
# 171 "x509v3/v3_pmaps.c" 3 4
                       ((void *)0)
# 171 "x509v3/v3_pmaps.c"
                           ;
 ASN1_OBJECT *obj1 = 
# 172 "x509v3/v3_pmaps.c" 3 4
                    ((void *)0)
# 172 "x509v3/v3_pmaps.c"
                        , *obj2 = 
# 172 "x509v3/v3_pmaps.c" 3 4
                                  ((void *)0)
# 172 "x509v3/v3_pmaps.c"
 ...
 if (!(pmaps = ((struct stack_st_POLICY_MAPPING *)sk_new_null()))) {
  ERR_put_error(34,(145),((1|64)),"x509v3/v3_pmaps.c",177);
  return 
# 178 "x509v3/v3_pmaps.c" 3 4
        ((void *)0)
# 178 "x509v3/v3_pmaps.c"
            ;
 }
 ...
 for (i = 0; i < sk_num(((_STACK*) (1 ? (nval) : (struct stack_st_CONF_VALUE*)0))); i++) {
  ...
  obj1 = obj2 = 
# 200 "x509v3/v3_pmaps.c" 3 4
               ((void *)0)
# 200 "x509v3/v3_pmaps.c"
                   ;
  if (sk_push(((_STACK*) (1 ? (pmaps) : (struct stack_st_POLICY_MAPPING*)0)), ((void*) (1 ? (pmap) : (POLICY_MAPPING*)0))) == 0) {
       rc = (1|64);
   goto err;
  }
  pmap = 
# 205 "x509v3/v3_pmaps.c" 3 4
        ((void *)0)
# 205 "x509v3/v3_pmaps.c"
            ;
 }
 return pmaps;

err:
 sk_pop_free(((_STACK*) (1 ? (pmaps) : (struct stack_st_POLICY_MAPPING*)0)), ((void (*)(void *)) ((1 ? (POLICY_MAPPING_free) : (void (*)(POLICY_MAPPING *))0))));
 ERR_put_error(34,(145),(rc),"x509v3/v3_pmaps.c",211);
 if (rc == 110)
 ...
 return 
# 217 "x509v3/v3_pmaps.c" 3 4
       ((void *)0)
# 217 "x509v3/v3_pmaps.c"
           ;
}
