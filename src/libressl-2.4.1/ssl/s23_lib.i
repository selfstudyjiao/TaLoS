...
# 76 "../ssl/s23_lib.c"
 ...
 if ((SSL_state(s)&(0x1000|0x2000)) && (!s->in_handshake)) {
  ...
  if (n < 0)
   return (n);
  if (n == 0) {
   ERR_put_error(20,(120),(229),"../ssl/s23_lib.c",82);
   return (-1);
  }
...
# 97 "../ssl/s23_lib.c"
 ...
 if ((SSL_state(s)&(0x1000|0x2000)) && (!s->in_handshake)) {
  ...
  if (n < 0)
   return (n);
  if (n == 0) {
   ERR_put_error(20,(237),(229),"../ssl/s23_lib.c",103);
   return (-1);
  }
...
# 118 "../ssl/s23_lib.c"
 ...
 if ((SSL_state(s)&(0x1000|0x2000)) && (!s->in_handshake)) {
  ...
  if (n < 0)
   return (n);
  if (n == 0) {
   ERR_put_error(20,(121),(229),"../ssl/s23_lib.c",124);
   return (-1);
  }
