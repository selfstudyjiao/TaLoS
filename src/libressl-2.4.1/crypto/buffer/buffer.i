...
BUF_MEM_new(void)
{
 ...
 if (ret == 
# 77 "buffer/buffer.c" 3 4
           ((void *)0)
# 77 "buffer/buffer.c"
               ) {
  ERR_put_error(7,(101),((1|64)),"buffer/buffer.c",78);
  return (
# 79 "buffer/buffer.c" 3 4
         ((void *)0)
# 79 "buffer/buffer.c"
             );
 }
...
BUF_MEM_grow(BUF_MEM *str, size_t len)
{
 ...
 if (len > 0x5ffffffc) {
  ERR_put_error(7,(100),((1|64)),"buffer/buffer.c",117);
  return 0;
 }
 n = (len + 3) / 3 * 4;
 ret = realloc(str->data, n);
 if (ret == 
# 122 "buffer/buffer.c" 3 4
           ((void *)0)
# 122 "buffer/buffer.c"
               ) {
  ERR_put_error(7,(100),((1|64)),"buffer/buffer.c",123);
  len = 0;
 } else {
  str->data = ret;
  str->max = n;
...
BUF_MEM_grow_clean(BUF_MEM *str, size_t len)
{
 ...
 if (len > 0x5ffffffc) {
  ERR_put_error(7,(105),((1|64)),"buffer/buffer.c",152);
  return 0;
 }
 n = (len + 3) / 3 * 4;
 ret = malloc(n);
...
# 158 "buffer/buffer.c"
 ...
 if (ret == 
# 163 "buffer/buffer.c" 3 4
           ((void *)0)
# 163 "buffer/buffer.c"
               ) {
  ERR_put_error(7,(105),((1|64)),"buffer/buffer.c",164);
  len = 0;
 } else {
  str->data = ret;
  str->max = n;
