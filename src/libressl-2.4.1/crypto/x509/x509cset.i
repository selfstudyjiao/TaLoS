...
# 65 "x509/x509cset.c" 2

int
X509_CRL_set_version(X509_CRL *x, long version)
{
 if (x == 
# 69 "x509/x509cset.c" 3 4
         ((void *)0)
# 69 "x509/x509cset.c"
             )
  return (0);
 if (x->crl->version == 
# 71 "x509/x509cset.c" 3 4
                       ((void *)0)
# 71 "x509/x509cset.c"
                           ) {
  if ((x->crl->version = ASN1_INTEGER_new()) == 
# 72 "x509/x509cset.c" 3 4
                                               ((void *)0)
# 72 "x509/x509cset.c"
                                                   )
   return (0);
...
X509_CRL_sort(X509_CRL *c)
{
 ...
 sk_sort(((_STACK*) (1 ? (c->crl->revoked) : (struct stack_st_X509_REVOKED*)0)));
 for (i = 0; i < sk_num(((_STACK*) (1 ? (c->crl->revoked) : (struct stack_st_X509_REVOKED*)0))); i++) {
  r = ((X509_REVOKED *)sk_value(((_STACK*) (1 ? (c->crl->revoked) : (struct stack_st_X509_REVOKED*)0)), (i)));
  r->sequence = i;
 }
