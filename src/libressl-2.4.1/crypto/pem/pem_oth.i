...
{
 const unsigned char *p = 
# 74 "pem/pem_oth.c" 3 4
                         ((void *)0)
# 74 "pem/pem_oth.c"
                             ;
 unsigned char *data = 
# 75 "pem/pem_oth.c" 3 4
                      ((void *)0)
# 75 "pem/pem_oth.c"
                          ;
 long len;
 char *ret = 
# 77 "pem/pem_oth.c" 3 4
            ((void *)0)
# 77 "pem/pem_oth.c"
                ;

 if (!PEM_bytes_read_bio(&data, &len, 
# 79 "pem/pem_oth.c" 3 4
                                     ((void *)0)
# 79 "pem/pem_oth.c"
                                         , name, bp, cb, u))
  return 
# 80 "pem/pem_oth.c" 3 4
        ((void *)0)
# 80 "pem/pem_oth.c"
            ;
 p = data;
 ret = d2i(x, &p, len);
 if (ret == 
# 83 "pem/pem_oth.c" 3 4
           ((void *)0)
# 83 "pem/pem_oth.c"
               )
  ERR_put_error(9,(103),(13),"pem/pem_oth.c",84);
 free(data);
 return (ret);
}
