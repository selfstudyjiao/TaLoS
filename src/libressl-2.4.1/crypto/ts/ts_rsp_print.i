...
TS_RESP_print_bio(BIO *bio, TS_RESP *a)
{
 ...
 if (tst_info != 
# 89 "ts/ts_rsp_print.c" 3 4
                ((void *)0)
# 89 "ts/ts_rsp_print.c"
                    )
...
TS_STATUS_INFO_print_bio(BIO *bio, TS_STATUS_INFO *a)
{
 ...
 static struct status_map_st failure_map[] = {
  ...
  { -1, 
# 142 "ts/ts_rsp_print.c" 3 4
       ((void *)0) 
# 142 "ts/ts_rsp_print.c"
            }
 };
 long status;
 int i, lines = 0;
 ...
 for (i = 0; i < sk_num(((_STACK*) (1 ? (a->text) : (struct stack_st_ASN1_UTF8STRING*)0))); ++i) {
  if (i > 0)
   BIO_puts(bio, "\t");
  ASN1_STRING_print_ex(bio, ((ASN1_UTF8STRING *)sk_value(((_STACK*) (1 ? (a->text) : (struct stack_st_ASN1_UTF8STRING*)0)), (i))),
      0);
  BIO_puts(bio, "\n");
 }
 if (i == 0)
 ...
 if (a->failure_info != 
# 170 "ts/ts_rsp_print.c" 3 4
                       ((void *)0)
# 170 "ts/ts_rsp_print.c"
                           )
...
TS_TST_INFO_print_bio(BIO *bio, TS_TST_INFO *a)
{
 ...
 if (a == 
# 206 "ts/ts_rsp_print.c" 3 4
         ((void *)0)
# 206 "ts/ts_rsp_print.c"
             )
  return 0;
 ...
 if (serial == 
# 224 "ts/ts_rsp_print.c" 3 4
              ((void *)0)
# 224 "ts/ts_rsp_print.c"
                  )
  BIO_printf(bio, "unspecified");
 else
 ...
 if (accuracy == 
# 239 "ts/ts_rsp_print.c" 3 4
                ((void *)0)
# 239 "ts/ts_rsp_print.c"
                    )
  BIO_printf(bio, "unspecified");
 else
 ...
 if (nonce == 
# 252 "ts/ts_rsp_print.c" 3 4
             ((void *)0)
# 252 "ts/ts_rsp_print.c"
                 )
  BIO_printf(bio, "unspecified");
 else
 ...
 if (tsa_name == 
# 261 "ts/ts_rsp_print.c" 3 4
                ((void *)0)
# 261 "ts/ts_rsp_print.c"
                    )
  BIO_printf(bio, "unspecified");
 else {
  struct stack_st_CONF_VALUE *nval;
  if ((nval = i2v_GENERAL_NAME(
# 265 "ts/ts_rsp_print.c" 3 4
                              ((void *)0)
# 265 "ts/ts_rsp_print.c"
                                  , tsa_name, 
# 265 "ts/ts_rsp_print.c" 3 4
                                              ((void *)0)
# 265 "ts/ts_rsp_print.c"
...
TS_ACCURACY_print_bio(BIO *bio, const TS_ACCURACY *accuracy)
{
 ...
 if (seconds != 
# 284 "ts/ts_rsp_print.c" 3 4
               ((void *)0)
# 284 "ts/ts_rsp_print.c"
                   )
 ...
 if (millis != 
# 289 "ts/ts_rsp_print.c" 3 4
              ((void *)0)
# 289 "ts/ts_rsp_print.c"
                  )
 ...
 if (micros != 
# 294 "ts/ts_rsp_print.c" 3 4
              ((void *)0)
# 294 "ts/ts_rsp_print.c"
                  )
