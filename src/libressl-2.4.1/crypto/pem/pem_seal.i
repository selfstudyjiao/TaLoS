...
# 80 "pem/pem_seal.c"
 ...
 for (i = 0; i < npubk; i++) {
  if (pubk[i]->type != 6) {
   ERR_put_error(9,(111),(110),"pem/pem_seal.c",84);
   goto err;
  }
 ...
 s = reallocarray(
# 91 "pem/pem_seal.c" 3 4
                 ((void *)0)
# 91 "pem/pem_seal.c"
                     , max, 2);
 if (s == 
# 92 "pem/pem_seal.c" 3 4
         ((void *)0)
# 92 "pem/pem_seal.c"
             ) {
  ERR_put_error(9,(111),((1|64)),"pem/pem_seal.c",93);
  goto err;
 }
 ...
 if (!EVP_DigestInit(&ctx->md,md_type))
  goto err;
 ...
 *outl = 0;
 EVP_DigestUpdate(&ctx->md,in,inl);
 for (;;) {
  if (inl <= 0)
   break;
  if (inl > 1200)
...
# 153 "pem/pem_seal.c"
 ...
 if (priv->type != 6) {
  ERR_put_error(9,(110),(110),"pem/pem_seal.c",158);
  goto err;
 }
 ...
 if (i < 100)
  i = 100;
 s = reallocarray(
# 164 "pem/pem_seal.c" 3 4
                 ((void *)0)
# 164 "pem/pem_seal.c"
                     , i, 2);
 if (s == 
# 165 "pem/pem_seal.c" 3 4
         ((void *)0)
# 165 "pem/pem_seal.c"
             ) {
  ERR_put_error(9,(110),((1|64)),"pem/pem_seal.c",166);
  goto err;
 }
