...
# 108 "dsa/dsa_gen.c"
 ...
 int r = 0;
 BN_CTX *ctx = 
# 112 "dsa/dsa_gen.c" 3 4
              ((void *)0)
# 112 "dsa/dsa_gen.c"
                  ;
 unsigned int h = 2;

 if (qsize != 20 && qsize != 28 &&
     qsize != 32)

  return 0;

 if (evpmd == 
# 120 "dsa/dsa_gen.c" 3 4
             ((void *)0)
# 120 "dsa/dsa_gen.c"
                 )
...
# 151 "dsa/dsa_gen.c" 3 4
                              ((void *)0)
# 151 "dsa/dsa_gen.c"
                                  )
  goto err;
 if ((g = BN_CTX_get(ctx)) == 
# 153 "dsa/dsa_gen.c" 3 4
                             ((void *)0)
# 153 "dsa/dsa_gen.c"
                                 )
  goto err;
 if ((W = BN_CTX_get(ctx)) == 
# 155 "dsa/dsa_gen.c" 3 4
                             ((void *)0)
# 155 "dsa/dsa_gen.c"
                                 )
  goto err;
 if ((q = BN_CTX_get(ctx)) == 
# 157 "dsa/dsa_gen.c" 3 4
                             ((void *)0)
# 157 "dsa/dsa_gen.c"
                                 )
  goto err;
 if ((X = BN_CTX_get(ctx)) == 
# 159 "dsa/dsa_gen.c" 3 4
                             ((void *)0)
# 159 "dsa/dsa_gen.c"
                                 )
  goto err;
 if ((c = BN_CTX_get(ctx)) == 
# 161 "dsa/dsa_gen.c" 3 4
                             ((void *)0)
# 161 "dsa/dsa_gen.c"
                                 )
  goto err;
 if ((p = BN_CTX_get(ctx)) == 
# 163 "dsa/dsa_gen.c" 3 4
                             ((void *)0)
# 163 "dsa/dsa_gen.c"
                                 )
  goto err;
 if ((test = BN_CTX_get(ctx)) == 
# 165 "dsa/dsa_gen.c" 3 4
                                ((void *)0)
# 165 "dsa/dsa_gen.c"
                                    )
  goto err;
 ...
 for (;;) {
  for (;;) {
   ...
   if (!EVP_Digest(seed, qsize, md, 
# 198 "dsa/dsa_gen.c" 3 4
                                     ((void *)0)
# 198 "dsa/dsa_gen.c"
                                         , evpmd, 
# 198 "dsa/dsa_gen.c" 3 4
...
# 198 "dsa/dsa_gen.c"
    ...
    goto err;
   if (!EVP_Digest(buf, qsize, buf2, 
# 200 "dsa/dsa_gen.c" 3 4
                                     ((void *)0)
# 200 "dsa/dsa_gen.c"
                                         , evpmd, 
# 200 "dsa/dsa_gen.c" 3 4
...
# 200 "dsa/dsa_gen.c"
   ...
   r = BN_is_prime_fasttest_ex(q, 50, ctx,
       seed_is_random, cb);
   if (r > 0)
    break;
   if (r != 0)
  ...
  for (;;) {
   ...
   for (k = 0; k <= n; k++) {
    ...
    if (!EVP_Digest(buf, qsize, md ,
# 249 "dsa/dsa_gen.c" 3 4
                                   ((void *)0)
# 249 "dsa/dsa_gen.c"
                                       , evpmd,
        
# 250 "dsa/dsa_gen.c" 3 4
       ((void *)0)
# 250 "dsa/dsa_gen.c"
           ))
     goto err;
...
# 273 "dsa/dsa_gen.c"
   ...
   if (BN_cmp(p, test) >= 0) {
    ...
    r = BN_is_prime_fasttest_ex(p, 50,
        ctx, 1, cb);
    if (r > 0)
     goto end;
    if (r != 0)
...
# 308 "dsa/dsa_gen.c"
 ...
 for (;;) {
  ...
  if (!BN_mod_exp_mont(g, test, r0, p, ctx, mont))
   goto err;
  if (!((((((g))->top == 1) && (((g))->d[0] == (unsigned long)(1))) || (((1) == 0) && (((g))->top == 0))) && !(g)->neg))
   break;
...
# 339 "dsa/dsa_gen.c"
  ...
  if (counter_ret != 
# 343 "dsa/dsa_gen.c" 3 4
                    ((void *)0)
# 343 "dsa/dsa_gen.c"
                        )
   *counter_ret = counter;
  if (h_ret != 
# 345 "dsa/dsa_gen.c" 3 4
              ((void *)0)
# 345 "dsa/dsa_gen.c"
                  )
   *h_ret = h;
  if (seed_out != 
# 347 "dsa/dsa_gen.c" 3 4
                 ((void *)0)
# 347 "dsa/dsa_gen.c"
                     )
