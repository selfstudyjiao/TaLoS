    ...
    const GOST2814789_KEY *key)
{
 ...
 ((n1)=*((const unsigned int *)(in)), (in)+=4);
 ((n2)=*((const unsigned int *)(in)), (in)+=4);
 ...
 (*((unsigned int *)(out))=(n2), (out)+=4);
 (*((unsigned int *)(out))=(n1), (out)+=4);
}
    ...
    GOST2814789_KEY *key)
{
 ...
 p = mac;
 ((n1)=*((const unsigned int *)(p)), (p)+=4);
 ((n2)=*((const unsigned int *)(p)), (p)+=4);
 ...
 p = mac;
 (*((unsigned int *)(p))=(n1), (p)+=4);
 (*((unsigned int *)(p))=(n2), (p)+=4);
}
    ...
    GOST2814789_KEY *key)
{
 ...
 ((val)=*((const unsigned int *)(p)), (p)+=4);
 val2 = val + 0x01010101;
 (*((unsigned int *)(p2))=(val2), (p2)+=4);
...
# 228 "./md32_common.h"
int
GOST2814789IMIT_Update(GOST2814789IMIT_CTX *c, const void *data_, size_t len)
{
 ...
 if (n != 0) {
  ...
  if (len >= 8 || len + n >= 8) {
   memcpy (p + n, data, 8 - n);
   GOST2814789IMIT_block_data_order (c, p, 1);
   n = 8 - n;
   data += n;
   len -= n;
   c->num = 0;
 ...
 n = len/8;
 if (n > 0) {
  GOST2814789IMIT_block_data_order (c, data, n);
  n *= 8;
  data += n;
  len -= n;
 }
...
void GOST2814789IMIT_Transform (GOST2814789IMIT_CTX *c, const unsigned char *data)
{
 GOST2814789IMIT_block_data_order (c, data, 1);
}
# 437 "gost/gost2814789.c" 2
    ...
    const unsigned char *key, const unsigned char *iv)
{
 ...
 static unsigned char m[4];

 if (md == 
# 460 "gost/gost2814789.c" 3 4
          ((void *)0)
# 460 "gost/gost2814789.c"
              )
  md = m;
