...
static ERR_STRING_DATA UI_str_functs[] = {
 {(((((unsigned long)40)&0xffL)<<24L)| ((((unsigned long)108)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "GENERAL_ALLOCATE_BOOLEAN"},
 {(((((unsigned long)40)&0xffL)<<24L)| ((((unsigned long)109)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "GENERAL_ALLOCATE_PROMPT"},
 {(((((unsigned long)40)&0xffL)<<24L)| ((((unsigned long)100)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "GENERAL_ALLOCATE_STRING"},
 {(((((unsigned long)40)&0xffL)<<24L)| ((((unsigned long)111)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "UI_ctrl"},
 {(((((unsigned long)40)&0xffL)<<24L)| ((((unsigned long)101)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "UI_dup_error_string"},
 {(((((unsigned long)40)&0xffL)<<24L)| ((((unsigned long)102)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "UI_dup_info_string"},
 {(((((unsigned long)40)&0xffL)<<24L)| ((((unsigned long)110)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "UI_dup_input_boolean"},
 {(((((unsigned long)40)&0xffL)<<24L)| ((((unsigned long)103)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "UI_dup_input_string"},
 {(((((unsigned long)40)&0xffL)<<24L)| ((((unsigned long)106)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "UI_dup_verify_string"},
 {(((((unsigned long)40)&0xffL)<<24L)| ((((unsigned long)107)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "UI_get0_result"},
 {(((((unsigned long)40)&0xffL)<<24L)| ((((unsigned long)104)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "UI_new_method"},
 {(((((unsigned long)40)&0xffL)<<24L)| ((((unsigned long)105)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "UI_set_result"},
 {0, 
# 87 "ui/ui_err.c" 3 4
    ((void *)0)
# 87 "ui/ui_err.c"
...
static ERR_STRING_DATA UI_str_reasons[] = {
 {(((((unsigned long)40)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)104)&0xfffL))), "common ok and cancel characters"},
 {(((((unsigned long)40)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)102)&0xfffL))), "index too large"},
 {(((((unsigned long)40)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)103)&0xfffL))), "index too small"},
 {(((((unsigned long)40)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)105)&0xfffL))), "no result buffer"},
 {(((((unsigned long)40)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)100)&0xfffL))), "result too large"},
 {(((((unsigned long)40)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)101)&0xfffL))), "result too small"},
 {(((((unsigned long)40)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)106)&0xfffL))), "unknown control command"},
 {0, 
# 98 "ui/ui_err.c" 3 4
    ((void *)0)
# 98 "ui/ui_err.c"
...
ERR_load_UI_strings(void)
{
 ...
 if (ERR_func_error_string(UI_str_functs[0].error) == 
# 107 "ui/ui_err.c" 3 4
                                                     ((void *)0)
# 107 "ui/ui_err.c"
                                                         ) {
