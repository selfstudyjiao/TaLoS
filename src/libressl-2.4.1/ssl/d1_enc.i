...
dtls1_enc(SSL *s, int send)
{
 ...
 if (send) {
  ...
  rec = &(s->s3->wrec);
  if (s->enc_write_ctx == 
# 149 "../ssl/d1_enc.c" 3 4
                         ((void *)0)
# 149 "../ssl/d1_enc.c"
                             )
   enc = 
# 150 "../ssl/d1_enc.c" 3 4
        ((void *)0)
# 150 "../ssl/d1_enc.c"
            ;
  else {
  ...
  if (EVP_MD_CTX_md(s->read_hash)) {
   ...
   (void)((mac_size >= 0) ? 0 : (OpenSSLDie("../ssl/d1_enc.c", 167, "mac_size >= 0"),1));
  }
  ds = s->enc_read_ctx;
  rec = &(s->s3->rrec);
  if (s->enc_read_ctx == 
# 171 "../ssl/d1_enc.c" 3 4
                        ((void *)0)
# 171 "../ssl/d1_enc.c"
                            )
   enc = 
# 172 "../ssl/d1_enc.c" 3 4
        ((void *)0)
# 172 "../ssl/d1_enc.c"
            ;
  else
