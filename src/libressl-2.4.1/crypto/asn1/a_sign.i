...
# 147 "asn1/a_sign.c"
 ...
 if (!type || !pkey) {
  ERR_put_error(13,(220),(217),"asn1/a_sign.c",157)
                                     ;
  return 0;
 }
 ...
 if (pkey->ameth->item_sign) {
  ...
  if (rv <= 0)
   ERR_put_error(13,(220),(6),"asn1/a_sign.c",173);
  if (rv <= 1)
   goto err;
 } else
  rv = 2;
 ...
 if (rv == 2) {
  if (type->flags & 0x0004) {
   if (!pkey->ameth ||
       !OBJ_find_sigid_by_algs(&signid,
    EVP_MD_type(type), pkey->ameth->pkey_id)) {
    ERR_put_error(13,(220),(198),"asn1/a_sign.c",185)
                                                 ;
    return 0;
   }
  } else
  ...
  if (algor1)
   X509_ALGOR_set0(algor1,
       OBJ_nid2obj(signid), paramtype, 
# 198 "asn1/a_sign.c" 3 4
                                      ((void *)0)
# 198 "asn1/a_sign.c"
                                          );
  if (algor2)
...
# 208 "asn1/a_sign.c"
  ...
  outl = 0;
  ERR_put_error(13,(220),((1|64)),"asn1/a_sign.c",210);
  goto err;
 }
 ...
 if (!EVP_DigestUpdate(ctx,buf_in,inl) ||
  ...
  outl = 0;
  ERR_put_error(13,(220),(6),"asn1/a_sign.c",217);
  goto err;
 }
 free(signature->data);
 signature->data = buf_out;
 buf_out = 
# 222 "asn1/a_sign.c" 3 4
          ((void *)0)
# 222 "asn1/a_sign.c"
              ;
 ...
 signature->flags &= ~(0x08|0x07);
 signature->flags |= 0x08;

err:
 EVP_MD_CTX_cleanup(ctx);
 if (buf_in != 
# 232 "asn1/a_sign.c" 3 4
              ((void *)0)
# 232 "asn1/a_sign.c"
                  ) {
