...
# 142 "bn/bn_blind.c"
 ...
 if ((ret = calloc(1, sizeof(BN_BLINDING))) == 
# 146 "bn/bn_blind.c" 3 4
                                              ((void *)0)
# 146 "bn/bn_blind.c"
                                                  ) {
  ERR_put_error(3,(102),((1|64)),"bn/bn_blind.c",147);
  return (
# 148 "bn/bn_blind.c" 3 4
         ((void *)0)
# 148 "bn/bn_blind.c"
             );
 }
 if (A != 
# 150 "bn/bn_blind.c" 3 4
         ((void *)0)
# 150 "bn/bn_blind.c"
             ) {
  if ((ret->A = BN_dup(A)) == 
# 151 "bn/bn_blind.c" 3 4
                              ((void *)0)
# 151 "bn/bn_blind.c"
                                  )
   goto err;
 ...
 if (Ai != 
# 154 "bn/bn_blind.c" 3 4
          ((void *)0)
# 154 "bn/bn_blind.c"
              ) {
  if ((ret->Ai = BN_dup(Ai)) == 
# 155 "bn/bn_blind.c" 3 4
                               ((void *)0)
# 155 "bn/bn_blind.c"
                                   )
   goto err;
 ...
 if ((ret->mod = BN_dup(mod)) == 
# 160 "bn/bn_blind.c" 3 4
                                ((void *)0)
# 160 "bn/bn_blind.c"
                                    )
  goto err;
...
err:
 if (ret != 
# 173 "bn/bn_blind.c" 3 4
           ((void *)0)
# 173 "bn/bn_blind.c"
               )
  BN_BLINDING_free(ret);
 return (
# 175 "bn/bn_blind.c" 3 4
        ((void *)0)
# 175 "bn/bn_blind.c"
            );
}
...
# 196 "bn/bn_blind.c"
  ...
  ERR_put_error(3,(103),(107),"bn/bn_blind.c",197);
  goto err;
 }
 ...
 if (++b->counter == 32 && b->e != 
# 204 "bn/bn_blind.c" 3 4
                                                   ((void *)0) 
# 204 "bn/bn_blind.c"
                                                        &&
     !(b->flags & 0x00000002)) {

  if (!BN_BLINDING_create_param(b, 
# 207 "bn/bn_blind.c" 3 4
                                  ((void *)0)
# 207 "bn/bn_blind.c"
                                      , 
# 207 "bn/bn_blind.c" 3 4
...
{
 return BN_BLINDING_convert_ex(n, 
# 227 "bn/bn_blind.c" 3 4
                                 ((void *)0)
# 227 "bn/bn_blind.c"
                                     , b, ctx);
}
...
# 237 "bn/bn_blind.c"
  ...
  ERR_put_error(3,(100),(107),"bn/bn_blind.c",238);
  return (0);
 }
...
{
 return BN_BLINDING_invert_ex(n, 
# 262 "bn/bn_blind.c" 3 4
                                ((void *)0)
# 262 "bn/bn_blind.c"
                                    , b, ctx);
}
...
# 272 "bn/bn_blind.c"
  ...
  if (b->Ai == 
# 275 "bn/bn_blind.c" 3 4
              ((void *)0)
# 275 "bn/bn_blind.c"
                  ) {
   ERR_put_error(3,(101),(107),"bn/bn_blind.c",276);
   return (0);
  }
    ...
    const BIGNUM *m, BN_CTX *ctx, BN_MONT_CTX *m_ctx), BN_MONT_CTX *m_ctx)
{
 ...
 BN_BLINDING *ret = 
# 324 "bn/bn_blind.c" 3 4
                   ((void *)0)
# 324 "bn/bn_blind.c"
                       ;

 if (b == 
# 326 "bn/bn_blind.c" 3 4
         ((void *)0)
# 326 "bn/bn_blind.c"
             )
  ret = BN_BLINDING_new(
# 327 "bn/bn_blind.c" 3 4
                       ((void *)0)
# 327 "bn/bn_blind.c"
                           , 
# 327 "bn/bn_blind.c" 3 4
...
# 343 "bn/bn_blind.c"
 ...
 if (bn_mod_exp != 
# 346 "bn/bn_blind.c" 3 4
                  ((void *)0)
# 346 "bn/bn_blind.c"
                      )
  ret->bn_mod_exp = bn_mod_exp;
 if (m_ctx != 
# 348 "bn/bn_blind.c" 3 4
             ((void *)0)
# 348 "bn/bn_blind.c"
                 )
  ret->m_ctx = m_ctx;
 ...
 do {
  if (!BN_rand_range(ret->A, ret->mod))
   goto err;
  if (BN_mod_inverse(ret->Ai, ret->A, ret->mod, ctx) == 
# 354 "bn/bn_blind.c" 3 4
                                                       ((void *)0)
# 354 "bn/bn_blind.c"
                                                           ) {

   unsigned long error = ERR_peek_last_error();
   if ((int)((error)&0xfffL) == 108) {
    if (retry_counter-- == 0) {
     ERR_put_error(3,(128),(113),"bn/bn_blind.c",360)
                                  ;
     goto err;
    }
    ERR_clear_error();
