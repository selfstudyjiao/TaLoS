...
# 65 "conf/conf_sap.c" 2
# 1 "../include/openssl/crypto.h" 1
# 119 "../include/openssl/crypto.h"
# 1 "../include/compat/stdlib.h" 1
# 120 "../include/openssl/crypto.h" 2
# 66 "conf/conf_sap.c" 2
...
# 98 "conf/conf_sap.c"
  ...
  if ((bio_err = BIO_new_fp(
# 102 "conf/conf_sap.c" 3 4
                           stderr
# 102 "conf/conf_sap.c"
                                 , 0x00)) != 
# 102 "conf/conf_sap.c" 3 4
