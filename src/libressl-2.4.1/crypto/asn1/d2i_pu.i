...
# 84 "asn1/d2i_pu.c"
  ...
  if ((ret = EVP_PKEY_new()) == 
# 85 "asn1/d2i_pu.c" 3 4
                               ((void *)0)
# 85 "asn1/d2i_pu.c"
                                   ) {
   ERR_put_error(13,(155),(6),"asn1/d2i_pu.c",86);
   return (
# 87 "asn1/d2i_pu.c" 3 4
          ((void *)0)
# 87 "asn1/d2i_pu.c"
              );
  }
 ...
 if (!EVP_PKEY_set_type(ret, type)) {
  ERR_put_error(13,(155),(6),"asn1/d2i_pu.c",93);
  goto err;
 }
...
# 100 "asn1/d2i_pu.c" 3 4
                                       ((void *)0)
# 100 "asn1/d2i_pu.c"
                                           , pp, length)) ==
      
# 101 "asn1/d2i_pu.c" 3 4
     ((void *)0)
# 101 "asn1/d2i_pu.c"
         ) {
   ERR_put_error(13,(155),(13),"asn1/d2i_pu.c",102);
   goto err;
  }
  break;
 ...
 case 116:
  if (!d2i_DSAPublicKey(&(ret->pkey.dsa), pp, length)) {
   ERR_put_error(13,(155),(13),"asn1/d2i_pu.c",110);
   goto err;
  }
  break;
 ...
 case 408:
  if (!o2i_ECPublicKey(&(ret->pkey.ec), pp, length)) {
   ERR_put_error(13,(155),(13),"asn1/d2i_pu.c",118);
   goto err;
  }
  break;

 default:
  ERR_put_error(13,(155),(163),"asn1/d2i_pu.c",124);
  goto err;

 }
 if (a != 
# 128 "asn1/d2i_pu.c" 3 4
         ((void *)0)
# 128 "asn1/d2i_pu.c"
             )
  (*a) = ret;
...
err:
 if (a == 
# 133 "asn1/d2i_pu.c" 3 4
         ((void *)0) 
# 133 "asn1/d2i_pu.c"
              || *a != ret)
  EVP_PKEY_free(ret);
 return (
# 135 "asn1/d2i_pu.c" 3 4
        ((void *)0)
# 135 "asn1/d2i_pu.c"
            );
}
