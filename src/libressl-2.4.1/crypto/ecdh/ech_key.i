    ...
    void *(*KDF)(const void *in, size_t inlen, void *out, size_t *outlen))
{
 BN_CTX *ctx;
 EC_POINT *tmp = 
# 99 "ecdh/ech_key.c" 3 4
                ((void *)0)
# 99 "ecdh/ech_key.c"
                    ;
 BIGNUM *x = 
# 100 "ecdh/ech_key.c" 3 4
            ((void *)0)
# 100 "ecdh/ech_key.c"
                , *y = 
# 100 "ecdh/ech_key.c" 3 4
...
# 105 "ecdh/ech_key.c"
 ...
 if (outlen > 0x7fffffff) {
  ...
  ERR_put_error(43,(100),((1|64)),"ecdh/ech_key.c",109);
  return -1;
 }

 if ((ctx = BN_CTX_new()) == 
# 113 "ecdh/ech_key.c" 3 4
                            ((void *)0)
# 113 "ecdh/ech_key.c"
                                )
  goto err;
 BN_CTX_start(ctx);
 if ((x = BN_CTX_get(ctx)) == 
# 116 "ecdh/ech_key.c" 3 4
                             ((void *)0)
# 116 "ecdh/ech_key.c"
                                 )
  goto err;
 if ((y = BN_CTX_get(ctx)) == 
# 118 "ecdh/ech_key.c" 3 4
                             ((void *)0)
# 118 "ecdh/ech_key.c"
                                 )
  goto err;
 ...
 if (priv_key == 
# 122 "ecdh/ech_key.c" 3 4
                ((void *)0)
# 122 "ecdh/ech_key.c"
                    ) {
  ERR_put_error(43,(100),(100),"ecdh/ech_key.c",123);
  goto err;
 }

 group = EC_KEY_get0_group(ecdh);
 if ((tmp = EC_POINT_new(group)) == 
# 128 "ecdh/ech_key.c" 3 4
                                   ((void *)0)
# 128 "ecdh/ech_key.c"
                                       ) {
  ERR_put_error(43,(100),((1|64)),"ecdh/ech_key.c",129);
  goto err;
 }

 if (!EC_POINT_mul(group, tmp, 
# 133 "ecdh/ech_key.c" 3 4
                              ((void *)0)
# 133 "ecdh/ech_key.c"
                                  , pub_key, priv_key, ctx)) {
  ERR_put_error(43,(100),(101),"ecdh/ech_key.c",135)
                                      ;
  goto err;
 }
 ...
 if (EC_METHOD_get_field_type(EC_GROUP_method_of(group)) ==
  ...
  if (!EC_POINT_get_affine_coordinates_GFp(group, tmp, x, y,
      ctx)) {
   ERR_put_error(43,(100),(101),"ecdh/ech_key.c",144)
                                       ;
   goto err;
  }
 }
  ...
  if (!EC_POINT_get_affine_coordinates_GF2m(group, tmp, x, y,
      ctx)) {
   ERR_put_error(43,(100),(101),"ecdh/ech_key.c",153)
                                       ;
   goto err;
  }
 }
 ...
 len = ((BN_num_bits(x)+7)/8);
 if (len > buflen) {
  ERR_put_error(43,(100),((4|64)),"ecdh/ech_key.c",162);
  goto err;
 }
 if (KDF == 
# 165 "ecdh/ech_key.c" 3 4
           ((void *)0) 
# 165 "ecdh/ech_key.c"
                && outlen < buflen) {

  ERR_put_error(43,(100),(104),"ecdh/ech_key.c",167);
  goto err;
 }
 if ((buf = malloc(buflen)) == 
# 170 "ecdh/ech_key.c" 3 4
                              ((void *)0)
# 170 "ecdh/ech_key.c"
                                  ) {
  ERR_put_error(43,(100),((1|64)),"ecdh/ech_key.c",171);
  goto err;
 }

 memset(buf, 0, buflen - len);
 if (len != (size_t)BN_bn2bin(x, buf + buflen - len)) {
  ERR_put_error(43,(100),(3),"ecdh/ech_key.c",177);
  goto err;
 }

 if (KDF != 
# 181 "ecdh/ech_key.c" 3 4
           ((void *)0)
# 181 "ecdh/ech_key.c"
               ) {
  if (KDF(buf, buflen, out, &outlen) == 
# 182 "ecdh/ech_key.c" 3 4
                                       ((void *)0)
# 182 "ecdh/ech_key.c"
                                           ) {
   ERR_put_error(43,(100),(102),"ecdh/ech_key.c",183);
   goto err;
  }
  ret = outlen;
 } else {
