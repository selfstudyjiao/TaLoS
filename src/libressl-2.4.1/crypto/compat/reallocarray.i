...
reallocarray(void *optr, size_t nmemb, size_t size)
{
 if ((nmemb >= ((size_t)1 << (sizeof(size_t) * 4)) || size >= ((size_t)1 << (sizeof(size_t) * 4))) &&
     nmemb > 0 && 
# 33 "compat/reallocarray.c" 3 4
                 (18446744073709551615UL) 
# 33 "compat/reallocarray.c"
                          / nmemb < size) {
  
# 34 "compat/reallocarray.c" 3 4
 (*__errno_location ()) 
# 34 "compat/reallocarray.c"
       = 
# 34 "compat/reallocarray.c" 3 4
         12
# 34 "compat/reallocarray.c"
               ;
  return 
# 35 "compat/reallocarray.c" 3 4
        ((void *)0)
# 35 "compat/reallocarray.c"
            ;
 }
