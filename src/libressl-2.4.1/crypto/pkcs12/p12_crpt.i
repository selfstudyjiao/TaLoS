    ...
    ASN1_TYPE *param, const EVP_CIPHER *cipher, const EVP_MD *md, int en_de)
{
 ...
 if (param == 
# 83 "pkcs12/p12_crpt.c" 3 4
             ((void *)0) 
# 83 "pkcs12/p12_crpt.c"
                  || param->type != 16 ||
     param->value.sequence == 
# 84 "pkcs12/p12_crpt.c" 3 4
                             ((void *)0)
# 84 "pkcs12/p12_crpt.c"
                                 ) {
  ERR_put_error(35,(120),(101),"pkcs12/p12_crpt.c",85);
  return 0;
 }

 pbuf = param->value.sequence->data;
 if (!(pbe = d2i_PBEPARAM(
# 90 "pkcs12/p12_crpt.c" 3 4
                         ((void *)0)
# 90 "pkcs12/p12_crpt.c"
                             , &pbuf, param->value.sequence->length))) {
  ERR_put_error(35,(120),(101),"pkcs12/p12_crpt.c",91);
  return 0;
 }
 ...
 if (!PKCS12_key_gen_asc (pass, passlen, salt, saltlen, 1,
     iter, EVP_CIPHER_key_length(cipher), key, md)) {
  ERR_put_error(35,(120),(107),"pkcs12/p12_crpt.c",103);
  PBEPARAM_free(pbe);
  return 0;
 }
 if (!PKCS12_key_gen_asc (pass, passlen, salt, saltlen, 2,
     iter, EVP_CIPHER_iv_length(cipher), iv, md)) {
  ERR_put_error(35,(120),(106),"pkcs12/p12_crpt.c",109);
  PBEPARAM_free(pbe);
  return 0;
 }
 PBEPARAM_free(pbe);
 ret = EVP_CipherInit_ex(ctx, cipher, 
# 114 "pkcs12/p12_crpt.c" 3 4
                                     ((void *)0)
# 114 "pkcs12/p12_crpt.c"
                                         , key, iv, en_de);
 explicit_bzero(key, 64);
 explicit_bzero(iv, 16);
 return ret;
}
