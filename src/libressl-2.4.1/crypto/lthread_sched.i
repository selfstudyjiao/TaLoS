...
_lthread_wait_cmp(struct lthread *l1, struct lthread *l2)
{
 ...
 void lthread_rb_sleep_RB_INSERT_COLOR(struct lthread_rb_sleep *head, struct lthread *elm) { struct lthread *parent, *gparent, *tmp; while ((parent = (elm)->sleep_node.rbe_parent) != 
# 75 "lthread_sched.c" 3 4
((void *)0) 
# 75 "lthread_sched.c"
&& (parent)->sleep_node.rbe_color == 1) { gparent = (parent)->sleep_node.rbe_parent; if (parent == (gparent)->sleep_node.rbe_left) { tmp = (gparent)->sleep_node.rbe_right; if (tmp && (tmp)->sleep_node.rbe_color == 1) { (tmp)->sleep_node.rbe_color = 0; do { (parent)->sleep_node.rbe_color = 0; (gparent)->sleep_node.rbe_color = 1; } while ( 0); elm = gparent; continue; } if ((parent)->sleep_node.rbe_right == elm) { do { (tmp) = (parent)->sleep_node.rbe_right; if (((parent)->sleep_node.rbe_right = (tmp)->sleep_node.rbe_left) != 
# 75 "lthread_sched.c" 3 4
((void *)0)
# 75 "lthread_sched.c"
) { ((tmp)->sleep_node.rbe_left)->sleep_node.rbe_parent = (parent); } do {} while (0); if (((tmp)->sleep_node.rbe_parent = (parent)->sleep_node.rbe_parent) != 
# 75 "lthread_sched.c" 3 4
((void *)0)
# 75 "lthread_sched.c"
) { if ((parent) == ((parent)->sleep_node.rbe_parent)->sleep_node.rbe_left) ((parent)->sleep_node.rbe_parent)->sleep_node.rbe_left = (tmp); else ((parent)->sleep_node.rbe_parent)->sleep_node.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->sleep_node.rbe_left = (parent); (parent)->sleep_node.rbe_parent = (tmp); do {} while (0); if (((tmp)->sleep_node.rbe_parent)) do {} while (0); } while ( 0); tmp = parent; parent = elm; elm = tmp; } do { (parent)->sleep_node.rbe_color = 0; (gparent)->sleep_node.rbe_color = 1; } while ( 0); do { (tmp) = (gparent)->sleep_node.rbe_left; if (((gparent)->sleep_node.rbe_left = (tmp)->sleep_node.rbe_right) != 
# 75 "lthread_sched.c" 3 4
((void *)0)
# 75 "lthread_sched.c"
) { ((tmp)->sleep_node.rbe_right)->sleep_node.rbe_parent = (gparent); } do {} while (0); if (((tmp)->sleep_node.rbe_parent = (gparent)->sleep_node.rbe_parent) != 
# 75 "lthread_sched.c" 3 4
((void *)0)
# 75 "lthread_sched.c"
) { if ((gparent) == ((gparent)->sleep_node.rbe_parent)->sleep_node.rbe_left) ((gparent)->sleep_node.rbe_parent)->sleep_node.rbe_left = (tmp); else ((gparent)->sleep_node.rbe_parent)->sleep_node.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->sleep_node.rbe_right = (gparent); (gparent)->sleep_node.rbe_parent = (tmp); do {} while (0); if (((tmp)->sleep_node.rbe_parent)) do {} while (0); } while ( 0); } else { tmp = (gparent)->sleep_node.rbe_left; if (tmp && (tmp)->sleep_node.rbe_color == 1) { (tmp)->sleep_node.rbe_color = 0; do { (parent)->sleep_node.rbe_color = 0; (gparent)->sleep_node.rbe_color = 1; } while ( 0); elm = gparent; continue; } if ((parent)->sleep_node.rbe_left == elm) { do { (tmp) = (parent)->sleep_node.rbe_left; if (((parent)->sleep_node.rbe_left = (tmp)->sleep_node.rbe_right) != 
# 75 "lthread_sched.c" 3 4
((void *)0)
# 75 "lthread_sched.c"
) { ((tmp)->sleep_node.rbe_right)->sleep_node.rbe_parent = (parent); } do {} while (0); if (((tmp)->sleep_node.rbe_parent = (parent)->sleep_node.rbe_parent) != 
# 75 "lthread_sched.c" 3 4
((void *)0)
# 75 "lthread_sched.c"
) { if ((parent) == ((parent)->sleep_node.rbe_parent)->sleep_node.rbe_left) ((parent)->sleep_node.rbe_parent)->sleep_node.rbe_left = (tmp); else ((parent)->sleep_node.rbe_parent)->sleep_node.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->sleep_node.rbe_right = (parent); (parent)->sleep_node.rbe_parent = (tmp); do {} while (0); if (((tmp)->sleep_node.rbe_parent)) do {} while (0); } while ( 0); tmp = parent; parent = elm; elm = tmp; } do { (parent)->sleep_node.rbe_color = 0; (gparent)->sleep_node.rbe_color = 1; } while ( 0); do { (tmp) = (gparent)->sleep_node.rbe_right; if (((gparent)->sleep_node.rbe_right = (tmp)->sleep_node.rbe_left) != 
# 75 "lthread_sched.c" 3 4
((void *)0)
# 75 "lthread_sched.c"
) { ((tmp)->sleep_node.rbe_left)->sleep_node.rbe_parent = (gparent); } do {} while (0); if (((tmp)->sleep_node.rbe_parent = (gparent)->sleep_node.rbe_parent) != 
# 75 "lthread_sched.c" 3 4
((void *)0)
# 75 "lthread_sched.c"
) { if ((gparent) == ((gparent)->sleep_node.rbe_parent)->sleep_node.rbe_left) ((gparent)->sleep_node.rbe_parent)->sleep_node.rbe_left = (tmp); else ((gparent)->sleep_node.rbe_parent)->sleep_node.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->sleep_node.rbe_left = (gparent); (gparent)->sleep_node.rbe_parent = (tmp); do {} while (0); if (((tmp)->sleep_node.rbe_parent)) do {} while (0); } while ( 0); } } (head->rbh_root)->sleep_node.rbe_color = 0; } void lthread_rb_sleep_RB_REMOVE_COLOR(struct lthread_rb_sleep *head, struct lthread *parent, struct lthread *elm) { struct lthread *tmp; while ((elm == 
# 75 "lthread_sched.c" 3 4
((void *)0) 
# 75 "lthread_sched.c"
|| (elm)->sleep_node.rbe_color == 0) && elm != (head)->rbh_root) { if ((parent)->sleep_node.rbe_left == elm) { tmp = (parent)->sleep_node.rbe_right; if ((tmp)->sleep_node.rbe_color == 1) { do { (tmp)->sleep_node.rbe_color = 0; (parent)->sleep_node.rbe_color = 1; } while ( 0); do { (tmp) = (parent)->sleep_node.rbe_right; if (((parent)->sleep_node.rbe_right = (tmp)->sleep_node.rbe_left) != 
# 75 "lthread_sched.c" 3 4
((void *)0)
# 75 "lthread_sched.c"
) { ((tmp)->sleep_node.rbe_left)->sleep_node.rbe_parent = (parent); } do {} while (0); if (((tmp)->sleep_node.rbe_parent = (parent)->sleep_node.rbe_parent) != 
...
((void *)0)
# 75 "lthread_sched.c"
) { if ((parent) == ((parent)->sleep_node.rbe_parent)->sleep_node.rbe_left) ((parent)->sleep_node.rbe_parent)->sleep_node.rbe_left = (tmp); else ((parent)->sleep_node.rbe_parent)->sleep_node.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->sleep_node.rbe_left = (parent); (parent)->sleep_node.rbe_parent = (tmp); do {} while (0); if (((tmp)->sleep_node.rbe_parent)) do {} while (0); } while ( 0); tmp = (parent)->sleep_node.rbe_right; } if (((tmp)->sleep_node.rbe_left == 
# 75 "lthread_sched.c" 3 4
((void *)0) 
# 75 "lthread_sched.c"
|| ((tmp)->sleep_node.rbe_left)->sleep_node.rbe_color == 0) && ((tmp)->sleep_node.rbe_right == 
# 75 "lthread_sched.c" 3 4
((void *)0) 
# 75 "lthread_sched.c"
|| ((tmp)->sleep_node.rbe_right)->sleep_node.rbe_color == 0)) { (tmp)->sleep_node.rbe_color = 1; elm = parent; parent = (elm)->sleep_node.rbe_parent; } else { if ((tmp)->sleep_node.rbe_right == 
# 75 "lthread_sched.c" 3 4
((void *)0) 
# 75 "lthread_sched.c"
|| ((tmp)->sleep_node.rbe_right)->sleep_node.rbe_color == 0) { struct lthread *oleft; if ((oleft = (tmp)->sleep_node.rbe_left) != 
# 75 "lthread_sched.c" 3 4
((void *)0)
# 75 "lthread_sched.c"
) (oleft)->sleep_node.rbe_color = 0; (tmp)->sleep_node.rbe_color = 1; do { (oleft) = (tmp)->sleep_node.rbe_left; if (((tmp)->sleep_node.rbe_left = (oleft)->sleep_node.rbe_right) != 
# 75 "lthread_sched.c" 3 4
((void *)0)
# 75 "lthread_sched.c"
) { ((oleft)->sleep_node.rbe_right)->sleep_node.rbe_parent = (tmp); } do {} while (0); if (((oleft)->sleep_node.rbe_parent = (tmp)->sleep_node.rbe_parent) != 
# 75 "lthread_sched.c" 3 4
((void *)0)
# 75 "lthread_sched.c"
) { if ((tmp) == ((tmp)->sleep_node.rbe_parent)->sleep_node.rbe_left) ((tmp)->sleep_node.rbe_parent)->sleep_node.rbe_left = (oleft); else ((tmp)->sleep_node.rbe_parent)->sleep_node.rbe_right = (oleft); } else (head)->rbh_root = (oleft); (oleft)->sleep_node.rbe_right = (tmp); (tmp)->sleep_node.rbe_parent = (oleft); do {} while (0); if (((oleft)->sleep_node.rbe_parent)) do {} while (0); } while ( 0); tmp = (parent)->sleep_node.rbe_right; } (tmp)->sleep_node.rbe_color = (parent)->sleep_node.rbe_color; (parent)->sleep_node.rbe_color = 0; if ((tmp)->sleep_node.rbe_right) ((tmp)->sleep_node.rbe_right)->sleep_node.rbe_color = 0; do { (tmp) = (parent)->sleep_node.rbe_right; if (((parent)->sleep_node.rbe_right = (tmp)->sleep_node.rbe_left) != 
# 75 "lthread_sched.c" 3 4
((void *)0)
# 75 "lthread_sched.c"
) { ((tmp)->sleep_node.rbe_left)->sleep_node.rbe_parent = (parent); } do {} while (0); if (((tmp)->sleep_node.rbe_parent = (parent)->sleep_node.rbe_parent) != 
...
((void *)0)
# 75 "lthread_sched.c"
) { if ((parent) == ((parent)->sleep_node.rbe_parent)->sleep_node.rbe_left) ((parent)->sleep_node.rbe_parent)->sleep_node.rbe_left = (tmp); else ((parent)->sleep_node.rbe_parent)->sleep_node.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->sleep_node.rbe_left = (parent); (parent)->sleep_node.rbe_parent = (tmp); do {} while (0); if (((tmp)->sleep_node.rbe_parent)) do {} while (0); } while ( 0); elm = (head)->rbh_root; break; } } else { tmp = (parent)->sleep_node.rbe_left; if ((tmp)->sleep_node.rbe_color == 1) { do { (tmp)->sleep_node.rbe_color = 0; (parent)->sleep_node.rbe_color = 1; } while ( 0); do { (tmp) = (parent)->sleep_node.rbe_left; if (((parent)->sleep_node.rbe_left = (tmp)->sleep_node.rbe_right) != 
# 75 "lthread_sched.c" 3 4
((void *)0)
# 75 "lthread_sched.c"
) { ((tmp)->sleep_node.rbe_right)->sleep_node.rbe_parent = (parent); } do {} while (0); if (((tmp)->sleep_node.rbe_parent = (parent)->sleep_node.rbe_parent) != 
...
((void *)0)
# 75 "lthread_sched.c"
) { if ((parent) == ((parent)->sleep_node.rbe_parent)->sleep_node.rbe_left) ((parent)->sleep_node.rbe_parent)->sleep_node.rbe_left = (tmp); else ((parent)->sleep_node.rbe_parent)->sleep_node.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->sleep_node.rbe_right = (parent); (parent)->sleep_node.rbe_parent = (tmp); do {} while (0); if (((tmp)->sleep_node.rbe_parent)) do {} while (0); } while ( 0); tmp = (parent)->sleep_node.rbe_left; } if (((tmp)->sleep_node.rbe_left == 
# 75 "lthread_sched.c" 3 4
((void *)0) 
# 75 "lthread_sched.c"
|| ((tmp)->sleep_node.rbe_left)->sleep_node.rbe_color == 0) && ((tmp)->sleep_node.rbe_right == 
...
((void *)0) 
# 75 "lthread_sched.c"
|| ((tmp)->sleep_node.rbe_right)->sleep_node.rbe_color == 0)) { (tmp)->sleep_node.rbe_color = 1; elm = parent; parent = (elm)->sleep_node.rbe_parent; } else { if ((tmp)->sleep_node.rbe_left == 
# 75 "lthread_sched.c" 3 4
((void *)0) 
# 75 "lthread_sched.c"
|| ((tmp)->sleep_node.rbe_left)->sleep_node.rbe_color == 0) { struct lthread *oright; if ((oright = (tmp)->sleep_node.rbe_right) != 
# 75 "lthread_sched.c" 3 4
((void *)0)
# 75 "lthread_sched.c"
) (oright)->sleep_node.rbe_color = 0; (tmp)->sleep_node.rbe_color = 1; do { (oright) = (tmp)->sleep_node.rbe_right; if (((tmp)->sleep_node.rbe_right = (oright)->sleep_node.rbe_left) != 
# 75 "lthread_sched.c" 3 4
((void *)0)
# 75 "lthread_sched.c"
) { ((oright)->sleep_node.rbe_left)->sleep_node.rbe_parent = (tmp); } do {} while (0); if (((oright)->sleep_node.rbe_parent = (tmp)->sleep_node.rbe_parent) != 
# 75 "lthread_sched.c" 3 4
((void *)0)
# 75 "lthread_sched.c"
) { if ((tmp) == ((tmp)->sleep_node.rbe_parent)->sleep_node.rbe_left) ((tmp)->sleep_node.rbe_parent)->sleep_node.rbe_left = (oright); else ((tmp)->sleep_node.rbe_parent)->sleep_node.rbe_right = (oright); } else (head)->rbh_root = (oright); (oright)->sleep_node.rbe_left = (tmp); (tmp)->sleep_node.rbe_parent = (oright); do {} while (0); if (((oright)->sleep_node.rbe_parent)) do {} while (0); } while ( 0); tmp = (parent)->sleep_node.rbe_left; } (tmp)->sleep_node.rbe_color = (parent)->sleep_node.rbe_color; (parent)->sleep_node.rbe_color = 0; if ((tmp)->sleep_node.rbe_left) ((tmp)->sleep_node.rbe_left)->sleep_node.rbe_color = 0; do { (tmp) = (parent)->sleep_node.rbe_left; if (((parent)->sleep_node.rbe_left = (tmp)->sleep_node.rbe_right) != 
# 75 "lthread_sched.c" 3 4
((void *)0)
# 75 "lthread_sched.c"
) { ((tmp)->sleep_node.rbe_right)->sleep_node.rbe_parent = (parent); } do {} while (0); if (((tmp)->sleep_node.rbe_parent = (parent)->sleep_node.rbe_parent) != 
...
((void *)0)
# 75 "lthread_sched.c"
) { if ((parent) == ((parent)->sleep_node.rbe_parent)->sleep_node.rbe_left) ((parent)->sleep_node.rbe_parent)->sleep_node.rbe_left = (tmp); else ((parent)->sleep_node.rbe_parent)->sleep_node.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->sleep_node.rbe_right = (parent); (parent)->sleep_node.rbe_parent = (tmp); do {} while (0); if (((tmp)->sleep_node.rbe_parent)) do {} while (0); } while ( 0); elm = (head)->rbh_root; break; } } } if (elm) (elm)->sleep_node.rbe_color = 0; } struct lthread * lthread_rb_sleep_RB_REMOVE(struct lthread_rb_sleep *head, struct lthread *elm) { struct lthread *child, *parent, *old = elm; int color; if ((elm)->sleep_node.rbe_left == 
# 75 "lthread_sched.c" 3 4
((void *)0)
# 75 "lthread_sched.c"
) child = (elm)->sleep_node.rbe_right; else if ((elm)->sleep_node.rbe_right == 
# 75 "lthread_sched.c" 3 4
((void *)0)
# 75 "lthread_sched.c"
) child = (elm)->sleep_node.rbe_left; else { struct lthread *left; elm = (elm)->sleep_node.rbe_right; while ((left = (elm)->sleep_node.rbe_left) != 
# 75 "lthread_sched.c" 3 4
((void *)0)
# 75 "lthread_sched.c"
) elm = left; child = (elm)->sleep_node.rbe_right; parent = (elm)->sleep_node.rbe_parent; color = (elm)->sleep_node.rbe_color; if (child) (child)->sleep_node.rbe_parent = parent; if (parent) { if ((parent)->sleep_node.rbe_left == elm) (parent)->sleep_node.rbe_left = child; else (parent)->sleep_node.rbe_right = child; do {} while (0); } else (head)->rbh_root = child; if ((elm)->sleep_node.rbe_parent == old) parent = elm; (elm)->sleep_node = (old)->sleep_node; if ((old)->sleep_node.rbe_parent) { if (((old)->sleep_node.rbe_parent)->sleep_node.rbe_left == old) ((old)->sleep_node.rbe_parent)->sleep_node.rbe_left = elm; else ((old)->sleep_node.rbe_parent)->sleep_node.rbe_right = elm; do {} while (0); } else (head)->rbh_root = elm; ((old)->sleep_node.rbe_left)->sleep_node.rbe_parent = elm; if ((old)->sleep_node.rbe_right) ((old)->sleep_node.rbe_right)->sleep_node.rbe_parent = elm; if (parent) { left = parent; do { do {} while (0); } while ((left = (left)->sleep_node.rbe_parent) != 
# 75 "lthread_sched.c" 3 4
((void *)0)
# 75 "lthread_sched.c"
); } goto color; } parent = (elm)->sleep_node.rbe_parent; color = (elm)->sleep_node.rbe_color; if (child) (child)->sleep_node.rbe_parent = parent; if (parent) { if ((parent)->sleep_node.rbe_left == elm) (parent)->sleep_node.rbe_left = child; else (parent)->sleep_node.rbe_right = child; do {} while (0); } else (head)->rbh_root = child; color: if (color == 0) lthread_rb_sleep_RB_REMOVE_COLOR(head, parent, child); return (old); } struct lthread * lthread_rb_sleep_RB_INSERT(struct lthread_rb_sleep *head, struct lthread *elm) { struct lthread *tmp; struct lthread *parent = 
# 75 "lthread_sched.c" 3 4
((void *)0)
# 75 "lthread_sched.c"
; int comp = 0; tmp = (head)->rbh_root; while (tmp) { parent = tmp; comp = (_lthread_sleep_cmp)(elm, parent); if (comp < 0) tmp = (tmp)->sleep_node.rbe_left; else if (comp > 0) tmp = (tmp)->sleep_node.rbe_right; else return (tmp); } do { (elm)->sleep_node.rbe_parent = parent; (elm)->sleep_node.rbe_left = (elm)->sleep_node.rbe_right = 
# 75 "lthread_sched.c" 3 4
((void *)0)
# 75 "lthread_sched.c"
; (elm)->sleep_node.rbe_color = 1; } while ( 0); if (parent != 
# 75 "lthread_sched.c" 3 4
((void *)0)
# 75 "lthread_sched.c"
) { if (comp < 0) (parent)->sleep_node.rbe_left = elm; else (parent)->sleep_node.rbe_right = elm; do {} while (0); } else (head)->rbh_root = elm; lthread_rb_sleep_RB_INSERT_COLOR(head, elm); return (
# 75 "lthread_sched.c" 3 4
((void *)0)
# 75 "lthread_sched.c"
); } struct lthread * lthread_rb_sleep_RB_FIND(struct lthread_rb_sleep *head, struct lthread *elm) { struct lthread *tmp = (head)->rbh_root; int comp; while (tmp) { comp = _lthread_sleep_cmp(elm, tmp); if (comp < 0) tmp = (tmp)->sleep_node.rbe_left; else if (comp > 0) tmp = (tmp)->sleep_node.rbe_right; else return (tmp); } return (
# 75 "lthread_sched.c" 3 4
((void *)0)
# 75 "lthread_sched.c"
); } struct lthread * lthread_rb_sleep_RB_NFIND(struct lthread_rb_sleep *head, struct lthread *elm) { struct lthread *tmp = (head)->rbh_root; struct lthread *res = 
# 75 "lthread_sched.c" 3 4
((void *)0)
# 75 "lthread_sched.c"
; int comp; while (tmp) { comp = _lthread_sleep_cmp(elm, tmp); if (comp < 0) { res = tmp; tmp = (tmp)->sleep_node.rbe_left; } else if (comp > 0) tmp = (tmp)->sleep_node.rbe_right; else return (tmp); } return (res); } struct lthread * lthread_rb_sleep_RB_NEXT(struct lthread *elm) { if ((elm)->sleep_node.rbe_right) { elm = (elm)->sleep_node.rbe_right; while ((elm)->sleep_node.rbe_left) elm = (elm)->sleep_node.rbe_left; } else { if ((elm)->sleep_node.rbe_parent && (elm == ((elm)->sleep_node.rbe_parent)->sleep_node.rbe_left)) elm = (elm)->sleep_node.rbe_parent; else { while ((elm)->sleep_node.rbe_parent && (elm == ((elm)->sleep_node.rbe_parent)->sleep_node.rbe_right)) elm = (elm)->sleep_node.rbe_parent; elm = (elm)->sleep_node.rbe_parent; } } return (elm); } struct lthread * lthread_rb_sleep_RB_PREV(struct lthread *elm) { if ((elm)->sleep_node.rbe_left) { elm = (elm)->sleep_node.rbe_left; while ((elm)->sleep_node.rbe_right) elm = (elm)->sleep_node.rbe_right; } else { if ((elm)->sleep_node.rbe_parent && (elm == ((elm)->sleep_node.rbe_parent)->sleep_node.rbe_right)) elm = (elm)->sleep_node.rbe_parent; else { while ((elm)->sleep_node.rbe_parent && (elm == ((elm)->sleep_node.rbe_parent)->sleep_node.rbe_left)) elm = (elm)->sleep_node.rbe_parent; elm = (elm)->sleep_node.rbe_parent; } } return (elm); } struct lthread * lthread_rb_sleep_RB_MINMAX(struct lthread_rb_sleep *head, int val) { struct lthread *tmp = (head)->rbh_root; struct lthread *parent = 
# 75 "lthread_sched.c" 3 4
((void *)0)
# 75 "lthread_sched.c"
; while (tmp) { parent = tmp; if (val < 0) tmp = (tmp)->sleep_node.rbe_left; else tmp = (tmp)->sleep_node.rbe_right; } return (parent); };
 void lthread_rb_wait_RB_INSERT_COLOR(struct lthread_rb_wait *head, struct lthread *elm) { struct lthread *parent, *gparent, *tmp; while ((parent = (elm)->wait_node.rbe_parent) != 
# 76 "lthread_sched.c" 3 4
((void *)0) 
# 76 "lthread_sched.c"
&& (parent)->wait_node.rbe_color == 1) { gparent = (parent)->wait_node.rbe_parent; if (parent == (gparent)->wait_node.rbe_left) { tmp = (gparent)->wait_node.rbe_right; if (tmp && (tmp)->wait_node.rbe_color == 1) { (tmp)->wait_node.rbe_color = 0; do { (parent)->wait_node.rbe_color = 0; (gparent)->wait_node.rbe_color = 1; } while ( 0); elm = gparent; continue; } if ((parent)->wait_node.rbe_right == elm) { do { (tmp) = (parent)->wait_node.rbe_right; if (((parent)->wait_node.rbe_right = (tmp)->wait_node.rbe_left) != 
# 76 "lthread_sched.c" 3 4
((void *)0)
# 76 "lthread_sched.c"
) { ((tmp)->wait_node.rbe_left)->wait_node.rbe_parent = (parent); } do {} while (0); if (((tmp)->wait_node.rbe_parent = (parent)->wait_node.rbe_parent) != 
# 76 "lthread_sched.c" 3 4
((void *)0)
# 76 "lthread_sched.c"
) { if ((parent) == ((parent)->wait_node.rbe_parent)->wait_node.rbe_left) ((parent)->wait_node.rbe_parent)->wait_node.rbe_left = (tmp); else ((parent)->wait_node.rbe_parent)->wait_node.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->wait_node.rbe_left = (parent); (parent)->wait_node.rbe_parent = (tmp); do {} while (0); if (((tmp)->wait_node.rbe_parent)) do {} while (0); } while ( 0); tmp = parent; parent = elm; elm = tmp; } do { (parent)->wait_node.rbe_color = 0; (gparent)->wait_node.rbe_color = 1; } while ( 0); do { (tmp) = (gparent)->wait_node.rbe_left; if (((gparent)->wait_node.rbe_left = (tmp)->wait_node.rbe_right) != 
# 76 "lthread_sched.c" 3 4
((void *)0)
# 76 "lthread_sched.c"
) { ((tmp)->wait_node.rbe_right)->wait_node.rbe_parent = (gparent); } do {} while (0); if (((tmp)->wait_node.rbe_parent = (gparent)->wait_node.rbe_parent) != 
# 76 "lthread_sched.c" 3 4
((void *)0)
# 76 "lthread_sched.c"
) { if ((gparent) == ((gparent)->wait_node.rbe_parent)->wait_node.rbe_left) ((gparent)->wait_node.rbe_parent)->wait_node.rbe_left = (tmp); else ((gparent)->wait_node.rbe_parent)->wait_node.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->wait_node.rbe_right = (gparent); (gparent)->wait_node.rbe_parent = (tmp); do {} while (0); if (((tmp)->wait_node.rbe_parent)) do {} while (0); } while ( 0); } else { tmp = (gparent)->wait_node.rbe_left; if (tmp && (tmp)->wait_node.rbe_color == 1) { (tmp)->wait_node.rbe_color = 0; do { (parent)->wait_node.rbe_color = 0; (gparent)->wait_node.rbe_color = 1; } while ( 0); elm = gparent; continue; } if ((parent)->wait_node.rbe_left == elm) { do { (tmp) = (parent)->wait_node.rbe_left; if (((parent)->wait_node.rbe_left = (tmp)->wait_node.rbe_right) != 
# 76 "lthread_sched.c" 3 4
((void *)0)
# 76 "lthread_sched.c"
) { ((tmp)->wait_node.rbe_right)->wait_node.rbe_parent = (parent); } do {} while (0); if (((tmp)->wait_node.rbe_parent = (parent)->wait_node.rbe_parent) != 
# 76 "lthread_sched.c" 3 4
((void *)0)
# 76 "lthread_sched.c"
) { if ((parent) == ((parent)->wait_node.rbe_parent)->wait_node.rbe_left) ((parent)->wait_node.rbe_parent)->wait_node.rbe_left = (tmp); else ((parent)->wait_node.rbe_parent)->wait_node.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->wait_node.rbe_right = (parent); (parent)->wait_node.rbe_parent = (tmp); do {} while (0); if (((tmp)->wait_node.rbe_parent)) do {} while (0); } while ( 0); tmp = parent; parent = elm; elm = tmp; } do { (parent)->wait_node.rbe_color = 0; (gparent)->wait_node.rbe_color = 1; } while ( 0); do { (tmp) = (gparent)->wait_node.rbe_right; if (((gparent)->wait_node.rbe_right = (tmp)->wait_node.rbe_left) != 
# 76 "lthread_sched.c" 3 4
((void *)0)
# 76 "lthread_sched.c"
) { ((tmp)->wait_node.rbe_left)->wait_node.rbe_parent = (gparent); } do {} while (0); if (((tmp)->wait_node.rbe_parent = (gparent)->wait_node.rbe_parent) != 
# 76 "lthread_sched.c" 3 4
((void *)0)
# 76 "lthread_sched.c"
) { if ((gparent) == ((gparent)->wait_node.rbe_parent)->wait_node.rbe_left) ((gparent)->wait_node.rbe_parent)->wait_node.rbe_left = (tmp); else ((gparent)->wait_node.rbe_parent)->wait_node.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->wait_node.rbe_left = (gparent); (gparent)->wait_node.rbe_parent = (tmp); do {} while (0); if (((tmp)->wait_node.rbe_parent)) do {} while (0); } while ( 0); } } (head->rbh_root)->wait_node.rbe_color = 0; } void lthread_rb_wait_RB_REMOVE_COLOR(struct lthread_rb_wait *head, struct lthread *parent, struct lthread *elm) { struct lthread *tmp; while ((elm == 
# 76 "lthread_sched.c" 3 4
((void *)0) 
# 76 "lthread_sched.c"
|| (elm)->wait_node.rbe_color == 0) && elm != (head)->rbh_root) { if ((parent)->wait_node.rbe_left == elm) { tmp = (parent)->wait_node.rbe_right; if ((tmp)->wait_node.rbe_color == 1) { do { (tmp)->wait_node.rbe_color = 0; (parent)->wait_node.rbe_color = 1; } while ( 0); do { (tmp) = (parent)->wait_node.rbe_right; if (((parent)->wait_node.rbe_right = (tmp)->wait_node.rbe_left) != 
# 76 "lthread_sched.c" 3 4
((void *)0)
# 76 "lthread_sched.c"
) { ((tmp)->wait_node.rbe_left)->wait_node.rbe_parent = (parent); } do {} while (0); if (((tmp)->wait_node.rbe_parent = (parent)->wait_node.rbe_parent) != 
...
((void *)0)
# 76 "lthread_sched.c"
) { if ((parent) == ((parent)->wait_node.rbe_parent)->wait_node.rbe_left) ((parent)->wait_node.rbe_parent)->wait_node.rbe_left = (tmp); else ((parent)->wait_node.rbe_parent)->wait_node.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->wait_node.rbe_left = (parent); (parent)->wait_node.rbe_parent = (tmp); do {} while (0); if (((tmp)->wait_node.rbe_parent)) do {} while (0); } while ( 0); tmp = (parent)->wait_node.rbe_right; } if (((tmp)->wait_node.rbe_left == 
# 76 "lthread_sched.c" 3 4
((void *)0) 
# 76 "lthread_sched.c"
|| ((tmp)->wait_node.rbe_left)->wait_node.rbe_color == 0) && ((tmp)->wait_node.rbe_right == 
# 76 "lthread_sched.c" 3 4
((void *)0) 
# 76 "lthread_sched.c"
|| ((tmp)->wait_node.rbe_right)->wait_node.rbe_color == 0)) { (tmp)->wait_node.rbe_color = 1; elm = parent; parent = (elm)->wait_node.rbe_parent; } else { if ((tmp)->wait_node.rbe_right == 
# 76 "lthread_sched.c" 3 4
((void *)0) 
# 76 "lthread_sched.c"
|| ((tmp)->wait_node.rbe_right)->wait_node.rbe_color == 0) { struct lthread *oleft; if ((oleft = (tmp)->wait_node.rbe_left) != 
# 76 "lthread_sched.c" 3 4
((void *)0)
# 76 "lthread_sched.c"
) (oleft)->wait_node.rbe_color = 0; (tmp)->wait_node.rbe_color = 1; do { (oleft) = (tmp)->wait_node.rbe_left; if (((tmp)->wait_node.rbe_left = (oleft)->wait_node.rbe_right) != 
# 76 "lthread_sched.c" 3 4
((void *)0)
# 76 "lthread_sched.c"
) { ((oleft)->wait_node.rbe_right)->wait_node.rbe_parent = (tmp); } do {} while (0); if (((oleft)->wait_node.rbe_parent = (tmp)->wait_node.rbe_parent) != 
# 76 "lthread_sched.c" 3 4
((void *)0)
# 76 "lthread_sched.c"
) { if ((tmp) == ((tmp)->wait_node.rbe_parent)->wait_node.rbe_left) ((tmp)->wait_node.rbe_parent)->wait_node.rbe_left = (oleft); else ((tmp)->wait_node.rbe_parent)->wait_node.rbe_right = (oleft); } else (head)->rbh_root = (oleft); (oleft)->wait_node.rbe_right = (tmp); (tmp)->wait_node.rbe_parent = (oleft); do {} while (0); if (((oleft)->wait_node.rbe_parent)) do {} while (0); } while ( 0); tmp = (parent)->wait_node.rbe_right; } (tmp)->wait_node.rbe_color = (parent)->wait_node.rbe_color; (parent)->wait_node.rbe_color = 0; if ((tmp)->wait_node.rbe_right) ((tmp)->wait_node.rbe_right)->wait_node.rbe_color = 0; do { (tmp) = (parent)->wait_node.rbe_right; if (((parent)->wait_node.rbe_right = (tmp)->wait_node.rbe_left) != 
# 76 "lthread_sched.c" 3 4
((void *)0)
# 76 "lthread_sched.c"
) { ((tmp)->wait_node.rbe_left)->wait_node.rbe_parent = (parent); } do {} while (0); if (((tmp)->wait_node.rbe_parent = (parent)->wait_node.rbe_parent) != 
...
((void *)0)
# 76 "lthread_sched.c"
) { if ((parent) == ((parent)->wait_node.rbe_parent)->wait_node.rbe_left) ((parent)->wait_node.rbe_parent)->wait_node.rbe_left = (tmp); else ((parent)->wait_node.rbe_parent)->wait_node.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->wait_node.rbe_left = (parent); (parent)->wait_node.rbe_parent = (tmp); do {} while (0); if (((tmp)->wait_node.rbe_parent)) do {} while (0); } while ( 0); elm = (head)->rbh_root; break; } } else { tmp = (parent)->wait_node.rbe_left; if ((tmp)->wait_node.rbe_color == 1) { do { (tmp)->wait_node.rbe_color = 0; (parent)->wait_node.rbe_color = 1; } while ( 0); do { (tmp) = (parent)->wait_node.rbe_left; if (((parent)->wait_node.rbe_left = (tmp)->wait_node.rbe_right) != 
# 76 "lthread_sched.c" 3 4
((void *)0)
# 76 "lthread_sched.c"
) { ((tmp)->wait_node.rbe_right)->wait_node.rbe_parent = (parent); } do {} while (0); if (((tmp)->wait_node.rbe_parent = (parent)->wait_node.rbe_parent) != 
...
((void *)0)
# 76 "lthread_sched.c"
) { if ((parent) == ((parent)->wait_node.rbe_parent)->wait_node.rbe_left) ((parent)->wait_node.rbe_parent)->wait_node.rbe_left = (tmp); else ((parent)->wait_node.rbe_parent)->wait_node.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->wait_node.rbe_right = (parent); (parent)->wait_node.rbe_parent = (tmp); do {} while (0); if (((tmp)->wait_node.rbe_parent)) do {} while (0); } while ( 0); tmp = (parent)->wait_node.rbe_left; } if (((tmp)->wait_node.rbe_left == 
# 76 "lthread_sched.c" 3 4
((void *)0) 
# 76 "lthread_sched.c"
|| ((tmp)->wait_node.rbe_left)->wait_node.rbe_color == 0) && ((tmp)->wait_node.rbe_right == 
...
((void *)0) 
# 76 "lthread_sched.c"
|| ((tmp)->wait_node.rbe_right)->wait_node.rbe_color == 0)) { (tmp)->wait_node.rbe_color = 1; elm = parent; parent = (elm)->wait_node.rbe_parent; } else { if ((tmp)->wait_node.rbe_left == 
# 76 "lthread_sched.c" 3 4
((void *)0) 
# 76 "lthread_sched.c"
|| ((tmp)->wait_node.rbe_left)->wait_node.rbe_color == 0) { struct lthread *oright; if ((oright = (tmp)->wait_node.rbe_right) != 
# 76 "lthread_sched.c" 3 4
((void *)0)
# 76 "lthread_sched.c"
) (oright)->wait_node.rbe_color = 0; (tmp)->wait_node.rbe_color = 1; do { (oright) = (tmp)->wait_node.rbe_right; if (((tmp)->wait_node.rbe_right = (oright)->wait_node.rbe_left) != 
# 76 "lthread_sched.c" 3 4
((void *)0)
# 76 "lthread_sched.c"
) { ((oright)->wait_node.rbe_left)->wait_node.rbe_parent = (tmp); } do {} while (0); if (((oright)->wait_node.rbe_parent = (tmp)->wait_node.rbe_parent) != 
# 76 "lthread_sched.c" 3 4
((void *)0)
# 76 "lthread_sched.c"
) { if ((tmp) == ((tmp)->wait_node.rbe_parent)->wait_node.rbe_left) ((tmp)->wait_node.rbe_parent)->wait_node.rbe_left = (oright); else ((tmp)->wait_node.rbe_parent)->wait_node.rbe_right = (oright); } else (head)->rbh_root = (oright); (oright)->wait_node.rbe_left = (tmp); (tmp)->wait_node.rbe_parent = (oright); do {} while (0); if (((oright)->wait_node.rbe_parent)) do {} while (0); } while ( 0); tmp = (parent)->wait_node.rbe_left; } (tmp)->wait_node.rbe_color = (parent)->wait_node.rbe_color; (parent)->wait_node.rbe_color = 0; if ((tmp)->wait_node.rbe_left) ((tmp)->wait_node.rbe_left)->wait_node.rbe_color = 0; do { (tmp) = (parent)->wait_node.rbe_left; if (((parent)->wait_node.rbe_left = (tmp)->wait_node.rbe_right) != 
# 76 "lthread_sched.c" 3 4
((void *)0)
# 76 "lthread_sched.c"
) { ((tmp)->wait_node.rbe_right)->wait_node.rbe_parent = (parent); } do {} while (0); if (((tmp)->wait_node.rbe_parent = (parent)->wait_node.rbe_parent) != 
...
((void *)0)
# 76 "lthread_sched.c"
) { if ((parent) == ((parent)->wait_node.rbe_parent)->wait_node.rbe_left) ((parent)->wait_node.rbe_parent)->wait_node.rbe_left = (tmp); else ((parent)->wait_node.rbe_parent)->wait_node.rbe_right = (tmp); } else (head)->rbh_root = (tmp); (tmp)->wait_node.rbe_right = (parent); (parent)->wait_node.rbe_parent = (tmp); do {} while (0); if (((tmp)->wait_node.rbe_parent)) do {} while (0); } while ( 0); elm = (head)->rbh_root; break; } } } if (elm) (elm)->wait_node.rbe_color = 0; } struct lthread * lthread_rb_wait_RB_REMOVE(struct lthread_rb_wait *head, struct lthread *elm) { struct lthread *child, *parent, *old = elm; int color; if ((elm)->wait_node.rbe_left == 
# 76 "lthread_sched.c" 3 4
((void *)0)
# 76 "lthread_sched.c"
) child = (elm)->wait_node.rbe_right; else if ((elm)->wait_node.rbe_right == 
# 76 "lthread_sched.c" 3 4
((void *)0)
# 76 "lthread_sched.c"
) child = (elm)->wait_node.rbe_left; else { struct lthread *left; elm = (elm)->wait_node.rbe_right; while ((left = (elm)->wait_node.rbe_left) != 
# 76 "lthread_sched.c" 3 4
((void *)0)
# 76 "lthread_sched.c"
) elm = left; child = (elm)->wait_node.rbe_right; parent = (elm)->wait_node.rbe_parent; color = (elm)->wait_node.rbe_color; if (child) (child)->wait_node.rbe_parent = parent; if (parent) { if ((parent)->wait_node.rbe_left == elm) (parent)->wait_node.rbe_left = child; else (parent)->wait_node.rbe_right = child; do {} while (0); } else (head)->rbh_root = child; if ((elm)->wait_node.rbe_parent == old) parent = elm; (elm)->wait_node = (old)->wait_node; if ((old)->wait_node.rbe_parent) { if (((old)->wait_node.rbe_parent)->wait_node.rbe_left == old) ((old)->wait_node.rbe_parent)->wait_node.rbe_left = elm; else ((old)->wait_node.rbe_parent)->wait_node.rbe_right = elm; do {} while (0); } else (head)->rbh_root = elm; ((old)->wait_node.rbe_left)->wait_node.rbe_parent = elm; if ((old)->wait_node.rbe_right) ((old)->wait_node.rbe_right)->wait_node.rbe_parent = elm; if (parent) { left = parent; do { do {} while (0); } while ((left = (left)->wait_node.rbe_parent) != 
# 76 "lthread_sched.c" 3 4
((void *)0)
# 76 "lthread_sched.c"
); } goto color; } parent = (elm)->wait_node.rbe_parent; color = (elm)->wait_node.rbe_color; if (child) (child)->wait_node.rbe_parent = parent; if (parent) { if ((parent)->wait_node.rbe_left == elm) (parent)->wait_node.rbe_left = child; else (parent)->wait_node.rbe_right = child; do {} while (0); } else (head)->rbh_root = child; color: if (color == 0) lthread_rb_wait_RB_REMOVE_COLOR(head, parent, child); return (old); } struct lthread * lthread_rb_wait_RB_INSERT(struct lthread_rb_wait *head, struct lthread *elm) { struct lthread *tmp; struct lthread *parent = 
# 76 "lthread_sched.c" 3 4
((void *)0)
# 76 "lthread_sched.c"
; int comp = 0; tmp = (head)->rbh_root; while (tmp) { parent = tmp; comp = (_lthread_wait_cmp)(elm, parent); if (comp < 0) tmp = (tmp)->wait_node.rbe_left; else if (comp > 0) tmp = (tmp)->wait_node.rbe_right; else return (tmp); } do { (elm)->wait_node.rbe_parent = parent; (elm)->wait_node.rbe_left = (elm)->wait_node.rbe_right = 
# 76 "lthread_sched.c" 3 4
((void *)0)
# 76 "lthread_sched.c"
; (elm)->wait_node.rbe_color = 1; } while ( 0); if (parent != 
# 76 "lthread_sched.c" 3 4
((void *)0)
# 76 "lthread_sched.c"
) { if (comp < 0) (parent)->wait_node.rbe_left = elm; else (parent)->wait_node.rbe_right = elm; do {} while (0); } else (head)->rbh_root = elm; lthread_rb_wait_RB_INSERT_COLOR(head, elm); return (
# 76 "lthread_sched.c" 3 4
((void *)0)
# 76 "lthread_sched.c"
); } struct lthread * lthread_rb_wait_RB_FIND(struct lthread_rb_wait *head, struct lthread *elm) { struct lthread *tmp = (head)->rbh_root; int comp; while (tmp) { comp = _lthread_wait_cmp(elm, tmp); if (comp < 0) tmp = (tmp)->wait_node.rbe_left; else if (comp > 0) tmp = (tmp)->wait_node.rbe_right; else return (tmp); } return (
# 76 "lthread_sched.c" 3 4
((void *)0)
# 76 "lthread_sched.c"
); } struct lthread * lthread_rb_wait_RB_NFIND(struct lthread_rb_wait *head, struct lthread *elm) { struct lthread *tmp = (head)->rbh_root; struct lthread *res = 
# 76 "lthread_sched.c" 3 4
((void *)0)
# 76 "lthread_sched.c"
; int comp; while (tmp) { comp = _lthread_wait_cmp(elm, tmp); if (comp < 0) { res = tmp; tmp = (tmp)->wait_node.rbe_left; } else if (comp > 0) tmp = (tmp)->wait_node.rbe_right; else return (tmp); } return (res); } struct lthread * lthread_rb_wait_RB_NEXT(struct lthread *elm) { if ((elm)->wait_node.rbe_right) { elm = (elm)->wait_node.rbe_right; while ((elm)->wait_node.rbe_left) elm = (elm)->wait_node.rbe_left; } else { if ((elm)->wait_node.rbe_parent && (elm == ((elm)->wait_node.rbe_parent)->wait_node.rbe_left)) elm = (elm)->wait_node.rbe_parent; else { while ((elm)->wait_node.rbe_parent && (elm == ((elm)->wait_node.rbe_parent)->wait_node.rbe_right)) elm = (elm)->wait_node.rbe_parent; elm = (elm)->wait_node.rbe_parent; } } return (elm); } struct lthread * lthread_rb_wait_RB_PREV(struct lthread *elm) { if ((elm)->wait_node.rbe_left) { elm = (elm)->wait_node.rbe_left; while ((elm)->wait_node.rbe_right) elm = (elm)->wait_node.rbe_right; } else { if ((elm)->wait_node.rbe_parent && (elm == ((elm)->wait_node.rbe_parent)->wait_node.rbe_right)) elm = (elm)->wait_node.rbe_parent; else { while ((elm)->wait_node.rbe_parent && (elm == ((elm)->wait_node.rbe_parent)->wait_node.rbe_left)) elm = (elm)->wait_node.rbe_parent; elm = (elm)->wait_node.rbe_parent; } } return (elm); } struct lthread * lthread_rb_wait_RB_MINMAX(struct lthread_rb_wait *head, int val) { struct lthread *tmp = (head)->rbh_root; struct lthread *parent = 
# 76 "lthread_sched.c" 3 4
((void *)0)
# 76 "lthread_sched.c"
; while (tmp) { parent = tmp; if (val < 0) tmp = (tmp)->wait_node.rbe_left; else tmp = (tmp)->wait_node.rbe_right; } return (parent); };
...
{
    return (((&sched->waiting)->rbh_root == 
# 89 "lthread_sched.c" 3 4
           ((void *)0)
# 89 "lthread_sched.c"
           ) &&
        ((&sched->busy)->lh_first == 
# 90 "lthread_sched.c" 3 4
       ((void *)0)
# 90 "lthread_sched.c"
       ) &&
        ((&sched->sleeping)->rbh_root == 
# 91 "lthread_sched.c" 3 4
       ((void *)0)
# 91 "lthread_sched.c"
       ) &&
        ((&sched->ready)->tqh_first == 
# 92 "lthread_sched.c" 3 4
       ((void *)0)
# 92 "lthread_sched.c"
       ));
}
...
{
    if (lt->state & (1 << (LT_ST_WAIT_READ))) {
        lt->state &= ~(1 << (LT_ST_WAIT_READ));
    } else if (lt->state & (1 << (LT_ST_WAIT_WRITE))) {
        lt->state &= ~(1 << (LT_ST_WAIT_WRITE));
    }

    if (lt->fd_wait >= 0)
        _lthread_desched_event(((lt->fd_wait) >> ((sizeof(int32_t) * 8))), ((int32_t)(lt->fd_wait)));
    lt->fd_wait = -1;
}
...
{
    struct lthread *lt = 
# 242 "lthread_sched.c" 3 4
                        ((void *)0)
# 242 "lthread_sched.c"
                            ;
    struct lthread_sched *sched = lthread_get_sched();
    find_lt.fd_wait = (((int64_t)(fd) << (sizeof(int32_t) * 8)) | e);

    lt = lthread_rb_wait_RB_FIND(&sched->waiting, &find_lt);
    if (lt != 
# 247 "lthread_sched.c" 3 4
             ((void *)0)
# 247 "lthread_sched.c"
                 ) {
        lthread_rb_wait_RB_REMOVE(&lt->sched->waiting, lt);
...
_lthread_sched_event(struct lthread *lt, int fd, enum lthread_event e,
    uint64_t timeout)
{
    struct lthread *lt_tmp = 
# 268 "lthread_sched.c" 3 4
                            ((void *)0)
# 268 "lthread_sched.c"
                                ;
    enum lthread_st st;
    if (lt->state & (1 << (LT_ST_WAIT_READ)) || lt->state & (1 << (LT_ST_WAIT_WRITE))) {
        my_printf("Unexpected event. lt id %"
# 271 "lthread_sched.c" 3 4
                                            "l" "u"
# 271 "lthread_sched.c"
                                                  " fd %"
# 271 "lthread_sched.c" 3 4
...
# 273 "lthread_sched.c"
       "0"
# 273 "lthread_sched.c" 3 4
       , "lthread_sched.c", 273, __PRETTY_FUNCTION__))
# 273 "lthread_sched.c"
                ;
    }
...
# 281 "lthread_sched.c"
       "0"
# 281 "lthread_sched.c" 3 4
       , "lthread_sched.c", 281, __PRETTY_FUNCTION__))
# 281 "lthread_sched.c"
                ;
    }

    lt->state |= (1 << (st));
    lt->fd_wait = (((int64_t)(fd) << (sizeof(int32_t) * 8)) | e);
    lt_tmp = lthread_rb_wait_RB_INSERT(&lt->sched->waiting, lt);
    
# 287 "lthread_sched.c" 3 4
   ((
# 287 "lthread_sched.c"
   lt_tmp == 
# 287 "lthread_sched.c" 3 4
...
# 287 "lthread_sched.c"
   "lt_tmp == NULL"
# 287 "lthread_sched.c" 3 4
   , "lthread_sched.c", 287, __PRETTY_FUNCTION__))
# 287 "lthread_sched.c"
                         ;
    if (timeout == -1)
        return;
...
_lthread_desched_sleep(struct lthread *lt)
{
    if (lt->state & (1 << (LT_ST_SLEEPING))) {
        lthread_rb_sleep_RB_REMOVE(&lt->sched->sleeping, lt);
        lt->state &= ~(1 << (LT_ST_SLEEPING));
        lt->state |= (1 << (LT_ST_READY));
        lt->state &= ~(1 << (LT_ST_EXPIRED));
    }
}
...
# 319 "lthread_sched.c"
    ...
    while (msecs) {
        lt_tmp = lthread_rb_sleep_RB_INSERT(&lt->sched->sleeping, lt);
        if (lt_tmp) {
            lt->sleep_usecs++;
            continue;
        }
...
_lthread_sched_busy_sleep(struct lthread *lt, uint64_t msecs)
{
    ...
    do { ; if (((((lt))->busy_next.le_next) = (((&lt->sched->busy))->lh_first)) != 
# 349 "lthread_sched.c" 3 4
   ((void *)0)
# 349 "lthread_sched.c"
   ) (((&lt->sched->busy))->lh_first)->busy_next.le_prev = &(((lt))->busy_next.le_next); (((&lt->sched->busy))->lh_first) = (lt); (lt)->busy_next.le_prev = &(((&lt->sched->busy))->lh_first); } while (0);
    lt->state |= (1 << (LT_ST_BUSY));
    _lthread_sched_sleep(lt, msecs);
    lt->state &= ~(1 << (LT_ST_BUSY));
    do { ; ; if ((((lt))->busy_next.le_next) != 
# 353 "lthread_sched.c" 3 4
   ((void *)0)
# 353 "lthread_sched.c"
