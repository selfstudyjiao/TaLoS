    ...
    const unsigned char *ukm, unsigned char *outputKey)
{
 ...
 for (i = 0; i < 8; i++) {
  ...
  p = S;
  (*((unsigned int *)(p))=(s1), (p)+=4);
  (*((unsigned int *)(p))=(s2), (p)+=4);
