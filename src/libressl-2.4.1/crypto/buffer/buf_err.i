...
static ERR_STRING_DATA BUF_str_functs[] = {
 {(((((unsigned long)7)&0xffL)<<24L)| ((((unsigned long)103)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "BUF_memdup"},
 {(((((unsigned long)7)&0xffL)<<24L)| ((((unsigned long)100)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "BUF_MEM_grow"},
 {(((((unsigned long)7)&0xffL)<<24L)| ((((unsigned long)105)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "BUF_MEM_grow_clean"},
 {(((((unsigned long)7)&0xffL)<<24L)| ((((unsigned long)101)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "BUF_MEM_new"},
 {(((((unsigned long)7)&0xffL)<<24L)| ((((unsigned long)102)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "BUF_strdup"},
 {(((((unsigned long)7)&0xffL)<<24L)| ((((unsigned long)104)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "BUF_strndup"},
 {0, 
# 81 "buffer/buf_err.c" 3 4
    ((void *)0)
# 81 "buffer/buf_err.c"
        }
};
...
ERR_load_BUF_strings(void)
{
 ...
 if (ERR_func_error_string(BUF_str_functs[0].error) == 
# 94 "buffer/buf_err.c" 3 4
                                                      ((void *)0)
# 94 "buffer/buf_err.c"
                                                          ) {
