...
# 76 "asn1/a_d2i_fp.c" 3 4
                                   ((void *)0)
# 76 "asn1/a_d2i_fp.c"
                                       ) {
  ERR_put_error(13,(109),(7),"asn1/a_d2i_fp.c",77);
  return (
# 78 "asn1/a_d2i_fp.c" 3 4
         ((void *)0)
# 78 "asn1/a_d2i_fp.c"
             );
 }
 BIO_ctrl(b,106,0x00,(char *)in);
...
{
 BUF_MEM *b = 
# 89 "asn1/a_d2i_fp.c" 3 4
             ((void *)0)
# 89 "asn1/a_d2i_fp.c"
                 ;
 const unsigned char *p;
 void *ret = 
# 91 "asn1/a_d2i_fp.c" 3 4
            ((void *)0)
# 91 "asn1/a_d2i_fp.c"
                ;
 int len;
...
{
 BUF_MEM *b = 
# 112 "asn1/a_d2i_fp.c" 3 4
             ((void *)0)
# 112 "asn1/a_d2i_fp.c"
                 ;
 const unsigned char *p;
 void *ret = 
# 114 "asn1/a_d2i_fp.c" 3 4
            ((void *)0)
# 114 "asn1/a_d2i_fp.c"
                ;
 int len;
...
ASN1_item_d2i_fp(const ASN1_ITEM *it, FILE *in, void *x)
{
 ...
 if ((b = BIO_new(BIO_s_file())) == 
# 136 "asn1/a_d2i_fp.c" 3 4
                                   ((void *)0)
# 136 "asn1/a_d2i_fp.c"
                                       ) {
  ERR_put_error(13,(206),(7),"asn1/a_d2i_fp.c",137);
  return (
# 138 "asn1/a_d2i_fp.c" 3 4
         ((void *)0)
# 138 "asn1/a_d2i_fp.c"
             );
 }
...
asn1_d2i_read_bio(BIO *in, BUF_MEM **pb)
{
 ...
 b = BUF_MEM_new();
 if (b == 
# 161 "asn1/a_d2i_fp.c" 3 4
         ((void *)0)
# 161 "asn1/a_d2i_fp.c"
             ) {
  ERR_put_error(13,(107),((1|64)),"asn1/a_d2i_fp.c",162);
  return -1;
 }
 ...
 for (;;) {
  if (want >= (len - off)) {
   ...
   if (len + want < len ||
    ...
    ERR_put_error(13,(107),((1|64)),"asn1/a_d2i_fp.c",174)
                             ;
    goto err;
   }
   i = BIO_read(in, &(b->data[len]), want);
   if ((i < 0) && ((len - off) == 0)) {
    ERR_put_error(13,(107),(142),"asn1/a_d2i_fp.c",180)
                               ;
    goto err;
   }
   if (i > 0) {
    if (len + i < len) {
     ERR_put_error(13,(107),(155),"asn1/a_d2i_fp.c",186)
                         ;
     goto err;
    }
    len += i;
  ...
  if (c.inf & 1) {
   ...
   eos++;
   if (eos < 0) {
    ERR_put_error(13,(107),(123),"asn1/a_d2i_fp.c",215)
                               ;
    goto err;
   }
   want = 8;
  } else if (eos && (c.slen == 0) && (c.tag == 0)) {
   ...
   want = c.slen;
   if (want > (len - off)) {
    size_t chunk_max = (16 * 1024);

    want -= (len - off);
    if (want > 0x7fffffff ||
        len+want < len) {
     ERR_put_error(13,(107),(155),"asn1/a_d2i_fp.c",236)
                         ;
     goto err;
    }
    while (want > 0) {
     ...
     if (!BUF_MEM_grow_clean(b, len + chunk)) {
      ERR_put_error(13,(107),((1|64)),"asn1/a_d2i_fp.c",250)
                               ;
      goto err;
     }
     want -= chunk;
     while (chunk > 0) {
      ...
      if (i <= 0) {
       ERR_put_error(13,(107),(142),"asn1/a_d2i_fp.c",258)
                                  ;
       goto err;
      }
     ...
     if (chunk_max < 0x7fffffff/2)
      chunk_max *= 2;
    }
   }
   if (off + c.slen < off) {
    ERR_put_error(13,(107),(155),"asn1/a_d2i_fp.c",273);
    goto err;
   }
   off += c.slen;
   if (eos <= 0) {
 ...
 if (off > 0x7fffffff) {
  ERR_put_error(13,(107),(155),"asn1/a_d2i_fp.c",285);
  goto err;
 }
