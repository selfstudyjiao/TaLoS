    ...
    const unsigned char *from, int flen)
{
 ...
 if (flen > (tlen - 11)) {
  ERR_put_error(4,(108),(110),"rsa/rsa_pk1.c",76)
                                        ;
  return 0;
 }
    ...
    const unsigned char *from, int flen, int num)
{
 ...
 p = from;
 if (num != flen + 1 || *(p++) != 01) {
  ERR_put_error(4,(112),(106),"rsa/rsa_pk1.c",105)
                                 ;
  return -1;
 }
 ...
 for (i = 0; i < j; i++) {
  if (*p != 0xff) {
   ...
   if (*p == 0) {
    ...
    ERR_put_error(4,(112),(102),"rsa/rsa_pk1.c",119)
                                       ;
    return -1;
   }
  }
 ...
 if (i == j) {
  ERR_put_error(4,(112),(113),"rsa/rsa_pk1.c",128)
                                      ;
  return -1;
 }

 if (i < 8) {
  ERR_put_error(4,(112),(103),"rsa/rsa_pk1.c",134)
                               ;
  return -1;
 }
 i++;
 j -= i;
 if (j > tlen) {
  ERR_put_error(4,(112),(109),"rsa/rsa_pk1.c",141)
                           ;
  return -1;
 }
 memcpy(to, p, j);
    ...
    const unsigned char *from, int flen)
{
 ...
 if (flen > tlen - 11) {
  ERR_put_error(4,(109),(110),"rsa/rsa_pk1.c",158)
                                        ;
  return 0;
 }
    ...
    const unsigned char *from, int flen, int num)
{
 ...
 p = from;
 if (num != flen + 1 || *(p++) != 02) {
  ERR_put_error(4,(113),(107),"rsa/rsa_pk1.c",193)
                                 ;
  return -1;
 }
 ...
 if (i == j) {
  ERR_put_error(4,(113),(113),"rsa/rsa_pk1.c",205)
                                      ;
  return -1;
 }

 if (i < 8) {
  ERR_put_error(4,(113),(103),"rsa/rsa_pk1.c",211)
                               ;
  return -1;
 }
 i++;
 j -= i;
 if (j > tlen) {
  ERR_put_error(4,(113),(109),"rsa/rsa_pk1.c",218)
                           ;
  return -1;
 }
 memcpy(to, p, j);
