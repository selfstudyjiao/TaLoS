...
TS_REQ_set_msg_imprint(TS_REQ *a, TS_MSG_IMPRINT *msg_imprint)
{
 ...
 if (new_msg_imprint == 
# 86 "ts/ts_req_utils.c" 3 4
                       ((void *)0)
# 86 "ts/ts_req_utils.c"
                           ) {
  ERR_put_error(47,(119),((1|64)),"ts/ts_req_utils.c",87);
  return 0;
 }
...
TS_MSG_IMPRINT_set_algo(TS_MSG_IMPRINT *a, X509_ALGOR *alg)
{
 ...
 if (new_alg == 
# 109 "ts/ts_req_utils.c" 3 4
               ((void *)0)
# 109 "ts/ts_req_utils.c"
                   ) {
  ERR_put_error(47,(118),((1|64)),"ts/ts_req_utils.c",110);
  return 0;
 }
...
TS_REQ_set_policy_id(TS_REQ *a, ASN1_OBJECT *policy)
{
 ...
 if (new_policy == 
# 144 "ts/ts_req_utils.c" 3 4
                  ((void *)0)
# 144 "ts/ts_req_utils.c"
                      ) {
  ERR_put_error(47,(121),((1|64)),"ts/ts_req_utils.c",145);
  return 0;
 }
...
TS_REQ_set_nonce(TS_REQ *a, const ASN1_INTEGER *nonce)
{
 ...
 if (new_nonce == 
# 167 "ts/ts_req_utils.c" 3 4
                 ((void *)0)
# 167 "ts/ts_req_utils.c"
                     ) {
  ERR_put_error(47,(120),((1|64)),"ts/ts_req_utils.c",168);
  return 0;
 }
...
TS_REQ_ext_free(TS_REQ *a)
{
 ...
 a->extensions = 
# 206 "ts/ts_req_utils.c" 3 4
                ((void *)0)
# 206 "ts/ts_req_utils.c"
                    ;
}
...
# 248 "ts/ts_req_utils.c" 3 4
                                                  ((void *)0)
# 248 "ts/ts_req_utils.c"
                                                      ;
}
