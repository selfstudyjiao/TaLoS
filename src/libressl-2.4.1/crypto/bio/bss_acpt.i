...
acpt_new(BIO *bi)
{
 ...
 bi->num = -1;
 bi->flags = 0;
 if ((ba = BIO_ACCEPT_new()) == 
# 134 "bio/bss_acpt.c" 3 4
                               ((void *)0)
# 134 "bio/bss_acpt.c"
                                   )
  return (0);
...
BIO_ACCEPT_new(void)
{
 ...
 if ((ret = calloc(1, sizeof(BIO_ACCEPT))) == 
# 147 "bio/bss_acpt.c" 3 4
                                             ((void *)0)
# 147 "bio/bss_acpt.c"
                                                 )
  return (
# 148 "bio/bss_acpt.c" 3 4
         ((void *)0)
# 148 "bio/bss_acpt.c"
             );
 ret->accept_sock = -1;
...
acpt_close_socket(BIO *bio)
{
 ...
 if (c->accept_sock != -1) {
  shutdown(c->accept_sock, 
# 173 "bio/bss_acpt.c" 3 4
                          SHUT_RDWR
# 173 "bio/bss_acpt.c"
                                   );
  close(c->accept_sock);
...
again:
 ...
 case 1:
  if (c->param_addr == 
# 209 "bio/bss_acpt.c" 3 4
                      ((void *)0)
# 209 "bio/bss_acpt.c"
                          ) {
   ERR_put_error(32,(100),(111),"bio/bss_acpt.c",210);
   return (-1);
  }
  ...
  if (c->accept_nbio) {
   if (!BIO_socket_nbio(s, 1)) {
    close(s);
    ERR_put_error(32,(100),(106),"bio/bss_acpt.c",220);
    return (-1);
   }
  }
  c->accept_sock = s;
...
# 230 "bio/bss_acpt.c"
  ...
  bio = BIO_new_socket(i, 0x01);
  if (bio == 
# 249 "bio/bss_acpt.c" 3 4
            ((void *)0)
# 249 "bio/bss_acpt.c"
                )
   goto err;
  ...
  if (c->nbio) {
   if (!BIO_socket_nbio(i, 1)) {
    ERR_put_error(32,(100),(105),"bio/bss_acpt.c",257);
    goto err;
   }
  }
  ...
  if (c->bio_chain != 
# 264 "bio/bss_acpt.c" 3 4
                     ((void *)0)
# 264 "bio/bss_acpt.c"
                         ) {
   if ((dbio = BIO_dup_chain(c->bio_chain)) == 
# 265 "bio/bss_acpt.c" 3 4
                                              ((void *)0)
# 265 "bio/bss_acpt.c"
                                                  )
    goto err;
...
# 356 "bio/bss_acpt.c"
   ...
   if (num == 0) {
    ...
    data->accept_nbio = (ptr != 
# 362 "bio/bss_acpt.c" 3 4
                               ((void *)0)
# 362 "bio/bss_acpt.c"
                                   );
   } else if (num == 2) {
...
BIO_new_accept(char *str)
{
 ...
 if (ret == 
# 450 "bio/bss_acpt.c" 3 4
           ((void *)0)
# 450 "bio/bss_acpt.c"
               )
  return (
# 451 "bio/bss_acpt.c" 3 4
         ((void *)0)
# 451 "bio/bss_acpt.c"
             );
 if (BIO_ctrl(ret,118,0,(char *)str))
  return (ret);
 else {
  BIO_free(ret);
  return (
# 456 "bio/bss_acpt.c" 3 4
         ((void *)0)
# 456 "bio/bss_acpt.c"
             );
 }
