...
# 119 "des/set_key.c"
static const DES_cblock weak_keys[16]={
...
void DES_set_key_unchecked(const_DES_cblock *key, DES_key_schedule *schedule)
 ...
 (c =((unsigned int)(*((in)++))) , c|=((unsigned int)(*((in)++)))<< 8L, c|=((unsigned int)(*((in)++)))<<16L, c|=((unsigned int)(*((in)++)))<<24L);
 (d =((unsigned int)(*((in)++))) , d|=((unsigned int)(*((in)++)))<< 8L, d|=((unsigned int)(*((in)++)))<<16L, d|=((unsigned int)(*((in)++)))<<24L);
