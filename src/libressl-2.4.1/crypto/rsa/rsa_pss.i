...
{
 return RSA_verify_PKCS1_PSS_mgf1(rsa, mHash, Hash, 
# 75 "rsa/rsa_pss.c" 3 4
                                                   ((void *)0)
# 75 "rsa/rsa_pss.c"
                                                       , EM, sLen);
}
...
# 93 "rsa/rsa_pss.c"
 ...
 if (sLen == -1)
  ...
  ERR_put_error(4,(149),(136),"rsa/rsa_pss.c",111)
                              ;
  goto err;
 }
 ...
 emLen = RSA_size(rsa);
 if (EM[0] & (0xFF << MSBits)) {
  ERR_put_error(4,(149),(133),"rsa/rsa_pss.c",119)
                                ;
  goto err;
 }
 if (MSBits == 0) {
 ...
 if (emLen < (hLen + sLen + 2)) {
  ...
  ERR_put_error(4,(149),(109),"rsa/rsa_pss.c",128);
  goto err;
 }
 if (EM[emLen - 1] != 0xbc) {
  ERR_put_error(4,(149),(134),"rsa/rsa_pss.c",133)
                               ;
  goto err;
 }
 ...
 if (!DB) {
  ERR_put_error(4,(149),((1|64)),"rsa/rsa_pss.c",140);
  goto err;
 }
 ...
 for (i = 0; DB[i] == 0 && i < (maskedDBLen - 1); i++)
  ;
 if (DB[i++] != 0x1) {
  ERR_put_error(4,(149),(135),"rsa/rsa_pss.c",153)
                                 ;
  goto err;
 }
 if (sLen >= 0 && (maskedDBLen - i) != sLen) {
  ERR_put_error(4,(149),(136),"rsa/rsa_pss.c",158)
                              ;
  goto err;
 }
 if (!EVP_DigestInit_ex(&ctx, Hash, 
# 161 "rsa/rsa_pss.c" 3 4
                                   ((void *)0)
# 161 "rsa/rsa_pss.c"
                                       ) ||
 ...
 if (!EVP_DigestFinal_ex(&ctx, H_, 
# 169 "rsa/rsa_pss.c" 3 4
                                  ((void *)0)
# 169 "rsa/rsa_pss.c"
                                      ))
  goto err;
 if (memcmp(H_, H, hLen)) {
  ERR_put_error(4,(149),(104),"rsa/rsa_pss.c",172);
  ret = 0;
 } else
  ret = 1;
...
RSA_padding_add_PKCS1_PSS(RSA *rsa, unsigned char *EM,
    const unsigned char *mHash, const EVP_MD *Hash, int sLen)
{
 return RSA_padding_add_PKCS1_PSS_mgf1(rsa, EM, mHash, Hash, 
# 188 "rsa/rsa_pss.c" 3 4
                                                            ((void *)0)
# 188 "rsa/rsa_pss.c"
                                                                , sLen);
}
...
# 204 "rsa/rsa_pss.c"
 ...
 if (sLen == -1)
  ...
  ERR_put_error(4,(148),(136),"rsa/rsa_pss.c",222)
                              ;
  goto err;
 }
 ...
 if (sLen == -2)
  ...
  ERR_put_error(4,(148),(110),"rsa/rsa_pss.c",236)
                                        ;
  goto err;
 }
 if (sLen > 0) {
  salt = malloc(sLen);
  if (!salt) {
   ERR_put_error(4,(148),((1|64)),"rsa/rsa_pss.c",243)
                            ;
   goto err;
  }
...
# 250 "rsa/rsa_pss.c"
 ...
 if (sLen && !EVP_DigestUpdate(&ctx, salt, sLen))
  goto err;
 if (!EVP_DigestFinal_ex(&ctx, H, 
# 256 "rsa/rsa_pss.c" 3 4
                                 ((void *)0)
# 256 "rsa/rsa_pss.c"
                                     ))
  goto err;
