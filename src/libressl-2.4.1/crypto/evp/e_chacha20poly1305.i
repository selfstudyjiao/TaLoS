...
# 33 "evp/e_chacha20poly1305.c" 2
# 47 "evp/e_chacha20poly1305.c"
    ...
    size_t key_len, size_t tag_len)
{
 ...
 if (tag_len > 16) {
  ERR_put_error(6,(192),(164),"evp/e_chacha20poly1305.c",62);
  return 0;
 }
 ...
 if (c20_ctx == 
# 71 "evp/e_chacha20poly1305.c" 3 4
               ((void *)0)
# 71 "evp/e_chacha20poly1305.c"
                   )
  return 0;
    ...
    const unsigned char *data, size_t data_len)
{
 ...
 if (data != 
# 103 "evp/e_chacha20poly1305.c" 3 4
            ((void *)0)
# 103 "evp/e_chacha20poly1305.c"
                )
    ...
    const unsigned char *ad, size_t ad_len)
{
 ...
 uint64_t ctr;
# 144 "evp/e_chacha20poly1305.c"
 if (in_len_64 >= (1ULL << 32) * 64 - 64) {
  ERR_put_error(6,(194),(164),"evp/e_chacha20poly1305.c",145);
  return 0;
 }

 if (max_out_len < in_len + c20_ctx->tag_len) {
  ERR_put_error(6,(194),(155),"evp/e_chacha20poly1305.c",151)
                             ;
  return 0;
 }

 if (nonce_len != ctx->aead->nonce_len) {
  ERR_put_error(6,(194),(102),"evp/e_chacha20poly1305.c",156);
  return 0;
 }
 ...
 if (nonce_len == 8) {
  ...
  poly1305_update_with_length(&poly1305, 
# 186 "evp/e_chacha20poly1305.c" 3 4
                                        ((void *)0)
# 186 "evp/e_chacha20poly1305.c"
                                            , ad_len);
  poly1305_update_with_length(&poly1305, 
# 187 "evp/e_chacha20poly1305.c" 3 4
                                        ((void *)0)
# 187 "evp/e_chacha20poly1305.c"
                                            , in_len);
 }

 if (c20_ctx->tag_len != 16) {
    ...
    const unsigned char *ad, size_t ad_len)
{
 ...
 if (in_len < c20_ctx->tag_len) {
  ERR_put_error(6,(193),(100),"evp/e_chacha20poly1305.c",219);
  return 0;
 }
# 230 "evp/e_chacha20poly1305.c"
 if (in_len_64 >= (1ULL << 32) * 64 - 64) {
  ERR_put_error(6,(193),(164),"evp/e_chacha20poly1305.c",231);
  return 0;
 }

 if (nonce_len != ctx->aead->nonce_len) {
  ERR_put_error(6,(193),(102),"evp/e_chacha20poly1305.c",236);
  return 0;
 }
 ...
 if (max_out_len < plaintext_len) {
  ERR_put_error(6,(193),(155),"evp/e_chacha20poly1305.c",244)
                             ;
  return 0;
 }
 ...
 if (nonce_len == 8) {
  ...
  poly1305_update_with_length(&poly1305, 
# 272 "evp/e_chacha20poly1305.c" 3 4
                                        ((void *)0)
# 272 "evp/e_chacha20poly1305.c"
                                            , ad_len);
  poly1305_update_with_length(&poly1305, 
# 273 "evp/e_chacha20poly1305.c" 3 4
                                        ((void *)0)
# 273 "evp/e_chacha20poly1305.c"
                                            , plaintext_len);
 }
 ...
 if (timingsafe_memcmp(mac, in + plaintext_len, c20_ctx->tag_len) != 0) {
  ERR_put_error(6,(193),(100),"evp/e_chacha20poly1305.c",279);
  return 0;
 }
