...
# 64 "txt_db/txt_db.c" 2
# 1 "../include/openssl/txt_db.h" 1
# 62 "../include/openssl/txt_db.h"
# 1 "../include/openssl/opensslconf.h" 1
# 1 "../include/openssl/opensslfeatures.h" 1
# 2 "../include/openssl/opensslconf.h" 2
# 63 "../include/openssl/txt_db.h" 2
...
# 78 "txt_db/txt_db.c"
 ...
 OPENSSL_STRING *pp;
 BUF_MEM *buf = 
# 87 "txt_db/txt_db.c" 3 4
               ((void *)0)
# 87 "txt_db/txt_db.c"
                   ;

 if ((buf = BUF_MEM_new()) == 
# 89 "txt_db/txt_db.c" 3 4
                             ((void *)0)
# 89 "txt_db/txt_db.c"
                                 )
  goto err;
 ...
 if ((ret = malloc(sizeof(TXT_DB))) == 
# 94 "txt_db/txt_db.c" 3 4
                                      ((void *)0)
# 94 "txt_db/txt_db.c"
                                          )
  goto err;
 ret->num_fields = num;
 ret->index = 
# 97 "txt_db/txt_db.c" 3 4
             ((void *)0)
# 97 "txt_db/txt_db.c"
                 ;
 ret->qual = 
# 98 "txt_db/txt_db.c" 3 4
            ((void *)0)
# 98 "txt_db/txt_db.c"
                ;
 if ((ret->data = ((struct stack_st_OPENSSL_PSTRING *)sk_new_null())) == 
# 99 "txt_db/txt_db.c" 3 4
                                                   ((void *)0)
# 99 "txt_db/txt_db.c"
                                                       )
  goto err;
 if ((ret->index = reallocarray(
# 101 "txt_db/txt_db.c" 3 4
                               ((void *)0)
# 101 "txt_db/txt_db.c"
                                   , num, sizeof(*ret->index))) == 
# 101 "txt_db/txt_db.c" 3 4
                                                                   ((void *)0)
# 101 "txt_db/txt_db.c"
                                                                       )
  goto err;
 if ((ret->qual = reallocarray(
# 103 "txt_db/txt_db.c" 3 4
                              ((void *)0)
# 103 "txt_db/txt_db.c"
                                  , num, sizeof(*(ret->qual)))) == 
# 103 "txt_db/txt_db.c" 3 4
...
# 103 "txt_db/txt_db.c"
 ...
 for (i = 0; i < num; i++) {
  ret->index[i] = 
# 106 "txt_db/txt_db.c" 3 4
                 ((void *)0)
# 106 "txt_db/txt_db.c"
                     ;
  ret->qual[i] = 
# 107 "txt_db/txt_db.c" 3 4
                ((void *)0)
# 107 "txt_db/txt_db.c"
                    ;
 }
...
# 164 "txt_db/txt_db.c"
  ...
  pp[n] = p;
  if (!sk_push(((_STACK*) (1 ? ret->data : (struct stack_st_OPENSSL_PSTRING*)0)), ((void*) (1 ? pp : (OPENSSL_STRING*)0)))) {
   my_fprintf(
# 170 "txt_db/txt_db.c" 3 4
             stderr
# 170 "txt_db/txt_db.c"
                   , "failure in sk_push\n");
   er = 2;
...
err:
 ...
 if (er) {
  if (er == 1)
   my_fprintf(
# 181 "txt_db/txt_db.c" 3 4
             stderr
# 181 "txt_db/txt_db.c"
                   , "malloc failure\n");
  if (ret != 
# 182 "txt_db/txt_db.c" 3 4
            ((void *)0)
# 182 "txt_db/txt_db.c"
                ) {
   if (ret->data != 
# 183 "txt_db/txt_db.c" 3 4
                   ((void *)0)
# 183 "txt_db/txt_db.c"
                       )
    sk_free(((_STACK*) (1 ? ret->data : (struct stack_st_OPENSSL_PSTRING*)0)));
   free(ret->index);
   free(ret->qual);
   free(ret);
  }
  return (
# 189 "txt_db/txt_db.c" 3 4
         ((void *)0)
# 189 "txt_db/txt_db.c"
             );
 } else
...
{
 OPENSSL_STRING *ret;
 struct lhash_st_OPENSSL_STRING *lh;

 if (idx >= db->num_fields) {
  db->error = 3;
  return (
# 202 "txt_db/txt_db.c" 3 4
         ((void *)0)
# 202 "txt_db/txt_db.c"
             );
 }
 lh = db->index[idx];
 if (lh == 
# 205 "txt_db/txt_db.c" 3 4
          ((void *)0)
# 205 "txt_db/txt_db.c"
              ) {
  db->error = 4;
  return (
# 207 "txt_db/txt_db.c" 3 4
         ((void *)0)
# 207 "txt_db/txt_db.c"
             );
 }
 ret = ((OPENSSL_STRING *)lh_retrieve(((_LHASH *)((void*) (1 ? lh : (struct lhash_st_OPENSSL_STRING*)0))), ((void*) (1 ? value : (OPENSSL_STRING*)0))));
 db->error = 0;
 return (ret);
}
...
TXT_DB_create_index(TXT_DB *db, int field, int (*qual)(OPENSSL_STRING *),
    LHASH_HASH_FN_TYPE hash, LHASH_COMP_FN_TYPE cmp)
{
 struct lhash_st_OPENSSL_STRING *idx;
 OPENSSL_STRING *r;
 int i, n;
 ...
 if ((idx = (struct lhash_st_OPENSSL_STRING *)lh_new(hash, cmp)) == 
# 227 "txt_db/txt_db.c" 3 4
                                                             ((void *)0)
# 227 "txt_db/txt_db.c"
                                                                 ) {
  db->error = 1;
 ...
 n = sk_num(((_STACK*) (1 ? db->data : (struct stack_st_OPENSSL_PSTRING*)0)));
 for (i = 0; i < n; i++) {
  r = ((OPENSSL_PSTRING)sk_value(((_STACK*) (1 ? db->data : (struct stack_st_OPENSSL_PSTRING*)0)), i));
  if ((qual != 
# 234 "txt_db/txt_db.c" 3 4
              ((void *)0)
# 234 "txt_db/txt_db.c"
                  ) && (qual(r) == 0))
   continue;
  if ((r = ((OPENSSL_STRING *)lh_insert(((_LHASH *)((void*) (1 ? idx : (struct lhash_st_OPENSSL_STRING*)0))), ((void*) (1 ? r : (OPENSSL_STRING*)0))))) != 
# 236 "txt_db/txt_db.c" 3 4
                                               ((void *)0)
# 236 "txt_db/txt_db.c"
                                                   ) {
   db->error = 2;
   db->arg1 = sk_find(((_STACK*) (1 ? db->data : (struct stack_st_OPENSSL_PSTRING*)0)), ((void*) (1 ? r : (OPENSSL_STRING*)0)));
   db->arg2 = i;
   lh_free(((_LHASH *)((void*) (1 ? idx : (struct lhash_st_OPENSSL_STRING*)0))));
   return (0);
  }
 }
 if (db->index[field] != 
# 244 "txt_db/txt_db.c" 3 4
                        ((void *)0)
# 244 "txt_db/txt_db.c"
                            )
  lh_free(((_LHASH *)((void*) (1 ? db->index[field] : (struct lhash_st_OPENSSL_STRING*)0))));
 db->index[field] = idx;
 db->qual[field] = qual;
 return (1);
}
...
# 259 "txt_db/txt_db.c"
 ...
 nn = db->num_fields;
 for (i = 0; i < n; i++) {
  pp = ((OPENSSL_PSTRING)sk_value(((_STACK*) (1 ? db->data : (struct stack_st_OPENSSL_PSTRING*)0)), i));

  l = 0;
  for (j = 0; j < nn; j++) {
   if (pp[j] != 
# 268 "txt_db/txt_db.c" 3 4
               ((void *)0)
# 268 "txt_db/txt_db.c"
                   )
    l += strlen(pp[j]);
...
TXT_DB_insert(TXT_DB *db, OPENSSL_STRING *row)
{
 ...
 for (i = 0; i < db->num_fields; i++) {
  if (db->index[i] != 
# 308 "txt_db/txt_db.c" 3 4
                     ((void *)0)
# 308 "txt_db/txt_db.c"
                         ) {
   if ((db->qual[i] != 
# 309 "txt_db/txt_db.c" 3 4
                      ((void *)0)
# 309 "txt_db/txt_db.c"
                          ) && (db->qual[i](row) == 0))
    continue;
   r = ((OPENSSL_STRING *)lh_retrieve(((_LHASH *)((void*) (1 ? db->index[i] : (struct lhash_st_OPENSSL_STRING*)0))), ((void*) (1 ? row : (OPENSSL_STRING*)0))));
   if (r != 
# 312 "txt_db/txt_db.c" 3 4
           ((void *)0)
# 312 "txt_db/txt_db.c"
               ) {
    db->error = 2;
 ...
 if (!sk_push(((_STACK*) (1 ? db->data : (struct stack_st_OPENSSL_PSTRING*)0)), ((void*) (1 ? row : (OPENSSL_STRING*)0)))) {
  db->error = 1;
  goto err;
 }
 ...
 for (i = 0; i < db->num_fields; i++) {
  if (db->index[i] != 
# 327 "txt_db/txt_db.c" 3 4
                     ((void *)0)
# 327 "txt_db/txt_db.c"
                         ) {
   if ((db->qual[i] != 
# 328 "txt_db/txt_db.c" 3 4
                      ((void *)0)
# 328 "txt_db/txt_db.c"
                          ) && (db->qual[i](row) == 0))
    continue;
   (void)((OPENSSL_STRING *)lh_insert(((_LHASH *)((void*) (1 ? db->index[i] : (struct lhash_st_OPENSSL_STRING*)0))), ((void*) (1 ? row : (OPENSSL_STRING*)0))));
  }
 }
 return (1);
...
# 345 "txt_db/txt_db.c"
 ...
 if (db->index != 
# 348 "txt_db/txt_db.c" 3 4
                 ((void *)0)
# 348 "txt_db/txt_db.c"
                     ) {
  for (i = db->num_fields - 1; i >= 0; i--)
   if (db->index[i] != 
# 350 "txt_db/txt_db.c" 3 4
                      ((void *)0)
# 350 "txt_db/txt_db.c"
                          )
    lh_free(((_LHASH *)((void*) (1 ? db->index[i] : (struct lhash_st_OPENSSL_STRING*)0))));
  free(db->index);
 }
 free(db->qual);
 if (db->data != 
# 355 "txt_db/txt_db.c" 3 4
                ((void *)0)
# 355 "txt_db/txt_db.c"
                    ) {
  for (i = sk_num(((_STACK*) (1 ? db->data : (struct stack_st_OPENSSL_PSTRING*)0))) - 1; i >= 0; i--) {


   p = ((OPENSSL_PSTRING)sk_value(((_STACK*) (1 ? db->data : (struct stack_st_OPENSSL_PSTRING*)0)), i));
   max = p[db->num_fields];
   if (max == 
# 361 "txt_db/txt_db.c" 3 4
             ((void *)0)
# 361 "txt_db/txt_db.c"
                 )
   {
...
# 369 "txt_db/txt_db.c"
   ...
   free(((OPENSSL_PSTRING)sk_value(((_STACK*) (1 ? db->data : (struct stack_st_OPENSSL_PSTRING*)0)), i)));
  }
  sk_free(((_STACK*) (1 ? db->data : (struct stack_st_OPENSSL_PSTRING*)0)));
 }
 free(db);
}
