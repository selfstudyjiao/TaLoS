...
EC_GROUP_check(const EC_GROUP * group, BN_CTX * ctx)
{
 ...
 BIGNUM *order;
 BN_CTX *new_ctx = 
# 64 "ec/ec_check.c" 3 4
                  ((void *)0)
# 64 "ec/ec_check.c"
                      ;
 EC_POINT *point = 
# 65 "ec/ec_check.c" 3 4
                  ((void *)0)
# 65 "ec/ec_check.c"
                      ;

 if (ctx == 
# 67 "ec/ec_check.c" 3 4
           ((void *)0)
# 67 "ec/ec_check.c"
               ) {
  ctx = new_ctx = BN_CTX_new();
  if (ctx == 
# 69 "ec/ec_check.c" 3 4
            ((void *)0)
# 69 "ec/ec_check.c"
                ) {
   ERR_put_error(16,(170),((1|64)),"ec/ec_check.c",70);
   goto err;
  }
 }
 BN_CTX_start(ctx);
 if ((order = BN_CTX_get(ctx)) == 
# 75 "ec/ec_check.c" 3 4
                                 ((void *)0)
# 75 "ec/ec_check.c"
                                     )
  goto err;
 ...
 if (!EC_GROUP_check_discriminant(group, ctx)) {
  ERR_put_error(16,(170),(118),"ec/ec_check.c",80);
  goto err;
 }

 if (group->generator == 
# 84 "ec/ec_check.c" 3 4
                        ((void *)0)
# 84 "ec/ec_check.c"
                            ) {
  ERR_put_error(16,(170),(113),"ec/ec_check.c",85);
  goto err;
 }
 if (EC_POINT_is_on_curve(group, group->generator, ctx) <= 0) {
  ERR_put_error(16,(170),(107),"ec/ec_check.c",89);
  goto err;
 }

 if ((point = EC_POINT_new(group)) == 
# 93 "ec/ec_check.c" 3 4
                                     ((void *)0)
# 93 "ec/ec_check.c"
                                         )
  goto err;
 if (!EC_GROUP_get_order(group, order, ctx))
  goto err;
 if (BN_is_zero(order)) {
  ERR_put_error(16,(170),(128),"ec/ec_check.c",98);
  goto err;
 }
 if (!EC_POINT_mul(group, point, order, 
# 101 "ec/ec_check.c" 3 4
                                       ((void *)0)
# 101 "ec/ec_check.c"
                                           , 
# 101 "ec/ec_check.c" 3 4
...
# 101 "ec/ec_check.c"
 ...
 if (EC_POINT_is_at_infinity(group, point) <= 0) {
  ERR_put_error(16,(170),(122),"ec/ec_check.c",104);
  goto err;
 }
 ret = 1;
