...
# 69 "pkcs12/p12_p8e.c"
 ...
 if (!(p8 = X509_SIG_new())) {
  ERR_put_error(35,(125),((1|64)),"pkcs12/p12_p8e.c",73);
  goto err;
 }
 ...
 if (!pbe) {
  ERR_put_error(35,(125),(13),"pkcs12/p12_p8e.c",82);
  goto err;
 }
 ...
 if (!p8->digest) {
  ERR_put_error(35,(125),(103),"pkcs12/p12_p8e.c",91);
  goto err;
 }
