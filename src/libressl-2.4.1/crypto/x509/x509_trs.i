...
static X509_TRUST trstandard[] = {
 {1, 0, trust_compat, "compatible", 0, 
# 87 "x509/x509_trs.c" 3 4
                                                      ((void *)0)
# 87 "x509/x509_trs.c"
                                                          },
 {2, 0, trust_1oidany, "SSL Client", 130, 
# 88 "x509/x509_trs.c" 3 4
                                                                         ((void *)0)
# 88 "x509/x509_trs.c"
                                                                             },
 {3, 0, trust_1oidany, "SSL Server", 129, 
# 89 "x509/x509_trs.c" 3 4
                                                                         ((void *)0)
# 89 "x509/x509_trs.c"
                                                                             },
 {4, 0, trust_1oidany, "S/MIME email", 132, 
# 90 "x509/x509_trs.c" 3 4
                                                                        ((void *)0)
# 90 "x509/x509_trs.c"
                                                                            },
 {5, 0, trust_1oidany, "Object Signer", 131, 
# 91 "x509/x509_trs.c" 3 4
                                                                           ((void *)0)
# 91 "x509/x509_trs.c"
                                                                               },
 {6, 0, trust_1oid, "OCSP responder", 180, 
# 92 "x509/x509_trs.c" 3 4
                                                                       ((void *)0)
# 92 "x509/x509_trs.c"
                                                                           },
 {7, 0, trust_1oid, "OCSP request", 178, 
# 93 "x509/x509_trs.c" 3 4
                                                                      ((void *)0)
# 93 "x509/x509_trs.c"
                                                                          },
 {8, 0, trust_1oidany, "TSA server", 133, 
# 94 "x509/x509_trs.c" 3 4
                                                                 ((void *)0)
# 94 "x509/x509_trs.c"
                                                                     }
};
...
static struct stack_st_X509_TRUST *trtable = 
# 99 "x509/x509_trs.c" 3 4
                                      ((void *)0)
# 99 "x509/x509_trs.c"
                                          ;
...
{
 if (!trtable)
  return (sizeof(trstandard)/sizeof(X509_TRUST));
 return sk_num(((_STACK*) (1 ? (trtable) : (struct stack_st_X509_TRUST*)0))) + (sizeof(trstandard)/sizeof(X509_TRUST));
}
...
X509_TRUST_get0(int idx)
{
 if (idx < 0)
  return 
# 144 "x509/x509_trs.c" 3 4
        ((void *)0)
# 144 "x509/x509_trs.c"
            ;
 if (idx < (int)(sizeof(trstandard)/sizeof(X509_TRUST)))
  return trstandard + idx;
 return ((X509_TRUST *)sk_value(((_STACK*) (1 ? (trtable) : (struct stack_st_X509_TRUST*)0)), (idx - (sizeof(trstandard)/sizeof(X509_TRUST)))));
}
...
X509_TRUST_get_by_id(int id)
{
 ...
 if (!trtable)
  return -1;
 idx = sk_find(((_STACK*) (1 ? (trtable) : (struct stack_st_X509_TRUST*)0)), ((void*) (1 ? (&tmp) : (X509_TRUST*)0)));
 if (idx == -1)
  return -1;
 return idx + (sizeof(trstandard)/sizeof(X509_TRUST));
}
...
X509_TRUST_set(int *t, int trust)
{
 if (X509_TRUST_get_by_id(trust) == -1) {
  ERR_put_error(11,(141),(123),"x509/x509_trs.c",171);
  return 0;
 }
 *t = trust;
 return 1;
    ...
    char *name, int arg1, void *arg2)
{
 ...
 if (idx == -1) {
  if (!(trtmp = malloc(sizeof(X509_TRUST)))) {
   ERR_put_error(11,(133),((1|64)),"x509/x509_trs.c",195);
   return 0;
  }
  trtmp->flags = 1;
 } else {
  ...
  if (trtmp == 
# 201 "x509/x509_trs.c" 3 4
              ((void *)0)
# 201 "x509/x509_trs.c"
                  ) {
   ERR_put_error(11,(133),(123),"x509/x509_trs.c",202);
   return 0;
  }
 }

 if ((name_dup = my_strdup(name)) == 
# 207 "x509/x509_trs.c" 3 4
                                    ((void *)0)
# 207 "x509/x509_trs.c"
                                        )
  goto err;
 ...
 if (idx == -1) {
  if (trtable == 
# 227 "x509/x509_trs.c" 3 4
                ((void *)0) 
# 227 "x509/x509_trs.c"
                     &&
      (trtable = ((struct stack_st_X509_TRUST *)sk_new(((int (*)(const void *, const void *)) ((1 ? (tr_cmp) : (int (*)(const X509_TRUST * const *, const X509_TRUST * const *))0)))))) == 
# 228 "x509/x509_trs.c" 3 4
                                              ((void *)0)
# 228 "x509/x509_trs.c"
                                                  )
   goto err;
  if (sk_push(((_STACK*) (1 ? (trtable) : (struct stack_st_X509_TRUST*)0)), ((void*) (1 ? (trtmp) : (X509_TRUST*)0))) == 0)
   goto err;
 }
 return 1;
...
err:
 ...
 if (idx == -1)
  free(trtmp);
 ERR_put_error(11,(133),((1|64)),"x509/x509_trs.c",239);
 return 0;
}
...
X509_TRUST_cleanup(void)
{
 ...
 for (i = 0; i < (sizeof(trstandard)/sizeof(X509_TRUST)); i++)
  trtable_free(trstandard + i);
 sk_pop_free(((_STACK*) (1 ? (trtable) : (struct stack_st_X509_TRUST*)0)), ((void (*)(void *)) ((1 ? (trtable_free) : (void (*)(X509_TRUST *))0))));
 trtable = 
# 263 "x509/x509_trs.c" 3 4
          ((void *)0)
# 263 "x509/x509_trs.c"
              ;
}
...
obj_trust(int id, X509 *x, int flags)
{
 ...
 if (!ax)
  return 3;
 if (ax->reject) {
  for (i = 0; i < sk_num(((_STACK*) (1 ? (ax->reject) : (struct stack_st_ASN1_OBJECT*)0))); i++) {
   obj = ((ASN1_OBJECT *)sk_value(((_STACK*) (1 ? (ax->reject) : (struct stack_st_ASN1_OBJECT*)0)), (i)));
   if (OBJ_obj2nid(obj) == id)
    return 2;
  }
 }
 if (ax->trust) {
  for (i = 0; i < sk_num(((_STACK*) (1 ? (ax->trust) : (struct stack_st_ASN1_OBJECT*)0))); i++) {
   obj = ((ASN1_OBJECT *)sk_value(((_STACK*) (1 ? (ax->trust) : (struct stack_st_ASN1_OBJECT*)0)), (i)));
   if (OBJ_obj2nid(obj) == id)
    return 1;
  }
 }
