...
# 69 "../include/openssl/ts.h" 2
# 78 "../include/openssl/ts.h"
...
# 83 "../include/openssl/ts.h" 2
# 93 "../include/openssl/ts.h"
...
# 135 "../include/openssl/ts.h"
typedef struct TS_accuracy_st {
 ASN1_INTEGER *seconds;
 ASN1_INTEGER *millis;
 ASN1_INTEGER *micros;
} TS_ACCURACY;
# 161 "../include/openssl/ts.h"
...
# 237 "../include/openssl/ts.h"
typedef struct ESS_issuer_serial {
 struct stack_st_GENERAL_NAME *issuer;
 ASN1_INTEGER *serial;
} ESS_ISSUER_SERIAL;
# 249 "../include/openssl/ts.h"
...
static ERR_STRING_DATA TS_str_functs[] = {
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)147)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "d2i_TS_RESP"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)110)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "DEF_SERIAL_CB"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)111)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "DEF_TIME_CB"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)112)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "ESS_ADD_SIGNING_CERT"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)113)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "ESS_CERT_ID_NEW_INIT"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)114)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "ESS_SIGNING_CERT_NEW_INIT"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)149)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "INT_TS_RESP_VERIFY_TOKEN"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)148)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PKCS7_to_TS_TST_INFO"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)115)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_ACCURACY_set_micros"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)116)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_ACCURACY_set_millis"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)117)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_ACCURACY_set_seconds"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)100)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_CHECK_IMPRINTS"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)101)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_CHECK_NONCES"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)102)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_CHECK_POLICY"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)103)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_CHECK_SIGNING_CERTS"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)104)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_CHECK_STATUS_INFO"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)145)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_COMPUTE_IMPRINT"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)146)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_CONF_set_default_engine"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)105)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_GET_STATUS_TEXT"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)118)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_MSG_IMPRINT_set_algo"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)119)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_REQ_set_msg_imprint"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)120)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_REQ_set_nonce"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)121)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_REQ_set_policy_id"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)122)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_RESP_create_response"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)123)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_RESP_CREATE_TST_INFO"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)124)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_RESP_CTX_add_failure_info"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)125)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_RESP_CTX_add_md"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)126)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_RESP_CTX_add_policy"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)127)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_RESP_CTX_new"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)128)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_RESP_CTX_set_accuracy"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)129)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_RESP_CTX_set_certs"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)130)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_RESP_CTX_set_def_policy"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)131)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_RESP_CTX_set_signer_cert"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)132)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_RESP_CTX_set_status_info"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)133)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_RESP_GET_POLICY"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)134)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_RESP_SET_GENTIME_WITH_PRECISION"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)135)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_RESP_set_status_info"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)150)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_RESP_set_tst_info"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)136)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_RESP_SIGN"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)106)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_RESP_verify_signature"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)107)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_RESP_verify_token"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)137)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_TST_INFO_set_accuracy"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)138)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_TST_INFO_set_msg_imprint"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)139)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_TST_INFO_set_nonce"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)140)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_TST_INFO_set_policy_id"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)141)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_TST_INFO_set_serial"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)142)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_TST_INFO_set_time"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)143)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_TST_INFO_set_tsa"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)108)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_VERIFY"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)109)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_VERIFY_CERT"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)144)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "TS_VERIFY_CTX_new"},
 {0, 
# 126 "ts/ts_err.c" 3 4
    ((void *)0)
# 126 "ts/ts_err.c"
...
static ERR_STRING_DATA TS_str_reasons[]= {
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)132)&0xfffL))) , "bad pkcs7 type"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)133)&0xfffL))) , "bad type"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)100)&0xfffL))), "certificate verify error"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)127)&0xfffL))) , "could not set engine"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)115)&0xfffL))) , "could not set time"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)128)&0xfffL))) , "d2i ts resp int failed"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)134)&0xfffL))) , "detached content"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)116)&0xfffL))), "ess add signing cert error"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)101)&0xfffL))), "ess signing certificate error"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)102)&0xfffL))) , "invalid null pointer"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)117)&0xfffL))), "invalid signer certificate purpose"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)103)&0xfffL))), "message imprint mismatch"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)104)&0xfffL))) , "nonce mismatch"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)105)&0xfffL))) , "nonce not returned"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)106)&0xfffL))) , "no content"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)107)&0xfffL))) , "no time stamp token"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)118)&0xfffL))), "pkcs7 add signature error"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)119)&0xfffL))), "pkcs7 add signed attr error"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)129)&0xfffL))), "pkcs7 to ts tst info failed"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)108)&0xfffL))) , "policy mismatch"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)120)&0xfffL))), "private key does not match certificate"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)121)&0xfffL))) , "response setup error"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)109)&0xfffL))) , "signature failure"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)110)&0xfffL))), "there must be one signer"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)122)&0xfffL))) , "time syscall error"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)130)&0xfffL))) , "token not present"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)131)&0xfffL))) , "token present"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)111)&0xfffL))) , "tsa name mismatch"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)112)&0xfffL))) , "tsa untrusted"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)123)&0xfffL))) , "tst info setup error"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)124)&0xfffL))) , "ts datasign"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)125)&0xfffL))) , "unacceptable policy"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)126)&0xfffL))), "unsupported md algorithm"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)113)&0xfffL))) , "unsupported version"},
 {(((((unsigned long)47)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)114)&0xfffL))) , "wrong content type"},
 {0, 
# 165 "ts/ts_err.c" 3 4
    ((void *)0)
# 165 "ts/ts_err.c"
...
ERR_load_TS_strings(void)
{
 ...
 if (ERR_func_error_string(TS_str_functs[0].error) == 
# 174 "ts/ts_err.c" 3 4
                                                     ((void *)0)
# 174 "ts/ts_err.c"
                                                         ) {
