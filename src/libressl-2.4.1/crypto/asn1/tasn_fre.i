...
# 68 "asn1/tasn_fre.c" 2

# 1 "./enclaveshim_config.h" 1
# 70 "asn1/tasn_fre.c" 2
...
ASN1_template_free(ASN1_VALUE **pval, const ASN1_TEMPLATE *tt)
{
 ...
 if (tt->flags & (0x3 << 1)) {
  ...
  for (i = 0; i < sk_num(((_STACK*) (1 ? (sk) : (struct stack_st_ASN1_VALUE*)0))); i++) {
   ASN1_VALUE *vtmp;
   vtmp = ((ASN1_VALUE *)sk_value(((_STACK*) (1 ? (sk) : (struct stack_st_ASN1_VALUE*)0)), (i)));
   asn1_item_combine_free(&vtmp, (tt->item),
       0);
  }
  sk_free(((_STACK*) (1 ? (sk) : (struct stack_st_ASN1_VALUE*)0)));
  *pval = 
# 207 "asn1/tasn_fre.c" 3 4
         ((void *)0)
# 207 "asn1/tasn_fre.c"
             ;
 } else
...
ASN1_primitive_free(ASN1_VALUE **pval, const ASN1_ITEM *it)
{
 ...
 case -4:
  ASN1_primitive_free(pval, 
# 258 "asn1/tasn_fre.c" 3 4
                           ((void *)0)
# 258 "asn1/tasn_fre.c"
                               );
  free(*pval);
