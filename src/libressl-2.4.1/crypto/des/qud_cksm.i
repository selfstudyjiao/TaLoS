...
unsigned int DES_quad_cksum(const unsigned char *input, DES_cblock output[],
 ...
 lp = (unsigned int *) &(output[0])[0];

 z0=(((unsigned int)((*seed)[0])))|(((unsigned int)((*seed)[1]))<<8)|(((unsigned int)((*seed)[2]))<<16)|(((unsigned int)((*seed)[3]))<<24);
 z1=(((unsigned int)((*seed)[4])))|(((unsigned int)((*seed)[5]))<<8)|(((unsigned int)((*seed)[6]))<<16)|(((unsigned int)((*seed)[7]))<<24);
 ...
 for (i=0; ((i<4)&&(i<out_count)); i++)
  ...
  while (l > 0)
   ...
   if (l > 1)
    {
    t0= (unsigned int)(*(cp++));
    t0|=(unsigned int)(((unsigned int)(*(cp++)))<<8);
    l--;
    }
   else
    t0= (unsigned int)(*(cp++));
   ...
   z1=((t0*((t1+((unsigned int)83653421L))&0xffffffffL))&0xffffffffL)%0x7fffffffL;
   }
  if (lp != 
# 115 "des/qud_cksm.c" 3 4
           ((void *)0)
# 115 "des/qud_cksm.c"
               )
   {
