...
SSL_CIPHER ssl3_ciphers[] = {
...

 {
  ...
  .algo_strength = 0x00000004L,
  .algorithm2 = (0x10 | 0x20)|((0x10 << 10) | (0x20 << 10)),
  .strength_bits = 0,
  .alg_bits = 0,
 },
...

 {
  ...
  .algorithm_enc = 0x00000200L,
  .algorithm_mac = 0x00000008L,
  .algorithm_ssl = 0x00000002L,
  .algo_strength = 0x00000080L,
  .algorithm2 = 0x40|(0x40 << 10)|
      0x04,
  .strength_bits = 256,
  .alg_bits = 256
 },
...

 {
  ...
  .algorithm_mkey = 0x00000001L,
  .algorithm_auth = 0x00000001L,
  .algorithm_enc = 0x00000400L,
  .algorithm_mac = 0x00000040L,
  .algorithm_ssl = 0x00000004L,
  .algo_strength = 0x00000080L,
  .algorithm2 = 0x80|(0x80 << 10)|
      (1 << 23)|(((4 / 2) & 0xf) << 24)|
      (1 << 22),
  .strength_bits = 128,
  .alg_bits = 128,
...

 {
  ...
  .algorithm_mkey = 0x00000001L,
  .algorithm_auth = 0x00000001L,
  .algorithm_enc = 0x00000800L,
  .algorithm_mac = 0x00000040L,
  .algorithm_ssl = 0x00000004L,
  .algo_strength = 0x00000080L,
  .algorithm2 = 0x100|(0x100 << 10)|
      (1 << 23)|(((4 / 2) & 0xf) << 24)|
      (1 << 22),
  .strength_bits = 256,
  .alg_bits = 256,
...
{
 return ((sizeof(ssl3_ciphers) / sizeof(SSL_CIPHER)));
}

const SSL_CIPHER *
ssl3_get_cipher(unsigned int u)
{
 if (u < (sizeof(ssl3_ciphers) / sizeof(SSL_CIPHER)))
  return (&(ssl3_ciphers[(sizeof(ssl3_ciphers) / sizeof(SSL_CIPHER)) - 1 - u]));
 else
  return (
# 1968 "../ssl/s3_lib.c" 3 4
         ((void *)0)
# 1968 "../ssl/s3_lib.c"
             );
}
...
ssl3_get_cipher_by_id(unsigned int id)
{
 ...
 c.id = id;
 cp = OBJ_bsearch_ssl_cipher_id(&c, ssl3_ciphers, (sizeof(ssl3_ciphers) / sizeof(SSL_CIPHER)));
 if (cp != 
# 1979 "../ssl/s3_lib.c" 3 4
          ((void *)0) 
# 1979 "../ssl/s3_lib.c"
               && cp->valid == 1)
  return (cp);
...
{
 return ssl3_get_cipher_by_id(0x03000000 | value);
}

uint16_t
ssl3_cipher_get_value(const SSL_CIPHER *c)
{
 return (c->id & 0x0000ffff);
}
...
{
 return ((s->method->ssl3_enc->enc_flags & (1 << 3)) ? 12 :
            4);
}
...
ssl3_handshake_msg_finish(SSL *s, unsigned int len)
{
 ...
 msg_type = *(p++);
 ((p[0]=(unsigned char)(((len)>>16)&0xff), p[1]=(unsigned char)(((len)>> 8)&0xff), p[2]=(unsigned char)(((len) )&0xff)),p+=3);
...
# 2108 "../ssl/s3_lib.c"
 ...
 DH_free(s->s3->tmp.dh);
 s->s3->tmp.dh = 
# 2112 "../ssl/s3_lib.c" 3 4
                ((void *)0)
# 2112 "../ssl/s3_lib.c"
                    ;
 EC_KEY_free(s->s3->tmp.ecdh);
 s->s3->tmp.ecdh = 
# 2114 "../ssl/s3_lib.c" 3 4
                  ((void *)0)
# 2114 "../ssl/s3_lib.c"
                      ;
...
ssl3_ctrl(SSL *s, int cmd, long larg, void *parg)
{
 ...
 if (cmd == 3 || cmd == 6) {
  if (!ssl_cert_inst(&s->cert)) {
   ERR_put_error(20,(213),((1|64)),"../ssl/s3_lib.c",2158)
                            ;
   return (0);
  }
 }
 ...
 case 2:
 case 5:
  ERR_put_error(20,(213),((2|64)),"../ssl/s3_lib.c",2187);
  break;
 case 3:
  {
   DH *dh = (DH *)parg;
   if (dh == 
# 2192 "../ssl/s3_lib.c" 3 4
            ((void *)0)
# 2192 "../ssl/s3_lib.c"
                ) {
    ERR_put_error(20,(213),((3|64)),"../ssl/s3_lib.c",2194)
                                    ;
    return (ret);
   }
   if ((dh = DHparams_dup(dh)) == 
# 2197 "../ssl/s3_lib.c" 3 4
                                 ((void *)0)
# 2197 "../ssl/s3_lib.c"
                                     ) {
    ERR_put_error(20,(213),(5),"../ssl/s3_lib.c",2199)
                     ;
    return (ret);
   }
 ...
 case 6:
  ERR_put_error(20,(213),((2|64)),"../ssl/s3_lib.c",2209);
  return (ret);
 ...
 case 4:
  {
   EC_KEY *ecdh = 
# 2218 "../ssl/s3_lib.c" 3 4
                 ((void *)0)
# 2218 "../ssl/s3_lib.c"
                     ;

   if (parg == 
# 2220 "../ssl/s3_lib.c" 3 4
              ((void *)0)
# 2220 "../ssl/s3_lib.c"
                  ) {
    ERR_put_error(20,(213),((3|64)),"../ssl/s3_lib.c",2222)
                                    ;
    return (ret);
   }
   if (!EC_KEY_up_ref((EC_KEY *)parg)) {
    ERR_put_error(20,(213),(43),"../ssl/s3_lib.c",2227)
                       ;
    return (ret);
   }
   ecdh = (EC_KEY *)parg;
   if (!(s->options & 0x00080000L)) {
    if (!EC_KEY_generate_key(ecdh)) {
     EC_KEY_free(ecdh);
     ERR_put_error(20,(213),(43),"../ssl/s3_lib.c",2235)
                        ;
     return (ret);
    }
   }
 ...
 case 7:
  {
   ERR_put_error(20,(213),((2|64)),"../ssl/s3_lib.c",2247)
                                         ;
   return (ret);
  }
  break;
...
# 2254 "../ssl/s3_lib.c"
   ...
   ret = 1;
   if (parg == 
# 2257 "../ssl/s3_lib.c" 3 4
              ((void *)0)
# 2257 "../ssl/s3_lib.c"
                  )
    break;
   if (strlen((char *)parg) > 255) {
    ERR_put_error(20,(213),(319),"../ssl/s3_lib.c",2261)
                                          ;
    return 0;
   }
   if ((s->tlsext_hostname = my_strdup((char *)parg))
       == 
# 2265 "../ssl/s3_lib.c" 3 4
         ((void *)0)
# 2265 "../ssl/s3_lib.c"
             ) {
    ERR_put_error(20,(213),((4|64)),"../ssl/s3_lib.c",2267)
                             ;
    return 0;
   }
  } else {
   ERR_put_error(20,(213),(320),"../ssl/s3_lib.c",2272)
                                              ;
   return 0;
  }
  break;
 ...
 case 66:
  *(struct stack_st_X509_EXTENSION **)parg = s->tlsext_ocsp_exts;
  ret = 1;
  break;
 ...
 case 68:
  *(struct stack_st_OCSP_RESPID **)parg = s->tlsext_ocsp_ids;
  ret = 1;
  break;
...
ssl3_callback_ctrl(SSL *s, int cmd, void (*fp)(void))
{
 ...
 if (cmd == 6) {
  if (!ssl_cert_inst(&s->cert)) {
   ERR_put_error(20,(233),((1|64)),"../ssl/s3_lib.c",2342)
                            ;
   return (0);
  }
 }
 ...
 switch (cmd) {
 case 5:
  ERR_put_error(20,(213),((2|64)),"../ssl/s3_lib.c",2349);
  break;
 case 6:
...
ssl3_ctx_ctrl(SSL_CTX *ctx, int cmd, long larg, void *parg)
{
 ...
 case 2:
 case 5:
  ERR_put_error(20,(133),((2|64)),"../ssl/s3_lib.c",2379);
  return (0);
 case 3:
  {
   DH *new = 
# 2383 "../ssl/s3_lib.c" 3 4
            ((void *)0)
# 2383 "../ssl/s3_lib.c"
                , *dh;

   dh = (DH *)parg;
   if ((new = DHparams_dup(dh)) == 
# 2386 "../ssl/s3_lib.c" 3 4
                                  ((void *)0)
# 2386 "../ssl/s3_lib.c"
                                      ) {
    ERR_put_error(20,(133),(5),"../ssl/s3_lib.c",2388)
                     ;
    return 0;
   }
   DH_free(cert->dh_tmp);
 ...
 case 6:
  ERR_put_error(20,(133),((2|64)),"../ssl/s3_lib.c",2398);
  return (0);
 ...
 case 4:
  {
   EC_KEY *ecdh = 
# 2407 "../ssl/s3_lib.c" 3 4
                 ((void *)0)
# 2407 "../ssl/s3_lib.c"
                     ;

   if (parg == 
# 2409 "../ssl/s3_lib.c" 3 4
              ((void *)0)
# 2409 "../ssl/s3_lib.c"
                  ) {
    ERR_put_error(20,(133),(43),"../ssl/s3_lib.c",2411)
                       ;
    return 0;
   }
   ecdh = EC_KEY_dup((EC_KEY *)parg);
   if (ecdh == 
# 2415 "../ssl/s3_lib.c" 3 4
              ((void *)0)
# 2415 "../ssl/s3_lib.c"
                  ) {
    ERR_put_error(20,(133),(16),"../ssl/s3_lib.c",2417)
                     ;
    return 0;
   }
   if (!(ctx->options & 0x00080000L)) {
    if (!EC_KEY_generate_key(ecdh)) {
     EC_KEY_free(ecdh);
     ERR_put_error(20,(133),(43),"../ssl/s3_lib.c",2424)
                        ;
     return 0;
    }
   }
 ...
 case 7:
  {
   ERR_put_error(20,(133),((2|64)),"../ssl/s3_lib.c",2437)
                                         ;
   return (0);
  }
  break;
 ...
 case 58:
  {
   ...
   if (!keys)
    return 48;
   if (larg != 48) {
    ERR_put_error(20,(133),(325),"../ssl/s3_lib.c",2452)
                                         ;
    return 0;
   }
   if (cmd == 59) {
...
# 2486 "../ssl/s3_lib.c"
 case 14:
  if (ctx->extra_certs == 
# 2487 "../ssl/s3_lib.c" 3 4
                         ((void *)0)
# 2487 "../ssl/s3_lib.c"
                             ) {
   if ((ctx->extra_certs = ((struct stack_st_X509 *)sk_new_null())) == 
# 2488 "../ssl/s3_lib.c" 3 4
                                                 ((void *)0)
# 2488 "../ssl/s3_lib.c"
                                                     )
    return (0);
  }
  sk_push(((_STACK*) (1 ? (ctx->extra_certs) : (struct stack_st_X509*)0)), ((void*) (1 ? ((X509 *)parg) : (X509*)0)));
  break;

 case 82:
  *(struct stack_st_X509 **)parg = ctx->extra_certs;
  break;

 case 83:
  if (ctx->extra_certs) {
   sk_pop_free(((_STACK*) (1 ? (ctx->extra_certs) : (struct stack_st_X509*)0)), ((void (*)(void *)) ((1 ? (X509_free) : (void (*)(X509 *))0))));
   ctx->extra_certs = 
# 2501 "../ssl/s3_lib.c" 3 4
                     ((void *)0)
# 2501 "../ssl/s3_lib.c"
                         ;
  }
...
ssl3_ctx_callback_ctrl(SSL_CTX *ctx, int cmd, void (*fp)(void))
{
 ...
 switch (cmd) {
 case 5:
  ERR_put_error(20,(133),((2|64)),"../ssl/s3_lib.c",2520);
  return (0);
 case 6:
...
{
 if (p != 
# 2578 "../ssl/s3_lib.c" 3 4
         ((void *)0)
# 2578 "../ssl/s3_lib.c"
             ) {
  if ((c->id & ~0x0000ffff) != 0x03000000)
   return (0);
...
SSL_CIPHER *
ssl3_choose_cipher(SSL *s, struct stack_st_SSL_CIPHER *clnt,
    struct stack_st_SSL_CIPHER *srvr)
{
 unsigned long alg_k, alg_a, mask_k, mask_a;
 struct stack_st_SSL_CIPHER *prio, *allow;
 SSL_CIPHER *c, *ret = 
# 2592 "../ssl/s3_lib.c" 3 4
                      ((void *)0)
# 2592 "../ssl/s3_lib.c"
                          ;
 int i, ii, ok;
...
# 2606 "../ssl/s3_lib.c"
 ...
 for (i = 0; i < sk_num(((_STACK*) (1 ? (prio) : (struct stack_st_SSL_CIPHER*)0))); i++) {
  c = ((SSL_CIPHER *)sk_value(((_STACK*) (1 ? (prio) : (struct stack_st_SSL_CIPHER*)0)), (i)));


  if ((c->algorithm_ssl & 0x00000004L) &&
      !(s->method->ssl3_enc->enc_flags & (1 << 4)))
   continue;
  ...
  if (alg_a & (0x00000040L|0x00000010L))
  ...
  if (!ok)
   continue;
  ii = sk_find(((_STACK*) (1 ? (allow) : (struct stack_st_SSL_CIPHER*)0)), ((void*) (1 ? (c) : (SSL_CIPHER*)0)));
  if (ii >= 0) {
   ret = ((SSL_CIPHER *)sk_value(((_STACK*) (1 ? (allow) : (struct stack_st_SSL_CIPHER*)0)), (ii)));
   break;
  }
 }
 return (ret);
...
# 2765 "../ssl/s3_lib.c"
 if ((s->s3->flags & 0x0004) && (s->wbio == s->bbio)) {

  if (s->s3->delay_buf_pop_ret == 0) {
   ret = ssl3_write_bytes(s, 23,
       buf, len);
   if (ret <= 0)
    return (ret);
  ...
  s->rwstate = 2;
  n = (int)BIO_ctrl(s->wbio,11,0,
# 2777 "../ssl/s3_lib.c" 3 4
     ((void *)0)
# 2777 "../ssl/s3_lib.c"
     );
  if (n <= 0)
  ...
  ret = s->method->ssl_write_bytes(s, 23,
      buf, len);
  if (ret <= 0)
   return (ret);
 }
...
{
 if (s->handshake_func == 
# 2842 "../ssl/s3_lib.c" 3 4
                         ((void *)0)
# 2842 "../ssl/s3_lib.c"
                             )
  return (1);

 if (s->s3->flags & 0x0001)
  return (0);
...
ssl_get_algorithm2(SSL *s)
{
 ...
 if (s->method->ssl3_enc->enc_flags & (1 << 2) &&
     alg2 == ((0x10 | 0x20)|((0x10 << 10) | (0x20 << 10))))
  return 0x80 | (0x80 << 10);
 return alg2;
}
