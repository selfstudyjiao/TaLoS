...
# 187 "../ssl/d1_srvr.c" 3 4
(*__errno_location ()) 
# 187 "../ssl/d1_srvr.c"
      = 0;

 if (s->info_callback != 
# 189 "../ssl/d1_srvr.c" 3 4
                        ((void *)0)
# 189 "../ssl/d1_srvr.c"
                            )
  cb = s->info_callback;
 else if (s->ctx->info_callback != 
# 191 "../ssl/d1_srvr.c" 3 4
                                  ((void *)0)
# 191 "../ssl/d1_srvr.c"
                                      )
 ...
 if (s->cert == 
# 203 "../ssl/d1_srvr.c" 3 4
               ((void *)0)
# 203 "../ssl/d1_srvr.c"
                   ) {
  ERR_put_error(20,(246),(179),"../ssl/d1_srvr.c",204);
  ret = -1;
  goto end;
 }
...
# 223 "../ssl/d1_srvr.c"
   ...
   if ((s->version & 0xff00) != (0xFEFF & 0xff00)) {
    ERR_put_error(20,(246),((4|64)),"../ssl/d1_srvr.c",227);
    ret = -1;
    goto end;
   }
   s->type = 0x2000;
  ...
  case (0x121|0x2000):
   ...
   if (ret <= 0)
    goto end;
   s->s3->tmp.next_state = (0x110|0x2000);
  ...
  case (0x112|0x2000):
   ...
   if (ret == 1 && (SSL_ctrl((s),32,0,
# 303 "../ssl/d1_srvr.c" 3 4
                   ((void *)0)
# 303 "../ssl/d1_srvr.c"
                   ) & 0x00002000L))
    s->state = (0x113|0x2000);
   else
   ...
   if (listen && s->state == (0x130|0x2000)) {
    ret = 2;
    s->d1->listen = 0;
...
# 455 "../ssl/d1_srvr.c"
  ...
  case (0x191|0x2000):
   ...
   if (ret == 2) {
    ...
    s->init_num = 0;
   } else if ((s->method->ssl3_enc->enc_flags & (1 << 1))) {
    s->state = (0x1A0|0x2000);
    s->init_num = 0;
    if (!s->session->peer)
     break;
    ...
    if (!s->s3->handshake_buffer) {
     ERR_put_error(20,(128),((4|64)),"../ssl/d1_srvr.c",509)
                              ;
     ret = -1;
     goto end;
    }
  ...
  case (0x1E1|0x2000):
   ...
   s->state = (0x100|0x2000);
   if (s->hit) {
    s->s3->tmp.next_state = (0x1C0|0x2000);
...
# 646 "../ssl/d1_srvr.c"
  ...
  default:
   ERR_put_error(20,(246),(255),"../ssl/d1_srvr.c",661);
   ret = -1;
   goto end;
...
dtls1_send_hello_verify_request(SSL *s)
{
  ...
  *(p++) = s->version & 0xFF;
  ...
  if (s->ctx->app_gen_cookie_cb == 
# 705 "../ssl/d1_srvr.c" 3 4
                                  ((void *)0) 
# 705 "../ssl/d1_srvr.c"
                                       ||
      s->ctx->app_gen_cookie_cb(s, s->d1->cookie,
   &(s->d1->cookie_len)) == 0) {
   ERR_put_error(20,(264),((4|64)),"../ssl/d1_srvr.c",709)
                            ;
   return 0;
  }
...
dtls1_send_server_certificate(SSL *s)
{
 ...
 if (s->state == (0x140|0x2000)) {
  ...
  if (x == 
# 734 "../ssl/d1_srvr.c" 3 4
          ((void *)0)
# 734 "../ssl/d1_srvr.c"
              ) {
   ERR_put_error(20,(265),((4|64)),"../ssl/d1_srvr.c",736)
                            ;
   return (0);
  }
