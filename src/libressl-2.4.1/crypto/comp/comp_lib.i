...
COMP_CTX_new(COMP_METHOD *meth)
{
 ...
 if ((ret = calloc(1, sizeof(COMP_CTX))) == 
# 13 "comp/comp_lib.c" 3 4
                                           ((void *)0)
# 13 "comp/comp_lib.c"
                                               ) {
  return (
# 14 "comp/comp_lib.c" 3 4
         ((void *)0)
# 14 "comp/comp_lib.c"
             );
 }
 ret->meth = meth;
 if ((ret->meth->init != 
# 17 "comp/comp_lib.c" 3 4
                        ((void *)0)
# 17 "comp/comp_lib.c"
                            ) && !ret->meth->init(ret)) {
  free(ret);
  ret = 
# 19 "comp/comp_lib.c" 3 4
       ((void *)0)
# 19 "comp/comp_lib.c"
           ;
 }
