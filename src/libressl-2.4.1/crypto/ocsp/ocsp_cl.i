...
# 84 "ocsp/ocsp_cl.c"
 ...
 one->reqCert = cid;
 if (req && !sk_push(((_STACK*) (1 ? (req->tbsRequest->requestList) : (struct stack_st_OCSP_ONEREQ*)0)), ((void*) (1 ? (one) : (OCSP_ONEREQ*)0))))
  goto err;
 return one;
...
OCSP_request_add1_cert(OCSP_REQUEST *req, X509 *cert)
{
 ...
 if (!cert)
  return 1;
 if (!sig->certs && !(sig->certs = ((struct stack_st_X509 *)sk_new_null())))
  return 0;

 if (!sk_push(((_STACK*) (1 ? (sig->certs) : (struct stack_st_X509*)0)), ((void*) (1 ? (cert) : (X509*)0))))
  return 0;
 CRYPTO_add_lock(&cert->references,1,3,"ocsp/ocsp_cl.c",138);
 return 1;
}
    ...
    const EVP_MD *dgst, struct stack_st_X509 *certs, unsigned long flags)
{
 ...
 if (key) {
  if (!X509_check_private_key(signer, key)) {
   ERR_put_error(39,(110),(110),"ocsp/ocsp_cl.c",163)
                                                     ;
   goto err;
  }
  if (!ASN1_item_sign((&(OCSP_REQINFO_it)), req->optionalSignature->signatureAlgorithm,
# 166 "ocsp/ocsp_cl.c" 3 4
      ((void *)0)
# 166 "ocsp/ocsp_cl.c"
...
err:
 ...
 req->optionalSignature = 
# 184 "ocsp/ocsp_cl.c" 3 4
                         ((void *)0)
# 184 "ocsp/ocsp_cl.c"
                             ;
 return 0;
...
OCSP_response_get1_basic(OCSP_RESPONSE *resp)
{
 ...
 if (!rb) {
  ERR_put_error(39,(111),(108),"ocsp/ocsp_cl.c",206)
                              ;
  return 
# 207 "ocsp/ocsp_cl.c" 3 4
        ((void *)0)
# 207 "ocsp/ocsp_cl.c"
            ;
 }
 if (OBJ_obj2nid(rb->responseType) != 365) {
  ERR_put_error(39,(111),(104),"ocsp/ocsp_cl.c",211)
                                ;
  return 
# 212 "ocsp/ocsp_cl.c" 3 4
        ((void *)0)
# 212 "ocsp/ocsp_cl.c"
            ;
 }
...
OCSP_resp_count(OCSP_BASICRESP *bs)
{
 if (!bs)
  return -1;
 return sk_num(((_STACK*) (1 ? (bs->tbsResponseData->responses) : (struct stack_st_OCSP_SINGLERESP*)0)));
}
...
OCSP_resp_get0(OCSP_BASICRESP *bs, int idx)
{
 if (!bs)
  return 
# 234 "ocsp/ocsp_cl.c" 3 4
        ((void *)0)
# 234 "ocsp/ocsp_cl.c"
            ;
 return ((OCSP_SINGLERESP *)sk_value(((_STACK*) (1 ? (bs->tbsResponseData->responses) : (struct stack_st_OCSP_SINGLERESP*)0)), (idx)));
}
...
OCSP_resp_find(OCSP_BASICRESP *bs, OCSP_CERTID *id, int last)
{
 ...
 for (i = last; i < sk_num(((_STACK*) (1 ? (sresp) : (struct stack_st_OCSP_SINGLERESP*)0))); i++) {
  single = ((OCSP_SINGLERESP *)sk_value(((_STACK*) (1 ? (sresp) : (struct stack_st_OCSP_SINGLERESP*)0)), (i)));
    ...
    ASN1_GENERALIZEDTIME *nextupd, long nsec, long maxsec)
{
 ...
 if (!ASN1_GENERALIZEDTIME_check(thisupd)) {
  ERR_put_error(39,(115),(123),"ocsp/ocsp_cl.c",337)
                                       ;
  ret = 0;
 } else {
  t_tmp = t_now + nsec;
  if (X509_cmp_time(thisupd, &t_tmp) > 0) {
   ERR_put_error(39,(115),(126),"ocsp/ocsp_cl.c",343)
                                   ;
   ret = 0;
  }
  ...
  if (maxsec >= 0) {
   t_tmp = t_now - maxsec;
   if (X509_cmp_time(thisupd, &t_tmp) < 0) {
    ERR_put_error(39,(115),(127),"ocsp/ocsp_cl.c",352)
                              ;
    ret = 0;
   }
  }
 ...
 if (!ASN1_GENERALIZEDTIME_check(nextupd)) {
  ERR_put_error(39,(115),(122),"ocsp/ocsp_cl.c",364)
                                       ;
  ret = 0;
 } else {
  t_tmp = t_now - nsec;
  if (X509_cmp_time(nextupd, &t_tmp) < 0) {
   ERR_put_error(39,(115),(125),"ocsp/ocsp_cl.c",370)
                             ;
   ret = 0;
  }
 }
 ...
 if (ASN1_STRING_cmp(nextupd, thisupd) < 0) {
  ERR_put_error(39,(115),(124),"ocsp/ocsp_cl.c",378)
                                          ;
  ret = 0;
 }
