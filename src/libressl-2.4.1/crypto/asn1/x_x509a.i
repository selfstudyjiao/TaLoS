...
aux_get(X509 *x)
{
 if (!x)
  return 
# 155 "asn1/x_x509a.c" 3 4
        ((void *)0)
# 155 "asn1/x_x509a.c"
            ;
 if (!x->aux && !(x->aux = X509_CERT_AUX_new()))
  return 
# 157 "asn1/x_x509a.c" 3 4
        ((void *)0)
# 157 "asn1/x_x509a.c"
            ;
 return x->aux;
...
static unsigned char* ecall_alias_buffer = 
# 197 "asn1/x_x509a.c" 3 4
                                          ((void *)0)
# 197 "asn1/x_x509a.c"
                                              ;
...
X509_add1_trust_object(X509 *x, ASN1_OBJECT *obj)
{
 ...
 if (!(aux = aux_get(x)))
  goto err;
 if (!aux->trust && !(aux->trust = ((struct stack_st_ASN1_OBJECT *)sk_new_null())))
  goto err;
 rc = sk_push(((_STACK*) (1 ? (aux->trust) : (struct stack_st_ASN1_OBJECT*)0)), ((void*) (1 ? (objtmp) : (ASN1_OBJECT*)0)));
 if (rc != 0)
  return rc;
...
X509_add1_reject_object(X509 *x, ASN1_OBJECT *obj)
{
 ...
 if (!(aux = aux_get(x)))
  goto err;
 if (!aux->reject && !(aux->reject = ((struct stack_st_ASN1_OBJECT *)sk_new_null())))
  goto err;
 rc = sk_push(((_STACK*) (1 ? (aux->reject) : (struct stack_st_ASN1_OBJECT*)0)), ((void*) (1 ? (objtmp) : (ASN1_OBJECT*)0)));
 if (rc != 0)
  return rc;
...
X509_trust_clear(X509 *x)
{
 if (x->aux && x->aux->trust) {
  sk_pop_free(((_STACK*) (1 ? (x->aux->trust) : (struct stack_st_ASN1_OBJECT*)0)), ((void (*)(void *)) ((1 ? (ASN1_OBJECT_free) : (void (*)(ASN1_OBJECT *))0))));
  x->aux->trust = 
# 285 "asn1/x_x509a.c" 3 4
                 ((void *)0)
# 285 "asn1/x_x509a.c"
                     ;
 }
...
X509_reject_clear(X509 *x)
{
 if (x->aux && x->aux->reject) {
  sk_pop_free(((_STACK*) (1 ? (x->aux->reject) : (struct stack_st_ASN1_OBJECT*)0)), ((void (*)(void *)) ((1 ? (ASN1_OBJECT_free) : (void (*)(ASN1_OBJECT *))0))));
  x->aux->reject = 
# 294 "asn1/x_x509a.c" 3 4
                  ((void *)0)
# 294 "asn1/x_x509a.c"
                      ;
 }
