...
{
 if (x == 
# 74 "x509/x509_set.c" 3 4
         ((void *)0)
# 74 "x509/x509_set.c"
             )
  return (0);
 if (x->cert_info->version == 
# 76 "x509/x509_set.c" 3 4
                             ((void *)0)
# 76 "x509/x509_set.c"
                                 ) {
  if ((x->cert_info->version = ASN1_INTEGER_new()) == 
# 77 "x509/x509_set.c" 3 4
                                                     ((void *)0)
# 77 "x509/x509_set.c"
                                                         )
   return (0);
...
X509_set_notBefore(X509 *x, const ASN1_TIME *tm)
{
 ...
 if ((x == 
# 134 "x509/x509_set.c" 3 4
          ((void *)0)
# 134 "x509/x509_set.c"
              ) || (x->cert_info->validity == 
# 134 "x509/x509_set.c" 3 4
                                              ((void *)0)
# 134 "x509/x509_set.c"
                                                  ))
