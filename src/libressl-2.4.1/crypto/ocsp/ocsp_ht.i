...
# 123 "ocsp/ocsp_ht.c" 3 4
                                                        ((void *)0)
# 123 "ocsp/ocsp_ht.c"
                                                            )) <= 0)
  return 0;
 if ((ASN1_i2d_bio(((i2d_of_void*) (1 ? i2d_OCSP_REQUEST : ((int (*)(OCSP_REQUEST *,unsigned char **))0))), rctx->mem, ((void*) (1 ? req : (OCSP_REQUEST*)0)))) <= 0)
  return 0;
 rctx->state = (6 | 0x1000);
 rctx->asn1_len = BIO_ctrl(rctx->mem,3,0,(char *)
# 128 "ocsp/ocsp_ht.c" 3 4
                 ((void *)0)
# 128 "ocsp/ocsp_ht.c"
                 );
 return 1;
...
OCSP_sendreq_new(BIO *io, char *path, OCSP_REQUEST *req, int maxline)
{
 ...
 if (rctx == 
# 157 "ocsp/ocsp_ht.c" 3 4
            ((void *)0)
# 157 "ocsp/ocsp_ht.c"
                )
  return 
# 158 "ocsp/ocsp_ht.c" 3 4
        ((void *)0)
# 158 "ocsp/ocsp_ht.c"
            ;
 rctx->state = (0 | 0x1000);
...
# 204 "ocsp/ocsp_ht.c"
  ...
  continue;
 if (!*p) {
  ERR_put_error(39,(118),(115),"ocsp/ocsp_ht.c",208)
                                         ;
  return 0;
 }
...
# 213 "ocsp/ocsp_ht.c"
  ...
  p++;
 if (!*p) {
  ERR_put_error(39,(118),(115),"ocsp/ocsp_ht.c",217)
                                         ;
  return 0;
 }
...
# 222 "ocsp/ocsp_ht.c"
  ...
  continue;
 if (!*q) {
  ERR_put_error(39,(118),(115),"ocsp/ocsp_ht.c",226)
                                         ;
  return 0;
 }
...
# 247 "ocsp/ocsp_ht.c"
 ...
 if (retcode != 200) {
  ERR_put_error(39,(118),(114),"ocsp/ocsp_ht.c",251);
  if (!*q)
...
next_io:
 if (!(rctx->state & 0x1000)) {
  n = BIO_read(rctx->io, rctx->iobuf, rctx->iobuflen);

  if (n <= 0) {
   if (BIO_test_flags(rctx->io, 0x08))
    return -1;
   return 0;
  }
 ...
 switch (rctx->state) {
 case (6 | 0x1000):
  n = BIO_ctrl(rctx->mem,3,0,(char *)&p);
  i = BIO_write(rctx->io,
  ...
  (void)(int)BIO_ctrl(rctx->mem,1,0,
# 301 "ocsp/ocsp_ht.c" 3 4
       ((void *)0)
# 301 "ocsp/ocsp_ht.c"
       );
 ...
 case (7 | 0x1000):
  i = (int)BIO_ctrl(rctx->io,11,0,
# 305 "ocsp/ocsp_ht.c" 3 4
     ((void *)0)
# 305 "ocsp/ocsp_ht.c"
     );
  if (i > 0) {
...
next_line:
  ...
  if (n <= 0) {
   if (BIO_test_flags(rctx->mem, 0x08))
    goto next_io;
   rctx->state = (0 | 0x1000);
   return 0;
  }
  ...
  *presp = d2i_OCSP_RESPONSE(
# 425 "ocsp/ocsp_ht.c" 3 4
                            ((void *)0)
# 425 "ocsp/ocsp_ht.c"
                                , &p, rctx->asn1_len);
  if (*presp) {
...
# 445 "ocsp/ocsp_ht.c"
 ...
 if (ctx == 
# 450 "ocsp/ocsp_ht.c" 3 4
           ((void *)0)
# 450 "ocsp/ocsp_ht.c"
               )
  return 
# 451 "ocsp/ocsp_ht.c" 3 4
        ((void *)0)
# 451 "ocsp/ocsp_ht.c"
            ;
 ...
 } while ((rv == -1) && BIO_test_flags(b, 0x08));
