...
# 103 "asn1/bio_ndef.c" 3 4
                         ((void *)0)
# 103 "asn1/bio_ndef.c"
                             ;
 BIO *asn_bio = 
# 104 "asn1/bio_ndef.c" 3 4
               ((void *)0)
# 104 "asn1/bio_ndef.c"
                   ;
 ...
 if (!aux || !aux->asn1_cb) {
  ERR_put_error(13,(208),(202),"asn1/bio_ndef.c",109);
  return 
# 110 "asn1/bio_ndef.c" 3 4
        ((void *)0)
# 110 "asn1/bio_ndef.c"
            ;
 }
 ...
 sarg.out = out;
 sarg.ndef_bio = 
# 130 "asn1/bio_ndef.c" 3 4
                ((void *)0)
# 130 "asn1/bio_ndef.c"
                    ;
 sarg.boundary = 
# 131 "asn1/bio_ndef.c" 3 4
                ((void *)0)
# 131 "asn1/bio_ndef.c"
                    ;

 if (aux->asn1_cb(10, &val, it, &sarg) <= 0)
  goto err;
 ...
 BIO_ctrl(asn_bio, 153, 0, ndef_aux);
...
ndef_prefix_free(BIO *b, unsigned char **pbuf, int *plen, void *parg)
{
 ...
 ndef_aux->derbuf = 
# 190 "asn1/bio_ndef.c" 3 4
                   ((void *)0)
# 190 "asn1/bio_ndef.c"
                       ;
 *pbuf = 
# 191 "asn1/bio_ndef.c" 3 4
        ((void *)0)
# 191 "asn1/bio_ndef.c"
            ;
 *plen = 0;
