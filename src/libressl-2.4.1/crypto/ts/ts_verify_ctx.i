...
TS_VERIFY_CTX_new(void)
{
 ...
 if (!ctx)
  ERR_put_error(47,(144),((1|64)),"ts/ts_verify_ctx.c",71);
...
TS_REQ_to_TS_VERIFY_CTX(TS_REQ *req, TS_VERIFY_CTX *ctx)
{
 ...
 if (ret)
  ...
  return 
# 128 "ts/ts_verify_ctx.c" 3 4
        ((void *)0)
# 128 "ts/ts_verify_ctx.c"
            ;


 ret->flags = ((1u << 0) | (1u << 1) | (1u << 2) | (1u << 3) | (1u << 5) | (1u << 6) | (1u << 7)) & ~((1u << 7) | (1u << 0));


 if ((policy = TS_REQ_get_policy_id(req)) != 
# 134 "ts/ts_verify_ctx.c" 3 4
                                            ((void *)0)
# 134 "ts/ts_verify_ctx.c"
                                                ) {
...
# 152 "ts/ts_verify_ctx.c" 3 4
                                       ((void *)0)
# 152 "ts/ts_verify_ctx.c"
                                           ) {
...
err:
 ...
 return 
# 165 "ts/ts_verify_ctx.c" 3 4
       ((void *)0)
# 165 "ts/ts_verify_ctx.c"
           ;
}
