...
static int bf_cbc_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { while(inl>=((size_t)1<<(sizeof(long)*8-2))) { BF_cbc_encrypt(in, out, (long)((size_t)1<<(sizeof(long)*8-2)), &((EVP_BF_KEY *)ctx->cipher_data)->ks, ctx->iv, ctx->encrypt); inl-=((size_t)1<<(sizeof(long)*8-2)); in +=((size_t)1<<(sizeof(long)*8-2)); out+=((size_t)1<<(sizeof(long)*8-2)); } if (inl) BF_cbc_encrypt(in, out, (long)inl, &((EVP_BF_KEY *)ctx->cipher_data)->ks, ctx->iv, ctx->encrypt); return 1;} static int bf_cfb64_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { size_t chunk=((size_t)1<<(sizeof(long)*8-2)); if (64==1) chunk>>=3; if (inl<chunk) chunk=inl; while(inl && inl>=chunk) { BF_cfb64_encrypt(in, out, (long)((64==1) && !(ctx->flags & 0x2000) ?inl*8:inl), &((EVP_BF_KEY *)ctx->cipher_data)->ks, ctx->iv, &ctx->num, ctx->encrypt); inl-=chunk; in +=chunk; out+=chunk; if(inl<chunk) chunk=inl; } return 1;} static int bf_ecb_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { size_t i, bl; bl = ctx->cipher->block_size; if(inl < bl) return 1; inl -= bl; for(i=0; i <= inl; i+=bl) BF_ecb_encrypt(in + i, out + i, &((EVP_BF_KEY *)ctx->cipher_data)->ks, ctx->encrypt); return 1;} static int bf_ofb_cipher(EVP_CIPHER_CTX *ctx, unsigned char *out, const unsigned char *in, size_t inl) { while(inl>=((size_t)1<<(sizeof(long)*8-2))) { BF_ofb64_encrypt(in, out, (long)((size_t)1<<(sizeof(long)*8-2)), &((EVP_BF_KEY *)ctx->cipher_data)->ks, ctx->iv, &ctx->num); inl-=((size_t)1<<(sizeof(long)*8-2)); in +=((size_t)1<<(sizeof(long)*8-2)); out+=((size_t)1<<(sizeof(long)*8-2)); } if (inl) BF_ofb64_encrypt(in, out, (long)inl, &((EVP_BF_KEY *)ctx->cipher_data)->ks, ctx->iv, &ctx->num); return 1;} static const EVP_CIPHER bf_cbc = { 91, 8, 16, 8, 0x8 | 0x2, bf_init_key, bf_cbc_cipher, 
# 80 "evp/e_bf.c" 3 4
((void *)0)
# 80 "evp/e_bf.c"
, sizeof(EVP_BF_KEY), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, 
# 80 "evp/e_bf.c" 3 4
((void *)0)
# 80 "evp/e_bf.c"
, 
...
((void *)0) 
# 80 "evp/e_bf.c"
}; const EVP_CIPHER *EVP_bf_cbc(void) { return &bf_cbc; } static const EVP_CIPHER bf_cfb64 = { 93, 1, 16, 8, 0x8 | 0x3, bf_init_key, bf_cfb64_cipher, 
# 80 "evp/e_bf.c" 3 4
((void *)0)
# 80 "evp/e_bf.c"
, sizeof(EVP_BF_KEY), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, 
...
((void *)0) 
# 80 "evp/e_bf.c"
}; const EVP_CIPHER *EVP_bf_cfb64(void) { return &bf_cfb64; } static const EVP_CIPHER bf_ofb = { 94, 1, 16, 8, 0x8 | 0x4, bf_init_key, bf_ofb_cipher, 
# 80 "evp/e_bf.c" 3 4
((void *)0)
# 80 "evp/e_bf.c"
, sizeof(EVP_BF_KEY), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, 
...
((void *)0) 
# 80 "evp/e_bf.c"
}; const EVP_CIPHER *EVP_bf_ofb(void) { return &bf_ofb; } static const EVP_CIPHER bf_ecb = { 92, 8, 16, 0, 0x8 | 0x1, bf_init_key, bf_ecb_cipher, 
# 80 "evp/e_bf.c" 3 4
((void *)0)
# 80 "evp/e_bf.c"
, sizeof(EVP_BF_KEY), EVP_CIPHER_set_asn1_iv, EVP_CIPHER_get_asn1_iv, 
