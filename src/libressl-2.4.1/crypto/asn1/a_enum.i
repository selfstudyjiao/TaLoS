...
ASN1_ENUMERATED_set(ASN1_ENUMERATED *a, long v)
{
 ...
 if (a->data == 
# 83 "asn1/a_enum.c" 3 4
               ((void *)0)
# 83 "asn1/a_enum.c"
                   ) {
  ERR_put_error(13,(112),((1|64)),"asn1/a_enum.c",84);
  return (0);
 }
 d = v;
 if (d < 0) {
...
# 142 "asn1/a_enum.c"
  ...
  ret = ai;
 if (ret == 
# 146 "asn1/a_enum.c" 3 4
           ((void *)0)
# 146 "asn1/a_enum.c"
               ) {
  ERR_put_error(13,(138),(58),"asn1/a_enum.c",147);
  goto err;
 }
 if (((bn)->neg != 0))
  ret->type = (10 | 0x100);
 ...
 if (ret->length < len + 4) {
  ...
  if (!new_data) {
   ERR_put_error(13,(138),((1|64)),"asn1/a_enum.c",159);
   goto err;
  }
  ret->data = new_data;
 }
...
ASN1_ENUMERATED_to_BN(ASN1_ENUMERATED *ai, BIGNUM *bn)
{
 ...
 if ((ret = BN_bin2bn(ai->data, ai->length, bn)) == 
# 184 "asn1/a_enum.c" 3 4
                                                   ((void *)0)
# 184 "asn1/a_enum.c"
                                                       )
  ERR_put_error(13,(113),(105),"asn1/a_enum.c",185);
 else if (ai->type == (10 | 0x100))
