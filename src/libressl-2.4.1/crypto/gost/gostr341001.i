...
GOST_le2bn(const unsigned char *buf, size_t len, BIGNUM *bn)
{
 ...
 if (len > 64)
  return 
# 70 "gost/gostr341001.c" 3 4
        ((void *)0)
# 70 "gost/gostr341001.c"
            ;
...
gost2001_compute_public(GOST_KEY *ec)
{
 ...
 EC_POINT *pub_key = 
# 104 "gost/gostr341001.c" 3 4
                    ((void *)0)
# 104 "gost/gostr341001.c"
                        ;
 const BIGNUM *priv_key = 
# 105 "gost/gostr341001.c" 3 4
                         ((void *)0)
# 105 "gost/gostr341001.c"
                             ;
 BN_CTX *ctx = 
# 106 "gost/gostr341001.c" 3 4
              ((void *)0)
# 106 "gost/gostr341001.c"
                  ;
 int ok = 0;

 if (group == 
# 109 "gost/gostr341001.c" 3 4
             ((void *)0)
# 109 "gost/gostr341001.c"
                 ) {
  ERR_put_error(50,(106),(112),"gost/gostr341001.c",111)
                                    ;
  return 0;
 }
 ctx = BN_CTX_new();
 if (ctx == 
# 115 "gost/gostr341001.c" 3 4
           ((void *)0)
# 115 "gost/gostr341001.c"
               ) {
  ERR_put_error(50,(106),((1|64)),"gost/gostr341001.c",117)
                           ;
  return 0;
 }
 BN_CTX_start(ctx);
 if ((priv_key = GOST_KEY_get0_private_key(ec)) == 
# 121 "gost/gostr341001.c" 3 4
                                                  ((void *)0)
# 121 "gost/gostr341001.c"
                                                      )
  goto err;

 pub_key = EC_POINT_new(group);
 if (pub_key == 
# 125 "gost/gostr341001.c" 3 4
               ((void *)0)
# 125 "gost/gostr341001.c"
                   )
  goto err;
 if (EC_POINT_mul(group, pub_key, priv_key, 
# 127 "gost/gostr341001.c" 3 4
                                           ((void *)0)
# 127 "gost/gostr341001.c"
                                               , 
# 127 "gost/gostr341001.c" 3 4
                                                 ((void *)0)
# 127 "gost/gostr341001.c"
 ...
 if (ok == 0) {
err:
  ERR_put_error(50,(106),(16),"gost/gostr341001.c",135);
 }
 EC_POINT_free(pub_key);
 if (ctx != 
# 138 "gost/gostr341001.c" 3 4
           ((void *)0)
# 138 "gost/gostr341001.c"
               ) {
  BN_CTX_end(ctx);
  BN_CTX_free(ctx);
 }
...
{
 ECDSA_SIG *newsig = 
# 148 "gost/gostr341001.c" 3 4
                    ((void *)0)
# 148 "gost/gostr341001.c"
                        ;
 BIGNUM *order = 
# 149 "gost/gostr341001.c" 3 4
                ((void *)0)
# 149 "gost/gostr341001.c"
                    ;
 const EC_GROUP *group;
 const BIGNUM *priv_key;
 BIGNUM *r = 
# 152 "gost/gostr341001.c" 3 4
            ((void *)0)
# 152 "gost/gostr341001.c"
                , *s = 
# 152 "gost/gostr341001.c" 3 4
                       ((void *)0)
# 152 "gost/gostr341001.c"
...
# 153 "gost/gostr341001.c" 3 4
    ((void *)0)
# 153 "gost/gostr341001.c"
        , *e = 
# 153 "gost/gostr341001.c" 3 4
               ((void *)0)
# 153 "gost/gostr341001.c"
                   ;
 EC_POINT *C = 
# 154 "gost/gostr341001.c" 3 4
              ((void *)0)
# 154 "gost/gostr341001.c"
                  ;
 BN_CTX *ctx = BN_CTX_new();
 int ok = 0;

 if (ctx == 
# 158 "gost/gostr341001.c" 3 4
           ((void *)0)
# 158 "gost/gostr341001.c"
               ) {
  ERR_put_error(50,(107),((1|64)),"gost/gostr341001.c",159);
  return 
# 160 "gost/gostr341001.c" 3 4
        ((void *)0)
# 160 "gost/gostr341001.c"
            ;
 }
 BN_CTX_start(ctx);
 newsig = ECDSA_SIG_new();
 if (newsig == 
# 164 "gost/gostr341001.c" 3 4
              ((void *)0)
# 164 "gost/gostr341001.c"
                  ) {
  ERR_put_error(50,(107),((1|64)),"gost/gostr341001.c",165);
  goto err;
 }
 s = newsig->s;
 r = newsig->r;
 group = GOST_KEY_get0_group(eckey);
 if ((order = BN_CTX_get(ctx)) == 
# 171 "gost/gostr341001.c" 3 4
                                 ((void *)0)
# 171 "gost/gostr341001.c"
                                     )
  goto err;
 ...
 if ((e = BN_CTX_get(ctx)) == 
# 176 "gost/gostr341001.c" 3 4
                             ((void *)0)
# 176 "gost/gostr341001.c"
                                 )
  goto err;
 if (BN_div(
# 178 "gost/gostr341001.c" 3 4
    ((void *)0)
# 178 "gost/gostr341001.c"
    ,(e),(md),(order),(ctx)) == 0)
  goto err;
 if (BN_is_zero(e))
  (BN_set_word((e),1));
 if ((k = BN_CTX_get(ctx)) == 
# 182 "gost/gostr341001.c" 3 4
                             ((void *)0)
# 182 "gost/gostr341001.c"
                                 )
  goto err;
 if ((X = BN_CTX_get(ctx)) == 
# 184 "gost/gostr341001.c" 3 4
                             ((void *)0)
# 184 "gost/gostr341001.c"
                                 )
  goto err;
 if ((C = EC_POINT_new(group)) == 
# 186 "gost/gostr341001.c" 3 4
                                 ((void *)0)
# 186 "gost/gostr341001.c"
                                     )
  goto err;
 do {
  do {
   if (!BN_rand_range(k, order)) {
    ERR_put_error(50,(107),(120),"gost/gostr341001.c",192)
                                           ;
    goto err;
   }
   ...
   if (EC_POINT_mul(group, C, k, 
# 206 "gost/gostr341001.c" 3 4
                                ((void *)0)
# 206 "gost/gostr341001.c"
                                    , 
# 206 "gost/gostr341001.c" 3 4
                                      ((void *)0)
# 206 "gost/gostr341001.c"
                                          , ctx) == 0) {
    ERR_put_error(50,(107),(16),"gost/gostr341001.c",207);
    goto err;
   }
   if (EC_POINT_get_affine_coordinates_GFp(group, C, X,
       
# 211 "gost/gostr341001.c" 3 4
      ((void *)0)
# 211 "gost/gostr341001.c"
          , ctx) == 0) {
    ERR_put_error(50,(107),(16),"gost/gostr341001.c",212);
    goto err;
   }
  ...
  if (tmp == 
# 219 "gost/gostr341001.c" 3 4
            ((void *)0)
# 219 "gost/gostr341001.c"
                ) {
   if ((tmp = BN_CTX_get(ctx)) == 
# 220 "gost/gostr341001.c" 3 4
                                 ((void *)0)
# 220 "gost/gostr341001.c"
                                     )
    goto err;
  }
  if (BN_mod_mul(tmp, priv_key, r, order, ctx) == 0)
   goto err;
  if (tmp2 == 
# 225 "gost/gostr341001.c" 3 4
             ((void *)0)
# 225 "gost/gostr341001.c"
                 ) {
   if ((tmp2 = BN_CTX_get(ctx)) == 
# 226 "gost/gostr341001.c" 3 4
                                  ((void *)0)
# 226 "gost/gostr341001.c"
                                      )
    goto err;
  }
...
err:
 EC_POINT_free(C);
 if (ctx != 
# 238 "gost/gostr341001.c" 3 4
           ((void *)0)
# 238 "gost/gostr341001.c"
               ) {
  BN_CTX_end(ctx);
  BN_CTX_free(ctx);
 }
 if (ok == 0) {
  ...
  newsig = 
# 244 "gost/gostr341001.c" 3 4
          ((void *)0)
# 244 "gost/gostr341001.c"
              ;
 }
 return newsig;
}
...
gost2001_do_verify(BIGNUM *md, ECDSA_SIG *sig, GOST_KEY *ec)
{
 ...
 BIGNUM *order;
 BIGNUM *e = 
# 255 "gost/gostr341001.c" 3 4
            ((void *)0)
# 255 "gost/gostr341001.c"
                , *R = 
# 255 "gost/gostr341001.c" 3 4
                       ((void *)0)
# 255 "gost/gostr341001.c"
...
# 255 "gost/gostr341001.c"
                                                              ;
 BIGNUM *X = 
# 256 "gost/gostr341001.c" 3 4
            ((void *)0)
# 256 "gost/gostr341001.c"
                , *tmp = 
# 256 "gost/gostr341001.c" 3 4
                         ((void *)0)
# 256 "gost/gostr341001.c"
                             ;
 EC_POINT *C = 
# 257 "gost/gostr341001.c" 3 4
              ((void *)0)
# 257 "gost/gostr341001.c"
                  ;
 const EC_POINT *pub_key = 
# 258 "gost/gostr341001.c" 3 4
                          ((void *)0)
# 258 "gost/gostr341001.c"
                              ;
 int ok = 0;

 if (ctx == 
# 261 "gost/gostr341001.c" 3 4
           ((void *)0)
# 261 "gost/gostr341001.c"
               )
  goto err;
 BN_CTX_start(ctx);
 if ((order = BN_CTX_get(ctx)) == 
# 264 "gost/gostr341001.c" 3 4
                                 ((void *)0)
# 264 "gost/gostr341001.c"
                                     )
  goto err;
 if ((e = BN_CTX_get(ctx)) == 
# 266 "gost/gostr341001.c" 3 4
                             ((void *)0)
# 266 "gost/gostr341001.c"
                                 )
  goto err;
 if ((z1 = BN_CTX_get(ctx)) == 
# 268 "gost/gostr341001.c" 3 4
                              ((void *)0)
# 268 "gost/gostr341001.c"
                                  )
  goto err;
 if ((z2 = BN_CTX_get(ctx)) == 
# 270 "gost/gostr341001.c" 3 4
                              ((void *)0)
# 270 "gost/gostr341001.c"
                                  )
  goto err;
 if ((tmp = BN_CTX_get(ctx)) == 
# 272 "gost/gostr341001.c" 3 4
                               ((void *)0)
# 272 "gost/gostr341001.c"
                                   )
  goto err;
 if ((X = BN_CTX_get(ctx)) == 
# 274 "gost/gostr341001.c" 3 4
                             ((void *)0)
# 274 "gost/gostr341001.c"
                                 )
  goto err;
 if ((R = BN_CTX_get(ctx)) == 
# 276 "gost/gostr341001.c" 3 4
                             ((void *)0)
# 276 "gost/gostr341001.c"
                                 )
  goto err;
 if ((v = BN_CTX_get(ctx)) == 
# 278 "gost/gostr341001.c" 3 4
                             ((void *)0)
# 278 "gost/gostr341001.c"
                                 )
  goto err;
 ...
 if (BN_is_zero(sig->s) || BN_is_zero(sig->r) ||
  ...
  ERR_put_error(50,(108),(122),"gost/gostr341001.c",287)
                                            ;
  goto err;
 }

 if (BN_div(
# 291 "gost/gostr341001.c" 3 4
    ((void *)0)
# 291 "gost/gostr341001.c"
    ,(e),(md),(order),(ctx)) == 0)
  goto err;
 if (BN_is_zero(e))
  (BN_set_word((e),1));
 if ((v = BN_mod_inverse(v, e, order, ctx)) == 
# 295 "gost/gostr341001.c" 3 4
                                              ((void *)0)
# 295 "gost/gostr341001.c"
                                                  )
  goto err;
 ...
 if (BN_mod_mul(z2, tmp, v, order, ctx) == 0)
  goto err;
 if ((C = EC_POINT_new(group)) == 
# 303 "gost/gostr341001.c" 3 4
                                 ((void *)0)
# 303 "gost/gostr341001.c"
                                     )
  goto err;
 if (EC_POINT_mul(group, C, z1, pub_key, z2, ctx) == 0) {
  ERR_put_error(50,(108),(16),"gost/gostr341001.c",306);
  goto err;
 }
 if (EC_POINT_get_affine_coordinates_GFp(group, C, X, 
# 309 "gost/gostr341001.c" 3 4
                                                     ((void *)0)
# 309 "gost/gostr341001.c"
                                                         , ctx) == 0) {
  ERR_put_error(50,(108),(16),"gost/gostr341001.c",310);
  goto err;
 }
 if (BN_div(
# 313 "gost/gostr341001.c" 3 4
    ((void *)0)
# 313 "gost/gostr341001.c"
    ,(R),(X),(order),(ctx)) == 0)
  goto err;
 if (BN_cmp(R, sig->r) != 0) {
  ERR_put_error(50,(108),(121),"gost/gostr341001.c",316);
 } else {
  ok = 1;
 }
err:
 EC_POINT_free(C);
 if (ctx != 
# 322 "gost/gostr341001.c" 3 4
           ((void *)0)
# 322 "gost/gostr341001.c"
               ) {
  BN_CTX_end(ctx);
  BN_CTX_free(ctx);
 }
...
{
 BIGNUM *p = 
# 334 "gost/gostr341001.c" 3 4
            ((void *)0)
# 334 "gost/gostr341001.c"
                , *order = 
# 334 "gost/gostr341001.c" 3 4
                           ((void *)0)
# 334 "gost/gostr341001.c"
 ...
 EC_POINT *pnt;
 BN_CTX *ctx = 
# 339 "gost/gostr341001.c" 3 4
              ((void *)0)
# 339 "gost/gostr341001.c"
                  ;
 int ok = 0;

 pnt = EC_POINT_new(group);
 if (pnt == 
# 343 "gost/gostr341001.c" 3 4
           ((void *)0)
# 343 "gost/gostr341001.c"
               )
  goto err;
 ctx = BN_CTX_new();
 if (ctx == 
# 346 "gost/gostr341001.c" 3 4
           ((void *)0)
# 346 "gost/gostr341001.c"
               )
  goto err;
 BN_CTX_start(ctx);
 if ((p = BN_CTX_get(ctx)) == 
# 349 "gost/gostr341001.c" 3 4
                             ((void *)0)
# 349 "gost/gostr341001.c"
                                 )
  goto err;
 if ((order = BN_CTX_get(ctx)) == 
# 351 "gost/gostr341001.c" 3 4
                                 ((void *)0)
# 351 "gost/gostr341001.c"
                                     )
  goto err;
 if (EC_GROUP_get_order(group, order, ctx) == 0)
  goto err;
 if (BN_mod_mul(p, key, ukm, order, ctx) == 0)
  goto err;
 if (EC_POINT_mul(group, pnt, 
# 357 "gost/gostr341001.c" 3 4
                             ((void *)0)
# 357 "gost/gostr341001.c"
                                 , pub_key, p, ctx) == 0)
  goto err;
...
gost2001_keygen(GOST_KEY *ec)
{
 ...
 if (order == 
# 379 "gost/gostr341001.c" 3 4
             ((void *)0) 
# 379 "gost/gostr341001.c"
                  || d == 
# 379 "gost/gostr341001.c" 3 4
                          ((void *)0)
# 379 "gost/gostr341001.c"
...
# 381 "gost/gostr341001.c" 3 4
                                     ((void *)0)
# 381 "gost/gostr341001.c"
                                         ) == 0)
  goto err;

 do {
  if (BN_rand_range(d, order) == 0) {
   ERR_put_error(50,(109),(120),"gost/gostr341001.c",387)
                                          ;
   goto err;
  }
 } while (BN_is_zero(d));
