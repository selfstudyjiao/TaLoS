...
# 98 "x509v3/v3_pcia.c"
 ...
 },
 {
  ...
  .tag = 0,
  .offset = 
# 105 "x509v3/v3_pcia.c" 3 4
           __builtin_offsetof (
# 105 "x509v3/v3_pcia.c"
           PROXY_CERT_INFO_EXTENSION
# 105 "x509v3/v3_pcia.c" 3 4
           , 
# 105 "x509v3/v3_pcia.c"
...
const ASN1_ITEM PROXY_CERT_INFO_EXTENSION_it = {
 ...
 .funcs = 
# 116 "x509v3/v3_pcia.c" 3 4
         ((void *)0)
# 116 "x509v3/v3_pcia.c"
             ,
