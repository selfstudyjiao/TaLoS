...
static ERR_STRING_DATA OCSP_str_functs[]= {
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)100)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "ASN1_STRING_encode"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)102)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "D2I_OCSP_NONCE"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)103)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "OCSP_basic_add1_status"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)104)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "OCSP_basic_sign"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)105)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "OCSP_basic_verify"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)101)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "OCSP_cert_id_new"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)106)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "OCSP_CHECK_DELEGATED"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)107)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "OCSP_CHECK_IDS"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)108)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "OCSP_CHECK_ISSUER"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)115)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "OCSP_check_validity"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)109)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "OCSP_MATCH_ISSUERID"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)114)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "OCSP_parse_url"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)110)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "OCSP_request_sign"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)116)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "OCSP_request_verify"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)111)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "OCSP_response_get1_basic"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)112)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "OCSP_sendreq_bio"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)117)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "OCSP_sendreq_nbio"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)118)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "PARSE_HTTP_LINE1"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)113)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "REQUEST_VERIFY"},
 {0, 
# 94 "ocsp/ocsp_err.c" 3 4
    ((void *)0)
# 94 "ocsp/ocsp_err.c"
        }
};
...
static ERR_STRING_DATA OCSP_str_reasons[]= {
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)100)&0xfffL))) , "bad data"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)101)&0xfffL))), "certificate verify error"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)102)&0xfffL))) , "digest err"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)122)&0xfffL))), "error in nextupdate field"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)123)&0xfffL))), "error in thisupdate field"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)121)&0xfffL))) , "error parsing url"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)103)&0xfffL))), "missing ocspsigning usage"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)124)&0xfffL))), "nextupdate before thisupdate"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)104)&0xfffL))) , "not basic response"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)105)&0xfffL))), "no certificates in chain"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)106)&0xfffL))) , "no content"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)107)&0xfffL))) , "no public key"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)108)&0xfffL))) , "no response data"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)109)&0xfffL))) , "no revoked time"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)110)&0xfffL))), "private key does not match certificate"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)128)&0xfffL))) , "request not signed"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)111)&0xfffL))), "response contains no revocation data"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)112)&0xfffL))) , "root ca not trusted"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)113)&0xfffL))) , "server read error"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)114)&0xfffL))), "server response error"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)115)&0xfffL))), "server response parse error"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)116)&0xfffL))) , "server write error"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)117)&0xfffL))) , "signature failure"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)118)&0xfffL))), "signer certificate not found"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)125)&0xfffL))) , "status expired"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)126)&0xfffL))) , "status not yet valid"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)127)&0xfffL))) , "status too old"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)119)&0xfffL))), "unknown message digest"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)120)&0xfffL))) , "unknown nid"},
 {(((((unsigned long)39)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)129)&0xfffL))), "unsupported requestorname type"},
 {0, 
# 128 "ocsp/ocsp_err.c" 3 4
    ((void *)0)
# 128 "ocsp/ocsp_err.c"
        }
};
...
ERR_load_OCSP_strings(void)
{
 ...
 if (ERR_func_error_string(OCSP_str_functs[0].error) == 
# 137 "ocsp/ocsp_err.c" 3 4
                                                       ((void *)0)
# 137 "ocsp/ocsp_err.c"
                                                           ) {
