...
# 228 "./md32_common.h"
int
GOSTR341194_Update(GOSTR341194_CTX *c, const void *data_, size_t len)
{
 ...
 if (n != 0) {
  ...
  if (len >= 32 || len + n >= 32) {
   memcpy (p + n, data, 32 - n);
   GOSTR341194_block_data_order (c, p, 1);
   n = 32 - n;
   data += n;
   len -= n;
   c->num = 0;
 ...
 n = len/32;
 if (n > 0) {
  GOSTR341194_block_data_order (c, data, n);
  n *= 32;
  data += n;
  len -= n;
 }
...
void GOSTR341194_Transform (GOSTR341194_CTX *c, const unsigned char *data)
{
 GOSTR341194_block_data_order (c, data, 1);
}
# 233 "gost/gostr341194.c" 2
...
GOSTR341194(const unsigned char *d, size_t n, unsigned char *md, int nid)
{
 ...
 if (md == 
# 264 "gost/gostr341194.c" 3 4
          ((void *)0)
# 264 "gost/gostr341194.c"
              )
  md = m;
