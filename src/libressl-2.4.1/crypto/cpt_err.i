...
static ERR_STRING_DATA CRYPTO_str_functs[] = {
 {(((((unsigned long)15)&0xffL)<<24L)| ((((unsigned long)100)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "CRYPTO_get_ex_new_index"},
 {(((((unsigned long)15)&0xffL)<<24L)| ((((unsigned long)103)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "CRYPTO_get_new_dynlockid"},
 {(((((unsigned long)15)&0xffL)<<24L)| ((((unsigned long)101)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "CRYPTO_get_new_lockid"},
 {(((((unsigned long)15)&0xffL)<<24L)| ((((unsigned long)102)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "CRYPTO_set_ex_data"},
 {(((((unsigned long)15)&0xffL)<<24L)| ((((unsigned long)104)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "DEF_ADD_INDEX"},
 {(((((unsigned long)15)&0xffL)<<24L)| ((((unsigned long)105)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "DEF_GET_CLASS"},
 {(((((unsigned long)15)&0xffL)<<24L)| ((((unsigned long)109)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "FIPS_mode_set"},
 {(((((unsigned long)15)&0xffL)<<24L)| ((((unsigned long)106)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "INT_DUP_EX_DATA"},
 {(((((unsigned long)15)&0xffL)<<24L)| ((((unsigned long)107)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "INT_FREE_EX_DATA"},
 {(((((unsigned long)15)&0xffL)<<24L)| ((((unsigned long)108)&0xfffL)<<12L)| ((((unsigned long)0)&0xfffL))), "INT_NEW_EX_DATA"},
 {0, 
# 85 "cpt_err.c" 3 4
    ((void *)0)
# 85 "cpt_err.c"
...
static ERR_STRING_DATA CRYPTO_str_reasons[] = {
 {(((((unsigned long)15)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)101)&0xfffL))), "fips mode not supported"},
 {(((((unsigned long)15)&0xffL)<<24L)| ((((unsigned long)0)&0xfffL)<<12L)| ((((unsigned long)100)&0xfffL))), "no dynlock create callback"},
 {0, 
# 91 "cpt_err.c" 3 4
    ((void *)0)
# 91 "cpt_err.c"
...
ERR_load_CRYPTO_strings(void)
{
 ...
 if (ERR_func_error_string(CRYPTO_str_functs[0].error) == 
# 100 "cpt_err.c" 3 4
                                                         ((void *)0)
# 100 "cpt_err.c"
                                                             ) {
